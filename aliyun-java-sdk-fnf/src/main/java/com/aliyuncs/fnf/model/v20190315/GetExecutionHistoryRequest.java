 ...
 * @version 
 */
public class GetExecutionHistoryRequest extends RpcAcsRequest<GetExecutionHistoryResponse> {
	...
	@Override
	public Class<GetExecutionHistoryResponse> getResponseClass() {
		return GetExecutionHistoryResponse.class;
	}
