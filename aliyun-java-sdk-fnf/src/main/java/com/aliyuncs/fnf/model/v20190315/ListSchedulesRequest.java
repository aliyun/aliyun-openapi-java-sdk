 ...
 * @version 
 */
public class ListSchedulesRequest extends RpcAcsRequest<ListSchedulesResponse> {
	...
	@Override
	public Class<ListSchedulesResponse> getResponseClass() {
		return ListSchedulesResponse.class;
	}
