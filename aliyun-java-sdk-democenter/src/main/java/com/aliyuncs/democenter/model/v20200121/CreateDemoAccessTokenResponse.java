...
import com.aliyuncs.democenter.transform.v20200121.CreateDemoAccessTokenResponseUnmarshaller;
 ...
 * @version 
 */
public class CreateDemoAccessTokenResponse extends AcsResponse {
	...
	@Override
	public CreateDemoAccessTokenResponse getInstance(UnmarshallerContext context) {
		return	CreateDemoAccessTokenResponseUnmarshaller.unmarshall(this, context);
	}
