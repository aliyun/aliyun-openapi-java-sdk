 ...
 * @version 
 */
public class ExpireDemoAccessTokenRequest extends RpcAcsRequest<ExpireDemoAccessTokenResponse> {
	...
	@Override
	public Class<ExpireDemoAccessTokenResponse> getResponseClass() {
		return ExpireDemoAccessTokenResponse.class;
	}
