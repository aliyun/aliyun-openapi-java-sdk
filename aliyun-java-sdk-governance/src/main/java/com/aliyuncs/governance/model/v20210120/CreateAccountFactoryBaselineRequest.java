 ...
 * @version 
 */
public class CreateAccountFactoryBaselineRequest extends RpcAcsRequest<CreateAccountFactoryBaselineResponse> {
	...
	public CreateAccountFactoryBaselineRequest() {
		super("governance", "2021-01-20", "CreateAccountFactoryBaseline", "governance");
	...
	@Override
	public Class<CreateAccountFactoryBaselineResponse> getResponseClass() {
		return CreateAccountFactoryBaselineResponse.class;
	}
