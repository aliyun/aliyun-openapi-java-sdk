 ...
 * @version 
 */
public class DeleteDatabaseAccessPointRequest extends RpcAcsRequest<DeleteDatabaseAccessPointResponse> {
	...
	public DeleteDatabaseAccessPointRequest() {
		super("dg", "2019-03-27", "DeleteDatabaseAccessPoint", "dg");
	...
	@Override
	public Class<DeleteDatabaseAccessPointResponse> getResponseClass() {
		return DeleteDatabaseAccessPointResponse.class;
	}
