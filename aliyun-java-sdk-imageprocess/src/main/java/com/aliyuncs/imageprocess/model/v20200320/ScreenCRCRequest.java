 ...
 * @version 
 */
public class ScreenCRCRequest extends RpcAcsRequest<ScreenCRCResponse> {
	...
	public ScreenCRCRequest() {
		super("imageprocess", "2020-03-20", "ScreenCRC", "imageprocess");
	...
	@Override
	public Class<ScreenCRCResponse> getResponseClass() {
		return ScreenCRCResponse.class;
	}
