 ...
 * @version 
 */
public class SegmentLymphNodeRequest extends RpcAcsRequest<SegmentLymphNodeResponse> {
	...
	public SegmentLymphNodeRequest() {
		super("imageprocess", "2020-03-20", "SegmentLymphNode", "imageprocess");
	...
	@Override
	public Class<SegmentLymphNodeResponse> getResponseClass() {
		return SegmentLymphNodeResponse.class;
	}
