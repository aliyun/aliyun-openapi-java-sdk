 ...
 * @version 
 */
public class PredictCVDRequest extends RpcAcsRequest<PredictCVDResponse> {
	...
	public PredictCVDRequest() {
		super("imageprocess", "2020-03-20", "PredictCVD", "imageprocess");
	...
	@Override
	public Class<PredictCVDResponse> getResponseClass() {
		return PredictCVDResponse.class;
	}
