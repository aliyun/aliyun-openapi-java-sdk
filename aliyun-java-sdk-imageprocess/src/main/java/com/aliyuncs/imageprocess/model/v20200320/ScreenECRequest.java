 ...
 * @version 
 */
public class ScreenECRequest extends RpcAcsRequest<ScreenECResponse> {
	   

	private String dataSourceType;

	private List<URLList> uRLLists;
	public ScreenECRequest() {
		super("imageprocess", "2020-03-20", "ScreenEC", "imageprocess");
	...
	@Override
	public Class<ScreenECResponse> getResponseClass() {
		return ScreenECResponse.class;
	}
