 ...
 * @version 
 */
public class CalcBMDRequest extends RpcAcsRequest<CalcBMDResponse> {
	...
	public CalcBMDRequest() {
		super("imageprocess", "2020-03-20", "CalcBMD", "imageprocess");
	...
	@Override
	public Class<CalcBMDResponse> getResponseClass() {
		return CalcBMDResponse.class;
	}
