 ...
 * @version 
 */
public class ScreenGCRequest extends RpcAcsRequest<ScreenGCResponse> {
	...
	public ScreenGCRequest() {
		super("imageprocess", "2020-03-20", "ScreenGC", "imageprocess");
	...
	@Override
	public Class<ScreenGCResponse> getResponseClass() {
		return ScreenGCResponse.class;
	}
