 ...
 * @version 
 */
public class TargetVolumeSegmentRequest extends RpcAcsRequest<TargetVolumeSegmentResponse> {
	...
	public TargetVolumeSegmentRequest() {
		super("imageprocess", "2020-03-20", "TargetVolumeSegment", "imageprocess");
	...
	public void setCancerType(String cancerType) {
		...
		if(cancerType != null){
			putBodyParameter("CancerType", cancerType);
		}
	}
	...
	public void setTargetVolumeType(String targetVolumeType) {
		...
		if(targetVolumeType != null){
			putBodyParameter("TargetVolumeType", targetVolumeType);
		}
	}
	...
	@Override
	public Class<TargetVolumeSegmentResponse> getResponseClass() {
		return TargetVolumeSegmentResponse.class;
	}
