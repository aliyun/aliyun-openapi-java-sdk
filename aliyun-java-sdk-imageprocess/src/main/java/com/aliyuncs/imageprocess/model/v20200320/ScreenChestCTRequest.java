 ...
 * @version 
 */
public class ScreenChestCTRequest extends RpcAcsRequest<ScreenChestCTResponse> {
	...
	@Override
	public Class<ScreenChestCTResponse> getResponseClass() {
		return ScreenChestCTResponse.class;
	}
