 ...
 * @version 
 */
public class ScreenLCRequest extends RpcAcsRequest<ScreenLCResponse> {
	...
	public ScreenLCRequest() {
		super("imageprocess", "2020-03-20", "ScreenLC", "imageprocess");
	...
	@Override
	public Class<ScreenLCResponse> getResponseClass() {
		return ScreenLCResponse.class;
	}
