 ...
 * @version 
 */
public class DetectLiverSteatosisRequest extends RpcAcsRequest<DetectLiverSteatosisResponse> {
	...
	public DetectLiverSteatosisRequest() {
		super("imageprocess", "2020-03-20", "DetectLiverSteatosis", "imageprocess");
	...
	@Override
	public Class<DetectLiverSteatosisResponse> getResponseClass() {
		return DetectLiverSteatosisResponse.class;
	}
