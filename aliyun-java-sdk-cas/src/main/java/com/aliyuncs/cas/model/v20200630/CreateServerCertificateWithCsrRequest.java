 ...
 * @version 
 */
public class CreateServerCertificateWithCsrRequest extends RpcAcsRequest<CreateServerCertificateWithCsrResponse> {
	...
	public CreateServerCertificateWithCsrRequest() {
		super("cas", "2020-06-30", "CreateServerCertificateWithCsr");
	...
	@Override
	public Class<CreateServerCertificateWithCsrResponse> getResponseClass() {
		return CreateServerCertificateWithCsrResponse.class;
	}
