...
import com.aliyuncs.cas.transform.v20180813.DescribeExpectationResultResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeExpectationResultResponse extends AcsResponse {
	...
	@Override
	public DescribeExpectationResultResponse getInstance(UnmarshallerContext context) {
		return	DescribeExpectationResultResponseUnmarshaller.unmarshall(this, context);
	}
