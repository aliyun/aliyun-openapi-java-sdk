...
import com.aliyuncs.cas.transform.v20200407.CreateWHClientCertificateResponseUnmarshaller;
 ...
 * @version 
 */
public class CreateWHClientCertificateResponse extends AcsResponse {
	...
	@Override
	public CreateWHClientCertificateResponse getInstance(UnmarshallerContext context) {
		return	CreateWHClientCertificateResponseUnmarshaller.unmarshall(this, context);
	}
