 ...
 * @version 
 */
public class CreateClientCertificateWithCsrRequest extends RpcAcsRequest<CreateClientCertificateWithCsrResponse> {
	...
	public CreateClientCertificateWithCsrRequest() {
		super("cas", "2020-06-30", "CreateClientCertificateWithCsr");
	...
	public void setSanType(Integer sanType) {
	...
	@Override
	public Class<CreateClientCertificateWithCsrResponse> getResponseClass() {
		return CreateClientCertificateWithCsrResponse.class;
	}
