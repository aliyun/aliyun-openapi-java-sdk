...
import com.aliyuncs.cas.transform.v20200630.CreateClientCertificateResponseUnmarshaller;
 ...
 * @version 
 */
public class CreateClientCertificateResponse extends AcsResponse {
	...
	@Override
	public CreateClientCertificateResponse getInstance(UnmarshallerContext context) {
		return	CreateClientCertificateResponseUnmarshaller.unmarshall(this, context);
	}
