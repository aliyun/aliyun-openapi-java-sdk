...
import com.aliyuncs.cas.transform.v20180813.DescribeDomainVerifyInfoResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeDomainVerifyInfoResponse extends AcsResponse {
	...
	@Override
	public DescribeDomainVerifyInfoResponse getInstance(UnmarshallerContext context) {
		return	DescribeDomainVerifyInfoResponseUnmarshaller.unmarshall(this, context);
	}
