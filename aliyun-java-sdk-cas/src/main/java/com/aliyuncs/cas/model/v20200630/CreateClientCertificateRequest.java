 ...
 * @version 
 */
public class CreateClientCertificateRequest extends RpcAcsRequest<CreateClientCertificateResponse> {
	...
	@Override
	public Class<CreateClientCertificateResponse> getResponseClass() {
		return CreateClientCertificateResponse.class;
	}
