...
public class GetUserCertificateDetailResponseUnmarshaller {
	...
	public static GetUserCertificateDetailResponse unmarshall(GetUserCertificateDetailResponse getUserCertificateDetailResponse, UnmarshallerContext _ctx) {
		...
		getUserCertificateDetailResponse.setEncryptCert(_ctx.stringValue("GetUserCertificateDetailResponse.EncryptCert"));
		getUserCertificateDetailResponse.setEncryptPrivateKey(_ctx.stringValue("GetUserCertificateDetailResponse.EncryptPrivateKey"));
		getUserCertificateDetailResponse.setSignCert(_ctx.stringValue("GetUserCertificateDetailResponse.SignCert"));
		getUserCertificateDetailResponse.setSignPrivateKey(_ctx.stringValue("GetUserCertificateDetailResponse.SignPrivateKey"));
		...
		getUserCertificateDetailResponse.setOrderId(_ctx.longValue("GetUserCertificateDetailResponse.OrderId"));
		getUserCertificateDetailResponse.setResourceGroupId(_ctx.stringValue("GetUserCertificateDetailResponse.ResourceGroupId"));
		getUserCertificateDetailResponse.setAlgorithm(_ctx.stringValue("GetUserCertificateDetailResponse.Algorithm"));
