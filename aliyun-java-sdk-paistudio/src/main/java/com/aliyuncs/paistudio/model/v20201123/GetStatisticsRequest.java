 ...
 * @version 
 */
public class GetStatisticsRequest extends RoaAcsRequest<GetStatisticsResponse> {
	...
	public GetStatisticsRequest() {
		super("PaiStudio", "2020-11-23", "GetStatistics");
		setUriPattern("/api/core/v1.0/statistics");
