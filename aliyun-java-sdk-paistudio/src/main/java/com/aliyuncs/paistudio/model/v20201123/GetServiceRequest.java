 ...
 * @version 
 */
public class GetServiceRequest extends RoaAcsRequest<GetServiceResponse> {
	...
	public GetServiceRequest() {
		super("PaiStudio", "2020-11-23", "GetService");
		setUriPattern("/api/core/v1.0/services/[ServiceId]");
