...
import com.aliyuncs.paistudio.transform.v20201123.GetOdpsTableResponseUnmarshaller;
 ...
 * @version 
 */
public class GetOdpsTableResponse extends AcsResponse {
	...
	@Override
	public GetOdpsTableResponse getInstance(UnmarshallerContext context) {
		return	GetOdpsTableResponseUnmarshaller.unmarshall(this, context);
	}
