 ...
 * @version 
 */
public class GetTemplateRequest extends RoaAcsRequest<GetTemplateResponse> {
	   

	private String templateId;
	public GetTemplateRequest() {
		super("PaiStudio", "2020-11-23", "GetTemplate");
		setUriPattern("/api/core/v1.0/templates/[TemplateId]");
