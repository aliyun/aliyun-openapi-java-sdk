 ...
 * @version 
 */
public class RecognizeTrainTicketRequest extends RpcAcsRequest<RecognizeTrainTicketResponse> {
	...
	@Override
	public Class<RecognizeTrainTicketResponse> getResponseClass() {
		return RecognizeTrainTicketResponse.class;
	}
