...
import com.aliyuncs.ocr.transform.v20191230.RecognizeMalaysiaIdentityCardResponseUnmarshaller;
 ...
 * @version 
 */
public class RecognizeMalaysiaIdentityCardResponse extends AcsResponse {
	...
	@Override
	public RecognizeMalaysiaIdentityCardResponse getInstance(UnmarshallerContext context) {
		return	RecognizeMalaysiaIdentityCardResponseUnmarshaller.unmarshall(this, context);
	}
