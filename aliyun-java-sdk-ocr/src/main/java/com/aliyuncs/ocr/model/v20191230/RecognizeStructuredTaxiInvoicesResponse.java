...
import com.aliyuncs.ocr.transform.v20191230.RecognizeStructuredTaxiInvoicesResponseUnmarshaller;
 ...
 * @version 
 */
public class RecognizeStructuredTaxiInvoicesResponse extends AcsResponse {
	...
	@Override
	public RecognizeStructuredTaxiInvoicesResponse getInstance(UnmarshallerContext context) {
		return	RecognizeStructuredTaxiInvoicesResponseUnmarshaller.unmarshall(this, context);
	}
