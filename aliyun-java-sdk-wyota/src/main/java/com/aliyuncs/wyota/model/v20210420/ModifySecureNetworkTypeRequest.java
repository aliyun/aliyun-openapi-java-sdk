 ...
 * @version 
 */
public class ModifySecureNetworkTypeRequest extends RpcAcsRequest<ModifySecureNetworkTypeResponse> {
	   

	private String serialNo;

	private String secureNetworkType;
	public ModifySecureNetworkTypeRequest() {
		super("wyota", "2021-04-20", "ModifySecureNetworkType");
	...
	@Override
	public Class<ModifySecureNetworkTypeResponse> getResponseClass() {
		return ModifySecureNetworkTypeResponse.class;
	}
