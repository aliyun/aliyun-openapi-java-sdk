 ...
 * @version 
 */
public class DetachLabelsRequest extends RpcAcsRequest<DetachLabelsResponse> {
	...
	public DetachLabelsRequest() {
		super("wyota", "2021-04-20", "DetachLabels");
	...
	@Override
	public Class<DetachLabelsResponse> getResponseClass() {
		return DetachLabelsResponse.class;
	}
