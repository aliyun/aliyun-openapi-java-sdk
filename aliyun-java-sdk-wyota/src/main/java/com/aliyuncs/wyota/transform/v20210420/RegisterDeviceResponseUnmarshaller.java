...
import com.aliyuncs.wyota.model.v20210420.RegisterDeviceResponse;
import com.aliyuncs.wyota.model.v20210420.RegisterDeviceResponse.Data;
...
public class RegisterDeviceResponseUnmarshaller {
	...
	public static RegisterDeviceResponse unmarshall(RegisterDeviceResponse registerDeviceResponse, UnmarshallerContext _ctx) {
		...
		Data data = new Data();
		data.setUuid(_ctx.stringValue("RegisterDeviceResponse.Data.Uuid"));
