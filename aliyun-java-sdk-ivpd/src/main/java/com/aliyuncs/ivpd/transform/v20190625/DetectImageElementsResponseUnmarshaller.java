...
import com.aliyuncs.ivpd.model.v20190625.DetectImageElementsResponse;
import com.aliyuncs.ivpd.model.v20190625.DetectImageElementsResponse.Data;
import com.aliyuncs.ivpd.model.v20190625.DetectImageElementsResponse.Data.Element;
...
public class DetectImageElementsResponseUnmarshaller {
	...
	public static DetectImageElementsResponse unmarshall(DetectImageElementsResponse detectImageElementsResponse, UnmarshallerContext _ctx) {
		...
		detectImageElementsResponse.setCode(_ctx.stringValue("DetectImageElementsResponse.Code"));
		detectImageElementsResponse.setMessage(_ctx.stringValue("DetectImageElementsResponse.Message"));
