...
import com.aliyuncs.csas.transform.v20230120.ListRegistrationPoliciesForUserGroupResponseUnmarshaller;
 ...
 * @version 
 */
public class ListRegistrationPoliciesForUserGroupResponse extends AcsResponse {

	private String requestId;

	private List<Data> userGroups;
	...
	public List<Data> getUserGroups() {
		return this.userGroups;
	}

	public void setUserGroups(List<Data> userGroups) {
	...
	@Override
	public ListRegistrationPoliciesForUserGroupResponse getInstance(UnmarshallerContext context) {
		return	ListRegistrationPoliciesForUserGroupResponseUnmarshaller.unmarshall(this, context);
	}
