...
import com.aliyuncs.csas.transform.v20230120.UpdateRegistrationPolicyResponseUnmarshaller;
 ...
 * @version 
 */
public class UpdateRegistrationPolicyResponse extends AcsResponse {
	...
	@Override
	public UpdateRegistrationPolicyResponse getInstance(UnmarshallerContext context) {
		return	UpdateRegistrationPolicyResponseUnmarshaller.unmarshall(this, context);
	}
