...
import com.aliyuncs.csas.transform.v20230120.ListUserDevicesResponseUnmarshaller;
 ...
 * @version 
 */
public class ListUserDevicesResponse extends AcsResponse {

	private String requestId;

	private Long totalNum;

	private List<DataList> devices;
	...
	public List<DataList> getDevices() {
		return this.devices;
	}

	public void setDevices(List<DataList> devices) {
	...
	@Override
	public ListUserDevicesResponse getInstance(UnmarshallerContext context) {
		return	ListUserDevicesResponseUnmarshaller.unmarshall(this, context);
	}
