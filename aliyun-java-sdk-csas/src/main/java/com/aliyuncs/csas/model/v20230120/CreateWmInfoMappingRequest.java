 ...
 * @version 
 */
public class CreateWmInfoMappingRequest extends RpcAcsRequest<CreateWmInfoMappingResponse> {
	...
	public CreateWmInfoMappingRequest() {
		super("csas", "2023-01-20", "CreateWmInfoMapping");
	...
	@Override
	public Class<CreateWmInfoMappingResponse> getResponseClass() {
		return CreateWmInfoMappingResponse.class;
	}
