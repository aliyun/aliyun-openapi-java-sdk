...
import com.aliyuncs.csas.transform.v20230120.GetApprovalResponseUnmarshaller;
 ...
 * @version 
 */
public class GetApprovalResponse extends AcsResponse {
	...
	@Override
	public GetApprovalResponse getInstance(UnmarshallerContext context) {
		return	GetApprovalResponseUnmarshaller.unmarshall(this, context);
	}
