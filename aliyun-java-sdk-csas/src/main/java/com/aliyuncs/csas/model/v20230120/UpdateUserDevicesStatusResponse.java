...
import com.aliyuncs.csas.transform.v20230120.UpdateUserDevicesStatusResponseUnmarshaller;
 ...
 * @version 
 */
public class UpdateUserDevicesStatusResponse extends AcsResponse {
	...
	@Override
	public UpdateUserDevicesStatusResponse getInstance(UnmarshallerContext context) {
		return	UpdateUserDevicesStatusResponseUnmarshaller.unmarshall(this, context);
	}
