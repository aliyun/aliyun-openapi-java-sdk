...
import com.aliyuncs.csas.transform.v20230120.GetUserDeviceResponseUnmarshaller;
 ...
 * @version 
 */
public class GetUserDeviceResponse extends AcsResponse {
	...
	public static class Device {
		...
		public List<HistoryUsersItem> getHistoryUsers() {
			return this.historyUsers;
		}

		public void setHistoryUsers(List<HistoryUsersItem> historyUsers) {
	...
	@Override
	public GetUserDeviceResponse getInstance(UnmarshallerContext context) {
		return	GetUserDeviceResponseUnmarshaller.unmarshall(this, context);
	}
