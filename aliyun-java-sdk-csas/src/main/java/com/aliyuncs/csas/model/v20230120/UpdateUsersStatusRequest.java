 ...
 * @version 
 */
public class UpdateUsersStatusRequest extends RpcAcsRequest<UpdateUsersStatusResponse> {
	   

	private List<String> saseUserIds;

	private String status;
	public UpdateUsersStatusRequest() {
		super("csas", "2023-01-20", "UpdateUsersStatus");
	...
	@Override
	public Class<UpdateUsersStatusResponse> getResponseClass() {
		return UpdateUsersStatusResponse.class;
	}
