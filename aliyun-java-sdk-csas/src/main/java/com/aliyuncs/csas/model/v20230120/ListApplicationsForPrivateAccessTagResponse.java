...
public class ListApplicationsForPrivateAccessTagResponse extends AcsResponse {
	...
	@Override
	public ListApplicationsForPrivateAccessTagResponse getInstance(UnmarshallerContext context) {
		return	ListApplicationsForPrivateAccessTagResponseUnmarshaller.unmarshall(this, context);
	}
