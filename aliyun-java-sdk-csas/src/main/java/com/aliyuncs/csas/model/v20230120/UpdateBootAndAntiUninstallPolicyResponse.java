...
import com.aliyuncs.csas.transform.v20230120.UpdateBootAndAntiUninstallPolicyResponseUnmarshaller;
 ...
 * @version 
 */
public class UpdateBootAndAntiUninstallPolicyResponse extends AcsResponse {
	...
	@Override
	public UpdateBootAndAntiUninstallPolicyResponse getInstance(UnmarshallerContext context) {
		return	UpdateBootAndAntiUninstallPolicyResponseUnmarshaller.unmarshall(this, context);
	}
