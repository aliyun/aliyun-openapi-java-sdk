...
import com.aliyuncs.csas.transform.v20230120.GetRegistrationPolicyResponseUnmarshaller;
 ...
 * @version 
 */
public class GetRegistrationPolicyResponse extends AcsResponse {
	...
	@Override
	public GetRegistrationPolicyResponse getInstance(UnmarshallerContext context) {
		return	GetRegistrationPolicyResponseUnmarshaller.unmarshall(this, context);
	}
