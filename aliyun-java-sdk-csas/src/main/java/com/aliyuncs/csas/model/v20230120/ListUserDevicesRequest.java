 ...
 * @version 
 */
public class ListUserDevicesRequest extends RpcAcsRequest<ListUserDevicesResponse> {
	...
	public ListUserDevicesRequest() {
		super("csas", "2023-01-20", "ListUserDevices");
	...
	public void setDeviceTypes(List<String> deviceTypes) {
		...
		if (deviceTypes != null) {
			for (int depth1 = 0; depth1 < deviceTypes.size(); depth1++) {
				putQueryParameter("DeviceTypes." + (depth1 + 1) , deviceTypes.get(depth1));
			}
		}	
	}
	...
	public void setAppStatuses(List<String> appStatuses) {
		...
		if (appStatuses != null) {
			for (int depth1 = 0; depth1 < appStatuses.size(); depth1++) {
				putQueryParameter("AppStatuses." + (depth1 + 1) , appStatuses.get(depth1));
			}
		}	
	}
	...
	public void setDlpStatuses(List<String> dlpStatuses) {
		...
		if (dlpStatuses != null) {
			for (int depth1 = 0; depth1 < dlpStatuses.size(); depth1++) {
				putQueryParameter("DlpStatuses." + (depth1 + 1) , dlpStatuses.get(depth1));
			}
		}	
	}
	...
	public void setNacStatuses(List<String> nacStatuses) {
		...
		if (nacStatuses != null) {
			for (int depth1 = 0; depth1 < nacStatuses.size(); depth1++) {
				putQueryParameter("NacStatuses." + (depth1 + 1) , nacStatuses.get(depth1));
			}
		}	
	}
	...
	public void setIaStatuses(List<String> iaStatuses) {
		...
		if (iaStatuses != null) {
			for (int depth1 = 0; depth1 < iaStatuses.size(); depth1++) {
				putQueryParameter("IaStatuses." + (depth1 + 1) , iaStatuses.get(depth1));
			}
		}	
	}
	...
	public void setDeviceBelong(String deviceBelong) {
		...
		if(deviceBelong != null){
			putQueryParameter("DeviceBelong", deviceBelong);
		}
	}
	...
	public void setSharingStatus(Boolean sharingStatus) {
		...
		if(sharingStatus != null){
			putQueryParameter("SharingStatus", sharingStatus.toString());
		}
	}
	...
	public void setDeviceTags(List<String> deviceTags) {
		...
		if (deviceTags != null) {
			for (int depth1 = 0; depth1 < deviceTags.size(); depth1++) {
				putQueryParameter("DeviceTags." + (depth1 + 1) , deviceTags.get(depth1));
			}
		}	
	}
	...
	public void setDeviceStatuses(List<String> deviceStatuses) {
		...
		if (deviceStatuses != null) {
			for (int depth1 = 0; depth1 < deviceStatuses.size(); depth1++) {
				putQueryParameter("DeviceStatuses." + (depth1 + 1) , deviceStatuses.get(depth1));
			}
		}	
	}
	...
	public void setPaStatuses(List<String> paStatuses) {
		...
		if (paStatuses != null) {
			for (int depth1 = 0; depth1 < paStatuses.size(); depth1++) {
				putQueryParameter("PaStatuses." + (depth1 + 1) , paStatuses.get(depth1));
			}
		}	
	}
	...
	@Override
	public Class<ListUserDevicesResponse> getResponseClass() {
		return ListUserDevicesResponse.class;
	}
