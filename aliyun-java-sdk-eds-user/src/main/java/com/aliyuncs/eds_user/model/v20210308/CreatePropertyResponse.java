...
import com.aliyuncs.eds_user.transform.v20210308.CreatePropertyResponseUnmarshaller;
 ...
 * @version 
 */
public class CreatePropertyResponse extends AcsResponse {
	...
	@Override
	public CreatePropertyResponse getInstance(UnmarshallerContext context) {
		return	CreatePropertyResponseUnmarshaller.unmarshall(this, context);
	}
