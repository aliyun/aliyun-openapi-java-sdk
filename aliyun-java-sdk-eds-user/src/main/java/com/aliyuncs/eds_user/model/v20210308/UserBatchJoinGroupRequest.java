 ...
 * @version 
 */
public class UserBatchJoinGroupRequest extends RpcAcsRequest<UserBatchJoinGroupResponse> {
	   

	private List<String> endUserIdss;

	private String groupId;
	public UserBatchJoinGroupRequest() {
		super("eds-user", "2021-03-08", "UserBatchJoinGroup", "eds-user");
	...
	@Override
	public Class<UserBatchJoinGroupResponse> getResponseClass() {
		return UserBatchJoinGroupResponse.class;
	}
