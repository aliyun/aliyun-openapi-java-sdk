...
public class ResetUserPasswordRequest extends RpcAcsRequest<ResetUserPasswordResponse> {
	...
	public ResetUserPasswordRequest() {
		super("eds-user", "2021-03-08", "ResetUserPassword", "eds-user");
	...
	public void setNotifyType(Integer notifyType) {
		...
		if(notifyType != null){
			putBodyParameter("NotifyType", notifyType.toString());
		}
	}

	@Override
	public Class<ResetUserPasswordResponse> getResponseClass() {
