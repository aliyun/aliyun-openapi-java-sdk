 ...
 * @version 
 */
public class UnlockUsersRequest extends RpcAcsRequest<UnlockUsersResponse> {
	...
	public UnlockUsersRequest() {
		super("eds-user", "2021-03-08", "UnlockUsers", "eds-user");
	...
	@Override
	public Class<UnlockUsersResponse> getResponseClass() {
		return UnlockUsersResponse.class;
	}
