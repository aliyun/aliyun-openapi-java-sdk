 ...
 * @version 
 */
public class DeleteUserPropertyValueRequest extends RpcAcsRequest<DeleteUserPropertyValueResponse> {
	...
	public DeleteUserPropertyValueRequest() {
		super("eds-user", "2021-03-08", "DeleteUserPropertyValue", "eds-user");
	...
	@Override
	public Class<DeleteUserPropertyValueResponse> getResponseClass() {
		return DeleteUserPropertyValueResponse.class;
	}
