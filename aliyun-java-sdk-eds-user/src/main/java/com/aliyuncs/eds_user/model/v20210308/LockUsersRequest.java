 ...
 * @version 
 */
public class LockUsersRequest extends RpcAcsRequest<LockUsersResponse> {
	   

	private Boolean logoutSession;

	private List<String> userss;
	public LockUsersRequest() {
		super("eds-user", "2021-03-08", "LockUsers", "eds-user");
	...
	public void setLogoutSession(Boolean logoutSession) {
		...
		if(logoutSession != null){
			putQueryParameter("LogoutSession", logoutSession.toString());
		}
	}
	...
	@Override
	public Class<LockUsersResponse> getResponseClass() {
		return LockUsersResponse.class;
	}
