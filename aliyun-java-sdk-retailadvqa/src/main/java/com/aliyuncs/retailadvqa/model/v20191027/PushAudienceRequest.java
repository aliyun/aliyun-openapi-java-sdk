 ...
 * @version 
 */
public class PushAudienceRequest extends RpcAcsRequest<PushAudienceResponse> {
	...
	public PushAudienceRequest() {
		super("retailadvqa", "2019-10-27", "PushAudience");
	...
	public void setCrowdName(String crowdName) {
		...
		if(crowdName != null){
			putQueryParameter("CrowdName", crowdName);
		}
	}
	...
	@Override
	public Class<PushAudienceResponse> getResponseClass() {
		return PushAudienceResponse.class;
	}
