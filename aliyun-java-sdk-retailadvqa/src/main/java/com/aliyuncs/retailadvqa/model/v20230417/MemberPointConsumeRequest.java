 ...
 * @version 
 */
public class MemberPointConsumeRequest extends RpcAcsRequest<MemberPointConsumeResponse> {
	...
	@Override
	public Class<MemberPointConsumeResponse> getResponseClass() {
		return MemberPointConsumeResponse.class;
	}
