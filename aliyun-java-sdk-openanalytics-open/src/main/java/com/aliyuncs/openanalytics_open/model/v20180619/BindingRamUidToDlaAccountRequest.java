 ...
 * @version 
 */
public class BindingRamUidToDlaAccountRequest extends RpcAcsRequest<BindingRamUidToDlaAccountResponse> {
	...
	public BindingRamUidToDlaAccountRequest() {
		super("openanalytics-open", "2018-06-19", "BindingRamUidToDlaAccount", "openanalytics");
	...
	@Override
	public Class<BindingRamUidToDlaAccountResponse> getResponseClass() {
		return BindingRamUidToDlaAccountResponse.class;
	}
