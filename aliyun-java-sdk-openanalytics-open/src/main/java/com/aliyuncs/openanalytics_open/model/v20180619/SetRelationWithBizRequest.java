 ...
 * @version 
 */
public class SetRelationWithBizRequest extends RpcAcsRequest<SetRelationWithBizResponse> {
	...
	@Override
	public Class<SetRelationWithBizResponse> getResponseClass() {
		return SetRelationWithBizResponse.class;
	}
