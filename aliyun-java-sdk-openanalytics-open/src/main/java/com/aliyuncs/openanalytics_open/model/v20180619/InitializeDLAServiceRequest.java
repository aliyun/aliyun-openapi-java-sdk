 ...
 * @version 
 */
public class InitializeDLAServiceRequest extends RpcAcsRequest<InitializeDLAServiceResponse> {
	...
	@Override
	public Class<InitializeDLAServiceResponse> getResponseClass() {
		return InitializeDLAServiceResponse.class;
	}
