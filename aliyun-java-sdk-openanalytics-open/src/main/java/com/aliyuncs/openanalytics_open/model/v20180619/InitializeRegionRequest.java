 ...
 * @version 
 */
public class InitializeRegionRequest extends RpcAcsRequest<InitializeRegionResponse> {
	...
	@Override
	public Class<InitializeRegionResponse> getResponseClass() {
		return InitializeRegionResponse.class;
	}
