 ...
 * @version 
 */
public class StopVirtualClusterRequest extends RpcAcsRequest<StopVirtualClusterResponse> {
	...
	@Override
	public Class<StopVirtualClusterResponse> getResponseClass() {
		return StopVirtualClusterResponse.class;
	}
