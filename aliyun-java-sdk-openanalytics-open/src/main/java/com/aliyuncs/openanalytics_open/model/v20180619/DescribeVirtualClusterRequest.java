 ...
 * @version 
 */
public class DescribeVirtualClusterRequest extends RpcAcsRequest<DescribeVirtualClusterResponse> {
	...
	@Override
	public Class<DescribeVirtualClusterResponse> getResponseClass() {
		return DescribeVirtualClusterResponse.class;
	}
