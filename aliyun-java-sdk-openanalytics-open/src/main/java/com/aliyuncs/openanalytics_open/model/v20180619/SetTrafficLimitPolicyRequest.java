 ...
 * @version 
 */
public class SetTrafficLimitPolicyRequest extends RpcAcsRequest<SetTrafficLimitPolicyResponse> {
	...
	@Override
	public Class<SetTrafficLimitPolicyResponse> getResponseClass() {
		return SetTrafficLimitPolicyResponse.class;
	}
