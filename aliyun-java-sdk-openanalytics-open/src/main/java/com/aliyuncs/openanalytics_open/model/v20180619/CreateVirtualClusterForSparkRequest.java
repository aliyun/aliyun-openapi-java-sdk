 ...
 * @version 
 */
public class CreateVirtualClusterForSparkRequest extends RpcAcsRequest<CreateVirtualClusterForSparkResponse> {
	...
	public CreateVirtualClusterForSparkRequest() {
		super("openanalytics-open", "2018-06-19", "CreateVirtualClusterForSpark", "openanalytics");
	...
	@Override
	public Class<CreateVirtualClusterForSparkResponse> getResponseClass() {
		return CreateVirtualClusterForSparkResponse.class;
	}
