 ...
 * @version 
 */
public class RevokePrivilegesRequest extends RpcAcsRequest<RevokePrivilegesResponse> {
	   

	private Struct privilegeBag;
	public RevokePrivilegesRequest() {
		super("openanalytics-open", "2020-09-28", "RevokePrivileges", "openanalytics");
	...
	@Override
	public Class<RevokePrivilegesResponse> getResponseClass() {
		return RevokePrivilegesResponse.class;
	}
