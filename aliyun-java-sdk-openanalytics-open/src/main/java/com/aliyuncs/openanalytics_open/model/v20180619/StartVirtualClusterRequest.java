 ...
 * @version 
 */
public class StartVirtualClusterRequest extends RpcAcsRequest<StartVirtualClusterResponse> {
	...
	@Override
	public Class<StartVirtualClusterResponse> getResponseClass() {
		return StartVirtualClusterResponse.class;
	}
