 ...
 * @version 
 */
public class DestroyVirtualClusterRequest extends RpcAcsRequest<DestroyVirtualClusterResponse> {
	...
	@Override
	public Class<DestroyVirtualClusterResponse> getResponseClass() {
		return DestroyVirtualClusterResponse.class;
	}
