 ...
 * @version 
 */
public class CancelSparkStatementRequest extends RpcAcsRequest<CancelSparkStatementResponse> {
	...
	@Override
	public Class<CancelSparkStatementResponse> getResponseClass() {
		return CancelSparkStatementResponse.class;
	}
