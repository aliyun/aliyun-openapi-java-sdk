 ...
 * @version 
 */
public class GetSparkSessionStateRequest extends RpcAcsRequest<GetSparkSessionStateResponse> {
	...
	@Override
	public Class<GetSparkSessionStateResponse> getResponseClass() {
		return GetSparkSessionStateResponse.class;
	}
