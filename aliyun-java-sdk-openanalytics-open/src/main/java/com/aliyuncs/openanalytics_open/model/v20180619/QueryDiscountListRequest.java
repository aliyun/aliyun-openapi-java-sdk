 ...
 * @version 
 */
public class QueryDiscountListRequest extends RpcAcsRequest<QueryDiscountListResponse> {
	...
	@Override
	public Class<QueryDiscountListResponse> getResponseClass() {
		return QueryDiscountListResponse.class;
	}
