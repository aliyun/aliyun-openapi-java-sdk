 ...
 * @version 
 */
public class GetJobAttemptLogRequest extends RpcAcsRequest<GetJobAttemptLogResponse> {
	...
	public GetJobAttemptLogRequest() {
		super("openanalytics-open", "2018-06-19", "GetJobAttemptLog", "openanalytics");
	...
	public void setJobAttemptId(String jobAttemptId) {
		...
		if(jobAttemptId != null){
			putBodyParameter("JobAttemptId", jobAttemptId);
		}
	}
	...
	@Override
	public Class<GetJobAttemptLogResponse> getResponseClass() {
		return GetJobAttemptLogResponse.class;
	}
