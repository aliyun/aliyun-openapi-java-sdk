 ...
 * @version 
 */
public class GetDLAServiceStatusRequest extends RpcAcsRequest<GetDLAServiceStatusResponse> {
	...
	@Override
	public Class<GetDLAServiceStatusResponse> getResponseClass() {
		return GetDLAServiceStatusResponse.class;
	}
