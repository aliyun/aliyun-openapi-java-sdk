...
import com.aliyuncs.openanalytics_open.model.v20180619.GetRegionStatusResponse;
...
public class GetRegionStatusResponseUnmarshaller {
	...
	public static GetRegionStatusResponse unmarshall(GetRegionStatusResponse getRegionStatusResponse, UnmarshallerContext _ctx) {
		...
		getRegionStatusResponse.setRegionId(_ctx.stringValue("GetRegionStatusResponse.RegionId"));
		getRegionStatusResponse.setStatus(_ctx.stringValue("GetRegionStatusResponse.Status"));
