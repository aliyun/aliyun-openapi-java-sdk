 ...
 * @version 
 */
public class ListJobHistoriesRequest extends RpcAcsRequest<ListJobHistoriesResponse> {
	...
	@Override
	public Class<ListJobHistoriesResponse> getResponseClass() {
		return ListJobHistoriesResponse.class;
	}
