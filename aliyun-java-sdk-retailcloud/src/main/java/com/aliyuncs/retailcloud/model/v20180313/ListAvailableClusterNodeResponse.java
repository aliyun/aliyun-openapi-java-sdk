...
import com.aliyuncs.retailcloud.transform.v20180313.ListAvailableClusterNodeResponseUnmarshaller;
...
public class ListAvailableClusterNodeResponse extends AcsResponse {
	...
	@Override
	public ListAvailableClusterNodeResponse getInstance(UnmarshallerContext context) {
		return	ListAvailableClusterNodeResponseUnmarshaller.unmarshall(this, context);
	}
