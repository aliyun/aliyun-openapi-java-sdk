 ...
 * @version 
 */
public class DeleteAppEnvironmentRequest extends RpcAcsRequest<DeleteAppEnvironmentResponse> {
	...
	@Override
	public Class<DeleteAppEnvironmentResponse> getResponseClass() {
		return DeleteAppEnvironmentResponse.class;
	}
