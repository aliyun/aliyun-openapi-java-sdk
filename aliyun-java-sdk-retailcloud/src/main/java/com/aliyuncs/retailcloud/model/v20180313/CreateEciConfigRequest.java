 ...
 * @version 
 */
public class CreateEciConfigRequest extends RpcAcsRequest<CreateEciConfigResponse> {
	...
	public CreateEciConfigRequest() {
		super("retailcloud", "2018-03-13", "CreateEciConfig");
	...
	@Override
	public Class<CreateEciConfigResponse> getResponseClass() {
		return CreateEciConfigResponse.class;
	}
