 ...
 * @version 
 */
public class DeletePersistentVolumeRequest extends RpcAcsRequest<DeletePersistentVolumeResponse> {
	...
	public void setPersistentVolumeName(String persistentVolumeName) {
		...
		if(persistentVolumeName != null){
			putBodyParameter("PersistentVolumeName", persistentVolumeName);
		}
	}
	...
	@Override
	public Class<DeletePersistentVolumeResponse> getResponseClass() {
		return DeletePersistentVolumeResponse.class;
	}
