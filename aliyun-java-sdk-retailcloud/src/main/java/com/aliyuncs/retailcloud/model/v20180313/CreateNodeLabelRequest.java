 ...
 * @version 
 */
public class CreateNodeLabelRequest extends RpcAcsRequest<CreateNodeLabelResponse> {
	...
	@Override
	public Class<CreateNodeLabelResponse> getResponseClass() {
		return CreateNodeLabelResponse.class;
	}
