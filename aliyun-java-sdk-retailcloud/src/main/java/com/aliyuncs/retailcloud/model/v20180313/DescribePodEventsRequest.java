 ...
 * @version 
 */
public class DescribePodEventsRequest extends RpcAcsRequest<DescribePodEventsResponse> {
	...
	public DescribePodEventsRequest() {
		super("retailcloud", "2018-03-13", "DescribePodEvents", "retailcloud");
	...
	public void setAppInstId(String appInstId) {
		...
		if(appInstId != null){
			putQueryParameter("AppInstId", appInstId);
		}
	}

	@Override
	public Class<DescribePodEventsResponse> getResponseClass() {
		return DescribePodEventsResponse.class;
	}
