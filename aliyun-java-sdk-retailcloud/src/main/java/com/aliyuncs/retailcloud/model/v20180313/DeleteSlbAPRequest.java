 ...
 * @version 
 */
public class DeleteSlbAPRequest extends RpcAcsRequest<DeleteSlbAPResponse> {
	...
	@Override
	public Class<DeleteSlbAPResponse> getResponseClass() {
		return DeleteSlbAPResponse.class;
	}
