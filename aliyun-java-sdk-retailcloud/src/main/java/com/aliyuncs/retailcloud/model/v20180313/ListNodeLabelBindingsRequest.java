 ...
 * @version 
 */
public class ListNodeLabelBindingsRequest extends RpcAcsRequest<ListNodeLabelBindingsResponse> {
	...
	@Override
	public Class<ListNodeLabelBindingsResponse> getResponseClass() {
		return ListNodeLabelBindingsResponse.class;
	}
