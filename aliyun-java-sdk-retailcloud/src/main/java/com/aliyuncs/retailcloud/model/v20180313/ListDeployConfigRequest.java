 ...
 * @version 
 */
public class ListDeployConfigRequest extends RpcAcsRequest<ListDeployConfigResponse> {
	...
	@Override
	public Class<ListDeployConfigResponse> getResponseClass() {
		return ListDeployConfigResponse.class;
	}
