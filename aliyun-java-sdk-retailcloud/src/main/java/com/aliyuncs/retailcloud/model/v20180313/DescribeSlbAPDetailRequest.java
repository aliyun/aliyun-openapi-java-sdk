 ...
 * @version 
 */
public class DescribeSlbAPDetailRequest extends RpcAcsRequest<DescribeSlbAPDetailResponse> {
	...
	@Override
	public Class<DescribeSlbAPDetailResponse> getResponseClass() {
		return DescribeSlbAPDetailResponse.class;
	}
