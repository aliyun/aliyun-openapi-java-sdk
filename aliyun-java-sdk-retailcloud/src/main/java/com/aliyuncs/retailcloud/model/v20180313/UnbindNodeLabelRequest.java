 ...
 * @version 
 */
public class UnbindNodeLabelRequest extends RpcAcsRequest<UnbindNodeLabelResponse> {
	...
	@Override
	public Class<UnbindNodeLabelResponse> getResponseClass() {
		return UnbindNodeLabelResponse.class;
	}
