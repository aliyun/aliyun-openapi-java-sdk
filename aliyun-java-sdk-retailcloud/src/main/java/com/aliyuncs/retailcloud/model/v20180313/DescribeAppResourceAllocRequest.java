 ...
 * @version 
 */
public class DescribeAppResourceAllocRequest extends RpcAcsRequest<DescribeAppResourceAllocResponse> {
	...
	@Override
	public Class<DescribeAppResourceAllocResponse> getResponseClass() {
		return DescribeAppResourceAllocResponse.class;
	}
