 ...
 * @version 
 */
public class CreateAppResourceAllocRequest extends RpcAcsRequest<CreateAppResourceAllocResponse> {
	...
	@Override
	public Class<CreateAppResourceAllocResponse> getResponseClass() {
		return CreateAppResourceAllocResponse.class;
	}
