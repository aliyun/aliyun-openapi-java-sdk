 ...
 * @version 
 */
public class UnbindGroupRequest extends RpcAcsRequest<UnbindGroupResponse> {
	...
	@Override
	public Class<UnbindGroupResponse> getResponseClass() {
		return UnbindGroupResponse.class;
	}
