 ...
 * @version 
 */
public class ListAppEnvironmentRequest extends RpcAcsRequest<ListAppEnvironmentResponse> {
	...
	@Override
	public Class<ListAppEnvironmentResponse> getResponseClass() {
		return ListAppEnvironmentResponse.class;
	}
