 ...
 * @version 
 */
public class BindNodeLabelRequest extends RpcAcsRequest<BindNodeLabelResponse> {
	...
	@Override
	public Class<BindNodeLabelResponse> getResponseClass() {
		return BindNodeLabelResponse.class;
	}
