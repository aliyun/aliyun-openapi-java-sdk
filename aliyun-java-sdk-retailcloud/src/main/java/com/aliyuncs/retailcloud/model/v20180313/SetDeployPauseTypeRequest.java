 ...
 * @version 
 */
public class SetDeployPauseTypeRequest extends RpcAcsRequest<SetDeployPauseTypeResponse> {
	...
	public SetDeployPauseTypeRequest() {
		super("retailcloud", "2018-03-13", "SetDeployPauseType", "retailcloud");
	...
	public void setDeployPauseType(String deployPauseType) {
		...
		if(deployPauseType != null){
			putQueryParameter("DeployPauseType", deployPauseType);
		}
	}
	...
	@Override
	public Class<SetDeployPauseTypeResponse> getResponseClass() {
		return SetDeployPauseTypeResponse.class;
	}
