 ...
 * @version 
 */
public class ListAppResourceAllocsRequest extends RpcAcsRequest<ListAppResourceAllocsResponse> {
	...
	@Override
	public Class<ListAppResourceAllocsResponse> getResponseClass() {
		return ListAppResourceAllocsResponse.class;
	}
