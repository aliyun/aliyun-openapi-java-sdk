 ...
 * @version 
 */
public class DescribeDeployOrderDetailRequest extends RpcAcsRequest<DescribeDeployOrderDetailResponse> {
	...
	@Override
	public Class<DescribeDeployOrderDetailResponse> getResponseClass() {
		return DescribeDeployOrderDetailResponse.class;
	}
