 ...
 * @version 
 */
public class ListAppCmsGroupsRequest extends RpcAcsRequest<ListAppCmsGroupsResponse> {
	...
	@Override
	public Class<ListAppCmsGroupsResponse> getResponseClass() {
		return ListAppCmsGroupsResponse.class;
	}
