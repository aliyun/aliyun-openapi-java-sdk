...
import com.aliyuncs.retailcloud.model.v20180313.CreateClusterResponse.Result;
...
public class CreateClusterResponseUnmarshaller {
	...
	public static CreateClusterResponse unmarshall(CreateClusterResponse createClusterResponse, UnmarshallerContext _ctx) {
		...
		createClusterResponse.setErrMsg(_ctx.stringValue("CreateClusterResponse.ErrMsg"));
		createClusterResponse.setSuccess(_ctx.booleanValue("CreateClusterResponse.Success"));

		Result result = new Result();
		result.setClusterInstanceId(_ctx.stringValue("CreateClusterResponse.Result.ClusterInstanceId"));
