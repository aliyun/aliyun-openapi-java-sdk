...
import com.aliyuncs.retailcloud.model.v20180313.CreateAppResponse.Result;
...
public class CreateAppResponseUnmarshaller {
	...
	public static CreateAppResponse unmarshall(CreateAppResponse createAppResponse, UnmarshallerContext _ctx) {
		...
		createAppResponse.setErrMsg(_ctx.stringValue("CreateAppResponse.ErrMsg"));

		Result result = new Result();
		result.setAppId(_ctx.longValue("CreateAppResponse.Result.AppId"));
