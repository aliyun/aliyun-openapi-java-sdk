...
import com.aliyuncs.retailcloud.model.v20180313.DeleteAppGroupResponse.Result;
...
public class DeleteAppGroupResponseUnmarshaller {
	...
	public static DeleteAppGroupResponse unmarshall(DeleteAppGroupResponse deleteAppGroupResponse, UnmarshallerContext _ctx) {
		...
		deleteAppGroupResponse.setErrMsg(_ctx.stringValue("DeleteAppGroupResponse.ErrMsg"));

		Result result = new Result();
		result.setSuccess(_ctx.booleanValue("DeleteAppGroupResponse.Result.Success"));
