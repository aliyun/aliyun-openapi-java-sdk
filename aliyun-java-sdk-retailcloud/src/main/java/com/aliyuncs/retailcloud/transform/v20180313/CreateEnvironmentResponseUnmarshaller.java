...
import com.aliyuncs.retailcloud.model.v20180313.CreateEnvironmentResponse.Result;
...
public class CreateEnvironmentResponseUnmarshaller {
	...
	public static CreateEnvironmentResponse unmarshall(CreateEnvironmentResponse createEnvironmentResponse, UnmarshallerContext _ctx) {
		...
		createEnvironmentResponse.setErrMsg(_ctx.stringValue("CreateEnvironmentResponse.ErrMsg"));

		Result result = new Result();
		result.setAppEnvId(_ctx.longValue("CreateEnvironmentResponse.Result.AppEnvId"));
