...
import com.aliyuncs.retailcloud.model.v20180313.UpdateEnvironmentResponse.Result;
...
public class UpdateEnvironmentResponseUnmarshaller {
	...
	public static UpdateEnvironmentResponse unmarshall(UpdateEnvironmentResponse updateEnvironmentResponse, UnmarshallerContext _ctx) {
		...
		updateEnvironmentResponse.setErrMsg(_ctx.stringValue("UpdateEnvironmentResponse.ErrMsg"));

		Result result = new Result();
		result.setSuccess(_ctx.booleanValue("UpdateEnvironmentResponse.Result.Success"));
