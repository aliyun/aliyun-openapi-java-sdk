 ...
 * @version 
 */
public class DeleteLogResourceRequest extends RpcAcsRequest<DeleteLogResourceResponse> {
	...
	@Override
	public Class<DeleteLogResourceResponse> getResponseClass() {
		return DeleteLogResourceResponse.class;
	}
