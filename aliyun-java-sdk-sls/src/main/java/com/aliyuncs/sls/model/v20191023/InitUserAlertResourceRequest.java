 ...
 * @version 
 */
public class InitUserAlertResourceRequest extends RpcAcsRequest<InitUserAlertResourceResponse> {
	...
	@Override
	public Class<InitUserAlertResourceResponse> getResponseClass() {
		return InitUserAlertResourceResponse.class;
	}
