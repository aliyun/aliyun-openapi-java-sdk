 ...
 * @version 
 */
public class DeleteIngestionJobRequest extends RpcAcsRequest<DeleteIngestionJobResponse> {
	...
	@Override
	public Class<DeleteIngestionJobResponse> getResponseClass() {
		return DeleteIngestionJobResponse.class;
	}
