 ...
 * @version 
 */
public class CreateImportIngestionJobRequest extends RpcAcsRequest<CreateImportIngestionJobResponse> {
	...
	public CreateImportIngestionJobRequest() {
		super("Sls", "2019-10-23", "CreateImportIngestionJob", "sls");
	...
	@Override
	public Class<CreateImportIngestionJobResponse> getResponseClass() {
		return CreateImportIngestionJobResponse.class;
	}
