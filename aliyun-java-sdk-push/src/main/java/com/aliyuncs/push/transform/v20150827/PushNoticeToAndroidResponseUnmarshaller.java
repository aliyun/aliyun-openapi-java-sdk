...
public class PushNoticeToAndroidResponseUnmarshaller {
	...
	public static PushNoticeToAndroidResponse unmarshall(PushNoticeToAndroidResponse pushNoticeToAndroidResponse, UnmarshallerContext context) {
		...
		pushNoticeToAndroidResponse.setResponseId(context.stringValue("PushNoticeToAndroidResponse.ResponseId"));
		pushNoticeToAndroidResponse.setMessage(context.stringValue("PushNoticeToAndroidResponse.Message"));
