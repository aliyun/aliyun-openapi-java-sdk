...
public class PushNoticeToiOSResponseUnmarshaller {
	...
	public static PushNoticeToiOSResponse unmarshall(PushNoticeToiOSResponse pushNoticeToiOSResponse, UnmarshallerContext context) {
		...
		pushNoticeToiOSResponse.setResponseId(context.stringValue("PushNoticeToiOSResponse.ResponseId"));
		pushNoticeToiOSResponse.setMessage(context.stringValue("PushNoticeToiOSResponse.Message"));
