...
public class PushMessageToiOSResponseUnmarshaller {
	...
	public static PushMessageToiOSResponse unmarshall(PushMessageToiOSResponse pushMessageToiOSResponse, UnmarshallerContext context) {
		...
		pushMessageToiOSResponse.setResponseId(context.stringValue("PushMessageToiOSResponse.ResponseId"));
		pushMessageToiOSResponse.setMessage(context.stringValue("PushMessageToiOSResponse.Message"));
