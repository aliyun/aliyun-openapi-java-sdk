...
public class ModifySnapshotAttributeRequest extends RpcAcsRequest<ModifySnapshotAttributeResponse> {
	...
	public ModifySnapshotAttributeRequest() {
		super("Ens", "2017-11-10", "ModifySnapshotAttribute", "ens");
	...
	@Override
	public Class<ModifySnapshotAttributeResponse> getResponseClass() {
		return ModifySnapshotAttributeResponse.class;
	}
