 ...
 * @version 
 */
public class AccosicateNetworkAclRequest extends RpcAcsRequest<AccosicateNetworkAclResponse> {
	   

	private String networkAclId;

	private List<Resource> resource;
	public AccosicateNetworkAclRequest() {
		super("Ens", "2017-11-10", "AccosicateNetworkAcl", "ens");
	...
	@Override
	public Class<AccosicateNetworkAclResponse> getResponseClass() {
		return AccosicateNetworkAclResponse.class;
	}
