...
import com.aliyuncs.ens.transform.v20171110.GetBucketInfoResponseUnmarshaller;
 ...
 * @version 
 */
public class GetBucketInfoResponse extends AcsResponse {
	...
	@Override
	public GetBucketInfoResponse getInstance(UnmarshallerContext context) {
		return	GetBucketInfoResponseUnmarshaller.unmarshall(this, context);
	}
