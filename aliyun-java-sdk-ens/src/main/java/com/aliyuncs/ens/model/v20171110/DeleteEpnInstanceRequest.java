 ...
 * @version 
 */
public class DeleteEpnInstanceRequest extends RpcAcsRequest<DeleteEpnInstanceResponse> {
	...
	@Override
	public Class<DeleteEpnInstanceResponse> getResponseClass() {
		return DeleteEpnInstanceResponse.class;
	}
