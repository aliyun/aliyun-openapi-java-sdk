 ...
 * @version 
 */
public class JoinPublicIpsToEpnInstanceRequest extends RpcAcsRequest<JoinPublicIpsToEpnInstanceResponse> {
	...
	@Override
	public Class<JoinPublicIpsToEpnInstanceResponse> getResponseClass() {
		return JoinPublicIpsToEpnInstanceResponse.class;
	}
