...
import com.aliyuncs.ens.transform.v20171110.DescribeEnsNetDistrictResponseUnmarshaller;
...
public class DescribeEnsNetDistrictResponse extends AcsResponse {
	...
	@Override
	public DescribeEnsNetDistrictResponse getInstance(UnmarshallerContext context) {
		return	DescribeEnsNetDistrictResponseUnmarshaller.unmarshall(this, context);
	}
}
