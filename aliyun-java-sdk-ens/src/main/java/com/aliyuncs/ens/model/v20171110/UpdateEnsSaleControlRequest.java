 ...
 * @version 
 */
public class UpdateEnsSaleControlRequest extends RpcAcsRequest<UpdateEnsSaleControlResponse> {
	...
	public UpdateEnsSaleControlRequest() {
		super("Ens", "2017-11-10", "UpdateEnsSaleControl", "ens");
	...
	@Override
	public Class<UpdateEnsSaleControlResponse> getResponseClass() {
		return UpdateEnsSaleControlResponse.class;
	}
