 ...
 * @version 
 */
public class ModifyEpnInstanceRequest extends RpcAcsRequest<ModifyEpnInstanceResponse> {
	...
	@Override
	public Class<ModifyEpnInstanceResponse> getResponseClass() {
		return ModifyEpnInstanceResponse.class;
	}
