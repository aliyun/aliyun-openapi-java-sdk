...
import com.aliyuncs.ens.transform.v20171110.DescribeExportImageStatusResponseUnmarshaller;
...
public class DescribeExportImageStatusResponse extends AcsResponse {
	...
	@Override
	public DescribeExportImageStatusResponse getInstance(UnmarshallerContext context) {
		return	DescribeExportImageStatusResponseUnmarshaller.unmarshall(this, context);
	}
}
