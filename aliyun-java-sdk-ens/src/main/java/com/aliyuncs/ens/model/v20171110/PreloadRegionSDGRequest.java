 ...
 * @version 
 */
public class PreloadRegionSDGRequest extends RpcAcsRequest<PreloadRegionSDGResponse> {
	...
	public PreloadRegionSDGRequest() {
		super("Ens", "2017-11-10", "PreloadRegionSDG", "ens");
	...
	public void setRedundantNum(Integer redundantNum) {
		...
		if(redundantNum != null){
			putQueryParameter("RedundantNum", redundantNum.toString());
		}
	}
	...
	@Override
	public Class<PreloadRegionSDGResponse> getResponseClass() {
		return PreloadRegionSDGResponse.class;
	}
