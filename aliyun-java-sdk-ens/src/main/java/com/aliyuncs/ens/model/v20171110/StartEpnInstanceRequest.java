 ...
 * @version 
 */
public class StartEpnInstanceRequest extends RpcAcsRequest<StartEpnInstanceResponse> {
	...
	@Override
	public Class<StartEpnInstanceResponse> getResponseClass() {
		return StartEpnInstanceResponse.class;
	}
