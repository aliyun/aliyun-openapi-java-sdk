...
import com.aliyuncs.ens.transform.v20171110.DescribeBandWithdChargeTypeResponseUnmarshaller;
...
public class DescribeBandWithdChargeTypeResponse extends AcsResponse {
	...
	@Override
	public DescribeBandWithdChargeTypeResponse getInstance(UnmarshallerContext context) {
		return	DescribeBandWithdChargeTypeResponseUnmarshaller.unmarshall(this, context);
	}
}
