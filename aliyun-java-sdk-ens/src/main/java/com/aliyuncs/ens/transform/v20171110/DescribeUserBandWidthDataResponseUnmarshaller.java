...
public class DescribeUserBandWidthDataResponseUnmarshaller {
	...
	public static DescribeUserBandWidthDataResponse unmarshall(DescribeUserBandWidthDataResponse describeUserBandWidthDataResponse, UnmarshallerContext _ctx) {
		...
		for (int i = 0; i < _ctx.lengthValue("DescribeUserBandWidthDataResponse.MonitorData.BandWidthMonitorData.Length"); i++) {
			...
			bandWidthMonitorDataItem.setDownBandWidth(_ctx.longValue("DescribeUserBandWidthDataResponse.MonitorData.BandWidthMonitorData["+ i +"].DownBandWidth"));
			bandWidthMonitorDataItem.setInternetRX(_ctx.longValue("DescribeUserBandWidthDataResponse.MonitorData.BandWidthMonitorData["+ i +"].InternetRX"));
			bandWidthMonitorDataItem.setInternetTX(_ctx.longValue("DescribeUserBandWidthDataResponse.MonitorData.BandWidthMonitorData["+ i +"].InternetTX"));
			...
			bandWidthMonitorDataItem.setUpBandWidth(_ctx.longValue("DescribeUserBandWidthDataResponse.MonitorData.BandWidthMonitorData["+ i +"].UpBandWidth"));
