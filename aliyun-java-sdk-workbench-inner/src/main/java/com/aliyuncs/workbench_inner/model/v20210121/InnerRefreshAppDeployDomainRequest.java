 ...
 * @version 
 */
public class InnerRefreshAppDeployDomainRequest extends RpcAcsRequest<InnerRefreshAppDeployDomainResponse> {
	...
	public InnerRefreshAppDeployDomainRequest() {
		super("Workbench-inner", "2021-01-21", "InnerRefreshAppDeployDomain");
	...
	@Override
	public Class<InnerRefreshAppDeployDomainResponse> getResponseClass() {
		return InnerRefreshAppDeployDomainResponse.class;
	}
