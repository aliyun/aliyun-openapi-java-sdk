 ...
 * @version 
 */
public class InnerStopAppRequest extends RpcAcsRequest<InnerStopAppResponse> {
	...
	public InnerStopAppRequest() {
		super("Workbench-inner", "2021-01-21", "InnerStopApp");
	...
	@Override
	public Class<InnerStopAppResponse> getResponseClass() {
		return InnerStopAppResponse.class;
	}
