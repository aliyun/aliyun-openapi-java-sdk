 ...
 * @version 
 */
public class InnerGetAppDeployDomainRequest extends RpcAcsRequest<InnerGetAppDeployDomainResponse> {
	...
	public InnerGetAppDeployDomainRequest() {
		super("Workbench-inner", "2021-01-21", "InnerGetAppDeployDomain");
	...
	@Override
	public Class<InnerGetAppDeployDomainResponse> getResponseClass() {
		return InnerGetAppDeployDomainResponse.class;
	}
