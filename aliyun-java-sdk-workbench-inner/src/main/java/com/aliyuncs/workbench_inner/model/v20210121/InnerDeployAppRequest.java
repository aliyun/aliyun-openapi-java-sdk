 ...
 * @version 
 */
public class InnerDeployAppRequest extends RpcAcsRequest<InnerDeployAppResponse> {
	...
	public InnerDeployAppRequest() {
		super("Workbench-inner", "2021-01-21", "InnerDeployApp");
	...
	@Override
	public Class<InnerDeployAppResponse> getResponseClass() {
		return InnerDeployAppResponse.class;
	}
