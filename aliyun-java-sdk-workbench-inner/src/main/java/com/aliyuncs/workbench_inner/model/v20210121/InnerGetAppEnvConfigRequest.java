 ...
 * @version 
 */
public class InnerGetAppEnvConfigRequest extends RpcAcsRequest<InnerGetAppEnvConfigResponse> {
	...
	public InnerGetAppEnvConfigRequest() {
		super("Workbench-inner", "2021-01-21", "InnerGetAppEnvConfig");
	...
	@Override
	public Class<InnerGetAppEnvConfigResponse> getResponseClass() {
		return InnerGetAppEnvConfigResponse.class;
	}
