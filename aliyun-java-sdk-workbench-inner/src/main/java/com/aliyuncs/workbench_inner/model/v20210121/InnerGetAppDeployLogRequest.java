 ...
 * @version 
 */
public class InnerGetAppDeployLogRequest extends RpcAcsRequest<InnerGetAppDeployLogResponse> {
	...
	public InnerGetAppDeployLogRequest() {
		super("Workbench-inner", "2021-01-21", "InnerGetAppDeployLog");
	...
	@Override
	public Class<InnerGetAppDeployLogResponse> getResponseClass() {
		return InnerGetAppDeployLogResponse.class;
	}
