 ...
 * @version 
 */
public class InnerSetSolutionRepoRequest extends RpcAcsRequest<InnerSetSolutionRepoResponse> {
	...
	public InnerSetSolutionRepoRequest() {
		super("Workbench-inner", "2021-01-21", "InnerSetSolutionRepo");
	...
	@Override
	public Class<InnerSetSolutionRepoResponse> getResponseClass() {
		return InnerSetSolutionRepoResponse.class;
	}
