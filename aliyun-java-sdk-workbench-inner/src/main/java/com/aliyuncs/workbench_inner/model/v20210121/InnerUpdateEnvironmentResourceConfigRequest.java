 ...
 * @version 
 */
public class InnerUpdateEnvironmentResourceConfigRequest extends RpcAcsRequest<InnerUpdateEnvironmentResourceConfigResponse> {
	...
	public InnerUpdateEnvironmentResourceConfigRequest() {
		super("Workbench-inner", "2021-01-21", "InnerUpdateEnvironmentResourceConfig");
	...
	@Override
	public Class<InnerUpdateEnvironmentResourceConfigResponse> getResponseClass() {
		return InnerUpdateEnvironmentResourceConfigResponse.class;
	}
