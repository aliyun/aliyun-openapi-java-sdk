 ...
 * @version 
 */
public class InnerGetAppDeployRequest extends RpcAcsRequest<InnerGetAppDeployResponse> {
	...
	public InnerGetAppDeployRequest() {
		super("Workbench-inner", "2021-01-21", "InnerGetAppDeploy");
	...
	@Override
	public Class<InnerGetAppDeployResponse> getResponseClass() {
		return InnerGetAppDeployResponse.class;
	}
