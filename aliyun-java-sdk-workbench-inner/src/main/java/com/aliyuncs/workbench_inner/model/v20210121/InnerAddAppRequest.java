 ...
 * @version 
 */
public class InnerAddAppRequest extends RpcAcsRequest<InnerAddAppResponse> {
	...
	public InnerAddAppRequest() {
		super("Workbench-inner", "2021-01-21", "InnerAddApp");
	...
	@Override
	public Class<InnerAddAppResponse> getResponseClass() {
		return InnerAddAppResponse.class;
	}
