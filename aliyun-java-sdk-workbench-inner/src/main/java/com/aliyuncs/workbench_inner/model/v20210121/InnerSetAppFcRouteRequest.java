 ...
 * @version 
 */
public class InnerSetAppFcRouteRequest extends RpcAcsRequest<InnerSetAppFcRouteResponse> {
	...
	public InnerSetAppFcRouteRequest() {
		super("Workbench-inner", "2021-01-21", "InnerSetAppFcRoute");
	...
	@Override
	public Class<InnerSetAppFcRouteResponse> getResponseClass() {
		return InnerSetAppFcRouteResponse.class;
	}
