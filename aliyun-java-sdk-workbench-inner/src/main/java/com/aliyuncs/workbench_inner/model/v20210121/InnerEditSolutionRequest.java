 ...
 * @version 
 */
public class InnerEditSolutionRequest extends RpcAcsRequest<InnerEditSolutionResponse> {
	...
	public InnerEditSolutionRequest() {
		super("Workbench-inner", "2021-01-21", "InnerEditSolution");
	...
	@Override
	public Class<InnerEditSolutionResponse> getResponseClass() {
		return InnerEditSolutionResponse.class;
	}
