 ...
 * @version 
 */
public class InnerSetAppEnvConfigRequest extends RpcAcsRequest<InnerSetAppEnvConfigResponse> {
	...
	public InnerSetAppEnvConfigRequest() {
		super("Workbench-inner", "2021-01-21", "InnerSetAppEnvConfig");
	...
	@Override
	public Class<InnerSetAppEnvConfigResponse> getResponseClass() {
		return InnerSetAppEnvConfigResponse.class;
	}
