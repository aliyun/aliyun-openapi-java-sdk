 ...
 * @version 
 */
public class InnerGetAppGlobalConfigRequest extends RpcAcsRequest<InnerGetAppGlobalConfigResponse> {
	...
	public InnerGetAppGlobalConfigRequest() {
		super("Workbench-inner", "2021-01-21", "InnerGetAppGlobalConfig");
	...
	@Override
	public Class<InnerGetAppGlobalConfigResponse> getResponseClass() {
		return InnerGetAppGlobalConfigResponse.class;
	}
