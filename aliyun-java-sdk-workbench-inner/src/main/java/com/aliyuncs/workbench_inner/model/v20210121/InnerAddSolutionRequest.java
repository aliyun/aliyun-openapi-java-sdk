 ...
 * @version 
 */
public class InnerAddSolutionRequest extends RpcAcsRequest<InnerAddSolutionResponse> {
	...
	public InnerAddSolutionRequest() {
		super("Workbench-inner", "2021-01-21", "InnerAddSolution");
	...
	@Override
	public Class<InnerAddSolutionResponse> getResponseClass() {
		return InnerAddSolutionResponse.class;
	}
