 ...
 * @version 
 */
public class SelectRequest extends RpcAcsRequest<SelectResponse> {
	...
	public SelectRequest() {
		super("rds-data", "2022-03-30", "Select");
	...
	@Override
	public Class<SelectResponse> getResponseClass() {
		return SelectResponse.class;
	}
