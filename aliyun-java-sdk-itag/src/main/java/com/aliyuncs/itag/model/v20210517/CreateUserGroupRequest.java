 ...
 * @version 
 */
public class CreateUserGroupRequest extends RoaAcsRequest<CreateUserGroupResponse> {
	   

	private String body;
	public CreateUserGroupRequest() {
		super("Itag", "2021-05-17", "CreateUserGroup");
		setUriPattern("/mng/api/v1/usergroup/createUserGroup");
