...
import com.aliyuncs.itag.transform.v20210517.FetchVideoMarkResultResponseUnmarshaller;
 ...
 * @version 
 */
public class FetchVideoMarkResultResponse extends AcsResponse {
	...
	@Override
	public FetchVideoMarkResultResponse getInstance(UnmarshallerContext context) {
		return	FetchVideoMarkResultResponseUnmarshaller.unmarshall(this, context);
	}
