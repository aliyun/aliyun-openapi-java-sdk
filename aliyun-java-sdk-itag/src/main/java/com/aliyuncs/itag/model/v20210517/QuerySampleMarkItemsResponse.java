...
import com.aliyuncs.itag.transform.v20210517.QuerySampleMarkItemsResponseUnmarshaller;
 ...
 * @version 
 */
public class QuerySampleMarkItemsResponse extends AcsResponse {
	...
	@Override
	public QuerySampleMarkItemsResponse getInstance(UnmarshallerContext context) {
		return	QuerySampleMarkItemsResponseUnmarshaller.unmarshall(this, context);
	}
