...
import com.aliyuncs.itag.transform.v20210517.GetCheckUserEfficiencyResponseUnmarshaller;
 ...
 * @version 
 */
public class GetCheckUserEfficiencyResponse extends AcsResponse {
	...
	public static class Result {
		...
		private List<ITagBaseReportResponse> userWorkEfficiencyList;

		public List<ITagBaseReportResponse> getUserWorkEfficiencyList() {
			return this.userWorkEfficiencyList;
		}

		public void setUserWorkEfficiencyList(List<ITagBaseReportResponse> userWorkEfficiencyList) {
			this.userWorkEfficiencyList = userWorkEfficiencyList;
		}
	...
	@Override
	public GetCheckUserEfficiencyResponse getInstance(UnmarshallerContext context) {
		return	GetCheckUserEfficiencyResponseUnmarshaller.unmarshall(this, context);
	}
