...
import com.aliyuncs.itag.transform.v20210517.PreviewTaskTemplateResponseUnmarshaller;
 ...
 * @version 
 */
public class PreviewTaskTemplateResponse extends AcsResponse {
	...
	@Override
	public PreviewTaskTemplateResponse getInstance(UnmarshallerContext context) {
		return	PreviewTaskTemplateResponseUnmarshaller.unmarshall(this, context);
	}
