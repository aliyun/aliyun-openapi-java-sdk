...
import com.aliyuncs.itag.transform.v20210517.GetBizSummaryResponseUnmarshaller;
 ...
 * @version 
 */
public class GetBizSummaryResponse extends AcsResponse {
	...
	@Override
	public GetBizSummaryResponse getInstance(UnmarshallerContext context) {
		return	GetBizSummaryResponseUnmarshaller.unmarshall(this, context);
	}
