...
import com.aliyuncs.itag.transform.v20210517.GetGroupTaskPersonDetailResponseUnmarshaller;
 ...
 * @version 
 */
public class GetGroupTaskPersonDetailResponse extends AcsResponse {
	...
	@Override
	public GetGroupTaskPersonDetailResponse getInstance(UnmarshallerContext context) {
		return	GetGroupTaskPersonDetailResponseUnmarshaller.unmarshall(this, context);
	}
