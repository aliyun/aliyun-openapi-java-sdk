...
import com.aliyuncs.itag.transform.v20210517.QuerySamplingPoolSizeResponseUnmarshaller;
 ...
 * @version 
 */
public class QuerySamplingPoolSizeResponse extends AcsResponse {
	...
	@Override
	public QuerySamplingPoolSizeResponse getInstance(UnmarshallerContext context) {
		return	QuerySamplingPoolSizeResponseUnmarshaller.unmarshall(this, context);
	}
