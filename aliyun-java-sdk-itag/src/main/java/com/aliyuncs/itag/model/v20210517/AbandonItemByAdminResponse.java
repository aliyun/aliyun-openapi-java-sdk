...
import com.aliyuncs.itag.transform.v20210517.AbandonItemByAdminResponseUnmarshaller;
 ...
 * @version 
 */
public class AbandonItemByAdminResponse extends AcsResponse {
	...
	@Override
	public AbandonItemByAdminResponse getInstance(UnmarshallerContext context) {
		return	AbandonItemByAdminResponseUnmarshaller.unmarshall(this, context);
	}
