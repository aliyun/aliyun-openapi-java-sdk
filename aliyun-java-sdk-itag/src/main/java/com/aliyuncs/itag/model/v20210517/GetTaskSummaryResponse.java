...
import com.aliyuncs.itag.transform.v20210517.GetTaskSummaryResponseUnmarshaller;
 ...
 * @version 
 */
public class GetTaskSummaryResponse extends AcsResponse {
	...
	@Override
	public GetTaskSummaryResponse getInstance(UnmarshallerContext context) {
		return	GetTaskSummaryResponseUnmarshaller.unmarshall(this, context);
	}
