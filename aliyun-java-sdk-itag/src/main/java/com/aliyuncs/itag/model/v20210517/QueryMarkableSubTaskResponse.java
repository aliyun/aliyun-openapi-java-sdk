...
import com.aliyuncs.itag.transform.v20210517.QueryMarkableSubTaskResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryMarkableSubTaskResponse extends AcsResponse {
	...
	public static class Result {
		...
		private List<MarkItemListItem> markItemList;
		...
		public List<MarkItemListItem> getMarkItemList() {
			return this.markItemList;
		}

		public void setMarkItemList(List<MarkItemListItem> markItemList) {
		...
		public static class MarkItemListItem {
	...
	@Override
	public QueryMarkableSubTaskResponse getInstance(UnmarshallerContext context) {
		return	QueryMarkableSubTaskResponseUnmarshaller.unmarshall(this, context);
	}
