...
import com.aliyuncs.itag.transform.v20210517.GetCheckUserSummaryResponseUnmarshaller;
 ...
 * @version 
 */
public class GetCheckUserSummaryResponse extends AcsResponse {
	...
	public static class Result {
		...
		private List<ITagDailyWorkload> dailyWorkload;

		private List<ITagUserProportion> userProportion;

		private List<ITagSimpleUserVO> userList;
		...
		public List<ITagDailyWorkload> getDailyWorkload() {
			return this.dailyWorkload;
		}

		public void setDailyWorkload(List<ITagDailyWorkload> dailyWorkload) {
			this.dailyWorkload = dailyWorkload;
		}

		public List<ITagUserProportion> getUserProportion() {
			return this.userProportion;
		}

		public void setUserProportion(List<ITagUserProportion> userProportion) {
			this.userProportion = userProportion;
		}

		public List<ITagSimpleUserVO> getUserList() {
			return this.userList;
		}

		public void setUserList(List<ITagSimpleUserVO> userList) {
			this.userList = userList;
		}

		public static class ITagDailyWorkload {
		...
		public static class ITagUserProportion {
	...
	@Override
	public GetCheckUserSummaryResponse getInstance(UnmarshallerContext context) {
		return	GetCheckUserSummaryResponseUnmarshaller.unmarshall(this, context);
	}
