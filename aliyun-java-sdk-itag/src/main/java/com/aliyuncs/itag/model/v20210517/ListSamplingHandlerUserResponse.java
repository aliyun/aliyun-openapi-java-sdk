...
import com.aliyuncs.itag.transform.v20210517.ListSamplingHandlerUserResponseUnmarshaller;
 ...
 * @version 
 */
public class ListSamplingHandlerUserResponse extends AcsResponse {
	...
	@Override
	public ListSamplingHandlerUserResponse getInstance(UnmarshallerContext context) {
		return	ListSamplingHandlerUserResponseUnmarshaller.unmarshall(this, context);
	}
