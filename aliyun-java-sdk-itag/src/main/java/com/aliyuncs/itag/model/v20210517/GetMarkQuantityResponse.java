...
import com.aliyuncs.itag.transform.v20210517.GetMarkQuantityResponseUnmarshaller;
 ...
 * @version 
 */
public class GetMarkQuantityResponse extends AcsResponse {
	...
	@Override
	public GetMarkQuantityResponse getInstance(UnmarshallerContext context) {
		return	GetMarkQuantityResponseUnmarshaller.unmarshall(this, context);
	}
