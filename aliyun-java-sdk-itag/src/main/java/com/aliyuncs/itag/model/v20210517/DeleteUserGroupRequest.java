 ...
 * @version 
 */
public class DeleteUserGroupRequest extends RoaAcsRequest<DeleteUserGroupResponse> {
	   

	private String body;
	public DeleteUserGroupRequest() {
		super("Itag", "2021-05-17", "DeleteUserGroup");
		setUriPattern("/mng/api/v1/usergroup/deleteUserGroup");
