...
import com.aliyuncs.itag.transform.v20210517.GetSubTaskDownloadUserResultResponseUnmarshaller;
 ...
 * @version 
 */
public class GetSubTaskDownloadUserResultResponse extends AcsResponse {
	...
	@Override
	public GetSubTaskDownloadUserResultResponse getInstance(UnmarshallerContext context) {
		return	GetSubTaskDownloadUserResultResponseUnmarshaller.unmarshall(this, context);
	}
