...
import com.aliyuncs.itag.transform.v20210517.RemoveUserInTntResponseUnmarshaller;
 ...
 * @version 
 */
public class RemoveUserInTntResponse extends AcsResponse {
	...
	@Override
	public RemoveUserInTntResponse getInstance(UnmarshallerContext context) {
		return	RemoveUserInTntResponseUnmarshaller.unmarshall(this, context);
	}
