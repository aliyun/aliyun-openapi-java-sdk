...
import com.aliyuncs.itag.transform.v20210517.GetIntWholeSummaryResponseUnmarshaller;
 ...
 * @version 
 */
public class GetIntWholeSummaryResponse extends AcsResponse {
	...
	@Override
	public GetIntWholeSummaryResponse getInstance(UnmarshallerContext context) {
		return	GetIntWholeSummaryResponseUnmarshaller.unmarshall(this, context);
	}
