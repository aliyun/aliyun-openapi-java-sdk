...
import com.aliyuncs.itag.transform.v20210517.SkipFinishedResponseUnmarshaller;
 ...
 * @version 
 */
public class SkipFinishedResponse extends AcsResponse {
	...
	@Override
	public SkipFinishedResponse getInstance(UnmarshallerContext context) {
		return	SkipFinishedResponseUnmarshaller.unmarshall(this, context);
	}
