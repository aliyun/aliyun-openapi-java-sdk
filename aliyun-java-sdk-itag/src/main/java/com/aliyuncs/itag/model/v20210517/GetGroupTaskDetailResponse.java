...
import com.aliyuncs.itag.transform.v20210517.GetGroupTaskDetailResponseUnmarshaller;
 ...
 * @version 
 */
public class GetGroupTaskDetailResponse extends AcsResponse {
	...
	@Override
	public GetGroupTaskDetailResponse getInstance(UnmarshallerContext context) {
		return	GetGroupTaskDetailResponseUnmarshaller.unmarshall(this, context);
	}
