...
import com.aliyuncs.itag.transform.v20210517.GetPersonSummaryResponseUnmarshaller;
 ...
 * @version 
 */
public class GetPersonSummaryResponse extends AcsResponse {
	...
	@Override
	public GetPersonSummaryResponse getInstance(UnmarshallerContext context) {
		return	GetPersonSummaryResponseUnmarshaller.unmarshall(this, context);
	}
