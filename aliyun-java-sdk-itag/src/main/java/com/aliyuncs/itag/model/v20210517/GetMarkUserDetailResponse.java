...
import com.aliyuncs.itag.transform.v20210517.GetMarkUserDetailResponseUnmarshaller;
 ...
 * @version 
 */
public class GetMarkUserDetailResponse extends AcsResponse {
	...
	@Override
	public GetMarkUserDetailResponse getInstance(UnmarshallerContext context) {
		return	GetMarkUserDetailResponseUnmarshaller.unmarshall(this, context);
	}
