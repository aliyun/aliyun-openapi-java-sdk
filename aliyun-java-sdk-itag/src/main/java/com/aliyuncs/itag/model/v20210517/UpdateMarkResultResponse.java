...
import com.aliyuncs.itag.transform.v20210517.UpdateMarkResultResponseUnmarshaller;
 ...
 * @version 
 */
public class UpdateMarkResultResponse extends AcsResponse {
	...
	@Override
	public UpdateMarkResultResponse getInstance(UnmarshallerContext context) {
		return	UpdateMarkResultResponseUnmarshaller.unmarshall(this, context);
	}
