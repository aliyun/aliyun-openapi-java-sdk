...
import com.aliyuncs.itag.transform.v20210517.GetBizPersonSummaryResponseUnmarshaller;
 ...
 * @version 
 */
public class GetBizPersonSummaryResponse extends AcsResponse {
	...
	@Override
	public GetBizPersonSummaryResponse getInstance(UnmarshallerContext context) {
		return	GetBizPersonSummaryResponseUnmarshaller.unmarshall(this, context);
	}
