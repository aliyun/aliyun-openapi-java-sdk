...
import com.aliyuncs.itag.transform.v20210517.RemoveUserInGroupResponseUnmarshaller;
 ...
 * @version 
 */
public class RemoveUserInGroupResponse extends AcsResponse {
	...
	@Override
	public RemoveUserInGroupResponse getInstance(UnmarshallerContext context) {
		return	RemoveUserInGroupResponseUnmarshaller.unmarshall(this, context);
	}
