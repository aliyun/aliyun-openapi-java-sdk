...
import com.aliyuncs.itag.transform.v20210517.GetMarkUserEfficiencyResponseUnmarshaller;
 ...
 * @version 
 */
public class GetMarkUserEfficiencyResponse extends AcsResponse {
	...
	@Override
	public GetMarkUserEfficiencyResponse getInstance(UnmarshallerContext context) {
		return	GetMarkUserEfficiencyResponseUnmarshaller.unmarshall(this, context);
	}
