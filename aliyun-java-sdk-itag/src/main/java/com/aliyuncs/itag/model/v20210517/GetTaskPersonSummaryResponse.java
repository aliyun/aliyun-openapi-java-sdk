...
import com.aliyuncs.itag.transform.v20210517.GetTaskPersonSummaryResponseUnmarshaller;
 ...
 * @version 
 */
public class GetTaskPersonSummaryResponse extends AcsResponse {
	...
	@Override
	public GetTaskPersonSummaryResponse getInstance(UnmarshallerContext context) {
		return	GetTaskPersonSummaryResponseUnmarshaller.unmarshall(this, context);
	}
