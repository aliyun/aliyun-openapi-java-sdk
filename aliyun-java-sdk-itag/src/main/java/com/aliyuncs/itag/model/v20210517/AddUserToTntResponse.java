...
import com.aliyuncs.itag.transform.v20210517.AddUserToTntResponseUnmarshaller;
 ...
 * @version 
 */
public class AddUserToTntResponse extends AcsResponse {
	...
	@Override
	public AddUserToTntResponse getInstance(UnmarshallerContext context) {
		return	AddUserToTntResponseUnmarshaller.unmarshall(this, context);
	}
