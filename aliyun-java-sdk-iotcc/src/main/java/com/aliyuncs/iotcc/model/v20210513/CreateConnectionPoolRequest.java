 ...
 * @version 
 */
public class CreateConnectionPoolRequest extends RpcAcsRequest<CreateConnectionPoolResponse> {
	...
	@Override
	public Class<CreateConnectionPoolResponse> getResponseClass() {
		return CreateConnectionPoolResponse.class;
	}
