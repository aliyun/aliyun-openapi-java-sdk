 ...
 * @version 
 */
public class DeleteDNSServiceRuleRequest extends RpcAcsRequest<DeleteDNSServiceRuleResponse> {
	...
	public DeleteDNSServiceRuleRequest() {
		super("IoTCC", "2021-05-13", "DeleteDNSServiceRule", "IoTCC");
	...
	@Override
	public Class<DeleteDNSServiceRuleResponse> getResponseClass() {
		return DeleteDNSServiceRuleResponse.class;
	}
