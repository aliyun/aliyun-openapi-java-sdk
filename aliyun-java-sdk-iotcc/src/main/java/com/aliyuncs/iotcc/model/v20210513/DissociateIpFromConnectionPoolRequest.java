 ...
 * @version 
 */
public class DissociateIpFromConnectionPoolRequest extends RpcAcsRequest<DissociateIpFromConnectionPoolResponse> {
	...
	public DissociateIpFromConnectionPoolRequest() {
		super("IoTCC", "2021-05-13", "DissociateIpFromConnectionPool", "IoTCC");
	...
	@Override
	public Class<DissociateIpFromConnectionPoolResponse> getResponseClass() {
		return DissociateIpFromConnectionPoolResponse.class;
	}
