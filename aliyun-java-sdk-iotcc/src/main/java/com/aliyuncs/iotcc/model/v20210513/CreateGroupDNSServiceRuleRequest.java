 ...
 * @version 
 */
public class CreateGroupDNSServiceRuleRequest extends RpcAcsRequest<CreateGroupDNSServiceRuleResponse> {
	...
	public CreateGroupDNSServiceRuleRequest() {
		super("IoTCC", "2021-05-13", "CreateGroupDNSServiceRule", "IoTCC");
	...
	@Override
	public Class<CreateGroupDNSServiceRuleResponse> getResponseClass() {
		return CreateGroupDNSServiceRuleResponse.class;
	}
