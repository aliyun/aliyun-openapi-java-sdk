 ...
 * @version 
 */
public class ListIpMappingRulesRequest extends RpcAcsRequest<ListIpMappingRulesResponse> {
	...
	public ListIpMappingRulesRequest() {
		super("IoTCC", "2021-05-13", "ListIpMappingRules", "IoTCC");
	...
	@Override
	public Class<ListIpMappingRulesResponse> getResponseClass() {
		return ListIpMappingRulesResponse.class;
	}
