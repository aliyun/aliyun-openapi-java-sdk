 ...
 * @version 
 */
public class UpdateAuthorizationRuleAttributeRequest extends RpcAcsRequest<UpdateAuthorizationRuleAttributeResponse> {
	...
	@Override
	public Class<UpdateAuthorizationRuleAttributeResponse> getResponseClass() {
		return UpdateAuthorizationRuleAttributeResponse.class;
	}
