 ...
 * @version 
 */
public class DeleteConnectionPoolRequest extends RpcAcsRequest<DeleteConnectionPoolResponse> {
	...
	public DeleteConnectionPoolRequest() {
		super("IoTCC", "2021-05-13", "DeleteConnectionPool", "cciot");
	...
	@Override
	public Class<DeleteConnectionPoolResponse> getResponseClass() {
		return DeleteConnectionPoolResponse.class;
	}
