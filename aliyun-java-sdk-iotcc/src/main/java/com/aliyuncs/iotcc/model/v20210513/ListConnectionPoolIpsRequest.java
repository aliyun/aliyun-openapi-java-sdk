 ...
 * @version 
 */
public class ListConnectionPoolIpsRequest extends RpcAcsRequest<ListConnectionPoolIpsResponse> {
	...
	public ListConnectionPoolIpsRequest() {
		super("IoTCC", "2021-05-13", "ListConnectionPoolIps", "IoTCC");
	...
	@Override
	public Class<ListConnectionPoolIpsResponse> getResponseClass() {
		return ListConnectionPoolIpsResponse.class;
	}
