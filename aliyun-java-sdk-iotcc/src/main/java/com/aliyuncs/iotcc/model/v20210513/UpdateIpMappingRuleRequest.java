 ...
 * @version 
 */
public class UpdateIpMappingRuleRequest extends RpcAcsRequest<UpdateIpMappingRuleResponse> {
	...
	public UpdateIpMappingRuleRequest() {
		super("IoTCC", "2021-05-13", "UpdateIpMappingRule", "IoTCC");
	...
	@Override
	public Class<UpdateIpMappingRuleResponse> getResponseClass() {
		return UpdateIpMappingRuleResponse.class;
	}
