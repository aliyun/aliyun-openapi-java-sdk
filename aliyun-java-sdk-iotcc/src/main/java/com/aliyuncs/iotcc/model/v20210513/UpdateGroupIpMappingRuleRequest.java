 ...
 * @version 
 */
public class UpdateGroupIpMappingRuleRequest extends RpcAcsRequest<UpdateGroupIpMappingRuleResponse> {
	...
	public UpdateGroupIpMappingRuleRequest() {
		super("IoTCC", "2021-05-13", "UpdateGroupIpMappingRule", "IoTCC");
	...
	public void setGroupIpMappingRuleId(String groupIpMappingRuleId) {
		this.groupIpMappingRuleId = groupIpMappingRuleId;
		if(groupIpMappingRuleId != null){
			putQueryParameter("GroupIpMappingRuleId", groupIpMappingRuleId);
		}
	}
	...
	@Override
	public Class<UpdateGroupIpMappingRuleResponse> getResponseClass() {
		return UpdateGroupIpMappingRuleResponse.class;
	}
