 ...
 * @version 
 */
public class DeleteServiceEntryRequest extends RpcAcsRequest<DeleteServiceEntryResponse> {
	...
	@Override
	public Class<DeleteServiceEntryResponse> getResponseClass() {
		return DeleteServiceEntryResponse.class;
	}
