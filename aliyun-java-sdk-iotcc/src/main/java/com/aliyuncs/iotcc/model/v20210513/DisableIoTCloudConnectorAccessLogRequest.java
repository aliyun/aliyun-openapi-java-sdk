 ...
 * @version 
 */
public class DisableIoTCloudConnectorAccessLogRequest extends RpcAcsRequest<DisableIoTCloudConnectorAccessLogResponse> {
	...
	@Override
	public Class<DisableIoTCloudConnectorAccessLogResponse> getResponseClass() {
		return DisableIoTCloudConnectorAccessLogResponse.class;
	}
