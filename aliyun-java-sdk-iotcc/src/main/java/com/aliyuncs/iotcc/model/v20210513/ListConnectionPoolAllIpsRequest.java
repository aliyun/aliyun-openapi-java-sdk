 ...
 * @version 
 */
public class ListConnectionPoolAllIpsRequest extends RpcAcsRequest<ListConnectionPoolAllIpsResponse> {
	...
	public ListConnectionPoolAllIpsRequest() {
		super("IoTCC", "2021-05-13", "ListConnectionPoolAllIps", "IoTCC");
	...
	@Override
	public Class<ListConnectionPoolAllIpsResponse> getResponseClass() {
		return ListConnectionPoolAllIpsResponse.class;
	}
