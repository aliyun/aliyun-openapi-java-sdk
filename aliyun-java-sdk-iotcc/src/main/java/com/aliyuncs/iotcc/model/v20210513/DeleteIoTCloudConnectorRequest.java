 ...
 * @version 
 */
public class DeleteIoTCloudConnectorRequest extends RpcAcsRequest<DeleteIoTCloudConnectorResponse> {
	...
	@Override
	public Class<DeleteIoTCloudConnectorResponse> getResponseClass() {
		return DeleteIoTCloudConnectorResponse.class;
	}
