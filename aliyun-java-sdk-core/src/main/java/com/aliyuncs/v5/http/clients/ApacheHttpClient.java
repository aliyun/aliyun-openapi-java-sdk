...
public class ApacheHttpClient extends IHttpClient {
    ...
    @Override
    public final Future<com.aliyuncs.v5.http.HttpResponse> asyncInvoke(final HttpRequest apiRequest,
                                                                       final CallBack callback) {
        return executorService.submit(new Callable<com.aliyuncs.v5.http.HttpResponse>() {
            @Override
            public com.aliyuncs.v5.http.HttpResponse call() throws Exception {
                com.aliyuncs.v5.http.HttpResponse result;
                try {
