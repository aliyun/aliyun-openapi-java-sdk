...
public class ClientExceptionTest {
    ...
    public void errMsgTest() {
        ClientException ex = new ClientException("errCode", "errMsg");
        Assert.assertEquals(com.aliyuncs.v5.exceptions.ErrorType.Client, ex.getErrorType());
        ...
        Assert.assertEquals("com.aliyuncs.v5.exceptions.ClientException: errCode : errMsg\r\n" +
