...
public class DefaultAcsClientTest {
    ...
    @Test
    public void testGetAcsResponse() throws NoSuchFieldException, SecurityException, IllegalArgumentException, IllegalAccessException, ClientException, IOException {
        DefaultProfile profile = DefaultProfile.getProfile("cn-hangzhou", "accessKeyId", "secret");
        DefaultAcsClient client = new DefaultAcsClient(profile);
        ...
        Mockito.doReturn(response).when(compatibleUrlConnClient).syncInvoke(Mockito.any(HttpRequest.class));
        ...
        Assert.assertTrue(client.getAcsResponse(request, profile) instanceof DescribeRegionsResponse);
        Assert.assertTrue(client.getAcsResponse(request, "regionId", profile.getCredential()) instanceof DescribeRegionsResponse);
    ...
    @Test
    public void testGetAcsResponseInvalidServerResponseException() throws NoSuchFieldException, SecurityException, IllegalArgumentException, IllegalAccessException, ClientException, IOException {
        DefaultProfile profile = DefaultProfile.getProfile("cn-hangzhou", "accessKeyId", "secret");
        DefaultAcsClient client = new DefaultAcsClient(profile);
        Field httpClient = client.getClass().getDeclaredField("httpClient");
        httpClient.setAccessible(true);
        ...
        thrown.expect(ClientException.class);
        thrown.expectMessage(ErrorCodeConstant.SDK_INVALID_SERVER_RESPONSE+" : "+ ErrorMessageConstant.SERVER_RESPONSE_HTTP_BODY_EMPTY);
        client.getAcsResponse(request);
    }
    
    
    @Test
    public void testDoActionEndpointTestabilityException() throws ClientException, IOException, IllegalArgumentException,
            IllegalAccessException, NoSuchFieldException, SecurityException {
        DefaultProfile profile = DefaultProfile.getProfile("cn-hangzhou", "accessKeyId", "secret");
        DefaultAcsClient client = new DefaultAcsClient(profile);
        AcsRequest request = Mockito.mock(AcsRequest.class);
    ...
    public void testDoActionSocketTimeoutException() throws ClientException, IOException, IllegalArgumentException,
        ...
        Mockito.doReturn("endpoint").when(endpointResolver).resolve(Mockito.any(ResolveEndpointRequest.class));
        Mockito.doReturn(ProtocolType.HTTP).when(request).getSysProtocol();
        Mockito.doThrow(new SocketTimeoutException()).when(compatibleUrlConnClient).syncInvoke(Mockito.any(HttpRequest.class));
        thrown.expect(ClientException.class);
    ...
    public void testDoActionIOException() throws ClientException, IOException, IllegalArgumentException,
        ...
        Mockito.doReturn("endpoint").when(endpointResolver).resolve(Mockito.any(ResolveEndpointRequest.class));
        Mockito.doReturn(ProtocolType.HTTP).when(request).getSysProtocol();
        Mockito.doThrow(new IOException()).when(compatibleUrlConnClient).syncInvoke(Mockito.any(HttpRequest.class));
        thrown.expect(ClientException.class);
    ...
    public void testDoActionInvalidKeyException() throws ClientException, IOException, IllegalArgumentException,
        ...
        Mockito.doReturn("endpoint").when(endpointResolver).resolve(Mockito.any(ResolveEndpointRequest.class));
        Mockito.doReturn(ProtocolType.HTTP).when(request).getSysProtocol();
        Mockito.doThrow(InvalidKeyException.class).when(compatibleUrlConnClient).syncInvoke(Mockito.any(HttpRequest.class));
        thrown.expect(ClientException.class);
    ...
    public void testDoActionNoSuchAlgorithmException() throws ClientException, IOException, IllegalArgumentException,
        ...
        Mockito.doReturn("endpoint").when(endpointResolver).resolve(Mockito.any(ResolveEndpointRequest.class));
        Mockito.doReturn(ProtocolType.HTTP).when(request).getSysProtocol();
        Mockito.doThrow(NoSuchAlgorithmException.class).when(compatibleUrlConnClient).syncInvoke(Mockito.any(HttpRequest.class));
        thrown.expect(ClientException.class);
