...
import com.aliyuncs.educloud.transform.v20220202.ListLabTokensResponseUnmarshaller;
 ...
 * @version 
 */
public class ListLabTokensResponse extends AcsResponse {
	...
	public static class Data {
		...
		public List<LabOrder> getList() {
			return this.list;
		}

		public void setList(List<LabOrder> list) {
			this.list = list;
		}
	...
	@Override
	public ListLabTokensResponse getInstance(UnmarshallerContext context) {
		return	ListLabTokensResponseUnmarshaller.unmarshall(this, context);
	}
