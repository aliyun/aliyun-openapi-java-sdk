 ...
 * @version 
 */
public class CreateFederatedCredentialProviderRequest extends RpcAcsRequest<CreateFederatedCredentialProviderResponse> {
	...
	public CreateFederatedCredentialProviderRequest() {
		super("Eiam", "2021-12-01", "CreateFederatedCredentialProvider", "eiam");
	...
	public void setOidcProviderConfig(OidcProviderConfig oidcProviderConfig) {
		...
		if (oidcProviderConfig != null) {
				...
				putQueryParameter("OidcProviderConfig.Issuer" , oidcProviderConfig.getIssuer());
		}	
	}
	...
	@Override
	public Class<CreateFederatedCredentialProviderResponse> getResponseClass() {
		return CreateFederatedCredentialProviderResponse.class;
	}
