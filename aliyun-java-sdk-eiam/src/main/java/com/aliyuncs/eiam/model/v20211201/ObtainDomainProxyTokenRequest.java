 ...
 * @version 
 */
public class ObtainDomainProxyTokenRequest extends RpcAcsRequest<ObtainDomainProxyTokenResponse> {
	...
	public ObtainDomainProxyTokenRequest() {
		super("Eiam", "2021-12-01", "ObtainDomainProxyToken", "eiam");
	...
	@Override
	public Class<ObtainDomainProxyTokenResponse> getResponseClass() {
		return ObtainDomainProxyTokenResponse.class;
	}
