 ...
 * @version 
 */
public class CreateApplicationTokenRequest extends RpcAcsRequest<CreateApplicationTokenResponse> {
	...
	public CreateApplicationTokenRequest() {
		super("Eiam", "2021-12-01", "CreateApplicationToken", "eiam");
	...
	@Override
	public Class<CreateApplicationTokenResponse> getResponseClass() {
		return CreateApplicationTokenResponse.class;
	}
