...
import com.aliyuncs.eiam.transform.v20211201.ListConditionalAccessPoliciesForUserResponseUnmarshaller;
 ...
 * @version 
 */
public class ListConditionalAccessPoliciesForUserResponse extends AcsResponse {
	...
	@Override
	public ListConditionalAccessPoliciesForUserResponse getInstance(UnmarshallerContext context) {
		return	ListConditionalAccessPoliciesForUserResponseUnmarshaller.unmarshall(this, context);
	}
