 ...
 * @version 
 */
public class DisableApplicationTokenRequest extends RpcAcsRequest<DisableApplicationTokenResponse> {
	...
	public DisableApplicationTokenRequest() {
		super("Eiam", "2021-12-01", "DisableApplicationToken", "eiam");
	...
	@Override
	public Class<DisableApplicationTokenResponse> getResponseClass() {
		return DisableApplicationTokenResponse.class;
	}
