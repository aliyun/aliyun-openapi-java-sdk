 ...
 * @version 
 */
public class UpdateApplicationDescriptionRequest extends RpcAcsRequest<UpdateApplicationDescriptionResponse> {
	...
	public UpdateApplicationDescriptionRequest() {
		super("Eiam", "2021-12-01", "UpdateApplicationDescription", "eiam");
