 ...
 * @version 
 */
public class DeleteApplicationTokenRequest extends RpcAcsRequest<DeleteApplicationTokenResponse> {
	...
	public DeleteApplicationTokenRequest() {
		super("Eiam", "2021-12-01", "DeleteApplicationToken", "eiam");
	...
	@Override
	public Class<DeleteApplicationTokenResponse> getResponseClass() {
		return DeleteApplicationTokenResponse.class;
	}
