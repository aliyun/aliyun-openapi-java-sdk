 ...
 * @version 
 */
public class DeleteFederatedCredentialProviderRequest extends RpcAcsRequest<DeleteFederatedCredentialProviderResponse> {
	   

	private String instanceId;

	private String federatedCredentialProviderId;
	public DeleteFederatedCredentialProviderRequest() {
		super("Eiam", "2021-12-01", "DeleteFederatedCredentialProvider", "eiam");
	...
	@Override
	public Class<DeleteFederatedCredentialProviderResponse> getResponseClass() {
		return DeleteFederatedCredentialProviderResponse.class;
	}
