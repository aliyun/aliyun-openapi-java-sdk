 ...
 * @version 
 */
public class UpdateApplicationFederatedCredentialDescriptionRequest extends RpcAcsRequest<UpdateApplicationFederatedCredentialDescriptionResponse> {
	...
	public UpdateApplicationFederatedCredentialDescriptionRequest() {
		super("Eiam", "2021-12-01", "UpdateApplicationFederatedCredentialDescription", "eiam");
	...
	@Override
	public Class<UpdateApplicationFederatedCredentialDescriptionResponse> getResponseClass() {
		return UpdateApplicationFederatedCredentialDescriptionResponse.class;
	}
