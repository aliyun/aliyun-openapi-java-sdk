 ...
 * @version 
 */
public class UpdateNetworkZoneRequest extends RpcAcsRequest<UpdateNetworkZoneResponse> {
	...
	public UpdateNetworkZoneRequest() {
		super("Eiam", "2021-12-01", "UpdateNetworkZone", "eiam");
	...
	@Override
	public Class<UpdateNetworkZoneResponse> getResponseClass() {
		return UpdateNetworkZoneResponse.class;
	}
