...
import com.aliyuncs.eiam.transform.v20211201.ListConditionalAccessPoliciesResponseUnmarshaller;
 ...
 * @version 
 */
public class ListConditionalAccessPoliciesResponse extends AcsResponse {
	...
	@Override
	public ListConditionalAccessPoliciesResponse getInstance(UnmarshallerContext context) {
		return	ListConditionalAccessPoliciesResponseUnmarshaller.unmarshall(this, context);
	}
