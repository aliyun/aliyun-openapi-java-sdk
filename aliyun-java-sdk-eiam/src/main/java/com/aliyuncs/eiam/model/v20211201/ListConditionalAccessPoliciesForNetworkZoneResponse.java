...
import com.aliyuncs.eiam.transform.v20211201.ListConditionalAccessPoliciesForNetworkZoneResponseUnmarshaller;
 ...
 * @version 
 */
public class ListConditionalAccessPoliciesForNetworkZoneResponse extends AcsResponse {
	...
	@Override
	public ListConditionalAccessPoliciesForNetworkZoneResponse getInstance(UnmarshallerContext context) {
		return	ListConditionalAccessPoliciesForNetworkZoneResponseUnmarshaller.unmarshall(this, context);
	}
