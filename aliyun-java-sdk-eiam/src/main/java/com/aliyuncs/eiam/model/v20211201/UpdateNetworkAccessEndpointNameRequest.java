 ...
 * @version 
 */
public class UpdateNetworkAccessEndpointNameRequest extends RpcAcsRequest<UpdateNetworkAccessEndpointNameResponse> {
	...
	public UpdateNetworkAccessEndpointNameRequest() {
		super("Eiam", "2021-12-01", "UpdateNetworkAccessEndpointName", "eiam");
	...
	@Override
	public Class<UpdateNetworkAccessEndpointNameResponse> getResponseClass() {
		return UpdateNetworkAccessEndpointNameResponse.class;
	}
