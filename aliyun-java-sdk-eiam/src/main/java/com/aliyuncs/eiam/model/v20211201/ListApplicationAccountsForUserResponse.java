...
import com.aliyuncs.eiam.transform.v20211201.ListApplicationAccountsForUserResponseUnmarshaller;
 ...
 * @version 
 */
public class ListApplicationAccountsForUserResponse extends AcsResponse {
	...
	@Override
	public ListApplicationAccountsForUserResponse getInstance(UnmarshallerContext context) {
		return	ListApplicationAccountsForUserResponseUnmarshaller.unmarshall(this, context);
	}
