 ...
 * @version 
 */
public class EnableFederatedCredentialProviderRequest extends RpcAcsRequest<EnableFederatedCredentialProviderResponse> {
	   

	private String instanceId;

	private String federatedCredentialProviderId;
	public EnableFederatedCredentialProviderRequest() {
		super("Eiam", "2021-12-01", "EnableFederatedCredentialProvider", "eiam");
	...
	@Override
	public Class<EnableFederatedCredentialProviderResponse> getResponseClass() {
		return EnableFederatedCredentialProviderResponse.class;
	}
