 ...
 * @version 
 */
public class DisableCustomPrivacyPolicyRequest extends RpcAcsRequest<DisableCustomPrivacyPolicyResponse> {
	   

	private String customPrivacyPolicyId;

	private String instanceId;
	public DisableCustomPrivacyPolicyRequest() {
		super("Eiam", "2021-12-01", "DisableCustomPrivacyPolicy", "eiam");
	...
	@Override
	public Class<DisableCustomPrivacyPolicyResponse> getResponseClass() {
		return DisableCustomPrivacyPolicyResponse.class;
	}
