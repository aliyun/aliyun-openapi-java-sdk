 ...
 * @version 
 */
public class EnableApplicationTokenRequest extends RpcAcsRequest<EnableApplicationTokenResponse> {
	...
	public EnableApplicationTokenRequest() {
		super("Eiam", "2021-12-01", "EnableApplicationToken", "eiam");
	...
	@Override
	public Class<EnableApplicationTokenResponse> getResponseClass() {
		return EnableApplicationTokenResponse.class;
	}
