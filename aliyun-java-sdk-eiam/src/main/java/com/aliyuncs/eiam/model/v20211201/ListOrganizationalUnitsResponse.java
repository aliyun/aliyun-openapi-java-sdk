...
import com.aliyuncs.eiam.transform.v20211201.ListOrganizationalUnitsResponseUnmarshaller;
 ...
 * @version 
 */
public class ListOrganizationalUnitsResponse extends AcsResponse {
	...
	@Override
	public ListOrganizationalUnitsResponse getInstance(UnmarshallerContext context) {
		return	ListOrganizationalUnitsResponseUnmarshaller.unmarshall(this, context);
	}
