 ...
 * @version 
 */
public class EnableCustomPrivacyPolicyRequest extends RpcAcsRequest<EnableCustomPrivacyPolicyResponse> {
	   

	private String customPrivacyPolicyId;

	private String instanceId;
	public EnableCustomPrivacyPolicyRequest() {
		super("Eiam", "2021-12-01", "EnableCustomPrivacyPolicy", "eiam");
	...
	@Override
	public Class<EnableCustomPrivacyPolicyResponse> getResponseClass() {
		return EnableCustomPrivacyPolicyResponse.class;
	}
