 ...
 * @version 
 */
public class ListSynchronizationJobsRequest extends RpcAcsRequest<ListSynchronizationJobsResponse> {
	...
	public ListSynchronizationJobsRequest() {
		super("Eiam", "2021-12-01", "ListSynchronizationJobs", "eiam");
	...
	public void setTargetIds(List<String> targetIds) {
		...
		if (targetIds != null) {
			for (int depth1 = 0; depth1 < targetIds.size(); depth1++) {
				putQueryParameter("TargetIds." + (depth1 + 1) , targetIds.get(depth1));
			}
		}	
	}
	...
	@Override
	public Class<ListSynchronizationJobsResponse> getResponseClass() {
		return ListSynchronizationJobsResponse.class;
	}
