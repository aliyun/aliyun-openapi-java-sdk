 ...
 * @version 
 */
public class GetConditionalAccessPolicyRequest extends RpcAcsRequest<GetConditionalAccessPolicyResponse> {
	   

	private String conditionalAccessPolicyId;

	private String instanceId;
	public GetConditionalAccessPolicyRequest() {
		super("Eiam", "2021-12-01", "GetConditionalAccessPolicy", "eiam");
	...
	@Override
	public Class<GetConditionalAccessPolicyResponse> getResponseClass() {
		return GetConditionalAccessPolicyResponse.class;
	}
