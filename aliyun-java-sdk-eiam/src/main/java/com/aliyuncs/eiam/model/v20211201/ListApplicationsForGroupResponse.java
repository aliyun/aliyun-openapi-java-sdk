...
import com.aliyuncs.eiam.transform.v20211201.ListApplicationsForGroupResponseUnmarshaller;
 ...
 * @version 
 */
public class ListApplicationsForGroupResponse extends AcsResponse {
	...
	@Override
	public ListApplicationsForGroupResponse getInstance(UnmarshallerContext context) {
		return	ListApplicationsForGroupResponseUnmarshaller.unmarshall(this, context);
	}
