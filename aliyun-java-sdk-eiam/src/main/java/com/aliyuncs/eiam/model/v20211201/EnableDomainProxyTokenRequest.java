 ...
 * @version 
 */
public class EnableDomainProxyTokenRequest extends RpcAcsRequest<EnableDomainProxyTokenResponse> {
	...
	public EnableDomainProxyTokenRequest() {
		super("Eiam", "2021-12-01", "EnableDomainProxyToken", "eiam");
	...
	@Override
	public Class<EnableDomainProxyTokenResponse> getResponseClass() {
		return EnableDomainProxyTokenResponse.class;
	}
