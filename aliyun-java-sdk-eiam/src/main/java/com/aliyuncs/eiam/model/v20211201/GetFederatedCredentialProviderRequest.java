 ...
 * @version 
 */
public class GetFederatedCredentialProviderRequest extends RpcAcsRequest<GetFederatedCredentialProviderResponse> {
	   

	private String instanceId;

	private String federatedCredentialProviderId;
	public GetFederatedCredentialProviderRequest() {
		super("Eiam", "2021-12-01", "GetFederatedCredentialProvider", "eiam");
	...
	@Override
	public Class<GetFederatedCredentialProviderResponse> getResponseClass() {
		return GetFederatedCredentialProviderResponse.class;
	}
