 ...
 * @version 
 */
public class DeleteApplicationFederatedCredentialRequest extends RpcAcsRequest<DeleteApplicationFederatedCredentialResponse> {
	...
	public DeleteApplicationFederatedCredentialRequest() {
		super("Eiam", "2021-12-01", "DeleteApplicationFederatedCredential", "eiam");
	...
	@Override
	public Class<DeleteApplicationFederatedCredentialResponse> getResponseClass() {
		return DeleteApplicationFederatedCredentialResponse.class;
	}
