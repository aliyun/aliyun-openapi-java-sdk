...
import com.aliyuncs.eiam.transform.v20211201.ObtainDomainProxyTokenResponseUnmarshaller;
 ...
 * @version 
 */
public class ObtainDomainProxyTokenResponse extends AcsResponse {
	...
	public void setDomainProxyToken(DomainProxyToken domainProxyToken) {
	...
	@Override
	public ObtainDomainProxyTokenResponse getInstance(UnmarshallerContext context) {
		return	ObtainDomainProxyTokenResponseUnmarshaller.unmarshall(this, context);
	}
