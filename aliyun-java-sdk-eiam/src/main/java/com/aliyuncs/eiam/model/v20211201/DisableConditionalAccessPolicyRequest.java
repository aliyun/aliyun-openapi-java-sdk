 ...
 * @version 
 */
public class DisableConditionalAccessPolicyRequest extends RpcAcsRequest<DisableConditionalAccessPolicyResponse> {
	   

	private String conditionalAccessPolicyId;

	private String instanceId;
	public DisableConditionalAccessPolicyRequest() {
		super("Eiam", "2021-12-01", "DisableConditionalAccessPolicy", "eiam");
	...
	@Override
	public Class<DisableConditionalAccessPolicyResponse> getResponseClass() {
		return DisableConditionalAccessPolicyResponse.class;
	}
