 ...
 * @version 
 */
public class GetApplicationFederatedCredentialRequest extends RpcAcsRequest<GetApplicationFederatedCredentialResponse> {
	...
	public GetApplicationFederatedCredentialRequest() {
		super("Eiam", "2021-12-01", "GetApplicationFederatedCredential", "eiam");
	...
	@Override
	public Class<GetApplicationFederatedCredentialResponse> getResponseClass() {
		return GetApplicationFederatedCredentialResponse.class;
	}
