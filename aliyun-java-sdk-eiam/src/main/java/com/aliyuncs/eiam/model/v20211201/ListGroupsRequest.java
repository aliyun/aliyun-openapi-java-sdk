...
public class ListGroupsRequest extends RpcAcsRequest<ListGroupsResponse> {
	...
	public ListGroupsRequest() {
		super("Eiam", "2021-12-01", "ListGroups", "eiam");
	...
	public void setGroupNameStartsWith(String groupNameStartsWith) {
		this.groupNameStartsWith = groupNameStartsWith;
		if(groupNameStartsWith != null){
			putQueryParameter("GroupNameStartsWith", groupNameStartsWith);
		}
	}
