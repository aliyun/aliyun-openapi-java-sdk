...
import com.aliyuncs.eiam.transform.v20211201.ListApplicationFederatedCredentialsForProviderResponseUnmarshaller;
 ...
 * @version 
 */
public class ListApplicationFederatedCredentialsForProviderResponse extends AcsResponse {
	...
	@Override
	public ListApplicationFederatedCredentialsForProviderResponse getInstance(UnmarshallerContext context) {
		return	ListApplicationFederatedCredentialsForProviderResponseUnmarshaller.unmarshall(this, context);
	}
