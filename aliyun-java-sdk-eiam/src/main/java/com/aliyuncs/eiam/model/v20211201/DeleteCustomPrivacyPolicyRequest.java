 ...
 * @version 
 */
public class DeleteCustomPrivacyPolicyRequest extends RpcAcsRequest<DeleteCustomPrivacyPolicyResponse> {
	   

	private String customPrivacyPolicyId;

	private String instanceId;
	public DeleteCustomPrivacyPolicyRequest() {
		super("Eiam", "2021-12-01", "DeleteCustomPrivacyPolicy", "eiam");
	...
	@Override
	public Class<DeleteCustomPrivacyPolicyResponse> getResponseClass() {
		return DeleteCustomPrivacyPolicyResponse.class;
	}
