...
import com.aliyuncs.eiam.transform.v20211201.GetSynchronizationJobResponseUnmarshaller;
 ...
 * @version 
 */
public class GetSynchronizationJobResponse extends AcsResponse {
	...
	public void setSynchronizationJob(SynchronizationJob synchronizationJob) {
	...
	@Override
	public GetSynchronizationJobResponse getInstance(UnmarshallerContext context) {
		return	GetSynchronizationJobResponseUnmarshaller.unmarshall(this, context);
	}
