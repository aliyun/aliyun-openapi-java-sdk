 ...
 * @version 
 */
public class DeleteDomainProxyTokenRequest extends RpcAcsRequest<DeleteDomainProxyTokenResponse> {
	...
	public DeleteDomainProxyTokenRequest() {
		super("Eiam", "2021-12-01", "DeleteDomainProxyToken", "eiam");
	...
	@Override
	public Class<DeleteDomainProxyTokenResponse> getResponseClass() {
		return DeleteDomainProxyTokenResponse.class;
	}
