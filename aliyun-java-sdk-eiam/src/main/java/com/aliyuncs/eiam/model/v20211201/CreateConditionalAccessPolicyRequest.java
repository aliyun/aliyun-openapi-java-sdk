 ...
 * @version 
 */
public class CreateConditionalAccessPolicyRequest extends RpcAcsRequest<CreateConditionalAccessPolicyResponse> {
	...
	public CreateConditionalAccessPolicyRequest() {
		super("Eiam", "2021-12-01", "CreateConditionalAccessPolicy", "eiam");
	...
	public void setConditionalAccessPolicyType(String conditionalAccessPolicyType) {
		...
		if(conditionalAccessPolicyType != null){
			putQueryParameter("ConditionalAccessPolicyType", conditionalAccessPolicyType);
		}
	}
	...
	public void setEvaluateAt(String evaluateAt) {
		...
		if(evaluateAt != null){
			putQueryParameter("EvaluateAt", evaluateAt);
		}
	}
	...
	@Override
	public Class<CreateConditionalAccessPolicyResponse> getResponseClass() {
		return CreateConditionalAccessPolicyResponse.class;
	}
