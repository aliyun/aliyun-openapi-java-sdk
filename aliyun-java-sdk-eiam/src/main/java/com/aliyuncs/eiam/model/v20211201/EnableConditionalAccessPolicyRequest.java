 ...
 * @version 
 */
public class EnableConditionalAccessPolicyRequest extends RpcAcsRequest<EnableConditionalAccessPolicyResponse> {
	   

	private String conditionalAccessPolicyId;

	private String instanceId;
	public EnableConditionalAccessPolicyRequest() {
		super("Eiam", "2021-12-01", "EnableConditionalAccessPolicy", "eiam");
	...
	@Override
	public Class<EnableConditionalAccessPolicyResponse> getResponseClass() {
		return EnableConditionalAccessPolicyResponse.class;
	}
