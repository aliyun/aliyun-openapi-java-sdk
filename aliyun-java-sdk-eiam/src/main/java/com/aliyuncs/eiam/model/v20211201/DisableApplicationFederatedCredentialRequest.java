 ...
 * @version 
 */
public class DisableApplicationFederatedCredentialRequest extends RpcAcsRequest<DisableApplicationFederatedCredentialResponse> {
	...
	public DisableApplicationFederatedCredentialRequest() {
		super("Eiam", "2021-12-01", "DisableApplicationFederatedCredential", "eiam");
	...
	@Override
	public Class<DisableApplicationFederatedCredentialResponse> getResponseClass() {
		return DisableApplicationFederatedCredentialResponse.class;
	}
