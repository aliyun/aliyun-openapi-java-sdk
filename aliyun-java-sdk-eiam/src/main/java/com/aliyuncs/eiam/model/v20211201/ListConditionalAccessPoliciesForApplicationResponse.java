...
import com.aliyuncs.eiam.transform.v20211201.ListConditionalAccessPoliciesForApplicationResponseUnmarshaller;
 ...
 * @version 
 */
public class ListConditionalAccessPoliciesForApplicationResponse extends AcsResponse {
	...
	public List<ConditionalAccessPolicy> getConditionalAccessPolicies() {
		return this.conditionalAccessPolicies;
	}

	public void setConditionalAccessPolicies(List<ConditionalAccessPolicy> conditionalAccessPolicies) {
	...
	@Override
	public ListConditionalAccessPoliciesForApplicationResponse getInstance(UnmarshallerContext context) {
		return	ListConditionalAccessPoliciesForApplicationResponseUnmarshaller.unmarshall(this, context);
	}
