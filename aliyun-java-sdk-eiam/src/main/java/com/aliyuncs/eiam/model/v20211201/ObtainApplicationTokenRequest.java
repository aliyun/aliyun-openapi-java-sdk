 ...
 * @version 
 */
public class ObtainApplicationTokenRequest extends RpcAcsRequest<ObtainApplicationTokenResponse> {
	...
	public ObtainApplicationTokenRequest() {
		super("Eiam", "2021-12-01", "ObtainApplicationToken", "eiam");
	...
	@Override
	public Class<ObtainApplicationTokenResponse> getResponseClass() {
		return ObtainApplicationTokenResponse.class;
	}
