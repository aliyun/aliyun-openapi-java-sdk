...
import com.aliyuncs.config.transform.v20200907.DetachAggregateConfigRuleToCompliancePackResponseUnmarshaller;
 ...
 * @version 
 */
public class DetachAggregateConfigRuleToCompliancePackResponse extends AcsResponse {
	...
	@Override
	public DetachAggregateConfigRuleToCompliancePackResponse getInstance(UnmarshallerContext context) {
		return	DetachAggregateConfigRuleToCompliancePackResponseUnmarshaller.unmarshall(this, context);
	}
