...
import com.aliyuncs.config.transform.v20200907.GetAggregateAdvancedSearchFileResponseUnmarshaller;
 ...
 * @version 
 */
public class GetAggregateAdvancedSearchFileResponse extends AcsResponse {
	...
	@Override
	public GetAggregateAdvancedSearchFileResponse getInstance(UnmarshallerContext context) {
		return	GetAggregateAdvancedSearchFileResponseUnmarshaller.unmarshall(this, context);
	}
