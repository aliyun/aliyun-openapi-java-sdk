...
import com.aliyuncs.config.transform.v20190108.DeleteConfigRulesResponseUnmarshaller;
 ...
 * @version 
 */
public class DeleteConfigRulesResponse extends AcsResponse {
	...
	@Override
	public DeleteConfigRulesResponse getInstance(UnmarshallerContext context) {
		return	DeleteConfigRulesResponseUnmarshaller.unmarshall(this, context);
	}
