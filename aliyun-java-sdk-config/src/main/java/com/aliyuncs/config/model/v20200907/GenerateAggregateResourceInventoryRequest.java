...
public class GenerateAggregateResourceInventoryRequest extends RpcAcsRequest<GenerateAggregateResourceInventoryResponse> {
	...
	public void setAccountIds(String accountIds) {
		...
		if(accountIds != null){
			putQueryParameter("AccountIds", accountIds);
		}
	}

	@Override
	public Class<GenerateAggregateResourceInventoryResponse> getResponseClass() {
		return GenerateAggregateResourceInventoryResponse.class;
	}
