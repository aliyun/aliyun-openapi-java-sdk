...
import com.aliyuncs.config.transform.v20200907.GetAggregateResourceCountsGroupByRegionResponseUnmarshaller;
 ...
 * @version 
 */
public class GetAggregateResourceCountsGroupByRegionResponse extends AcsResponse {
	...
	@Override
	public GetAggregateResourceCountsGroupByRegionResponse getInstance(UnmarshallerContext context) {
		return	GetAggregateResourceCountsGroupByRegionResponseUnmarshaller.unmarshall(this, context);
	}
