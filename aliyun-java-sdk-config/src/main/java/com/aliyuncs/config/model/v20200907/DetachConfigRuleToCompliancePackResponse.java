...
import com.aliyuncs.config.transform.v20200907.DetachConfigRuleToCompliancePackResponseUnmarshaller;
 ...
 * @version 
 */
public class DetachConfigRuleToCompliancePackResponse extends AcsResponse {
	...
	@Override
	public DetachConfigRuleToCompliancePackResponse getInstance(UnmarshallerContext context) {
		return	DetachConfigRuleToCompliancePackResponseUnmarshaller.unmarshall(this, context);
	}
