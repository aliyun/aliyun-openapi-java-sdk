 ...
 * @version 
 */
public class DeleteConfigRulesRequest extends RpcAcsRequest<DeleteConfigRulesResponse> {
	...
	@Override
	public Class<DeleteConfigRulesResponse> getResponseClass() {
		return DeleteConfigRulesResponse.class;
	}
