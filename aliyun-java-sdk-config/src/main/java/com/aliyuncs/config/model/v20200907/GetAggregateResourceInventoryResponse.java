...
import com.aliyuncs.config.transform.v20200907.GetAggregateResourceInventoryResponseUnmarshaller;
 ...
 * @version 
 */
public class GetAggregateResourceInventoryResponse extends AcsResponse {
	...
	@Override
	public GetAggregateResourceInventoryResponse getInstance(UnmarshallerContext context) {
		return	GetAggregateResourceInventoryResponseUnmarshaller.unmarshall(this, context);
	}
