 ...
 * @version 
 */
public class DescribeConfigRuleRequest extends RpcAcsRequest<DescribeConfigRuleResponse> {
	...
	public DescribeConfigRuleRequest() {
		super("Config", "2019-01-08", "DescribeConfigRule");
	...
	@Override
	public Class<DescribeConfigRuleResponse> getResponseClass() {
		return DescribeConfigRuleResponse.class;
	}
