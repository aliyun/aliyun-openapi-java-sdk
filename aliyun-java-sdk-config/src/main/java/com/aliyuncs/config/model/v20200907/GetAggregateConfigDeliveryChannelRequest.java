 ...
 * @version 
 */
public class GetAggregateConfigDeliveryChannelRequest extends RpcAcsRequest<GetAggregateConfigDeliveryChannelResponse> {
	...
	@Override
	public Class<GetAggregateConfigDeliveryChannelResponse> getResponseClass() {
		return GetAggregateConfigDeliveryChannelResponse.class;
	}
