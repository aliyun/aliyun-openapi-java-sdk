...
import com.aliyuncs.config.transform.v20190108.DescribeConfigurationRecorderResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeConfigurationRecorderResponse extends AcsResponse {
	...
	@Override
	public DescribeConfigurationRecorderResponse getInstance(UnmarshallerContext context) {
		return	DescribeConfigurationRecorderResponseUnmarshaller.unmarshall(this, context);
	}
