...
import com.aliyuncs.config.transform.v20190108.PutConfigurationRecorderResponseUnmarshaller;
 ...
 * @version 
 */
public class PutConfigurationRecorderResponse extends AcsResponse {
	...
	@Override
	public PutConfigurationRecorderResponse getInstance(UnmarshallerContext context) {
		return	PutConfigurationRecorderResponseUnmarshaller.unmarshall(this, context);
	}
