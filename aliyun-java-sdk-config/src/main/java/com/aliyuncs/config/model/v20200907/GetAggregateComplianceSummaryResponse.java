...
import com.aliyuncs.config.transform.v20200907.GetAggregateComplianceSummaryResponseUnmarshaller;
 ...
 * @version 
 */
public class GetAggregateComplianceSummaryResponse extends AcsResponse {
	...
	@Override
	public GetAggregateComplianceSummaryResponse getInstance(UnmarshallerContext context) {
		return	GetAggregateComplianceSummaryResponseUnmarshaller.unmarshall(this, context);
	}
