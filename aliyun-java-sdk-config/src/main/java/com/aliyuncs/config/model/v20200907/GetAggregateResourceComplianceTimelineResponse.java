...
import com.aliyuncs.config.transform.v20200907.GetAggregateResourceComplianceTimelineResponseUnmarshaller;
 ...
 * @version 
 */
public class GetAggregateResourceComplianceTimelineResponse extends AcsResponse {
	...
	@Override
	public GetAggregateResourceComplianceTimelineResponse getInstance(UnmarshallerContext context) {
		return	GetAggregateResourceComplianceTimelineResponseUnmarshaller.unmarshall(this, context);
	}
