...
import com.aliyuncs.config.transform.v20200907.GetAggregateConfigRuleSummaryByRiskLevelResponseUnmarshaller;
 ...
 * @version 
 */
public class GetAggregateConfigRuleSummaryByRiskLevelResponse extends AcsResponse {
	...
	@Override
	public GetAggregateConfigRuleSummaryByRiskLevelResponse getInstance(UnmarshallerContext context) {
		return	GetAggregateConfigRuleSummaryByRiskLevelResponseUnmarshaller.unmarshall(this, context);
	}
