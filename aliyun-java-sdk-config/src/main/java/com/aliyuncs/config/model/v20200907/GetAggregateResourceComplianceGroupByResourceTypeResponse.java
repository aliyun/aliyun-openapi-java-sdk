...
import com.aliyuncs.config.transform.v20200907.GetAggregateResourceComplianceGroupByResourceTypeResponseUnmarshaller;
 ...
 * @version 
 */
public class GetAggregateResourceComplianceGroupByResourceTypeResponse extends AcsResponse {
	...
	@Override
	public GetAggregateResourceComplianceGroupByResourceTypeResponse getInstance(UnmarshallerContext context) {
		return	GetAggregateResourceComplianceGroupByResourceTypeResponseUnmarshaller.unmarshall(this, context);
	}
