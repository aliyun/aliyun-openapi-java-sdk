...
import com.aliyuncs.config.transform.v20200907.GetConfigRuleComplianceByPackResponseUnmarshaller;
 ...
 * @version 
 */
public class GetConfigRuleComplianceByPackResponse extends AcsResponse {
	...
	@Override
	public GetConfigRuleComplianceByPackResponse getInstance(UnmarshallerContext context) {
		return	GetConfigRuleComplianceByPackResponseUnmarshaller.unmarshall(this, context);
	}
