...
import com.aliyuncs.config.transform.v20200907.DeleteAggregateConfigRulesResponseUnmarshaller;
 ...
 * @version 
 */
public class DeleteAggregateConfigRulesResponse extends AcsResponse {
	...
	@Override
	public DeleteAggregateConfigRulesResponse getInstance(UnmarshallerContext context) {
		return	DeleteAggregateConfigRulesResponseUnmarshaller.unmarshall(this, context);
	}
