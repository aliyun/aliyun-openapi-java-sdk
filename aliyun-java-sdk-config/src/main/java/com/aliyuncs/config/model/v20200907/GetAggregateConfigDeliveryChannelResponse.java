...
import com.aliyuncs.config.transform.v20200907.GetAggregateConfigDeliveryChannelResponseUnmarshaller;
 ...
 * @version 
 */
public class GetAggregateConfigDeliveryChannelResponse extends AcsResponse {
	...
	@Override
	public GetAggregateConfigDeliveryChannelResponse getInstance(UnmarshallerContext context) {
		return	GetAggregateConfigDeliveryChannelResponseUnmarshaller.unmarshall(this, context);
	}
