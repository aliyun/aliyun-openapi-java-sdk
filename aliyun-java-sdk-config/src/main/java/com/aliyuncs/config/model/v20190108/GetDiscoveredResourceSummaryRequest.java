 ...
 * @version 
 */
public class GetDiscoveredResourceSummaryRequest extends RpcAcsRequest<GetDiscoveredResourceSummaryResponse> {
	...
	public GetDiscoveredResourceSummaryRequest() {
		super("Config", "2019-01-08", "GetDiscoveredResourceSummary");
	...
	@Override
	public Class<GetDiscoveredResourceSummaryResponse> getResponseClass() {
		return GetDiscoveredResourceSummaryResponse.class;
	}
