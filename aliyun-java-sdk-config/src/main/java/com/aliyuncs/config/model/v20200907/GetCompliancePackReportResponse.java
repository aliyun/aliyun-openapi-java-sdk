...
import com.aliyuncs.config.transform.v20200907.GetCompliancePackReportResponseUnmarshaller;
 ...
 * @version 
 */
public class GetCompliancePackReportResponse extends AcsResponse {
	...
	@Override
	public GetCompliancePackReportResponse getInstance(UnmarshallerContext context) {
		return	GetCompliancePackReportResponseUnmarshaller.unmarshall(this, context);
	}
