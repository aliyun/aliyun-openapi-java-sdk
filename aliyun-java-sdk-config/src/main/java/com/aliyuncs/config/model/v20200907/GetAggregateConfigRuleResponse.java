...
import com.aliyuncs.config.transform.v20200907.GetAggregateConfigRuleResponseUnmarshaller;
 ...
 * @version 
 */
public class GetAggregateConfigRuleResponse extends AcsResponse {
	...
	@Override
	public GetAggregateConfigRuleResponse getInstance(UnmarshallerContext context) {
		return	GetAggregateConfigRuleResponseUnmarshaller.unmarshall(this, context);
	}
