...
public class GetSupportedResourceTypesRequest extends RpcAcsRequest<GetSupportedResourceTypesResponse> {
	...
	public GetSupportedResourceTypesRequest() {
		super("Config", "2019-01-08", "GetSupportedResourceTypes");
	...
	@Override
	public Class<GetSupportedResourceTypesResponse> getResponseClass() {
		return GetSupportedResourceTypesResponse.class;
	}
