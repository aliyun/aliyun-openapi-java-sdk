 ...
 * @version 
 */
public class DetachConfigRuleToCompliancePackRequest extends RpcAcsRequest<DetachConfigRuleToCompliancePackResponse> {
	...
	@Override
	public Class<DetachConfigRuleToCompliancePackResponse> getResponseClass() {
		return DetachConfigRuleToCompliancePackResponse.class;
	}
