...
import com.aliyuncs.config.transform.v20200907.GetAggregateResourceComplianceByConfigRuleResponseUnmarshaller;
 ...
 * @version 
 */
public class GetAggregateResourceComplianceByConfigRuleResponse extends AcsResponse {
	...
	@Override
	public GetAggregateResourceComplianceByConfigRuleResponse getInstance(UnmarshallerContext context) {
		return	GetAggregateResourceComplianceByConfigRuleResponseUnmarshaller.unmarshall(this, context);
	}
