...
import com.aliyuncs.config.transform.v20200907.GetConfigurationRecorderResponseUnmarshaller;
 ...
 * @version 
 */
public class GetConfigurationRecorderResponse extends AcsResponse {
	...
	@Override
	public GetConfigurationRecorderResponse getInstance(UnmarshallerContext context) {
		return	GetConfigurationRecorderResponseUnmarshaller.unmarshall(this, context);
	}
