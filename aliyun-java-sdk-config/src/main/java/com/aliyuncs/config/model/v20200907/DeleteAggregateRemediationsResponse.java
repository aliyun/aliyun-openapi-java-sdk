...
import com.aliyuncs.config.transform.v20200907.DeleteAggregateRemediationsResponseUnmarshaller;
 ...
 * @version 
 */
public class DeleteAggregateRemediationsResponse extends AcsResponse {
	...
	@Override
	public DeleteAggregateRemediationsResponse getInstance(UnmarshallerContext context) {
		return	DeleteAggregateRemediationsResponseUnmarshaller.unmarshall(this, context);
	}
