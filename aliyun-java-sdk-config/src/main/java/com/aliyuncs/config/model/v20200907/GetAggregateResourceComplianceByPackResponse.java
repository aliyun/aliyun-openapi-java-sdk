...
import com.aliyuncs.config.transform.v20200907.GetAggregateResourceComplianceByPackResponseUnmarshaller;
 ...
 * @version 
 */
public class GetAggregateResourceComplianceByPackResponse extends AcsResponse {
	...
	@Override
	public GetAggregateResourceComplianceByPackResponse getInstance(UnmarshallerContext context) {
		return	GetAggregateResourceComplianceByPackResponseUnmarshaller.unmarshall(this, context);
	}
