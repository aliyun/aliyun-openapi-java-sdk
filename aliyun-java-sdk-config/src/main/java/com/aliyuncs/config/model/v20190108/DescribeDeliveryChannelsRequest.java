 ...
 * @version 
 */
public class DescribeDeliveryChannelsRequest extends RpcAcsRequest<DescribeDeliveryChannelsResponse> {
	   

	private String deliveryChannelIds;
	public DescribeDeliveryChannelsRequest() {
		super("Config", "2019-01-08", "DescribeDeliveryChannels");
	...
	@Override
	public Class<DescribeDeliveryChannelsResponse> getResponseClass() {
		return DescribeDeliveryChannelsResponse.class;
	}
