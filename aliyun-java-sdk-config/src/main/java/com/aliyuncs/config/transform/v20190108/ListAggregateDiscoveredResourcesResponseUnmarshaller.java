...
import com.aliyuncs.config.model.v20190108.ListAggregateDiscoveredResourcesResponse;
import com.aliyuncs.config.model.v20190108.ListAggregateDiscoveredResourcesResponse.DiscoveredResourceProfiles;
import com.aliyuncs.config.model.v20190108.ListAggregateDiscoveredResourcesResponse.DiscoveredResourceProfiles.DiscoveredResourceProfile;
...
public class ListAggregateDiscoveredResourcesResponseUnmarshaller {
	...
	public static ListAggregateDiscoveredResourcesResponse unmarshall(ListAggregateDiscoveredResourcesResponse listAggregateDiscoveredResourcesResponse, UnmarshallerContext _ctx) {
		...
		discoveredResourceProfiles.setPageNumber(_ctx.integerValue("ListAggregateDiscoveredResourcesResponse.DiscoveredResourceProfiles.PageNumber"));
		discoveredResourceProfiles.setPageSize(_ctx.integerValue("ListAggregateDiscoveredResourcesResponse.DiscoveredResourceProfiles.PageSize"));
