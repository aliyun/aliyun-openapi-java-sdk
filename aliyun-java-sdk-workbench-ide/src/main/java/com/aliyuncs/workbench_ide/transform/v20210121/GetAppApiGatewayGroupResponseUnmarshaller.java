...
import com.aliyuncs.workbench_ide.model.v20210121.GetAppApiGatewayGroupResponse;
import java.util.Map;
import com.aliyuncs.transform.UnmarshallerContext;


public class GetAppApiGatewayGroupResponseUnmarshaller {

	public static GetAppApiGatewayGroupResponse unmarshall(GetAppApiGatewayGroupResponse getAppApiGatewayGroupResponse, UnmarshallerContext _ctx) {
