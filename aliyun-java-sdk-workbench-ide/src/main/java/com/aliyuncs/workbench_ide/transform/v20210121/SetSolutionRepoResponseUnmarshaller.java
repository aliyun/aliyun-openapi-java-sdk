...
import com.aliyuncs.workbench_ide.model.v20210121.SetSolutionRepoResponse;
import java.util.Map;
import com.aliyuncs.transform.UnmarshallerContext;


public class SetSolutionRepoResponseUnmarshaller {

	public static SetSolutionRepoResponse unmarshall(SetSolutionRepoResponse setSolutionRepoResponse, UnmarshallerContext _ctx) {
