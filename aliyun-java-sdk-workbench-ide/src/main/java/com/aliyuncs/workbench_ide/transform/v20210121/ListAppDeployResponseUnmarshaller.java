...
public class ListAppDeployResponseUnmarshaller {

	public static ListAppDeployResponse unmarshall(ListAppDeployResponse listAppDeployResponse, UnmarshallerContext _ctx) {
