 ...
 * @version 
 */
public class GetAppDeployDomainRequest extends RpcAcsRequest<GetAppDeployDomainResponse> {
	...
	public GetAppDeployDomainRequest() {
		super("Workbench-ide", "2021-01-21", "GetAppDeployDomain");
	...
	@Override
	public Class<GetAppDeployDomainResponse> getResponseClass() {
		return GetAppDeployDomainResponse.class;
	}
