 ...
 * @version 
 */
public class SetAppDeployDomainRequest extends RpcAcsRequest<SetAppDeployDomainResponse> {
	...
	public SetAppDeployDomainRequest() {
		super("Workbench-ide", "2021-01-21", "SetAppDeployDomain");
	...
	@Override
	public Class<SetAppDeployDomainResponse> getResponseClass() {
		return SetAppDeployDomainResponse.class;
	}
