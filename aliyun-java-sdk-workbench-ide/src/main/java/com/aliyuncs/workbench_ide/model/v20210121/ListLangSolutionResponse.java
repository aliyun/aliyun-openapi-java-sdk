 ...
 * @version 
 */
public class ListLangSolutionResponse extends AcsResponse {
	...
	@Override
	public ListLangSolutionResponse getInstance(UnmarshallerContext context) {
		return	ListLangSolutionResponseUnmarshaller.unmarshall(this, context);
	}
