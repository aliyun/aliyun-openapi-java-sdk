 ...
 * @version 
 */
public class GetAppDeployRequest extends RpcAcsRequest<GetAppDeployResponse> {
	...
	public GetAppDeployRequest() {
		super("Workbench-ide", "2021-01-21", "GetAppDeploy");
	...
	@Override
	public Class<GetAppDeployResponse> getResponseClass() {
		return GetAppDeployResponse.class;
	}
