 ...
 * @version 
 */
public class GetAppGlobalConfigRequest extends RpcAcsRequest<GetAppGlobalConfigResponse> {
	...
	public GetAppGlobalConfigRequest() {
		super("Workbench-ide", "2021-01-21", "GetAppGlobalConfig");
	...
	@Override
	public Class<GetAppGlobalConfigResponse> getResponseClass() {
		return GetAppGlobalConfigResponse.class;
	}
