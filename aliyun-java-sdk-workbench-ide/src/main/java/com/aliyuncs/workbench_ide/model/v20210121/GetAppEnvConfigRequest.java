 ...
 * @version 
 */
public class GetAppEnvConfigRequest extends RpcAcsRequest<GetAppEnvConfigResponse> {
	...
	public GetAppEnvConfigRequest() {
		super("Workbench-ide", "2021-01-21", "GetAppEnvConfig");
	...
	@Override
	public Class<GetAppEnvConfigResponse> getResponseClass() {
		return GetAppEnvConfigResponse.class;
	}
