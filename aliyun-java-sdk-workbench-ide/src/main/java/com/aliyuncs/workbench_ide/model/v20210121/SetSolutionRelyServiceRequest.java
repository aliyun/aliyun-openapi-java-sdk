 ...
 * @version 
 */
public class SetSolutionRelyServiceRequest extends RpcAcsRequest<SetSolutionRelyServiceResponse> {
	...
	public SetSolutionRelyServiceRequest() {
		super("Workbench-ide", "2021-01-21", "SetSolutionRelyService");
	...
	@Override
	public Class<SetSolutionRelyServiceResponse> getResponseClass() {
		return SetSolutionRelyServiceResponse.class;
	}
