 ...
 * @version 
 */
public class RefreshAppDeployDomainRequest extends RpcAcsRequest<RefreshAppDeployDomainResponse> {
	...
	public RefreshAppDeployDomainRequest() {
		super("Workbench-ide", "2021-01-21", "RefreshAppDeployDomain");
	...
	@Override
	public Class<RefreshAppDeployDomainResponse> getResponseClass() {
		return RefreshAppDeployDomainResponse.class;
	}
