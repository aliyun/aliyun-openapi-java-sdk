...
import com.aliyuncs.devops.model.v20210625.CreateSshKeyResponse;
import com.aliyuncs.devops.model.v20210625.CreateSshKeyResponse.SshKey;
...
public class CreateSshKeyResponseUnmarshaller {
	...
	public static CreateSshKeyResponse unmarshall(CreateSshKeyResponse createSshKeyResponse, UnmarshallerContext _ctx) {
		...
		sshKey.setPublicKey(_ctx.stringValue("CreateSshKeyResponse.sshKey.publicKey"));
		sshKey.setId(_ctx.longValue("CreateSshKeyResponse.sshKey.id"));
		createSshKeyResponse.setSshKey(sshKey);
