...
import com.aliyuncs.devops.model.v20210625.UpdatePipelineResponse;
...
public class UpdatePipelineResponseUnmarshaller {
	...
	public static UpdatePipelineResponse unmarshall(UpdatePipelineResponse updatePipelineResponse, UnmarshallerContext _ctx) {
		...
		updatePipelineResponse.setErrorCode(_ctx.stringValue("UpdatePipelineResponse.errorCode"));
		updatePipelineResponse.setErrorMessage(_ctx.stringValue("UpdatePipelineResponse.errorMessage"));
