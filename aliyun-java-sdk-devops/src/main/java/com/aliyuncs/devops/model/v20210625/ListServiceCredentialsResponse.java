...
import com.aliyuncs.devops.transform.v20210625.ListServiceCredentialsResponseUnmarshaller;
 ...
 * @version 
 */
public class ListServiceCredentialsResponse extends AcsResponse {
	...
	@Override
	public ListServiceCredentialsResponse getInstance(UnmarshallerContext context) {
		return	ListServiceCredentialsResponseUnmarshaller.unmarshall(this, context);
	}
