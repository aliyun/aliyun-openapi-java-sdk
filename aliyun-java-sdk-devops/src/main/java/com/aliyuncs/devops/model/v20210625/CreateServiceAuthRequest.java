 ...
 * @version 
 */
public class CreateServiceAuthRequest extends RoaAcsRequest<CreateServiceAuthResponse> {
	   

	private String organizationId;

	private String serviceAuthType;
	public CreateServiceAuthRequest() {
		super("devops", "2021-06-25", "CreateServiceAuth");
	...
	@Override
	public Class<CreateServiceAuthResponse> getResponseClass() {
		return CreateServiceAuthResponse.class;
	}
