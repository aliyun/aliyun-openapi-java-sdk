 ...
 * @version 
 */
public class CreateHostGroupRequest extends RoaAcsRequest<CreateHostGroupResponse> {
	...
	public CreateHostGroupRequest() {
		super("devops", "2021-06-25", "CreateHostGroup");
	...
	@Override
	public Class<CreateHostGroupResponse> getResponseClass() {
		return CreateHostGroupResponse.class;
	}
