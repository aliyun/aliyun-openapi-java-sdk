...
import com.aliyuncs.devops.transform.v20210625.CreateWorkitemRecordResponseUnmarshaller;
 ...
 * @version 
 */
public class CreateWorkitemRecordResponse extends AcsResponse {
	...
	public void setWorkitemTime(WorkitemTime workitemTime) {
		this.workitemTime = workitemTime;
	}

	public static class WorkitemTime {
	...
	@Override
	public CreateWorkitemRecordResponse getInstance(UnmarshallerContext context) {
		return	CreateWorkitemRecordResponseUnmarshaller.unmarshall(this, context);
	}
