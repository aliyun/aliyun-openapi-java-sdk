...
import com.aliyuncs.devops.transform.v20210625.UpdatePushRuleResponseUnmarshaller;
 ...
 * @version 
 */
public class UpdatePushRuleResponse extends AcsResponse {
	...
	@Override
	public UpdatePushRuleResponse getInstance(UnmarshallerContext context) {
		return	UpdatePushRuleResponseUnmarshaller.unmarshall(this, context);
	}
