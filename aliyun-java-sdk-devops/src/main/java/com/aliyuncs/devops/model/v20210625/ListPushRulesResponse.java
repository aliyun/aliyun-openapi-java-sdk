...
import com.aliyuncs.devops.transform.v20210625.ListPushRulesResponseUnmarshaller;
 ...
 * @version 
 */
public class ListPushRulesResponse extends AcsResponse {
	...
	@Override
	public ListPushRulesResponse getInstance(UnmarshallerContext context) {
		return	ListPushRulesResponseUnmarshaller.unmarshall(this, context);
	}
