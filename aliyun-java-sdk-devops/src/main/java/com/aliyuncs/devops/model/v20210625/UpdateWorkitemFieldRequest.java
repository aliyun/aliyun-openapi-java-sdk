 ...
 * @version 
 */
public class UpdateWorkitemFieldRequest extends RoaAcsRequest<UpdateWorkitemFieldResponse> {
	...
	public UpdateWorkitemFieldRequest() {
		super("devops", "2021-06-25", "UpdateWorkitemField");
		setUriPattern("/organization/[organizationId]/workitems/updateWorkitemField");
	...
	@Override
	public Class<UpdateWorkitemFieldResponse> getResponseClass() {
		return UpdateWorkitemFieldResponse.class;
	}
