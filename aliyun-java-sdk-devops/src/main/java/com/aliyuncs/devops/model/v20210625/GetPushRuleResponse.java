...
import com.aliyuncs.devops.transform.v20210625.GetPushRuleResponseUnmarshaller;
 ...
 * @version 
 */
public class GetPushRuleResponse extends AcsResponse {
	...
	@Override
	public GetPushRuleResponse getInstance(UnmarshallerContext context) {
		return	GetPushRuleResponseUnmarshaller.unmarshall(this, context);
	}
