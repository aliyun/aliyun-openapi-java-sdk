...
import com.aliyuncs.devops.transform.v20210625.ListCheckRunsResponseUnmarshaller;
 ...
 * @version 
 */
public class ListCheckRunsResponse extends AcsResponse {
	...
	@Override
	public ListCheckRunsResponse getInstance(UnmarshallerContext context) {
		return	ListCheckRunsResponseUnmarshaller.unmarshall(this, context);
	}
