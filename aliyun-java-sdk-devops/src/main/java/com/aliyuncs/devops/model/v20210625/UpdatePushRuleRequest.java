 ...
 * @version 
 */
public class UpdatePushRuleRequest extends RoaAcsRequest<UpdatePushRuleResponse> {
	...
	@SerializedName("body")
	private Body body;
	public UpdatePushRuleRequest() {
		super("devops", "2021-06-25", "UpdatePushRule");
	...
	@Override
	public Class<UpdatePushRuleResponse> getResponseClass() {
		return UpdatePushRuleResponse.class;
	}
