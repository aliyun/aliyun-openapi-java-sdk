 ...
 * @version 
 */
public class CreateProtectdBranchRequest extends RoaAcsRequest<CreateProtectdBranchResponse> {
	...
	@SerializedName("body")
	private Body body;
	public CreateProtectdBranchRequest() {
		super("devops", "2021-06-25", "CreateProtectdBranch");
	...
	@Override
	public Class<CreateProtectdBranchResponse> getResponseClass() {
		return CreateProtectdBranchResponse.class;
	}
