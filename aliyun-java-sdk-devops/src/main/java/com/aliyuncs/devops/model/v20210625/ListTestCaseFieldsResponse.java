...
import com.aliyuncs.devops.transform.v20210625.ListTestCaseFieldsResponseUnmarshaller;
 ...
 * @version 
 */
public class ListTestCaseFieldsResponse extends AcsResponse {
	...
	@Override
	public ListTestCaseFieldsResponse getInstance(UnmarshallerContext context) {
		return	ListTestCaseFieldsResponseUnmarshaller.unmarshall(this, context);
	}
