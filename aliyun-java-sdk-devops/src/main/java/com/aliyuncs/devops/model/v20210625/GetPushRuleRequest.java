 ...
 * @version 
 */
public class GetPushRuleRequest extends RoaAcsRequest<GetPushRuleResponse> {
	...
	public GetPushRuleRequest() {
		super("devops", "2021-06-25", "GetPushRule");
	...
	@Override
	public Class<GetPushRuleResponse> getResponseClass() {
		return GetPushRuleResponse.class;
	}
