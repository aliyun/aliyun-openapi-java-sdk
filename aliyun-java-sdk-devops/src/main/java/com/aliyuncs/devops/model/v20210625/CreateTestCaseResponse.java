...
import com.aliyuncs.devops.transform.v20210625.CreateTestCaseResponseUnmarshaller;
 ...
 * @version 
 */
public class CreateTestCaseResponse extends AcsResponse {
	...
	@Override
	public CreateTestCaseResponse getInstance(UnmarshallerContext context) {
		return	CreateTestCaseResponseUnmarshaller.unmarshall(this, context);
	}
