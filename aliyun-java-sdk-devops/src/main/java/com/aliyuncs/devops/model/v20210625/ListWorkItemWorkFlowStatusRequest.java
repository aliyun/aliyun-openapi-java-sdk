 ...
 * @version 
 */
public class ListWorkItemWorkFlowStatusRequest extends RoaAcsRequest<ListWorkItemWorkFlowStatusResponse> {
	...
	public ListWorkItemWorkFlowStatusRequest() {
		super("devops", "2021-06-25", "ListWorkItemWorkFlowStatus");
		setUriPattern("/organization/[organizationId]/workitems/workflow/listWorkflowStatus");
	...
	public void setWorkitemCategoryIdentifier(String workitemCategoryIdentifier) {
		this.workitemCategoryIdentifier = workitemCategoryIdentifier;
		if(workitemCategoryIdentifier != null){
			putQueryParameter("workitemCategoryIdentifier", workitemCategoryIdentifier);
		}
	}
	...
	@Override
	public Class<ListWorkItemWorkFlowStatusResponse> getResponseClass() {
		return ListWorkItemWorkFlowStatusResponse.class;
	}
