...
import com.aliyuncs.devops.transform.v20210625.UpdateProtectedBranchesResponseUnmarshaller;
 ...
 * @version 
 */
public class UpdateProtectedBranchesResponse extends AcsResponse {
	...
	@Override
	public UpdateProtectedBranchesResponse getInstance(UnmarshallerContext context) {
		return	UpdateProtectedBranchesResponseUnmarshaller.unmarshall(this, context);
	}
