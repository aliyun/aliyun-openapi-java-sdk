 ...
 * @version 
 */
public class UpdateResourceMemberRequest extends RoaAcsRequest<UpdateResourceMemberResponse> {
	...
	public UpdateResourceMemberRequest() {
		super("devops", "2021-06-25", "UpdateResourceMember");
	...
	@Override
	public Class<UpdateResourceMemberResponse> getResponseClass() {
		return UpdateResourceMemberResponse.class;
	}
