 ...
 * @version 
 */
public class GetMergeRequestChangeTreeRequest extends RoaAcsRequest<GetMergeRequestChangeTreeResponse> {
	...
	public GetMergeRequestChangeTreeRequest() {
		super("devops", "2021-06-25", "GetMergeRequestChangeTree");
		setProtocol(ProtocolType.HTTPS);
		setUriPattern("/api/v4/projects/merge_requests/diffs/change_tree");
	...
	@Override
	public Class<GetMergeRequestChangeTreeResponse> getResponseClass() {
		return GetMergeRequestChangeTreeResponse.class;
	}
