 ...
 * @version 
 */
public class ListRepositoryGroupsRequest extends RoaAcsRequest<ListRepositoryGroupsResponse> {
	...
	private Long page;
	public ListRepositoryGroupsRequest() {
		super("devops", "2021-06-25", "ListRepositoryGroups");
		setUriPattern("/repository/groups/get/all");
	...
	@Override
	public Class<ListRepositoryGroupsResponse> getResponseClass() {
		return ListRepositoryGroupsResponse.class;
	}
