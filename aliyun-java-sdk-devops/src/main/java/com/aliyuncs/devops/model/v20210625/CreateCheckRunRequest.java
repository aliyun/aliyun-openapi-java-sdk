 ...
 * @version 
 */
public class CreateCheckRunRequest extends RoaAcsRequest<CreateCheckRunResponse> {
	...
	@SerializedName("body")
	private Body body;
	public CreateCheckRunRequest() {
		super("devops", "2021-06-25", "CreateCheckRun");
		setProtocol(ProtocolType.HTTPS);
		setUriPattern("/api/v4/projects/check_runs/create_check_run");
	...
	@Override
	public Class<CreateCheckRunResponse> getResponseClass() {
		return CreateCheckRunResponse.class;
	}
