 ...
 * @version 
 */
public class DescribeMPCoSAuthorizedInfoRequest extends RpcAcsRequest<DescribeMPCoSAuthorizedInfoResponse> {
	...
	public DescribeMPCoSAuthorizedInfoRequest() {
		super("ltl", "2019-05-10", "DescribeMPCoSAuthorizedInfo");
	...
	@Override
	public Class<DescribeMPCoSAuthorizedInfoResponse> getResponseClass() {
		return DescribeMPCoSAuthorizedInfoResponse.class;
	}
