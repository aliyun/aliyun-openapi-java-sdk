 ...
 * @version 
 */
public class AttachDataWithSignatureRequest extends RpcAcsRequest<AttachDataWithSignatureResponse> {
	...
	public AttachDataWithSignatureRequest() {
		super("ltl", "2019-05-10", "AttachDataWithSignature");
	...
	@Override
	public Class<AttachDataWithSignatureResponse> getResponseClass() {
		return AttachDataWithSignatureResponse.class;
	}
