 ...
 * @version 
 */
public class BatchUploadMPCoSPhaseDigestInfoRequest extends RpcAcsRequest<BatchUploadMPCoSPhaseDigestInfoResponse> {
	...
	public BatchUploadMPCoSPhaseDigestInfoRequest() {
		super("ltl", "2019-05-10", "BatchUploadMPCoSPhaseDigestInfo");
	...
	@Override
	public Class<BatchUploadMPCoSPhaseDigestInfoResponse> getResponseClass() {
		return BatchUploadMPCoSPhaseDigestInfoResponse.class;
	}
