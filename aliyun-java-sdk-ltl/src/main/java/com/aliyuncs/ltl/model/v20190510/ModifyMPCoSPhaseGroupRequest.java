 ...
 * @version 
 */
public class ModifyMPCoSPhaseGroupRequest extends RpcAcsRequest<ModifyMPCoSPhaseGroupResponse> {
	...
	public ModifyMPCoSPhaseGroupRequest() {
		super("ltl", "2019-05-10", "ModifyMPCoSPhaseGroup");
	...
	@Override
	public Class<ModifyMPCoSPhaseGroupResponse> getResponseClass() {
		return ModifyMPCoSPhaseGroupResponse.class;
	}
