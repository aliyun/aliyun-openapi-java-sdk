 ...
 * @version 
 */
public class ApplyDataModelConfigInfoRequest extends RpcAcsRequest<ApplyDataModelConfigInfoResponse> {
	...
	public ApplyDataModelConfigInfoRequest() {
		super("ltl", "2019-05-10", "ApplyDataModelConfigInfo");
	...
	public void setDataModelCode(String dataModelCode) {
		...
		if(dataModelCode != null){
			putQueryParameter("DataModelCode", dataModelCode);
		}
	}

	@Override
	public Class<ApplyDataModelConfigInfoResponse> getResponseClass() {
		return ApplyDataModelConfigInfoResponse.class;
	}
