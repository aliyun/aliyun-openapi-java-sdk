 ...
 * @version 
 */
public class CreateMPCoSPhaseRequest extends RpcAcsRequest<CreateMPCoSPhaseResponse> {
	...
	public CreateMPCoSPhaseRequest() {
		super("ltl", "2019-05-10", "CreateMPCoSPhase");
	...
	@Override
	public Class<CreateMPCoSPhaseResponse> getResponseClass() {
		return CreateMPCoSPhaseResponse.class;
	}
