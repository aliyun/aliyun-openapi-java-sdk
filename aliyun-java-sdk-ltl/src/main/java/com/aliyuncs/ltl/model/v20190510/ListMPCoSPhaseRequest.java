 ...
 * @version 
 */
public class ListMPCoSPhaseRequest extends RpcAcsRequest<ListMPCoSPhaseResponse> {
	...
	public ListMPCoSPhaseRequest() {
		super("ltl", "2019-05-10", "ListMPCoSPhase");
	...
	@Override
	public Class<ListMPCoSPhaseResponse> getResponseClass() {
		return ListMPCoSPhaseResponse.class;
	}
