 ...
 * @version 
 */
public class BatchUploadMPCoSPhaseTextInfoByDeviceRequest extends RpcAcsRequest<BatchUploadMPCoSPhaseTextInfoByDeviceResponse> {
	...
	public BatchUploadMPCoSPhaseTextInfoByDeviceRequest() {
		super("ltl", "2019-05-10", "BatchUploadMPCoSPhaseTextInfoByDevice");
	...
	@Override
	public Class<BatchUploadMPCoSPhaseTextInfoByDeviceResponse> getResponseClass() {
		return BatchUploadMPCoSPhaseTextInfoByDeviceResponse.class;
	}
