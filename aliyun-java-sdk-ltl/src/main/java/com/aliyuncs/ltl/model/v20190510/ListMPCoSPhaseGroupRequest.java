 ...
 * @version 
 */
public class ListMPCoSPhaseGroupRequest extends RpcAcsRequest<ListMPCoSPhaseGroupResponse> {
	...
	public ListMPCoSPhaseGroupRequest() {
		super("ltl", "2019-05-10", "ListMPCoSPhaseGroup");
	...
	@Override
	public Class<ListMPCoSPhaseGroupResponse> getResponseClass() {
		return ListMPCoSPhaseGroupResponse.class;
	}
