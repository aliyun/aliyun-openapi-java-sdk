 ...
 * @version 
 */
public class UploadMPCoSPhaseDigestInfoRequest extends RpcAcsRequest<UploadMPCoSPhaseDigestInfoResponse> {
	...
	public UploadMPCoSPhaseDigestInfoRequest() {
		super("ltl", "2019-05-10", "UploadMPCoSPhaseDigestInfo");
	...
	@Override
	public Class<UploadMPCoSPhaseDigestInfoResponse> getResponseClass() {
		return UploadMPCoSPhaseDigestInfoResponse.class;
	}
