 ...
 * @version 
 */
public class RegisterDeviceGroupRequest extends RpcAcsRequest<RegisterDeviceGroupResponse> {
	...
	public RegisterDeviceGroupRequest() {
		super("ltl", "2019-05-10", "RegisterDeviceGroup");
	...
	public void setAuthorizeType(String authorizeType) {
		...
		if(authorizeType != null){
			putQueryParameter("AuthorizeType", authorizeType);
		}
	}
	...
	@Override
	public Class<RegisterDeviceGroupResponse> getResponseClass() {
		return RegisterDeviceGroupResponse.class;
	}
