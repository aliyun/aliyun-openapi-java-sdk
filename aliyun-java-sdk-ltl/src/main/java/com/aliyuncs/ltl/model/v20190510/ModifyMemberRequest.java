 ...
 * @version 
 */
public class ModifyMemberRequest extends RpcAcsRequest<ModifyMemberResponse> {
	...
	public ModifyMemberRequest() {
		super("ltl", "2019-05-10", "ModifyMember");
	...
	@Override
	public Class<ModifyMemberResponse> getResponseClass() {
		return ModifyMemberResponse.class;
	}
