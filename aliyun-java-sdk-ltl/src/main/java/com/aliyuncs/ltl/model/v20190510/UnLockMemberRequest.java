 ...
 * @version 
 */
public class UnLockMemberRequest extends RpcAcsRequest<UnLockMemberResponse> {
	...
	public UnLockMemberRequest() {
		super("ltl", "2019-05-10", "UnLockMember");
	...
	@Override
	public Class<UnLockMemberResponse> getResponseClass() {
		return UnLockMemberResponse.class;
	}
