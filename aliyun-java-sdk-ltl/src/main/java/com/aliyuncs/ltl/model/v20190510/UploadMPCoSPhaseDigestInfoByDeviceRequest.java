 ...
 * @version 
 */
public class UploadMPCoSPhaseDigestInfoByDeviceRequest extends RpcAcsRequest<UploadMPCoSPhaseDigestInfoByDeviceResponse> {
	...
	public UploadMPCoSPhaseDigestInfoByDeviceRequest() {
		super("ltl", "2019-05-10", "UploadMPCoSPhaseDigestInfoByDevice");
	...
	@Override
	public Class<UploadMPCoSPhaseDigestInfoByDeviceResponse> getResponseClass() {
		return UploadMPCoSPhaseDigestInfoByDeviceResponse.class;
	}
