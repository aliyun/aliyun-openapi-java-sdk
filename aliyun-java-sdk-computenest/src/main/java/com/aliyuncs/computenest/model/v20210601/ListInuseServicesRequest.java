 ...
 * @version 
 */
public class ListInuseServicesRequest extends RpcAcsRequest<ListInuseServicesResponse> {
	...
	public ListInuseServicesRequest() {
		super("ComputeNest", "2021-06-01", "ListInuseServices");
	...
	@Override
	public Class<ListInuseServicesResponse> getResponseClass() {
		return ListInuseServicesResponse.class;
	}
