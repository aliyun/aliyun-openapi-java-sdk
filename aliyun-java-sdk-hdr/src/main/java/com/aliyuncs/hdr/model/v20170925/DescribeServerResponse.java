...
import com.aliyuncs.hdr.transform.v20170925.DescribeServerResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeServerResponse extends AcsResponse {
	...
	@Override
	public DescribeServerResponse getInstance(UnmarshallerContext context) {
		return	DescribeServerResponseUnmarshaller.unmarshall(this, context);
	}
}
