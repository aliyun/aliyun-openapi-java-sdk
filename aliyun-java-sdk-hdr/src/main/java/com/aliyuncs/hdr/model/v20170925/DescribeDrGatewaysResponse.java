...
import com.aliyuncs.hdr.transform.v20170925.DescribeDrGatewaysResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeDrGatewaysResponse extends AcsResponse {
	...
	private List<Gateway> drGateways;
	...
	public List<Gateway> getDrGateways() {
		return this.drGateways;
	}

	public void setDrGateways(List<Gateway> drGateways) {
	...
	@Override
	public DescribeDrGatewaysResponse getInstance(UnmarshallerContext context) {
		return	DescribeDrGatewaysResponseUnmarshaller.unmarshall(this, context);
	}
}
