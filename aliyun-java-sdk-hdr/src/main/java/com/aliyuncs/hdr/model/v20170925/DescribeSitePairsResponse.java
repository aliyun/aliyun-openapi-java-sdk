...
import com.aliyuncs.hdr.transform.v20170925.DescribeSitePairsResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeSitePairsResponse extends AcsResponse {
	...
	private List<SitePair> sitePairs;
	...
	public List<SitePair> getSitePairs() {
		return this.sitePairs;
	}

	public void setSitePairs(List<SitePair> sitePairs) {
	...
	@Override
	public DescribeSitePairsResponse getInstance(UnmarshallerContext context) {
		return	DescribeSitePairsResponseUnmarshaller.unmarshall(this, context);
	}
}
