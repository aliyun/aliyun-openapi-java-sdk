 ...
 * @version 
 */
public class AddInfrastructureRequest extends RpcAcsRequest<AddInfrastructureResponse> {
	...
	@Override
	public Class<AddInfrastructureResponse> getResponseClass() {
		return AddInfrastructureResponse.class;
	}
