 ...
 * @version 
 */
public class ReportReplicationErrorRequest extends RpcAcsRequest<ReportReplicationErrorResponse> {
	...
	@Override
	public Class<ReportReplicationErrorResponse> getResponseClass() {
		return ReportReplicationErrorResponse.class;
	}
