 ...
 * @version 
 */
public class ReportDataPruneStatusRequest extends RpcAcsRequest<ReportDataPruneStatusResponse> {
	...
	@Override
	public Class<ReportDataPruneStatusResponse> getResponseClass() {
		return ReportDataPruneStatusResponse.class;
	}
