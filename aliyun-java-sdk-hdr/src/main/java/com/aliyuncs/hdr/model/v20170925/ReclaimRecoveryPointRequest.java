 ...
 * @version 
 */
public class ReclaimRecoveryPointRequest extends RpcAcsRequest<ReclaimRecoveryPointResponse> {
	...
	@Override
	public Class<ReclaimRecoveryPointResponse> getResponseClass() {
		return ReclaimRecoveryPointResponse.class;
	}
