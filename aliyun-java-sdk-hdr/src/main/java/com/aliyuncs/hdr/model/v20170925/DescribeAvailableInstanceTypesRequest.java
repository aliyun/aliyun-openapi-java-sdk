 ...
 * @version 
 */
public class DescribeAvailableInstanceTypesRequest extends RpcAcsRequest<DescribeAvailableInstanceTypesResponse> {
	...
	@Override
	public Class<DescribeAvailableInstanceTypesResponse> getResponseClass() {
		return DescribeAvailableInstanceTypesResponse.class;
	}
