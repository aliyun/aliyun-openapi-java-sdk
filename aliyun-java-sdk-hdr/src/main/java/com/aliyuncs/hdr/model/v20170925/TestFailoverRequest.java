 ...
 * @version 
 */
public class TestFailoverRequest extends RpcAcsRequest<TestFailoverResponse> {
	...
	@Override
	public Class<TestFailoverResponse> getResponseClass() {
		return TestFailoverResponse.class;
	}
