...
import com.aliyuncs.hdr.model.v20170925.DescribeTaskResponse;
...
public class DescribeTaskResponseUnmarshaller {
	...
	public static DescribeTaskResponse unmarshall(DescribeTaskResponse describeTaskResponse, UnmarshallerContext _ctx) {
		...
		describeTaskResponse.setTaskId(_ctx.stringValue("DescribeTaskResponse.TaskId"));
		describeTaskResponse.setStatusCode(_ctx.stringValue("DescribeTaskResponse.StatusCode"));
		describeTaskResponse.setStatusParams(_ctx.stringValue("DescribeTaskResponse.StatusParams"));
		describeTaskResponse.setContent(_ctx.stringValue("DescribeTaskResponse.Content"));
