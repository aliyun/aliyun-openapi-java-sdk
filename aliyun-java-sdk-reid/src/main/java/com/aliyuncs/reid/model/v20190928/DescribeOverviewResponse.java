...
import com.aliyuncs.reid.transform.v20190928.DescribeOverviewResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeOverviewResponse extends AcsResponse {
	...
	@Override
	public DescribeOverviewResponse getInstance(UnmarshallerContext context) {
		return	DescribeOverviewResponseUnmarshaller.unmarshall(this, context);
	}
}
