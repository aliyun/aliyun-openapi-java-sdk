...
import com.aliyuncs.reid.transform.v20190928.DescribeCameraStatisticResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeCameraStatisticResponse extends AcsResponse {
	...
	@Override
	public DescribeCameraStatisticResponse getInstance(UnmarshallerContext context) {
		return	DescribeCameraStatisticResponseUnmarshaller.unmarshall(this, context);
	}
}
