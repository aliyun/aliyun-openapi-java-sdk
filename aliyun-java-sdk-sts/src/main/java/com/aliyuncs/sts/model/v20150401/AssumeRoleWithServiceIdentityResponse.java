...
public class AssumeRoleWithServiceIdentityResponse extends AcsResponse {
	...
	@Override
	public AssumeRoleWithServiceIdentityResponse getInstance(UnmarshallerContext context) {
		return	AssumeRoleWithServiceIdentityResponseUnmarshaller.unmarshall(this, context);
	}
}
