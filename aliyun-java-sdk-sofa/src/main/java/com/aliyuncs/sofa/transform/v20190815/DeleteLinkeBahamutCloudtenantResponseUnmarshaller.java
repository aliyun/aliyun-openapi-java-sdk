...
import com.aliyuncs.sofa.model.v20190815.DeleteLinkeBahamutCloudtenantResponse;
import com.aliyuncs.transform.UnmarshallerContext;


public class DeleteLinkeBahamutCloudtenantResponseUnmarshaller {

	public static DeleteLinkeBahamutCloudtenantResponse unmarshall(DeleteLinkeBahamutCloudtenantResponse deleteLinkeBahamutCloudtenantResponse, UnmarshallerContext _ctx) {
		
		deleteLinkeBahamutCloudtenantResponse.setRequestId(_ctx.stringValue("DeleteLinkeBahamutCloudtenantResponse.RequestId"));
		...
		deleteLinkeBahamutCloudtenantResponse.setSuccess(_ctx.booleanValue("DeleteLinkeBahamutCloudtenantResponse.Success"));
	 	...
	 	return deleteLinkeBahamutCloudtenantResponse;
	}
}