...
import com.aliyuncs.sofa.transform.v20190815.AddLinkeantcodeAntcodeProjectsidinstallationsResponseUnmarshaller;
 ...
 * @version 
 */
public class AddLinkeantcodeAntcodeProjectsidinstallationsResponse extends AcsResponse {
	...
	@Override
	public AddLinkeantcodeAntcodeProjectsidinstallationsResponse getInstance(UnmarshallerContext context) {
		return	AddLinkeantcodeAntcodeProjectsidinstallationsResponseUnmarshaller.unmarshall(this, context);
	}
