...
import com.aliyuncs.sofa.transform.v20190815.GetLinkeLinktWorkflowResponseUnmarshaller;
 ...
 * @version 
 */
public class GetLinkeLinktWorkflowResponse extends AcsResponse {
	...
	@Override
	public GetLinkeLinktWorkflowResponse getInstance(UnmarshallerContext context) {
		return	GetLinkeLinktWorkflowResponseUnmarshaller.unmarshall(this, context);
	}
