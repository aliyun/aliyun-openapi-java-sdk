 ...
 * @version 
 */
public class SetLinkeBahamutWriteflagRequest extends RpcAcsRequest<SetLinkeBahamutWriteflagResponse> {
	...
	@Override
	public Class<SetLinkeBahamutWriteflagResponse> getResponseClass() {
		return SetLinkeBahamutWriteflagResponse.class;
	}
