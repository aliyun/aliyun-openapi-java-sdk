...
import com.aliyuncs.sofa.transform.v20190815.CreateLinkeLinktTemplateResponseUnmarshaller;
 ...
 * @version 
 */
public class CreateLinkeLinktTemplateResponse extends AcsResponse {
	...
	@Override
	public CreateLinkeLinktTemplateResponse getInstance(UnmarshallerContext context) {
		return	CreateLinkeLinktTemplateResponseUnmarshaller.unmarshall(this, context);
	}
