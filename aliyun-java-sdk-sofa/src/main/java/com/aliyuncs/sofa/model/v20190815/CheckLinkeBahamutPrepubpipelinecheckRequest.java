 ...
 * @version 
 */
public class CheckLinkeBahamutPrepubpipelinecheckRequest extends RpcAcsRequest<CheckLinkeBahamutPrepubpipelinecheckResponse> {
	...
	@Override
	public Class<CheckLinkeBahamutPrepubpipelinecheckResponse> getResponseClass() {
		return CheckLinkeBahamutPrepubpipelinecheckResponse.class;
	}
