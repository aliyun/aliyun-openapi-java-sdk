 ...
 * @version 
 */
public class UpdateLinkeLinktWorkflowstatusRequest extends RpcAcsRequest<UpdateLinkeLinktWorkflowstatusResponse> {
	...
	public UpdateLinkeLinktWorkflowstatusRequest() {
		super("SOFA", "2019-08-15", "UpdateLinkeLinktWorkflowstatus", "ApplySidecarCert");
	...
	@Override
	public Class<UpdateLinkeLinktWorkflowstatusResponse> getResponseClass() {
		return UpdateLinkeLinktWorkflowstatusResponse.class;
	}
