...
import com.aliyuncs.sofa.transform.v20190815.QueryMsSgServicePublishersResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryMsSgServicePublishersResponse extends AcsResponse {
	...
	@Override
	public QueryMsSgServicePublishersResponse getInstance(UnmarshallerContext context) {
		return	QueryMsSgServicePublishersResponseUnmarshaller.unmarshall(this, context);
	}
