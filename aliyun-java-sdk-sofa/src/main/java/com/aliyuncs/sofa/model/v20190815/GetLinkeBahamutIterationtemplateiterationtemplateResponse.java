...
import com.aliyuncs.sofa.transform.v20190815.GetLinkeBahamutIterationtemplateiterationtemplateResponseUnmarshaller;
 ...
 * @version 
 */
public class GetLinkeBahamutIterationtemplateiterationtemplateResponse extends AcsResponse {
	...
	@Override
	public GetLinkeBahamutIterationtemplateiterationtemplateResponse getInstance(UnmarshallerContext context) {
		return	GetLinkeBahamutIterationtemplateiterationtemplateResponseUnmarshaller.unmarshall(this, context);
	}
