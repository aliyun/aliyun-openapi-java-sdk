 ...
 * @version 
 */
public class CheckLinkeBahamutStctaskRequest extends RpcAcsRequest<CheckLinkeBahamutStctaskResponse> {
	...
	@Override
	public Class<CheckLinkeBahamutStctaskResponse> getResponseClass() {
		return CheckLinkeBahamutStctaskResponse.class;
	}
