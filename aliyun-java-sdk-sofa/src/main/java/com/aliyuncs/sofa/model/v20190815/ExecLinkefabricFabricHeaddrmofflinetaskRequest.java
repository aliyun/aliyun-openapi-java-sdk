 ...
 * @version 
 */
public class ExecLinkefabricFabricHeaddrmofflinetaskRequest extends RpcAcsRequest<ExecLinkefabricFabricHeaddrmofflinetaskResponse> {
	...
	public ExecLinkefabricFabricHeaddrmofflinetaskRequest() {
		super("SOFA", "2019-08-15", "ExecLinkefabricFabricHeaddrmofflinetask", "sofacafedeps");
	...
	@Override
	public Class<ExecLinkefabricFabricHeaddrmofflinetaskResponse> getResponseClass() {
		return ExecLinkefabricFabricHeaddrmofflinetaskResponse.class;
	}
