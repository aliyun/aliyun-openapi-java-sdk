 ...
 * @version 
 */
public class ExecLinkeLinktSearchtagRequest extends RpcAcsRequest<ExecLinkeLinktSearchtagResponse> {
	...
	@Override
	public Class<ExecLinkeLinktSearchtagResponse> getResponseClass() {
		return ExecLinkeLinktSearchtagResponse.class;
	}
