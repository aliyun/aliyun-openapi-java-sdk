 ...
 * @version 
 */
public class UpdateAKSBuildConfigRequest extends RpcAcsRequest<UpdateAKSBuildConfigResponse> {
	...
	public UpdateAKSBuildConfigRequest() {
		super("SOFA", "2019-08-15", "UpdateAKSBuildConfig", "ApplySidecarCert");
	...
	@Override
	public Class<UpdateAKSBuildConfigResponse> getResponseClass() {
		return UpdateAKSBuildConfigResponse.class;
	}
