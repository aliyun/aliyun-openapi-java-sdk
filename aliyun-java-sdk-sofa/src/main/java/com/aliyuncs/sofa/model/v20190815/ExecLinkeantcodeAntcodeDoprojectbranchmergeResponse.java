...
import com.aliyuncs.sofa.transform.v20190815.ExecLinkeantcodeAntcodeDoprojectbranchmergeResponseUnmarshaller;
 ...
 * @version 
 */
public class ExecLinkeantcodeAntcodeDoprojectbranchmergeResponse extends AcsResponse {
	...
	@Override
	public ExecLinkeantcodeAntcodeDoprojectbranchmergeResponse getInstance(UnmarshallerContext context) {
		return	ExecLinkeantcodeAntcodeDoprojectbranchmergeResponseUnmarshaller.unmarshall(this, context);
	}
