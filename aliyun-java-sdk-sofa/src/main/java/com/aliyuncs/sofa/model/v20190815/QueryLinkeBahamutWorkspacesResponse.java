...
import com.aliyuncs.sofa.transform.v20190815.QueryLinkeBahamutWorkspacesResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryLinkeBahamutWorkspacesResponse extends AcsResponse {
	...
	@Override
	public QueryLinkeBahamutWorkspacesResponse getInstance(UnmarshallerContext context) {
		return	QueryLinkeBahamutWorkspacesResponseUnmarshaller.unmarshall(this, context);
	}
