 ...
 * @version 
 */
public class ExecLinkefabricFabricPatchdrmtaskRequest extends RpcAcsRequest<ExecLinkefabricFabricPatchdrmtaskResponse> {
	...
	public ExecLinkefabricFabricPatchdrmtaskRequest() {
		super("SOFA", "2019-08-15", "ExecLinkefabricFabricPatchdrmtask", "sofacafedeps");
	...
	@Override
	public Class<ExecLinkefabricFabricPatchdrmtaskResponse> getResponseClass() {
		return ExecLinkefabricFabricPatchdrmtaskResponse.class;
	}
