 ...
 * @version 
 */
public class QueryLinkeLinktRelatedworkitemsRequest extends RpcAcsRequest<QueryLinkeLinktRelatedworkitemsResponse> {
	   

	private String workItemRelationType;

	private String workItemSign;
	public QueryLinkeLinktRelatedworkitemsRequest() {
		super("SOFA", "2019-08-15", "QueryLinkeLinktRelatedworkitems", "sofacafedeps");
	...
	@Override
	public Class<QueryLinkeLinktRelatedworkitemsResponse> getResponseClass() {
		return QueryLinkeLinktRelatedworkitemsResponse.class;
	}
