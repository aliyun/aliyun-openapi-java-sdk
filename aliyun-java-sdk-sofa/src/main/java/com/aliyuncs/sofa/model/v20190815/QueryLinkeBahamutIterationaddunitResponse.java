...
import com.aliyuncs.sofa.transform.v20190815.QueryLinkeBahamutIterationaddunitResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryLinkeBahamutIterationaddunitResponse extends AcsResponse {
	...
	@Override
	public QueryLinkeBahamutIterationaddunitResponse getInstance(UnmarshallerContext context) {
		return	QueryLinkeBahamutIterationaddunitResponseUnmarshaller.unmarshall(this, context);
	}
