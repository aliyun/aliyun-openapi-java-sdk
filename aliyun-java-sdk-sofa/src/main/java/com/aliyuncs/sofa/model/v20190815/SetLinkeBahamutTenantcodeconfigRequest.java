 ...
 * @version 
 */
public class SetLinkeBahamutTenantcodeconfigRequest extends RpcAcsRequest<SetLinkeBahamutTenantcodeconfigResponse> {
	...
	public SetLinkeBahamutTenantcodeconfigRequest() {
		super("SOFA", "2019-08-15", "SetLinkeBahamutTenantcodeconfig", "ApplySidecarCert");
	...
	public void setMyCodeCenterHost(String myCodeCenterHost) {
		...
		if(myCodeCenterHost != null){
			putBodyParameter("MyCodeCenterHost", myCodeCenterHost);
		}
	}
	...
	@Override
	public Class<SetLinkeBahamutTenantcodeconfigResponse> getResponseClass() {
		return SetLinkeBahamutTenantcodeconfigResponse.class;
	}
