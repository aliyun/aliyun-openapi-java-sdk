...
import com.aliyuncs.sofa.transform.v20190815.QueryLinkefabricFabricCiconfigsResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryLinkefabricFabricCiconfigsResponse extends AcsResponse {
	...
	@Override
	public QueryLinkefabricFabricCiconfigsResponse getInstance(UnmarshallerContext context) {
		return	QueryLinkefabricFabricCiconfigsResponseUnmarshaller.unmarshall(this, context);
	}
