...
import com.aliyuncs.sofa.transform.v20190815.GetLinkeBahamutIterationgetrelatelatestiterationResponseUnmarshaller;
 ...
 * @version 
 */
public class GetLinkeBahamutIterationgetrelatelatestiterationResponse extends AcsResponse {
	...
	@Override
	public GetLinkeBahamutIterationgetrelatelatestiterationResponse getInstance(UnmarshallerContext context) {
		return	GetLinkeBahamutIterationgetrelatelatestiterationResponseUnmarshaller.unmarshall(this, context);
	}
