...
import com.aliyuncs.sofa.transform.v20190815.CreateAKSSecretResponseUnmarshaller;
 ...
 * @version 
 */
public class CreateAKSSecretResponse extends AcsResponse {
	...
	@Override
	public CreateAKSSecretResponse getInstance(UnmarshallerContext context) {
		return	CreateAKSSecretResponseUnmarshaller.unmarshall(this, context);
	}
