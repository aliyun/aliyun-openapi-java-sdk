...
import com.aliyuncs.sofa.transform.v20190815.ListLinkeLinktCustomfieldsResponseUnmarshaller;
 ...
 * @version 
 */
public class ListLinkeLinktCustomfieldsResponse extends AcsResponse {
	...
	@Override
	public ListLinkeLinktCustomfieldsResponse getInstance(UnmarshallerContext context) {
		return	ListLinkeLinktCustomfieldsResponseUnmarshaller.unmarshall(this, context);
	}
