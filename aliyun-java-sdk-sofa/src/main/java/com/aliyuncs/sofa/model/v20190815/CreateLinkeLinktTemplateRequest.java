 ...
 * @version 
 */
public class CreateLinkeLinktTemplateRequest extends RpcAcsRequest<CreateLinkeLinktTemplateResponse> {
	...
	public CreateLinkeLinktTemplateRequest() {
		super("SOFA", "2019-08-15", "CreateLinkeLinktTemplate", "ApplySidecarCert");
	...
	@Override
	public Class<CreateLinkeLinktTemplateResponse> getResponseClass() {
		return CreateLinkeLinktTemplateResponse.class;
	}
