 ...
 * @version 
 */
public class QueryODPSchemasRequest extends RpcAcsRequest<QueryODPSchemasResponse> {
	...
	public QueryODPSchemasRequest() {
		super("SOFA", "2019-08-15", "QueryODPSchemas", "ApplySidecarCert");
	...
	@Override
	public Class<QueryODPSchemasResponse> getResponseClass() {
		return QueryODPSchemasResponse.class;
	}
