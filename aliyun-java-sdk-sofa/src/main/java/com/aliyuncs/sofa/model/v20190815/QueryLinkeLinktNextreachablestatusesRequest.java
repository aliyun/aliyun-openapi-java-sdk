 ...
 * @version 
 */
public class QueryLinkeLinktNextreachablestatusesRequest extends RpcAcsRequest<QueryLinkeLinktNextreachablestatusesResponse> {
	...
	@Override
	public Class<QueryLinkeLinktNextreachablestatusesResponse> getResponseClass() {
		return QueryLinkeLinktNextreachablestatusesResponse.class;
	}
