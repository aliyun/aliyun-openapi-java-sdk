...
import com.aliyuncs.sofa.transform.v20190815.UpdateLinkeantcodeAntcodeNamespacesidservicesResponseUnmarshaller;
 ...
 * @version 
 */
public class UpdateLinkeantcodeAntcodeNamespacesidservicesResponse extends AcsResponse {
	...
	@Override
	public UpdateLinkeantcodeAntcodeNamespacesidservicesResponse getInstance(UnmarshallerContext context) {
		return	UpdateLinkeantcodeAntcodeNamespacesidservicesResponseUnmarshaller.unmarshall(this, context);
	}
