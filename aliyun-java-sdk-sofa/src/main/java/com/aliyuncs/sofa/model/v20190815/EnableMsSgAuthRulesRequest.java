 ...
 * @version 
 */
public class EnableMsSgAuthRulesRequest extends RpcAcsRequest<EnableMsSgAuthRulesResponse> {
	...
	public EnableMsSgAuthRulesRequest() {
		super("SOFA", "2019-08-15", "EnableMsSgAuthRules", "sofacafedeps");
	...
	@Override
	public Class<EnableMsSgAuthRulesResponse> getResponseClass() {
		return EnableMsSgAuthRulesResponse.class;
	}
