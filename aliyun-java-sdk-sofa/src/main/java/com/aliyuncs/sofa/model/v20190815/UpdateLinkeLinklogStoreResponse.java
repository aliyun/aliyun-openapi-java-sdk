...
import com.aliyuncs.sofa.transform.v20190815.UpdateLinkeLinklogStoreResponseUnmarshaller;
 ...
 * @version 
 */
public class UpdateLinkeLinklogStoreResponse extends AcsResponse {
	...
	@Override
	public UpdateLinkeLinklogStoreResponse getInstance(UnmarshallerContext context) {
		return	UpdateLinkeLinklogStoreResponseUnmarshaller.unmarshall(this, context);
	}
