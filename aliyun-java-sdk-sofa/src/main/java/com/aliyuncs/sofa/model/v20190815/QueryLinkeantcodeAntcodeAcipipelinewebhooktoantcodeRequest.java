 ...
 * @version 
 */
public class QueryLinkeantcodeAntcodeAcipipelinewebhooktoantcodeRequest extends RpcAcsRequest<QueryLinkeantcodeAntcodeAcipipelinewebhooktoantcodeResponse> {
	...
	@Override
	public Class<QueryLinkeantcodeAntcodeAcipipelinewebhooktoantcodeResponse> getResponseClass() {
		return QueryLinkeantcodeAntcodeAcipipelinewebhooktoantcodeResponse.class;
	}
