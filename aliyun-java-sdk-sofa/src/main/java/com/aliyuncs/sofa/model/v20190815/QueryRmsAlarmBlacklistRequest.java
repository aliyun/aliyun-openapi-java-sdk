 ...
 * @version 
 */
public class QueryRmsAlarmBlacklistRequest extends RpcAcsRequest<QueryRmsAlarmBlacklistResponse> {
	...
	public QueryRmsAlarmBlacklistRequest() {
		super("SOFA", "2019-08-15", "QueryRmsAlarmBlacklist", "ApplySidecarCert");
	...
	@Override
	public Class<QueryRmsAlarmBlacklistResponse> getResponseClass() {
		return QueryRmsAlarmBlacklistResponse.class;
	}
