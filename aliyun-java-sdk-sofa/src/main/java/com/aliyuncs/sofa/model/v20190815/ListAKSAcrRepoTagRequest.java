 ...
 * @version 
 */
public class ListAKSAcrRepoTagRequest extends RpcAcsRequest<ListAKSAcrRepoTagResponse> {
	...
	public ListAKSAcrRepoTagRequest() {
		super("SOFA", "2019-08-15", "ListAKSAcrRepoTag", "sofacafedeps");
	...
	@Override
	public Class<ListAKSAcrRepoTagResponse> getResponseClass() {
		return ListAKSAcrRepoTagResponse.class;
	}
