 ...
 * @version 
 */
public class AddLinkeantcodeAntcodeHookRequest extends RpcAcsRequest<AddLinkeantcodeAntcodeHookResponse> {
	...
	public AddLinkeantcodeAntcodeHookRequest() {
		super("SOFA", "2019-08-15", "AddLinkeantcodeAntcodeHook", "sofacafedeps");
	...
	public void setBuildEvents(String buildEvents) {
		...
		if(buildEvents != null){
			putBodyParameter("BuildEvents", buildEvents);
		}
	}
	...
	@Override
	public Class<AddLinkeantcodeAntcodeHookResponse> getResponseClass() {
		return AddLinkeantcodeAntcodeHookResponse.class;
	}
