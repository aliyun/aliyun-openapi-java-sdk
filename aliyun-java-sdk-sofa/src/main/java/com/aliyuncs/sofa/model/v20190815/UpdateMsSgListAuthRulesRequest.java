 ...
 * @version 
 */
public class UpdateMsSgListAuthRulesRequest extends RpcAcsRequest<UpdateMsSgListAuthRulesResponse> {
	...
	@Override
	public Class<UpdateMsSgListAuthRulesResponse> getResponseClass() {
		return UpdateMsSgListAuthRulesResponse.class;
	}
