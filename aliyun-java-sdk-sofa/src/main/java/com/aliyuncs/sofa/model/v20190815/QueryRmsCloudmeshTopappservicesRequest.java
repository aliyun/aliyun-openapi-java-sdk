 ...
 * @version 
 */
public class QueryRmsCloudmeshTopappservicesRequest extends RpcAcsRequest<QueryRmsCloudmeshTopappservicesResponse> {
	...
	public QueryRmsCloudmeshTopappservicesRequest() {
		super("SOFA", "2019-08-15", "QueryRmsCloudmeshTopappservices", "sofacafedeps");
	...
	@Override
	public Class<QueryRmsCloudmeshTopappservicesResponse> getResponseClass() {
		return QueryRmsCloudmeshTopappservicesResponse.class;
	}
