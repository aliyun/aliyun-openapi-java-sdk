 ...
 * @version 
 */
public class QueryRmsResourcesRequest extends RpcAcsRequest<QueryRmsResourcesResponse> {
	   

	private String envJsonStr;

	private String queryJsonStr;
	public QueryRmsResourcesRequest() {
		super("SOFA", "2019-08-15", "QueryRmsResources", "ApplySidecarCert");
	...
	@Override
	public Class<QueryRmsResourcesResponse> getResponseClass() {
		return QueryRmsResourcesResponse.class;
	}
