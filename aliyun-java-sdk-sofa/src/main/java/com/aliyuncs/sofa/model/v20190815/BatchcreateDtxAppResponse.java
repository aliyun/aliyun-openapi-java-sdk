...
import com.aliyuncs.sofa.transform.v20190815.BatchcreateDtxAppResponseUnmarshaller;
 ...
 * @version 
 */
public class BatchcreateDtxAppResponse extends AcsResponse {
	...
	@Override
	public BatchcreateDtxAppResponse getInstance(UnmarshallerContext context) {
		return	BatchcreateDtxAppResponseUnmarshaller.unmarshall(this, context);
	}
