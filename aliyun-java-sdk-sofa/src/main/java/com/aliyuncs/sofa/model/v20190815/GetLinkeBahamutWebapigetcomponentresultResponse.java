...
import com.aliyuncs.sofa.transform.v20190815.GetLinkeBahamutWebapigetcomponentresultResponseUnmarshaller;
 ...
 * @version 
 */
public class GetLinkeBahamutWebapigetcomponentresultResponse extends AcsResponse {
	...
	@Override
	public GetLinkeBahamutWebapigetcomponentresultResponse getInstance(UnmarshallerContext context) {
		return	GetLinkeBahamutWebapigetcomponentresultResponseUnmarshaller.unmarshall(this, context);
	}
