 ...
 * @version 
 */
public class CreateLinkeantcodeAntcodeTenantserviceRequest extends RpcAcsRequest<CreateLinkeantcodeAntcodeTenantserviceResponse> {
	   

	private String requestGitOperate;

	private String createDTOJsonStr;
	public CreateLinkeantcodeAntcodeTenantserviceRequest() {
		super("SOFA", "2019-08-15", "CreateLinkeantcodeAntcodeTenantservice", "sofacafedeps");
	...
	@Override
	public Class<CreateLinkeantcodeAntcodeTenantserviceResponse> getResponseClass() {
		return CreateLinkeantcodeAntcodeTenantserviceResponse.class;
	}
