...
import com.aliyuncs.sofa.transform.v20190815.GetLinkeBahamutAppmetalistResponseUnmarshaller;
 ...
 * @version 
 */
public class GetLinkeBahamutAppmetalistResponse extends AcsResponse {
	...
	@Override
	public GetLinkeBahamutAppmetalistResponse getInstance(UnmarshallerContext context) {
		return	GetLinkeBahamutAppmetalistResponseUnmarshaller.unmarshall(this, context);
	}
