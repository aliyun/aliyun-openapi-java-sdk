...
public class UpdateLinkeLinktMilestonestatusRequest extends RpcAcsRequest<UpdateLinkeLinktMilestonestatusResponse> {
	...
	public UpdateLinkeLinktMilestonestatusRequest() {
		super("SOFA", "2019-08-15", "UpdateLinkeLinktMilestonestatus", "sofacafedeps");
	...
	@Override
	public Class<UpdateLinkeLinktMilestonestatusResponse> getResponseClass() {
		return UpdateLinkeLinktMilestonestatusResponse.class;
	}
