 ...
 * @version 
 */
public class UpdateLinkeLinktTemplateRequest extends RpcAcsRequest<UpdateLinkeLinktTemplateResponse> {
	...
	public UpdateLinkeLinktTemplateRequest() {
		super("SOFA", "2019-08-15", "UpdateLinkeLinktTemplate", "sofacafedeps");
	...
	@Override
	public Class<UpdateLinkeLinktTemplateResponse> getResponseClass() {
		return UpdateLinkeLinktTemplateResponse.class;
	}
