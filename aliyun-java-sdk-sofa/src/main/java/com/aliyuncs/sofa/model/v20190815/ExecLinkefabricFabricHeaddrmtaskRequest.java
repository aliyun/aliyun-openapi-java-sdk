 ...
 * @version 
 */
public class ExecLinkefabricFabricHeaddrmtaskRequest extends RpcAcsRequest<ExecLinkefabricFabricHeaddrmtaskResponse> {
	...
	public ExecLinkefabricFabricHeaddrmtaskRequest() {
		super("SOFA", "2019-08-15", "ExecLinkefabricFabricHeaddrmtask", "sofacafedeps");
	...
	@Override
	public Class<ExecLinkefabricFabricHeaddrmtaskResponse> getResponseClass() {
		return ExecLinkefabricFabricHeaddrmtaskResponse.class;
	}
