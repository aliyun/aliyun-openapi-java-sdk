...
import com.aliyuncs.sofa.transform.v20190815.ModifyAppServiceEnvParamsResponseUnmarshaller;
 ...
 * @version 
 */
public class ModifyAppServiceEnvParamsResponse extends AcsResponse {
	...
	private List<AppServiceEnvParamItem> appServiceEnvParam;
	...
	public List<AppServiceEnvParamItem> getAppServiceEnvParam() {
		return this.appServiceEnvParam;
	}

	public void setAppServiceEnvParam(List<AppServiceEnvParamItem> appServiceEnvParam) {
		this.appServiceEnvParam = appServiceEnvParam;
	}

	public static class AppServiceEnvParamItem {
	...
	@Override
	public ModifyAppServiceEnvParamsResponse getInstance(UnmarshallerContext context) {
		return	ModifyAppServiceEnvParamsResponseUnmarshaller.unmarshall(this, context);
	}
