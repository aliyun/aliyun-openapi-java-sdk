...
import com.aliyuncs.sofa.transform.v20190815.AddLinkeBahamutIterationaddmemberResponseUnmarshaller;
 ...
 * @version 
 */
public class AddLinkeBahamutIterationaddmemberResponse extends AcsResponse {
	...
	@Override
	public AddLinkeBahamutIterationaddmemberResponse getInstance(UnmarshallerContext context) {
		return	AddLinkeBahamutIterationaddmemberResponseUnmarshaller.unmarshall(this, context);
	}
