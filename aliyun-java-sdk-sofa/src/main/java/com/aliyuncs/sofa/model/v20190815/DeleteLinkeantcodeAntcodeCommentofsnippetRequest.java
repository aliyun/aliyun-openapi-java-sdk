 ...
 * @version 
 */
public class DeleteLinkeantcodeAntcodeCommentofsnippetRequest extends RpcAcsRequest<DeleteLinkeantcodeAntcodeCommentofsnippetResponse> {
	...
	@Override
	public Class<DeleteLinkeantcodeAntcodeCommentofsnippetResponse> getResponseClass() {
		return DeleteLinkeantcodeAntcodeCommentofsnippetResponse.class;
	}
