...
import com.aliyuncs.sofa.transform.v20190815.GetLinkeBahamutAlltenantsResponseUnmarshaller;
 ...
 * @version 
 */
public class GetLinkeBahamutAlltenantsResponse extends AcsResponse {
	...
	@Override
	public GetLinkeBahamutAlltenantsResponse getInstance(UnmarshallerContext context) {
		return	GetLinkeBahamutAlltenantsResponseUnmarshaller.unmarshall(this, context);
	}
