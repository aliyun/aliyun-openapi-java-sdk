...
import com.aliyuncs.sofa.transform.v20190815.QueryLinkeBahamutDelbasejarmoduleResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryLinkeBahamutDelbasejarmoduleResponse extends AcsResponse {
	...
	@Override
	public QueryLinkeBahamutDelbasejarmoduleResponse getInstance(UnmarshallerContext context) {
		return	QueryLinkeBahamutDelbasejarmoduleResponseUnmarshaller.unmarshall(this, context);
	}
