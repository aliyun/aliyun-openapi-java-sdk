...
import com.aliyuncs.sofa.transform.v20190815.GetLinkeBahamutIterationsgetlterationResponseUnmarshaller;
 ...
 * @version 
 */
public class GetLinkeBahamutIterationsgetlterationResponse extends AcsResponse {
	...
	@Override
	public GetLinkeBahamutIterationsgetlterationResponse getInstance(UnmarshallerContext context) {
		return	GetLinkeBahamutIterationsgetlterationResponseUnmarshaller.unmarshall(this, context);
	}
