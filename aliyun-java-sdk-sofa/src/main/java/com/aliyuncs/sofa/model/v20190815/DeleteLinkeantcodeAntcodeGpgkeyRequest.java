 ...
 * @version 
 */
public class DeleteLinkeantcodeAntcodeGpgkeyRequest extends RpcAcsRequest<DeleteLinkeantcodeAntcodeGpgkeyResponse> {
	...
	@Override
	public Class<DeleteLinkeantcodeAntcodeGpgkeyResponse> getResponseClass() {
		return DeleteLinkeantcodeAntcodeGpgkeyResponse.class;
	}
