 ...
 * @version 
 */
public class ExecLinkefabricFabricCloudmsgtaskRequest extends RpcAcsRequest<ExecLinkefabricFabricCloudmsgtaskResponse> {
	...
	@Override
	public Class<ExecLinkefabricFabricCloudmsgtaskResponse> getResponseClass() {
		return ExecLinkefabricFabricCloudmsgtaskResponse.class;
	}
