 ...
 * @version 
 */
public class QueryLinkeBahamutPipelinererunRequest extends RpcAcsRequest<QueryLinkeBahamutPipelinererunResponse> {
	...
	public QueryLinkeBahamutPipelinererunRequest() {
		super("SOFA", "2019-08-15", "QueryLinkeBahamutPipelinererun", "sofacafedeps");
	...
	@Override
	public Class<QueryLinkeBahamutPipelinererunResponse> getResponseClass() {
		return QueryLinkeBahamutPipelinererunResponse.class;
	}
