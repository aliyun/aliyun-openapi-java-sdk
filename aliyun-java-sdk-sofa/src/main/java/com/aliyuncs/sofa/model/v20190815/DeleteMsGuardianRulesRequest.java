 ...
 * @version 
 */
public class DeleteMsGuardianRulesRequest extends RpcAcsRequest<DeleteMsGuardianRulesResponse> {
	...
	public DeleteMsGuardianRulesRequest() {
		super("SOFA", "2019-08-15", "DeleteMsGuardianRules", "ApplySidecarCert");
	...
	@Override
	public Class<DeleteMsGuardianRulesResponse> getResponseClass() {
		return DeleteMsGuardianRulesResponse.class;
	}
