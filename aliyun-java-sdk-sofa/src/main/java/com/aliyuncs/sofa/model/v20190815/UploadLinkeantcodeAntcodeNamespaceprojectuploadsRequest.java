 ...
 * @version 
 */
public class UploadLinkeantcodeAntcodeNamespaceprojectuploadsRequest extends RpcAcsRequest<UploadLinkeantcodeAntcodeNamespaceprojectuploadsResponse> {
	...
	@Override
	public Class<UploadLinkeantcodeAntcodeNamespaceprojectuploadsResponse> getResponseClass() {
		return UploadLinkeantcodeAntcodeNamespaceprojectuploadsResponse.class;
	}
