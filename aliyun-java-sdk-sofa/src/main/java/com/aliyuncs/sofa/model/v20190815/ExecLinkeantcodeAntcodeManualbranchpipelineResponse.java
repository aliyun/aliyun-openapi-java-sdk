...
import com.aliyuncs.sofa.transform.v20190815.ExecLinkeantcodeAntcodeManualbranchpipelineResponseUnmarshaller;
 ...
 * @version 
 */
public class ExecLinkeantcodeAntcodeManualbranchpipelineResponse extends AcsResponse {
	...
	@Override
	public ExecLinkeantcodeAntcodeManualbranchpipelineResponse getInstance(UnmarshallerContext context) {
		return	ExecLinkeantcodeAntcodeManualbranchpipelineResponseUnmarshaller.unmarshall(this, context);
	}
