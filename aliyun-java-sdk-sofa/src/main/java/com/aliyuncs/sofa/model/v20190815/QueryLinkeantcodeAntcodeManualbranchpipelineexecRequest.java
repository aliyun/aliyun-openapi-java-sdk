 ...
 * @version 
 */
public class QueryLinkeantcodeAntcodeManualbranchpipelineexecRequest extends RpcAcsRequest<QueryLinkeantcodeAntcodeManualbranchpipelineexecResponse> {
	...
	public void setManualPipelineRequestJsonStr(String manualPipelineRequestJsonStr) {
		this.manualPipelineRequestJsonStr = manualPipelineRequestJsonStr;
		if(manualPipelineRequestJsonStr != null){
			putBodyParameter("ManualPipelineRequestJsonStr", manualPipelineRequestJsonStr);
		}
	}

	@Override
	public Class<QueryLinkeantcodeAntcodeManualbranchpipelineexecResponse> getResponseClass() {
		return QueryLinkeantcodeAntcodeManualbranchpipelineexecResponse.class;
	}
