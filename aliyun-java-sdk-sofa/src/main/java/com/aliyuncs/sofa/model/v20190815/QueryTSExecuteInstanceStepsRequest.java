 ...
 * @version 
 */
public class QueryTSExecuteInstanceStepsRequest extends RpcAcsRequest<QueryTSExecuteInstanceStepsResponse> {
	...
	public QueryTSExecuteInstanceStepsRequest() {
		super("SOFA", "2019-08-15", "QueryTSExecuteInstanceSteps", "sofacafedeps");
	...
	@Override
	public Class<QueryTSExecuteInstanceStepsResponse> getResponseClass() {
		return QueryTSExecuteInstanceStepsResponse.class;
	}
