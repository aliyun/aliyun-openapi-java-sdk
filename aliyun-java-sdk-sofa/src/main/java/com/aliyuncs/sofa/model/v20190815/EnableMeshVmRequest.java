 ...
 * @version 
 */
public class EnableMeshVmRequest extends RpcAcsRequest<EnableMeshVmResponse> {
	...
	@Override
	public Class<EnableMeshVmResponse> getResponseClass() {
		return EnableMeshVmResponse.class;
	}
