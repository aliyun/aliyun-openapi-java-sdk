...
import com.aliyuncs.sofa.transform.v20190815.GetLinkeBahamutIterationgetiterationsResponseUnmarshaller;
 ...
 * @version 
 */
public class GetLinkeBahamutIterationgetiterationsResponse extends AcsResponse {
	...
	@Override
	public GetLinkeBahamutIterationgetiterationsResponse getInstance(UnmarshallerContext context) {
		return	GetLinkeBahamutIterationgetiterationsResponseUnmarshaller.unmarshall(this, context);
	}
