 ...
 * @version 
 */
public class SkipODPJobsSqlbatchRequest extends RpcAcsRequest<SkipODPJobsSqlbatchResponse> {
	...
	public SkipODPJobsSqlbatchRequest() {
		super("SOFA", "2019-08-15", "SkipODPJobsSqlbatch", "sofacafedeps");
	...
	@Override
	public Class<SkipODPJobsSqlbatchResponse> getResponseClass() {
		return SkipODPJobsSqlbatchResponse.class;
	}
