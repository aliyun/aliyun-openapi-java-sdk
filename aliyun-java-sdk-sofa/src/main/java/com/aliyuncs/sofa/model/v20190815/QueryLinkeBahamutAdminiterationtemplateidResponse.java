...
import com.aliyuncs.sofa.transform.v20190815.QueryLinkeBahamutAdminiterationtemplateidResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryLinkeBahamutAdminiterationtemplateidResponse extends AcsResponse {
	...
	@Override
	public QueryLinkeBahamutAdminiterationtemplateidResponse getInstance(UnmarshallerContext context) {
		return	QueryLinkeBahamutAdminiterationtemplateidResponseUnmarshaller.unmarshall(this, context);
	}
