...
import com.aliyuncs.sofa.transform.v20190815.SaveLinkeBahamutAdminiterationtemplateeditstageResponseUnmarshaller;
 ...
 * @version 
 */
public class SaveLinkeBahamutAdminiterationtemplateeditstageResponse extends AcsResponse {
	...
	@Override
	public SaveLinkeBahamutAdminiterationtemplateeditstageResponse getInstance(UnmarshallerContext context) {
		return	SaveLinkeBahamutAdminiterationtemplateeditstageResponseUnmarshaller.unmarshall(this, context);
	}
