 ...
 * @version 
 */
public class QueryODPSqlAuditSummaryRequest extends RpcAcsRequest<QueryODPSqlAuditSummaryResponse> {
	...
	@Override
	public Class<QueryODPSqlAuditSummaryResponse> getResponseClass() {
		return QueryODPSqlAuditSummaryResponse.class;
	}
