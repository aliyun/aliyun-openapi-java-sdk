...
import com.aliyuncs.sofa.transform.v20190815.SetLinkeBahamutEditinstanceResponseUnmarshaller;
 ...
 * @version 
 */
public class SetLinkeBahamutEditinstanceResponse extends AcsResponse {
	...
	@Override
	public SetLinkeBahamutEditinstanceResponse getInstance(UnmarshallerContext context) {
		return	SetLinkeBahamutEditinstanceResponseUnmarshaller.unmarshall(this, context);
	}
