...
import com.aliyuncs.sofa.transform.v20190815.GetLinkeBahamutAppsallResponseUnmarshaller;
 ...
 * @version 
 */
public class GetLinkeBahamutAppsallResponse extends AcsResponse {
	...
	@Override
	public GetLinkeBahamutAppsallResponse getInstance(UnmarshallerContext context) {
		return	GetLinkeBahamutAppsallResponseUnmarshaller.unmarshall(this, context);
	}
