 ...
 * @version 
 */
public class UpdateAKSConfigmapRequest extends RpcAcsRequest<UpdateAKSConfigmapResponse> {
	...
	public UpdateAKSConfigmapRequest() {
		super("SOFA", "2019-08-15", "UpdateAKSConfigmap", "ApplySidecarCert");
	...
	@Override
	public Class<UpdateAKSConfigmapResponse> getResponseClass() {
		return UpdateAKSConfigmapResponse.class;
	}
