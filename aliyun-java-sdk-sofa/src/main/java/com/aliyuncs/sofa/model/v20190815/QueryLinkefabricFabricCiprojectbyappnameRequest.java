 ...
 * @version 
 */
public class QueryLinkefabricFabricCiprojectbyappnameRequest extends RpcAcsRequest<QueryLinkefabricFabricCiprojectbyappnameResponse> {
	...
	public QueryLinkefabricFabricCiprojectbyappnameRequest() {
		super("SOFA", "2019-08-15", "QueryLinkefabricFabricCiprojectbyappname", "sofacafedeps");
	...
	@Override
	public Class<QueryLinkefabricFabricCiprojectbyappnameResponse> getResponseClass() {
		return QueryLinkefabricFabricCiprojectbyappnameResponse.class;
	}
