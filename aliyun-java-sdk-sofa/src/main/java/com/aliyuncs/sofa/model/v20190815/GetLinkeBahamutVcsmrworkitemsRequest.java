 ...
 * @version 
 */
public class GetLinkeBahamutVcsmrworkitemsRequest extends RpcAcsRequest<GetLinkeBahamutVcsmrworkitemsResponse> {
	...
	@Override
	public Class<GetLinkeBahamutVcsmrworkitemsResponse> getResponseClass() {
		return GetLinkeBahamutVcsmrworkitemsResponse.class;
	}
