...
import com.aliyuncs.sofa.transform.v20190815.GetLinkeLinklogStoretokensResponseUnmarshaller;
 ...
 * @version 
 */
public class GetLinkeLinklogStoretokensResponse extends AcsResponse {
	...
	@Override
	public GetLinkeLinklogStoretokensResponse getInstance(UnmarshallerContext context) {
		return	GetLinkeLinklogStoretokensResponseUnmarshaller.unmarshall(this, context);
	}
