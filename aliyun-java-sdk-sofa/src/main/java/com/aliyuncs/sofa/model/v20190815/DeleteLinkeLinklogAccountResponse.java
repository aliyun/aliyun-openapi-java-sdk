...
import com.aliyuncs.sofa.transform.v20190815.DeleteLinkeLinklogAccountResponseUnmarshaller;
 ...
 * @version 
 */
public class DeleteLinkeLinklogAccountResponse extends AcsResponse {
	...
	@Override
	public DeleteLinkeLinklogAccountResponse getInstance(UnmarshallerContext context) {
		return	DeleteLinkeLinklogAccountResponseUnmarshaller.unmarshall(this, context);
	}
