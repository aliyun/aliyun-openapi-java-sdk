 ...
 * @version 
 */
public class QueryRmsDataTopksRequest extends RpcAcsRequest<QueryRmsDataTopksResponse> {
	...
	public QueryRmsDataTopksRequest() {
		super("SOFA", "2019-08-15", "QueryRmsDataTopks", "ApplySidecarCert");
	...
	@Override
	public Class<QueryRmsDataTopksResponse> getResponseClass() {
		return QueryRmsDataTopksResponse.class;
	}
