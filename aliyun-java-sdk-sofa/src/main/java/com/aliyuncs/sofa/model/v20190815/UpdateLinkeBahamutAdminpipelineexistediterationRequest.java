 ...
 * @version 
 */
public class UpdateLinkeBahamutAdminpipelineexistediterationRequest extends RpcAcsRequest<UpdateLinkeBahamutAdminpipelineexistediterationResponse> {
	...
	@Override
	public Class<UpdateLinkeBahamutAdminpipelineexistediterationResponse> getResponseClass() {
		return UpdateLinkeBahamutAdminpipelineexistediterationResponse.class;
	}
