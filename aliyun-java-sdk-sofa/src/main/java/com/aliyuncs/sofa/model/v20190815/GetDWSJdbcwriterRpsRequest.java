 ...
 * @version 
 */
public class GetDWSJdbcwriterRpsRequest extends RpcAcsRequest<GetDWSJdbcwriterRpsResponse> {
	...
	public GetDWSJdbcwriterRpsRequest() {
		super("SOFA", "2019-08-15", "GetDWSJdbcwriterRps", "sofacafedeps");
	...
	@Override
	public Class<GetDWSJdbcwriterRpsResponse> getResponseClass() {
		return GetDWSJdbcwriterRpsResponse.class;
	}
