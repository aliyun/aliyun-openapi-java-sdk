...
import com.aliyuncs.sofa.transform.v20190815.QueryLinkeLinktMyentryprojectsResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryLinkeLinktMyentryprojectsResponse extends AcsResponse {
	...
	@Override
	public QueryLinkeLinktMyentryprojectsResponse getInstance(UnmarshallerContext context) {
		return	QueryLinkeLinktMyentryprojectsResponseUnmarshaller.unmarshall(this, context);
	}
