 ...
 * @version 
 */
public class ExecLinkefabricFabricOptdrmtaskRequest extends RpcAcsRequest<ExecLinkefabricFabricOptdrmtaskResponse> {
	...
	public ExecLinkefabricFabricOptdrmtaskRequest() {
		super("SOFA", "2019-08-15", "ExecLinkefabricFabricOptdrmtask", "sofacafedeps");
	...
	@Override
	public Class<ExecLinkefabricFabricOptdrmtaskResponse> getResponseClass() {
		return ExecLinkefabricFabricOptdrmtaskResponse.class;
	}
