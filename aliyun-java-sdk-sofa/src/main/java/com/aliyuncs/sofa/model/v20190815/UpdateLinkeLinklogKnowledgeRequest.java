 ...
 * @version 
 */
public class UpdateLinkeLinklogKnowledgeRequest extends RpcAcsRequest<UpdateLinkeLinklogKnowledgeResponse> {
	...
	@Override
	public Class<UpdateLinkeLinklogKnowledgeResponse> getResponseClass() {
		return UpdateLinkeLinklogKnowledgeResponse.class;
	}
