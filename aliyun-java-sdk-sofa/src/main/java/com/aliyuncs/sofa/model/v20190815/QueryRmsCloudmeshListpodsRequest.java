 ...
 * @version 
 */
public class QueryRmsCloudmeshListpodsRequest extends RpcAcsRequest<QueryRmsCloudmeshListpodsResponse> {
	...
	public QueryRmsCloudmeshListpodsRequest() {
		super("SOFA", "2019-08-15", "QueryRmsCloudmeshListpods", "ApplySidecarCert");
	...
	@Override
	public Class<QueryRmsCloudmeshListpodsResponse> getResponseClass() {
		return QueryRmsCloudmeshListpodsResponse.class;
	}
