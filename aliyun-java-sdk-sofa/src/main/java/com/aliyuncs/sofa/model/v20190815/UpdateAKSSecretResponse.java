...
import com.aliyuncs.sofa.transform.v20190815.UpdateAKSSecretResponseUnmarshaller;
 ...
 * @version 
 */
public class UpdateAKSSecretResponse extends AcsResponse {
	...
	@Override
	public UpdateAKSSecretResponse getInstance(UnmarshallerContext context) {
		return	UpdateAKSSecretResponseUnmarshaller.unmarshall(this, context);
	}
