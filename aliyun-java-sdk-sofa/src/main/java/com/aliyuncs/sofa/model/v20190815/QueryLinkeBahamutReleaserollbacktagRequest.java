 ...
 * @version 
 */
public class QueryLinkeBahamutReleaserollbacktagRequest extends RpcAcsRequest<QueryLinkeBahamutReleaserollbacktagResponse> {
	...
	public void setDeleteTag(Boolean deleteTag) {
		...
		if(deleteTag != null){
			putBodyParameter("DeleteTag", deleteTag.toString());
		}
	}
	...
	@Override
	public Class<QueryLinkeBahamutReleaserollbacktagResponse> getResponseClass() {
		return QueryLinkeBahamutReleaserollbacktagResponse.class;
	}
