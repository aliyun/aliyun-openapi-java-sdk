...
import com.aliyuncs.sofa.transform.v20190815.ListLinkeantcodeAntcodeRepositoryfilesResponseUnmarshaller;
 ...
 * @version 
 */
public class ListLinkeantcodeAntcodeRepositoryfilesResponse extends AcsResponse {
	...
	@Override
	public ListLinkeantcodeAntcodeRepositoryfilesResponse getInstance(UnmarshallerContext context) {
		return	ListLinkeantcodeAntcodeRepositoryfilesResponseUnmarshaller.unmarshall(this, context);
	}
