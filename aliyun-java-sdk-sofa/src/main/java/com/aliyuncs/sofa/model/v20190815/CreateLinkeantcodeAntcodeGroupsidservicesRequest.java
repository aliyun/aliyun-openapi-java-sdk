 ...
 * @version 
 */
public class CreateLinkeantcodeAntcodeGroupsidservicesRequest extends RpcAcsRequest<CreateLinkeantcodeAntcodeGroupsidservicesResponse> {
	...
	@Override
	public Class<CreateLinkeantcodeAntcodeGroupsidservicesResponse> getResponseClass() {
		return CreateLinkeantcodeAntcodeGroupsidservicesResponse.class;
	}
