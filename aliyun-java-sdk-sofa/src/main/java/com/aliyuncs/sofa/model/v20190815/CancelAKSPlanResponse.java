...
import com.aliyuncs.sofa.transform.v20190815.CancelAKSPlanResponseUnmarshaller;
 ...
 * @version 
 */
public class CancelAKSPlanResponse extends AcsResponse {
	...
	@Override
	public CancelAKSPlanResponse getInstance(UnmarshallerContext context) {
		return	CancelAKSPlanResponseUnmarshaller.unmarshall(this, context);
	}
