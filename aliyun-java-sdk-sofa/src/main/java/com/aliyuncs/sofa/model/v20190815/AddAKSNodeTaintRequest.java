 ...
 * @version 
 */
public class AddAKSNodeTaintRequest extends RpcAcsRequest<AddAKSNodeTaintResponse> {
	...
	public AddAKSNodeTaintRequest() {
		super("SOFA", "2019-08-15", "AddAKSNodeTaint", "ApplySidecarCert");
	...
	@Override
	public Class<AddAKSNodeTaintResponse> getResponseClass() {
		return AddAKSNodeTaintResponse.class;
	}
