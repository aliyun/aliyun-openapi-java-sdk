 ...
 * @version 
 */
public class CreateLinkeLinktAdmincustomfieldRequest extends RpcAcsRequest<CreateLinkeLinktAdmincustomfieldResponse> {
	...
	@Override
	public Class<CreateLinkeLinktAdmincustomfieldResponse> getResponseClass() {
		return CreateLinkeLinktAdmincustomfieldResponse.class;
	}
