...
import com.aliyuncs.sofa.transform.v20190815.CreateLinkeBahamutReleaseResponseUnmarshaller;
 ...
 * @version 
 */
public class CreateLinkeBahamutReleaseResponse extends AcsResponse {
	...
	@Override
	public CreateLinkeBahamutReleaseResponse getInstance(UnmarshallerContext context) {
		return	CreateLinkeBahamutReleaseResponseUnmarshaller.unmarshall(this, context);
	}
