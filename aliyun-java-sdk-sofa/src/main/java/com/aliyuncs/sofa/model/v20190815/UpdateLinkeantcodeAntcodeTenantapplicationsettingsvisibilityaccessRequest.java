 ...
 * @version 
 */
public class UpdateLinkeantcodeAntcodeTenantapplicationsettingsvisibilityaccessRequest extends RpcAcsRequest<UpdateLinkeantcodeAntcodeTenantapplicationsettingsvisibilityaccessResponse> {
	...
	@Override
	public Class<UpdateLinkeantcodeAntcodeTenantapplicationsettingsvisibilityaccessResponse> getResponseClass() {
		return UpdateLinkeantcodeAntcodeTenantapplicationsettingsvisibilityaccessResponse.class;
	}
