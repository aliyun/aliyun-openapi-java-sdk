 ...
 * @version 
 */
public class RetryLinkeBahamutPipelineRequest extends RpcAcsRequest<RetryLinkeBahamutPipelineResponse> {
	...
	public RetryLinkeBahamutPipelineRequest() {
		super("SOFA", "2019-08-15", "RetryLinkeBahamutPipeline", "sofacafedeps");
	...
	@Override
	public Class<RetryLinkeBahamutPipelineResponse> getResponseClass() {
		return RetryLinkeBahamutPipelineResponse.class;
	}
