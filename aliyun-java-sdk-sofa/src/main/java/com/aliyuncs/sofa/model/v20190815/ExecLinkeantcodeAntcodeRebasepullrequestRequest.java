 ...
 * @version 
 */
public class ExecLinkeantcodeAntcodeRebasepullrequestRequest extends RpcAcsRequest<ExecLinkeantcodeAntcodeRebasepullrequestResponse> {
	...
	@Override
	public Class<ExecLinkeantcodeAntcodeRebasepullrequestResponse> getResponseClass() {
		return ExecLinkeantcodeAntcodeRebasepullrequestResponse.class;
	}
