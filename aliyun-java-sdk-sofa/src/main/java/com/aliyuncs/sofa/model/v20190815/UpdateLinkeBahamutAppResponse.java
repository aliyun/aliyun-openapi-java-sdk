...
import com.aliyuncs.sofa.transform.v20190815.UpdateLinkeBahamutAppResponseUnmarshaller;
 ...
 * @version 
 */
public class UpdateLinkeBahamutAppResponse extends AcsResponse {
	...
	@Override
	public UpdateLinkeBahamutAppResponse getInstance(UnmarshallerContext context) {
		return	UpdateLinkeBahamutAppResponseUnmarshaller.unmarshall(this, context);
	}
