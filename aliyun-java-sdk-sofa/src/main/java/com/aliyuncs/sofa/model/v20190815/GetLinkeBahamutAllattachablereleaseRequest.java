 ...
 * @version 
 */
public class GetLinkeBahamutAllattachablereleaseRequest extends RpcAcsRequest<GetLinkeBahamutAllattachablereleaseResponse> {
	...
	@Override
	public Class<GetLinkeBahamutAllattachablereleaseResponse> getResponseClass() {
		return GetLinkeBahamutAllattachablereleaseResponse.class;
	}
