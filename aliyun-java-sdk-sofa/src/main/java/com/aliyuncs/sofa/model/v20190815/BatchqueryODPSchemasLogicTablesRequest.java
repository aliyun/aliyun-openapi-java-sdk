 ...
 * @version 
 */
public class BatchqueryODPSchemasLogicTablesRequest extends RpcAcsRequest<BatchqueryODPSchemasLogicTablesResponse> {
	...
	public BatchqueryODPSchemasLogicTablesRequest() {
		super("SOFA", "2019-08-15", "BatchqueryODPSchemasLogicTables", "ApplySidecarCert");
	...
	@Override
	public Class<BatchqueryODPSchemasLogicTablesResponse> getResponseClass() {
		return BatchqueryODPSchemasLogicTablesResponse.class;
	}
