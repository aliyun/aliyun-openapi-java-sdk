...
import com.aliyuncs.sofa.transform.v20190815.GetLinkeBahamutAllappResponseUnmarshaller;
 ...
 * @version 
 */
public class GetLinkeBahamutAllappResponse extends AcsResponse {
	...
	@Override
	public GetLinkeBahamutAllappResponse getInstance(UnmarshallerContext context) {
		return	GetLinkeBahamutAllappResponseUnmarshaller.unmarshall(this, context);
	}
