...
import com.aliyuncs.sofa.transform.v20190815.DescribeCasComputerResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeCasComputerResponse extends AcsResponse {
	...
	@Override
	public DescribeCasComputerResponse getInstance(UnmarshallerContext context) {
		return	DescribeCasComputerResponseUnmarshaller.unmarshall(this, context);
	}
