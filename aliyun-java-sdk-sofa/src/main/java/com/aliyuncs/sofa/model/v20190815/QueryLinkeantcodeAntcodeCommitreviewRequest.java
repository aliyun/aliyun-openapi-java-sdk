 ...
 * @version 
 */
public class QueryLinkeantcodeAntcodeCommitreviewRequest extends RpcAcsRequest<QueryLinkeantcodeAntcodeCommitreviewResponse> {
	...
	@Override
	public Class<QueryLinkeantcodeAntcodeCommitreviewResponse> getResponseClass() {
		return QueryLinkeantcodeAntcodeCommitreviewResponse.class;
	}
