 ...
 * @version 
 */
public class UpdateMSDdsJobRequest extends RpcAcsRequest<UpdateMSDdsJobResponse> {
	...
	public UpdateMSDdsJobRequest() {
		super("SOFA", "2019-08-15", "UpdateMSDdsJob", "sofacafedeps");
	...
	@Override
	public Class<UpdateMSDdsJobResponse> getResponseClass() {
		return UpdateMSDdsJobResponse.class;
	}
