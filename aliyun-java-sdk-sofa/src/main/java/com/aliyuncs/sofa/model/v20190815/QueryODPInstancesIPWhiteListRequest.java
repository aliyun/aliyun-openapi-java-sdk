 ...
 * @version 
 */
public class QueryODPInstancesIPWhiteListRequest extends RpcAcsRequest<QueryODPInstancesIPWhiteListResponse> {
	...
	public QueryODPInstancesIPWhiteListRequest() {
		super("SOFA", "2019-08-15", "QueryODPInstancesIPWhiteList", "ApplySidecarCert");
	...
	@Override
	public Class<QueryODPInstancesIPWhiteListResponse> getResponseClass() {
		return QueryODPInstancesIPWhiteListResponse.class;
	}
