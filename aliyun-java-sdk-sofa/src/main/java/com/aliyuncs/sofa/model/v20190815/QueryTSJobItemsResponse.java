...
import com.aliyuncs.sofa.transform.v20190815.QueryTSJobItemsResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryTSJobItemsResponse extends AcsResponse {
	...
	@Override
	public QueryTSJobItemsResponse getInstance(UnmarshallerContext context) {
		return	QueryTSJobItemsResponseUnmarshaller.unmarshall(this, context);
	}
