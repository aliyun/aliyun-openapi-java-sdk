...
import com.aliyuncs.sofa.transform.v20190815.CreateLinkeLinklogKnowledgeResponseUnmarshaller;
 ...
 * @version 
 */
public class CreateLinkeLinklogKnowledgeResponse extends AcsResponse {
	...
	@Override
	public CreateLinkeLinklogKnowledgeResponse getInstance(UnmarshallerContext context) {
		return	CreateLinkeLinklogKnowledgeResponseUnmarshaller.unmarshall(this, context);
	}
