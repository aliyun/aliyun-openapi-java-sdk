...
import com.aliyuncs.sofa.transform.v20190815.GetLinkeBahamutGetmyreleaseResponseUnmarshaller;
 ...
 * @version 
 */
public class GetLinkeBahamutGetmyreleaseResponse extends AcsResponse {
	...
	@Override
	public GetLinkeBahamutGetmyreleaseResponse getInstance(UnmarshallerContext context) {
		return	GetLinkeBahamutGetmyreleaseResponseUnmarshaller.unmarshall(this, context);
	}
