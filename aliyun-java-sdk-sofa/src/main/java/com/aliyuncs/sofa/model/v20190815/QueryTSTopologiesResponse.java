...
import com.aliyuncs.sofa.transform.v20190815.QueryTSTopologiesResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryTSTopologiesResponse extends AcsResponse {
	...
	@Override
	public QueryTSTopologiesResponse getInstance(UnmarshallerContext context) {
		return	QueryTSTopologiesResponseUnmarshaller.unmarshall(this, context);
	}
