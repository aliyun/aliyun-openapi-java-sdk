...
import com.aliyuncs.sofa.transform.v20190815.GetLinkeBahamutArchdomainappsResponseUnmarshaller;
 ...
 * @version 
 */
public class GetLinkeBahamutArchdomainappsResponse extends AcsResponse {
	...
	@Override
	public GetLinkeBahamutArchdomainappsResponse getInstance(UnmarshallerContext context) {
		return	GetLinkeBahamutArchdomainappsResponseUnmarshaller.unmarshall(this, context);
	}
