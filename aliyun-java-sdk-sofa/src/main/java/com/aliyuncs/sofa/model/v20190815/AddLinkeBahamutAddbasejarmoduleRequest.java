 ...
 * @version 
 */
public class AddLinkeBahamutAddbasejarmoduleRequest extends RpcAcsRequest<AddLinkeBahamutAddbasejarmoduleResponse> {
	...
	@Override
	public Class<AddLinkeBahamutAddbasejarmoduleResponse> getResponseClass() {
		return AddLinkeBahamutAddbasejarmoduleResponse.class;
	}
