...
import com.aliyuncs.sofa.transform.v20190815.GetLinkeBahamutAppstypenewResponseUnmarshaller;
 ...
 * @version 
 */
public class GetLinkeBahamutAppstypenewResponse extends AcsResponse {
	...
	@Override
	public GetLinkeBahamutAppstypenewResponse getInstance(UnmarshallerContext context) {
		return	GetLinkeBahamutAppstypenewResponseUnmarshaller.unmarshall(this, context);
	}
