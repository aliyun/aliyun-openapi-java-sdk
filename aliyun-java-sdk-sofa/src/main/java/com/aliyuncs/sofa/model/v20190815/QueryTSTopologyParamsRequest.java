 ...
 * @version 
 */
public class QueryTSTopologyParamsRequest extends RpcAcsRequest<QueryTSTopologyParamsResponse> {
	...
	public QueryTSTopologyParamsRequest() {
		super("SOFA", "2019-08-15", "QueryTSTopologyParams", "ApplySidecarCert");
	...
	@Override
	public Class<QueryTSTopologyParamsResponse> getResponseClass() {
		return QueryTSTopologyParamsResponse.class;
	}
