 ...
 * @version 
 */
public class DeleteODPSchemasInterceptorsRequest extends RpcAcsRequest<DeleteODPSchemasInterceptorsResponse> {
	...
	public void setInterceptorName(String interceptorName) {
		...
		if(interceptorName != null){
			putBodyParameter("InterceptorName", interceptorName);
		}
	}
	...
	@Override
	public Class<DeleteODPSchemasInterceptorsResponse> getResponseClass() {
		return DeleteODPSchemasInterceptorsResponse.class;
	}
