 ...
 * @version 
 */
public class GetLinkeBahamutIterationgetiterationworkitemsRequest extends RpcAcsRequest<GetLinkeBahamutIterationgetiterationworkitemsResponse> {
	...
	@Override
	public Class<GetLinkeBahamutIterationgetiterationworkitemsResponse> getResponseClass() {
		return GetLinkeBahamutIterationgetiterationworkitemsResponse.class;
	}
