 ...
 * @version 
 */
public class QueryLinkeBahamutArchdomainRequest extends RpcAcsRequest<QueryLinkeBahamutArchdomainResponse> {
	...
	@Override
	public Class<QueryLinkeBahamutArchdomainResponse> getResponseClass() {
		return QueryLinkeBahamutArchdomainResponse.class;
	}
