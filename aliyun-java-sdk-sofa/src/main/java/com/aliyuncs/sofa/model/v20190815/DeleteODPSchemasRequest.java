 ...
 * @version 
 */
public class DeleteODPSchemasRequest extends RpcAcsRequest<DeleteODPSchemasResponse> {
	...
	public DeleteODPSchemasRequest() {
		super("SOFA", "2019-08-15", "DeleteODPSchemas", "ApplySidecarCert");
	...
	@Override
	public Class<DeleteODPSchemasResponse> getResponseClass() {
		return DeleteODPSchemasResponse.class;
	}
