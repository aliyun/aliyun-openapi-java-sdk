...
import com.aliyuncs.sofa.transform.v20190815.EnableLinkeantcodeAntcodeGroupsidinstallationsResponseUnmarshaller;
 ...
 * @version 
 */
public class EnableLinkeantcodeAntcodeGroupsidinstallationsResponse extends AcsResponse {
	...
	@Override
	public EnableLinkeantcodeAntcodeGroupsidinstallationsResponse getInstance(UnmarshallerContext context) {
		return	EnableLinkeantcodeAntcodeGroupsidinstallationsResponseUnmarshaller.unmarshall(this, context);
	}
