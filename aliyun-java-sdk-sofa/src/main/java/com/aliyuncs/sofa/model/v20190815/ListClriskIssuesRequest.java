 ...
 * @version 
 */
public class ListClriskIssuesRequest extends RpcAcsRequest<ListClriskIssuesResponse> {
	...
	public ListClriskIssuesRequest() {
		super("SOFA", "2019-08-15", "ListClriskIssues", "sofacafedeps");
	...
	@Override
	public Class<ListClriskIssuesResponse> getResponseClass() {
		return ListClriskIssuesResponse.class;
	}
