 ...
 * @version 
 */
public class RemoveLinkeLinktRelatedlinkeiterationRequest extends RpcAcsRequest<RemoveLinkeLinktRelatedlinkeiterationResponse> {
	...
	public RemoveLinkeLinktRelatedlinkeiterationRequest() {
		super("SOFA", "2019-08-15", "RemoveLinkeLinktRelatedlinkeiteration", "ApplySidecarCert");
	...
	@Override
	public Class<RemoveLinkeLinktRelatedlinkeiterationResponse> getResponseClass() {
		return RemoveLinkeLinktRelatedlinkeiterationResponse.class;
	}
