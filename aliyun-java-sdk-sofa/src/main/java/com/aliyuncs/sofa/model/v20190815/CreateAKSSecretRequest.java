 ...
 * @version 
 */
public class CreateAKSSecretRequest extends RpcAcsRequest<CreateAKSSecretResponse> {
	...
	public CreateAKSSecretRequest() {
		super("SOFA", "2019-08-15", "CreateAKSSecret", "sofacafedeps");
	...
	@Override
	public Class<CreateAKSSecretResponse> getResponseClass() {
		return CreateAKSSecretResponse.class;
	}
