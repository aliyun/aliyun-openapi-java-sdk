 ...
 * @version 
 */
public class ConfirmLinkefabricFabricNewappconfigsRequest extends RpcAcsRequest<ConfirmLinkefabricFabricNewappconfigsResponse> {
	...
	@Override
	public Class<ConfirmLinkefabricFabricNewappconfigsResponse> getResponseClass() {
		return ConfirmLinkefabricFabricNewappconfigsResponse.class;
	}
