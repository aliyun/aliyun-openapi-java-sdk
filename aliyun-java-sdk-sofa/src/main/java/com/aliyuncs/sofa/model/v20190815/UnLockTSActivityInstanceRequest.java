 ...
 * @version 
 */
public class UnLockTSActivityInstanceRequest extends RpcAcsRequest<UnLockTSActivityInstanceResponse> {
	...
	public UnLockTSActivityInstanceRequest() {
		super("SOFA", "2019-08-15", "UnLockTSActivityInstance", "ApplySidecarCert");
	...
	@Override
	public Class<UnLockTSActivityInstanceResponse> getResponseClass() {
		return UnLockTSActivityInstanceResponse.class;
	}
