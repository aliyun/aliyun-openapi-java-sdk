...
import com.aliyuncs.sofa.transform.v20190815.QueryCasLoadbalanceMountResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryCasLoadbalanceMountResponse extends AcsResponse {
	...
	@Override
	public QueryCasLoadbalanceMountResponse getInstance(UnmarshallerContext context) {
		return	QueryCasLoadbalanceMountResponseUnmarshaller.unmarshall(this, context);
	}
