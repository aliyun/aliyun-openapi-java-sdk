 ...
 * @version 
 */
public class RetryLinkeBahamutPipelineretryoldRequest extends RpcAcsRequest<RetryLinkeBahamutPipelineretryoldResponse> {
	...
	public void setPipelineGroup(String pipelineGroup) {
		...
		if(pipelineGroup != null){
			putBodyParameter("PipelineGroup", pipelineGroup);
		}
	}
	...
	@Override
	public Class<RetryLinkeBahamutPipelineretryoldResponse> getResponseClass() {
		return RetryLinkeBahamutPipelineretryoldResponse.class;
	}
