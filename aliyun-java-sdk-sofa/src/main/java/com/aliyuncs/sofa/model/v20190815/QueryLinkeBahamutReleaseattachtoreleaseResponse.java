...
import com.aliyuncs.sofa.transform.v20190815.QueryLinkeBahamutReleaseattachtoreleaseResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryLinkeBahamutReleaseattachtoreleaseResponse extends AcsResponse {
	...
	@Override
	public QueryLinkeBahamutReleaseattachtoreleaseResponse getInstance(UnmarshallerContext context) {
		return	QueryLinkeBahamutReleaseattachtoreleaseResponseUnmarshaller.unmarshall(this, context);
	}
