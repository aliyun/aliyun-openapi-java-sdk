 ...
 * @version 
 */
public class OpenODPInstancesPublicAccessRequest extends RpcAcsRequest<OpenODPInstancesPublicAccessResponse> {
	...
	public OpenODPInstancesPublicAccessRequest() {
		super("SOFA", "2019-08-15", "OpenODPInstancesPublicAccess", "sofacafedeps");
	...
	@Override
	public Class<OpenODPInstancesPublicAccessResponse> getResponseClass() {
		return OpenODPInstancesPublicAccessResponse.class;
	}
