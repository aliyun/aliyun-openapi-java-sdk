 ...
 * @version 
 */
public class UpdateLinkeBahamutIterationupdateiterationworkitemsRequest extends RpcAcsRequest<UpdateLinkeBahamutIterationupdateiterationworkitemsResponse> {
	...
	public UpdateLinkeBahamutIterationupdateiterationworkitemsRequest() {
		super("SOFA", "2019-08-15", "UpdateLinkeBahamutIterationupdateiterationworkitems", "sofacaferms");
	...
	public void setWorkItemss(List<WorkItems> workItemss) {
		...
		if (workItemss != null) {
			for (int depth1 = 0; depth1 < workItemss.size(); depth1++) {
				...
				if (workItemss.get(depth1).getMergeRequestIdss() != null) {
					for (int i = 0; i < workItemss.get(depth1).getMergeRequestIdss().size(); i++) {
						putBodyParameter("WorkItems." + (depth1 + 1) + ".MergeRequestIds." + (i + 1) , workItemss.get(depth1).getMergeRequestIdss().get(i));
					}
				}
	...
	public static class WorkItems {
		...
		private List<String> mergeRequestIdss;
		...
		public List<String> getMergeRequestIdss() {
			return this.mergeRequestIdss;
		}

		public void setMergeRequestIdss(List<String> mergeRequestIdss) {
			this.mergeRequestIdss = mergeRequestIdss;
		}
	...
	@Override
	public Class<UpdateLinkeBahamutIterationupdateiterationworkitemsResponse> getResponseClass() {
		return UpdateLinkeBahamutIterationupdateiterationworkitemsResponse.class;
	}
