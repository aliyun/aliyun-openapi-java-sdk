 ...
 * @version 
 */
public class QueryLinkeLinktKanbancolumninfoRequest extends RpcAcsRequest<QueryLinkeLinktKanbancolumninfoResponse> {
	...
	@Override
	public Class<QueryLinkeLinktKanbancolumninfoResponse> getResponseClass() {
		return QueryLinkeLinktKanbancolumninfoResponse.class;
	}
