...
import com.aliyuncs.sofa.transform.v20190815.UpdateLinkeBahamutIterationsupdateResponseUnmarshaller;
 ...
 * @version 
 */
public class UpdateLinkeBahamutIterationsupdateResponse extends AcsResponse {
	...
	@Override
	public UpdateLinkeBahamutIterationsupdateResponse getInstance(UnmarshallerContext context) {
		return	UpdateLinkeBahamutIterationsupdateResponseUnmarshaller.unmarshall(this, context);
	}
