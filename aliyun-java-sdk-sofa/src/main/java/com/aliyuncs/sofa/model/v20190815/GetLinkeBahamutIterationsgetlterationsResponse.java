...
import com.aliyuncs.sofa.transform.v20190815.GetLinkeBahamutIterationsgetlterationsResponseUnmarshaller;
 ...
 * @version 
 */
public class GetLinkeBahamutIterationsgetlterationsResponse extends AcsResponse {
	...
	@Override
	public GetLinkeBahamutIterationsgetlterationsResponse getInstance(UnmarshallerContext context) {
		return	GetLinkeBahamutIterationsgetlterationsResponseUnmarshaller.unmarshall(this, context);
	}
