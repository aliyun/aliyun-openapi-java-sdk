 ...
 * @version 
 */
public class GetLinkeBahamutQualitygetqualitylogRequest extends RpcAcsRequest<GetLinkeBahamutQualitygetqualitylogResponse> {
	...
	@Override
	public Class<GetLinkeBahamutQualitygetqualitylogResponse> getResponseClass() {
		return GetLinkeBahamutQualitygetqualitylogResponse.class;
	}
