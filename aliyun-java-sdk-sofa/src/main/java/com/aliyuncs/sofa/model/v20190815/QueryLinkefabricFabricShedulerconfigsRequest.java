 ...
 * @version 
 */
public class QueryLinkefabricFabricShedulerconfigsRequest extends RpcAcsRequest<QueryLinkefabricFabricShedulerconfigsResponse> {
	...
	public QueryLinkefabricFabricShedulerconfigsRequest() {
		super("SOFA", "2019-08-15", "QueryLinkefabricFabricShedulerconfigs", "sofacafedeps");
	...
	@Override
	public Class<QueryLinkefabricFabricShedulerconfigsResponse> getResponseClass() {
		return QueryLinkefabricFabricShedulerconfigsResponse.class;
	}
