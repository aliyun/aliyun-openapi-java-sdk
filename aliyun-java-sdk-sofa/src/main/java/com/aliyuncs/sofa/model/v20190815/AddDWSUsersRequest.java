 ...
 * @version 
 */
public class AddDWSUsersRequest extends RpcAcsRequest<AddDWSUsersResponse> {
	...
	public AddDWSUsersRequest() {
		super("SOFA", "2019-08-15", "AddDWSUsers", "ApplySidecarCert");
	...
	@Override
	public Class<AddDWSUsersResponse> getResponseClass() {
		return AddDWSUsersResponse.class;
	}
