 ...
 * @version 
 */
public class ListAKSHelmChartReleaseRequest extends RpcAcsRequest<ListAKSHelmChartReleaseResponse> {
	...
	public ListAKSHelmChartReleaseRequest() {
		super("SOFA", "2019-08-15", "ListAKSHelmChartRelease", "sofacafedeps");
	...
	@Override
	public Class<ListAKSHelmChartReleaseResponse> getResponseClass() {
		return ListAKSHelmChartReleaseResponse.class;
	}
