 ...
 * @version 
 */
public class CheckODPInstancesRequest extends RpcAcsRequest<CheckODPInstancesResponse> {
	...
	public CheckODPInstancesRequest() {
		super("SOFA", "2019-08-15", "CheckODPInstances", "sofacafedeps");
	...
	@Override
	public Class<CheckODPInstancesResponse> getResponseClass() {
		return CheckODPInstancesResponse.class;
	}
