...
import com.aliyuncs.sofa.transform.v20190815.GetLinkeBahamutAdmintenantidconfigResponseUnmarshaller;
 ...
 * @version 
 */
public class GetLinkeBahamutAdmintenantidconfigResponse extends AcsResponse {
	...
	@Override
	public GetLinkeBahamutAdmintenantidconfigResponse getInstance(UnmarshallerContext context) {
		return	GetLinkeBahamutAdmintenantidconfigResponseUnmarshaller.unmarshall(this, context);
	}
