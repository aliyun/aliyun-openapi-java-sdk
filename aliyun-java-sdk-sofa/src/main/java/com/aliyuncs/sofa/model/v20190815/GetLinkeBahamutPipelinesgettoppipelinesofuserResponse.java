...
import com.aliyuncs.sofa.transform.v20190815.GetLinkeBahamutPipelinesgettoppipelinesofuserResponseUnmarshaller;
 ...
 * @version 
 */
public class GetLinkeBahamutPipelinesgettoppipelinesofuserResponse extends AcsResponse {
	...
	@Override
	public GetLinkeBahamutPipelinesgettoppipelinesofuserResponse getInstance(UnmarshallerContext context) {
		return	GetLinkeBahamutPipelinesgettoppipelinesofuserResponseUnmarshaller.unmarshall(this, context);
	}
