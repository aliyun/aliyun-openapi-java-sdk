...
import com.aliyuncs.sofa.transform.v20190815.QueryLinkefabricFabricShedulerconfigsResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryLinkefabricFabricShedulerconfigsResponse extends AcsResponse {
	...
	@Override
	public QueryLinkefabricFabricShedulerconfigsResponse getInstance(UnmarshallerContext context) {
		return	QueryLinkefabricFabricShedulerconfigsResponseUnmarshaller.unmarshall(this, context);
	}
