...
import com.aliyuncs.sofa.transform.v20190815.UpdateLinkeLinktCustomfieldResponseUnmarshaller;
 ...
 * @version 
 */
public class UpdateLinkeLinktCustomfieldResponse extends AcsResponse {
	...
	@Override
	public UpdateLinkeLinktCustomfieldResponse getInstance(UnmarshallerContext context) {
		return	UpdateLinkeLinktCustomfieldResponseUnmarshaller.unmarshall(this, context);
	}
