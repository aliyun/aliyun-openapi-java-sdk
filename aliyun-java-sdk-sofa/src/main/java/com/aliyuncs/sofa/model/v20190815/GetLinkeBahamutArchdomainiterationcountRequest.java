 ...
 * @version 
 */
public class GetLinkeBahamutArchdomainiterationcountRequest extends RpcAcsRequest<GetLinkeBahamutArchdomainiterationcountResponse> {
	...
	@Override
	public Class<GetLinkeBahamutArchdomainiterationcountResponse> getResponseClass() {
		return GetLinkeBahamutArchdomainiterationcountResponse.class;
	}
