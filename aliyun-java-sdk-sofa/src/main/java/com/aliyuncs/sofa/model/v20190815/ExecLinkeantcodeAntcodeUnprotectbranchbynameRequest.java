 ...
 * @version 
 */
public class ExecLinkeantcodeAntcodeUnprotectbranchbynameRequest extends RpcAcsRequest<ExecLinkeantcodeAntcodeUnprotectbranchbynameResponse> {
	...
	@Override
	public Class<ExecLinkeantcodeAntcodeUnprotectbranchbynameResponse> getResponseClass() {
		return ExecLinkeantcodeAntcodeUnprotectbranchbynameResponse.class;
	}
