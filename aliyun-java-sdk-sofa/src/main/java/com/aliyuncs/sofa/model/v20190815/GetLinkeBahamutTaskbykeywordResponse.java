...
import com.aliyuncs.sofa.transform.v20190815.GetLinkeBahamutTaskbykeywordResponseUnmarshaller;
 ...
 * @version 
 */
public class GetLinkeBahamutTaskbykeywordResponse extends AcsResponse {
	...
	@Override
	public GetLinkeBahamutTaskbykeywordResponse getInstance(UnmarshallerContext context) {
		return	GetLinkeBahamutTaskbykeywordResponseUnmarshaller.unmarshall(this, context);
	}
