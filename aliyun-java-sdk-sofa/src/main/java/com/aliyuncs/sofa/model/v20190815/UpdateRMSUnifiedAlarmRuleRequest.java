 ...
 * @version 
 */
public class UpdateRMSUnifiedAlarmRuleRequest extends RpcAcsRequest<UpdateRMSUnifiedAlarmRuleResponse> {
	...
	public UpdateRMSUnifiedAlarmRuleRequest() {
		super("SOFA", "2019-08-15", "UpdateRMSUnifiedAlarmRule");
	...
	public void setSuspendedStartTime(Long suspendedStartTime) {
		...
		if(suspendedStartTime != null){
			putBodyParameter("SuspendedStartTime", suspendedStartTime.toString());
		}
	}
	...
	public void setSuspendedReason(String suspendedReason) {
		...
		if(suspendedReason != null){
			putBodyParameter("SuspendedReason", suspendedReason);
		}
	}
	...
	public void setSuspendedEndTime(Long suspendedEndTime) {
		...
		if(suspendedEndTime != null){
			putBodyParameter("SuspendedEndTime", suspendedEndTime.toString());
		}
	}
	...
	@Override
	public Class<UpdateRMSUnifiedAlarmRuleResponse> getResponseClass() {
		return UpdateRMSUnifiedAlarmRuleResponse.class;
	}
