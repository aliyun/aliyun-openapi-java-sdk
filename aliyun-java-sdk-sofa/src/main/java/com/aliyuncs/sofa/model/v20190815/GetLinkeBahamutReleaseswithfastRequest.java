 ...
 * @version 
 */
public class GetLinkeBahamutReleaseswithfastRequest extends RpcAcsRequest<GetLinkeBahamutReleaseswithfastResponse> {
	...
	@Override
	public Class<GetLinkeBahamutReleaseswithfastResponse> getResponseClass() {
		return GetLinkeBahamutReleaseswithfastResponse.class;
	}
