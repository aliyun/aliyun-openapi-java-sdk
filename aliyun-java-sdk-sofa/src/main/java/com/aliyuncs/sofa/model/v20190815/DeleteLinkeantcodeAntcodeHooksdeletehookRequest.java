 ...
 * @version 
 */
public class DeleteLinkeantcodeAntcodeHooksdeletehookRequest extends RpcAcsRequest<DeleteLinkeantcodeAntcodeHooksdeletehookResponse> {
	...
	@Override
	public Class<DeleteLinkeantcodeAntcodeHooksdeletehookResponse> getResponseClass() {
		return DeleteLinkeantcodeAntcodeHooksdeletehookResponse.class;
	}
