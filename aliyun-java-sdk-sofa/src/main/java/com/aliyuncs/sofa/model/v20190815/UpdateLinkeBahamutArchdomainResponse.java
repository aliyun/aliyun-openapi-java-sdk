...
import com.aliyuncs.sofa.transform.v20190815.UpdateLinkeBahamutArchdomainResponseUnmarshaller;
 ...
 * @version 
 */
public class UpdateLinkeBahamutArchdomainResponse extends AcsResponse {
	...
	@Override
	public UpdateLinkeBahamutArchdomainResponse getInstance(UnmarshallerContext context) {
		return	UpdateLinkeBahamutArchdomainResponseUnmarshaller.unmarshall(this, context);
	}
