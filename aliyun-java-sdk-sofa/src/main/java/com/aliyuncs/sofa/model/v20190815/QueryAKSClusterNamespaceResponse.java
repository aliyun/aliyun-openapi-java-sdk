...
import com.aliyuncs.sofa.transform.v20190815.QueryAKSClusterNamespaceResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryAKSClusterNamespaceResponse extends AcsResponse {
	...
	@Override
	public QueryAKSClusterNamespaceResponse getInstance(UnmarshallerContext context) {
		return	QueryAKSClusterNamespaceResponseUnmarshaller.unmarshall(this, context);
	}
