...
import com.aliyuncs.sofa.transform.v20190815.GetLinkeBahamutIterationunitResponseUnmarshaller;
 ...
 * @version 
 */
public class GetLinkeBahamutIterationunitResponse extends AcsResponse {
	...
	@Override
	public GetLinkeBahamutIterationunitResponse getInstance(UnmarshallerContext context) {
		return	GetLinkeBahamutIterationunitResponseUnmarshaller.unmarshall(this, context);
	}
