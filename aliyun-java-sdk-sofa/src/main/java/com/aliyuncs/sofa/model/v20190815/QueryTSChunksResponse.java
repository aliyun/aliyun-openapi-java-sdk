...
import com.aliyuncs.sofa.transform.v20190815.QueryTSChunksResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryTSChunksResponse extends AcsResponse {
	...
	@Override
	public QueryTSChunksResponse getInstance(UnmarshallerContext context) {
		return	QueryTSChunksResponseUnmarshaller.unmarshall(this, context);
	}
