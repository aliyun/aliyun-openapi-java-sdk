 ...
 * @version 
 */
public class UpdateAKSNodeLabelRequest extends RpcAcsRequest<UpdateAKSNodeLabelResponse> {
	...
	public UpdateAKSNodeLabelRequest() {
		super("SOFA", "2019-08-15", "UpdateAKSNodeLabel", "sofacafedeps");
	...
	@Override
	public Class<UpdateAKSNodeLabelResponse> getResponseClass() {
		return UpdateAKSNodeLabelResponse.class;
	}
