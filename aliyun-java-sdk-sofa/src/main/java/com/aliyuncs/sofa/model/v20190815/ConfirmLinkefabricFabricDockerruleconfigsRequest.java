 ...
 * @version 
 */
public class ConfirmLinkefabricFabricDockerruleconfigsRequest extends RpcAcsRequest<ConfirmLinkefabricFabricDockerruleconfigsResponse> {
	...
	@Override
	public Class<ConfirmLinkefabricFabricDockerruleconfigsResponse> getResponseClass() {
		return ConfirmLinkefabricFabricDockerruleconfigsResponse.class;
	}
