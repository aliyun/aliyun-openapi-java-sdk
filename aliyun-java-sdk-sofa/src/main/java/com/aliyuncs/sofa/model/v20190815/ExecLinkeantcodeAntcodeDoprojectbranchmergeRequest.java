 ...
 * @version 
 */
public class ExecLinkeantcodeAntcodeDoprojectbranchmergeRequest extends RpcAcsRequest<ExecLinkeantcodeAntcodeDoprojectbranchmergeResponse> {
	...
	@Override
	public Class<ExecLinkeantcodeAntcodeDoprojectbranchmergeResponse> getResponseClass() {
		return ExecLinkeantcodeAntcodeDoprojectbranchmergeResponse.class;
	}
