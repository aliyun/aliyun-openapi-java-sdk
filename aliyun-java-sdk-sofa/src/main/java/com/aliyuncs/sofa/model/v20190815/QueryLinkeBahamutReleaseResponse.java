...
import com.aliyuncs.sofa.transform.v20190815.QueryLinkeBahamutReleaseResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryLinkeBahamutReleaseResponse extends AcsResponse {
	...
	@Override
	public QueryLinkeBahamutReleaseResponse getInstance(UnmarshallerContext context) {
		return	QueryLinkeBahamutReleaseResponseUnmarshaller.unmarshall(this, context);
	}
