 ...
 * @version 
 */
public class GetLinkeBahamutTenantuploadinfoRequest extends RpcAcsRequest<GetLinkeBahamutTenantuploadinfoResponse> {
	...
	public void setFolder(String folder) {
		this.folder = folder;
		if(folder != null){
			putBodyParameter("Folder", folder);
		}
	}

	@Override
	public Class<GetLinkeBahamutTenantuploadinfoResponse> getResponseClass() {
		return GetLinkeBahamutTenantuploadinfoResponse.class;
	}
