...
import com.aliyuncs.sofa.transform.v20190815.UpdateLinkeLinktAdmincustomfieldResponseUnmarshaller;
 ...
 * @version 
 */
public class UpdateLinkeLinktAdmincustomfieldResponse extends AcsResponse {
	...
	@Override
	public UpdateLinkeLinktAdmincustomfieldResponse getInstance(UnmarshallerContext context) {
		return	UpdateLinkeLinktAdmincustomfieldResponseUnmarshaller.unmarshall(this, context);
	}
