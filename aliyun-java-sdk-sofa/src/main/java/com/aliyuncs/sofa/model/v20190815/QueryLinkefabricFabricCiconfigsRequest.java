 ...
 * @version 
 */
public class QueryLinkefabricFabricCiconfigsRequest extends RpcAcsRequest<QueryLinkefabricFabricCiconfigsResponse> {
	...
	public QueryLinkefabricFabricCiconfigsRequest() {
		super("SOFA", "2019-08-15", "QueryLinkefabricFabricCiconfigs", "sofacafedeps");
	...
	@Override
	public Class<QueryLinkefabricFabricCiconfigsResponse> getResponseClass() {
		return QueryLinkefabricFabricCiconfigsResponse.class;
	}
