 ...
 * @version 
 */
public class QueryRmsAlarmrecordsRequest extends RpcAcsRequest<QueryRmsAlarmrecordsResponse> {
	   

	private String envJsonStr;

	private String queryJsonStr;
	public QueryRmsAlarmrecordsRequest() {
		super("SOFA", "2019-08-15", "QueryRmsAlarmrecords", "ApplySidecarCert");
	...
	@Override
	public Class<QueryRmsAlarmrecordsResponse> getResponseClass() {
		return QueryRmsAlarmrecordsResponse.class;
	}
