 ...
 * @version 
 */
public class UpdateMsConfigResourcesRequest extends RpcAcsRequest<UpdateMsConfigResourcesResponse> {
	...
	private String desc;
	public UpdateMsConfigResourcesRequest() {
		super("SOFA", "2019-08-15", "UpdateMsConfigResources", "sofacafedeps");
	...
	@Override
	public Class<UpdateMsConfigResourcesResponse> getResponseClass() {
		return UpdateMsConfigResourcesResponse.class;
	}
