...
import com.aliyuncs.sofa.transform.v20190815.SaveLinkeBahamutAppcustomciconfigResponseUnmarshaller;
 ...
 * @version 
 */
public class SaveLinkeBahamutAppcustomciconfigResponse extends AcsResponse {
	...
	@Override
	public SaveLinkeBahamutAppcustomciconfigResponse getInstance(UnmarshallerContext context) {
		return	SaveLinkeBahamutAppcustomciconfigResponseUnmarshaller.unmarshall(this, context);
	}
