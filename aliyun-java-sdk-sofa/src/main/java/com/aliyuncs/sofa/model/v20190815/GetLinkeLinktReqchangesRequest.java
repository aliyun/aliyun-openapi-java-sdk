 ...
 * @version 
 */
public class GetLinkeLinktReqchangesRequest extends RpcAcsRequest<GetLinkeLinktReqchangesResponse> {
	...
	@Override
	public Class<GetLinkeLinktReqchangesResponse> getResponseClass() {
		return GetLinkeLinktReqchangesResponse.class;
	}
