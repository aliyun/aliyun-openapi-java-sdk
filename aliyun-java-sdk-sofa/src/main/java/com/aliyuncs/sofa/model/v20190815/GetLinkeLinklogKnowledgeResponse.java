...
import com.aliyuncs.sofa.transform.v20190815.GetLinkeLinklogKnowledgeResponseUnmarshaller;
 ...
 * @version 
 */
public class GetLinkeLinklogKnowledgeResponse extends AcsResponse {
	...
	@Override
	public GetLinkeLinklogKnowledgeResponse getInstance(UnmarshallerContext context) {
		return	GetLinkeLinklogKnowledgeResponseUnmarshaller.unmarshall(this, context);
	}
