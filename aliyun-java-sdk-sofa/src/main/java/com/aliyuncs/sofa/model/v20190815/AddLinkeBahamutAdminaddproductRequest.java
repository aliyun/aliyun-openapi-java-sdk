 ...
 * @version 
 */
public class AddLinkeBahamutAdminaddproductRequest extends RpcAcsRequest<AddLinkeBahamutAdminaddproductResponse> {
	...
	public AddLinkeBahamutAdminaddproductRequest() {
		super("SOFA", "2019-08-15", "AddLinkeBahamutAdminaddproduct", "sofacafedeps");
	...
	@Override
	public Class<AddLinkeBahamutAdminaddproductResponse> getResponseClass() {
		return AddLinkeBahamutAdminaddproductResponse.class;
	}
