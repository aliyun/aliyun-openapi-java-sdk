...
import com.aliyuncs.sofa.transform.v20190815.RetryrollbackLinkeBahamutWebapirecoveryinitinstanceResponseUnmarshaller;
 ...
 * @version 
 */
public class RetryrollbackLinkeBahamutWebapirecoveryinitinstanceResponse extends AcsResponse {
	...
	@Override
	public RetryrollbackLinkeBahamutWebapirecoveryinitinstanceResponse getInstance(UnmarshallerContext context) {
		return	RetryrollbackLinkeBahamutWebapirecoveryinitinstanceResponseUnmarshaller.unmarshall(this, context);
	}
