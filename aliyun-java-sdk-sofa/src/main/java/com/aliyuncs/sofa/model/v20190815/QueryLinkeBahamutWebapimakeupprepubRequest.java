 ...
 * @version 
 */
public class QueryLinkeBahamutWebapimakeupprepubRequest extends RpcAcsRequest<QueryLinkeBahamutWebapimakeupprepubResponse> {
	...
	@Override
	public Class<QueryLinkeBahamutWebapimakeupprepubResponse> getResponseClass() {
		return QueryLinkeBahamutWebapimakeupprepubResponse.class;
	}
