...
import com.aliyuncs.sofa.transform.v20190815.UpdateLinkeLinklogAccountResponseUnmarshaller;
 ...
 * @version 
 */
public class UpdateLinkeLinklogAccountResponse extends AcsResponse {
	...
	@Override
	public UpdateLinkeLinklogAccountResponse getInstance(UnmarshallerContext context) {
		return	UpdateLinkeLinklogAccountResponseUnmarshaller.unmarshall(this, context);
	}
