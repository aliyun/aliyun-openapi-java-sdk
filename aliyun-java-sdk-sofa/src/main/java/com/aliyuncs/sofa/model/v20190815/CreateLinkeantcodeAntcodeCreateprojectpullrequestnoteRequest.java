 ...
 * @version 
 */
public class CreateLinkeantcodeAntcodeCreateprojectpullrequestnoteRequest extends RpcAcsRequest<CreateLinkeantcodeAntcodeCreateprojectpullrequestnoteResponse> {
	...
	public void setNotify(String notify) {
		this.notify = notify;
		if(notify != null){
			putBodyParameter("Notify", notify);
		}
	}
	...
	@Override
	public Class<CreateLinkeantcodeAntcodeCreateprojectpullrequestnoteResponse> getResponseClass() {
		return CreateLinkeantcodeAntcodeCreateprojectpullrequestnoteResponse.class;
	}
