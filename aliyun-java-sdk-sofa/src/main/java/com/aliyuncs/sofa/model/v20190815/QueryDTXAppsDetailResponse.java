...
import com.aliyuncs.sofa.transform.v20190815.QueryDTXAppsDetailResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryDTXAppsDetailResponse extends AcsResponse {
	...
	@Override
	public QueryDTXAppsDetailResponse getInstance(UnmarshallerContext context) {
		return	QueryDTXAppsDetailResponseUnmarshaller.unmarshall(this, context);
	}
