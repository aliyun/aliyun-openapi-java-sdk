...
import com.aliyuncs.sofa.transform.v20190815.ListDTXNewAppsResponseUnmarshaller;
 ...
 * @version 
 */
public class ListDTXNewAppsResponse extends AcsResponse {
	...
	@Override
	public ListDTXNewAppsResponse getInstance(UnmarshallerContext context) {
		return	ListDTXNewAppsResponseUnmarshaller.unmarshall(this, context);
	}
