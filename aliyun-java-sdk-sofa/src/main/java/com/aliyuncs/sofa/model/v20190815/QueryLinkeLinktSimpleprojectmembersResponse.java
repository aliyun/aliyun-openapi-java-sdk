...
import com.aliyuncs.sofa.transform.v20190815.QueryLinkeLinktSimpleprojectmembersResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryLinkeLinktSimpleprojectmembersResponse extends AcsResponse {
	...
	@Override
	public QueryLinkeLinktSimpleprojectmembersResponse getInstance(UnmarshallerContext context) {
		return	QueryLinkeLinktSimpleprojectmembersResponseUnmarshaller.unmarshall(this, context);
	}
