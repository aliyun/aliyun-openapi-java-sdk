 ...
 * @version 
 */
public class QueryMsRcSyncTaskRequest extends RpcAcsRequest<QueryMsRcSyncTaskResponse> {
	...
	public QueryMsRcSyncTaskRequest() {
		super("SOFA", "2019-08-15", "QueryMsRcSyncTask", "sofacafedeps");
	...
	@Override
	public Class<QueryMsRcSyncTaskResponse> getResponseClass() {
		return QueryMsRcSyncTaskResponse.class;
	}
