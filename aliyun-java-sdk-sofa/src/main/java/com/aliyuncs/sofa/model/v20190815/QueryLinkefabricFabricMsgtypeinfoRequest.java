 ...
 * @version 
 */
public class QueryLinkefabricFabricMsgtypeinfoRequest extends RpcAcsRequest<QueryLinkefabricFabricMsgtypeinfoResponse> {
	...
	public QueryLinkefabricFabricMsgtypeinfoRequest() {
		super("SOFA", "2019-08-15", "QueryLinkefabricFabricMsgtypeinfo", "sofacafedeps");
	...
	@Override
	public Class<QueryLinkefabricFabricMsgtypeinfoResponse> getResponseClass() {
		return QueryLinkefabricFabricMsgtypeinfoResponse.class;
	}
