...
import com.aliyuncs.sofa.transform.v20190815.QueryLinkeBahamutAoneinternaliterationResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryLinkeBahamutAoneinternaliterationResponse extends AcsResponse {
	...
	@Override
	public QueryLinkeBahamutAoneinternaliterationResponse getInstance(UnmarshallerContext context) {
		return	QueryLinkeBahamutAoneinternaliterationResponseUnmarshaller.unmarshall(this, context);
	}
