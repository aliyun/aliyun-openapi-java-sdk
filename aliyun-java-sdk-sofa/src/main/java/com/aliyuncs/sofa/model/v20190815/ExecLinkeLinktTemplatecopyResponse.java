...
import com.aliyuncs.sofa.transform.v20190815.ExecLinkeLinktTemplatecopyResponseUnmarshaller;
 ...
 * @version 
 */
public class ExecLinkeLinktTemplatecopyResponse extends AcsResponse {
	...
	@Override
	public ExecLinkeLinktTemplatecopyResponse getInstance(UnmarshallerContext context) {
		return	ExecLinkeLinktTemplatecopyResponseUnmarshaller.unmarshall(this, context);
	}
