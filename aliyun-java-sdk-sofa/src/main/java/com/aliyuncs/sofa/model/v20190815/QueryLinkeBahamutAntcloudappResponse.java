...
import com.aliyuncs.sofa.transform.v20190815.QueryLinkeBahamutAntcloudappResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryLinkeBahamutAntcloudappResponse extends AcsResponse {
	...
	@Override
	public QueryLinkeBahamutAntcloudappResponse getInstance(UnmarshallerContext context) {
		return	QueryLinkeBahamutAntcloudappResponseUnmarshaller.unmarshall(this, context);
	}
