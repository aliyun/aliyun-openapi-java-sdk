 ...
 * @version 
 */
public class GetLinkeBahamutIterationgetiterationgrouppipelinesoftimelineRequest extends RpcAcsRequest<GetLinkeBahamutIterationgetiterationgrouppipelinesoftimelineResponse> {
	...
	public GetLinkeBahamutIterationgetiterationgrouppipelinesoftimelineRequest() {
		super("SOFA", "2019-08-15", "GetLinkeBahamutIterationgetiterationgrouppipelinesoftimeline", "sofacafedeps");
	...
	@Override
	public Class<GetLinkeBahamutIterationgetiterationgrouppipelinesoftimelineResponse> getResponseClass() {
		return GetLinkeBahamutIterationgetiterationgrouppipelinesoftimelineResponse.class;
	}
