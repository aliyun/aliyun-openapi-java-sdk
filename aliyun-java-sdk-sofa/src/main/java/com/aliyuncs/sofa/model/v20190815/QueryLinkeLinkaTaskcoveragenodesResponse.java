...
import com.aliyuncs.sofa.transform.v20190815.QueryLinkeLinkaTaskcoveragenodesResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryLinkeLinkaTaskcoveragenodesResponse extends AcsResponse {
	...
	@Override
	public QueryLinkeLinkaTaskcoveragenodesResponse getInstance(UnmarshallerContext context) {
		return	QueryLinkeLinkaTaskcoveragenodesResponseUnmarshaller.unmarshall(this, context);
	}
