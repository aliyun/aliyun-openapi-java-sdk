 ...
 * @version 
 */
public class QueryLinkeLinktStatisticsRequest extends RpcAcsRequest<QueryLinkeLinktStatisticsResponse> {
	...
	@Override
	public Class<QueryLinkeLinktStatisticsResponse> getResponseClass() {
		return QueryLinkeLinktStatisticsResponse.class;
	}
