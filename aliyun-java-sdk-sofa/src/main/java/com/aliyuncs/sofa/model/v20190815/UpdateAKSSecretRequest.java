 ...
 * @version 
 */
public class UpdateAKSSecretRequest extends RpcAcsRequest<UpdateAKSSecretResponse> {
	...
	public UpdateAKSSecretRequest() {
		super("SOFA", "2019-08-15", "UpdateAKSSecret", "ApplySidecarCert");
	...
	@Override
	public Class<UpdateAKSSecretResponse> getResponseClass() {
		return UpdateAKSSecretResponse.class;
	}
