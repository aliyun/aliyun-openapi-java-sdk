...
import com.aliyuncs.sofa.transform.v20190815.UpdateLinkeantcodeAntcodeTenantserviceResponseUnmarshaller;
 ...
 * @version 
 */
public class UpdateLinkeantcodeAntcodeTenantserviceResponse extends AcsResponse {
	...
	@Override
	public UpdateLinkeantcodeAntcodeTenantserviceResponse getInstance(UnmarshallerContext context) {
		return	UpdateLinkeantcodeAntcodeTenantserviceResponseUnmarshaller.unmarshall(this, context);
	}
