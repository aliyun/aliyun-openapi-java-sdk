 ...
 * @version 
 */
public class QueryODPJobsSqlbatchRequest extends RpcAcsRequest<QueryODPJobsSqlbatchResponse> {
	...
	public QueryODPJobsSqlbatchRequest() {
		super("SOFA", "2019-08-15", "QueryODPJobsSqlbatch", "ApplySidecarCert");
	...
	@Override
	public Class<QueryODPJobsSqlbatchResponse> getResponseClass() {
		return QueryODPJobsSqlbatchResponse.class;
	}
