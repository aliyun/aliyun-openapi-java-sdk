...
import com.aliyuncs.sofa.transform.v20190815.UpdateLinkeLinktIterationResponseUnmarshaller;
 ...
 * @version 
 */
public class UpdateLinkeLinktIterationResponse extends AcsResponse {
	...
	@Override
	public UpdateLinkeLinktIterationResponse getInstance(UnmarshallerContext context) {
		return	UpdateLinkeLinktIterationResponseUnmarshaller.unmarshall(this, context);
	}
