...
import com.aliyuncs.sofa.transform.v20190815.UpdateLinkeBahamutIterationupdateiterationworkitemsResponseUnmarshaller;
 ...
 * @version 
 */
public class UpdateLinkeBahamutIterationupdateiterationworkitemsResponse extends AcsResponse {
	...
	public static class ResultItem {
		...
		private List<String> mergeRequestIds;
		...
		public List<String> getMergeRequestIds() {
			return this.mergeRequestIds;
		}

		public void setMergeRequestIds(List<String> mergeRequestIds) {
			this.mergeRequestIds = mergeRequestIds;
		}
	}

	@Override
	public UpdateLinkeBahamutIterationupdateiterationworkitemsResponse getInstance(UnmarshallerContext context) {
		return	UpdateLinkeBahamutIterationupdateiterationworkitemsResponseUnmarshaller.unmarshall(this, context);
	}
