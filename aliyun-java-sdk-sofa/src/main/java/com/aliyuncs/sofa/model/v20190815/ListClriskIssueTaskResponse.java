...
import com.aliyuncs.sofa.transform.v20190815.ListClriskIssueTaskResponseUnmarshaller;
 ...
 * @version 
 */
public class ListClriskIssueTaskResponse extends AcsResponse {
	...
	@Override
	public ListClriskIssueTaskResponse getInstance(UnmarshallerContext context) {
		return	ListClriskIssueTaskResponseUnmarshaller.unmarshall(this, context);
	}
