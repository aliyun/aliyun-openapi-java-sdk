 ...
 * @version 
 */
public class CreateDTXAppsActionRequest extends RpcAcsRequest<CreateDTXAppsActionResponse> {
	...
	@Override
	public Class<CreateDTXAppsActionResponse> getResponseClass() {
		return CreateDTXAppsActionResponse.class;
	}
