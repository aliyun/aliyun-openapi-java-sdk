...
import com.aliyuncs.sofa.transform.v20190815.QueryLinkeLinkaPmdtaskresultResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryLinkeLinkaPmdtaskresultResponse extends AcsResponse {
	...
	@Override
	public QueryLinkeLinkaPmdtaskresultResponse getInstance(UnmarshallerContext context) {
		return	QueryLinkeLinkaPmdtaskresultResponseUnmarshaller.unmarshall(this, context);
	}
