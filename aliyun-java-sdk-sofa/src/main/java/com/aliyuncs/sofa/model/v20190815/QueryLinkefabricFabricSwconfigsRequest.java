 ...
 * @version 
 */
public class QueryLinkefabricFabricSwconfigsRequest extends RpcAcsRequest<QueryLinkefabricFabricSwconfigsResponse> {
	...
	public QueryLinkefabricFabricSwconfigsRequest() {
		super("SOFA", "2019-08-15", "QueryLinkefabricFabricSwconfigs", "sofacafedeps");
	...
	@Override
	public Class<QueryLinkefabricFabricSwconfigsResponse> getResponseClass() {
		return QueryLinkefabricFabricSwconfigsResponse.class;
	}
