...
import com.aliyuncs.sofa.transform.v20190815.QueryRmsCloudmeshTopappservicesResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryRmsCloudmeshTopappservicesResponse extends AcsResponse {
	...
	@Override
	public QueryRmsCloudmeshTopappservicesResponse getInstance(UnmarshallerContext context) {
		return	QueryRmsCloudmeshTopappservicesResponseUnmarshaller.unmarshall(this, context);
	}
