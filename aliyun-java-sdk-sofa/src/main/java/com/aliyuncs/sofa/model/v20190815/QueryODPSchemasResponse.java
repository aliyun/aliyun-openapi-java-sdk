...
import com.aliyuncs.sofa.transform.v20190815.QueryODPSchemasResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryODPSchemasResponse extends AcsResponse {
	...
	@Override
	public QueryODPSchemasResponse getInstance(UnmarshallerContext context) {
		return	QueryODPSchemasResponseUnmarshaller.unmarshall(this, context);
	}
