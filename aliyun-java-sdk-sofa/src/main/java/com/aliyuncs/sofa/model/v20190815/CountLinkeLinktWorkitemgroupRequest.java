 ...
 * @version 
 */
public class CountLinkeLinktWorkitemgroupRequest extends RpcAcsRequest<CountLinkeLinktWorkitemgroupResponse> {
	...
	@Override
	public Class<CountLinkeLinktWorkitemgroupResponse> getResponseClass() {
