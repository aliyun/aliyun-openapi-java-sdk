...
import com.aliyuncs.sofa.transform.v20190815.QueryLinkeLinktRelatedworkitemsResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryLinkeLinktRelatedworkitemsResponse extends AcsResponse {
	...
	@Override
	public QueryLinkeLinktRelatedworkitemsResponse getInstance(UnmarshallerContext context) {
		return	QueryLinkeLinktRelatedworkitemsResponseUnmarshaller.unmarshall(this, context);
	}
