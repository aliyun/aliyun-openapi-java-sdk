...
import com.aliyuncs.sofa.transform.v20190815.CreateAKSConfigmapResponseUnmarshaller;
 ...
 * @version 
 */
public class CreateAKSConfigmapResponse extends AcsResponse {
	...
	@Override
	public CreateAKSConfigmapResponse getInstance(UnmarshallerContext context) {
		return	CreateAKSConfigmapResponseUnmarshaller.unmarshall(this, context);
	}
