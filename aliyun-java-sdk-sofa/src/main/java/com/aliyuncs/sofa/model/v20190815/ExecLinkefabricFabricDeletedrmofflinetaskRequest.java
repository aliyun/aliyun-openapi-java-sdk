 ...
 * @version 
 */
public class ExecLinkefabricFabricDeletedrmofflinetaskRequest extends RpcAcsRequest<ExecLinkefabricFabricDeletedrmofflinetaskResponse> {
	...
	public ExecLinkefabricFabricDeletedrmofflinetaskRequest() {
		super("SOFA", "2019-08-15", "ExecLinkefabricFabricDeletedrmofflinetask", "sofacafedeps");
	...
	@Override
	public Class<ExecLinkefabricFabricDeletedrmofflinetaskResponse> getResponseClass() {
		return ExecLinkefabricFabricDeletedrmofflinetaskResponse.class;
	}
