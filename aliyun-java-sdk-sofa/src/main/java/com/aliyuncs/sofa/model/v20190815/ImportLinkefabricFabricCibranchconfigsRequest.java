 ...
 * @version 
 */
public class ImportLinkefabricFabricCibranchconfigsRequest extends RpcAcsRequest<ImportLinkefabricFabricCibranchconfigsResponse> {
	...
	@Override
	public Class<ImportLinkefabricFabricCibranchconfigsResponse> getResponseClass() {
		return ImportLinkefabricFabricCibranchconfigsResponse.class;
	}
