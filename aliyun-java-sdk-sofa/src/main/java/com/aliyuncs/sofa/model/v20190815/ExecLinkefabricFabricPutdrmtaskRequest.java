 ...
 * @version 
 */
public class ExecLinkefabricFabricPutdrmtaskRequest extends RpcAcsRequest<ExecLinkefabricFabricPutdrmtaskResponse> {
	...
	public ExecLinkefabricFabricPutdrmtaskRequest() {
		super("SOFA", "2019-08-15", "ExecLinkefabricFabricPutdrmtask", "sofacafedeps");
	...
	@Override
	public Class<ExecLinkefabricFabricPutdrmtaskResponse> getResponseClass() {
		return ExecLinkefabricFabricPutdrmtaskResponse.class;
	}
