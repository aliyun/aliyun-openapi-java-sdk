...
import com.aliyuncs.sofa.transform.v20190815.GetCasDatabaseResponseUnmarshaller;
 ...
 * @version 
 */
public class GetCasDatabaseResponse extends AcsResponse {
	...
	@Override
	public GetCasDatabaseResponse getInstance(UnmarshallerContext context) {
		return	GetCasDatabaseResponseUnmarshaller.unmarshall(this, context);
	}
