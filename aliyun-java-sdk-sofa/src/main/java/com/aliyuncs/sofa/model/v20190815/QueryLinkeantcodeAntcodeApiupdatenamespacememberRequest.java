 ...
 * @version 
 */
public class QueryLinkeantcodeAntcodeApiupdatenamespacememberRequest extends RpcAcsRequest<QueryLinkeantcodeAntcodeApiupdatenamespacememberResponse> {
	...
	@Override
	public Class<QueryLinkeantcodeAntcodeApiupdatenamespacememberResponse> getResponseClass() {
		return QueryLinkeantcodeAntcodeApiupdatenamespacememberResponse.class;
	}
