 ...
 * @version 
 */
public class QueryODPSqlAuditStatusRequest extends RpcAcsRequest<QueryODPSqlAuditStatusResponse> {
	...
	public QueryODPSqlAuditStatusRequest() {
		super("SOFA", "2019-08-15", "QueryODPSqlAuditStatus", "sofacafedeps");
	...
	@Override
	public Class<QueryODPSqlAuditStatusResponse> getResponseClass() {
		return QueryODPSqlAuditStatusResponse.class;
	}
