 ...
 * @version 
 */
public class QueryRmsUsersRequest extends RpcAcsRequest<QueryRmsUsersResponse> {
	   

	private String envJsonStr;

	private String queryJsonStr;
	public QueryRmsUsersRequest() {
		super("SOFA", "2019-08-15", "QueryRmsUsers", "ApplySidecarCert");
	...
	@Override
	public Class<QueryRmsUsersResponse> getResponseClass() {
		return QueryRmsUsersResponse.class;
	}
