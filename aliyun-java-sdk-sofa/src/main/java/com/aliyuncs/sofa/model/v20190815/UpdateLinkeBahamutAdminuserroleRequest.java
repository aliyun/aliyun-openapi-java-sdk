 ...
 * @version 
 */
public class UpdateLinkeBahamutAdminuserroleRequest extends RpcAcsRequest<UpdateLinkeBahamutAdminuserroleResponse> {
	...
	public UpdateLinkeBahamutAdminuserroleRequest() {
		super("SOFA", "2019-08-15", "UpdateLinkeBahamutAdminuserrole", "sofacafedeps");
	...
	@Override
	public Class<UpdateLinkeBahamutAdminuserroleResponse> getResponseClass() {
		return UpdateLinkeBahamutAdminuserroleResponse.class;
	}
