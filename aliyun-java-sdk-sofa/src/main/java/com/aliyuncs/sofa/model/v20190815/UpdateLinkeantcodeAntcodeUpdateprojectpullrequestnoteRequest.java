 ...
 * @version 
 */
public class UpdateLinkeantcodeAntcodeUpdateprojectpullrequestnoteRequest extends RpcAcsRequest<UpdateLinkeantcodeAntcodeUpdateprojectpullrequestnoteResponse> {
	...
	@Override
	public Class<UpdateLinkeantcodeAntcodeUpdateprojectpullrequestnoteResponse> getResponseClass() {
		return UpdateLinkeantcodeAntcodeUpdateprojectpullrequestnoteResponse.class;
	}
