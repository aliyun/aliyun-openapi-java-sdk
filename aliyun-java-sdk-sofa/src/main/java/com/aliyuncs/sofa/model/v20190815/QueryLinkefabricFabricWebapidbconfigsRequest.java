 ...
 * @version 
 */
public class QueryLinkefabricFabricWebapidbconfigsRequest extends RpcAcsRequest<QueryLinkefabricFabricWebapidbconfigsResponse> {
	...
	public QueryLinkefabricFabricWebapidbconfigsRequest() {
		super("SOFA", "2019-08-15", "QueryLinkefabricFabricWebapidbconfigs", "sofacafedeps");
	...
	@Override
	public Class<QueryLinkefabricFabricWebapidbconfigsResponse> getResponseClass() {
		return QueryLinkefabricFabricWebapidbconfigsResponse.class;
	}
