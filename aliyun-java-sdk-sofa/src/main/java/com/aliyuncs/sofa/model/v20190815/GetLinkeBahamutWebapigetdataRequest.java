 ...
 * @version 
 */
public class GetLinkeBahamutWebapigetdataRequest extends RpcAcsRequest<GetLinkeBahamutWebapigetdataResponse> {
	...
	@Override
	public Class<GetLinkeBahamutWebapigetdataResponse> getResponseClass() {
		return GetLinkeBahamutWebapigetdataResponse.class;
	}
