 ...
 * @version 
 */
public class QueryODPSchemasConnPropsRequest extends RpcAcsRequest<QueryODPSchemasConnPropsResponse> {
	...
	public QueryODPSchemasConnPropsRequest() {
		super("SOFA", "2019-08-15", "QueryODPSchemasConnProps", "ApplySidecarCert");
	...
	@Override
	public Class<QueryODPSchemasConnPropsResponse> getResponseClass() {
		return QueryODPSchemasConnPropsResponse.class;
	}
