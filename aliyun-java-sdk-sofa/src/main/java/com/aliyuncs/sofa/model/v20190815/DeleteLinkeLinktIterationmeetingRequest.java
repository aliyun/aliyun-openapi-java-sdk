...
public class DeleteLinkeLinktIterationmeetingRequest extends RpcAcsRequest<DeleteLinkeLinktIterationmeetingResponse> {
	...
	public DeleteLinkeLinktIterationmeetingRequest() {
		super("SOFA", "2019-08-15", "DeleteLinkeLinktIterationmeeting", "sofacafedeps");
	...
	@Override
	public Class<DeleteLinkeLinktIterationmeetingResponse> getResponseClass() {
		return DeleteLinkeLinktIterationmeetingResponse.class;
	}
