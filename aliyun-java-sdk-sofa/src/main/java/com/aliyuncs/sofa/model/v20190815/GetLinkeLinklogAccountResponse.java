...
import com.aliyuncs.sofa.transform.v20190815.GetLinkeLinklogAccountResponseUnmarshaller;
 ...
 * @version 
 */
public class GetLinkeLinklogAccountResponse extends AcsResponse {
	...
	@Override
	public GetLinkeLinklogAccountResponse getInstance(UnmarshallerContext context) {
		return	GetLinkeLinklogAccountResponseUnmarshaller.unmarshall(this, context);
	}
