 ...
 * @version 
 */
public class ExecLinkefabricFabricGetdrmofflinetaskRequest extends RpcAcsRequest<ExecLinkefabricFabricGetdrmofflinetaskResponse> {
	...
	public ExecLinkefabricFabricGetdrmofflinetaskRequest() {
		super("SOFA", "2019-08-15", "ExecLinkefabricFabricGetdrmofflinetask", "sofacafedeps");
	...
	@Override
	public Class<ExecLinkefabricFabricGetdrmofflinetaskResponse> getResponseClass() {
		return ExecLinkefabricFabricGetdrmofflinetaskResponse.class;
	}
