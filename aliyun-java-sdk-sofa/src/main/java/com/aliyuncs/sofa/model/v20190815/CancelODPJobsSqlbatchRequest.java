 ...
 * @version 
 */
public class CancelODPJobsSqlbatchRequest extends RpcAcsRequest<CancelODPJobsSqlbatchResponse> {
	...
	public CancelODPJobsSqlbatchRequest() {
		super("SOFA", "2019-08-15", "CancelODPJobsSqlbatch", "ApplySidecarCert");
	...
	@Override
	public Class<CancelODPJobsSqlbatchResponse> getResponseClass() {
		return CancelODPJobsSqlbatchResponse.class;
	}
