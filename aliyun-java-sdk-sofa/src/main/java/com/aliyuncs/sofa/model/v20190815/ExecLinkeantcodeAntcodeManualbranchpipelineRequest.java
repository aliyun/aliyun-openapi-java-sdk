 ...
 * @version 
 */
public class ExecLinkeantcodeAntcodeManualbranchpipelineRequest extends RpcAcsRequest<ExecLinkeantcodeAntcodeManualbranchpipelineResponse> {
	...
	@Override
	public Class<ExecLinkeantcodeAntcodeManualbranchpipelineResponse> getResponseClass() {
		return ExecLinkeantcodeAntcodeManualbranchpipelineResponse.class;
	}
