...
import com.aliyuncs.sofa.transform.v20190815.QueryLinkeLinktProjectongoingiterationsResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryLinkeLinktProjectongoingiterationsResponse extends AcsResponse {
	...
	@Override
	public QueryLinkeLinktProjectongoingiterationsResponse getInstance(UnmarshallerContext context) {
		return	QueryLinkeLinktProjectongoingiterationsResponseUnmarshaller.unmarshall(this, context);
	}
