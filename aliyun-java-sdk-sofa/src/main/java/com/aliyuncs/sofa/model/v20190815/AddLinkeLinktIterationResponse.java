...
import com.aliyuncs.sofa.transform.v20190815.AddLinkeLinktIterationResponseUnmarshaller;
 ...
 * @version 
 */
public class AddLinkeLinktIterationResponse extends AcsResponse {
	...
	@Override
	public AddLinkeLinktIterationResponse getInstance(UnmarshallerContext context) {
		return	AddLinkeLinktIterationResponseUnmarshaller.unmarshall(this, context);
	}
