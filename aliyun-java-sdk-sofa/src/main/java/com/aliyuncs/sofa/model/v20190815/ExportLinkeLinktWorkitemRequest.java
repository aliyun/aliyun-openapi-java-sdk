 ...
 * @version 
 */
public class ExportLinkeLinktWorkitemRequest extends RpcAcsRequest<ExportLinkeLinktWorkitemResponse> {
	...
	@Override
	public Class<ExportLinkeLinktWorkitemResponse> getResponseClass() {
		return ExportLinkeLinktWorkitemResponse.class;
	}
