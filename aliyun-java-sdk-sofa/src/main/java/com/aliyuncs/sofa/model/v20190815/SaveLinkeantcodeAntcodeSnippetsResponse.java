...
import com.aliyuncs.sofa.transform.v20190815.SaveLinkeantcodeAntcodeSnippetsResponseUnmarshaller;
 ...
 * @version 
 */
public class SaveLinkeantcodeAntcodeSnippetsResponse extends AcsResponse {
	...
	@Override
	public SaveLinkeantcodeAntcodeSnippetsResponse getInstance(UnmarshallerContext context) {
		return	SaveLinkeantcodeAntcodeSnippetsResponseUnmarshaller.unmarshall(this, context);
	}
