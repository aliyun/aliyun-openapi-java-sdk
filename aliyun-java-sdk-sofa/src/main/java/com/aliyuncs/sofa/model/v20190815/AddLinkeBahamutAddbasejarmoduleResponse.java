...
import com.aliyuncs.sofa.transform.v20190815.AddLinkeBahamutAddbasejarmoduleResponseUnmarshaller;
 ...
 * @version 
 */
public class AddLinkeBahamutAddbasejarmoduleResponse extends AcsResponse {
	...
	@Override
	public AddLinkeBahamutAddbasejarmoduleResponse getInstance(UnmarshallerContext context) {
		return	AddLinkeBahamutAddbasejarmoduleResponseUnmarshaller.unmarshall(this, context);
	}
