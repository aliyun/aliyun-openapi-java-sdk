...
import com.aliyuncs.sofa.transform.v20190815.QueryMsTransparentProxyAppResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryMsTransparentProxyAppResponse extends AcsResponse {
	...
	@Override
	public QueryMsTransparentProxyAppResponse getInstance(UnmarshallerContext context) {
		return	QueryMsTransparentProxyAppResponseUnmarshaller.unmarshall(this, context);
	}
