 ...
 * @version 
 */
public class GetLinkeBahamutGetcloudworkspaceRequest extends RpcAcsRequest<GetLinkeBahamutGetcloudworkspaceResponse> {
	...
	public void setCurrentStage(String currentStage) {
		...
		if(currentStage != null){
			putBodyParameter("CurrentStage", currentStage);
		}
	}
	...
	@Override
	public Class<GetLinkeBahamutGetcloudworkspaceResponse> getResponseClass() {
		return GetLinkeBahamutGetcloudworkspaceResponse.class;
	}
