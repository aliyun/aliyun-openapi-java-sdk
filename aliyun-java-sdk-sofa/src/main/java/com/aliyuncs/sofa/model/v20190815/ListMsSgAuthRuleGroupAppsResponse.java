...
import com.aliyuncs.sofa.transform.v20190815.ListMsSgAuthRuleGroupAppsResponseUnmarshaller;
 ...
 * @version 
 */
public class ListMsSgAuthRuleGroupAppsResponse extends AcsResponse {
	...
	@Override
	public ListMsSgAuthRuleGroupAppsResponse getInstance(UnmarshallerContext context) {
		return	ListMsSgAuthRuleGroupAppsResponseUnmarshaller.unmarshall(this, context);
	}
