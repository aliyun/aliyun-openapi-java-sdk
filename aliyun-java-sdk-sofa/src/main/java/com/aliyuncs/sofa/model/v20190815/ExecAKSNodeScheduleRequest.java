 ...
 * @version 
 */
public class ExecAKSNodeScheduleRequest extends RpcAcsRequest<ExecAKSNodeScheduleResponse> {
	...
	public ExecAKSNodeScheduleRequest() {
		super("SOFA", "2019-08-15", "ExecAKSNodeSchedule", "ApplySidecarCert");
	...
	@Override
	public Class<ExecAKSNodeScheduleResponse> getResponseClass() {
		return ExecAKSNodeScheduleResponse.class;
	}
