...
public class ExecLinkeLinktCreatestatusandaddtoworkflowRequest extends RpcAcsRequest<ExecLinkeLinktCreatestatusandaddtoworkflowResponse> {
	...
	public ExecLinkeLinktCreatestatusandaddtoworkflowRequest() {
		super("SOFA", "2019-08-15", "ExecLinkeLinktCreatestatusandaddtoworkflow", "sofacafedeps");
	...
	@Override
	public Class<ExecLinkeLinktCreatestatusandaddtoworkflowResponse> getResponseClass() {
		return ExecLinkeLinktCreatestatusandaddtoworkflowResponse.class;
	}
