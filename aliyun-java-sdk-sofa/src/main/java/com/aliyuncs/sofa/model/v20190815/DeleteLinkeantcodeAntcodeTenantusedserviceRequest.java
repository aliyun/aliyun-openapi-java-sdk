 ...
 * @version 
 */
public class DeleteLinkeantcodeAntcodeTenantusedserviceRequest extends RpcAcsRequest<DeleteLinkeantcodeAntcodeTenantusedserviceResponse> {
	...
	@Override
	public Class<DeleteLinkeantcodeAntcodeTenantusedserviceResponse> getResponseClass() {
		return DeleteLinkeantcodeAntcodeTenantusedserviceResponse.class;
	}
