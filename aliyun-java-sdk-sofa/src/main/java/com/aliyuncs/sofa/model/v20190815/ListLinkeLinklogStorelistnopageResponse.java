...
import com.aliyuncs.sofa.transform.v20190815.ListLinkeLinklogStorelistnopageResponseUnmarshaller;
 ...
 * @version 
 */
public class ListLinkeLinklogStorelistnopageResponse extends AcsResponse {
	...
	@Override
	public ListLinkeLinklogStorelistnopageResponse getInstance(UnmarshallerContext context) {
		return	ListLinkeLinklogStorelistnopageResponseUnmarshaller.unmarshall(this, context);
	}
