...
import com.aliyuncs.sofa.transform.v20190815.CreateLinkeantcodeAntcodeTenantserviceResponseUnmarshaller;
 ...
 * @version 
 */
public class CreateLinkeantcodeAntcodeTenantserviceResponse extends AcsResponse {
	...
	@Override
	public CreateLinkeantcodeAntcodeTenantserviceResponse getInstance(UnmarshallerContext context) {
		return	CreateLinkeantcodeAntcodeTenantserviceResponseUnmarshaller.unmarshall(this, context);
	}
