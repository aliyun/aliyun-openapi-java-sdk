...
import com.aliyuncs.sofa.transform.v20190815.GetLinkeBahamutAppstypeResponseUnmarshaller;
 ...
 * @version 
 */
public class GetLinkeBahamutAppstypeResponse extends AcsResponse {
	...
	@Override
	public GetLinkeBahamutAppstypeResponse getInstance(UnmarshallerContext context) {
		return	GetLinkeBahamutAppstypeResponseUnmarshaller.unmarshall(this, context);
	}
