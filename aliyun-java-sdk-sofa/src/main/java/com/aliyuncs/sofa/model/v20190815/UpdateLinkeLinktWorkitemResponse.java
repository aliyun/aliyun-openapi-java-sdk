...
import com.aliyuncs.sofa.transform.v20190815.UpdateLinkeLinktWorkitemResponseUnmarshaller;
 ...
 * @version 
 */
public class UpdateLinkeLinktWorkitemResponse extends AcsResponse {
	...
	@Override
	public UpdateLinkeLinktWorkitemResponse getInstance(UnmarshallerContext context) {
		return	UpdateLinkeLinktWorkitemResponseUnmarshaller.unmarshall(this, context);
	}
