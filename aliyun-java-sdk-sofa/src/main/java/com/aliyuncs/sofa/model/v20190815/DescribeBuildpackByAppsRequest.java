 ...
 * @version 
 */
public class DescribeBuildpackByAppsRequest extends RpcAcsRequest<DescribeBuildpackByAppsResponse> {
	...
	public DescribeBuildpackByAppsRequest() {
		super("SOFA", "2019-08-15", "DescribeBuildpackByApps", "sofacafedeps");
	...
	@Override
	public Class<DescribeBuildpackByAppsResponse> getResponseClass() {
		return DescribeBuildpackByAppsResponse.class;
	}
