...
import com.aliyuncs.sofa.transform.v20190815.ListLinkeLinktTemplatecustomfieldsResponseUnmarshaller;
 ...
 * @version 
 */
public class ListLinkeLinktTemplatecustomfieldsResponse extends AcsResponse {
	...
	@Override
	public ListLinkeLinktTemplatecustomfieldsResponse getInstance(UnmarshallerContext context) {
		return	ListLinkeLinktTemplatecustomfieldsResponseUnmarshaller.unmarshall(this, context);
	}
