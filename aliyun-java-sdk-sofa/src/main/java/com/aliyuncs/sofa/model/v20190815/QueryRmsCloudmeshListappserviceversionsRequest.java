 ...
 * @version 
 */
public class QueryRmsCloudmeshListappserviceversionsRequest extends RpcAcsRequest<QueryRmsCloudmeshListappserviceversionsResponse> {
	...
	public QueryRmsCloudmeshListappserviceversionsRequest() {
		super("SOFA", "2019-08-15", "QueryRmsCloudmeshListappserviceversions", "ApplySidecarCert");
	...
	@Override
	public Class<QueryRmsCloudmeshListappserviceversionsResponse> getResponseClass() {
		return QueryRmsCloudmeshListappserviceversionsResponse.class;
	}
