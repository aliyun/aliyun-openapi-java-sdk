 ...
 * @version 
 */
public class DebugClriskTemplateRuleRequest extends RpcAcsRequest<DebugClriskTemplateRuleResponse> {
	...
	public DebugClriskTemplateRuleRequest() {
		super("SOFA", "2019-08-15", "DebugClriskTemplateRule", "sofacaferms");
	...
	@Override
	public Class<DebugClriskTemplateRuleResponse> getResponseClass() {
		return DebugClriskTemplateRuleResponse.class;
	}
