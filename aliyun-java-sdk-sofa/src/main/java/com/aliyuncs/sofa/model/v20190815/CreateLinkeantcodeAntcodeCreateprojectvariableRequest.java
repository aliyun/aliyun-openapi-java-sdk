 ...
 * @version 
 */
public class CreateLinkeantcodeAntcodeCreateprojectvariableRequest extends RpcAcsRequest<CreateLinkeantcodeAntcodeCreateprojectvariableResponse> {
	...
	public void setVariableJsonStr(String variableJsonStr) {
		this.variableJsonStr = variableJsonStr;
		if(variableJsonStr != null){
			putBodyParameter("VariableJsonStr", variableJsonStr);
		}
	}

	@Override
	public Class<CreateLinkeantcodeAntcodeCreateprojectvariableResponse> getResponseClass() {
		return CreateLinkeantcodeAntcodeCreateprojectvariableResponse.class;
	}
