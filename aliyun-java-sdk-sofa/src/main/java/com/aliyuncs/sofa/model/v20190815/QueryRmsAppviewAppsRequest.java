 ...
 * @version 
 */
public class QueryRmsAppviewAppsRequest extends RpcAcsRequest<QueryRmsAppviewAppsResponse> {
	   

	private String envJsonStr;

	private String queryJsonStr;
	public QueryRmsAppviewAppsRequest() {
		super("SOFA", "2019-08-15", "QueryRmsAppviewApps", "ApplySidecarCert");
	...
	@Override
	public Class<QueryRmsAppviewAppsResponse> getResponseClass() {
		return QueryRmsAppviewAppsResponse.class;
	}
