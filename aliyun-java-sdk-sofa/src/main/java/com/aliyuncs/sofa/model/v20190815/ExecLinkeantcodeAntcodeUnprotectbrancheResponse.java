...
import com.aliyuncs.sofa.transform.v20190815.ExecLinkeantcodeAntcodeUnprotectbrancheResponseUnmarshaller;
 ...
 * @version 
 */
public class ExecLinkeantcodeAntcodeUnprotectbrancheResponse extends AcsResponse {
	...
	@Override
	public ExecLinkeantcodeAntcodeUnprotectbrancheResponse getInstance(UnmarshallerContext context) {
		return	ExecLinkeantcodeAntcodeUnprotectbrancheResponseUnmarshaller.unmarshall(this, context);
	}
