...
import com.aliyuncs.sofa.transform.v20190815.DeleteBuildpacksResponseUnmarshaller;
 ...
 * @version 
 */
public class DeleteBuildpacksResponse extends AcsResponse {
	...
	private List<BuildpackDetailVoItem> buildpackDetailVo;
	...
	public List<BuildpackDetailVoItem> getBuildpackDetailVo() {
		return this.buildpackDetailVo;
	}

	public void setBuildpackDetailVo(List<BuildpackDetailVoItem> buildpackDetailVo) {
		this.buildpackDetailVo = buildpackDetailVo;
	}

	public static class BuildpackDetailVoItem {
	...
	@Override
	public DeleteBuildpacksResponse getInstance(UnmarshallerContext context) {
		return	DeleteBuildpacksResponseUnmarshaller.unmarshall(this, context);
	}
