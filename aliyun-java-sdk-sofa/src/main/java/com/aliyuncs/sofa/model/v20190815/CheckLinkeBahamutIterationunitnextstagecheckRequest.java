 ...
 * @version 
 */
public class CheckLinkeBahamutIterationunitnextstagecheckRequest extends RpcAcsRequest<CheckLinkeBahamutIterationunitnextstagecheckResponse> {
	...
	@Override
	public Class<CheckLinkeBahamutIterationunitnextstagecheckResponse> getResponseClass() {
		return CheckLinkeBahamutIterationunitnextstagecheckResponse.class;
	}
