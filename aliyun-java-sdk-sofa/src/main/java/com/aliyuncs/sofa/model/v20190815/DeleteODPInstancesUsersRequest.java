 ...
 * @version 
 */
public class DeleteODPInstancesUsersRequest extends RpcAcsRequest<DeleteODPInstancesUsersResponse> {
	...
	public DeleteODPInstancesUsersRequest() {
		super("SOFA", "2019-08-15", "DeleteODPInstancesUsers", "ApplySidecarCert");
	...
	@Override
	public Class<DeleteODPInstancesUsersResponse> getResponseClass() {
		return DeleteODPInstancesUsersResponse.class;
	}
