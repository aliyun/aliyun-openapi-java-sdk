 ...
 * @version 
 */
public class ExistODPSchemasRequest extends RpcAcsRequest<ExistODPSchemasResponse> {
	...
	public ExistODPSchemasRequest() {
		super("SOFA", "2019-08-15", "ExistODPSchemas", "sofacafedeps");
	...
	@Override
	public Class<ExistODPSchemasResponse> getResponseClass() {
		return ExistODPSchemasResponse.class;
	}
