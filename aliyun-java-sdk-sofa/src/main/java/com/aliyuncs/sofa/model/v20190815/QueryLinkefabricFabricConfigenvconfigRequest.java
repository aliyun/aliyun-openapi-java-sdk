 ...
 * @version 
 */
public class QueryLinkefabricFabricConfigenvconfigRequest extends RpcAcsRequest<QueryLinkefabricFabricConfigenvconfigResponse> {
	...
	public QueryLinkefabricFabricConfigenvconfigRequest() {
		super("SOFA", "2019-08-15", "QueryLinkefabricFabricConfigenvconfig", "sofacafedeps");
	...
	@Override
	public Class<QueryLinkefabricFabricConfigenvconfigResponse> getResponseClass() {
		return QueryLinkefabricFabricConfigenvconfigResponse.class;
	}
