 ...
 * @version 
 */
public class CreateODPSchemasRequest extends RpcAcsRequest<CreateODPSchemasResponse> {
	...
	public CreateODPSchemasRequest() {
		super("SOFA", "2019-08-15", "CreateODPSchemas", "ApplySidecarCert");
	...
	@Override
	public Class<CreateODPSchemasResponse> getResponseClass() {
		return CreateODPSchemasResponse.class;
	}
