 ...
 * @version 
 */
public class CreateDTXAppRequest extends RpcAcsRequest<CreateDTXAppResponse> {
	...
	private String desc;
	public CreateDTXAppRequest() {
		super("SOFA", "2019-08-15", "CreateDTXApp", "sofacafedeps");
	...
	@Override
	public Class<CreateDTXAppResponse> getResponseClass() {
		return CreateDTXAppResponse.class;
	}
