...
import com.aliyuncs.sofa.transform.v20190815.BatchcreateDTXAppsResponseUnmarshaller;
 ...
 * @version 
 */
public class BatchcreateDTXAppsResponse extends AcsResponse {
	...
	@Override
	public BatchcreateDTXAppsResponse getInstance(UnmarshallerContext context) {
		return	BatchcreateDTXAppsResponseUnmarshaller.unmarshall(this, context);
	}
