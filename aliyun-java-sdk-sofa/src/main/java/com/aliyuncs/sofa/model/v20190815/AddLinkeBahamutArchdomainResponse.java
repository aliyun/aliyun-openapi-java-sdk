...
import com.aliyuncs.sofa.transform.v20190815.AddLinkeBahamutArchdomainResponseUnmarshaller;
 ...
 * @version 
 */
public class AddLinkeBahamutArchdomainResponse extends AcsResponse {
	...
	@Override
	public AddLinkeBahamutArchdomainResponse getInstance(UnmarshallerContext context) {
		return	AddLinkeBahamutArchdomainResponseUnmarshaller.unmarshall(this, context);
	}
