 ...
 * @version 
 */
public class ExportODPSchemasRequest extends RpcAcsRequest<ExportODPSchemasResponse> {
	...
	public ExportODPSchemasRequest() {
		super("SOFA", "2019-08-15", "ExportODPSchemas", "ApplySidecarCert");
	...
	@Override
	public Class<ExportODPSchemasResponse> getResponseClass() {
		return ExportODPSchemasResponse.class;
	}
