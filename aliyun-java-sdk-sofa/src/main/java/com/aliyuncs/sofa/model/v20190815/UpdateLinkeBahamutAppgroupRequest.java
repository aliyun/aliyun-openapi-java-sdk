 ...
 * @version 
 */
public class UpdateLinkeBahamutAppgroupRequest extends RpcAcsRequest<UpdateLinkeBahamutAppgroupResponse> {
	...
	private String name;
	public UpdateLinkeBahamutAppgroupRequest() {
		super("SOFA", "2019-08-15", "UpdateLinkeBahamutAppgroup", "sofacafedeps");
	...
	@Override
	public Class<UpdateLinkeBahamutAppgroupResponse> getResponseClass() {
		return UpdateLinkeBahamutAppgroupResponse.class;
	}
