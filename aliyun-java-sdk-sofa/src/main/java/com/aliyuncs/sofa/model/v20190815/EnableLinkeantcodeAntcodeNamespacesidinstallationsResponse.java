...
import com.aliyuncs.sofa.transform.v20190815.EnableLinkeantcodeAntcodeNamespacesidinstallationsResponseUnmarshaller;
 ...
 * @version 
 */
public class EnableLinkeantcodeAntcodeNamespacesidinstallationsResponse extends AcsResponse {
	...
	@Override
	public EnableLinkeantcodeAntcodeNamespacesidinstallationsResponse getInstance(UnmarshallerContext context) {
		return	EnableLinkeantcodeAntcodeNamespacesidinstallationsResponseUnmarshaller.unmarshall(this, context);
	}
