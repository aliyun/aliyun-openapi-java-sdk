 ...
 * @version 
 */
public class CreateLinkeantcodeAntcodeSearchmonitorRequest extends RpcAcsRequest<CreateLinkeantcodeAntcodeSearchmonitorResponse> {
	...
	public void setSequence(String sequence) {
		...
		if(sequence != null){
			putBodyParameter("Sequence", sequence);
		}
	}
	...
	@Override
	public Class<CreateLinkeantcodeAntcodeSearchmonitorResponse> getResponseClass() {
		return CreateLinkeantcodeAntcodeSearchmonitorResponse.class;
	}
