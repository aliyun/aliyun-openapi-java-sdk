...
import com.aliyuncs.sofa.transform.v20190815.QueryMsSgServicesResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryMsSgServicesResponse extends AcsResponse {
	...
	@Override
	public QueryMsSgServicesResponse getInstance(UnmarshallerContext context) {
		return	QueryMsSgServicesResponseUnmarshaller.unmarshall(this, context);
	}
