 ...
 * @version 
 */
public class SetLinkeBahamutReviewRequest extends RpcAcsRequest<SetLinkeBahamutReviewResponse> {
	...
	@Override
	public Class<SetLinkeBahamutReviewResponse> getResponseClass() {
		return SetLinkeBahamutReviewResponse.class;
	}
