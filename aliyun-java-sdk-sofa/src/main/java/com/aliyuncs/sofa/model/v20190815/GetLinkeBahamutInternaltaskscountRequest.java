 ...
 * @version 
 */
public class GetLinkeBahamutInternaltaskscountRequest extends RpcAcsRequest<GetLinkeBahamutInternaltaskscountResponse> {
	...
	@Override
	public Class<GetLinkeBahamutInternaltaskscountResponse> getResponseClass() {
		return GetLinkeBahamutInternaltaskscountResponse.class;
	}
