...
import com.aliyuncs.sofa.transform.v20190815.ExecLinkeantcodeAntcodeUnprotectbranchbynameResponseUnmarshaller;
 ...
 * @version 
 */
public class ExecLinkeantcodeAntcodeUnprotectbranchbynameResponse extends AcsResponse {
	...
	@Override
	public ExecLinkeantcodeAntcodeUnprotectbranchbynameResponse getInstance(UnmarshallerContext context) {
		return	ExecLinkeantcodeAntcodeUnprotectbranchbynameResponseUnmarshaller.unmarshall(this, context);
	}
