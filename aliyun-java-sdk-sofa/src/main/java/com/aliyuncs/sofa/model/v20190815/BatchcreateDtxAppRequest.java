 ...
 * @version 
 */
public class BatchcreateDtxAppRequest extends RpcAcsRequest<BatchcreateDtxAppResponse> {
	...
	@Override
	public Class<BatchcreateDtxAppResponse> getResponseClass() {
		return BatchcreateDtxAppResponse.class;
	}
