 ...
 * @version 
 */
public class ExistBuildpackRequest extends RpcAcsRequest<ExistBuildpackResponse> {
	...
	public ExistBuildpackRequest() {
		super("SOFA", "2019-08-15", "ExistBuildpack", "sofacafedeps");
	...
	@Override
	public Class<ExistBuildpackResponse> getResponseClass() {
		return ExistBuildpackResponse.class;
	}
