 ...
 * @version 
 */
public class ExecLinkefabricFabricPostdrmtaskRequest extends RpcAcsRequest<ExecLinkefabricFabricPostdrmtaskResponse> {
	...
	public ExecLinkefabricFabricPostdrmtaskRequest() {
		super("SOFA", "2019-08-15", "ExecLinkefabricFabricPostdrmtask", "sofacafedeps");
	...
	@Override
	public Class<ExecLinkefabricFabricPostdrmtaskResponse> getResponseClass() {
		return ExecLinkefabricFabricPostdrmtaskResponse.class;
	}
