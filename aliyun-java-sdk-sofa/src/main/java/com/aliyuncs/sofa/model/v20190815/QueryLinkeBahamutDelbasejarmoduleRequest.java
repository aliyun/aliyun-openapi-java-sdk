 ...
 * @version 
 */
public class QueryLinkeBahamutDelbasejarmoduleRequest extends RpcAcsRequest<QueryLinkeBahamutDelbasejarmoduleResponse> {
	...
	@Override
	public Class<QueryLinkeBahamutDelbasejarmoduleResponse> getResponseClass() {
		return QueryLinkeBahamutDelbasejarmoduleResponse.class;
	}
