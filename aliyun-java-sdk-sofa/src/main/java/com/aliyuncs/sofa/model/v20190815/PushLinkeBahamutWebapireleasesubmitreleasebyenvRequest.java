 ...
 * @version 
 */
public class PushLinkeBahamutWebapireleasesubmitreleasebyenvRequest extends RpcAcsRequest<PushLinkeBahamutWebapireleasesubmitreleasebyenvResponse> {
	...
	@Override
	public Class<PushLinkeBahamutWebapireleasesubmitreleasebyenvResponse> getResponseClass() {
		return PushLinkeBahamutWebapireleasesubmitreleasebyenvResponse.class;
	}
