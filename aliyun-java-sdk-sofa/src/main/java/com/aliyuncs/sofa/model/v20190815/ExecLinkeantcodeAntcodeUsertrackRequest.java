 ...
 * @version 
 */
public class ExecLinkeantcodeAntcodeUsertrackRequest extends RpcAcsRequest<ExecLinkeantcodeAntcodeUsertrackResponse> {
	...
	@Override
	public Class<ExecLinkeantcodeAntcodeUsertrackResponse> getResponseClass() {
		return ExecLinkeantcodeAntcodeUsertrackResponse.class;
	}
