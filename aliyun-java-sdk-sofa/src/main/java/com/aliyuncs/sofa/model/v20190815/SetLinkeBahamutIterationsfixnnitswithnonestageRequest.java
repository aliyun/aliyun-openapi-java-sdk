 ...
 * @version 
 */
public class SetLinkeBahamutIterationsfixnnitswithnonestageRequest extends RpcAcsRequest<SetLinkeBahamutIterationsfixnnitswithnonestageResponse> {
	...
	@Override
	public Class<SetLinkeBahamutIterationsfixnnitswithnonestageResponse> getResponseClass() {
		return SetLinkeBahamutIterationsfixnnitswithnonestageResponse.class;
	}
