 ...
 * @version 
 */
public class ExecLinkeantcodeAntcodeAcceptreviewRequest extends RpcAcsRequest<ExecLinkeantcodeAntcodeAcceptreviewResponse> {
	...
	@Override
	public Class<ExecLinkeantcodeAntcodeAcceptreviewResponse> getResponseClass() {
		return ExecLinkeantcodeAntcodeAcceptreviewResponse.class;
	}
