...
import com.aliyuncs.sofa.transform.v20190815.QueryMsSgServiceSubKeysResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryMsSgServiceSubKeysResponse extends AcsResponse {
	...
	@Override
	public QueryMsSgServiceSubKeysResponse getInstance(UnmarshallerContext context) {
		return	QueryMsSgServiceSubKeysResponseUnmarshaller.unmarshall(this, context);
	}
