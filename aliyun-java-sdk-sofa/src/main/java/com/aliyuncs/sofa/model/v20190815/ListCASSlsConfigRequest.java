 ...
 * @version 
 */
public class ListCASSlsConfigRequest extends RpcAcsRequest<ListCASSlsConfigResponse> {
	...
	@Override
	public Class<ListCASSlsConfigResponse> getResponseClass() {
		return ListCASSlsConfigResponse.class;
	}
