...
import com.aliyuncs.sofa.transform.v20190815.AddLinkeantcodeAntcodeTenantinstallationsResponseUnmarshaller;
 ...
 * @version 
 */
public class AddLinkeantcodeAntcodeTenantinstallationsResponse extends AcsResponse {
	...
	@Override
	public AddLinkeantcodeAntcodeTenantinstallationsResponse getInstance(UnmarshallerContext context) {
		return	AddLinkeantcodeAntcodeTenantinstallationsResponseUnmarshaller.unmarshall(this, context);
	}
