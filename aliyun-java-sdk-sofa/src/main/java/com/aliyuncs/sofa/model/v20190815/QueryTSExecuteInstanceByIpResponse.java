...
import com.aliyuncs.sofa.transform.v20190815.QueryTSExecuteInstanceByIpResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryTSExecuteInstanceByIpResponse extends AcsResponse {
	...
	@Override
	public QueryTSExecuteInstanceByIpResponse getInstance(UnmarshallerContext context) {
		return	QueryTSExecuteInstanceByIpResponseUnmarshaller.unmarshall(this, context);
	}
