...
import com.aliyuncs.sofa.transform.v20190815.UpdateLinkeBahamutIterationnameprojectResponseUnmarshaller;
 ...
 * @version 
 */
public class UpdateLinkeBahamutIterationnameprojectResponse extends AcsResponse {
	...
	@Override
	public UpdateLinkeBahamutIterationnameprojectResponse getInstance(UnmarshallerContext context) {
		return	UpdateLinkeBahamutIterationnameprojectResponseUnmarshaller.unmarshall(this, context);
	}
