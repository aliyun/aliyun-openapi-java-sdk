...
public class RemoveLinkeLinktWorkitemtagRequest extends RpcAcsRequest<RemoveLinkeLinktWorkitemtagResponse> {
	...
	public RemoveLinkeLinktWorkitemtagRequest() {
		super("SOFA", "2019-08-15", "RemoveLinkeLinktWorkitemtag", "sofacafedeps");
	...
	@Override
	public Class<RemoveLinkeLinktWorkitemtagResponse> getResponseClass() {
		return RemoveLinkeLinktWorkitemtagResponse.class;
	}
