...
import com.aliyuncs.sofa.transform.v20190815.AddLinkeBahamutIterationaddunitsResponseUnmarshaller;
 ...
 * @version 
 */
public class AddLinkeBahamutIterationaddunitsResponse extends AcsResponse {
	...
	@Override
	public AddLinkeBahamutIterationaddunitsResponse getInstance(UnmarshallerContext context) {
		return	AddLinkeBahamutIterationaddunitsResponseUnmarshaller.unmarshall(this, context);
	}
