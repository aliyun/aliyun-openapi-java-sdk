 ...
 * @version 
 */
public class ReinitAKSOpsContainerServiceRequest extends RpcAcsRequest<ReinitAKSOpsContainerServiceResponse> {
	...
	@Override
	public Class<ReinitAKSOpsContainerServiceResponse> getResponseClass() {
		return ReinitAKSOpsContainerServiceResponse.class;
	}
