...
import com.aliyuncs.sofa.transform.v20190815.QueryLinkeLinkaTaskreportsummaryResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryLinkeLinkaTaskreportsummaryResponse extends AcsResponse {
	...
	@Override
	public QueryLinkeLinkaTaskreportsummaryResponse getInstance(UnmarshallerContext context) {
		return	QueryLinkeLinkaTaskreportsummaryResponseUnmarshaller.unmarshall(this, context);
	}
