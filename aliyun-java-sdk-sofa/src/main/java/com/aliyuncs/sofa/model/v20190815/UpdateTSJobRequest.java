 ...
 * @version 
 */
public class UpdateTSJobRequest extends RpcAcsRequest<UpdateTSJobResponse> {
	   

	private Long preAutoTrigger;
	...
	public UpdateTSJobRequest() {
		super("SOFA", "2019-08-15", "UpdateTSJob", "ApplySidecarCert");
	...
	public void setPreAutoTrigger(Long preAutoTrigger) {
	...
	@Override
	public Class<UpdateTSJobResponse> getResponseClass() {
		return UpdateTSJobResponse.class;
	}
