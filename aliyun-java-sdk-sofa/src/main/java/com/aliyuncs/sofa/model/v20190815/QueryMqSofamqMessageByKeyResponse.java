...
import com.aliyuncs.sofa.transform.v20190815.QueryMqSofamqMessageByKeyResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryMqSofamqMessageByKeyResponse extends AcsResponse {
	...
	@Override
	public QueryMqSofamqMessageByKeyResponse getInstance(UnmarshallerContext context) {
		return	QueryMqSofamqMessageByKeyResponseUnmarshaller.unmarshall(this, context);
	}
