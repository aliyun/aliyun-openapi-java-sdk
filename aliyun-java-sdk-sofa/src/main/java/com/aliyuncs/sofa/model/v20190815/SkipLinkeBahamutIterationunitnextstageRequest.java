 ...
 * @version 
 */
public class SkipLinkeBahamutIterationunitnextstageRequest extends RpcAcsRequest<SkipLinkeBahamutIterationunitnextstageResponse> {
	...
	public SkipLinkeBahamutIterationunitnextstageRequest() {
		super("SOFA", "2019-08-15", "SkipLinkeBahamutIterationunitnextstage", "sofacaferms");
	...
	@Override
	public Class<SkipLinkeBahamutIterationunitnextstageResponse> getResponseClass() {
		return SkipLinkeBahamutIterationunitnextstageResponse.class;
	}
