...
import com.aliyuncs.sofa.transform.v20190815.GetLinkeBahamutIterationsgetunitsResponseUnmarshaller;
 ...
 * @version 
 */
public class GetLinkeBahamutIterationsgetunitsResponse extends AcsResponse {
	...
	@Override
	public GetLinkeBahamutIterationsgetunitsResponse getInstance(UnmarshallerContext context) {
		return	GetLinkeBahamutIterationsgetunitsResponseUnmarshaller.unmarshall(this, context);
	}
