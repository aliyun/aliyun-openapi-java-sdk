...
import com.aliyuncs.sofa.transform.v20190815.GetLinkeLinklogStoreResponseUnmarshaller;
 ...
 * @version 
 */
public class GetLinkeLinklogStoreResponse extends AcsResponse {
	...
	@Override
	public GetLinkeLinklogStoreResponse getInstance(UnmarshallerContext context) {
		return	GetLinkeLinklogStoreResponseUnmarshaller.unmarshall(this, context);
	}
