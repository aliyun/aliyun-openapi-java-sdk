...
import com.aliyuncs.sofa.transform.v20190815.GetLinkeBahamutIterationgetiterationworkitemsResponseUnmarshaller;
 ...
 * @version 
 */
public class GetLinkeBahamutIterationgetiterationworkitemsResponse extends AcsResponse {
	...
	@Override
	public GetLinkeBahamutIterationgetiterationworkitemsResponse getInstance(UnmarshallerContext context) {
		return	GetLinkeBahamutIterationgetiterationworkitemsResponseUnmarshaller.unmarshall(this, context);
	}
