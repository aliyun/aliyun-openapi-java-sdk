...
import com.aliyuncs.sofa.transform.v20190815.ListClriskDataNodeResponseUnmarshaller;
 ...
 * @version 
 */
public class ListClriskDataNodeResponse extends AcsResponse {
	...
	@Override
	public ListClriskDataNodeResponse getInstance(UnmarshallerContext context) {
		return	ListClriskDataNodeResponseUnmarshaller.unmarshall(this, context);
	}
