 ...
 * @version 
 */
public class GetLinkeBahamutVcsdiffbetweenbrancheRequest extends RpcAcsRequest<GetLinkeBahamutVcsdiffbetweenbrancheResponse> {
	...
	@Override
	public Class<GetLinkeBahamutVcsdiffbetweenbrancheResponse> getResponseClass() {
		return GetLinkeBahamutVcsdiffbetweenbrancheResponse.class;
	}
