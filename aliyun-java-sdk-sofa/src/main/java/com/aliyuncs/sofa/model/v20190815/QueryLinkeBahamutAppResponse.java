...
import com.aliyuncs.sofa.transform.v20190815.QueryLinkeBahamutAppResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryLinkeBahamutAppResponse extends AcsResponse {
	...
	@Override
	public QueryLinkeBahamutAppResponse getInstance(UnmarshallerContext context) {
		return	QueryLinkeBahamutAppResponseUnmarshaller.unmarshall(this, context);
	}
