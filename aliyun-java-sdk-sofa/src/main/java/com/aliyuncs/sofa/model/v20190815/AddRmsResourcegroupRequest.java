 ...
 * @version 
 */
public class AddRmsResourcegroupRequest extends RpcAcsRequest<AddRmsResourcegroupResponse> {
	...
	public AddRmsResourcegroupRequest() {
		super("SOFA", "2019-08-15", "AddRmsResourcegroup", "sofacafedeps");
	...
	@Override
	public Class<AddRmsResourcegroupResponse> getResponseClass() {
		return AddRmsResourcegroupResponse.class;
	}
