 ...
 * @version 
 */
public class DeprecateBuildpackRequest extends RpcAcsRequest<DeprecateBuildpackResponse> {
	...
	public DeprecateBuildpackRequest() {
		super("SOFA", "2019-08-15", "DeprecateBuildpack", "sofacafedeps");
	...
	public void setDepracationNoteMapJsonStr(String depracationNoteMapJsonStr) {
		this.depracationNoteMapJsonStr = depracationNoteMapJsonStr;
		if(depracationNoteMapJsonStr != null){
			putBodyParameter("DepracationNoteMapJsonStr", depracationNoteMapJsonStr);
		}
	}

	@Override
	public Class<DeprecateBuildpackResponse> getResponseClass() {
		return DeprecateBuildpackResponse.class;
	}
