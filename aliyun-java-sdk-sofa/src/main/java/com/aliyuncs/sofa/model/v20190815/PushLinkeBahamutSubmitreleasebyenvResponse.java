...
import com.aliyuncs.sofa.transform.v20190815.PushLinkeBahamutSubmitreleasebyenvResponseUnmarshaller;
 ...
 * @version 
 */
public class PushLinkeBahamutSubmitreleasebyenvResponse extends AcsResponse {
	...
	@Override
	public PushLinkeBahamutSubmitreleasebyenvResponse getInstance(UnmarshallerContext context) {
		return	PushLinkeBahamutSubmitreleasebyenvResponseUnmarshaller.unmarshall(this, context);
	}
