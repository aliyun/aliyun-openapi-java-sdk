 ...
 * @version 
 */
public class QueryLinkefabricFabricTaskstatusRequest extends RpcAcsRequest<QueryLinkefabricFabricTaskstatusResponse> {
	...
	public QueryLinkefabricFabricTaskstatusRequest() {
		super("SOFA", "2019-08-15", "QueryLinkefabricFabricTaskstatus", "sofacafedeps");
	...
	@Override
	public Class<QueryLinkefabricFabricTaskstatusResponse> getResponseClass() {
		return QueryLinkefabricFabricTaskstatusResponse.class;
	}
