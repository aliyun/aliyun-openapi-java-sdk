 ...
 * @version 
 */
public class QueryRmsAlertruleMonitortargetsRequest extends RpcAcsRequest<QueryRmsAlertruleMonitortargetsResponse> {
	...
	public QueryRmsAlertruleMonitortargetsRequest() {
		super("SOFA", "2019-08-15", "QueryRmsAlertruleMonitortargets", "sofacafedeps");
	...
	@Override
	public Class<QueryRmsAlertruleMonitortargetsResponse> getResponseClass() {
		return QueryRmsAlertruleMonitortargetsResponse.class;
	}
