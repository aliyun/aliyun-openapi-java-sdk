...
import com.aliyuncs.sofa.transform.v20190815.CreateLinkeantcodeAntcodeRecoverytaskResponseUnmarshaller;
 ...
 * @version 
 */
public class CreateLinkeantcodeAntcodeRecoverytaskResponse extends AcsResponse {
	...
	@Override
	public CreateLinkeantcodeAntcodeRecoverytaskResponse getInstance(UnmarshallerContext context) {
		return	CreateLinkeantcodeAntcodeRecoverytaskResponseUnmarshaller.unmarshall(this, context);
	}
