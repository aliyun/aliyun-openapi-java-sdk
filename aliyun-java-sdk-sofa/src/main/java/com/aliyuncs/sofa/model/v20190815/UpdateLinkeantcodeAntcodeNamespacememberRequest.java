 ...
 * @version 
 */
public class UpdateLinkeantcodeAntcodeNamespacememberRequest extends RpcAcsRequest<UpdateLinkeantcodeAntcodeNamespacememberResponse> {
	...
	@Override
	public Class<UpdateLinkeantcodeAntcodeNamespacememberResponse> getResponseClass() {
		return UpdateLinkeantcodeAntcodeNamespacememberResponse.class;
	}
