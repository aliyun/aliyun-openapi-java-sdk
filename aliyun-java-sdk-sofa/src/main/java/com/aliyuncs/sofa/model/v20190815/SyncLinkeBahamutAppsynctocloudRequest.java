 ...
 * @version 
 */
public class SyncLinkeBahamutAppsynctocloudRequest extends RpcAcsRequest<SyncLinkeBahamutAppsynctocloudResponse> {
	...
	public void setCloudTenantId(String cloudTenantId) {
		...
		if(cloudTenantId != null){
			putBodyParameter("CloudTenantId", cloudTenantId);
		}
	}
	...
	@Override
	public Class<SyncLinkeBahamutAppsynctocloudResponse> getResponseClass() {
		return SyncLinkeBahamutAppsynctocloudResponse.class;
	}
