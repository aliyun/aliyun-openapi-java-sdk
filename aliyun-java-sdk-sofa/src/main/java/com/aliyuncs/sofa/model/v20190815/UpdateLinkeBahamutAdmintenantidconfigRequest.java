 ...
 * @version 
 */
public class UpdateLinkeBahamutAdmintenantidconfigRequest extends RpcAcsRequest<UpdateLinkeBahamutAdmintenantidconfigResponse> {
	...
	@Override
	public Class<UpdateLinkeBahamutAdmintenantidconfigResponse> getResponseClass() {
		return UpdateLinkeBahamutAdmintenantidconfigResponse.class;
	}
