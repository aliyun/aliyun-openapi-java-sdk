 ...
 * @version 
 */
public class CreateCasLoadbalanceMountRequest extends RpcAcsRequest<CreateCasLoadbalanceMountResponse> {
	...
	public CreateCasLoadbalanceMountRequest() {
		super("SOFA", "2019-08-15", "CreateCasLoadbalanceMount", "sofacafedeps");
	...
	@Override
	public Class<CreateCasLoadbalanceMountResponse> getResponseClass() {
		return CreateCasLoadbalanceMountResponse.class;
	}
