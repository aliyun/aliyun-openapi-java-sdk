 ...
 * @version 
 */
public class QueryLinkefabricFabricConfigdisableswitchRequest extends RpcAcsRequest<QueryLinkefabricFabricConfigdisableswitchResponse> {
	...
	public QueryLinkefabricFabricConfigdisableswitchRequest() {
		super("SOFA", "2019-08-15", "QueryLinkefabricFabricConfigdisableswitch", "sofacafedeps");
	...
	@Override
	public Class<QueryLinkefabricFabricConfigdisableswitchResponse> getResponseClass() {
		return QueryLinkefabricFabricConfigdisableswitchResponse.class;
	}
