 ...
 * @version 
 */
public class UpdateLinkeBahamutAdminupdatecommonuseRequest extends RpcAcsRequest<UpdateLinkeBahamutAdminupdatecommonuseResponse> {
	...
	@Override
	public Class<UpdateLinkeBahamutAdminupdatecommonuseResponse> getResponseClass() {
		return UpdateLinkeBahamutAdminupdatecommonuseResponse.class;
	}
