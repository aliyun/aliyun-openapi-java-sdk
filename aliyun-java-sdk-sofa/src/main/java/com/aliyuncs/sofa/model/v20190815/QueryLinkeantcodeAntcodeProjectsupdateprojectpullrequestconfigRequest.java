 ...
 * @version 
 */
public class QueryLinkeantcodeAntcodeProjectsupdateprojectpullrequestconfigRequest extends RpcAcsRequest<QueryLinkeantcodeAntcodeProjectsupdateprojectpullrequestconfigResponse> {
	...
	@Override
	public Class<QueryLinkeantcodeAntcodeProjectsupdateprojectpullrequestconfigResponse> getResponseClass() {
		return QueryLinkeantcodeAntcodeProjectsupdateprojectpullrequestconfigResponse.class;
	}
