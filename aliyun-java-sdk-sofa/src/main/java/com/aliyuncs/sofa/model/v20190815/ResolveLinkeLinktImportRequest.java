 ...
 * @version 
 */
public class ResolveLinkeLinktImportRequest extends RpcAcsRequest<ResolveLinkeLinktImportResponse> {
	...
	@Override
	public Class<ResolveLinkeLinktImportResponse> getResponseClass() {
		return ResolveLinkeLinktImportResponse.class;
	}
