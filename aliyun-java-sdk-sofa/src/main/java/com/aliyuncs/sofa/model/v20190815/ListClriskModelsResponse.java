...
import com.aliyuncs.sofa.transform.v20190815.ListClriskModelsResponseUnmarshaller;
 ...
 * @version 
 */
public class ListClriskModelsResponse extends AcsResponse {
	...
	private List<EntranceListItem> entranceList;
	...
	public List<EntranceListItem> getEntranceList() {
		return this.entranceList;
	}

	public void setEntranceList(List<EntranceListItem> entranceList) {
	...
	@Override
	public ListClriskModelsResponse getInstance(UnmarshallerContext context) {
		return	ListClriskModelsResponseUnmarshaller.unmarshall(this, context);
	}
