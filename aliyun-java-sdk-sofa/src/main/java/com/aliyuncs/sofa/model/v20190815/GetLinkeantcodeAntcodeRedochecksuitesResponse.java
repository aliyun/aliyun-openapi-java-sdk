...
import com.aliyuncs.sofa.transform.v20190815.GetLinkeantcodeAntcodeRedochecksuitesResponseUnmarshaller;
 ...
 * @version 
 */
public class GetLinkeantcodeAntcodeRedochecksuitesResponse extends AcsResponse {
	...
	@Override
	public GetLinkeantcodeAntcodeRedochecksuitesResponse getInstance(UnmarshallerContext context) {
		return	GetLinkeantcodeAntcodeRedochecksuitesResponseUnmarshaller.unmarshall(this, context);
	}
