...
import com.aliyuncs.sofa.transform.v20190815.GetLinkelinkflowLinkflowProcessResponseUnmarshaller;
 ...
 * @version 
 */
public class GetLinkelinkflowLinkflowProcessResponse extends AcsResponse {
	...
	@Override
	public GetLinkelinkflowLinkflowProcessResponse getInstance(UnmarshallerContext context) {
		return	GetLinkelinkflowLinkflowProcessResponseUnmarshaller.unmarshall(this, context);
	}
