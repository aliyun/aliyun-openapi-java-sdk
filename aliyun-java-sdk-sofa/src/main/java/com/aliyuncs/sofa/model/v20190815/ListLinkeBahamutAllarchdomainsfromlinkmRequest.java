 ...
 * @version 
 */
public class ListLinkeBahamutAllarchdomainsfromlinkmRequest extends RpcAcsRequest<ListLinkeBahamutAllarchdomainsfromlinkmResponse> {
	...
	public void setNeedParentLinkcGroups(String needParentLinkcGroups) {
		this.needParentLinkcGroups = needParentLinkcGroups;
		if(needParentLinkcGroups != null){
			putBodyParameter("NeedParentLinkcGroups", needParentLinkcGroups);
		}
	}

	@Override
	public Class<ListLinkeBahamutAllarchdomainsfromlinkmResponse> getResponseClass() {
		return ListLinkeBahamutAllarchdomainsfromlinkmResponse.class;
	}
