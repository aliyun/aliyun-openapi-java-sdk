 ...
 * @version 
 */
public class CreateAKSClusterNamespaceRequest extends RpcAcsRequest<CreateAKSClusterNamespaceResponse> {
	...
	public CreateAKSClusterNamespaceRequest() {
		super("SOFA", "2019-08-15", "CreateAKSClusterNamespace", "ApplySidecarCert");
	...
	@Override
	public Class<CreateAKSClusterNamespaceResponse> getResponseClass() {
		return CreateAKSClusterNamespaceResponse.class;
	}
