...
import com.aliyuncs.sofa.transform.v20190815.QueryMqSofamqMessageByTopicResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryMqSofamqMessageByTopicResponse extends AcsResponse {
	...
	@Override
	public QueryMqSofamqMessageByTopicResponse getInstance(UnmarshallerContext context) {
		return	QueryMqSofamqMessageByTopicResponseUnmarshaller.unmarshall(this, context);
	}
