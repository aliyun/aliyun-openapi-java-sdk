 ...
 * @version 
 */
public class UpdateMsSgAuthRulesRequest extends RpcAcsRequest<UpdateMsSgAuthRulesResponse> {
	...
	private Long ruleId;
	public UpdateMsSgAuthRulesRequest() {
		super("SOFA", "2019-08-15", "UpdateMsSgAuthRules", "ApplySidecarCert");
	...
	public void setAuthRule(String authRule) {
		...
		if(authRule != null){
			putBodyParameter("AuthRule", authRule);
		}
	}
	...
	@Override
	public Class<UpdateMsSgAuthRulesResponse> getResponseClass() {
		return UpdateMsSgAuthRulesResponse.class;
	}
