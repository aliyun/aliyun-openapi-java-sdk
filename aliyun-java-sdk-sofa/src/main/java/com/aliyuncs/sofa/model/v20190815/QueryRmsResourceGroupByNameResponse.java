...
import com.aliyuncs.sofa.transform.v20190815.QueryRmsResourceGroupByNameResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryRmsResourceGroupByNameResponse extends AcsResponse {
	...
	public Resopnse getResopnse() {
		return this.resopnse;
	}

	public void setResopnse(Resopnse resopnse) {
	...
	@Override
	public QueryRmsResourceGroupByNameResponse getInstance(UnmarshallerContext context) {
		return	QueryRmsResourceGroupByNameResponseUnmarshaller.unmarshall(this, context);
	}
