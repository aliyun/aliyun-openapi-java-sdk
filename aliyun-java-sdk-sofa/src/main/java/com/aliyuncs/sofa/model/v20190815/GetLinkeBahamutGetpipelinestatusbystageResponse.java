...
import com.aliyuncs.sofa.transform.v20190815.GetLinkeBahamutGetpipelinestatusbystageResponseUnmarshaller;
 ...
 * @version 
 */
public class GetLinkeBahamutGetpipelinestatusbystageResponse extends AcsResponse {
	...
	@Override
	public GetLinkeBahamutGetpipelinestatusbystageResponse getInstance(UnmarshallerContext context) {
		return	GetLinkeBahamutGetpipelinestatusbystageResponseUnmarshaller.unmarshall(this, context);
	}
