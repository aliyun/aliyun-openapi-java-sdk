...
import com.aliyuncs.sofa.transform.v20190815.GetLinkeBahamutApprovaltasksResponseUnmarshaller;
 ...
 * @version 
 */
public class GetLinkeBahamutApprovaltasksResponse extends AcsResponse {
	...
	@Override
	public GetLinkeBahamutApprovaltasksResponse getInstance(UnmarshallerContext context) {
		return	GetLinkeBahamutApprovaltasksResponseUnmarshaller.unmarshall(this, context);
	}
