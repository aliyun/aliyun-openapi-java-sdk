 ...
 * @version 
 */
public class QueryLinkeBahamutGlobalreleaseRequest extends RpcAcsRequest<QueryLinkeBahamutGlobalreleaseResponse> {
	...
	public QueryLinkeBahamutGlobalreleaseRequest() {
		super("SOFA", "2019-08-15", "QueryLinkeBahamutGlobalrelease", "sofacafedeps");
	...
	public void setParticipationType(String participationType) {
		...
		if(participationType != null){
			putBodyParameter("ParticipationType", participationType);
		}
	}
	...
	@Override
	public Class<QueryLinkeBahamutGlobalreleaseResponse> getResponseClass() {
		return QueryLinkeBahamutGlobalreleaseResponse.class;
	}
