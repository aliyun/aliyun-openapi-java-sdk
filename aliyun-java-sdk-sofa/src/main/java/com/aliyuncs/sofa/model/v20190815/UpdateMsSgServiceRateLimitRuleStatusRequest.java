 ...
 * @version 
 */
public class UpdateMsSgServiceRateLimitRuleStatusRequest extends RpcAcsRequest<UpdateMsSgServiceRateLimitRuleStatusResponse> {
	...
	public UpdateMsSgServiceRateLimitRuleStatusRequest() {
		super("SOFA", "2019-08-15", "UpdateMsSgServiceRateLimitRuleStatus", "ApplySidecarCert");
	...
	@Override
	public Class<UpdateMsSgServiceRateLimitRuleStatusResponse> getResponseClass() {
		return UpdateMsSgServiceRateLimitRuleStatusResponse.class;
	}
