 ...
 * @version 
 */
public class UpdateLinkeLinklogConditionRequest extends RpcAcsRequest<UpdateLinkeLinklogConditionResponse> {
	...
	@Override
	public Class<UpdateLinkeLinklogConditionResponse> getResponseClass() {
		return UpdateLinkeLinklogConditionResponse.class;
	}
