 ...
 * @version 
 */
public class ListLinkeLinktOperationlogsRequest extends RpcAcsRequest<ListLinkeLinktOperationlogsResponse> {
	...
	@Override
	public Class<ListLinkeLinktOperationlogsResponse> getResponseClass() {
		return ListLinkeLinktOperationlogsResponse.class;
	}
