...
import com.aliyuncs.sofa.transform.v20190815.QueryLinkefabricFabricSwconfigsResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryLinkefabricFabricSwconfigsResponse extends AcsResponse {
	...
	@Override
	public QueryLinkefabricFabricSwconfigsResponse getInstance(UnmarshallerContext context) {
		return	QueryLinkefabricFabricSwconfigsResponseUnmarshaller.unmarshall(this, context);
	}
