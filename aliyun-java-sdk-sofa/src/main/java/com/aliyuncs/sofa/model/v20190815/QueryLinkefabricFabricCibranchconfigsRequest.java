 ...
 * @version 
 */
public class QueryLinkefabricFabricCibranchconfigsRequest extends RpcAcsRequest<QueryLinkefabricFabricCibranchconfigsResponse> {
	...
	public QueryLinkefabricFabricCibranchconfigsRequest() {
		super("SOFA", "2019-08-15", "QueryLinkefabricFabricCibranchconfigs", "sofacafedeps");
	...
	@Override
	public Class<QueryLinkefabricFabricCibranchconfigsResponse> getResponseClass() {
		return QueryLinkefabricFabricCibranchconfigsResponse.class;
	}
