 ...
 * @version 
 */
public class CountRmsAlertrecordsRequest extends RpcAcsRequest<CountRmsAlertrecordsResponse> {
	...
	public CountRmsAlertrecordsRequest() {
		super("SOFA", "2019-08-15", "CountRmsAlertrecords", "sofacafedeps");
	...
	@Override
	public Class<CountRmsAlertrecordsResponse> getResponseClass() {
		return CountRmsAlertrecordsResponse.class;
	}
