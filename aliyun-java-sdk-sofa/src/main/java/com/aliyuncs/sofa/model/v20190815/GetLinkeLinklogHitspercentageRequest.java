 ...
 * @version 
 */
public class GetLinkeLinklogHitspercentageRequest extends RpcAcsRequest<GetLinkeLinklogHitspercentageResponse> {
	...
	private Long begin;
	public GetLinkeLinklogHitspercentageRequest() {
		super("SOFA", "2019-08-15", "GetLinkeLinklogHitspercentage", "sofacafedeps");
	...
	@Override
	public Class<GetLinkeLinklogHitspercentageResponse> getResponseClass() {
		return GetLinkeLinklogHitspercentageResponse.class;
	}
