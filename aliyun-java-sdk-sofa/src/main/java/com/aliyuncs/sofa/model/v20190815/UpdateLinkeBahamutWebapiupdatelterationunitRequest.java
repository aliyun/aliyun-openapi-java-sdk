 ...
 * @version 
 */
public class UpdateLinkeBahamutWebapiupdatelterationunitRequest extends RpcAcsRequest<UpdateLinkeBahamutWebapiupdatelterationunitResponse> {
	...
	public void setIterationversion(String iterationversion) {
		...
		if(iterationversion != null){
			putBodyParameter("Iterationversion", iterationversion);
		}
	}
	...
	@Override
	public Class<UpdateLinkeBahamutWebapiupdatelterationunitResponse> getResponseClass() {
		return UpdateLinkeBahamutWebapiupdatelterationunitResponse.class;
	}
