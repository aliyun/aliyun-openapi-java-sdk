...
import com.aliyuncs.sofa.transform.v20190815.ListLinkeBahamutAlltenantsResponseUnmarshaller;
 ...
 * @version 
 */
public class ListLinkeBahamutAlltenantsResponse extends AcsResponse {
	...
	@Override
	public ListLinkeBahamutAlltenantsResponse getInstance(UnmarshallerContext context) {
		return	ListLinkeBahamutAlltenantsResponseUnmarshaller.unmarshall(this, context);
	}
