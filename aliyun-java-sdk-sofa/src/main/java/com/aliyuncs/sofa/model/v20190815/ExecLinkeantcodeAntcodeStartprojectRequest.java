 ...
 * @version 
 */
public class ExecLinkeantcodeAntcodeStartprojectRequest extends RpcAcsRequest<ExecLinkeantcodeAntcodeStartprojectResponse> {
	   

	private String projectIdOrPath;

	private String requestGitOperate;
	public ExecLinkeantcodeAntcodeStartprojectRequest() {
		super("SOFA", "2019-08-15", "ExecLinkeantcodeAntcodeStartproject", "sofacafedeps");
	...
	@Override
	public Class<ExecLinkeantcodeAntcodeStartprojectResponse> getResponseClass() {
		return ExecLinkeantcodeAntcodeStartprojectResponse.class;
	}
