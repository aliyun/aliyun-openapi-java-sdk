...
public class ExecLinkeLinktCreatecustomfieldanddaddtotemplateRequest extends RpcAcsRequest<ExecLinkeLinktCreatecustomfieldanddaddtotemplateResponse> {
	...
	@Override
	public Class<ExecLinkeLinktCreatecustomfieldanddaddtotemplateResponse> getResponseClass() {
		return ExecLinkeLinktCreatecustomfieldanddaddtotemplateResponse.class;
	}
