 ...
 * @version 
 */
public class QueryMsRcSyncClusterRequest extends RpcAcsRequest<QueryMsRcSyncClusterResponse> {
	   

	private String clusterTaskUniqueKey;

	private String instanceId;
	public QueryMsRcSyncClusterRequest() {
		super("SOFA", "2019-08-15", "QueryMsRcSyncCluster", "ApplySidecarCert");
	...
	@Override
	public Class<QueryMsRcSyncClusterResponse> getResponseClass() {
		return QueryMsRcSyncClusterResponse.class;
	}
