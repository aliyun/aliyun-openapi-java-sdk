 ...
 * @version 
 */
public class UpdateLinkeantcodeAntcodeUpdateprojectvariableRequest extends RpcAcsRequest<UpdateLinkeantcodeAntcodeUpdateprojectvariableResponse> {
	...
	@Override
	public Class<UpdateLinkeantcodeAntcodeUpdateprojectvariableResponse> getResponseClass() {
		return UpdateLinkeantcodeAntcodeUpdateprojectvariableResponse.class;
	}
