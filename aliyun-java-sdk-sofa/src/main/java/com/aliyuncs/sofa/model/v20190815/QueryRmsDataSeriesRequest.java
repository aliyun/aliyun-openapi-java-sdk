 ...
 * @version 
 */
public class QueryRmsDataSeriesRequest extends RpcAcsRequest<QueryRmsDataSeriesResponse> {
	   

	private String envJsonStr;

	private String queryJsonStr;
	public QueryRmsDataSeriesRequest() {
		super("SOFA", "2019-08-15", "QueryRmsDataSeries", "ApplySidecarCert");
	...
	@Override
	public Class<QueryRmsDataSeriesResponse> getResponseClass() {
		return QueryRmsDataSeriesResponse.class;
	}
