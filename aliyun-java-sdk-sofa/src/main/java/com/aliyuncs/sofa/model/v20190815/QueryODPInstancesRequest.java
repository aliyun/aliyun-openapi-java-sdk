 ...
 * @version 
 */
public class QueryODPInstancesRequest extends RpcAcsRequest<QueryODPInstancesResponse> {
	   

	private String zdalproxyInstanceId;

	private String instanceId;
	public QueryODPInstancesRequest() {
		super("SOFA", "2019-08-15", "QueryODPInstances", "ApplySidecarCert");
	...
	@Override
	public Class<QueryODPInstancesResponse> getResponseClass() {
		return QueryODPInstancesResponse.class;
	}
