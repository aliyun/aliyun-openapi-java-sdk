...
import com.aliyuncs.sofa.transform.v20190815.QueryLinkeantcodeAntcodeGetprojectbranchbybranchnameResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryLinkeantcodeAntcodeGetprojectbranchbybranchnameResponse extends AcsResponse {
	...
	@Override
	public QueryLinkeantcodeAntcodeGetprojectbranchbybranchnameResponse getInstance(UnmarshallerContext context) {
		return	QueryLinkeantcodeAntcodeGetprojectbranchbybranchnameResponseUnmarshaller.unmarshall(this, context);
	}
