...
import com.aliyuncs.sofa.transform.v20190815.QueryODPSchemasLogicTablesResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryODPSchemasLogicTablesResponse extends AcsResponse {
	...
	@Override
	public QueryODPSchemasLogicTablesResponse getInstance(UnmarshallerContext context) {
		return	QueryODPSchemasLogicTablesResponseUnmarshaller.unmarshall(this, context);
	}
