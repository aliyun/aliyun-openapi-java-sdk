 ...
 * @version 
 */
public class QueryMSDdcsAttributesRequest extends RpcAcsRequest<QueryMSDdcsAttributesResponse> {
	...
	@Override
	public Class<QueryMSDdcsAttributesResponse> getResponseClass() {
		return QueryMSDdcsAttributesResponse.class;
	}
