 ...
 * @version 
 */
public class GetLinkeBahamutPaasgetappsRequest extends RpcAcsRequest<GetLinkeBahamutPaasgetappsResponse> {
	   

	private String tenantExternalId;

	private String iterationExternalId;
	public GetLinkeBahamutPaasgetappsRequest() {
		super("SOFA", "2019-08-15", "GetLinkeBahamutPaasgetapps", "sofacafedeps");
	...
	@Override
	public Class<GetLinkeBahamutPaasgetappsResponse> getResponseClass() {
		return GetLinkeBahamutPaasgetappsResponse.class;
	}
