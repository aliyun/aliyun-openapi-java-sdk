...
import com.aliyuncs.sofa.transform.v20190815.GetLinkeBahamutPipelinesgetreleasejarpipelineexecutionsbygroupResponseUnmarshaller;
 ...
 * @version 
 */
public class GetLinkeBahamutPipelinesgetreleasejarpipelineexecutionsbygroupResponse extends AcsResponse {
	...
	@Override
	public GetLinkeBahamutPipelinesgetreleasejarpipelineexecutionsbygroupResponse getInstance(UnmarshallerContext context) {
		return	GetLinkeBahamutPipelinesgetreleasejarpipelineexecutionsbygroupResponseUnmarshaller.unmarshall(this, context);
	}
