...
import com.aliyuncs.sofa.transform.v20190815.ExecLinkeBahamutSearcharchdomainResponseUnmarshaller;
 ...
 * @version 
 */
public class ExecLinkeBahamutSearcharchdomainResponse extends AcsResponse {
	...
	@Override
	public ExecLinkeBahamutSearcharchdomainResponse getInstance(UnmarshallerContext context) {
		return	ExecLinkeBahamutSearcharchdomainResponseUnmarshaller.unmarshall(this, context);
	}
