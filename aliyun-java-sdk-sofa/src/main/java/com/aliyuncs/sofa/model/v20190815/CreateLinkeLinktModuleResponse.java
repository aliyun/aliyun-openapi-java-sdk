...
import com.aliyuncs.sofa.transform.v20190815.CreateLinkeLinktModuleResponseUnmarshaller;
 ...
 * @version 
 */
public class CreateLinkeLinktModuleResponse extends AcsResponse {
	...
	@Override
	public CreateLinkeLinktModuleResponse getInstance(UnmarshallerContext context) {
		return	CreateLinkeLinktModuleResponseUnmarshaller.unmarshall(this, context);
	}
