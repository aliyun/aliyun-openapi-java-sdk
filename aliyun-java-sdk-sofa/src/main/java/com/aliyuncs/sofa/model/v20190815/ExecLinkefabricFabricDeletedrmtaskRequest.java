 ...
 * @version 
 */
public class ExecLinkefabricFabricDeletedrmtaskRequest extends RpcAcsRequest<ExecLinkefabricFabricDeletedrmtaskResponse> {
	...
	public ExecLinkefabricFabricDeletedrmtaskRequest() {
		super("SOFA", "2019-08-15", "ExecLinkefabricFabricDeletedrmtask", "sofacafedeps");
	...
	@Override
	public Class<ExecLinkefabricFabricDeletedrmtaskResponse> getResponseClass() {
		return ExecLinkefabricFabricDeletedrmtaskResponse.class;
	}
