 ...
 * @version 
 */
public class UpdateLinkeBahamutVcsmergerequestRequest extends RpcAcsRequest<UpdateLinkeBahamutVcsmergerequestResponse> {
	...
	@Override
	public Class<UpdateLinkeBahamutVcsmergerequestResponse> getResponseClass() {
		return UpdateLinkeBahamutVcsmergerequestResponse.class;
	}
