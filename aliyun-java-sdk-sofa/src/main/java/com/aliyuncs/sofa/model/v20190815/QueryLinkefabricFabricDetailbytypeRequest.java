 ...
 * @version 
 */
public class QueryLinkefabricFabricDetailbytypeRequest extends RpcAcsRequest<QueryLinkefabricFabricDetailbytypeResponse> {
	...
	public QueryLinkefabricFabricDetailbytypeRequest() {
		super("SOFA", "2019-08-15", "QueryLinkefabricFabricDetailbytype", "sofacafedeps");
	...
	@Override
	public Class<QueryLinkefabricFabricDetailbytypeResponse> getResponseClass() {
		return QueryLinkefabricFabricDetailbytypeResponse.class;
	}
