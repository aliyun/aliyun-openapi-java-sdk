...
import com.aliyuncs.sofa.transform.v20190815.AddLinkeantcodeAntcodeInstallationsserviceResponseUnmarshaller;
 ...
 * @version 
 */
public class AddLinkeantcodeAntcodeInstallationsserviceResponse extends AcsResponse {
	...
	@Override
	public AddLinkeantcodeAntcodeInstallationsserviceResponse getInstance(UnmarshallerContext context) {
		return	AddLinkeantcodeAntcodeInstallationsserviceResponseUnmarshaller.unmarshall(this, context);
	}
