 ...
 * @version 
 */
public class QueryLinkeantcodeAntcodeRebaseprojectpullrequestRequest extends RpcAcsRequest<QueryLinkeantcodeAntcodeRebaseprojectpullrequestResponse> {
	...
	@Override
	public Class<QueryLinkeantcodeAntcodeRebaseprojectpullrequestResponse> getResponseClass() {
		return QueryLinkeantcodeAntcodeRebaseprojectpullrequestResponse.class;
	}
