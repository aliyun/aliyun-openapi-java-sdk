...
import com.aliyuncs.sofa.transform.v20190815.QueryCasLoadbalanceResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryCasLoadbalanceResponse extends AcsResponse {
	...
	@Override
	public QueryCasLoadbalanceResponse getInstance(UnmarshallerContext context) {
		return	QueryCasLoadbalanceResponseUnmarshaller.unmarshall(this, context);
	}
