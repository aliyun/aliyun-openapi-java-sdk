 ...
 * @version 
 */
public class QueryLinkefabricFabricProjectconfigtypesRequest extends RpcAcsRequest<QueryLinkefabricFabricProjectconfigtypesResponse> {
	...
	public QueryLinkefabricFabricProjectconfigtypesRequest() {
		super("SOFA", "2019-08-15", "QueryLinkefabricFabricProjectconfigtypes", "sofacafedeps");
	...
	@Override
	public Class<QueryLinkefabricFabricProjectconfigtypesResponse> getResponseClass() {
		return QueryLinkefabricFabricProjectconfigtypesResponse.class;
	}
