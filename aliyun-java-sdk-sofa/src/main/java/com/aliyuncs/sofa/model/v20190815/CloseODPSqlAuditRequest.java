 ...
 * @version 
 */
public class CloseODPSqlAuditRequest extends RpcAcsRequest<CloseODPSqlAuditResponse> {
	...
	@Override
	public Class<CloseODPSqlAuditResponse> getResponseClass() {
		return CloseODPSqlAuditResponse.class;
	}
