 ...
 * @version 
 */
public class GetLinkeantcodeAntcodeRedochecksuitesRequest extends RpcAcsRequest<GetLinkeantcodeAntcodeRedochecksuitesResponse> {
	...
	@Override
	public Class<GetLinkeantcodeAntcodeRedochecksuitesResponse> getResponseClass() {
		return GetLinkeantcodeAntcodeRedochecksuitesResponse.class;
	}
