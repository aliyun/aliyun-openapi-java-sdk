 ...
 * @version 
 */
public class QueryRmsAlertrulesRequest extends RpcAcsRequest<QueryRmsAlertrulesResponse> {
	...
	public QueryRmsAlertrulesRequest() {
		super("SOFA", "2019-08-15", "QueryRmsAlertrules", "sofacafedeps");
	...
	@Override
	public Class<QueryRmsAlertrulesResponse> getResponseClass() {
		return QueryRmsAlertrulesResponse.class;
	}
