 ...
 * @version 
 */
public class ListCASSlsProjectRequest extends RpcAcsRequest<ListCASSlsProjectResponse> {
	...
	@Override
	public Class<ListCASSlsProjectResponse> getResponseClass() {
		return ListCASSlsProjectResponse.class;
	}
