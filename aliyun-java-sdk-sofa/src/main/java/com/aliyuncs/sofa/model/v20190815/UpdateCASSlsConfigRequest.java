 ...
 * @version 
 */
public class UpdateCASSlsConfigRequest extends RpcAcsRequest<UpdateCASSlsConfigResponse> {
	...
	public UpdateCASSlsConfigRequest() {
		super("SOFA", "2019-08-15", "UpdateCASSlsConfig", "sofacafedeps");
	...
	@Override
	public Class<UpdateCASSlsConfigResponse> getResponseClass() {
		return UpdateCASSlsConfigResponse.class;
	}
