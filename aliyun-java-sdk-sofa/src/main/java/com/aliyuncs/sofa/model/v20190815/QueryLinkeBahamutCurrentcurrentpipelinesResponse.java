...
import com.aliyuncs.sofa.transform.v20190815.QueryLinkeBahamutCurrentcurrentpipelinesResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryLinkeBahamutCurrentcurrentpipelinesResponse extends AcsResponse {
	...
	@Override
	public QueryLinkeBahamutCurrentcurrentpipelinesResponse getInstance(UnmarshallerContext context) {
		return	QueryLinkeBahamutCurrentcurrentpipelinesResponseUnmarshaller.unmarshall(this, context);
	}
