 ...
 * @version 
 */
public class AddLinkeLinktWorkflowstatusRequest extends RpcAcsRequest<AddLinkeLinktWorkflowstatusResponse> {
	...
	public AddLinkeLinktWorkflowstatusRequest() {
		super("SOFA", "2019-08-15", "AddLinkeLinktWorkflowstatus", "sofacafedeps");
	...
	@Override
	public Class<AddLinkeLinktWorkflowstatusResponse> getResponseClass() {
		return AddLinkeLinktWorkflowstatusResponse.class;
	}
