 ...
 * @version 
 */
public class UpdateLinkeLinktWorkitemRequest extends RpcAcsRequest<UpdateLinkeLinktWorkitemResponse> {
	...
	public UpdateLinkeLinktWorkitemRequest() {
		super("SOFA", "2019-08-15", "UpdateLinkeLinktWorkitem", "sofacafedeps");
	...
	@Override
	public Class<UpdateLinkeLinktWorkitemResponse> getResponseClass() {
		return UpdateLinkeLinktWorkitemResponse.class;
	}
