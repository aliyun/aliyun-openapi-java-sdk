 ...
 * @version 
 */
public class OfflineODPSchemasRequest extends RpcAcsRequest<OfflineODPSchemasResponse> {
	...
	public OfflineODPSchemasRequest() {
		super("SOFA", "2019-08-15", "OfflineODPSchemas", "ApplySidecarCert");
	...
	@Override
	public Class<OfflineODPSchemasResponse> getResponseClass() {
		return OfflineODPSchemasResponse.class;
	}
