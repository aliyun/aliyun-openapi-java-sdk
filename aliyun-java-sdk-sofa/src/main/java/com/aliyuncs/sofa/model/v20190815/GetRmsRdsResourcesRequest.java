 ...
 * @version 
 */
public class GetRmsRdsResourcesRequest extends RpcAcsRequest<GetRmsRdsResourcesResponse> {
	   

	private String envJsonStr;

	private String queryJsonStr;
	public GetRmsRdsResourcesRequest() {
		super("SOFA", "2019-08-15", "GetRmsRdsResources", "ApplySidecarCert");
	...
	@Override
	public Class<GetRmsRdsResourcesResponse> getResponseClass() {
		return GetRmsRdsResourcesResponse.class;
	}
