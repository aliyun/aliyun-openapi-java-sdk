...
import com.aliyuncs.sofa.transform.v20190815.CountLinkeLinktWorkitemgroupResponseUnmarshaller;
 ...
 * @version 
 */
public class CountLinkeLinktWorkitemgroupResponse extends AcsResponse {
	...
	@Override
	public CountLinkeLinktWorkitemgroupResponse getInstance(UnmarshallerContext context) {
		return	CountLinkeLinktWorkitemgroupResponseUnmarshaller.unmarshall(this, context);
	}
