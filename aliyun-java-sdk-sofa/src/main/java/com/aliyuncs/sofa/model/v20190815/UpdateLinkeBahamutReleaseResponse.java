...
import com.aliyuncs.sofa.transform.v20190815.UpdateLinkeBahamutReleaseResponseUnmarshaller;
 ...
 * @version 
 */
public class UpdateLinkeBahamutReleaseResponse extends AcsResponse {
	...
	@Override
	public UpdateLinkeBahamutReleaseResponse getInstance(UnmarshallerContext context) {
		return	UpdateLinkeBahamutReleaseResponseUnmarshaller.unmarshall(this, context);
	}
