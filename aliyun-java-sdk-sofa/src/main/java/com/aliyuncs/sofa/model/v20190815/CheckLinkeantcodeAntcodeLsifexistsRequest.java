 ...
 * @version 
 */
public class CheckLinkeantcodeAntcodeLsifexistsRequest extends RpcAcsRequest<CheckLinkeantcodeAntcodeLsifexistsResponse> {
	...
	@Override
	public Class<CheckLinkeantcodeAntcodeLsifexistsResponse> getResponseClass() {
		return CheckLinkeantcodeAntcodeLsifexistsResponse.class;
	}
