...
import com.aliyuncs.sofa.transform.v20190815.GetLinkeLinktCurrentuserResponseUnmarshaller;
 ...
 * @version 
 */
public class GetLinkeLinktCurrentuserResponse extends AcsResponse {
	...
	@Override
	public GetLinkeLinktCurrentuserResponse getInstance(UnmarshallerContext context) {
		return	GetLinkeLinktCurrentuserResponseUnmarshaller.unmarshall(this, context);
	}
