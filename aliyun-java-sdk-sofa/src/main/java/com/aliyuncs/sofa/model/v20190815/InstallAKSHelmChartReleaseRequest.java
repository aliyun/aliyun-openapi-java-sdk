 ...
 * @version 
 */
public class InstallAKSHelmChartReleaseRequest extends RpcAcsRequest<InstallAKSHelmChartReleaseResponse> {
	...
	@Override
	public Class<InstallAKSHelmChartReleaseResponse> getResponseClass() {
		return InstallAKSHelmChartReleaseResponse.class;
	}
