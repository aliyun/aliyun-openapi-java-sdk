...
import com.aliyuncs.sofa.transform.v20190815.GetLinkeLinklogHitspercentagesResponseUnmarshaller;
 ...
 * @version 
 */
public class GetLinkeLinklogHitspercentagesResponse extends AcsResponse {
	...
	@Override
	public GetLinkeLinklogHitspercentagesResponse getInstance(UnmarshallerContext context) {
		return	GetLinkeLinklogHitspercentagesResponseUnmarshaller.unmarshall(this, context);
	}
