...
import com.aliyuncs.sofa.transform.v20190815.CreateLinkeantcodeAntcodeCreateprojectbranchResponseUnmarshaller;
 ...
 * @version 
 */
public class CreateLinkeantcodeAntcodeCreateprojectbranchResponse extends AcsResponse {
	...
	@Override
	public CreateLinkeantcodeAntcodeCreateprojectbranchResponse getInstance(UnmarshallerContext context) {
		return	CreateLinkeantcodeAntcodeCreateprojectbranchResponseUnmarshaller.unmarshall(this, context);
	}
