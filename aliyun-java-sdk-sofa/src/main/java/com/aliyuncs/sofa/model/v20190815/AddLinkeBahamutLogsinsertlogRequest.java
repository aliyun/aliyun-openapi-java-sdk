 ...
 * @version 
 */
public class AddLinkeBahamutLogsinsertlogRequest extends RpcAcsRequest<AddLinkeBahamutLogsinsertlogResponse> {
	...
	@Override
	public Class<AddLinkeBahamutLogsinsertlogResponse> getResponseClass() {
		return AddLinkeBahamutLogsinsertlogResponse.class;
	}
