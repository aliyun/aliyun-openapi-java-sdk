 ...
 * @version 
 */
public class BatchqueryODPSchemasRequest extends RpcAcsRequest<BatchqueryODPSchemasResponse> {
	   

	private String zdalproxyInstanceId;

	private String instanceId;
	public BatchqueryODPSchemasRequest() {
		super("SOFA", "2019-08-15", "BatchqueryODPSchemas", "ApplySidecarCert");
	...
	@Override
	public Class<BatchqueryODPSchemasResponse> getResponseClass() {
		return BatchqueryODPSchemasResponse.class;
	}
