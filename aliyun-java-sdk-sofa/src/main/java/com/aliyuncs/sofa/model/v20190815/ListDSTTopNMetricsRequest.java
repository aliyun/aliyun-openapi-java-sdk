 ...
 * @version 
 */
public class ListDSTTopNMetricsRequest extends RpcAcsRequest<ListDSTTopNMetricsResponse> {
	...
	public ListDSTTopNMetricsRequest() {
		super("SOFA", "2019-08-15", "ListDSTTopNMetrics", "ApplySidecarCert");
	...
	public void setTopN(Long topN) {
		this.topN = topN;
		if(topN != null){
			putBodyParameter("TopN", topN.toString());
		}
	}
	...
	@Override
	public Class<ListDSTTopNMetricsResponse> getResponseClass() {
		return ListDSTTopNMetricsResponse.class;
	}
