 ...
 * @version 
 */
public class AddAKSNodeLabelRequest extends RpcAcsRequest<AddAKSNodeLabelResponse> {
	...
	public AddAKSNodeLabelRequest() {
		super("SOFA", "2019-08-15", "AddAKSNodeLabel", "sofacafedeps");
	...
	@Override
	public Class<AddAKSNodeLabelResponse> getResponseClass() {
		return AddAKSNodeLabelResponse.class;
	}
