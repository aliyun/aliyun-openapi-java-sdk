 ...
 * @version 
 */
public class QueryLinkeBahamutUsersbyacountRequest extends RpcAcsRequest<QueryLinkeBahamutUsersbyacountResponse> {
	...
	public QueryLinkeBahamutUsersbyacountRequest() {
		super("SOFA", "2019-08-15", "QueryLinkeBahamutUsersbyacount", "ApplySidecarCert");
	...
	@Override
	public Class<QueryLinkeBahamutUsersbyacountResponse> getResponseClass() {
		return QueryLinkeBahamutUsersbyacountResponse.class;
	}
