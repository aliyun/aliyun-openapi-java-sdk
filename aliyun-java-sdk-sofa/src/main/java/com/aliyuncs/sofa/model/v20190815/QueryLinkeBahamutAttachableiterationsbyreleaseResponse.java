...
import com.aliyuncs.sofa.transform.v20190815.QueryLinkeBahamutAttachableiterationsbyreleaseResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryLinkeBahamutAttachableiterationsbyreleaseResponse extends AcsResponse {
	...
	@Override
	public QueryLinkeBahamutAttachableiterationsbyreleaseResponse getInstance(UnmarshallerContext context) {
		return	QueryLinkeBahamutAttachableiterationsbyreleaseResponseUnmarshaller.unmarshall(this, context);
	}
