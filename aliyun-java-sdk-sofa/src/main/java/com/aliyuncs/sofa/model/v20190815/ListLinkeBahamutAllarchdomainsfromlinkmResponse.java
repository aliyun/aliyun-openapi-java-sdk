...
import com.aliyuncs.sofa.transform.v20190815.ListLinkeBahamutAllarchdomainsfromlinkmResponseUnmarshaller;
 ...
 * @version 
 */
public class ListLinkeBahamutAllarchdomainsfromlinkmResponse extends AcsResponse {
	...
	@Override
	public ListLinkeBahamutAllarchdomainsfromlinkmResponse getInstance(UnmarshallerContext context) {
		return	ListLinkeBahamutAllarchdomainsfromlinkmResponseUnmarshaller.unmarshall(this, context);
	}
