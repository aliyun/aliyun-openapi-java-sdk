...
import com.aliyuncs.sofa.transform.v20190815.SetLinkeBahamutIterationsfixnnitswithnonestageResponseUnmarshaller;
 ...
 * @version 
 */
public class SetLinkeBahamutIterationsfixnnitswithnonestageResponse extends AcsResponse {
	...
	@Override
	public SetLinkeBahamutIterationsfixnnitswithnonestageResponse getInstance(UnmarshallerContext context) {
		return	SetLinkeBahamutIterationsfixnnitswithnonestageResponseUnmarshaller.unmarshall(this, context);
	}
