 ...
 * @version 
 */
public class ListLinkeantcodeAntcodeNewrepositoryfilesRequest extends RpcAcsRequest<ListLinkeantcodeAntcodeNewrepositoryfilesResponse> {
	...
	public void setRequestJsonStr(String requestJsonStr) {
		...
		if(requestJsonStr != null){
			putBodyParameter("RequestJsonStr", requestJsonStr);
		}
	}
	...
	@Override
	public Class<ListLinkeantcodeAntcodeNewrepositoryfilesResponse> getResponseClass() {
		return ListLinkeantcodeAntcodeNewrepositoryfilesResponse.class;
	}
