 ...
 * @version 
 */
public class QueryLinkefabricFabricCloudenvinfoRequest extends RpcAcsRequest<QueryLinkefabricFabricCloudenvinfoResponse> {
	...
	public QueryLinkefabricFabricCloudenvinfoRequest() {
		super("SOFA", "2019-08-15", "QueryLinkefabricFabricCloudenvinfo", "sofacafedeps");
	...
	@Override
	public Class<QueryLinkefabricFabricCloudenvinfoResponse> getResponseClass() {
		return QueryLinkefabricFabricCloudenvinfoResponse.class;
	}
