 ...
 * @version 
 */
public class AddMSDdcsResourcesRequest extends RpcAcsRequest<AddMSDdcsResourcesResponse> {
	...
	@Override
	public Class<AddMSDdcsResourcesResponse> getResponseClass() {
		return AddMSDdcsResourcesResponse.class;
	}
