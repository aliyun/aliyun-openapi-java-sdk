 ...
 * @version 
 */
public class UpdateMsGuardianRulesRequest extends RpcAcsRequest<UpdateMsGuardianRulesResponse> {
	...
	public UpdateMsGuardianRulesRequest() {
		super("SOFA", "2019-08-15", "UpdateMsGuardianRules", "ApplySidecarCert");
	...
	@Override
	public Class<UpdateMsGuardianRulesResponse> getResponseClass() {
		return UpdateMsGuardianRulesResponse.class;
	}
