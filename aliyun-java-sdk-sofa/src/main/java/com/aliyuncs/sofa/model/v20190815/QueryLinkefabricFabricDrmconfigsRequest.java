 ...
 * @version 
 */
public class QueryLinkefabricFabricDrmconfigsRequest extends RpcAcsRequest<QueryLinkefabricFabricDrmconfigsResponse> {
	...
	public QueryLinkefabricFabricDrmconfigsRequest() {
		super("SOFA", "2019-08-15", "QueryLinkefabricFabricDrmconfigs", "sofacafedeps");
	...
	@Override
	public Class<QueryLinkefabricFabricDrmconfigsResponse> getResponseClass() {
		return QueryLinkefabricFabricDrmconfigsResponse.class;
	}
