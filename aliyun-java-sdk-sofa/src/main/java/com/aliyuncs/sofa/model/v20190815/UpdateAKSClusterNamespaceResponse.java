...
import com.aliyuncs.sofa.transform.v20190815.UpdateAKSClusterNamespaceResponseUnmarshaller;
 ...
 * @version 
 */
public class UpdateAKSClusterNamespaceResponse extends AcsResponse {
	...
	@Override
	public UpdateAKSClusterNamespaceResponse getInstance(UnmarshallerContext context) {
		return	UpdateAKSClusterNamespaceResponseUnmarshaller.unmarshall(this, context);
	}
