...
import com.aliyuncs.sofa.transform.v20190815.AddLinkeBahamutAppmoduleResponseUnmarshaller;
 ...
 * @version 
 */
public class AddLinkeBahamutAppmoduleResponse extends AcsResponse {
	...
	@Override
	public AddLinkeBahamutAppmoduleResponse getInstance(UnmarshallerContext context) {
		return	AddLinkeBahamutAppmoduleResponseUnmarshaller.unmarshall(this, context);
	}
