...
import com.aliyuncs.sofa.transform.v20190815.UpdateLinkeLinktAdmintemplateResponseUnmarshaller;
 ...
 * @version 
 */
public class UpdateLinkeLinktAdmintemplateResponse extends AcsResponse {
	...
	@Override
	public UpdateLinkeLinktAdmintemplateResponse getInstance(UnmarshallerContext context) {
		return	UpdateLinkeLinktAdmintemplateResponseUnmarshaller.unmarshall(this, context);
	}
