...
import com.aliyuncs.sofa.transform.v20190815.UpdateLinkeLinktMilestonestatusResponseUnmarshaller;
 ...
 * @version 
 */
public class UpdateLinkeLinktMilestonestatusResponse extends AcsResponse {
	...
	@Override
	public UpdateLinkeLinktMilestonestatusResponse getInstance(UnmarshallerContext context) {
		return	UpdateLinkeLinktMilestonestatusResponseUnmarshaller.unmarshall(this, context);
	}
