...
import com.aliyuncs.sofa.transform.v20190815.GetAKSContainerservicesResponseUnmarshaller;
 ...
 * @version 
 */
public class GetAKSContainerservicesResponse extends AcsResponse {
	...
	@Override
	public GetAKSContainerservicesResponse getInstance(UnmarshallerContext context) {
		return	GetAKSContainerservicesResponseUnmarshaller.unmarshall(this, context);
	}
