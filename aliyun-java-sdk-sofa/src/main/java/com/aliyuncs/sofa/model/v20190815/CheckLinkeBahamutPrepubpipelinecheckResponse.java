...
import com.aliyuncs.sofa.transform.v20190815.CheckLinkeBahamutPrepubpipelinecheckResponseUnmarshaller;
 ...
 * @version 
 */
public class CheckLinkeBahamutPrepubpipelinecheckResponse extends AcsResponse {
	...
	@Override
	public CheckLinkeBahamutPrepubpipelinecheckResponse getInstance(UnmarshallerContext context) {
		return	CheckLinkeBahamutPrepubpipelinecheckResponseUnmarshaller.unmarshall(this, context);
	}
