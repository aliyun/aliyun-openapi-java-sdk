...
import com.aliyuncs.sofa.transform.v20190815.SetLinkeBahamutAdminiterationtemplateResponseUnmarshaller;
 ...
 * @version 
 */
public class SetLinkeBahamutAdminiterationtemplateResponse extends AcsResponse {
	...
	@Override
	public SetLinkeBahamutAdminiterationtemplateResponse getInstance(UnmarshallerContext context) {
		return	SetLinkeBahamutAdminiterationtemplateResponseUnmarshaller.unmarshall(this, context);
	}
