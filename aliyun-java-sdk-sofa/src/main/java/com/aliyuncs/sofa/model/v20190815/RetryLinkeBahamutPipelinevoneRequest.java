 ...
 * @version 
 */
public class RetryLinkeBahamutPipelinevoneRequest extends RpcAcsRequest<RetryLinkeBahamutPipelinevoneResponse> {
	...
	public RetryLinkeBahamutPipelinevoneRequest() {
		super("SOFA", "2019-08-15", "RetryLinkeBahamutPipelinevone", "sofacafedeps");
	...
	@Override
	public Class<RetryLinkeBahamutPipelinevoneResponse> getResponseClass() {
		return RetryLinkeBahamutPipelinevoneResponse.class;
	}
