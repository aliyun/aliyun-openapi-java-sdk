...
import com.aliyuncs.sofa.transform.v20190815.CreateLinkeantcodeAntcodeSnippetnoteResponseUnmarshaller;
 ...
 * @version 
 */
public class CreateLinkeantcodeAntcodeSnippetnoteResponse extends AcsResponse {
	...
	@Override
	public CreateLinkeantcodeAntcodeSnippetnoteResponse getInstance(UnmarshallerContext context) {
		return	CreateLinkeantcodeAntcodeSnippetnoteResponseUnmarshaller.unmarshall(this, context);
	}
