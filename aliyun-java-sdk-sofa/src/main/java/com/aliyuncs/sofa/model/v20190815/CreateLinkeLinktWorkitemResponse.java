...
import com.aliyuncs.sofa.transform.v20190815.CreateLinkeLinktWorkitemResponseUnmarshaller;
 ...
 * @version 
 */
public class CreateLinkeLinktWorkitemResponse extends AcsResponse {
	...
	@Override
	public CreateLinkeLinktWorkitemResponse getInstance(UnmarshallerContext context) {
		return	CreateLinkeLinktWorkitemResponseUnmarshaller.unmarshall(this, context);
	}
