...
import com.aliyuncs.sofa.transform.v20190815.UpdateLinkeLinktModuleResponseUnmarshaller;
 ...
 * @version 
 */
public class UpdateLinkeLinktModuleResponse extends AcsResponse {
	...
	@Override
	public UpdateLinkeLinktModuleResponse getInstance(UnmarshallerContext context) {
		return	UpdateLinkeLinktModuleResponseUnmarshaller.unmarshall(this, context);
	}
