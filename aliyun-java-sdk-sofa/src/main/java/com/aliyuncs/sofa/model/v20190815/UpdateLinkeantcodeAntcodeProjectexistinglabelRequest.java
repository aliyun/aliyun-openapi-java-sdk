 ...
 * @version 
 */
public class UpdateLinkeantcodeAntcodeProjectexistinglabelRequest extends RpcAcsRequest<UpdateLinkeantcodeAntcodeProjectexistinglabelResponse> {
	...
	@Override
	public Class<UpdateLinkeantcodeAntcodeProjectexistinglabelResponse> getResponseClass() {
		return UpdateLinkeantcodeAntcodeProjectexistinglabelResponse.class;
	}
