...
import com.aliyuncs.sofa.transform.v20190815.QueryLinkeBahamutWorkitemResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryLinkeBahamutWorkitemResponse extends AcsResponse {
	...
	@Override
	public QueryLinkeBahamutWorkitemResponse getInstance(UnmarshallerContext context) {
		return	QueryLinkeBahamutWorkitemResponseUnmarshaller.unmarshall(this, context);
	}
