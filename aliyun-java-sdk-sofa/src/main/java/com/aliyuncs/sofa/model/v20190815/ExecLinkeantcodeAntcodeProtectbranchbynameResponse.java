...
import com.aliyuncs.sofa.transform.v20190815.ExecLinkeantcodeAntcodeProtectbranchbynameResponseUnmarshaller;
 ...
 * @version 
 */
public class ExecLinkeantcodeAntcodeProtectbranchbynameResponse extends AcsResponse {
	...
	@Override
	public ExecLinkeantcodeAntcodeProtectbranchbynameResponse getInstance(UnmarshallerContext context) {
		return	ExecLinkeantcodeAntcodeProtectbranchbynameResponseUnmarshaller.unmarshall(this, context);
	}
