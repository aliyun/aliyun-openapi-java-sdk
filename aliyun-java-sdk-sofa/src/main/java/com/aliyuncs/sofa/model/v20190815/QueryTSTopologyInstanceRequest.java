 ...
 * @version 
 */
public class QueryTSTopologyInstanceRequest extends RpcAcsRequest<QueryTSTopologyInstanceResponse> {
	   

	private String shardings;
	...
	public QueryTSTopologyInstanceRequest() {
		super("SOFA", "2019-08-15", "QueryTSTopologyInstance", "ApplySidecarCert");
	...
	public void setShardings(String shardings) {
		this.shardings = shardings;
		if(shardings != null){
			putBodyParameter("Shardings", shardings);
		}
	}
	...
	@Override
	public Class<QueryTSTopologyInstanceResponse> getResponseClass() {
		return QueryTSTopologyInstanceResponse.class;
	}
