...
import com.aliyuncs.sofa.transform.v20190815.UpdateLinkeantcodeAntcodeRecoverytaskResponseUnmarshaller;
 ...
 * @version 
 */
public class UpdateLinkeantcodeAntcodeRecoverytaskResponse extends AcsResponse {
	...
	@Override
	public UpdateLinkeantcodeAntcodeRecoverytaskResponse getInstance(UnmarshallerContext context) {
		return	UpdateLinkeantcodeAntcodeRecoverytaskResponseUnmarshaller.unmarshall(this, context);
	}
