...
import com.aliyuncs.sofa.transform.v20190815.ListMsDrmLogsResponseUnmarshaller;
 ...
 * @version 
 */
public class ListMsDrmLogsResponse extends AcsResponse {
	...
	@Override
	public ListMsDrmLogsResponse getInstance(UnmarshallerContext context) {
		return	ListMsDrmLogsResponseUnmarshaller.unmarshall(this, context);
	}
