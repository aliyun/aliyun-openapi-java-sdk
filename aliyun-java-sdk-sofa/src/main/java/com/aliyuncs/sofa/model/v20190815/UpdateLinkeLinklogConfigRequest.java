 ...
 * @version 
 */
public class UpdateLinkeLinklogConfigRequest extends RpcAcsRequest<UpdateLinkeLinklogConfigResponse> {
	...
	private Long begin;
	public UpdateLinkeLinklogConfigRequest() {
		super("SOFA", "2019-08-15", "UpdateLinkeLinklogConfig", "sofacafedeps");
	...
	@Override
	public Class<UpdateLinkeLinklogConfigResponse> getResponseClass() {
		return UpdateLinkeLinklogConfigResponse.class;
	}
