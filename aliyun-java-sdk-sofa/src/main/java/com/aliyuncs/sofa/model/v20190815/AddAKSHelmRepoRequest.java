 ...
 * @version 
 */
public class AddAKSHelmRepoRequest extends RpcAcsRequest<AddAKSHelmRepoResponse> {
	...
	@Override
	public Class<AddAKSHelmRepoResponse> getResponseClass() {
		return AddAKSHelmRepoResponse.class;
	}
