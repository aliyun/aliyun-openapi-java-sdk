...
import com.aliyuncs.sofa.transform.v20190815.QueryTSTopologyResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryTSTopologyResponse extends AcsResponse {
	...
	@Override
	public QueryTSTopologyResponse getInstance(UnmarshallerContext context) {
		return	QueryTSTopologyResponseUnmarshaller.unmarshall(this, context);
	}
