 ...
 * @version 
 */
public class ReinitMsRcSyncClustersRequest extends RpcAcsRequest<ReinitMsRcSyncClustersResponse> {
	   

	private String replaceClusterEnabled;
	...
	public ReinitMsRcSyncClustersRequest() {
		super("SOFA", "2019-08-15", "ReinitMsRcSyncClusters", "sofacafedeps");
	...
	public void setReplaceClusterEnabled(String replaceClusterEnabled) {
		this.replaceClusterEnabled = replaceClusterEnabled;
		if(replaceClusterEnabled != null){
			putBodyParameter("ReplaceClusterEnabled", replaceClusterEnabled);
		}
	}
	...
	public void setNewCluster(String newCluster) {
		...
		if(newCluster != null){
			putBodyParameter("NewCluster", newCluster);
		}
	}
	...
	@Override
	public Class<ReinitMsRcSyncClustersResponse> getResponseClass() {
		return ReinitMsRcSyncClustersResponse.class;
	}
