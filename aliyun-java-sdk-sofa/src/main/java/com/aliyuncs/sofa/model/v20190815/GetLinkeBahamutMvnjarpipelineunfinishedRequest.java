 ...
 * @version 
 */
public class GetLinkeBahamutMvnjarpipelineunfinishedRequest extends RpcAcsRequest<GetLinkeBahamutMvnjarpipelineunfinishedResponse> {
	...
	@Override
	public Class<GetLinkeBahamutMvnjarpipelineunfinishedResponse> getResponseClass() {
		return GetLinkeBahamutMvnjarpipelineunfinishedResponse.class;
	}
