 ...
 * @version 
 */
public class QueryLinkefabricFabricMsgconfigRequest extends RpcAcsRequest<QueryLinkefabricFabricMsgconfigResponse> {
	...
	@Override
	public Class<QueryLinkefabricFabricMsgconfigResponse> getResponseClass() {
		return QueryLinkefabricFabricMsgconfigResponse.class;
	}
