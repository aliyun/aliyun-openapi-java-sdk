 ...
 * @version 
 */
public class QueryAKSBuildPackTechStacksRequest extends RpcAcsRequest<QueryAKSBuildPackTechStacksResponse> {
	...
	@Override
	public Class<QueryAKSBuildPackTechStacksResponse> getResponseClass() {
		return QueryAKSBuildPackTechStacksResponse.class;
	}
