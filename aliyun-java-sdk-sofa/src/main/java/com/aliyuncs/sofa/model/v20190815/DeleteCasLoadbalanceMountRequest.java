 ...
 * @version 
 */
public class DeleteCasLoadbalanceMountRequest extends RpcAcsRequest<DeleteCasLoadbalanceMountResponse> {
	...
	@Override
	public Class<DeleteCasLoadbalanceMountResponse> getResponseClass() {
		return DeleteCasLoadbalanceMountResponse.class;
	}
