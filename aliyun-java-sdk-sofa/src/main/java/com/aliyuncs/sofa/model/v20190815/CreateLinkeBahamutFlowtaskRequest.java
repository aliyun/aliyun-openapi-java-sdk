 ...
 * @version 
 */
public class CreateLinkeBahamutFlowtaskRequest extends RpcAcsRequest<CreateLinkeBahamutFlowtaskResponse> {
	...
	public CreateLinkeBahamutFlowtaskRequest() {
		super("SOFA", "2019-08-15", "CreateLinkeBahamutFlowtask", "ApplySidecarCert");
	...
	@Override
	public Class<CreateLinkeBahamutFlowtaskResponse> getResponseClass() {
		return CreateLinkeBahamutFlowtaskResponse.class;
	}
