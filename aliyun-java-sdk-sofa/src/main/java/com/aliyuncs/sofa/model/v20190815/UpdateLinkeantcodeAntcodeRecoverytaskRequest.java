 ...
 * @version 
 */
public class UpdateLinkeantcodeAntcodeRecoverytaskRequest extends RpcAcsRequest<UpdateLinkeantcodeAntcodeRecoverytaskResponse> {
	...
	@Override
	public Class<UpdateLinkeantcodeAntcodeRecoverytaskResponse> getResponseClass() {
		return UpdateLinkeantcodeAntcodeRecoverytaskResponse.class;
	}
