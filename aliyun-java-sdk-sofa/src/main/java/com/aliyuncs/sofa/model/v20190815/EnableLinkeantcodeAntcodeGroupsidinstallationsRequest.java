 ...
 * @version 
 */
public class EnableLinkeantcodeAntcodeGroupsidinstallationsRequest extends RpcAcsRequest<EnableLinkeantcodeAntcodeGroupsidinstallationsResponse> {
	...
	@Override
	public Class<EnableLinkeantcodeAntcodeGroupsidinstallationsResponse> getResponseClass() {
		return EnableLinkeantcodeAntcodeGroupsidinstallationsResponse.class;
	}
