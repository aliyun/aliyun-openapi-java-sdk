 ...
 * @version 
 */
public class UpdateLinkeLinktIterationRequest extends RpcAcsRequest<UpdateLinkeLinktIterationResponse> {
	...
	public UpdateLinkeLinktIterationRequest() {
		super("SOFA", "2019-08-15", "UpdateLinkeLinktIteration", "sofacafedeps");
	...
	@Override
	public Class<UpdateLinkeLinktIterationResponse> getResponseClass() {
		return UpdateLinkeLinktIterationResponse.class;
	}
