 ...
 * @version 
 */
public class ExecLinkeantcodeAntcodeProjectbranchmergeRequest extends RpcAcsRequest<ExecLinkeantcodeAntcodeProjectbranchmergeResponse> {
	...
	public ExecLinkeantcodeAntcodeProjectbranchmergeRequest() {
		super("SOFA", "2019-08-15", "ExecLinkeantcodeAntcodeProjectbranchmerge", "sofacafedeps");
	...
	@Override
	public Class<ExecLinkeantcodeAntcodeProjectbranchmergeResponse> getResponseClass() {
		return ExecLinkeantcodeAntcodeProjectbranchmergeResponse.class;
	}
