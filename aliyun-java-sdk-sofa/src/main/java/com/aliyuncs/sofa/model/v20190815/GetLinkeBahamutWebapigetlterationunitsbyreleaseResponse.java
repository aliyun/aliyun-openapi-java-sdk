...
import com.aliyuncs.sofa.transform.v20190815.GetLinkeBahamutWebapigetlterationunitsbyreleaseResponseUnmarshaller;
 ...
 * @version 
 */
public class GetLinkeBahamutWebapigetlterationunitsbyreleaseResponse extends AcsResponse {
	...
	@Override
	public GetLinkeBahamutWebapigetlterationunitsbyreleaseResponse getInstance(UnmarshallerContext context) {
		return	GetLinkeBahamutWebapigetlterationunitsbyreleaseResponseUnmarshaller.unmarshall(this, context);
	}
