...
import com.aliyuncs.sofa.transform.v20190815.QueryODPInstancesResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryODPInstancesResponse extends AcsResponse {
	...
	@Override
	public QueryODPInstancesResponse getInstance(UnmarshallerContext context) {
		return	QueryODPInstancesResponseUnmarshaller.unmarshall(this, context);
	}
