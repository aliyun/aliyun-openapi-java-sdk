 ...
 * @version 
 */
public class RemoveLinkeLinktWorkitemrelationRequest extends RpcAcsRequest<RemoveLinkeLinktWorkitemrelationResponse> {
	...
	public void setTargetSign(String targetSign) {
		...
		if(targetSign != null){
			putBodyParameter("TargetSign", targetSign);
		}
	}
	...
	@Override
	public Class<RemoveLinkeLinktWorkitemrelationResponse> getResponseClass() {
		return RemoveLinkeLinktWorkitemrelationResponse.class;
	}
