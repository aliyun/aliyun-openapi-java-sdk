 ...
 * @version 
 */
public class CreateLinkeLinklogStoreRequest extends RpcAcsRequest<CreateLinkeLinklogStoreResponse> {
	...
	@Override
	public Class<CreateLinkeLinklogStoreResponse> getResponseClass() {
		return CreateLinkeLinklogStoreResponse.class;
	}
