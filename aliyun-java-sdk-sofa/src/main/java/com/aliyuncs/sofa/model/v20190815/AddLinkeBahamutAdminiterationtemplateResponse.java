...
import com.aliyuncs.sofa.transform.v20190815.AddLinkeBahamutAdminiterationtemplateResponseUnmarshaller;
 ...
 * @version 
 */
public class AddLinkeBahamutAdminiterationtemplateResponse extends AcsResponse {
	...
	@Override
	public AddLinkeBahamutAdminiterationtemplateResponse getInstance(UnmarshallerContext context) {
		return	AddLinkeBahamutAdminiterationtemplateResponseUnmarshaller.unmarshall(this, context);
	}
