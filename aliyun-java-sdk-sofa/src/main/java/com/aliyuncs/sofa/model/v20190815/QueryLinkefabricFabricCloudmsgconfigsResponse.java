...
import com.aliyuncs.sofa.transform.v20190815.QueryLinkefabricFabricCloudmsgconfigsResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryLinkefabricFabricCloudmsgconfigsResponse extends AcsResponse {
	...
	@Override
	public QueryLinkefabricFabricCloudmsgconfigsResponse getInstance(UnmarshallerContext context) {
		return	QueryLinkefabricFabricCloudmsgconfigsResponseUnmarshaller.unmarshall(this, context);
	}
