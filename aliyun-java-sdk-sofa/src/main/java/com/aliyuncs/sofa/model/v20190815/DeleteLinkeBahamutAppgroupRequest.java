 ...
 * @version 
 */
public class DeleteLinkeBahamutAppgroupRequest extends RpcAcsRequest<DeleteLinkeBahamutAppgroupResponse> {
	...
	private String name;
	public DeleteLinkeBahamutAppgroupRequest() {
		super("SOFA", "2019-08-15", "DeleteLinkeBahamutAppgroup", "sofacafedeps");
	...
	@Override
	public Class<DeleteLinkeBahamutAppgroupResponse> getResponseClass() {
		return DeleteLinkeBahamutAppgroupResponse.class;
	}
