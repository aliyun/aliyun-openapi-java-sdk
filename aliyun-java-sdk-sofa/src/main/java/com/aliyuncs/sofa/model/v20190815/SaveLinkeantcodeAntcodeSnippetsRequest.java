 ...
 * @version 
 */
public class SaveLinkeantcodeAntcodeSnippetsRequest extends RpcAcsRequest<SaveLinkeantcodeAntcodeSnippetsResponse> {
	...
	@Override
	public Class<SaveLinkeantcodeAntcodeSnippetsResponse> getResponseClass() {
		return SaveLinkeantcodeAntcodeSnippetsResponse.class;
	}
