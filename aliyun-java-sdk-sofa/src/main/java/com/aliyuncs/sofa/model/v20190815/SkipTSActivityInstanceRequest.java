 ...
 * @version 
 */
public class SkipTSActivityInstanceRequest extends RpcAcsRequest<SkipTSActivityInstanceResponse> {
	...
	public SkipTSActivityInstanceRequest() {
		super("SOFA", "2019-08-15", "SkipTSActivityInstance", "ApplySidecarCert");
	...
	@Override
	public Class<SkipTSActivityInstanceResponse> getResponseClass() {
		return SkipTSActivityInstanceResponse.class;
	}
