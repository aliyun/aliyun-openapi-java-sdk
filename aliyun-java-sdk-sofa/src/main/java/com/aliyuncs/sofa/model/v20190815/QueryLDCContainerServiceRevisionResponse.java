...
import com.aliyuncs.sofa.transform.v20190815.QueryLDCContainerServiceRevisionResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryLDCContainerServiceRevisionResponse extends AcsResponse {
	...
	private List<RevisionListItem> revisionList;
	...
	public List<RevisionListItem> getRevisionList() {
		return this.revisionList;
	}

	public void setRevisionList(List<RevisionListItem> revisionList) {
		this.revisionList = revisionList;
	}

	public static class RevisionListItem {
	...
	@Override
	public QueryLDCContainerServiceRevisionResponse getInstance(UnmarshallerContext context) {
		return	QueryLDCContainerServiceRevisionResponseUnmarshaller.unmarshall(this, context);
	}
