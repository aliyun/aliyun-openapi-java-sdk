...
import com.aliyuncs.sofa.transform.v20190815.GetLinkeBahamutIterationworkitemsResponseUnmarshaller;
 ...
 * @version 
 */
public class GetLinkeBahamutIterationworkitemsResponse extends AcsResponse {
	...
	@Override
	public GetLinkeBahamutIterationworkitemsResponse getInstance(UnmarshallerContext context) {
		return	GetLinkeBahamutIterationworkitemsResponseUnmarshaller.unmarshall(this, context);
	}
