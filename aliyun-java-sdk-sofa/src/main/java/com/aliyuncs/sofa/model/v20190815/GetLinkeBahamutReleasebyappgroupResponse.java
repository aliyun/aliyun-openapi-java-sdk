...
import com.aliyuncs.sofa.transform.v20190815.GetLinkeBahamutReleasebyappgroupResponseUnmarshaller;
 ...
 * @version 
 */
public class GetLinkeBahamutReleasebyappgroupResponse extends AcsResponse {
	...
	@Override
	public GetLinkeBahamutReleasebyappgroupResponse getInstance(UnmarshallerContext context) {
		return	GetLinkeBahamutReleasebyappgroupResponseUnmarshaller.unmarshall(this, context);
	}
