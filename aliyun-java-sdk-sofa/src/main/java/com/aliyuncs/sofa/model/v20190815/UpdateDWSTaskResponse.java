...
import com.aliyuncs.sofa.transform.v20190815.UpdateDWSTaskResponseUnmarshaller;
 ...
 * @version 
 */
public class UpdateDWSTaskResponse extends AcsResponse {
	...
	@Override
	public UpdateDWSTaskResponse getInstance(UnmarshallerContext context) {
		return	UpdateDWSTaskResponseUnmarshaller.unmarshall(this, context);
	}
