 ...
 * @version 
 */
public class QueryLinkefabricFabricCloudmsgconfigsRequest extends RpcAcsRequest<QueryLinkefabricFabricCloudmsgconfigsResponse> {
	...
	public QueryLinkefabricFabricCloudmsgconfigsRequest() {
		super("SOFA", "2019-08-15", "QueryLinkefabricFabricCloudmsgconfigs", "sofacafedeps");
	...
	@Override
	public Class<QueryLinkefabricFabricCloudmsgconfigsResponse> getResponseClass() {
		return QueryLinkefabricFabricCloudmsgconfigsResponse.class;
	}
