 ...
 * @version 
 */
public class QueryLinkeantcodeAntcodeBatchuploadartifactsRequest extends RpcAcsRequest<QueryLinkeantcodeAntcodeBatchuploadartifactsResponse> {
	...
	@Override
	public Class<QueryLinkeantcodeAntcodeBatchuploadartifactsResponse> getResponseClass() {
		return QueryLinkeantcodeAntcodeBatchuploadartifactsResponse.class;
	}
