...
import com.aliyuncs.sofa.transform.v20190815.QueryLinkeBahamutAppssearchResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryLinkeBahamutAppssearchResponse extends AcsResponse {
	...
	@Override
	public QueryLinkeBahamutAppssearchResponse getInstance(UnmarshallerContext context) {
		return	QueryLinkeBahamutAppssearchResponseUnmarshaller.unmarshall(this, context);
	}
