...
import com.aliyuncs.sofa.transform.v20190815.QueryLinkeBahamutIterationunitsResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryLinkeBahamutIterationunitsResponse extends AcsResponse {
	...
	@Override
	public QueryLinkeBahamutIterationunitsResponse getInstance(UnmarshallerContext context) {
		return	QueryLinkeBahamutIterationunitsResponseUnmarshaller.unmarshall(this, context);
	}
