...
import com.aliyuncs.sofa.transform.v20190815.CreateLinkeLinklogStoreResponseUnmarshaller;
 ...
 * @version 
 */
public class CreateLinkeLinklogStoreResponse extends AcsResponse {
	...
	@Override
	public CreateLinkeLinklogStoreResponse getInstance(UnmarshallerContext context) {
		return	CreateLinkeLinklogStoreResponseUnmarshaller.unmarshall(this, context);
	}
