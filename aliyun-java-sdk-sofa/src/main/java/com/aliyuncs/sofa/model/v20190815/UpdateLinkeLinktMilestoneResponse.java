...
import com.aliyuncs.sofa.transform.v20190815.UpdateLinkeLinktMilestoneResponseUnmarshaller;
 ...
 * @version 
 */
public class UpdateLinkeLinktMilestoneResponse extends AcsResponse {
	...
	@Override
	public UpdateLinkeLinktMilestoneResponse getInstance(UnmarshallerContext context) {
		return	UpdateLinkeLinktMilestoneResponseUnmarshaller.unmarshall(this, context);
	}
