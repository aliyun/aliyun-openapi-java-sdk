 ...
 * @version 
 */
public class CreateLinkeBahamutTaskRequest extends RpcAcsRequest<CreateLinkeBahamutTaskResponse> {
	...
	public CreateLinkeBahamutTaskRequest() {
		super("SOFA", "2019-08-15", "CreateLinkeBahamutTask", "sofacafedeps");
	...
	@Override
	public Class<CreateLinkeBahamutTaskResponse> getResponseClass() {
		return CreateLinkeBahamutTaskResponse.class;
	}
