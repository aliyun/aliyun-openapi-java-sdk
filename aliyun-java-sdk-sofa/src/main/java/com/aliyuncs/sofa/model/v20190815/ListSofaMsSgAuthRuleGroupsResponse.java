...
import com.aliyuncs.sofa.transform.v20190815.ListSofaMsSgAuthRuleGroupsResponseUnmarshaller;
 ...
 * @version 
 */
public class ListSofaMsSgAuthRuleGroupsResponse extends AcsResponse {
	...
	@Override
	public ListSofaMsSgAuthRuleGroupsResponse getInstance(UnmarshallerContext context) {
		return	ListSofaMsSgAuthRuleGroupsResponseUnmarshaller.unmarshall(this, context);
	}
