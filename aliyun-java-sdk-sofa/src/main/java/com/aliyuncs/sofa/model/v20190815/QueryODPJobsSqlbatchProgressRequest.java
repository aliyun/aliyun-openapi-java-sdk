 ...
 * @version 
 */
public class QueryODPJobsSqlbatchProgressRequest extends RpcAcsRequest<QueryODPJobsSqlbatchProgressResponse> {
	...
	public QueryODPJobsSqlbatchProgressRequest() {
		super("SOFA", "2019-08-15", "QueryODPJobsSqlbatchProgress", "sofacafedeps");
	...
	@Override
	public Class<QueryODPJobsSqlbatchProgressResponse> getResponseClass() {
		return QueryODPJobsSqlbatchProgressResponse.class;
	}
