 ...
 * @version 
 */
public class SaveLinkeLinktAdmintemplateorderRequest extends RpcAcsRequest<SaveLinkeLinktAdmintemplateorderResponse> {
	   

	private String stamp;

	private List<Templates> templatess;
	public SaveLinkeLinktAdmintemplateorderRequest() {
		super("SOFA", "2019-08-15", "SaveLinkeLinktAdmintemplateorder", "sofacafedeps");
	...
	@Override
	public Class<SaveLinkeLinktAdmintemplateorderResponse> getResponseClass() {
		return SaveLinkeLinktAdmintemplateorderResponse.class;
	}
