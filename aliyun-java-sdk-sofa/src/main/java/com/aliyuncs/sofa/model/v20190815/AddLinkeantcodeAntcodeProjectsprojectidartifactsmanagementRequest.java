 ...
 * @version 
 */
public class AddLinkeantcodeAntcodeProjectsprojectidartifactsmanagementRequest extends RpcAcsRequest<AddLinkeantcodeAntcodeProjectsprojectidartifactsmanagementResponse> {
	...
	@Override
	public Class<AddLinkeantcodeAntcodeProjectsprojectidartifactsmanagementResponse> getResponseClass() {
		return AddLinkeantcodeAntcodeProjectsprojectidartifactsmanagementResponse.class;
	}
