...
import com.aliyuncs.sofa.transform.v20190815.GetLinkeBahamutIterationsgetlterationsbyappgroupResponseUnmarshaller;
 ...
 * @version 
 */
public class GetLinkeBahamutIterationsgetlterationsbyappgroupResponse extends AcsResponse {
	...
	@Override
	public GetLinkeBahamutIterationsgetlterationsbyappgroupResponse getInstance(UnmarshallerContext context) {
		return	GetLinkeBahamutIterationsgetlterationsbyappgroupResponseUnmarshaller.unmarshall(this, context);
	}
