 ...
 * @version 
 */
public class QueryRmsCloudmeshListdataidsRequest extends RpcAcsRequest<QueryRmsCloudmeshListdataidsResponse> {
	...
	public QueryRmsCloudmeshListdataidsRequest() {
		super("SOFA", "2019-08-15", "QueryRmsCloudmeshListdataids", "sofacafedeps");
	...
	@Override
	public Class<QueryRmsCloudmeshListdataidsResponse> getResponseClass() {
		return QueryRmsCloudmeshListdataidsResponse.class;
	}
