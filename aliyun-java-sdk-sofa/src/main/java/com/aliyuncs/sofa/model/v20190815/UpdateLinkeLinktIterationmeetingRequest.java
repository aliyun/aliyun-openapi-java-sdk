 ...
 * @version 
 */
public class UpdateLinkeLinktIterationmeetingRequest extends RpcAcsRequest<UpdateLinkeLinktIterationmeetingResponse> {
	...
	public UpdateLinkeLinktIterationmeetingRequest() {
		super("SOFA", "2019-08-15", "UpdateLinkeLinktIterationmeeting", "ApplySidecarCert");
	...
	@Override
	public Class<UpdateLinkeLinktIterationmeetingResponse> getResponseClass() {
		return UpdateLinkeLinktIterationmeetingResponse.class;
	}
