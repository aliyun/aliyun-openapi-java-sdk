 ...
 * @version 
 */
public class SkipTSShardingActivityInstancesRequest extends RpcAcsRequest<SkipTSShardingActivityInstancesResponse> {
	...
	public SkipTSShardingActivityInstancesRequest() {
		super("SOFA", "2019-08-15", "SkipTSShardingActivityInstances", "sofacafedeps");
	...
	@Override
	public Class<SkipTSShardingActivityInstancesResponse> getResponseClass() {
		return SkipTSShardingActivityInstancesResponse.class;
	}
