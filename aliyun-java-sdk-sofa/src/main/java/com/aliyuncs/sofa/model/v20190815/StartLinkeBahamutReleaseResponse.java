...
import com.aliyuncs.sofa.transform.v20190815.StartLinkeBahamutReleaseResponseUnmarshaller;
 ...
 * @version 
 */
public class StartLinkeBahamutReleaseResponse extends AcsResponse {
	...
	@Override
	public StartLinkeBahamutReleaseResponse getInstance(UnmarshallerContext context) {
		return	StartLinkeBahamutReleaseResponseUnmarshaller.unmarshall(this, context);
	}
