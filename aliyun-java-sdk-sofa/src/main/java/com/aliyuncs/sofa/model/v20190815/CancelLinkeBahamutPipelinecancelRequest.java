 ...
 * @version 
 */
public class CancelLinkeBahamutPipelinecancelRequest extends RpcAcsRequest<CancelLinkeBahamutPipelinecancelResponse> {
	...
	public CancelLinkeBahamutPipelinecancelRequest() {
		super("SOFA", "2019-08-15", "CancelLinkeBahamutPipelinecancel", "sofacafedeps");
	...
	@Override
	public Class<CancelLinkeBahamutPipelinecancelResponse> getResponseClass() {
		return CancelLinkeBahamutPipelinecancelResponse.class;
	}
