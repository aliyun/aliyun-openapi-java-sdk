...
import com.aliyuncs.sofa.transform.v20190815.DescribeLDCContainerServiceRevisionResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeLDCContainerServiceRevisionResponse extends AcsResponse {
	...
	@Override
	public DescribeLDCContainerServiceRevisionResponse getInstance(UnmarshallerContext context) {
		return	DescribeLDCContainerServiceRevisionResponseUnmarshaller.unmarshall(this, context);
	}
