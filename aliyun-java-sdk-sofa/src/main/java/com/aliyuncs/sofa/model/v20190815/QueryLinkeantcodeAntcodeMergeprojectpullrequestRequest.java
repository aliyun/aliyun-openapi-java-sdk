 ...
 * @version 
 */
public class QueryLinkeantcodeAntcodeMergeprojectpullrequestRequest extends RpcAcsRequest<QueryLinkeantcodeAntcodeMergeprojectpullrequestResponse> {
	...
	@Override
	public Class<QueryLinkeantcodeAntcodeMergeprojectpullrequestResponse> getResponseClass() {
		return QueryLinkeantcodeAntcodeMergeprojectpullrequestResponse.class;
	}
