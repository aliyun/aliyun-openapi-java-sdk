 ...
 * @version 
 */
public class ExecLinkefabricFabricPutdrmofflinetaskRequest extends RpcAcsRequest<ExecLinkefabricFabricPutdrmofflinetaskResponse> {
	...
	public ExecLinkefabricFabricPutdrmofflinetaskRequest() {
		super("SOFA", "2019-08-15", "ExecLinkefabricFabricPutdrmofflinetask", "sofacafedeps");
	...
	@Override
	public Class<ExecLinkefabricFabricPutdrmofflinetaskResponse> getResponseClass() {
		return ExecLinkefabricFabricPutdrmofflinetaskResponse.class;
	}
