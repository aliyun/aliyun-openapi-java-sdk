 ...
 * @version 
 */
public class QueryLinkeBahamutAppRequest extends RpcAcsRequest<QueryLinkeBahamutAppResponse> {
	...
	private String page;
	public QueryLinkeBahamutAppRequest() {
		super("SOFA", "2019-08-15", "QueryLinkeBahamutApp", "sofacafedeps");
	...
	@Override
	public Class<QueryLinkeBahamutAppResponse> getResponseClass() {
		return QueryLinkeBahamutAppResponse.class;
	}
