 ...
 * @version 
 */
public class CreateLinkeantcodeAntcodeLsifreferencesRequest extends RpcAcsRequest<CreateLinkeantcodeAntcodeLsifreferencesResponse> {
	...
	@Override
	public Class<CreateLinkeantcodeAntcodeLsifreferencesResponse> getResponseClass() {
		return CreateLinkeantcodeAntcodeLsifreferencesResponse.class;
	}
