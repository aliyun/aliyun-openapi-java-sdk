 ...
 * @version 
 */
public class QueryLinkedeploycoreDeploycoreAppquerybranchRequest extends RpcAcsRequest<QueryLinkedeploycoreDeploycoreAppquerybranchResponse> {
	...
	public QueryLinkedeploycoreDeploycoreAppquerybranchRequest() {
		super("SOFA", "2019-08-15", "QueryLinkedeploycoreDeploycoreAppquerybranch", "sofacafedeps");
	...
	@Override
	public Class<QueryLinkedeploycoreDeploycoreAppquerybranchResponse> getResponseClass() {
		return QueryLinkedeploycoreDeploycoreAppquerybranchResponse.class;
	}
