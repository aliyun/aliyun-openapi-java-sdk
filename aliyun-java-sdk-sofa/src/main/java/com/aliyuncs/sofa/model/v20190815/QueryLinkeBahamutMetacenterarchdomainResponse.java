...
import com.aliyuncs.sofa.transform.v20190815.QueryLinkeBahamutMetacenterarchdomainResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryLinkeBahamutMetacenterarchdomainResponse extends AcsResponse {
	...
	@Override
	public QueryLinkeBahamutMetacenterarchdomainResponse getInstance(UnmarshallerContext context) {
		return	QueryLinkeBahamutMetacenterarchdomainResponseUnmarshaller.unmarshall(this, context);
	}
