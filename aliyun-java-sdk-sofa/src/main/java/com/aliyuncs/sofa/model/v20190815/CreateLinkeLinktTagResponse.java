...
import com.aliyuncs.sofa.transform.v20190815.CreateLinkeLinktTagResponseUnmarshaller;
 ...
 * @version 
 */
public class CreateLinkeLinktTagResponse extends AcsResponse {
	...
	@Override
	public CreateLinkeLinktTagResponse getInstance(UnmarshallerContext context) {
		return	CreateLinkeLinktTagResponseUnmarshaller.unmarshall(this, context);
	}
