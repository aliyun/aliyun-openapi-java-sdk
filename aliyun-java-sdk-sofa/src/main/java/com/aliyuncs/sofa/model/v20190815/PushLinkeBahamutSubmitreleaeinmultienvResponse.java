...
import com.aliyuncs.sofa.transform.v20190815.PushLinkeBahamutSubmitreleaeinmultienvResponseUnmarshaller;
 ...
 * @version 
 */
public class PushLinkeBahamutSubmitreleaeinmultienvResponse extends AcsResponse {
	...
	@Override
	public PushLinkeBahamutSubmitreleaeinmultienvResponse getInstance(UnmarshallerContext context) {
		return	PushLinkeBahamutSubmitreleaeinmultienvResponseUnmarshaller.unmarshall(this, context);
	}
