...
import com.aliyuncs.sofa.transform.v20190815.DescribeAppServiceEnvParamResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeAppServiceEnvParamResponse extends AcsResponse {
	...
	private List<AppServiceEnvParamsItem> appServiceEnvParams;
	...
	public List<AppServiceEnvParamsItem> getAppServiceEnvParams() {
		return this.appServiceEnvParams;
	}

	public void setAppServiceEnvParams(List<AppServiceEnvParamsItem> appServiceEnvParams) {
		this.appServiceEnvParams = appServiceEnvParams;
	}

	public static class AppServiceEnvParamsItem {
	...
	@Override
	public DescribeAppServiceEnvParamResponse getInstance(UnmarshallerContext context) {
		return	DescribeAppServiceEnvParamResponseUnmarshaller.unmarshall(this, context);
	}
