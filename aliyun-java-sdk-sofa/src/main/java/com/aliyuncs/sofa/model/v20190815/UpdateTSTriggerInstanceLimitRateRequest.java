 ...
 * @version 
 */
public class UpdateTSTriggerInstanceLimitRateRequest extends RpcAcsRequest<UpdateTSTriggerInstanceLimitRateResponse> {
	...
	public UpdateTSTriggerInstanceLimitRateRequest() {
		super("SOFA", "2019-08-15", "UpdateTSTriggerInstanceLimitRate", "ApplySidecarCert");
	...
	@Override
	public Class<UpdateTSTriggerInstanceLimitRateResponse> getResponseClass() {
		return UpdateTSTriggerInstanceLimitRateResponse.class;
	}
