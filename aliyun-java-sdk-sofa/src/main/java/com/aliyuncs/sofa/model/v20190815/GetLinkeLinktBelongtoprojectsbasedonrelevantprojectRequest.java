 ...
 * @version 
 */
public class GetLinkeLinktBelongtoprojectsbasedonrelevantprojectRequest extends RpcAcsRequest<GetLinkeLinktBelongtoprojectsbasedonrelevantprojectResponse> {
	...
	@Override
	public Class<GetLinkeLinktBelongtoprojectsbasedonrelevantprojectResponse> getResponseClass() {
		return GetLinkeLinktBelongtoprojectsbasedonrelevantprojectResponse.class;
	}
