 ...
 * @version 
 */
public class CreateLinkeantcodeAntcodeTenantpusheventsrecoveriesRequest extends RpcAcsRequest<CreateLinkeantcodeAntcodeTenantpusheventsrecoveriesResponse> {
	...
	@Override
	public Class<CreateLinkeantcodeAntcodeTenantpusheventsrecoveriesResponse> getResponseClass() {
		return CreateLinkeantcodeAntcodeTenantpusheventsrecoveriesResponse.class;
	}
