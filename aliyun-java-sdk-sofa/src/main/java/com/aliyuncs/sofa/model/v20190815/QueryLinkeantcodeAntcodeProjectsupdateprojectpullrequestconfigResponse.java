...
import com.aliyuncs.sofa.transform.v20190815.QueryLinkeantcodeAntcodeProjectsupdateprojectpullrequestconfigResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryLinkeantcodeAntcodeProjectsupdateprojectpullrequestconfigResponse extends AcsResponse {
	...
	@Override
	public QueryLinkeantcodeAntcodeProjectsupdateprojectpullrequestconfigResponse getInstance(UnmarshallerContext context) {
		return	QueryLinkeantcodeAntcodeProjectsupdateprojectpullrequestconfigResponseUnmarshaller.unmarshall(this, context);
	}
