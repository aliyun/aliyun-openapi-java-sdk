 ...
 * @version 
 */
public class QueryLinkefabricFabricSystemparameterisadminRequest extends RpcAcsRequest<QueryLinkefabricFabricSystemparameterisadminResponse> {
	...
	@Override
	public Class<QueryLinkefabricFabricSystemparameterisadminResponse> getResponseClass() {
		return QueryLinkefabricFabricSystemparameterisadminResponse.class;
	}
