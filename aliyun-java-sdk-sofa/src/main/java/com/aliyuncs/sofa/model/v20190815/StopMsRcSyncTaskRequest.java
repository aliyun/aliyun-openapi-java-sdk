 ...
 * @version 
 */
public class StopMsRcSyncTaskRequest extends RpcAcsRequest<StopMsRcSyncTaskResponse> {
	   

	private String clusterTaskUniqueKey;

	private String instanceId;
	public StopMsRcSyncTaskRequest() {
		super("SOFA", "2019-08-15", "StopMsRcSyncTask", "ApplySidecarCert");
	...
	@Override
	public Class<StopMsRcSyncTaskResponse> getResponseClass() {
		return StopMsRcSyncTaskResponse.class;
	}
