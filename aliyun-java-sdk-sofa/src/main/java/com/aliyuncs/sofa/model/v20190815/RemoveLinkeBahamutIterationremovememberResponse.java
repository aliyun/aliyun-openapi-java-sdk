...
import com.aliyuncs.sofa.transform.v20190815.RemoveLinkeBahamutIterationremovememberResponseUnmarshaller;
 ...
 * @version 
 */
public class RemoveLinkeBahamutIterationremovememberResponse extends AcsResponse {
	...
	@Override
	public RemoveLinkeBahamutIterationremovememberResponse getInstance(UnmarshallerContext context) {
		return	RemoveLinkeBahamutIterationremovememberResponseUnmarshaller.unmarshall(this, context);
	}
