 ...
 * @version 
 */
public class CreateDTXRecoveryInitiatorRequest extends RpcAcsRequest<CreateDTXRecoveryInitiatorResponse> {
	...
	@Override
	public Class<CreateDTXRecoveryInitiatorResponse> getResponseClass() {
		return CreateDTXRecoveryInitiatorResponse.class;
	}
