 ...
 * @version 
 */
public class ExecLinkeantcodeAntcodeTesthookRequest extends RpcAcsRequest<ExecLinkeantcodeAntcodeTesthookResponse> {
	...
	@Override
	public Class<ExecLinkeantcodeAntcodeTesthookResponse> getResponseClass() {
		return ExecLinkeantcodeAntcodeTesthookResponse.class;
	}
