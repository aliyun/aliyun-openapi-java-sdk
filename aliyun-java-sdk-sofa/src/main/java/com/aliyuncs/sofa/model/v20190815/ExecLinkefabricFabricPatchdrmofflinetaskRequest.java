 ...
 * @version 
 */
public class ExecLinkefabricFabricPatchdrmofflinetaskRequest extends RpcAcsRequest<ExecLinkefabricFabricPatchdrmofflinetaskResponse> {
	...
	public ExecLinkefabricFabricPatchdrmofflinetaskRequest() {
		super("SOFA", "2019-08-15", "ExecLinkefabricFabricPatchdrmofflinetask", "sofacafedeps");
	...
	@Override
	public Class<ExecLinkefabricFabricPatchdrmofflinetaskResponse> getResponseClass() {
		return ExecLinkefabricFabricPatchdrmofflinetaskResponse.class;
	}
