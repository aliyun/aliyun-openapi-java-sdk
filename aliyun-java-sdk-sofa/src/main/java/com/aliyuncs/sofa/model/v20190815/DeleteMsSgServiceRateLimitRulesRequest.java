 ...
 * @version 
 */
public class DeleteMsSgServiceRateLimitRulesRequest extends RpcAcsRequest<DeleteMsSgServiceRateLimitRulesResponse> {
	...
	public DeleteMsSgServiceRateLimitRulesRequest() {
		super("SOFA", "2019-08-15", "DeleteMsSgServiceRateLimitRules", "sofacafedeps");
	...
	@Override
	public Class<DeleteMsSgServiceRateLimitRulesResponse> getResponseClass() {
		return DeleteMsSgServiceRateLimitRulesResponse.class;
	}
