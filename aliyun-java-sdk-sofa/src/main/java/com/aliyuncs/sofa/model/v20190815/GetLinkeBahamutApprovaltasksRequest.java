 ...
 * @version 
 */
public class GetLinkeBahamutApprovaltasksRequest extends RpcAcsRequest<GetLinkeBahamutApprovaltasksResponse> {
	...
	@Override
	public Class<GetLinkeBahamutApprovaltasksResponse> getResponseClass() {
		return GetLinkeBahamutApprovaltasksResponse.class;
	}
