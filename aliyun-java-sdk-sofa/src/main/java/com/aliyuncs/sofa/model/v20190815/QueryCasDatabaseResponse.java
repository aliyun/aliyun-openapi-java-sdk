...
import com.aliyuncs.sofa.transform.v20190815.QueryCasDatabaseResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryCasDatabaseResponse extends AcsResponse {
	...
	@Override
	public QueryCasDatabaseResponse getInstance(UnmarshallerContext context) {
		return	QueryCasDatabaseResponseUnmarshaller.unmarshall(this, context);
	}
