...
import com.aliyuncs.sofa.transform.v20190815.ListClriskDatasourceResponseUnmarshaller;
 ...
 * @version 
 */
public class ListClriskDatasourceResponse extends AcsResponse {
	...
	private List<DataSourceListItem> dataSourceList;
	...
	public List<DataSourceListItem> getDataSourceList() {
		return this.dataSourceList;
	}

	public void setDataSourceList(List<DataSourceListItem> dataSourceList) {
		this.dataSourceList = dataSourceList;
	}

	public static class DataSourceListItem {
	...
	@Override
	public ListClriskDatasourceResponse getInstance(UnmarshallerContext context) {
		return	ListClriskDatasourceResponseUnmarshaller.unmarshall(this, context);
	}
