 ...
 * @version 
 */
public class AddLinkeBahamutVcsmergerequestRequest extends RpcAcsRequest<AddLinkeBahamutVcsmergerequestResponse> {
	...
	public AddLinkeBahamutVcsmergerequestRequest() {
		super("SOFA", "2019-08-15", "AddLinkeBahamutVcsmergerequest", "sofacafedeps");
	...
	@Override
	public Class<AddLinkeBahamutVcsmergerequestResponse> getResponseClass() {
		return AddLinkeBahamutVcsmergerequestResponse.class;
	}
