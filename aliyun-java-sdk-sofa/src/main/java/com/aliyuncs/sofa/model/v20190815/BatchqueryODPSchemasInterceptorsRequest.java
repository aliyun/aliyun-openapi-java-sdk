 ...
 * @version 
 */
public class BatchqueryODPSchemasInterceptorsRequest extends RpcAcsRequest<BatchqueryODPSchemasInterceptorsResponse> {
	...
	@Override
	public Class<BatchqueryODPSchemasInterceptorsResponse> getResponseClass() {
		return BatchqueryODPSchemasInterceptorsResponse.class;
	}
