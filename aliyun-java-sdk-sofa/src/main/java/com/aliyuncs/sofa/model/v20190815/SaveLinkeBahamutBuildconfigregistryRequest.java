 ...
 * @version 
 */
public class SaveLinkeBahamutBuildconfigregistryRequest extends RpcAcsRequest<SaveLinkeBahamutBuildconfigregistryResponse> {
	...
	public SaveLinkeBahamutBuildconfigregistryRequest() {
		super("SOFA", "2019-08-15", "SaveLinkeBahamutBuildconfigregistry", "sofa");
	...
	@Override
	public Class<SaveLinkeBahamutBuildconfigregistryResponse> getResponseClass() {
		return SaveLinkeBahamutBuildconfigregistryResponse.class;
	}
