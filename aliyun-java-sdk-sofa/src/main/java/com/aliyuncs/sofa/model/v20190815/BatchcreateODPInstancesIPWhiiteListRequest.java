 ...
 * @version 
 */
public class BatchcreateODPInstancesIPWhiiteListRequest extends RpcAcsRequest<BatchcreateODPInstancesIPWhiiteListResponse> {
	...
	public BatchcreateODPInstancesIPWhiiteListRequest() {
		super("SOFA", "2019-08-15", "BatchcreateODPInstancesIPWhiiteList", "ApplySidecarCert");
	...
	@Override
	public Class<BatchcreateODPInstancesIPWhiiteListResponse> getResponseClass() {
		return BatchcreateODPInstancesIPWhiiteListResponse.class;
	}
