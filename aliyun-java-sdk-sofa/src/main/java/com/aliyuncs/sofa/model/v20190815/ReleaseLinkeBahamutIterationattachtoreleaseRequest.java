 ...
 * @version 
 */
public class ReleaseLinkeBahamutIterationattachtoreleaseRequest extends RpcAcsRequest<ReleaseLinkeBahamutIterationattachtoreleaseResponse> {
	...
	public ReleaseLinkeBahamutIterationattachtoreleaseRequest() {
		super("SOFA", "2019-08-15", "ReleaseLinkeBahamutIterationattachtorelease", "sofacaferms");
	...
	@Override
	public Class<ReleaseLinkeBahamutIterationattachtoreleaseResponse> getResponseClass() {
		return ReleaseLinkeBahamutIterationattachtoreleaseResponse.class;
	}
