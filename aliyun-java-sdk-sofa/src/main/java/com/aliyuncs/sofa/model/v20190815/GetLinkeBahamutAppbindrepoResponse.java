...
import com.aliyuncs.sofa.transform.v20190815.GetLinkeBahamutAppbindrepoResponseUnmarshaller;
 ...
 * @version 
 */
public class GetLinkeBahamutAppbindrepoResponse extends AcsResponse {
	...
	@Override
	public GetLinkeBahamutAppbindrepoResponse getInstance(UnmarshallerContext context) {
		return	GetLinkeBahamutAppbindrepoResponseUnmarshaller.unmarshall(this, context);
	}
