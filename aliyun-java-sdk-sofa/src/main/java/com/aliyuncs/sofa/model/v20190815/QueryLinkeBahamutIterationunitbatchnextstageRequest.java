 ...
 * @version 
 */
public class QueryLinkeBahamutIterationunitbatchnextstageRequest extends RpcAcsRequest<QueryLinkeBahamutIterationunitbatchnextstageResponse> {
	...
	@Override
	public Class<QueryLinkeBahamutIterationunitbatchnextstageResponse> getResponseClass() {
		return QueryLinkeBahamutIterationunitbatchnextstageResponse.class;
	}
