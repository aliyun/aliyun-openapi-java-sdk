...
import com.aliyuncs.sofa.transform.v20190815.UpdateLinkeLinktTemplateResponseUnmarshaller;
 ...
 * @version 
 */
public class UpdateLinkeLinktTemplateResponse extends AcsResponse {
	...
	@Override
	public UpdateLinkeLinktTemplateResponse getInstance(UnmarshallerContext context) {
		return	UpdateLinkeLinktTemplateResponseUnmarshaller.unmarshall(this, context);
	}
