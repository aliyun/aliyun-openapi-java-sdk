 ...
 * @version 
 */
public class QueryRmsCloudmeshSidecarlistRequest extends RpcAcsRequest<QueryRmsCloudmeshSidecarlistResponse> {
	...
	public QueryRmsCloudmeshSidecarlistRequest() {
		super("SOFA", "2019-08-15", "QueryRmsCloudmeshSidecarlist", "sofacafedeps");
	...
	@Override
	public Class<QueryRmsCloudmeshSidecarlistResponse> getResponseClass() {
		return QueryRmsCloudmeshSidecarlistResponse.class;
	}
