...
import com.aliyuncs.sofa.transform.v20190815.UpdateLinkeLinktTagResponseUnmarshaller;
 ...
 * @version 
 */
public class UpdateLinkeLinktTagResponse extends AcsResponse {
	...
	@Override
	public UpdateLinkeLinktTagResponse getInstance(UnmarshallerContext context) {
		return	UpdateLinkeLinktTagResponseUnmarshaller.unmarshall(this, context);
	}
