...
import com.aliyuncs.sofa.transform.v20190815.GetLinkeBahamutAppsbyrepoResponseUnmarshaller;
 ...
 * @version 
 */
public class GetLinkeBahamutAppsbyrepoResponse extends AcsResponse {
	...
	@Override
	public GetLinkeBahamutAppsbyrepoResponse getInstance(UnmarshallerContext context) {
		return	GetLinkeBahamutAppsbyrepoResponseUnmarshaller.unmarshall(this, context);
	}
