 ...
 * @version 
 */
public class QueryLinkeantcodeAntcodeTesthookRequest extends RpcAcsRequest<QueryLinkeantcodeAntcodeTesthookResponse> {
	...
	@Override
	public Class<QueryLinkeantcodeAntcodeTesthookResponse> getResponseClass() {
		return QueryLinkeantcodeAntcodeTesthookResponse.class;
	}
