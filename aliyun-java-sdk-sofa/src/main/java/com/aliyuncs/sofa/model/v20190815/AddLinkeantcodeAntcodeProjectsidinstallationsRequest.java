 ...
 * @version 
 */
public class AddLinkeantcodeAntcodeProjectsidinstallationsRequest extends RpcAcsRequest<AddLinkeantcodeAntcodeProjectsidinstallationsResponse> {
	...
	@Override
	public Class<AddLinkeantcodeAntcodeProjectsidinstallationsResponse> getResponseClass() {
		return AddLinkeantcodeAntcodeProjectsidinstallationsResponse.class;
	}
