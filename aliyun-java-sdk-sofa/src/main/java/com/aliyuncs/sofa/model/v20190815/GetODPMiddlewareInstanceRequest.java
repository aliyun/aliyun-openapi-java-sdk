 ...
 * @version 
 */
public class GetODPMiddlewareInstanceRequest extends RpcAcsRequest<GetODPMiddlewareInstanceResponse> {
	...
	public GetODPMiddlewareInstanceRequest() {
		super("SOFA", "2019-08-15", "GetODPMiddlewareInstance", "ApplySidecarCert");
	...
	@Override
	public Class<GetODPMiddlewareInstanceResponse> getResponseClass() {
		return GetODPMiddlewareInstanceResponse.class;
	}
