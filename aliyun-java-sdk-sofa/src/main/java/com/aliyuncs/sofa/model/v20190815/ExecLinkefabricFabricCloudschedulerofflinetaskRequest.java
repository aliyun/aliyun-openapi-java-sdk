 ...
 * @version 
 */
public class ExecLinkefabricFabricCloudschedulerofflinetaskRequest extends RpcAcsRequest<ExecLinkefabricFabricCloudschedulerofflinetaskResponse> {
	...
	@Override
	public Class<ExecLinkefabricFabricCloudschedulerofflinetaskResponse> getResponseClass() {
		return ExecLinkefabricFabricCloudschedulerofflinetaskResponse.class;
	}
