 ...
 * @version 
 */
public class QueryLinkeantcodeAntcodeAddhookRequest extends RpcAcsRequest<QueryLinkeantcodeAntcodeAddhookResponse> {
	...
	@Override
	public Class<QueryLinkeantcodeAntcodeAddhookResponse> getResponseClass() {
		return QueryLinkeantcodeAntcodeAddhookResponse.class;
	}
