 ...
 * @version 
 */
public class QueryLinkefabricFabricCloudmsgtypeinfoRequest extends RpcAcsRequest<QueryLinkefabricFabricCloudmsgtypeinfoResponse> {
	...
	@Override
	public Class<QueryLinkefabricFabricCloudmsgtypeinfoResponse> getResponseClass() {
		return QueryLinkefabricFabricCloudmsgtypeinfoResponse.class;
	}
