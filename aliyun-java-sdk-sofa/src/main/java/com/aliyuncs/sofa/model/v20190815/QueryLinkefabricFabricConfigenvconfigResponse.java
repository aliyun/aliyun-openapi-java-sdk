...
import com.aliyuncs.sofa.transform.v20190815.QueryLinkefabricFabricConfigenvconfigResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryLinkefabricFabricConfigenvconfigResponse extends AcsResponse {
	...
	@Override
	public QueryLinkefabricFabricConfigenvconfigResponse getInstance(UnmarshallerContext context) {
		return	QueryLinkefabricFabricConfigenvconfigResponseUnmarshaller.unmarshall(this, context);
	}
