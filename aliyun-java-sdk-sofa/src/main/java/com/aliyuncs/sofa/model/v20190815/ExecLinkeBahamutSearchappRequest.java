 ...
 * @version 
 */
public class ExecLinkeBahamutSearchappRequest extends RpcAcsRequest<ExecLinkeBahamutSearchappResponse> {
	...
	@Override
	public Class<ExecLinkeBahamutSearchappResponse> getResponseClass() {
		return ExecLinkeBahamutSearchappResponse.class;
	}
