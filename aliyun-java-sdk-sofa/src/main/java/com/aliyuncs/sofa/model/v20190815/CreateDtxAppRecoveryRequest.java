 ...
 * @version 
 */
public class CreateDtxAppRecoveryRequest extends RpcAcsRequest<CreateDtxAppRecoveryResponse> {
	...
	public CreateDtxAppRecoveryRequest() {
		super("SOFA", "2019-08-15", "CreateDtxAppRecovery", "sofacafedeps");
	...
	@Override
	public Class<CreateDtxAppRecoveryResponse> getResponseClass() {
		return CreateDtxAppRecoveryResponse.class;
	}
