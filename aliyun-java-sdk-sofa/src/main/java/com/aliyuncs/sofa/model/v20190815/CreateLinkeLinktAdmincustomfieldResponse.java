...
import com.aliyuncs.sofa.transform.v20190815.CreateLinkeLinktAdmincustomfieldResponseUnmarshaller;
 ...
 * @version 
 */
public class CreateLinkeLinktAdmincustomfieldResponse extends AcsResponse {
	...
	@Override
	public CreateLinkeLinktAdmincustomfieldResponse getInstance(UnmarshallerContext context) {
		return	CreateLinkeLinktAdmincustomfieldResponseUnmarshaller.unmarshall(this, context);
	}
