...
import com.aliyuncs.sofa.transform.v20190815.BatchqueryODPJobsSqlbatchResponseUnmarshaller;
 ...
 * @version 
 */
public class BatchqueryODPJobsSqlbatchResponse extends AcsResponse {
	...
	@Override
	public BatchqueryODPJobsSqlbatchResponse getInstance(UnmarshallerContext context) {
		return	BatchqueryODPJobsSqlbatchResponseUnmarshaller.unmarshall(this, context);
	}
