 ...
 * @version 
 */
public class AddMsSgDowngradesRequest extends RpcAcsRequest<AddMsSgDowngradesResponse> {
	...
	public AddMsSgDowngradesRequest() {
		super("SOFA", "2019-08-15", "AddMsSgDowngrades", "sofacafedeps");
	...
	@Override
	public Class<AddMsSgDowngradesResponse> getResponseClass() {
		return AddMsSgDowngradesResponse.class;
	}
