 ...
 * @version 
 */
public class RemoveLinkeBahamutIterationremovememberRequest extends RpcAcsRequest<RemoveLinkeBahamutIterationremovememberResponse> {
	...
	public RemoveLinkeBahamutIterationremovememberRequest() {
		super("SOFA", "2019-08-15", "RemoveLinkeBahamutIterationremovemember", "sofa");
	...
	@Override
	public Class<RemoveLinkeBahamutIterationremovememberResponse> getResponseClass() {
		return RemoveLinkeBahamutIterationremovememberResponse.class;
	}
