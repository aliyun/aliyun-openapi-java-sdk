 ...
 * @version 
 */
public class QueryLinkeLinktIterationRequest extends RpcAcsRequest<QueryLinkeLinktIterationResponse> {
	...
	@Override
	public Class<QueryLinkeLinktIterationResponse> getResponseClass() {
		return QueryLinkeLinktIterationResponse.class;
	}
