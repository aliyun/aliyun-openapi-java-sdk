 ...
 * @version 
 */
public class CreateODPSchemasInterceptorsRequest extends RpcAcsRequest<CreateODPSchemasInterceptorsResponse> {
	...
	@Override
	public Class<CreateODPSchemasInterceptorsResponse> getResponseClass() {
		return CreateODPSchemasInterceptorsResponse.class;
	}
