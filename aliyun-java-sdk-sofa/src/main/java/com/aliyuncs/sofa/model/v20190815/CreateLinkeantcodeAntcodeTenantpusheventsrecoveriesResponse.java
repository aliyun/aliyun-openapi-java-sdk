...
import com.aliyuncs.sofa.transform.v20190815.CreateLinkeantcodeAntcodeTenantpusheventsrecoveriesResponseUnmarshaller;
 ...
 * @version 
 */
public class CreateLinkeantcodeAntcodeTenantpusheventsrecoveriesResponse extends AcsResponse {
	...
	@Override
	public CreateLinkeantcodeAntcodeTenantpusheventsrecoveriesResponse getInstance(UnmarshallerContext context) {
		return	CreateLinkeantcodeAntcodeTenantpusheventsrecoveriesResponseUnmarshaller.unmarshall(this, context);
	}
