 ...
 * @version 
 */
public class ExecLinkefabricFabricPostdrmofflinetaskRequest extends RpcAcsRequest<ExecLinkefabricFabricPostdrmofflinetaskResponse> {
	...
	@Override
	public Class<ExecLinkefabricFabricPostdrmofflinetaskResponse> getResponseClass() {
		return ExecLinkefabricFabricPostdrmofflinetaskResponse.class;
	}
