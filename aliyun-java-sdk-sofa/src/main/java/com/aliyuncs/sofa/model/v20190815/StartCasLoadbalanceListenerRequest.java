 ...
 * @version 
 */
public class StartCasLoadbalanceListenerRequest extends RpcAcsRequest<StartCasLoadbalanceListenerResponse> {
	...
	@Override
	public Class<StartCasLoadbalanceListenerResponse> getResponseClass() {
		return StartCasLoadbalanceListenerResponse.class;
	}
