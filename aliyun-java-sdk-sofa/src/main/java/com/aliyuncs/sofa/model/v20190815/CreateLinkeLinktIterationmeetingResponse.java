...
import com.aliyuncs.sofa.transform.v20190815.CreateLinkeLinktIterationmeetingResponseUnmarshaller;
 ...
 * @version 
 */
public class CreateLinkeLinktIterationmeetingResponse extends AcsResponse {
	...
	@Override
	public CreateLinkeLinktIterationmeetingResponse getInstance(UnmarshallerContext context) {
		return	CreateLinkeLinktIterationmeetingResponseUnmarshaller.unmarshall(this, context);
	}
