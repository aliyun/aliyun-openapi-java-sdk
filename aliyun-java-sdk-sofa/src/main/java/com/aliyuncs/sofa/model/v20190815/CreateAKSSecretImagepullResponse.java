...
import com.aliyuncs.sofa.transform.v20190815.CreateAKSSecretImagepullResponseUnmarshaller;
 ...
 * @version 
 */
public class CreateAKSSecretImagepullResponse extends AcsResponse {
	...
	@Override
	public CreateAKSSecretImagepullResponse getInstance(UnmarshallerContext context) {
		return	CreateAKSSecretImagepullResponseUnmarshaller.unmarshall(this, context);
	}
