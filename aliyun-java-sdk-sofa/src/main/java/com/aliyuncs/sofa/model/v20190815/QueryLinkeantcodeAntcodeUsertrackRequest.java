 ...
 * @version 
 */
public class QueryLinkeantcodeAntcodeUsertrackRequest extends RpcAcsRequest<QueryLinkeantcodeAntcodeUsertrackResponse> {
	...
	public void setTrackJsonStr(String trackJsonStr) {
		this.trackJsonStr = trackJsonStr;
		if(trackJsonStr != null){
			putBodyParameter("TrackJsonStr", trackJsonStr);
		}
	}

	@Override
	public Class<QueryLinkeantcodeAntcodeUsertrackResponse> getResponseClass() {
		return QueryLinkeantcodeAntcodeUsertrackResponse.class;
	}
