 ...
 * @version 
 */
public class UpdateLinkeantcodeAntcodeTenantserviceRequest extends RpcAcsRequest<UpdateLinkeantcodeAntcodeTenantserviceResponse> {
	...
	public UpdateLinkeantcodeAntcodeTenantserviceRequest() {
		super("SOFA", "2019-08-15", "UpdateLinkeantcodeAntcodeTenantservice", "sofacafedeps");
	...
	@Override
	public Class<UpdateLinkeantcodeAntcodeTenantserviceResponse> getResponseClass() {
		return UpdateLinkeantcodeAntcodeTenantserviceResponse.class;
	}
