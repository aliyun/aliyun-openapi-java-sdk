 ...
 * @version 
 */
public class DeleteClriskSubscriberRequest extends RpcAcsRequest<DeleteClriskSubscriberResponse> {
	...
	@Override
	public Class<DeleteClriskSubscriberResponse> getResponseClass() {
		return DeleteClriskSubscriberResponse.class;
	}
