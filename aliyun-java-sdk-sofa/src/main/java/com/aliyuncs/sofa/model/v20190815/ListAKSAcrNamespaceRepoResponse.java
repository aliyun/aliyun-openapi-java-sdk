...
import com.aliyuncs.sofa.transform.v20190815.ListAKSAcrNamespaceRepoResponseUnmarshaller;
 ...
 * @version 
 */
public class ListAKSAcrNamespaceRepoResponse extends AcsResponse {
	...
	@Override
	public ListAKSAcrNamespaceRepoResponse getInstance(UnmarshallerContext context) {
		return	ListAKSAcrNamespaceRepoResponseUnmarshaller.unmarshall(this, context);
	}
