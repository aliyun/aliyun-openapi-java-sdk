 ...
 * @version 
 */
public class DeleteLinkeantcodeAntcodeGroupsRequest extends RpcAcsRequest<DeleteLinkeantcodeAntcodeGroupsResponse> {
	...
	@Override
	public Class<DeleteLinkeantcodeAntcodeGroupsResponse> getResponseClass() {
		return DeleteLinkeantcodeAntcodeGroupsResponse.class;
	}
