 ...
 * @version 
 */
public class OnlineODPSchemasRequest extends RpcAcsRequest<OnlineODPSchemasResponse> {
	...
	public OnlineODPSchemasRequest() {
		super("SOFA", "2019-08-15", "OnlineODPSchemas", "ApplySidecarCert");
	...
	@Override
	public Class<OnlineODPSchemasResponse> getResponseClass() {
		return OnlineODPSchemasResponse.class;
	}
