 ...
 * @version 
 */
public class DeleteLinkeBahamutVcsmrcommentRequest extends RpcAcsRequest<DeleteLinkeBahamutVcsmrcommentResponse> {
	...
	@Override
	public Class<DeleteLinkeBahamutVcsmrcommentResponse> getResponseClass() {
		return DeleteLinkeBahamutVcsmrcommentResponse.class;
	}
