...
import com.aliyuncs.sofa.transform.v20190815.QueryTSTriggerInstancesResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryTSTriggerInstancesResponse extends AcsResponse {
	...
	@Override
	public QueryTSTriggerInstancesResponse getInstance(UnmarshallerContext context) {
		return	QueryTSTriggerInstancesResponseUnmarshaller.unmarshall(this, context);
	}
