 ...
 * @version 
 */
public class AddLinkeBahamutIterationaddmemberRequest extends RpcAcsRequest<AddLinkeBahamutIterationaddmemberResponse> {
	...
	public AddLinkeBahamutIterationaddmemberRequest() {
		super("SOFA", "2019-08-15", "AddLinkeBahamutIterationaddmember", "sofacaferms");
	...
	@Override
	public Class<AddLinkeBahamutIterationaddmemberResponse> getResponseClass() {
		return AddLinkeBahamutIterationaddmemberResponse.class;
	}
