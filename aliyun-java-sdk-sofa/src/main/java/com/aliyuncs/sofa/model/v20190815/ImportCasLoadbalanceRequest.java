 ...
 * @version 
 */
public class ImportCasLoadbalanceRequest extends RpcAcsRequest<ImportCasLoadbalanceResponse> {
	...
	@Override
	public Class<ImportCasLoadbalanceResponse> getResponseClass() {
		return ImportCasLoadbalanceResponse.class;
	}
