...
import com.aliyuncs.sofa.transform.v20190815.QueryODPDbnodesResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryODPDbnodesResponse extends AcsResponse {
	...
	@Override
	public QueryODPDbnodesResponse getInstance(UnmarshallerContext context) {
		return	QueryODPDbnodesResponseUnmarshaller.unmarshall(this, context);
	}
