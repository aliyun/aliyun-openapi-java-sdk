 ...
 * @version 
 */
public class QueryODPInstancesMachinesRequest extends RpcAcsRequest<QueryODPInstancesMachinesResponse> {
	...
	public QueryODPInstancesMachinesRequest() {
		super("SOFA", "2019-08-15", "QueryODPInstancesMachines", "ApplySidecarCert");
	...
	@Override
	public Class<QueryODPInstancesMachinesResponse> getResponseClass() {
		return QueryODPInstancesMachinesResponse.class;
	}
