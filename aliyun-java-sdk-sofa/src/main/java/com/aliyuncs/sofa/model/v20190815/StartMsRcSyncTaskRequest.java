 ...
 * @version 
 */
public class StartMsRcSyncTaskRequest extends RpcAcsRequest<StartMsRcSyncTaskResponse> {
	...
	public StartMsRcSyncTaskRequest() {
		super("SOFA", "2019-08-15", "StartMsRcSyncTask", "sofacafedeps");
	...
	@Override
	public Class<StartMsRcSyncTaskResponse> getResponseClass() {
		return StartMsRcSyncTaskResponse.class;
	}
