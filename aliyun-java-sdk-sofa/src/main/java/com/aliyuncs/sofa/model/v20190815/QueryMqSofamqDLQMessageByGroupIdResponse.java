...
import com.aliyuncs.sofa.transform.v20190815.QueryMqSofamqDLQMessageByGroupIdResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryMqSofamqDLQMessageByGroupIdResponse extends AcsResponse {
	...
	@Override
	public QueryMqSofamqDLQMessageByGroupIdResponse getInstance(UnmarshallerContext context) {
		return	QueryMqSofamqDLQMessageByGroupIdResponseUnmarshaller.unmarshall(this, context);
	}
