 ...
 * @version 
 */
public class QueryLinkefabricFabricConfigdisableexecuteRequest extends RpcAcsRequest<QueryLinkefabricFabricConfigdisableexecuteResponse> {
	...
	public QueryLinkefabricFabricConfigdisableexecuteRequest() {
		super("SOFA", "2019-08-15", "QueryLinkefabricFabricConfigdisableexecute", "sofacafedeps");
	...
	@Override
	public Class<QueryLinkefabricFabricConfigdisableexecuteResponse> getResponseClass() {
		return QueryLinkefabricFabricConfigdisableexecuteResponse.class;
	}
