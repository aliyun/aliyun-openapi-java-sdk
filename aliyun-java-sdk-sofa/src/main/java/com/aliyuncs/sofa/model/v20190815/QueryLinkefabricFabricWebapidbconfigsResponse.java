...
import com.aliyuncs.sofa.transform.v20190815.QueryLinkefabricFabricWebapidbconfigsResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryLinkefabricFabricWebapidbconfigsResponse extends AcsResponse {
	...
	@Override
	public QueryLinkefabricFabricWebapidbconfigsResponse getInstance(UnmarshallerContext context) {
		return	QueryLinkefabricFabricWebapidbconfigsResponseUnmarshaller.unmarshall(this, context);
	}
