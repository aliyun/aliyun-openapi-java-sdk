 ...
 * @version 
 */
public class CheckLinkefabricFabricReleasepaascheckwithappRequest extends RpcAcsRequest<CheckLinkefabricFabricReleasepaascheckwithappResponse> {
	...
	public CheckLinkefabricFabricReleasepaascheckwithappRequest() {
		super("SOFA", "2019-08-15", "CheckLinkefabricFabricReleasepaascheckwithapp", "sofacafedeps");
	...
	@Override
	public Class<CheckLinkefabricFabricReleasepaascheckwithappResponse> getResponseClass() {
		return CheckLinkefabricFabricReleasepaascheckwithappResponse.class;
	}
