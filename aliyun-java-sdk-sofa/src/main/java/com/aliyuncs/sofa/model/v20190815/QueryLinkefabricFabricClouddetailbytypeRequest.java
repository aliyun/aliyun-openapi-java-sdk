 ...
 * @version 
 */
public class QueryLinkefabricFabricClouddetailbytypeRequest extends RpcAcsRequest<QueryLinkefabricFabricClouddetailbytypeResponse> {
	...
	public QueryLinkefabricFabricClouddetailbytypeRequest() {
		super("SOFA", "2019-08-15", "QueryLinkefabricFabricClouddetailbytype", "sofacafedeps");
	...
	@Override
	public Class<QueryLinkefabricFabricClouddetailbytypeResponse> getResponseClass() {
		return QueryLinkefabricFabricClouddetailbytypeResponse.class;
	}
