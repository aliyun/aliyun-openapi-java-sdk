 ...
 * @version 
 */
public class ExecLinkefabricFabricMsgconfigtaskRequest extends RpcAcsRequest<ExecLinkefabricFabricMsgconfigtaskResponse> {
	...
	public ExecLinkefabricFabricMsgconfigtaskRequest() {
		super("SOFA", "2019-08-15", "ExecLinkefabricFabricMsgconfigtask", "sofacafedeps");
	...
	@Override
	public Class<ExecLinkefabricFabricMsgconfigtaskResponse> getResponseClass() {
		return ExecLinkefabricFabricMsgconfigtaskResponse.class;
	}
