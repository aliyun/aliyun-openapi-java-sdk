 ...
 * @version 
 */
public class QueryLinkefabricFabricMsgbinginginfoRequest extends RpcAcsRequest<QueryLinkefabricFabricMsgbinginginfoResponse> {
	...
	public QueryLinkefabricFabricMsgbinginginfoRequest() {
		super("SOFA", "2019-08-15", "QueryLinkefabricFabricMsgbinginginfo", "sofacafedeps");
	...
	@Override
	public Class<QueryLinkefabricFabricMsgbinginginfoResponse> getResponseClass() {
		return QueryLinkefabricFabricMsgbinginginfoResponse.class;
	}
