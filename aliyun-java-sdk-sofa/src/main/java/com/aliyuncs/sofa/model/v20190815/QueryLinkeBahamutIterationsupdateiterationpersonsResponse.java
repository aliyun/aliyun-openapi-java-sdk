...
import com.aliyuncs.sofa.transform.v20190815.QueryLinkeBahamutIterationsupdateiterationpersonsResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryLinkeBahamutIterationsupdateiterationpersonsResponse extends AcsResponse {
	...
	@Override
	public QueryLinkeBahamutIterationsupdateiterationpersonsResponse getInstance(UnmarshallerContext context) {
		return	QueryLinkeBahamutIterationsupdateiterationpersonsResponseUnmarshaller.unmarshall(this, context);
	}
