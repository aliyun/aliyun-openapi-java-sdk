 ...
 * @version 
 */
public class OnlineBuildpackRequest extends RpcAcsRequest<OnlineBuildpackResponse> {
	   

	private List<String> idRepeatLists;
	public OnlineBuildpackRequest() {
		super("SOFA", "2019-08-15", "OnlineBuildpack", "ApplySidecarCert");
	...
	@Override
	public Class<OnlineBuildpackResponse> getResponseClass() {
		return OnlineBuildpackResponse.class;
	}
