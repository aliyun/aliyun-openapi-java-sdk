 ...
 * @version 
 */
public class DeleteLinkeBahamutAdminuserroleRequest extends RpcAcsRequest<DeleteLinkeBahamutAdminuserroleResponse> {
	...
	@Override
	public Class<DeleteLinkeBahamutAdminuserroleResponse> getResponseClass() {
		return DeleteLinkeBahamutAdminuserroleResponse.class;
	}
