 ...
 * @version 
 */
public class CheckLinkeLinktDeleteworkflowstatusRequest extends RpcAcsRequest<CheckLinkeLinktDeleteworkflowstatusResponse> {
	...
	public CheckLinkeLinktDeleteworkflowstatusRequest() {
		super("SOFA", "2019-08-15", "CheckLinkeLinktDeleteworkflowstatus", "ApplySidecarCert");
	...
	@Override
	public Class<CheckLinkeLinktDeleteworkflowstatusResponse> getResponseClass() {
		return CheckLinkeLinktDeleteworkflowstatusResponse.class;
	}
