...
import com.aliyuncs.sofa.transform.v20190815.CreateLinkeLinktCustomfieldResponseUnmarshaller;
 ...
 * @version 
 */
public class CreateLinkeLinktCustomfieldResponse extends AcsResponse {
	...
	@Override
	public CreateLinkeLinktCustomfieldResponse getInstance(UnmarshallerContext context) {
		return	CreateLinkeLinktCustomfieldResponseUnmarshaller.unmarshall(this, context);
	}
