...
import com.aliyuncs.sofa.transform.v20190815.GetLinkeBahamutDeprecateddeprecatedgetallattachableResponseUnmarshaller;
 ...
 * @version 
 */
public class GetLinkeBahamutDeprecateddeprecatedgetallattachableResponse extends AcsResponse {
	...
	@Override
	public GetLinkeBahamutDeprecateddeprecatedgetallattachableResponse getInstance(UnmarshallerContext context) {
		return	GetLinkeBahamutDeprecateddeprecatedgetallattachableResponseUnmarshaller.unmarshall(this, context);
	}
