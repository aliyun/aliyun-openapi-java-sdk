...
public class GetLinkeBahamutArchdomainRequest extends RpcAcsRequest<GetLinkeBahamutArchdomainResponse> {
	...
	public GetLinkeBahamutArchdomainRequest() {
		super("SOFA", "2019-08-15", "GetLinkeBahamutArchdomain", "sofacafedeps");
	...
	@Override
	public Class<GetLinkeBahamutArchdomainResponse> getResponseClass() {
		return GetLinkeBahamutArchdomainResponse.class;
	}
