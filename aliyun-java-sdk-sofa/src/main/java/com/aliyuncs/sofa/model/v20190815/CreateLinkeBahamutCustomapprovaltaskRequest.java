 ...
 * @version 
 */
public class CreateLinkeBahamutCustomapprovaltaskRequest extends RpcAcsRequest<CreateLinkeBahamutCustomapprovaltaskResponse> {
	...
	@Override
	public Class<CreateLinkeBahamutCustomapprovaltaskResponse> getResponseClass() {
		return CreateLinkeBahamutCustomapprovaltaskResponse.class;
	}
