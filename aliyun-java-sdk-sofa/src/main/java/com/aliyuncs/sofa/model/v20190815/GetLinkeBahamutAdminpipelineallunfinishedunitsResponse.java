...
import com.aliyuncs.sofa.transform.v20190815.GetLinkeBahamutAdminpipelineallunfinishedunitsResponseUnmarshaller;
 ...
 * @version 
 */
public class GetLinkeBahamutAdminpipelineallunfinishedunitsResponse extends AcsResponse {
	...
	@Override
	public GetLinkeBahamutAdminpipelineallunfinishedunitsResponse getInstance(UnmarshallerContext context) {
		return	GetLinkeBahamutAdminpipelineallunfinishedunitsResponseUnmarshaller.unmarshall(this, context);
	}
