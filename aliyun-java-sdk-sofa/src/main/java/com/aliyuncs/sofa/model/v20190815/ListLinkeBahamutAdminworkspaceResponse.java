...
import com.aliyuncs.sofa.transform.v20190815.ListLinkeBahamutAdminworkspaceResponseUnmarshaller;
 ...
 * @version 
 */
public class ListLinkeBahamutAdminworkspaceResponse extends AcsResponse {
	...
	@Override
	public ListLinkeBahamutAdminworkspaceResponse getInstance(UnmarshallerContext context) {
		return	ListLinkeBahamutAdminworkspaceResponseUnmarshaller.unmarshall(this, context);
	}
