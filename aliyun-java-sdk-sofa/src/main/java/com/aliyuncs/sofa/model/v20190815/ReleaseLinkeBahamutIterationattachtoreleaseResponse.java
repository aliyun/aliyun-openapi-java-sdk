...
import com.aliyuncs.sofa.transform.v20190815.ReleaseLinkeBahamutIterationattachtoreleaseResponseUnmarshaller;
 ...
 * @version 
 */
public class ReleaseLinkeBahamutIterationattachtoreleaseResponse extends AcsResponse {
	...
	@Override
	public ReleaseLinkeBahamutIterationattachtoreleaseResponse getInstance(UnmarshallerContext context) {
		return	ReleaseLinkeBahamutIterationattachtoreleaseResponseUnmarshaller.unmarshall(this, context);
	}
