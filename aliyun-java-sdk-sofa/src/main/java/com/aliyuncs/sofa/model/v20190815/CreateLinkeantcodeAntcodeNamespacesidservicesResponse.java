...
import com.aliyuncs.sofa.transform.v20190815.CreateLinkeantcodeAntcodeNamespacesidservicesResponseUnmarshaller;
 ...
 * @version 
 */
public class CreateLinkeantcodeAntcodeNamespacesidservicesResponse extends AcsResponse {
	...
	@Override
	public CreateLinkeantcodeAntcodeNamespacesidservicesResponse getInstance(UnmarshallerContext context) {
		return	CreateLinkeantcodeAntcodeNamespacesidservicesResponseUnmarshaller.unmarshall(this, context);
	}
