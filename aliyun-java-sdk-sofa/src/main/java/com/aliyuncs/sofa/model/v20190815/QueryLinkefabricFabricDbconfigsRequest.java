 ...
 * @version 
 */
public class QueryLinkefabricFabricDbconfigsRequest extends RpcAcsRequest<QueryLinkefabricFabricDbconfigsResponse> {
	...
	public QueryLinkefabricFabricDbconfigsRequest() {
		super("SOFA", "2019-08-15", "QueryLinkefabricFabricDbconfigs", "sofacafedeps");
	...
	@Override
	public Class<QueryLinkefabricFabricDbconfigsResponse> getResponseClass() {
		return QueryLinkefabricFabricDbconfigsResponse.class;
	}
