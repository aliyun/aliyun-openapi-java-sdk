 ...
 * @version 
 */
public class CreateCASSlsProjectRequest extends RpcAcsRequest<CreateCASSlsProjectResponse> {
	...
	@Override
	public Class<CreateCASSlsProjectResponse> getResponseClass() {
		return CreateCASSlsProjectResponse.class;
	}
