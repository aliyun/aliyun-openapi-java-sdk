...
import com.aliyuncs.sofa.transform.v20190815.DeleteLinkeBahamutAppmoduleResponseUnmarshaller;
 ...
 * @version 
 */
public class DeleteLinkeBahamutAppmoduleResponse extends AcsResponse {
	...
	@Override
	public DeleteLinkeBahamutAppmoduleResponse getInstance(UnmarshallerContext context) {
		return	DeleteLinkeBahamutAppmoduleResponseUnmarshaller.unmarshall(this, context);
	}
