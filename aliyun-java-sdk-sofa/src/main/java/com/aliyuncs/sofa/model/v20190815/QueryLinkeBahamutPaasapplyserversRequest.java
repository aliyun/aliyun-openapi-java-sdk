 ...
 * @version 
 */
public class QueryLinkeBahamutPaasapplyserversRequest extends RpcAcsRequest<QueryLinkeBahamutPaasapplyserversResponse> {
	   

	private List<String> serversRepeatLists;

	private String iterationId;
	public QueryLinkeBahamutPaasapplyserversRequest() {
		super("SOFA", "2019-08-15", "QueryLinkeBahamutPaasapplyservers", "sofacafedeps");
	...
	@Override
	public Class<QueryLinkeBahamutPaasapplyserversResponse> getResponseClass() {
		return QueryLinkeBahamutPaasapplyserversResponse.class;
	}
