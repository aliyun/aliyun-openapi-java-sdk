 ...
 * @version 
 */
public class DeleteCASSlsConfigRequest extends RpcAcsRequest<DeleteCASSlsConfigResponse> {
	...
	@Override
	public Class<DeleteCASSlsConfigResponse> getResponseClass() {
		return DeleteCASSlsConfigResponse.class;
	}
