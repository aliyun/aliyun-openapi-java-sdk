...
import com.aliyuncs.sofa.transform.v20190815.StartLinkelinkflowLinkflowProcessResponseUnmarshaller;
 ...
 * @version 
 */
public class StartLinkelinkflowLinkflowProcessResponse extends AcsResponse {
	...
	@Override
	public StartLinkelinkflowLinkflowProcessResponse getInstance(UnmarshallerContext context) {
		return	StartLinkelinkflowLinkflowProcessResponseUnmarshaller.unmarshall(this, context);
	}
