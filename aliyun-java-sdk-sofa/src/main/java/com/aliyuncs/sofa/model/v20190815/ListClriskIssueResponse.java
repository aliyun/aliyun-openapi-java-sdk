...
import com.aliyuncs.sofa.transform.v20190815.ListClriskIssueResponseUnmarshaller;
 ...
 * @version 
 */
public class ListClriskIssueResponse extends AcsResponse {
	...
	@Override
	public ListClriskIssueResponse getInstance(UnmarshallerContext context) {
		return	ListClriskIssueResponseUnmarshaller.unmarshall(this, context);
	}
