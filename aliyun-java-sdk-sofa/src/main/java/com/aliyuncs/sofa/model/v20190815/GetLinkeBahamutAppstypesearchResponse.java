...
import com.aliyuncs.sofa.transform.v20190815.GetLinkeBahamutAppstypesearchResponseUnmarshaller;
 ...
 * @version 
 */
public class GetLinkeBahamutAppstypesearchResponse extends AcsResponse {
	...
	@Override
	public GetLinkeBahamutAppstypesearchResponse getInstance(UnmarshallerContext context) {
		return	GetLinkeBahamutAppstypesearchResponseUnmarshaller.unmarshall(this, context);
	}
