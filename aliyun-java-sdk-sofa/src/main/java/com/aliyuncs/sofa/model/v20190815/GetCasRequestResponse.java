...
import com.aliyuncs.sofa.transform.v20190815.GetCasRequestResponseUnmarshaller;
 ...
 * @version 
 */
public class GetCasRequestResponse extends AcsResponse {
	...
	@Override
	public GetCasRequestResponse getInstance(UnmarshallerContext context) {
		return	GetCasRequestResponseUnmarshaller.unmarshall(this, context);
	}
