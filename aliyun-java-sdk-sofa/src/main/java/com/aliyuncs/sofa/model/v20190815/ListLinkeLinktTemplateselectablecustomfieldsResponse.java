...
import com.aliyuncs.sofa.transform.v20190815.ListLinkeLinktTemplateselectablecustomfieldsResponseUnmarshaller;
 ...
 * @version 
 */
public class ListLinkeLinktTemplateselectablecustomfieldsResponse extends AcsResponse {
	...
	@Override
	public ListLinkeLinktTemplateselectablecustomfieldsResponse getInstance(UnmarshallerContext context) {
		return	ListLinkeLinktTemplateselectablecustomfieldsResponseUnmarshaller.unmarshall(this, context);
	}
