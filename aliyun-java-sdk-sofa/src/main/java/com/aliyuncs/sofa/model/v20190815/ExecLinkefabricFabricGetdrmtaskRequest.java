 ...
 * @version 
 */
public class ExecLinkefabricFabricGetdrmtaskRequest extends RpcAcsRequest<ExecLinkefabricFabricGetdrmtaskResponse> {
	...
	public ExecLinkefabricFabricGetdrmtaskRequest() {
		super("SOFA", "2019-08-15", "ExecLinkefabricFabricGetdrmtask", "sofacafedeps");
	...
	@Override
	public Class<ExecLinkefabricFabricGetdrmtaskResponse> getResponseClass() {
		return ExecLinkefabricFabricGetdrmtaskResponse.class;
	}
