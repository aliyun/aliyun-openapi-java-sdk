...
import com.aliyuncs.sofa.transform.v20190815.QueryLinkefabricFabricMsgconfigResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryLinkefabricFabricMsgconfigResponse extends AcsResponse {
	...
	@Override
	public QueryLinkefabricFabricMsgconfigResponse getInstance(UnmarshallerContext context) {
		return	QueryLinkefabricFabricMsgconfigResponseUnmarshaller.unmarshall(this, context);
	}
