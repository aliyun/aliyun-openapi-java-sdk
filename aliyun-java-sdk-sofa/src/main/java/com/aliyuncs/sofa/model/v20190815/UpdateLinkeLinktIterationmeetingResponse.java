...
import com.aliyuncs.sofa.transform.v20190815.UpdateLinkeLinktIterationmeetingResponseUnmarshaller;
 ...
 * @version 
 */
public class UpdateLinkeLinktIterationmeetingResponse extends AcsResponse {
	...
	@Override
	public UpdateLinkeLinktIterationmeetingResponse getInstance(UnmarshallerContext context) {
		return	UpdateLinkeLinktIterationmeetingResponseUnmarshaller.unmarshall(this, context);
	}
