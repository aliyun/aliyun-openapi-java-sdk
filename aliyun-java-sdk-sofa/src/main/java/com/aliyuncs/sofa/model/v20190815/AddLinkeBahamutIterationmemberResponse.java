...
import com.aliyuncs.sofa.transform.v20190815.AddLinkeBahamutIterationmemberResponseUnmarshaller;
 ...
 * @version 
 */
public class AddLinkeBahamutIterationmemberResponse extends AcsResponse {
	...
	@Override
	public AddLinkeBahamutIterationmemberResponse getInstance(UnmarshallerContext context) {
		return	AddLinkeBahamutIterationmemberResponseUnmarshaller.unmarshall(this, context);
	}
