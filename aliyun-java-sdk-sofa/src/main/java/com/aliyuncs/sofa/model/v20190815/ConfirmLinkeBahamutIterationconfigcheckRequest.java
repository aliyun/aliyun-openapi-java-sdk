 ...
 * @version 
 */
public class ConfirmLinkeBahamutIterationconfigcheckRequest extends RpcAcsRequest<ConfirmLinkeBahamutIterationconfigcheckResponse> {
	...
	@Override
	public Class<ConfirmLinkeBahamutIterationconfigcheckResponse> getResponseClass() {
		return ConfirmLinkeBahamutIterationconfigcheckResponse.class;
	}
