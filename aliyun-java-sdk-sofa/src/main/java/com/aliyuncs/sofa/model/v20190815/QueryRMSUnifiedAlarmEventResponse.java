...
import com.aliyuncs.sofa.transform.v20190815.QueryRMSUnifiedAlarmEventResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryRMSUnifiedAlarmEventResponse extends AcsResponse {
	...
	private List<UnifiedAlarmEventListItem> unifiedAlarmEventList;
	...
	public List<UnifiedAlarmEventListItem> getUnifiedAlarmEventList() {
		return this.unifiedAlarmEventList;
	}

	public void setUnifiedAlarmEventList(List<UnifiedAlarmEventListItem> unifiedAlarmEventList) {
		this.unifiedAlarmEventList = unifiedAlarmEventList;
	}

	public static class UnifiedAlarmEventListItem {
		...
		private Long silenceRemainTime;
		...
		private List<AlarmHistoryListItem> alarmHistoryList;
		...
		public void setSilenceRemainTime(Long silenceRemainTime) {
		...
		public void setAlarmRecoverTime(String alarmRecoverTime) {
		...
		public List<AlarmHistoryListItem> getAlarmHistoryList() {
			return this.alarmHistoryList;
		}

		public void setAlarmHistoryList(List<AlarmHistoryListItem> alarmHistoryList) {
			this.alarmHistoryList = alarmHistoryList;
		}

		public static class AlarmHistoryListItem {
	...
	@Override
	public QueryRMSUnifiedAlarmEventResponse getInstance(UnmarshallerContext context) {
		return	QueryRMSUnifiedAlarmEventResponseUnmarshaller.unmarshall(this, context);
	}
