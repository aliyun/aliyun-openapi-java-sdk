 ...
 * @version 
 */
public class QueryRmsSubscriptionsRequest extends RpcAcsRequest<QueryRmsSubscriptionsResponse> {
	   

	private String envJsonStr;

	private String queryJsonStr;
	public QueryRmsSubscriptionsRequest() {
		super("SOFA", "2019-08-15", "QueryRmsSubscriptions", "ApplySidecarCert");
	...
	@Override
	public Class<QueryRmsSubscriptionsResponse> getResponseClass() {
		return QueryRmsSubscriptionsResponse.class;
	}
