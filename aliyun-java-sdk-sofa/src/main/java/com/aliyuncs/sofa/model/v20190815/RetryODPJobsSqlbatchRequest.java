 ...
 * @version 
 */
public class RetryODPJobsSqlbatchRequest extends RpcAcsRequest<RetryODPJobsSqlbatchResponse> {
	...
	public RetryODPJobsSqlbatchRequest() {
		super("SOFA", "2019-08-15", "RetryODPJobsSqlbatch", "ApplySidecarCert");
	...
	@Override
	public Class<RetryODPJobsSqlbatchResponse> getResponseClass() {
		return RetryODPJobsSqlbatchResponse.class;
	}
