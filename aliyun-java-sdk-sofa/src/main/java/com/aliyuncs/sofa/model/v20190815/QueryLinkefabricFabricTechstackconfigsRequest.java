 ...
 * @version 
 */
public class QueryLinkefabricFabricTechstackconfigsRequest extends RpcAcsRequest<QueryLinkefabricFabricTechstackconfigsResponse> {
	...
	public QueryLinkefabricFabricTechstackconfigsRequest() {
		super("SOFA", "2019-08-15", "QueryLinkefabricFabricTechstackconfigs", "sofacafedeps");
	...
	@Override
	public Class<QueryLinkefabricFabricTechstackconfigsResponse> getResponseClass() {
		return QueryLinkefabricFabricTechstackconfigsResponse.class;
	}
