...
import com.aliyuncs.aliyuncvc.transform.v20191030.GetStatisticResponseUnmarshaller;
 ...
 * @version 
 */
public class GetStatisticResponse extends AcsResponse {
	...
	@Override
	public GetStatisticResponse getInstance(UnmarshallerContext context) {
		return	GetStatisticResponseUnmarshaller.unmarshall(this, context);
	}
