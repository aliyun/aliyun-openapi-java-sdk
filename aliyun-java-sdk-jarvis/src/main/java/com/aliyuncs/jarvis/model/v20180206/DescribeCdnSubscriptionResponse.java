...
import com.aliyuncs.jarvis.transform.v20180206.DescribeCdnSubscriptionResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeCdnSubscriptionResponse extends AcsResponse {
	...
	@Override
	public DescribeCdnSubscriptionResponse getInstance(UnmarshallerContext context) {
		return	DescribeCdnSubscriptionResponseUnmarshaller.unmarshall(this, context);
	}
