 ...
 * @version 
 */
public class CreateConsoleAccessWhiteListRequest extends RpcAcsRequest<CreateConsoleAccessWhiteListResponse> {
	
	public CreateConsoleAccessWhiteListRequest() {
		super("jarvis", "2018-02-06", "CreateConsoleAccessWhiteList", "jarvis");
	}
	...
	@Override
	public Class<CreateConsoleAccessWhiteListResponse> getResponseClass() {
		return CreateConsoleAccessWhiteListResponse.class;
	}
