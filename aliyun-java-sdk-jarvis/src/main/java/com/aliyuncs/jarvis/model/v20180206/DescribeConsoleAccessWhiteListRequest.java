 ...
 * @version 
 */
public class DescribeConsoleAccessWhiteListRequest extends RpcAcsRequest<DescribeConsoleAccessWhiteListResponse> {
	
	public DescribeConsoleAccessWhiteListRequest() {
		super("jarvis", "2018-02-06", "DescribeConsoleAccessWhiteList", "jarvis");
	}
	...
	@Override
	public Class<DescribeConsoleAccessWhiteListResponse> getResponseClass() {
		return DescribeConsoleAccessWhiteListResponse.class;
	}
