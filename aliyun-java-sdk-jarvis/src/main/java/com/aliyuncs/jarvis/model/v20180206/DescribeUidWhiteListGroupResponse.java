...
import com.aliyuncs.jarvis.transform.v20180206.DescribeUidWhiteListGroupResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeUidWhiteListGroupResponse extends AcsResponse {
	...
	@Override
	public DescribeUidWhiteListGroupResponse getInstance(UnmarshallerContext context) {
		return	DescribeUidWhiteListGroupResponseUnmarshaller.unmarshall(this, context);
	}
