 ...
 * @version 
 */
public class CreateCdnSubscriptionRequest extends RpcAcsRequest<CreateCdnSubscriptionResponse> {
	
	public CreateCdnSubscriptionRequest() {
		super("jarvis", "2018-02-06", "CreateCdnSubscription", "jarvis");
	}
	...
	@Override
	public Class<CreateCdnSubscriptionResponse> getResponseClass() {
		return CreateCdnSubscriptionResponse.class;
	}
