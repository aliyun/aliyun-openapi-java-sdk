 ...
 * @version 
 */
public class DescribeABTestExperimentRequest extends RoaAcsRequest<DescribeABTestExperimentResponse> {
	...
	public DescribeABTestExperimentRequest() {
		super("OpenSearch", "2017-12-25", "DescribeABTestExperiment", "opensearch");
	...
	@Override
	public Class<DescribeABTestExperimentResponse> getResponseClass() {
		return DescribeABTestExperimentResponse.class;
	}
