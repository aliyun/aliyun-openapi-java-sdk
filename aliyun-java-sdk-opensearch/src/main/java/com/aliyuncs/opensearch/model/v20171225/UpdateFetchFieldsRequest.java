 ...
 * @version 
 */
public class UpdateFetchFieldsRequest extends RoaAcsRequest<UpdateFetchFieldsResponse> {
	...
	@Override
	public Class<UpdateFetchFieldsResponse> getResponseClass() {
		return UpdateFetchFieldsResponse.class;
	}
