 ...
 * @version 
 */
public class DeleteFunctionTaskRequest extends RoaAcsRequest<DeleteFunctionTaskResponse> {
	...
	public DeleteFunctionTaskRequest() {
		super("OpenSearch", "2017-12-25", "DeleteFunctionTask");
	...
	@Override
	public Class<DeleteFunctionTaskResponse> getResponseClass() {
		return DeleteFunctionTaskResponse.class;
	}
