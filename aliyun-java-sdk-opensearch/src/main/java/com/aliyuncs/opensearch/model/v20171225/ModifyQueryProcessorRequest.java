 ...
 * @version 
 */
public class ModifyQueryProcessorRequest extends RoaAcsRequest<ModifyQueryProcessorResponse> {
	...
	@Override
	public Class<ModifyQueryProcessorResponse> getResponseClass() {
		return ModifyQueryProcessorResponse.class;
	}
