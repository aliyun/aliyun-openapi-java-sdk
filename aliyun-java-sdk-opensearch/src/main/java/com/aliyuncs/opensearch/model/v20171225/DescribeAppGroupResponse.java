...
import com.aliyuncs.opensearch.transform.v20171225.DescribeAppGroupResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeAppGroupResponse extends AcsResponse {
	...
	@Override
	public DescribeAppGroupResponse getInstance(UnmarshallerContext context) {
		return	DescribeAppGroupResponseUnmarshaller.unmarshall(this, context);
	}
