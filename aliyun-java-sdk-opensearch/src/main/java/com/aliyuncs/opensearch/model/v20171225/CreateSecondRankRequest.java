 ...
 * @version 
 */
public class CreateSecondRankRequest extends RoaAcsRequest<CreateSecondRankResponse> {
	...
	@Override
	public Class<CreateSecondRankResponse> getResponseClass() {
		return CreateSecondRankResponse.class;
	}
