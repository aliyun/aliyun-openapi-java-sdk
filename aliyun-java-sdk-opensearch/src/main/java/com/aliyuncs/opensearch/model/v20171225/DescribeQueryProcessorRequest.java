 ...
 * @version 
 */
public class DescribeQueryProcessorRequest extends RoaAcsRequest<DescribeQueryProcessorResponse> {
	...
	@Override
	public Class<DescribeQueryProcessorResponse> getResponseClass() {
		return DescribeQueryProcessorResponse.class;
	}
