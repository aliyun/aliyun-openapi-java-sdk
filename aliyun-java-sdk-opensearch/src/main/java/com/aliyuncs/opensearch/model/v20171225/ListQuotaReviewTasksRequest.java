 ...
 * @version 
 */
public class ListQuotaReviewTasksRequest extends RoaAcsRequest<ListQuotaReviewTasksResponse> {
	...
	@Override
	public Class<ListQuotaReviewTasksResponse> getResponseClass() {
		return ListQuotaReviewTasksResponse.class;
	}
