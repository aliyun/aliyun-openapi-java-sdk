 ...
 * @version 
 */
public class RankPreviewQueryRequest extends RoaAcsRequest<RankPreviewQueryResponse> {
	...
	@Override
	public Class<RankPreviewQueryResponse> getResponseClass() {
		return RankPreviewQueryResponse.class;
	}
