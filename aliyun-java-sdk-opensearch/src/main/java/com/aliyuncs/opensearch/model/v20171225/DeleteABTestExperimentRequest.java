 ...
 * @version 
 */
public class DeleteABTestExperimentRequest extends RoaAcsRequest<DeleteABTestExperimentResponse> {
	...
	@Override
	public Class<DeleteABTestExperimentResponse> getResponseClass() {
		return DeleteABTestExperimentResponse.class;
	}
