...
public class DescribeQueryProcessorResponse extends AcsResponse {
	...
	@Override
	public DescribeQueryProcessorResponse getInstance(UnmarshallerContext context) {
		return	DescribeQueryProcessorResponseUnmarshaller.unmarshall(this, context);
	}
