 ...
 * @version 
 */
public class ListSlowQueryCategoriesRequest extends RoaAcsRequest<ListSlowQueryCategoriesResponse> {
	...
	@Override
	public Class<ListSlowQueryCategoriesResponse> getResponseClass() {
		return ListSlowQueryCategoriesResponse.class;
	}
