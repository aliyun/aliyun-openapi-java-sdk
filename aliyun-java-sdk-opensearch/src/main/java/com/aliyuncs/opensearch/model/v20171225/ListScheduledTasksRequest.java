 ...
 * @version 
 */
public class ListScheduledTasksRequest extends RoaAcsRequest<ListScheduledTasksResponse> {
	...
	@Override
	public Class<ListScheduledTasksResponse> getResponseClass() {
		return ListScheduledTasksResponse.class;
	}
