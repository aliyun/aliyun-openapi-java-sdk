 ...
 * @version 
 */
public class CreateABTestSceneRequest extends RoaAcsRequest<CreateABTestSceneResponse> {
	...
	@Override
	public Class<CreateABTestSceneResponse> getResponseClass() {
		return CreateABTestSceneResponse.class;
	}
