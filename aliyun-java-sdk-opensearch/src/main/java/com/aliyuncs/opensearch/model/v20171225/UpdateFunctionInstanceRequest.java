 ...
 * @version 
 */
public class UpdateFunctionInstanceRequest extends RoaAcsRequest<UpdateFunctionInstanceResponse> {
	...
	public UpdateFunctionInstanceRequest() {
		super("OpenSearch", "2017-12-25", "UpdateFunctionInstance");
	...
	@Override
	public Class<UpdateFunctionInstanceResponse> getResponseClass() {
		return UpdateFunctionInstanceResponse.class;
	}
