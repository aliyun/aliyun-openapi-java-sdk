 ...
 * @version 
 */
public class ReplaceAppGroupCommodityCodeRequest extends RoaAcsRequest<ReplaceAppGroupCommodityCodeResponse> {
	...
	@Override
	public Class<ReplaceAppGroupCommodityCodeResponse> getResponseClass() {
		return ReplaceAppGroupCommodityCodeResponse.class;
	}
