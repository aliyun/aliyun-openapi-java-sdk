 ...
 * @version 
 */
public class ModifyAppGroupQuotaRequest extends RoaAcsRequest<ModifyAppGroupQuotaResponse> {
	...
	@Override
	public Class<ModifyAppGroupQuotaResponse> getResponseClass() {
		return ModifyAppGroupQuotaResponse.class;
	}
