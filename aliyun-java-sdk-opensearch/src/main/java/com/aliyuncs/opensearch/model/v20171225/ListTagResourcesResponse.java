...
import com.aliyuncs.opensearch.transform.v20171225.ListTagResourcesResponseUnmarshaller;
...
public class ListTagResourcesResponse extends AcsResponse {
	...
	private List<TagResource> result;
	...
	public List<TagResource> getResult() {
		return this.result;
	}

	public void setResult(List<TagResource> result) {
		this.result = result;
	}
