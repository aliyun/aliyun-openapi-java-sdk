 ...
 * @version 
 */
public class RemoveAppGroupRequest extends RoaAcsRequest<RemoveAppGroupResponse> {
	...
	@Override
	public Class<RemoveAppGroupResponse> getResponseClass() {
		return RemoveAppGroupResponse.class;
	}
