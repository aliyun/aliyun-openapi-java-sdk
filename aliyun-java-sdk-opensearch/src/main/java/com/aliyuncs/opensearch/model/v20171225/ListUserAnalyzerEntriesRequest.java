 ...
 * @version 
 */
public class ListUserAnalyzerEntriesRequest extends RoaAcsRequest<ListUserAnalyzerEntriesResponse> {
	...
	@Override
	public Class<ListUserAnalyzerEntriesResponse> getResponseClass() {
		return ListUserAnalyzerEntriesResponse.class;
	}
