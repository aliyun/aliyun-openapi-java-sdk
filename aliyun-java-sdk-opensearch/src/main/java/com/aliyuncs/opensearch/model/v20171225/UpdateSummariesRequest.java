 ...
 * @version 
 */
public class UpdateSummariesRequest extends RoaAcsRequest<UpdateSummariesResponse> {
	...
	@Override
	public Class<UpdateSummariesResponse> getResponseClass() {
		return UpdateSummariesResponse.class;
	}
