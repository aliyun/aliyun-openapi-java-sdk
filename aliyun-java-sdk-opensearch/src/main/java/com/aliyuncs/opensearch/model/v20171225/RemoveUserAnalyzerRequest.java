 ...
 * @version 
 */
public class RemoveUserAnalyzerRequest extends RoaAcsRequest<RemoveUserAnalyzerResponse> {
	...
	@Override
	public Class<RemoveUserAnalyzerResponse> getResponseClass() {
		return RemoveUserAnalyzerResponse.class;
	}
