 ...
 * @version 
 */
public class DeleteSortScriptRequest extends RoaAcsRequest<DeleteSortScriptResponse> {
	...
	@Override
	public Class<DeleteSortScriptResponse> getResponseClass() {
		return DeleteSortScriptResponse.class;
	}
