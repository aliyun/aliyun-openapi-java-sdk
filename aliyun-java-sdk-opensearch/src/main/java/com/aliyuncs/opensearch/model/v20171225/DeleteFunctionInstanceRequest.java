 ...
 * @version 
 */
public class DeleteFunctionInstanceRequest extends RoaAcsRequest<DeleteFunctionInstanceResponse> {
	...
	public DeleteFunctionInstanceRequest() {
		super("OpenSearch", "2017-12-25", "DeleteFunctionInstance");
	...
	@Override
	public Class<DeleteFunctionInstanceResponse> getResponseClass() {
		return DeleteFunctionInstanceResponse.class;
	}
