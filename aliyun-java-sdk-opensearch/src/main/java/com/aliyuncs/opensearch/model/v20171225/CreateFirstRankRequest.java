 ...
 * @version 
 */
public class CreateFirstRankRequest extends RoaAcsRequest<CreateFirstRankResponse> {
	...
	@Override
	public Class<CreateFirstRankResponse> getResponseClass() {
		return CreateFirstRankResponse.class;
	}
