 ...
 * @version 
 */
public class GetScriptFileNamesRequest extends RoaAcsRequest<GetScriptFileNamesResponse> {
	...
	@Override
	public Class<GetScriptFileNamesResponse> getResponseClass() {
		return GetScriptFileNamesResponse.class;
	}
