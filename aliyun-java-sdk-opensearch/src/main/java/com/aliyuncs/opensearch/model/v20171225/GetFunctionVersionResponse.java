...
import com.aliyuncs.opensearch.transform.v20171225.GetFunctionVersionResponseUnmarshaller;
 ...
 * @version 
 */
public class GetFunctionVersionResponse extends AcsResponse {
	...
	@Override
	public GetFunctionVersionResponse getInstance(UnmarshallerContext context) {
		return	GetFunctionVersionResponseUnmarshaller.unmarshall(this, context);
	}
