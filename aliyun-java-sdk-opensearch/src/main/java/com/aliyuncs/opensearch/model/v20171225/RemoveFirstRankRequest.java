 ...
 * @version 
 */
public class RemoveFirstRankRequest extends RoaAcsRequest<RemoveFirstRankResponse> {
	...
	@Override
	public Class<RemoveFirstRankResponse> getResponseClass() {
		return RemoveFirstRankResponse.class;
	}
