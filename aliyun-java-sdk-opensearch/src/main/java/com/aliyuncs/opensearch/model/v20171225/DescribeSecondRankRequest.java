 ...
 * @version 
 */
public class DescribeSecondRankRequest extends RoaAcsRequest<DescribeSecondRankResponse> {
	...
	@Override
	public Class<DescribeSecondRankResponse> getResponseClass() {
		return DescribeSecondRankResponse.class;
	}
