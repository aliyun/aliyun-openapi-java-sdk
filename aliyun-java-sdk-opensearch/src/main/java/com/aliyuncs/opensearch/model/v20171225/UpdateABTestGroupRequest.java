 ...
 * @version 
 */
public class UpdateABTestGroupRequest extends RoaAcsRequest<UpdateABTestGroupResponse> {
	...
	@Override
	public Class<UpdateABTestGroupResponse> getResponseClass() {
		return UpdateABTestGroupResponse.class;
	}
