 ...
 * @version 
 */
public class GetDomainRequest extends RoaAcsRequest<GetDomainResponse> {
	...
	public void setAppGroupIdentity(String appGroupIdentity) {
		...
		if(appGroupIdentity != null){
			putQueryParameter("appGroupIdentity", appGroupIdentity);
		}
	}

	@Override
	public Class<GetDomainResponse> getResponseClass() {
		return GetDomainResponse.class;
	}
