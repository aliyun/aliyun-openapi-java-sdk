 ...
 * @version 
 */
public class DeleteABTestSceneRequest extends RoaAcsRequest<DeleteABTestSceneResponse> {
	...
	@Override
	public Class<DeleteABTestSceneResponse> getResponseClass() {
		return DeleteABTestSceneResponse.class;
	}
