 ...
 * @version 
 */
public class ModifyFirstRankRequest extends RoaAcsRequest<ModifyFirstRankResponse> {
	...
	@Override
	public Class<ModifyFirstRankResponse> getResponseClass() {
		return ModifyFirstRankResponse.class;
	}
