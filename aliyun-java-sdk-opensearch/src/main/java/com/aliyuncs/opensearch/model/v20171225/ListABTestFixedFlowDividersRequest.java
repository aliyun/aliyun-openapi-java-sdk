 ...
 * @version 
 */
public class ListABTestFixedFlowDividersRequest extends RoaAcsRequest<ListABTestFixedFlowDividersResponse> {
	...
	@Override
	public Class<ListABTestFixedFlowDividersResponse> getResponseClass() {
		return ListABTestFixedFlowDividersResponse.class;
	}
