 ...
 * @version 
 */
public class ListSortScriptsRequest extends RoaAcsRequest<ListSortScriptsResponse> {
	...
	@Override
	public Class<ListSortScriptsResponse> getResponseClass() {
		return ListSortScriptsResponse.class;
	}
