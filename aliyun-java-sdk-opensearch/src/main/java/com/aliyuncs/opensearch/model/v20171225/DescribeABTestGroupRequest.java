 ...
 * @version 
 */
public class DescribeABTestGroupRequest extends RoaAcsRequest<DescribeABTestGroupResponse> {
	...
	@Override
	public Class<DescribeABTestGroupResponse> getResponseClass() {
		return DescribeABTestGroupResponse.class;
	}
