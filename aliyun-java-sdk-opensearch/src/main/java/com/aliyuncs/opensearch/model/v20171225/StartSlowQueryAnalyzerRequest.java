 ...
 * @version 
 */
public class StartSlowQueryAnalyzerRequest extends RoaAcsRequest<StartSlowQueryAnalyzerResponse> {
	...
	@Override
	public Class<StartSlowQueryAnalyzerResponse> getResponseClass() {
		return StartSlowQueryAnalyzerResponse.class;
	}
