 ...
 * @version 
 */
public class ListFunctionInstancesRequest extends RoaAcsRequest<ListFunctionInstancesResponse> {
	...
	public ListFunctionInstancesRequest() {
		super("OpenSearch", "2017-12-25", "ListFunctionInstances");
	...
	@Override
	public Class<ListFunctionInstancesResponse> getResponseClass() {
		return ListFunctionInstancesResponse.class;
	}
