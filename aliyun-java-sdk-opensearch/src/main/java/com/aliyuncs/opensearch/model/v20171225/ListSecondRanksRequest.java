 ...
 * @version 
 */
public class ListSecondRanksRequest extends RoaAcsRequest<ListSecondRanksResponse> {
	...
	@Override
	public Class<ListSecondRanksResponse> getResponseClass() {
		return ListSecondRanksResponse.class;
	}
