 ...
 * @version 
 */
public class SaveSortScriptFileRequest extends RoaAcsRequest<SaveSortScriptFileResponse> {
	...
	@Override
	public Class<SaveSortScriptFileResponse> getResponseClass() {
		return SaveSortScriptFileResponse.class;
	}
