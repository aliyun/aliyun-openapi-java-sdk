 ...
 * @version 
 */
public class RemoveQueryProcessorRequest extends RoaAcsRequest<RemoveQueryProcessorResponse> {
	...
	@Override
	public Class<RemoveQueryProcessorResponse> getResponseClass() {
		return RemoveQueryProcessorResponse.class;
	}
