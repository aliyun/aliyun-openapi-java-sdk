 ...
 * @version 
 */
public class TrainModelRequest extends RoaAcsRequest<TrainModelResponse> {
	...
	@Override
	public Class<TrainModelResponse> getResponseClass() {
		return TrainModelResponse.class;
	}
