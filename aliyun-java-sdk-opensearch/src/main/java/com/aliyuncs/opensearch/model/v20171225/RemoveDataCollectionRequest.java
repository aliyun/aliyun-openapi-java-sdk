 ...
 * @version 
 */
public class RemoveDataCollectionRequest extends RoaAcsRequest<RemoveDataCollectionResponse> {
	...
	@Override
	public Class<RemoveDataCollectionResponse> getResponseClass() {
		return RemoveDataCollectionResponse.class;
	}
