 ...
 * @version 
 */
public class EnableSlowQueryRequest extends RoaAcsRequest<EnableSlowQueryResponse> {
	...
	@Override
	public Class<EnableSlowQueryResponse> getResponseClass() {
		return EnableSlowQueryResponse.class;
	}
