 ...
 * @version 
 */
public class CreateABTestExperimentRequest extends RoaAcsRequest<CreateABTestExperimentResponse> {
	...
	public CreateABTestExperimentRequest() {
		super("OpenSearch", "2017-12-25", "CreateABTestExperiment", "opensearch");
	...
	@Override
	public Class<CreateABTestExperimentResponse> getResponseClass() {
		return CreateABTestExperimentResponse.class;
	}
