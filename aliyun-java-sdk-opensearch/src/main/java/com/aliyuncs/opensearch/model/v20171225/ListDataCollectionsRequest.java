 ...
 * @version 
 */
public class ListDataCollectionsRequest extends RoaAcsRequest<ListDataCollectionsResponse> {
	...
	@Override
	public Class<ListDataCollectionsResponse> getResponseClass() {
		return ListDataCollectionsResponse.class;
	}
