 ...
 * @version 
 */
public class DescribeAppGroupDataReportRequest extends RoaAcsRequest<DescribeAppGroupDataReportResponse> {
	...
	@Override
	public Class<DescribeAppGroupDataReportResponse> getResponseClass() {
		return DescribeAppGroupDataReportResponse.class;
	}
