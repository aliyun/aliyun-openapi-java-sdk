 ...
 * @version 
 */
public class ListABTestMetricsRequest extends RoaAcsRequest<ListABTestMetricsResponse> {
	...
	@Override
	public Class<ListABTestMetricsResponse> getResponseClass() {
		return ListABTestMetricsResponse.class;
	}
