 ...
 * @version 
 */
public class ModifyAppGroupRequest extends RoaAcsRequest<ModifyAppGroupResponse> {
	...
	@Override
	public Class<ModifyAppGroupResponse> getResponseClass() {
		return ModifyAppGroupResponse.class;
	}
