 ...
 * @version 
 */
public class CompileSortScriptRequest extends RoaAcsRequest<CompileSortScriptResponse> {
	...
	@Override
	public Class<CompileSortScriptResponse> getResponseClass() {
		return CompileSortScriptResponse.class;
	}
