 ...
 * @version 
 */
public class CreateQueryProcessorRequest extends RoaAcsRequest<CreateQueryProcessorResponse> {
	...
	@Override
	public Class<CreateQueryProcessorResponse> getResponseClass() {
		return CreateQueryProcessorResponse.class;
	}
