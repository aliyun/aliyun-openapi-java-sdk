 ...
 * @version 
 */
public class UpdateABTestFixedFlowDividersRequest extends RoaAcsRequest<UpdateABTestFixedFlowDividersResponse> {
	...
	@Override
	public Class<UpdateABTestFixedFlowDividersResponse> getResponseClass() {
		return UpdateABTestFixedFlowDividersResponse.class;
	}
