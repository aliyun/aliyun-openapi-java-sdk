 ...
 * @version 
 */
public class DescribeDataCollctionRequest extends RoaAcsRequest<DescribeDataCollctionResponse> {
	...
	public void setDataCollectionIdentity(String dataCollectionIdentity) {
		this.dataCollectionIdentity = dataCollectionIdentity;
		if(dataCollectionIdentity != null){
			putPathParameter("dataCollectionIdentity", dataCollectionIdentity);
		}
	}
	...
	@Override
	public Class<DescribeDataCollctionResponse> getResponseClass() {
		return DescribeDataCollctionResponse.class;
	}
