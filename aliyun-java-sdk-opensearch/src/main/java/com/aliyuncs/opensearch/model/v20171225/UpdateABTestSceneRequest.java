 ...
 * @version 
 */
public class UpdateABTestSceneRequest extends RoaAcsRequest<UpdateABTestSceneResponse> {
	...
	@Override
	public Class<UpdateABTestSceneResponse> getResponseClass() {
		return UpdateABTestSceneResponse.class;
	}
