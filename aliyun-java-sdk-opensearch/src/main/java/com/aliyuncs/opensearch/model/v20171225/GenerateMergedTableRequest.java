 ...
 * @version 
 */
public class GenerateMergedTableRequest extends RoaAcsRequest<GenerateMergedTableResponse> {
	...
	@Override
	public Class<GenerateMergedTableResponse> getResponseClass() {
		return GenerateMergedTableResponse.class;
	}
