...
import com.aliyuncs.opensearch.transform.v20171225.ModifyAppGroupQuotaResponseUnmarshaller;
 ...
 * @version 
 */
public class ModifyAppGroupQuotaResponse extends AcsResponse {
	...
	@Override
	public ModifyAppGroupQuotaResponse getInstance(UnmarshallerContext context) {
		return	ModifyAppGroupQuotaResponseUnmarshaller.unmarshall(this, context);
	}
