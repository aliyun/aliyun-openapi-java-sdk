 ...
 * @version 
 */
public class DescribeFirstRankRequest extends RoaAcsRequest<DescribeFirstRankResponse> {
	...
	@Override
	public Class<DescribeFirstRankResponse> getResponseClass() {
		return DescribeFirstRankResponse.class;
	}
