 ...
 * @version 
 */
public class UpdateSortScriptRequest extends RoaAcsRequest<UpdateSortScriptResponse> {
	...
	public UpdateSortScriptRequest() {
		super("OpenSearch", "2017-12-25", "UpdateSortScript", "opensearch");
	...
	@Override
	public Class<UpdateSortScriptResponse> getResponseClass() {
		return UpdateSortScriptResponse.class;
	}
