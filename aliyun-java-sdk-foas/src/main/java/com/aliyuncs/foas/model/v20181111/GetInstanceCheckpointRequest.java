 ...
 * @version 
 */
public class GetInstanceCheckpointRequest extends RoaAcsRequest<GetInstanceCheckpointResponse> {
	...
	@Override
	public Class<GetInstanceCheckpointResponse> getResponseClass() {
		return GetInstanceCheckpointResponse.class;
	}
