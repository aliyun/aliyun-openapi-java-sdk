 ...
 * @version 
 */
public class ValidateJobRequest extends RoaAcsRequest<ValidateJobResponse> {
	...
	@Override
	public Class<ValidateJobResponse> getResponseClass() {
		return ValidateJobResponse.class;
	}
