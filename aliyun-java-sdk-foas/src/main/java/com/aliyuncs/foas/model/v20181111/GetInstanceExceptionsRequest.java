 ...
 * @version 
 */
public class GetInstanceExceptionsRequest extends RoaAcsRequest<GetInstanceExceptionsResponse> {
	...
	@Override
	public Class<GetInstanceExceptionsResponse> getResponseClass() {
		return GetInstanceExceptionsResponse.class;
	}
