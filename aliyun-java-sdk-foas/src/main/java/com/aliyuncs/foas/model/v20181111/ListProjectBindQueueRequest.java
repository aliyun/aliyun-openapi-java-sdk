 ...
 * @version 
 */
public class ListProjectBindQueueRequest extends RoaAcsRequest<ListProjectBindQueueResponse> {
	...
	@Override
	public Class<ListProjectBindQueueResponse> getResponseClass() {
		return ListProjectBindQueueResponse.class;
	}
