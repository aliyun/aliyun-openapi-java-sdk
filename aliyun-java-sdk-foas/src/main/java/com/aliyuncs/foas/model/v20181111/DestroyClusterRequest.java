 ...
 * @version 
 */
public class DestroyClusterRequest extends RoaAcsRequest<DestroyClusterResponse> {
	...
	@Override
	public Class<DestroyClusterResponse> getResponseClass() {
		return DestroyClusterResponse.class;
	}
