...
public class ListBandwidthPackagesRequest extends RpcAcsRequest<ListBandwidthPackagesResponse> {
	...
	public ListBandwidthPackagesRequest() {
		super("Ga", "2019-11-20", "ListBandwidthPackages", "gaplus");
	...
	@Override
	public Class<ListBandwidthPackagesResponse> getResponseClass() {
		return ListBandwidthPackagesResponse.class;
	}
