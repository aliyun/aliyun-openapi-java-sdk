 ...
 * @version 
 */
public class UpdateBandwidthPackageRequest extends RpcAcsRequest<UpdateBandwidthPackageResponse> {
	...
	@Override
	public Class<UpdateBandwidthPackageResponse> getResponseClass() {
		return UpdateBandwidthPackageResponse.class;
	}
