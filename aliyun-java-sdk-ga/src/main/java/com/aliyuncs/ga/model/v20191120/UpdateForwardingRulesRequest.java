 ...
 * @version 
 */
public class UpdateForwardingRulesRequest extends RpcAcsRequest<UpdateForwardingRulesResponse> {
	...
	public UpdateForwardingRulesRequest() {
		super("Ga", "2019-11-20", "UpdateForwardingRules", "gaplus");
		...
		if (forwardingRules != null) {
			for (int depth1 = 0; depth1 < forwardingRules.size(); depth1++) {
				if (forwardingRules.get(depth1) != null) {
						...
						putQueryParameter("ForwardingRules." + (depth1 + 1) + ".ForwardingRuleId" , forwardingRules.get(depth1).getForwardingRuleId());
	...
	@Override
	public Class<UpdateForwardingRulesResponse> getResponseClass() {
		return UpdateForwardingRulesResponse.class;
	}
