...
import com.aliyuncs.ga.transform.v20191120.UpdateForwardingRulesResponseUnmarshaller;
 ...
 * @version 
 */
public class UpdateForwardingRulesResponse extends AcsResponse {
	...
	@Override
	public UpdateForwardingRulesResponse getInstance(UnmarshallerContext context) {
		return	UpdateForwardingRulesResponseUnmarshaller.unmarshall(this, context);
	}
