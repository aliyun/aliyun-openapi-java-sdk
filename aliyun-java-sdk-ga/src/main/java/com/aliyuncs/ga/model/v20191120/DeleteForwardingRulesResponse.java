...
import com.aliyuncs.ga.transform.v20191120.DeleteForwardingRulesResponseUnmarshaller;
 ...
 * @version 
 */
public class DeleteForwardingRulesResponse extends AcsResponse {
	...
	@Override
	public DeleteForwardingRulesResponse getInstance(UnmarshallerContext context) {
		return	DeleteForwardingRulesResponseUnmarshaller.unmarshall(this, context);
	}
