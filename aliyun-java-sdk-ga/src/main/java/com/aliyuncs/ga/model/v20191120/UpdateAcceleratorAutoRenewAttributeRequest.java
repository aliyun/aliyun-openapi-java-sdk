 ...
 * @version 
 */
public class UpdateAcceleratorAutoRenewAttributeRequest extends RpcAcsRequest<UpdateAcceleratorAutoRenewAttributeResponse> {
	...
	public UpdateAcceleratorAutoRenewAttributeRequest() {
		super("Ga", "2019-11-20", "UpdateAcceleratorAutoRenewAttribute", "gaplus");
	...
	@Override
	public Class<UpdateAcceleratorAutoRenewAttributeResponse> getResponseClass() {
		return UpdateAcceleratorAutoRenewAttributeResponse.class;
	}
