...
public class ListCustomRoutingEndpointGroupsRequest extends RpcAcsRequest<ListCustomRoutingEndpointGroupsResponse> {
	...
	public ListCustomRoutingEndpointGroupsRequest() {
		super("Ga", "2019-11-20", "ListCustomRoutingEndpointGroups", "gaplus");
	...
	@Override
	public Class<ListCustomRoutingEndpointGroupsResponse> getResponseClass() {
		return ListCustomRoutingEndpointGroupsResponse.class;
	}
