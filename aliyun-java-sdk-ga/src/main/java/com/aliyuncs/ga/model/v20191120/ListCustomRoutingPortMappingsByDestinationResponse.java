...
import com.aliyuncs.ga.transform.v20191120.ListCustomRoutingPortMappingsByDestinationResponseUnmarshaller;
 ...
 * @version 
 */
public class ListCustomRoutingPortMappingsByDestinationResponse extends AcsResponse {
	...
	@Override
	public ListCustomRoutingPortMappingsByDestinationResponse getInstance(UnmarshallerContext context) {
		return	ListCustomRoutingPortMappingsByDestinationResponseUnmarshaller.unmarshall(this, context);
	}
