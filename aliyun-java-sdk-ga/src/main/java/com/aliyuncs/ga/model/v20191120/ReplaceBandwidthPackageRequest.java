 ...
 * @version 
 */
public class ReplaceBandwidthPackageRequest extends RpcAcsRequest<ReplaceBandwidthPackageResponse> {
	...
	@Override
	public Class<ReplaceBandwidthPackageResponse> getResponseClass() {
		return ReplaceBandwidthPackageResponse.class;
	}
