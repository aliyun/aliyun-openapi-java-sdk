 ...
 * @version 
 */
public class DeleteDomainAcceleratorRelationRequest extends RpcAcsRequest<DeleteDomainAcceleratorRelationResponse> {
	   

	private List<String> acceleratorIdss;

	private String domain;
	public DeleteDomainAcceleratorRelationRequest() {
		super("Ga", "2019-11-20", "DeleteDomainAcceleratorRelation", "gaplus");
	...
	@Override
	public Class<DeleteDomainAcceleratorRelationResponse> getResponseClass() {
		return DeleteDomainAcceleratorRelationResponse.class;
	}
