 ...
 * @version 
 */
public class UpdateEndpointGroupsRequest extends RpcAcsRequest<UpdateEndpointGroupsResponse> {
	...
	public UpdateEndpointGroupsRequest() {
		super("Ga", "2019-11-20", "UpdateEndpointGroups", "gaplus");
	...
	public void setEndpointGroupConfigurationss(List<EndpointGroupConfigurations> endpointGroupConfigurationss) {
		...
		if (endpointGroupConfigurationss != null) {
			for (int depth1 = 0; depth1 < endpointGroupConfigurationss.size(); depth1++) {
				...
				putQueryParameter("EndpointGroupConfigurations." + (depth1 + 1) + ".EndpointGroupId" , endpointGroupConfigurationss.get(depth1).getEndpointGroupId());
			}
		}	
	}
	...
	@Override
	public Class<UpdateEndpointGroupsResponse> getResponseClass() {
		return UpdateEndpointGroupsResponse.class;
	}
