...
import com.aliyuncs.ga.transform.v20191120.ListCommonAreasResponseUnmarshaller;
 ...
 * @version 
 */
public class ListCommonAreasResponse extends AcsResponse {
	...
	@Override
	public ListCommonAreasResponse getInstance(UnmarshallerContext context) {
		return	ListCommonAreasResponseUnmarshaller.unmarshall(this, context);
	}
