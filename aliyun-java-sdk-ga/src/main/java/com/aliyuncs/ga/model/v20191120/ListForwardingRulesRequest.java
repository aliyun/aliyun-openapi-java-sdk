 ...
 * @version 
 */
public class ListForwardingRulesRequest extends RpcAcsRequest<ListForwardingRulesResponse> {
	...
	public ListForwardingRulesRequest() {
		super("Ga", "2019-11-20", "ListForwardingRules", "gaplus");
	...
	public void setForwardingRuleId(String forwardingRuleId) {
		...
		if(forwardingRuleId != null){
			putQueryParameter("ForwardingRuleId", forwardingRuleId);
		}
	}
	...
	@Override
	public Class<ListForwardingRulesResponse> getResponseClass() {
		return ListForwardingRulesResponse.class;
	}
