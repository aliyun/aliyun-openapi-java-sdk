 ...
 * @version 
 */
public class CreateCustomRoutingEndpointGroupDestinationsRequest extends RpcAcsRequest<CreateCustomRoutingEndpointGroupDestinationsResponse> {
	...
	public CreateCustomRoutingEndpointGroupDestinationsRequest() {
		super("Ga", "2019-11-20", "CreateCustomRoutingEndpointGroupDestinations", "gaplus");
	...
	@Override
	public Class<CreateCustomRoutingEndpointGroupDestinationsResponse> getResponseClass() {
		return CreateCustomRoutingEndpointGroupDestinationsResponse.class;
	}
