 ...
 * @version 
 */
public class DeleteSpareIpsRequest extends RpcAcsRequest<DeleteSpareIpsResponse> {
	...
	public DeleteSpareIpsRequest() {
		super("Ga", "2019-11-20", "DeleteSpareIps", "gaplus");
	...
	@Override
	public Class<DeleteSpareIpsResponse> getResponseClass() {
		return DeleteSpareIpsResponse.class;
	}
