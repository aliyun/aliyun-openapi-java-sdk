 ...
 * @version 
 */
public class DeleteCustomRoutingEndpointGroupsRequest extends RpcAcsRequest<DeleteCustomRoutingEndpointGroupsResponse> {
	...
	public DeleteCustomRoutingEndpointGroupsRequest() {
		super("Ga", "2019-11-20", "DeleteCustomRoutingEndpointGroups", "gaplus");
	...
	@Override
	public Class<DeleteCustomRoutingEndpointGroupsResponse> getResponseClass() {
		return DeleteCustomRoutingEndpointGroupsResponse.class;
	}
