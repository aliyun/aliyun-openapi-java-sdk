 ...
 * @version 
 */
public class CreateCustomRoutingEndpointTrafficPoliciesRequest extends RpcAcsRequest<CreateCustomRoutingEndpointTrafficPoliciesResponse> {
	...
	public CreateCustomRoutingEndpointTrafficPoliciesRequest() {
		super("Ga", "2019-11-20", "CreateCustomRoutingEndpointTrafficPolicies", "gaplus");
	...
	@Override
	public Class<CreateCustomRoutingEndpointTrafficPoliciesResponse> getResponseClass() {
		return CreateCustomRoutingEndpointTrafficPoliciesResponse.class;
	}
