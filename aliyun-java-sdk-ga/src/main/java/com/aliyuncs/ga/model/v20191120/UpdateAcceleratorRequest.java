 ...
 * @version 
 */
public class UpdateAcceleratorRequest extends RpcAcsRequest<UpdateAcceleratorResponse> {
	...
	@Override
	public Class<UpdateAcceleratorResponse> getResponseClass() {
		return UpdateAcceleratorResponse.class;
	}
