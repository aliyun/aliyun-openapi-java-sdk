 ...
 * @version 
 */
public class UpdateApplicationMonitorRequest extends RpcAcsRequest<UpdateApplicationMonitorResponse> {
	...
	public UpdateApplicationMonitorRequest() {
		super("Ga", "2019-11-20", "UpdateApplicationMonitor", "gaplus");
	...
	@Override
	public Class<UpdateApplicationMonitorResponse> getResponseClass() {
		return UpdateApplicationMonitorResponse.class;
	}
