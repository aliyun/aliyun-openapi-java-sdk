...
import com.aliyuncs.idrsservice.model.v20200630.CreateRuleResponse;
import com.aliyuncs.idrsservice.model.v20200630.CreateRuleResponse.Data;
...
public class CreateRuleResponseUnmarshaller {
	...
	public static CreateRuleResponse unmarshall(CreateRuleResponse createRuleResponse, UnmarshallerContext _ctx) {
		...
		Data data = new Data();
		data.setContent(_ctx.stringValue("CreateRuleResponse.Data.Content"));
		data.setId(_ctx.stringValue("CreateRuleResponse.Data.Id"));
		data.setName(_ctx.stringValue("CreateRuleResponse.Data.Name"));
