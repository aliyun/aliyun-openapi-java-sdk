...
import com.aliyuncs.teambition_aliyun.model.v20200226.DeleteProjectResponse;
...
public class DeleteProjectResponseUnmarshaller {
	...
	public static DeleteProjectResponse unmarshall(DeleteProjectResponse deleteProjectResponse, UnmarshallerContext _ctx) {
		...
		deleteProjectResponse.setErrorMessage(_ctx.stringValue("DeleteProjectResponse.ErrorMessage"));
		deleteProjectResponse.setObject(_ctx.stringValue("DeleteProjectResponse.Object"));
