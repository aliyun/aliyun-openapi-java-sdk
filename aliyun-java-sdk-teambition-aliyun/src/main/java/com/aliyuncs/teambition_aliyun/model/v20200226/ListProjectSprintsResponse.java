...
import com.aliyuncs.teambition_aliyun.transform.v20200226.ListProjectSprintsResponseUnmarshaller;
 ...
 * @version 
 */
public class ListProjectSprintsResponse extends AcsResponse {
	...
	@Override
	public ListProjectSprintsResponse getInstance(UnmarshallerContext context) {
		return	ListProjectSprintsResponseUnmarshaller.unmarshall(this, context);
	}
