...
import com.aliyuncs.teambition_aliyun.transform.v20200226.GetProjectSprintInfoResponseUnmarshaller;
 ...
 * @version 
 */
public class GetProjectSprintInfoResponse extends AcsResponse {
	...
	@Override
	public GetProjectSprintInfoResponse getInstance(UnmarshallerContext context) {
		return	GetProjectSprintInfoResponseUnmarshaller.unmarshall(this, context);
	}
