...
import com.aliyuncs.teambition_aliyun.transform.v20200226.GetProjectTaskInfoResponseUnmarshaller;
 ...
 * @version 
 */
public class GetProjectTaskInfoResponse extends AcsResponse {
	...
	@Override
	public GetProjectTaskInfoResponse getInstance(UnmarshallerContext context) {
		return	GetProjectTaskInfoResponseUnmarshaller.unmarshall(this, context);
	}
