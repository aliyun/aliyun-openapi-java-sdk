 ...
 * @version 
 */
public class GetSkillVersionDetailRequest extends RpcAcsRequest<GetSkillVersionDetailResponse> {
	...
	@Override
	public Class<GetSkillVersionDetailResponse> getResponseClass() {
		return GetSkillVersionDetailResponse.class;
	}
