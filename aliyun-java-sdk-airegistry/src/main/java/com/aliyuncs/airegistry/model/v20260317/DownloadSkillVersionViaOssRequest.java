 ...
 * @version 
 */
public class DownloadSkillVersionViaOssRequest extends RpcAcsRequest<DownloadSkillVersionViaOssResponse> {
	...
	@Override
	public Class<DownloadSkillVersionViaOssResponse> getResponseClass() {
		return DownloadSkillVersionViaOssResponse.class;
	}
