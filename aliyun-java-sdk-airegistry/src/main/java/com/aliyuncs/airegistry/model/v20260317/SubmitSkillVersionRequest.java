 ...
 * @version 
 */
public class SubmitSkillVersionRequest extends RpcAcsRequest<SubmitSkillVersionResponse> {
	...
	@Override
	public Class<SubmitSkillVersionResponse> getResponseClass() {
		return SubmitSkillVersionResponse.class;
	}
