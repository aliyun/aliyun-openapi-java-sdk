 ...
 * @version 
 */
public class ForcePublishSkillVersionRequest extends RpcAcsRequest<ForcePublishSkillVersionResponse> {
	...
	@Override
	public Class<ForcePublishSkillVersionResponse> getResponseClass() {
		return ForcePublishSkillVersionResponse.class;
	}
