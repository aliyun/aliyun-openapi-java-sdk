 ...
 * @version 
 */
public class OnlineSkillRequest extends RpcAcsRequest<OnlineSkillResponse> {
	...
	@Override
	public Class<OnlineSkillResponse> getResponseClass() {
		return OnlineSkillResponse.class;
	}
