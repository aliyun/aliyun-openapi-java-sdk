...
import com.aliyuncs.iqs.transform.v20240712.QueryHotelsResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryHotelsResponse extends AcsResponse {
	...
	@Override
	public QueryHotelsResponse getInstance(UnmarshallerContext context) {
		return	QueryHotelsResponseUnmarshaller.unmarshall(this, context);
	}
