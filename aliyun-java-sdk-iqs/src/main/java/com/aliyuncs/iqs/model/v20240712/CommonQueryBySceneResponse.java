...
import com.aliyuncs.iqs.transform.v20240712.CommonQueryBySceneResponseUnmarshaller;
 ...
 * @version 
 */
public class CommonQueryBySceneResponse extends AcsResponse {
	...
	@Override
	public CommonQueryBySceneResponse getInstance(UnmarshallerContext context) {
		return	CommonQueryBySceneResponseUnmarshaller.unmarshall(this, context);
	}
