...
import com.aliyuncs.iqs.transform.v20240712.QueryAttractionsResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryAttractionsResponse extends AcsResponse {
	...
	@Override
	public QueryAttractionsResponse getInstance(UnmarshallerContext context) {
		return	QueryAttractionsResponseUnmarshaller.unmarshall(this, context);
	}
