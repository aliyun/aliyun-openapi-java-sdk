 ...
 * @version 
 */
public class DescribeServiceMeshKubeconfigRequest extends RpcAcsRequest<DescribeServiceMeshKubeconfigResponse> {
	   

	private Boolean privateIpAddress;

	private String serviceMeshId;
	public DescribeServiceMeshKubeconfigRequest() {
		super("servicemesh", "2020-01-11", "DescribeServiceMeshKubeconfig", "servicemesh");
	...
	@Override
	public Class<DescribeServiceMeshKubeconfigResponse> getResponseClass() {
		return DescribeServiceMeshKubeconfigResponse.class;
	}
