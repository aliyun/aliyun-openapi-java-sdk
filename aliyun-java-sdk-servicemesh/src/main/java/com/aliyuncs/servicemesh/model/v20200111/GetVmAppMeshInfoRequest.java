 ...
 * @version 
 */
public class GetVmAppMeshInfoRequest extends RpcAcsRequest<GetVmAppMeshInfoResponse> {
	   

	private String serviceMeshId;
	public GetVmAppMeshInfoRequest() {
		super("servicemesh", "2020-01-11", "GetVmAppMeshInfo", "servicemesh");
	...
	@Override
	public Class<GetVmAppMeshInfoResponse> getResponseClass() {
		return GetVmAppMeshInfoResponse.class;
	}
