 ...
 * @version 
 */
public class GetOnlineStaTimeSerRequest extends RpcAcsRequest<GetOnlineStaTimeSerResponse> {
	
	public GetOnlineStaTimeSerRequest() {
		super("cloudwf", "2017-03-28", "GetOnlineStaTimeSer", "cloudwf");
	}
	...
	@Override
	public Class<GetOnlineStaTimeSerResponse> getResponseClass() {
		return GetOnlineStaTimeSerResponse.class;
	}
