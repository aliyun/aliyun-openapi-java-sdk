 ...
 * @version 
 */
public class ShopCreateRequest extends RpcAcsRequest<ShopCreateResponse> {
	
	public ShopCreateRequest() {
		super("cloudwf", "2017-03-28", "ShopCreate", "cloudwf");
	}
	...
	@Override
	public Class<ShopCreateResponse> getResponseClass() {
