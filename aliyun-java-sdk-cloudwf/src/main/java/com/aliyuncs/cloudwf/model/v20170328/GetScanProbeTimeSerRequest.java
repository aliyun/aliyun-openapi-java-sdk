 ...
 * @version 
 */
public class GetScanProbeTimeSerRequest extends RpcAcsRequest<GetScanProbeTimeSerResponse> {
	
	public GetScanProbeTimeSerRequest() {
		super("cloudwf", "2017-03-28", "GetScanProbeTimeSer", "cloudwf");
	}
	...
	@Override
	public Class<GetScanProbeTimeSerResponse> getResponseClass() {
		return GetScanProbeTimeSerResponse.class;
	}
