 ...
 * @version 
 */
public class SaveApgroupConfigRequest extends RpcAcsRequest<SaveApgroupConfigResponse> {
	
	public SaveApgroupConfigRequest() {
		super("cloudwf", "2017-03-28", "SaveApgroupConfig", "cloudwf");
	}
	...
	@Override
	public Class<SaveApgroupConfigResponse> getResponseClass() {
		return SaveApgroupConfigResponse.class;
	}
