 ...
 * @version 
 */
public class QueryRenewPriceRequest extends RpcAcsRequest<QueryRenewPriceResponse> {
	
	public QueryRenewPriceRequest() {
		super("cloudwf", "2017-03-28", "QueryRenewPrice", "cloudwf");
	}
	...
	@Override
	public Class<QueryRenewPriceResponse> getResponseClass() {
		return QueryRenewPriceResponse.class;
	}
