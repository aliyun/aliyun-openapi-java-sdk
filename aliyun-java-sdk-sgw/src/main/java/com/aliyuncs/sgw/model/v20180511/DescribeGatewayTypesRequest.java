 ...
 * @version 
 */
public class DescribeGatewayTypesRequest extends RpcAcsRequest<DescribeGatewayTypesResponse> {
	   

	private String gatewayLocation;

	private String securityToken;
	public DescribeGatewayTypesRequest() {
		super("sgw", "2018-05-11", "DescribeGatewayTypes", "hcs_sgw");
	...
	@Override
	public Class<DescribeGatewayTypesResponse> getResponseClass() {
		return DescribeGatewayTypesResponse.class;
	}
