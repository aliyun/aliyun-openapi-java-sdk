 ...
 * @version 
 */
public class DeleteStorageBundleRequest extends RpcAcsRequest<DeleteStorageBundleResponse> {
	   

	private String securityToken;

	private String storageBundleId;
	public DeleteStorageBundleRequest() {
		super("sgw", "2018-05-11", "DeleteStorageBundle", "hcs_sgw");
	...
	@Override
	public Class<DeleteStorageBundleResponse> getResponseClass() {
		return DeleteStorageBundleResponse.class;
	}
