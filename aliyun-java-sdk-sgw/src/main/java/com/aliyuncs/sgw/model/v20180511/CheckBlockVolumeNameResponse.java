...
import com.aliyuncs.sgw.transform.v20180511.CheckBlockVolumeNameResponseUnmarshaller;
...
public class CheckBlockVolumeNameResponse extends AcsResponse {
	...
	@Override
	public CheckBlockVolumeNameResponse getInstance(UnmarshallerContext context) {
		return	CheckBlockVolumeNameResponseUnmarshaller.unmarshall(this, context);
	}
}
