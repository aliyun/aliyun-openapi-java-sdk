 ...
 * @version 
 */
public class RestartFileSharesRequest extends RpcAcsRequest<RestartFileSharesResponse> {
	...
	public RestartFileSharesRequest() {
		super("sgw", "2018-05-11", "RestartFileShares", "hcs_sgw");
	...
	@Override
	public Class<RestartFileSharesResponse> getResponseClass() {
		return RestartFileSharesResponse.class;
	}
