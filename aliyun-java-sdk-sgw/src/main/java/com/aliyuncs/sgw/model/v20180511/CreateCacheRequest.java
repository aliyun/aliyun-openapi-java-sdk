 ...
 * @version 
 */
public class CreateCacheRequest extends RpcAcsRequest<CreateCacheResponse> {
	...
	public CreateCacheRequest() {
		super("sgw", "2018-05-11", "CreateCache", "hcs_sgw");
	...
	@Override
	public Class<CreateCacheResponse> getResponseClass() {
		return CreateCacheResponse.class;
	}
