 ...
 * @version 
 */
public class DescribeCSGClientTasksRequest extends RpcAcsRequest<DescribeCSGClientTasksResponse> {
	...
	public DescribeCSGClientTasksRequest() {
		super("sgw", "2018-05-11", "DescribeCSGClientTasks", "hcs_sgw");
	...
	@Override
	public Class<DescribeCSGClientTasksResponse> getResponseClass() {
		return DescribeCSGClientTasksResponse.class;
	}
