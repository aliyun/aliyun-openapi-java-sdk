 ...
 * @version 
 */
public class SplitTrafficControlTargetRequest extends RoaAcsRequest<SplitTrafficControlTargetResponse> {
	   

	private String trafficControlTargetId;

	private String body;
	public SplitTrafficControlTargetRequest() {
		super("PaiRecService", "2022-12-13", "SplitTrafficControlTarget");
		setUriPattern("/api/v1/trafficcontroltargets/[TrafficControlTargetId]/action/split");
	...
	@Override
	public Class<SplitTrafficControlTargetResponse> getResponseClass() {
		return SplitTrafficControlTargetResponse.class;
	}
