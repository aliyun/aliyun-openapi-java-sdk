...
import com.aliyuncs.pairecservice.transform.v20221213.ListExperimentGroupsResponseUnmarshaller;
 ...
 * @version 
 */
public class ListExperimentGroupsResponse extends AcsResponse {

	private String requestId;

	private Long totalCount;

	private List<ExperimentGroupsItem> experimentGroups;
	...
	public List<ExperimentGroupsItem> getExperimentGroups() {
		return this.experimentGroups;
	}

	public void setExperimentGroups(List<ExperimentGroupsItem> experimentGroups) {
		this.experimentGroups = experimentGroups;
	}

	public static class ExperimentGroupsItem {
	...
	@Override
	public ListExperimentGroupsResponse getInstance(UnmarshallerContext context) {
		return	ListExperimentGroupsResponseUnmarshaller.unmarshall(this, context);
	}
