...
import com.aliyuncs.pairecservice.transform.v20221213.ListResourceRulesResponseUnmarshaller;
 ...
 * @version 
 */
public class ListResourceRulesResponse extends AcsResponse {

	private String requestId;

	private Long totalCount;

	private List<ResourceRulesItem> resourceRules;
	...
	public List<ResourceRulesItem> getResourceRules() {
		return this.resourceRules;
	}

	public void setResourceRules(List<ResourceRulesItem> resourceRules) {
		this.resourceRules = resourceRules;
	}

	public static class ResourceRulesItem {
	...
	@Override
	public ListResourceRulesResponse getInstance(UnmarshallerContext context) {
		return	ListResourceRulesResponseUnmarshaller.unmarshall(this, context);
	}
