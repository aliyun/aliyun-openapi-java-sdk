 ...
 * @version 
 */
public class ListInstanceResourcesRequest extends RoaAcsRequest<ListInstanceResourcesResponse> {
	...
	@Override
	public Class<ListInstanceResourcesResponse> getResponseClass() {
