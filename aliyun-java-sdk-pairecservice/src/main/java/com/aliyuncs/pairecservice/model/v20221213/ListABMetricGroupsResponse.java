...
public class ListABMetricGroupsResponse extends AcsResponse {
	...
	private List<ABMetricGroupsItem> aBMetricGroups;
	...
	public List<ABMetricGroupsItem> getABMetricGroups() {
		return this.aBMetricGroups;
	}

	public void setABMetricGroups(List<ABMetricGroupsItem> aBMetricGroups) {
