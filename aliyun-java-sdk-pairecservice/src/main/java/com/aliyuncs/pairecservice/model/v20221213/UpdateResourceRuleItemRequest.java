 ...
 * @version 
 */
public class UpdateResourceRuleItemRequest extends RoaAcsRequest<UpdateResourceRuleItemResponse> {
	...
	public UpdateResourceRuleItemRequest() {
		super("PaiRecService", "2022-12-13", "UpdateResourceRuleItem");
	...
	@Override
	public Class<UpdateResourceRuleItemResponse> getResponseClass() {
		return UpdateResourceRuleItemResponse.class;
	}
