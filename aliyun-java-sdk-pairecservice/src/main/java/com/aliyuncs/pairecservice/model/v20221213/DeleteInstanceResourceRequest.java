 ...
 * @version 
 */
public class DeleteInstanceResourceRequest extends RoaAcsRequest<DeleteInstanceResourceResponse> {
	...
	@Override
	public Class<DeleteInstanceResourceResponse> getResponseClass() {
