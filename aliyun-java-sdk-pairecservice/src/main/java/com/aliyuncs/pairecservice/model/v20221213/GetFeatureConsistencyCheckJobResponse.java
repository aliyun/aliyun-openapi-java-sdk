...
import com.aliyuncs.pairecservice.transform.v20221213.GetFeatureConsistencyCheckJobResponseUnmarshaller;
 ...
 * @version 
 */
public class GetFeatureConsistencyCheckJobResponse extends AcsResponse {
	...
	@Override
	public GetFeatureConsistencyCheckJobResponse getInstance(UnmarshallerContext context) {
		return	GetFeatureConsistencyCheckJobResponseUnmarshaller.unmarshall(this, context);
	}
