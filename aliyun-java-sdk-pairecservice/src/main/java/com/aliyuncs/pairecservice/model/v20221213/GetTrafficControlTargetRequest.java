 ...
 * @version 
 */
public class GetTrafficControlTargetRequest extends RoaAcsRequest<GetTrafficControlTargetResponse> {
	   

	private String trafficControlTargetId;

	private String instanceId;
	public GetTrafficControlTargetRequest() {
		super("PaiRecService", "2022-12-13", "GetTrafficControlTarget");
	...
	@Override
	public Class<GetTrafficControlTargetResponse> getResponseClass() {
		return GetTrafficControlTargetResponse.class;
	}
