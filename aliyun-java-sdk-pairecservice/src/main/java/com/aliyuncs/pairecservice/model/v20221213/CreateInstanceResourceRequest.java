 ...
 * @version 
 */
public class CreateInstanceResourceRequest extends RoaAcsRequest<CreateInstanceResourceResponse> {
	...
	@Override
	public Class<CreateInstanceResourceResponse> getResponseClass() {
