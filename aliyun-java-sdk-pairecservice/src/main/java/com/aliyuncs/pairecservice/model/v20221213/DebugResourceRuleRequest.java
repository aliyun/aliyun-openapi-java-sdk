 ...
 * @version 
 */
public class DebugResourceRuleRequest extends RoaAcsRequest<DebugResourceRuleResponse> {
	...
	public DebugResourceRuleRequest() {
		super("PaiRecService", "2022-12-13", "DebugResourceRule");
		setUriPattern("/api/v1/resourcerules/[ResourceRuleId]/action/debug");
	...
	@Override
	public Class<DebugResourceRuleResponse> getResponseClass() {
		return DebugResourceRuleResponse.class;
	}
