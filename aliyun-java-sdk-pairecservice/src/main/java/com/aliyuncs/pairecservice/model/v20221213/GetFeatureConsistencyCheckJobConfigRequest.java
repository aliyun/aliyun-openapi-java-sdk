 ...
 * @version 
 */
public class GetFeatureConsistencyCheckJobConfigRequest extends RoaAcsRequest<GetFeatureConsistencyCheckJobConfigResponse> {
	   

	private String featureConsistencyCheckJobConfigId;

	private String instanceId;
	public GetFeatureConsistencyCheckJobConfigRequest() {
		super("PaiRecService", "2022-12-13", "GetFeatureConsistencyCheckJobConfig");
	...
	@Override
	public Class<GetFeatureConsistencyCheckJobConfigResponse> getResponseClass() {
		return GetFeatureConsistencyCheckJobConfigResponse.class;
	}
