 ...
 * @version 
 */
public class UpdateTrafficControlTargetRequest extends RoaAcsRequest<UpdateTrafficControlTargetResponse> {
	...
	public UpdateTrafficControlTargetRequest() {
		super("PaiRecService", "2022-12-13", "UpdateTrafficControlTarget");
	...
	@Override
	public Class<UpdateTrafficControlTargetResponse> getResponseClass() {
		return UpdateTrafficControlTargetResponse.class;
	}
