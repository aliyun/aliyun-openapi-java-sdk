 ...
 * @version 
 */
public class CreateCalculationJobsRequest extends RoaAcsRequest<CreateCalculationJobsResponse> {
	...
	@Override
	public Class<CreateCalculationJobsResponse> getResponseClass() {
