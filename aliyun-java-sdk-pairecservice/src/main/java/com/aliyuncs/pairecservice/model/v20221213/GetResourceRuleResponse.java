...
import com.aliyuncs.pairecservice.transform.v20221213.GetResourceRuleResponseUnmarshaller;
 ...
 * @version 
 */
public class GetResourceRuleResponse extends AcsResponse {
	...
	@Override
	public GetResourceRuleResponse getInstance(UnmarshallerContext context) {
		return	GetResourceRuleResponseUnmarshaller.unmarshall(this, context);
	}
