 ...
 * @version 
 */
public class UpdateTrafficControlTaskRequest extends RoaAcsRequest<UpdateTrafficControlTaskResponse> {
	   

	private String trafficControlTaskId;

	private String body;
	public UpdateTrafficControlTaskRequest() {
		super("PaiRecService", "2022-12-13", "UpdateTrafficControlTask");
	...
	@Override
	public Class<UpdateTrafficControlTaskResponse> getResponseClass() {
		return UpdateTrafficControlTaskResponse.class;
	}
