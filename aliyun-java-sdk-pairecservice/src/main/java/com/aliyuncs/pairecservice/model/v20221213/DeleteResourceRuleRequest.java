 ...
 * @version 
 */
public class DeleteResourceRuleRequest extends RoaAcsRequest<DeleteResourceRuleResponse> {
	...
	public DeleteResourceRuleRequest() {
		super("PaiRecService", "2022-12-13", "DeleteResourceRule");
	...
	@Override
	public Class<DeleteResourceRuleResponse> getResponseClass() {
		return DeleteResourceRuleResponse.class;
	}
