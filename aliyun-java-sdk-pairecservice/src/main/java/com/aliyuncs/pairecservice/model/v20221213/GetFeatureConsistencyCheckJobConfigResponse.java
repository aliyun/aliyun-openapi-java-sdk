...
import com.aliyuncs.pairecservice.transform.v20221213.GetFeatureConsistencyCheckJobConfigResponseUnmarshaller;
 ...
 * @version 
 */
public class GetFeatureConsistencyCheckJobConfigResponse extends AcsResponse {
	...
	@Override
	public GetFeatureConsistencyCheckJobConfigResponse getInstance(UnmarshallerContext context) {
		return	GetFeatureConsistencyCheckJobConfigResponseUnmarshaller.unmarshall(this, context);
	}
