 ...
 * @version 
 */
public class ModifyJDBCDataSourceRequest extends RpcAcsRequest<ModifyJDBCDataSourceResponse> {
	...
	public ModifyJDBCDataSourceRequest() {
		super("gpdb", "2016-05-03", "ModifyJDBCDataSource", "gpdb");
	...
	@Override
	public Class<ModifyJDBCDataSourceResponse> getResponseClass() {
		return ModifyJDBCDataSourceResponse.class;
	}
