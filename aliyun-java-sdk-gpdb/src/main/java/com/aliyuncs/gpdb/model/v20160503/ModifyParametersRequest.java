...
public class ModifyParametersRequest extends RpcAcsRequest<ModifyParametersResponse> {
	...
	public void setForceRestartInstance(Boolean forceRestartInstance) {
		this.forceRestartInstance = forceRestartInstance;
		if(forceRestartInstance != null){
			putQueryParameter("ForceRestartInstance", forceRestartInstance.toString());
		}
	}
