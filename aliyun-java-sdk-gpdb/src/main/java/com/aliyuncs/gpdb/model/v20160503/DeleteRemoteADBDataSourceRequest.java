 ...
 * @version 
 */
public class DeleteRemoteADBDataSourceRequest extends RpcAcsRequest<DeleteRemoteADBDataSourceResponse> {
	...
	public DeleteRemoteADBDataSourceRequest() {
		super("gpdb", "2016-05-03", "DeleteRemoteADBDataSource", "gpdb");
	...
	@Override
	public Class<DeleteRemoteADBDataSourceResponse> getResponseClass() {
		return DeleteRemoteADBDataSourceResponse.class;
	}
