 ...
 * @version 
 */
public class CreateHadoopDataSourceRequest extends RpcAcsRequest<CreateHadoopDataSourceResponse> {
	...
	public CreateHadoopDataSourceRequest() {
		super("gpdb", "2016-05-03", "CreateHadoopDataSource", "gpdb");
	...
	@Override
	public Class<CreateHadoopDataSourceResponse> getResponseClass() {
		return CreateHadoopDataSourceResponse.class;
	}
