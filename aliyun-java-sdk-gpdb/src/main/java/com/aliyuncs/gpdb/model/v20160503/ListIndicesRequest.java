 ...
 * @version 
 */
public class ListIndicesRequest extends RpcAcsRequest<ListIndicesResponse> {
	...
	public ListIndicesRequest() {
		super("gpdb", "2016-05-03", "ListIndices", "gpdb");
	...
	@Override
	public Class<ListIndicesResponse> getResponseClass() {
		return ListIndicesResponse.class;
	}
