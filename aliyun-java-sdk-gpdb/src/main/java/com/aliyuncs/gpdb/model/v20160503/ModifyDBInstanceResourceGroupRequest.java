 ...
 * @version 
 */
public class ModifyDBInstanceResourceGroupRequest extends RpcAcsRequest<ModifyDBInstanceResourceGroupResponse> {
	...
	@Override
	public Class<ModifyDBInstanceResourceGroupResponse> getResponseClass() {
		return ModifyDBInstanceResourceGroupResponse.class;
	}
