 ...
 * @version 
 */
public class CreateDBInstancePlanRequest extends RpcAcsRequest<CreateDBInstancePlanResponse> {
	...
	@Override
	public Class<CreateDBInstancePlanResponse> getResponseClass() {
		return CreateDBInstancePlanResponse.class;
	}
