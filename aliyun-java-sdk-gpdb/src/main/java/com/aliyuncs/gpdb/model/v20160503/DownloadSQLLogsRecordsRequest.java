 ...
 * @version 
 */
public class DownloadSQLLogsRecordsRequest extends RpcAcsRequest<DownloadSQLLogsRecordsResponse> {
	...
	private String user;
	public DownloadSQLLogsRecordsRequest() {
		super("gpdb", "2016-05-03", "DownloadSQLLogsRecords", "gpdb");
	...
	@Override
	public Class<DownloadSQLLogsRecordsResponse> getResponseClass() {
		return DownloadSQLLogsRecordsResponse.class;
	}
