 ...
 * @version 
 */
public class SetDataShareInstanceRequest extends RpcAcsRequest<SetDataShareInstanceResponse> {
	...
	@Override
	public Class<SetDataShareInstanceResponse> getResponseClass() {
		return SetDataShareInstanceResponse.class;
	}
