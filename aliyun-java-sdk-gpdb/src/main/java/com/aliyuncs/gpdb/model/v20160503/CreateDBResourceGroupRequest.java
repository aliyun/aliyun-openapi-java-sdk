 ...
 * @version 
 */
public class CreateDBResourceGroupRequest extends RpcAcsRequest<CreateDBResourceGroupResponse> {
	...
	public CreateDBResourceGroupRequest() {
		super("gpdb", "2016-05-03", "CreateDBResourceGroup", "gpdb");
	...
	public void setResourceGroupConfig(String resourceGroupConfig) {
		...
		if(resourceGroupConfig != null){
			putQueryParameter("ResourceGroupConfig", resourceGroupConfig);
		}
	}
	...
	@Override
	public Class<CreateDBResourceGroupResponse> getResponseClass() {
		return CreateDBResourceGroupResponse.class;
	}
