...
import com.aliyuncs.gpdb.transform.v20160503.CreateRemoteADBDataSourceResponseUnmarshaller;
 ...
 * @version 
 */
public class CreateRemoteADBDataSourceResponse extends AcsResponse {
	...
	@Override
	public CreateRemoteADBDataSourceResponse getInstance(UnmarshallerContext context) {
		return	CreateRemoteADBDataSourceResponseUnmarshaller.unmarshall(this, context);
	}
}
