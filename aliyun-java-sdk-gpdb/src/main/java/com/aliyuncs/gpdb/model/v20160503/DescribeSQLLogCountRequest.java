 ...
 * @version 
 */
public class DescribeSQLLogCountRequest extends RpcAcsRequest<DescribeSQLLogCountResponse> {
	...
	public DescribeSQLLogCountRequest() {
		super("gpdb", "2016-05-03", "DescribeSQLLogCount", "gpdb");
	...
	@Override
	public Class<DescribeSQLLogCountResponse> getResponseClass() {
		return DescribeSQLLogCountResponse.class;
	}
