...
import com.aliyuncs.gpdb.transform.v20160503.DescribeSlowSQLLogsResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeSlowSQLLogsResponse extends AcsResponse {
	...
	@Override
	public DescribeSlowSQLLogsResponse getInstance(UnmarshallerContext context) {
		return	DescribeSlowSQLLogsResponseUnmarshaller.unmarshall(this, context);
	}
