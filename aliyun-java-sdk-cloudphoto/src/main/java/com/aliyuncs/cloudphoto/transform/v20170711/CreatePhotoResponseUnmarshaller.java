...
public class CreatePhotoResponseUnmarshaller {
	...
	public static CreatePhotoResponse unmarshall(CreatePhotoResponse createPhotoResponse, UnmarshallerContext context) {
		...
		photo.setIdStr(context.stringValue("CreatePhotoResponse.Photo.IdStr"));
		...
		photo.setLocation(context.stringValue("CreatePhotoResponse.Photo.Location"));
		...
		photo.setSize(context.longValue("CreatePhotoResponse.Photo.Size"));
		...
		photo.setShareExpireTime(context.longValue("CreatePhotoResponse.Photo.ShareExpireTime"));
