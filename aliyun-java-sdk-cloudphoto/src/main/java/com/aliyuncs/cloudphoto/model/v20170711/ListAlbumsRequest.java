 ...
 * @version 
 */
public class ListAlbumsRequest extends RpcAcsRequest<ListAlbumsResponse> {
	...
	@Override
	public Class<ListAlbumsResponse> getResponseClass() {
		return ListAlbumsResponse.class;
	}
