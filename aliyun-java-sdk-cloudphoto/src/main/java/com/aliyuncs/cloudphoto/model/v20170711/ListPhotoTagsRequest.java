 ...
 * @version 
 */
public class ListPhotoTagsRequest extends RpcAcsRequest<ListPhotoTagsResponse> {
	...
	@Override
	public Class<ListPhotoTagsResponse> getResponseClass() {
		return ListPhotoTagsResponse.class;
	}
