...
import com.aliyuncs.webplus.transform.v20190320.CreateAppEnvResponseUnmarshaller;
 ...
 * @version 
 */
public class CreateAppEnvResponse extends AcsResponse {
	...
	@Override
	public CreateAppEnvResponse getInstance(UnmarshallerContext context) {
		return	CreateAppEnvResponseUnmarshaller.unmarshall(this, context);
	}
}
