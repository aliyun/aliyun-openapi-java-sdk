...
import com.aliyuncs.webplus.transform.v20190320.DescribeGatherLogResultResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeGatherLogResultResponse extends AcsResponse {
	...
	public void setGatherLogResult(GatherLogResult gatherLogResult) {
		this.gatherLogResult = gatherLogResult;
	}

	public static class GatherLogResult {
	...
	@Override
	public DescribeGatherLogResultResponse getInstance(UnmarshallerContext context) {
		return	DescribeGatherLogResultResponseUnmarshaller.unmarshall(this, context);
	}
}
