...
import com.aliyuncs.webplus.transform.v20190320.RebuildAppEnvResponseUnmarshaller;
 ...
 * @version 
 */
public class RebuildAppEnvResponse extends AcsResponse {
	...
	@Override
	public RebuildAppEnvResponse getInstance(UnmarshallerContext context) {
		return	RebuildAppEnvResponseUnmarshaller.unmarshall(this, context);
	}
}
