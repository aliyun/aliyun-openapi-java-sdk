...
import com.aliyuncs.webplus.transform.v20190320.UpdateAppEnvResponseUnmarshaller;
 ...
 * @version 
 */
public class UpdateAppEnvResponse extends AcsResponse {
	...
	@Override
	public UpdateAppEnvResponse getInstance(UnmarshallerContext context) {
		return	UpdateAppEnvResponseUnmarshaller.unmarshall(this, context);
	}
}
