 ...
 * @version 
 */
public class ExtendClusterRequest extends RpcAcsRequest<ExtendClusterResponse> {
	...
	public ExtendClusterRequest() {
		super("eflo-controller", "2022-12-15", "ExtendCluster");
	...
	@Override
	public Class<ExtendClusterResponse> getResponseClass() {
		return ExtendClusterResponse.class;
	}
