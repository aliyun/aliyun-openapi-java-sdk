...
import com.aliyuncs.fss.transform.v20190125.QuerySoftwareVulnResponseUnmarshaller;
 ...
 * @version 
 */
public class QuerySoftwareVulnResponse extends AcsResponse {
	...
	@Override
	public QuerySoftwareVulnResponse getInstance(UnmarshallerContext context) {
		return	QuerySoftwareVulnResponseUnmarshaller.unmarshall(this, context);
	}
}
