 ...
 * @version 
 */
public class DeleteVpdGrantRuleRequest extends RpcAcsRequest<DeleteVpdGrantRuleResponse> {
	...
	public DeleteVpdGrantRuleRequest() {
		super("eflo", "2022-05-30", "DeleteVpdGrantRule", "eflo");
	...
	@Override
	public Class<DeleteVpdGrantRuleResponse> getResponseClass() {
		return DeleteVpdGrantRuleResponse.class;
	}
