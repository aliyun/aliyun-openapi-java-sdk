...
import com.aliyuncs.eflo.transform.v20220530.GetErAttachmentResponseUnmarshaller;
 ...
 * @version 
 */
public class GetErAttachmentResponse extends AcsResponse {
	...
	@Override
	public GetErAttachmentResponse getInstance(UnmarshallerContext context) {
		return	GetErAttachmentResponseUnmarshaller.unmarshall(this, context);
	}
