...
import com.aliyuncs.eflo.transform.v20220530.GetNetworkInterfaceResponseUnmarshaller;
 ...
 * @version 
 */
public class GetNetworkInterfaceResponse extends AcsResponse {
	...
	@Override
	public GetNetworkInterfaceResponse getInstance(UnmarshallerContext context) {
		return	GetNetworkInterfaceResponseUnmarshaller.unmarshall(this, context);
	}
