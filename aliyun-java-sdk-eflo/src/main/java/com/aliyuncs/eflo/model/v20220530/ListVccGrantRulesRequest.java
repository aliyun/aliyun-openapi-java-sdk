 ...
 * @version 
 */
public class ListVccGrantRulesRequest extends RpcAcsRequest<ListVccGrantRulesResponse> {
	...
	public ListVccGrantRulesRequest() {
		super("eflo", "2022-05-30", "ListVccGrantRules", "eflo");
	...
	@Override
	public Class<ListVccGrantRulesResponse> getResponseClass() {
		return ListVccGrantRulesResponse.class;
	}
