 ...
 * @version 
 */
public class DeleteErAttachmentRequest extends RpcAcsRequest<DeleteErAttachmentResponse> {
	   

	private String erId;

	private String erAttachmentId;
	public DeleteErAttachmentRequest() {
		super("eflo", "2022-05-30", "DeleteErAttachment", "eflo");
	...
	@Override
	public Class<DeleteErAttachmentResponse> getResponseClass() {
		return DeleteErAttachmentResponse.class;
	}
