 ...
 * @version 
 */
public class GetVpdGrantRuleRequest extends RpcAcsRequest<GetVpdGrantRuleResponse> {
	...
	public GetVpdGrantRuleRequest() {
		super("eflo", "2022-05-30", "GetVpdGrantRule", "eflo");
	...
	@Override
	public Class<GetVpdGrantRuleResponse> getResponseClass() {
		return GetVpdGrantRuleResponse.class;
	}
