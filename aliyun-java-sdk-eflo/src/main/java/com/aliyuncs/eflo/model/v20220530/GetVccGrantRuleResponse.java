...
import com.aliyuncs.eflo.transform.v20220530.GetVccGrantRuleResponseUnmarshaller;
 ...
 * @version 
 */
public class GetVccGrantRuleResponse extends AcsResponse {
	...
	@Override
	public GetVccGrantRuleResponse getInstance(UnmarshallerContext context) {
		return	GetVccGrantRuleResponseUnmarshaller.unmarshall(this, context);
	}
