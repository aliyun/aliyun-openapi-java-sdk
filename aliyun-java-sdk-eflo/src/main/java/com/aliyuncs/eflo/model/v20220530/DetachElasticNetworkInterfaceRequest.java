 ...
 * @version 
 */
public class DetachElasticNetworkInterfaceRequest extends RpcAcsRequest<DetachElasticNetworkInterfaceResponse> {
	   

	private String nodeId;

	private String elasticNetworkInterfaceId;
	public DetachElasticNetworkInterfaceRequest() {
		super("eflo", "2022-05-30", "DetachElasticNetworkInterface", "eflo");
	...
	@Override
	public Class<DetachElasticNetworkInterfaceResponse> getResponseClass() {
		return DetachElasticNetworkInterfaceResponse.class;
	}
