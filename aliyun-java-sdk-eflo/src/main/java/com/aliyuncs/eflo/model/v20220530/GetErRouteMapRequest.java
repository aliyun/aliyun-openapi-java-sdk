 ...
 * @version 
 */
public class GetErRouteMapRequest extends RpcAcsRequest<GetErRouteMapResponse> {
	   

	private String erId;

	private String erRouteMapId;
	public GetErRouteMapRequest() {
		super("eflo", "2022-05-30", "GetErRouteMap", "eflo");
	...
	@Override
	public Class<GetErRouteMapResponse> getResponseClass() {
		return GetErRouteMapResponse.class;
	}
