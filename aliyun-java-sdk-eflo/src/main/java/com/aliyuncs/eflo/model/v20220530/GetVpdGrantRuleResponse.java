...
import com.aliyuncs.eflo.transform.v20220530.GetVpdGrantRuleResponseUnmarshaller;
 ...
 * @version 
 */
public class GetVpdGrantRuleResponse extends AcsResponse {
	...
	@Override
	public GetVpdGrantRuleResponse getInstance(UnmarshallerContext context) {
		return	GetVpdGrantRuleResponseUnmarshaller.unmarshall(this, context);
	}
