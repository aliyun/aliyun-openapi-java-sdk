...
import com.aliyuncs.eflo.transform.v20220530.ListVpdGrantRulesResponseUnmarshaller;
 ...
 * @version 
 */
public class ListVpdGrantRulesResponse extends AcsResponse {
	...
	@Override
	public ListVpdGrantRulesResponse getInstance(UnmarshallerContext context) {
		return	ListVpdGrantRulesResponseUnmarshaller.unmarshall(this, context);
	}
