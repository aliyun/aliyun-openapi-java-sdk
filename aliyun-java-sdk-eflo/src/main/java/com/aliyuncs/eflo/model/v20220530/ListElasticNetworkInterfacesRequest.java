 ...
 * @version 
 */
public class ListElasticNetworkInterfacesRequest extends RpcAcsRequest<ListElasticNetworkInterfacesResponse> {
	...
	public ListElasticNetworkInterfacesRequest() {
		super("eflo", "2022-05-30", "ListElasticNetworkInterfaces", "eflo");
	...
	@Override
	public Class<ListElasticNetworkInterfacesResponse> getResponseClass() {
		return ListElasticNetworkInterfacesResponse.class;
	}
