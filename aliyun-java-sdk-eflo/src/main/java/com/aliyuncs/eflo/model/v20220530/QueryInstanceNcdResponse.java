...
import com.aliyuncs.eflo.transform.v20220530.QueryInstanceNcdResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryInstanceNcdResponse extends AcsResponse {
	...
	@Override
	public QueryInstanceNcdResponse getInstance(UnmarshallerContext context) {
		return	QueryInstanceNcdResponseUnmarshaller.unmarshall(this, context);
	}
