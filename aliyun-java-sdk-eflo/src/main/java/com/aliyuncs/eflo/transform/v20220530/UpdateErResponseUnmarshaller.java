...
import com.aliyuncs.eflo.model.v20220530.UpdateErResponse;
...
public class UpdateErResponseUnmarshaller {
	...
	public static UpdateErResponse unmarshall(UpdateErResponse updateErResponse, UnmarshallerContext _ctx) {
		
		updateErResponse.setRequestId(_ctx.stringValue("UpdateErResponse.RequestId"));
