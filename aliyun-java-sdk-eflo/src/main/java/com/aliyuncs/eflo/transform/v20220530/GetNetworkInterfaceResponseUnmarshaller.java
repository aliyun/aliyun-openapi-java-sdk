...
public class GetNetworkInterfaceResponseUnmarshaller {
	...
	public static GetNetworkInterfaceResponse unmarshall(GetNetworkInterfaceResponse getNetworkInterfaceResponse, UnmarshallerContext _ctx) {
		...
		content.setGmtCreate(_ctx.stringValue("GetNetworkInterfaceResponse.Content.GmtCreate"));
		...
		vpdBaseInfo.setName(_ctx.stringValue("GetNetworkInterfaceResponse.Content.VpdBaseInfo.Name"));
		vpdBaseInfo.setCidr(_ctx.stringValue("GetNetworkInterfaceResponse.Content.VpdBaseInfo.Cidr"));
		vpdBaseInfo.setGmtCreate(_ctx.stringValue("GetNetworkInterfaceResponse.Content.VpdBaseInfo.GmtCreate"));
		...
		subnetBaseInfo.setName(_ctx.stringValue("GetNetworkInterfaceResponse.Content.SubnetBaseInfo.Name"));
		subnetBaseInfo.setCidr(_ctx.stringValue("GetNetworkInterfaceResponse.Content.SubnetBaseInfo.Cidr"));
		subnetBaseInfo.setGmtCreate(_ctx.stringValue("GetNetworkInterfaceResponse.Content.SubnetBaseInfo.GmtCreate"));
