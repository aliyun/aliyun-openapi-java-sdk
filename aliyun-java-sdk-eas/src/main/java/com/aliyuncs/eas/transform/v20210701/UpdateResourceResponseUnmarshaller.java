...
import com.aliyuncs.eas.model.v20210701.UpdateResourceResponse;
...
public class UpdateResourceResponseUnmarshaller {
	...
	public static UpdateResourceResponse unmarshall(UpdateResourceResponse updateResourceResponse, UnmarshallerContext _ctx) {
		...
		updateResourceResponse.setResourceId(_ctx.stringValue("UpdateResourceResponse.ResourceId"));
		updateResourceResponse.setResourceName(_ctx.stringValue("UpdateResourceResponse.ResourceName"));
