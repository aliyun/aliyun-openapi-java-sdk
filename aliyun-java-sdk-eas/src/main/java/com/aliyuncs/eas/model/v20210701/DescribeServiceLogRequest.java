...
public class DescribeServiceLogRequest extends RoaAcsRequest<DescribeServiceLogResponse> {
	...
	public DescribeServiceLogRequest() {
		super("eas", "2021-07-01", "DescribeServiceLog", "eas");
		setUriPattern("/api/v2/services/[ClusterId]/[ServiceName]/logs");
	...
	@Override
	public Class<DescribeServiceLogResponse> getResponseClass() {
		return DescribeServiceLogResponse.class;
	}
