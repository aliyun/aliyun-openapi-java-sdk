 ...
 * @version 
 */
public class GetServiceVersionRequest extends RoaAcsRequest<GetServiceVersionResponse> {
	...
	public GetServiceVersionRequest() {
		super("eas", "2017-10-23", "GetServiceVersion", "pai");
	...
	@Override
	public Class<GetServiceVersionResponse> getResponseClass() {
		return GetServiceVersionResponse.class;
	}
