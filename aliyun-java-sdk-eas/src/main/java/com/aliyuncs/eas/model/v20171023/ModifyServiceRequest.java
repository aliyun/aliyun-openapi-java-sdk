 ...
 * @version 
 */
public class ModifyServiceRequest extends RoaAcsRequest<ModifyServiceResponse> {
	...
	public ModifyServiceRequest() {
		super("eas", "2017-10-23", "ModifyService", "pai");
		setUriPattern("/api/services/[region]/[service_name]");
