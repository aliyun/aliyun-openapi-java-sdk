 ...
 * @version 
 */
public class CreateNetworkInterfaceRequest extends RoaAcsRequest<CreateNetworkInterfaceResponse> {
	...
	public CreateNetworkInterfaceRequest() {
		super("eas", "2018-05-22", "CreateNetworkInterface");
		setUriPattern("/api/resources/[cluster_id]/[resource_name]/network");
