...
import com.aliyuncs.eas.transform.v20210701.ListResourceServicesResponseUnmarshaller;
 ...
 * @version 
 */
public class ListResourceServicesResponse extends AcsResponse {
	...
	@Override
	public ListResourceServicesResponse getInstance(UnmarshallerContext context) {
		return	ListResourceServicesResponseUnmarshaller.unmarshall(this, context);
	}
