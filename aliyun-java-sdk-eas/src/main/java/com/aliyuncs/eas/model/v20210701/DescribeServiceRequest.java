 ...
 * @version 
 */
public class DescribeServiceRequest extends RoaAcsRequest<DescribeServiceResponse> {
	...
	public DescribeServiceRequest() {
		super("eas", "2021-07-01", "DescribeService", "eas");
		setUriPattern("/api/v2/services/[ClusterId]/[ServiceName]");
