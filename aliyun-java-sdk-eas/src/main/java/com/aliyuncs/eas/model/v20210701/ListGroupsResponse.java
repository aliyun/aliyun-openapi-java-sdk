...
import com.aliyuncs.eas.transform.v20210701.ListGroupsResponseUnmarshaller;
...
public class ListGroupsResponse extends AcsResponse {
	...
	public List<服务组列表> getGroups() {
		return this.groups;
	}

	public void setGroups(List<服务组列表> groups) {
		this.groups = groups;
	}

	public static class 服务组列表 {
