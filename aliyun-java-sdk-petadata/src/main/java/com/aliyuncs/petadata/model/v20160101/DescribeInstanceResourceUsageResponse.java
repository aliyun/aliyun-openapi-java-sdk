...
import com.aliyuncs.petadata.transform.v20160101.DescribeInstanceResourceUsageResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeInstanceResourceUsageResponse extends AcsResponse {
	...
	@Override
	public DescribeInstanceResourceUsageResponse getInstance(UnmarshallerContext context) {
		return	DescribeInstanceResourceUsageResponseUnmarshaller.unmarshall(this, context);
	}
}
