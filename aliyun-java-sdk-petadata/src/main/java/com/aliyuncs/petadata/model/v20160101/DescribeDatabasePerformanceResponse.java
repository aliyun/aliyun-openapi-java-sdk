...
import com.aliyuncs.petadata.transform.v20160101.DescribeDatabasePerformanceResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeDatabasePerformanceResponse extends AcsResponse {
	...
	@Override
	public DescribeDatabasePerformanceResponse getInstance(UnmarshallerContext context) {
		return	DescribeDatabasePerformanceResponseUnmarshaller.unmarshall(this, context);
	}
}
