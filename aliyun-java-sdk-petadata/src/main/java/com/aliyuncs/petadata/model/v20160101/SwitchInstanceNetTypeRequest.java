 ...
 * @version 
 */
public class SwitchInstanceNetTypeRequest extends RpcAcsRequest<SwitchInstanceNetTypeResponse> {
	
	public SwitchInstanceNetTypeRequest() {
		super("PetaData", "2016-01-01", "SwitchInstanceNetType", "petadata");
	}
	...
	@Override
	public Class<SwitchInstanceNetTypeResponse> getResponseClass() {
		return SwitchInstanceNetTypeResponse.class;
	}
