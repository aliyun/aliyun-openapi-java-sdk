...
import com.aliyuncs.petadata.model.v20160101.ModifySecurityIPsResponse;
...
public class ModifySecurityIPsResponseUnmarshaller {
	...
	public static ModifySecurityIPsResponse unmarshall(ModifySecurityIPsResponse modifySecurityIPsResponse, UnmarshallerContext context) {
		...
		modifySecurityIPsResponse.setInstanceId(context.stringValue("ModifySecurityIPsResponse.InstanceId"));
		modifySecurityIPsResponse.setSecurityIPList(context.stringValue("ModifySecurityIPsResponse.SecurityIPList"));
