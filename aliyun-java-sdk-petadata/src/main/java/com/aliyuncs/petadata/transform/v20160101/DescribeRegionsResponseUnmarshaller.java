...
import com.aliyuncs.petadata.model.v20160101.DescribeRegionsResponse;
import com.aliyuncs.petadata.model.v20160101.DescribeRegionsResponse.Region;
import com.aliyuncs.petadata.model.v20160101.DescribeRegionsResponse.Region.Zone;
...
public class DescribeRegionsResponseUnmarshaller {
	...
	public static DescribeRegionsResponse unmarshall(DescribeRegionsResponse describeRegionsResponse, UnmarshallerContext context) {
		...
		for (int i = 0; i < context.lengthValue("DescribeRegionsResponse.Regions.Length"); i++) {
			...
			region.setZoneId(context.stringValue("DescribeRegionsResponse.Regions["+ i +"].ZoneId"));
