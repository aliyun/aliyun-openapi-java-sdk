 ...
 * @version 
 */
public class CreateGifTaskRequest extends RpcAcsRequest<CreateGifTaskResponse> {
	...
	@Override
	public Class<CreateGifTaskResponse> getResponseClass() {
		return CreateGifTaskResponse.class;
	}
