...
public class UpdateImageResponseUnmarshaller {
	...
	public static UpdateImageResponse unmarshall(UpdateImageResponse updateImageResponse, UnmarshallerContext _ctx) {
		...
		updateImageResponse.setMessage(_ctx.stringValue("UpdateImageResponse.Message"));
		updateImageResponse.setErrorCode(_ctx.stringValue("UpdateImageResponse.ErrorCode"));
		updateImageResponse.setSuccess(_ctx.booleanValue("UpdateImageResponse.Success"));
