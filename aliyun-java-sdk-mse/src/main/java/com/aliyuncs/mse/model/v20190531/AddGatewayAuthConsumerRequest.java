 ...
 * @version 
 */
public class AddGatewayAuthConsumerRequest extends RpcAcsRequest<AddGatewayAuthConsumerResponse> {
	...
	public AddGatewayAuthConsumerRequest() {
		super("mse", "2019-05-31", "AddGatewayAuthConsumer", "mse");
	...
	@Override
	public Class<AddGatewayAuthConsumerResponse> getResponseClass() {
		return AddGatewayAuthConsumerResponse.class;
	}
