 ...
 * @version 
 */
public class ListConfigTrackRequest extends RpcAcsRequest<ListConfigTrackResponse> {
	...
	@Override
	public Class<ListConfigTrackResponse> getResponseClass() {
		return ListConfigTrackResponse.class;
	}
