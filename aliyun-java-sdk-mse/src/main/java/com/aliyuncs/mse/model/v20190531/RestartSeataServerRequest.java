 ...
 * @version 
 */
public class RestartSeataServerRequest extends RpcAcsRequest<RestartSeataServerResponse> {
	   

	private String acceptLanguage;

	private String seataServerUniqueId;
	public RestartSeataServerRequest() {
		super("mse", "2019-05-31", "RestartSeataServer", "mse");
	...
	@Override
	public Class<RestartSeataServerResponse> getResponseClass() {
		return RestartSeataServerResponse.class;
	}
