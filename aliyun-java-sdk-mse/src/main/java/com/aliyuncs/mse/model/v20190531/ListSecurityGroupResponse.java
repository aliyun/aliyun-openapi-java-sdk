...
import com.aliyuncs.mse.transform.v20190531.ListSecurityGroupResponseUnmarshaller;
...
public class ListSecurityGroupResponse extends AcsResponse {
	...
	public List<Sgs> getData() {
		return this.data;
	}

	public void setData(List<Sgs> data) {
		this.data = data;
	}
