 ...
 * @version 
 */
public class ApplyGatewayRouteRequest extends RpcAcsRequest<ApplyGatewayRouteResponse> {
	...
	@Override
	public Class<ApplyGatewayRouteResponse> getResponseClass() {
		return ApplyGatewayRouteResponse.class;
	}
