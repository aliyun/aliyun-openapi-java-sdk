...
import com.aliyuncs.mse.transform.v20190531.UpdateGatewayRouteWafStatusResponseUnmarshaller;
 ...
 * @version 
 */
public class UpdateGatewayRouteWafStatusResponse extends AcsResponse {
	...
	@Override
	public UpdateGatewayRouteWafStatusResponse getInstance(UnmarshallerContext context) {
		return	UpdateGatewayRouteWafStatusResponseUnmarshaller.unmarshall(this, context);
	}
