...
import com.aliyuncs.mse.transform.v20190531.ImportNacosConfigResponseUnmarshaller;
 ...
 * @version 
 */
public class ImportNacosConfigResponse extends AcsResponse {
	...
	@Override
	public ImportNacosConfigResponse getInstance(UnmarshallerContext context) {
		return	ImportNacosConfigResponseUnmarshaller.unmarshall(this, context);
	}
