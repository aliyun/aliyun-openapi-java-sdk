 ...
 * @version 
 */
public class ListGatewayAuthConsumerResourceRequest extends RpcAcsRequest<ListGatewayAuthConsumerResourceResponse> {
	...
	public ListGatewayAuthConsumerResourceRequest() {
		super("mse", "2019-05-31", "ListGatewayAuthConsumerResource", "mse");
	...
	@Override
	public Class<ListGatewayAuthConsumerResourceResponse> getResponseClass() {
		return ListGatewayAuthConsumerResourceResponse.class;
	}
