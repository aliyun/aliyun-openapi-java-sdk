 ...
 * @version 
 */
public class CreateNacosInstanceRequest extends RpcAcsRequest<CreateNacosInstanceResponse> {
	...
	public CreateNacosInstanceRequest() {
		super("mse", "2019-05-31", "CreateNacosInstance", "mse");
	...
	@Override
	public Class<CreateNacosInstanceResponse> getResponseClass() {
		return CreateNacosInstanceResponse.class;
	}
