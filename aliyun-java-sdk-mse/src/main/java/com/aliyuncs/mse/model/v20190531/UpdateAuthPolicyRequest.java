 ...
 * @version 
 */
public class UpdateAuthPolicyRequest extends RpcAcsRequest<UpdateAuthPolicyResponse> {
	...
	public UpdateAuthPolicyRequest() {
		super("mse", "2019-05-31", "UpdateAuthPolicy", "mse");
	...
	@Override
	public Class<UpdateAuthPolicyResponse> getResponseClass() {
		return UpdateAuthPolicyResponse.class;
	}
