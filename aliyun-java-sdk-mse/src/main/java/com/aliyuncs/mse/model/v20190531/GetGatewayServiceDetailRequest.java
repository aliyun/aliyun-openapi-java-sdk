 ...
 * @version 
 */
public class GetGatewayServiceDetailRequest extends RpcAcsRequest<GetGatewayServiceDetailResponse> {
	...
	@Override
	public Class<GetGatewayServiceDetailResponse> getResponseClass() {
		return GetGatewayServiceDetailResponse.class;
	}
