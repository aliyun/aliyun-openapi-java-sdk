 ...
 * @version 
 */
public class UpdateGatewayServiceVersionRequest extends RpcAcsRequest<UpdateGatewayServiceVersionResponse> {
	...
	@Override
	public Class<UpdateGatewayServiceVersionResponse> getResponseClass() {
		return UpdateGatewayServiceVersionResponse.class;
	}
