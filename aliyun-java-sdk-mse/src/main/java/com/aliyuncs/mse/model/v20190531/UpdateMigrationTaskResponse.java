...
import com.aliyuncs.mse.transform.v20190531.UpdateMigrationTaskResponseUnmarshaller;
 ...
 * @version 
 */
public class UpdateMigrationTaskResponse extends AcsResponse {
	...
	@Override
	public UpdateMigrationTaskResponse getInstance(UnmarshallerContext context) {
		return	UpdateMigrationTaskResponseUnmarshaller.unmarshall(this, context);
	}
