 ...
 * @version 
 */
public class DeleteGatewayServiceVersionRequest extends RpcAcsRequest<DeleteGatewayServiceVersionResponse> {
	...
	@Override
	public Class<DeleteGatewayServiceVersionResponse> getResponseClass() {
		return DeleteGatewayServiceVersionResponse.class;
	}
