 ...
 * @version 
 */
public class AddMigrationTaskRequest extends RpcAcsRequest<AddMigrationTaskResponse> {
	...
	public AddMigrationTaskRequest() {
		super("mse", "2019-05-31", "AddMigrationTask", "mse");
	...
	@Override
	public Class<AddMigrationTaskResponse> getResponseClass() {
		return AddMigrationTaskResponse.class;
	}
