...
import com.aliyuncs.mse.transform.v20190531.QueryGovernanceKubernetesClusterResponseUnmarshaller;
...
public class QueryGovernanceKubernetesClusterResponse extends AcsResponse {
	...
	@Override
	public QueryGovernanceKubernetesClusterResponse getInstance(UnmarshallerContext context) {
		return	QueryGovernanceKubernetesClusterResponseUnmarshaller.unmarshall(this, context);
	}
