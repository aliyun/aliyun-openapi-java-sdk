 ...
 * @version 
 */
public class ModifyGovernanceKubernetesClusterRequest extends RpcAcsRequest<ModifyGovernanceKubernetesClusterResponse> {
	...
	@Override
	public Class<ModifyGovernanceKubernetesClusterResponse> getResponseClass() {
		return ModifyGovernanceKubernetesClusterResponse.class;
	}
