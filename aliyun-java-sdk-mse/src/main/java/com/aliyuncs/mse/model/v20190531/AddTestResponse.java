...
import com.aliyuncs.mse.transform.v20190531.AddTestResponseUnmarshaller;
 ...
 * @version 
 */
public class AddTestResponse extends AcsResponse {
	...
	@Override
	public AddTestResponse getInstance(UnmarshallerContext context) {
		return	AddTestResponseUnmarshaller.unmarshall(this, context);
	}
