 ...
 * @version 
 */
public class AddBlackWhiteListRequest extends RpcAcsRequest<AddBlackWhiteListResponse> {
	...
	@Override
	public Class<AddBlackWhiteListResponse> getResponseClass() {
		return AddBlackWhiteListResponse.class;
	}
