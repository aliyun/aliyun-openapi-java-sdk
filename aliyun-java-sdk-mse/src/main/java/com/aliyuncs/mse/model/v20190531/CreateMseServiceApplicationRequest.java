...
public class CreateMseServiceApplicationRequest extends RpcAcsRequest<CreateMseServiceApplicationResponse> {
	...
	public CreateMseServiceApplicationRequest() {
		super("mse", "2019-05-31", "CreateMseServiceApplication", "mse");
	...
	@Override
	public Class<CreateMseServiceApplicationResponse> getResponseClass() {
		return CreateMseServiceApplicationResponse.class;
	}
