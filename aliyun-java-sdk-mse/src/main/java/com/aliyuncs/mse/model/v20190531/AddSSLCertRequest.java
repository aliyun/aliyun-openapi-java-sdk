 ...
 * @version 
 */
public class AddSSLCertRequest extends RpcAcsRequest<AddSSLCertResponse> {
	...
	@Override
	public Class<AddSSLCertResponse> getResponseClass() {
		return AddSSLCertResponse.class;
	}
