...
import com.aliyuncs.mse.transform.v20190531.CreateCircuitBreakerRuleResponseUnmarshaller;
 ...
 * @version 
 */
public class CreateCircuitBreakerRuleResponse extends AcsResponse {
	...
	@Override
	public CreateCircuitBreakerRuleResponse getInstance(UnmarshallerContext context) {
		return	CreateCircuitBreakerRuleResponseUnmarshaller.unmarshall(this, context);
	}
