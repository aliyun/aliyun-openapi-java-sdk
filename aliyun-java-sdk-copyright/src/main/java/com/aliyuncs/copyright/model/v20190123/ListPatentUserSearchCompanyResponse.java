...
public class ListPatentUserSearchCompanyResponse extends AcsResponse {
	...
	@Override
	public ListPatentUserSearchCompanyResponse getInstance(UnmarshallerContext context) {
		return	ListPatentUserSearchCompanyResponseUnmarshaller.unmarshall(this, context);
	}
