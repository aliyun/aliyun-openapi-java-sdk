...
import com.aliyuncs.itaas.transform.v20170505.GetRegisterBoxListResponseUnmarshaller;
 ...
 * @version 
 */
public class GetRegisterBoxListResponse extends AcsResponse {
	...
	@Override
	public GetRegisterBoxListResponse getInstance(UnmarshallerContext context) {
		return	GetRegisterBoxListResponseUnmarshaller.unmarshall(this, context);
	}
}
