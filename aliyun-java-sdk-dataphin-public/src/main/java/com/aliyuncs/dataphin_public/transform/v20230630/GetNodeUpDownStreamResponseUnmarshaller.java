...
public class GetNodeUpDownStreamResponseUnmarshaller {
	...
	public static GetNodeUpDownStreamResponse unmarshall(GetNodeUpDownStreamResponse getNodeUpDownStreamResponse, UnmarshallerContext _ctx) {
		...
		for (int i = 0; i < _ctx.lengthValue("GetNodeUpDownStreamResponse.NodeDagInfo.UpStreamNodeList.Length"); i++) {
			...
			nodeInfo.setType(_ctx.stringValue("GetNodeUpDownStreamResponse.NodeDagInfo.UpStreamNodeList["+ i +"].Type"));
			nodeInfo.setId(_ctx.stringValue("GetNodeUpDownStreamResponse.NodeDagInfo.UpStreamNodeList["+ i +"].Id"));
			nodeInfo.setName(_ctx.stringValue("GetNodeUpDownStreamResponse.NodeDagInfo.UpStreamNodeList["+ i +"].Name"));
		...
		for (int i = 0; i < _ctx.lengthValue("GetNodeUpDownStreamResponse.NodeDagInfo.DownStreamNodeList.Length"); i++) {
			...
			nodeInfo1.setType(_ctx.stringValue("GetNodeUpDownStreamResponse.NodeDagInfo.DownStreamNodeList["+ i +"].Type"));
			nodeInfo1.setId(_ctx.stringValue("GetNodeUpDownStreamResponse.NodeDagInfo.DownStreamNodeList["+ i +"].Id"));
			nodeInfo1.setName(_ctx.stringValue("GetNodeUpDownStreamResponse.NodeDagInfo.DownStreamNodeList["+ i +"].Name"));
			...
			downStreamNodeList.add(nodeInfo1);
		}
		...
		for (int i = 0; i < _ctx.lengthValue("GetNodeUpDownStreamResponse.NodeDagInfo.StartNodeList.Length"); i++) {
			...
			nodeInfo2.setType(_ctx.stringValue("GetNodeUpDownStreamResponse.NodeDagInfo.StartNodeList["+ i +"].Type"));
			nodeInfo2.setId(_ctx.stringValue("GetNodeUpDownStreamResponse.NodeDagInfo.StartNodeList["+ i +"].Id"));
			nodeInfo2.setName(_ctx.stringValue("GetNodeUpDownStreamResponse.NodeDagInfo.StartNodeList["+ i +"].Name"));
