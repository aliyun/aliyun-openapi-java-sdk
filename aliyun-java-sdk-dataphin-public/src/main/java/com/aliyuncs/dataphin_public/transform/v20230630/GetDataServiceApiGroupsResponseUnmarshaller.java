...
import com.aliyuncs.dataphin_public.model.v20230630.GetDataServiceApiGroupsResponse;
import com.aliyuncs.dataphin_public.model.v20230630.GetDataServiceApiGroupsResponse.ApiGroup;
import com.aliyuncs.transform.UnmarshallerContext;


public class GetDataServiceApiGroupsResponseUnmarshaller {
	...
	public static GetDataServiceApiGroupsResponse unmarshall(GetDataServiceApiGroupsResponse getDataServiceApiGroupsResponse, UnmarshallerContext _ctx) {
		...
		for (int i = 0; i < _ctx.lengthValue("GetDataServiceApiGroupsResponse.ApiGroupList.Length"); i++) {
			...
			apiGroup.setId(_ctx.integerValue("GetDataServiceApiGroupsResponse.ApiGroupList["+ i +"].Id"));
			apiGroup.setName(_ctx.stringValue("GetDataServiceApiGroupsResponse.ApiGroupList["+ i +"].Name"));

			apiGroupList.add(apiGroup);
		}
		getDataServiceApiGroupsResponse.setApiGroupList(apiGroupList);
