 ...
 * @version 
 */
public class ApplyDataServiceApiRequest extends RpcAcsRequest<ApplyDataServiceApiResponse> {
	...
	public static class ApplyCommand {
		...
		public static class DevFieldListItem {
	...
	@Override
	public Class<ApplyDataServiceApiResponse> getResponseClass() {
		return ApplyDataServiceApiResponse.class;
	}
