 ...
 * @version 
 */
public class CreateComputeClusterRequest extends RpcAcsRequest<CreateComputeClusterResponse> {
	...
	@Override
	public Class<CreateComputeClusterResponse> getResponseClass() {
		return CreateComputeClusterResponse.class;
	}
