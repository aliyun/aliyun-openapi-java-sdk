...
import com.aliyuncs.dataphin_public.transform.v20230630.GetLlmModelProviderByNameResponseUnmarshaller;
 ...
 * @version 
 */
public class GetLlmModelProviderByNameResponse extends AcsResponse {
	...
	@Override
	public GetLlmModelProviderByNameResponse getInstance(UnmarshallerContext context) {
		return	GetLlmModelProviderByNameResponseUnmarshaller.unmarshall(this, context);
	}
