...
import com.aliyuncs.dataphin_public.transform.v20230630.GetQualityWatchByObjectIdResponseUnmarshaller;
 ...
 * @version 
 */
public class GetQualityWatchByObjectIdResponse extends AcsResponse {
	...
	@Override
	public GetQualityWatchByObjectIdResponse getInstance(UnmarshallerContext context) {
		return	GetQualityWatchByObjectIdResponseUnmarshaller.unmarshall(this, context);
	}
