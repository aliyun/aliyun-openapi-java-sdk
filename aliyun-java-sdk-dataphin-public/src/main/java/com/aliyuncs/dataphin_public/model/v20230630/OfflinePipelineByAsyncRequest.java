 ...
 * @version 
 */
public class OfflinePipelineByAsyncRequest extends RpcAcsRequest<OfflinePipelineByAsyncResponse> {
	...
	@Override
	public Class<OfflinePipelineByAsyncResponse> getResponseClass() {
		return OfflinePipelineByAsyncResponse.class;
	}
