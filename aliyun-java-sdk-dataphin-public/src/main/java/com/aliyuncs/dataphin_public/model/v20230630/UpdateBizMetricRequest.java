 ...
 * @version 
 */
public class UpdateBizMetricRequest extends RpcAcsRequest<UpdateBizMetricResponse> {
	...
	public UpdateBizMetricRequest() {
		super("dataphin-public", "2023-06-30", "UpdateBizMetric");
	...
	public void setUpdateBizMetricCommand(UpdateBizMetricCommand updateBizMetricCommand) {
		this.updateBizMetricCommand = updateBizMetricCommand;	
		if (updateBizMetricCommand != null) {
			putBodyParameter("UpdateBizMetricCommand" , new Gson().toJson(updateBizMetricCommand));
		}	
	}

	public static class UpdateBizMetricCommand {
	...
	@Override
	public Class<UpdateBizMetricResponse> getResponseClass() {
		return UpdateBizMetricResponse.class;
	}
