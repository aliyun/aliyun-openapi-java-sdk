...
import com.aliyuncs.dataphin_public.transform.v20230630.GetQualityTemplateResponseUnmarshaller;
 ...
 * @version 
 */
public class GetQualityTemplateResponse extends AcsResponse {
	...
	public static class QualityTemplateInfo {
	...
	@Override
	public GetQualityTemplateResponse getInstance(UnmarshallerContext context) {
		return	GetQualityTemplateResponseUnmarshaller.unmarshall(this, context);
	}
