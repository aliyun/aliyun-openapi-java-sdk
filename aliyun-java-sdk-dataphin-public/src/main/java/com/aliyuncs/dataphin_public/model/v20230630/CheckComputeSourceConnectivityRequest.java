 ...
 * @version 
 */
public class CheckComputeSourceConnectivityRequest extends RpcAcsRequest<CheckComputeSourceConnectivityResponse> {
	...
	public CheckComputeSourceConnectivityRequest() {
		super("dataphin-public", "2023-06-30", "CheckComputeSourceConnectivity");
	...
	@Override
	public Class<CheckComputeSourceConnectivityResponse> getResponseClass() {
		return CheckComputeSourceConnectivityResponse.class;
	}
