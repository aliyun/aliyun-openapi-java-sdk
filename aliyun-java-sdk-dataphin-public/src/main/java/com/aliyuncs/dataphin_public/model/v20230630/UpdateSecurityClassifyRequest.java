 ...
 * @version 
 */
public class UpdateSecurityClassifyRequest extends RpcAcsRequest<UpdateSecurityClassifyResponse> {
	...
	public UpdateSecurityClassifyRequest() {
		super("dataphin-public", "2023-06-30", "UpdateSecurityClassify");
	...
	@Override
	public Class<UpdateSecurityClassifyResponse> getResponseClass() {
		return UpdateSecurityClassifyResponse.class;
	}
