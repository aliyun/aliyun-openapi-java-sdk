 ...
 * @version 
 */
public class SubmitAssetsOnShelveRequest extends RpcAcsRequest<SubmitAssetsOnShelveResponse> {
	...
	@Override
	public Class<SubmitAssetsOnShelveResponse> getResponseClass() {
		return SubmitAssetsOnShelveResponse.class;
	}
