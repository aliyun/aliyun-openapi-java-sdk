 ...
 * @version 
 */
public class DeleteStandardRelationsRequest extends RpcAcsRequest<DeleteStandardRelationsResponse> {
	...
	public DeleteStandardRelationsRequest() {
		super("dataphin-public", "2023-06-30", "DeleteStandardRelations");
	...
	@Override
	public Class<DeleteStandardRelationsResponse> getResponseClass() {
		return DeleteStandardRelationsResponse.class;
	}
