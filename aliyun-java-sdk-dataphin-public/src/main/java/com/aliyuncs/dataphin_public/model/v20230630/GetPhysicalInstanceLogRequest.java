 ...
 * @version 
 */
public class GetPhysicalInstanceLogRequest extends RpcAcsRequest<GetPhysicalInstanceLogResponse> {
	...
	@Override
	public Class<GetPhysicalInstanceLogResponse> getResponseClass() {
