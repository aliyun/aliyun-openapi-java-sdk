...
import com.aliyuncs.dataphin_public.transform.v20230630.DeleteSecurityClassifyCatalogResponseUnmarshaller;
 ...
 * @version 
 */
public class DeleteSecurityClassifyCatalogResponse extends AcsResponse {
	...
	@Override
	public DeleteSecurityClassifyCatalogResponse getInstance(UnmarshallerContext context) {
		return	DeleteSecurityClassifyCatalogResponseUnmarshaller.unmarshall(this, context);
	}
