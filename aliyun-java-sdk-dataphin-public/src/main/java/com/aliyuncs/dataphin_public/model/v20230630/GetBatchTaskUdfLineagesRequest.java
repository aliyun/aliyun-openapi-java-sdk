 ...
 * @version 
 */
public class GetBatchTaskUdfLineagesRequest extends RpcAcsRequest<GetBatchTaskUdfLineagesResponse> {
	...
	@Override
	public Class<GetBatchTaskUdfLineagesResponse> getResponseClass() {
