 ...
 * @version 
 */
public class CreateStandardTemplateRequest extends RpcAcsRequest<CreateStandardTemplateResponse> {
	...
	public CreateStandardTemplateRequest() {
		super("dataphin-public", "2023-06-30", "CreateStandardTemplate", "Dataphin");
	...
	@Override
	public Class<CreateStandardTemplateResponse> getResponseClass() {
		return CreateStandardTemplateResponse.class;
	}
