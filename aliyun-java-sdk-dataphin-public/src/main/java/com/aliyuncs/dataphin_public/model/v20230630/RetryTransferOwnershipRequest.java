 ...
 * @version 
 */
public class RetryTransferOwnershipRequest extends RpcAcsRequest<RetryTransferOwnershipResponse> {
	...
	public RetryTransferOwnershipRequest() {
		super("dataphin-public", "2023-06-30", "RetryTransferOwnership");
	...
	@Override
	public Class<RetryTransferOwnershipResponse> getResponseClass() {
		return RetryTransferOwnershipResponse.class;
	}
