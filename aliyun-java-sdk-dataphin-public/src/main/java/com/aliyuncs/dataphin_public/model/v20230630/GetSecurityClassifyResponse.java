...
import com.aliyuncs.dataphin_public.transform.v20230630.GetSecurityClassifyResponseUnmarshaller;
 ...
 * @version 
 */
public class GetSecurityClassifyResponse extends AcsResponse {
	...
	public void setSecurityClassifyInfo(SecurityClassifyInfo securityClassifyInfo) {
	...
	@Override
	public GetSecurityClassifyResponse getInstance(UnmarshallerContext context) {
		return	GetSecurityClassifyResponseUnmarshaller.unmarshall(this, context);
	}
