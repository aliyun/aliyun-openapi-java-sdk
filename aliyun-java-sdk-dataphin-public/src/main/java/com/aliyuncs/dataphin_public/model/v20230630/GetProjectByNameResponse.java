...
import com.aliyuncs.dataphin_public.transform.v20230630.GetProjectByNameResponseUnmarshaller;
 ...
 * @version 
 */
public class GetProjectByNameResponse extends AcsResponse {
	...
	@Override
	public GetProjectByNameResponse getInstance(UnmarshallerContext context) {
		return	GetProjectByNameResponseUnmarshaller.unmarshall(this, context);
	}
