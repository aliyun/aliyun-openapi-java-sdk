 ...
 * @version 
 */
public class DeleteSecurityIdentifyResultsRequest extends RpcAcsRequest<DeleteSecurityIdentifyResultsResponse> {
	...
	public DeleteSecurityIdentifyResultsRequest() {
		super("dataphin-public", "2023-06-30", "DeleteSecurityIdentifyResults");
	...
	@Override
	public Class<DeleteSecurityIdentifyResultsResponse> getResponseClass() {
		return DeleteSecurityIdentifyResultsResponse.class;
	}
