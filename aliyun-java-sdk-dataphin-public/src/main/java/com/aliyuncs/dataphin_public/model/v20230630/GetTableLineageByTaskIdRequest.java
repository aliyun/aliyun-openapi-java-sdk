 ...
 * @version 
 */
public class GetTableLineageByTaskIdRequest extends RpcAcsRequest<GetTableLineageByTaskIdResponse> {
	...
	public GetTableLineageByTaskIdRequest() {
		super("dataphin-public", "2023-06-30", "GetTableLineageByTaskId");
	...
	public void setTableLineageByTaskIdQuery(TableLineageByTaskIdQuery tableLineageByTaskIdQuery) {
		this.tableLineageByTaskIdQuery = tableLineageByTaskIdQuery;	
		if (tableLineageByTaskIdQuery != null) {
			putBodyParameter("TableLineageByTaskIdQuery" , new Gson().toJson(tableLineageByTaskIdQuery));
		}	
	}

	public static class TableLineageByTaskIdQuery {
	...
	@Override
	public Class<GetTableLineageByTaskIdResponse> getResponseClass() {
		return GetTableLineageByTaskIdResponse.class;
	}
