 ...
 * @version 
 */
public class BatchCreateKgRelationRequest extends RpcAcsRequest<BatchCreateKgRelationResponse> {
	...
	public BatchCreateKgRelationRequest() {
		super("dataphin-public", "2023-06-30", "BatchCreateKgRelation");
	...
	@Override
	public Class<BatchCreateKgRelationResponse> getResponseClass() {
		return BatchCreateKgRelationResponse.class;
	}
