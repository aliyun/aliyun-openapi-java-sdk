 ...
 * @version 
 */
public class UpdateDataServiceAppMemberRequest extends RpcAcsRequest<UpdateDataServiceAppMemberResponse> {
	...
	public UpdateDataServiceAppMemberRequest() {
		super("dataphin-public", "2023-06-30", "UpdateDataServiceAppMember");
	...
	@Override
	public Class<UpdateDataServiceAppMemberResponse> getResponseClass() {
		return UpdateDataServiceAppMemberResponse.class;
	}
