 ...
 * @version 
 */
public class GetOperationSubmitStatusRequest extends RpcAcsRequest<GetOperationSubmitStatusResponse> {
	...
	@Override
	public Class<GetOperationSubmitStatusResponse> getResponseClass() {
