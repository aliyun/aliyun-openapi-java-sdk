 ...
 * @version 
 */
public class UpdateAdHocFileRequest extends RpcAcsRequest<UpdateAdHocFileResponse> {
	...
	@Override
	public Class<UpdateAdHocFileResponse> getResponseClass() {
		return UpdateAdHocFileResponse.class;
	}
