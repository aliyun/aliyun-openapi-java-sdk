...
import com.aliyuncs.dataphin_public.transform.v20230630.GetOperationRecordByIdResponseUnmarshaller;
 ...
 * @version 
 */
public class GetOperationRecordByIdResponse extends AcsResponse {
	...
	@Override
	public GetOperationRecordByIdResponse getInstance(UnmarshallerContext context) {
		return	GetOperationRecordByIdResponseUnmarshaller.unmarshall(this, context);
	}
