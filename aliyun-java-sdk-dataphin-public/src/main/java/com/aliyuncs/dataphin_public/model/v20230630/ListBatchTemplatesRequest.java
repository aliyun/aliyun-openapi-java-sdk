 ...
 * @version 
 */
public class ListBatchTemplatesRequest extends RpcAcsRequest<ListBatchTemplatesResponse> {
	...
	@Override
	public Class<ListBatchTemplatesResponse> getResponseClass() {
		return ListBatchTemplatesResponse.class;
	}
