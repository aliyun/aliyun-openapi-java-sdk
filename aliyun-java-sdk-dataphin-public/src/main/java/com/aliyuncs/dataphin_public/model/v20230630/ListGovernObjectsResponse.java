...
import com.aliyuncs.dataphin_public.transform.v20230630.ListGovernObjectsResponseUnmarshaller;
 ...
 * @version 
 */
public class ListGovernObjectsResponse extends AcsResponse {
	...
	@Override
	public ListGovernObjectsResponse getInstance(UnmarshallerContext context) {
		return	ListGovernObjectsResponseUnmarshaller.unmarshall(this, context);
	}
