 ...
 * @version 
 */
public class UpdateComputeSourceRequest extends RpcAcsRequest<UpdateComputeSourceResponse> {
	...
	@Override
	public Class<UpdateComputeSourceResponse> getResponseClass() {
		return UpdateComputeSourceResponse.class;
	}
