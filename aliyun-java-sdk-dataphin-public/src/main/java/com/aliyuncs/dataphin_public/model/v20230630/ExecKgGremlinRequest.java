 ...
 * @version 
 */
public class ExecKgGremlinRequest extends RpcAcsRequest<ExecKgGremlinResponse> {
	...
	@Override
	public Class<ExecKgGremlinResponse> getResponseClass() {
		return ExecKgGremlinResponse.class;
	}
