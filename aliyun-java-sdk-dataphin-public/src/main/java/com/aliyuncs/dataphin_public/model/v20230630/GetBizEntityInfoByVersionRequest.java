 ...
 * @version 
 */
public class GetBizEntityInfoByVersionRequest extends RpcAcsRequest<GetBizEntityInfoByVersionResponse> {
	...
	@Override
	public Class<GetBizEntityInfoByVersionResponse> getResponseClass() {
