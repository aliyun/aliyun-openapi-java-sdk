...
import com.aliyuncs.dataphin_public.transform.v20230630.GetBelongAssetMappingResponseUnmarshaller;
 ...
 * @version 
 */
public class GetBelongAssetMappingResponse extends AcsResponse {
	...
	@Override
	public GetBelongAssetMappingResponse getInstance(UnmarshallerContext context) {
		return	GetBelongAssetMappingResponseUnmarshaller.unmarshall(this, context);
	}
