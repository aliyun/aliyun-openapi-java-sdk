 ...
 * @version 
 */
public class CreateRowPermissionRequest extends RpcAcsRequest<CreateRowPermissionResponse> {
	...
	public void setCreateRowPermissionCommand(CreateRowPermissionCommand createRowPermissionCommand) {
		this.createRowPermissionCommand = createRowPermissionCommand;	
		if (createRowPermissionCommand != null) {
			putBodyParameter("CreateRowPermissionCommand" , new Gson().toJson(createRowPermissionCommand));
		}	
	}

	public static class CreateRowPermissionCommand {
	...
	@Override
	public Class<CreateRowPermissionResponse> getResponseClass() {
		return CreateRowPermissionResponse.class;
	}
