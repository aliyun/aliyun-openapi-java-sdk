 ...
 * @version 
 */
public class DeleteQualityRulesRequest extends RpcAcsRequest<DeleteQualityRulesResponse> {
	...
	@Override
	public Class<DeleteQualityRulesResponse> getResponseClass() {
		return DeleteQualityRulesResponse.class;
	}
