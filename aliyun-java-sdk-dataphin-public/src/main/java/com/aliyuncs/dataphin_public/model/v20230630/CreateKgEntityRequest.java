 ...
 * @version 
 */
public class CreateKgEntityRequest extends RpcAcsRequest<CreateKgEntityResponse> {
	...
	@Override
	public Class<CreateKgEntityResponse> getResponseClass() {
		return CreateKgEntityResponse.class;
	}
