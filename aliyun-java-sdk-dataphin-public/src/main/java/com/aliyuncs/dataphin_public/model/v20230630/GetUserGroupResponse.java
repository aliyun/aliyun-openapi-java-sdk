...
import com.aliyuncs.dataphin_public.transform.v20230630.GetUserGroupResponseUnmarshaller;
...
public class GetUserGroupResponse extends AcsResponse {
	...
	@Override
	public GetUserGroupResponse getInstance(UnmarshallerContext context) {
		return	GetUserGroupResponseUnmarshaller.unmarshall(this, context);
	}
