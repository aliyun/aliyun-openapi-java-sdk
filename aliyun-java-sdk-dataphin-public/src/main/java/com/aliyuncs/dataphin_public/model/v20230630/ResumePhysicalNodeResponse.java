...
import com.aliyuncs.dataphin_public.transform.v20230630.ResumePhysicalNodeResponseUnmarshaller;
 ...
 * @version 
 */
public class ResumePhysicalNodeResponse extends AcsResponse {
	...
	@Override
	public ResumePhysicalNodeResponse getInstance(UnmarshallerContext context) {
		return	ResumePhysicalNodeResponseUnmarshaller.unmarshall(this, context);
	}
