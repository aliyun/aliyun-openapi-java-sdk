...
import com.aliyuncs.dataphin_public.transform.v20230630.GetQualitySchedulesByWatchIdResponseUnmarshaller;
 ...
 * @version 
 */
public class GetQualitySchedulesByWatchIdResponse extends AcsResponse {
	...
	private List<QualitySchedule> qualityScheduleList;
	...
	public List<QualitySchedule> getQualityScheduleList() {
		return this.qualityScheduleList;
	}

	public void setQualityScheduleList(List<QualitySchedule> qualityScheduleList) {
		this.qualityScheduleList = qualityScheduleList;
	}

	public static class QualitySchedule {
	...
	@Override
	public GetQualitySchedulesByWatchIdResponse getInstance(UnmarshallerContext context) {
		return	GetQualitySchedulesByWatchIdResponseUnmarshaller.unmarshall(this, context);
	}
