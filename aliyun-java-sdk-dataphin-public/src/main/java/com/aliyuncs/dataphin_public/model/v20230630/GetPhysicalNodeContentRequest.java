 ...
 * @version 
 */
public class GetPhysicalNodeContentRequest extends RpcAcsRequest<GetPhysicalNodeContentResponse> {
	...
	@Override
	public Class<GetPhysicalNodeContentResponse> getResponseClass() {
