 ...
 * @version 
 */
public class GetBatchTaskInfoByVersionRequest extends RpcAcsRequest<GetBatchTaskInfoByVersionResponse> {
	...
	@Override
	public Class<GetBatchTaskInfoByVersionResponse> getResponseClass() {
