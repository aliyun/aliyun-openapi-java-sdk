...
import com.aliyuncs.dataphin_public.transform.v20230630.GetTableColumnLineagesResponseUnmarshaller;
 ...
 * @version 
 */
public class GetTableColumnLineagesResponse extends AcsResponse {
	...
	public void setTableColumnLineageList(List<TableColumnLineage> tableColumnLineageList) {
	...
	public static class TableColumnLineage {
		...
		public void setInputColumnGuid(String inputColumnGuid) {
	...
	@Override
	public GetTableColumnLineagesResponse getInstance(UnmarshallerContext context) {
		return	GetTableColumnLineagesResponseUnmarshaller.unmarshall(this, context);
	}
