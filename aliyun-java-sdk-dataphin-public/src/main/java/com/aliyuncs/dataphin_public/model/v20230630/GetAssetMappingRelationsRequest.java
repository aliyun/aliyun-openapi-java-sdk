 ...
 * @version 
 */
public class GetAssetMappingRelationsRequest extends RpcAcsRequest<GetAssetMappingRelationsResponse> {
	...
	@Override
	public Class<GetAssetMappingRelationsResponse> getResponseClass() {
		return GetAssetMappingRelationsResponse.class;
	}
