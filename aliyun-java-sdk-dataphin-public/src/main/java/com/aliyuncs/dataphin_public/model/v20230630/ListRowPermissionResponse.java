...
import com.aliyuncs.dataphin_public.transform.v20230630.ListRowPermissionResponseUnmarshaller;
 ...
 * @version 
 */
public class ListRowPermissionResponse extends AcsResponse {
	...
	@Override
	public ListRowPermissionResponse getInstance(UnmarshallerContext context) {
		return	ListRowPermissionResponseUnmarshaller.unmarshall(this, context);
	}
