 ...
 * @version 
 */
public class ListQualityArchiveTablesRequest extends RpcAcsRequest<ListQualityArchiveTablesResponse> {
	...
	@Override
	public Class<ListQualityArchiveTablesResponse> getResponseClass() {
		return ListQualityArchiveTablesResponse.class;
	}
