 ...
 * @version 
 */
public class CreatePipelineByAsyncRequest extends RpcAcsRequest<CreatePipelineByAsyncResponse> {
	...
	public CreatePipelineByAsyncRequest() {
		super("dataphin-public", "2023-06-30", "CreatePipelineByAsync");
	...
	@Override
	public Class<CreatePipelineByAsyncResponse> getResponseClass() {
		return CreatePipelineByAsyncResponse.class;
	}
