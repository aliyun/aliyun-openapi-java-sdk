...
import com.aliyuncs.dataphin_public.transform.v20230630.ListComputeSourcesResponseUnmarshaller;
 ...
 * @version 
 */
public class ListComputeSourcesResponse extends AcsResponse {
	...
	public static class PageResult {
		...
		private List<ComputeSource> computeSourceList;
		...
		public List<ComputeSource> getComputeSourceList() {
			return this.computeSourceList;
		}

		public void setComputeSourceList(List<ComputeSource> computeSourceList) {
			this.computeSourceList = computeSourceList;
		}

		public static class ComputeSource {
	...
	@Override
	public ListComputeSourcesResponse getInstance(UnmarshallerContext context) {
		return	ListComputeSourcesResponseUnmarshaller.unmarshall(this, context);
	}
