...
import com.aliyuncs.dataphin_public.transform.v20230630.GetQualityWatchTaskResponseUnmarshaller;
 ...
 * @version 
 */
public class GetQualityWatchTaskResponse extends AcsResponse {
	...
	public void setWatchTaskInfo(WatchTaskInfo watchTaskInfo) {
		this.watchTaskInfo = watchTaskInfo;
	}

	public static class WatchTaskInfo {
	...
	@Override
	public GetQualityWatchTaskResponse getInstance(UnmarshallerContext context) {
		return	GetQualityWatchTaskResponseUnmarshaller.unmarshall(this, context);
	}
