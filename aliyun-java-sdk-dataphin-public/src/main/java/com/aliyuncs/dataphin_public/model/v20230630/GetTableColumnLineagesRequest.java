 ...
 * @version 
 */
public class GetTableColumnLineagesRequest extends RpcAcsRequest<GetTableColumnLineagesResponse> {
	...
	public GetTableColumnLineagesRequest() {
		super("dataphin-public", "2023-06-30", "GetTableColumnLineages");
	...
	@Override
	public Class<GetTableColumnLineagesResponse> getResponseClass() {
		return GetTableColumnLineagesResponse.class;
	}
