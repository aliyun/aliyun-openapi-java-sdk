 ...
 * @version 
 */
public class GetPhysicalNodeOperationLogRequest extends RpcAcsRequest<GetPhysicalNodeOperationLogResponse> {
	...
	@Override
	public Class<GetPhysicalNodeOperationLogResponse> getResponseClass() {
