 ...
 * @version 
 */
public class UpdateDataServiceAppGroupRequest extends RpcAcsRequest<UpdateDataServiceAppGroupResponse> {
	...
	@Override
	public Class<UpdateDataServiceAppGroupResponse> getResponseClass() {
		return UpdateDataServiceAppGroupResponse.class;
	}
