 ...
 * @version 
 */
public class DeleteStandardInValidMappingRequest extends RpcAcsRequest<DeleteStandardInValidMappingResponse> {
	...
	@Override
	public Class<DeleteStandardInValidMappingResponse> getResponseClass() {
		return DeleteStandardInValidMappingResponse.class;
	}
