 ...
 * @version 
 */
public class OfflineStandardRequest extends RpcAcsRequest<OfflineStandardResponse> {
	...
	@Override
	public Class<OfflineStandardResponse> getResponseClass() {
		return OfflineStandardResponse.class;
	}
