 ...
 * @version 
 */
public class GrantDataServiceApiRequest extends RpcAcsRequest<GrantDataServiceApiResponse> {
	...
	@Override
	public Class<GrantDataServiceApiResponse> getResponseClass() {
		return GrantDataServiceApiResponse.class;
	}
