...
import com.aliyuncs.dataphin_public.transform.v20230630.ListQualityWatchesResponseUnmarshaller;
 ...
 * @version 
 */
public class ListQualityWatchesResponse extends AcsResponse {
	...
	public static class PageResult {
		...
		private List<QualityWatch> qualityWatchList;
		...
		public List<QualityWatch> getQualityWatchList() {
			return this.qualityWatchList;
		}

		public void setQualityWatchList(List<QualityWatch> qualityWatchList) {
	...
	@Override
	public ListQualityWatchesResponse getInstance(UnmarshallerContext context) {
		return	ListQualityWatchesResponseUnmarshaller.unmarshall(this, context);
	}
