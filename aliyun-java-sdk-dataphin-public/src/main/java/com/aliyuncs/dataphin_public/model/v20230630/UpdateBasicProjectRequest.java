 ...
 * @version 
 */
public class UpdateBasicProjectRequest extends RpcAcsRequest<UpdateBasicProjectResponse> {
	...
	public UpdateBasicProjectRequest() {
		super("dataphin-public", "2023-06-30", "UpdateBasicProject");
	...
	@Override
	public Class<UpdateBasicProjectResponse> getResponseClass() {
		return UpdateBasicProjectResponse.class;
	}
