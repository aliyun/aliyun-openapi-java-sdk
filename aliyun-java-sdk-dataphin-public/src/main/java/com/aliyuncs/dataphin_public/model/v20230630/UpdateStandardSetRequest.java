 ...
 * @version 
 */
public class UpdateStandardSetRequest extends RpcAcsRequest<UpdateStandardSetResponse> {
	...
	public UpdateStandardSetRequest() {
		super("dataphin-public", "2023-06-30", "UpdateStandardSet", "Dataphin");
	...
	@Override
	public Class<UpdateStandardSetResponse> getResponseClass() {
		return UpdateStandardSetResponse.class;
	}
