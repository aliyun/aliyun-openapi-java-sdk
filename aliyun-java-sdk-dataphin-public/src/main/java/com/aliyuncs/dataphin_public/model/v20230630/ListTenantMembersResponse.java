...
import com.aliyuncs.dataphin_public.transform.v20230630.ListTenantMembersResponseUnmarshaller;
 ...
 * @version 
 */
public class ListTenantMembersResponse extends AcsResponse {
	...
	@Override
	public ListTenantMembersResponse getInstance(UnmarshallerContext context) {
		return	ListTenantMembersResponseUnmarshaller.unmarshall(this, context);
	}
