 ...
 * @version 
 */
public class GetQualityRuleTaskRequest extends RpcAcsRequest<GetQualityRuleTaskResponse> {
	...
	@Override
	public Class<GetQualityRuleTaskResponse> getResponseClass() {
		return GetQualityRuleTaskResponse.class;
	}
