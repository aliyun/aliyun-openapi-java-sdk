...
public class ListDataSourceWithConfigResponse extends AcsResponse {
	...
	public static class PageResult {
		...
		private List<DevProdDataSource> dataSourceList;
		...
		public List<DevProdDataSource> getDataSourceList() {
			return this.dataSourceList;
		}

		public void setDataSourceList(List<DevProdDataSource> dataSourceList) {
		...
		public static class DevProdDataSource {
			...
			public static class DevDataSourceInfo {
				...
				public void setConfigItemList1(List<ConfigItem2> configItemList1) {
