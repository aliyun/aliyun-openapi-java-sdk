 ...
 * @version 
 */
public class ListAssetDirectoriesRequest extends RpcAcsRequest<ListAssetDirectoriesResponse> {
	...
	public static class ListQuery {
		...
		@SerializedName("ParentDirectoryId")
	...
	@Override
	public Class<ListAssetDirectoriesResponse> getResponseClass() {
		return ListAssetDirectoriesResponse.class;
	}
