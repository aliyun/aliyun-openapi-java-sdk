 ...
 * @version 
 */
public class DeleteStandardValidMappingRequest extends RpcAcsRequest<DeleteStandardValidMappingResponse> {
	...
	public DeleteStandardValidMappingRequest() {
		super("dataphin-public", "2023-06-30", "DeleteStandardValidMapping");
	...
	@Override
	public Class<DeleteStandardValidMappingResponse> getResponseClass() {
		return DeleteStandardValidMappingResponse.class;
	}
