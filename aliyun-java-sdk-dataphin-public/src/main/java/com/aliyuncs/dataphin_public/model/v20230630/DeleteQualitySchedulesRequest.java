 ...
 * @version 
 */
public class DeleteQualitySchedulesRequest extends RpcAcsRequest<DeleteQualitySchedulesResponse> {
	...
	@Override
	public Class<DeleteQualitySchedulesResponse> getResponseClass() {
		return DeleteQualitySchedulesResponse.class;
	}
