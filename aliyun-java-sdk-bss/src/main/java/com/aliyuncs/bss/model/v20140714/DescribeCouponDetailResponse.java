...
import com.aliyuncs.bss.transform.v20140714.DescribeCouponDetailResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeCouponDetailResponse extends AcsResponse {
	...
	@Override
	public DescribeCouponDetailResponse getInstance(UnmarshallerContext context) {
		return	DescribeCouponDetailResponseUnmarshaller.unmarshall(this, context);
	}
}
