...
public class DescribeContainerGroupMetricResponseUnmarshaller {
	...
	public static DescribeContainerGroupMetricResponse unmarshall(DescribeContainerGroupMetricResponse describeContainerGroupMetricResponse, UnmarshallerContext context) {
		...
		for (int i = 0; i < context.lengthValue("DescribeContainerGroupMetricResponse.Records.Length"); i++) {
			...
			memory.setCache(context.longValue("DescribeContainerGroupMetricResponse.Records["+ i +"].Memory.Cache"));
			memory.setWorkingSet(context.longValue("DescribeContainerGroupMetricResponse.Records["+ i +"].Memory.WorkingSet"));
			memory.setRss(context.longValue("DescribeContainerGroupMetricResponse.Records["+ i +"].Memory.Rss"));
			...
			for (int j = 0; j < context.lengthValue("DescribeContainerGroupMetricResponse.Records["+ i +"].Containers.Length"); j++) {
				...
				memory2.setCache(context.longValue("DescribeContainerGroupMetricResponse.Records["+ i +"].Containers["+ j +"].Memory.Cache"));
				memory2.setWorkingSet(context.longValue("DescribeContainerGroupMetricResponse.Records["+ i +"].Containers["+ j +"].Memory.WorkingSet"));
				memory2.setRss(context.longValue("DescribeContainerGroupMetricResponse.Records["+ i +"].Containers["+ j +"].Memory.Rss"));
