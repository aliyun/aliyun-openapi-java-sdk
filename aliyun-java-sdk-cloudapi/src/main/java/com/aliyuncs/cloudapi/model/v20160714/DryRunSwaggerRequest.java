 ...
 * @version 
 */
public class DryRunSwaggerRequest extends RpcAcsRequest<DryRunSwaggerResponse> {
	...
	public DryRunSwaggerRequest() {
		super("CloudAPI", "2016-07-14", "DryRunSwagger", "apigateway");
	...
	@Override
	public Class<DryRunSwaggerResponse> getResponseClass() {
		return DryRunSwaggerResponse.class;
	}
