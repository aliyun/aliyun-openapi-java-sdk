...
public class DescribeAccessControlListsRequest extends RpcAcsRequest<DescribeAccessControlListsResponse> {
	...
	public DescribeAccessControlListsRequest() {
		super("CloudAPI", "2016-07-14", "DescribeAccessControlLists", "apigateway");
	...
	@Override
	public Class<DescribeAccessControlListsResponse> getResponseClass() {
		return DescribeAccessControlListsResponse.class;
	}
