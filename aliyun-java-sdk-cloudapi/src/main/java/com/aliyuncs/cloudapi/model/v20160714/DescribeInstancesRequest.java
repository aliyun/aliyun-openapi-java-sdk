...
public class DescribeInstancesRequest extends RpcAcsRequest<DescribeInstancesResponse> {
	...
	public void setEnableTagAuthorization(Boolean enableTagAuthorization) {
		this.enableTagAuthorization = enableTagAuthorization;
		if(enableTagAuthorization != null){
			putQueryParameter("EnableTagAuthorization", enableTagAuthorization.toString());
		}
	}
