...
public class CreateMonitorGroupRequest extends RpcAcsRequest<CreateMonitorGroupResponse> {
	...
	public CreateMonitorGroupRequest() {
		super("CloudAPI", "2016-07-14", "CreateMonitorGroup", "apigateway");
	...
	public void setRawMonitorGroupId(Long rawMonitorGroupId) {
		this.rawMonitorGroupId = rawMonitorGroupId;
		if(rawMonitorGroupId != null){
			putQueryParameter("RawMonitorGroupId", rawMonitorGroupId.toString());
		}
	}
