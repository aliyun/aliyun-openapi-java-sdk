 ...
 * @version 
 */
public class DescribeApiProductApisRequest extends RpcAcsRequest<DescribeApiProductApisResponse> {
	...
	@Override
	public Class<DescribeApiProductApisResponse> getResponseClass() {
