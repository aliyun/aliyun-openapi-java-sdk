...
public class AddAccessControlListEntryRequest extends RpcAcsRequest<AddAccessControlListEntryResponse> {
	...
	public AddAccessControlListEntryRequest() {
		super("CloudAPI", "2016-07-14", "AddAccessControlListEntry", "apigateway");
	...
	@Override
	public Class<AddAccessControlListEntryResponse> getResponseClass() {
		return AddAccessControlListEntryResponse.class;
	}
