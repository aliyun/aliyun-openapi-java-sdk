 ...
 * @version 
 */
public class CreateBackendModelRequest extends RpcAcsRequest<CreateBackendModelResponse> {
	...
	public CreateBackendModelRequest() {
		super("CloudAPI", "2016-07-14", "CreateBackendModel", "apigateway");
	...
	@Override
	public Class<CreateBackendModelResponse> getResponseClass() {
		return CreateBackendModelResponse.class;
	}
