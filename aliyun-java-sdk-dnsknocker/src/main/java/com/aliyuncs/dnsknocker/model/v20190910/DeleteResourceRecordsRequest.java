 ...
 * @version 
 */
public class DeleteResourceRecordsRequest extends RpcAcsRequest<DeleteResourceRecordsResponse> {
	...
	public DeleteResourceRecordsRequest() {
		super("DnsKnocker", "2019-09-10", "DeleteResourceRecords", "dns_knocker");
	...
	public void setTypeList(String typeList) {
		...
		if(typeList != null){
			putBodyParameter("TypeList", typeList);
		}
	}
	...
	@Override
	public Class<DeleteResourceRecordsResponse> getResponseClass() {
		return DeleteResourceRecordsResponse.class;
	}
