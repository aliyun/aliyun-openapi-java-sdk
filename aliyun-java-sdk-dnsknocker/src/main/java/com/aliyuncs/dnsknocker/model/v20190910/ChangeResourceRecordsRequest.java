 ...
 * @version 
 */
public class ChangeResourceRecordsRequest extends RpcAcsRequest<ChangeResourceRecordsResponse> {
	...
	public ChangeResourceRecordsRequest() {
		super("DnsKnocker", "2019-09-10", "ChangeResourceRecords", "dns_knocker");
	...
	@Override
	public Class<ChangeResourceRecordsResponse> getResponseClass() {
		return ChangeResourceRecordsResponse.class;
	}
