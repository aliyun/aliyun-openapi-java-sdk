 ...
 * @version 
 */
public class BatchCreateRrRequest extends RpcAcsRequest<BatchCreateRrResponse> {
	...
	public BatchCreateRrRequest() {
		super("DnsKnocker", "2019-09-10", "BatchCreateRr", "dns_knocker");
	...
	@Override
	public Class<BatchCreateRrResponse> getResponseClass() {
		return BatchCreateRrResponse.class;
	}
