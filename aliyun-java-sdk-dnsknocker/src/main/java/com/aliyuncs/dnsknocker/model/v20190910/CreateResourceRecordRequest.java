 ...
 * @version 
 */
public class CreateResourceRecordRequest extends RpcAcsRequest<CreateResourceRecordResponse> {
	...
	public CreateResourceRecordRequest() {
		super("DnsKnocker", "2019-09-10", "CreateResourceRecord", "dns_knocker");
	...
	@Override
	public Class<CreateResourceRecordResponse> getResponseClass() {
		return CreateResourceRecordResponse.class;
	}
