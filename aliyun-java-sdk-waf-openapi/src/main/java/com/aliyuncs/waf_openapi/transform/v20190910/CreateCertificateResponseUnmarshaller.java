...
import com.aliyuncs.waf_openapi.model.v20190910.CreateCertificateResponse;
...
public class CreateCertificateResponseUnmarshaller {
	...
	public static CreateCertificateResponse unmarshall(CreateCertificateResponse createCertificateResponse, UnmarshallerContext _ctx) {
		...
		createCertificateResponse.setCertificateId(_ctx.longValue("CreateCertificateResponse.CertificateId"));
