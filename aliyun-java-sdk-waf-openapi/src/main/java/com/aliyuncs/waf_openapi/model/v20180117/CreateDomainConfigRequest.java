 ...
 * @version 
 */
public class CreateDomainConfigRequest extends RpcAcsRequest<CreateDomainConfigResponse> {
	...
	public CreateDomainConfigRequest() {
		super("waf-openapi", "2018-01-17", "CreateDomainConfig", "waf");
	...
	@Override
	public Class<CreateDomainConfigResponse> getResponseClass() {
		return CreateDomainConfigResponse.class;
	}
