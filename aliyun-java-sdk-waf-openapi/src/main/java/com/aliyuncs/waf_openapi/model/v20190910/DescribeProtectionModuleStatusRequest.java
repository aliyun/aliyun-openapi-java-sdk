...
public class DescribeProtectionModuleStatusRequest extends RpcAcsRequest<DescribeProtectionModuleStatusResponse> {
	...
	public DescribeProtectionModuleStatusRequest() {
		super("waf-openapi", "2019-09-10", "DescribeProtectionModuleStatus", "waf");
	...
	@Override
	public Class<DescribeProtectionModuleStatusResponse> getResponseClass() {
		return DescribeProtectionModuleStatusResponse.class;
	}
