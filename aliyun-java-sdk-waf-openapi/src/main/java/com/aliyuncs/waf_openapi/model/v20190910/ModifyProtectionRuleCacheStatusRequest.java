...
public class ModifyProtectionRuleCacheStatusRequest extends RpcAcsRequest<ModifyProtectionRuleCacheStatusResponse> {
	...
	public ModifyProtectionRuleCacheStatusRequest() {
		super("waf-openapi", "2019-09-10", "ModifyProtectionRuleCacheStatus", "waf");
	...
	@Override
	public Class<ModifyProtectionRuleCacheStatusResponse> getResponseClass() {
		return ModifyProtectionRuleCacheStatusResponse.class;
	}
