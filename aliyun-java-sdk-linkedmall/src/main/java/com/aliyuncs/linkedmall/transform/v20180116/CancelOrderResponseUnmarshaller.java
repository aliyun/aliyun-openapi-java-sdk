...
public class CancelOrderResponseUnmarshaller {
	...
	public static CancelOrderResponse unmarshall(CancelOrderResponse cancelOrderResponse, UnmarshallerContext _ctx) {
		...
		cancelOrderResponse.setSubCode(_ctx.stringValue("CancelOrderResponse.SubCode"));
		cancelOrderResponse.setSubMessage(_ctx.stringValue("CancelOrderResponse.SubMessage"));
		cancelOrderResponse.setLogsId(_ctx.stringValue("CancelOrderResponse.LogsId"));
