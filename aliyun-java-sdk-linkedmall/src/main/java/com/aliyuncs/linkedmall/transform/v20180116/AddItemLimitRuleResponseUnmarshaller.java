...
public class AddItemLimitRuleResponseUnmarshaller {
	...
	public static AddItemLimitRuleResponse unmarshall(AddItemLimitRuleResponse addItemLimitRuleResponse, UnmarshallerContext _ctx) {
		
		addItemLimitRuleResponse.setRequestId(_ctx.stringValue("AddItemLimitRuleResponse.RequestId"));
