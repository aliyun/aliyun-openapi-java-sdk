...
import com.aliyuncs.linkedmall.transform.v20180116.CreateOrderV2ResponseUnmarshaller;
 ...
 * @version 
 */
public class CreateOrderV2Response extends AcsResponse {
	...
	@Override
	public CreateOrderV2Response getInstance(UnmarshallerContext context) {
		return	CreateOrderV2ResponseUnmarshaller.unmarshall(this, context);
	}
}
