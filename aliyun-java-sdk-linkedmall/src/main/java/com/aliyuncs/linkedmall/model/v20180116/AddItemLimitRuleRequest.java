 ...
 * @version 
 */
public class AddItemLimitRuleRequest extends RpcAcsRequest<AddItemLimitRuleResponse> {
	...
	@Override
	public Class<AddItemLimitRuleResponse> getResponseClass() {
		return AddItemLimitRuleResponse.class;
	}
