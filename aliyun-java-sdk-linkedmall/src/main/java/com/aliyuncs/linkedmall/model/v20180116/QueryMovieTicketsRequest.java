 ...
 * @version 
 */
public class QueryMovieTicketsRequest extends RpcAcsRequest<QueryMovieTicketsResponse> {
	...
	@Override
	public Class<QueryMovieTicketsResponse> getResponseClass() {
		return QueryMovieTicketsResponse.class;
	}
