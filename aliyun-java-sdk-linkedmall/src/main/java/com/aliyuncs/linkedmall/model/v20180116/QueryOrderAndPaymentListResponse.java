...
import com.aliyuncs.linkedmall.transform.v20180116.QueryOrderAndPaymentListResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryOrderAndPaymentListResponse extends AcsResponse {
	...
	public static class LmOrderListItem {
		...
		public void setLmPaymentId(String lmPaymentId) {
	...
	@Override
	public QueryOrderAndPaymentListResponse getInstance(UnmarshallerContext context) {
		return	QueryOrderAndPaymentListResponseUnmarshaller.unmarshall(this, context);
	}
}
