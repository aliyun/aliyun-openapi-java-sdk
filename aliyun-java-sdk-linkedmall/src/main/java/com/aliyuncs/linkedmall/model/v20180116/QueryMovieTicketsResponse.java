 ...
 * @version 
 */
public class QueryMovieTicketsResponse extends AcsResponse {
	...
	@Override
	public QueryMovieTicketsResponse getInstance(UnmarshallerContext context) {
		return	QueryMovieTicketsResponseUnmarshaller.unmarshall(this, context);
	}
}
