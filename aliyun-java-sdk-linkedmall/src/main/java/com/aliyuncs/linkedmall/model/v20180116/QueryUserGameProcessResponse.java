...
import com.aliyuncs.linkedmall.transform.v20180116.QueryUserGameProcessResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryUserGameProcessResponse extends AcsResponse {
	...
	@Override
	public QueryUserGameProcessResponse getInstance(UnmarshallerContext context) {
		return	QueryUserGameProcessResponseUnmarshaller.unmarshall(this, context);
	}
