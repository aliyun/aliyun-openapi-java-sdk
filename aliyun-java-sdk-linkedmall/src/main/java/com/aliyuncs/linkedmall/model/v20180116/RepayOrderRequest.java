 ...
 * @version 
 */
public class RepayOrderRequest extends RpcAcsRequest<RepayOrderResponse> {
	...
	@Override
	public Class<RepayOrderResponse> getResponseClass() {
		return RepayOrderResponse.class;
	}
