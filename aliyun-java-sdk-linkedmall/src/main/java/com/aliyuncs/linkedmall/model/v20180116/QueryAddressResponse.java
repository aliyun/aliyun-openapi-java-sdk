...
public class QueryAddressResponse extends AcsResponse {
	...
	public void setDivisionAddress(List<DivisionAddressItem> divisionAddress) {
	...
	@Override
	public QueryAddressResponse getInstance(UnmarshallerContext context) {
		return	QueryAddressResponseUnmarshaller.unmarshall(this, context);
	}
}
