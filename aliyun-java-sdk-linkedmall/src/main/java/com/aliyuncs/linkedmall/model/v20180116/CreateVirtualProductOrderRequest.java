 ...
 * @version 
 */
public class CreateVirtualProductOrderRequest extends RpcAcsRequest<CreateVirtualProductOrderResponse> {
	...
	@Override
	public Class<CreateVirtualProductOrderResponse> getResponseClass() {
		return CreateVirtualProductOrderResponse.class;
	}
