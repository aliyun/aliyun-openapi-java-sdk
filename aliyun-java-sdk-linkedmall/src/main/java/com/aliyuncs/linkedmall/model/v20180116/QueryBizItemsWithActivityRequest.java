 ...
 * @version 
 */
public class QueryBizItemsWithActivityRequest extends RpcAcsRequest<QueryBizItemsWithActivityResponse> {
	...
	public QueryBizItemsWithActivityRequest() {
		super("linkedmall", "2018-01-16", "QueryBizItemsWithActivity", "linkedmall");
	...
	@Override
	public Class<QueryBizItemsWithActivityResponse> getResponseClass() {
		return QueryBizItemsWithActivityResponse.class;
	}
