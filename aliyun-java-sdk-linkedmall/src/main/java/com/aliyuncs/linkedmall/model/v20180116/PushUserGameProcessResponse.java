...
import com.aliyuncs.linkedmall.transform.v20180116.PushUserGameProcessResponseUnmarshaller;
 ...
 * @version 
 */
public class PushUserGameProcessResponse extends AcsResponse {
	...
	@Override
	public PushUserGameProcessResponse getInstance(UnmarshallerContext context) {
		return	PushUserGameProcessResponseUnmarshaller.unmarshall(this, context);
	}
