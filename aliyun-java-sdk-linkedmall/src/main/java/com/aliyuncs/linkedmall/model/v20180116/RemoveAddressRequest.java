 ...
 * @version 
 */
public class RemoveAddressRequest extends RpcAcsRequest<RemoveAddressResponse> {
	...
	@Override
	public Class<RemoveAddressResponse> getResponseClass() {
		return RemoveAddressResponse.class;
	}
