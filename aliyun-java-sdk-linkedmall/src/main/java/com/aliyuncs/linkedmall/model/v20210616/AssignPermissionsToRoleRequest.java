 ...
 * @version 
 */
public class AssignPermissionsToRoleRequest extends RpcAcsRequest<AssignPermissionsToRoleResponse> {
	...
	public AssignPermissionsToRoleRequest() {
		super("linkedmall", "2021-06-16", "AssignPermissionsToRole", "linkedmall");
	...
	@Override
	public Class<AssignPermissionsToRoleResponse> getResponseClass() {
		return AssignPermissionsToRoleResponse.class;
	}
