 ...
 * @version 
 */
public class QueryOrderCommissionRateRequest extends RpcAcsRequest<QueryOrderCommissionRateResponse> {
	...
	public QueryOrderCommissionRateRequest() {
		super("linkedmall", "2018-01-16", "QueryOrderCommissionRate", "linkedmall");
	...
	@Override
	public Class<QueryOrderCommissionRateResponse> getResponseClass() {
		return QueryOrderCommissionRateResponse.class;
	}
