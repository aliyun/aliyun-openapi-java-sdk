 ...
 * @version 
 */
public class QueryBestSession4ItemsRequest extends RpcAcsRequest<QueryBestSession4ItemsResponse> {
	...
	@Override
	public Class<QueryBestSession4ItemsResponse> getResponseClass() {
		return QueryBestSession4ItemsResponse.class;
	}
