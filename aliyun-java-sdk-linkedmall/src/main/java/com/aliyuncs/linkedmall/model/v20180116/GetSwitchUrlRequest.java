 ...
 * @version 
 */
public class GetSwitchUrlRequest extends RpcAcsRequest<GetSwitchUrlResponse> {
	...
	@Override
	public Class<GetSwitchUrlResponse> getResponseClass() {
		return GetSwitchUrlResponse.class;
	}
