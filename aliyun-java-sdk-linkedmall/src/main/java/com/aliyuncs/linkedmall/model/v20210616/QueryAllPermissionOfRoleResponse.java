...
import com.aliyuncs.linkedmall.transform.v20210616.QueryAllPermissionOfRoleResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryAllPermissionOfRoleResponse extends AcsResponse {
	...
	@Override
	public QueryAllPermissionOfRoleResponse getInstance(UnmarshallerContext context) {
		return	QueryAllPermissionOfRoleResponseUnmarshaller.unmarshall(this, context);
	}
