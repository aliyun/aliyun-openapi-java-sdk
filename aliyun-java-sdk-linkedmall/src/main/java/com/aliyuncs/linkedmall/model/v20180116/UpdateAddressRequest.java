 ...
 * @version 
 */
public class UpdateAddressRequest extends RpcAcsRequest<UpdateAddressResponse> {
	...
	@Override
	public Class<UpdateAddressResponse> getResponseClass() {
		return UpdateAddressResponse.class;
	}
