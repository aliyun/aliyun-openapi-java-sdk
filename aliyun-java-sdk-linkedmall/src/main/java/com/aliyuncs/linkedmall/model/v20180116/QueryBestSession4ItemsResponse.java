...
public class QueryBestSession4ItemsResponse extends AcsResponse {
	...
	public void setLmItemActivitySessionModelList(List<LmItemActivitySessionModel> lmItemActivitySessionModelList) {
	...
	@Override
	public QueryBestSession4ItemsResponse getInstance(UnmarshallerContext context) {
		return	QueryBestSession4ItemsResponseUnmarshaller.unmarshall(this, context);
	}
}
