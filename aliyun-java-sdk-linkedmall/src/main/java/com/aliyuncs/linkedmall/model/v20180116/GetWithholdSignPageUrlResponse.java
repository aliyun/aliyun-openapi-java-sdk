...
public class GetWithholdSignPageUrlResponse extends AcsResponse {
	...
	@Override
	public GetWithholdSignPageUrlResponse getInstance(UnmarshallerContext context) {
		return	GetWithholdSignPageUrlResponseUnmarshaller.unmarshall(this, context);
	}
