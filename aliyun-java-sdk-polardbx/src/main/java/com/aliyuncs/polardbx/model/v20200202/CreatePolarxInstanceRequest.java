 ...
 * @version 
 */
public class CreatePolarxInstanceRequest extends RpcAcsRequest<CreatePolarxInstanceResponse> {
	...
	public CreatePolarxInstanceRequest() {
		super("polardbx", "2020-02-02", "CreatePolarxInstance", "polardbx");
	...
	@Override
	public Class<CreatePolarxInstanceResponse> getResponseClass() {
		return CreatePolarxInstanceResponse.class;
	}
