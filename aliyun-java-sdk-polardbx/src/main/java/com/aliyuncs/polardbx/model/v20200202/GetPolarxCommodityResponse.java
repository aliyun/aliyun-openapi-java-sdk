...
import com.aliyuncs.polardbx.transform.v20200202.GetPolarxCommodityResponseUnmarshaller;
 ...
 * @version 
 */
public class GetPolarxCommodityResponse extends AcsResponse {
	...
	@Override
	public GetPolarxCommodityResponse getInstance(UnmarshallerContext context) {
		return	GetPolarxCommodityResponseUnmarshaller.unmarshall(this, context);
	}
