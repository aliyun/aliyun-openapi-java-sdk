...
import com.aliyuncs.polardbx.transform.v20200202.DescribeDBNodePerformanceResponseUnmarshaller;
...
public class DescribeDBNodePerformanceResponse extends AcsResponse {
	...
	@Override
	public DescribeDBNodePerformanceResponse getInstance(UnmarshallerContext context) {
		return	DescribeDBNodePerformanceResponseUnmarshaller.unmarshall(this, context);
	}
}
