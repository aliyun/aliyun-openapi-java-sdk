...
import com.aliyuncs.polardbx.model.v20200202.DescribeDBNodePerformanceResponse;
import com.aliyuncs.polardbx.model.v20200202.DescribeDBNodePerformanceResponse.PerformanceItem;
import com.aliyuncs.polardbx.model.v20200202.DescribeDBNodePerformanceResponse.PerformanceItem.PerformanceItemValue;
...
public class DescribeDBNodePerformanceResponseUnmarshaller {
	...
	public static DescribeDBNodePerformanceResponse unmarshall(DescribeDBNodePerformanceResponse describeDBNodePerformanceResponse, UnmarshallerContext _ctx) {
		...
		describeDBNodePerformanceResponse.setDBInstanceName(_ctx.stringValue("DescribeDBNodePerformanceResponse.DBInstanceName"));
		...
		for (int i = 0; i < _ctx.lengthValue("DescribeDBNodePerformanceResponse.PerformanceKeys.Length"); i++) {
			...
			performanceItem.setDBNodeId(_ctx.stringValue("DescribeDBNodePerformanceResponse.PerformanceKeys["+ i +"].DBNodeId"));
