...
import com.aliyuncs.polardbx.model.v20200202.DescribeActiveOperationTasksResponse;
import com.aliyuncs.polardbx.model.v20200202.DescribeActiveOperationTasksResponse.ItemsItem;
...
public class DescribeActiveOperationTasksResponseUnmarshaller {
	...
	public static DescribeActiveOperationTasksResponse unmarshall(DescribeActiveOperationTasksResponse describeActiveOperationTasksResponse, UnmarshallerContext _ctx) {
		...
		describeActiveOperationTasksResponse.setPageSize(_ctx.longValue("DescribeActiveOperationTasksResponse.PageSize"));
		describeActiveOperationTasksResponse.setPageNumber(_ctx.longValue("DescribeActiveOperationTasksResponse.PageNumber"));
		describeActiveOperationTasksResponse.setTotalRecordCount(_ctx.longValue("DescribeActiveOperationTasksResponse.TotalRecordCount"));
		...
		for (int i = 0; i < _ctx.lengthValue("DescribeActiveOperationTasksResponse.Items.Length"); i++) {
			...
			itemsItem.setId(_ctx.longValue("DescribeActiveOperationTasksResponse.Items["+ i +"].Id"));
			...
			itemsItem.setStatus(_ctx.longValue("DescribeActiveOperationTasksResponse.Items["+ i +"].Status"));
