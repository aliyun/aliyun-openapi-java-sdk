...
import com.aliyuncs.polardbx.model.v20200202.DescribeActiveOperationTaskCountResponse;
...
public class DescribeActiveOperationTaskCountResponseUnmarshaller {
	...
	public static DescribeActiveOperationTaskCountResponse unmarshall(DescribeActiveOperationTaskCountResponse describeActiveOperationTaskCountResponse, UnmarshallerContext _ctx) {
		...
		describeActiveOperationTaskCountResponse.setNeedPop(_ctx.longValue("DescribeActiveOperationTaskCountResponse.NeedPop"));
		describeActiveOperationTaskCountResponse.setTaskCount(_ctx.longValue("DescribeActiveOperationTaskCountResponse.TaskCount"));
