...
import com.aliyuncs.polardbx.model.v20200202.ResetAccountPasswordResponse;
...
public class ResetAccountPasswordResponseUnmarshaller {
	...
	public static ResetAccountPasswordResponse unmarshall(ResetAccountPasswordResponse resetAccountPasswordResponse, UnmarshallerContext _ctx) {
		...
		resetAccountPasswordResponse.setSuccess(_ctx.booleanValue("ResetAccountPasswordResponse.Success"));
		resetAccountPasswordResponse.setMessage(_ctx.stringValue("ResetAccountPasswordResponse.Message"));
