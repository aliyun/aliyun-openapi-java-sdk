...
import com.aliyuncs.cdt.transform.v20210813.ListSwitchedCdtProductsResponseUnmarshaller;
 ...
 * @version 
 */
public class ListSwitchedCdtProductsResponse extends AcsResponse {
	...
	@Override
	public ListSwitchedCdtProductsResponse getInstance(UnmarshallerContext context) {
		return	ListSwitchedCdtProductsResponseUnmarshaller.unmarshall(this, context);
	}
