 ...
 * @version 
 */
public class ListCdtInternetTrafficRequest extends RpcAcsRequest<ListCdtInternetTrafficResponse> {
	   

	private String businessRegionId;
	public ListCdtInternetTrafficRequest() {
		super("CDT", "2021-08-13", "ListCdtInternetTraffic");
	...
	@Override
	public Class<ListCdtInternetTrafficResponse> getResponseClass() {
		return ListCdtInternetTrafficResponse.class;
	}
