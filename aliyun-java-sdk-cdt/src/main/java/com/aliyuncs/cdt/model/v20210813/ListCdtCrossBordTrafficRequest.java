 ...
 * @version 
 */
public class ListCdtCrossBordTrafficRequest extends RpcAcsRequest<ListCdtCrossBordTrafficResponse> {
	   

	private String businessRegionId;
	public ListCdtCrossBordTrafficRequest() {
		super("CDT", "2021-08-13", "ListCdtCrossBordTraffic");
	...
	@Override
	public Class<ListCdtCrossBordTrafficResponse> getResponseClass() {
		return ListCdtCrossBordTrafficResponse.class;
	}
