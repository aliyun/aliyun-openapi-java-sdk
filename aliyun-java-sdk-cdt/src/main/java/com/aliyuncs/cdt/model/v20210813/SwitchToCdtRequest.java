 ...
 * @version 
 */
public class SwitchToCdtRequest extends RpcAcsRequest<SwitchToCdtResponse> {
	...
	public SwitchToCdtRequest() {
		super("CDT", "2021-08-13", "SwitchToCdt");
	...
	@Override
	public Class<SwitchToCdtResponse> getResponseClass() {
		return SwitchToCdtResponse.class;
	}
