 ...
 * @version 
 */
public class ListCdtProductsRequest extends RpcAcsRequest<ListCdtProductsResponse> {
	   

	private String product;

	private String businessRegionId;
	public ListCdtProductsRequest() {
		super("CDT", "2021-08-13", "ListCdtProducts");
	...
	@Override
	public Class<ListCdtProductsResponse> getResponseClass() {
		return ListCdtProductsResponse.class;
	}
