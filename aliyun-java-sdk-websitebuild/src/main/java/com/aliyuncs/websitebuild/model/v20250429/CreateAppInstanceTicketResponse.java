...
import com.aliyuncs.websitebuild.transform.v20250429.CreateAppInstanceTicketResponseUnmarshaller;
 ...
 * @version 
 */
public class CreateAppInstanceTicketResponse extends AcsResponse {
	...
	@Override
	public CreateAppInstanceTicketResponse getInstance(UnmarshallerContext context) {
		return	CreateAppInstanceTicketResponseUnmarshaller.unmarshall(this, context);
	}
