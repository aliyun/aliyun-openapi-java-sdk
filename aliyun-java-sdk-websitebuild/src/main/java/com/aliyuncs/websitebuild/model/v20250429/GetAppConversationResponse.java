...
import com.aliyuncs.websitebuild.transform.v20250429.GetAppConversationResponseUnmarshaller;
 ...
 * @version 
 */
public class GetAppConversationResponse extends AcsResponse {
	...
	@Override
	public GetAppConversationResponse getInstance(UnmarshallerContext context) {
		return	GetAppConversationResponseUnmarshaller.unmarshall(this, context);
	}
