...
import com.aliyuncs.websitebuild.transform.v20250429.ListAppConversationsResponseUnmarshaller;
 ...
 * @version 
 */
public class ListAppConversationsResponse extends AcsResponse {
	...
	@Override
	public ListAppConversationsResponse getInstance(UnmarshallerContext context) {
		return	ListAppConversationsResponseUnmarshaller.unmarshall(this, context);
	}
