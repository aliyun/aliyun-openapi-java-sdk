...
import com.aliyuncs.websitebuild.transform.v20250429.GetAppSupabaseInstanceResponseUnmarshaller;
 ...
 * @version 
 */
public class GetAppSupabaseInstanceResponse extends AcsResponse {
	...
	@Override
	public GetAppSupabaseInstanceResponse getInstance(UnmarshallerContext context) {
		return	GetAppSupabaseInstanceResponseUnmarshaller.unmarshall(this, context);
	}
