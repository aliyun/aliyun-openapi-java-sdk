...
import com.aliyuncs.websitebuild.transform.v20250429.CreateAppAssistantAgentResponseUnmarshaller;
 ...
 * @version 
 */
public class CreateAppAssistantAgentResponse extends AcsResponse {
	...
	@Override
	public CreateAppAssistantAgentResponse getInstance(UnmarshallerContext context) {
		return	CreateAppAssistantAgentResponseUnmarshaller.unmarshall(this, context);
	}
