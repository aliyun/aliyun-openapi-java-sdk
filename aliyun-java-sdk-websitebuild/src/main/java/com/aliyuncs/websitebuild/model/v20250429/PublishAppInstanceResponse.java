...
import com.aliyuncs.websitebuild.transform.v20250429.PublishAppInstanceResponseUnmarshaller;
 ...
 * @version 
 */
public class PublishAppInstanceResponse extends AcsResponse {
	...
	@Override
	public PublishAppInstanceResponse getInstance(UnmarshallerContext context) {
		return	PublishAppInstanceResponseUnmarshaller.unmarshall(this, context);
	}
