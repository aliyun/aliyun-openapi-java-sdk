...
import com.aliyuncs.websitebuild.transform.v20250429.QuerySupabaseInstanceInfoForAdminResponseUnmarshaller;
 ...
 * @version 
 */
public class QuerySupabaseInstanceInfoForAdminResponse extends AcsResponse {
	...
	@Override
	public QuerySupabaseInstanceInfoForAdminResponse getInstance(UnmarshallerContext context) {
		return	QuerySupabaseInstanceInfoForAdminResponseUnmarshaller.unmarshall(this, context);
	}
