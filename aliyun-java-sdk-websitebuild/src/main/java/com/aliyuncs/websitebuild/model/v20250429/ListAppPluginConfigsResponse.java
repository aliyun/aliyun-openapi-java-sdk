...
import com.aliyuncs.websitebuild.transform.v20250429.ListAppPluginConfigsResponseUnmarshaller;
 ...
 * @version 
 */
public class ListAppPluginConfigsResponse extends AcsResponse {
	...
	@Override
	public ListAppPluginConfigsResponse getInstance(UnmarshallerContext context) {
		return	ListAppPluginConfigsResponseUnmarshaller.unmarshall(this, context);
	}
