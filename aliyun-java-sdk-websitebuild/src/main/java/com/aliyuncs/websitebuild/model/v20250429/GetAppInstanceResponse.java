...
import com.aliyuncs.websitebuild.transform.v20250429.GetAppInstanceResponseUnmarshaller;
 ...
 * @version 
 */
public class GetAppInstanceResponse extends AcsResponse {
	...
	@Override
	public GetAppInstanceResponse getInstance(UnmarshallerContext context) {
		return	GetAppInstanceResponseUnmarshaller.unmarshall(this, context);
	}
