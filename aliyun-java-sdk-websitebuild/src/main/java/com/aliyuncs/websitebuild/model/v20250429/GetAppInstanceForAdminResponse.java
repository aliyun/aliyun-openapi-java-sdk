...
import com.aliyuncs.websitebuild.transform.v20250429.GetAppInstanceForAdminResponseUnmarshaller;
 ...
 * @version 
 */
public class GetAppInstanceForAdminResponse extends AcsResponse {
	...
	@Override
	public GetAppInstanceForAdminResponse getInstance(UnmarshallerContext context) {
		return	GetAppInstanceForAdminResponseUnmarshaller.unmarshall(this, context);
	}
