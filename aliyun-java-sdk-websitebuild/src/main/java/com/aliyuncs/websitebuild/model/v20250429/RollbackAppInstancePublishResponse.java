...
import com.aliyuncs.websitebuild.transform.v20250429.RollbackAppInstancePublishResponseUnmarshaller;
 ...
 * @version 
 */
public class RollbackAppInstancePublishResponse extends AcsResponse {
	...
	@Override
	public RollbackAppInstancePublishResponse getInstance(UnmarshallerContext context) {
		return	RollbackAppInstancePublishResponseUnmarshaller.unmarshall(this, context);
	}
