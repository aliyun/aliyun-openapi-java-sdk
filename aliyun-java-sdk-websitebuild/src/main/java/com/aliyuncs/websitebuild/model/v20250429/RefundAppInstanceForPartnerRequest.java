...
public class RefundAppInstanceForPartnerRequest extends RpcAcsRequest<RefundAppInstanceForPartnerResponse> {
	...
	public void setRefundReason(String refundReason) {
		...
		if(refundReason != null){
			putQueryParameter("RefundReason", refundReason);
		}
	}
	...
	@Override
	public Class<RefundAppInstanceForPartnerResponse> getResponseClass() {
		return RefundAppInstanceForPartnerResponse.class;
	}
