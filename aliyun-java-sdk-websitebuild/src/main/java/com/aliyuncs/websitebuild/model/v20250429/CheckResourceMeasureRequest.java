 ...
 * @version 
 */
public class CheckResourceMeasureRequest extends RpcAcsRequest<CheckResourceMeasureResponse> {
	...
	public CheckResourceMeasureRequest() {
		super("WebsiteBuild", "2025-04-29", "CheckResourceMeasure");
	...
	@Override
	public Class<CheckResourceMeasureResponse> getResponseClass() {
		return CheckResourceMeasureResponse.class;
	}
