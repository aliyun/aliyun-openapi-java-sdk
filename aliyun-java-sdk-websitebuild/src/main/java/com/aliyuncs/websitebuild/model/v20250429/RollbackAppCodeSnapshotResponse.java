...
import com.aliyuncs.websitebuild.transform.v20250429.RollbackAppCodeSnapshotResponseUnmarshaller;
 ...
 * @version 
 */
public class RollbackAppCodeSnapshotResponse extends AcsResponse {
	...
	@Override
	public RollbackAppCodeSnapshotResponse getInstance(UnmarshallerContext context) {
		return	RollbackAppCodeSnapshotResponseUnmarshaller.unmarshall(this, context);
	}
