...
import com.aliyuncs.websitebuild.transform.v20250429.IntrospectAppInstanceTicketForPreviewResponseUnmarshaller;
 ...
 * @version 
 */
public class IntrospectAppInstanceTicketForPreviewResponse extends AcsResponse {
	...
	@Override
	public IntrospectAppInstanceTicketForPreviewResponse getInstance(UnmarshallerContext context) {
		return	IntrospectAppInstanceTicketForPreviewResponseUnmarshaller.unmarshall(this, context);
	}
