...
import com.aliyuncs.websitebuild.transform.v20250429.QueryMaterialTaskDetailResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryMaterialTaskDetailResponse extends AcsResponse {
	...
	@Override
	public QueryMaterialTaskDetailResponse getInstance(UnmarshallerContext context) {
		return	QueryMaterialTaskDetailResponseUnmarshaller.unmarshall(this, context);
	}
