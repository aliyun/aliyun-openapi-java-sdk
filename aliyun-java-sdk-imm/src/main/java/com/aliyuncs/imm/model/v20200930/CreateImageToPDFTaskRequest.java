 ...
 * @version 
 */
public class CreateImageToPDFTaskRequest extends RpcAcsRequest<CreateImageToPDFTaskResponse> {
	...
	public CreateImageToPDFTaskRequest() {
		super("imm", "2020-09-30", "CreateImageToPDFTask", "imm");
	...
	@Override
	public Class<CreateImageToPDFTaskResponse> getResponseClass() {
		return CreateImageToPDFTaskResponse.class;
	}
