...
import com.aliyuncs.imm.transform.v20200930.QueryStoriesResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryStoriesResponse extends AcsResponse {
	...
	public static class StoriesItem {
	...
	@Override
	public QueryStoriesResponse getInstance(UnmarshallerContext context) {
		return	QueryStoriesResponseUnmarshaller.unmarshall(this, context);
	}
