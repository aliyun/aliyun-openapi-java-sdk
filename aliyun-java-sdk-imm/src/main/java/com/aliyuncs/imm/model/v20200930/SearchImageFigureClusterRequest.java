 ...
 * @version 
 */
public class SearchImageFigureClusterRequest extends RpcAcsRequest<SearchImageFigureClusterResponse> {
	...
	public SearchImageFigureClusterRequest() {
		super("imm", "2020-09-30", "SearchImageFigureCluster", "imm");
	...
	@Override
	public Class<SearchImageFigureClusterResponse> getResponseClass() {
		return SearchImageFigureClusterResponse.class;
	}
