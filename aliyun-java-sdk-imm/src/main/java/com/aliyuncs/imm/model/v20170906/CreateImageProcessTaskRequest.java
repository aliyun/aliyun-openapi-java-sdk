 ...
 * @version 
 */
public class CreateImageProcessTaskRequest extends RpcAcsRequest<CreateImageProcessTaskResponse> {
	...
	@Override
	public Class<CreateImageProcessTaskResponse> getResponseClass() {
		return CreateImageProcessTaskResponse.class;
	}
