...
import com.aliyuncs.imm.transform.v20170906.GetOfficeEditURLResponseUnmarshaller;
...
public class GetOfficeEditURLResponse extends AcsResponse {
	...
	@Override
	public GetOfficeEditURLResponse getInstance(UnmarshallerContext context) {
		return	GetOfficeEditURLResponseUnmarshaller.unmarshall(this, context);
	}
