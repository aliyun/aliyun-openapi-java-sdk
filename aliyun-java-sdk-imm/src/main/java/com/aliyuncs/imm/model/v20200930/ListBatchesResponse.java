...
import com.aliyuncs.imm.transform.v20200930.ListBatchesResponseUnmarshaller;
 ...
 * @version 
 */
public class ListBatchesResponse extends AcsResponse {
	...
	public static class BatchesItem {
	...
	@Override
	public ListBatchesResponse getInstance(UnmarshallerContext context) {
		return	ListBatchesResponseUnmarshaller.unmarshall(this, context);
	}
