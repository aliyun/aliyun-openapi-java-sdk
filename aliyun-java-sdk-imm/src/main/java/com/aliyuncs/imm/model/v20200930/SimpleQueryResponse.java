...
import com.aliyuncs.imm.transform.v20200930.SimpleQueryResponseUnmarshaller;
 ...
 * @version 
 */
public class SimpleQueryResponse extends AcsResponse {
	...
	@Override
	public SimpleQueryResponse getInstance(UnmarshallerContext context) {
		return	SimpleQueryResponseUnmarshaller.unmarshall(this, context);
	}
