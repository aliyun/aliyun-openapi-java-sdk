...
public class BatchUpdateFileMetaRequest extends RpcAcsRequest<BatchUpdateFileMetaResponse> {
	...
	public BatchUpdateFileMetaRequest() {
		super("imm", "2020-09-30", "BatchUpdateFileMeta", "imm");
	...
	@Override
	public Class<BatchUpdateFileMetaResponse> getResponseClass() {
		return BatchUpdateFileMetaResponse.class;
	}
