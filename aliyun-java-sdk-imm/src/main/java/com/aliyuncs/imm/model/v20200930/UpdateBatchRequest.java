 ...
 * @version 
 */
public class UpdateBatchRequest extends RpcAcsRequest<UpdateBatchResponse> {
	...
	public UpdateBatchRequest() {
		super("imm", "2020-09-30", "UpdateBatch", "imm");
	...
	@Override
	public Class<UpdateBatchResponse> getResponseClass() {
		return UpdateBatchResponse.class;
	}
