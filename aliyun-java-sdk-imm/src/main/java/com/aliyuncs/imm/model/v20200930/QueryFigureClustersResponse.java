...
import com.aliyuncs.imm.transform.v20200930.QueryFigureClustersResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryFigureClustersResponse extends AcsResponse {
	...
	@Override
	public QueryFigureClustersResponse getInstance(UnmarshallerContext context) {
		return	QueryFigureClustersResponseUnmarshaller.unmarshall(this, context);
	}
