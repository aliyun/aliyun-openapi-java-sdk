...
import com.aliyuncs.imm.transform.v20170906.FaceCompareResponseUnmarshaller;
 ...
 * @version 
 */
public class FaceCompareResponse extends AcsResponse {
	...
	@Override
	public FaceCompareResponse getInstance(UnmarshallerContext context) {
		return	FaceCompareResponseUnmarshaller.unmarshall(this, context);
	}
