 ...
 * @version 
 */
public class DetectImageScoreRequest extends RpcAcsRequest<DetectImageScoreResponse> {
	...
	public DetectImageScoreRequest() {
		super("imm", "2020-09-30", "DetectImageScore", "imm");
	...
	@Override
	public Class<DetectImageScoreResponse> getResponseClass() {
		return DetectImageScoreResponse.class;
	}
