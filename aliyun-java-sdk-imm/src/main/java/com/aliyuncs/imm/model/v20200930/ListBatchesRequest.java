 ...
 * @version 
 */
public class ListBatchesRequest extends RpcAcsRequest<ListBatchesResponse> {
	...
	public ListBatchesRequest() {
		super("imm", "2020-09-30", "ListBatches", "imm");
	...
	@Override
	public Class<ListBatchesResponse> getResponseClass() {
		return ListBatchesResponse.class;
	}
