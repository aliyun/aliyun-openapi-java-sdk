...
import com.aliyuncs.imm.transform.v20200930.BatchGetFileMetaResponseUnmarshaller;
 ...
 * @version 
 */
public class BatchGetFileMetaResponse extends AcsResponse {
	...
	@Override
	public BatchGetFileMetaResponse getInstance(UnmarshallerContext context) {
		return	BatchGetFileMetaResponseUnmarshaller.unmarshall(this, context);
	}
