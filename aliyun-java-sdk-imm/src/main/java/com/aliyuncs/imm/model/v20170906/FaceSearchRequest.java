 ...
 * @version 
 */
public class FaceSearchRequest extends RpcAcsRequest<FaceSearchResponse> {
	
	public FaceSearchRequest() {
		super("imm", "2017-09-06", "FaceSearch", "imm");
	}
	...
	@Override
	public Class<FaceSearchResponse> getResponseClass() {
		return FaceSearchResponse.class;
	}
