 ...
 * @version 
 */
public class FaceRegistRequest extends RpcAcsRequest<FaceRegistResponse> {
	
	public FaceRegistRequest() {
		super("imm", "2017-09-06", "FaceRegist", "imm");
	}
	...
	@Override
	public Class<FaceRegistResponse> getResponseClass() {
		return FaceRegistResponse.class;
	}
