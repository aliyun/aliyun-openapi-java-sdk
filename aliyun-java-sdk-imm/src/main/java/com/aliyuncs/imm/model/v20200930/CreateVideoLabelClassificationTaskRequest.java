 ...
 * @version 
 */
public class CreateVideoLabelClassificationTaskRequest extends RpcAcsRequest<CreateVideoLabelClassificationTaskResponse> {
	...
	public CreateVideoLabelClassificationTaskRequest() {
		super("imm", "2020-09-30", "CreateVideoLabelClassificationTask", "imm");
	...
	@Override
	public Class<CreateVideoLabelClassificationTaskResponse> getResponseClass() {
		return CreateVideoLabelClassificationTaskResponse.class;
	}
