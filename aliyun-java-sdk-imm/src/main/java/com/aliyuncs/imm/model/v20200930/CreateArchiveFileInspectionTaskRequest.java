 ...
 * @version 
 */
public class CreateArchiveFileInspectionTaskRequest extends RpcAcsRequest<CreateArchiveFileInspectionTaskResponse> {
	...
	public CreateArchiveFileInspectionTaskRequest() {
		super("imm", "2020-09-30", "CreateArchiveFileInspectionTask", "imm");
	...
	@Override
	public Class<CreateArchiveFileInspectionTaskResponse> getResponseClass() {
		return CreateArchiveFileInspectionTaskResponse.class;
	}
