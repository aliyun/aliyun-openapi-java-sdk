...
import com.aliyuncs.imm.transform.v20200930.GetVideoLabelClassificationResultResponseUnmarshaller;
 ...
 * @version 
 */
public class GetVideoLabelClassificationResultResponse extends AcsResponse {
	...
	@Override
	public GetVideoLabelClassificationResultResponse getInstance(UnmarshallerContext context) {
		return	GetVideoLabelClassificationResultResponseUnmarshaller.unmarshall(this, context);
	}
