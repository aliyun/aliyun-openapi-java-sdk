 ...
 * @version 
 */
public class DetectImageCarsRequest extends RpcAcsRequest<DetectImageCarsResponse> {
	...
	public DetectImageCarsRequest() {
		super("imm", "2020-09-30", "DetectImageCars", "imm");
	...
	@Override
	public Class<DetectImageCarsResponse> getResponseClass() {
		return DetectImageCarsResponse.class;
	}
