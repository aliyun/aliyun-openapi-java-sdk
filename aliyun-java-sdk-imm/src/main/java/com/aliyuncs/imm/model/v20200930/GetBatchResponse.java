...
import com.aliyuncs.imm.transform.v20200930.GetBatchResponseUnmarshaller;
 ...
 * @version 
 */
public class GetBatchResponse extends AcsResponse {
	...
	@Override
	public GetBatchResponse getInstance(UnmarshallerContext context) {
		return	GetBatchResponseUnmarshaller.unmarshall(this, context);
	}
