...
import com.aliyuncs.imm.transform.v20200930.GenerateWebofficeTokenResponseUnmarshaller;
 ...
 * @version 
 */
public class GenerateWebofficeTokenResponse extends AcsResponse {
	...
	@Override
	public GenerateWebofficeTokenResponse getInstance(UnmarshallerContext context) {
		return	GenerateWebofficeTokenResponseUnmarshaller.unmarshall(this, context);
	}
