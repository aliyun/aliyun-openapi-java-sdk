 ...
 * @version 
 */
public class DetectMediaMetaRequest extends RpcAcsRequest<DetectMediaMetaResponse> {
	...
	public DetectMediaMetaRequest() {
		super("imm", "2020-09-30", "DetectMediaMeta", "imm");
	...
	@Override
	public Class<DetectMediaMetaResponse> getResponseClass() {
		return DetectMediaMetaResponse.class;
	}
