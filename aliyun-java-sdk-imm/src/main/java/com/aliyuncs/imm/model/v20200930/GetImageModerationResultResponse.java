...
import com.aliyuncs.imm.transform.v20200930.GetImageModerationResultResponseUnmarshaller;
 ...
 * @version 
 */
public class GetImageModerationResultResponse extends AcsResponse {
	...
	@Override
	public GetImageModerationResultResponse getInstance(UnmarshallerContext context) {
		return	GetImageModerationResultResponseUnmarshaller.unmarshall(this, context);
	}
