...
public class DeleteTagJobRequest extends RpcAcsRequest<DeleteTagJobResponse> {
	...
	public void setClearIndexData(String clearIndexData) {
		this.clearIndexData = clearIndexData;
		if(clearIndexData != null){
			putQueryParameter("ClearIndexData", clearIndexData);
		}
	}

	@Override
	public Class<DeleteTagJobResponse> getResponseClass() {
		return DeleteTagJobResponse.class;
	}
