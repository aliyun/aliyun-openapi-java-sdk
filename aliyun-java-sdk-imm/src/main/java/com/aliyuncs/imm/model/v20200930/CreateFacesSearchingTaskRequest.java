 ...
 * @version 
 */
public class CreateFacesSearchingTaskRequest extends RpcAcsRequest<CreateFacesSearchingTaskResponse> {
	...
	public CreateFacesSearchingTaskRequest() {
		super("imm", "2020-09-30", "CreateFacesSearchingTask", "imm");
	...
	@Override
	public Class<CreateFacesSearchingTaskResponse> getResponseClass() {
		return CreateFacesSearchingTaskResponse.class;
	}
