...
import com.aliyuncs.imm.transform.v20200930.GetTriggerResponseUnmarshaller;
 ...
 * @version 
 */
public class GetTriggerResponse extends AcsResponse {
	...
	@Override
	public GetTriggerResponse getInstance(UnmarshallerContext context) {
		return	GetTriggerResponseUnmarshaller.unmarshall(this, context);
	}
