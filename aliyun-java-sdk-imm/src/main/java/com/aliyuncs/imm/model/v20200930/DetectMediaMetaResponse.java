...
import com.aliyuncs.imm.transform.v20200930.DetectMediaMetaResponseUnmarshaller;
 ...
 * @version 
 */
public class DetectMediaMetaResponse extends AcsResponse {
	...
	@Override
	public DetectMediaMetaResponse getInstance(UnmarshallerContext context) {
		return	DetectMediaMetaResponseUnmarshaller.unmarshall(this, context);
	}
