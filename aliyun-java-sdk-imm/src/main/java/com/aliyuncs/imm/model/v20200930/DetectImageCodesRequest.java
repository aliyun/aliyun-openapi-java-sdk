 ...
 * @version 
 */
public class DetectImageCodesRequest extends RpcAcsRequest<DetectImageCodesResponse> {
	...
	public DetectImageCodesRequest() {
		super("imm", "2020-09-30", "DetectImageCodes", "imm");
	...
	@Override
	public Class<DetectImageCodesResponse> getResponseClass() {
		return DetectImageCodesResponse.class;
	}
