...
import com.aliyuncs.imm.transform.v20200930.FuzzyQueryResponseUnmarshaller;
 ...
 * @version 
 */
public class FuzzyQueryResponse extends AcsResponse {
	...
	@Override
	public FuzzyQueryResponse getInstance(UnmarshallerContext context) {
		return	FuzzyQueryResponseUnmarshaller.unmarshall(this, context);
	}
