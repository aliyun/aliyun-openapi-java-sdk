 ...
 * @version 
 */
public class ExtractDocumentTextRequest extends RpcAcsRequest<ExtractDocumentTextResponse> {
	...
	public ExtractDocumentTextRequest() {
		super("imm", "2020-09-30", "ExtractDocumentText", "imm");
	...
	@Override
	public Class<ExtractDocumentTextResponse> getResponseClass() {
		return ExtractDocumentTextResponse.class;
	}
