...
import com.aliyuncs.imm.transform.v20200930.BatchGetFigureClusterResponseUnmarshaller;
 ...
 * @version 
 */
public class BatchGetFigureClusterResponse extends AcsResponse {
	...
	public void setFigureClusters(List<FigureClustersItem> figureClusters) {
		this.figureClusters = figureClusters;
	}

	public static class FigureClustersItem {
	...
	@Override
	public BatchGetFigureClusterResponse getInstance(UnmarshallerContext context) {
		return	BatchGetFigureClusterResponseUnmarshaller.unmarshall(this, context);
	}
