 ...
 * @version 
 */
public class CreateFileUncompressionTaskRequest extends RpcAcsRequest<CreateFileUncompressionTaskResponse> {
	...
	public CreateFileUncompressionTaskRequest() {
		super("imm", "2020-09-30", "CreateFileUncompressionTask", "imm");
	...
	public void setSelectedFiles(List<String> selectedFiles) {
		...
		if (selectedFiles != null) {
			putQueryParameter("SelectedFiles" , new Gson().toJson(selectedFiles));
		}	
	}
	...
	public void setTarget(Target target) {
		this.target = target;	
		if (target != null) {
			putQueryParameter("Target" , new Gson().toJson(target));
		}	
	}
	...
	@Override
	public Class<CreateFileUncompressionTaskResponse> getResponseClass() {
		return CreateFileUncompressionTaskResponse.class;
	}
