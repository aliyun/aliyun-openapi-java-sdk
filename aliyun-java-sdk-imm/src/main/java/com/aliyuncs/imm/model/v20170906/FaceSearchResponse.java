...
import com.aliyuncs.imm.transform.v20170906.FaceSearchResponseUnmarshaller;
 ...
 * @version 
 */
public class FaceSearchResponse extends AcsResponse {
	...
	@Override
	public FaceSearchResponse getInstance(UnmarshallerContext context) {
		return	FaceSearchResponseUnmarshaller.unmarshall(this, context);
	}
