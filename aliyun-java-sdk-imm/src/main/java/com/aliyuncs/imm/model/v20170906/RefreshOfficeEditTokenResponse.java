...
import com.aliyuncs.imm.transform.v20170906.RefreshOfficeEditTokenResponseUnmarshaller;
...
public class RefreshOfficeEditTokenResponse extends AcsResponse {
	...
	@Override
	public RefreshOfficeEditTokenResponse getInstance(UnmarshallerContext context) {
		return	RefreshOfficeEditTokenResponseUnmarshaller.unmarshall(this, context);
	}
