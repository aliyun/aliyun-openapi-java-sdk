...
@RunWith(Suite.class)
@SuiteClasses({HttpTest.class, UtilsTest.class, DefaultProfileTest.class, ErrorHandlingTest.class, CredentialTest.class,
        AuthTest.class, ClientExceptionTest.class, DefaultAcsClientTest.class, APIEncapsulateTest.class, CoreTest.class,
        UnmarshallerContextTest.class, JsonReaderTest.class, XmlReaderTest.class, ShaHmac256Test.class,
        CredentialTest.class, ParameterHelperTest.class, NewEndpointTest.class})
