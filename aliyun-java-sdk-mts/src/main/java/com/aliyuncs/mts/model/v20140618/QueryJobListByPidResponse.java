...
import com.aliyuncs.mts.transform.v20140618.QueryJobListByPidResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryJobListByPidResponse extends AcsResponse {
	...
	@Override
	public QueryJobListByPidResponse getInstance(UnmarshallerContext context) {
		return	QueryJobListByPidResponseUnmarshaller.unmarshall(this, context);
	}
}
