...
import com.aliyuncs.mts.transform.v20140618.QuerySystemTemplateListResponseUnmarshaller;
 ...
 * @version 
 */
public class QuerySystemTemplateListResponse extends AcsResponse {
	...
	@Override
	public QuerySystemTemplateListResponse getInstance(UnmarshallerContext context) {
		return	QuerySystemTemplateListResponseUnmarshaller.unmarshall(this, context);
	}
}
