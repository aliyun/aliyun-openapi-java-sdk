...
import com.aliyuncs.mts.transform.v20140618.QueryJobListByFileResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryJobListByFileResponse extends AcsResponse {

	private String requestId;

	private List<Job> jobList;

	private List<String> nonExistUploadFileObjects;
	...
	public List<String> getNonExistUploadFileObjects() {
		return this.nonExistUploadFileObjects;
	}

	public void setNonExistUploadFileObjects(List<String> nonExistUploadFileObjects) {
		this.nonExistUploadFileObjects = nonExistUploadFileObjects;
	}
	...
	public static class Job {
		...
		private List<FileJob> fileJobList;
		...
		public List<FileJob> getFileJobList() {
			return this.fileJobList;
		}

		public void setFileJobList(List<FileJob> fileJobList) {
			this.fileJobList = fileJobList;
		}
		...
		public static class FileJob {
			...
			public void setTranscodeJob(TranscodeJob transcodeJob) {
	...
	@Override
	public QueryJobListByFileResponse getInstance(UnmarshallerContext context) {
		return	QueryJobListByFileResponseUnmarshaller.unmarshall(this, context);
	}
}
