 ...
 * @version 
 */
public class SubmitComplexJobResponse extends AcsResponse {
	...
	public void setComplexJob(ComplexJob complexJob) {
		this.complexJob = complexJob;
	}

	public static class ComplexJob {
	...
	@Override
	public SubmitComplexJobResponse getInstance(UnmarshallerContext context) {
		return	SubmitComplexJobResponseUnmarshaller.unmarshall(this, context);
	}
}
