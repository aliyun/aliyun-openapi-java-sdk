 ...
 * @version 
 */
public class ListCustomViewsRequest extends RpcAcsRequest<ListCustomViewsResponse> {
	...
	public ListCustomViewsRequest() {
		super("Mts", "2014-06-18", "ListCustomViews", "mts");
	...
	@Override
	public Class<ListCustomViewsResponse> getResponseClass() {
		return ListCustomViewsResponse.class;
	}
