 ...
 * @version 
 */
public class ListFpShotFilesRequest extends RpcAcsRequest<ListFpShotFilesResponse> {
	...
	@Override
	public Class<ListFpShotFilesResponse> getResponseClass() {
		return ListFpShotFilesResponse.class;
	}
