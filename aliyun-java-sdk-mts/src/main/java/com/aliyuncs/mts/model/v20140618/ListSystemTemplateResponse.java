...
import com.aliyuncs.mts.transform.v20140618.ListSystemTemplateResponseUnmarshaller;
 ...
 * @version 
 */
public class ListSystemTemplateResponse extends AcsResponse {
	...
	@Override
	public ListSystemTemplateResponse getInstance(UnmarshallerContext context) {
		return	ListSystemTemplateResponseUnmarshaller.unmarshall(this, context);
	}
}
