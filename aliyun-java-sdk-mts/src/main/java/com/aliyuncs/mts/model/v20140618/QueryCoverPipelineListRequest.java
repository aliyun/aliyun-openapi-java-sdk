 ...
 * @version 
 */
public class QueryCoverPipelineListRequest extends RpcAcsRequest<QueryCoverPipelineListResponse> {
	...
	@Override
	public Class<QueryCoverPipelineListResponse> getResponseClass() {
		return QueryCoverPipelineListResponse.class;
	}
