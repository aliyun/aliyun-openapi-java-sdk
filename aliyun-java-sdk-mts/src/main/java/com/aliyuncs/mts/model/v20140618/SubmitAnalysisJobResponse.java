...
import com.aliyuncs.mts.transform.v20140618.SubmitAnalysisJobResponseUnmarshaller;
 ...
 * @version 
 */
public class SubmitAnalysisJobResponse extends AcsResponse {
	...
	@Override
	public SubmitAnalysisJobResponse getInstance(UnmarshallerContext context) {
		return	SubmitAnalysisJobResponseUnmarshaller.unmarshall(this, context);
	}
}
