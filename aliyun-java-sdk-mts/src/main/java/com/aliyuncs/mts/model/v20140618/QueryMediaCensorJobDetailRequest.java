...
public class QueryMediaCensorJobDetailRequest extends RpcAcsRequest<QueryMediaCensorJobDetailResponse> {
	...
	public QueryMediaCensorJobDetailRequest() {
		super("Mts", "2014-06-18", "QueryMediaCensorJobDetail");
	...
	@Override
	public Class<QueryMediaCensorJobDetailResponse> getResponseClass() {
		return QueryMediaCensorJobDetailResponse.class;
	}
