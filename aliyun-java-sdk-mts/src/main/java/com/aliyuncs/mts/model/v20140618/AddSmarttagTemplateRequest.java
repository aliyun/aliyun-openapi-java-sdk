 ...
 * @version 
 */
public class AddSmarttagTemplateRequest extends RpcAcsRequest<AddSmarttagTemplateResponse> {
	...
	@Override
	public Class<AddSmarttagTemplateResponse> getResponseClass() {
		return AddSmarttagTemplateResponse.class;
	}
