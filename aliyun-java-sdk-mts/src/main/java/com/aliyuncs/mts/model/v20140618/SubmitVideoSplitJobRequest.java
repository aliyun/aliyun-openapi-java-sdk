...
public class SubmitVideoSplitJobRequest extends RpcAcsRequest<SubmitVideoSplitJobResponse> {
	...
	public void setVideoSplitConfig(String videoSplitConfig) {
		this.videoSplitConfig = videoSplitConfig;
		if(videoSplitConfig != null){
			putQueryParameter("VideoSplitConfig", videoSplitConfig);
		}
	}
	...
	@Override
	public Class<SubmitVideoSplitJobResponse> getResponseClass() {
		return SubmitVideoSplitJobResponse.class;
	}
