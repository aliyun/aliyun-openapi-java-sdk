 ...
 * @version 
 */
public class UpdateMediaResponse extends AcsResponse {
	...
	@Override
	public UpdateMediaResponse getInstance(UnmarshallerContext context) {
		return	UpdateMediaResponseUnmarshaller.unmarshall(this, context);
	}
}
