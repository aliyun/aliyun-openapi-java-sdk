 ...
 * @version 
 */
public class DeleteCustomEntityRequest extends RpcAcsRequest<DeleteCustomEntityResponse> {
	...
	public DeleteCustomEntityRequest() {
		super("Mts", "2014-06-18", "DeleteCustomEntity", "mts");
	...
	@Override
	public Class<DeleteCustomEntityResponse> getResponseClass() {
		return DeleteCustomEntityResponse.class;
	}
