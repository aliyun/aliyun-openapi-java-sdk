...
import com.aliyuncs.mts.transform.v20140618.QueryEditingJobListResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryEditingJobListResponse extends AcsResponse {
	...
	public static class Job {
		...
		public static class EditingConfig {
			...
			public static class Editing {
				...
				private List<Clip3> clipList;

				private Timeline timeline;

				public List<Clip3> getClipList() {
					return this.clipList;
				}

				public void setClipList(List<Clip3> clipList) {
				...
				public static class Timeline {
					...
					public static class Track {
						...
						public List<Clip4> getClips() {
							return this.clips;
						}

						public void setClips(List<Clip4> clips) {
							this.clips = clips;
						}
	...
	@Override
	public QueryEditingJobListResponse getInstance(UnmarshallerContext context) {
		return	QueryEditingJobListResponseUnmarshaller.unmarshall(this, context);
	}
}
