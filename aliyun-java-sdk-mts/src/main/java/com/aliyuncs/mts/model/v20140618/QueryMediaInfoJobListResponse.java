 ...
 * @version 
 */
public class QueryMediaInfoJobListResponse extends AcsResponse {
	...
	public List<MediaInfoJob> getMediaInfoJobList() {
		return this.mediaInfoJobList;
	}

	public void setMediaInfoJobList(List<MediaInfoJob> mediaInfoJobList) {
		this.mediaInfoJobList = mediaInfoJobList;
	}

	public List<String> getNonExistMediaInfoJobIds() {
		return this.nonExistMediaInfoJobIds;
	}

	public void setNonExistMediaInfoJobIds(List<String> nonExistMediaInfoJobIds) {
	...
	@Override
	public QueryMediaInfoJobListResponse getInstance(UnmarshallerContext context) {
		return	QueryMediaInfoJobListResponseUnmarshaller.unmarshall(this, context);
	}
}
