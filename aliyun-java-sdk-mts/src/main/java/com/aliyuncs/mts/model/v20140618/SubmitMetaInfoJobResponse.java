...
import com.aliyuncs.mts.transform.v20140618.SubmitMetaInfoJobResponseUnmarshaller;
 ...
 * @version 
 */
public class SubmitMetaInfoJobResponse extends AcsResponse {

	private String requestId;

	private MetaInfoJob metaInfoJob;
	...
	public MetaInfoJob getMetaInfoJob() {
		return this.metaInfoJob;
	}

	public void setMetaInfoJob(MetaInfoJob metaInfoJob) {
		this.metaInfoJob = metaInfoJob;
	}
	...
	@Override
	public SubmitMetaInfoJobResponse getInstance(UnmarshallerContext context) {
		return	SubmitMetaInfoJobResponseUnmarshaller.unmarshall(this, context);
	}
}
