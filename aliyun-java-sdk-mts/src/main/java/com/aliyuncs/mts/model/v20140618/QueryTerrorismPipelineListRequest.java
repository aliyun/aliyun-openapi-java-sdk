 ...
 * @version 
 */
public class QueryTerrorismPipelineListRequest extends RpcAcsRequest<QueryTerrorismPipelineListResponse> {
	...
	@Override
	public Class<QueryTerrorismPipelineListResponse> getResponseClass() {
		return QueryTerrorismPipelineListResponse.class;
	}
