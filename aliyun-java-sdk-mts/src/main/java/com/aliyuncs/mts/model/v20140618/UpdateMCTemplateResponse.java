...
import com.aliyuncs.mts.transform.v20140618.UpdateMCTemplateResponseUnmarshaller;
 ...
 * @version 
 */
public class UpdateMCTemplateResponse extends AcsResponse {
	...
	@Override
	public UpdateMCTemplateResponse getInstance(UnmarshallerContext context) {
		return	UpdateMCTemplateResponseUnmarshaller.unmarshall(this, context);
	}
}
