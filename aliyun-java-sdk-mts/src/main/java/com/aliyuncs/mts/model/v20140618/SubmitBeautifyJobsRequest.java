...
public class SubmitBeautifyJobsRequest extends RpcAcsRequest<SubmitBeautifyJobsResponse> {
	...
	public void setBeautifyConfig(String beautifyConfig) {
		this.beautifyConfig = beautifyConfig;
		if(beautifyConfig != null){
			putQueryParameter("BeautifyConfig", beautifyConfig);
		}
	}
	...
	@Override
	public Class<SubmitBeautifyJobsResponse> getResponseClass() {
		return SubmitBeautifyJobsResponse.class;
	}
