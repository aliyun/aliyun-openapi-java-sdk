 ...
 * @version 
 */
public class DeleteMediaWorkflowRequest extends RpcAcsRequest<DeleteMediaWorkflowResponse> {
	...
	@Override
	public Class<DeleteMediaWorkflowResponse> getResponseClass() {
		return DeleteMediaWorkflowResponse.class;
	}
