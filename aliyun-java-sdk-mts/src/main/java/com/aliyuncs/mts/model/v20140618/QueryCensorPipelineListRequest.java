 ...
 * @version 
 */
public class QueryCensorPipelineListRequest extends RpcAcsRequest<QueryCensorPipelineListResponse> {
	...
	@Override
	public Class<QueryCensorPipelineListResponse> getResponseClass() {
		return QueryCensorPipelineListResponse.class;
	}
