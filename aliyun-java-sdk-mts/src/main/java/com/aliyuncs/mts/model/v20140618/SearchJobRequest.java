 ...
 * @version 
 */
public class SearchJobRequest extends RpcAcsRequest<SearchJobResponse> {
	
	public SearchJobRequest() {
		super("Mts", "2014-06-18", "SearchJob");
	}
	...
	@Override
	public Class<SearchJobResponse> getResponseClass() {
		return SearchJobResponse.class;
	}
