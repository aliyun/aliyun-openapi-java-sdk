...
import com.aliyuncs.mts.transform.v20140618.QueryMetaInfoJobListResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryMetaInfoJobListResponse extends AcsResponse {

	private String requestId;

	private List<MetaInfoJob> metaInfoJobList;

	private List<String> nonExistMetaInfoJobIds;
	...
	public List<MetaInfoJob> getMetaInfoJobList() {
		return this.metaInfoJobList;
	}

	public void setMetaInfoJobList(List<MetaInfoJob> metaInfoJobList) {
		this.metaInfoJobList = metaInfoJobList;
	}

	public List<String> getNonExistMetaInfoJobIds() {
		return this.nonExistMetaInfoJobIds;
	}

	public void setNonExistMetaInfoJobIds(List<String> nonExistMetaInfoJobIds) {
		this.nonExistMetaInfoJobIds = nonExistMetaInfoJobIds;
	}

	public static class MetaInfoJob {
	...
	@Override
	public QueryMetaInfoJobListResponse getInstance(UnmarshallerContext context) {
		return	QueryMetaInfoJobListResponseUnmarshaller.unmarshall(this, context);
	}
}
