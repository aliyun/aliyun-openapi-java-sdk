...
import com.aliyuncs.mts.transform.v20140618.QueryJobListResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryJobListResponse extends AcsResponse {
	...
	public static class Job {
		...
		public static class Output {
			...
			public static class Properties {
				...
				private List<SourceLogo> sourceLogos;
				...
				public List<SourceLogo> getSourceLogos() {
					return this.sourceLogos;
				}

				public void setSourceLogos(List<SourceLogo> sourceLogos) {
				...
				public static class SourceLogo {
	...
	@Override
	public QueryJobListResponse getInstance(UnmarshallerContext context) {
		return	QueryJobListResponseUnmarshaller.unmarshall(this, context);
	}
}
