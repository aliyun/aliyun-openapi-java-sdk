...
import com.aliyuncs.mts.transform.v20140618.QueryVideoPoseJobListResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryVideoPoseJobListResponse extends AcsResponse {
	...
	@Override
	public QueryVideoPoseJobListResponse getInstance(UnmarshallerContext context) {
		return	QueryVideoPoseJobListResponseUnmarshaller.unmarshall(this, context);
	}
}
