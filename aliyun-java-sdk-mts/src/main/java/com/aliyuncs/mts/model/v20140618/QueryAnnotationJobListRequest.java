...
public class QueryAnnotationJobListRequest extends RpcAcsRequest<QueryAnnotationJobListResponse> {
	...
	public void setAnnotationJobIds(String annotationJobIds) {
		this.annotationJobIds = annotationJobIds;
		if(annotationJobIds != null){
			putQueryParameter("AnnotationJobIds", annotationJobIds);
		}
	}

	@Override
	public Class<QueryAnnotationJobListResponse> getResponseClass() {
		return QueryAnnotationJobListResponse.class;
	}
