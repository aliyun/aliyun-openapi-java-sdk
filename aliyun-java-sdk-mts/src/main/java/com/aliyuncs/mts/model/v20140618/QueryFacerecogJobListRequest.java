...
public class QueryFacerecogJobListRequest extends RpcAcsRequest<QueryFacerecogJobListResponse> {
	...
	public void setFacerecogJobIds(String facerecogJobIds) {
		this.facerecogJobIds = facerecogJobIds;
		if(facerecogJobIds != null){
			putQueryParameter("FacerecogJobIds", facerecogJobIds);
		}
	}
	...
	@Override
	public Class<QueryFacerecogJobListResponse> getResponseClass() {
		return QueryFacerecogJobListResponse.class;
	}
