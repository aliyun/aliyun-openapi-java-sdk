 ...
 * @version 
 */
public class ModifyDBClusterConfigInXMLRequest extends RpcAcsRequest<ModifyDBClusterConfigInXMLResponse> {
	...
	@Override
	public Class<ModifyDBClusterConfigInXMLResponse> getResponseClass() {
