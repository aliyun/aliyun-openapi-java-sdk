...
public class DescribeDBClusterAttributeRequest extends RpcAcsRequest<DescribeDBClusterAttributeResponse> {
	...
	public DescribeDBClusterAttributeRequest() {
		super("clickhouse", "2019-11-11", "DescribeDBClusterAttribute", "service");
	...
	@Override
	public Class<DescribeDBClusterAttributeResponse> getResponseClass() {
		return DescribeDBClusterAttributeResponse.class;
	}
