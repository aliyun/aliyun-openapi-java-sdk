 ...
 * @version 
 */
public class CreateRDSToClickhouseDbRequest extends RpcAcsRequest<CreateRDSToClickhouseDbResponse> {
	...
	public void setSynDbTables(String synDbTables) {
		this.synDbTables = synDbTables;
		if(synDbTables != null){
			putQueryParameter("SynDbTables", synDbTables);
		}
	}
	...
	@Override
	public Class<CreateRDSToClickhouseDbResponse> getResponseClass() {
		return CreateRDSToClickhouseDbResponse.class;
	}
