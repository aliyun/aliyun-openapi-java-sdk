 ...
 * @version 
 */
public class CreateAccountAndAuthorityRequest extends RpcAcsRequest<CreateAccountAndAuthorityResponse> {
	...
	@Override
	public Class<CreateAccountAndAuthorityResponse> getResponseClass() {
		return CreateAccountAndAuthorityResponse.class;
	}
