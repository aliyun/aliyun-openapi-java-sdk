 ...
 * @version 
 */
public class CreateMonitorDataReportRequest extends RpcAcsRequest<CreateMonitorDataReportResponse> {
	...
	@Override
	public Class<CreateMonitorDataReportResponse> getResponseClass() {
