 ...
 * @version 
 */
public class CheckVersionTransferRequest extends RpcAcsRequest<CheckVersionTransferResponse> {
	...
	public CheckVersionTransferRequest() {
		super("clickhouse", "2019-11-11", "CheckVersionTransfer");
	...
	public void setCheckAccount(Boolean checkAccount) {
		...
		if(checkAccount != null){
			putQueryParameter("CheckAccount", checkAccount.toString());
		}
	}
	...
	@Override
	public Class<CheckVersionTransferResponse> getResponseClass() {
		return CheckVersionTransferResponse.class;
	}
