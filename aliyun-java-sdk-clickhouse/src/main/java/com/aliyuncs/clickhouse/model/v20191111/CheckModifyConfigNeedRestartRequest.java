 ...
 * @version 
 */
public class CheckModifyConfigNeedRestartRequest extends RpcAcsRequest<CheckModifyConfigNeedRestartResponse> {
	...
	@Override
	public Class<CheckModifyConfigNeedRestartResponse> getResponseClass() {
