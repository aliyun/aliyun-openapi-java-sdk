 ...
 * @version 
 */
public class DescribeRDSschemasRequest extends RpcAcsRequest<DescribeRDSschemasResponse> {
	...
	@Override
	public Class<DescribeRDSschemasResponse> getResponseClass() {
		return DescribeRDSschemasResponse.class;
	}
