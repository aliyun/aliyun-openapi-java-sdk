 ...
 * @version 
 */
public class SearchRDSTablesRequest extends RpcAcsRequest<SearchRDSTablesResponse> {
	...
	@Override
	public Class<SearchRDSTablesResponse> getResponseClass() {
		return SearchRDSTablesResponse.class;
	}
