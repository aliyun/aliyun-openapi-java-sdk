 ...
 * @version 
 */
public class StartScenarioRequest extends RpcAcsRequest<StartScenarioResponse> {
	...
	@Override
	public Class<StartScenarioResponse> getResponseClass() {
		return StartScenarioResponse.class;
	}
