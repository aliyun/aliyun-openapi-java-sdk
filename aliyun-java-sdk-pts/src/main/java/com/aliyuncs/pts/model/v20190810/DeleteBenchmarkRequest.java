 ...
 * @version 
 */
public class DeleteBenchmarkRequest extends RpcAcsRequest<DeleteBenchmarkResponse> {
	...
	@Override
	public Class<DeleteBenchmarkResponse> getResponseClass() {
		return DeleteBenchmarkResponse.class;
	}
