 ...
 * @version 
 */
public class DescribeAgentGCInfoRequest extends RpcAcsRequest<DescribeAgentGCInfoResponse> {
	...
	@Override
	public Class<DescribeAgentGCInfoResponse> getResponseClass() {
		return DescribeAgentGCInfoResponse.class;
	}
