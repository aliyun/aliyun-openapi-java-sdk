 ...
 * @version 
 */
public class SaveBenchmarkRequest extends RpcAcsRequest<SaveBenchmarkResponse> {
	   

	private String routeRequestBody;
	public SaveBenchmarkRequest() {
		super("PTS", "2019-08-10", "SaveBenchmark", "1.0.0");
	...
	@Override
	public Class<SaveBenchmarkResponse> getResponseClass() {
		return SaveBenchmarkResponse.class;
	}
