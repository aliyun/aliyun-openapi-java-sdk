 ...
 * @version 
 */
public class GetPtsReportDetailsRequest extends RpcAcsRequest<GetPtsReportDetailsResponse> {
	...
	@Override
	public Class<GetPtsReportDetailsResponse> getResponseClass() {
		return GetPtsReportDetailsResponse.class;
	}
