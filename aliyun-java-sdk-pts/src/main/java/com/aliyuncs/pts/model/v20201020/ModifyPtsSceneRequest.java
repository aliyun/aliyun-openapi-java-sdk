 ...
 * @version 
 */
public class ModifyPtsSceneRequest extends RpcAcsRequest<ModifyPtsSceneResponse> {
	...
	@Override
	public Class<ModifyPtsSceneResponse> getResponseClass() {
		return ModifyPtsSceneResponse.class;
	}
