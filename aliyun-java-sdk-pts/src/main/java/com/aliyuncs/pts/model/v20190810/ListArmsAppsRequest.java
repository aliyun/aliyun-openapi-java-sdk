 ...
 * @version 
 */
public class ListArmsAppsRequest extends RpcAcsRequest<ListArmsAppsResponse> {
	...
	@Override
	public Class<ListArmsAppsResponse> getResponseClass() {
		return ListArmsAppsResponse.class;
	}
