 ...
 * @version 
 */
public class DeleteScenarioRecordRequest extends RpcAcsRequest<DeleteScenarioRecordResponse> {
	...
	@Override
	public Class<DeleteScenarioRecordResponse> getResponseClass() {
		return DeleteScenarioRecordResponse.class;
	}
