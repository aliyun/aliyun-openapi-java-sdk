 ...
 * @version 
 */
public class SaveScenarioRequest extends RpcAcsRequest<SaveScenarioResponse> {
	...
	@Override
	public Class<SaveScenarioResponse> getResponseClass() {
		return SaveScenarioResponse.class;
	}
