 ...
 * @version 
 */
public class StopPtsSceneRequest extends RpcAcsRequest<StopPtsSceneResponse> {
	...
	@Override
	public Class<StopPtsSceneResponse> getResponseClass() {
		return StopPtsSceneResponse.class;
	}
