 ...
 * @version 
 */
public class DescribeAgentNetTrafficRequest extends RpcAcsRequest<DescribeAgentNetTrafficResponse> {
	...
	@Override
	public Class<DescribeAgentNetTrafficResponse> getResponseClass() {
		return DescribeAgentNetTrafficResponse.class;
	}
