 ...
 * @version 
 */
public class ListJMeterReportsRequest extends RpcAcsRequest<ListJMeterReportsResponse> {
	...
	public ListJMeterReportsRequest() {
		super("PTS", "2020-10-20", "ListJMeterReports");
	...
	@Override
	public Class<ListJMeterReportsResponse> getResponseClass() {
		return ListJMeterReportsResponse.class;
	}
