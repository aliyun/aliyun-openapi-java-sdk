 ...
 * @version 
 */
public class DescribeProjectStatusRequest extends RpcAcsRequest<DescribeProjectStatusResponse> {
	...
	@Override
	public Class<DescribeProjectStatusResponse> getResponseClass() {
		return DescribeProjectStatusResponse.class;
	}
