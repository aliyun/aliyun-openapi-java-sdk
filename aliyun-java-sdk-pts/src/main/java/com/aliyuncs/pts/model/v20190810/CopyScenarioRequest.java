 ...
 * @version 
 */
public class CopyScenarioRequest extends RpcAcsRequest<CopyScenarioResponse> {
	   

	private String routeRequestBody;
	public CopyScenarioRequest() {
		super("PTS", "2019-08-10", "CopyScenario", "1.0.0");
	...
	@Override
	public Class<CopyScenarioResponse> getResponseClass() {
		return CopyScenarioResponse.class;
	}
