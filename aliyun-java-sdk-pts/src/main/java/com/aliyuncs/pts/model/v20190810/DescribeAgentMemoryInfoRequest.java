 ...
 * @version 
 */
public class DescribeAgentMemoryInfoRequest extends RpcAcsRequest<DescribeAgentMemoryInfoResponse> {
	...
	@Override
	public Class<DescribeAgentMemoryInfoResponse> getResponseClass() {
		return DescribeAgentMemoryInfoResponse.class;
	}
