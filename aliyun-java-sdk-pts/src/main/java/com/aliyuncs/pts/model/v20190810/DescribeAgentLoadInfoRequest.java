 ...
 * @version 
 */
public class DescribeAgentLoadInfoRequest extends RpcAcsRequest<DescribeAgentLoadInfoResponse> {
	...
	@Override
	public Class<DescribeAgentLoadInfoResponse> getResponseClass() {
		return DescribeAgentLoadInfoResponse.class;
	}
