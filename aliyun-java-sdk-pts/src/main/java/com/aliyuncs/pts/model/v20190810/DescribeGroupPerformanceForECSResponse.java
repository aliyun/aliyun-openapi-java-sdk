...
import com.aliyuncs.pts.transform.v20190810.DescribeGroupPerformanceForECSResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeGroupPerformanceForECSResponse extends AcsResponse {
	...
	@Override
	public DescribeGroupPerformanceForECSResponse getInstance(UnmarshallerContext context) {
		return	DescribeGroupPerformanceForECSResponseUnmarshaller.unmarshall(this, context);
	}
