 ...
 * @version 
 */
public class StopScenarioRequest extends RpcAcsRequest<StopScenarioResponse> {
	...
	@Override
	public Class<StopScenarioResponse> getResponseClass() {
		return StopScenarioResponse.class;
	}
