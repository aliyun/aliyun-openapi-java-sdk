 ...
 * @version 
 */
public class DescribeBenchmarkRequest extends RpcAcsRequest<DescribeBenchmarkResponse> {
	...
	@Override
	public Class<DescribeBenchmarkResponse> getResponseClass() {
		return DescribeBenchmarkResponse.class;
	}
