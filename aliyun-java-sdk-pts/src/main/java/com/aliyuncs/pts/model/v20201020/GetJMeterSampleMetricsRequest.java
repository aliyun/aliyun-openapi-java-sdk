 ...
 * @version 
 */
public class GetJMeterSampleMetricsRequest extends RpcAcsRequest<GetJMeterSampleMetricsResponse> {
	...
	public GetJMeterSampleMetricsRequest() {
		super("PTS", "2020-10-20", "GetJMeterSampleMetrics");
	...
	@Override
	public Class<GetJMeterSampleMetricsResponse> getResponseClass() {
		return GetJMeterSampleMetricsResponse.class;
	}
