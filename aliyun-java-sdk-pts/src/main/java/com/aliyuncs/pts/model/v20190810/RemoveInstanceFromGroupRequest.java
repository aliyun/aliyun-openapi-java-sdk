 ...
 * @version 
 */
public class RemoveInstanceFromGroupRequest extends RpcAcsRequest<RemoveInstanceFromGroupResponse> {
	...
	@Override
	public Class<RemoveInstanceFromGroupResponse> getResponseClass() {
		return RemoveInstanceFromGroupResponse.class;
	}
