 ...
 * @version 
 */
public class DescribeScenarioRecordDetailRequest extends RpcAcsRequest<DescribeScenarioRecordDetailResponse> {
	...
	@Override
	public Class<DescribeScenarioRecordDetailResponse> getResponseClass() {
		return DescribeScenarioRecordDetailResponse.class;
	}
