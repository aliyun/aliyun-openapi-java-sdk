...
import com.aliyuncs.pts.transform.v20190810.DescribeGroupPerformanceResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeGroupPerformanceResponse extends AcsResponse {
	...
	private String monitorGroupPerformanceViewList;
	...
	public String getMonitorGroupPerformanceViewList() {
		return this.monitorGroupPerformanceViewList;
	}

	public void setMonitorGroupPerformanceViewList(String monitorGroupPerformanceViewList) {
		this.monitorGroupPerformanceViewList = monitorGroupPerformanceViewList;
	}
	...
	@Override
	public DescribeGroupPerformanceResponse getInstance(UnmarshallerContext context) {
		return	DescribeGroupPerformanceResponseUnmarshaller.unmarshall(this, context);
	}
