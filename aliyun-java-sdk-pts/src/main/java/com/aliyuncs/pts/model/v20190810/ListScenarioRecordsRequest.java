 ...
 * @version 
 */
public class ListScenarioRecordsRequest extends RpcAcsRequest<ListScenarioRecordsResponse> {
	...
	@Override
	public Class<ListScenarioRecordsResponse> getResponseClass() {
		return ListScenarioRecordsResponse.class;
	}
