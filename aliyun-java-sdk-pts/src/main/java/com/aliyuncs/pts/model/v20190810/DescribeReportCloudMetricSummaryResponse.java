...
import com.aliyuncs.pts.transform.v20190810.DescribeReportCloudMetricSummaryResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeReportCloudMetricSummaryResponse extends AcsResponse {
	...
	@Override
	public DescribeReportCloudMetricSummaryResponse getInstance(UnmarshallerContext context) {
		return	DescribeReportCloudMetricSummaryResponseUnmarshaller.unmarshall(this, context);
	}
