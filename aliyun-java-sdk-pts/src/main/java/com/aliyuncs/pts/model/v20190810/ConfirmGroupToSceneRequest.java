 ...
 * @version 
 */
public class ConfirmGroupToSceneRequest extends RpcAcsRequest<ConfirmGroupToSceneResponse> {
	...
	@Override
	public Class<ConfirmGroupToSceneResponse> getResponseClass() {
		return ConfirmGroupToSceneResponse.class;
	}
