 ...
 * @version 
 */
public class CreatePtsSceneRequest extends RpcAcsRequest<CreatePtsSceneResponse> {
	...
	@Override
	public Class<CreatePtsSceneResponse> getResponseClass() {
		return CreatePtsSceneResponse.class;
	}
