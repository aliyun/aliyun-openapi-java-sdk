 ...
 * @version 
 */
public class DeletePtsScenesRequest extends RpcAcsRequest<DeletePtsScenesResponse> {
	...
	@Override
	public Class<DeletePtsScenesResponse> getResponseClass() {
		return DeletePtsScenesResponse.class;
	}
