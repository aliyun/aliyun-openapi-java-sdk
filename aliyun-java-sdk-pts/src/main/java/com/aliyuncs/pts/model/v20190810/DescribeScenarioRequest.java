 ...
 * @version 
 */
public class DescribeScenarioRequest extends RpcAcsRequest<DescribeScenarioResponse> {
	   

	private String routeRequestBody;
	public DescribeScenarioRequest() {
		super("PTS", "2019-08-10", "DescribeScenario", "1.0.0");
	...
	@Override
	public Class<DescribeScenarioResponse> getResponseClass() {
		return DescribeScenarioResponse.class;
	}
