...
import com.aliyuncs.pts.model.v20190810.CreateMonitorGroupResponse;
...
public class CreateMonitorGroupResponseUnmarshaller {
	...
	public static CreateMonitorGroupResponse unmarshall(CreateMonitorGroupResponse createMonitorGroupResponse, UnmarshallerContext _ctx) {
		...
		createMonitorGroupResponse.setCode(_ctx.stringValue("CreateMonitorGroupResponse.Code"));
		...
		createMonitorGroupResponse.setHttpStatusCode(_ctx.integerValue("CreateMonitorGroupResponse.HttpStatusCode"));
		createMonitorGroupResponse.setMonitorGroup(_ctx.mapValue("CreateMonitorGroupResponse.MonitorGroup"));
