 ...
 * @version 
 */
public class SubmitImageTranslateTaskRequest extends RoaAcsRequest<SubmitImageTranslateTaskResponse> {
	...
	public SubmitImageTranslateTaskRequest() {
		super("AnyTrans", "2025-07-07", "SubmitImageTranslateTask");
		setProtocol(ProtocolType.HTTPS);
		setUriPattern("/anytrans/translate/image/submit");
	...
	public void setTargetLanguage(List<String> targetLanguage) {
		...
		if (targetLanguage != null) {
			putBodyParameter("targetLanguage" , new Gson().toJson(targetLanguage));
		}	
	}
	...
	@Override
	public Class<SubmitImageTranslateTaskResponse> getResponseClass() {
		return SubmitImageTranslateTaskResponse.class;
	}
