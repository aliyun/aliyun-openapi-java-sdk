 ...
 * @version 
 */
public class BatchTranslateRequest extends RoaAcsRequest<BatchTranslateResponse> {
	...
	public BatchTranslateRequest() {
		super("AnyTrans", "2025-07-07", "BatchTranslate");
		setProtocol(ProtocolType.HTTPS);
		setUriPattern("/anytrans/translate/batch");
	...
	@Override
	public Class<BatchTranslateResponse> getResponseClass() {
		return BatchTranslateResponse.class;
	}
