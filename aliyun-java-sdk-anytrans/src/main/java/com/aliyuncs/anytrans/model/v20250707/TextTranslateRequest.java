 ...
 * @version 
 */
public class TextTranslateRequest extends RoaAcsRequest<TextTranslateResponse> {
	...
	public TextTranslateRequest() {
		super("AnyTrans", "2025-07-07", "TextTranslate");
		setProtocol(ProtocolType.HTTPS);
		setUriPattern("/anytrans/translate/text");
	...
	@Override
	public Class<TextTranslateResponse> getResponseClass() {
		return TextTranslateResponse.class;
	}
