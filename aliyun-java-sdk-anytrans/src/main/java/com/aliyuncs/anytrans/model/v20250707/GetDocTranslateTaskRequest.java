 ...
 * @version 
 */
public class GetDocTranslateTaskRequest extends RoaAcsRequest<GetDocTranslateTaskResponse> {
	...
	public GetDocTranslateTaskRequest() {
		super("AnyTrans", "2025-07-07", "GetDocTranslateTask");
		setProtocol(ProtocolType.HTTPS);
		setUriPattern("/anytrans/translate/doc/get");
