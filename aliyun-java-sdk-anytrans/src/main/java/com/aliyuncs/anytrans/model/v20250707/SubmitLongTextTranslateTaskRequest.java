 ...
 * @version 
 */
public class SubmitLongTextTranslateTaskRequest extends RoaAcsRequest<SubmitLongTextTranslateTaskResponse> {
	...
	public SubmitLongTextTranslateTaskRequest() {
		super("AnyTrans", "2025-07-07", "SubmitLongTextTranslateTask");
		setProtocol(ProtocolType.HTTPS);
		setUriPattern("/anytrans/translate/longText/submit");
	...
	@Override
	public Class<SubmitLongTextTranslateTaskResponse> getResponseClass() {
		return SubmitLongTextTranslateTaskResponse.class;
	}
