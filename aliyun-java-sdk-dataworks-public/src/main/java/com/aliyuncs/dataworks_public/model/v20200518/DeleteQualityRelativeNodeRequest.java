 ...
 * @version 
 */
public class DeleteQualityRelativeNodeRequest extends RpcAcsRequest<DeleteQualityRelativeNodeResponse> {
	...
	@Override
	public Class<DeleteQualityRelativeNodeResponse> getResponseClass() {
		return DeleteQualityRelativeNodeResponse.class;
	}
