...
public class ListDataServiceFoldersResponse extends AcsResponse {
	...
	@Override
	public ListDataServiceFoldersResponse getInstance(UnmarshallerContext context) {
		return	ListDataServiceFoldersResponseUnmarshaller.unmarshall(this, context);
	}
