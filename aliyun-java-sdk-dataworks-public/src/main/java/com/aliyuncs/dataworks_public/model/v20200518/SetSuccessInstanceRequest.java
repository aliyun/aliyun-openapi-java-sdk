 ...
 * @version 
 */
public class SetSuccessInstanceRequest extends RpcAcsRequest<SetSuccessInstanceResponse> {
	...
	@Override
	public Class<SetSuccessInstanceResponse> getResponseClass() {
		return SetSuccessInstanceResponse.class;
	}
