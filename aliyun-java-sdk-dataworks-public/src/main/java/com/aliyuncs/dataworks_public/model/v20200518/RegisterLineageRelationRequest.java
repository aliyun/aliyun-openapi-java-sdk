...
public class RegisterLineageRelationRequest extends RpcAcsRequest<RegisterLineageRelationResponse> {
	...
	private Object lineageRelationRegisterVO;
	...
	public Object getLineageRelationRegisterVO() {
		return this.lineageRelationRegisterVO;
	}

	public void setLineageRelationRegisterVO(Object lineageRelationRegisterVO) {
		this.lineageRelationRegisterVO = lineageRelationRegisterVO;
		if(lineageRelationRegisterVO != null){
			putBodyParameter("LineageRelationRegisterVO", lineageRelationRegisterVO.toString());
		}
	}
