 ...
 * @version 
 */
public class GetNodeCodeRequest extends RpcAcsRequest<GetNodeCodeResponse> {
	...
	@Override
	public Class<GetNodeCodeResponse> getResponseClass() {
		return GetNodeCodeResponse.class;
	}
