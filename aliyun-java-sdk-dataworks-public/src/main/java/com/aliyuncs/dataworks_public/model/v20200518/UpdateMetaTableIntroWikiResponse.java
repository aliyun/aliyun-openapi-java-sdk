...
public class UpdateMetaTableIntroWikiResponse extends AcsResponse {
	...
	@Override
	public UpdateMetaTableIntroWikiResponse getInstance(UnmarshallerContext context) {
		return	UpdateMetaTableIntroWikiResponseUnmarshaller.unmarshall(this, context);
	}
