...
public class ListDataServiceApplicationsRequest extends RpcAcsRequest<ListDataServiceApplicationsResponse> {
	...
	public ListDataServiceApplicationsRequest() {
		super("dataworks-public", "2020-05-18", "ListDataServiceApplications", "dide");
	...
	@Override
	public Class<ListDataServiceApplicationsResponse> getResponseClass() {
		return ListDataServiceApplicationsResponse.class;
	}
