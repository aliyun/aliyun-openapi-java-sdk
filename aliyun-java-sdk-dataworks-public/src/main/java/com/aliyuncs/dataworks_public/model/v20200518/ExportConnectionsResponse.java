...
import com.aliyuncs.dataworks_public.transform.v20200518.ExportConnectionsResponseUnmarshaller;
 ...
 * @version 
 */
public class ExportConnectionsResponse extends AcsResponse {
	...
	@Override
	public ExportConnectionsResponse getInstance(UnmarshallerContext context) {
		return	ExportConnectionsResponseUnmarshaller.unmarshall(this, context);
	}
