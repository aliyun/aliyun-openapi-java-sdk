...
import com.aliyuncs.dataworks_public.transform.v20200518.GetInstanceStatusStatisticResponseUnmarshaller;
 ...
 * @version 
 */
public class GetInstanceStatusStatisticResponse extends AcsResponse {
	...
	@Override
	public GetInstanceStatusStatisticResponse getInstance(UnmarshallerContext context) {
		return	GetInstanceStatusStatisticResponseUnmarshaller.unmarshall(this, context);
	}
