 ...
 * @version 
 */
public class ListLineageRequest extends RpcAcsRequest<ListLineageResponse> {
	...
	public ListLineageRequest() {
		super("dataworks-public", "2020-05-18", "ListLineage");
	...
	@Override
	public Class<ListLineageResponse> getResponseClass() {
		return ListLineageResponse.class;
	}
