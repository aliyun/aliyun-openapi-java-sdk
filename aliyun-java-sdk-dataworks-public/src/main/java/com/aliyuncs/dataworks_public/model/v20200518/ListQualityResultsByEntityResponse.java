...
public class ListQualityResultsByEntityResponse extends AcsResponse {
	...
	@Override
	public ListQualityResultsByEntityResponse getInstance(UnmarshallerContext context) {
		return	ListQualityResultsByEntityResponseUnmarshaller.unmarshall(this, context);
	}
