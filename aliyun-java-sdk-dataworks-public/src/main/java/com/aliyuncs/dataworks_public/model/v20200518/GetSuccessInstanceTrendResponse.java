...
import com.aliyuncs.dataworks_public.transform.v20200518.GetSuccessInstanceTrendResponseUnmarshaller;
 ...
 * @version 
 */
public class GetSuccessInstanceTrendResponse extends AcsResponse {
	...
	@Override
	public GetSuccessInstanceTrendResponse getInstance(UnmarshallerContext context) {
		return	GetSuccessInstanceTrendResponseUnmarshaller.unmarshall(this, context);
	}
