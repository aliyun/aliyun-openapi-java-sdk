 ...
 * @version 
 */
public class EditRecognizeRuleRequest extends RpcAcsRequest<EditRecognizeRuleResponse> {
	...
	public EditRecognizeRuleRequest() {
		super("dataworks-public", "2020-05-18", "EditRecognizeRule");
	...
	@Override
	public Class<EditRecognizeRuleResponse> getResponseClass() {
		return EditRecognizeRuleResponse.class;
	}
