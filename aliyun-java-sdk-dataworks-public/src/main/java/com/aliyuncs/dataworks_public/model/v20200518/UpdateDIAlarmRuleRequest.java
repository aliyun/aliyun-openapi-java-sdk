 ...
 * @version 
 */
public class UpdateDIAlarmRuleRequest extends RpcAcsRequest<UpdateDIAlarmRuleResponse> {
	...
	public UpdateDIAlarmRuleRequest() {
		super("dataworks-public", "2020-05-18", "UpdateDIAlarmRule");
	...
	@Override
	public Class<UpdateDIAlarmRuleResponse> getResponseClass() {
		return UpdateDIAlarmRuleResponse.class;
	}
