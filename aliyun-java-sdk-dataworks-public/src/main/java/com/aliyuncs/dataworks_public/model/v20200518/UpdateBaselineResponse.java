...
import com.aliyuncs.dataworks_public.transform.v20200518.UpdateBaselineResponseUnmarshaller;
 ...
 * @version 
 */
public class UpdateBaselineResponse extends AcsResponse {
	...
	@Override
	public UpdateBaselineResponse getInstance(UnmarshallerContext context) {
		return	UpdateBaselineResponseUnmarshaller.unmarshall(this, context);
	}
