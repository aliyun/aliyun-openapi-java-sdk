 ...
 * @version 
 */
public class RunCycleDagNodesRequest extends RpcAcsRequest<RunCycleDagNodesResponse> {
	...
	public RunCycleDagNodesRequest() {
		super("dataworks-public", "2020-05-18", "RunCycleDagNodes");
	...
	@Override
	public Class<RunCycleDagNodesResponse> getResponseClass() {
		return RunCycleDagNodesResponse.class;
	}
