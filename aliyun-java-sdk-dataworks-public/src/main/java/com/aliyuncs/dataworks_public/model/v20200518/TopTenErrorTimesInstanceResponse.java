...
import com.aliyuncs.dataworks_public.transform.v20200518.TopTenErrorTimesInstanceResponseUnmarshaller;
 ...
 * @version 
 */
public class TopTenErrorTimesInstanceResponse extends AcsResponse {
	...
	@Override
	public TopTenErrorTimesInstanceResponse getInstance(UnmarshallerContext context) {
		return	TopTenErrorTimesInstanceResponseUnmarshaller.unmarshall(this, context);
	}
