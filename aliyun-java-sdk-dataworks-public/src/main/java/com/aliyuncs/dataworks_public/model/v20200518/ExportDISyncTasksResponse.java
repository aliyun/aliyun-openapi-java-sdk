...
public class ExportDISyncTasksResponse extends AcsResponse {
	...
	public static class TaskDetail {
		...
		public void setRealTimeSolution(String realTimeSolution) {
			this.realTimeSolution = realTimeSolution;
		}
	}

	@Override
	public ExportDISyncTasksResponse getInstance(UnmarshallerContext context) {
		return	ExportDISyncTasksResponseUnmarshaller.unmarshall(this, context);
	}
