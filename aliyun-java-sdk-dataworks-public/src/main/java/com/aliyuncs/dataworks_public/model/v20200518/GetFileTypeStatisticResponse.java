...
import com.aliyuncs.dataworks_public.transform.v20200518.GetFileTypeStatisticResponseUnmarshaller;
 ...
 * @version 
 */
public class GetFileTypeStatisticResponse extends AcsResponse {
	...
	@Override
	public GetFileTypeStatisticResponse getInstance(UnmarshallerContext context) {
		return	GetFileTypeStatisticResponseUnmarshaller.unmarshall(this, context);
	}
