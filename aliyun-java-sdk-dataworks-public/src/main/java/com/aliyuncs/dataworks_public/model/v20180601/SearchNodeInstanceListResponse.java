...
import com.aliyuncs.dataworks_public.transform.v20180601.SearchNodeInstanceListResponseUnmarshaller;
 ...
 * @version 
 */
public class SearchNodeInstanceListResponse extends AcsResponse {
	...
	@Override
	public SearchNodeInstanceListResponse getInstance(UnmarshallerContext context) {
		return	SearchNodeInstanceListResponseUnmarshaller.unmarshall(this, context);
	}
}
