 ...
 * @version 
 */
public class ListEntitiesByTagsResponse extends AcsResponse {
	...
	@Override
	public ListEntitiesByTagsResponse getInstance(UnmarshallerContext context) {
		return	ListEntitiesByTagsResponseUnmarshaller.unmarshall(this, context);
	}
