 ...
 * @version 
 */
public class GetBaselineKeyPathRequest extends RpcAcsRequest<GetBaselineKeyPathResponse> {
	...
	@Override
	public Class<GetBaselineKeyPathResponse> getResponseClass() {
		return GetBaselineKeyPathResponse.class;
	}
