...
import com.aliyuncs.dataworks_public.transform.v20200518.ListFileTypeResponseUnmarshaller;
 ...
 * @version 
 */
public class ListFileTypeResponse extends AcsResponse {
	...
	@Override
	public ListFileTypeResponse getInstance(UnmarshallerContext context) {
		return	ListFileTypeResponseUnmarshaller.unmarshall(this, context);
	}
