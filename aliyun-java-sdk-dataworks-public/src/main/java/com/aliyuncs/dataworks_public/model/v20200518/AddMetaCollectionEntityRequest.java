 ...
 * @version 
 */
public class AddMetaCollectionEntityRequest extends RpcAcsRequest<AddMetaCollectionEntityResponse> {
	...
	public AddMetaCollectionEntityRequest() {
		super("dataworks-public", "2020-05-18", "AddMetaCollectionEntity");
	...
	@Override
	public Class<AddMetaCollectionEntityResponse> getResponseClass() {
		return AddMetaCollectionEntityResponse.class;
	}
