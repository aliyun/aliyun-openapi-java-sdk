 ...
 * @version 
 */
public class DeleteBusinessRequest extends RpcAcsRequest<DeleteBusinessResponse> {
	...
	@Override
	public Class<DeleteBusinessResponse> getResponseClass() {
		return DeleteBusinessResponse.class;
	}
