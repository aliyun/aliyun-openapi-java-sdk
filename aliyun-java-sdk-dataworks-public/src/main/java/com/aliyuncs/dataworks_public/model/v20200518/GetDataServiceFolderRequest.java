...
public class GetDataServiceFolderRequest extends RpcAcsRequest<GetDataServiceFolderResponse> {
	...
	public GetDataServiceFolderRequest() {
		super("dataworks-public", "2020-05-18", "GetDataServiceFolder", "dide");
	...
	@Override
	public Class<GetDataServiceFolderResponse> getResponseClass() {
		return GetDataServiceFolderResponse.class;
	}
