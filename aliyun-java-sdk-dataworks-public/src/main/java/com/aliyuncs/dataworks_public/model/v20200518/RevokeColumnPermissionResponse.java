...
public class RevokeColumnPermissionResponse extends AcsResponse {
	...
	@Override
	public RevokeColumnPermissionResponse getInstance(UnmarshallerContext context) {
		return	RevokeColumnPermissionResponseUnmarshaller.unmarshall(this, context);
	}
