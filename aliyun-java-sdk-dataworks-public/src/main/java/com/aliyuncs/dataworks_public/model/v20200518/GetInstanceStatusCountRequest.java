 ...
 * @version 
 */
public class GetInstanceStatusCountRequest extends RpcAcsRequest<GetInstanceStatusCountResponse> {
	...
	@Override
	public Class<GetInstanceStatusCountResponse> getResponseClass() {
		return GetInstanceStatusCountResponse.class;
	}
