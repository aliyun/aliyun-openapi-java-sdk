 ...
 * @version 
 */
public class ListQualityResultsByEntityRequest extends RpcAcsRequest<ListQualityResultsByEntityResponse> {
	...
	@Override
	public Class<ListQualityResultsByEntityResponse> getResponseClass() {
		return ListQualityResultsByEntityResponse.class;
	}
