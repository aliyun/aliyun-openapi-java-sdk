 ...
 * @version 
 */
public class ListDataServiceApiAuthoritiesRequest extends RpcAcsRequest<ListDataServiceApiAuthoritiesResponse> {
	...
	@Override
	public Class<ListDataServiceApiAuthoritiesResponse> getResponseClass() {
		return ListDataServiceApiAuthoritiesResponse.class;
	}
