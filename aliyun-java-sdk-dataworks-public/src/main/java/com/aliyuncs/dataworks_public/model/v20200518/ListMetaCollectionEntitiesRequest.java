 ...
 * @version 
 */
public class ListMetaCollectionEntitiesRequest extends RpcAcsRequest<ListMetaCollectionEntitiesResponse> {
	...
	public ListMetaCollectionEntitiesRequest() {
		super("dataworks-public", "2020-05-18", "ListMetaCollectionEntities");
	...
	@Override
	public Class<ListMetaCollectionEntitiesResponse> getResponseClass() {
		return ListMetaCollectionEntitiesResponse.class;
	}
