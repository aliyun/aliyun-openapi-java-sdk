 ...
 * @version 
 */
public class GetNodeTypeListInfoRequest extends RpcAcsRequest<GetNodeTypeListInfoResponse> {
	...
	@Override
	public Class<GetNodeTypeListInfoResponse> getResponseClass() {
		return GetNodeTypeListInfoResponse.class;
	}
