...
import com.aliyuncs.dataworks_public.transform.v20200518.ListInstanceHistoryResponseUnmarshaller;
 ...
 * @version 
 */
public class ListInstanceHistoryResponse extends AcsResponse {
	...
	@Override
	public ListInstanceHistoryResponse getInstance(UnmarshallerContext context) {
		return	ListInstanceHistoryResponseUnmarshaller.unmarshall(this, context);
	}
