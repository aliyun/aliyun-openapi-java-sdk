 ...
 * @version 
 */
public class UpdateIDEEventResultRequest extends RpcAcsRequest<UpdateIDEEventResultResponse> {
	...
	public UpdateIDEEventResultRequest() {
		super("dataworks-public", "2020-05-18", "UpdateIDEEventResult");
	...
	public void setCheckResultTip(String checkResultTip) {
		...
		if(checkResultTip != null){
			putBodyParameter("CheckResultTip", checkResultTip);
		}
	}
	...
	@Override
	public Class<UpdateIDEEventResultResponse> getResponseClass() {
		return UpdateIDEEventResultResponse.class;
	}
