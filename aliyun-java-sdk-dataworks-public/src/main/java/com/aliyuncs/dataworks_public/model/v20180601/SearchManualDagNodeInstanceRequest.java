...
public class SearchManualDagNodeInstanceRequest extends RpcAcsRequest<SearchManualDagNodeInstanceResponse> {
	...
	public SearchManualDagNodeInstanceRequest() {
		super("dataworks-public", "2018-06-01", "SearchManualDagNodeInstance", "dide");
	...
	@Override
	public Class<SearchManualDagNodeInstanceResponse> getResponseClass() {
		return SearchManualDagNodeInstanceResponse.class;
	}
