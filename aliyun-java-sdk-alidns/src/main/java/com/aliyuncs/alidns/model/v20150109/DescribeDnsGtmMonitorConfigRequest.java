 ...
 * @version 
 */
public class DescribeDnsGtmMonitorConfigRequest extends RpcAcsRequest<DescribeDnsGtmMonitorConfigResponse> {
	...
	@Override
	public Class<DescribeDnsGtmMonitorConfigResponse> getResponseClass() {
		return DescribeDnsGtmMonitorConfigResponse.class;
	}
