...
public class DescribeDomainStatisticsResponse extends AcsResponse {
	...
	@Override
	public DescribeDomainStatisticsResponse getInstance(UnmarshallerContext context) {
		return	DescribeDomainStatisticsResponseUnmarshaller.unmarshall(this, context);
	}
}
