...
public class ModifyHichinaDomainDNSResponse extends AcsResponse {
	...
	@Override
	public ModifyHichinaDomainDNSResponse getInstance(UnmarshallerContext context) {
		return	ModifyHichinaDomainDNSResponseUnmarshaller.unmarshall(this, context);
	}
}
