...
public class DescribeDohSubDomainStatisticsResponse extends AcsResponse {
	...
	@Override
	public DescribeDohSubDomainStatisticsResponse getInstance(UnmarshallerContext context) {
		return	DescribeDohSubDomainStatisticsResponseUnmarshaller.unmarshall(this, context);
	}
