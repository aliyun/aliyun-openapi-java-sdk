...
import com.aliyuncs.alidns.transform.v20150109.DescribeDomainRecordsResponseUnmarshaller;
...
public class DescribeDomainRecordsResponse extends AcsResponse {
	...
	@Override
	public DescribeDomainRecordsResponse getInstance(UnmarshallerContext context) {
		return	DescribeDomainRecordsResponseUnmarshaller.unmarshall(this, context);
	}
}
