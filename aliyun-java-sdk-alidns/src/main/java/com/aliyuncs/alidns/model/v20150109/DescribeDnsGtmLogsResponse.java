...
import com.aliyuncs.alidns.transform.v20150109.DescribeDnsGtmLogsResponseUnmarshaller;
...
public class DescribeDnsGtmLogsResponse extends AcsResponse {
	...
	@Override
	public DescribeDnsGtmLogsResponse getInstance(UnmarshallerContext context) {
		return	DescribeDnsGtmLogsResponseUnmarshaller.unmarshall(this, context);
	}
}
