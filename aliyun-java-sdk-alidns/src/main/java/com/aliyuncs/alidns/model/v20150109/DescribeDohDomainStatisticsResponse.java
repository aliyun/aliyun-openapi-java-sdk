...
import com.aliyuncs.alidns.transform.v20150109.DescribeDohDomainStatisticsResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeDohDomainStatisticsResponse extends AcsResponse {
	...
	@Override
	public DescribeDohDomainStatisticsResponse getInstance(UnmarshallerContext context) {
		return	DescribeDohDomainStatisticsResponseUnmarshaller.unmarshall(this, context);
	}
