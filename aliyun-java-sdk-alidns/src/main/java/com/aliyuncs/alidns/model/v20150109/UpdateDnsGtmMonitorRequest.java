 ...
 * @version 
 */
public class UpdateDnsGtmMonitorRequest extends RpcAcsRequest<UpdateDnsGtmMonitorResponse> {
	...
	public UpdateDnsGtmMonitorRequest() {
		super("Alidns", "2015-01-09", "UpdateDnsGtmMonitor", "alidns");
	...
	@Override
	public Class<UpdateDnsGtmMonitorResponse> getResponseClass() {
		return UpdateDnsGtmMonitorResponse.class;
	}
