...
public class DescribeGtmInstanceSystemCnameResponse extends AcsResponse {
	...
	@Override
	public DescribeGtmInstanceSystemCnameResponse getInstance(UnmarshallerContext context) {
		return	DescribeGtmInstanceSystemCnameResponseUnmarshaller.unmarshall(this, context);
	}
}
