 ...
 * @version 
 */
public class PreviewGtmRecoveryPlanRequest extends RpcAcsRequest<PreviewGtmRecoveryPlanResponse> {
	...
	@Override
	public Class<PreviewGtmRecoveryPlanResponse> getResponseClass() {
		return PreviewGtmRecoveryPlanResponse.class;
	}
