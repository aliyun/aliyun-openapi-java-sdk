...
import com.aliyuncs.alidns.transform.v20150109.DescribeDnsGtmMonitorConfigResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeDnsGtmMonitorConfigResponse extends AcsResponse {
	...
	@Override
	public DescribeDnsGtmMonitorConfigResponse getInstance(UnmarshallerContext context) {
		return	DescribeDnsGtmMonitorConfigResponseUnmarshaller.unmarshall(this, context);
	}
}
