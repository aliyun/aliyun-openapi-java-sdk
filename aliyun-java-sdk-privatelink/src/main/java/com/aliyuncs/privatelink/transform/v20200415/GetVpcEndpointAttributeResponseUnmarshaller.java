...
public class GetVpcEndpointAttributeResponseUnmarshaller {
	...
	public static GetVpcEndpointAttributeResponse unmarshall(GetVpcEndpointAttributeResponse getVpcEndpointAttributeResponse, UnmarshallerContext _ctx) {
		...
		getVpcEndpointAttributeResponse.setZonePrivateIpAddressCount(_ctx.longValue("GetVpcEndpointAttributeResponse.ZonePrivateIpAddressCount"));
		getVpcEndpointAttributeResponse.setEndpointType(_ctx.stringValue("GetVpcEndpointAttributeResponse.EndpointType"));
