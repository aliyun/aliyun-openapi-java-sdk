 ...
 * @version 
 */
public class UpdateVpcEndpointServiceResourceAttributeRequest extends RpcAcsRequest<UpdateVpcEndpointServiceResourceAttributeResponse> {
	...
	public void setAutoAllocatedEnabled(Boolean autoAllocatedEnabled) {
		...
		if(autoAllocatedEnabled != null){
			putQueryParameter("AutoAllocatedEnabled", autoAllocatedEnabled.toString());
		}
	}
	...
	@Override
	public Class<UpdateVpcEndpointServiceResourceAttributeResponse> getResponseClass() {
		return UpdateVpcEndpointServiceResourceAttributeResponse.class;
	}
