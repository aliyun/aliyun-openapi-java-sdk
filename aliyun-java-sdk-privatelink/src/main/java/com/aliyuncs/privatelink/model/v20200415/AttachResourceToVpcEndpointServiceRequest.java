 ...
 * @version 
 */
public class AttachResourceToVpcEndpointServiceRequest extends RpcAcsRequest<AttachResourceToVpcEndpointServiceResponse> {
	...
	@Override
	public Class<AttachResourceToVpcEndpointServiceResponse> getResponseClass() {
		return AttachResourceToVpcEndpointServiceResponse.class;
	}
