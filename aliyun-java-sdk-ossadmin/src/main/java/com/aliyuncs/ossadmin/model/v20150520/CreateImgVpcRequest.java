 ...
 * @version 
 */
public class CreateImgVpcRequest extends RpcAcsRequest<CreateImgVpcResponse> {
	
	public CreateImgVpcRequest() {
		super("OssAdmin", "2015-05-20", "CreateImgVpc");
	}
	...
	@Override
	public Class<CreateImgVpcResponse> getResponseClass() {
		return CreateImgVpcResponse.class;
	}
