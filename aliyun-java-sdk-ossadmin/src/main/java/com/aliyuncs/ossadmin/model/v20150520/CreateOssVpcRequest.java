 ...
 * @version 
 */
public class CreateOssVpcRequest extends RpcAcsRequest<CreateOssVpcResponse> {
	
	public CreateOssVpcRequest() {
		super("OssAdmin", "2015-05-20", "CreateOssVpc");
	}
	...
	@Override
	public Class<CreateOssVpcResponse> getResponseClass() {
		return CreateOssVpcResponse.class;
	}
