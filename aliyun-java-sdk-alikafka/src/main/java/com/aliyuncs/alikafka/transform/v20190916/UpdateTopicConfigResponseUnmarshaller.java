...
import com.aliyuncs.alikafka.model.v20190916.UpdateTopicConfigResponse;
...
public class UpdateTopicConfigResponseUnmarshaller {
	...
	public static UpdateTopicConfigResponse unmarshall(UpdateTopicConfigResponse updateTopicConfigResponse, UnmarshallerContext _ctx) {
		...
		updateTopicConfigResponse.setCode(_ctx.longValue("UpdateTopicConfigResponse.Code"));
		updateTopicConfigResponse.setMessage(_ctx.stringValue("UpdateTopicConfigResponse.Message"));
		updateTopicConfigResponse.setData(_ctx.stringValue("UpdateTopicConfigResponse.Data"));
