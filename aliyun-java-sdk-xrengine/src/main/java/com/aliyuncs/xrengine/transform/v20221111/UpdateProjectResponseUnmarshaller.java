...
import com.aliyuncs.xrengine.model.v20221111.UpdateProjectResponse;
...
public class UpdateProjectResponseUnmarshaller {
	...
	public static UpdateProjectResponse unmarshall(UpdateProjectResponse updateProjectResponse, UnmarshallerContext _ctx) {
		...
		updateProjectResponse.setErrorName(_ctx.stringValue("UpdateProjectResponse.ErrorName"));
		updateProjectResponse.setHttpCode(_ctx.integerValue("UpdateProjectResponse.HttpCode"));
