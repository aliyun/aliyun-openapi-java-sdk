 ...
 * @version 
 */
public class ListAreaMapRequest extends RpcAcsRequest<ListAreaMapResponse> {
	...
	public ListAreaMapRequest() {
		super("xrEngine", "2022-11-11", "ListAreaMap");
	...
	@Override
	public Class<ListAreaMapResponse> getResponseClass() {
		return ListAreaMapResponse.class;
	}
