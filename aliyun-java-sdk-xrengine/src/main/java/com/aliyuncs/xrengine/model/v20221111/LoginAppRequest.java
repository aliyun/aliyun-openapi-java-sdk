 ...
 * @version 
 */
public class LoginAppRequest extends RpcAcsRequest<LoginAppResponse> {
	...
	public LoginAppRequest() {
		super("xrEngine", "2022-11-11", "LoginApp");
	...
	@Override
	public Class<LoginAppResponse> getResponseClass() {
		return LoginAppResponse.class;
	}
