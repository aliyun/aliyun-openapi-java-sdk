 ...
 * @version 
 */
public class FindSvcMapBindRequest extends RpcAcsRequest<FindSvcMapBindResponse> {
	...
	public FindSvcMapBindRequest() {
		super("xrEngine", "2022-11-11", "FindSvcMapBind");
	...
	@Override
	public Class<FindSvcMapBindResponse> getResponseClass() {
		return FindSvcMapBindResponse.class;
	}
