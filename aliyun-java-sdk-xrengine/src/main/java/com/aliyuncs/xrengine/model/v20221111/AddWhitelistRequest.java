 ...
 * @version 
 */
public class AddWhitelistRequest extends RpcAcsRequest<AddWhitelistResponse> {
	...
	public AddWhitelistRequest() {
		super("xrEngine", "2022-11-11", "AddWhitelist");
	...
	@Override
	public Class<AddWhitelistResponse> getResponseClass() {
		return AddWhitelistResponse.class;
	}
