 ...
 * @version 
 */
public class GetMetricStreamStatusRequest extends RpcAcsRequest<GetMetricStreamStatusResponse> {
	
	public GetMetricStreamStatusRequest() {
		super("Cms", "2015-08-01", "GetMetricStreamStatus");
	}
	...
	@Override
	public Class<GetMetricStreamStatusResponse> getResponseClass() {
		return GetMetricStreamStatusResponse.class;
	}
