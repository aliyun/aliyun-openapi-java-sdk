 ...
 * @version 
 */
public class DescribeAlertLogCountRequest extends RpcAcsRequest<DescribeAlertLogCountResponse> {
	...
	@Override
	public Class<DescribeAlertLogCountResponse> getResponseClass() {
		return DescribeAlertLogCountResponse.class;
	}
