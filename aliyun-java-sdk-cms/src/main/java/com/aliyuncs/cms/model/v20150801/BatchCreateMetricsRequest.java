 ...
 * @version 
 */
public class BatchCreateMetricsRequest extends RpcAcsRequest<BatchCreateMetricsResponse> {
	
	public BatchCreateMetricsRequest() {
		super("Cms", "2015-08-01", "BatchCreateMetrics");
	...
	@Override
	public Class<BatchCreateMetricsResponse> getResponseClass() {
		return BatchCreateMetricsResponse.class;
	}
