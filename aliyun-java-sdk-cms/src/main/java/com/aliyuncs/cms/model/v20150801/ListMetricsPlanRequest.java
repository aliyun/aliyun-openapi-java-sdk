 ...
 * @version 
 */
public class ListMetricsPlanRequest extends RpcAcsRequest<ListMetricsPlanResponse> {
	
	public ListMetricsPlanRequest() {
		super("Cms", "2015-08-01", "ListMetricsPlan");
	}
	...
	@Override
	public Class<ListMetricsPlanResponse> getResponseClass() {
		return ListMetricsPlanResponse.class;
	}
