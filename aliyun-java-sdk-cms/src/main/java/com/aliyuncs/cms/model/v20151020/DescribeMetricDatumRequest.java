 ...
 * @version 
 */
public class DescribeMetricDatumRequest extends RpcAcsRequest<com.aliyuncs.cms.model.v20151020.DescribeMetricDatumResponse> {
	
	public DescribeMetricDatumRequest() {
		super("Cms", "2015-10-20", "DescribeMetricDatum");
	}
