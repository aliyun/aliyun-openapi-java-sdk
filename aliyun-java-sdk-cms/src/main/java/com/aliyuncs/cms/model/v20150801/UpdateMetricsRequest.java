 ...
 * @version 
 */
public class UpdateMetricsRequest extends RpcAcsRequest<UpdateMetricsResponse> {
	
	public UpdateMetricsRequest() {
		super("Cms", "2015-08-01", "UpdateMetrics");
	...
	@Override
	public Class<UpdateMetricsResponse> getResponseClass() {
		return UpdateMetricsResponse.class;
	}
