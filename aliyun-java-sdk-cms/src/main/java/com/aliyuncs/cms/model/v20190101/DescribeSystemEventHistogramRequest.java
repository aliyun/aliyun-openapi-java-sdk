 ...
 * @version 
 */
public class DescribeSystemEventHistogramRequest extends RpcAcsRequest<DescribeSystemEventHistogramResponse> {
	...
	@Override
	public Class<DescribeSystemEventHistogramResponse> getResponseClass() {
		return DescribeSystemEventHistogramResponse.class;
	}
