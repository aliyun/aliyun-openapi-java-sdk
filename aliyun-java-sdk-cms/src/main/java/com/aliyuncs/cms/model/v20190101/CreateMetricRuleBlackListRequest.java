 ...
 * @version 
 */
public class CreateMetricRuleBlackListRequest extends RpcAcsRequest<CreateMetricRuleBlackListResponse> {
	...
	public CreateMetricRuleBlackListRequest() {
		super("Cms", "2019-01-01", "CreateMetricRuleBlackList", "cms");
	...
	@Override
	public Class<CreateMetricRuleBlackListResponse> getResponseClass() {
		return CreateMetricRuleBlackListResponse.class;
	}
