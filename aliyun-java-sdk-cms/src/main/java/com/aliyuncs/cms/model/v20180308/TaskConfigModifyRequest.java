 ...
 * @version 
 */
public class TaskConfigModifyRequest extends RpcAcsRequest<TaskConfigModifyResponse> {
	
	public TaskConfigModifyRequest() {
		super("Cms", "2018-03-08", "TaskConfigModify", "cms");
	}
	...
	@Override
	public Class<TaskConfigModifyResponse> getResponseClass() {
		return TaskConfigModifyResponse.class;
	}
