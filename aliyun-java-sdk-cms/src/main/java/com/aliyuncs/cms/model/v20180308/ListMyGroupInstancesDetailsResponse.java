...
import com.aliyuncs.cms.transform.v20180308.ListMyGroupInstancesDetailsResponseUnmarshaller;
...
public class ListMyGroupInstancesDetailsResponse extends AcsResponse {
	...
	@Override
	public ListMyGroupInstancesDetailsResponse getInstance(UnmarshallerContext context) {
		return	ListMyGroupInstancesDetailsResponseUnmarshaller.unmarshall(this, context);
	}
}
