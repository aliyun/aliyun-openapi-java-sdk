 ...
 * @version 
 */
public class DeleteDimTableRequest extends RpcAcsRequest<DeleteDimTableResponse> {
	
	public DeleteDimTableRequest() {
		super("Cms", "2015-08-01", "DeleteDimTable");
	}
	...
	@Override
	public Class<DeleteDimTableResponse> getResponseClass() {
		return DeleteDimTableResponse.class;
	}
