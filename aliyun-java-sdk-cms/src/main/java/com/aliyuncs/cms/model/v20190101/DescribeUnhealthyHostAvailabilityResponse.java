...
public class DescribeUnhealthyHostAvailabilityResponse extends AcsResponse {
	...
	@Override
	public DescribeUnhealthyHostAvailabilityResponse getInstance(UnmarshallerContext context) {
		return	DescribeUnhealthyHostAvailabilityResponseUnmarshaller.unmarshall(this, context);
	}
}
