 ...
 * @version 
 */
public class DeleteMetricStreamRequest extends RpcAcsRequest<DeleteMetricStreamResponse> {
	
	public DeleteMetricStreamRequest() {
		super("Cms", "2015-08-01", "DeleteMetricStream");
	}
	...
	@Override
	public Class<DeleteMetricStreamResponse> getResponseClass() {
		return DeleteMetricStreamResponse.class;
	}
