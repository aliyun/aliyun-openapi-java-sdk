...
import com.aliyuncs.cms.transform.v20180308.DeleteMonitoringTemplateResponseUnmarshaller;
 ...
 * @version 
 */
public class DeleteMonitoringTemplateResponse extends AcsResponse {
	...
	@Override
	public DeleteMonitoringTemplateResponse getInstance(UnmarshallerContext context) {
		return	DeleteMonitoringTemplateResponseUnmarshaller.unmarshall(this, context);
	}
}
