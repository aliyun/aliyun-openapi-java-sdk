 ...
 * @version 
 */
public class DescribeAlertLogHistogramRequest extends RpcAcsRequest<DescribeAlertLogHistogramResponse> {
	...
	@Override
	public Class<DescribeAlertLogHistogramResponse> getResponseClass() {
		return DescribeAlertLogHistogramResponse.class;
	}
