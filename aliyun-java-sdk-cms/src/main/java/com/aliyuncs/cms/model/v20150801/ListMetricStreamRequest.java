 ...
 * @version 
 */
public class ListMetricStreamRequest extends RpcAcsRequest<ListMetricStreamResponse> {
	
	public ListMetricStreamRequest() {
		super("Cms", "2015-08-01", "ListMetricStream");
	}
	...
	@Override
	public Class<ListMetricStreamResponse> getResponseClass() {
		return ListMetricStreamResponse.class;
	}
