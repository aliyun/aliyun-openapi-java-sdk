...
public class DescribeContactListByContactGroupResponse extends AcsResponse {
	...
	@Override
	public DescribeContactListByContactGroupResponse getInstance(UnmarshallerContext context) {
		return	DescribeContactListByContactGroupResponseUnmarshaller.unmarshall(this, context);
	}
}
