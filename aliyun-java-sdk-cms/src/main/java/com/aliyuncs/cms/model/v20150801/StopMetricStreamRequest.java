 ...
 * @version 
 */
public class StopMetricStreamRequest extends RpcAcsRequest<StopMetricStreamResponse> {
	
	public StopMetricStreamRequest() {
		super("Cms", "2015-08-01", "StopMetricStream");
	}
	...
	@Override
	public Class<StopMetricStreamResponse> getResponseClass() {
		return StopMetricStreamResponse.class;
	}
