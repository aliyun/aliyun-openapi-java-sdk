 ...
 * @version 
 */
public class StartMetricStreamRequest extends RpcAcsRequest<StartMetricStreamResponse> {
	
	public StartMetricStreamRequest() {
		super("Cms", "2015-08-01", "StartMetricStream");
	}
	...
	@Override
	public Class<StartMetricStreamResponse> getResponseClass() {
		return StartMetricStreamResponse.class;
	}
