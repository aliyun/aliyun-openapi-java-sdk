 ...
 * @version 
 */
public class ModifyHybridMonitorTaskRequest extends RpcAcsRequest<ModifyHybridMonitorTaskResponse> {
	...
	public ModifyHybridMonitorTaskRequest() {
		super("Cms", "2019-01-01", "ModifyHybridMonitorTask", "cms");
	...
	@Override
	public Class<ModifyHybridMonitorTaskResponse> getResponseClass() {
		return ModifyHybridMonitorTaskResponse.class;
	}
