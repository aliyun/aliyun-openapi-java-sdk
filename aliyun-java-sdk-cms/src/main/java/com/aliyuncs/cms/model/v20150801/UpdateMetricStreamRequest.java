 ...
 * @version 
 */
public class UpdateMetricStreamRequest extends RpcAcsRequest<UpdateMetricStreamResponse> {
	
	public UpdateMetricStreamRequest() {
		super("Cms", "2015-08-01", "UpdateMetricStream");
	...
	@Override
	public Class<UpdateMetricStreamResponse> getResponseClass() {
		return UpdateMetricStreamResponse.class;
	}
