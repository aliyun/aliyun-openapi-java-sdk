 ...
 * @version 
 */
public class BatchCreateInstantSiteMonitorRequest extends RpcAcsRequest<BatchCreateInstantSiteMonitorResponse> {
	   

	private List<TaskList> taskLists;
	public BatchCreateInstantSiteMonitorRequest() {
		super("Cms", "2019-01-01", "BatchCreateInstantSiteMonitor", "cms");
	...
	@Override
	public Class<BatchCreateInstantSiteMonitorResponse> getResponseClass() {
		return BatchCreateInstantSiteMonitorResponse.class;
	}
