 ...
 * @version 
 */
public class GetMetricStreamMetaRequest extends RpcAcsRequest<GetMetricStreamMetaResponse> {
	
	public GetMetricStreamMetaRequest() {
		super("Cms", "2015-08-01", "GetMetricStreamMeta");
	}
	...
	@Override
	public Class<GetMetricStreamMetaResponse> getResponseClass() {
		return GetMetricStreamMetaResponse.class;
	}
