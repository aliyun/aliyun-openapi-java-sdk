 ...
 * @version 
 */
public class GetMetricStreamRequest extends RpcAcsRequest<GetMetricStreamResponse> {
	
	public GetMetricStreamRequest() {
		super("Cms", "2015-08-01", "GetMetricStream");
	}
	...
	@Override
	public Class<GetMetricStreamResponse> getResponseClass() {
		return GetMetricStreamResponse.class;
	}
