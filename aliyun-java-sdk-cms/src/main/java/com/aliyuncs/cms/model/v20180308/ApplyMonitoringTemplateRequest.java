 ...
 * @version 
 */
public class ApplyMonitoringTemplateRequest extends RpcAcsRequest<ApplyMonitoringTemplateResponse> {
	
	public ApplyMonitoringTemplateRequest() {
		super("Cms", "2018-03-08", "ApplyMonitoringTemplate", "cms");
	}
	...
	@Override
	public Class<ApplyMonitoringTemplateResponse> getResponseClass() {
		return ApplyMonitoringTemplateResponse.class;
	}
