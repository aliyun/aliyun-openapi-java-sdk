 ...
 * @version 
 */
public class DescribeSystemEventAttributeRequest extends RpcAcsRequest<DescribeSystemEventAttributeResponse> {
	...
	@Override
	public Class<DescribeSystemEventAttributeResponse> getResponseClass() {
		return DescribeSystemEventAttributeResponse.class;
	}
