...
import com.aliyuncs.cms.transform.v20190101.DescribeMonitoringConfigResponseUnmarshaller;
...
public class DescribeMonitoringConfigResponse extends AcsResponse {
	...
	@Override
	public DescribeMonitoringConfigResponse getInstance(UnmarshallerContext context) {
		return	DescribeMonitoringConfigResponseUnmarshaller.unmarshall(this, context);
	}
}
