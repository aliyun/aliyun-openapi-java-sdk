 ...
 * @version 
 */
public class ListDimTableRequest extends RpcAcsRequest<ListDimTableResponse> {
	
	public ListDimTableRequest() {
		super("Cms", "2015-08-01", "ListDimTable");
	}
	...
	@Override
	public Class<ListDimTableResponse> getResponseClass() {
		return ListDimTableResponse.class;
	}
