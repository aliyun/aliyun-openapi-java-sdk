 ...
 * @version 
 */
public class QueryIncrementalRequest extends RpcAcsRequest<QueryIncrementalResponse> {
	
	public QueryIncrementalRequest() {
		super("Cms", "2015-08-01", "QueryIncremental");
	}
	...
	@Override
	public Class<QueryIncrementalResponse> getResponseClass() {
		return QueryIncrementalResponse.class;
	}
