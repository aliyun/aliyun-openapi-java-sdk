...
import com.aliyuncs.cms.transform.v20180308.DescribeAlarmsForResourcesResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeAlarmsForResourcesResponse extends AcsResponse {
	...
	@Override
	public DescribeAlarmsForResourcesResponse getInstance(UnmarshallerContext context) {
		return	DescribeAlarmsForResourcesResponseUnmarshaller.unmarshall(this, context);
	}
}
