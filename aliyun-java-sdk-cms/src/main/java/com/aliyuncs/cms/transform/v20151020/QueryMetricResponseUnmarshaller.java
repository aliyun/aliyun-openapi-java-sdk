...
import com.aliyuncs.cms.model.v20151020.QueryMetricResponse;
...
public class QueryMetricResponseUnmarshaller {
	...
	public static QueryMetricResponse unmarshall(QueryMetricResponse queryMetricResponse, UnmarshallerContext context) {
		...
		queryMetricResponse.setNextToken(context.stringValue("QueryMetricResponse.NextToken"));


		List<JSONObject> datapoints = JSONParser.parseJSONArray(context, context.lengthValue("QueryMetricResponse.Datapoints.Length"));
