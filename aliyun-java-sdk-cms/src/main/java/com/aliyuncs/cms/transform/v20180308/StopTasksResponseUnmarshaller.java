...
import com.aliyuncs.cms.model.v20180308.StopTasksResponse;
import com.aliyuncs.transform.UnmarshallerContext;


public class StopTasksResponseUnmarshaller {

	public static StopTasksResponse unmarshall(StopTasksResponse stopTasksResponse, UnmarshallerContext context) {
		
		stopTasksResponse.setRequestId(context.stringValue("StopTasksResponse.RequestId"));
