...
import com.aliyuncs.cms.model.v20150801.GetMetricStatisticsResponse;
...
public class GetMetricStatisticsResponseUnmarshaller {
	...
	public static GetMetricStatisticsResponse unmarshall(GetMetricStatisticsResponse getMetricStatisticsResponse, UnmarshallerContext context) {
		...
		for (int i = 0; i < context.lengthValue("GetMetricStatisticsResponse.Datapoints.Length"); i++) {
			datapoints.add(context.stringValue("GetMetricStatisticsResponse.Datapoints["+ i +"]"));
		}
