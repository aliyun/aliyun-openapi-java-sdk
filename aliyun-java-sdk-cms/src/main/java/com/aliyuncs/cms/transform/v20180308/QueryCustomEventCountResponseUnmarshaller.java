...
import com.aliyuncs.cms.model.v20180308.QueryCustomEventCountResponse;
...
public class QueryCustomEventCountResponseUnmarshaller {
	...
	public static QueryCustomEventCountResponse unmarshall(QueryCustomEventCountResponse queryCustomEventCountResponse, UnmarshallerContext context) {
		...
		queryCustomEventCountResponse.setRequestId(context.stringValue("QueryCustomEventCountResponse.RequestId"));
		...
		queryCustomEventCountResponse.setSuccess(context.booleanValue("QueryCustomEventCountResponse.Success"));
