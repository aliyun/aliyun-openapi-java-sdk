...
import com.aliyuncs.cms.model.v20180308.TaskConfigCreateResponse;
import com.aliyuncs.transform.UnmarshallerContext;


public class TaskConfigCreateResponseUnmarshaller {

	public static TaskConfigCreateResponse unmarshall(TaskConfigCreateResponse taskConfigCreateResponse, UnmarshallerContext context) {
		
		taskConfigCreateResponse.setRequestId(context.stringValue("TaskConfigCreateResponse.RequestId"));
