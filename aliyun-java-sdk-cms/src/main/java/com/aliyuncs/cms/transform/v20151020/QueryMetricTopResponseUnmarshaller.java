...
import com.aliyuncs.cms.model.v20151020.QueryMetricTopResponse;
...
public class QueryMetricTopResponseUnmarshaller {
	...
	public static QueryMetricTopResponse unmarshall(QueryMetricTopResponse queryMetricTopResponse, UnmarshallerContext context) {
		...
		queryMetricTopResponse.setSuccess(context.stringValue("QueryMetricTopResponse.Success"));
		queryMetricTopResponse.setTraceId(context.stringValue("QueryMetricTopResponse.TraceId"));
		...
		queryMetricTopResponse.setDatapoints(datapoints);
