...
import com.aliyuncs.cms.model.v20180308.ModifyTaskResponse;
import com.aliyuncs.transform.UnmarshallerContext;


public class ModifyTaskResponseUnmarshaller {

	public static ModifyTaskResponse unmarshall(ModifyTaskResponse modifyTaskResponse, UnmarshallerContext context) {
		
		modifyTaskResponse.setRequestId(context.stringValue("ModifyTaskResponse.RequestId"));
