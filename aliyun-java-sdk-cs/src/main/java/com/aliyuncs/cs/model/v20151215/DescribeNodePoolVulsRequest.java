 ...
 * @version 
 */
public class DescribeNodePoolVulsRequest extends RoaAcsRequest<DescribeNodePoolVulsResponse> {
	...
	@Override
	public Class<DescribeNodePoolVulsResponse> getResponseClass() {
		return DescribeNodePoolVulsResponse.class;
	}
