 ...
 * @version 
 */
public class DeleteTriggerRequest extends RoaAcsRequest<DeleteTriggerResponse> {
	...
	public DeleteTriggerRequest() {
		super("CS", "2015-12-15", "DeleteTrigger");
		setUriPattern("/clusters/[cluster_id]/triggers/[Id]");
