...
import com.aliyuncs.linkwan.model.v20181230.DescribeRegionsResponse;
import com.aliyuncs.linkwan.model.v20181230.DescribeRegionsResponse.Region;
...
public class DescribeRegionsResponseUnmarshaller {
	...
	public static DescribeRegionsResponse unmarshall(DescribeRegionsResponse describeRegionsResponse, UnmarshallerContext context) {
		...
		for (int i = 0; i < context.lengthValue("DescribeRegionsResponse.Data.Length"); i++) {
			Region region = new Region();
			region.setRegionId(context.stringValue("DescribeRegionsResponse.Data["+ i +"].RegionId"));
			region.setLocalName(context.stringValue("DescribeRegionsResponse.Data["+ i +"].LocalName"));
