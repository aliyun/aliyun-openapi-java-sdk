 ...
 * @version 
 */
public class GetMeteringStatisticsRequest extends RpcAcsRequest<GetMeteringStatisticsResponse> {
	...
	private Long end;
	public GetMeteringStatisticsRequest() {
		super("LinkWAN", "2019-03-01", "GetMeteringStatistics", "linkwan");
	...
	@Override
	public Class<GetMeteringStatisticsResponse> getResponseClass() {
		return GetMeteringStatisticsResponse.class;
	}
