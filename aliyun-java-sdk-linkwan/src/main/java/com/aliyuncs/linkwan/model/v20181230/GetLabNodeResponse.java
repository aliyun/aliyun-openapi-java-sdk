...
import com.aliyuncs.linkwan.transform.v20181230.GetLabNodeResponseUnmarshaller;
 ...
 * @version 
 */
public class GetLabNodeResponse extends AcsResponse {
	...
	@Override
	public GetLabNodeResponse getInstance(UnmarshallerContext context) {
		return	GetLabNodeResponseUnmarshaller.unmarshall(this, context);
	}
