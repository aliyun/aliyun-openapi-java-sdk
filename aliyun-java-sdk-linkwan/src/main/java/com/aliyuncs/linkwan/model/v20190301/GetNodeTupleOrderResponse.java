...
import com.aliyuncs.linkwan.transform.v20190301.GetNodeTupleOrderResponseUnmarshaller;
 ...
 * @version 
 */
public class GetNodeTupleOrderResponse extends AcsResponse {
	...
	@Override
	public GetNodeTupleOrderResponse getInstance(UnmarshallerContext context) {
		return	GetNodeTupleOrderResponseUnmarshaller.unmarshall(this, context);
	}
