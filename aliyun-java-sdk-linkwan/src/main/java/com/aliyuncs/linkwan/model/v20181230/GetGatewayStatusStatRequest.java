...
public class GetGatewayStatusStatRequest extends RpcAcsRequest<GetGatewayStatusStatResponse> {
	...
	public GetGatewayStatusStatRequest() {
		super("LinkWAN", "2018-12-30", "GetGatewayStatusStat", "linkwan");
	...
	@Override
	public Class<GetGatewayStatusStatResponse> getResponseClass() {
		return GetGatewayStatusStatResponse.class;
	}
