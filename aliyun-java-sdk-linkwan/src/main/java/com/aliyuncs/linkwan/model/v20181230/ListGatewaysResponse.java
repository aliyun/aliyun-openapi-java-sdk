...
import com.aliyuncs.linkwan.transform.v20181230.ListGatewaysResponseUnmarshaller;
 ...
 * @version 
 */
public class ListGatewaysResponse extends AcsResponse {
	...
	@Override
	public ListGatewaysResponse getInstance(UnmarshallerContext context) {
		return	ListGatewaysResponseUnmarshaller.unmarshall(this, context);
	}
