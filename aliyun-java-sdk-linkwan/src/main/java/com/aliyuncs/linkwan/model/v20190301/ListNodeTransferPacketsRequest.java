 ...
 * @version 
 */
public class ListNodeTransferPacketsRequest extends RpcAcsRequest<ListNodeTransferPacketsResponse> {
	...
	public ListNodeTransferPacketsRequest() {
		super("LinkWAN", "2019-03-01", "ListNodeTransferPackets", "linkwan");
	...
	@Override
	public Class<ListNodeTransferPacketsResponse> getResponseClass() {
		return ListNodeTransferPacketsResponse.class;
	}
