...
import com.aliyuncs.linkwan.transform.v20181230.ListFreqBandPlanGroupsResponseUnmarshaller;
 ...
 * @version 
 */
public class ListFreqBandPlanGroupsResponse extends AcsResponse {
	...
	@Override
	public ListFreqBandPlanGroupsResponse getInstance(UnmarshallerContext context) {
		return	ListFreqBandPlanGroupsResponseUnmarshaller.unmarshall(this, context);
	}
