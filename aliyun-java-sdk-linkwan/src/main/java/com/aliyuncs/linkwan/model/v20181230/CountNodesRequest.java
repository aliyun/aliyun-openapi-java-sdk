 ...
 * @version 
 */
public class CountNodesRequest extends RpcAcsRequest<CountNodesResponse> {
	
	public CountNodesRequest() {
		super("LinkWAN", "2018-12-30", "CountNodes", "linkwan");
	...
	@Override
	public Class<CountNodesResponse> getResponseClass() {
		return CountNodesResponse.class;
	}
