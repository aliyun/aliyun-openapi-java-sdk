...
import com.aliyuncs.linkwan.transform.v20181230.ListNodesByOwnedJoinPermissionIdResponseUnmarshaller;
 ...
 * @version 
 */
public class ListNodesByOwnedJoinPermissionIdResponse extends AcsResponse {
	...
	@Override
	public ListNodesByOwnedJoinPermissionIdResponse getInstance(UnmarshallerContext context) {
		return	ListNodesByOwnedJoinPermissionIdResponseUnmarshaller.unmarshall(this, context);
	}
