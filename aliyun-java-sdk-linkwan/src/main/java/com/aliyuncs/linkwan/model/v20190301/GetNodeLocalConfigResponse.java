...
import com.aliyuncs.linkwan.transform.v20190301.GetNodeLocalConfigResponseUnmarshaller;
 ...
 * @version 
 */
public class GetNodeLocalConfigResponse extends AcsResponse {
	...
	@Override
	public GetNodeLocalConfigResponse getInstance(UnmarshallerContext context) {
		return	GetNodeLocalConfigResponseUnmarshaller.unmarshall(this, context);
	}
}
