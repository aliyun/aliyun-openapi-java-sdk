 ...
 * @version 
 */
public class SubmitGatewayLocalConfigAddingTaskRequest extends RpcAcsRequest<SubmitGatewayLocalConfigAddingTaskResponse> {
	...
	public SubmitGatewayLocalConfigAddingTaskRequest() {
		super("LinkWAN", "2019-03-01", "SubmitGatewayLocalConfigAddingTask", "linkwan");
	...
	@Override
	public Class<SubmitGatewayLocalConfigAddingTaskResponse> getResponseClass() {
		return SubmitGatewayLocalConfigAddingTaskResponse.class;
	}
