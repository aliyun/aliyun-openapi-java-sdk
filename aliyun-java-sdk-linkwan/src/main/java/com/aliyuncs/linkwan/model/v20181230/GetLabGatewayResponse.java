...
import com.aliyuncs.linkwan.transform.v20181230.GetLabGatewayResponseUnmarshaller;
 ...
 * @version 
 */
public class GetLabGatewayResponse extends AcsResponse {
	...
	@Override
	public GetLabGatewayResponse getInstance(UnmarshallerContext context) {
		return	GetLabGatewayResponseUnmarshaller.unmarshall(this, context);
	}
