...
public class UpdateGatewayEnablingStateRequest extends RpcAcsRequest<UpdateGatewayEnablingStateResponse> {
	...
	public UpdateGatewayEnablingStateRequest() {
		super("LinkWAN", "2018-12-30", "UpdateGatewayEnablingState", "linkwan");
	...
	@Override
	public Class<UpdateGatewayEnablingStateResponse> getResponseClass() {
		return UpdateGatewayEnablingStateResponse.class;
	}
