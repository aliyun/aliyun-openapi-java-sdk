 ...
 * @version 
 */
public class ListLabNodesRequest extends RpcAcsRequest<ListLabNodesResponse> {
	
	public ListLabNodesRequest() {
		super("LinkWAN", "2018-12-30", "ListLabNodes", "linkwan");
	...
	@Override
	public Class<ListLabNodesResponse> getResponseClass() {
		return ListLabNodesResponse.class;
	}
