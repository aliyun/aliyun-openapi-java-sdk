...
import com.aliyuncs.linkwan.transform.v20190301.ListNodeGroupsResponseUnmarshaller;
 ...
 * @version 
 */
public class ListNodeGroupsResponse extends AcsResponse {
	...
	@Override
	public ListNodeGroupsResponse getInstance(UnmarshallerContext context) {
		return	ListNodeGroupsResponseUnmarshaller.unmarshall(this, context);
	}
