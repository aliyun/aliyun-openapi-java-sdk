...
import com.aliyuncs.linkwan.transform.v20181230.ListBoundLabGatewaysResponseUnmarshaller;
 ...
 * @version 
 */
public class ListBoundLabGatewaysResponse extends AcsResponse {

	private String requestId;

	private Boolean success;

	private List<LabGateway> data;
	...
	public List<LabGateway> getData() {
		return this.data;
	}

	public void setData(List<LabGateway> data) {
		this.data = data;
	}
	...
	@Override
	public ListBoundLabGatewaysResponse getInstance(UnmarshallerContext context) {
		return	ListBoundLabGatewaysResponseUnmarshaller.unmarshall(this, context);
	}
