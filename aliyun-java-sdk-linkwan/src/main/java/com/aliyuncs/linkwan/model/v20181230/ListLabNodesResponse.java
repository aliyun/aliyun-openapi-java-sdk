...
import com.aliyuncs.linkwan.transform.v20181230.ListLabNodesResponseUnmarshaller;
 ...
 * @version 
 */
public class ListLabNodesResponse extends AcsResponse {
	...
	public static class Data {
		...
		public List<LabNode> getList() {
			return this.list;
		}

		public void setList(List<LabNode> list) {
			this.list = list;
		}
	...
	@Override
	public ListLabNodesResponse getInstance(UnmarshallerContext context) {
		return	ListLabNodesResponseUnmarshaller.unmarshall(this, context);
	}
