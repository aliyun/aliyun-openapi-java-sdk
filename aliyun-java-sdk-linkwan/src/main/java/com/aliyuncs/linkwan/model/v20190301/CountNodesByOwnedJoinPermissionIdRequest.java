 ...
 * @version 
 */
public class CountNodesByOwnedJoinPermissionIdRequest extends RpcAcsRequest<CountNodesByOwnedJoinPermissionIdResponse> {
	...
	public CountNodesByOwnedJoinPermissionIdRequest() {
		super("LinkWAN", "2019-03-01", "CountNodesByOwnedJoinPermissionId", "linkwan");
	...
	@Override
	public Class<CountNodesByOwnedJoinPermissionIdResponse> getResponseClass() {
		return CountNodesByOwnedJoinPermissionIdResponse.class;
	}
