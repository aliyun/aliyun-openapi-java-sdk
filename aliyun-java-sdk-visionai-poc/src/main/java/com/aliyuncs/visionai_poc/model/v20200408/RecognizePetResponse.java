...
import com.aliyuncs.visionai_poc.transform.v20200408.RecognizePetResponseUnmarshaller;
 ...
 * @version 
 */
public class RecognizePetResponse extends AcsResponse {
	...
	@Override
	public RecognizePetResponse getInstance(UnmarshallerContext context) {
		return	RecognizePetResponseUnmarshaller.unmarshall(this, context);
	}
