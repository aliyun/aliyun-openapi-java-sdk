 ...
 * @version 
 */
public class ReleaseStoreFileRequest extends RpcAcsRequest<ReleaseStoreFileResponse> {
	...
	public ReleaseStoreFileRequest() {
		super("emap", "2020-06-08", "ReleaseStoreFile");
	...
	@Override
	public Class<ReleaseStoreFileResponse> getResponseClass() {
		return ReleaseStoreFileResponse.class;
	}
