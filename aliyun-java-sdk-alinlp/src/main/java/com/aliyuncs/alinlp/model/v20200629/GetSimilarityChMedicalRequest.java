 ...
 * @version 
 */
public class GetSimilarityChMedicalRequest extends RpcAcsRequest<GetSimilarityChMedicalResponse> {
	...
	public GetSimilarityChMedicalRequest() {
		super("alinlp", "2020-06-29", "GetSimilarityChMedical", "GetKeywordChEcom");
	...
	@Override
	public Class<GetSimilarityChMedicalResponse> getResponseClass() {
		return GetSimilarityChMedicalResponse.class;
	}
