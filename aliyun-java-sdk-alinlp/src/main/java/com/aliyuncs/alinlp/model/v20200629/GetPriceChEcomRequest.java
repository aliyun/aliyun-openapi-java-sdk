 ...
 * @version 
 */
public class GetPriceChEcomRequest extends RpcAcsRequest<GetPriceChEcomResponse> {
	...
	public GetPriceChEcomRequest() {
		super("alinlp", "2020-06-29", "GetPriceChEcom");
	...
	@Override
	public Class<GetPriceChEcomResponse> getResponseClass() {
