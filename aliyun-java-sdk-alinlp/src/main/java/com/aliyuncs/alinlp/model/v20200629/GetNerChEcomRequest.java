 ...
 * @version 
 */
public class GetNerChEcomRequest extends RpcAcsRequest<GetNerChEcomResponse> {
	...
	public GetNerChEcomRequest() {
		super("alinlp", "2020-06-29", "GetNerChEcom", "GetKeywordChEcom");
	...
	@Override
	public Class<GetNerChEcomResponse> getResponseClass() {
		return GetNerChEcomResponse.class;
	}
