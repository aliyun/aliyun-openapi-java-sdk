 ...
 * @version 
 */
public class GetPosChGeneralRequest extends RpcAcsRequest<GetPosChGeneralResponse> {
	...
	public GetPosChGeneralRequest() {
		super("alinlp", "2020-06-29", "GetPosChGeneral", "GetKeywordChEcom");
	...
	@Override
	public Class<GetPosChGeneralResponse> getResponseClass() {
		return GetPosChGeneralResponse.class;
	}
