 ...
 * @version 
 */
public class GetWeChCommentRequest extends RpcAcsRequest<GetWeChCommentResponse> {
	...
	public GetWeChCommentRequest() {
		super("alinlp", "2020-06-29", "GetWeChComment");
	...
	@Override
	public Class<GetWeChCommentResponse> getResponseClass() {
		return GetWeChCommentResponse.class;
	}
