 ...
 * @version 
 */
public class GetWeChEntertainmentRequest extends RpcAcsRequest<GetWeChEntertainmentResponse> {
	...
	public GetWeChEntertainmentRequest() {
		super("alinlp", "2020-06-29", "GetWeChEntertainment");
	...
	@Override
	public Class<GetWeChEntertainmentResponse> getResponseClass() {
		return GetWeChEntertainmentResponse.class;
	}
