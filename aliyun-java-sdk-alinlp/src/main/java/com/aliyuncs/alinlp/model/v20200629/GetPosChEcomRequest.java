 ...
 * @version 
 */
public class GetPosChEcomRequest extends RpcAcsRequest<GetPosChEcomResponse> {
	...
	public GetPosChEcomRequest() {
		super("alinlp", "2020-06-29", "GetPosChEcom");
	...
	@Override
	public Class<GetPosChEcomResponse> getResponseClass() {
		return GetPosChEcomResponse.class;
	}
