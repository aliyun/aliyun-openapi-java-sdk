 ...
 * @version 
 */
public class GetDpChGeneralCTBRequest extends RpcAcsRequest<GetDpChGeneralCTBResponse> {
	...
	public GetDpChGeneralCTBRequest() {
		super("alinlp", "2020-06-29", "GetDpChGeneralCTB", "GetKeywordChEcom");
	...
	@Override
	public Class<GetDpChGeneralCTBResponse> getResponseClass() {
