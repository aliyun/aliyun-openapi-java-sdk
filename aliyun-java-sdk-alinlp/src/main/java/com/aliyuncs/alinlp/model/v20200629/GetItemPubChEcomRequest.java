 ...
 * @version 
 */
public class GetItemPubChEcomRequest extends RpcAcsRequest<GetItemPubChEcomResponse> {
	...
	public GetItemPubChEcomRequest() {
		super("alinlp", "2020-06-29", "GetItemPubChEcom");
	...
	@Override
	public Class<GetItemPubChEcomResponse> getResponseClass() {
