 ...
 * @version 
 */
public class QueryDomainSpecialBizDetailRequest extends RpcAcsRequest<QueryDomainSpecialBizDetailResponse> {
	...
	@Override
	public Class<QueryDomainSpecialBizDetailResponse> getResponseClass() {
