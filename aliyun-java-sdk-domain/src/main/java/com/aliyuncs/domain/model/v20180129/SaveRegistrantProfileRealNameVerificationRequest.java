 ...
 * @version 
 */
public class SaveRegistrantProfileRealNameVerificationRequest extends RpcAcsRequest<SaveRegistrantProfileRealNameVerificationResponse> {
	...
	public SaveRegistrantProfileRealNameVerificationRequest() {
		super("Domain", "2018-01-29", "SaveRegistrantProfileRealNameVerification", "domain");
	...
	@Override
	public Class<SaveRegistrantProfileRealNameVerificationResponse> getResponseClass() {
		return SaveRegistrantProfileRealNameVerificationResponse.class;
	}
