 ...
 * @version 
 */
public class CancelQualificationVerificationRequest extends RpcAcsRequest<CancelQualificationVerificationResponse> {
	...
	@Override
	public Class<CancelQualificationVerificationResponse> getResponseClass() {
