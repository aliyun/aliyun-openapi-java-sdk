 ...
 * @version 
 */
public class CreateFixedPriceDemandOrderRequest extends RpcAcsRequest<CreateFixedPriceDemandOrderResponse> {
	...
	@Override
	public Class<CreateFixedPriceDemandOrderResponse> getResponseClass() {
