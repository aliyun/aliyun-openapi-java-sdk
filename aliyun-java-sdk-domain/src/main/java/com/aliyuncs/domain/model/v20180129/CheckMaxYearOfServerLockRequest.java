 ...
 * @version 
 */
public class CheckMaxYearOfServerLockRequest extends RpcAcsRequest<CheckMaxYearOfServerLockResponse> {
	...
	@Override
	public Class<CheckMaxYearOfServerLockResponse> getResponseClass() {
