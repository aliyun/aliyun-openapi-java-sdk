 ...
 * @version 
 */
public class QueryDomainSpecialBizInfoByDomainRequest extends RpcAcsRequest<QueryDomainSpecialBizInfoByDomainResponse> {
	...
	@Override
	public Class<QueryDomainSpecialBizInfoByDomainResponse> getResponseClass() {
