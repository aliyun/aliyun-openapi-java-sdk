 ...
 * @version 
 */
public class StopSingleCardRequest extends RpcAcsRequest<StopSingleCardResponse> {
	   

	private String iccid;

	private String optMsisdns;
	public StopSingleCardRequest() {
		super("Linkcard", "2021-05-20", "StopSingleCard");
	...
	@Override
	public Class<StopSingleCardResponse> getResponseClass() {
		return StopSingleCardResponse.class;
	}
