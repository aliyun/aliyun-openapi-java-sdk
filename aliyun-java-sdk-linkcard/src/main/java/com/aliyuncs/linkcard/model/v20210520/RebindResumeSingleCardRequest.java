 ...
 * @version 
 */
public class RebindResumeSingleCardRequest extends RpcAcsRequest<RebindResumeSingleCardResponse> {
	   

	private String iccid;

	private String optMsisdns;
	public RebindResumeSingleCardRequest() {
		super("Linkcard", "2021-05-20", "RebindResumeSingleCard");
	...
	@Override
	public Class<RebindResumeSingleCardResponse> getResponseClass() {
		return RebindResumeSingleCardResponse.class;
	}
