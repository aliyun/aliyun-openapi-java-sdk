 ...
 * @version 
 */
public class LiquifyFaceRequest extends RpcAcsRequest<LiquifyFaceResponse> {
	...
	@Override
	public Class<LiquifyFaceResponse> getResponseClass() {
		return LiquifyFaceResponse.class;
	}
