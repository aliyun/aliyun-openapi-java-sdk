 ...
 * @version 
 */
public class CompareFaceWithMaskRequest extends RpcAcsRequest<CompareFaceWithMaskResponse> {
	...
	public CompareFaceWithMaskRequest() {
		super("facebody", "2019-12-30", "CompareFaceWithMask", "facebody");
	...
	@Override
	public Class<CompareFaceWithMaskResponse> getResponseClass() {
		return CompareFaceWithMaskResponse.class;
	}
