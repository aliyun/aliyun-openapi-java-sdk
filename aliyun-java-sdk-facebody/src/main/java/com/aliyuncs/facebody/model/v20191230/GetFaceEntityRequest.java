 ...
 * @version 
 */
public class GetFaceEntityRequest extends RpcAcsRequest<GetFaceEntityResponse> {
	...
	@Override
	public Class<GetFaceEntityResponse> getResponseClass() {
		return GetFaceEntityResponse.class;
	}
