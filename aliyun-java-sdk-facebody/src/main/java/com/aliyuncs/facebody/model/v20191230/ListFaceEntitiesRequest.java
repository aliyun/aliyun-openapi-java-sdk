 ...
 * @version 
 */
public class ListFaceEntitiesRequest extends RpcAcsRequest<ListFaceEntitiesResponse> {
	...
	@Override
	public Class<ListFaceEntitiesResponse> getResponseClass() {
		return ListFaceEntitiesResponse.class;
	}
