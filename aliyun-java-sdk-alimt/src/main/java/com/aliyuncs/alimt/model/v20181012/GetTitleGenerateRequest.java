 ...
 * @version 
 */
public class GetTitleGenerateRequest extends RpcAcsRequest<GetTitleGenerateResponse> {
	...
	public void setHotWords(String hotWords) {
		...
		if(hotWords != null){
			putBodyParameter("HotWords", hotWords);
		}
	}
	...
	@Override
	public Class<GetTitleGenerateResponse> getResponseClass() {
		return GetTitleGenerateResponse.class;
	}
