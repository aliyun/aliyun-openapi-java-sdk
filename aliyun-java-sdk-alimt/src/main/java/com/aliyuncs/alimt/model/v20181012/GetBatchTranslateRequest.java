 ...
 * @version 
 */
public class GetBatchTranslateRequest extends RpcAcsRequest<GetBatchTranslateResponse> {
	...
	@Override
	public Class<GetBatchTranslateResponse> getResponseClass() {
		return GetBatchTranslateResponse.class;
	}
