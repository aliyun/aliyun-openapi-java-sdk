...
public class CreateImageTranslateTaskResponse extends AcsResponse {
	...
	@Override
	public CreateImageTranslateTaskResponse getInstance(UnmarshallerContext context) {
		return	CreateImageTranslateTaskResponseUnmarshaller.unmarshall(this, context);
	}
