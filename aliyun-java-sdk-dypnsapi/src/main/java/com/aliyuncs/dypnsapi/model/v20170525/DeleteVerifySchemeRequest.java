 ...
 * @version 
 */
public class DeleteVerifySchemeRequest extends RpcAcsRequest<DeleteVerifySchemeResponse> {
	...
	@Override
	public Class<DeleteVerifySchemeResponse> getResponseClass() {
		return DeleteVerifySchemeResponse.class;
	}
