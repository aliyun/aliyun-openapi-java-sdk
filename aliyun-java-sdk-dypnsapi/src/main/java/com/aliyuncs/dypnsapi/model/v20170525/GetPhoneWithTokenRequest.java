 ...
 * @version 
 */
public class GetPhoneWithTokenRequest extends RpcAcsRequest<GetPhoneWithTokenResponse> {
	...
	@Override
	public Class<GetPhoneWithTokenResponse> getResponseClass() {
		return GetPhoneWithTokenResponse.class;
	}
