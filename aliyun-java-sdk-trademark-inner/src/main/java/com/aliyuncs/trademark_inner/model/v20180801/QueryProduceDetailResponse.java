...
import com.aliyuncs.trademark_inner.transform.v20180801.QueryProduceDetailResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryProduceDetailResponse extends AcsResponse {
	...
	@Override
	public QueryProduceDetailResponse getInstance(UnmarshallerContext context) {
		return	QueryProduceDetailResponseUnmarshaller.unmarshall(this, context);
	}
}
