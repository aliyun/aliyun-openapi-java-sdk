 ...
 * @version 
 */
public class DescribePhoneTwiceTelVerifyRequest extends RpcAcsRequest<DescribePhoneTwiceTelVerifyResponse> {
	...
	public DescribePhoneTwiceTelVerifyRequest() {
		super("Dytnsapi", "2020-02-17", "DescribePhoneTwiceTelVerify");
	...
	@Override
	public Class<DescribePhoneTwiceTelVerifyResponse> getResponseClass() {
		return DescribePhoneTwiceTelVerifyResponse.class;
	}
