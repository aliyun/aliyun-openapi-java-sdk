 ...
 * @version 
 */
public class PhoneNumberStatusForVoiceRequest extends RpcAcsRequest<PhoneNumberStatusForVoiceResponse> {
	...
	public PhoneNumberStatusForVoiceRequest() {
		super("Dytnsapi", "2020-02-17", "PhoneNumberStatusForVoice");
	...
	@Override
	public Class<PhoneNumberStatusForVoiceResponse> getResponseClass() {
		return PhoneNumberStatusForVoiceResponse.class;
	}
