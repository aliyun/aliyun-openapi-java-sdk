 ...
 * @version 
 */
public class PhoneNumberStatusForSmsRequest extends RpcAcsRequest<PhoneNumberStatusForSmsResponse> {
	...
	public PhoneNumberStatusForSmsRequest() {
		super("Dytnsapi", "2020-02-17", "PhoneNumberStatusForSms");
	...
	@Override
	public Class<PhoneNumberStatusForSmsResponse> getResponseClass() {
		return PhoneNumberStatusForSmsResponse.class;
	}
