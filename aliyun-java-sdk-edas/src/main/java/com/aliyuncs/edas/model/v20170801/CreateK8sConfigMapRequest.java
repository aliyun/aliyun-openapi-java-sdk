 ...
 * @version 
 */
public class CreateK8sConfigMapRequest extends RoaAcsRequest<CreateK8sConfigMapResponse> {
	...
	@Override
	public Class<CreateK8sConfigMapResponse> getResponseClass() {
		return CreateK8sConfigMapResponse.class;
	}
