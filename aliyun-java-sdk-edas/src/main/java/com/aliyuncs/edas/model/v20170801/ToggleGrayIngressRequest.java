 ...
 * @version 
 */
public class ToggleGrayIngressRequest extends RoaAcsRequest<ToggleGrayIngressResponse> {
	...
	@Override
	public Class<ToggleGrayIngressResponse> getResponseClass() {
		return ToggleGrayIngressResponse.class;
	}
