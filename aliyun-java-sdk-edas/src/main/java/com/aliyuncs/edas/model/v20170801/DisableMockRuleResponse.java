...
import com.aliyuncs.edas.transform.v20170801.DisableMockRuleResponseUnmarshaller;
 ...
 * @version 
 */
public class DisableMockRuleResponse extends AcsResponse {
	...
	@Override
	public DisableMockRuleResponse getInstance(UnmarshallerContext context) {
		return	DisableMockRuleResponseUnmarshaller.unmarshall(this, context);
	}
