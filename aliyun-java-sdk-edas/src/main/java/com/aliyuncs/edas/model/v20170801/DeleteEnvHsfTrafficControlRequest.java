 ...
 * @version 
 */
public class DeleteEnvHsfTrafficControlRequest extends RoaAcsRequest<DeleteEnvHsfTrafficControlResponse> {
	...
	@Override
	public Class<DeleteEnvHsfTrafficControlResponse> getResponseClass() {
		return DeleteEnvHsfTrafficControlResponse.class;
	}
