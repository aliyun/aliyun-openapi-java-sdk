 ...
 * @version 
 */
public class CreateEnvAppGroupRequest extends RoaAcsRequest<CreateEnvAppGroupResponse> {
	...
	@Override
	public Class<CreateEnvAppGroupResponse> getResponseClass() {
		return CreateEnvAppGroupResponse.class;
	}
