...
import com.aliyuncs.edas.transform.v20170801.GetJvmConfigurationResponseUnmarshaller;
 ...
 * @version 
 */
public class GetJvmConfigurationResponse extends AcsResponse {
	...
	@Override
	public GetJvmConfigurationResponse getInstance(UnmarshallerContext context) {
		return	GetJvmConfigurationResponseUnmarshaller.unmarshall(this, context);
	}
}
