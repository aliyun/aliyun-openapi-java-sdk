...
import com.aliyuncs.edas.transform.v20170801.EnableMockRuleResponseUnmarshaller;
 ...
 * @version 
 */
public class EnableMockRuleResponse extends AcsResponse {
	...
	@Override
	public EnableMockRuleResponse getInstance(UnmarshallerContext context) {
		return	EnableMockRuleResponseUnmarshaller.unmarshall(this, context);
	}
