 ...
 * @version 
 */
public class DeleteEnvAppGroupRequest extends RoaAcsRequest<DeleteEnvAppGroupResponse> {
	...
	@Override
	public Class<DeleteEnvAppGroupResponse> getResponseClass() {
		return DeleteEnvAppGroupResponse.class;
	}
