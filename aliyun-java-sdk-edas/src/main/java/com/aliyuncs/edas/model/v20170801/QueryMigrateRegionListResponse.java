...
public class QueryMigrateRegionListResponse extends AcsResponse {
	...
	@Override
	public QueryMigrateRegionListResponse getInstance(UnmarshallerContext context) {
		return	QueryMigrateRegionListResponseUnmarshaller.unmarshall(this, context);
	}
}
