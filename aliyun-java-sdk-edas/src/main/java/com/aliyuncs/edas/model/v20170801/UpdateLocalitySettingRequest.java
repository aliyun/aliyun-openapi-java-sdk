 ...
 * @version 
 */
public class UpdateLocalitySettingRequest extends RoaAcsRequest<UpdateLocalitySettingResponse> {
	...
	@Override
	public Class<UpdateLocalitySettingResponse> getResponseClass() {
		return UpdateLocalitySettingResponse.class;
	}
