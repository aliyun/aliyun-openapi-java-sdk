 ...
 * @version 
 */
public class StartK8sApplicationRequest extends RoaAcsRequest<StartK8sApplicationResponse> {
	...
	@Override
	public Class<StartK8sApplicationResponse> getResponseClass() {
		return StartK8sApplicationResponse.class;
	}
