 ...
 * @version 
 */
public class GetMockRuleByConsumerAppIdRequest extends RoaAcsRequest<GetMockRuleByConsumerAppIdResponse> {
	...
	@Override
	public Class<GetMockRuleByConsumerAppIdResponse> getResponseClass() {
		return GetMockRuleByConsumerAppIdResponse.class;
	}
