 ...
 * @version 
 */
public class CreateK8sServiceRequest extends RoaAcsRequest<CreateK8sServiceResponse> {
	...
	@Override
	public Class<CreateK8sServiceResponse> getResponseClass() {
		return CreateK8sServiceResponse.class;
	}
