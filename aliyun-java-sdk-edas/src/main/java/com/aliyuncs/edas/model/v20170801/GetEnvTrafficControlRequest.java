 ...
 * @version 
 */
public class GetEnvTrafficControlRequest extends RoaAcsRequest<GetEnvTrafficControlResponse> {
	...
	@Override
	public Class<GetEnvTrafficControlResponse> getResponseClass() {
		return GetEnvTrafficControlResponse.class;
	}
