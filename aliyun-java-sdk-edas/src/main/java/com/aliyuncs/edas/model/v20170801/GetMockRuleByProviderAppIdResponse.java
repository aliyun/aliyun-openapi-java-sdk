...
public class GetMockRuleByProviderAppIdResponse extends AcsResponse {
	...
	@Override
	public GetMockRuleByProviderAppIdResponse getInstance(UnmarshallerContext context) {
		return	GetMockRuleByProviderAppIdResponseUnmarshaller.unmarshall(this, context);
	}
