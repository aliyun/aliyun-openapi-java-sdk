 ...
 * @version 
 */
public class CreateGrayEnvironmentRequest extends RoaAcsRequest<CreateGrayEnvironmentResponse> {
	...
	public void setLogicalRegionId(String logicalRegionId) {
		...
		if(logicalRegionId != null){
			putBodyParameter("LogicalRegionId", logicalRegionId);
		}
	}
	...
	@Override
	public Class<CreateGrayEnvironmentResponse> getResponseClass() {
		return CreateGrayEnvironmentResponse.class;
	}
