...
public class UpdateContainerConfigurationResponse extends AcsResponse {
	...
	@Override
	public UpdateContainerConfigurationResponse getInstance(UnmarshallerContext context) {
		return	UpdateContainerConfigurationResponseUnmarshaller.unmarshall(this, context);
	}
}
