 ...
 * @version 
 */
public class GetGrayEnvironmentsRequest extends RoaAcsRequest<GetGrayEnvironmentsResponse> {
	...
	@Override
	public Class<GetGrayEnvironmentsResponse> getResponseClass() {
		return GetGrayEnvironmentsResponse.class;
	}
