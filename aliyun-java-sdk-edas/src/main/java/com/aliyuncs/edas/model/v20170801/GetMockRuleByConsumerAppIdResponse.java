...
import com.aliyuncs.edas.transform.v20170801.GetMockRuleByConsumerAppIdResponseUnmarshaller;
 ...
 * @version 
 */
public class GetMockRuleByConsumerAppIdResponse extends AcsResponse {
	...
	public void setData(List<RuleItemList> data) {
		this.data = data;
	}
	...
	@Override
	public GetMockRuleByConsumerAppIdResponse getInstance(UnmarshallerContext context) {
		return	GetMockRuleByConsumerAppIdResponseUnmarshaller.unmarshall(this, context);
	}
