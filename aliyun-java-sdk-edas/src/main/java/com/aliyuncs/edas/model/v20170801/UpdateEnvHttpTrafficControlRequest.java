 ...
 * @version 
 */
public class UpdateEnvHttpTrafficControlRequest extends RoaAcsRequest<UpdateEnvHttpTrafficControlResponse> {
	...
	@Override
	public Class<UpdateEnvHttpTrafficControlResponse> getResponseClass() {
		return UpdateEnvHttpTrafficControlResponse.class;
	}
