...
import com.aliyuncs.edas.transform.v20170801.DescribeApplicationScalingRulesResponseUnmarshaller;
...
public class DescribeApplicationScalingRulesResponse extends AcsResponse {
	...
	public void setAppScalingRules(AppScalingRules appScalingRules) {
		this.appScalingRules = appScalingRules;
	}

	public static class AppScalingRules {
