 ...
 * @version 
 */
public class GetServiceMethodPageRequest extends RoaAcsRequest<GetServiceMethodPageResponse> {
	...
	@Override
	public Class<GetServiceMethodPageResponse> getResponseClass() {
		return GetServiceMethodPageResponse.class;
	}
