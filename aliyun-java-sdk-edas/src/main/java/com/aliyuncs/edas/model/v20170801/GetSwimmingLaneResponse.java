...
import com.aliyuncs.edas.transform.v20170801.GetSwimmingLaneResponseUnmarshaller;
 ...
 * @version 
 */
public class GetSwimmingLaneResponse extends AcsResponse {
	...
	@Override
	public GetSwimmingLaneResponse getInstance(UnmarshallerContext context) {
		return	GetSwimmingLaneResponseUnmarshaller.unmarshall(this, context);
	}
