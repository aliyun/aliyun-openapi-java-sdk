 ...
 * @version 
 */
public class GetServiceConsumersPageRequest extends RoaAcsRequest<GetServiceConsumersPageResponse> {
	...
	@Override
	public Class<GetServiceConsumersPageResponse> getResponseClass() {
		return GetServiceConsumersPageResponse.class;
	}
