...
import com.aliyuncs.edas.transform.v20170801.CreateApplicationScalingRuleResponseUnmarshaller;
 ...
 * @version 
 */
public class CreateApplicationScalingRuleResponse extends AcsResponse {
	...
	@Override
	public CreateApplicationScalingRuleResponse getInstance(UnmarshallerContext context) {
		return	CreateApplicationScalingRuleResponseUnmarshaller.unmarshall(this, context);
	}
