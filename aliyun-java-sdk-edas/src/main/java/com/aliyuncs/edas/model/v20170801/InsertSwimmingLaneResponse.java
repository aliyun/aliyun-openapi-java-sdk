...
import com.aliyuncs.edas.transform.v20170801.InsertSwimmingLaneResponseUnmarshaller;
 ...
 * @version 
 */
public class InsertSwimmingLaneResponse extends AcsResponse {
	...
	@Override
	public InsertSwimmingLaneResponse getInstance(UnmarshallerContext context) {
		return	InsertSwimmingLaneResponseUnmarshaller.unmarshall(this, context);
	}
