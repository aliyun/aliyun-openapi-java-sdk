 ...
 * @version 
 */
public class GetStackDriftDetectionStatusRequest extends RpcAcsRequest<GetStackDriftDetectionStatusResponse> {
	...
	public void setDriftDetectionId(String driftDetectionId) {
		...
		if(driftDetectionId != null){
			putQueryParameter("DriftDetectionId", driftDetectionId);
		}
	}

	@Override
	public Class<GetStackDriftDetectionStatusResponse> getResponseClass() {
		return GetStackDriftDetectionStatusResponse.class;
	}
