...
import com.aliyuncs.ros.transform.v20190910.UpdateStackTemplateByResourcesResponseUnmarshaller;
 ...
 * @version 
 */
public class UpdateStackTemplateByResourcesResponse extends AcsResponse {
	...
	@Override
	public UpdateStackTemplateByResourcesResponse getInstance(UnmarshallerContext context) {
		return	UpdateStackTemplateByResourcesResponseUnmarshaller.unmarshall(this, context);
	}
