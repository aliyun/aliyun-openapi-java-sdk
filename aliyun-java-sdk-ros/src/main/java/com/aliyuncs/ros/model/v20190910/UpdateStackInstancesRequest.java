 ...
 * @version 
 */
public class UpdateStackInstancesRequest extends RpcAcsRequest<UpdateStackInstancesResponse> {
	...
	public UpdateStackInstancesRequest() {
		super("ROS", "2019-09-10", "UpdateStackInstances", "ros");
	...
	@Override
	public Class<UpdateStackInstancesResponse> getResponseClass() {
		return UpdateStackInstancesResponse.class;
	}
