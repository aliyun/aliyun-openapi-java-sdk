 ...
 * @version 
 */
public class CreateDiagnosticRequest extends RpcAcsRequest<CreateDiagnosticResponse> {
	...
	public CreateDiagnosticRequest() {
		super("ROS", "2019-09-10", "CreateDiagnostic", "ros");
	...
	public void setDiagnosticType(String diagnosticType) {
		...
		if(diagnosticType != null){
			putQueryParameter("DiagnosticType", diagnosticType);
		}
	}
	...
	@Override
	public Class<CreateDiagnosticResponse> getResponseClass() {
		return CreateDiagnosticResponse.class;
	}
