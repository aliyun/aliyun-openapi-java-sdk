...
public class GetTemplateEstimateCostResponse extends AcsResponse {
	...
	@Override
	public GetTemplateEstimateCostResponse getInstance(UnmarshallerContext context) {
		return	GetTemplateEstimateCostResponseUnmarshaller.unmarshall(this, context);
	}
