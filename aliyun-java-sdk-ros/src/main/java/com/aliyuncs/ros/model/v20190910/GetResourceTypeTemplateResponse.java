...
public class GetResourceTypeTemplateResponse extends AcsResponse {
	...
	@Override
	public GetResourceTypeTemplateResponse getInstance(UnmarshallerContext context) {
		return	GetResourceTypeTemplateResponseUnmarshaller.unmarshall(this, context);
	}
