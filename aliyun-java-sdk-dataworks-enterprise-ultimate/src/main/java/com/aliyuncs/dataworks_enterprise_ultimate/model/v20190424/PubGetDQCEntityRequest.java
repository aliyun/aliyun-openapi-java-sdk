 ...
 * @version 
 */
public class PubGetDQCEntityRequest extends RpcAcsRequest<PubGetDQCEntityResponse> {
	
	public PubGetDQCEntityRequest() {
		super("dataworks-enterprise-ultimate", "2019-04-24", "PubGetDQCEntity");
	...
	@Override
	public Class<PubGetDQCEntityResponse> getResponseClass() {
		return PubGetDQCEntityResponse.class;
	}
