 ...
 * @version 
 */
public class PhysicalDeleteResourceRequest extends RpcAcsRequest<PhysicalDeleteResourceResponse> {
	...
	public PhysicalDeleteResourceRequest() {
		super("Dts-inner", "2016-08-01", "PhysicalDeleteResource", "dts");
	...
	@Override
	public Class<PhysicalDeleteResourceResponse> getResponseClass() {
		return PhysicalDeleteResourceResponse.class;
	}
