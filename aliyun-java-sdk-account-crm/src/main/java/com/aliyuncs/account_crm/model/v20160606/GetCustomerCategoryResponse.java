...
import com.aliyuncs.account_crm.transform.v20160606.GetCustomerCategoryResponseUnmarshaller;
 ...
 * @version 
 */
public class GetCustomerCategoryResponse extends AcsResponse {
	...
	@Override
	public GetCustomerCategoryResponse getInstance(UnmarshallerContext context) {
		return	GetCustomerCategoryResponseUnmarshaller.unmarshall(this, context);
	}
}
