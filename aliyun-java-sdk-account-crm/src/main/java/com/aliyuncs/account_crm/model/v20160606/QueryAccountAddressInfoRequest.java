 ...
 * @version 
 */
public class QueryAccountAddressInfoRequest extends RpcAcsRequest<QueryAccountAddressInfoResponse> {
	...
	public QueryAccountAddressInfoRequest() {
		super("account-crm", "2016-06-06", "QueryAccountAddressInfo");
	...
	@Override
	public Class<QueryAccountAddressInfoResponse> getResponseClass() {
		return QueryAccountAddressInfoResponse.class;
	}
