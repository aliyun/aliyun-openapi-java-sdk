 ...
 * @version 
 */
public class GetAgOneKeyDeleteTaskRequest extends RpcAcsRequest<GetAgOneKeyDeleteTaskResponse> {
	...
	public GetAgOneKeyDeleteTaskRequest() {
		super("account-crm", "2016-06-06", "GetAgOneKeyDeleteTask");
	...
	@Override
	public Class<GetAgOneKeyDeleteTaskResponse> getResponseClass() {
		return GetAgOneKeyDeleteTaskResponse.class;
	}
