...
import com.aliyuncs.account_crm.transform.v20160606.QueryBindsByOuterIdResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryBindsByOuterIdResponse extends AcsResponse {
	...
	@Override
	public QueryBindsByOuterIdResponse getInstance(UnmarshallerContext context) {
		return	QueryBindsByOuterIdResponseUnmarshaller.unmarshall(this, context);
	}
