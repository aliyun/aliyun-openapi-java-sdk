 ...
 * @version 
 */
public class ApplyAgOneKeyDeleteTaskRequest extends RpcAcsRequest<ApplyAgOneKeyDeleteTaskResponse> {
	...
	public ApplyAgOneKeyDeleteTaskRequest() {
		super("account-crm", "2016-06-06", "ApplyAgOneKeyDeleteTask");
	...
	public void setAbandonedDependency(String abandonedDependency) {
		this.abandonedDependency = abandonedDependency;
		if(abandonedDependency != null){
			putQueryParameter("AbandonedDependency", abandonedDependency);
		}
	}
	...
	@Override
	public Class<ApplyAgOneKeyDeleteTaskResponse> getResponseClass() {
		return ApplyAgOneKeyDeleteTaskResponse.class;
	}
