 ...
 * @version 
 */
public class AllowAgAccountLoginRequest extends RpcAcsRequest<AllowAgAccountLoginResponse> {
	...
	public AllowAgAccountLoginRequest() {
		super("account-crm", "2016-06-06", "AllowAgAccountLogin");
	...
	@Override
	public Class<AllowAgAccountLoginResponse> getResponseClass() {
		return AllowAgAccountLoginResponse.class;
	}
