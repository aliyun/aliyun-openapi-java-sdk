 ...
 * @version 
 */
public class QueryBindsByOuterIdRequest extends RpcAcsRequest<QueryBindsByOuterIdResponse> {
	...
	public QueryBindsByOuterIdRequest() {
		super("account-crm", "2016-06-06", "QueryBindsByOuterId");
	...
	@Override
	public Class<QueryBindsByOuterIdResponse> getResponseClass() {
