...
import com.aliyuncs.account_crm.transform.v20160606.FindFinanceTaxDetailResponseUnmarshaller;
 ...
 * @version 
 */
public class FindFinanceTaxDetailResponse extends AcsResponse {
	...
	@Override
	public FindFinanceTaxDetailResponse getInstance(UnmarshallerContext context) {
		return	FindFinanceTaxDetailResponseUnmarshaller.unmarshall(this, context);
	}
}
