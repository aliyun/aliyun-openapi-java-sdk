 ...
 * @version 
 */
public class CreateContacterRequest extends RpcAcsRequest<CreateContacterResponse> {
	...
	public CreateContacterRequest() {
		super("account-crm", "2016-06-06", "CreateContacter");
	...
	@Override
	public Class<CreateContacterResponse> getResponseClass() {
		return CreateContacterResponse.class;
	}
