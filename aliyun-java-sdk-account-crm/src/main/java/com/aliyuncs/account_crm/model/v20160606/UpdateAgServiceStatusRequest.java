 ...
 * @version 
 */
public class UpdateAgServiceStatusRequest extends RpcAcsRequest<UpdateAgServiceStatusResponse> {
	...
	public UpdateAgServiceStatusRequest() {
		super("account-crm", "2016-06-06", "UpdateAgServiceStatus");
	...
	@Override
	public Class<UpdateAgServiceStatusResponse> getResponseClass() {
		return UpdateAgServiceStatusResponse.class;
	}
