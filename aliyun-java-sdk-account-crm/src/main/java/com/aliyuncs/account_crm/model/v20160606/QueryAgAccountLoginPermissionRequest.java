 ...
 * @version 
 */
public class QueryAgAccountLoginPermissionRequest extends RpcAcsRequest<QueryAgAccountLoginPermissionResponse> {
	...
	public QueryAgAccountLoginPermissionRequest() {
		super("account-crm", "2016-06-06", "QueryAgAccountLoginPermission");
	...
	@Override
	public Class<QueryAgAccountLoginPermissionResponse> getResponseClass() {
		return QueryAgAccountLoginPermissionResponse.class;
	}
