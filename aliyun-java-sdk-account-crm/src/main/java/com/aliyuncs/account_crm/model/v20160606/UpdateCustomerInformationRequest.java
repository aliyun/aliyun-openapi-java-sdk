 ...
 * @version 
 */
public class UpdateCustomerInformationRequest extends RpcAcsRequest<UpdateCustomerInformationResponse> {
	...
	private Long userId;
	public UpdateCustomerInformationRequest() {
		super("account-crm", "2016-06-06", "UpdateCustomerInformation");
	...
	@Override
	public Class<UpdateCustomerInformationResponse> getResponseClass() {
