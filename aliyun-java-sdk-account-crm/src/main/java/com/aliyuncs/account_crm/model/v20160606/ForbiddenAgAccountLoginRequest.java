 ...
 * @version 
 */
public class ForbiddenAgAccountLoginRequest extends RpcAcsRequest<ForbiddenAgAccountLoginResponse> {
	...
	public ForbiddenAgAccountLoginRequest() {
		super("account-crm", "2016-06-06", "ForbiddenAgAccountLogin");
	...
	@Override
	public Class<ForbiddenAgAccountLoginResponse> getResponseClass() {
		return ForbiddenAgAccountLoginResponse.class;
	}
