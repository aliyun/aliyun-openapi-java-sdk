...
import com.aliyuncs.account_crm.transform.v20160606.FindAllContacterResponseUnmarshaller;
 ...
 * @version 
 */
public class FindAllContacterResponse extends AcsResponse {
	...
	private List<ContacterInfo> data;
	...
	public List<ContacterInfo> getData() {
		return this.data;
	}

	public void setData(List<ContacterInfo> data) {
		this.data = data;
	}
	...
	@Override
	public FindAllContacterResponse getInstance(UnmarshallerContext context) {
		return	FindAllContacterResponseUnmarshaller.unmarshall(this, context);
	}
}
