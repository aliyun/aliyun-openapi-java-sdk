...
import com.aliyuncs.quickbi_public.transform.v20200804.QuerySharesToUserListResponseUnmarshaller;
...
public class QuerySharesToUserListResponse extends AcsResponse {
	...
	@Override
	public QuerySharesToUserListResponse getInstance(UnmarshallerContext context) {
		return	QuerySharesToUserListResponseUnmarshaller.unmarshall(this, context);
	}
