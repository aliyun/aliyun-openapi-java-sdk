 ...
 * @version 
 */
public class TransferUsergroupRequest extends RpcAcsRequest<TransferUsergroupResponse> {
	...
	@Override
	public Class<TransferUsergroupResponse> getResponseClass() {
		return TransferUsergroupResponse.class;
	}
