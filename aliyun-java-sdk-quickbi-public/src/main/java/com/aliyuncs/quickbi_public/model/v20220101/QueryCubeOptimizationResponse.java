...
import com.aliyuncs.quickbi_public.transform.v20220101.QueryCubeOptimizationResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryCubeOptimizationResponse extends AcsResponse {
	...
	public static class Data {
		...
		public void setCubePerformanceDiagnoseModel(CubePerformanceDiagnoseModel cubePerformanceDiagnoseModel) {
	...
	@Override
	public QueryCubeOptimizationResponse getInstance(UnmarshallerContext context) {
		return	QueryCubeOptimizationResponseUnmarshaller.unmarshall(this, context);
	}
