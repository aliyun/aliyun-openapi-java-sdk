 ...
 * @version 
 */
public class QueryDatasetSmartqStatusRequest extends RpcAcsRequest<QueryDatasetSmartqStatusResponse> {
	...
	@Override
	public Class<QueryDatasetSmartqStatusResponse> getResponseClass() {
