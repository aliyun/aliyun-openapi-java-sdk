...
public class QueryUserTagMetaListRequest extends RpcAcsRequest<QueryUserTagMetaListResponse> {
	...
	public QueryUserTagMetaListRequest() {
		super("quickbi-public", "2020-08-02", "QueryUserTagMetaList", "quickbi");
	...
	@Override
	public Class<QueryUserTagMetaListResponse> getResponseClass() {
		return QueryUserTagMetaListResponse.class;
	}
