 ...
 * @version 
 */
public class ListPortalMenuAuthorizationRequest extends RpcAcsRequest<ListPortalMenuAuthorizationResponse> {
	   

	private String dataPortalId;
	public ListPortalMenuAuthorizationRequest() {
		super("quickbi-public", "2020-08-08", "ListPortalMenuAuthorization", "quickbi");
	...
	@Override
	public Class<ListPortalMenuAuthorizationResponse> getResponseClass() {
		return ListPortalMenuAuthorizationResponse.class;
	}
