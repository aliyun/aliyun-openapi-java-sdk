 ...
 * @version 
 */
public class ModifyDashboardNl2sqlStatusRequest extends RpcAcsRequest<ModifyDashboardNl2sqlStatusResponse> {
	...
	public void setDashboardIds(String dashboardIds) {
		...
		if(dashboardIds != null){
			putQueryParameter("DashboardIds", dashboardIds);
		}
	}
	...
	@Override
	public Class<ModifyDashboardNl2sqlStatusResponse> getResponseClass() {
		return ModifyDashboardNl2sqlStatusResponse.class;
	}
