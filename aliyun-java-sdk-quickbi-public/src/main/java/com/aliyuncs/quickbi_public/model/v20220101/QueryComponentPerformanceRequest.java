 ...
 * @version 
 */
public class QueryComponentPerformanceRequest extends RpcAcsRequest<QueryComponentPerformanceResponse> {
	...
	@Override
	public Class<QueryComponentPerformanceResponse> getResponseClass() {
