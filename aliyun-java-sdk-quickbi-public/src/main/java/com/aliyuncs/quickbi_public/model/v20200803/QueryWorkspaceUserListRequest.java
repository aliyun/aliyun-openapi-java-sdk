...
public class QueryWorkspaceUserListRequest extends RpcAcsRequest<QueryWorkspaceUserListResponse> {
	...
	public QueryWorkspaceUserListRequest() {
		super("quickbi-public", "2020-08-03", "QueryWorkspaceUserList", "quickbi");
	...
	@Override
	public Class<QueryWorkspaceUserListResponse> getResponseClass() {
		return QueryWorkspaceUserListResponse.class;
	}
