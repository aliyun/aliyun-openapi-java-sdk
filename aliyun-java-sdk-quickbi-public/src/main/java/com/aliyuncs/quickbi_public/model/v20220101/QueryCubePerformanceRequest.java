 ...
 * @version 
 */
public class QueryCubePerformanceRequest extends RpcAcsRequest<QueryCubePerformanceResponse> {
	...
	public QueryCubePerformanceRequest() {
		super("quickbi-public", "2022-01-01", "QueryCubePerformance", "QuickBI");
	...
	@Override
	public Class<QueryCubePerformanceResponse> getResponseClass() {
		return QueryCubePerformanceResponse.class;
	}
