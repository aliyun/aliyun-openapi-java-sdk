...
import com.aliyuncs.quickbi_public.transform.v20220101.QueryCubePerformanceResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryCubePerformanceResponse extends AcsResponse {
	...
	@Override
	public QueryCubePerformanceResponse getInstance(UnmarshallerContext context) {
		return	QueryCubePerformanceResponseUnmarshaller.unmarshall(this, context);
	}
