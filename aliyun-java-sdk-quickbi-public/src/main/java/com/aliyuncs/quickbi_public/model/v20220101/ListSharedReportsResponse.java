...
import com.aliyuncs.quickbi_public.transform.v20220101.ListSharedReportsResponseUnmarshaller;
 ...
 * @version 
 */
public class ListSharedReportsResponse extends AcsResponse {
	...
	@Override
	public ListSharedReportsResponse getInstance(UnmarshallerContext context) {
		return	ListSharedReportsResponseUnmarshaller.unmarshall(this, context);
	}
