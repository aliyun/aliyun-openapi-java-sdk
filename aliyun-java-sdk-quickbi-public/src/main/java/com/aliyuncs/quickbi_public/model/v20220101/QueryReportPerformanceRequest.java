 ...
 * @version 
 */
public class QueryReportPerformanceRequest extends RpcAcsRequest<QueryReportPerformanceResponse> {
	...
	@Override
	public Class<QueryReportPerformanceResponse> getResponseClass() {
		return QueryReportPerformanceResponse.class;
	}
