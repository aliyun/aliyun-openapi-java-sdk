...
public class QueryUserInfoByUserIdResponseUnmarshaller {
	...
	public static QueryUserInfoByUserIdResponse unmarshall(QueryUserInfoByUserIdResponse queryUserInfoByUserIdResponse, UnmarshallerContext _ctx) {
		...
		result.setIsDeleted(_ctx.booleanValue("QueryUserInfoByUserIdResponse.Result.IsDeleted"));
		...
		for (int i = 0; i < _ctx.lengthValue("QueryUserInfoByUserIdResponse.Result.CopilotModules.Length"); i++) {
			copilotModules.add(_ctx.stringValue("QueryUserInfoByUserIdResponse.Result.CopilotModules["+ i +"]"));
		}
