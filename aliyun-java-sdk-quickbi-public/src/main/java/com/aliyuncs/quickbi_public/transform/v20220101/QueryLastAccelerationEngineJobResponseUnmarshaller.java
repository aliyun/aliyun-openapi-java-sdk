...
import com.aliyuncs.quickbi_public.model.v20220101.QueryLastAccelerationEngineJobResponse;
import com.aliyuncs.quickbi_public.model.v20220101.QueryLastAccelerationEngineJobResponse.Result;
import com.aliyuncs.transform.UnmarshallerContext;


public class QueryLastAccelerationEngineJobResponseUnmarshaller {

	public static QueryLastAccelerationEngineJobResponse unmarshall(QueryLastAccelerationEngineJobResponse queryLastAccelerationEngineJobResponse, UnmarshallerContext _ctx) {
		
		queryLastAccelerationEngineJobResponse.setRequestId(_ctx.stringValue("QueryLastAccelerationEngineJobResponse.RequestId"));
