...
import com.aliyuncs.ddi.transform.v20200617.ListFlowJobsResponseUnmarshaller;
 ...
 * @version 
 */
public class ListFlowJobsResponse extends AcsResponse {
	...
	@Override
	public ListFlowJobsResponse getInstance(UnmarshallerContext context) {
		return	ListFlowJobsResponseUnmarshaller.unmarshall(this, context);
	}
}
