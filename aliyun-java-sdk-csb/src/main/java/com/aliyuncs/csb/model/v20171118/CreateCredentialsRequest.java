 ...
 * @version 
 */
public class CreateCredentialsRequest extends RpcAcsRequest<CreateCredentialsResponse> {
	...
	@Override
	public Class<CreateCredentialsResponse> getResponseClass() {
		return CreateCredentialsResponse.class;
	}
