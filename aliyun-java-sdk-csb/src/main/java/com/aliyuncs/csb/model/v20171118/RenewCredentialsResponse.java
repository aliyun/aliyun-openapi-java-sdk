...
import com.aliyuncs.csb.transform.v20171118.RenewCredentialsResponseUnmarshaller;
 ...
 * @version 
 */
public class RenewCredentialsResponse extends AcsResponse {
	...
	@Override
	public RenewCredentialsResponse getInstance(UnmarshallerContext context) {
		return	RenewCredentialsResponseUnmarshaller.unmarshall(this, context);
	}
