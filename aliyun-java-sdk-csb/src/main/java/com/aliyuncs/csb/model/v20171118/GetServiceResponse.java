	...
	public static class Data {
		...
		public static class Service {
			...
			public static class RouteConf {
				...
				private ImportConf importConf;

				private ImportConfs importConfs;

				public String getServiceRouteStrategy() {
					return this.serviceRouteStrategy;
				}

				public void setServiceRouteStrategy(String serviceRouteStrategy) {
					this.serviceRouteStrategy = serviceRouteStrategy;
				}

				public ImportConf getImportConf() {
					return this.importConf;
				}

				public void setImportConf(ImportConf importConf) {
					this.importConf = importConf;
				}

				public ImportConfs getImportConfs() {
					return this.importConfs;
				}

				public void setImportConfs(ImportConfs importConfs) {
					this.importConfs = importConfs;
				}

				public static class ImportConf {

					private String accessEndpointJSON;

					private String provideType;

					private List<InputParameter> inputParameterMap;

					private List<OutputParameter> outputParameterMap;

					public String getAccessEndpointJSON() {
						return this.accessEndpointJSON;
					}

					public void setAccessEndpointJSON(String accessEndpointJSON) {
						this.accessEndpointJSON = accessEndpointJSON;
					}
					...
					public List<InputParameter> getInputParameterMap() {
						return this.inputParameterMap;
					}

					public void setInputParameterMap(List<InputParameter> inputParameterMap) {
						this.inputParameterMap = inputParameterMap;
					}

					public List<OutputParameter> getOutputParameterMap() {
						return this.outputParameterMap;
					}

					public void setOutputParameterMap(List<OutputParameter> outputParameterMap) {
				...
				public static class ImportConfs {

					private String accessEndpointJSON;

					private String provideType;

					private List<InputParameter3> inputParameterMap1;

					private List<OutputParameter4> outputParameterMap2;
					...
					public List<InputParameter3> getInputParameterMap1() {
						return this.inputParameterMap1;
					}

					public void setInputParameterMap1(List<InputParameter3> inputParameterMap1) {
						this.inputParameterMap1 = inputParameterMap1;
					}

					public List<OutputParameter4> getOutputParameterMap2() {
						return this.outputParameterMap2;
					}

					public void setOutputParameterMap2(List<OutputParameter4> outputParameterMap2) {
						this.outputParameterMap2 = outputParameterMap2;
					}

					public static class InputParameter3 {
					...
					public static class OutputParameter4 {
