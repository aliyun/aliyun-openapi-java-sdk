 ...
 * @version 
 */
public class FindApproveServiceListResponse extends AcsResponse {
	...
	@Override
	public FindApproveServiceListResponse getInstance(UnmarshallerContext context) {
		return	FindApproveServiceListResponseUnmarshaller.unmarshall(this, context);
	}
