...
public class DescribeDataHubTopicsRequest extends RpcAcsRequest<DescribeDataHubTopicsResponse> {
	...
	public DescribeDataHubTopicsRequest() {
		super("Yundun-ds", "2019-01-03", "DescribeDataHubTopics", "sddp");
	}
	...
	@Override
	public Class<DescribeDataHubTopicsResponse> getResponseClass() {
		return DescribeDataHubTopicsResponse.class;
	}
