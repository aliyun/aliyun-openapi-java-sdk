 ...
 * @version 
 */
public class ValidateConnectorRequest extends RpcAcsRequest<ValidateConnectorResponse> {
	
	public ValidateConnectorRequest() {
		super("Yundun-ds", "2019-01-03", "ValidateConnector", "sddp");
	}
	...
	@Override
	public Class<ValidateConnectorResponse> getResponseClass() {
		return ValidateConnectorResponse.class;
	}
