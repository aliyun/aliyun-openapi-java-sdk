 ...
 * @version 
 */
public class ListApplicationOrderCaseSKURequest extends RpcAcsRequest<ListApplicationOrderCaseSKUResponse> {
	...
	public ListApplicationOrderCaseSKURequest() {
		super("digitalstore", "2020-01-07", "ListApplicationOrderCaseSKU", "digitalstore");
	...
	@Override
	public Class<ListApplicationOrderCaseSKUResponse> getResponseClass() {
		return ListApplicationOrderCaseSKUResponse.class;
	}
