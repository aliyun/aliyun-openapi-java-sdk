 ...
 * @version 
 */
public class ListApplicationOrderLinesRequest extends RpcAcsRequest<ListApplicationOrderLinesResponse> {
	...
	public ListApplicationOrderLinesRequest() {
		super("digitalstore", "2020-01-07", "ListApplicationOrderLines", "digitalstore");
	...
	@Override
	public Class<ListApplicationOrderLinesResponse> getResponseClass() {
		return ListApplicationOrderLinesResponse.class;
	}
