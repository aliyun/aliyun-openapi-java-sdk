 ...
 * @version 
 */
public class ListSizeGroupsRequest extends RpcAcsRequest<ListSizeGroupsResponse> {
	...
	public ListSizeGroupsRequest() {
		super("digitalstore", "2020-01-07", "ListSizeGroups", "digitalstore");
	...
	@Override
	public Class<ListSizeGroupsResponse> getResponseClass() {
		return ListSizeGroupsResponse.class;
	}
