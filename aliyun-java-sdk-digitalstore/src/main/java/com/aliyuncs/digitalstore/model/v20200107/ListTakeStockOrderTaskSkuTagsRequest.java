 ...
 * @version 
 */
public class ListTakeStockOrderTaskSkuTagsRequest extends RpcAcsRequest<ListTakeStockOrderTaskSkuTagsResponse> {
	...
	public ListTakeStockOrderTaskSkuTagsRequest() {
		super("digitalstore", "2020-01-07", "ListTakeStockOrderTaskSkuTags", "digitalstore");
	...
	@Override
	public Class<ListTakeStockOrderTaskSkuTagsResponse> getResponseClass() {
		return ListTakeStockOrderTaskSkuTagsResponse.class;
	}
