 ...
 * @version 
 */
public class CreateMerchantRequest extends RpcAcsRequest<CreateMerchantResponse> {
	...
	public CreateMerchantRequest() {
		super("digitalstore", "2020-01-07", "CreateMerchant", "digitalstore");
	...
	@Override
	public Class<CreateMerchantResponse> getResponseClass() {
		return CreateMerchantResponse.class;
	}
