 ...
 * @version 
 */
public class ListApplicationOrderCasesRequest extends RpcAcsRequest<ListApplicationOrderCasesResponse> {
	...
	public ListApplicationOrderCasesRequest() {
		super("digitalstore", "2020-01-07", "ListApplicationOrderCases", "digitalstore");
	...
	@Override
	public Class<ListApplicationOrderCasesResponse> getResponseClass() {
		return ListApplicationOrderCasesResponse.class;
	}
