 ...
 * @version 
 */
public class ListInboundOrderCasesRequest extends RpcAcsRequest<ListInboundOrderCasesResponse> {
	...
	public ListInboundOrderCasesRequest() {
		super("digitalstore", "2020-01-07", "ListInboundOrderCases", "digitalstore");
	...
	@Override
	public Class<ListInboundOrderCasesResponse> getResponseClass() {
		return ListInboundOrderCasesResponse.class;
	}
