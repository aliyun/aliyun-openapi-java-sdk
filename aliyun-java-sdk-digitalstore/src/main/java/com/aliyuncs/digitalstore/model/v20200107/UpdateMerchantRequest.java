 ...
 * @version 
 */
public class UpdateMerchantRequest extends RpcAcsRequest<UpdateMerchantResponse> {
	...
	public UpdateMerchantRequest() {
		super("digitalstore", "2020-01-07", "UpdateMerchant", "digitalstore");
	...
	@Override
	public Class<UpdateMerchantResponse> getResponseClass() {
		return UpdateMerchantResponse.class;
	}
