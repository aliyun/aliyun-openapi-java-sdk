...
import com.aliyuncs.digitalstore.transform.v20200107.ListInboundOrdersResponseUnmarshaller;
 ...
 * @version 
 */
public class ListInboundOrdersResponse extends AcsResponse {
	...
	@Override
	public ListInboundOrdersResponse getInstance(UnmarshallerContext context) {
		return	ListInboundOrdersResponseUnmarshaller.unmarshall(this, context);
	}
}
