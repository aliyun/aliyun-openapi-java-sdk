 ...
 * @version 
 */
public class CancelTakeStockOrderRequest extends RpcAcsRequest<CancelTakeStockOrderResponse> {
	   

	private String takeStockOrderId;
	public CancelTakeStockOrderRequest() {
		super("digitalstore", "2020-01-07", "CancelTakeStockOrder", "digitalstore");
	...
	@Override
	public Class<CancelTakeStockOrderResponse> getResponseClass() {
		return CancelTakeStockOrderResponse.class;
	}
