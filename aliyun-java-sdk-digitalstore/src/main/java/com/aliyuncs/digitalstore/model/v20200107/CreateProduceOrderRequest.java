 ...
 * @version 
 */
public class CreateProduceOrderRequest extends RpcAcsRequest<CreateProduceOrderResponse> {
	...
	public CreateProduceOrderRequest() {
		super("digitalstore", "2020-01-07", "CreateProduceOrder", "digitalstore");
	...
	@Override
	public Class<CreateProduceOrderResponse> getResponseClass() {
		return CreateProduceOrderResponse.class;
	}
