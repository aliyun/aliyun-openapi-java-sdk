 ...
 * @version 
 */
public class ListColorsRequest extends RpcAcsRequest<ListColorsResponse> {
	...
	public ListColorsRequest() {
		super("digitalstore", "2020-01-07", "ListColors", "digitalstore");
	...
	@Override
	public Class<ListColorsResponse> getResponseClass() {
		return ListColorsResponse.class;
	}
