 ...
 * @version 
 */
public class ImportWarehouseRequest extends RpcAcsRequest<ImportWarehouseResponse> {
	...
	private String name;
	public ImportWarehouseRequest() {
		super("digitalstore", "2020-01-07", "ImportWarehouse", "digitalstore");
	...
	@Override
	public Class<ImportWarehouseResponse> getResponseClass() {
		return ImportWarehouseResponse.class;
	}
