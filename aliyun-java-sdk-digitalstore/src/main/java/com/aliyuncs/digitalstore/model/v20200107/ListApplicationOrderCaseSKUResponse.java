...
import com.aliyuncs.digitalstore.transform.v20200107.ListApplicationOrderCaseSKUResponseUnmarshaller;
 ...
 * @version 
 */
public class ListApplicationOrderCaseSKUResponse extends AcsResponse {
	...
	private List<ApplyOrderCaseSkuModel> applyOrderCaseSkus;
	...
	public List<ApplyOrderCaseSkuModel> getApplyOrderCaseSkus() {
		return this.applyOrderCaseSkus;
	}

	public void setApplyOrderCaseSkus(List<ApplyOrderCaseSkuModel> applyOrderCaseSkus) {
		this.applyOrderCaseSkus = applyOrderCaseSkus;
	}

	public static class ApplyOrderCaseSkuModel {
	...
	@Override
	public ListApplicationOrderCaseSKUResponse getInstance(UnmarshallerContext context) {
		return	ListApplicationOrderCaseSKUResponseUnmarshaller.unmarshall(this, context);
	}
}
