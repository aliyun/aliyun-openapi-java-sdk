 ...
 * @version 
 */
public class ListOutboundOrderSKUTagsRequest extends RpcAcsRequest<ListOutboundOrderSKUTagsResponse> {
	...
	public ListOutboundOrderSKUTagsRequest() {
		super("digitalstore", "2020-01-07", "ListOutboundOrderSKUTags", "digitalstore");
	...
	@Override
	public Class<ListOutboundOrderSKUTagsResponse> getResponseClass() {
		return ListOutboundOrderSKUTagsResponse.class;
	}
