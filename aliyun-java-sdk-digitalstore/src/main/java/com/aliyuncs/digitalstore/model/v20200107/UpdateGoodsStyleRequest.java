 ...
 * @version 
 */
public class UpdateGoodsStyleRequest extends RpcAcsRequest<UpdateGoodsStyleResponse> {
	...
	public UpdateGoodsStyleRequest() {
		super("digitalstore", "2020-01-07", "UpdateGoodsStyle", "digitalstore");
	...
	@Override
	public Class<UpdateGoodsStyleResponse> getResponseClass() {
		return UpdateGoodsStyleResponse.class;
	}
