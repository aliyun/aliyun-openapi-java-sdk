 ...
 * @version 
 */
public class UpdateWarehouseRequest extends RpcAcsRequest<UpdateWarehouseResponse> {
	...
	public UpdateWarehouseRequest() {
		super("digitalstore", "2020-01-07", "UpdateWarehouse", "digitalstore");
	...
	@Override
	public Class<UpdateWarehouseResponse> getResponseClass() {
		return UpdateWarehouseResponse.class;
	}
