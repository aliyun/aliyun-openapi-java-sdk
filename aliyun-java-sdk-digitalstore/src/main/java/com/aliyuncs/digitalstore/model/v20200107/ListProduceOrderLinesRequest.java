 ...
 * @version 
 */
public class ListProduceOrderLinesRequest extends RpcAcsRequest<ListProduceOrderLinesResponse> {
	...
	public ListProduceOrderLinesRequest() {
		super("digitalstore", "2020-01-07", "ListProduceOrderLines", "digitalstore");
	...
	@Override
	public Class<ListProduceOrderLinesResponse> getResponseClass() {
		return ListProduceOrderLinesResponse.class;
	}
