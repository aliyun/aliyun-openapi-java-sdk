 ...
 * @version 
 */
public class StartTakeStockOrderRequest extends RpcAcsRequest<StartTakeStockOrderResponse> {
	   

	private String takeStockOrderId;
	public StartTakeStockOrderRequest() {
		super("digitalstore", "2020-01-07", "StartTakeStockOrder", "digitalstore");
	...
	@Override
	public Class<StartTakeStockOrderResponse> getResponseClass() {
		return StartTakeStockOrderResponse.class;
	}
