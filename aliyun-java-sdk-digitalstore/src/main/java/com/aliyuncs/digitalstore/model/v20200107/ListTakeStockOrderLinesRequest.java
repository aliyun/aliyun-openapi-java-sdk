 ...
 * @version 
 */
public class ListTakeStockOrderLinesRequest extends RpcAcsRequest<ListTakeStockOrderLinesResponse> {
	...
	public ListTakeStockOrderLinesRequest() {
		super("digitalstore", "2020-01-07", "ListTakeStockOrderLines", "digitalstore");
	...
	@Override
	public Class<ListTakeStockOrderLinesResponse> getResponseClass() {
		return ListTakeStockOrderLinesResponse.class;
	}
