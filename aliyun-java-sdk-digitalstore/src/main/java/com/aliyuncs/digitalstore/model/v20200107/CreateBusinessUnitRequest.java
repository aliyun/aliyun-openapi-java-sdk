 ...
 * @version 
 */
public class CreateBusinessUnitRequest extends RpcAcsRequest<CreateBusinessUnitResponse> {
	...
	public CreateBusinessUnitRequest() {
		super("digitalstore", "2020-01-07", "CreateBusinessUnit", "digitalstore");
	...
	@Override
	public Class<CreateBusinessUnitResponse> getResponseClass() {
		return CreateBusinessUnitResponse.class;
	}
