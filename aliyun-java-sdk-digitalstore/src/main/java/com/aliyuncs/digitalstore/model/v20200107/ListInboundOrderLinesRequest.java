 ...
 * @version 
 */
public class ListInboundOrderLinesRequest extends RpcAcsRequest<ListInboundOrderLinesResponse> {
	...
	public ListInboundOrderLinesRequest() {
		super("digitalstore", "2020-01-07", "ListInboundOrderLines", "digitalstore");
	...
	@Override
	public Class<ListInboundOrderLinesResponse> getResponseClass() {
		return ListInboundOrderLinesResponse.class;
	}
