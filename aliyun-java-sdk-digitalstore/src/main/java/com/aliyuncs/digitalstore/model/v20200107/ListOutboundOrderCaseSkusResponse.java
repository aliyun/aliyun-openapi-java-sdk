...
import com.aliyuncs.digitalstore.transform.v20200107.ListOutboundOrderCaseSkusResponseUnmarshaller;
 ...
 * @version 
 */
public class ListOutboundOrderCaseSkusResponse extends AcsResponse {
	...
	@Override
	public ListOutboundOrderCaseSkusResponse getInstance(UnmarshallerContext context) {
		return	ListOutboundOrderCaseSkusResponseUnmarshaller.unmarshall(this, context);
	}
}
