 ...
 * @version 
 */
public class ListOutboundOrderCaseSkusRequest extends RpcAcsRequest<ListOutboundOrderCaseSkusResponse> {
	...
	public ListOutboundOrderCaseSkusRequest() {
		super("digitalstore", "2020-01-07", "ListOutboundOrderCaseSkus", "digitalstore");
	...
	@Override
	public Class<ListOutboundOrderCaseSkusResponse> getResponseClass() {
		return ListOutboundOrderCaseSkusResponse.class;
	}
