 ...
 * @version 
 */
public class DeleteTakeStockTaskRequest extends RpcAcsRequest<DeleteTakeStockTaskResponse> {
	   

	private String takeStockTaskId;
	public DeleteTakeStockTaskRequest() {
		super("digitalstore", "2020-01-07", "DeleteTakeStockTask", "digitalstore");
	...
	@Override
	public Class<DeleteTakeStockTaskResponse> getResponseClass() {
		return DeleteTakeStockTaskResponse.class;
	}
