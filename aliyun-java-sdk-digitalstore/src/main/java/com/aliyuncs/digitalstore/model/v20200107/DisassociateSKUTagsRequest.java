 ...
 * @version 
 */
public class DisassociateSKUTagsRequest extends RpcAcsRequest<DisassociateSKUTagsResponse> {
	...
	public DisassociateSKUTagsRequest() {
		super("digitalstore", "2020-01-07", "DisassociateSKUTags", "digitalstore");
	...
	@Override
	public Class<DisassociateSKUTagsResponse> getResponseClass() {
		return DisassociateSKUTagsResponse.class;
	}
