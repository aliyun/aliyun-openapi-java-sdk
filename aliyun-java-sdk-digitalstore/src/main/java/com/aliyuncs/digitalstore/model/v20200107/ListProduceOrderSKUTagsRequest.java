 ...
 * @version 
 */
public class ListProduceOrderSKUTagsRequest extends RpcAcsRequest<ListProduceOrderSKUTagsResponse> {
	...
	public ListProduceOrderSKUTagsRequest() {
		super("digitalstore", "2020-01-07", "ListProduceOrderSKUTags", "digitalstore");
	...
	@Override
	public Class<ListProduceOrderSKUTagsResponse> getResponseClass() {
		return ListProduceOrderSKUTagsResponse.class;
	}
