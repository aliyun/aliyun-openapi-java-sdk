 ...
 * @version 
 */
public class ResetTakeStockTaskRequest extends RpcAcsRequest<ResetTakeStockTaskResponse> {
	   

	private String takeStockTaskId;
	public ResetTakeStockTaskRequest() {
		super("digitalstore", "2020-01-07", "ResetTakeStockTask", "digitalstore");
	...
	@Override
	public Class<ResetTakeStockTaskResponse> getResponseClass() {
		return ResetTakeStockTaskResponse.class;
	}
