 ...
 * @version 
 */
public class ListOutboundOrderCasesRequest extends RpcAcsRequest<ListOutboundOrderCasesResponse> {
	...
	public ListOutboundOrderCasesRequest() {
		super("digitalstore", "2020-01-07", "ListOutboundOrderCases", "digitalstore");
	...
	@Override
	public Class<ListOutboundOrderCasesResponse> getResponseClass() {
		return ListOutboundOrderCasesResponse.class;
	}
