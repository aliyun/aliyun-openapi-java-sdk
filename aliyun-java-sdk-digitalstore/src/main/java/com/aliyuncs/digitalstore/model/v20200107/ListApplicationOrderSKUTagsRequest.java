 ...
 * @version 
 */
public class ListApplicationOrderSKUTagsRequest extends RpcAcsRequest<ListApplicationOrderSKUTagsResponse> {
	...
	public ListApplicationOrderSKUTagsRequest() {
		super("digitalstore", "2020-01-07", "ListApplicationOrderSKUTags", "digitalstore");
	...
	@Override
	public Class<ListApplicationOrderSKUTagsResponse> getResponseClass() {
		return ListApplicationOrderSKUTagsResponse.class;
	}
