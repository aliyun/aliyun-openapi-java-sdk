 ...
 * @version 
 */
public class ListInboundOrderCaseSkusRequest extends RpcAcsRequest<ListInboundOrderCaseSkusResponse> {
	...
	public ListInboundOrderCaseSkusRequest() {
		super("digitalstore", "2020-01-07", "ListInboundOrderCaseSkus", "digitalstore");
	...
	@Override
	public Class<ListInboundOrderCaseSkusResponse> getResponseClass() {
		return ListInboundOrderCaseSkusResponse.class;
	}
