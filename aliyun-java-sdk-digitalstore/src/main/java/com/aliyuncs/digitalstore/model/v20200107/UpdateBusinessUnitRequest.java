 ...
 * @version 
 */
public class UpdateBusinessUnitRequest extends RpcAcsRequest<UpdateBusinessUnitResponse> {
	...
	private String name;
	public UpdateBusinessUnitRequest() {
		super("digitalstore", "2020-01-07", "UpdateBusinessUnit", "digitalstore");
	...
	@Override
	public Class<UpdateBusinessUnitResponse> getResponseClass() {
		return UpdateBusinessUnitResponse.class;
	}
