 ...
 * @version 
 */
public class AssociateSKUTagsRequest extends RpcAcsRequest<AssociateSKUTagsResponse> {
	...
	public AssociateSKUTagsRequest() {
		super("digitalstore", "2020-01-07", "AssociateSKUTags", "digitalstore");
	...
	@Override
	public Class<AssociateSKUTagsResponse> getResponseClass() {
		return AssociateSKUTagsResponse.class;
	}
