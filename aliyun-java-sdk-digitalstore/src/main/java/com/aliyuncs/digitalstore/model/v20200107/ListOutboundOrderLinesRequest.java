 ...
 * @version 
 */
public class ListOutboundOrderLinesRequest extends RpcAcsRequest<ListOutboundOrderLinesResponse> {
	...
	public ListOutboundOrderLinesRequest() {
		super("digitalstore", "2020-01-07", "ListOutboundOrderLines", "digitalstore");
	...
	@Override
	public Class<ListOutboundOrderLinesResponse> getResponseClass() {
		return ListOutboundOrderLinesResponse.class;
	}
