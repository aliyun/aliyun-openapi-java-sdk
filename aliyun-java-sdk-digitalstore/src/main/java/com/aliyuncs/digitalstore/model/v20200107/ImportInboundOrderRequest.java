 ...
 * @version 
 */
public class ImportInboundOrderRequest extends RpcAcsRequest<ImportInboundOrderResponse> {
	...
	public ImportInboundOrderRequest() {
		super("digitalstore", "2020-01-07", "ImportInboundOrder", "digitalstore");
	...
	@Override
	public Class<ImportInboundOrderResponse> getResponseClass() {
		return ImportInboundOrderResponse.class;
	}
