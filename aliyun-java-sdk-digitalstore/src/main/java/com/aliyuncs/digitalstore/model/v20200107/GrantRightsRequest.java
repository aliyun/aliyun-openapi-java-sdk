 ...
 * @version 
 */
public class GrantRightsRequest extends RpcAcsRequest<GrantRightsResponse> {
	...
	public GrantRightsRequest() {
		super("digitalstore", "2020-01-07", "GrantRights", "digitalstore");
	...
	public void setAliyunAccount(String aliyunAccount) {
		...
		if(aliyunAccount != null){
			putBodyParameter("AliyunAccount", aliyunAccount);
		}
	}
	...
	@Override
	public Class<GrantRightsResponse> getResponseClass() {
		return GrantRightsResponse.class;
	}
