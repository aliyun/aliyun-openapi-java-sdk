...
public class ListDashboardParametersResponse extends AcsResponse {
	...
	@Override
	public ListDashboardParametersResponse getInstance(UnmarshallerContext context) {
		return	ListDashboardParametersResponseUnmarshaller.unmarshall(this, context);
	}
