...
import com.aliyuncs.airec.transform.v20201126.ModifyRankingModelTemplateResponseUnmarshaller;
 ...
 * @version 
 */
public class ModifyRankingModelTemplateResponse extends AcsResponse {
	...
	@Override
	public ModifyRankingModelTemplateResponse getInstance(UnmarshallerContext context) {
		return	ModifyRankingModelTemplateResponseUnmarshaller.unmarshall(this, context);
	}
