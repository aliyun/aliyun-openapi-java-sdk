...
public class ModifyExposureSettingsResponse extends AcsResponse {
	...
	@Override
	public ModifyExposureSettingsResponse getInstance(UnmarshallerContext context) {
		return	ModifyExposureSettingsResponseUnmarshaller.unmarshall(this, context);
	}
