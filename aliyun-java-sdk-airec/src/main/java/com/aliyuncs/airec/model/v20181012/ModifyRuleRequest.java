 ...
 * @version 
 */
public class ModifyRuleRequest extends RoaAcsRequest<ModifyRuleResponse> {
	...
	public ModifyRuleRequest() {
		super("Airec", "2018-10-12", "ModifyRule", "airec");
		setUriPattern("/openapi/instances/[InstanceId]/rules/[RuleId]");
