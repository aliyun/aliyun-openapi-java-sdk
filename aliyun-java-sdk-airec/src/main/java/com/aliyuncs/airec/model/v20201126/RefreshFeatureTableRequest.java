 ...
 * @version 
 */
public class RefreshFeatureTableRequest extends RoaAcsRequest<RefreshFeatureTableResponse> {
	...
	private String type;
	public RefreshFeatureTableRequest() {
		super("Airec", "2020-11-26", "RefreshFeatureTable", "airec");
		setUriPattern("/v2/openapi/instances/[instanceId]/feature-tables/[type]/[featureTableId]/actions/refresh");
	...
	@Override
	public Class<RefreshFeatureTableResponse> getResponseClass() {
