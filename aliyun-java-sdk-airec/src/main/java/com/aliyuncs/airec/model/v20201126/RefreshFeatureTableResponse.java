...
import com.aliyuncs.airec.transform.v20201126.RefreshFeatureTableResponseUnmarshaller;
 ...
 * @version 
 */
public class RefreshFeatureTableResponse extends AcsResponse {
	...
	@Override
	public RefreshFeatureTableResponse getInstance(UnmarshallerContext context) {
		return	RefreshFeatureTableResponseUnmarshaller.unmarshall(this, context);
	}
