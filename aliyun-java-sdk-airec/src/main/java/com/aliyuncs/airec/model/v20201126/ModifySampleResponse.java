...
import com.aliyuncs.airec.transform.v20201126.ModifySampleResponseUnmarshaller;
 ...
 * @version 
 */
public class ModifySampleResponse extends AcsResponse {
	...
	@Override
	public ModifySampleResponse getInstance(UnmarshallerContext context) {
		return	ModifySampleResponseUnmarshaller.unmarshall(this, context);
	}
