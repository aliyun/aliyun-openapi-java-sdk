 ...
 * @version 
 */
public class ModifyKnowledgeRequest extends RpcAcsRequest<ModifyKnowledgeResponse> {
	...
	public ModifyKnowledgeRequest() {
		super("VoiceNavigator", "2018-06-12", "ModifyKnowledge", "voicebot");
	...
	@Override
	public Class<ModifyKnowledgeResponse> getResponseClass() {
		return ModifyKnowledgeResponse.class;
	}
