...
public class ListChatbotInstancesRequest extends RpcAcsRequest<ListChatbotInstancesResponse> {
	...
	public ListChatbotInstancesRequest() {
		super("VoiceNavigator", "2018-06-12", "ListChatbotInstances", "voicebot");
	...
	@Override
	public Class<ListChatbotInstancesResponse> getResponseClass() {
		return ListChatbotInstancesResponse.class;
	}
