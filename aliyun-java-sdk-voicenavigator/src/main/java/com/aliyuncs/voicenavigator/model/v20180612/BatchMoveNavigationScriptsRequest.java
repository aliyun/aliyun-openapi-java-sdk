 ...
 * @version 
 */
public class BatchMoveNavigationScriptsRequest extends RpcAcsRequest<BatchMoveNavigationScriptsResponse> {
	...
	public BatchMoveNavigationScriptsRequest() {
		super("VoiceNavigator", "2018-06-12", "BatchMoveNavigationScripts", "voicebot");
	...
	@Override
	public Class<BatchMoveNavigationScriptsResponse> getResponseClass() {
		return BatchMoveNavigationScriptsResponse.class;
	}
