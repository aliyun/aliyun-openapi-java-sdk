 ...
 * @version 
 */
public class CollectedNumberRequest extends RpcAcsRequest<CollectedNumberResponse> {
	...
	@Override
	public Class<CollectedNumberResponse> getResponseClass() {
		return CollectedNumberResponse.class;
	}
