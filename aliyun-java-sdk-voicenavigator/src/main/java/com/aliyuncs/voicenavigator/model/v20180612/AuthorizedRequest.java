 ...
 * @version 
 */
public class AuthorizedRequest extends RpcAcsRequest<AuthorizedResponse> {
	...
	public AuthorizedRequest() {
		super("VoiceNavigator", "2018-06-12", "Authorized", "voicebot");
	...
	@Override
	public Class<AuthorizedResponse> getResponseClass() {
		return AuthorizedResponse.class;
	}
