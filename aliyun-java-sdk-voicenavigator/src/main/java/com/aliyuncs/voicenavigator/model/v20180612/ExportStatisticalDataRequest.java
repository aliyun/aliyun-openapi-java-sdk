 ...
 * @version 
 */
public class ExportStatisticalDataRequest extends RpcAcsRequest<ExportStatisticalDataResponse> {
	...
	public ExportStatisticalDataRequest() {
		super("VoiceNavigator", "2018-06-12", "ExportStatisticalData", "voicebot");
	...
	@Override
	public Class<ExportStatisticalDataResponse> getResponseClass() {
		return ExportStatisticalDataResponse.class;
	}
