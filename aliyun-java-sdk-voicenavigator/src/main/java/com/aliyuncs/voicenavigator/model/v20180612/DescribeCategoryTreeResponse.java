...
import com.aliyuncs.voicenavigator.transform.v20180612.DescribeCategoryTreeResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeCategoryTreeResponse extends AcsResponse {
	...
	@Override
	public DescribeCategoryTreeResponse getInstance(UnmarshallerContext context) {
		return	DescribeCategoryTreeResponseUnmarshaller.unmarshall(this, context);
	}
