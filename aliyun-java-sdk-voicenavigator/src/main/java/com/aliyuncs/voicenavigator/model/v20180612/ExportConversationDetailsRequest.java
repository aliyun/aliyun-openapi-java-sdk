 ...
 * @version 
 */
public class ExportConversationDetailsRequest extends RpcAcsRequest<ExportConversationDetailsResponse> {
	...
	@Override
	public Class<ExportConversationDetailsResponse> getResponseClass() {
		return ExportConversationDetailsResponse.class;
	}
