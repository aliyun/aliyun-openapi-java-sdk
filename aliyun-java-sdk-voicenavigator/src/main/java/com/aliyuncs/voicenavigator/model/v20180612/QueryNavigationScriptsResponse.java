...
public class QueryNavigationScriptsResponse extends AcsResponse {
	...
	@Override
	public QueryNavigationScriptsResponse getInstance(UnmarshallerContext context) {
		return	QueryNavigationScriptsResponseUnmarshaller.unmarshall(this, context);
	}
