 ...
 * @version 
 */
public class DeleteNavigationScriptRequest extends RpcAcsRequest<DeleteNavigationScriptResponse> {
	   

	private String instanceId;

	private String navigationScriptId;
	public DeleteNavigationScriptRequest() {
		super("VoiceNavigator", "2018-06-12", "DeleteNavigationScript", "voicebot");
	...
	@Override
	public Class<DeleteNavigationScriptResponse> getResponseClass() {
		return DeleteNavigationScriptResponse.class;
	}
