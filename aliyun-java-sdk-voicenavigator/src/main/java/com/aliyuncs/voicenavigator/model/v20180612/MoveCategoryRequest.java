 ...
 * @version 
 */
public class MoveCategoryRequest extends RpcAcsRequest<MoveCategoryResponse> {
	...
	public MoveCategoryRequest() {
		super("VoiceNavigator", "2018-06-12", "MoveCategory", "voicebot");
	...
	@Override
	public Class<MoveCategoryResponse> getResponseClass() {
		return MoveCategoryResponse.class;
	}
