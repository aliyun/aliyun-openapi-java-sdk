 ...
 * @version 
 */
public class CreateMergeRequestCommentRequest extends RoaAcsRequest<CreateMergeRequestCommentResponse> {
	...
	public CreateMergeRequestCommentRequest() {
		super("codeup", "2020-04-14", "CreateMergeRequestComment");
	...
	@Override
	public Class<CreateMergeRequestCommentResponse> getResponseClass() {
		return CreateMergeRequestCommentResponse.class;
	}
