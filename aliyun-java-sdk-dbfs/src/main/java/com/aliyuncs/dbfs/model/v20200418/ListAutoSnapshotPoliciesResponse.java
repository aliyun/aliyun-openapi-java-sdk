...
import com.aliyuncs.dbfs.transform.v20200418.ListAutoSnapshotPoliciesResponseUnmarshaller;
 ...
 * @version 
 */
public class ListAutoSnapshotPoliciesResponse extends AcsResponse {
	...
	private List<SnapshotPoliciesItem> snapshotPolicies;
	...
	public List<SnapshotPoliciesItem> getSnapshotPolicies() {
		return this.snapshotPolicies;
	}

	public void setSnapshotPolicies(List<SnapshotPoliciesItem> snapshotPolicies) {
		this.snapshotPolicies = snapshotPolicies;
	}

	public static class SnapshotPoliciesItem {
	...
	@Override
	public ListAutoSnapshotPoliciesResponse getInstance(UnmarshallerContext context) {
		return	ListAutoSnapshotPoliciesResponseUnmarshaller.unmarshall(this, context);
	}
