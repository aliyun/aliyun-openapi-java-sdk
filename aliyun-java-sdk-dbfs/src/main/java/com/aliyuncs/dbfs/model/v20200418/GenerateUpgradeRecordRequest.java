 ...
 * @version 
 */
public class GenerateUpgradeRecordRequest extends RpcAcsRequest<GenerateUpgradeRecordResponse> {
	...
	public GenerateUpgradeRecordRequest() {
		super("DBFS", "2020-04-18", "GenerateUpgradeRecord");
	...
	@Override
	public Class<GenerateUpgradeRecordResponse> getResponseClass() {
		return GenerateUpgradeRecordResponse.class;
	}
