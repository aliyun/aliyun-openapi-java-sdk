 ...
 * @version 
 */
public class AddTagsBatchRequest extends RpcAcsRequest<AddTagsBatchResponse> {
	...
	@Override
	public Class<AddTagsBatchResponse> getResponseClass() {
		return AddTagsBatchResponse.class;
	}
