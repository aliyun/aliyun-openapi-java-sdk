 ...
 * @version 
 */
public class UpdateConstantsRequest extends RpcAcsRequest<UpdateConstantsResponse> {
	...
	public UpdateConstantsRequest() {
		super("DBFS", "2020-04-18", "UpdateConstants");
	...
	@Override
	public Class<UpdateConstantsResponse> getResponseClass() {
		return UpdateConstantsResponse.class;
	}
