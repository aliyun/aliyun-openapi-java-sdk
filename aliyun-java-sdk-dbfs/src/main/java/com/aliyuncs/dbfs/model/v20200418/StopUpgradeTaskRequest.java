 ...
 * @version 
 */
public class StopUpgradeTaskRequest extends RpcAcsRequest<StopUpgradeTaskResponse> {
	...
	public StopUpgradeTaskRequest() {
		super("DBFS", "2020-04-18", "StopUpgradeTask");
	...
	@Override
	public Class<StopUpgradeTaskResponse> getResponseClass() {
		return StopUpgradeTaskResponse.class;
	}
