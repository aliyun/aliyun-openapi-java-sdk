 ...
 * @version 
 */
public class ListConstantsRequest extends RpcAcsRequest<ListConstantsResponse> {
	...
	public ListConstantsRequest() {
		super("DBFS", "2020-04-18", "ListConstants");
	...
	@Override
	public Class<ListConstantsResponse> getResponseClass() {
		return ListConstantsResponse.class;
	}
