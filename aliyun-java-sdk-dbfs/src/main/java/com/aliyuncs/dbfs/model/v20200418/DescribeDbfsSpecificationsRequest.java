 ...
 * @version 
 */
public class DescribeDbfsSpecificationsRequest extends RpcAcsRequest<DescribeDbfsSpecificationsResponse> {
	...
	public void setEcsInstanceType(String ecsInstanceType) {
		...
		if(ecsInstanceType != null){
			putQueryParameter("EcsInstanceType", ecsInstanceType);
		}
	}
	...
	@Override
	public Class<DescribeDbfsSpecificationsResponse> getResponseClass() {
		return DescribeDbfsSpecificationsResponse.class;
	}
