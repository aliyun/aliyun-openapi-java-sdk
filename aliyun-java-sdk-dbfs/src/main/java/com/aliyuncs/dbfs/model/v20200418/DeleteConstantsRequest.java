 ...
 * @version 
 */
public class DeleteConstantsRequest extends RpcAcsRequest<DeleteConstantsResponse> {
	...
	public DeleteConstantsRequest() {
		super("DBFS", "2020-04-18", "DeleteConstants");
	...
	@Override
	public Class<DeleteConstantsResponse> getResponseClass() {
		return DeleteConstantsResponse.class;
	}
