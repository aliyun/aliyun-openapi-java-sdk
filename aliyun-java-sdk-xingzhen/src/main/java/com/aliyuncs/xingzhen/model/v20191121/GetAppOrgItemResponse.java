...
import com.aliyuncs.xingzhen.transform.v20191121.GetAppOrgItemResponseUnmarshaller;
 ...
 * @version 
 */
public class GetAppOrgItemResponse extends AcsResponse {
	...
	@Override
	public GetAppOrgItemResponse getInstance(UnmarshallerContext context) {
		return	GetAppOrgItemResponseUnmarshaller.unmarshall(this, context);
	}
