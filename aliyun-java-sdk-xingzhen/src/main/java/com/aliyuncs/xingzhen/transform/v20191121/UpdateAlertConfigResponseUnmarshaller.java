...
import com.aliyuncs.xingzhen.model.v20191121.UpdateAlertConfigResponse;
...
public class UpdateAlertConfigResponseUnmarshaller {
	...
	public static UpdateAlertConfigResponse unmarshall(UpdateAlertConfigResponse updateAlertConfigResponse, UnmarshallerContext _ctx) {
		...
		updateAlertConfigResponse.setSuccess(_ctx.stringValue("UpdateAlertConfigResponse.Success"));
		...
		updateAlertConfigResponse.setData(_ctx.booleanValue("UpdateAlertConfigResponse.Data"));
