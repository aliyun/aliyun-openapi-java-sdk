 ...
 * @version 
 */
public class DescribeDataFlowsRequest extends RpcAcsRequest<DescribeDataFlowsResponse> {
	...
	@Override
	public Class<DescribeDataFlowsResponse> getResponseClass() {
		return DescribeDataFlowsResponse.class;
	}
