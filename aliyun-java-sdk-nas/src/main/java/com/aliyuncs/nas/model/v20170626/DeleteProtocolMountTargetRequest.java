 ...
 * @version 
 */
public class DeleteProtocolMountTargetRequest extends RpcAcsRequest<DeleteProtocolMountTargetResponse> {
	...
	@Override
	public Class<DeleteProtocolMountTargetResponse> getResponseClass() {
		return DeleteProtocolMountTargetResponse.class;
	}
