 ...
 * @version 
 */
public class DescribeDataFlowSubTasksRequest extends RpcAcsRequest<DescribeDataFlowSubTasksResponse> {
	...
	public DescribeDataFlowSubTasksRequest() {
		super("NAS", "2017-06-26", "DescribeDataFlowSubTasks", "nas");
	...
	@Override
	public Class<DescribeDataFlowSubTasksResponse> getResponseClass() {
		return DescribeDataFlowSubTasksResponse.class;
	}
