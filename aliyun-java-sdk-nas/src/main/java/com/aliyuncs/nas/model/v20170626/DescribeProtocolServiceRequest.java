 ...
 * @version 
 */
public class DescribeProtocolServiceRequest extends RpcAcsRequest<DescribeProtocolServiceResponse> {
	...
	@Override
	public Class<DescribeProtocolServiceResponse> getResponseClass() {
		return DescribeProtocolServiceResponse.class;
	}
