 ...
 * @version 
 */
public class DescribeAgenticSpacesRequest extends RpcAcsRequest<DescribeAgenticSpacesResponse> {
	...
	public DescribeAgenticSpacesRequest() {
		super("NAS", "2017-06-26", "DescribeAgenticSpaces", "nas");
	...
	@Override
	public Class<DescribeAgenticSpacesResponse> getResponseClass() {
		return DescribeAgenticSpacesResponse.class;
	}
