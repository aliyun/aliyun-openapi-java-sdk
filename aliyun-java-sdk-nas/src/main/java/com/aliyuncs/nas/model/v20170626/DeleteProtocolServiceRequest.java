 ...
 * @version 
 */
public class DeleteProtocolServiceRequest extends RpcAcsRequest<DeleteProtocolServiceResponse> {
	...
	@Override
	public Class<DeleteProtocolServiceResponse> getResponseClass() {
		return DeleteProtocolServiceResponse.class;
	}
