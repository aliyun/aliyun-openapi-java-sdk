 ...
 * @version 
 */
public class ModifyLifecyclePolicyRequest extends RpcAcsRequest<ModifyLifecyclePolicyResponse> {
	...
	public ModifyLifecyclePolicyRequest() {
		super("NAS", "2017-06-26", "ModifyLifecyclePolicy");
	...
	@Override
	public Class<ModifyLifecyclePolicyResponse> getResponseClass() {
		return ModifyLifecyclePolicyResponse.class;
	}
