 ...
 * @version 
 */
public class ModifyDataFlowAutoRefreshRequest extends RpcAcsRequest<ModifyDataFlowAutoRefreshResponse> {
	...
	public ModifyDataFlowAutoRefreshRequest() {
		super("NAS", "2017-06-26", "ModifyDataFlowAutoRefresh", "NAS");
	...
	@Override
	public Class<ModifyDataFlowAutoRefreshResponse> getResponseClass() {
		return ModifyDataFlowAutoRefreshResponse.class;
	}
