 ...
 * @version 
 */
public class DescribeStoragePackagesRequest extends RpcAcsRequest<DescribeStoragePackagesResponse> {
	...
	@Override
	public Class<DescribeStoragePackagesResponse> getResponseClass() {
		return DescribeStoragePackagesResponse.class;
	}
