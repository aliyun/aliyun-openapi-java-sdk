 ...
 * @version 
 */
public class EnableRecycleBinRequest extends RpcAcsRequest<EnableRecycleBinResponse> {
	...
	public EnableRecycleBinRequest() {
		super("NAS", "2017-06-26", "EnableRecycleBin");
	...
	@Override
	public Class<EnableRecycleBinResponse> getResponseClass() {
		return EnableRecycleBinResponse.class;
	}
