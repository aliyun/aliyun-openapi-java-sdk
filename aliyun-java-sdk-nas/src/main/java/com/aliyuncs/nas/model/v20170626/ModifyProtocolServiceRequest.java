 ...
 * @version 
 */
public class ModifyProtocolServiceRequest extends RpcAcsRequest<ModifyProtocolServiceResponse> {
	...
	public ModifyProtocolServiceRequest() {
		super("NAS", "2017-06-26", "ModifyProtocolService", "nas");
	...
	@Override
	public Class<ModifyProtocolServiceResponse> getResponseClass() {
		return ModifyProtocolServiceResponse.class;
	}
