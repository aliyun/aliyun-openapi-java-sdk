 ...
 * @version 
 */
public class SetAgenticSpaceQuotaRequest extends RpcAcsRequest<SetAgenticSpaceQuotaResponse> {
	...
	public SetAgenticSpaceQuotaRequest() {
		super("NAS", "2017-06-26", "SetAgenticSpaceQuota", "nas");
	...
	@Override
	public Class<SetAgenticSpaceQuotaResponse> getResponseClass() {
		return SetAgenticSpaceQuotaResponse.class;
	}
