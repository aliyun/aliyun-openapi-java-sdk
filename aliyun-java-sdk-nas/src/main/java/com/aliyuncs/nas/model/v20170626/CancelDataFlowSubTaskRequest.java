 ...
 * @version 
 */
public class CancelDataFlowSubTaskRequest extends RpcAcsRequest<CancelDataFlowSubTaskResponse> {
	...
	public CancelDataFlowSubTaskRequest() {
		super("NAS", "2017-06-26", "CancelDataFlowSubTask", "nas");
	...
	public void setDataFlowSubTaskId(String dataFlowSubTaskId) {
		...
		if(dataFlowSubTaskId != null){
			putQueryParameter("DataFlowSubTaskId", dataFlowSubTaskId);
		}
	}
	...
	@Override
	public Class<CancelDataFlowSubTaskResponse> getResponseClass() {
		return CancelDataFlowSubTaskResponse.class;
	}
