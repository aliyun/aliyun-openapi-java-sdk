...
import com.aliyuncs.nas.transform.v20170626.GetProtocolMountTargetResponseUnmarshaller;
 ...
 * @version 
 */
public class GetProtocolMountTargetResponse extends AcsResponse {
	...
	public void setProtocolMountTarget(ProtocolMountTarget protocolMountTarget) {
	...
	@Override
	public GetProtocolMountTargetResponse getInstance(UnmarshallerContext context) {
		return	GetProtocolMountTargetResponseUnmarshaller.unmarshall(this, context);
	}
