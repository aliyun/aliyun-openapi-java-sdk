 ...
 * @version 
 */
public class GetAgenticSpaceRequest extends RpcAcsRequest<GetAgenticSpaceResponse> {
	   

	private String fileSystemId;

	private String agenticSpaceId;
	public GetAgenticSpaceRequest() {
		super("NAS", "2017-06-26", "GetAgenticSpace", "nas");
	...
	@Override
	public Class<GetAgenticSpaceResponse> getResponseClass() {
		return GetAgenticSpaceResponse.class;
	}
