 ...
 * @version 
 */
public class CreateAgenticSpaceRequest extends RpcAcsRequest<CreateAgenticSpaceResponse> {
	...
	public CreateAgenticSpaceRequest() {
		super("NAS", "2017-06-26", "CreateAgenticSpace", "nas");
	...
	@Override
	public Class<CreateAgenticSpaceResponse> getResponseClass() {
		return CreateAgenticSpaceResponse.class;
	}
