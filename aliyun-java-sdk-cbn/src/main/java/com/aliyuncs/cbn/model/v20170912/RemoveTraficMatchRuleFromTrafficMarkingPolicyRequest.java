 ...
 * @version 
 */
public class RemoveTraficMatchRuleFromTrafficMarkingPolicyRequest extends RpcAcsRequest<RemoveTraficMatchRuleFromTrafficMarkingPolicyResponse> {
	...
	@Override
	public Class<RemoveTraficMatchRuleFromTrafficMarkingPolicyResponse> getResponseClass() {
		return RemoveTraficMatchRuleFromTrafficMarkingPolicyResponse.class;
	}
