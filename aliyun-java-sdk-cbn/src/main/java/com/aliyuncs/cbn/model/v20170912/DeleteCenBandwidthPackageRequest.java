...
public class DeleteCenBandwidthPackageRequest extends RpcAcsRequest<DeleteCenBandwidthPackageResponse> {
	...
	public DeleteCenBandwidthPackageRequest() {
		super("Cbn", "2017-09-12", "DeleteCenBandwidthPackage");
	...
	@Override
	public Class<DeleteCenBandwidthPackageResponse> getResponseClass() {
		return DeleteCenBandwidthPackageResponse.class;
	}
