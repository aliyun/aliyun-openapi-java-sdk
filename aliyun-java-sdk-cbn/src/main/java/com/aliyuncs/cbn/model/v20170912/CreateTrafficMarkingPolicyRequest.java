 ...
 * @version 
 */
public class CreateTrafficMarkingPolicyRequest extends RpcAcsRequest<CreateTrafficMarkingPolicyResponse> {
	...
	@Override
	public Class<CreateTrafficMarkingPolicyResponse> getResponseClass() {
