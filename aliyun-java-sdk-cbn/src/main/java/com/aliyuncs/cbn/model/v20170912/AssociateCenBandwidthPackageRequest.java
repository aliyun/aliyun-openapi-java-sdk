...
public class AssociateCenBandwidthPackageRequest extends RpcAcsRequest<AssociateCenBandwidthPackageResponse> {
	...
	public AssociateCenBandwidthPackageRequest() {
		super("Cbn", "2017-09-12", "AssociateCenBandwidthPackage");
	...
	@Override
	public Class<AssociateCenBandwidthPackageResponse> getResponseClass() {
		return AssociateCenBandwidthPackageResponse.class;
	}
