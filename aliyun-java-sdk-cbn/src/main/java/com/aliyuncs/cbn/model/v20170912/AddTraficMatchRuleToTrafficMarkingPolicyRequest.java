 ...
 * @version 
 */
public class AddTraficMatchRuleToTrafficMarkingPolicyRequest extends RpcAcsRequest<AddTraficMatchRuleToTrafficMarkingPolicyResponse> {
	...
	public AddTraficMatchRuleToTrafficMarkingPolicyRequest() {
		super("Cbn", "2017-09-12", "AddTraficMatchRuleToTrafficMarkingPolicy", "cbn");
	...
	@Override
	public Class<AddTraficMatchRuleToTrafficMarkingPolicyResponse> getResponseClass() {
		return AddTraficMatchRuleToTrafficMarkingPolicyResponse.class;
	}
