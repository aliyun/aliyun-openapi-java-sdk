 ...
 * @version 
 */
public class CreateTransitRouterEcrAttachmentRequest extends RpcAcsRequest<CreateTransitRouterEcrAttachmentResponse> {
	...
	public CreateTransitRouterEcrAttachmentRequest() {
		super("Cbn", "2017-09-12", "CreateTransitRouterEcrAttachment", "cbn");
	...
	public void setEcrOwnerId(Long ecrOwnerId) {
		...
		if(ecrOwnerId != null){
			putQueryParameter("EcrOwnerId", ecrOwnerId.toString());
		}
	}
	...
	@Override
	public Class<CreateTransitRouterEcrAttachmentResponse> getResponseClass() {
		return CreateTransitRouterEcrAttachmentResponse.class;
	}
