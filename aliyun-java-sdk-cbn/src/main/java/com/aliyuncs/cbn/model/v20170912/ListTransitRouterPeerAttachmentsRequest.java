 ...
 * @version 
 */
public class ListTransitRouterPeerAttachmentsRequest extends RpcAcsRequest<ListTransitRouterPeerAttachmentsResponse> {
	...
	@Override
	public Class<ListTransitRouterPeerAttachmentsResponse> getResponseClass() {
