 ...
 * @version 
 */
public class CreateTransitRouterRouteEntryRequest extends RpcAcsRequest<CreateTransitRouterRouteEntryResponse> {
	...
	public CreateTransitRouterRouteEntryRequest() {
		super("Cbn", "2017-09-12", "CreateTransitRouterRouteEntry", "cbn");
	...
	@Override
	public Class<CreateTransitRouterRouteEntryResponse> getResponseClass() {
		return CreateTransitRouterRouteEntryResponse.class;
	}
