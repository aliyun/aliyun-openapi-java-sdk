...
import com.aliyuncs.cbn.transform.v20170912.CreateCenBandwidthPackageResponseUnmarshaller;
...
public class CreateCenBandwidthPackageResponse extends AcsResponse {
	...
	@Override
	public CreateCenBandwidthPackageResponse getInstance(UnmarshallerContext context) {
		return	CreateCenBandwidthPackageResponseUnmarshaller.unmarshall(this, context);
	}
}
