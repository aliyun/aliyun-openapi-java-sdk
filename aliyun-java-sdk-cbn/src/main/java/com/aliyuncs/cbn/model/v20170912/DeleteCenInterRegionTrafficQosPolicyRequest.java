 ...
 * @version 
 */
public class DeleteCenInterRegionTrafficQosPolicyRequest extends RpcAcsRequest<DeleteCenInterRegionTrafficQosPolicyResponse> {
	...
	@Override
	public Class<DeleteCenInterRegionTrafficQosPolicyResponse> getResponseClass() {
		return DeleteCenInterRegionTrafficQosPolicyResponse.class;
	}
