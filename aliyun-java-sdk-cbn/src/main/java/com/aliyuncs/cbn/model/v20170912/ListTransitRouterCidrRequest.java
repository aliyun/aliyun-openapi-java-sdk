 ...
 * @version 
 */
public class ListTransitRouterCidrRequest extends RpcAcsRequest<ListTransitRouterCidrResponse> {
	...
	@Override
	public Class<ListTransitRouterCidrResponse> getResponseClass() {
		return ListTransitRouterCidrResponse.class;
	}
