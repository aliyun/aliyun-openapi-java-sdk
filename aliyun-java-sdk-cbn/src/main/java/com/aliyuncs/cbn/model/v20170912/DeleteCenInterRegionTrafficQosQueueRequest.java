 ...
 * @version 
 */
public class DeleteCenInterRegionTrafficQosQueueRequest extends RpcAcsRequest<DeleteCenInterRegionTrafficQosQueueResponse> {
	...
	@Override
	public Class<DeleteCenInterRegionTrafficQosQueueResponse> getResponseClass() {
		return DeleteCenInterRegionTrafficQosQueueResponse.class;
	}
