 ...
 * @version 
 */
public class RevokeInstanceFromTransitRouterRequest extends RpcAcsRequest<RevokeInstanceFromTransitRouterResponse> {
	...
	@Override
	public Class<RevokeInstanceFromTransitRouterResponse> getResponseClass() {
