 ...
 * @version 
 */
public class CreateTransitRouterRouteTableRequest extends RpcAcsRequest<CreateTransitRouterRouteTableResponse> {
	...
	@Override
	public Class<CreateTransitRouterRouteTableResponse> getResponseClass() {
		return CreateTransitRouterRouteTableResponse.class;
	}
