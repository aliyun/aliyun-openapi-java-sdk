 ...
 * @version 
 */
public class RefreshTransitRouteTableAggregationRequest extends RpcAcsRequest<RefreshTransitRouteTableAggregationResponse> {
	...
	@Override
	public Class<RefreshTransitRouteTableAggregationResponse> getResponseClass() {
		return RefreshTransitRouteTableAggregationResponse.class;
	}
