 ...
 * @version 
 */
public class ListTransitRouterVbrAttachmentsRequest extends RpcAcsRequest<ListTransitRouterVbrAttachmentsResponse> {
	...
	@Override
	public Class<ListTransitRouterVbrAttachmentsResponse> getResponseClass() {
		return ListTransitRouterVbrAttachmentsResponse.class;
	}
