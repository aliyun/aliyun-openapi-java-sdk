 ...
 * @version 
 */
public class DeleteCenChildInstanceRouteEntryToCenRequest extends RpcAcsRequest<DeleteCenChildInstanceRouteEntryToCenResponse> {
	...
	@Override
	public Class<DeleteCenChildInstanceRouteEntryToCenResponse> getResponseClass() {
		return DeleteCenChildInstanceRouteEntryToCenResponse.class;
	}
