...
import com.aliyuncs.ledgerdb.transform.v20191122.DescribeLedgersResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeLedgersResponse extends AcsResponse {
	...
	@Override
	public DescribeLedgersResponse getInstance(UnmarshallerContext context) {
		return	DescribeLedgersResponseUnmarshaller.unmarshall(this, context);
	}
