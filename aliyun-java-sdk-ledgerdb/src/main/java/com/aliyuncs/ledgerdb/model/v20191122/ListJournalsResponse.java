...
import com.aliyuncs.ledgerdb.transform.v20191122.ListJournalsResponseUnmarshaller;
 ...
 * @version 
 */
public class ListJournalsResponse extends AcsResponse {
	...
	@Override
	public ListJournalsResponse getInstance(UnmarshallerContext context) {
		return	ListJournalsResponseUnmarshaller.unmarshall(this, context);
	}
