...
import com.aliyuncs.ledgerdb.transform.v20191122.DescribeRegionsResponseUnmarshaller;
...
public class DescribeRegionsResponse extends AcsResponse {
	...
	public List<Result> getRegions() {
		return this.regions;
	}

	public void setRegions(List<Result> regions) {
