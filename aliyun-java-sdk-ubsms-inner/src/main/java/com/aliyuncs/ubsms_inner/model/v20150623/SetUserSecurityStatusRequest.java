 ...
 * @version 
 */
public class SetUserSecurityStatusRequest extends RpcAcsRequest<SetUserSecurityStatusResponse> {
	
	public SetUserSecurityStatusRequest() {
		super("Ubsms-inner", "2015-06-23", "SetUserSecurityStatus");
	}
	...
	@Override
	public Class<SetUserSecurityStatusResponse> getResponseClass() {
		return SetUserSecurityStatusResponse.class;
	}
