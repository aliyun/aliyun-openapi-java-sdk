 ...
 * @version 
 */
public class LogicalDeleteResourceActionRequest extends RpcAcsRequest<LogicalDeleteResourceActionResponse> {
	...
	public LogicalDeleteResourceActionRequest() {
		super("savingplan", "2020-07-15", "LogicalDeleteResourceAction", "savingplan");
	...
	@Override
	public Class<LogicalDeleteResourceActionResponse> getResponseClass() {
		return LogicalDeleteResourceActionResponse.class;
	}
