 ...
 * @version 
 */
public class PhysicalDeleteResourceActionRequest extends RpcAcsRequest<PhysicalDeleteResourceActionResponse> {
	...
	public PhysicalDeleteResourceActionRequest() {
		super("savingplan", "2020-07-15", "PhysicalDeleteResourceAction", "savingplan");
	...
	@Override
	public Class<PhysicalDeleteResourceActionResponse> getResponseClass() {
		return PhysicalDeleteResourceActionResponse.class;
	}
