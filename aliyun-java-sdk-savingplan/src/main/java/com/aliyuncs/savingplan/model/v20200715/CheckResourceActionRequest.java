 ...
 * @version 
 */
public class CheckResourceActionRequest extends RpcAcsRequest<CheckResourceActionResponse> {
	...
	public CheckResourceActionRequest() {
		super("savingplan", "2020-07-15", "CheckResourceAction", "savingplan");
	...
	@Override
	public Class<CheckResourceActionResponse> getResponseClass() {
		return CheckResourceActionResponse.class;
	}
