 ...
 * @version 
 */
public class InsertDevopsUserRequest extends RpcAcsRequest<InsertDevopsUserResponse> {
	...
	@Override
	public Class<InsertDevopsUserResponse> getResponseClass() {
		return InsertDevopsUserResponse.class;
	}
