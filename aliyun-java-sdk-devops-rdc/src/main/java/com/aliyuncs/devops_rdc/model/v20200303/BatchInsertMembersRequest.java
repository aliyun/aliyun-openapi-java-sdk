 ...
 * @version 
 */
public class BatchInsertMembersRequest extends RpcAcsRequest<BatchInsertMembersResponse> {
	...
	@Override
	public Class<BatchInsertMembersResponse> getResponseClass() {
		return BatchInsertMembersResponse.class;
	}
