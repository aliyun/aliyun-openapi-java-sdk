 ...
 * @version 
 */
public class CreateDevopsProjectTaskRequest extends RpcAcsRequest<CreateDevopsProjectTaskResponse> {
	...
	@Override
	public Class<CreateDevopsProjectTaskResponse> getResponseClass() {
		return CreateDevopsProjectTaskResponse.class;
	}
