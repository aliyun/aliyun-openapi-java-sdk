 ...
 * @version 
 */
public class UpdateDevopsProjectTaskRequest extends RpcAcsRequest<UpdateDevopsProjectTaskResponse> {
	...
	public UpdateDevopsProjectTaskRequest() {
		super("devops-rdc", "2020-03-03", "UpdateDevopsProjectTask", "1.9.6");
	...
	@Override
	public Class<UpdateDevopsProjectTaskResponse> getResponseClass() {
		return UpdateDevopsProjectTaskResponse.class;
	}
