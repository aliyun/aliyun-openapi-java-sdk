 ...
 * @version 
 */
public class CreateCommonGroupRequest extends RpcAcsRequest<CreateCommonGroupResponse> {
	...
	@Override
	public Class<CreateCommonGroupResponse> getResponseClass() {
		return CreateCommonGroupResponse.class;
	}
