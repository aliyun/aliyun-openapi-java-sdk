 ...
 * @version 
 */
public class InsertPipelineMemberRequest extends RpcAcsRequest<InsertPipelineMemberResponse> {
	...
	@Override
	public Class<InsertPipelineMemberResponse> getResponseClass() {
		return InsertPipelineMemberResponse.class;
	}
