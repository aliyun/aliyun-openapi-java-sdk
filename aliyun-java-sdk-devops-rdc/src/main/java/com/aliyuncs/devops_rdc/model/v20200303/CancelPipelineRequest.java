 ...
 * @version 
 */
public class CancelPipelineRequest extends RpcAcsRequest<CancelPipelineResponse> {
	...
	@Override
	public Class<CancelPipelineResponse> getResponseClass() {
		return CancelPipelineResponse.class;
	}
