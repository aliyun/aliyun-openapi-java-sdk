...
import com.aliyuncs.cc5g.model.v20220314.ListDiagnoseInfoForSingleCardResponse;
import com.aliyuncs.cc5g.model.v20220314.ListDiagnoseInfoForSingleCardResponse.DiagnoseInfoItem;
...
public class ListDiagnoseInfoForSingleCardResponseUnmarshaller {
	...
	public static ListDiagnoseInfoForSingleCardResponse unmarshall(ListDiagnoseInfoForSingleCardResponse listDiagnoseInfoForSingleCardResponse, UnmarshallerContext _ctx) {
		...
		for (int i = 0; i < _ctx.lengthValue("ListDiagnoseInfoForSingleCardResponse.DiagnoseInfo.Length"); i++) {
			...
			diagnoseInfoItem.setWirelessCloudConnectorId(_ctx.stringValue("ListDiagnoseInfoForSingleCardResponse.DiagnoseInfo["+ i +"].WirelessCloudConnectorId"));
			...
			diagnoseInfoItem.setDiagnoseTaskId(_ctx.stringValue("ListDiagnoseInfoForSingleCardResponse.DiagnoseInfo["+ i +"].DiagnoseTaskId"));
