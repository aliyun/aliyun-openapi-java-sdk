 ...
 * @version 
 */
public class RevokeNetLinkRequest extends RpcAcsRequest<RevokeNetLinkResponse> {
	...
	public RevokeNetLinkRequest() {
		super("CC5G", "2022-03-14", "RevokeNetLink", "fivegcc");
	...
	@Override
	public Class<RevokeNetLinkResponse> getResponseClass() {
		return RevokeNetLinkResponse.class;
	}
