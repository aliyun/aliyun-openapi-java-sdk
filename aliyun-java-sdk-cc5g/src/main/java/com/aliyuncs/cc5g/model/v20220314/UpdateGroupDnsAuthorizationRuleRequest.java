 ...
 * @version 
 */
public class UpdateGroupDnsAuthorizationRuleRequest extends RpcAcsRequest<UpdateGroupDnsAuthorizationRuleResponse> {
	...
	private String name;
	public UpdateGroupDnsAuthorizationRuleRequest() {
		super("CC5G", "2022-03-14", "UpdateGroupDnsAuthorizationRule", "fivegcc");
	...
	@Override
	public Class<UpdateGroupDnsAuthorizationRuleResponse> getResponseClass() {
