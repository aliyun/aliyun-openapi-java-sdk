 ...
 * @version 
 */
public class GrantNetLinkRequest extends RpcAcsRequest<GrantNetLinkResponse> {
	...
	public GrantNetLinkRequest() {
		super("CC5G", "2022-03-14", "GrantNetLink", "fivegcc");
	...
	public void setGrantAliUid(Long grantAliUid) {
		this.grantAliUid = grantAliUid;
		if(grantAliUid != null){
			putQueryParameter("GrantAliUid", grantAliUid.toString());
		}
	}
	...
	@Override
	public Class<GrantNetLinkResponse> getResponseClass() {
		return GrantNetLinkResponse.class;
	}
