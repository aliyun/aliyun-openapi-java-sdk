 ...
 * @version 
 */
public class ListCardDayUsagesRequest extends RpcAcsRequest<ListCardDayUsagesResponse> {
	...
	public ListCardDayUsagesRequest() {
		super("CC5G", "2022-03-14", "ListCardDayUsages", "fivegcc");
	...
	public void setLatestMonthNum(Integer latestMonthNum) {
		this.latestMonthNum = latestMonthNum;
		if(latestMonthNum != null){
			putQueryParameter("LatestMonthNum", latestMonthNum.toString());
		}
	}
	...
	@Override
	public Class<ListCardDayUsagesResponse> getResponseClass() {
		return ListCardDayUsagesResponse.class;
	}
