 ...
 * @version 
 */
public class LockCardsRequest extends RpcAcsRequest<LockCardsResponse> {
	...
	public LockCardsRequest() {
		super("CC5G", "2022-03-14", "LockCards", "fivegcc");
	...
	@Override
	public Class<LockCardsResponse> getResponseClass() {
