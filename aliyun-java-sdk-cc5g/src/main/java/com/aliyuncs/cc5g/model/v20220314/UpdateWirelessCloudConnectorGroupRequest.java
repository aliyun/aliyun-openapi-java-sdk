 ...
 * @version 
 */
public class UpdateWirelessCloudConnectorGroupRequest extends RpcAcsRequest<UpdateWirelessCloudConnectorGroupResponse> {
	...
	private String name;
	public UpdateWirelessCloudConnectorGroupRequest() {
		super("CC5G", "2022-03-14", "UpdateWirelessCloudConnectorGroup", "fivegcc");
	...
	@Override
	public Class<UpdateWirelessCloudConnectorGroupResponse> getResponseClass() {
		return UpdateWirelessCloudConnectorGroupResponse.class;
	}
