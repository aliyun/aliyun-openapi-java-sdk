 ...
 * @version 
 */
public class RemoveWirelessCloudConnectorFromGroupRequest extends RpcAcsRequest<RemoveWirelessCloudConnectorFromGroupResponse> {
	...
	public RemoveWirelessCloudConnectorFromGroupRequest() {
		super("CC5G", "2022-03-14", "RemoveWirelessCloudConnectorFromGroup", "fivegcc");
	...
	@Override
	public Class<RemoveWirelessCloudConnectorFromGroupResponse> getResponseClass() {
		return RemoveWirelessCloudConnectorFromGroupResponse.class;
	}
