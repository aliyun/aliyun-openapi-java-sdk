 ...
 * @version 
 */
public class FailCardsRequest extends RpcAcsRequest<FailCardsResponse> {
	...
	public FailCardsRequest() {
		super("CC5G", "2022-03-14", "FailCards", "fivegcc");
	...
	@Override
	public Class<FailCardsResponse> getResponseClass() {
		return FailCardsResponse.class;
	}
