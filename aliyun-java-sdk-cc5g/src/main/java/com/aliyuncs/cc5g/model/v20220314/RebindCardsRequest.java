 ...
 * @version 
 */
public class RebindCardsRequest extends RpcAcsRequest<RebindCardsResponse> {
	...
	public RebindCardsRequest() {
		super("CC5G", "2022-03-14", "RebindCards", "fivegcc");
	...
	@Override
	public Class<RebindCardsResponse> getResponseClass() {
		return RebindCardsResponse.class;
	}
