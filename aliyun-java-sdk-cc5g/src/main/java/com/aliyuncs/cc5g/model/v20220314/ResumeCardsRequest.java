 ...
 * @version 
 */
public class ResumeCardsRequest extends RpcAcsRequest<ResumeCardsResponse> {
	...
	public ResumeCardsRequest() {
		super("CC5G", "2022-03-14", "ResumeCards", "fivegcc");
	...
	@Override
	public Class<ResumeCardsResponse> getResponseClass() {
		return ResumeCardsResponse.class;
	}
