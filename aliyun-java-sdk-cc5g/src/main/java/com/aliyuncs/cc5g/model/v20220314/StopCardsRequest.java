 ...
 * @version 
 */
public class StopCardsRequest extends RpcAcsRequest<StopCardsResponse> {
	...
	public StopCardsRequest() {
		super("CC5G", "2022-03-14", "StopCards", "fivegcc");
	...
	@Override
	public Class<StopCardsResponse> getResponseClass() {
		return StopCardsResponse.class;
	}
