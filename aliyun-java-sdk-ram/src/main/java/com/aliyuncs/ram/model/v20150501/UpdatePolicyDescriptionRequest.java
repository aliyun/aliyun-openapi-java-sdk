 ...
 * @version 
 */
public class UpdatePolicyDescriptionRequest extends RpcAcsRequest<UpdatePolicyDescriptionResponse> {
	...
	@Override
	public Class<UpdatePolicyDescriptionResponse> getResponseClass() {
		return UpdatePolicyDescriptionResponse.class;
	}
