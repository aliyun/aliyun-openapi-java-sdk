 ...
 * @version 
 */
public class DescribeProductsRequest extends RoaAcsRequest<DescribeProductsResponse> {
	   
	public DescribeProductsRequest() {
		super("BDRC", "2023-08-08", "DescribeProducts");
		setUriPattern("/api/v1/products");
