...
import com.aliyuncs.vpcpeer.transform.v20220101.GetVpcPeerConnectionAttributeResponseUnmarshaller;
 ...
 * @version 
 */
public class GetVpcPeerConnectionAttributeResponse extends AcsResponse {
	...
	@Override
	public GetVpcPeerConnectionAttributeResponse getInstance(UnmarshallerContext context) {
		return	GetVpcPeerConnectionAttributeResponseUnmarshaller.unmarshall(this, context);
	}
