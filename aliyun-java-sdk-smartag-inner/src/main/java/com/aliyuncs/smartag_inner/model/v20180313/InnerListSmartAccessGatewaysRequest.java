 ...
 * @version 
 */
public class InnerListSmartAccessGatewaysRequest extends RpcAcsRequest<InnerListSmartAccessGatewaysResponse> {
	
	public InnerListSmartAccessGatewaysRequest() {
		super("Smartag-inner", "2018-03-13", "InnerListSmartAccessGateways", "smartag", "innerAPI");
	}
	...
	@Override
	public Class<InnerListSmartAccessGatewaysResponse> getResponseClass() {
		return InnerListSmartAccessGatewaysResponse.class;
	}
