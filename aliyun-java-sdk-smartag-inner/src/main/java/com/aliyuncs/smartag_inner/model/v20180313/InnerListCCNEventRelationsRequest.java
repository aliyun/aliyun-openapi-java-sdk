 ...
 * @version 
 */
public class InnerListCCNEventRelationsRequest extends RpcAcsRequest<InnerListCCNEventRelationsResponse> {
	
	public InnerListCCNEventRelationsRequest() {
		super("Smartag-inner", "2018-03-13", "InnerListCCNEventRelations", "smartag", "innerAPI");
	}
	...
	@Override
	public Class<InnerListCCNEventRelationsResponse> getResponseClass() {
		return InnerListCCNEventRelationsResponse.class;
	}
