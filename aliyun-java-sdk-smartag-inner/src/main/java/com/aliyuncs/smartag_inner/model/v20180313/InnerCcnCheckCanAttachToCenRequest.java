 ...
 * @version 
 */
public class InnerCcnCheckCanAttachToCenRequest extends RpcAcsRequest<InnerCcnCheckCanAttachToCenResponse> {
	
	public InnerCcnCheckCanAttachToCenRequest() {
		super("Smartag-inner", "2018-03-13", "InnerCcnCheckCanAttachToCen", "smartag", "innerAPI");
	}
	...
	@Override
	public Class<InnerCcnCheckCanAttachToCenResponse> getResponseClass() {
		return InnerCcnCheckCanAttachToCenResponse.class;
	}
