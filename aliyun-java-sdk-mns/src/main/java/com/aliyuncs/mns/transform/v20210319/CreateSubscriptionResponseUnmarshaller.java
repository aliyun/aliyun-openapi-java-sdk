...
public class CreateSubscriptionResponseUnmarshaller {
	...
	public static CreateSubscriptionResponse unmarshall(CreateSubscriptionResponse createSubscriptionResponse, UnmarshallerContext _ctx) {
		...
		createSubscriptionResponse.setCode(_ctx.longValue("CreateSubscriptionResponse.Code"));
		createSubscriptionResponse.setStatus(_ctx.stringValue("CreateSubscriptionResponse.Status"));
		createSubscriptionResponse.setMessage(_ctx.stringValue("CreateSubscriptionResponse.Message"));
		createSubscriptionResponse.setSuccess(_ctx.booleanValue("CreateSubscriptionResponse.Success"));
		createSubscriptionResponse.setData(_ctx.stringValue("CreateSubscriptionResponse.Data"));
