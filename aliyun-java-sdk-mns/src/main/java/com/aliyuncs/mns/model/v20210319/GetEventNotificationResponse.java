...
import com.aliyuncs.mns.transform.v20210319.GetEventNotificationResponseUnmarshaller;
 ...
 * @version 
 */
public class GetEventNotificationResponse extends AcsResponse {
	...
	@Override
	public GetEventNotificationResponse getInstance(UnmarshallerContext context) {
		return	GetEventNotificationResponseUnmarshaller.unmarshall(this, context);
	}
