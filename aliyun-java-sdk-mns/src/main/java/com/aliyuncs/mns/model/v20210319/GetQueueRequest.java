 ...
 * @version 
 */
public class GetQueueRequest extends RpcAcsRequest<GetQueueResponse> {
	...
	@Override
	public Class<GetQueueResponse> getResponseClass() {
		return GetQueueResponse.class;
	}
