 ...
 * @version 
 */
public class AccountCheckResourceRequest extends RpcAcsRequest<AccountCheckResourceResponse> {
	...
	public AccountCheckResourceRequest() {
		super("mns", "2021-03-19", "AccountCheckResource");
	...
	@Override
	public Class<AccountCheckResourceResponse> getResponseClass() {
		return AccountCheckResourceResponse.class;
	}
