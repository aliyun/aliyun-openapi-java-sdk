 ...
 * @version 
 */
public class GetTopicRequest extends RpcAcsRequest<GetTopicResponse> {
	...
	@Override
	public Class<GetTopicResponse> getResponseClass() {
		return GetTopicResponse.class;
	}
