 ...
 * @version 
 */
public class DoesBucketExistRequest extends RpcAcsRequest<DoesBucketExistResponse> {
	...
	public DoesBucketExistRequest() {
		super("mns", "2021-03-19", "DoesBucketExist");
	...
	@Override
	public Class<DoesBucketExistResponse> getResponseClass() {
		return DoesBucketExistResponse.class;
	}
