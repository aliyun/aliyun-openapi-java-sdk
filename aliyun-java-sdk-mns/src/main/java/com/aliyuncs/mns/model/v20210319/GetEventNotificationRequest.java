 ...
 * @version 
 */
public class GetEventNotificationRequest extends RpcAcsRequest<GetEventNotificationResponse> {
	...
	public GetEventNotificationRequest() {
		super("mns", "2021-03-19", "GetEventNotification");
	...
	@Override
	public Class<GetEventNotificationResponse> getResponseClass() {
		return GetEventNotificationResponse.class;
	}
