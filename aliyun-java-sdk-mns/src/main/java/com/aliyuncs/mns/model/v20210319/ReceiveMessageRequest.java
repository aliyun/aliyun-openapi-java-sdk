 ...
 * @version 
 */
public class ReceiveMessageRequest extends RpcAcsRequest<ReceiveMessageResponse> {
	...
	public ReceiveMessageRequest() {
		super("mns", "2021-03-19", "ReceiveMessage");
	...
	public void setWaitSeconds(Long waitSeconds) {
		...
		if(waitSeconds != null){
			putQueryParameter("WaitSeconds", waitSeconds.toString());
		}
	}
	...
	@Override
	public Class<ReceiveMessageResponse> getResponseClass() {
		return ReceiveMessageResponse.class;
	}
