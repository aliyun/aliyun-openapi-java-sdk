 ...
 * @version 
 */
public class HasRoleRequest extends RpcAcsRequest<HasRoleResponse> {
	...
	@Override
	public Class<HasRoleResponse> getResponseClass() {
		return HasRoleResponse.class;
	}
