 ...
 * @version 
 */
public class ModifySasAssetStatisticsColumnRequest extends RpcAcsRequest<ModifySasAssetStatisticsColumnResponse> {
	
	public ModifySasAssetStatisticsColumnRequest() {
		super("aegis", "2016-11-11", "ModifySasAssetStatisticsColumn", "vipaegis");
	}
	...
	@Override
	public Class<ModifySasAssetStatisticsColumnResponse> getResponseClass() {
		return ModifySasAssetStatisticsColumnResponse.class;
	}
