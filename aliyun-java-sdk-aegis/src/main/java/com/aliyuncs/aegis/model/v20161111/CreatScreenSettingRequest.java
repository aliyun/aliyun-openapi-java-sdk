 ...
 * @version 
 */
public class CreatScreenSettingRequest extends RpcAcsRequest<CreatScreenSettingResponse> {
	
	public CreatScreenSettingRequest() {
		super("aegis", "2016-11-11", "CreatScreenSetting", "vipaegis");
	}
	...
	@Override
	public Class<CreatScreenSettingResponse> getResponseClass() {
		return CreatScreenSettingResponse.class;
	}
