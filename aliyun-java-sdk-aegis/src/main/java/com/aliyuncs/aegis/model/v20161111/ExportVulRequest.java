 ...
 * @version 
 */
public class ExportVulRequest extends RpcAcsRequest<ExportVulResponse> {
	
	public ExportVulRequest() {
		super("aegis", "2016-11-11", "ExportVul", "vipaegis");
	}
	...
	@Override
	public Class<ExportVulResponse> getResponseClass() {
