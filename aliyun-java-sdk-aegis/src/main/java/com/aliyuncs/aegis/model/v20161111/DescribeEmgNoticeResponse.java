...
import com.aliyuncs.aegis.transform.v20161111.DescribeEmgNoticeResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeEmgNoticeResponse extends AcsResponse {
	...
	@Override
	public DescribeEmgNoticeResponse getInstance(UnmarshallerContext context) {
		return	DescribeEmgNoticeResponseUnmarshaller.unmarshall(this, context);
	}
