 ...
 * @version 
 */
public class DeleteDataSourceLogRequest extends RpcAcsRequest<DeleteDataSourceLogResponse> {
	...
	public DeleteDataSourceLogRequest() {
		super("cloud-siem", "2022-06-16", "DeleteDataSourceLog", "cloud-siem");
	...
	@Override
	public Class<DeleteDataSourceLogResponse> getResponseClass() {
		return DeleteDataSourceLogResponse.class;
	}
