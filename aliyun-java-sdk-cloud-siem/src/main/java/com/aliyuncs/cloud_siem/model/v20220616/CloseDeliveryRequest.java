 ...
 * @version 
 */
public class CloseDeliveryRequest extends RpcAcsRequest<CloseDeliveryResponse> {
	...
	public CloseDeliveryRequest() {
		super("cloud-siem", "2022-06-16", "CloseDelivery", "cloud-siem");
	...
	@Override
	public Class<CloseDeliveryResponse> getResponseClass() {
		return CloseDeliveryResponse.class;
	}
