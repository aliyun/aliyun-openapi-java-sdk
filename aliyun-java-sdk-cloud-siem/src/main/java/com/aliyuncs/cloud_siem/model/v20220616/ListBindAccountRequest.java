 ...
 * @version 
 */
public class ListBindAccountRequest extends RpcAcsRequest<ListBindAccountResponse> {
	...
	@Override
	public Class<ListBindAccountResponse> getResponseClass() {
		return ListBindAccountResponse.class;
	}
