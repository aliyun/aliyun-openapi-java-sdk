...
import com.aliyuncs.cloud_siem.transform.v20220616.DescribeAlertSceneByEventResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeAlertSceneByEventResponse extends AcsResponse {
	...
	@Override
	public DescribeAlertSceneByEventResponse getInstance(UnmarshallerContext context) {
		return	DescribeAlertSceneByEventResponseUnmarshaller.unmarshall(this, context);
	}
