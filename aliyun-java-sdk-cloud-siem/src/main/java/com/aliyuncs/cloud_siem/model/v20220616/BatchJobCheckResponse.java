...
import com.aliyuncs.cloud_siem.transform.v20220616.BatchJobCheckResponseUnmarshaller;
 ...
 * @version 
 */
public class BatchJobCheckResponse extends AcsResponse {
	...
	@Override
	public BatchJobCheckResponse getInstance(UnmarshallerContext context) {
		return	BatchJobCheckResponseUnmarshaller.unmarshall(this, context);
	}
