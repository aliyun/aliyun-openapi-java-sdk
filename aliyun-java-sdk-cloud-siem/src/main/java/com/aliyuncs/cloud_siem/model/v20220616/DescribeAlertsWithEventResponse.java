...
import com.aliyuncs.cloud_siem.transform.v20220616.DescribeAlertsWithEventResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeAlertsWithEventResponse extends AcsResponse {
	...
	@Override
	public DescribeAlertsWithEventResponse getInstance(UnmarshallerContext context) {
		return	DescribeAlertsWithEventResponseUnmarshaller.unmarshall(this, context);
	}
