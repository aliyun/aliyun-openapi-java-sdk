...
import com.aliyuncs.cloud_siem.transform.v20220616.DescribeCustomizeRuleResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeCustomizeRuleResponse extends AcsResponse {
	...
	@Override
	public DescribeCustomizeRuleResponse getInstance(UnmarshallerContext context) {
		return	DescribeCustomizeRuleResponseUnmarshaller.unmarshall(this, context);
	}
