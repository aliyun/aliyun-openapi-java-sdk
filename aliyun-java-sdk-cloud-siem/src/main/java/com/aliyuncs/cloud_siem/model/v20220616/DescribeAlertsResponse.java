...
import com.aliyuncs.cloud_siem.transform.v20220616.DescribeAlertsResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeAlertsResponse extends AcsResponse {
	...
	@Override
	public DescribeAlertsResponse getInstance(UnmarshallerContext context) {
		return	DescribeAlertsResponseUnmarshaller.unmarshall(this, context);
	}
