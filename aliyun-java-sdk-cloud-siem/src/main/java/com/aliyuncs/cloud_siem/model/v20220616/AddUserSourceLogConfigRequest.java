 ...
 * @version 
 */
public class AddUserSourceLogConfigRequest extends RpcAcsRequest<AddUserSourceLogConfigResponse> {
	...
	public AddUserSourceLogConfigRequest() {
		super("cloud-siem", "2022-06-16", "AddUserSourceLogConfig", "cloud-siem");
	...
	public void setDisPlayLine(String disPlayLine) {
		...
		if(disPlayLine != null){
			putBodyParameter("DisPlayLine", disPlayLine);
		}
	}
	...
	public void setSourceLogInfo(String sourceLogInfo) {
		...
		if(sourceLogInfo != null){
			putBodyParameter("SourceLogInfo", sourceLogInfo);
		}
	}
	...
	@Override
	public Class<AddUserSourceLogConfigResponse> getResponseClass() {
