 ...
 * @version 
 */
public class RemoveSearchItemsRequest extends RpcAcsRequest<RemoveSearchItemsResponse> {
	   

	private String searchTableId;

	private String searchItemIds;
	public RemoveSearchItemsRequest() {
		super("Vcs", "2020-05-15", "RemoveSearchItems");
	...
	@Override
	public Class<RemoveSearchItemsResponse> getResponseClass() {
		return RemoveSearchItemsResponse.class;
	}
