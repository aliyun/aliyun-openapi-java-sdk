 ...
 * @version 
 */
public class DeleteDataSourcesRequest extends RpcAcsRequest<DeleteDataSourcesResponse> {
	   

	private String dataSourceIdList;
	public DeleteDataSourcesRequest() {
		super("Vcs", "2020-05-15", "DeleteDataSources");
	...
	@Override
	public Class<DeleteDataSourcesResponse> getResponseClass() {
		return DeleteDataSourcesResponse.class;
	}
