 ...
 * @version 
 */
public class CreateWatchTaskRequest extends RpcAcsRequest<CreateWatchTaskResponse> {
	...
	public CreateWatchTaskRequest() {
		super("Vcs", "2020-05-15", "CreateWatchTask");
	...
	@Override
	public Class<CreateWatchTaskResponse> getResponseClass() {
		return CreateWatchTaskResponse.class;
	}
