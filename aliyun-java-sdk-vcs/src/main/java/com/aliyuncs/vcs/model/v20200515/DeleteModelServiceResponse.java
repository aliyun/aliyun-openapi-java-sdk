...
import com.aliyuncs.vcs.transform.v20200515.DeleteModelServiceResponseUnmarshaller;
 ...
 * @version 
 */
public class DeleteModelServiceResponse extends AcsResponse {
	...
	public static class Data {
		...
		public void setModelServiceInstanceName(Integer modelServiceInstanceName) {
			this.modelServiceInstanceName = modelServiceInstanceName;
		}
	}

	@Override
	public DeleteModelServiceResponse getInstance(UnmarshallerContext context) {
		return	DeleteModelServiceResponseUnmarshaller.unmarshall(this, context);
	}
