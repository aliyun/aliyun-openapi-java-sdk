 ...
 * @version 
 */
public class UnbindPersonRequest extends RpcAcsRequest<UnbindPersonResponse> {
	...
	@Override
	public Class<UnbindPersonResponse> getResponseClass() {
		return UnbindPersonResponse.class;
	}
