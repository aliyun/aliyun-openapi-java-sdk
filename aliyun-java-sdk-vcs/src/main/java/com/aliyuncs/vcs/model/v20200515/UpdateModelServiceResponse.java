...
import com.aliyuncs.vcs.transform.v20200515.UpdateModelServiceResponseUnmarshaller;
 ...
 * @version 
 */
public class UpdateModelServiceResponse extends AcsResponse {
	...
	@Override
	public UpdateModelServiceResponse getInstance(UnmarshallerContext context) {
		return	UpdateModelServiceResponseUnmarshaller.unmarshall(this, context);
	}
