 ...
 * @version 
 */
public class CreateWatchPolicyRequest extends RpcAcsRequest<CreateWatchPolicyResponse> {
	...
	public CreateWatchPolicyRequest() {
		super("Vcs", "2020-05-15", "CreateWatchPolicy");
	...
	@Override
	public Class<CreateWatchPolicyResponse> getResponseClass() {
		return CreateWatchPolicyResponse.class;
	}
