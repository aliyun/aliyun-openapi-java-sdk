 ...
 * @version 
 */
public class GetDeviceConfigRequest extends RpcAcsRequest<GetDeviceConfigResponse> {
	...
	@Override
	public Class<GetDeviceConfigResponse> getResponseClass() {
		return GetDeviceConfigResponse.class;
	}
