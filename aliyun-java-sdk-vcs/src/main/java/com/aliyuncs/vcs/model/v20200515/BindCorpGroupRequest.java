 ...
 * @version 
 */
public class BindCorpGroupRequest extends RpcAcsRequest<BindCorpGroupResponse> {
	...
	@Override
	public Class<BindCorpGroupResponse> getResponseClass() {
		return BindCorpGroupResponse.class;
	}
