 ...
 * @version 
 */
public class UnbindDevicesRequest extends RpcAcsRequest<UnbindDevicesResponse> {
	...
	public UnbindDevicesRequest() {
		super("Vcs", "2020-05-15", "UnbindDevices");
	...
	@Override
	public Class<UnbindDevicesResponse> getResponseClass() {
		return UnbindDevicesResponse.class;
	}
