...
public class CreateScanDeviceRequest extends RpcAcsRequest<CreateScanDeviceResponse> {
	...
	public CreateScanDeviceRequest() {
		super("Vcs", "2020-05-15", "CreateScanDevice");
	...
	@Override
	public Class<CreateScanDeviceResponse> getResponseClass() {
		return CreateScanDeviceResponse.class;
	}
