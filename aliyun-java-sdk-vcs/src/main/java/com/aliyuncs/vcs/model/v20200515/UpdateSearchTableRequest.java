 ...
 * @version 
 */
public class UpdateSearchTableRequest extends RpcAcsRequest<UpdateSearchTableResponse> {
	   

	private String searchTableId;

	private String searchTableName;
	public UpdateSearchTableRequest() {
		super("Vcs", "2020-05-15", "UpdateSearchTable");
	...
	public void setSearchTableName(String searchTableName) {
		...
		if(searchTableName != null){
			putBodyParameter("SearchTableName", searchTableName);
		}
	}

	@Override
	public Class<UpdateSearchTableResponse> getResponseClass() {
		return UpdateSearchTableResponse.class;
	}
