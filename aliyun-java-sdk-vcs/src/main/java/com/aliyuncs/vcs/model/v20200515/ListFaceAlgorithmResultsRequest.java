 ...
 * @version 
 */
public class ListFaceAlgorithmResultsRequest extends RpcAcsRequest<ListFaceAlgorithmResultsResponse> {
	...
	@Override
	public Class<ListFaceAlgorithmResultsResponse> getResponseClass() {
		return ListFaceAlgorithmResultsResponse.class;
	}
