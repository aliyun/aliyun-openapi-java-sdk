...
import com.aliyuncs.vcs.transform.v20200515.CreateModelServiceResponseUnmarshaller;
 ...
 * @version 
 */
public class CreateModelServiceResponse extends AcsResponse {
	...
	@Override
	public CreateModelServiceResponse getInstance(UnmarshallerContext context) {
		return	CreateModelServiceResponseUnmarshaller.unmarshall(this, context);
	}
