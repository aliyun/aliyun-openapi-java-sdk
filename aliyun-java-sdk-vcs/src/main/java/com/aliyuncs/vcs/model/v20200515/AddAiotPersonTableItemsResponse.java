...
import com.aliyuncs.vcs.transform.v20200515.AddAiotPersonTableItemsResponseUnmarshaller;
...
public class AddAiotPersonTableItemsResponse extends AcsResponse {
	...
	@Override
	public AddAiotPersonTableItemsResponse getInstance(UnmarshallerContext context) {
		return	AddAiotPersonTableItemsResponseUnmarshaller.unmarshall(this, context);
	}
