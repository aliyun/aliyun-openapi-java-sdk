...
import com.aliyuncs.vcs.transform.v20200515.DescribeWatchItemsResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeWatchItemsResponse extends AcsResponse {
	...
	@Override
	public DescribeWatchItemsResponse getInstance(UnmarshallerContext context) {
		return	DescribeWatchItemsResponseUnmarshaller.unmarshall(this, context);
	}
