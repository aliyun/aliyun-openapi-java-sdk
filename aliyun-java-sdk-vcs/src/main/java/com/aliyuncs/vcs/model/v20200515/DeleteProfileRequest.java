 ...
 * @version 
 */
public class DeleteProfileRequest extends RpcAcsRequest<DeleteProfileResponse> {
	...
	public DeleteProfileRequest() {
		super("Vcs", "2020-05-15", "DeleteProfile", "vcs");
	...
	@Override
	public Class<DeleteProfileResponse> getResponseClass() {
