 ...
 * @version 
 */
public class AddAiotPersonTableRequest extends RpcAcsRequest<AddAiotPersonTableResponse> {
	   

	private PersonTable personTable;

	private String id;
	public AddAiotPersonTableRequest() {
		super("Vcs", "2020-05-15", "AddAiotPersonTable");
	...
	@Override
	public Class<AddAiotPersonTableResponse> getResponseClass() {
		return AddAiotPersonTableResponse.class;
	}
