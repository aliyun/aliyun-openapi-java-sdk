 ...
 * @version 
 */
public class CreateNewDeviceRequest extends RpcAcsRequest<CreateNewDeviceResponse> {
	...
	public CreateNewDeviceRequest() {
		super("Vcs", "2020-05-15", "CreateNewDevice");
	...
	@Override
	public Class<CreateNewDeviceResponse> getResponseClass() {
		return CreateNewDeviceResponse.class;
	}
