 ...
 * @version 
 */
public class GetProfileDetailRequest extends RpcAcsRequest<GetProfileDetailResponse> {
	...
	@Override
	public Class<GetProfileDetailResponse> getResponseClass() {
		return GetProfileDetailResponse.class;
	}
