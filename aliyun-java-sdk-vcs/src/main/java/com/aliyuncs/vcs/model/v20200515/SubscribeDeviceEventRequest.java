 ...
 * @version 
 */
public class SubscribeDeviceEventRequest extends RpcAcsRequest<SubscribeDeviceEventResponse> {
	...
	@Override
	public Class<SubscribeDeviceEventResponse> getResponseClass() {
		return SubscribeDeviceEventResponse.class;
	}
