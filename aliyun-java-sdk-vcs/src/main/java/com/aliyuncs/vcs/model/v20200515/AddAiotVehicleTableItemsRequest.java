 ...
 * @version 
 */
public class AddAiotVehicleTableItemsRequest extends RpcAcsRequest<AddAiotVehicleTableItemsResponse> {
	...
	private String id;
	public AddAiotVehicleTableItemsRequest() {
		super("Vcs", "2020-05-15", "AddAiotVehicleTableItems");
	...
	@Override
	public Class<AddAiotVehicleTableItemsResponse> getResponseClass() {
		return AddAiotVehicleTableItemsResponse.class;
	}
