...
import com.aliyuncs.vcs.transform.v20200515.StopModelServiceResponseUnmarshaller;
 ...
 * @version 
 */
public class StopModelServiceResponse extends AcsResponse {
	...
	@Override
	public StopModelServiceResponse getInstance(UnmarshallerContext context) {
		return	StopModelServiceResponseUnmarshaller.unmarshall(this, context);
	}
