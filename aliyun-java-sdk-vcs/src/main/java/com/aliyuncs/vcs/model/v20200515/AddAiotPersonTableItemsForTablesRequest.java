 ...
 * @version 
 */
public class AddAiotPersonTableItemsForTablesRequest extends RpcAcsRequest<AddAiotPersonTableItemsForTablesResponse> {
	   

	private List<PersonTableItemList> personTableItemList;

	private List<PersonTableList> personTableList;
	public AddAiotPersonTableItemsForTablesRequest() {
		super("Vcs", "2020-05-15", "AddAiotPersonTableItemsForTables");
	...
	public List<PersonTableList> getPersonTableList() {
		return this.personTableList;
	}

	public void setPersonTableList(List<PersonTableList> personTableList) {
		this.personTableList = personTableList;	
		if (personTableList != null) {
			for (int depth1 = 0; depth1 < personTableList.size(); depth1++) {
				if (personTableList.get(depth1) != null) {
					
						putBodyParameter("PersonTableList." + (depth1 + 1) + ".PersonTableId" , personTableList.get(depth1).getPersonTableId());
						putBodyParameter("PersonTableList." + (depth1 + 1) + ".Id" , personTableList.get(depth1).getId());
				}
			}
		}	
	}
	...
	public static class PersonTableList {
	...
	@Override
	public Class<AddAiotPersonTableItemsForTablesResponse> getResponseClass() {
		return AddAiotPersonTableItemsForTablesResponse.class;
	}
