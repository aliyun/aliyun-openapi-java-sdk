 ...
 * @version 
 */
public class BindUserRequest extends RpcAcsRequest<BindUserResponse> {
	...
	public void setMatchingRate(String matchingRate) {
		...
		if(matchingRate != null){
			putBodyParameter("MatchingRate", matchingRate);
		}
	}
	...
	@Override
	public Class<BindUserResponse> getResponseClass() {
		return BindUserResponse.class;
	}
