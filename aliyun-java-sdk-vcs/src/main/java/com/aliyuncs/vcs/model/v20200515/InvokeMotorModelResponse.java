...
public class InvokeMotorModelResponse extends AcsResponse {
	...
	public static class Data {
		...
		public void setStructList(String structList) {
			this.structList = structList;
		}
	}

	@Override
	public InvokeMotorModelResponse getInstance(UnmarshallerContext context) {
		return	InvokeMotorModelResponseUnmarshaller.unmarshall(this, context);
	}
