 ...
 * @version 
 */
public class SearchBodyRequest extends RpcAcsRequest<SearchBodyResponse> {
	...
	@Override
	public Class<SearchBodyResponse> getResponseClass() {
		return SearchBodyResponse.class;
	}
