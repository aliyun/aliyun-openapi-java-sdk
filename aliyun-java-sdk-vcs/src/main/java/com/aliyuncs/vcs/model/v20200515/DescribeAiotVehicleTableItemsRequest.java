 ...
 * @version 
 */
public class DescribeAiotVehicleTableItemsRequest extends RpcAcsRequest<DescribeAiotVehicleTableItemsResponse> {
	...
	private String id;
	public DescribeAiotVehicleTableItemsRequest() {
		super("Vcs", "2020-05-15", "DescribeAiotVehicleTableItems");
	...
	@Override
	public Class<DescribeAiotVehicleTableItemsResponse> getResponseClass() {
		return DescribeAiotVehicleTableItemsResponse.class;
	}
