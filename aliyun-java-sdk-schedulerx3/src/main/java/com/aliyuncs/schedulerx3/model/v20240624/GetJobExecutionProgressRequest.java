 ...
 * @version 
 */
public class GetJobExecutionProgressRequest extends RpcAcsRequest<GetJobExecutionProgressResponse> {
	...
	@Override
	public Class<GetJobExecutionProgressResponse> getResponseClass() {
