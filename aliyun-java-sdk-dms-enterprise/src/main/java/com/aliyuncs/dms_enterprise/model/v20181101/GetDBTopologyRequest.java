 ...
 * @version 
 */
public class GetDBTopologyRequest extends RpcAcsRequest<GetDBTopologyResponse> {
	...
	@Override
	public Class<GetDBTopologyResponse> getResponseClass() {
		return GetDBTopologyResponse.class;
	}
