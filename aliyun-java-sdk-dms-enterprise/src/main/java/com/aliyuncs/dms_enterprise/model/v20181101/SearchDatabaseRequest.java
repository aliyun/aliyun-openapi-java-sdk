 ...
 * @version 
 */
public class SearchDatabaseRequest extends RpcAcsRequest<SearchDatabaseResponse> {
	...
	public SearchDatabaseRequest() {
		super("dms-enterprise", "2018-11-01", "SearchDatabase", "dms-enterprise");
	...
	@Override
	public Class<SearchDatabaseResponse> getResponseClass() {
		return SearchDatabaseResponse.class;
	}
