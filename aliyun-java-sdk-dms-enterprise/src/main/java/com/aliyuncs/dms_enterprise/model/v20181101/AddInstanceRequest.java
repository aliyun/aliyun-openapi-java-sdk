 ...
 * @version 
 */
public class AddInstanceRequest extends RpcAcsRequest<AddInstanceResponse> {
	...
	public AddInstanceRequest() {
		super("dms-enterprise", "2018-11-01", "AddInstance", "dms-enterprise");
	...
	@Override
	public Class<AddInstanceResponse> getResponseClass() {
		return AddInstanceResponse.class;
	}
