...
import com.aliyuncs.dms_enterprise.transform.v20181101.ListDatabaseUserPermssionsResponseUnmarshaller;
...
public class ListDatabaseUserPermssionsResponse extends AcsResponse {
	...
	@Override
	public ListDatabaseUserPermssionsResponse getInstance(UnmarshallerContext context) {
		return	ListDatabaseUserPermssionsResponseUnmarshaller.unmarshall(this, context);
	}
}
