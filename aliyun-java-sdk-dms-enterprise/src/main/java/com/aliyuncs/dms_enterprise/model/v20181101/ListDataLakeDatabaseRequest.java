 ...
 * @version 
 */
public class ListDataLakeDatabaseRequest extends RpcAcsRequest<ListDataLakeDatabaseResponse> {
	...
	@Override
	public Class<ListDataLakeDatabaseResponse> getResponseClass() {
		return ListDataLakeDatabaseResponse.class;
	}
