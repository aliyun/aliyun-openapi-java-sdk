 ...
 * @version 
 */
public class ExecuteDataExportRequest extends RpcAcsRequest<ExecuteDataExportResponse> {
	...
	@Override
	public Class<ExecuteDataExportResponse> getResponseClass() {
		return ExecuteDataExportResponse.class;
	}
