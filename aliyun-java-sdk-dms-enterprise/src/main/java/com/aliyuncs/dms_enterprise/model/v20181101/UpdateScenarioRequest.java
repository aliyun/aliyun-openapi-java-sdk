 ...
 * @version 
 */
public class UpdateScenarioRequest extends RpcAcsRequest<UpdateScenarioResponse> {
	...
	@Override
	public Class<UpdateScenarioResponse> getResponseClass() {
		return UpdateScenarioResponse.class;
	}
