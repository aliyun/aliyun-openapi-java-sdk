 ...
 * @version 
 */
public class CreateDataCorrectOrderRequest extends RpcAcsRequest<CreateDataCorrectOrderResponse> {
	...
	@Override
	public Class<CreateDataCorrectOrderResponse> getResponseClass() {
		return CreateDataCorrectOrderResponse.class;
	}
