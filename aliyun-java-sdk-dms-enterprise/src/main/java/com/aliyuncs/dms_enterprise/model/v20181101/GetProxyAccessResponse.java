...
import com.aliyuncs.dms_enterprise.transform.v20181101.GetProxyAccessResponseUnmarshaller;
 ...
 * @version 
 */
public class GetProxyAccessResponse extends AcsResponse {
	...
	public void setProxyAccess(ProxyAccess proxyAccess) {
	...
	@Override
	public GetProxyAccessResponse getInstance(UnmarshallerContext context) {
		return	GetProxyAccessResponseUnmarshaller.unmarshall(this, context);
	}
