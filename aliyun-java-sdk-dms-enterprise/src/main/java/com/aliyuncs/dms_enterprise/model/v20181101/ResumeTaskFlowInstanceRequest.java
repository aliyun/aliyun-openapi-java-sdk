...
public class ResumeTaskFlowInstanceRequest extends RpcAcsRequest<ResumeTaskFlowInstanceResponse> {
	...
	public ResumeTaskFlowInstanceRequest() {
		super("dms-enterprise", "2018-11-01", "ResumeTaskFlowInstance", "dms-enterprise");
	...
	@Override
	public Class<ResumeTaskFlowInstanceResponse> getResponseClass() {
		return ResumeTaskFlowInstanceResponse.class;
	}
