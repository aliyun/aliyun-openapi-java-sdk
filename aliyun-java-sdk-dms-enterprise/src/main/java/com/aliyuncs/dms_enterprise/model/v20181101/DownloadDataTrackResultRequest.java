 ...
 * @version 
 */
public class DownloadDataTrackResultRequest extends RpcAcsRequest<DownloadDataTrackResultResponse> {
	...
	public DownloadDataTrackResultRequest() {
		super("dms-enterprise", "2018-11-01", "DownloadDataTrackResult", "dms-enterprise");
	...
	public void setRollbackSQLType(String rollbackSQLType) {
		...
		if(rollbackSQLType != null){
			putQueryParameter("RollbackSQLType", rollbackSQLType);
		}
	}
	...
	public void setEventIdList(List<Long> eventIdList) {
		...
		if (eventIdList != null) {
			putQueryParameter("EventIdList" , new Gson().toJson(eventIdList));
		}	
	}
	...
	@Override
	public Class<DownloadDataTrackResultResponse> getResponseClass() {
		return DownloadDataTrackResultResponse.class;
	}
