 ...
 * @version 
 */
public class GetAbacPolicyRequest extends RpcAcsRequest<GetAbacPolicyResponse> {
	...
	public GetAbacPolicyRequest() {
		super("dms-enterprise", "2018-11-01", "GetAbacPolicy", "dms-enterprise");
	...
	@Override
	public Class<GetAbacPolicyResponse> getResponseClass() {
		return GetAbacPolicyResponse.class;
	}
