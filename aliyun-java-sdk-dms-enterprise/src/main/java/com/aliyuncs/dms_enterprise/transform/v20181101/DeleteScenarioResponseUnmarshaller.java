...
public class DeleteScenarioResponseUnmarshaller {
	...
	public static DeleteScenarioResponse unmarshall(DeleteScenarioResponse deleteScenarioResponse, UnmarshallerContext _ctx) {
		...
		deleteScenarioResponse.setErrorCode(_ctx.stringValue("DeleteScenarioResponse.ErrorCode"));
		deleteScenarioResponse.setErrorMessage(_ctx.stringValue("DeleteScenarioResponse.ErrorMessage"));
		deleteScenarioResponse.setSuccess(_ctx.booleanValue("DeleteScenarioResponse.Success"));
