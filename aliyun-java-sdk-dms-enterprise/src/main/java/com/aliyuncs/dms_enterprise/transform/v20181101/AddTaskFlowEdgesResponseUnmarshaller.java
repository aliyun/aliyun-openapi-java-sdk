...
public class AddTaskFlowEdgesResponseUnmarshaller {

	public static AddTaskFlowEdgesResponse unmarshall(AddTaskFlowEdgesResponse addTaskFlowEdgesResponse, UnmarshallerContext _ctx) {
		
		addTaskFlowEdgesResponse.setRequestId(_ctx.stringValue("AddTaskFlowEdgesResponse.RequestId"));
