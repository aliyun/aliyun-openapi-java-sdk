...
public class CreateScenarioResponseUnmarshaller {
	...
	public static CreateScenarioResponse unmarshall(CreateScenarioResponse createScenarioResponse, UnmarshallerContext _ctx) {
		...
		createScenarioResponse.setErrorCode(_ctx.stringValue("CreateScenarioResponse.ErrorCode"));
		createScenarioResponse.setErrorMessage(_ctx.stringValue("CreateScenarioResponse.ErrorMessage"));
		createScenarioResponse.setSuccess(_ctx.booleanValue("CreateScenarioResponse.Success"));
		createScenarioResponse.setScenarioId(_ctx.longValue("CreateScenarioResponse.ScenarioId"));
