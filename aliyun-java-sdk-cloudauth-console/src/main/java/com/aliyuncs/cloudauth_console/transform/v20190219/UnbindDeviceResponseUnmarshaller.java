...
import com.aliyuncs.cloudauth_console.model.v20190219.UnbindDeviceResponse;
...
public class UnbindDeviceResponseUnmarshaller {
	...
	public static UnbindDeviceResponse unmarshall(UnbindDeviceResponse unbindDeviceResponse, UnmarshallerContext _ctx) {
		...
		unbindDeviceResponse.setSuccess(_ctx.booleanValue("UnbindDeviceResponse.Success"));
		unbindDeviceResponse.setHttpStatusCode(_ctx.integerValue("UnbindDeviceResponse.HttpStatusCode"));
