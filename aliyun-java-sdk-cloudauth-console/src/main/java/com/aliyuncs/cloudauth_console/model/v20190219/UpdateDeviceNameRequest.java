 ...
 * @version 
 */
public class UpdateDeviceNameRequest extends RpcAcsRequest<UpdateDeviceNameResponse> {
	...
	@Override
	public Class<UpdateDeviceNameResponse> getResponseClass() {
		return UpdateDeviceNameResponse.class;
	}
