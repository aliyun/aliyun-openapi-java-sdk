 ...
 * @version 
 */
public class DescribeTopicRequest extends RpcAcsRequest<DescribeTopicResponse> {
	...
	@Override
	public Class<DescribeTopicResponse> getResponseClass() {
		return DescribeTopicResponse.class;
	}
