 ...
 * @version 
 */
public class UpdateProjectNameRequest extends RpcAcsRequest<UpdateProjectNameResponse> {
	...
	@Override
	public Class<UpdateProjectNameResponse> getResponseClass() {
		return UpdateProjectNameResponse.class;
	}
