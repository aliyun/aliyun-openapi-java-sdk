 ...
 * @version 
 */
public class DescribeMnsOauthRequest extends RpcAcsRequest<DescribeMnsOauthResponse> {
	...
	@Override
	public Class<DescribeMnsOauthResponse> getResponseClass() {
		return DescribeMnsOauthResponse.class;
	}
