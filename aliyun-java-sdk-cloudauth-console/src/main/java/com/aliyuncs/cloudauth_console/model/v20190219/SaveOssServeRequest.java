 ...
 * @version 
 */
public class SaveOssServeRequest extends RpcAcsRequest<SaveOssServeResponse> {
	...
	@Override
	public Class<SaveOssServeResponse> getResponseClass() {
		return SaveOssServeResponse.class;
	}
