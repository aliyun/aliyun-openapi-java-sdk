 ...
 * @version 
 */
public class DeleteUserInfoRequest extends RpcAcsRequest<DeleteUserInfoResponse> {
	...
	@Override
	public Class<DeleteUserInfoResponse> getResponseClass() {
		return DeleteUserInfoResponse.class;
	}
