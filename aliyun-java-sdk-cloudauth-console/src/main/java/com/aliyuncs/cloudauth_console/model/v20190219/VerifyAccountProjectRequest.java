...
public class VerifyAccountProjectRequest extends RpcAcsRequest<VerifyAccountProjectResponse> {
	...
	public VerifyAccountProjectRequest() {
		super("Cloudauth-console", "2019-02-19", "VerifyAccountProject");
	...
	@Override
	public Class<VerifyAccountProjectResponse> getResponseClass() {
		return VerifyAccountProjectResponse.class;
	}
