...
public class CreateLiveMessageAppResponseUnmarshaller {
	...
	public static CreateLiveMessageAppResponse unmarshall(CreateLiveMessageAppResponse createLiveMessageAppResponse, UnmarshallerContext _ctx) {
		
		createLiveMessageAppResponse.setRequestId(_ctx.stringValue("CreateLiveMessageAppResponse.RequestId"));
