...
import com.aliyuncs.live.model.v20161101.GetMessageTokenResponse.Result;
import com.aliyuncs.transform.UnmarshallerContext;


public class GetMessageTokenResponseUnmarshaller {

	public static GetMessageTokenResponse unmarshall(GetMessageTokenResponse getMessageTokenResponse, UnmarshallerContext _ctx) {
		
		getMessageTokenResponse.setRequestId(_ctx.stringValue("GetMessageTokenResponse.RequestId"));
