 ...
 * @version 
 */
public class UpdateRtsLiveStreamTranscodeRequest extends RpcAcsRequest<UpdateRtsLiveStreamTranscodeResponse> {
	...
	@Override
	public Class<UpdateRtsLiveStreamTranscodeResponse> getResponseClass() {
