...
import com.aliyuncs.live.transform.v20161101.DescribeMeterLiveBypassDurationResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeMeterLiveBypassDurationResponse extends AcsResponse {
	...
	public void setSingleAudioSummaryDuration(Long singleAudioSummaryDuration) {
	...
	public void setSingleVideoSummaryDuration(Long singleVideoSummaryDuration) {
	...
	public static class DataItem {
		...
		public Long getSingle_Audio() {
			return this.single_Audio;
		}

		public void setSingle_Audio(Long single_Audio) {
			this.single_Audio = single_Audio;
		}

		public Long getSingle_Video() {
			return this.single_Video;
		}

		public void setSingle_Video(Long single_Video) {
	...
	@Override
	public DescribeMeterLiveBypassDurationResponse getInstance(UnmarshallerContext context) {
		return	DescribeMeterLiveBypassDurationResponseUnmarshaller.unmarshall(this, context);
	}
