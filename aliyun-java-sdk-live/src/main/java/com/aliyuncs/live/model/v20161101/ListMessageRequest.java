 ...
 * @version 
 */
public class ListMessageRequest extends RpcAcsRequest<ListMessageResponse> {
	...
	@Override
	public Class<ListMessageResponse> getResponseClass() {
		return ListMessageResponse.class;
	}
