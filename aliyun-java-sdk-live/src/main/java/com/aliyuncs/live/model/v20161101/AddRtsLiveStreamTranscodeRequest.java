 ...
 * @version 
 */
public class AddRtsLiveStreamTranscodeRequest extends RpcAcsRequest<AddRtsLiveStreamTranscodeResponse> {
	...
	@Override
	public Class<AddRtsLiveStreamTranscodeResponse> getResponseClass() {
		return AddRtsLiveStreamTranscodeResponse.class;
	}
