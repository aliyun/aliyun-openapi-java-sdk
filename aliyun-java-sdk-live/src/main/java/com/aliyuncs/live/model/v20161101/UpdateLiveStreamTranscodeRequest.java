 ...
 * @version 
 */
public class UpdateLiveStreamTranscodeRequest extends RpcAcsRequest<UpdateLiveStreamTranscodeResponse> {
	...
	public UpdateLiveStreamTranscodeRequest() {
		super("live", "2016-11-01", "UpdateLiveStreamTranscode", "live");
	...
	@Override
	public Class<UpdateLiveStreamTranscodeResponse> getResponseClass() {
		return UpdateLiveStreamTranscodeResponse.class;
	}
