...
import com.aliyuncs.live.transform.v20161101.GetEdgeTranscodeJobResponseUnmarshaller;
 ...
 * @version 
 */
public class GetEdgeTranscodeJobResponse extends AcsResponse {
	...
	@Override
	public GetEdgeTranscodeJobResponse getInstance(UnmarshallerContext context) {
		return	GetEdgeTranscodeJobResponseUnmarshaller.unmarshall(this, context);
	}
}
