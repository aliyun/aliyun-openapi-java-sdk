 ...
 * @version 
 */
public class AddLiveCenterTransferRequest extends RpcAcsRequest<AddLiveCenterTransferResponse> {
	...
	public AddLiveCenterTransferRequest() {
		super("live", "2016-11-01", "AddLiveCenterTransfer", "live");
	...
	@Override
	public Class<AddLiveCenterTransferResponse> getResponseClass() {
		return AddLiveCenterTransferResponse.class;
	}
