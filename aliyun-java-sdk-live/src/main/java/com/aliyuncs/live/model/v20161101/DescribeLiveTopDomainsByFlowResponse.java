...
import com.aliyuncs.live.transform.v20161101.DescribeLiveTopDomainsByFlowResponseUnmarshaller;
...
public class DescribeLiveTopDomainsByFlowResponse extends AcsResponse {
	...
	@Override
	public DescribeLiveTopDomainsByFlowResponse getInstance(UnmarshallerContext context) {
		return	DescribeLiveTopDomainsByFlowResponseUnmarshaller.unmarshall(this, context);
	}
}
