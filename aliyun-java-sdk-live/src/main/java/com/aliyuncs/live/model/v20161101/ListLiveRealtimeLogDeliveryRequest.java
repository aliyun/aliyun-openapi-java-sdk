...
public class ListLiveRealtimeLogDeliveryRequest extends RpcAcsRequest<ListLiveRealtimeLogDeliveryResponse> {
	...
	public ListLiveRealtimeLogDeliveryRequest() {
		super("live", "2016-11-01", "ListLiveRealtimeLogDelivery");
	...
	@Override
	public Class<ListLiveRealtimeLogDeliveryResponse> getResponseClass() {
		return ListLiveRealtimeLogDeliveryResponse.class;
	}
