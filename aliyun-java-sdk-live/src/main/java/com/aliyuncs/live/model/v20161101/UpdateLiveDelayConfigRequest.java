 ...
 * @version 
 */
public class UpdateLiveDelayConfigRequest extends RpcAcsRequest<UpdateLiveDelayConfigResponse> {
	...
	public UpdateLiveDelayConfigRequest() {
		super("live", "2016-11-01", "UpdateLiveDelayConfig", "live");
	...
	@Override
	public Class<UpdateLiveDelayConfigResponse> getResponseClass() {
		return UpdateLiveDelayConfigResponse.class;
	}
