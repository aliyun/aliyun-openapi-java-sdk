 ...
 * @version 
 */
public class DeleteHtmlResourceRequest extends RpcAcsRequest<DeleteHtmlResourceResponse> {
	...
	@Override
	public Class<DeleteHtmlResourceResponse> getResponseClass() {
		return DeleteHtmlResourceResponse.class;
	}
