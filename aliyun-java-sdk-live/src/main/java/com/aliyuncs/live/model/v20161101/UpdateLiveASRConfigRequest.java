 ...
 * @version 
 */
public class UpdateLiveASRConfigRequest extends RpcAcsRequest<UpdateLiveASRConfigResponse> {
	...
	public UpdateLiveASRConfigRequest() {
		super("live", "2016-11-01", "UpdateLiveASRConfig", "live");
	...
	@Override
	public Class<UpdateLiveASRConfigResponse> getResponseClass() {
		return UpdateLiveASRConfigResponse.class;
	}
