...
import com.aliyuncs.live.transform.v20161101.DescribeLivePullToPushResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeLivePullToPushResponse extends AcsResponse {
	...
	@Override
	public DescribeLivePullToPushResponse getInstance(UnmarshallerContext context) {
		return	DescribeLivePullToPushResponseUnmarshaller.unmarshall(this, context);
	}
