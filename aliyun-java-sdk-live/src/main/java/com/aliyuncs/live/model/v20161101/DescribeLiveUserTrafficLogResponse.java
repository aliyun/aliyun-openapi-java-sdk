...
import com.aliyuncs.live.transform.v20161101.DescribeLiveUserTrafficLogResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeLiveUserTrafficLogResponse extends AcsResponse {
	...
	@Override
	public DescribeLiveUserTrafficLogResponse getInstance(UnmarshallerContext context) {
		return	DescribeLiveUserTrafficLogResponseUnmarshaller.unmarshall(this, context);
	}
}
