 ...
 * @version 
 */
public class ListPlaylistItemsRequest extends RpcAcsRequest<ListPlaylistItemsResponse> {
	...
	public ListPlaylistItemsRequest() {
		super("live", "2016-11-01", "ListPlaylistItems", "live");
	...
	@Override
	public Class<ListPlaylistItemsResponse> getResponseClass() {
		return ListPlaylistItemsResponse.class;
	}
