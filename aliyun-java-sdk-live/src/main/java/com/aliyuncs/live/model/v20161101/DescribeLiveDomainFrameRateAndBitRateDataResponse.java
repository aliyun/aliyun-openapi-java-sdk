...
import com.aliyuncs.live.transform.v20161101.DescribeLiveDomainFrameRateAndBitRateDataResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeLiveDomainFrameRateAndBitRateDataResponse extends AcsResponse {
	...
	@Override
	public DescribeLiveDomainFrameRateAndBitRateDataResponse getInstance(UnmarshallerContext context) {
		return	DescribeLiveDomainFrameRateAndBitRateDataResponseUnmarshaller.unmarshall(this, context);
	}
}
