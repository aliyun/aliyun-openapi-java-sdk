...
public class DescribeLiveCertificateDetailRequest extends RpcAcsRequest<DescribeLiveCertificateDetailResponse> {
	...
	public DescribeLiveCertificateDetailRequest() {
		super("live", "2016-11-01", "DescribeLiveCertificateDetail");
	...
	@Override
	public Class<DescribeLiveCertificateDetailResponse> getResponseClass() {
		return DescribeLiveCertificateDetailResponse.class;
	}
