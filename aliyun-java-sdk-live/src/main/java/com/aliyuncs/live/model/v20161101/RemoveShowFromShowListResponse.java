...
public class RemoveShowFromShowListResponse extends AcsResponse {
	...
	@Override
	public RemoveShowFromShowListResponse getInstance(UnmarshallerContext context) {
		return	RemoveShowFromShowListResponseUnmarshaller.unmarshall(this, context);
	}
}
