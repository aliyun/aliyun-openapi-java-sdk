 ...
 * @version 
 */
public class UpdateEdgeTranscodeJobRequest extends RpcAcsRequest<UpdateEdgeTranscodeJobResponse> {
	...
	private String name;
	public UpdateEdgeTranscodeJobRequest() {
		super("live", "2016-11-01", "UpdateEdgeTranscodeJob", "live");
	...
	@Override
	public Class<UpdateEdgeTranscodeJobResponse> getResponseClass() {
		return UpdateEdgeTranscodeJobResponse.class;
	}
