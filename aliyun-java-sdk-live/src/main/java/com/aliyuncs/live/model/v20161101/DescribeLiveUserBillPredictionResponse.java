...
import com.aliyuncs.live.transform.v20161101.DescribeLiveUserBillPredictionResponseUnmarshaller;
...
public class DescribeLiveUserBillPredictionResponse extends AcsResponse {
	...
	@Override
	public DescribeLiveUserBillPredictionResponse getInstance(UnmarshallerContext context) {
		return	DescribeLiveUserBillPredictionResponseUnmarshaller.unmarshall(this, context);
	}
}
