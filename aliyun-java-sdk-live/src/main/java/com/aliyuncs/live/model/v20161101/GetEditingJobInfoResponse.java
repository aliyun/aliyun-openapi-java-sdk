...
import com.aliyuncs.live.transform.v20161101.GetEditingJobInfoResponseUnmarshaller;
...
public class GetEditingJobInfoResponse extends AcsResponse {
	...
	@Override
	public GetEditingJobInfoResponse getInstance(UnmarshallerContext context) {
		return	GetEditingJobInfoResponseUnmarshaller.unmarshall(this, context);
	}
}
