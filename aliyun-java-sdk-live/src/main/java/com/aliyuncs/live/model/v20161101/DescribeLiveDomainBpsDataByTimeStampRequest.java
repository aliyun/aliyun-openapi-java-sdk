 ...
 * @version 
 */
public class DescribeLiveDomainBpsDataByTimeStampRequest extends RpcAcsRequest<DescribeLiveDomainBpsDataByTimeStampResponse> {
	...
	@Override
	public Class<DescribeLiveDomainBpsDataByTimeStampResponse> getResponseClass() {
		return DescribeLiveDomainBpsDataByTimeStampResponse.class;
	}
