 ...
 * @version 
 */
public class ControlHtmlResourceRequest extends RpcAcsRequest<ControlHtmlResourceResponse> {
	...
	public ControlHtmlResourceRequest() {
		super("live", "2016-11-01", "ControlHtmlResource", "live");
	...
	@Override
	public Class<ControlHtmlResourceResponse> getResponseClass() {
		return ControlHtmlResourceResponse.class;
	}
