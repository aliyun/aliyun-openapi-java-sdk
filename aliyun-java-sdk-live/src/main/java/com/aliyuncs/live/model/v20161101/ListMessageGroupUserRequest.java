 ...
 * @version 
 */
public class ListMessageGroupUserRequest extends RpcAcsRequest<ListMessageGroupUserResponse> {
	...
	@Override
	public Class<ListMessageGroupUserResponse> getResponseClass() {
		return ListMessageGroupUserResponse.class;
	}
