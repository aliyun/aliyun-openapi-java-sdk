 ...
 * @version 
 */
public class AddLivePackageConfigRequest extends RpcAcsRequest<AddLivePackageConfigResponse> {
	...
	public AddLivePackageConfigRequest() {
		super("live", "2016-11-01", "AddLivePackageConfig", "live");
	...
	@Override
	public Class<AddLivePackageConfigResponse> getResponseClass() {
		return AddLivePackageConfigResponse.class;
	}
