...
import com.aliyuncs.live.transform.v20161101.DescribeLiveDomainEdgeLogResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeLiveDomainEdgeLogResponse extends AcsResponse {
	...
	@Override
	public DescribeLiveDomainEdgeLogResponse getInstance(UnmarshallerContext context) {
		return	DescribeLiveDomainEdgeLogResponseUnmarshaller.unmarshall(this, context);
	}
}
