 ...
 * @version 
 */
public class DescribeRTSNativeSDKPlayTimeRequest extends RpcAcsRequest<DescribeRTSNativeSDKPlayTimeResponse> {
	...
	public DescribeRTSNativeSDKPlayTimeRequest() {
		super("live", "2016-11-01", "DescribeRTSNativeSDKPlayTime", "live");
	...
	@Override
	public Class<DescribeRTSNativeSDKPlayTimeResponse> getResponseClass() {
		return DescribeRTSNativeSDKPlayTimeResponse.class;
	}
