 ...
 * @version 
 */
public class OpenLiveShiftRequest extends RpcAcsRequest<OpenLiveShiftResponse> {
	...
	public OpenLiveShiftRequest() {
		super("live", "2016-11-01", "OpenLiveShift", "live");
	...
	public void setVision(Integer vision) {
		this.vision = vision;
		if(vision != null){
			putQueryParameter("Vision", vision.toString());
		}
	}

	@Override
	public Class<OpenLiveShiftResponse> getResponseClass() {
		return OpenLiveShiftResponse.class;
	}
