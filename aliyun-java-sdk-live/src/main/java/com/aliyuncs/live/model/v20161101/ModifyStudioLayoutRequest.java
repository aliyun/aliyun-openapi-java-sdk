 ...
 * @version 
 */
public class ModifyStudioLayoutRequest extends RpcAcsRequest<ModifyStudioLayoutResponse> {
	...
	public ModifyStudioLayoutRequest() {
		super("live", "2016-11-01", "ModifyStudioLayout", "live");
	...
	@Override
	public Class<ModifyStudioLayoutResponse> getResponseClass() {
		return ModifyStudioLayoutResponse.class;
	}
