...
public class DeleteLiveRealtimeLogDeliveryRequest extends RpcAcsRequest<DeleteLiveRealtimeLogDeliveryResponse> {
	...
	public DeleteLiveRealtimeLogDeliveryRequest() {
		super("live", "2016-11-01", "DeleteLiveRealtimeLogDelivery");
	...
	@Override
	public Class<DeleteLiveRealtimeLogDeliveryResponse> getResponseClass() {
		return DeleteLiveRealtimeLogDeliveryResponse.class;
	}
