 ...
 * @version 
 */
public class AddLiveAudioAuditNotifyConfigRequest extends RpcAcsRequest<AddLiveAudioAuditNotifyConfigResponse> {
	...
	@Override
	public Class<AddLiveAudioAuditNotifyConfigResponse> getResponseClass() {
		return AddLiveAudioAuditNotifyConfigResponse.class;
	}
