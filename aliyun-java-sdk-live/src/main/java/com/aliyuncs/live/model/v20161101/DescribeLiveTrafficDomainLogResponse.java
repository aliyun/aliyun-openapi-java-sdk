...
import com.aliyuncs.live.transform.v20161101.DescribeLiveTrafficDomainLogResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeLiveTrafficDomainLogResponse extends AcsResponse {
	...
	@Override
	public DescribeLiveTrafficDomainLogResponse getInstance(UnmarshallerContext context) {
		return	DescribeLiveTrafficDomainLogResponseUnmarshaller.unmarshall(this, context);
	}
}
