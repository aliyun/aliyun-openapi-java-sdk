...
import com.aliyuncs.live.transform.v20161101.DescribeLivePushProxyLogResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeLivePushProxyLogResponse extends AcsResponse {
	...
	@Override
	public DescribeLivePushProxyLogResponse getInstance(UnmarshallerContext context) {
		return	DescribeLivePushProxyLogResponseUnmarshaller.unmarshall(this, context);
	}
}
