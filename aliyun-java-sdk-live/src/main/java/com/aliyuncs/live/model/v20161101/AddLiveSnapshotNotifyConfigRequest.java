 ...
 * @version 
 */
public class AddLiveSnapshotNotifyConfigRequest extends RpcAcsRequest<AddLiveSnapshotNotifyConfigResponse> {
	...
	public AddLiveSnapshotNotifyConfigRequest() {
		super("live", "2016-11-01", "AddLiveSnapshotNotifyConfig", "live");
	...
	@Override
	public Class<AddLiveSnapshotNotifyConfigResponse> getResponseClass() {
		return AddLiveSnapshotNotifyConfigResponse.class;
	}
