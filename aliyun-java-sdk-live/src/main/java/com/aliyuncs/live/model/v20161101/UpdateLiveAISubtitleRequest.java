 ...
 * @version 
 */
public class UpdateLiveAISubtitleRequest extends RpcAcsRequest<UpdateLiveAISubtitleResponse> {
	...
	public UpdateLiveAISubtitleRequest() {
		super("live", "2016-11-01", "UpdateLiveAISubtitle", "live");
	...
	@Override
	public Class<UpdateLiveAISubtitleResponse> getResponseClass() {
		return UpdateLiveAISubtitleResponse.class;
	}
