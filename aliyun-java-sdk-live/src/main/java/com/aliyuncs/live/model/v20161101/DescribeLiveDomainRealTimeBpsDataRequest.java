 ...
 * @version 
 */
public class DescribeLiveDomainRealTimeBpsDataRequest extends RpcAcsRequest<DescribeLiveDomainRealTimeBpsDataResponse> {
	...
	@Override
	public Class<DescribeLiveDomainRealTimeBpsDataResponse> getResponseClass() {
		return DescribeLiveDomainRealTimeBpsDataResponse.class;
	}
