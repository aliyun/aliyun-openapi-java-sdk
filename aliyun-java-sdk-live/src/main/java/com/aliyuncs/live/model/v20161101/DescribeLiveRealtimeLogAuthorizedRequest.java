 ...
 * @version 
 */
public class DescribeLiveRealtimeLogAuthorizedRequest extends RpcAcsRequest<DescribeLiveRealtimeLogAuthorizedResponse> {
	...
	@Override
	public Class<DescribeLiveRealtimeLogAuthorizedResponse> getResponseClass() {
		return DescribeLiveRealtimeLogAuthorizedResponse.class;
	}
