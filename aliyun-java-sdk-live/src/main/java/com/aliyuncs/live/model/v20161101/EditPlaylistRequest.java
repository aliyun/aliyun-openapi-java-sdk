 ...
 * @version 
 */
public class EditPlaylistRequest extends RpcAcsRequest<EditPlaylistResponse> {
	...
	public EditPlaylistRequest() {
		super("live", "2016-11-01", "EditPlaylist", "live");
	...
	@Override
	public Class<EditPlaylistResponse> getResponseClass() {
		return EditPlaylistResponse.class;
	}
