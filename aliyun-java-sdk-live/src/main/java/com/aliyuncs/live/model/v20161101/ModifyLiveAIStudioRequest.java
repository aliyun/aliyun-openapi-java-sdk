 ...
 * @version 
 */
public class ModifyLiveAIStudioRequest extends RpcAcsRequest<ModifyLiveAIStudioResponse> {
	...
	public ModifyLiveAIStudioRequest() {
		super("live", "2016-11-01", "ModifyLiveAIStudio", "live");
	...
	@Override
	public Class<ModifyLiveAIStudioResponse> getResponseClass() {
		return ModifyLiveAIStudioResponse.class;
	}
