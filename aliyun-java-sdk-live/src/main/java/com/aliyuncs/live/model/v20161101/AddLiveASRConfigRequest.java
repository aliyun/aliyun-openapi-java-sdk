 ...
 * @version 
 */
public class AddLiveASRConfigRequest extends RpcAcsRequest<AddLiveASRConfigResponse> {
	...
	public AddLiveASRConfigRequest() {
		super("live", "2016-11-01", "AddLiveASRConfig", "live");
	...
	public void setMnsTopic(String mnsTopic) {
		...
		if(mnsTopic != null){
			putQueryParameter("MnsTopic", mnsTopic);
		}
	}
	...
	public void setMnsRegion(String mnsRegion) {
		...
		if(mnsRegion != null){
			putQueryParameter("MnsRegion", mnsRegion);
		}
	}

	@Override
	public Class<AddLiveASRConfigResponse> getResponseClass() {
		return AddLiveASRConfigResponse.class;
	}
