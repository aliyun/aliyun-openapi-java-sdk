 ...
 * @version 
 */
public class ListLiveTagResourcesRequest extends RpcAcsRequest<ListLiveTagResourcesResponse> {
	...
	public ListLiveTagResourcesRequest() {
		super("live", "2016-11-01", "ListLiveTagResources", "live");
	...
	@Override
	public Class<ListLiveTagResourcesResponse> getResponseClass() {
		return ListLiveTagResourcesResponse.class;
	}
