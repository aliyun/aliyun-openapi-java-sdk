 ...
 * @version 
 */
public class UpdateLiveSnapshotNotifyConfigRequest extends RpcAcsRequest<UpdateLiveSnapshotNotifyConfigResponse> {
	...
	public UpdateLiveSnapshotNotifyConfigRequest() {
		super("live", "2016-11-01", "UpdateLiveSnapshotNotifyConfig", "live");
	...
	@Override
	public Class<UpdateLiveSnapshotNotifyConfigResponse> getResponseClass() {
		return UpdateLiveSnapshotNotifyConfigResponse.class;
	}
