 ...
 * @version 
 */
public class StartLiveMPUTaskRequest extends RpcAcsRequest<StartLiveMPUTaskResponse> {
	...
	@Override
	public Class<StartLiveMPUTaskResponse> getResponseClass() {
		return StartLiveMPUTaskResponse.class;
	}
