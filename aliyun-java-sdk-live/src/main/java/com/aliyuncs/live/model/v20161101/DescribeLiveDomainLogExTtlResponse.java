...
import com.aliyuncs.live.transform.v20161101.DescribeLiveDomainLogExTtlResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeLiveDomainLogExTtlResponse extends AcsResponse {
	...
	@Override
	public DescribeLiveDomainLogExTtlResponse getInstance(UnmarshallerContext context) {
		return	DescribeLiveDomainLogExTtlResponseUnmarshaller.unmarshall(this, context);
	}
}
