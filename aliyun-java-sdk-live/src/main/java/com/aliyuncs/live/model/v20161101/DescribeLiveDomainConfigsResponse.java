...
public class DescribeLiveDomainConfigsResponse extends AcsResponse {
	...
	@Override
	public DescribeLiveDomainConfigsResponse getInstance(UnmarshallerContext context) {
		return	DescribeLiveDomainConfigsResponseUnmarshaller.unmarshall(this, context);
	}
}
