...
import com.aliyuncs.live.transform.v20161101.DescribeLiveDomainTrafficDataResponseUnmarshaller;
...
public class DescribeLiveDomainTrafficDataResponse extends AcsResponse {
	...
	@Override
	public DescribeLiveDomainTrafficDataResponse getInstance(UnmarshallerContext context) {
		return	DescribeLiveDomainTrafficDataResponseUnmarshaller.unmarshall(this, context);
	}
}
