...
import com.aliyuncs.hitsdb.model.v20200615.ListTagResourcesResponse;
import com.aliyuncs.hitsdb.model.v20200615.ListTagResourcesResponse.TagResource;
...
public class ListTagResourcesResponseUnmarshaller {
	...
	public static ListTagResourcesResponse unmarshall(ListTagResourcesResponse listTagResourcesResponse, UnmarshallerContext _ctx) {
		...
		for (int i = 0; i < _ctx.lengthValue("ListTagResourcesResponse.TagResources.Length"); i++) {
			...
			tagResource.setCategory(_ctx.stringValue("ListTagResourcesResponse.TagResources["+ i +"].Category"));
			tagResource.setScope(_ctx.stringValue("ListTagResourcesResponse.TagResources["+ i +"].Scope"));
			tagResource.setAliUid(_ctx.longValue("ListTagResourcesResponse.TagResources["+ i +"].AliUid"));
