...
import com.aliyuncs.hitsdb.model.v20200615.ModifyAutoScalingConfigResponse;
...
public class ModifyAutoScalingConfigResponseUnmarshaller {
	...
	public static ModifyAutoScalingConfigResponse unmarshall(ModifyAutoScalingConfigResponse modifyAutoScalingConfigResponse, UnmarshallerContext _ctx) {
		...
		modifyAutoScalingConfigResponse.setSuccess(_ctx.booleanValue("ModifyAutoScalingConfigResponse.Success"));
		...
		modifyAutoScalingConfigResponse.setHttpStatusCode(_ctx.integerValue("ModifyAutoScalingConfigResponse.HttpStatusCode"));
