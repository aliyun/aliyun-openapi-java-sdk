 ...
 * @version 
 */
public class DeleteHiTSDBInstanceDataRequest extends RpcAcsRequest<DeleteHiTSDBInstanceDataResponse> {
	...
	public DeleteHiTSDBInstanceDataRequest() {
		super("hitsdb", "2017-06-01", "DeleteHiTSDBInstanceData", "hitsdb");
	...
	@Override
	public Class<DeleteHiTSDBInstanceDataResponse> getResponseClass() {
		return DeleteHiTSDBInstanceDataResponse.class;
	}
