...
import com.aliyuncs.hitsdb.transform.v20200615.GetAutoScalingRuleResponseUnmarshaller;
 ...
 * @version 
 */
public class GetAutoScalingRuleResponse extends AcsResponse {
	...
	@Override
	public GetAutoScalingRuleResponse getInstance(UnmarshallerContext context) {
		return	GetAutoScalingRuleResponseUnmarshaller.unmarshall(this, context);
	}
