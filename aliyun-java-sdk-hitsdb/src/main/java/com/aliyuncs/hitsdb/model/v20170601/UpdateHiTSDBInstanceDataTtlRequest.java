 ...
 * @version 
 */
public class UpdateHiTSDBInstanceDataTtlRequest extends RpcAcsRequest<UpdateHiTSDBInstanceDataTtlResponse> {
	...
	@Override
	public Class<UpdateHiTSDBInstanceDataTtlResponse> getResponseClass() {
		return UpdateHiTSDBInstanceDataTtlResponse.class;
	}
