 ...
 * @version 
 */
public class ModifyHiTSDBInstanceSecurityIpListRequest extends RpcAcsRequest<ModifyHiTSDBInstanceSecurityIpListResponse> {
	...
	@Override
	public Class<ModifyHiTSDBInstanceSecurityIpListResponse> getResponseClass() {
		return ModifyHiTSDBInstanceSecurityIpListResponse.class;
	}
