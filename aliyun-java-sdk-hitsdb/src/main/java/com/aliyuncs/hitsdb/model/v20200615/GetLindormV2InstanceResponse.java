...
import com.aliyuncs.hitsdb.transform.v20200615.GetLindormV2InstanceResponseUnmarshaller;
 ...
 * @version 
 */
public class GetLindormV2InstanceResponse extends AcsResponse {
	...
	public static class EngineInfo {
		...
		public void setEnableCDC(String enableCDC) {
		...
		public void setEnableMaaS(String enableMaaS) {
		...
		public static class NodeGroupItem {
			...
			public void setIsScaleSpecGroup(Boolean isScaleSpecGroup) {
	...
	@Override
	public GetLindormV2InstanceResponse getInstance(UnmarshallerContext context) {
		return	GetLindormV2InstanceResponseUnmarshaller.unmarshall(this, context);
	}
