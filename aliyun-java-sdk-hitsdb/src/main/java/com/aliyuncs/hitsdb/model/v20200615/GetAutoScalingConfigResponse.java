...
import com.aliyuncs.hitsdb.transform.v20200615.GetAutoScalingConfigResponseUnmarshaller;
 ...
 * @version 
 */
public class GetAutoScalingConfigResponse extends AcsResponse {
	...
	@Override
	public GetAutoScalingConfigResponse getInstance(UnmarshallerContext context) {
		return	GetAutoScalingConfigResponseUnmarshaller.unmarshall(this, context);
	}
