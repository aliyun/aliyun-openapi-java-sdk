 ...
 * @version 
 */
public class CreateAutoScalingRuleRequest extends RpcAcsRequest<CreateAutoScalingRuleResponse> {
	...
	public CreateAutoScalingRuleRequest() {
		super("hitsdb", "2020-06-15", "CreateAutoScalingRule", "hitsdb");
	...
	@Override
	public Class<CreateAutoScalingRuleResponse> getResponseClass() {
		return CreateAutoScalingRuleResponse.class;
	}
