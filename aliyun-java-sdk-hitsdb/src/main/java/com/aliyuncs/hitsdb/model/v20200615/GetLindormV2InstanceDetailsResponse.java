...
import com.aliyuncs.hitsdb.transform.v20200615.GetLindormV2InstanceDetailsResponseUnmarshaller;
 ...
 * @version 
 */
public class GetLindormV2InstanceDetailsResponse extends AcsResponse {
	...
	public void setEnableFs(String enableFs) {
	...
	public void setEnableStoreTDE(String enableStoreTDE) {
	...
	@Override
	public GetLindormV2InstanceDetailsResponse getInstance(UnmarshallerContext context) {
		return	GetLindormV2InstanceDetailsResponseUnmarshaller.unmarshall(this, context);
	}
