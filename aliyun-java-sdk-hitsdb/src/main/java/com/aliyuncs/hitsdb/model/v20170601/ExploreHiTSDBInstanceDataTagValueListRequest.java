 ...
 * @version 
 */
public class ExploreHiTSDBInstanceDataTagValueListRequest extends RpcAcsRequest<ExploreHiTSDBInstanceDataTagValueListResponse> {
	...
	@Override
	public Class<ExploreHiTSDBInstanceDataTagValueListResponse> getResponseClass() {
		return ExploreHiTSDBInstanceDataTagValueListResponse.class;
	}
