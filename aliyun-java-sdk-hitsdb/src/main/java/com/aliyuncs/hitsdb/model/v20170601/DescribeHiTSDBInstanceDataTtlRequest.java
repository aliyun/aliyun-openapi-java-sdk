 ...
 * @version 
 */
public class DescribeHiTSDBInstanceDataTtlRequest extends RpcAcsRequest<DescribeHiTSDBInstanceDataTtlResponse> {
	...
	public DescribeHiTSDBInstanceDataTtlRequest() {
		super("hitsdb", "2017-06-01", "DescribeHiTSDBInstanceDataTtl", "hitsdb");
	...
	@Override
	public Class<DescribeHiTSDBInstanceDataTtlResponse> getResponseClass() {
		return DescribeHiTSDBInstanceDataTtlResponse.class;
	}
