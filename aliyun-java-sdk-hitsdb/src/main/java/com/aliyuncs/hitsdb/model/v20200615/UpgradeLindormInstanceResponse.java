...
public class UpgradeLindormInstanceResponse extends AcsResponse {
	...
	@Override
	public UpgradeLindormInstanceResponse getInstance(UnmarshallerContext context) {
		return	UpgradeLindormInstanceResponseUnmarshaller.unmarshall(this, context);
	}
