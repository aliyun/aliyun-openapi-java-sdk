 ...
 * @version 
 */
public class CheckCreateLindormV2InstanceRequest extends RpcAcsRequest<CheckCreateLindormV2InstanceResponse> {
	...
	public CheckCreateLindormV2InstanceRequest() {
		super("hitsdb", "2020-06-15", "CheckCreateLindormV2Instance", "hitsdb");
	...
	@Override
	public Class<CheckCreateLindormV2InstanceResponse> getResponseClass() {
		return CheckCreateLindormV2InstanceResponse.class;
	}
