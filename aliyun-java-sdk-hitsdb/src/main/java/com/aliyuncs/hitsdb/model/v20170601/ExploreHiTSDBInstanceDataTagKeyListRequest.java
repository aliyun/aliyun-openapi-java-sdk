 ...
 * @version 
 */
public class ExploreHiTSDBInstanceDataTagKeyListRequest extends RpcAcsRequest<ExploreHiTSDBInstanceDataTagKeyListResponse> {
	...
	public ExploreHiTSDBInstanceDataTagKeyListRequest() {
		super("hitsdb", "2017-06-01", "ExploreHiTSDBInstanceDataTagKeyList", "hitsdb");
	...
	@Override
	public Class<ExploreHiTSDBInstanceDataTagKeyListResponse> getResponseClass() {
		return ExploreHiTSDBInstanceDataTagKeyListResponse.class;
	}
