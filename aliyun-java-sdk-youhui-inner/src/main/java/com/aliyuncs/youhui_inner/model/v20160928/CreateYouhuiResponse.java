...
import com.aliyuncs.youhui_inner.transform.v20160928.CreateYouhuiResponseUnmarshaller;
 ...
 * @version 
 */
public class CreateYouhuiResponse extends AcsResponse {
	...
	@Override
	public CreateYouhuiResponse getInstance(UnmarshallerContext context) {
		return	CreateYouhuiResponseUnmarshaller.unmarshall(this, context);
	}
}
