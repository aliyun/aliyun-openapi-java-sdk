 ...
 * @version 
 */
public class IsTemplateYouhuiAvailableRequest extends RpcAcsRequest<IsTemplateYouhuiAvailableResponse> {
	
	public IsTemplateYouhuiAvailableRequest() {
		super("Youhui-inner", "2016-09-28", "IsTemplateYouhuiAvailable");
	}
	...
	@Override
	public Class<IsTemplateYouhuiAvailableResponse> getResponseClass() {
		return IsTemplateYouhuiAvailableResponse.class;
	}
