...
import com.aliyuncs.jaq.transform.v20161123.SpamRegisterPreventionResponseUnmarshaller;
 ...
 * @version 
 */
public class SpamRegisterPreventionResponse extends AcsResponse {
	...
	@Override
	public SpamRegisterPreventionResponse getInstance(UnmarshallerContext context) {
		return	SpamRegisterPreventionResponseUnmarshaller.unmarshall(this, context);
	}
}
