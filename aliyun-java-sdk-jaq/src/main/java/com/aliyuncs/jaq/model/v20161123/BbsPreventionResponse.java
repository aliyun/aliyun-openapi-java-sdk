...
import com.aliyuncs.jaq.transform.v20161123.BbsPreventionResponseUnmarshaller;
 ...
 * @version 
 */
public class BbsPreventionResponse extends AcsResponse {
	...
	@Override
	public BbsPreventionResponse getInstance(UnmarshallerContext context) {
		return	BbsPreventionResponseUnmarshaller.unmarshall(this, context);
	}
}
