...
import com.aliyuncs.jaq.transform.v20161123.ActivityPreventionResponseUnmarshaller;
 ...
 * @version 
 */
public class ActivityPreventionResponse extends AcsResponse {
	...
	@Override
	public ActivityPreventionResponse getInstance(UnmarshallerContext context) {
		return	ActivityPreventionResponseUnmarshaller.unmarshall(this, context);
	}
}
