...
import com.aliyuncs.jaq.transform.v20161123.CheckAccountAndPasswordRiskResponseUnmarshaller;
 ...
 * @version 
 */
public class CheckAccountAndPasswordRiskResponse extends AcsResponse {
	...
	@Override
	public CheckAccountAndPasswordRiskResponse getInstance(UnmarshallerContext context) {
		return	CheckAccountAndPasswordRiskResponseUnmarshaller.unmarshall(this, context);
	}
}
