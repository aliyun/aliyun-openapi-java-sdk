 ...
 * @version 
 */
public class OtherPreventionRequest extends RpcAcsRequest<OtherPreventionResponse> {
	
	public OtherPreventionRequest() {
		super("jaq", "2016-11-23", "OtherPrevention");
	}
	...
	public void setLoginDate(Long loginDate) {
		...
		putQueryParameter("LoginDate", loginDate);
	}
	...
	@Override
	public Class<OtherPreventionResponse> getResponseClass() {
		return OtherPreventionResponse.class;
	}
