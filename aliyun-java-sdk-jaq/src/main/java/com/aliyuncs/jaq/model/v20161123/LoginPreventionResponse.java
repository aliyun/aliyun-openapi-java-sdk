...
import com.aliyuncs.jaq.transform.v20161123.LoginPreventionResponseUnmarshaller;
 ...
 * @version 
 */
public class LoginPreventionResponse extends AcsResponse {
	...
	@Override
	public LoginPreventionResponse getInstance(UnmarshallerContext context) {
		return	LoginPreventionResponseUnmarshaller.unmarshall(this, context);
	}
}
