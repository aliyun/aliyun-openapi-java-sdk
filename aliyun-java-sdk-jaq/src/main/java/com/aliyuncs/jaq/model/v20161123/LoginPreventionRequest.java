 ...
 * @version 
 */
public class LoginPreventionRequest extends RpcAcsRequest<LoginPreventionResponse> {
	
	public LoginPreventionRequest() {
		super("jaq", "2016-11-23", "LoginPrevention");
	}
	...
	public Integer getAccountExist() {
		return this.accountExist;
	}

	public void setAccountExist(Integer accountExist) {
		this.accountExist = accountExist;
		putQueryParameter("AccountExist", accountExist);
	}
	...
	public void setPasswordHash(String passwordHash) {
		...
		putQueryParameter("PasswordHash", passwordHash);
	}
	...
	public Integer getPasswordCorrect() {
		return this.passwordCorrect;
	}

	public void setPasswordCorrect(Integer passwordCorrect) {
		this.passwordCorrect = passwordCorrect;
		putQueryParameter("PasswordCorrect", passwordCorrect);
	}

	@Override
	public Class<LoginPreventionResponse> getResponseClass() {
		return LoginPreventionResponse.class;
	}
