 ...
 * @version 
 */
public class BbsPreventionRequest extends RpcAcsRequest<BbsPreventionResponse> {
	
	public BbsPreventionRequest() {
		super("jaq", "2016-11-23", "BbsPrevention");
	}
	...
	@Override
	public Class<BbsPreventionResponse> getResponseClass() {
		return BbsPreventionResponse.class;
	}
