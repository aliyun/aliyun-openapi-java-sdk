 ...
 * @version 
 */
public class DetectMainBodyRequest extends RpcAcsRequest<DetectMainBodyResponse> {
	...
	@Override
	public Class<DetectMainBodyResponse> getResponseClass() {
		return DetectMainBodyResponse.class;
	}
