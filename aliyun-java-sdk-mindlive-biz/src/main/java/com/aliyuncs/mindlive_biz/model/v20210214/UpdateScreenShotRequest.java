 ...
 * @version 
 */
public class UpdateScreenShotRequest extends RpcAcsRequest<UpdateScreenShotResponse> {
	...
	public UpdateScreenShotRequest() {
		super("mindlive-biz", "2021-02-14", "UpdateScreenShot");
	...
	@Override
	public Class<UpdateScreenShotResponse> getResponseClass() {
		return UpdateScreenShotResponse.class;
	}
