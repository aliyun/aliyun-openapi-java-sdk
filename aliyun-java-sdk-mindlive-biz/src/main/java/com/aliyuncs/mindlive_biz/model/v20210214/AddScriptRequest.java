 ...
 * @version 
 */
public class AddScriptRequest extends RpcAcsRequest<AddScriptResponse> {
	...
	public AddScriptRequest() {
		super("mindlive-biz", "2021-02-14", "AddScript");
	...
	@Override
	public Class<AddScriptResponse> getResponseClass() {
		return AddScriptResponse.class;
	}
