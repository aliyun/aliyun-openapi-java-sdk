 ...
 * @version 
 */
public class RemoveGlobalSellingPointsRequest extends RpcAcsRequest<RemoveGlobalSellingPointsResponse> {
	...
	public RemoveGlobalSellingPointsRequest() {
		super("mindlive-biz", "2021-02-14", "RemoveGlobalSellingPoints");
	...
	@Override
	public Class<RemoveGlobalSellingPointsResponse> getResponseClass() {
		return RemoveGlobalSellingPointsResponse.class;
	}
