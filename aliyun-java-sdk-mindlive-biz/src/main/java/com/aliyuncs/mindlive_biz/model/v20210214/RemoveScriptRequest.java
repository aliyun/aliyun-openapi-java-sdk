 ...
 * @version 
 */
public class RemoveScriptRequest extends RpcAcsRequest<RemoveScriptResponse> {
	...
	public RemoveScriptRequest() {
		super("mindlive-biz", "2021-02-14", "RemoveScript");
	...
	@Override
	public Class<RemoveScriptResponse> getResponseClass() {
		return RemoveScriptResponse.class;
	}
