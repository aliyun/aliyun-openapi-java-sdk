...
import com.aliyuncs.mindlive_biz.transform.v20210214.RequestLoginInfoResponseUnmarshaller;
...
public class RequestLoginInfoResponse extends AcsResponse {
	...
	private List<DeviceStateDTO> data;
	...
	public List<DeviceStateDTO> getData() {
		return this.data;
	}

	public void setData(List<DeviceStateDTO> data) {
		this.data = data;
	}

	public static class DeviceStateDTO {
