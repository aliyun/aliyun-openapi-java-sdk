 ...
 * @version 
 */
public class RemovePromptRequest extends RpcAcsRequest<RemovePromptResponse> {
	...
	public RemovePromptRequest() {
		super("mindlive-biz", "2021-02-14", "RemovePrompt");
	...
	@Override
	public Class<RemovePromptResponse> getResponseClass() {
		return RemovePromptResponse.class;
	}
