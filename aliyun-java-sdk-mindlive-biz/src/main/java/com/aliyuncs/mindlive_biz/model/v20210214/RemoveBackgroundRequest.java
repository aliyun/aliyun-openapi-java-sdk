 ...
 * @version 
 */
public class RemoveBackgroundRequest extends RpcAcsRequest<RemoveBackgroundResponse> {
	...
	public RemoveBackgroundRequest() {
		super("mindlive-biz", "2021-02-14", "RemoveBackground");
	...
	@Override
	public Class<RemoveBackgroundResponse> getResponseClass() {
		return RemoveBackgroundResponse.class;
	}
