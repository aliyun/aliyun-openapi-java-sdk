 ...
 * @version 
 */
public class UpdateScriptRequest extends RpcAcsRequest<UpdateScriptResponse> {
	...
	public UpdateScriptRequest() {
		super("mindlive-biz", "2021-02-14", "UpdateScript");
	...
	@Override
	public Class<UpdateScriptResponse> getResponseClass() {
		return UpdateScriptResponse.class;
	}
