...
import com.aliyuncs.mindlive_biz.transform.v20210214.QueryLivePasterResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryLivePasterResponse extends AcsResponse {
	...
	@Override
	public QueryLivePasterResponse getInstance(UnmarshallerContext context) {
		return	QueryLivePasterResponseUnmarshaller.unmarshall(this, context);
	}
