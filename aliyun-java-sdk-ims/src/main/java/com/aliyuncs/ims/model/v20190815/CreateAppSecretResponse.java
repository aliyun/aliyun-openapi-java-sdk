...
import com.aliyuncs.ims.transform.v20190815.CreateAppSecretResponseUnmarshaller;
 ...
 * @version 
 */
public class CreateAppSecretResponse extends AcsResponse {
	...
	@Override
	public CreateAppSecretResponse getInstance(UnmarshallerContext context) {
		return	CreateAppSecretResponseUnmarshaller.unmarshall(this, context);
	}
}
