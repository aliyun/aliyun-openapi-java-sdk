 ...
 * @version 
 */
public class AddFingerprintToOIDCProviderRequest extends RpcAcsRequest<AddFingerprintToOIDCProviderResponse> {
	...
	@Override
	public Class<AddFingerprintToOIDCProviderResponse> getResponseClass() {
		return AddFingerprintToOIDCProviderResponse.class;
	}
