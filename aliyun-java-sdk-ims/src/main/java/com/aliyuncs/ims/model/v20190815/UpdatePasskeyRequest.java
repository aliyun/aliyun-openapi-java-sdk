 ...
 * @version 
 */
public class UpdatePasskeyRequest extends RpcAcsRequest<UpdatePasskeyResponse> {
	...
	public UpdatePasskeyRequest() {
		super("Ims", "2019-08-15", "UpdatePasskey", "ims");
	...
	public void setPasskeyName(String passkeyName) {
		...
		if(passkeyName != null){
			putQueryParameter("PasskeyName", passkeyName);
		}
	}
	...
	@Override
	public Class<UpdatePasskeyResponse> getResponseClass() {
		return UpdatePasskeyResponse.class;
	}
