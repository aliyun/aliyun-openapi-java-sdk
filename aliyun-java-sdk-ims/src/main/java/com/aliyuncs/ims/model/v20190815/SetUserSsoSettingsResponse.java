...
import com.aliyuncs.ims.transform.v20190815.SetUserSsoSettingsResponseUnmarshaller;
 ...
 * @version 
 */
public class SetUserSsoSettingsResponse extends AcsResponse {
	...
	@Override
	public SetUserSsoSettingsResponse getInstance(UnmarshallerContext context) {
		return	SetUserSsoSettingsResponseUnmarshaller.unmarshall(this, context);
	}
}
