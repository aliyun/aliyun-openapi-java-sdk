 ...
 * @version 
 */
public class GetSAMLProviderRequest extends RpcAcsRequest<GetSAMLProviderResponse> {
	...
	@Override
	public Class<GetSAMLProviderResponse> getResponseClass() {
		return GetSAMLProviderResponse.class;
	}
