 ...
 * @version 
 */
public class DeleteOIDCProviderRequest extends RpcAcsRequest<DeleteOIDCProviderResponse> {
	...
	@Override
	public Class<DeleteOIDCProviderResponse> getResponseClass() {
		return DeleteOIDCProviderResponse.class;
	}
