 ...
 * @version 
 */
public class AddClientIdToOIDCProviderRequest extends RpcAcsRequest<AddClientIdToOIDCProviderResponse> {
	...
	@Override
	public Class<AddClientIdToOIDCProviderResponse> getResponseClass() {
		return AddClientIdToOIDCProviderResponse.class;
	}
