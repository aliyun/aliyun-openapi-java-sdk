 ...
 * @version 
 */
public class DeleteAppSecretRequest extends RpcAcsRequest<DeleteAppSecretResponse> {
	...
	@Override
	public Class<DeleteAppSecretResponse> getResponseClass() {
		return DeleteAppSecretResponse.class;
	}
