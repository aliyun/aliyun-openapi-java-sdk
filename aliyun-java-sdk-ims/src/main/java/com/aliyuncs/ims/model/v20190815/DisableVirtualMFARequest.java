 ...
 * @version 
 */
public class DisableVirtualMFARequest extends RpcAcsRequest<DisableVirtualMFAResponse> {
	...
	@Override
	public Class<DisableVirtualMFAResponse> getResponseClass() {
		return DisableVirtualMFAResponse.class;
	}
