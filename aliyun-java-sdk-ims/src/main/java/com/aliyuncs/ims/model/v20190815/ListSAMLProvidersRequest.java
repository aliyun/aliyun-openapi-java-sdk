 ...
 * @version 
 */
public class ListSAMLProvidersRequest extends RpcAcsRequest<ListSAMLProvidersResponse> {
	...
	@Override
	public Class<ListSAMLProvidersResponse> getResponseClass() {
		return ListSAMLProvidersResponse.class;
	}
