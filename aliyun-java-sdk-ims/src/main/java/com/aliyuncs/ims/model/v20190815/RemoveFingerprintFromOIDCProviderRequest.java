 ...
 * @version 
 */
public class RemoveFingerprintFromOIDCProviderRequest extends RpcAcsRequest<RemoveFingerprintFromOIDCProviderResponse> {
	...
	public void setFingerprint(String fingerprint) {
		...
		if(fingerprint != null){
			putQueryParameter("Fingerprint", fingerprint);
		}
	}

	@Override
	public Class<RemoveFingerprintFromOIDCProviderResponse> getResponseClass() {
		return RemoveFingerprintFromOIDCProviderResponse.class;
	}
