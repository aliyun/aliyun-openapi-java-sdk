 ...
 * @version 
 */
public class RemoveClientIdFromOIDCProviderRequest extends RpcAcsRequest<RemoveClientIdFromOIDCProviderResponse> {
	...
	@Override
	public Class<RemoveClientIdFromOIDCProviderResponse> getResponseClass() {
		return RemoveClientIdFromOIDCProviderResponse.class;
	}
