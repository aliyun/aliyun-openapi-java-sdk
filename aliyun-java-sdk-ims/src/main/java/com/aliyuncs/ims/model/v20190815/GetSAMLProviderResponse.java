...
import com.aliyuncs.ims.transform.v20190815.GetSAMLProviderResponseUnmarshaller;
 ...
 * @version 
 */
public class GetSAMLProviderResponse extends AcsResponse {
	...
	@Override
	public GetSAMLProviderResponse getInstance(UnmarshallerContext context) {
		return	GetSAMLProviderResponseUnmarshaller.unmarshall(this, context);
	}
}
