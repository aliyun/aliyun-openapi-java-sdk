 ...
 * @version 
 */
public class GetOIDCProviderRequest extends RpcAcsRequest<GetOIDCProviderResponse> {
	...
	@Override
	public Class<GetOIDCProviderResponse> getResponseClass() {
		return GetOIDCProviderResponse.class;
	}
