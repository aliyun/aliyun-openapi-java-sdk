...
import com.aliyuncs.ims.transform.v20190815.RemoveClientIdFromOIDCProviderResponseUnmarshaller;
 ...
 * @version 
 */
public class RemoveClientIdFromOIDCProviderResponse extends AcsResponse {
	...
	@Override
	public RemoveClientIdFromOIDCProviderResponse getInstance(UnmarshallerContext context) {
		return	RemoveClientIdFromOIDCProviderResponseUnmarshaller.unmarshall(this, context);
	}
}
