...
import com.aliyuncs.ims.transform.v20190815.RemoveFingerprintFromOIDCProviderResponseUnmarshaller;
 ...
 * @version 
 */
public class RemoveFingerprintFromOIDCProviderResponse extends AcsResponse {
	...
	@Override
	public RemoveFingerprintFromOIDCProviderResponse getInstance(UnmarshallerContext context) {
		return	RemoveFingerprintFromOIDCProviderResponseUnmarshaller.unmarshall(this, context);
	}
}
