...
import com.aliyuncs.ims.model.v20190815.ListGroupsResponse;
import com.aliyuncs.ims.model.v20190815.ListGroupsResponse.Group;
...
public class ListGroupsResponseUnmarshaller {
	...
	public static ListGroupsResponse unmarshall(ListGroupsResponse listGroupsResponse, UnmarshallerContext _ctx) {
		...
		for (int i = 0; i < _ctx.lengthValue("ListGroupsResponse.Groups.Length"); i++) {
			...
			group.setDisplayName(_ctx.stringValue("ListGroupsResponse.Groups["+ i +"].DisplayName"));
			group.setGroupPrincipalName(_ctx.stringValue("ListGroupsResponse.Groups["+ i +"].GroupPrincipalName"));
