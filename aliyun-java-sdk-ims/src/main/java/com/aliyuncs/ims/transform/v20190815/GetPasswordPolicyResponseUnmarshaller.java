...
import com.aliyuncs.ims.model.v20190815.GetPasswordPolicyResponse;
import com.aliyuncs.ims.model.v20190815.GetPasswordPolicyResponse.PasswordPolicy;
...
public class GetPasswordPolicyResponseUnmarshaller {
	...
	public static GetPasswordPolicyResponse unmarshall(GetPasswordPolicyResponse getPasswordPolicyResponse, UnmarshallerContext _ctx) {
		...
		passwordPolicy.setPasswordNotContainUserName(_ctx.booleanValue("GetPasswordPolicyResponse.PasswordPolicy.PasswordNotContainUserName"));
		passwordPolicy.setMinimumPasswordDifferentCharacter(_ctx.integerValue("GetPasswordPolicyResponse.PasswordPolicy.MinimumPasswordDifferentCharacter"));
		passwordPolicy.setMaxPasswordAge(_ctx.integerValue("GetPasswordPolicyResponse.PasswordPolicy.MaxPasswordAge"));
		passwordPolicy.setHardExpire(_ctx.booleanValue("GetPasswordPolicyResponse.PasswordPolicy.HardExpire"));
