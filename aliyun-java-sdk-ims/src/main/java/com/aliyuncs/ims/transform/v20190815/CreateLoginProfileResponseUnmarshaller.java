...
import com.aliyuncs.ims.model.v20190815.CreateLoginProfileResponse;
import com.aliyuncs.ims.model.v20190815.CreateLoginProfileResponse.LoginProfile;
...
public class CreateLoginProfileResponseUnmarshaller {
	...
	public static CreateLoginProfileResponse unmarshall(CreateLoginProfileResponse createLoginProfileResponse, UnmarshallerContext _ctx) {
		...
		loginProfile.setUserPrincipalName(_ctx.stringValue("CreateLoginProfileResponse.LoginProfile.UserPrincipalName"));
		loginProfile.setStatus(_ctx.stringValue("CreateLoginProfileResponse.LoginProfile.Status"));
		loginProfile.setPassword(_ctx.stringValue("CreateLoginProfileResponse.LoginProfile.Password"));
		loginProfile.setUpdateDate(_ctx.stringValue("CreateLoginProfileResponse.LoginProfile.UpdateDate"));
