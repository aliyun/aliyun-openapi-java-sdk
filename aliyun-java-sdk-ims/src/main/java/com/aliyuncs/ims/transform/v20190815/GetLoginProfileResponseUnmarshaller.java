...
import com.aliyuncs.ims.model.v20190815.GetLoginProfileResponse;
import com.aliyuncs.ims.model.v20190815.GetLoginProfileResponse.LoginProfile;
...
public class GetLoginProfileResponseUnmarshaller {
	...
	public static GetLoginProfileResponse unmarshall(GetLoginProfileResponse getLoginProfileResponse, UnmarshallerContext _ctx) {
		...
		loginProfile.setStatus(_ctx.stringValue("GetLoginProfileResponse.LoginProfile.Status"));
		loginProfile.setUserPrincipalName(_ctx.stringValue("GetLoginProfileResponse.LoginProfile.UserPrincipalName"));
		loginProfile.setUpdateDate(_ctx.stringValue("GetLoginProfileResponse.LoginProfile.UpdateDate"));
		loginProfile.setLastLoginTime(_ctx.stringValue("GetLoginProfileResponse.LoginProfile.LastLoginTime"));
