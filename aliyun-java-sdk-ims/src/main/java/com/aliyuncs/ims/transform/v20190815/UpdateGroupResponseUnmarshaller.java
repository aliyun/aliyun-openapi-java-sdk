...
import com.aliyuncs.ims.model.v20190815.UpdateGroupResponse;
import com.aliyuncs.ims.model.v20190815.UpdateGroupResponse.Group;
...
public class UpdateGroupResponseUnmarshaller {
	...
	public static UpdateGroupResponse unmarshall(UpdateGroupResponse updateGroupResponse, UnmarshallerContext _ctx) {
		...
		group.setDisplayName(_ctx.stringValue("UpdateGroupResponse.Group.DisplayName"));
		group.setGroupPrincipalName(_ctx.stringValue("UpdateGroupResponse.Group.GroupPrincipalName"));
