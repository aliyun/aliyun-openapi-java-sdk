 ...
 * @version 
 */
public class UpdateExtendConfigRequest extends RoaAcsRequest<UpdateExtendConfigResponse> {
	...
	@Override
	public Class<UpdateExtendConfigResponse> getResponseClass() {
		return UpdateExtendConfigResponse.class;
	}
