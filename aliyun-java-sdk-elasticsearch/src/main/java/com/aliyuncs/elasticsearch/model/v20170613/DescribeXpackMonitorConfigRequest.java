 ...
 * @version 
 */
public class DescribeXpackMonitorConfigRequest extends RoaAcsRequest<DescribeXpackMonitorConfigResponse> {
	...
	@Override
	public Class<DescribeXpackMonitorConfigResponse> getResponseClass() {
		return DescribeXpackMonitorConfigResponse.class;
	}
