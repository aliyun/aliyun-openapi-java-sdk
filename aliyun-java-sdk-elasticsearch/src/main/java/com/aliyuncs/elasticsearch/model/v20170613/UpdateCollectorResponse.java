...
import com.aliyuncs.elasticsearch.transform.v20170613.UpdateCollectorResponseUnmarshaller;
 ...
 * @version 
 */
public class UpdateCollectorResponse extends AcsResponse {
	...
	@Override
	public UpdateCollectorResponse getInstance(UnmarshallerContext context) {
		return	UpdateCollectorResponseUnmarshaller.unmarshall(this, context);
	}
