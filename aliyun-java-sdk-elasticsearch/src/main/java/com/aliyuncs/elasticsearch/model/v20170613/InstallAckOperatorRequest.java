 ...
 * @version 
 */
public class InstallAckOperatorRequest extends RoaAcsRequest<InstallAckOperatorResponse> {
	...
	@Override
	public Class<InstallAckOperatorResponse> getResponseClass() {
		return InstallAckOperatorResponse.class;
	}
