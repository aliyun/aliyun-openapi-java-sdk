 ...
 * @version 
 */
public class UpdateXpackMonitorConfigRequest extends RoaAcsRequest<UpdateXpackMonitorConfigResponse> {
	...
	@Override
	public Class<UpdateXpackMonitorConfigResponse> getResponseClass() {
		return UpdateXpackMonitorConfigResponse.class;
	}
