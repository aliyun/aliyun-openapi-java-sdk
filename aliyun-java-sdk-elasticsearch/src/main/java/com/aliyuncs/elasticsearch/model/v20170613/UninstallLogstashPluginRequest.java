 ...
 * @version 
 */
public class UninstallLogstashPluginRequest extends RoaAcsRequest<UninstallLogstashPluginResponse> {
	...
	@Override
	public Class<UninstallLogstashPluginResponse> getResponseClass() {
		return UninstallLogstashPluginResponse.class;
	}
