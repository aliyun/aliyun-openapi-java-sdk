 ...
 * @version 
 */
public class CloseManagedIndexRequest extends RoaAcsRequest<CloseManagedIndexResponse> {
	...
	@Override
	public Class<CloseManagedIndexResponse> getResponseClass() {
		return CloseManagedIndexResponse.class;
	}
