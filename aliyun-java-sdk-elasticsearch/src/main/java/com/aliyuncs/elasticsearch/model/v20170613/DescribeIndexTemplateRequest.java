 ...
 * @version 
 */
public class DescribeIndexTemplateRequest extends RoaAcsRequest<DescribeIndexTemplateResponse> {
	...
	@Override
	public Class<DescribeIndexTemplateResponse> getResponseClass() {
		return DescribeIndexTemplateResponse.class;
	}
