 ...
 * @version 
 */
public class UpdateLogstashChargeTypeRequest extends RoaAcsRequest<UpdateLogstashChargeTypeResponse> {
	...
	@Override
	public Class<UpdateLogstashChargeTypeResponse> getResponseClass() {
		return UpdateLogstashChargeTypeResponse.class;
	}
