 ...
 * @version 
 */
public class ListPipelineIdsRequest extends RoaAcsRequest<ListPipelineIdsResponse> {
	...
	@Override
	public Class<ListPipelineIdsResponse> getResponseClass() {
		return ListPipelineIdsResponse.class;
	}
