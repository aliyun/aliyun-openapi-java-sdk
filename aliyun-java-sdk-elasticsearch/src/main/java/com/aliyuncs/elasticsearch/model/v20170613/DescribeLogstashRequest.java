 ...
 * @version 
 */
public class DescribeLogstashRequest extends RoaAcsRequest<DescribeLogstashResponse> {
	...
	@Override
	public Class<DescribeLogstashResponse> getResponseClass() {
		return DescribeLogstashResponse.class;
	}
