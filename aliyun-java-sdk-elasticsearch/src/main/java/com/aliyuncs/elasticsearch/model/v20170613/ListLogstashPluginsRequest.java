 ...
 * @version 
 */
public class ListLogstashPluginsRequest extends RoaAcsRequest<ListLogstashPluginsResponse> {
	...
	@Override
	public Class<ListLogstashPluginsResponse> getResponseClass() {
		return ListLogstashPluginsResponse.class;
	}
