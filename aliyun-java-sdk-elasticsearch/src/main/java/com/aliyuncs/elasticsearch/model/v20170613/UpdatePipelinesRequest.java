 ...
 * @version 
 */
public class UpdatePipelinesRequest extends RoaAcsRequest<UpdatePipelinesResponse> {
	...
	@Override
	public Class<UpdatePipelinesResponse> getResponseClass() {
		return UpdatePipelinesResponse.class;
	}
