 ...
 * @version 
 */
public class DescribeDiagnosisSettingsRequest extends RoaAcsRequest<DescribeDiagnosisSettingsResponse> {
	...
	@Override
	public Class<DescribeDiagnosisSettingsResponse> getResponseClass() {
		return DescribeDiagnosisSettingsResponse.class;
	}
