...
public class UpdateSnapshotSettingRequest extends RoaAcsRequest<UpdateSnapshotSettingResponse> {
	...
	public UpdateSnapshotSettingRequest() {
		super("elasticsearch", "2017-06-13", "UpdateSnapshotSetting", "elasticsearche");
	...
	@Override
	public Class<UpdateSnapshotSettingResponse> getResponseClass() {
		return UpdateSnapshotSettingResponse.class;
	}
