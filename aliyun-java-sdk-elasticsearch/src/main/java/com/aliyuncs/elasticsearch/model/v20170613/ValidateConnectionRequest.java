 ...
 * @version 
 */
public class ValidateConnectionRequest extends RoaAcsRequest<ValidateConnectionResponse> {
	...
	@Override
	public Class<ValidateConnectionResponse> getResponseClass() {
		return ValidateConnectionResponse.class;
	}
