 ...
 * @version 
 */
public class EstimatedRestartTimeRequest extends RoaAcsRequest<EstimatedRestartTimeResponse> {
	...
	@Override
	public Class<EstimatedRestartTimeResponse> getResponseClass() {
		return EstimatedRestartTimeResponse.class;
	}
