 ...
 * @version 
 */
public class RestartLogstashRequest extends RoaAcsRequest<RestartLogstashResponse> {
	...
	@Override
	public Class<RestartLogstashResponse> getResponseClass() {
		return RestartLogstashResponse.class;
	}
