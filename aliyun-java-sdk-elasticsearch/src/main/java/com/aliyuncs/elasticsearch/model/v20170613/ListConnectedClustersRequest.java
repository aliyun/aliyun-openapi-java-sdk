 ...
 * @version 
 */
public class ListConnectedClustersRequest extends RoaAcsRequest<ListConnectedClustersResponse> {
	...
	@Override
	public Class<ListConnectedClustersResponse> getResponseClass() {
		return ListConnectedClustersResponse.class;
	}
