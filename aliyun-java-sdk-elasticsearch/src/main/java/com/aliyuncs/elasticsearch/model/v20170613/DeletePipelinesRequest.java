 ...
 * @version 
 */
public class DeletePipelinesRequest extends RoaAcsRequest<DeletePipelinesResponse> {
	...
	@Override
	public Class<DeletePipelinesResponse> getResponseClass() {
		return DeletePipelinesResponse.class;
	}
