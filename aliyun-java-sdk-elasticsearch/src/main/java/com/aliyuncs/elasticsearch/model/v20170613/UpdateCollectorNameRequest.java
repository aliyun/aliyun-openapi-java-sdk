 ...
 * @version 
 */
public class UpdateCollectorNameRequest extends RoaAcsRequest<UpdateCollectorNameResponse> {
	...
	@Override
	public Class<UpdateCollectorNameResponse> getResponseClass() {
		return UpdateCollectorNameResponse.class;
	}
