...
import com.aliyuncs.elasticsearch.transform.v20170613.UpdateCollectorNameResponseUnmarshaller;
 ...
 * @version 
 */
public class UpdateCollectorNameResponse extends AcsResponse {
	...
	@Override
	public UpdateCollectorNameResponse getInstance(UnmarshallerContext context) {
		return	UpdateCollectorNameResponseUnmarshaller.unmarshall(this, context);
	}
