...
public class ListKibanaPluginsRequest extends RoaAcsRequest<ListKibanaPluginsResponse> {
	...
	public ListKibanaPluginsRequest() {
		super("elasticsearch", "2017-06-13", "ListKibanaPlugins", "elasticsearche");
	...
	@Override
	public Class<ListKibanaPluginsResponse> getResponseClass() {
		return ListKibanaPluginsResponse.class;
	}
