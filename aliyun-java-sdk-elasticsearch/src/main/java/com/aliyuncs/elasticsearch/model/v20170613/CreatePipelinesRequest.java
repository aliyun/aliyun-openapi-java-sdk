 ...
 * @version 
 */
public class CreatePipelinesRequest extends RoaAcsRequest<CreatePipelinesResponse> {
	...
	@Override
	public Class<CreatePipelinesResponse> getResponseClass() {
		return CreatePipelinesResponse.class;
	}
