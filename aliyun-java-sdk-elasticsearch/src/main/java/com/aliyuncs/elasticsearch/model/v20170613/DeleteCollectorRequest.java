 ...
 * @version 
 */
public class DeleteCollectorRequest extends RoaAcsRequest<DeleteCollectorResponse> {
	...
	@Override
	public Class<DeleteCollectorResponse> getResponseClass() {
		return DeleteCollectorResponse.class;
	}
