 ...
 * @version 
 */
public class ModifyElastictaskRequest extends RoaAcsRequest<ModifyElastictaskResponse> {
	...
	@Override
	public Class<ModifyElastictaskResponse> getResponseClass() {
		return ModifyElastictaskResponse.class;
	}
