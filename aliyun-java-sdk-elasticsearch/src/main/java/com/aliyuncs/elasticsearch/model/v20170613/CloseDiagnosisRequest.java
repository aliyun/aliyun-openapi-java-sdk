 ...
 * @version 
 */
public class CloseDiagnosisRequest extends RoaAcsRequest<CloseDiagnosisResponse> {
	...
	@Override
	public Class<CloseDiagnosisResponse> getResponseClass() {
		return CloseDiagnosisResponse.class;
	}
