 ...
 * @version 
 */
public class StopPipelinesRequest extends RoaAcsRequest<StopPipelinesResponse> {
	...
	@Override
	public Class<StopPipelinesResponse> getResponseClass() {
		return StopPipelinesResponse.class;
	}
