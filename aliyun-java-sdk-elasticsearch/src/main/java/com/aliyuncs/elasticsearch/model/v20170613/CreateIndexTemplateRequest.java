 ...
 * @version 
 */
public class CreateIndexTemplateRequest extends RoaAcsRequest<CreateIndexTemplateResponse> {
	...
	@Override
	public Class<CreateIndexTemplateResponse> getResponseClass() {
		return CreateIndexTemplateResponse.class;
	}
