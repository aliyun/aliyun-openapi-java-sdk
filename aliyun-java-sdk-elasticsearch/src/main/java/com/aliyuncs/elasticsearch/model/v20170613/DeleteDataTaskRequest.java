 ...
 * @version 
 */
public class DeleteDataTaskRequest extends RoaAcsRequest<DeleteDataTaskResponse> {
	...
	@Override
	public Class<DeleteDataTaskResponse> getResponseClass() {
		return DeleteDataTaskResponse.class;
	}
