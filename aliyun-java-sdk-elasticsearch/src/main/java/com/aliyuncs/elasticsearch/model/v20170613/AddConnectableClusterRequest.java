 ...
 * @version 
 */
public class AddConnectableClusterRequest extends RoaAcsRequest<AddConnectableClusterResponse> {
	...
	@Override
	public Class<AddConnectableClusterResponse> getResponseClass() {
		return AddConnectableClusterResponse.class;
	}
