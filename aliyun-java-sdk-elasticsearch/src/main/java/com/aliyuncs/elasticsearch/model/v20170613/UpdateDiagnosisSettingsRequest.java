 ...
 * @version 
 */
public class UpdateDiagnosisSettingsRequest extends RoaAcsRequest<UpdateDiagnosisSettingsResponse> {
	...
	@Override
	public Class<UpdateDiagnosisSettingsResponse> getResponseClass() {
		return UpdateDiagnosisSettingsResponse.class;
	}
