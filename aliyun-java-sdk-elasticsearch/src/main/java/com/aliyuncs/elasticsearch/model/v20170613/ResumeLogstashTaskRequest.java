 ...
 * @version 
 */
public class ResumeLogstashTaskRequest extends RoaAcsRequest<ResumeLogstashTaskResponse> {
	...
	@Override
	public Class<ResumeLogstashTaskResponse> getResponseClass() {
		return ResumeLogstashTaskResponse.class;
	}
