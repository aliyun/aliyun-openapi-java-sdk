 ...
 * @version 
 */
public class UpdatePipelineManagementConfigRequest extends RoaAcsRequest<UpdatePipelineManagementConfigResponse> {
	...
	@Override
	public Class<UpdatePipelineManagementConfigResponse> getResponseClass() {
		return UpdatePipelineManagementConfigResponse.class;
	}
