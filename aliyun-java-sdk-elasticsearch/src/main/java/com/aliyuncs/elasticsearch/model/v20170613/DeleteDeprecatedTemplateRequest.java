 ...
 * @version 
 */
public class DeleteDeprecatedTemplateRequest extends RoaAcsRequest<DeleteDeprecatedTemplateResponse> {
	...
	@Override
	public Class<DeleteDeprecatedTemplateResponse> getResponseClass() {
		return DeleteDeprecatedTemplateResponse.class;
	}
