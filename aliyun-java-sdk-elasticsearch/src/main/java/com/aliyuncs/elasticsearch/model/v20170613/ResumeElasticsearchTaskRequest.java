 ...
 * @version 
 */
public class ResumeElasticsearchTaskRequest extends RoaAcsRequest<ResumeElasticsearchTaskResponse> {
	...
	@Override
	public Class<ResumeElasticsearchTaskResponse> getResponseClass() {
		return ResumeElasticsearchTaskResponse.class;
	}
