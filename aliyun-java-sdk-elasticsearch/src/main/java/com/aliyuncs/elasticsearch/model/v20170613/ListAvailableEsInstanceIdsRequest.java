 ...
 * @version 
 */
public class ListAvailableEsInstanceIdsRequest extends RoaAcsRequest<ListAvailableEsInstanceIdsResponse> {
	...
	@Override
	public Class<ListAvailableEsInstanceIdsResponse> getResponseClass() {
		return ListAvailableEsInstanceIdsResponse.class;
	}
