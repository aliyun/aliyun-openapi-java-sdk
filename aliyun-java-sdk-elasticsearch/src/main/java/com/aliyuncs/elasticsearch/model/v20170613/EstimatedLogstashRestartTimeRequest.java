 ...
 * @version 
 */
public class EstimatedLogstashRestartTimeRequest extends RoaAcsRequest<EstimatedLogstashRestartTimeResponse> {
	...
	@Override
	public Class<EstimatedLogstashRestartTimeResponse> getResponseClass() {
		return EstimatedLogstashRestartTimeResponse.class;
	}
