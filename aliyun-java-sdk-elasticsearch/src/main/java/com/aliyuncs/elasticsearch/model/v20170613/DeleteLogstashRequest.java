 ...
 * @version 
 */
public class DeleteLogstashRequest extends RoaAcsRequest<DeleteLogstashResponse> {
	...
	@Override
	public Class<DeleteLogstashResponse> getResponseClass() {
		return DeleteLogstashResponse.class;
	}
