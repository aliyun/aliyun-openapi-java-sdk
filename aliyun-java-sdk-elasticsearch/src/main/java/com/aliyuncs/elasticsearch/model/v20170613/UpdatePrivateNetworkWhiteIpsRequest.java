...
public class UpdatePrivateNetworkWhiteIpsRequest extends RoaAcsRequest<UpdatePrivateNetworkWhiteIpsResponse> {
	...
	public UpdatePrivateNetworkWhiteIpsRequest() {
		super("elasticsearch", "2017-06-13", "UpdatePrivateNetworkWhiteIps", "elasticsearche");
	...
	@Override
	public Class<UpdatePrivateNetworkWhiteIpsResponse> getResponseClass() {
		return UpdatePrivateNetworkWhiteIpsResponse.class;
	}
