 ...
 * @version 
 */
public class AddSnapshotRepoRequest extends RoaAcsRequest<AddSnapshotRepoResponse> {
	...
	@Override
	public Class<AddSnapshotRepoResponse> getResponseClass() {
		return AddSnapshotRepoResponse.class;
	}
