 ...
 * @version 
 */
public class UpdateReadWritePolicyRequest extends RoaAcsRequest<UpdateReadWritePolicyResponse> {
	...
	@Override
	public Class<UpdateReadWritePolicyResponse> getResponseClass() {
		return UpdateReadWritePolicyResponse.class;
	}
