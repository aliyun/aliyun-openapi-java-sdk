 ...
 * @version 
 */
public class ReinstallCollectorRequest extends RoaAcsRequest<ReinstallCollectorResponse> {
	...
	@Override
	public Class<ReinstallCollectorResponse> getResponseClass() {
		return ReinstallCollectorResponse.class;
	}
