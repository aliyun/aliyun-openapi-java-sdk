 ...
 * @version 
 */
public class UpgradeEngineVersionRequest extends RoaAcsRequest<UpgradeEngineVersionResponse> {
	...
	@Override
	public Class<UpgradeEngineVersionResponse> getResponseClass() {
		return UpgradeEngineVersionResponse.class;
	}
