 ...
 * @version 
 */
public class StopCollectorRequest extends RoaAcsRequest<StopCollectorResponse> {
	...
	@Override
	public Class<StopCollectorResponse> getResponseClass() {
		return StopCollectorResponse.class;
	}
