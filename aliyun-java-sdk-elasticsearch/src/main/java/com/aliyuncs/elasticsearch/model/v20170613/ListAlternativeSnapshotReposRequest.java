 ...
 * @version 
 */
public class ListAlternativeSnapshotReposRequest extends RoaAcsRequest<ListAlternativeSnapshotReposResponse> {
	...
	@Override
	public Class<ListAlternativeSnapshotReposResponse> getResponseClass() {
		return ListAlternativeSnapshotReposResponse.class;
	}
