 ...
 * @version 
 */
public class StartCollectorRequest extends RoaAcsRequest<StartCollectorResponse> {
	...
	@Override
	public Class<StartCollectorResponse> getResponseClass() {
		return StartCollectorResponse.class;
	}
