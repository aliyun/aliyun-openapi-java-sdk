 ...
 * @version 
 */
public class DiagnoseInstanceRequest extends RoaAcsRequest<DiagnoseInstanceResponse> {
	...
	@Override
	public Class<DiagnoseInstanceResponse> getResponseClass() {
		return DiagnoseInstanceResponse.class;
	}
