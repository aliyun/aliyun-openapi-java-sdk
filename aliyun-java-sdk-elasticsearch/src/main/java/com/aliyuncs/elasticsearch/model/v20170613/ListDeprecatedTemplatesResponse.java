...
import com.aliyuncs.elasticsearch.transform.v20170613.ListDeprecatedTemplatesResponseUnmarshaller;
 ...
 * @version 
 */
public class ListDeprecatedTemplatesResponse extends AcsResponse {
	...
	@Override
	public ListDeprecatedTemplatesResponse getInstance(UnmarshallerContext context) {
		return	ListDeprecatedTemplatesResponseUnmarshaller.unmarshall(this, context);
	}
