 ...
 * @version 
 */
public class RolloverDataStreamRequest extends RoaAcsRequest<RolloverDataStreamResponse> {
	...
	@Override
	public Class<RolloverDataStreamResponse> getResponseClass() {
		return RolloverDataStreamResponse.class;
	}
