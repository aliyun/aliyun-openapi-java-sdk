 ...
 * @version 
 */
public class ListDataTasksRequest extends RoaAcsRequest<ListDataTasksResponse> {
	...
	@Override
	public Class<ListDataTasksResponse> getResponseClass() {
		return ListDataTasksResponse.class;
	}
