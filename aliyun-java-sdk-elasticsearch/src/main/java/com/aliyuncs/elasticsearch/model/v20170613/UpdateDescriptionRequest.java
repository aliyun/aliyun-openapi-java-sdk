...
public class UpdateDescriptionRequest extends RoaAcsRequest<UpdateDescriptionResponse> {
	...
	public UpdateDescriptionRequest() {
		super("elasticsearch", "2017-06-13", "UpdateDescription", "elasticsearche");
	...
	@Override
	public Class<UpdateDescriptionResponse> getResponseClass() {
		return UpdateDescriptionResponse.class;
	}
