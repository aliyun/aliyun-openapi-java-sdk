 ...
 * @version 
 */
public class InterruptElasticsearchTaskRequest extends RoaAcsRequest<InterruptElasticsearchTaskResponse> {
	...
	@Override
	public Class<InterruptElasticsearchTaskResponse> getResponseClass() {
		return InterruptElasticsearchTaskResponse.class;
	}
