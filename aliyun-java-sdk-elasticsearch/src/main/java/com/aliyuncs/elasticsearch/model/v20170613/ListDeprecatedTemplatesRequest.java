 ...
 * @version 
 */
public class ListDeprecatedTemplatesRequest extends RoaAcsRequest<ListDeprecatedTemplatesResponse> {
	...
	@Override
	public Class<ListDeprecatedTemplatesResponse> getResponseClass() {
		return ListDeprecatedTemplatesResponse.class;
	}
