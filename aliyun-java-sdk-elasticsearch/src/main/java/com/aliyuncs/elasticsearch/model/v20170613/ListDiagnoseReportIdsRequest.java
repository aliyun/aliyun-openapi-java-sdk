 ...
 * @version 
 */
public class ListDiagnoseReportIdsRequest extends RoaAcsRequest<ListDiagnoseReportIdsResponse> {
	...
	@Override
	public Class<ListDiagnoseReportIdsResponse> getResponseClass() {
		return ListDiagnoseReportIdsResponse.class;
	}
