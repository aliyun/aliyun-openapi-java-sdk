 ...
 * @version 
 */
public class UpdateCollectorRequest extends RoaAcsRequest<UpdateCollectorResponse> {
	...
	@Override
	public Class<UpdateCollectorResponse> getResponseClass() {
		return UpdateCollectorResponse.class;
	}
