 ...
 * @version 
 */
public class ListExtendfilesRequest extends RoaAcsRequest<ListExtendfilesResponse> {
	...
	@Override
	public Class<ListExtendfilesResponse> getResponseClass() {
		return ListExtendfilesResponse.class;
	}
