 ...
 * @version 
 */
public class DeleteILMPolicyRequest extends RoaAcsRequest<DeleteILMPolicyResponse> {
	...
	@Override
	public Class<DeleteILMPolicyResponse> getResponseClass() {
		return DeleteILMPolicyResponse.class;
	}
