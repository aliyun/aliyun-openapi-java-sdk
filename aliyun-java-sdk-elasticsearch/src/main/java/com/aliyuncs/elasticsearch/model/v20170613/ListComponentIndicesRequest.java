 ...
 * @version 
 */
public class ListComponentIndicesRequest extends RoaAcsRequest<ListComponentIndicesResponse> {
	...
	@Override
	public Class<ListComponentIndicesResponse> getResponseClass() {
		return ListComponentIndicesResponse.class;
	}
