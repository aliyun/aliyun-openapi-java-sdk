 ...
 * @version 
 */
public class GetHeatMapDataRequest extends RpcAcsRequest<GetHeatMapDataResponse> {
	
	public GetHeatMapDataRequest() {
		super("cusanalytic_sc_online", "2019-05-24", "GetHeatMapData");
		try {
	...
	public void setEMapName(String eMapName) {
		...
		if(eMapName != null){
			putBodyParameter("EMapName", eMapName);
		}
	}
	...
	@Override
	public Class<GetHeatMapDataResponse> getResponseClass() {
		return GetHeatMapDataResponse.class;
	}
