 ...
 * @version 
 */
public class DescribeTopBigKeysRequest extends RpcAcsRequest<DescribeTopBigKeysResponse> {
	...
	@Override
	public Class<DescribeTopBigKeysResponse> getResponseClass() {
		return DescribeTopBigKeysResponse.class;
	}
