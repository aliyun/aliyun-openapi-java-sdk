 ...
 * @version 
 */
public class DescribeTopHotKeysRequest extends RpcAcsRequest<DescribeTopHotKeysResponse> {
	...
	@Override
	public Class<DescribeTopHotKeysResponse> getResponseClass() {
		return DescribeTopHotKeysResponse.class;
	}
