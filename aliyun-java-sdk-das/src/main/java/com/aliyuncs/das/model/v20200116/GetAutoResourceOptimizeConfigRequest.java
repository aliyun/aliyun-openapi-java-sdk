 ...
 * @version 
 */
public class GetAutoResourceOptimizeConfigRequest extends RpcAcsRequest<GetAutoResourceOptimizeConfigResponse> {
	...
	@Override
	public Class<GetAutoResourceOptimizeConfigResponse> getResponseClass() {
		return GetAutoResourceOptimizeConfigResponse.class;
	}
