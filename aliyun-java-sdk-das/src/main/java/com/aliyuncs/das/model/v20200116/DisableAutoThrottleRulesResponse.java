...
import com.aliyuncs.das.transform.v20200116.DisableAutoThrottleRulesResponseUnmarshaller;
 ...
 * @version 
 */
public class DisableAutoThrottleRulesResponse extends AcsResponse {
	...
	@Override
	public DisableAutoThrottleRulesResponse getInstance(UnmarshallerContext context) {
		return	DisableAutoThrottleRulesResponseUnmarshaller.unmarshall(this, context);
	}
