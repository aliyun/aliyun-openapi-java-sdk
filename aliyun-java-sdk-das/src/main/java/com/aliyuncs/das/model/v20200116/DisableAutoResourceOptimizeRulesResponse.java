...
import com.aliyuncs.das.transform.v20200116.DisableAutoResourceOptimizeRulesResponseUnmarshaller;
 ...
 * @version 
 */
public class DisableAutoResourceOptimizeRulesResponse extends AcsResponse {
	...
	@Override
	public DisableAutoResourceOptimizeRulesResponse getInstance(UnmarshallerContext context) {
		return	DisableAutoResourceOptimizeRulesResponseUnmarshaller.unmarshall(this, context);
	}
