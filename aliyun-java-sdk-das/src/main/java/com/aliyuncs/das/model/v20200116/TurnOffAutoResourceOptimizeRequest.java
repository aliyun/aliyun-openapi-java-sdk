 ...
 * @version 
 */
public class TurnOffAutoResourceOptimizeRequest extends RpcAcsRequest<TurnOffAutoResourceOptimizeResponse> {
	...
	@Override
	public Class<TurnOffAutoResourceOptimizeResponse> getResponseClass() {
		return TurnOffAutoResourceOptimizeResponse.class;
	}
