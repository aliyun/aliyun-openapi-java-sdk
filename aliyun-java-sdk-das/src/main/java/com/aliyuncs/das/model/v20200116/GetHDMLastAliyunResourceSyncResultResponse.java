...
import com.aliyuncs.das.transform.v20200116.GetHDMLastAliyunResourceSyncResultResponseUnmarshaller;
...
public class GetHDMLastAliyunResourceSyncResultResponse extends AcsResponse {
	...
	@Override
	public GetHDMLastAliyunResourceSyncResultResponse getInstance(UnmarshallerContext context) {
		return	GetHDMLastAliyunResourceSyncResultResponseUnmarshaller.unmarshall(this, context);
	}
}
