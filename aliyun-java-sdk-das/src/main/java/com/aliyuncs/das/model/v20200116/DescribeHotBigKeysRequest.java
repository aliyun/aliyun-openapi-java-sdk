 ...
 * @version 
 */
public class DescribeHotBigKeysRequest extends RpcAcsRequest<DescribeHotBigKeysResponse> {
	...
	@Override
	public Class<DescribeHotBigKeysResponse> getResponseClass() {
		return DescribeHotBigKeysResponse.class;
	}
