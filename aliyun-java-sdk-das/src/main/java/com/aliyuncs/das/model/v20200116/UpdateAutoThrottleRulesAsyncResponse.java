...
import com.aliyuncs.das.transform.v20200116.UpdateAutoThrottleRulesAsyncResponseUnmarshaller;
 ...
 * @version 
 */
public class UpdateAutoThrottleRulesAsyncResponse extends AcsResponse {
	...
	@Override
	public UpdateAutoThrottleRulesAsyncResponse getInstance(UnmarshallerContext context) {
		return	UpdateAutoThrottleRulesAsyncResponseUnmarshaller.unmarshall(this, context);
	}
