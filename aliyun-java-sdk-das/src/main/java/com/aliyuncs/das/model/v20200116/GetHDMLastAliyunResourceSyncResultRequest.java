 ...
 * @version 
 */
public class GetHDMLastAliyunResourceSyncResultRequest extends RpcAcsRequest<GetHDMLastAliyunResourceSyncResultResponse> {
	...
	@Override
	public Class<GetHDMLastAliyunResourceSyncResultResponse> getResponseClass() {
		return GetHDMLastAliyunResourceSyncResultResponse.class;
	}
