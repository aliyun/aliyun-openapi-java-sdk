 ...
 * @version 
 */
public class GetHDMAliyunResourceSyncResultRequest extends RpcAcsRequest<GetHDMAliyunResourceSyncResultResponse> {
	...
	public GetHDMAliyunResourceSyncResultRequest() {
		super("DAS", "2020-01-16", "GetHDMAliyunResourceSyncResult", "hdm");
	...
	@Override
	public Class<GetHDMAliyunResourceSyncResultResponse> getResponseClass() {
		return GetHDMAliyunResourceSyncResultResponse.class;
	}
