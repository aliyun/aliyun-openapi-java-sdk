...
import com.aliyuncs.drds.model.v20190123.DescribeRdsDrdsDBResponse;
import com.aliyuncs.drds.model.v20190123.DescribeRdsDrdsDBResponse.RdsDrdsDb;
...
public class DescribeRdsDrdsDBResponseUnmarshaller {
	...
	public static DescribeRdsDrdsDBResponse unmarshall(DescribeRdsDrdsDBResponse describeRdsDrdsDBResponse, UnmarshallerContext _ctx) {
		...
		List<RdsDrdsDb> rdsDrdsDbs = new ArrayList<RdsDrdsDb>();
		for (int i = 0; i < _ctx.lengthValue("DescribeRdsDrdsDBResponse.RdsDrdsDbs.Length"); i++) {
			...
			rdsDrdsDbs.add(rdsDrdsDb);
		}
		describeRdsDrdsDBResponse.setRdsDrdsDbs(rdsDrdsDbs);
