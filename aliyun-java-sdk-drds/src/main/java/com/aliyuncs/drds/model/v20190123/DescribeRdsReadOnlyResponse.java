...
import com.aliyuncs.drds.transform.v20190123.DescribeRdsReadOnlyResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeRdsReadOnlyResponse extends AcsResponse {
	...
	@Override
	public DescribeRdsReadOnlyResponse getInstance(UnmarshallerContext context) {
		return	DescribeRdsReadOnlyResponseUnmarshaller.unmarshall(this, context);
	}
}
