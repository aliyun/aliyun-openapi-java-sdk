...
import com.aliyuncs.drds.transform.v20190123.GetBatchEvaluateTaskReportResponseUnmarshaller;
 ...
 * @version 
 */
public class GetBatchEvaluateTaskReportResponse extends AcsResponse {
	...
	@Override
	public GetBatchEvaluateTaskReportResponse getInstance(UnmarshallerContext context) {
		return	GetBatchEvaluateTaskReportResponseUnmarshaller.unmarshall(this, context);
	}
}
