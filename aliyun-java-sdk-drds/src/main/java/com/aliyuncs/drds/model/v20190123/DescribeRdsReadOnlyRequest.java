 ...
 * @version 
 */
public class DescribeRdsReadOnlyRequest extends RpcAcsRequest<DescribeRdsReadOnlyResponse> {
	...
	public DescribeRdsReadOnlyRequest() {
		super("Drds", "2019-01-23", "DescribeRdsReadOnly");
	...
	@Override
	public Class<DescribeRdsReadOnlyResponse> getResponseClass() {
		return DescribeRdsReadOnlyResponse.class;
	}
