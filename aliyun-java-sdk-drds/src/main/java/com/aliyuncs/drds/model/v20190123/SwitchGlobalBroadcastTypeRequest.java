...
public class SwitchGlobalBroadcastTypeRequest extends RpcAcsRequest<SwitchGlobalBroadcastTypeResponse> {
	...
	public SwitchGlobalBroadcastTypeRequest() {
		super("Drds", "2019-01-23", "SwitchGlobalBroadcastType");
	...
	@Override
	public Class<SwitchGlobalBroadcastTypeResponse> getResponseClass() {
		return SwitchGlobalBroadcastTypeResponse.class;
	}
