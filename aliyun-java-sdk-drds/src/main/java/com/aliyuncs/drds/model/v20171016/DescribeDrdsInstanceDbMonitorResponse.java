...
import com.aliyuncs.drds.transform.v20171016.DescribeDrdsInstanceDbMonitorResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeDrdsInstanceDbMonitorResponse extends AcsResponse {
	...
	@Override
	public DescribeDrdsInstanceDbMonitorResponse getInstance(UnmarshallerContext context) {
		return	DescribeDrdsInstanceDbMonitorResponseUnmarshaller.unmarshall(this, context);
	}
}
