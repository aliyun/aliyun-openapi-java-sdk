...
import com.aliyuncs.drds.transform.v20190123.DescribePreCheckResultResponseUnmarshaller;
...
public class DescribePreCheckResultResponse extends AcsResponse {
	...
	@Override
	public DescribePreCheckResultResponse getInstance(UnmarshallerContext context) {
		return	DescribePreCheckResultResponseUnmarshaller.unmarshall(this, context);
	}
