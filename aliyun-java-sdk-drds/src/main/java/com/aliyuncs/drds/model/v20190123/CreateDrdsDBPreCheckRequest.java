 ...
 * @version 
 */
public class CreateDrdsDBPreCheckRequest extends RpcAcsRequest<CreateDrdsDBPreCheckResponse> {
	
	public CreateDrdsDBPreCheckRequest() {
		super("Drds", "2019-01-23", "CreateDrdsDBPreCheck", "drds");
	}
	...
	@Override
	public Class<CreateDrdsDBPreCheckResponse> getResponseClass() {
		return CreateDrdsDBPreCheckResponse.class;
	}
