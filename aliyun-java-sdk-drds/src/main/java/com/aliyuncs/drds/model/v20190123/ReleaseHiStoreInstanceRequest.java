 ...
 * @version 
 */
public class ReleaseHiStoreInstanceRequest extends RpcAcsRequest<ReleaseHiStoreInstanceResponse> {
	...
	public ReleaseHiStoreInstanceRequest() {
		super("Drds", "2019-01-23", "ReleaseHiStoreInstance");
	...
	@Override
	public Class<ReleaseHiStoreInstanceResponse> getResponseClass() {
		return ReleaseHiStoreInstanceResponse.class;
	}
