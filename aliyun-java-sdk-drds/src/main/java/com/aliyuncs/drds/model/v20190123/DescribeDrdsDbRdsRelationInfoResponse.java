...
import com.aliyuncs.drds.transform.v20190123.DescribeDrdsDbRdsRelationInfoResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeDrdsDbRdsRelationInfoResponse extends AcsResponse {
	...
	@Override
	public DescribeDrdsDbRdsRelationInfoResponse getInstance(UnmarshallerContext context) {
		return	DescribeDrdsDbRdsRelationInfoResponseUnmarshaller.unmarshall(this, context);
	}
}
