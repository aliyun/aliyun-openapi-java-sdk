...
import com.aliyuncs.drds.transform.v20190123.DescribeDataImportPreCheckResultResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeDataImportPreCheckResultResponse extends AcsResponse {
	...
	@Override
	public DescribeDataImportPreCheckResultResponse getInstance(UnmarshallerContext context) {
		return	DescribeDataImportPreCheckResultResponseUnmarshaller.unmarshall(this, context);
	}
}
