 ...
 * @version 
 */
public class DescribeRdsDrdsDBRequest extends RpcAcsRequest<DescribeRdsDrdsDBResponse> {
	...
	@Override
	public Class<DescribeRdsDrdsDBResponse> getResponseClass() {
		return DescribeRdsDrdsDBResponse.class;
	}
