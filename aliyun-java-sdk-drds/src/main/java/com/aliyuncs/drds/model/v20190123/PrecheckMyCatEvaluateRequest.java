 ...
 * @version 
 */
public class PrecheckMyCatEvaluateRequest extends RpcAcsRequest<PrecheckMyCatEvaluateResponse> {
	...
	public PrecheckMyCatEvaluateRequest() {
		super("Drds", "2019-01-23", "PrecheckMyCatEvaluate");
	...
	@Override
	public Class<PrecheckMyCatEvaluateResponse> getResponseClass() {
		return PrecheckMyCatEvaluateResponse.class;
	}
