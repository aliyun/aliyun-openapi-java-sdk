 ...
 * @version 
 */
public class CreateMyCatCustomImportRequest extends RpcAcsRequest<CreateMyCatCustomImportResponse> {
	...
	@Override
	public Class<CreateMyCatCustomImportResponse> getResponseClass() {
		return CreateMyCatCustomImportResponse.class;
	}
