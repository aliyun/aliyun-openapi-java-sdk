...
public class SubmitSmoothExpandPreCheckRequest extends RpcAcsRequest<SubmitSmoothExpandPreCheckResponse> {
	...
	public SubmitSmoothExpandPreCheckRequest() {
		super("Drds", "2019-01-23", "SubmitSmoothExpandPreCheck");
	...
	@Override
	public Class<SubmitSmoothExpandPreCheckResponse> getResponseClass() {
		return SubmitSmoothExpandPreCheckResponse.class;
	}
