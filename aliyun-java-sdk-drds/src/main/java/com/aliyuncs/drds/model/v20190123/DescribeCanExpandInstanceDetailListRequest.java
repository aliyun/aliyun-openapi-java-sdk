...
public class DescribeCanExpandInstanceDetailListRequest extends RpcAcsRequest<DescribeCanExpandInstanceDetailListResponse> {
	...
	public void setCurrentPlan(String currentPlan) {
		...
		if(currentPlan != null){
			putQueryParameter("CurrentPlan", currentPlan);
		}
	}
	...
	@Override
	public Class<DescribeCanExpandInstanceDetailListResponse> getResponseClass() {
		return DescribeCanExpandInstanceDetailListResponse.class;
	}
