 ...
 * @version 
 */
public class CreateEvaluateTaskRequest extends RpcAcsRequest<CreateEvaluateTaskResponse> {
	...
	public CreateEvaluateTaskRequest() {
		super("Drds", "2019-01-23", "CreateEvaluateTask");
	...
	@Override
	public Class<CreateEvaluateTaskResponse> getResponseClass() {
		return CreateEvaluateTaskResponse.class;
	}
