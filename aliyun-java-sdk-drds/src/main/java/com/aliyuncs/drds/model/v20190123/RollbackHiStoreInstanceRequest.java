...
public class RollbackHiStoreInstanceRequest extends RpcAcsRequest<RollbackHiStoreInstanceResponse> {
	...
	public RollbackHiStoreInstanceRequest() {
		super("Drds", "2019-01-23", "RollbackHiStoreInstance");
	...
	@Override
	public Class<RollbackHiStoreInstanceResponse> getResponseClass() {
		return RollbackHiStoreInstanceResponse.class;
	}
