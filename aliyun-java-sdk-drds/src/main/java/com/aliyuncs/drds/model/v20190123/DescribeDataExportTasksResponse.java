...
import com.aliyuncs.drds.transform.v20190123.DescribeDataExportTasksResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeDataExportTasksResponse extends AcsResponse {
	...
	private List<DataExportTask> data;
	...
	public List<DataExportTask> getData() {
		return this.data;
	}

	public void setData(List<DataExportTask> data) {
		this.data = data;
	}

	public static class DataExportTask {
	...
	@Override
	public DescribeDataExportTasksResponse getInstance(UnmarshallerContext context) {
		return	DescribeDataExportTasksResponseUnmarshaller.unmarshall(this, context);
	}
}
