...
public class DescribeDrdsInstanceMonitorRequest extends RpcAcsRequest<DescribeDrdsInstanceMonitorResponse> {
	...
	public void setPeriodMultiple(Integer periodMultiple) {
		this.periodMultiple = periodMultiple;
		if(periodMultiple != null){
			putQueryParameter("PeriodMultiple", periodMultiple.toString());
		}
	}

	@Override
	public Class<DescribeDrdsInstanceMonitorResponse> getResponseClass() {
		return DescribeDrdsInstanceMonitorResponse.class;
	}
