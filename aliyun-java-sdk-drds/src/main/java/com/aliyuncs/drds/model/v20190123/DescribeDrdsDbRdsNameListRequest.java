...
public class DescribeDrdsDbRdsNameListRequest extends RpcAcsRequest<DescribeDrdsDbRdsNameListResponse> {
	...
	public DescribeDrdsDbRdsNameListRequest() {
		super("Drds", "2019-01-23", "DescribeDrdsDbRdsNameList");
	...
	@Override
	public Class<DescribeDrdsDbRdsNameListResponse> getResponseClass() {
		return DescribeDrdsDbRdsNameListResponse.class;
	}
