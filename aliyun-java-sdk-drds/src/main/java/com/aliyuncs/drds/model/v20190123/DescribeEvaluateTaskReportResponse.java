...
import com.aliyuncs.drds.transform.v20190123.DescribeEvaluateTaskReportResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeEvaluateTaskReportResponse extends AcsResponse {
	...
	@Override
	public DescribeEvaluateTaskReportResponse getInstance(UnmarshallerContext context) {
		return	DescribeEvaluateTaskReportResponseUnmarshaller.unmarshall(this, context);
	}
}
