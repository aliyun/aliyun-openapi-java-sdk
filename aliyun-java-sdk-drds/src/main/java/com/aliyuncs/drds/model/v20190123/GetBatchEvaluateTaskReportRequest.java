 ...
 * @version 
 */
public class GetBatchEvaluateTaskReportRequest extends RpcAcsRequest<GetBatchEvaluateTaskReportResponse> {
	   

	private Long batchEvaluateTaskId;
	public GetBatchEvaluateTaskReportRequest() {
		super("Drds", "2019-01-23", "GetBatchEvaluateTaskReport");
	...
	@Override
	public Class<GetBatchEvaluateTaskReportResponse> getResponseClass() {
		return GetBatchEvaluateTaskReportResponse.class;
	}
