...
import com.aliyuncs.drds.transform.v20190123.InnerDescribeDrdsInstancesResponseUnmarshaller;
 ...
 * @version 
 */
public class InnerDescribeDrdsInstancesResponse extends AcsResponse {
	...
	@Override
	public InnerDescribeDrdsInstancesResponse getInstance(UnmarshallerContext context) {
		return	InnerDescribeDrdsInstancesResponseUnmarshaller.unmarshall(this, context);
	}
}
