 ...
 * @version 
 */
public class UpdateResourceGroupAttributeRequest extends RpcAcsRequest<UpdateResourceGroupAttributeResponse> {
	...
	@Override
	public Class<UpdateResourceGroupAttributeResponse> getResponseClass() {
		return UpdateResourceGroupAttributeResponse.class;
	}
