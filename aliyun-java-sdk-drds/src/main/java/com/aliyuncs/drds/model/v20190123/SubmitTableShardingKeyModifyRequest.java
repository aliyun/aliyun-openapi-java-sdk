 ...
 * @version 
 */
public class SubmitTableShardingKeyModifyRequest extends RpcAcsRequest<SubmitTableShardingKeyModifyResponse> {
	...
	public SubmitTableShardingKeyModifyRequest() {
		super("Drds", "2019-01-23", "SubmitTableShardingKeyModify");
	...
	@Override
	public Class<SubmitTableShardingKeyModifyResponse> getResponseClass() {
		return SubmitTableShardingKeyModifyResponse.class;
	}
