...
import com.aliyuncs.drds.transform.v20190123.DescribeDataExportPreCheckResultResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeDataExportPreCheckResultResponse extends AcsResponse {
	...
	@Override
	public DescribeDataExportPreCheckResultResponse getInstance(UnmarshallerContext context) {
		return	DescribeDataExportPreCheckResultResponseUnmarshaller.unmarshall(this, context);
	}
}
