 ...
 * @version 
 */
public class DescribeDrdsShardingDbsRequest extends RpcAcsRequest<DescribeDrdsShardingDbsResponse> {
	...
	public void setDbNamePattern(String dbNamePattern) {
		...
		if(dbNamePattern != null){
			putQueryParameter("DbNamePattern", dbNamePattern);
		}
	}

	@Override
	public Class<DescribeDrdsShardingDbsResponse> getResponseClass() {
		return DescribeDrdsShardingDbsResponse.class;
	}
