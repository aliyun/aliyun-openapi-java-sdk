 ...
 * @version 
 */
public class CreateBookkeepingIntentionRequest extends RpcAcsRequest<CreateBookkeepingIntentionResponse> {
	...
	@Override
	public Class<CreateBookkeepingIntentionResponse> getResponseClass() {
		return CreateBookkeepingIntentionResponse.class;
	}
