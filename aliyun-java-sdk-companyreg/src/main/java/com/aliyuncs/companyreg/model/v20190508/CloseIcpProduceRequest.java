 ...
 * @version 
 */
public class CloseIcpProduceRequest extends RpcAcsRequest<CloseIcpProduceResponse> {
	...
	@Override
	public Class<CloseIcpProduceResponse> getResponseClass() {
		return CloseIcpProduceResponse.class;
	}
