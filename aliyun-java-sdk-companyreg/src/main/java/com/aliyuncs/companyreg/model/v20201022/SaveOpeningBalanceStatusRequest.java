 ...
 * @version 
 */
public class SaveOpeningBalanceStatusRequest extends RpcAcsRequest<SaveOpeningBalanceStatusResponse> {
	...
	public void setOpeningBalanceStatus(String openingBalanceStatus) {
		...
		if(openingBalanceStatus != null){
			putQueryParameter("OpeningBalanceStatus", openingBalanceStatus);
		}
	}
	...
	@Override
	public Class<SaveOpeningBalanceStatusResponse> getResponseClass() {
		return SaveOpeningBalanceStatusResponse.class;
	}
