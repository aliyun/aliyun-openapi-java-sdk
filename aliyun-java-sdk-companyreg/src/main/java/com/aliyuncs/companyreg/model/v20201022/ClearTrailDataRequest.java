 ...
 * @version 
 */
public class ClearTrailDataRequest extends RpcAcsRequest<ClearTrailDataResponse> {
	...
	@Override
	public Class<ClearTrailDataResponse> getResponseClass() {
		return ClearTrailDataResponse.class;
	}
