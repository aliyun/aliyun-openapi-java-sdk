 ...
 * @version 
 */
public class ListInvoiceRequest extends RpcAcsRequest<ListInvoiceResponse> {
	...
	@Override
	public Class<ListInvoiceResponse> getResponseClass() {
		return ListInvoiceResponse.class;
	}
