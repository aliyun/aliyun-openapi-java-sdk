 ...
 * @version 
 */
public class ConfirmIcpIntentionRequest extends RpcAcsRequest<ConfirmIcpIntentionResponse> {
	...
	public void setBizIds(String bizIds) {
		this.bizIds = bizIds;
		if(bizIds != null){
			putQueryParameter("BizIds", bizIds);
		}
	}

	@Override
	public Class<ConfirmIcpIntentionResponse> getResponseClass() {
		return ConfirmIcpIntentionResponse.class;
	}
