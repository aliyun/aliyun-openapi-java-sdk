 ...
 * @version 
 */
public class ConfirmTaxAmountRequest extends RpcAcsRequest<ConfirmTaxAmountResponse> {
	...
	@Override
	public Class<ConfirmTaxAmountResponse> getResponseClass() {
		return ConfirmTaxAmountResponse.class;
	}
