 ...
 * @version 
 */
public class RefuseMaterialRequest extends RpcAcsRequest<RefuseMaterialResponse> {
	...
	@Override
	public Class<RefuseMaterialResponse> getResponseClass() {
		return RefuseMaterialResponse.class;
	}
