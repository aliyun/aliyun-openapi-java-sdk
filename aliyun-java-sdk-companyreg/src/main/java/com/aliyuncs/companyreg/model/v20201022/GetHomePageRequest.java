 ...
 * @version 
 */
public class GetHomePageRequest extends RpcAcsRequest<GetHomePageResponse> {
	...
	@Override
	public Class<GetHomePageResponse> getResponseClass() {
		return GetHomePageResponse.class;
	}
