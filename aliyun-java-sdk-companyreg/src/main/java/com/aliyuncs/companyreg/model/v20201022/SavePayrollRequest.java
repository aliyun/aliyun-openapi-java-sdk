 ...
 * @version 
 */
public class SavePayrollRequest extends RpcAcsRequest<SavePayrollResponse> {
	...
	@Override
	public Class<SavePayrollResponse> getResponseClass() {
		return SavePayrollResponse.class;
	}
