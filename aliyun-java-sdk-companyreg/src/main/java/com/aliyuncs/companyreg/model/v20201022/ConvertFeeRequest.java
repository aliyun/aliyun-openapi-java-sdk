 ...
 * @version 
 */
public class ConvertFeeRequest extends RpcAcsRequest<ConvertFeeResponse> {
	...
	@Override
	public Class<ConvertFeeResponse> getResponseClass() {
		return ConvertFeeResponse.class;
	}
