 ...
 * @version 
 */
public class DeletePayrollRequest extends RpcAcsRequest<DeletePayrollResponse> {
	...
	@Override
	public Class<DeletePayrollResponse> getResponseClass() {
		return DeletePayrollResponse.class;
	}
