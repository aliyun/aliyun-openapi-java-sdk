 ...
 * @version 
 */
public class ReSubmitIcpSolutionRequest extends RpcAcsRequest<ReSubmitIcpSolutionResponse> {
	...
	@Override
	public Class<ReSubmitIcpSolutionResponse> getResponseClass() {
		return ReSubmitIcpSolutionResponse.class;
	}
