...
import com.aliyuncs.companyreg.transform.v20201022.UpdateCustomerInfoResponseUnmarshaller;
 ...
 * @version 
 */
public class UpdateCustomerInfoResponse extends AcsResponse {
	...
	@Override
	public UpdateCustomerInfoResponse getInstance(UnmarshallerContext context) {
		return	UpdateCustomerInfoResponseUnmarshaller.unmarshall(this, context);
	}
