 ...
 * @version 
 */
public class GetTypeListRequest extends RpcAcsRequest<GetTypeListResponse> {
	...
	@Override
	public Class<GetTypeListResponse> getResponseClass() {
		return GetTypeListResponse.class;
	}
