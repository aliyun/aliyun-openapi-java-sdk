 ...
 * @version 
 */
public class GetInvoiceInfoRequest extends RpcAcsRequest<GetInvoiceInfoResponse> {
	...
	@Override
	public Class<GetInvoiceInfoResponse> getResponseClass() {
		return GetInvoiceInfoResponse.class;
	}
