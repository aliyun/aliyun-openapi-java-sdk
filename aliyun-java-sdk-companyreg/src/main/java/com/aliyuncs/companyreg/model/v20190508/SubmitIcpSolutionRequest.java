 ...
 * @version 
 */
public class SubmitIcpSolutionRequest extends RpcAcsRequest<SubmitIcpSolutionResponse> {
	...
	public Integer getIcpType() {
		return this.icpType;
	}

	public void setIcpType(Integer icpType) {
		this.icpType = icpType;
		if(icpType != null){
			putBodyParameter("IcpType", icpType.toString());
		}
	}
	...
	public void setCompanyAddress(String companyAddress) {
		...
		if(companyAddress != null){
			putBodyParameter("CompanyAddress", companyAddress);
		}
	}
	...
	@Override
	public Class<SubmitIcpSolutionResponse> getResponseClass() {
		return SubmitIcpSolutionResponse.class;
	}
