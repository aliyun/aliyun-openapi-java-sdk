 ...
 * @version 
 */
public class GetQuarterIncomeStatementInfoRequest extends RpcAcsRequest<GetQuarterIncomeStatementInfoResponse> {
	...
	public void setIsQuarter(Boolean isQuarter) {
		...
		if(isQuarter != null){
			putQueryParameter("IsQuarter", isQuarter.toString());
		}
	}

	@Override
	public Class<GetQuarterIncomeStatementInfoResponse> getResponseClass() {
		return GetQuarterIncomeStatementInfoResponse.class;
	}
