 ...
 * @version 
 */
public class GetQuarterCashFlowInfoRequest extends RpcAcsRequest<GetQuarterCashFlowInfoResponse> {
	...
	@Override
	public Class<GetQuarterCashFlowInfoResponse> getResponseClass() {
		return GetQuarterCashFlowInfoResponse.class;
	}
