...
import com.aliyuncs.companyreg.transform.v20201022.GetPayrollSettingResponseUnmarshaller;
 ...
 * @version 
 */
public class GetPayrollSettingResponse extends AcsResponse {
	...
	@Override
	public GetPayrollSettingResponse getInstance(UnmarshallerContext context) {
		return	GetPayrollSettingResponseUnmarshaller.unmarshall(this, context);
	}
