 ...
 * @version 
 */
public class ListPayrollRequest extends RpcAcsRequest<ListPayrollResponse> {
	...
	@Override
	public Class<ListPayrollResponse> getResponseClass() {
		return ListPayrollResponse.class;
	}
