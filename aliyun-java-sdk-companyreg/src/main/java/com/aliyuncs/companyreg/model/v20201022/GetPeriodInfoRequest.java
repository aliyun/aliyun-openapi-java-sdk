 ...
 * @version 
 */
public class GetPeriodInfoRequest extends RpcAcsRequest<GetPeriodInfoResponse> {
	...
	@Override
	public Class<GetPeriodInfoResponse> getResponseClass() {
		return GetPeriodInfoResponse.class;
	}
