 ...
 * @version 
 */
public class GetPayrollInfoRequest extends RpcAcsRequest<GetPayrollInfoResponse> {
	...
	@Override
	public Class<GetPayrollInfoResponse> getResponseClass() {
		return GetPayrollInfoResponse.class;
	}
