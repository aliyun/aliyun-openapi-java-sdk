 ...
 * @version 
 */
public class UpdateTaxationProcessRequest extends RpcAcsRequest<UpdateTaxationProcessResponse> {
	...
	public void setTargetProcess(String targetProcess) {
		...
		if(targetProcess != null){
			putQueryParameter("TargetProcess", targetProcess);
		}
	}

	@Override
	public Class<UpdateTaxationProcessResponse> getResponseClass() {
		return UpdateTaxationProcessResponse.class;
	}
