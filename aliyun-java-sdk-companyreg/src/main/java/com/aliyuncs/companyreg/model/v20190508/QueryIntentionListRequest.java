 ...
 * @version 
 */
public class QueryIntentionListRequest extends RpcAcsRequest<QueryIntentionListResponse> {
	...
	public QueryIntentionListRequest() {
		super("companyreg", "2019-05-08", "QueryIntentionList", "companyreg");
	...
	@Override
	public Class<QueryIntentionListResponse> getResponseClass() {
		return QueryIntentionListResponse.class;
	}
