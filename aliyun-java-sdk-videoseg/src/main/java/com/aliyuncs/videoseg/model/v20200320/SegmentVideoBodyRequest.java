 ...
 * @version 
 */
public class SegmentVideoBodyRequest extends RpcAcsRequest<SegmentVideoBodyResponse> {
	...
	@Override
	public Class<SegmentVideoBodyResponse> getResponseClass() {
		return SegmentVideoBodyResponse.class;
	}
