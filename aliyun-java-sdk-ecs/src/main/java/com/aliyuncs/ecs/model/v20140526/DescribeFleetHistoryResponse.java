...
public class DescribeFleetHistoryResponse extends AcsResponse {
	...
	public void setFleetHistorys(List<FleetHistory> fleetHistorys) {
		this.fleetHistorys = fleetHistorys;
	}
	...
	@Override
	public DescribeFleetHistoryResponse getInstance(UnmarshallerContext context) {
		return	DescribeFleetHistoryResponseUnmarshaller.unmarshall(this, context);
	}
}
