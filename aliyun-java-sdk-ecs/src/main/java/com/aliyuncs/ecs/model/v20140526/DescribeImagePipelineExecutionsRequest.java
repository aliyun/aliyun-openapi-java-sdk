 ...
 * @version 
 */
public class DescribeImagePipelineExecutionsRequest extends RpcAcsRequest<DescribeImagePipelineExecutionsResponse> {
	...
	@Override
	public Class<DescribeImagePipelineExecutionsResponse> getResponseClass() {
		return DescribeImagePipelineExecutionsResponse.class;
	}
