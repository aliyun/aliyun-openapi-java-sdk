 ...
 * @version 
 */
public class DeleteDiagnosticMetricSetsRequest extends RpcAcsRequest<DeleteDiagnosticMetricSetsResponse> {
	...
	@Override
	public Class<DeleteDiagnosticMetricSetsResponse> getResponseClass() {
		return DeleteDiagnosticMetricSetsResponse.class;
	}
