 ...
 * @version 
 */
public class ModifyMigrationInstancesRequest extends RpcAcsRequest<ModifyMigrationInstancesResponse> {
	...
	public ModifyMigrationInstancesRequest() {
		super("Ecs", "2016-03-14", "ModifyMigrationInstances", "ecs");
	...
	@Override
	public Class<ModifyMigrationInstancesResponse> getResponseClass() {
		return ModifyMigrationInstancesResponse.class;
	}
