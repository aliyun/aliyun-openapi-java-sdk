 ...
 * @version 
 */
public class CancelMigrationPlanRequest extends RpcAcsRequest<CancelMigrationPlanResponse> {
	...
	public CancelMigrationPlanRequest() {
		super("Ecs", "2016-03-14", "CancelMigrationPlan", "ecs");
	...
	public void setOnlyCancelPlan(Boolean onlyCancelPlan) {
		...
		if(onlyCancelPlan != null){
			putQueryParameter("OnlyCancelPlan", onlyCancelPlan.toString());
		}
	}

	@Override
	public Class<CancelMigrationPlanResponse> getResponseClass() {
		return CancelMigrationPlanResponse.class;
	}
