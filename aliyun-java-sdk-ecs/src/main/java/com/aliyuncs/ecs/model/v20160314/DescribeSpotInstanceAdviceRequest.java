 ...
 * @version 
 */
public class DescribeSpotInstanceAdviceRequest extends RpcAcsRequest<DescribeSpotInstanceAdviceResponse> {
	...
	public DescribeSpotInstanceAdviceRequest() {
		super("Ecs", "2016-03-14", "DescribeSpotInstanceAdvice", "ecs");
	...
	@Override
	public Class<DescribeSpotInstanceAdviceResponse> getResponseClass() {
		return DescribeSpotInstanceAdviceResponse.class;
	}
