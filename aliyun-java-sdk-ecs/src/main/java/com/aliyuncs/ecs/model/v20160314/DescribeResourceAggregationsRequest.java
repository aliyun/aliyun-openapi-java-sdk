 ...
 * @version 
 */
public class DescribeResourceAggregationsRequest extends RpcAcsRequest<DescribeResourceAggregationsResponse> {
	...
	private List<String> aggregatorss;
	...
	public DescribeResourceAggregationsRequest() {
		super("Ecs", "2016-03-14", "DescribeResourceAggregations", "ecs");
	...
	public List<String> getAggregatorss() {
		return this.aggregatorss;
	}

	public void setAggregatorss(List<String> aggregatorss) {
		this.aggregatorss = aggregatorss;	
		if (aggregatorss != null) {
			for (int i = 0; i < aggregatorss.size(); i++) {
				putQueryParameter("Aggregators." + (i + 1) , aggregatorss.get(i));
			}
		}	
	}
	...
	@Override
	public Class<DescribeResourceAggregationsResponse> getResponseClass() {
		return DescribeResourceAggregationsResponse.class;
	}
