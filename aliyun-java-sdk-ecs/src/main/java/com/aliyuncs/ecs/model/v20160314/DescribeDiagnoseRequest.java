 ...
 * @version 
 */
public class DescribeDiagnoseRequest extends RpcAcsRequest<DescribeDiagnoseResponse> {
	...
	public DescribeDiagnoseRequest() {
		super("Ecs", "2016-03-14", "DescribeDiagnose", "ecs");
	...
	@Override
	public Class<DescribeDiagnoseResponse> getResponseClass() {
		return DescribeDiagnoseResponse.class;
	}
