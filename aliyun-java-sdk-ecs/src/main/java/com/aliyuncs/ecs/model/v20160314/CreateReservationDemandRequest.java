 ...
 * @version 
 */
public class CreateReservationDemandRequest extends RpcAcsRequest<CreateReservationDemandResponse> {
	...
	public CreateReservationDemandRequest() {
		super("Ecs", "2016-03-14", "CreateReservationDemand", "ecs");
	...
	@Override
	public Class<CreateReservationDemandResponse> getResponseClass() {
		return CreateReservationDemandResponse.class;
	}
