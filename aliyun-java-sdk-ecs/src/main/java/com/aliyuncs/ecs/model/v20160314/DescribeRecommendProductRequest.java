 ...
 * @version 
 */
public class DescribeRecommendProductRequest extends RpcAcsRequest<DescribeRecommendProductResponse> {
	...
	public DescribeRecommendProductRequest() {
		super("Ecs", "2016-03-14", "DescribeRecommendProduct", "ecs");
	...
	@Override
	public Class<DescribeRecommendProductResponse> getResponseClass() {
		return DescribeRecommendProductResponse.class;
	}
