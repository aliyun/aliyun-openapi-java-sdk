...
import com.aliyuncs.ecs.transform.v20160314.InnerDescribeNetworkInterfaceInGroupResponseUnmarshaller;
 ...
 * @version 
 */
public class InnerDescribeNetworkInterfaceInGroupResponse extends AcsResponse {
	...
	@Override
	public InnerDescribeNetworkInterfaceInGroupResponse getInstance(UnmarshallerContext context) {
		return	InnerDescribeNetworkInterfaceInGroupResponseUnmarshaller.unmarshall(this, context);
	}
}
