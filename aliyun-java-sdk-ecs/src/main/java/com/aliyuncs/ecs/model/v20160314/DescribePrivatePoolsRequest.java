 ...
 * @version 
 */
public class DescribePrivatePoolsRequest extends RpcAcsRequest<DescribePrivatePoolsResponse> {
	...
	public DescribePrivatePoolsRequest() {
		super("Ecs", "2016-03-14", "DescribePrivatePools", "ecs");
	...
	public void setPrivatePoolOptionsType(String privatePoolOptionsType) {
		...
		if(privatePoolOptionsType != null){
			putQueryParameter("PrivatePoolOptions.Type", privatePoolOptionsType);
		}
	}
	...
	public void setStartTimeType(String startTimeType) {
		...
		if(startTimeType != null){
			putQueryParameter("StartTimeType", startTimeType);
		}
	}
	...
	@Override
	public Class<DescribePrivatePoolsResponse> getResponseClass() {
		return DescribePrivatePoolsResponse.class;
	}
