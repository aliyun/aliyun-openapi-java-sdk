 ...
 * @version 
 */
public class DescribeWaitingOrdersRequest extends RpcAcsRequest<DescribeWaitingOrdersResponse> {
	...
	public DescribeWaitingOrdersRequest() {
		super("Ecs", "2016-03-14", "DescribeWaitingOrders", "ecs");
	...
	@Override
	public Class<DescribeWaitingOrdersResponse> getResponseClass() {
		return DescribeWaitingOrdersResponse.class;
	}
