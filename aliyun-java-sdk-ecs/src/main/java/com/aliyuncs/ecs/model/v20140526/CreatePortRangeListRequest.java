 ...
 * @version 
 */
public class CreatePortRangeListRequest extends RpcAcsRequest<CreatePortRangeListResponse> {
	...
	public CreatePortRangeListRequest() {
		super("Ecs", "2014-05-26", "CreatePortRangeList", "ecs");
	...
	public void setEntrys(List<Entry> entrys) {
		...
		if (entrys != null) {
			for (int depth1 = 0; depth1 < entrys.size(); depth1++) {
				putQueryParameter("Entry." + (depth1 + 1) + ".PortRange" , entrys.get(depth1).getPortRange());
	...
	@Override
	public Class<CreatePortRangeListResponse> getResponseClass() {
		return CreatePortRangeListResponse.class;
	}
