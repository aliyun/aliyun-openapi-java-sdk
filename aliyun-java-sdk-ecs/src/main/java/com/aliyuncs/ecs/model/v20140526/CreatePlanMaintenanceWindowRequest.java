 ...
 * @version 
 */
public class CreatePlanMaintenanceWindowRequest extends RpcAcsRequest<CreatePlanMaintenanceWindowResponse> {
	...
	public CreatePlanMaintenanceWindowRequest() {
		super("Ecs", "2014-05-26", "CreatePlanMaintenanceWindow", "ecs");
	...
	@Override
	public Class<CreatePlanMaintenanceWindowResponse> getResponseClass() {
		return CreatePlanMaintenanceWindowResponse.class;
	}
