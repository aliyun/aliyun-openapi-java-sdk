...
import com.aliyuncs.ecs.transform.v20140526.DeleteSnapshotGroupResponseUnmarshaller;
 ...
 * @version 
 */
public class DeleteSnapshotGroupResponse extends AcsResponse {
	...
	@Override
	public DeleteSnapshotGroupResponse getInstance(UnmarshallerContext context) {
		return	DeleteSnapshotGroupResponseUnmarshaller.unmarshall(this, context);
	}
}
