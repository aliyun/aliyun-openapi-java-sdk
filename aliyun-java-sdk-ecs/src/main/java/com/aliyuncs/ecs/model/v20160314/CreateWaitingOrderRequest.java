 ...
 * @version 
 */
public class CreateWaitingOrderRequest extends RpcAcsRequest<CreateWaitingOrderResponse> {
	...
	public CreateWaitingOrderRequest() {
		super("Ecs", "2016-03-14", "CreateWaitingOrder", "ecs");
	...
	public void setDataDisks(List<DataDisk> dataDisks) {
		...
		if (dataDisks != null) {
			for (int depth1 = 0; depth1 < dataDisks.size(); depth1++) {
				...
				putQueryParameter("DataDisk." + (depth1 + 1) + ".BurstingEnable" , dataDisks.get(depth1).getBurstingEnable());
			}
		}	
	}
	...
	public static class ImageOptions {
		...
		private String loginAsNonRoot;

		public String getLoginAsNonRoot() {
			return this.loginAsNonRoot;
		}

		public void setLoginAsNonRoot(String loginAsNonRoot) {
	...
	public static class DataDisk {
		...
		private Boolean burstingEnable;
		...
		public Boolean getBurstingEnable() {
			return this.burstingEnable;
		}

		public void setBurstingEnable(Boolean burstingEnable) {
			this.burstingEnable = burstingEnable;
		}
	}
	...
	@Override
	public Class<CreateWaitingOrderResponse> getResponseClass() {
		return CreateWaitingOrderResponse.class;
	}
