 ...
 * @version 
 */
public class ModifyDemandRequest extends RpcAcsRequest<ModifyDemandResponse> {
	...
	@Override
	public Class<ModifyDemandResponse> getResponseClass() {
		return ModifyDemandResponse.class;
	}
