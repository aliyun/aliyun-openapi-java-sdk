...
public class DescribeNetworkInterfacePermissionsRequest extends RpcAcsRequest<DescribeNetworkInterfacePermissionsResponse> {
	...
	public void setNetworkInterfacePermissionIds(List<String> networkInterfacePermissionIds) {
		...
		if (networkInterfacePermissionIds != null) {
			for (int i = 0; i < networkInterfacePermissionIds.size(); i++) {
				putQueryParameter("NetworkInterfacePermissionId." + (i + 1) , networkInterfacePermissionIds.get(i));
			}
		}	
	}
	...
	@Override
	public Class<DescribeNetworkInterfacePermissionsResponse> getResponseClass() {
		return DescribeNetworkInterfacePermissionsResponse.class;
	}
