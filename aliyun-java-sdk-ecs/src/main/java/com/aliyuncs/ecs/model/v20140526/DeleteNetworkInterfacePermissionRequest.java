...
public class DeleteNetworkInterfacePermissionRequest extends RpcAcsRequest<DeleteNetworkInterfacePermissionResponse> {
	...
	public void setNetworkInterfacePermissionId(String networkInterfacePermissionId) {
		...
		if(networkInterfacePermissionId != null){
			putQueryParameter("NetworkInterfacePermissionId", networkInterfacePermissionId);
		}
	}
	...
	@Override
	public Class<DeleteNetworkInterfacePermissionResponse> getResponseClass() {
		return DeleteNetworkInterfacePermissionResponse.class;
	}
