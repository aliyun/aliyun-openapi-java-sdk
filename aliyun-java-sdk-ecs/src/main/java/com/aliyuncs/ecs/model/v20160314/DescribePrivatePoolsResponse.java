...
import com.aliyuncs.ecs.transform.v20160314.DescribePrivatePoolsResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribePrivatePoolsResponse extends AcsResponse {
	...
	private List<PrivatePoolItem> privatePoolSet;
	...
	public List<PrivatePoolItem> getPrivatePoolSet() {
		return this.privatePoolSet;
	}

	public void setPrivatePoolSet(List<PrivatePoolItem> privatePoolSet) {
		this.privatePoolSet = privatePoolSet;
	}

	public static class PrivatePoolItem {
		...
		public void setPrivatePoolOptionsType(String privatePoolOptionsType) {
	...
	@Override
	public DescribePrivatePoolsResponse getInstance(UnmarshallerContext context) {
		return	DescribePrivatePoolsResponseUnmarshaller.unmarshall(this, context);
	}
}
