 ...
 * @version 
 */
public class DescribeAutoProvisioningGroupInstancesRequest extends RpcAcsRequest<DescribeAutoProvisioningGroupInstancesResponse> {
	...
	@Override
	public Class<DescribeAutoProvisioningGroupInstancesResponse> getResponseClass() {
		return DescribeAutoProvisioningGroupInstancesResponse.class;
	}
