 ...
 * @version 
 */
public class ModifyPrivatePoolRequest extends RpcAcsRequest<ModifyPrivatePoolResponse> {
	...
	public ModifyPrivatePoolRequest() {
		super("Ecs", "2016-03-14", "ModifyPrivatePool", "ecs");
	...
	@Override
	public Class<ModifyPrivatePoolResponse> getResponseClass() {
		return ModifyPrivatePoolResponse.class;
	}
