 ...
 * @version 
 */
public class DescribeSpotPriceHistoryRequest extends RpcAcsRequest<DescribeSpotPriceHistoryResponse> {
	...
	@Override
	public Class<DescribeSpotPriceHistoryResponse> getResponseClass() {
		return DescribeSpotPriceHistoryResponse.class;
	}
