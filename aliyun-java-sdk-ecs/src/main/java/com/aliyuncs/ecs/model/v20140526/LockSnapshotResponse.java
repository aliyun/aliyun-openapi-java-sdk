...
import com.aliyuncs.ecs.transform.v20140526.LockSnapshotResponseUnmarshaller;
 ...
 * @version 
 */
public class LockSnapshotResponse extends AcsResponse {
	...
	public void setLockedSnapshotInfo(LockedSnapshotInfo lockedSnapshotInfo) {
	...
	@Override
	public LockSnapshotResponse getInstance(UnmarshallerContext context) {
		return	LockSnapshotResponseUnmarshaller.unmarshall(this, context);
	}
