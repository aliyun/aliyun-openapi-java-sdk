 ...
 * @version 
 */
public class CreateStorageSetRequest extends RpcAcsRequest<CreateStorageSetResponse> {
	...
	public CreateStorageSetRequest() {
		super("Ecs", "2016-03-14", "CreateStorageSet", "ecs");
	...
	public void setMaxPartitionNumber(Integer maxPartitionNumber) {
		...
		if(maxPartitionNumber != null){
			putQueryParameter("MaxPartitionNumber", maxPartitionNumber.toString());
		}
	}
	...
	@Override
	public Class<CreateStorageSetResponse> getResponseClass() {
		return CreateStorageSetResponse.class;
	}
