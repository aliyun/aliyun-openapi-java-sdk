...
public class CreateCapacityReservationResponse extends AcsResponse {
	...
	@Override
	public CreateCapacityReservationResponse getInstance(UnmarshallerContext context) {
		return	CreateCapacityReservationResponseUnmarshaller.unmarshall(this, context);
	}
}
