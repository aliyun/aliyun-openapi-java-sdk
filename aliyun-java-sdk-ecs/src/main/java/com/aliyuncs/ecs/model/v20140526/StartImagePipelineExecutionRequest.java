 ...
 * @version 
 */
public class StartImagePipelineExecutionRequest extends RpcAcsRequest<StartImagePipelineExecutionResponse> {
	...
	@Override
	public Class<StartImagePipelineExecutionResponse> getResponseClass() {
		return StartImagePipelineExecutionResponse.class;
	}
