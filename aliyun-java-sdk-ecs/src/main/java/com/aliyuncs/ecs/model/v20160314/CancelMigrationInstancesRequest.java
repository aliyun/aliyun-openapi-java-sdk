 ...
 * @version 
 */
public class CancelMigrationInstancesRequest extends RpcAcsRequest<CancelMigrationInstancesResponse> {
	...
	public CancelMigrationInstancesRequest() {
		super("Ecs", "2016-03-14", "CancelMigrationInstances", "ecs");
	...
	@Override
	public Class<CancelMigrationInstancesResponse> getResponseClass() {
		return CancelMigrationInstancesResponse.class;
	}
