 ...
 * @version 
 */
public class CreateVscRequest extends RpcAcsRequest<CreateVscResponse> {
	...
	public CreateVscRequest() {
		super("Ecs", "2014-05-26", "CreateVsc", "ecs");
	...
	public void setVscName(String vscName) {
		...
		if(vscName != null){
			putQueryParameter("VscName", vscName);
		}
	}
	...
	@Override
	public Class<CreateVscResponse> getResponseClass() {
		return CreateVscResponse.class;
	}
