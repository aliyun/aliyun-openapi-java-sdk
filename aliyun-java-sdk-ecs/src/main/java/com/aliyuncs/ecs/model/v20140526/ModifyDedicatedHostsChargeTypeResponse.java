...
import com.aliyuncs.ecs.transform.v20140526.ModifyDedicatedHostsChargeTypeResponseUnmarshaller;
...
public class ModifyDedicatedHostsChargeTypeResponse extends AcsResponse {
	...
	@Override
	public ModifyDedicatedHostsChargeTypeResponse getInstance(UnmarshallerContext context) {
		return	ModifyDedicatedHostsChargeTypeResponseUnmarshaller.unmarshall(this, context);
	}
}
