 ...
 * @version 
 */
public class DescribeElasticityAssuranceInstancesRequest extends RpcAcsRequest<DescribeElasticityAssuranceInstancesResponse> {
	...
	@Override
	public Class<DescribeElasticityAssuranceInstancesResponse> getResponseClass() {
		return DescribeElasticityAssuranceInstancesResponse.class;
	}
