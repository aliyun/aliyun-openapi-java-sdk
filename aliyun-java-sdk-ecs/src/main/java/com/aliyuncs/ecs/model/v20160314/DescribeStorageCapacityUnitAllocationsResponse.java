...
import com.aliyuncs.ecs.transform.v20160314.DescribeStorageCapacityUnitAllocationsResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeStorageCapacityUnitAllocationsResponse extends AcsResponse {
	...
	@Override
	public DescribeStorageCapacityUnitAllocationsResponse getInstance(UnmarshallerContext context) {
		return	DescribeStorageCapacityUnitAllocationsResponseUnmarshaller.unmarshall(this, context);
	}
}
