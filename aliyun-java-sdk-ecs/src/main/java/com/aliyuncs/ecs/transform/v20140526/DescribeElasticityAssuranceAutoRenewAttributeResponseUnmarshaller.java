...
import com.aliyuncs.ecs.model.v20140526.DescribeElasticityAssuranceAutoRenewAttributeResponse;
import com.aliyuncs.ecs.model.v20140526.DescribeElasticityAssuranceAutoRenewAttributeResponse.ElasticityAssuranceRenewAttribute;
import com.aliyuncs.transform.UnmarshallerContext;


public class DescribeElasticityAssuranceAutoRenewAttributeResponseUnmarshaller {

	public static DescribeElasticityAssuranceAutoRenewAttributeResponse unmarshall(DescribeElasticityAssuranceAutoRenewAttributeResponse describeElasticityAssuranceAutoRenewAttributeResponse, UnmarshallerContext _ctx) {
		
		describeElasticityAssuranceAutoRenewAttributeResponse.setRequestId(_ctx.stringValue("DescribeElasticityAssuranceAutoRenewAttributeResponse.RequestId"));
		...
		describeElasticityAssuranceAutoRenewAttributeResponse.setElasticityAssuranceRenewAttributes(elasticityAssuranceRenewAttributes);
