...
import com.aliyuncs.ecs.model.v20160314.DescribeDedicatedHostClustersResponse;
import com.aliyuncs.ecs.model.v20160314.DescribeDedicatedHostClustersResponse.DedicatedHostCluster;
import com.aliyuncs.ecs.model.v20160314.DescribeDedicatedHostClustersResponse.DedicatedHostCluster.DedicatedHostClusterCapacity;
import com.aliyuncs.ecs.model.v20160314.DescribeDedicatedHostClustersResponse.DedicatedHostCluster.DedicatedHostClusterCapacity.AvailableInstanceType;
import com.aliyuncs.ecs.model.v20160314.DescribeDedicatedHostClustersResponse.DedicatedHostCluster.DedicatedHostClusterCapacity.LocalStorageCapacity;
import com.aliyuncs.ecs.model.v20160314.DescribeDedicatedHostClustersResponse.DedicatedHostCluster.Tag;
...
public class DescribeDedicatedHostClustersResponseUnmarshaller {
	...
	public static DescribeDedicatedHostClustersResponse unmarshall(DescribeDedicatedHostClustersResponse describeDedicatedHostClustersResponse, UnmarshallerContext _ctx) {
		...
		for (int i = 0; i < _ctx.lengthValue("DescribeDedicatedHostClustersResponse.DedicatedHostClusters.Length"); i++) {
			...
			dedicatedHostCluster.setSchedulerOptionsManagedPrivateSpaceId(_ctx.stringValue("DescribeDedicatedHostClustersResponse.DedicatedHostClusters["+ i +"].SchedulerOptions.ManagedPrivateSpaceId"));
