...
public class RunCommandResponseUnmarshaller {
	...
	public static RunCommandResponse unmarshall(RunCommandResponse runCommandResponse, UnmarshallerContext _ctx) {
		...
		runCommandResponse.setCommandId(_ctx.stringValue("RunCommandResponse.CommandId"));
		runCommandResponse.setInvokeId(_ctx.stringValue("RunCommandResponse.InvokeId"));
