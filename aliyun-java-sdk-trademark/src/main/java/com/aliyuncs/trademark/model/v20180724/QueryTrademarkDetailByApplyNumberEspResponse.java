...
import com.aliyuncs.trademark.transform.v20180724.QueryTrademarkDetailByApplyNumberEspResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryTrademarkDetailByApplyNumberEspResponse extends AcsResponse {
	...
	public static class Moudle {
		...
		public static class MaterialInfo {
			...
			private Map<Object,Object> reviewFileMap;
			...
			public Map<Object,Object> getReviewFileMap() {
				return this.reviewFileMap;
			}

			public void setReviewFileMap(Map<Object,Object> reviewFileMap) {
	...
	@Override
	public QueryTrademarkDetailByApplyNumberEspResponse getInstance(UnmarshallerContext context) {
		return	QueryTrademarkDetailByApplyNumberEspResponseUnmarshaller.unmarshall(this, context);
	}
}
