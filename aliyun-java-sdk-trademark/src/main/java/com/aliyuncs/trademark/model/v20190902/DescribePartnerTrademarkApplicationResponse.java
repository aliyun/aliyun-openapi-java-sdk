...
import com.aliyuncs.trademark.transform.v20190902.DescribePartnerTrademarkApplicationResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribePartnerTrademarkApplicationResponse extends AcsResponse {
	...
	@Override
	public DescribePartnerTrademarkApplicationResponse getInstance(UnmarshallerContext context) {
		return	DescribePartnerTrademarkApplicationResponseUnmarshaller.unmarshall(this, context);
	}
