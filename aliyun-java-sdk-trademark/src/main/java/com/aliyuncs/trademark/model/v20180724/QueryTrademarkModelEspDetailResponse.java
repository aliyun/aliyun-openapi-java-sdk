...
import com.aliyuncs.trademark.transform.v20180724.QueryTrademarkModelEspDetailResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryTrademarkModelEspDetailResponse extends AcsResponse {
	...
	@Override
	public QueryTrademarkModelEspDetailResponse getInstance(UnmarshallerContext context) {
		return	QueryTrademarkModelEspDetailResponseUnmarshaller.unmarshall(this, context);
	}
}
