 ...
 * @version 
 */
public class CreateIntentionOrderRequest extends RpcAcsRequest<CreateIntentionOrderResponse> {
	...
	@Override
	public Class<CreateIntentionOrderResponse> getResponseClass() {
		return CreateIntentionOrderResponse.class;
	}
