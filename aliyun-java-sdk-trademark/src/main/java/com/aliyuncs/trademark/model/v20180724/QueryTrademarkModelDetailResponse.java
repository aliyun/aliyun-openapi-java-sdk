...
import com.aliyuncs.trademark.transform.v20180724.QueryTrademarkModelDetailResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryTrademarkModelDetailResponse extends AcsResponse {
	...
	@Override
	public QueryTrademarkModelDetailResponse getInstance(UnmarshallerContext context) {
		return	QueryTrademarkModelDetailResponseUnmarshaller.unmarshall(this, context);
	}
}
