 ...
 * @version 
 */
public class CheckTrademarkOrderRequest extends RpcAcsRequest<CheckTrademarkOrderResponse> {
	...
	public CheckTrademarkOrderRequest() {
		super("Trademark", "2018-07-24", "CheckTrademarkOrder");
	...
	public void setLogoGoodsId(String logoGoodsId) {
		...
		if(logoGoodsId != null){
			putQueryParameter("LogoGoodsId", logoGoodsId);
		}
	}
	...
	@Override
	public Class<CheckTrademarkOrderResponse> getResponseClass() {
		return CheckTrademarkOrderResponse.class;
	}
