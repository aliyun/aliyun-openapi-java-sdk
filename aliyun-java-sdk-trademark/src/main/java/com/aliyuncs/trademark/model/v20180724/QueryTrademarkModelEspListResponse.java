...
import com.aliyuncs.trademark.transform.v20180724.QueryTrademarkModelEspListResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryTrademarkModelEspListResponse extends AcsResponse {
	...
	@Override
	public QueryTrademarkModelEspListResponse getInstance(UnmarshallerContext context) {
		return	QueryTrademarkModelEspListResponseUnmarshaller.unmarshall(this, context);
	}
}
