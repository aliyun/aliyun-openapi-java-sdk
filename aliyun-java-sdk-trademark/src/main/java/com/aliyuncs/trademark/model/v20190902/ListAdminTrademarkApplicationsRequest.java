 ...
 * @version 
 */
public class ListAdminTrademarkApplicationsRequest extends RpcAcsRequest<ListAdminTrademarkApplicationsResponse> {
	...
	public ListAdminTrademarkApplicationsRequest() {
		super("Trademark", "2019-09-02", "ListAdminTrademarkApplications");
	...
	@Override
	public Class<ListAdminTrademarkApplicationsResponse> getResponseClass() {
		return ListAdminTrademarkApplicationsResponse.class;
	}
