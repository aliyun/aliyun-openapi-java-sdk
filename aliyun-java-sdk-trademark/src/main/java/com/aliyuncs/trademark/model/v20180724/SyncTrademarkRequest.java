 ...
 * @version 
 */
public class SyncTrademarkRequest extends RpcAcsRequest<SyncTrademarkResponse> {
	...
	public SyncTrademarkRequest() {
		super("Trademark", "2018-07-24", "SyncTrademark");
	...
	@Override
	public Class<SyncTrademarkResponse> getResponseClass() {
		return SyncTrademarkResponse.class;
	}
