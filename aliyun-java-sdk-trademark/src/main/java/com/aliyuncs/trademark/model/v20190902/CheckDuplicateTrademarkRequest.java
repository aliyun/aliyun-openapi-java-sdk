 ...
 * @version 
 */
public class CheckDuplicateTrademarkRequest extends RpcAcsRequest<CheckDuplicateTrademarkResponse> {
	...
	public CheckDuplicateTrademarkRequest() {
		super("Trademark", "2019-09-02", "CheckDuplicateTrademark");
	...
	@Override
	public Class<CheckDuplicateTrademarkResponse> getResponseClass() {
		return CheckDuplicateTrademarkResponse.class;
	}
