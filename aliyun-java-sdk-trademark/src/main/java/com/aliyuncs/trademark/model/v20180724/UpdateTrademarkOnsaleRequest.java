 ...
 * @version 
 */
public class UpdateTrademarkOnsaleRequest extends RpcAcsRequest<UpdateTrademarkOnsaleResponse> {
	...
	public UpdateTrademarkOnsaleRequest() {
		super("Trademark", "2018-07-24", "UpdateTrademarkOnsale");
	...
	@Override
	public Class<UpdateTrademarkOnsaleResponse> getResponseClass() {
		return UpdateTrademarkOnsaleResponse.class;
	}
