 ...
 * @version 
 */
public class SaveTemporaryApplicantRequest extends RpcAcsRequest<SaveTemporaryApplicantResponse> {
	...
	public SaveTemporaryApplicantRequest() {
		super("Trademark", "2019-09-02", "SaveTemporaryApplicant");
	...
	public void setCompleteApplicant(Boolean completeApplicant) {
		this.completeApplicant = completeApplicant;
		if(completeApplicant != null){
			putQueryParameter("CompleteApplicant", completeApplicant.toString());
		}
	}
	...
	@Override
	public Class<SaveTemporaryApplicantResponse> getResponseClass() {
		return SaveTemporaryApplicantResponse.class;
	}
