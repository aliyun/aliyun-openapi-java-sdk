 ...
 * @version 
 */
public class UploadTrademarkOnSaleRequest extends RpcAcsRequest<UploadTrademarkOnSaleResponse> {
	...
	private String tradeTmDetailJson;
	...
	public UploadTrademarkOnSaleRequest() {
		super("Trademark", "2018-07-24", "UploadTrademarkOnSale");
	...
	public void setTradeTmDetailJson(String tradeTmDetailJson) {
		this.tradeTmDetailJson = tradeTmDetailJson;
		if(tradeTmDetailJson != null){
			putQueryParameter("TradeTmDetailJson", tradeTmDetailJson);
		}
	}
	...
	@Override
	public Class<UploadTrademarkOnSaleResponse> getResponseClass() {
		return UploadTrademarkOnSaleResponse.class;
	}
