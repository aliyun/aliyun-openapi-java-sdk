 ...
 * @version 
 */
public class ConfirmDissentOriginalRequest extends RpcAcsRequest<ConfirmDissentOriginalResponse> {
	...
	public ConfirmDissentOriginalRequest() {
		super("Trademark", "2018-07-24", "ConfirmDissentOriginal");
	...
	@Override
	public Class<ConfirmDissentOriginalResponse> getResponseClass() {
		return ConfirmDissentOriginalResponse.class;
	}
