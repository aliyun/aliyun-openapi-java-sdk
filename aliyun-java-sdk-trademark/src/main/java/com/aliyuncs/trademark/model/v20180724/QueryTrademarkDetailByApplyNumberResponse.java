...
import com.aliyuncs.trademark.transform.v20180724.QueryTrademarkDetailByApplyNumberResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryTrademarkDetailByApplyNumberResponse extends AcsResponse {
	...
	@Override
	public QueryTrademarkDetailByApplyNumberResponse getInstance(UnmarshallerContext context) {
		return	QueryTrademarkDetailByApplyNumberResponseUnmarshaller.unmarshall(this, context);
	}
}
