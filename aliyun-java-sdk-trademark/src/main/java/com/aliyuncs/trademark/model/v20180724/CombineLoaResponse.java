...
import com.aliyuncs.trademark.transform.v20180724.CombineLoaResponseUnmarshaller;
...
public class CombineLoaResponse extends AcsResponse {
	...
	@Override
	public CombineLoaResponse getInstance(UnmarshallerContext context) {
		return	CombineLoaResponseUnmarshaller.unmarshall(this, context);
	}
}
