...
import com.aliyuncs.trademark.model.v20190902.SubmitSupplementResponse;
...
public class SubmitSupplementResponseUnmarshaller {
	...
	public static SubmitSupplementResponse unmarshall(SubmitSupplementResponse submitSupplementResponse, UnmarshallerContext _ctx) {
		...
		submitSupplementResponse.setMessage(_ctx.stringValue("SubmitSupplementResponse.Message"));
		submitSupplementResponse.setCode(_ctx.stringValue("SubmitSupplementResponse.Code"));
