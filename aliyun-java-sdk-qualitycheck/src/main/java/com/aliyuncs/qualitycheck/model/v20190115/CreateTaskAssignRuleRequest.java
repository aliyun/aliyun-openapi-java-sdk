...
public class CreateTaskAssignRuleRequest extends RpcAcsRequest<CreateTaskAssignRuleResponse> {
	...
	public CreateTaskAssignRuleRequest() {
		super("Qualitycheck", "2019-01-15", "CreateTaskAssignRule", "Qualitycheck");
	...
	@Override
	public Class<CreateTaskAssignRuleResponse> getResponseClass() {
		return CreateTaskAssignRuleResponse.class;
	}
