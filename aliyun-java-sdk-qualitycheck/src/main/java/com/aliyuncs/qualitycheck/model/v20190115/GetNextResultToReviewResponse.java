...
import com.aliyuncs.qualitycheck.transform.v20190115.GetNextResultToReviewResponseUnmarshaller;
 ...
 * @version 
 */
public class GetNextResultToReviewResponse extends AcsResponse {
	...
	@Override
	public GetNextResultToReviewResponse getInstance(UnmarshallerContext context) {
		return	GetNextResultToReviewResponseUnmarshaller.unmarshall(this, context);
	}
}
