...
public class GetPrecisionTaskRequest extends RpcAcsRequest<GetPrecisionTaskResponse> {
	...
	public GetPrecisionTaskRequest() {
		super("Qualitycheck", "2019-01-15", "GetPrecisionTask", "Qualitycheck");
	...
	@Override
	public Class<GetPrecisionTaskResponse> getResponseClass() {
		return GetPrecisionTaskResponse.class;
	}
