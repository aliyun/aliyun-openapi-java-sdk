...
import com.aliyuncs.qualitycheck.transform.v20190115.GetRuleDimensionResponseUnmarshaller;
 ...
 * @version 
 */
public class GetRuleDimensionResponse extends AcsResponse {
	...
	@Override
	public GetRuleDimensionResponse getInstance(UnmarshallerContext context) {
		return	GetRuleDimensionResponseUnmarshaller.unmarshall(this, context);
	}
}
