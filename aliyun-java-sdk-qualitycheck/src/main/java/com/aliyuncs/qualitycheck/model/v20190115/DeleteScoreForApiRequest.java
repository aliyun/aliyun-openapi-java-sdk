...
public class DeleteScoreForApiRequest extends RpcAcsRequest<DeleteScoreForApiResponse> {
	...
	public DeleteScoreForApiRequest() {
		super("Qualitycheck", "2019-01-15", "DeleteScoreForApi", "Qualitycheck");
	...
	@Override
	public Class<DeleteScoreForApiResponse> getResponseClass() {
		return DeleteScoreForApiResponse.class;
	}
