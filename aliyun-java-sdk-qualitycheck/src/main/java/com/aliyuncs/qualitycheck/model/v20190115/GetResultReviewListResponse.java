...
import com.aliyuncs.qualitycheck.transform.v20190115.GetResultReviewListResponseUnmarshaller;
 ...
 * @version 
 */
public class GetResultReviewListResponse extends AcsResponse {
	...
	@Override
	public GetResultReviewListResponse getInstance(UnmarshallerContext context) {
		return	GetResultReviewListResponseUnmarshaller.unmarshall(this, context);
	}
}
