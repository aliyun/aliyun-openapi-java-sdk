...
import com.aliyuncs.qualitycheck.transform.v20190115.GetReviewInfoResponseUnmarshaller;
 ...
 * @version 
 */
public class GetReviewInfoResponse extends AcsResponse {
	...
	@Override
	public GetReviewInfoResponse getInstance(UnmarshallerContext context) {
		return	GetReviewInfoResponseUnmarshaller.unmarshall(this, context);
	}
}
