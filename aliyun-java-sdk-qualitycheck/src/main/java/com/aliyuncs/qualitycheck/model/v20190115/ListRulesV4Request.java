 ...
 * @version 
 */
public class ListRulesV4Request extends RpcAcsRequest<ListRulesV4Response> {
	...
	public ListRulesV4Request() {
		super("Qualitycheck", "2019-01-15", "ListRulesV4");
	...
	@Override
	public Class<ListRulesV4Response> getResponseClass() {
		return ListRulesV4Response.class;
	}
