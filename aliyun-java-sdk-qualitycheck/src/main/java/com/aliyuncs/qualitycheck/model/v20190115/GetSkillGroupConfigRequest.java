...
public class GetSkillGroupConfigRequest extends RpcAcsRequest<GetSkillGroupConfigResponse> {
	...
	public GetSkillGroupConfigRequest() {
		super("Qualitycheck", "2019-01-15", "GetSkillGroupConfig", "Qualitycheck");
	...
	@Override
	public Class<GetSkillGroupConfigResponse> getResponseClass() {
		return GetSkillGroupConfigResponse.class;
	}
