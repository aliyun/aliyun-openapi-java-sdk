...
import com.aliyuncs.qualitycheck.model.v20190115.GetHitResultResponse.ResultInfo;
import com.aliyuncs.transform.UnmarshallerContext;


public class GetHitResultResponseUnmarshaller {

	public static GetHitResultResponse unmarshall(GetHitResultResponse getHitResultResponse, UnmarshallerContext _ctx) {
		
		getHitResultResponse.setRequestId(_ctx.stringValue("GetHitResultResponse.RequestId"));
		...
		getHitResultResponse.setData(data);
