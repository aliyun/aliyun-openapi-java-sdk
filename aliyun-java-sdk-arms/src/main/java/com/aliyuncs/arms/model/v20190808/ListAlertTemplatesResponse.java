...
import com.aliyuncs.arms.transform.v20190808.ListAlertTemplatesResponseUnmarshaller;
 ...
 * @version 
 */
public class ListAlertTemplatesResponse extends AcsResponse {
	...
	@Override
	public ListAlertTemplatesResponse getInstance(UnmarshallerContext context) {
		return	ListAlertTemplatesResponseUnmarshaller.unmarshall(this, context);
	}
