 ...
 * @version 
 */
public class DescribeEnvServiceMonitorRequest extends RpcAcsRequest<DescribeEnvServiceMonitorResponse> {
	...
	public DescribeEnvServiceMonitorRequest() {
		super("ARMS", "2019-08-08", "DescribeEnvServiceMonitor", "arms");
	...
	@Override
	public Class<DescribeEnvServiceMonitorResponse> getResponseClass() {
		return DescribeEnvServiceMonitorResponse.class;
	}
