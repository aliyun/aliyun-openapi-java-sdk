...
public class DescribeEnvironmentFeatureRequest extends RpcAcsRequest<DescribeEnvironmentFeatureResponse> {
	...
	public DescribeEnvironmentFeatureRequest() {
		super("ARMS", "2019-08-08", "DescribeEnvironmentFeature", "arms");
	...
	@Override
	public Class<DescribeEnvironmentFeatureResponse> getResponseClass() {
		return DescribeEnvironmentFeatureResponse.class;
	}
