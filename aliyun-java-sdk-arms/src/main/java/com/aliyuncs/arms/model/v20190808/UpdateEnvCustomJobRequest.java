 ...
 * @version 
 */
public class UpdateEnvCustomJobRequest extends RpcAcsRequest<UpdateEnvCustomJobResponse> {
	...
	public UpdateEnvCustomJobRequest() {
		super("ARMS", "2019-08-08", "UpdateEnvCustomJob", "arms");
	...
	@Override
	public Class<UpdateEnvCustomJobResponse> getResponseClass() {
		return UpdateEnvCustomJobResponse.class;
	}
