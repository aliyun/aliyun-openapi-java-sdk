 ...
 * @version 
 */
public class DescribeEnvPodMonitorRequest extends RpcAcsRequest<DescribeEnvPodMonitorResponse> {
	...
	public DescribeEnvPodMonitorRequest() {
		super("ARMS", "2019-08-08", "DescribeEnvPodMonitor", "arms");
	...
	@Override
	public Class<DescribeEnvPodMonitorResponse> getResponseClass() {
		return DescribeEnvPodMonitorResponse.class;
	}
