 ...
 * @version 
 */
public class DeletePrometheusGlobalViewRequest extends RpcAcsRequest<DeletePrometheusGlobalViewResponse> {
	...
	@Override
	public Class<DeletePrometheusGlobalViewResponse> getResponseClass() {
		return DeletePrometheusGlobalViewResponse.class;
	}
