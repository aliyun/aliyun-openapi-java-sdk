 ...
 * @version 
 */
public class InstallAddonRequest extends RpcAcsRequest<InstallAddonResponse> {
	...
	public InstallAddonRequest() {
		super("ARMS", "2019-08-08", "InstallAddon", "arms");
	...
	@Override
	public Class<InstallAddonResponse> getResponseClass() {
		return InstallAddonResponse.class;
	}
