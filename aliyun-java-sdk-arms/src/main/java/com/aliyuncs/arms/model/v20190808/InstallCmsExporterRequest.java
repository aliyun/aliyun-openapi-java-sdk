 ...
 * @version 
 */
public class InstallCmsExporterRequest extends RpcAcsRequest<InstallCmsExporterResponse> {
	...
	public void setCmsArgs(String cmsArgs) {
		this.cmsArgs = cmsArgs;
		if(cmsArgs != null){
			putQueryParameter("CmsArgs", cmsArgs);
		}
	}
	...
	public void setEnableTag(Boolean enableTag) {
		...
		if(enableTag != null){
			putQueryParameter("EnableTag", enableTag.toString());
		}
	}

	@Override
	public Class<InstallCmsExporterResponse> getResponseClass() {
		return InstallCmsExporterResponse.class;
	}
