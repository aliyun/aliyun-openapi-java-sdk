...
public class GetMultipleTraceRequest extends RpcAcsRequest<GetMultipleTraceResponse> {
	...
	public List<String> getTraceIDss() {
		return this.traceIDss;
	}

	public void setTraceIDss(List<String> traceIDss) {
		this.traceIDss = traceIDss;	
		if (traceIDss != null) {
			for (int i = 0; i < traceIDss.size(); i++) {
