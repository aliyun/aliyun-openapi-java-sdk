 ...
 * @version 
 */
public class UpdateEnvServiceMonitorRequest extends RpcAcsRequest<UpdateEnvServiceMonitorResponse> {
	...
	public UpdateEnvServiceMonitorRequest() {
		super("ARMS", "2019-08-08", "UpdateEnvServiceMonitor", "arms");
	...
	@Override
	public Class<UpdateEnvServiceMonitorResponse> getResponseClass() {
		return UpdateEnvServiceMonitorResponse.class;
	}
