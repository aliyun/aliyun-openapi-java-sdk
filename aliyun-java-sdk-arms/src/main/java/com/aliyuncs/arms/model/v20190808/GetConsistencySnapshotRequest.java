 ...
 * @version 
 */
public class GetConsistencySnapshotRequest extends RpcAcsRequest<GetConsistencySnapshotResponse> {
	...
	@Override
	public Class<GetConsistencySnapshotResponse> getResponseClass() {
		return GetConsistencySnapshotResponse.class;
	}
