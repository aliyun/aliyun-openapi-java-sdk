 ...
 * @version 
 */
public class UpdateTimingSyntheticTaskRequest extends RpcAcsRequest<UpdateTimingSyntheticTaskResponse> {
	...
	public UpdateTimingSyntheticTaskRequest() {
		super("ARMS", "2019-08-08", "UpdateTimingSyntheticTask", "arms");
	...
	@Override
	public Class<UpdateTimingSyntheticTaskResponse> getResponseClass() {
		return UpdateTimingSyntheticTaskResponse.class;
	}
