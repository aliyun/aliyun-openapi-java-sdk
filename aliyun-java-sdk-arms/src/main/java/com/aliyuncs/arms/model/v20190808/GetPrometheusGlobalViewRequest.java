 ...
 * @version 
 */
public class GetPrometheusGlobalViewRequest extends RpcAcsRequest<GetPrometheusGlobalViewResponse> {
	   

	private String globalViewClusterId;
	public GetPrometheusGlobalViewRequest() {
		super("ARMS", "2019-08-08", "GetPrometheusGlobalView", "arms");
	...
	@Override
	public Class<GetPrometheusGlobalViewResponse> getResponseClass() {
		return GetPrometheusGlobalViewResponse.class;
	}
