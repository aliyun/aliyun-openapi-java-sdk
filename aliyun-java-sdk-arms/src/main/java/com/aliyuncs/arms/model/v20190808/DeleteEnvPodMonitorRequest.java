 ...
 * @version 
 */
public class DeleteEnvPodMonitorRequest extends RpcAcsRequest<DeleteEnvPodMonitorResponse> {
	...
	public DeleteEnvPodMonitorRequest() {
		super("ARMS", "2019-08-08", "DeleteEnvPodMonitor", "arms");
	...
	@Override
	public Class<DeleteEnvPodMonitorResponse> getResponseClass() {
		return DeleteEnvPodMonitorResponse.class;
	}
