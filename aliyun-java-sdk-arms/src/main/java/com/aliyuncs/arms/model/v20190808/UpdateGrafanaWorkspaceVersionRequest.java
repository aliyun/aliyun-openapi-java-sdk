 ...
 * @version 
 */
public class UpdateGrafanaWorkspaceVersionRequest extends RpcAcsRequest<UpdateGrafanaWorkspaceVersionResponse> {
	...
	public UpdateGrafanaWorkspaceVersionRequest() {
		super("ARMS", "2019-08-08", "UpdateGrafanaWorkspaceVersion", "arms");
	...
	@Override
	public Class<UpdateGrafanaWorkspaceVersionResponse> getResponseClass() {
