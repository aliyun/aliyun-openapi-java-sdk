 ...
 * @version 
 */
public class CreateEnvPodMonitorRequest extends RpcAcsRequest<CreateEnvPodMonitorResponse> {
	...
	public CreateEnvPodMonitorRequest() {
		super("ARMS", "2019-08-08", "CreateEnvPodMonitor", "arms");
	...
	@Override
	public Class<CreateEnvPodMonitorResponse> getResponseClass() {
