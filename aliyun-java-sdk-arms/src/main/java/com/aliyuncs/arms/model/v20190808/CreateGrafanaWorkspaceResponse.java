...
import com.aliyuncs.arms.transform.v20190808.CreateGrafanaWorkspaceResponseUnmarshaller;
 ...
 * @version 
 */
public class CreateGrafanaWorkspaceResponse extends AcsResponse {
	...
	@Override
	public CreateGrafanaWorkspaceResponse getInstance(UnmarshallerContext context) {
		return	CreateGrafanaWorkspaceResponseUnmarshaller.unmarshall(this, context);
	}
