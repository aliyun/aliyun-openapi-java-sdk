...
public class UninstallManagedPrometheusRequest extends RpcAcsRequest<UninstallManagedPrometheusResponse> {
	...
	public UninstallManagedPrometheusRequest() {
		super("ARMS", "2019-08-08", "UninstallManagedPrometheus");
	...
	@Override
	public Class<UninstallManagedPrometheusResponse> getResponseClass() {
		return UninstallManagedPrometheusResponse.class;
	}
