 ...
 * @version 
 */
public class DescribeUisNodesRequest extends RpcAcsRequest<DescribeUisNodesResponse> {
	
	public DescribeUisNodesRequest() {
		super("Uis", "2018-08-21", "DescribeUisNodes", "uis");
	}
	...
	@Override
	public Class<DescribeUisNodesResponse> getResponseClass() {
		return DescribeUisNodesResponse.class;
	}
