 ...
 * @version 
 */
public class DeleteUisNetworkInterfaceRequest extends RpcAcsRequest<DeleteUisNetworkInterfaceResponse> {
	
	public DeleteUisNetworkInterfaceRequest() {
		super("Uis", "2018-08-21", "DeleteUisNetworkInterface", "uis");
	}
	...
	@Override
	public Class<DeleteUisNetworkInterfaceResponse> getResponseClass() {
		return DeleteUisNetworkInterfaceResponse.class;
	}
