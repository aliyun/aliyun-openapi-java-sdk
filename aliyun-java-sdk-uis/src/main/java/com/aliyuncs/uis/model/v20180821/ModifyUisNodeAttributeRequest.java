 ...
 * @version 
 */
public class ModifyUisNodeAttributeRequest extends RpcAcsRequest<ModifyUisNodeAttributeResponse> {
	
	public ModifyUisNodeAttributeRequest() {
		super("Uis", "2018-08-21", "ModifyUisNodeAttribute", "uis");
	}
	...
	@Override
	public Class<ModifyUisNodeAttributeResponse> getResponseClass() {
		return ModifyUisNodeAttributeResponse.class;
	}
