 ...
 * @version 
 */
public class SetAccessLogRequest extends RpcAcsRequest<SetAccessLogResponse> {
	
	public SetAccessLogRequest() {
		super("Uis", "2018-08-21", "SetAccessLog", "uis");
	}
	...
	public void setLogProjectName(String logProjectName) {
		...
		if(logProjectName != null){
			putQueryParameter("LogProjectName", logProjectName);
		}
	}
	...
	@Override
	public Class<SetAccessLogResponse> getResponseClass() {
		return SetAccessLogResponse.class;
	}
