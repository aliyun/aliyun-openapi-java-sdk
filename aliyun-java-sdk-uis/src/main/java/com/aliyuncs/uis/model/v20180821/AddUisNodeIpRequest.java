 ...
 * @version 
 */
public class AddUisNodeIpRequest extends RpcAcsRequest<AddUisNodeIpResponse> {
	
	public AddUisNodeIpRequest() {
		super("Uis", "2018-08-21", "AddUisNodeIp", "uis");
	}
	...
	@Override
	public Class<AddUisNodeIpResponse> getResponseClass() {
		return AddUisNodeIpResponse.class;
	}
