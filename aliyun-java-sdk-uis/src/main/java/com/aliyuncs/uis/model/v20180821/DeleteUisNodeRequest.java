 ...
 * @version 
 */
public class DeleteUisNodeRequest extends RpcAcsRequest<DeleteUisNodeResponse> {
	
	public DeleteUisNodeRequest() {
		super("Uis", "2018-08-21", "DeleteUisNode", "uis");
	}
	...
	@Override
	public Class<DeleteUisNodeResponse> getResponseClass() {
		return DeleteUisNodeResponse.class;
	}
