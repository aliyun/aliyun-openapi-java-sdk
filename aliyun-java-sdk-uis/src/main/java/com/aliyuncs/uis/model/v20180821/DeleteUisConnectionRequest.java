 ...
 * @version 
 */
public class DeleteUisConnectionRequest extends RpcAcsRequest<DeleteUisConnectionResponse> {
	
	public DeleteUisConnectionRequest() {
		super("Uis", "2018-08-21", "DeleteUisConnection", "uis");
	}
	...
	@Override
	public Class<DeleteUisConnectionResponse> getResponseClass() {
		return DeleteUisConnectionResponse.class;
	}
