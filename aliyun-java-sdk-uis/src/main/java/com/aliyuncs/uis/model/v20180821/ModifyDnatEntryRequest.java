 ...
 * @version 
 */
public class ModifyDnatEntryRequest extends RpcAcsRequest<ModifyDnatEntryResponse> {
	
	public ModifyDnatEntryRequest() {
		super("Uis", "2018-08-21", "ModifyDnatEntry", "uis");
	}
	...
	@Override
	public Class<ModifyDnatEntryResponse> getResponseClass() {
		return ModifyDnatEntryResponse.class;
	}
