 ...
 * @version 
 */
public class DescribeDnatEntriesRequest extends RpcAcsRequest<DescribeDnatEntriesResponse> {
	
	public DescribeDnatEntriesRequest() {
		super("Uis", "2018-08-21", "DescribeDnatEntries", "uis");
	}
	...
	public void setUisDnatId(String uisDnatId) {
		...
		if(uisDnatId != null){
			putQueryParameter("UisDnatId", uisDnatId);
		}
	}
	...
	@Override
	public Class<DescribeDnatEntriesResponse> getResponseClass() {
		return DescribeDnatEntriesResponse.class;
	}
