 ...
 * @version 
 */
public class ModifyUisConnectionAttributeRequest extends RpcAcsRequest<ModifyUisConnectionAttributeResponse> {
	
	public ModifyUisConnectionAttributeRequest() {
		super("Uis", "2018-08-21", "ModifyUisConnectionAttribute", "uis");
	}
	...
	@Override
	public Class<ModifyUisConnectionAttributeResponse> getResponseClass() {
		return ModifyUisConnectionAttributeResponse.class;
	}
