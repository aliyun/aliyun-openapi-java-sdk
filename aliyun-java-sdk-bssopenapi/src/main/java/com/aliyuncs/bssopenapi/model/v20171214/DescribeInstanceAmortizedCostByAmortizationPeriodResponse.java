...
import com.aliyuncs.bssopenapi.transform.v20171214.DescribeInstanceAmortizedCostByAmortizationPeriodResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeInstanceAmortizedCostByAmortizationPeriodResponse extends AcsResponse {
	...
	@Override
	public DescribeInstanceAmortizedCostByAmortizationPeriodResponse getInstance(UnmarshallerContext context) {
		return	DescribeInstanceAmortizedCostByAmortizationPeriodResponseUnmarshaller.unmarshall(this, context);
	}
