 ...
 * @version 
 */
public class SetUserAlarmThresholdRequest extends RpcAcsRequest<SetUserAlarmThresholdResponse> {
	
	public SetUserAlarmThresholdRequest() {
		super("BssOpenApi", "2017-12-14", "SetUserAlarmThreshold");
	}
	...
	@Override
	public Class<SetUserAlarmThresholdResponse> getResponseClass() {
		return SetUserAlarmThresholdResponse.class;
	}
