...
import com.aliyuncs.bssopenapi.transform.v20171214.AllocateCostUnitResourceResponseUnmarshaller;
...
public class AllocateCostUnitResourceResponse extends AcsResponse {
	...
	@Override
	public AllocateCostUnitResourceResponse getInstance(UnmarshallerContext context) {
		return	AllocateCostUnitResourceResponseUnmarshaller.unmarshall(this, context);
	}
