 ...
 * @version 
 */
public class SubscribeDetailRequest extends RpcAcsRequest<SubscribeDetailResponse> {
	
	public SubscribeDetailRequest() {
		super("BssOpenApi", "2017-12-14", "SubscribeDetail");
	}
	...
	@Override
	public Class<SubscribeDetailResponse> getResponseClass() {
		return SubscribeDetailResponse.class;
	}
