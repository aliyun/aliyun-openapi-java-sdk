 ...
 * @version 
 */
public class DescribeInstanceAmortizedCostByAmortizationPeriodRequest extends RpcAcsRequest<DescribeInstanceAmortizedCostByAmortizationPeriodResponse> {
	...
	public DescribeInstanceAmortizedCostByAmortizationPeriodRequest() {
		super("BssOpenApi", "2017-12-14", "DescribeInstanceAmortizedCostByAmortizationPeriod", "bssopenapi");
	...
	@Override
	public Class<DescribeInstanceAmortizedCostByAmortizationPeriodResponse> getResponseClass() {
		return DescribeInstanceAmortizedCostByAmortizationPeriodResponse.class;
	}
