 ...
 * @version 
 */
public class DescribeResourceCoverageTotalRequest extends RpcAcsRequest<DescribeResourceCoverageTotalResponse> {
	...
	@Override
	public Class<DescribeResourceCoverageTotalResponse> getResponseClass() {
		return DescribeResourceCoverageTotalResponse.class;
	}
