 ...
 * @version 
 */
public class DescribeSavingsPlansUsageDetailRequest extends RpcAcsRequest<DescribeSavingsPlansUsageDetailResponse> {
	...
	@Override
	public Class<DescribeSavingsPlansUsageDetailResponse> getResponseClass() {
		return DescribeSavingsPlansUsageDetailResponse.class;
	}
