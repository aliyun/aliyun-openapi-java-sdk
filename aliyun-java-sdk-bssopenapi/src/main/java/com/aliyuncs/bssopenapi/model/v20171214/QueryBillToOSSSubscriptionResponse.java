...
public class QueryBillToOSSSubscriptionResponse extends AcsResponse {
	...
	@Override
	public QueryBillToOSSSubscriptionResponse getInstance(UnmarshallerContext context) {
		return	QueryBillToOSSSubscriptionResponseUnmarshaller.unmarshall(this, context);
	}
}
