 ...
 * @version 
 */
public class DescribeInstanceDeductAmortizedCostByAmortizationPeriodRequest extends RpcAcsRequest<DescribeInstanceDeductAmortizedCostByAmortizationPeriodResponse> {
	...
	public DescribeInstanceDeductAmortizedCostByAmortizationPeriodRequest() {
		super("BssOpenApi", "2017-12-14", "DescribeInstanceDeductAmortizedCostByAmortizationPeriod", "bssopenapi");
	...
	@Override
	public Class<DescribeInstanceDeductAmortizedCostByAmortizationPeriodResponse> getResponseClass() {
		return DescribeInstanceDeductAmortizedCostByAmortizationPeriodResponse.class;
	}
