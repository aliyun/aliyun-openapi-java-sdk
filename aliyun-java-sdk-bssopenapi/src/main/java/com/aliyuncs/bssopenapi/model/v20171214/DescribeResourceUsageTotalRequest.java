 ...
 * @version 
 */
public class DescribeResourceUsageTotalRequest extends RpcAcsRequest<DescribeResourceUsageTotalResponse> {
	...
	@Override
	public Class<DescribeResourceUsageTotalResponse> getResponseClass() {
