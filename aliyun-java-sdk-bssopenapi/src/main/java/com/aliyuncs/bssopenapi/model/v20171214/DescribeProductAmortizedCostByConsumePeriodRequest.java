 ...
 * @version 
 */
public class DescribeProductAmortizedCostByConsumePeriodRequest extends RpcAcsRequest<DescribeProductAmortizedCostByConsumePeriodResponse> {
	...
	public DescribeProductAmortizedCostByConsumePeriodRequest() {
		super("BssOpenApi", "2017-12-14", "DescribeProductAmortizedCostByConsumePeriod", "bssopenapi");
	...
	@Override
	public Class<DescribeProductAmortizedCostByConsumePeriodResponse> getResponseClass() {
