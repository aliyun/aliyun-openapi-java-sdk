...
public class Endpoint {
    public static HashMap<String, String> endpointMap = new HashMap<String, String>() {
        {
            put("cn-shanghai-internal-test-1", "business.aliyuncs.com");
            put("cn-shenzhen-su18-b01", "business.aliyuncs.com");
            put("cn-beijing", "business.aliyuncs.com");
            put("cn-shanghai-inner", "business.aliyuncs.com");
            put("cn-hangzhou-internal-prod-1", "business.aliyuncs.com");
            put("cn-north-2-gov-1", "business.aliyuncs.com");
            put("cn-yushanfang", "business.aliyuncs.com");
            put("cn-qingdao-nebula", "business.aliyuncs.com");
            put("cn-beijing-finance-pop", "business.aliyuncs.com");
            ...
            put("cn-hongkong-finance-pop", "business.aliyuncs.com");
            ...
            put("cn-zhengzhou-nebula-1", "business.aliyuncs.com");
            put("eu-west-1", "business.ap-southeast-1.aliyuncs.com");
            put("cn-hangzhou-internal-test-1", "business.aliyuncs.com");
            put("eu-west-1-oxs", "business.ap-southeast-1.aliyuncs.com");
            put("cn-beijing-finance-1", "business.aliyuncs.com");
            put("cn-hangzhou-internal-test-3", "business.aliyuncs.com");
            put("cn-hangzhou-internal-test-2", "business.aliyuncs.com");
            ...
            put("cn-hangzhou-test-306", "business.aliyuncs.com");
            put("cn-hangzhou-finance", "business.aliyuncs.com");
            put("cn-beijing-nu16-b01", "business.aliyuncs.com");
            put("cn-edge-1", "business.aliyuncs.com");
            put("cn-huhehaote", "business.aliyuncs.com");
            put("cn-fujian", "business.aliyuncs.com");
            put("ap-northeast-2-pop", "business.ap-southeast-1.aliyuncs.com");
