 ...
 * @version 
 */
public class AddHotlineNumberRequest extends RpcAcsRequest<AddHotlineNumberResponse> {
	...
	public AddHotlineNumberRequest() {
		super("aiccs", "2019-10-15", "AddHotlineNumber");
	...
	@Override
	public Class<AddHotlineNumberResponse> getResponseClass() {
		return AddHotlineNumberResponse.class;
	}
