...
public class StartTaskResponseUnmarshaller {
	...
	public static StartTaskResponse unmarshall(StartTaskResponse startTaskResponse, UnmarshallerContext _ctx) {
		...
		startTaskResponse.setData(_ctx.booleanValue("StartTaskResponse.Data"));
		startTaskResponse.setCode(_ctx.stringValue("StartTaskResponse.Code"));
		startTaskResponse.setMessage(_ctx.stringValue("StartTaskResponse.Message"));
