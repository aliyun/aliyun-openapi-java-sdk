...
public class DescribeVodTranscodeDataResponse extends AcsResponse {
	...
	public void setTranscodeData(List<TranscodeDataItem> transcodeData) {
	...
	@Override
	public DescribeVodTranscodeDataResponse getInstance(UnmarshallerContext context) {
		return	DescribeVodTranscodeDataResponseUnmarshaller.unmarshall(this, context);
	}
}
