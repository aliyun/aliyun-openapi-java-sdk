...
import com.aliyuncs.vod.transform.v20170321.DescribeVodServiceResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeVodServiceResponse extends AcsResponse {
	...
	@Override
	public DescribeVodServiceResponse getInstance(UnmarshallerContext context) {
		return	DescribeVodServiceResponseUnmarshaller.unmarshall(this, context);
	}
}
