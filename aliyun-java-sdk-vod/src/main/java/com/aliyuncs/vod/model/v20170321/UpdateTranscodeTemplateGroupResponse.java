...
public class UpdateTranscodeTemplateGroupResponse extends AcsResponse {
	...
	@Override
	public UpdateTranscodeTemplateGroupResponse getInstance(UnmarshallerContext context) {
		return	UpdateTranscodeTemplateGroupResponseUnmarshaller.unmarshall(this, context);
	}
}
