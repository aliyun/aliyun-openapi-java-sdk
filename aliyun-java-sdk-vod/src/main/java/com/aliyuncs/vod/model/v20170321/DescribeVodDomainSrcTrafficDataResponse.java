...
import com.aliyuncs.vod.transform.v20170321.DescribeVodDomainSrcTrafficDataResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeVodDomainSrcTrafficDataResponse extends AcsResponse {
	...
	@Override
	public DescribeVodDomainSrcTrafficDataResponse getInstance(UnmarshallerContext context) {
		return	DescribeVodDomainSrcTrafficDataResponseUnmarshaller.unmarshall(this, context);
	}
}
