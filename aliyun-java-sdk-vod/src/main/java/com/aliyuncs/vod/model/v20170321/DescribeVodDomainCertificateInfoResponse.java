...
public class DescribeVodDomainCertificateInfoResponse extends AcsResponse {
	...
	@Override
	public DescribeVodDomainCertificateInfoResponse getInstance(UnmarshallerContext context) {
		return	DescribeVodDomainCertificateInfoResponseUnmarshaller.unmarshall(this, context);
	}
}
