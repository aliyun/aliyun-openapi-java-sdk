...
import com.aliyuncs.vod.transform.v20170321.RestoreMediaResponseUnmarshaller;
 ...
 * @version 
 */
public class RestoreMediaResponse extends AcsResponse {
	...
	@Override
	public RestoreMediaResponse getInstance(UnmarshallerContext context) {
		return	RestoreMediaResponseUnmarshaller.unmarshall(this, context);
	}
}
