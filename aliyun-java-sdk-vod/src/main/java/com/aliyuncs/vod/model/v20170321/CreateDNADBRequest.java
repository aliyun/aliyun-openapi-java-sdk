 ...
 * @version 
 */
public class CreateDNADBRequest extends RpcAcsRequest<CreateDNADBResponse> {
	...
	public CreateDNADBRequest() {
		super("vod", "2017-03-21", "CreateDNADB", "vod");
	...
	public void setDBRegion(String dBRegion) {
		...
		if(dBRegion != null){
			putQueryParameter("DBRegion", dBRegion);
		}
	}
	...
	@Override
	public Class<CreateDNADBResponse> getResponseClass() {
		return CreateDNADBResponse.class;
	}
