 ...
 * @version 
 */
public class DescribeVodDomainRealTimeDetailDataRequest extends RpcAcsRequest<DescribeVodDomainRealTimeDetailDataResponse> {
	...
	public DescribeVodDomainRealTimeDetailDataRequest() {
		super("vod", "2017-03-21", "DescribeVodDomainRealTimeDetailData", "vod");
	...
	@Override
	public Class<DescribeVodDomainRealTimeDetailDataResponse> getResponseClass() {
		return DescribeVodDomainRealTimeDetailDataResponse.class;
	}
