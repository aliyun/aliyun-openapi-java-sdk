...
import com.aliyuncs.vod.transform.v20170321.DescribeVodUserResourcePackageResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeVodUserResourcePackageResponse extends AcsResponse {
	...
	@Override
	public DescribeVodUserResourcePackageResponse getInstance(UnmarshallerContext context) {
		return	DescribeVodUserResourcePackageResponseUnmarshaller.unmarshall(this, context);
	}
}
