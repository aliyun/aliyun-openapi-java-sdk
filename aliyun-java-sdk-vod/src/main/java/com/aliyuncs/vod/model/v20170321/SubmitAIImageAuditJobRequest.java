 ...
 * @version 
 */
public class SubmitAIImageAuditJobRequest extends RpcAcsRequest<SubmitAIImageAuditJobResponse> {
	...
	public SubmitAIImageAuditJobRequest() {
		super("vod", "2017-03-21", "SubmitAIImageAuditJob", "vod");
	...
	@Override
	public Class<SubmitAIImageAuditJobResponse> getResponseClass() {
		return SubmitAIImageAuditJobResponse.class;
	}
