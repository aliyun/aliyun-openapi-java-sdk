...
import com.aliyuncs.vod.transform.v20170321.DescribeUserVvByVideoidResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeUserVvByVideoidResponse extends AcsResponse {
	...
	@Override
	public DescribeUserVvByVideoidResponse getInstance(UnmarshallerContext context) {
		return	DescribeUserVvByVideoidResponseUnmarshaller.unmarshall(this, context);
	}
}
