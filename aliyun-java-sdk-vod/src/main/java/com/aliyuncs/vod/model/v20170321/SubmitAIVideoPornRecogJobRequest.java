...
public class SubmitAIVideoPornRecogJobRequest extends RpcAcsRequest<SubmitAIVideoPornRecogJobResponse> {
	...
	public void setAIVideoPornRecogConfig(String aIVideoPornRecogConfig) {
		this.aIVideoPornRecogConfig = aIVideoPornRecogConfig;
		if(aIVideoPornRecogConfig != null){
			putQueryParameter("AIVideoPornRecogConfig", aIVideoPornRecogConfig);
		}
	}
	...
	@Override
	public Class<SubmitAIVideoPornRecogJobResponse> getResponseClass() {
		return SubmitAIVideoPornRecogJobResponse.class;
	}
