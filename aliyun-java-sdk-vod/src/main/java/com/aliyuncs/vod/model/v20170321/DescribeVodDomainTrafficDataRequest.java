...
public class DescribeVodDomainTrafficDataRequest extends RpcAcsRequest<DescribeVodDomainTrafficDataResponse> {
	...
	public DescribeVodDomainTrafficDataRequest() {
		super("vod", "2017-03-21", "DescribeVodDomainTrafficData");
	...
	@Override
	public Class<DescribeVodDomainTrafficDataResponse> getResponseClass() {
		return DescribeVodDomainTrafficDataResponse.class;
	}
