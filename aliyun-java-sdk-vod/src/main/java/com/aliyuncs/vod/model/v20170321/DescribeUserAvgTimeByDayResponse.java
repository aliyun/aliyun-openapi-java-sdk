...
import com.aliyuncs.vod.transform.v20170321.DescribeUserAvgTimeByDayResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeUserAvgTimeByDayResponse extends AcsResponse {
	...
	@Override
	public DescribeUserAvgTimeByDayResponse getInstance(UnmarshallerContext context) {
		return	DescribeUserAvgTimeByDayResponseUnmarshaller.unmarshall(this, context);
	}
}
