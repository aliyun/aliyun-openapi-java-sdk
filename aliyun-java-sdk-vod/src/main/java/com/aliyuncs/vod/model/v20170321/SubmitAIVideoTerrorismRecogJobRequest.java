...
public class SubmitAIVideoTerrorismRecogJobRequest extends RpcAcsRequest<SubmitAIVideoTerrorismRecogJobResponse> {
	...
	public void setAIVideoTerrorismRecogConfig(String aIVideoTerrorismRecogConfig) {
		this.aIVideoTerrorismRecogConfig = aIVideoTerrorismRecogConfig;
		if(aIVideoTerrorismRecogConfig != null){
			putQueryParameter("AIVideoTerrorismRecogConfig", aIVideoTerrorismRecogConfig);
		}
	}
	...
	@Override
	public Class<SubmitAIVideoTerrorismRecogJobResponse> getResponseClass() {
		return SubmitAIVideoTerrorismRecogJobResponse.class;
	}
