...
import com.aliyuncs.vod.transform.v20170321.DescribeVodDomainHttpCodeDataResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeVodDomainHttpCodeDataResponse extends AcsResponse {
	...
	@Override
	public DescribeVodDomainHttpCodeDataResponse getInstance(UnmarshallerContext context) {
		return	DescribeVodDomainHttpCodeDataResponseUnmarshaller.unmarshall(this, context);
	}
}
