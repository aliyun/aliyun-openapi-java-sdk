...
import com.aliyuncs.vod.transform.v20170321.DescribeUserTimeRangeByDayResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeUserTimeRangeByDayResponse extends AcsResponse {
	...
	@Override
	public DescribeUserTimeRangeByDayResponse getInstance(UnmarshallerContext context) {
		return	DescribeUserTimeRangeByDayResponseUnmarshaller.unmarshall(this, context);
	}
}
