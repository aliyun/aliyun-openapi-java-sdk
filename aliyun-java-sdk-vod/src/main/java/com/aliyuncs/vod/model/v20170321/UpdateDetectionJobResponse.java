...
import com.aliyuncs.vod.transform.v20170321.UpdateDetectionJobResponseUnmarshaller;
 ...
 * @version 
 */
public class UpdateDetectionJobResponse extends AcsResponse {
	...
	@Override
	public UpdateDetectionJobResponse getInstance(UnmarshallerContext context) {
		return	UpdateDetectionJobResponseUnmarshaller.unmarshall(this, context);
	}
