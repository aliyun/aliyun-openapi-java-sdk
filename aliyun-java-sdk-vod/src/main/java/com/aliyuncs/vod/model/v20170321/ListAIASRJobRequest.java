...
public class ListAIASRJobRequest extends RpcAcsRequest<ListAIASRJobResponse> {
	...
	public void setAIASRJobIds(String aIASRJobIds) {
		this.aIASRJobIds = aIASRJobIds;
		if(aIASRJobIds != null){
			putQueryParameter("AIASRJobIds", aIASRJobIds);
		}
	}

	@Override
	public Class<ListAIASRJobResponse> getResponseClass() {
		return ListAIASRJobResponse.class;
	}
