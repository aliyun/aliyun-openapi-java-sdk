 ...
 * @version 
 */
public class RestoreMediaRequest extends RpcAcsRequest<RestoreMediaResponse> {
	...
	public RestoreMediaRequest() {
		super("vod", "2017-03-21", "RestoreMedia", "vod");
	...
	public void setRestoreDays(String restoreDays) {
		this.restoreDays = restoreDays;
		if(restoreDays != null){
			putQueryParameter("RestoreDays", restoreDays);
		}
	}
	...
	@Override
	public Class<RestoreMediaResponse> getResponseClass() {
		return RestoreMediaResponse.class;
	}
