...
import com.aliyuncs.vod.transform.v20170321.DescribeVodUserQuotaResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeVodUserQuotaResponse extends AcsResponse {
	...
	@Override
	public DescribeVodUserQuotaResponse getInstance(UnmarshallerContext context) {
		return	DescribeVodUserQuotaResponseUnmarshaller.unmarshall(this, context);
	}
}
