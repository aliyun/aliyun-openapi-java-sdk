...
public class ListAIVideoCensorJobRequest extends RpcAcsRequest<ListAIVideoCensorJobResponse> {
	...
	public void setAIVideoCensorJobIds(String aIVideoCensorJobIds) {
		this.aIVideoCensorJobIds = aIVideoCensorJobIds;
		if(aIVideoCensorJobIds != null){
			putQueryParameter("AIVideoCensorJobIds", aIVideoCensorJobIds);
		}
	}
	...
	@Override
	public Class<ListAIVideoCensorJobResponse> getResponseClass() {
		return ListAIVideoCensorJobResponse.class;
	}
