 ...
 * @version 
 */
public class SubmitLiveEditingRequest extends RpcAcsRequest<SubmitLiveEditingResponse> {
	...
	@Override
	public Class<SubmitLiveEditingResponse> getResponseClass() {
		return SubmitLiveEditingResponse.class;
	}
