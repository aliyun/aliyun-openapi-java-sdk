...
import com.aliyuncs.vod.transform.v20170321.GetImageInfosResponseUnmarshaller;
 ...
 * @version 
 */
public class GetImageInfosResponse extends AcsResponse {
	...
	@Override
	public GetImageInfosResponse getInstance(UnmarshallerContext context) {
		return	GetImageInfosResponseUnmarshaller.unmarshall(this, context);
	}
