...
import com.aliyuncs.vod.transform.v20170321.GetDetectionJobResponseUnmarshaller;
 ...
 * @version 
 */
public class GetDetectionJobResponse extends AcsResponse {
	...
	@Override
	public GetDetectionJobResponse getInstance(UnmarshallerContext context) {
		return	GetDetectionJobResponseUnmarshaller.unmarshall(this, context);
	}
