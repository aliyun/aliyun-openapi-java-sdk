...
public class SubmitAIASRJobRequest extends RpcAcsRequest<SubmitAIASRJobResponse> {
	...
	public void setAIASRConfig(String aIASRConfig) {
		this.aIASRConfig = aIASRConfig;
		if(aIASRConfig != null){
			putQueryParameter("AIASRConfig", aIASRConfig);
		}
	}
	...
	@Override
	public Class<SubmitAIASRJobResponse> getResponseClass() {
		return SubmitAIASRJobResponse.class;
	}
