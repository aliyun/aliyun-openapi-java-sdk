...
import com.aliyuncs.vod.transform.v20170321.DescribeVodDomainRealTimeHttpCodeDataResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeVodDomainRealTimeHttpCodeDataResponse extends AcsResponse {
	...
	@Override
	public DescribeVodDomainRealTimeHttpCodeDataResponse getInstance(UnmarshallerContext context) {
		return	DescribeVodDomainRealTimeHttpCodeDataResponseUnmarshaller.unmarshall(this, context);
	}
}
