...
public class DetachAppPolicyFromIdentityResponse extends AcsResponse {
	...
	public void setNonExistPolicyNames(List<String> nonExistPolicyNames) {
	...
	public void setFailedPolicyNames(List<String> failedPolicyNames) {
		this.failedPolicyNames = failedPolicyNames;
	}

	@Override
	public DetachAppPolicyFromIdentityResponse getInstance(UnmarshallerContext context) {
		return	DetachAppPolicyFromIdentityResponseUnmarshaller.unmarshall(this, context);
	}
