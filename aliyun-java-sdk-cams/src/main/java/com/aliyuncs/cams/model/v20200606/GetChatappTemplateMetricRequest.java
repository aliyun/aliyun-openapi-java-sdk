 ...
 * @version 
 */
public class GetChatappTemplateMetricRequest extends RpcAcsRequest<GetChatappTemplateMetricResponse> {
	...
	public GetChatappTemplateMetricRequest() {
		super("cams", "2020-06-06", "GetChatappTemplateMetric", "cams");
	...
	@Override
	public Class<GetChatappTemplateMetricResponse> getResponseClass() {
		return GetChatappTemplateMetricResponse.class;
	}
