 ...
 * @version 
 */
public class EnableWhatsappROIMetricRequest extends RpcAcsRequest<EnableWhatsappROIMetricResponse> {
	...
	@Override
	public Class<EnableWhatsappROIMetricResponse> getResponseClass() {
		return EnableWhatsappROIMetricResponse.class;
	}
