 ...
 * @version 
 */
public class ChatappPhoneNumberDeregisterRequest extends RpcAcsRequest<ChatappPhoneNumberDeregisterResponse> {
	...
	@Override
	public Class<ChatappPhoneNumberDeregisterResponse> getResponseClass() {
		return ChatappPhoneNumberDeregisterResponse.class;
	}
