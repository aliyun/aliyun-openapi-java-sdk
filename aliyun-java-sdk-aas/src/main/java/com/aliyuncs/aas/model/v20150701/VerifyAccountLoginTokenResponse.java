...
import com.aliyuncs.aas.transform.v20150701.VerifyAccountLoginTokenResponseUnmarshaller;
 ...
 * @version 
 */
public class VerifyAccountLoginTokenResponse extends AcsResponse {
	...
	@Override
	public VerifyAccountLoginTokenResponse getInstance(UnmarshallerContext context) {
		return	VerifyAccountLoginTokenResponseUnmarshaller.unmarshall(this, context);
	}
}
