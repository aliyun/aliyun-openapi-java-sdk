...
import com.aliyuncs.aas.transform.v20150701.GetShortTermAccessKeyForAccountResponseUnmarshaller;
 ...
 * @version 
 */
public class GetShortTermAccessKeyForAccountResponse extends AcsResponse {
	...
	@Override
	public GetShortTermAccessKeyForAccountResponse getInstance(UnmarshallerContext context) {
		return	GetShortTermAccessKeyForAccountResponseUnmarshaller.unmarshall(this, context);
	}
}
