 ...
 * @version 
 */
public class InnerCheckResourceRequest extends RpcAcsRequest<InnerCheckResourceResponse> {
	
	public InnerCheckResourceRequest() {
		super("Market-Inner", "2016-08-01", "InnerCheckResource");
	}
	...
	@Override
	public Class<InnerCheckResourceResponse> getResponseClass() {
		return InnerCheckResourceResponse.class;
	}
