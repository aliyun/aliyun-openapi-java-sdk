...
import com.aliyuncs.market_inner.transform.v20160801.InnerQueryMarketImageByCodeResponseUnmarshaller;
 ...
 * @version 
 */
public class InnerQueryMarketImageByCodeResponse extends AcsResponse {
	...
	@Override
	public InnerQueryMarketImageByCodeResponse getInstance(UnmarshallerContext context) {
		return	InnerQueryMarketImageByCodeResponseUnmarshaller.unmarshall(this, context);
	}
}
