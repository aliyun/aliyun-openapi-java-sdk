 ...
 * @version 
 */
public class InnerPhysicalDeleteResourceRequest extends RpcAcsRequest<InnerPhysicalDeleteResourceResponse> {
	
	public InnerPhysicalDeleteResourceRequest() {
		super("Market-Inner", "2016-08-01", "InnerPhysicalDeleteResource");
	}
	...
	@Override
	public Class<InnerPhysicalDeleteResourceResponse> getResponseClass() {
		return InnerPhysicalDeleteResourceResponse.class;
	}
