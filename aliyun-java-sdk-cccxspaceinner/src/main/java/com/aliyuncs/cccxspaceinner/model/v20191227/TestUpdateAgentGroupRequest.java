 ...
 * @version 
 */
public class TestUpdateAgentGroupRequest extends RpcAcsRequest<TestUpdateAgentGroupResponse> {
	   

	private Long agentId;

	private Long createAgentId;
	public TestUpdateAgentGroupRequest() {
		super("CCCXSpaceInner", "2019-12-27", "TestUpdateAgentGroup");
	...
	@Override
	public Class<TestUpdateAgentGroupResponse> getResponseClass() {
