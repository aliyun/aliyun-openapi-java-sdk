...
import com.aliyuncs.cdn.model.v20141111.DescribeLiveStreamSnapshotInfoResponse;
import com.aliyuncs.cdn.model.v20141111.DescribeLiveStreamSnapshotInfoResponse.LiveStreamSnapshotInfo;
...
public class DescribeLiveStreamSnapshotInfoResponseUnmarshaller {
	...
	public static DescribeLiveStreamSnapshotInfoResponse unmarshall(DescribeLiveStreamSnapshotInfoResponse describeLiveStreamSnapshotInfoResponse, UnmarshallerContext context) {
		...
		List<LiveStreamSnapshotInfo> liveStreamSnapshotInfoListList = new ArrayList<LiveStreamSnapshotInfo>();
		for (int i = 0; i < context.lengthValue("DescribeLiveStreamSnapshotInfoResponse.LiveStreamSnapshotInfoList.Length"); i++) {
			...
			liveStreamSnapshotInfoListList.add(liveStreamSnapshotInfo);
		}
		describeLiveStreamSnapshotInfoResponse.setLiveStreamSnapshotInfoList(liveStreamSnapshotInfoListList);
