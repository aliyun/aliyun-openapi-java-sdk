...
import com.aliyuncs.cdn.model.v20141111.DescribeDomainTopFileTypeVisitResponse.FileTypeList;
import com.aliyuncs.transform.UnmarshallerContext;


public class DescribeDomainTopFileTypeVisitResponseUnmarshaller {

	public static DescribeDomainTopFileTypeVisitResponse unmarshall(DescribeDomainTopFileTypeVisitResponse describeDomainTopFileTypeVisitResponse, UnmarshallerContext context) {
		
		describeDomainTopFileTypeVisitResponse.setRequestId(context.stringValue("DescribeDomainTopFileTypeVisitResponse.RequestId"));
