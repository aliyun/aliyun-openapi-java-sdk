...
public class DescribeLiveStreamPushErrorsResponse extends AcsResponse {
	...
	public void setPushErrorsModelList(List<PushErrorsModel> pushErrorsModelList) {
		this.pushErrorsModelList = pushErrorsModelList;
	}
	...
	@Override
	public DescribeLiveStreamPushErrorsResponse getInstance(UnmarshallerContext context) {
		return	DescribeLiveStreamPushErrorsResponseUnmarshaller.unmarshall(this, context);
	}
}
