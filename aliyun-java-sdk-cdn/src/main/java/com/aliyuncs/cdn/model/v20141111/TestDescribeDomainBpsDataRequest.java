 ...
 * @version 
 */
public class TestDescribeDomainBpsDataRequest extends RpcAcsRequest<TestDescribeDomainBpsDataResponse> {
	...
	public TestDescribeDomainBpsDataRequest() {
		super("Cdn", "2014-11-11", "TestDescribeDomainBpsData");
	...
	@Override
	public Class<TestDescribeDomainBpsDataResponse> getResponseClass() {
		return TestDescribeDomainBpsDataResponse.class;
	}
