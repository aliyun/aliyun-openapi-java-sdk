...
import com.aliyuncs.cdn.transform.v20141111.DescribeLiveStreamOnlineUserNumByDomainResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeLiveStreamOnlineUserNumByDomainResponse extends AcsResponse {
	...
	@Override
	public DescribeLiveStreamOnlineUserNumByDomainResponse getInstance(UnmarshallerContext context) {
		return	DescribeLiveStreamOnlineUserNumByDomainResponseUnmarshaller.unmarshall(this, context);
	}
}
