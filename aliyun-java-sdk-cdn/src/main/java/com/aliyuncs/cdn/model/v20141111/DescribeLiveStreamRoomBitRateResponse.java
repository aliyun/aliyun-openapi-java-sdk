...
import com.aliyuncs.cdn.transform.v20141111.DescribeLiveStreamRoomBitRateResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeLiveStreamRoomBitRateResponse extends AcsResponse {
	...
	@Override
	public DescribeLiveStreamRoomBitRateResponse getInstance(UnmarshallerContext context) {
		return	DescribeLiveStreamRoomBitRateResponseUnmarshaller.unmarshall(this, context);
	}
}
