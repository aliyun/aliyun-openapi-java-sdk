...
public class DescribeLiveStreamBpsDataResponse extends AcsResponse {
	...
	@Override
	public DescribeLiveStreamBpsDataResponse getInstance(UnmarshallerContext context) {
		return	DescribeLiveStreamBpsDataResponseUnmarshaller.unmarshall(this, context);
	}
}
