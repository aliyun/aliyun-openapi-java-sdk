...
import com.aliyuncs.cdn.transform.v20141111.DescribeLiveStreamFrameAndBitRateByDomainResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeLiveStreamFrameAndBitRateByDomainResponse extends AcsResponse {
	...
	@Override
	public DescribeLiveStreamFrameAndBitRateByDomainResponse getInstance(UnmarshallerContext context) {
		return	DescribeLiveStreamFrameAndBitRateByDomainResponseUnmarshaller.unmarshall(this, context);
	}
}
