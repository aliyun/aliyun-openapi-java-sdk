...
public class DescribeLiveStreamNumberListResponse extends AcsResponse {
	...
	public void setStreamNumberInfos(List<StreamNumberInfo> streamNumberInfos) {
		this.streamNumberInfos = streamNumberInfos;
	}
	...
	@Override
	public DescribeLiveStreamNumberListResponse getInstance(UnmarshallerContext context) {
		return	DescribeLiveStreamNumberListResponseUnmarshaller.unmarshall(this, context);
	}
}
