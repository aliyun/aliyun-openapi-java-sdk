...
import com.aliyuncs.cdn.transform.v20141111.DescribeLiveStreamRoomUserNumberResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeLiveStreamRoomUserNumberResponse extends AcsResponse {
	...
	@Override
	public DescribeLiveStreamRoomUserNumberResponse getInstance(UnmarshallerContext context) {
		return	DescribeLiveStreamRoomUserNumberResponseUnmarshaller.unmarshall(this, context);
	}
}
