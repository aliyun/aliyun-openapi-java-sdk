 ...
 * @version 
 */
public class EditEntityRouteRequest extends RpcAcsRequest<EditEntityRouteResponse> {
	...
	@Override
	public Class<EditEntityRouteResponse> getResponseClass() {
		return EditEntityRouteResponse.class;
	}
