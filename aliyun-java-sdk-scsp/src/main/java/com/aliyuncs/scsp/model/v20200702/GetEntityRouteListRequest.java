 ...
 * @version 
 */
public class GetEntityRouteListRequest extends RpcAcsRequest<GetEntityRouteListResponse> {
	...
	@Override
	public Class<GetEntityRouteListResponse> getResponseClass() {
		return GetEntityRouteListResponse.class;
	}
