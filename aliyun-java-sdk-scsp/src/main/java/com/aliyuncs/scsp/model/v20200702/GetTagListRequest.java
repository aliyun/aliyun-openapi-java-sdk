 ...
 * @version 
 */
public class GetTagListRequest extends RpcAcsRequest<GetTagListResponse> {
	...
	@Override
	public Class<GetTagListResponse> getResponseClass() {
		return GetTagListResponse.class;
	}
