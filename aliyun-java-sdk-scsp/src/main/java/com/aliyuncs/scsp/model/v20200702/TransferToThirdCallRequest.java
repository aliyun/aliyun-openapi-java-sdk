 ...
 * @version 
 */
public class TransferToThirdCallRequest extends RpcAcsRequest<TransferToThirdCallResponse> {
	...
	public TransferToThirdCallRequest() {
		super("scsp", "2020-07-02", "TransferToThirdCall", "scsp-service");
	...
	@Override
	public Class<TransferToThirdCallResponse> getResponseClass() {
		return TransferToThirdCallResponse.class;
	}
