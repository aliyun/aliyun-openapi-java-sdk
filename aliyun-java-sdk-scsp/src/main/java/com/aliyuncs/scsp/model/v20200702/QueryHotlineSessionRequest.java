 ...
 * @version 
 */
public class QueryHotlineSessionRequest extends RpcAcsRequest<QueryHotlineSessionResponse> {
	...
	@Override
	public Class<QueryHotlineSessionResponse> getResponseClass() {
		return QueryHotlineSessionResponse.class;
	}
