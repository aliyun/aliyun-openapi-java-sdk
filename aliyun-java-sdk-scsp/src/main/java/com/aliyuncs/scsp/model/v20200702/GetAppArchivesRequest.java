 ...
 * @version 
 */
public class GetAppArchivesRequest extends RpcAcsRequest<GetAppArchivesResponse> {
	   

	private String deploymentArchiveId;
	public GetAppArchivesRequest() {
		super("scsp", "2020-07-02", "GetAppArchives");
	...
	@Override
	public Class<GetAppArchivesResponse> getResponseClass() {
		return GetAppArchivesResponse.class;
	}
