 ...
 * @version 
 */
public class QueryAppResDiffRequest extends RpcAcsRequest<QueryAppResDiffResponse> {
	...
	public QueryAppResDiffRequest() {
		super("scsp", "2020-07-02", "QueryAppResDiff");
	...
	public void setDiffKeyword(String diffKeyword) {
		this.diffKeyword = diffKeyword;
		if(diffKeyword != null){
			putQueryParameter("DiffKeyword", diffKeyword);
		}
	}
	...
	@Override
	public Class<QueryAppResDiffResponse> getResponseClass() {
		return QueryAppResDiffResponse.class;
	}
