 ...
 * @version 
 */
public class SearchTicketByPhoneRequest extends RpcAcsRequest<SearchTicketByPhoneResponse> {
	...
	@Override
	public Class<SearchTicketByPhoneResponse> getResponseClass() {
		return SearchTicketByPhoneResponse.class;
	}
