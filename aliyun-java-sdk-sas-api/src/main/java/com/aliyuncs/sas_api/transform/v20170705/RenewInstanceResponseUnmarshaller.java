...
import com.aliyuncs.sas_api.model.v20170705.RenewInstanceResponse;
...
public class RenewInstanceResponseUnmarshaller {
	...
	public static RenewInstanceResponse unmarshall(RenewInstanceResponse renewInstanceResponse, UnmarshallerContext context) {
		...
		renewInstanceResponse.setInstanceId(context.stringValue("RenewInstanceResponse.InstanceId"));

		List<String> instanceIds = new ArrayList<String>();
		for (int i = 0; i < context.lengthValue("RenewInstanceResponse.InstanceIds.Length"); i++) {
			instanceIds.add(context.stringValue("RenewInstanceResponse.InstanceIds["+ i +"]"));
		}
		renewInstanceResponse.setInstanceIds(instanceIds);
