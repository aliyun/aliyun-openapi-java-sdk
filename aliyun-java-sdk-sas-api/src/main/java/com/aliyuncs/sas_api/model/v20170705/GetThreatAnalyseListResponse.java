...
import com.aliyuncs.sas_api.transform.v20170705.GetThreatAnalyseListResponseUnmarshaller;
 ...
 * @version 
 */
public class GetThreatAnalyseListResponse extends AcsResponse {
	...
	@Override
	public GetThreatAnalyseListResponse getInstance(UnmarshallerContext context) {
		return	GetThreatAnalyseListResponseUnmarshaller.unmarshall(this, context);
	}
}
