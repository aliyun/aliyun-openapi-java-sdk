...
import com.aliyuncs.sas_api.transform.v20170705.GetApplicationAttackListResponseUnmarshaller;
 ...
 * @version 
 */
public class GetApplicationAttackListResponse extends AcsResponse {
	...
	@Override
	public GetApplicationAttackListResponse getInstance(UnmarshallerContext context) {
		return	GetApplicationAttackListResponseUnmarshaller.unmarshall(this, context);
	}
}
