...
import com.aliyuncs.sas_api.transform.v20170705.GetSecurityEventListResponseUnmarshaller;
 ...
 * @version 
 */
public class GetSecurityEventListResponse extends AcsResponse {
	...
	@Override
	public GetSecurityEventListResponse getInstance(UnmarshallerContext context) {
		return	GetSecurityEventListResponseUnmarshaller.unmarshall(this, context);
	}
}
