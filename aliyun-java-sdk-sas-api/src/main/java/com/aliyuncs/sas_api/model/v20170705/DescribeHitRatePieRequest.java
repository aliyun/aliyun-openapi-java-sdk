 ...
 * @version 
 */
public class DescribeHitRatePieRequest extends RpcAcsRequest<DescribeHitRatePieResponse> {
	
	public DescribeHitRatePieRequest() {
		super("Sas-api", "2017-07-05", "DescribeHitRatePie", "sas-api");
	}
	...
	@Override
	public Class<DescribeHitRatePieResponse> getResponseClass() {
		return DescribeHitRatePieResponse.class;
	}
