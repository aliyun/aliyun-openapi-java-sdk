 ...
 * @version 
 */
public class InitDeviceActivationRequest extends RpcAcsRequest<InitDeviceActivationResponse> {
	...
	@Override
	public Class<InitDeviceActivationResponse> getResponseClass() {
		return InitDeviceActivationResponse.class;
	}
