 ...
 * @version 
 */
public class GetDeviceRiskStatusRequest extends RpcAcsRequest<GetDeviceRiskStatusResponse> {
	...
	@Override
	public Class<GetDeviceRiskStatusResponse> getResponseClass() {
		return GetDeviceRiskStatusResponse.class;
	}
