 ...
 * @version 
 */
public class QueryCveListForElfPatchRequest extends RpcAcsRequest<QueryCveListForElfPatchResponse> {
	...
	@Override
	public Class<QueryCveListForElfPatchResponse> getResponseClass() {
		return QueryCveListForElfPatchResponse.class;
	}
