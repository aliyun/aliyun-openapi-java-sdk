 ...
 * @version 
 */
public class SpiCheckResourceRequest extends RpcAcsRequest<SpiCheckResourceResponse> {
	...
	public SpiCheckResourceRequest() {
		super("Mhub", "2017-08-25", "SpiCheckResource");
	...
	@Override
	public Class<SpiCheckResourceResponse> getResponseClass() {
		return SpiCheckResourceResponse.class;
	}
