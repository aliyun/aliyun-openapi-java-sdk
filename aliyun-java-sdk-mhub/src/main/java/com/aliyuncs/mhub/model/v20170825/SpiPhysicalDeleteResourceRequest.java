 ...
 * @version 
 */
public class SpiPhysicalDeleteResourceRequest extends RpcAcsRequest<SpiPhysicalDeleteResourceResponse> {
	...
	public SpiPhysicalDeleteResourceRequest() {
		super("Mhub", "2017-08-25", "SpiPhysicalDeleteResource");
	...
	@Override
	public Class<SpiPhysicalDeleteResourceResponse> getResponseClass() {
		return SpiPhysicalDeleteResourceResponse.class;
	}
