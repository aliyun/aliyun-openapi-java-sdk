 ...
 * @version 
 */
public class SpiLogicalDeleteResourceRequest extends RpcAcsRequest<SpiLogicalDeleteResourceResponse> {
	...
	public SpiLogicalDeleteResourceRequest() {
		super("Mhub", "2017-08-25", "SpiLogicalDeleteResource");
	...
	@Override
	public Class<SpiLogicalDeleteResourceResponse> getResponseClass() {
		return SpiLogicalDeleteResourceResponse.class;
	}
