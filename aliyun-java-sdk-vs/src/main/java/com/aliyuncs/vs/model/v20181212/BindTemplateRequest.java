 ...
 * @version 
 */
public class BindTemplateRequest extends RpcAcsRequest<BindTemplateResponse> {
	...
	public BindTemplateRequest() {
		super("vs", "2018-12-12", "BindTemplate");
	...
	@Override
	public Class<BindTemplateResponse> getResponseClass() {
