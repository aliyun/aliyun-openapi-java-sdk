 ...
 * @version 
 */
public class CreateParentPlatformRequest extends RpcAcsRequest<CreateParentPlatformResponse> {
	...
	@Override
	public Class<CreateParentPlatformResponse> getResponseClass() {
		return CreateParentPlatformResponse.class;
	}
