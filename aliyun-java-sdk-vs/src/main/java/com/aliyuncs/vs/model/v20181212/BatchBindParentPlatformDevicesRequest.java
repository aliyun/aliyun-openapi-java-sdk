 ...
 * @version 
 */
public class BatchBindParentPlatformDevicesRequest extends RpcAcsRequest<BatchBindParentPlatformDevicesResponse> {
	...
	@Override
	public Class<BatchBindParentPlatformDevicesResponse> getResponseClass() {
		return BatchBindParentPlatformDevicesResponse.class;
	}
