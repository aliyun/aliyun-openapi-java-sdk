...
public class DescribeVsDomainSnapshotDataRequest extends RpcAcsRequest<DescribeVsDomainSnapshotDataResponse> {
	...
	public DescribeVsDomainSnapshotDataRequest() {
		super("vs", "2018-12-12", "DescribeVsDomainSnapshotData");
	...
	@Override
	public Class<DescribeVsDomainSnapshotDataResponse> getResponseClass() {
		return DescribeVsDomainSnapshotDataResponse.class;
	}
