...
import com.aliyuncs.vs.transform.v20181212.DescribeVsDomainConfigsResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeVsDomainConfigsResponse extends AcsResponse {
	...
	@Override
	public DescribeVsDomainConfigsResponse getInstance(UnmarshallerContext context) {
		return	DescribeVsDomainConfigsResponseUnmarshaller.unmarshall(this, context);
	}
