 ...
 * @version 
 */
public class UnbindParentPlatformDeviceRequest extends RpcAcsRequest<UnbindParentPlatformDeviceResponse> {
	...
	@Override
	public Class<UnbindParentPlatformDeviceResponse> getResponseClass() {
		return UnbindParentPlatformDeviceResponse.class;
	}
