 ...
 * @version 
 */
public class BatchBindTemplatesRequest extends RpcAcsRequest<BatchBindTemplatesResponse> {
	...
	@Override
	public Class<BatchBindTemplatesResponse> getResponseClass() {
		return BatchBindTemplatesResponse.class;
	}
