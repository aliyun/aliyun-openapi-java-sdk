 ...
 * @version 
 */
public class SetVsStreamsNotifyUrlConfigRequest extends RpcAcsRequest<SetVsStreamsNotifyUrlConfigResponse> {
	...
	@Override
	public Class<SetVsStreamsNotifyUrlConfigResponse> getResponseClass() {
		return SetVsStreamsNotifyUrlConfigResponse.class;
	}
