 ...
 * @version 
 */
public class BindParentPlatformDeviceRequest extends RpcAcsRequest<BindParentPlatformDeviceResponse> {
	...
	@Override
	public Class<BindParentPlatformDeviceResponse> getResponseClass() {
		return BindParentPlatformDeviceResponse.class;
	}
