 ...
 * @version 
 */
public class BatchDeleteVsDomainConfigsRequest extends RpcAcsRequest<BatchDeleteVsDomainConfigsResponse> {
	...
	@Override
	public Class<BatchDeleteVsDomainConfigsResponse> getResponseClass() {
		return BatchDeleteVsDomainConfigsResponse.class;
	}
