...
import com.aliyuncs.vs.transform.v20181212.DescribeVsCertificateListResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeVsCertificateListResponse extends AcsResponse {
	...
	@Override
	public DescribeVsCertificateListResponse getInstance(UnmarshallerContext context) {
		return	DescribeVsCertificateListResponseUnmarshaller.unmarshall(this, context);
	}
