...
import com.aliyuncs.datalake.transform.v20200710.ListMetastoreMigrationsResponseUnmarshaller;
 ...
 * @version 
 */
public class ListMetastoreMigrationsResponse extends AcsResponse {
	...
	private List<MigrationInstances> data;
	...
	public List<MigrationInstances> getData() {
		return this.data;
	}

	public void setData(List<MigrationInstances> data) {
		this.data = data;
	}

	public static class MigrationInstances {
	...
	@Override
	public ListMetastoreMigrationsResponse getInstance(UnmarshallerContext context) {
		return	ListMetastoreMigrationsResponseUnmarshaller.unmarshall(this, context);
	}
