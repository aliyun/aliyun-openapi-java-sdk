 ...
 * @version 
 */
public class ListFunctionsRequest extends RoaAcsRequest<ListFunctionsResponse> {
	...
	public ListFunctionsRequest() {
		super("DataLake", "2020-07-10", "ListFunctions");
		setUriPattern("/api/metastore/catalogs/databases/functions/list");
