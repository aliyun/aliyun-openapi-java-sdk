 ...
 * @version 
 */
public class UpdateWorkflowExecuteInfoRequest extends RoaAcsRequest<UpdateWorkflowExecuteInfoResponse> {
	...
	public UpdateWorkflowExecuteInfoRequest() {
		super("DataLake", "2020-07-10", "UpdateWorkflowExecuteInfo");
		setUriPattern("/webapi/blueprintinstance/updateWorkflowExecuteInfo");
	...
	@Override
	public Class<UpdateWorkflowExecuteInfoResponse> getResponseClass() {
		return UpdateWorkflowExecuteInfoResponse.class;
	}
