 ...
 * @version 
 */
public class GetBlueprintInstanceRequest extends RoaAcsRequest<GetBlueprintInstanceResponse> {
	   

	private String blueprintInstanceId;
	public GetBlueprintInstanceRequest() {
		super("DataLake", "2020-07-10", "GetBlueprintInstance");
		setUriPattern("/webapi/blueprintinstance/get");
	...
	@Override
	public Class<GetBlueprintInstanceResponse> getResponseClass() {
		return GetBlueprintInstanceResponse.class;
	}
