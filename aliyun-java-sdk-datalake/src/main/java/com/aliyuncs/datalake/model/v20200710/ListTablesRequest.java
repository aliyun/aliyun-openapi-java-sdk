 ...
 * @version 
 */
public class ListTablesRequest extends RoaAcsRequest<ListTablesResponse> {
	...
	public ListTablesRequest() {
		super("DataLake", "2020-07-10", "ListTables");
		setUriPattern("/api/metastore/databases/tables/list");
