 ...
 * @version 
 */
public class CertificatePrivateKeySignRequest extends RpcAcsRequest<CertificatePrivateKeySignResponse> {
	...
	@Override
	public Class<CertificatePrivateKeySignResponse> getResponseClass() {
		return CertificatePrivateKeySignResponse.class;
	}
