 ...
 * @version 
 */
public class DescribeKeyVersionRequest extends RpcAcsRequest<DescribeKeyVersionResponse> {
	...
	@Override
	public Class<DescribeKeyVersionResponse> getResponseClass() {
		return DescribeKeyVersionResponse.class;
	}
