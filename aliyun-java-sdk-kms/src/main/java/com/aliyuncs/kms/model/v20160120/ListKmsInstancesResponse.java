...
public class ListKmsInstancesResponse extends AcsResponse {
	...
	public void setKmsInstances(List<KmsInstance> kmsInstances) {
	...
	public static class KmsInstance {
		...
		public void setKmsInstanceArn(String kmsInstanceArn) {
	...
	@Override
	public ListKmsInstancesResponse getInstance(UnmarshallerContext context) {
		return	ListKmsInstancesResponseUnmarshaller.unmarshall(this, context);
	}
}
