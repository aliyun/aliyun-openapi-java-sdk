...
import com.aliyuncs.adb.transform.v20190315.DescribeVSwitchsResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeVSwitchsResponse extends AcsResponse {
	...
	@Override
	public DescribeVSwitchsResponse getInstance(UnmarshallerContext context) {
		return	DescribeVSwitchsResponseUnmarshaller.unmarshall(this, context);
	}
