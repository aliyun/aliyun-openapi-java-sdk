 ...
 * @version 
 */
public class CreateElasticPlanRequest extends RpcAcsRequest<CreateElasticPlanResponse> {
	...
	public CreateElasticPlanRequest() {
		super("adb", "2019-03-15", "CreateElasticPlan", "ads");
	...
	@Override
	public Class<CreateElasticPlanResponse> getResponseClass() {
		return CreateElasticPlanResponse.class;
	}
