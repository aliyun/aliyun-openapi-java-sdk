 ...
 * @version 
 */
public class DescribeSyncAvailableDBClusterListRequest extends RpcAcsRequest<DescribeSyncAvailableDBClusterListResponse> {
	...
	public DescribeSyncAvailableDBClusterListRequest() {
		super("adb", "2019-03-15", "DescribeSyncAvailableDBClusterList", "ads");
	...
	@Override
	public Class<DescribeSyncAvailableDBClusterListResponse> getResponseClass() {
		return DescribeSyncAvailableDBClusterListResponse.class;
	}
