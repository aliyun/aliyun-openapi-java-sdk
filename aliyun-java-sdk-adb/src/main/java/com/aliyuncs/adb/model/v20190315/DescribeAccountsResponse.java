...
import com.aliyuncs.adb.transform.v20190315.DescribeAccountsResponseUnmarshaller;
...
public class DescribeAccountsResponse extends AcsResponse {
	...
	public List<DBAccount> getAccountList() {
		return this.accountList;
	}

	public void setAccountList(List<DBAccount> accountList) {
