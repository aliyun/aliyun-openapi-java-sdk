...
public class DescribeDownloadRecordsRequest extends RpcAcsRequest<DescribeDownloadRecordsResponse> {
	...
	public DescribeDownloadRecordsRequest() {
		super("adb", "2019-03-15", "DescribeDownloadRecords", "ads");
	...
	@Override
	public Class<DescribeDownloadRecordsResponse> getResponseClass() {
		return DescribeDownloadRecordsResponse.class;
	}
