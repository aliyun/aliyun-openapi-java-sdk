 ...
 * @version 
 */
public class GrantSagInstanceToCcnRequest extends RpcAcsRequest<GrantSagInstanceToCcnResponse> {
	...
	public GrantSagInstanceToCcnRequest() {
		super("Smartag", "2018-03-13", "GrantSagInstanceToCcn", "smartag");
	...
	public void setCcnUid(Long ccnUid) {
		this.ccnUid = ccnUid;
		if(ccnUid != null){
			putQueryParameter("CcnUid", ccnUid.toString());
		}
	}
	...
	@Override
	public Class<GrantSagInstanceToCcnResponse> getResponseClass() {
		return GrantSagInstanceToCcnResponse.class;
	}
