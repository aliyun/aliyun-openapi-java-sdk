 ...
 * @version 
 */
public class DeleteHealthCheckRequest extends RpcAcsRequest<DeleteHealthCheckResponse> {
	...
	public DeleteHealthCheckRequest() {
		super("Smartag", "2018-03-13", "DeleteHealthCheck", "smartag");
	...
	@Override
	public Class<DeleteHealthCheckResponse> getResponseClass() {
		return DeleteHealthCheckResponse.class;
	}
