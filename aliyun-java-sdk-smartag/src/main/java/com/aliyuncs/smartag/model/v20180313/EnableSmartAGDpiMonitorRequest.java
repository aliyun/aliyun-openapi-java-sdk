 ...
 * @version 
 */
public class EnableSmartAGDpiMonitorRequest extends RpcAcsRequest<EnableSmartAGDpiMonitorResponse> {
	...
	public EnableSmartAGDpiMonitorRequest() {
		super("Smartag", "2018-03-13", "EnableSmartAGDpiMonitor", "smartag");
	...
	@Override
	public Class<EnableSmartAGDpiMonitorResponse> getResponseClass() {
		return EnableSmartAGDpiMonitorResponse.class;
	}
