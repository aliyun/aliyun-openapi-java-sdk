 ...
 * @version 
 */
public class ModifyDeviceAutoUpgradePolicyRequest extends RpcAcsRequest<ModifyDeviceAutoUpgradePolicyResponse> {
	...
	@Override
	public Class<ModifyDeviceAutoUpgradePolicyResponse> getResponseClass() {
		return ModifyDeviceAutoUpgradePolicyResponse.class;
	}
