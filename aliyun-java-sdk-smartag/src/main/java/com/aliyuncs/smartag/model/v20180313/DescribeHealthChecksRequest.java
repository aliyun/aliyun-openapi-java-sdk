 ...
 * @version 
 */
public class DescribeHealthChecksRequest extends RpcAcsRequest<DescribeHealthChecksResponse> {
	...
	public DescribeHealthChecksRequest() {
		super("Smartag", "2018-03-13", "DescribeHealthChecks", "smartag");
	...
	@Override
	public Class<DescribeHealthChecksResponse> getResponseClass() {
		return DescribeHealthChecksResponse.class;
	}
