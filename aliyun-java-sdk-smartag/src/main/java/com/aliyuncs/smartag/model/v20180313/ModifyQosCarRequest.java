 ...
 * @version 
 */
public class ModifyQosCarRequest extends RpcAcsRequest<ModifyQosCarResponse> {
	...
	public ModifyQosCarRequest() {
		super("Smartag", "2018-03-13", "ModifyQosCar", "smartag");
	...
	@Override
	public Class<ModifyQosCarResponse> getResponseClass() {
		return ModifyQosCarResponse.class;
	}
