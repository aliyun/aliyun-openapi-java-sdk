 ...
 * @version 
 */
public class CreateSagStaticRouteRequest extends RpcAcsRequest<CreateSagStaticRouteResponse> {
	...
	public CreateSagStaticRouteRequest() {
		super("Smartag", "2018-03-13", "CreateSagStaticRoute", "smartag");
	...
	public void setDestinationCidr(String destinationCidr) {
		...
		if(destinationCidr != null){
			putQueryParameter("DestinationCidr", destinationCidr);
		}
	}

	@Override
	public Class<CreateSagStaticRouteResponse> getResponseClass() {
		return CreateSagStaticRouteResponse.class;
	}
