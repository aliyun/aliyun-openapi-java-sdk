 ...
 * @version 
 */
public class ModifySagStaticRouteRequest extends RpcAcsRequest<ModifySagStaticRouteResponse> {
	...
	public ModifySagStaticRouteRequest() {
		super("Smartag", "2018-03-13", "ModifySagStaticRoute", "smartag");
	...
	@Override
	public Class<ModifySagStaticRouteResponse> getResponseClass() {
		return ModifySagStaticRouteResponse.class;
	}
