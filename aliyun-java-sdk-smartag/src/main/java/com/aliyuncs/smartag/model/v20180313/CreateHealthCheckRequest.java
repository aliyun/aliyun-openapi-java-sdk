 ...
 * @version 
 */
public class CreateHealthCheckRequest extends RpcAcsRequest<CreateHealthCheckResponse> {
	...
	public CreateHealthCheckRequest() {
		super("Smartag", "2018-03-13", "CreateHealthCheck", "smartag");
	...
	@Override
	public Class<CreateHealthCheckResponse> getResponseClass() {
		return CreateHealthCheckResponse.class;
	}
