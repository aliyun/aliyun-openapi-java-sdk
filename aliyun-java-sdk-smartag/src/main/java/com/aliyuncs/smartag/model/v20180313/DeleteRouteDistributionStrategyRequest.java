 ...
 * @version 
 */
public class DeleteRouteDistributionStrategyRequest extends RpcAcsRequest<DeleteRouteDistributionStrategyResponse> {
	...
	public DeleteRouteDistributionStrategyRequest() {
		super("Smartag", "2018-03-13", "DeleteRouteDistributionStrategy", "smartag");
	...
	@Override
	public Class<DeleteRouteDistributionStrategyResponse> getResponseClass() {
		return DeleteRouteDistributionStrategyResponse.class;
	}
