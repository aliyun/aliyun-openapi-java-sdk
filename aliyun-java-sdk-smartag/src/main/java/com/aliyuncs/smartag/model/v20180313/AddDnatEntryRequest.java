 ...
 * @version 
 */
public class AddDnatEntryRequest extends RpcAcsRequest<AddDnatEntryResponse> {
	...
	public AddDnatEntryRequest() {
		super("Smartag", "2018-03-13", "AddDnatEntry", "smartag");
	...
	@Override
	public Class<AddDnatEntryResponse> getResponseClass() {
		return AddDnatEntryResponse.class;
	}
