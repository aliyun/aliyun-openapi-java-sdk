 ...
 * @version 
 */
public class ModifySagPortRouteProtocolRequest extends RpcAcsRequest<ModifySagPortRouteProtocolResponse> {
	...
	public ModifySagPortRouteProtocolRequest() {
		super("Smartag", "2018-03-13", "ModifySagPortRouteProtocol", "smartag");
	...
	public void setRemoteAs(String remoteAs) {
		...
		if(remoteAs != null){
			putQueryParameter("RemoteAs", remoteAs);
		}
	}
	...
	@Override
	public Class<ModifySagPortRouteProtocolResponse> getResponseClass() {
		return ModifySagPortRouteProtocolResponse.class;
	}
