 ...
 * @version 
 */
public class CreateQosRequest extends RpcAcsRequest<CreateQosResponse> {
	...
	public CreateQosRequest() {
		super("Smartag", "2018-03-13", "CreateQos", "smartag");
	...
	@Override
	public Class<CreateQosResponse> getResponseClass() {
		return CreateQosResponse.class;
	}
