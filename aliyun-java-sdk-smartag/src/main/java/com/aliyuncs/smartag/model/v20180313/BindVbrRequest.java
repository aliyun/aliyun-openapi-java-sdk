 ...
 * @version 
 */
public class BindVbrRequest extends RpcAcsRequest<BindVbrResponse> {
	...
	public BindVbrRequest() {
		super("Smartag", "2018-03-13", "BindVbr", "smartag");
	...
	@Override
	public Class<BindVbrResponse> getResponseClass() {
		return BindVbrResponse.class;
	}
