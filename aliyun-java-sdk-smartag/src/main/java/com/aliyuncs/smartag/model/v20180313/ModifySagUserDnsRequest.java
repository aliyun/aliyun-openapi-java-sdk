 ...
 * @version 
 */
public class ModifySagUserDnsRequest extends RpcAcsRequest<ModifySagUserDnsResponse> {
	...
	public ModifySagUserDnsRequest() {
		super("Smartag", "2018-03-13", "ModifySagUserDns", "smartag");
	...
	public void setSlaveDns(String slaveDns) {
		...
		if(slaveDns != null){
			putQueryParameter("SlaveDns", slaveDns);
		}
	}
	...
	public void setMasterDns(String masterDns) {
		...
		if(masterDns != null){
			putQueryParameter("MasterDns", masterDns);
		}
	}
	...
	@Override
	public Class<ModifySagUserDnsResponse> getResponseClass() {
		return ModifySagUserDnsResponse.class;
	}
