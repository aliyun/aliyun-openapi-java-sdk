 ...
 * @version 
 */
public class RevokeSagInstanceFromCcnRequest extends RpcAcsRequest<RevokeSagInstanceFromCcnResponse> {
	...
	public RevokeSagInstanceFromCcnRequest() {
		super("Smartag", "2018-03-13", "RevokeSagInstanceFromCcn", "smartag");
	...
	@Override
	public Class<RevokeSagInstanceFromCcnResponse> getResponseClass() {
		return RevokeSagInstanceFromCcnResponse.class;
	}
