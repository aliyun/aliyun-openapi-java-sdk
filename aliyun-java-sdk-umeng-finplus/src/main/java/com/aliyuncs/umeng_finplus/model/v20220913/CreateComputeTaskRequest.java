 ...
 * @version 
 */
public class CreateComputeTaskRequest extends RoaAcsRequest<CreateComputeTaskResponse> {
	   

	@SerializedName("body")
	private Body body;
	public CreateComputeTaskRequest() {
		super("umeng-finplus", "2022-09-13", "CreateComputeTask");
		setProtocol(ProtocolType.HTTPS);
		setUriPattern("/bc/createComputeTask");
	...
	@Override
	public Class<CreateComputeTaskResponse> getResponseClass() {
		return CreateComputeTaskResponse.class;
	}
