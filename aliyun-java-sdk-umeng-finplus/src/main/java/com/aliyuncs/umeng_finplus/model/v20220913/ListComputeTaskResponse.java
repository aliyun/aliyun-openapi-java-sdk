...
import com.aliyuncs.umeng_finplus.transform.v20220913.ListComputeTaskResponseUnmarshaller;
 ...
 * @version 
 */
public class ListComputeTaskResponse extends AcsResponse {
	...
	@Override
	public ListComputeTaskResponse getInstance(UnmarshallerContext context) {
		return	ListComputeTaskResponseUnmarshaller.unmarshall(this, context);
	}
