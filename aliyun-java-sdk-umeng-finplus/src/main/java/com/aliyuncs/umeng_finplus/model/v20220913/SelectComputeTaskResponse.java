...
import com.aliyuncs.umeng_finplus.transform.v20220913.SelectComputeTaskResponseUnmarshaller;
 ...
 * @version 
 */
public class SelectComputeTaskResponse extends AcsResponse {
	...
	@Override
	public SelectComputeTaskResponse getInstance(UnmarshallerContext context) {
		return	SelectComputeTaskResponseUnmarshaller.unmarshall(this, context);
	}
