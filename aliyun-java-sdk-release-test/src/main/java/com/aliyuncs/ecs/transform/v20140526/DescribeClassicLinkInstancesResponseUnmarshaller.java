...
import com.aliyuncs.ecs.model.v20140526.DescribeClassicLinkInstancesResponse.Links;
...
public class DescribeClassicLinkInstancesResponseUnmarshaller {
	...
	public static DescribeClassicLinkInstancesResponse unmarshall(DescribeClassicLinkInstancesResponse describeClassicLinkInstancesResponse, UnmarshallerContext context) {
		...
		List<Links> data = new ArrayList<Links>();
		for (int i = 0; i < context.lengthValue("DescribeClassicLinkInstancesResponse.Data.Length"); i++) {
			Links links = new Links();
			links.setInstanceId(context.stringValue("DescribeClassicLinkInstancesResponse.Data["+ i +"].InstanceId"));
			links.setVpcId(context.stringValue("DescribeClassicLinkInstancesResponse.Data["+ i +"].VpcId"));

			data.add(links);
		}
		describeClassicLinkInstancesResponse.setData(data);
