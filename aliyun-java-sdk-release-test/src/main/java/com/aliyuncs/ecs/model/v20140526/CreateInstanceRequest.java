...
public class CreateInstanceRequest extends RpcAcsRequest<CreateInstanceResponse> {
	...
	public void setDataDisks(List<DataDisk> dataDisk) {
		this.dataDisks = dataDisk;	
		for (int i = 0; i < dataDisk.size(); i++) {
			putQueryParameter("DataDisk." + (i + 1) + ".Size" , dataDisk.get(i).getSize());
			putQueryParameter("DataDisk." + (i + 1) + ".SnapshotId" , dataDisk.get(i).getSnapshotId());
			putQueryParameter("DataDisk." + (i + 1) + ".Category" , dataDisk.get(i).getCategory());
			putQueryParameter("DataDisk." + (i + 1) + ".DiskName" , dataDisk.get(i).getDiskName());
			putQueryParameter("DataDisk." + (i + 1) + ".Description" , dataDisk.get(i).getDescription());
			putQueryParameter("DataDisk." + (i + 1) + ".Device" , dataDisk.get(i).getDevice());
			putQueryParameter("DataDisk." + (i + 1) + ".DeleteWithInstance" , dataDisk.get(i).getDeleteWithInstance());
		}	
	}
