...
public class DescribeRouteTablesResponse extends AcsResponse {
	...
	public static class RouteTable {
		...
		public static class RouteEntry {
			...
			public String getRouteTableId1() {
				return this.routeTableId1;
			}

			public void setRouteTableId1(String routeTableId1) {
				this.routeTableId1 = routeTableId1;
			}
			...
			public static class NextHop {
				...
				public String getNextHopType2() {
					return this.nextHopType2;
				}

				public void setNextHopType2(String nextHopType2) {
					this.nextHopType2 = nextHopType2;
				}
