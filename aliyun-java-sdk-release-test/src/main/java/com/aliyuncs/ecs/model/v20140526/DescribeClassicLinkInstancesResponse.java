...
public class DescribeClassicLinkInstancesResponse extends AcsResponse {
	...
	public void setData(List<Links> data) {
		this.data = data;
	}
	...
	@Override
	public DescribeClassicLinkInstancesResponse getInstance(UnmarshallerContext context) {
		return	DescribeClassicLinkInstancesResponseUnmarshaller.unmarshall(this, context);
	}
}
