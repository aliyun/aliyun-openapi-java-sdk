 ...
 * @version 
 */
public class DescribeExpressConnectRouterRequest extends RpcAcsRequest<DescribeExpressConnectRouterResponse> {
	...
	public DescribeExpressConnectRouterRequest() {
		super("ExpressConnectRouter", "2023-09-01", "DescribeExpressConnectRouter", "ecr");
	...
	@Override
	public Class<DescribeExpressConnectRouterResponse> getResponseClass() {
		return DescribeExpressConnectRouterResponse.class;
	}
