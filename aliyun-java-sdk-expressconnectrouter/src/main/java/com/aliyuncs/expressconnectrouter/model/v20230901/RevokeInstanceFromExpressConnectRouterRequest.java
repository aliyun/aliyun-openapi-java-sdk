 ...
 * @version 
 */
public class RevokeInstanceFromExpressConnectRouterRequest extends RpcAcsRequest<RevokeInstanceFromExpressConnectRouterResponse> {
	...
	public RevokeInstanceFromExpressConnectRouterRequest() {
		super("ExpressConnectRouter", "2023-09-01", "RevokeInstanceFromExpressConnectRouter", "ecr");
	...
	@Override
	public Class<RevokeInstanceFromExpressConnectRouterResponse> getResponseClass() {
		return RevokeInstanceFromExpressConnectRouterResponse.class;
	}
