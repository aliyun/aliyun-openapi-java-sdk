...
public class DescribeBackupPlansRequest extends RpcAcsRequest<DescribeBackupPlansResponse> {
	...
	public DescribeBackupPlansRequest() {
		super("Cassandra", "2019-01-01", "DescribeBackupPlans", "Cassandra");
	...
	@Override
	public Class<DescribeBackupPlansResponse> getResponseClass() {
		return DescribeBackupPlansResponse.class;
	}
