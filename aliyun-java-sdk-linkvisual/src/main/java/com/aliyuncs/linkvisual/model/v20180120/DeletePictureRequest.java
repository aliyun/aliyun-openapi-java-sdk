 ...
 * @version 
 */
public class DeletePictureRequest extends RpcAcsRequest<DeletePictureResponse> {
	...
	public DeletePictureRequest() {
		super("Linkvisual", "2018-01-20", "DeletePicture", "Linkvisual");
	...
	@Override
	public Class<DeletePictureResponse> getResponseClass() {
		return DeletePictureResponse.class;
	}
