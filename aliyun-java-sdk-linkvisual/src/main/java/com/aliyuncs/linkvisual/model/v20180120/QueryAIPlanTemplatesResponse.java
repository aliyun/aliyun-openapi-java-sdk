...
import com.aliyuncs.linkvisual.transform.v20180120.QueryAIPlanTemplatesResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryAIPlanTemplatesResponse extends AcsResponse {
	...
	@Override
	public QueryAIPlanTemplatesResponse getInstance(UnmarshallerContext context) {
		return	QueryAIPlanTemplatesResponseUnmarshaller.unmarshall(this, context);
	}
