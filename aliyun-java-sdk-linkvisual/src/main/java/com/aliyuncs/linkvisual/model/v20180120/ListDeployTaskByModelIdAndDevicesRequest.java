 ...
 * @version 
 */
public class ListDeployTaskByModelIdAndDevicesRequest extends RpcAcsRequest<ListDeployTaskByModelIdAndDevicesResponse> {
	   

	private Integer modelId;

	private List<DeviceList> deviceLists;
	public ListDeployTaskByModelIdAndDevicesRequest() {
		super("Linkvisual", "2018-01-20", "ListDeployTaskByModelIdAndDevices", "Linkvisual");
	...
	@Override
	public Class<ListDeployTaskByModelIdAndDevicesResponse> getResponseClass() {
		return ListDeployTaskByModelIdAndDevicesResponse.class;
	}
