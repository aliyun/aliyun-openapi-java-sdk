 ...
 * @version 
 */
public class GetModelOssPolicyRequest extends RpcAcsRequest<GetModelOssPolicyResponse> {
	...
	public GetModelOssPolicyRequest() {
		super("Linkvisual", "2018-01-20", "GetModelOssPolicy", "Linkvisual");
	...
	@Override
	public Class<GetModelOssPolicyResponse> getResponseClass() {
		return GetModelOssPolicyResponse.class;
	}
