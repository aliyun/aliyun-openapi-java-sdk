...
import com.aliyuncs.linkvisual.transform.v20180120.QueryFaceUserByNameResponseUnmarshaller;
...
public class QueryFaceUserByNameResponse extends AcsResponse {
	...
	@Override
	public QueryFaceUserByNameResponse getInstance(UnmarshallerContext context) {
		return	QueryFaceUserByNameResponseUnmarshaller.unmarshall(this, context);
	}
