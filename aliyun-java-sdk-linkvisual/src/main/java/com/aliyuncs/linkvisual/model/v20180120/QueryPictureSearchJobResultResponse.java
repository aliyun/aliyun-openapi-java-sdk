...
import com.aliyuncs.linkvisual.transform.v20180120.QueryPictureSearchJobResultResponseUnmarshaller;
...
public class QueryPictureSearchJobResultResponse extends AcsResponse {
	...
	@Override
	public QueryPictureSearchJobResultResponse getInstance(UnmarshallerContext context) {
		return	QueryPictureSearchJobResultResponseUnmarshaller.unmarshall(this, context);
	}
