 ...
 * @version 
 */
public class UpdateFaceUserRequest extends RpcAcsRequest<UpdateFaceUserResponse> {
	...
	private String name;
	public UpdateFaceUserRequest() {
		super("Linkvisual", "2018-01-20", "UpdateFaceUser", "Linkvisual");
	...
	@Override
	public Class<UpdateFaceUserResponse> getResponseClass() {
		return UpdateFaceUserResponse.class;
	}
