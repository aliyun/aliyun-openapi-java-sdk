...
import com.aliyuncs.linkvisual.transform.v20180120.QueryVisionDeviceInfoResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryVisionDeviceInfoResponse extends AcsResponse {
	...
	@Override
	public QueryVisionDeviceInfoResponse getInstance(UnmarshallerContext context) {
		return	QueryVisionDeviceInfoResponseUnmarshaller.unmarshall(this, context);
	}
}
