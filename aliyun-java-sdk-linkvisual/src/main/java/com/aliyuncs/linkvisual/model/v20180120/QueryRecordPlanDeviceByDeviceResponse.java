...
import com.aliyuncs.linkvisual.transform.v20180120.QueryRecordPlanDeviceByDeviceResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryRecordPlanDeviceByDeviceResponse extends AcsResponse {
	...
	@Override
	public QueryRecordPlanDeviceByDeviceResponse getInstance(UnmarshallerContext context) {
		return	QueryRecordPlanDeviceByDeviceResponseUnmarshaller.unmarshall(this, context);
	}
