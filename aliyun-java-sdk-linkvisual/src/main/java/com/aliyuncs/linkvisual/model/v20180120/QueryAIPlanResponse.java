...
import com.aliyuncs.linkvisual.transform.v20180120.QueryAIPlanResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryAIPlanResponse extends AcsResponse {
	...
	@Override
	public QueryAIPlanResponse getInstance(UnmarshallerContext context) {
		return	QueryAIPlanResponseUnmarshaller.unmarshall(this, context);
	}
