...
import com.aliyuncs.linkvisual.transform.v20180120.GetAIActionResponseUnmarshaller;
 ...
 * @version 
 */
public class GetAIActionResponse extends AcsResponse {
	...
	@Override
	public GetAIActionResponse getInstance(UnmarshallerContext context) {
		return	GetAIActionResponseUnmarshaller.unmarshall(this, context);
	}
