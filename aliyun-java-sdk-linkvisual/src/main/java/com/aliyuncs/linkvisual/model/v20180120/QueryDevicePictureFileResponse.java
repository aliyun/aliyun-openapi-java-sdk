...
public class QueryDevicePictureFileResponse extends AcsResponse {
	...
	@Override
	public QueryDevicePictureFileResponse getInstance(UnmarshallerContext context) {
		return	QueryDevicePictureFileResponseUnmarshaller.unmarshall(this, context);
	}
