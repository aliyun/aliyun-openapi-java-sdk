...
public class QueryEventRecordPlanDetailResponse extends AcsResponse {
	...
	@Override
	public QueryEventRecordPlanDetailResponse getInstance(UnmarshallerContext context) {
		return	QueryEventRecordPlanDetailResponseUnmarshaller.unmarshall(this, context);
	}
