...
import com.aliyuncs.linkvisual.transform.v20180120.QueryFaceUserResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryFaceUserResponse extends AcsResponse {
	...
	@Override
	public QueryFaceUserResponse getInstance(UnmarshallerContext context) {
		return	QueryFaceUserResponseUnmarshaller.unmarshall(this, context);
	}
