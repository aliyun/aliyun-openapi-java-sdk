 ...
 * @version 
 */
public class PictureSearchPictureRequest extends RpcAcsRequest<PictureSearchPictureResponse> {
	...
	public PictureSearchPictureRequest() {
		super("Linkvisual", "2018-01-20", "PictureSearchPicture", "Linkvisual");
	...
	public void setContainPicUrl(Boolean containPicUrl) {
		this.containPicUrl = containPicUrl;
		if(containPicUrl != null){
			putQueryParameter("ContainPicUrl", containPicUrl.toString());
		}
	}
	...
	@Override
	public Class<PictureSearchPictureResponse> getResponseClass() {
		return PictureSearchPictureResponse.class;
	}
