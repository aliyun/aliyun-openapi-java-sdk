...
import com.aliyuncs.dms_dg.model.v20230914.DescribeRegionsResponse;
import com.aliyuncs.dms_dg.model.v20230914.DescribeRegionsResponse.Region;
...
public class DescribeRegionsResponseUnmarshaller {
	...
	public static DescribeRegionsResponse unmarshall(DescribeRegionsResponse describeRegionsResponse, UnmarshallerContext _ctx) {
		...
		describeRegionsResponse.setErrorMsg(_ctx.stringValue("DescribeRegionsResponse.ErrorMsg"));
