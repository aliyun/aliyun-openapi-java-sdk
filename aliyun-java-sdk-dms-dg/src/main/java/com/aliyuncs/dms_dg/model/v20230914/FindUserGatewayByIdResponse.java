...
import com.aliyuncs.dms_dg.transform.v20230914.FindUserGatewayByIdResponseUnmarshaller;
 ...
 * @version 
 */
public class FindUserGatewayByIdResponse extends AcsResponse {
	...
	@Override
	public FindUserGatewayByIdResponse getInstance(UnmarshallerContext context) {
		return	FindUserGatewayByIdResponseUnmarshaller.unmarshall(this, context);
	}
}
