...
public class CreateGatewayVerifyCodeRequest extends RpcAcsRequest<CreateGatewayVerifyCodeResponse> {
	...
	public CreateGatewayVerifyCodeRequest() {
		super("dms-dg", "2023-09-14", "CreateGatewayVerifyCode");
	...
	@Override
	public Class<CreateGatewayVerifyCodeResponse> getResponseClass() {
		return CreateGatewayVerifyCodeResponse.class;
	}
