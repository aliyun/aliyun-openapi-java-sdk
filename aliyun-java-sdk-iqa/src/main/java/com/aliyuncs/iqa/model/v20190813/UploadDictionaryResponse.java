...
import com.aliyuncs.iqa.transform.v20190813.UploadDictionaryResponseUnmarshaller;
 ...
 * @version 
 */
public class UploadDictionaryResponse extends AcsResponse {
	...
	@Override
	public UploadDictionaryResponse getInstance(UnmarshallerContext context) {
		return	UploadDictionaryResponseUnmarshaller.unmarshall(this, context);
	}
