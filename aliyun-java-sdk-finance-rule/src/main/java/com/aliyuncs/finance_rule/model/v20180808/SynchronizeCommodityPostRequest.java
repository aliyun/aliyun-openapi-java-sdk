 ...
 * @version 
 */
public class SynchronizeCommodityPostRequest extends RpcAcsRequest<SynchronizeCommodityPostResponse> {
	...
	public SynchronizeCommodityPostRequest() {
		super("Finance-Rule", "2018-08-08", "SynchronizeCommodityPost");
	...
	@Override
	public Class<SynchronizeCommodityPostResponse> getResponseClass() {
		return SynchronizeCommodityPostResponse.class;
	}
