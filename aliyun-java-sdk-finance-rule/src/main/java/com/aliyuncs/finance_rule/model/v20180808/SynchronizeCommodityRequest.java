 ...
 * @version 
 */
public class SynchronizeCommodityRequest extends RpcAcsRequest<SynchronizeCommodityResponse> {
	...
	public SynchronizeCommodityRequest() {
		super("Finance-Rule", "2018-08-08", "SynchronizeCommodity");
	...
	public void setSpId(Long spId) {
		this.spId = spId;
		if(spId != null){
			putQueryParameter("SpId", spId.toString());
		}
	}
	...
	public void setMarketType(Long marketType) {
		...
		if(marketType != null){
			putQueryParameter("MarketType", marketType.toString());
		}
	}
	...
	public void setPurchaseType(String purchaseType) {
		...
		if(purchaseType != null){
			putQueryParameter("PurchaseType", purchaseType);
		}
	}
	...
	public void setArticleType(Long articleType) {
		...
		if(articleType != null){
			putQueryParameter("ArticleType", articleType.toString());
		}
	}
	...
	public void setServCode(String servCode) {
		...
		if(servCode != null){
			putQueryParameter("ServCode", servCode);
		}
	}
	...
	@Override
	public Class<SynchronizeCommodityResponse> getResponseClass() {
		return SynchronizeCommodityResponse.class;
	}
