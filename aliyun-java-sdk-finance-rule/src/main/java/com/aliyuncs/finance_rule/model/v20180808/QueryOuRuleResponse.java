...
import com.aliyuncs.finance_rule.transform.v20180808.QueryOuRuleResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryOuRuleResponse extends AcsResponse {
	...
	private List<FinanceRuleOuDto> resultObj;
	...
	public List<FinanceRuleOuDto> getResultObj() {
		return this.resultObj;
	}

	public void setResultObj(List<FinanceRuleOuDto> resultObj) {
	...
	@Override
	public QueryOuRuleResponse getInstance(UnmarshallerContext context) {
		return	QueryOuRuleResponseUnmarshaller.unmarshall(this, context);
	}
}
