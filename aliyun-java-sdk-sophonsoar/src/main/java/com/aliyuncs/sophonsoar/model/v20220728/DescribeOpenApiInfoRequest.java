 ...
 * @version 
 */
public class DescribeOpenApiInfoRequest extends RpcAcsRequest<DescribeOpenApiInfoResponse> {
	...
	public DescribeOpenApiInfoRequest() {
		super("sophonsoar", "2022-07-28", "DescribeOpenApiInfo");
	...
	@Override
	public Class<DescribeOpenApiInfoResponse> getResponseClass() {
		return DescribeOpenApiInfoResponse.class;
	}
