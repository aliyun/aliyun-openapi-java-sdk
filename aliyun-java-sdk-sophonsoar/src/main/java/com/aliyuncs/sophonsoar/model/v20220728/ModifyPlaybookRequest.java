 ...
 * @version 
 */
public class ModifyPlaybookRequest extends RpcAcsRequest<ModifyPlaybookResponse> {
	...
	private String lang;
	public ModifyPlaybookRequest() {
		super("sophonsoar", "2022-07-28", "ModifyPlaybook");
	...
	@Override
	public Class<ModifyPlaybookResponse> getResponseClass() {
		return ModifyPlaybookResponse.class;
	}
