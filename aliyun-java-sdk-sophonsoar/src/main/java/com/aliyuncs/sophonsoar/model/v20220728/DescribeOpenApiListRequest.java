 ...
 * @version 
 */
public class DescribeOpenApiListRequest extends RpcAcsRequest<DescribeOpenApiListResponse> {
	...
	public DescribeOpenApiListRequest() {
		super("sophonsoar", "2022-07-28", "DescribeOpenApiList");
	...
	@Override
	public Class<DescribeOpenApiListResponse> getResponseClass() {
		return DescribeOpenApiListResponse.class;
	}
