 ...
 * @version 
 */
public class RunNotifyComponentWithWebhookRequest extends RpcAcsRequest<RunNotifyComponentWithWebhookResponse> {
	...
	public RunNotifyComponentWithWebhookRequest() {
		super("sophonsoar", "2022-07-28", "RunNotifyComponentWithWebhook");
	...
	public void setSecret(String secret) {
		this.secret = secret;
		if(secret != null){
			putQueryParameter("Secret", secret);
		}
	}
	...
	@Override
	public Class<RunNotifyComponentWithWebhookResponse> getResponseClass() {
		return RunNotifyComponentWithWebhookResponse.class;
	}
