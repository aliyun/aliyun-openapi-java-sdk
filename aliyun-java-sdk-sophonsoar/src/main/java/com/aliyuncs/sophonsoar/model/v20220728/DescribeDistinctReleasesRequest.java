 ...
 * @version 
 */
public class DescribeDistinctReleasesRequest extends RpcAcsRequest<DescribeDistinctReleasesResponse> {
	...
	private String lang;
	public DescribeDistinctReleasesRequest() {
		super("sophonsoar", "2022-07-28", "DescribeDistinctReleases");
	...
	@Override
	public Class<DescribeDistinctReleasesResponse> getResponseClass() {
		return DescribeDistinctReleasesResponse.class;
	}
