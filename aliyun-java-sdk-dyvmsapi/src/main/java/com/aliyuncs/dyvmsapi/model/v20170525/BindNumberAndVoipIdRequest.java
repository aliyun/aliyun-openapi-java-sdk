 ...
 * @version 
 */
public class BindNumberAndVoipIdRequest extends RpcAcsRequest<BindNumberAndVoipIdResponse> {
	...
	@Override
	public Class<BindNumberAndVoipIdResponse> getResponseClass() {
		return BindNumberAndVoipIdResponse.class;
	}
