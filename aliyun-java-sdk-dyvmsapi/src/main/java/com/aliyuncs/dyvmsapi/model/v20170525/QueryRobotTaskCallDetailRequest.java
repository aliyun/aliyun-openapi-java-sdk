 ...
 * @version 
 */
public class QueryRobotTaskCallDetailRequest extends RpcAcsRequest<QueryRobotTaskCallDetailResponse> {
	...
	@Override
	public Class<QueryRobotTaskCallDetailResponse> getResponseClass() {
		return QueryRobotTaskCallDetailResponse.class;
	}
