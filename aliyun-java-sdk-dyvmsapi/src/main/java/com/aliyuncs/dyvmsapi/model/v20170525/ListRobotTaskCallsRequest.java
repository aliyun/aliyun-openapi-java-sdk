 ...
 * @version 
 */
public class ListRobotTaskCallsRequest extends RpcAcsRequest<ListRobotTaskCallsResponse> {
	...
	public ListRobotTaskCallsRequest() {
		super("Dyvmsapi", "2017-05-25", "ListRobotTaskCalls", "dyvms");
	...
	@Override
	public Class<ListRobotTaskCallsResponse> getResponseClass() {
		return ListRobotTaskCallsResponse.class;
	}
