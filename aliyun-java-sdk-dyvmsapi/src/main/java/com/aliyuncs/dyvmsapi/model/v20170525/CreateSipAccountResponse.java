...
import com.aliyuncs.dyvmsapi.transform.v20170525.CreateSipAccountResponseUnmarshaller;
 ...
 * @version 
 */
public class CreateSipAccountResponse extends AcsResponse {
	...
	@Override
	public CreateSipAccountResponse getInstance(UnmarshallerContext context) {
		return	CreateSipAccountResponseUnmarshaller.unmarshall(this, context);
	}
