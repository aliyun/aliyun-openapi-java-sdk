 ...
 * @version 
 */
public class SetTLSCipherPolicyAttributeRequest extends RpcAcsRequest<SetTLSCipherPolicyAttributeResponse> {
	...
	public void setTLSCipherPolicyId(String tLSCipherPolicyId) {
		...
		if(tLSCipherPolicyId != null){
			putQueryParameter("TLSCipherPolicyId", tLSCipherPolicyId);
		}
	}
	...
	@Override
	public Class<SetTLSCipherPolicyAttributeResponse> getResponseClass() {
		return SetTLSCipherPolicyAttributeResponse.class;
	}
