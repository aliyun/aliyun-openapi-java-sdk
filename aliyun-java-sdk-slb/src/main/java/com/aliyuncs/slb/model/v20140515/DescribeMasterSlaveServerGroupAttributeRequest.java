 ...
 * @version 
 */
public class DescribeMasterSlaveServerGroupAttributeRequest extends RpcAcsRequest<DescribeMasterSlaveServerGroupAttributeResponse> {
	...
	@Override
	public Class<DescribeMasterSlaveServerGroupAttributeResponse> getResponseClass() {
		return DescribeMasterSlaveServerGroupAttributeResponse.class;
	}
