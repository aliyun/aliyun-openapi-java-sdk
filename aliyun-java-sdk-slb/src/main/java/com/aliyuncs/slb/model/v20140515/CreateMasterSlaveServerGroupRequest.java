...
public class CreateMasterSlaveServerGroupRequest extends RpcAcsRequest<CreateMasterSlaveServerGroupResponse> {
	...
	public void setMasterSlaveServerGroupName(String masterSlaveServerGroupName) {
		...
		if(masterSlaveServerGroupName != null){
			putQueryParameter("MasterSlaveServerGroupName", masterSlaveServerGroupName);
		}
	}
	...
	@Override
	public Class<CreateMasterSlaveServerGroupResponse> getResponseClass() {
		return CreateMasterSlaveServerGroupResponse.class;
	}
