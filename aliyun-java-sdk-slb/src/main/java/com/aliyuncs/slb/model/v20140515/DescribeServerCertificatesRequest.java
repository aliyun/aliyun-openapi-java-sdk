...
public class DescribeServerCertificatesRequest extends RpcAcsRequest<DescribeServerCertificatesResponse> {
	...
	public DescribeServerCertificatesRequest() {
		super("Slb", "2014-05-15", "DescribeServerCertificates");
	}
	...
	@Override
	public Class<DescribeServerCertificatesResponse> getResponseClass() {
		return DescribeServerCertificatesResponse.class;
	}
