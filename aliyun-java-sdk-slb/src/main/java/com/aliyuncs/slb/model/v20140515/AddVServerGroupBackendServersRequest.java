...
public class AddVServerGroupBackendServersRequest extends RpcAcsRequest<AddVServerGroupBackendServersResponse> {
	...
	public AddVServerGroupBackendServersRequest() {
		super("Slb", "2014-05-15", "AddVServerGroupBackendServers");
	}
	...
	@Override
	public Class<AddVServerGroupBackendServersResponse> getResponseClass() {
		return AddVServerGroupBackendServersResponse.class;
	}
