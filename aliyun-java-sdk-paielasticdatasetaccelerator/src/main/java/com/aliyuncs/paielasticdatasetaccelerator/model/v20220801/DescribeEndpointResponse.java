...
import com.aliyuncs.paielasticdatasetaccelerator.transform.v20220801.DescribeEndpointResponseUnmarshaller;
...
public class DescribeEndpointResponse extends AcsResponse {
	...
	@Override
	public DescribeEndpointResponse getInstance(UnmarshallerContext context) {
		return	DescribeEndpointResponseUnmarshaller.unmarshall(this, context);
	}
