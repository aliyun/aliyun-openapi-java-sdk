 ...
 * @version 
 */
public class DeleteEndpointRequest extends RoaAcsRequest<DeleteEndpointResponse> {
	   

	private String endpointId;
	public DeleteEndpointRequest() {
		super("PAIElasticDatasetAccelerator", "2022-08-01", "DeleteEndpoint", "datasetacc");
	...
	@Override
	public Class<DeleteEndpointResponse> getResponseClass() {
