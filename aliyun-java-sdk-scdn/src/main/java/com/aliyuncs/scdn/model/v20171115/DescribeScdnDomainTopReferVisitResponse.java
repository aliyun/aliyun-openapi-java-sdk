...
import com.aliyuncs.scdn.transform.v20171115.DescribeScdnDomainTopReferVisitResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeScdnDomainTopReferVisitResponse extends AcsResponse {
	...
	@Override
	public DescribeScdnDomainTopReferVisitResponse getInstance(UnmarshallerContext context) {
		return	DescribeScdnDomainTopReferVisitResponseUnmarshaller.unmarshall(this, context);
	}
}
