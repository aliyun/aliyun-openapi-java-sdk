...
import com.aliyuncs.scdn.transform.v20171115.DescribeScdnRefreshQuotaResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeScdnRefreshQuotaResponse extends AcsResponse {
	...
	@Override
	public DescribeScdnRefreshQuotaResponse getInstance(UnmarshallerContext context) {
		return	DescribeScdnRefreshQuotaResponseUnmarshaller.unmarshall(this, context);
	}
}
