...
import com.aliyuncs.scdn.transform.v20171115.DescribeScdnDomainRealTimeHttpCodeDataResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeScdnDomainRealTimeHttpCodeDataResponse extends AcsResponse {
	...
	@Override
	public DescribeScdnDomainRealTimeHttpCodeDataResponse getInstance(UnmarshallerContext context) {
		return	DescribeScdnDomainRealTimeHttpCodeDataResponseUnmarshaller.unmarshall(this, context);
	}
}
