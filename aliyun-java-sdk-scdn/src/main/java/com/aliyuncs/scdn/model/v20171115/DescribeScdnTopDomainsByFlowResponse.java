...
import com.aliyuncs.scdn.transform.v20171115.DescribeScdnTopDomainsByFlowResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeScdnTopDomainsByFlowResponse extends AcsResponse {
	...
	@Override
	public DescribeScdnTopDomainsByFlowResponse getInstance(UnmarshallerContext context) {
		return	DescribeScdnTopDomainsByFlowResponseUnmarshaller.unmarshall(this, context);
	}
}
