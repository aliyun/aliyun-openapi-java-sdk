 ...
 * @version 
 */
public class DescribeScdnDomainPvDataResponse extends AcsResponse {
	...
	@Override
	public DescribeScdnDomainPvDataResponse getInstance(UnmarshallerContext context) {
		return	DescribeScdnDomainPvDataResponseUnmarshaller.unmarshall(this, context);
	}
}
