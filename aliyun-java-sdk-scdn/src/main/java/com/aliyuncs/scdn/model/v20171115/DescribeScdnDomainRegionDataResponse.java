...
import com.aliyuncs.scdn.transform.v20171115.DescribeScdnDomainRegionDataResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeScdnDomainRegionDataResponse extends AcsResponse {
	...
	@Override
	public DescribeScdnDomainRegionDataResponse getInstance(UnmarshallerContext context) {
		return	DescribeScdnDomainRegionDataResponseUnmarshaller.unmarshall(this, context);
	}
}
