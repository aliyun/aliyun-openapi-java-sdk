...
import com.aliyuncs.scdn.transform.v20171115.DescribeScdnDomainBpsDataResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeScdnDomainBpsDataResponse extends AcsResponse {
	...
	@Override
	public DescribeScdnDomainBpsDataResponse getInstance(UnmarshallerContext context) {
		return	DescribeScdnDomainBpsDataResponseUnmarshaller.unmarshall(this, context);
	}
}
