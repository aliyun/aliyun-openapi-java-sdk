...
public class DeleteScdnSpecificConfigRequest extends RpcAcsRequest<DeleteScdnSpecificConfigResponse> {
	...
	public DeleteScdnSpecificConfigRequest() {
		super("scdn", "2017-11-15", "DeleteScdnSpecificConfig");
	...
	@Override
	public Class<DeleteScdnSpecificConfigResponse> getResponseClass() {
		return DeleteScdnSpecificConfigResponse.class;
	}
