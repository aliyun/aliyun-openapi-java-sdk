 ...
 * @version 
 */
public class DescribeScdnCertificateListResponse extends AcsResponse {
	...
	@Override
	public DescribeScdnCertificateListResponse getInstance(UnmarshallerContext context) {
		return	DescribeScdnCertificateListResponseUnmarshaller.unmarshall(this, context);
	}
}
