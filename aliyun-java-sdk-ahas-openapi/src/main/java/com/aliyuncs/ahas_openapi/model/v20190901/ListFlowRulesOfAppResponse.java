...
import com.aliyuncs.ahas_openapi.transform.v20190901.ListFlowRulesOfAppResponseUnmarshaller;
 ...
 * @version 
 */
public class ListFlowRulesOfAppResponse extends AcsResponse {
	...
	@Override
	public ListFlowRulesOfAppResponse getInstance(UnmarshallerContext context) {
		return	ListFlowRulesOfAppResponseUnmarshaller.unmarshall(this, context);
	}
