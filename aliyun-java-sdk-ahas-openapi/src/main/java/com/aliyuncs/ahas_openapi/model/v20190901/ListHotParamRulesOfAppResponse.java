...
import com.aliyuncs.ahas_openapi.transform.v20190901.ListHotParamRulesOfAppResponseUnmarshaller;
 ...
 * @version 
 */
public class ListHotParamRulesOfAppResponse extends AcsResponse {
	...
	@Override
	public ListHotParamRulesOfAppResponse getInstance(UnmarshallerContext context) {
		return	ListHotParamRulesOfAppResponseUnmarshaller.unmarshall(this, context);
	}
