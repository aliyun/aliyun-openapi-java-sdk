...
import com.aliyuncs.ahas_openapi.transform.v20190901.EnableHotParamRuleResponseUnmarshaller;
 ...
 * @version 
 */
public class EnableHotParamRuleResponse extends AcsResponse {
	...
	@Override
	public EnableHotParamRuleResponse getInstance(UnmarshallerContext context) {
		return	EnableHotParamRuleResponseUnmarshaller.unmarshall(this, context);
	}
