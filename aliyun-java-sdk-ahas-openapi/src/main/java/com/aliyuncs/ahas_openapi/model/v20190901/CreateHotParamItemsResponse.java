...
import com.aliyuncs.ahas_openapi.transform.v20190901.CreateHotParamItemsResponseUnmarshaller;
 ...
 * @version 
 */
public class CreateHotParamItemsResponse extends AcsResponse {
	...
	@Override
	public CreateHotParamItemsResponse getInstance(UnmarshallerContext context) {
		return	CreateHotParamItemsResponseUnmarshaller.unmarshall(this, context);
	}
