...
import com.aliyuncs.ahas_openapi.transform.v20190901.CreateDegradeRuleResponseUnmarshaller;
 ...
 * @version 
 */
public class CreateDegradeRuleResponse extends AcsResponse {
	...
	@Override
	public CreateDegradeRuleResponse getInstance(UnmarshallerContext context) {
		return	CreateDegradeRuleResponseUnmarshaller.unmarshall(this, context);
	}
