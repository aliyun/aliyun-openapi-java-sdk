 ...
 * @version 
 */
public class CheckExperimentRunnableRequest extends RpcAcsRequest<CheckExperimentRunnableResponse> {
	...
	@Override
	public Class<CheckExperimentRunnableResponse> getResponseClass() {
		return CheckExperimentRunnableResponse.class;
	}
