...
import com.aliyuncs.ahas_openapi.transform.v20190901.EnableIsolationRuleResponseUnmarshaller;
 ...
 * @version 
 */
public class EnableIsolationRuleResponse extends AcsResponse {
	...
	@Override
	public EnableIsolationRuleResponse getInstance(UnmarshallerContext context) {
		return	EnableIsolationRuleResponseUnmarshaller.unmarshall(this, context);
	}
