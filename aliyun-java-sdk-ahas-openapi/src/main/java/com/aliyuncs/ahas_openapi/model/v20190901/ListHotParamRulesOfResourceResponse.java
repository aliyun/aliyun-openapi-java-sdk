...
import com.aliyuncs.ahas_openapi.transform.v20190901.ListHotParamRulesOfResourceResponseUnmarshaller;
...
public class ListHotParamRulesOfResourceResponse extends AcsResponse {
	...
	@Override
	public ListHotParamRulesOfResourceResponse getInstance(UnmarshallerContext context) {
		return	ListHotParamRulesOfResourceResponseUnmarshaller.unmarshall(this, context);
	}
