 ...
 * @version 
 */
public class FinishExperimentTaskRequest extends RpcAcsRequest<FinishExperimentTaskResponse> {
	...
	public FinishExperimentTaskRequest() {
		super("ahas-openapi", "2019-09-01", "FinishExperimentTask", "ahas");
	...
	@Override
	public Class<FinishExperimentTaskResponse> getResponseClass() {
		return FinishExperimentTaskResponse.class;
	}
