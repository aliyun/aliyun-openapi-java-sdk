...
import com.aliyuncs.ahas_openapi.transform.v20190901.EnableDegradeRuleResponseUnmarshaller;
 ...
 * @version 
 */
public class EnableDegradeRuleResponse extends AcsResponse {
	...
	@Override
	public EnableDegradeRuleResponse getInstance(UnmarshallerContext context) {
		return	EnableDegradeRuleResponseUnmarshaller.unmarshall(this, context);
	}
