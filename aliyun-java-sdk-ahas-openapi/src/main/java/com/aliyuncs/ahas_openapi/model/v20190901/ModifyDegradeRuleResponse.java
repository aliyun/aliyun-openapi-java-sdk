...
import com.aliyuncs.ahas_openapi.transform.v20190901.ModifyDegradeRuleResponseUnmarshaller;
 ...
 * @version 
 */
public class ModifyDegradeRuleResponse extends AcsResponse {
	...
	@Override
	public ModifyDegradeRuleResponse getInstance(UnmarshallerContext context) {
		return	ModifyDegradeRuleResponseUnmarshaller.unmarshall(this, context);
	}
