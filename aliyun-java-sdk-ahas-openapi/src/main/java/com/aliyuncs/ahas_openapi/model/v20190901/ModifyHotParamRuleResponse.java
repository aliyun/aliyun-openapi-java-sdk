...
import com.aliyuncs.ahas_openapi.transform.v20190901.ModifyHotParamRuleResponseUnmarshaller;
 ...
 * @version 
 */
public class ModifyHotParamRuleResponse extends AcsResponse {
	...
	@Override
	public ModifyHotParamRuleResponse getInstance(UnmarshallerContext context) {
		return	ModifyHotParamRuleResponseUnmarshaller.unmarshall(this, context);
	}
