...
import com.aliyuncs.ahas_openapi.transform.v20190901.CreateIsolationRuleResponseUnmarshaller;
...
public class CreateIsolationRuleResponse extends AcsResponse {
	...
	@Override
	public CreateIsolationRuleResponse getInstance(UnmarshallerContext context) {
		return	CreateIsolationRuleResponseUnmarshaller.unmarshall(this, context);
	}
