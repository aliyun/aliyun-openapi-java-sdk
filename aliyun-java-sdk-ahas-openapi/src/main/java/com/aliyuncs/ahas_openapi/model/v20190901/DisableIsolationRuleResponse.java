...
import com.aliyuncs.ahas_openapi.transform.v20190901.DisableIsolationRuleResponseUnmarshaller;
 ...
 * @version 
 */
public class DisableIsolationRuleResponse extends AcsResponse {
	...
	@Override
	public DisableIsolationRuleResponse getInstance(UnmarshallerContext context) {
		return	DisableIsolationRuleResponseUnmarshaller.unmarshall(this, context);
	}
