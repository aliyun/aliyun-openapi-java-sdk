...
import com.aliyuncs.ahas_openapi.transform.v20190901.ListDegradeRulesOfAppResponseUnmarshaller;
 ...
 * @version 
 */
public class ListDegradeRulesOfAppResponse extends AcsResponse {
	...
	@Override
	public ListDegradeRulesOfAppResponse getInstance(UnmarshallerContext context) {
		return	ListDegradeRulesOfAppResponseUnmarshaller.unmarshall(this, context);
	}
