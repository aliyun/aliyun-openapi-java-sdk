 ...
 * @version 
 */
public class ModifySystemRuleRequest extends RpcAcsRequest<ModifySystemRuleResponse> {
	...
	@Override
	public Class<ModifySystemRuleResponse> getResponseClass() {
		return ModifySystemRuleResponse.class;
	}
