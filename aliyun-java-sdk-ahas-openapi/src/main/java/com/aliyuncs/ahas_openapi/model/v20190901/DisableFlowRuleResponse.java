...
import com.aliyuncs.ahas_openapi.transform.v20190901.DisableFlowRuleResponseUnmarshaller;
...
public class DisableFlowRuleResponse extends AcsResponse {
	...
	@Override
	public DisableFlowRuleResponse getInstance(UnmarshallerContext context) {
		return	DisableFlowRuleResponseUnmarshaller.unmarshall(this, context);
	}
