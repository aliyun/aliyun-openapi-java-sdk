...
import com.aliyuncs.mpaas.model.v20200710.ListMcubeMiniAppsResponse;
import com.aliyuncs.mpaas.model.v20200710.ListMcubeMiniAppsResponse.ListMiniResult;
import com.aliyuncs.mpaas.model.v20200710.ListMcubeMiniAppsResponse.ListMiniResult.MiniProgramListItem;
...
public class ListMcubeMiniAppsResponseUnmarshaller {
	...
	public static ListMcubeMiniAppsResponse unmarshall(ListMcubeMiniAppsResponse listMcubeMiniAppsResponse, UnmarshallerContext _ctx) {
		...
		listMiniResult.setCurrentPage(_ctx.integerValue("ListMcubeMiniAppsResponse.ListMiniResult.CurrentPage"));
		listMiniResult.setPageSize(_ctx.integerValue("ListMcubeMiniAppsResponse.ListMiniResult.PageSize"));
		listMiniResult.setTotalCount(_ctx.longValue("ListMcubeMiniAppsResponse.ListMiniResult.TotalCount"));
		listMiniResult.setHasMore(_ctx.booleanValue("ListMcubeMiniAppsResponse.ListMiniResult.HasMore"));
