...
import com.aliyuncs.mpaas.model.v20200710.CreateTemplateResponse;
...
public class CreateTemplateResponseUnmarshaller {
	...
	public static CreateTemplateResponse unmarshall(CreateTemplateResponse createTemplateResponse, UnmarshallerContext _ctx) {
		...
		createTemplateResponse.setCode(_ctx.stringValue("CreateTemplateResponse.Code"));
		createTemplateResponse.setMsg(_ctx.stringValue("CreateTemplateResponse.Msg"));
		createTemplateResponse.setData(_ctx.stringValue("CreateTemplateResponse.Data"));
