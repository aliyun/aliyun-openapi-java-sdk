...
public class ListMcubeUpgradePackagesResponseUnmarshaller {
	...
	public static ListMcubeUpgradePackagesResponse unmarshall(ListMcubeUpgradePackagesResponse listMcubeUpgradePackagesResponse, UnmarshallerContext _ctx) {
		...
		listMcubeUpgradePackagesResponse.setCurrentPage(_ctx.integerValue("ListMcubeUpgradePackagesResponse.CurrentPage"));
		listMcubeUpgradePackagesResponse.setPageSize(_ctx.integerValue("ListMcubeUpgradePackagesResponse.PageSize"));
		listMcubeUpgradePackagesResponse.setTotalCount(_ctx.longValue("ListMcubeUpgradePackagesResponse.TotalCount"));
		listMcubeUpgradePackagesResponse.setHasMore(_ctx.booleanValue("ListMcubeUpgradePackagesResponse.HasMore"));
