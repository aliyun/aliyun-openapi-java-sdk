 ...
 * @version 
 */
public class GetFileTokenForUploadToMsaRequest extends RpcAcsRequest<GetFileTokenForUploadToMsaResponse> {
	...
	@Override
	public Class<GetFileTokenForUploadToMsaResponse> getResponseClass() {
		return GetFileTokenForUploadToMsaResponse.class;
	}
