 ...
 * @version 
 */
public class QueryMpaasMrtcArtvcRecordfileRequest extends RpcAcsRequest<QueryMpaasMrtcArtvcRecordfileResponse> {
	...
	public QueryMpaasMrtcArtvcRecordfileRequest() {
		super("mPaaS", "2019-08-21", "QueryMpaasMrtcArtvcRecordfile", "mpaas");
	...
	@Override
	public Class<QueryMpaasMrtcArtvcRecordfileResponse> getResponseClass() {
		return QueryMpaasMrtcArtvcRecordfileResponse.class;
	}
