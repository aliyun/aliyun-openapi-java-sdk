...
public class ListMappCenterWorkspacesRequest extends RpcAcsRequest<ListMappCenterWorkspacesResponse> {
	...
	public ListMappCenterWorkspacesRequest() {
		super("mPaaS", "2019-08-21", "ListMappCenterWorkspaces", "mpaas");
	...
	@Override
	public Class<ListMappCenterWorkspacesResponse> getResponseClass() {
		return ListMappCenterWorkspacesResponse.class;
	}
