 ...
 * @version 
 */
public class ListMdsCubeTasksRequest extends RpcAcsRequest<ListMdsCubeTasksResponse> {
	...
	public ListMdsCubeTasksRequest() {
		super("mPaaS", "2020-10-28", "ListMdsCubeTasks", "mpaas");
	...
	@Override
	public Class<ListMdsCubeTasksResponse> getResponseClass() {
		return ListMdsCubeTasksResponse.class;
	}
