...
import com.aliyuncs.mpaas.transform.v20200415.ListMcubeMiniAppsByUserNameResponseUnmarshaller;
 ...
 * @version 
 */
public class ListMcubeMiniAppsByUserNameResponse extends AcsResponse {
	...
	@Override
	public ListMcubeMiniAppsByUserNameResponse getInstance(UnmarshallerContext context) {
		return	ListMcubeMiniAppsByUserNameResponseUnmarshaller.unmarshall(this, context);
	}
