...
public class StartUserAppAsyncEnhanceInMsaRequest extends RpcAcsRequest<StartUserAppAsyncEnhanceInMsaResponse> {
	...
	public void setRoot(Integer root) {
		this.root = root;
		if(root != null){
			putBodyParameter("Root", root.toString());
		}
	}
	...
	public void setApkProtector(Boolean apkProtector) {
		this.apkProtector = apkProtector;
		if(apkProtector != null){
			putBodyParameter("ApkProtector", apkProtector.toString());
		}
	}
	...
	public void setUseYShield(Boolean useYShield) {
		this.useYShield = useYShield;
		if(useYShield != null){
			putBodyParameter("UseYShield", useYShield.toString());
		}
	}
	...
	public void setSoFileList(String soFileList) {
		this.soFileList = soFileList;
		if(soFileList != null){
			putBodyParameter("SoFileList", soFileList);
		}
	}
	...
	public void setAssetsFileList(String assetsFileList) {
		this.assetsFileList = assetsFileList;
		if(assetsFileList != null){
			putBodyParameter("AssetsFileList", assetsFileList);
		}
	}
	...
	public void setNewShieldConfig(String newShieldConfig) {
		this.newShieldConfig = newShieldConfig;
		if(newShieldConfig != null){
			putQueryParameter("NewShieldConfig", newShieldConfig);
		}
	}
