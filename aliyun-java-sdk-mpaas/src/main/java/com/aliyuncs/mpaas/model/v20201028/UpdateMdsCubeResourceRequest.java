 ...
 * @version 
 */
public class UpdateMdsCubeResourceRequest extends RpcAcsRequest<UpdateMdsCubeResourceResponse> {
	...
	public UpdateMdsCubeResourceRequest() {
		super("mPaaS", "2020-10-28", "UpdateMdsCubeResource", "mpaas");
	...
	@Override
	public Class<UpdateMdsCubeResourceResponse> getResponseClass() {
		return UpdateMdsCubeResourceResponse.class;
	}
