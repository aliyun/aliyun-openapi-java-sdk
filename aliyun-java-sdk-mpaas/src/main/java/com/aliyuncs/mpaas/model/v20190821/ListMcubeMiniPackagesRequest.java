...
public class ListMcubeMiniPackagesRequest extends RpcAcsRequest<ListMcubeMiniPackagesResponse> {
	...
	public ListMcubeMiniPackagesRequest() {
		super("mPaaS", "2019-08-21", "ListMcubeMiniPackages", "mpaas");
	...
	public void setPackageTypes(String packageTypes) {
		...
		if(packageTypes != null){
			putBodyParameter("PackageTypes", packageTypes);
		}
	}
	...
	@Override
	public Class<ListMcubeMiniPackagesResponse> getResponseClass() {
		return ListMcubeMiniPackagesResponse.class;
	}
