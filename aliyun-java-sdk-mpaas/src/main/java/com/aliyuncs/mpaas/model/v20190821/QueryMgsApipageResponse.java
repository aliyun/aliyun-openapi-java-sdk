...
import com.aliyuncs.mpaas.transform.v20190821.QueryMgsApipageResponseUnmarshaller;
...
public class QueryMgsApipageResponse extends AcsResponse {
	...
	@Override
	public QueryMgsApipageResponse getInstance(UnmarshallerContext context) {
		return	QueryMgsApipageResponseUnmarshaller.unmarshall(this, context);
	}
