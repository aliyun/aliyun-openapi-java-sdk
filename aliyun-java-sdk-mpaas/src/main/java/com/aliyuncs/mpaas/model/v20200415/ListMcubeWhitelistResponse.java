...
import com.aliyuncs.mpaas.transform.v20200415.ListMcubeWhitelistResponseUnmarshaller;
 ...
 * @version 
 */
public class ListMcubeWhitelistResponse extends AcsResponse {
	...
	@Override
	public ListMcubeWhitelistResponse getInstance(UnmarshallerContext context) {
		return	ListMcubeWhitelistResponseUnmarshaller.unmarshall(this, context);
	}
