 ...
 * @version 
 */
public class CreateLinkRequest extends RpcAcsRequest<CreateLinkResponse> {
	...
	public CreateLinkRequest() {
		super("mPaaS", "2020-10-28", "CreateLink", "mpaas");
	...
	@Override
	public Class<CreateLinkResponse> getResponseClass() {
		return CreateLinkResponse.class;
	}
