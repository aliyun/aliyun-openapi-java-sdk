...
public class UploadMcubeMiniPackageRequest extends RpcAcsRequest<UploadMcubeMiniPackageResponse> {
	...
	public UploadMcubeMiniPackageRequest() {
		super("mPaaS", "2020-04-15", "UploadMcubeMiniPackage", "mpaas");
	...
	public void setAppxVersion(String appxVersion) {
		this.appxVersion = appxVersion;
		if(appxVersion != null){
			putBodyParameter("AppxVersion", appxVersion);
		}
	}
