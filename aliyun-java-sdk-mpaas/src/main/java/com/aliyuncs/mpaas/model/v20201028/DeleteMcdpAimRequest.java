...
public class DeleteMcdpAimRequest extends RpcAcsRequest<DeleteMcdpAimResponse> {
	...
	public void setMpaasMappcenterMcdpAimDeleteJsonStr(String mpaasMappcenterMcdpAimDeleteJsonStr) {
		this.mpaasMappcenterMcdpAimDeleteJsonStr = mpaasMappcenterMcdpAimDeleteJsonStr;
		if(mpaasMappcenterMcdpAimDeleteJsonStr != null){
			putBodyParameter("MpaasMappcenterMcdpAimDeleteJsonStr", mpaasMappcenterMcdpAimDeleteJsonStr);
		}
	}
