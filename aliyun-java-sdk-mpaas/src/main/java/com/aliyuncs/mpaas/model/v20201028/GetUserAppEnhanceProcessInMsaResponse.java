...
import com.aliyuncs.mpaas.transform.v20201028.GetUserAppEnhanceProcessInMsaResponseUnmarshaller;
 ...
 * @version 
 */
public class GetUserAppEnhanceProcessInMsaResponse extends AcsResponse {
	...
	@Override
	public GetUserAppEnhanceProcessInMsaResponse getInstance(UnmarshallerContext context) {
		return	GetUserAppEnhanceProcessInMsaResponseUnmarshaller.unmarshall(this, context);
	}
