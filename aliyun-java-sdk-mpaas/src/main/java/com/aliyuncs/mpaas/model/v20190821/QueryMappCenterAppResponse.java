...
import com.aliyuncs.mpaas.transform.v20190821.QueryMappCenterAppResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryMappCenterAppResponse extends AcsResponse {
	...
	public void setQueryMappCenterAppResult(QueryMappCenterAppResult queryMappCenterAppResult) {
		this.queryMappCenterAppResult = queryMappCenterAppResult;
	}

	public static class QueryMappCenterAppResult {
		...
		public void setMappCenterApp(MappCenterApp mappCenterApp) {
			this.mappCenterApp = mappCenterApp;
		}

		public static class MappCenterApp {
	...
	@Override
	public QueryMappCenterAppResponse getInstance(UnmarshallerContext context) {
		return	QueryMappCenterAppResponseUnmarshaller.unmarshall(this, context);
	}
