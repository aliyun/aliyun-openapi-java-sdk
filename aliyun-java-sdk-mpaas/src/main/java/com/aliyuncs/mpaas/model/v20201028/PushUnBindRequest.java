 ...
 * @version 
 */
public class PushUnBindRequest extends RpcAcsRequest<PushUnBindResponse> {
	...
	@Override
	public Class<PushUnBindResponse> getResponseClass() {
		return PushUnBindResponse.class;
	}
