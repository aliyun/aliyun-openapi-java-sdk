...
import com.aliyuncs.sddp.transform.v20190103.DescribeColumnsV2ResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeColumnsV2Response extends AcsResponse {
	...
	@Override
	public DescribeColumnsV2Response getInstance(UnmarshallerContext context) {
		return	DescribeColumnsV2ResponseUnmarshaller.unmarshall(this, context);
	}
