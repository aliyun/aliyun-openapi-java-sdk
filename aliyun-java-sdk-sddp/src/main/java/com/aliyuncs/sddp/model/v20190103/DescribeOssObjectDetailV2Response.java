...
public class DescribeOssObjectDetailV2Response extends AcsResponse {
	...
	@Override
	public DescribeOssObjectDetailV2Response getInstance(UnmarshallerContext context) {
		return	DescribeOssObjectDetailV2ResponseUnmarshaller.unmarshall(this, context);
	}
