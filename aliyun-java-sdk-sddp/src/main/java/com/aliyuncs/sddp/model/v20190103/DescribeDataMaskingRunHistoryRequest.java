 ...
 * @version 
 */
public class DescribeDataMaskingRunHistoryRequest extends RpcAcsRequest<DescribeDataMaskingRunHistoryResponse> {
	...
	@Override
	public Class<DescribeDataMaskingRunHistoryResponse> getResponseClass() {
		return DescribeDataMaskingRunHistoryResponse.class;
	}
