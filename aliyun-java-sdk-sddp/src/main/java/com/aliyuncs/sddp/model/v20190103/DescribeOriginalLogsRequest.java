 ...
 * @version 
 */
public class DescribeOriginalLogsRequest extends RpcAcsRequest<DescribeOriginalLogsResponse> {
	...
	public DescribeOriginalLogsRequest() {
		super("Sddp", "2019-01-03", "DescribeOriginalLogs", "sddp");
	...
	public void setClientUa(String clientUa) {
		...
		if(clientUa != null){
			putQueryParameter("ClientUa", clientUa);
		}
	}
	...
	@Override
	public Class<DescribeOriginalLogsResponse> getResponseClass() {
		return DescribeOriginalLogsResponse.class;
	}
