 ...
 * @version 
 */
public class EnableSceneRequest extends RpcAcsRequest<EnableSceneResponse> {
	...
	public EnableSceneRequest() {
		super("RetailBot", "2021-02-24", "EnableScene");
	...
	@Override
	public Class<EnableSceneResponse> getResponseClass() {
		return EnableSceneResponse.class;
	}
