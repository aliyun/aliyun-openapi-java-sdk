 ...
 * @version 
 */
public class ReleaseServiceTestRequest extends RpcAcsRequest<ReleaseServiceTestResponse> {
	   

	private AliyunAccountDTO aliyunAccountDTO;
	public ReleaseServiceTestRequest() {
		super("RetailBot", "2021-02-24", "ReleaseServiceTest");
	...
	@Override
	public Class<ReleaseServiceTestResponse> getResponseClass() {
		return ReleaseServiceTestResponse.class;
	}
