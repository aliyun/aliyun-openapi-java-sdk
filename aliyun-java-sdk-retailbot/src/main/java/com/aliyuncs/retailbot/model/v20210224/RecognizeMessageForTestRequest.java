 ...
 * @version 
 */
public class RecognizeMessageForTestRequest extends RpcAcsRequest<RecognizeMessageForTestResponse> {
	...
	private Boolean ignoreSceneSwitch;
	...
	public RecognizeMessageForTestRequest() {
		super("RetailBot", "2021-02-24", "RecognizeMessageForTest");
	...
	public void setIgnoreSceneSwitch(Boolean ignoreSceneSwitch) {
		this.ignoreSceneSwitch = ignoreSceneSwitch;
		if(ignoreSceneSwitch != null){
			putBodyParameter("IgnoreSceneSwitch", ignoreSceneSwitch.toString());
		}
	}
	...
	@Override
	public Class<RecognizeMessageForTestResponse> getResponseClass() {
		return RecognizeMessageForTestResponse.class;
	}
