 ...
 * @version 
 */
public class AdminTestSeviceRequest extends RpcAcsRequest<AdminTestSeviceResponse> {
	   

	private AliyunAccountDTO aliyunAccountDTO;

	private Long versionId;
	public AdminTestSeviceRequest() {
		super("RetailBot", "2021-02-24", "AdminTestSevice");
	...
	@Override
	public Class<AdminTestSeviceResponse> getResponseClass() {
		return AdminTestSeviceResponse.class;
	}
