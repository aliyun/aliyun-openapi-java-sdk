 ...
 * @version 
 */
public class UpdateBlackEntryRequest extends RpcAcsRequest<UpdateBlackEntryResponse> {
	...
	public UpdateBlackEntryRequest() {
		super("RetailBot", "2021-02-24", "UpdateBlackEntry");
	...
	@Override
	public Class<UpdateBlackEntryResponse> getResponseClass() {
		return UpdateBlackEntryResponse.class;
	}
