...
import com.aliyuncs.retailbot.transform.v20210224.RecognizeMessageResponseUnmarshaller;
 ...
 * @version 
 */
public class RecognizeMessageResponse extends AcsResponse {
	...
	@Override
	public RecognizeMessageResponse getInstance(UnmarshallerContext context) {
		return	RecognizeMessageResponseUnmarshaller.unmarshall(this, context);
	}
