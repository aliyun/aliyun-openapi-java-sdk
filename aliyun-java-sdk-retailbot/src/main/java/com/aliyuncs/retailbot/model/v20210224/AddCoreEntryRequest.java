 ...
 * @version 
 */
public class AddCoreEntryRequest extends RpcAcsRequest<AddCoreEntryResponse> {
	...
	public AddCoreEntryRequest() {
		super("RetailBot", "2021-02-24", "AddCoreEntry");
	...
	@Override
	public Class<AddCoreEntryResponse> getResponseClass() {
		return AddCoreEntryResponse.class;
	}
