 ...
 * @version 
 */
public class UpdateSolutionRequest extends RpcAcsRequest<UpdateSolutionResponse> {
	...
	public UpdateSolutionRequest() {
		super("RetailBot", "2021-02-24", "UpdateSolution");
	...
	@Override
	public Class<UpdateSolutionResponse> getResponseClass() {
		return UpdateSolutionResponse.class;
	}
