...
import com.aliyuncs.retailbot.transform.v20210224.ListSubscribedPackageKnowledgesResponseUnmarshaller;
 ...
 * @version 
 */
public class ListSubscribedPackageKnowledgesResponse extends AcsResponse {
	...
	@Override
	public ListSubscribedPackageKnowledgesResponse getInstance(UnmarshallerContext context) {
		return	ListSubscribedPackageKnowledgesResponseUnmarshaller.unmarshall(this, context);
	}
