...
public class UpgradePackageResponse extends AcsResponse {
	...
	public static class Data {
		...
		public void setSuccessRobotCodes(List<String> successRobotCodes) {
		...
		public void setFailedRobotCodes(List<String> failedRobotCodes) {
			this.failedRobotCodes = failedRobotCodes;
		}
	}

	@Override
	public UpgradePackageResponse getInstance(UnmarshallerContext context) {
		return	UpgradePackageResponseUnmarshaller.unmarshall(this, context);
	}
