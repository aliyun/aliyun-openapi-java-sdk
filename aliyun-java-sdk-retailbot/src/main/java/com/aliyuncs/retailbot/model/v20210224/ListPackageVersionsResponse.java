...
import com.aliyuncs.retailbot.transform.v20210224.ListPackageVersionsResponseUnmarshaller;
 ...
 * @version 
 */
public class ListPackageVersionsResponse extends AcsResponse {
	...
	@Override
	public ListPackageVersionsResponse getInstance(UnmarshallerContext context) {
		return	ListPackageVersionsResponseUnmarshaller.unmarshall(this, context);
	}
