 ...
 * @version 
 */
public class DisassociateResourceShareRequest extends RpcAcsRequest<DisassociateResourceShareResponse> {
	...
	@Override
	public Class<DisassociateResourceShareResponse> getResponseClass() {
