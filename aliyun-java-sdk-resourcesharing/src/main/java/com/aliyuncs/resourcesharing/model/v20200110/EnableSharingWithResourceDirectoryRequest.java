 ...
 * @version 
 */
public class EnableSharingWithResourceDirectoryRequest extends RpcAcsRequest<EnableSharingWithResourceDirectoryResponse> {
	...
	@Override
	public Class<EnableSharingWithResourceDirectoryResponse> getResponseClass() {
