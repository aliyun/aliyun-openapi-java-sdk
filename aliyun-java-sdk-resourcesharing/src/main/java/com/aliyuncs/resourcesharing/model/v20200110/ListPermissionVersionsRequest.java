 ...
 * @version 
 */
public class ListPermissionVersionsRequest extends RpcAcsRequest<ListPermissionVersionsResponse> {
	...
	@Override
	public Class<ListPermissionVersionsResponse> getResponseClass() {
