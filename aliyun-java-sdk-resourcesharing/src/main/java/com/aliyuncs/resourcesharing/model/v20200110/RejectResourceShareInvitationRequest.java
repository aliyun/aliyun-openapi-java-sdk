 ...
 * @version 
 */
public class RejectResourceShareInvitationRequest extends RpcAcsRequest<RejectResourceShareInvitationResponse> {
	...
	@Override
	public Class<RejectResourceShareInvitationResponse> getResponseClass() {
