 ...
 * @version 
 */
public class AcceptResourceShareInvitationRequest extends RpcAcsRequest<AcceptResourceShareInvitationResponse> {
	...
	@Override
	public Class<AcceptResourceShareInvitationResponse> getResponseClass() {
