 ...
 * @version 
 */
public class DisassociateResourceSharePermissionRequest extends RpcAcsRequest<DisassociateResourceSharePermissionResponse> {
	...
	@Override
	public Class<DisassociateResourceSharePermissionResponse> getResponseClass() {
