 ...
 * @version 
 */
public class ListResourceShareInvitationsRequest extends RpcAcsRequest<ListResourceShareInvitationsResponse> {
	   

	private List<String> resourceShareInvitationIdss;
	...
	public List<String> getResourceShareInvitationIdss() {
		return this.resourceShareInvitationIdss;
	}

	public void setResourceShareInvitationIdss(List<String> resourceShareInvitationIdss) {
	...
	@Override
	public Class<ListResourceShareInvitationsResponse> getResponseClass() {
