...
import com.aliyuncs.baas.transform.v20180731.DescribeConsortiumSpecsResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeConsortiumSpecsResponse extends AcsResponse {
	...
	@Override
	public DescribeConsortiumSpecsResponse getInstance(UnmarshallerContext context) {
		return	DescribeConsortiumSpecsResponseUnmarshaller.unmarshall(this, context);
	}
