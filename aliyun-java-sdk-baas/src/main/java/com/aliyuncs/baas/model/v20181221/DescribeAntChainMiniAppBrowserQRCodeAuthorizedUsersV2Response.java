...
import com.aliyuncs.baas.transform.v20181221.DescribeAntChainMiniAppBrowserQRCodeAuthorizedUsersV2ResponseUnmarshaller;
...
public class DescribeAntChainMiniAppBrowserQRCodeAuthorizedUsersV2Response extends AcsResponse {
	...
	@Override
	public DescribeAntChainMiniAppBrowserQRCodeAuthorizedUsersV2Response getInstance(UnmarshallerContext context) {
		return	DescribeAntChainMiniAppBrowserQRCodeAuthorizedUsersV2ResponseUnmarshaller.unmarshall(this, context);
	}
