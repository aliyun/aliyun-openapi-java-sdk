 ...
 * @version 
 */
public class DescribeExplorerRequest extends RpcAcsRequest<DescribeExplorerResponse> {
	
	public DescribeExplorerRequest() {
		super("Baas", "2018-07-31", "DescribeExplorer");
	}
	...
	@Override
	public Class<DescribeExplorerResponse> getResponseClass() {
		return DescribeExplorerResponse.class;
	}
