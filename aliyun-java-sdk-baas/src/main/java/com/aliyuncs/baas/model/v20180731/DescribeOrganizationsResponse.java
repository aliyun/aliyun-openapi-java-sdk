...
import com.aliyuncs.baas.transform.v20180731.DescribeOrganizationsResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeOrganizationsResponse extends AcsResponse {
	...
	@Override
	public DescribeOrganizationsResponse getInstance(UnmarshallerContext context) {
		return	DescribeOrganizationsResponseUnmarshaller.unmarshall(this, context);
	}
