...
import com.aliyuncs.baas.transform.v20180731.DescribeBlockchainInfoResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeBlockchainInfoResponse extends AcsResponse {
	...
	@Override
	public DescribeBlockchainInfoResponse getInstance(UnmarshallerContext context) {
		return	DescribeBlockchainInfoResponseUnmarshaller.unmarshall(this, context);
	}
