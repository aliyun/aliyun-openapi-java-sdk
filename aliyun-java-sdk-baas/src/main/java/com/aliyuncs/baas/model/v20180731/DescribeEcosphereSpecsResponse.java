...
import com.aliyuncs.baas.transform.v20180731.DescribeEcosphereSpecsResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeEcosphereSpecsResponse extends AcsResponse {
	...
	@Override
	public DescribeEcosphereSpecsResponse getInstance(UnmarshallerContext context) {
		return	DescribeEcosphereSpecsResponseUnmarshaller.unmarshall(this, context);
	}
