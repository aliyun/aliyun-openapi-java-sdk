...
import com.aliyuncs.baas.transform.v20180731.DescribeOrganizationResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeOrganizationResponse extends AcsResponse {
	...
	@Override
	public DescribeOrganizationResponse getInstance(UnmarshallerContext context) {
		return	DescribeOrganizationResponseUnmarshaller.unmarshall(this, context);
	}
