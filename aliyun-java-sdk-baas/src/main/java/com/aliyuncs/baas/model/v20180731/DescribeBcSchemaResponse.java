...
import com.aliyuncs.baas.transform.v20180731.DescribeBcSchemaResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeBcSchemaResponse extends AcsResponse {
	...
	@Override
	public DescribeBcSchemaResponse getInstance(UnmarshallerContext context) {
		return	DescribeBcSchemaResponseUnmarshaller.unmarshall(this, context);
	}
