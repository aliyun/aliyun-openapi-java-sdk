...
import com.aliyuncs.baas.transform.v20180731.GetAppliesResponseUnmarshaller;
 ...
 * @version 
 */
public class GetAppliesResponse extends AcsResponse {
	...
	@Override
	public GetAppliesResponse getInstance(UnmarshallerContext context) {
		return	GetAppliesResponseUnmarshaller.unmarshall(this, context);
	}
