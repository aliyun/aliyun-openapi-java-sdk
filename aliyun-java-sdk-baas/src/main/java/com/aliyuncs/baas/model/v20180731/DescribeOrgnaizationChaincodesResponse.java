...
import com.aliyuncs.baas.transform.v20180731.DescribeOrgnaizationChaincodesResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeOrgnaizationChaincodesResponse extends AcsResponse {
	...
	@Override
	public DescribeOrgnaizationChaincodesResponse getInstance(UnmarshallerContext context) {
		return	DescribeOrgnaizationChaincodesResponseUnmarshaller.unmarshall(this, context);
	}
