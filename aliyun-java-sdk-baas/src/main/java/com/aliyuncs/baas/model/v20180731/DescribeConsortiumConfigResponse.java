...
import com.aliyuncs.baas.transform.v20180731.DescribeConsortiumConfigResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeConsortiumConfigResponse extends AcsResponse {
	...
	@Override
	public DescribeConsortiumConfigResponse getInstance(UnmarshallerContext context) {
		return	DescribeConsortiumConfigResponseUnmarshaller.unmarshall(this, context);
	}
