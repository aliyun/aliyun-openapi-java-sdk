...
import com.aliyuncs.baas.transform.v20180731.GetMySuccessAppliesResponseUnmarshaller;
 ...
 * @version 
 */
public class GetMySuccessAppliesResponse extends AcsResponse {
	...
	@Override
	public GetMySuccessAppliesResponse getInstance(UnmarshallerContext context) {
		return	GetMySuccessAppliesResponseUnmarshaller.unmarshall(this, context);
	}
