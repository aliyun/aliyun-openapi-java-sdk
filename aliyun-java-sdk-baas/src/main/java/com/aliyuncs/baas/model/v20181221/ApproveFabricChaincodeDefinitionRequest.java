 ...
 * @version 
 */
public class ApproveFabricChaincodeDefinitionRequest extends RpcAcsRequest<ApproveFabricChaincodeDefinitionResponse> {
	...
	public ApproveFabricChaincodeDefinitionRequest() {
		super("Baas", "2018-12-21", "ApproveFabricChaincodeDefinition", "baas");
	...
	@Override
	public Class<ApproveFabricChaincodeDefinitionResponse> getResponseClass() {
