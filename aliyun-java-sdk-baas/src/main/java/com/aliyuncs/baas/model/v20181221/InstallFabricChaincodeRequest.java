 ...
 * @version 
 */
public class InstallFabricChaincodeRequest extends RpcAcsRequest<InstallFabricChaincodeResponse> {
	...
	@Override
	public Class<InstallFabricChaincodeResponse> getResponseClass() {
		return InstallFabricChaincodeResponse.class;
	}
