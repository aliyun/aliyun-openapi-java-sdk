...
import com.aliyuncs.baas.transform.v20181221.DescribeFabricConsortiumAdminStatusResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeFabricConsortiumAdminStatusResponse extends AcsResponse {
	...
	@Override
	public DescribeFabricConsortiumAdminStatusResponse getInstance(UnmarshallerContext context) {
		return	DescribeFabricConsortiumAdminStatusResponseUnmarshaller.unmarshall(this, context);
	}
