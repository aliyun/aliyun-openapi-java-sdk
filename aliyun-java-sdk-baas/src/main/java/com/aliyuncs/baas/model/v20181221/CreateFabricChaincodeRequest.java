 ...
 * @version 
 */
public class CreateFabricChaincodeRequest extends RpcAcsRequest<CreateFabricChaincodeResponse> {
	...
	@Override
	public Class<CreateFabricChaincodeResponse> getResponseClass() {
		return CreateFabricChaincodeResponse.class;
	}
