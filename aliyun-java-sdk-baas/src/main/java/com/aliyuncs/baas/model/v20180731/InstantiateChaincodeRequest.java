 ...
 * @version 
 */
public class InstantiateChaincodeRequest extends RpcAcsRequest<InstantiateChaincodeResponse> {
	
	public InstantiateChaincodeRequest() {
		super("Baas", "2018-07-31", "InstantiateChaincode");
	}
	...
	@Override
	public Class<InstantiateChaincodeResponse> getResponseClass() {
		return InstantiateChaincodeResponse.class;
	}
