...
import com.aliyuncs.baas.transform.v20180731.UpdateSchemaResponseUnmarshaller;
 ...
 * @version 
 */
public class UpdateSchemaResponse extends AcsResponse {
	...
	@Override
	public UpdateSchemaResponse getInstance(UnmarshallerContext context) {
		return	UpdateSchemaResponseUnmarshaller.unmarshall(this, context);
	}
