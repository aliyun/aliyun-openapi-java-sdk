 ...
 * @version 
 */
public class UpgradeChaincodeRequest extends RpcAcsRequest<UpgradeChaincodeResponse> {
	
	public UpgradeChaincodeRequest() {
		super("Baas", "2018-07-31", "UpgradeChaincode");
	}
	...
	@Override
	public Class<UpgradeChaincodeResponse> getResponseClass() {
		return UpgradeChaincodeResponse.class;
	}
