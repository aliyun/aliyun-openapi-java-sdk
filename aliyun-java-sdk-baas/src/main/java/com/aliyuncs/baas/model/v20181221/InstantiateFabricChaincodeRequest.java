 ...
 * @version 
 */
public class InstantiateFabricChaincodeRequest extends RpcAcsRequest<InstantiateFabricChaincodeResponse> {
	...
	public InstantiateFabricChaincodeRequest() {
		super("Baas", "2018-12-21", "InstantiateFabricChaincode", "baas");
	...
	@Override
	public Class<InstantiateFabricChaincodeResponse> getResponseClass() {
		return InstantiateFabricChaincodeResponse.class;
	}
