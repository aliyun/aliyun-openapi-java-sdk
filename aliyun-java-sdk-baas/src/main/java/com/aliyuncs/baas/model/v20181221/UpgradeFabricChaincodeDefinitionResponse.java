...
import com.aliyuncs.baas.transform.v20181221.UpgradeFabricChaincodeDefinitionResponseUnmarshaller;
 ...
 * @version 
 */
public class UpgradeFabricChaincodeDefinitionResponse extends AcsResponse {
	...
	@Override
	public UpgradeFabricChaincodeDefinitionResponse getInstance(UnmarshallerContext context) {
		return	UpgradeFabricChaincodeDefinitionResponseUnmarshaller.unmarshall(this, context);
	}
