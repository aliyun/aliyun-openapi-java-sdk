...
import com.aliyuncs.baas.transform.v20180731.GetBlockchainCreateTaskResponseUnmarshaller;
 ...
 * @version 
 */
public class GetBlockchainCreateTaskResponse extends AcsResponse {
	...
	@Override
	public GetBlockchainCreateTaskResponse getInstance(UnmarshallerContext context) {
		return	GetBlockchainCreateTaskResponseUnmarshaller.unmarshall(this, context);
	}
}
