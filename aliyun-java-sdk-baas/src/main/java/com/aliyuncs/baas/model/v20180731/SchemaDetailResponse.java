...
import com.aliyuncs.baas.transform.v20180731.SchemaDetailResponseUnmarshaller;
 ...
 * @version 
 */
public class SchemaDetailResponse extends AcsResponse {
	...
	@Override
	public SchemaDetailResponse getInstance(UnmarshallerContext context) {
		return	SchemaDetailResponseUnmarshaller.unmarshall(this, context);
	}
