...
import com.aliyuncs.baas.transform.v20180731.DescribeConsortiumMemberApprovalResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeConsortiumMemberApprovalResponse extends AcsResponse {
	...
	@Override
	public DescribeConsortiumMemberApprovalResponse getInstance(UnmarshallerContext context) {
		return	DescribeConsortiumMemberApprovalResponseUnmarshaller.unmarshall(this, context);
	}
