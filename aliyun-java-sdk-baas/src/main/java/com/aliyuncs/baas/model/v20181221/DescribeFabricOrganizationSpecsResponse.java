...
import com.aliyuncs.baas.transform.v20181221.DescribeFabricOrganizationSpecsResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeFabricOrganizationSpecsResponse extends AcsResponse {
	...
	@Override
	public DescribeFabricOrganizationSpecsResponse getInstance(UnmarshallerContext context) {
		return	DescribeFabricOrganizationSpecsResponseUnmarshaller.unmarshall(this, context);
	}
