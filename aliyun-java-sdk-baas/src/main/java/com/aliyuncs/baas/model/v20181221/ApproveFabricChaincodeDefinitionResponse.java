...
import com.aliyuncs.baas.transform.v20181221.ApproveFabricChaincodeDefinitionResponseUnmarshaller;
 ...
 * @version 
 */
public class ApproveFabricChaincodeDefinitionResponse extends AcsResponse {
	...
	@Override
	public ApproveFabricChaincodeDefinitionResponse getInstance(UnmarshallerContext context) {
		return	ApproveFabricChaincodeDefinitionResponseUnmarshaller.unmarshall(this, context);
	}
