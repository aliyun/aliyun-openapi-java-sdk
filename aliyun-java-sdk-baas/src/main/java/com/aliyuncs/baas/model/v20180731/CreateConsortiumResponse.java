...
import com.aliyuncs.baas.transform.v20180731.CreateConsortiumResponseUnmarshaller;
 ...
 * @version 
 */
public class CreateConsortiumResponse extends AcsResponse {
	...
	@Override
	public CreateConsortiumResponse getInstance(UnmarshallerContext context) {
		return	CreateConsortiumResponseUnmarshaller.unmarshall(this, context);
	}
