...
import com.aliyuncs.baas.transform.v20181221.CreateFabricChaincodePackageResponseUnmarshaller;
 ...
 * @version 
 */
public class CreateFabricChaincodePackageResponse extends AcsResponse {
	...
	@Override
	public CreateFabricChaincodePackageResponse getInstance(UnmarshallerContext context) {
		return	CreateFabricChaincodePackageResponseUnmarshaller.unmarshall(this, context);
	}
