...
import com.aliyuncs.baas.transform.v20180731.DescribeConsortiumChannelsResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeConsortiumChannelsResponse extends AcsResponse {
	...
	@Override
	public DescribeConsortiumChannelsResponse getInstance(UnmarshallerContext context) {
		return	DescribeConsortiumChannelsResponseUnmarshaller.unmarshall(this, context);
	}
