...
import com.aliyuncs.baas.transform.v20180731.DescribeOrganizationSpecsResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeOrganizationSpecsResponse extends AcsResponse {
	...
	@Override
	public DescribeOrganizationSpecsResponse getInstance(UnmarshallerContext context) {
		return	DescribeOrganizationSpecsResponseUnmarshaller.unmarshall(this, context);
	}
