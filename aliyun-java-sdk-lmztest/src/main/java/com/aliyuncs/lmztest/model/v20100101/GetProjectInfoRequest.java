 ...
 * @version 
 */
public class GetProjectInfoRequest extends RoaAcsRequest<GetProjectInfoResponse> {
	...
	public GetProjectInfoRequest() {
		super("LmzTest", "2010-01-01", "GetProjectInfo");
		setUriPattern("/organization/[organizationId]/project/[projectId]");
