...
import com.aliyuncs.brinekingdom.transform.v20190627.ReceiveResponseUnmarshaller;
 ...
 * @version 
 */
public class ReceiveResponse extends AcsResponse {
	...
	@Override
	public ReceiveResponse getInstance(UnmarshallerContext context) {
		return	ReceiveResponseUnmarshaller.unmarshall(this, context);
	}
