 ...
 * @version 
 */
public class ReceiveRequest extends RpcAcsRequest<ReceiveResponse> {
	   

	@SerializedName("demandRequestList")
	private List<DemandRequestList> demandRequestList;
	public ReceiveRequest() {
		super("brinekingdom", "2019-06-27", "Receive");
	...
	public static class DemandRequestList {
		...
		@SerializedName("RackPlanStrategyDTO")
		private RackPlanStrategyDTO rackPlanStrategyDTO;
		...
		@SerializedName("CloudIsolationUnit")
		private String cloudIsolationUnit;
		...
		public RackPlanStrategyDTO getRackPlanStrategyDTO() {
			return this.rackPlanStrategyDTO;
		}

		public void setRackPlanStrategyDTO(RackPlanStrategyDTO rackPlanStrategyDTO) {
			this.rackPlanStrategyDTO = rackPlanStrategyDTO;
		}
		...
		public String getCloudIsolationUnit() {
			return this.cloudIsolationUnit;
		}

		public void setCloudIsolationUnit(String cloudIsolationUnit) {
			this.cloudIsolationUnit = cloudIsolationUnit;
		}
		...
		public static class RackPlanStrategyDTO {

			@SerializedName("cluster")
			private String cluster;

			@SerializedName("NetworkLocationDTO")
			private NetworkLocationDTO networkLocationDTO;

			@SerializedName("mixLogicZone")
			private String mixLogicZone;

			@SerializedName("PhysicsLocationDTO")
			private PhysicsLocationDTO physicsLocationDTO;

			@SerializedName("scatterNo")
			private Integer scatterNo;
			...
			public NetworkLocationDTO getNetworkLocationDTO() {
				return this.networkLocationDTO;
			}

			public void setNetworkLocationDTO(NetworkLocationDTO networkLocationDTO) {
				this.networkLocationDTO = networkLocationDTO;
			}

			public String getMixLogicZone() {
				return this.mixLogicZone;
			}

			public void setMixLogicZone(String mixLogicZone) {
				this.mixLogicZone = mixLogicZone;
			}

			public PhysicsLocationDTO getPhysicsLocationDTO() {
				return this.physicsLocationDTO;
			}

			public void setPhysicsLocationDTO(PhysicsLocationDTO physicsLocationDTO) {
				this.physicsLocationDTO = physicsLocationDTO;
			}

			public Integer getScatterNo() {
				return this.scatterNo;
			}

			public void setScatterNo(Integer scatterNo) {
				this.scatterNo = scatterNo;
			}

			public static class NetworkLocationDTO {

				@SerializedName("pod")
				private String pod;

				@SerializedName("aswList")
				private List<String> aswList;

				@SerializedName("netCluster")
				private String netCluster;
				...
				public List<String> getAswList() {
					return this.aswList;
				}

				public void setAswList(List<String> aswList) {
					this.aswList = aswList;
				}

				public String getNetCluster() {
					return this.netCluster;
				}

				public void setNetCluster(String netCluster) {
					this.netCluster = netCluster;
				}
			}

			public static class PhysicsLocationDTO {

				@SerializedName("roomName")
				private String roomName;

				@SerializedName("rackNameList")
				private List<String> rackNameList;
				...
				public void setRackNameList(List<String> rackNameList) {
	...
	@Override
	public Class<ReceiveResponse> getResponseClass() {
