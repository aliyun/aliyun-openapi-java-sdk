 ...
 * @version 
 */
public class GetShareCustomerListRequest extends RpcAcsRequest<GetShareCustomerListResponse> {
	...
	public GetShareCustomerListRequest() {
		super("Agency", "2018-07-03", "GetShareCustomerList", "openApi");
	...
	public void setExitOnGoingProject(String exitOnGoingProject) {
		...
		if(exitOnGoingProject != null){
			putQueryParameter("ExitOnGoingProject", exitOnGoingProject);
		}
	}
	...
	@Override
	public Class<GetShareCustomerListResponse> getResponseClass() {
		return GetShareCustomerListResponse.class;
	}
