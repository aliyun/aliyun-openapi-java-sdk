 ...
 * @version 
 */
public class SetCreditLimitRequest extends RpcAcsRequest<SetCreditLimitResponse> {
	...
	public SetCreditLimitRequest() {
		super("Agency", "2018-07-03", "SetCreditLimit", "openApi");
	...
	@Override
	public Class<SetCreditLimitResponse> getResponseClass() {
		return SetCreditLimitResponse.class;
	}
