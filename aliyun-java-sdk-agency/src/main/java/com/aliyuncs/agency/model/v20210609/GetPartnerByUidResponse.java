...
import com.aliyuncs.agency.transform.v20210609.GetPartnerByUidResponseUnmarshaller;
 ...
 * @version 
 */
public class GetPartnerByUidResponse extends AcsResponse {
	...
	@Override
	public GetPartnerByUidResponse getInstance(UnmarshallerContext context) {
		return	GetPartnerByUidResponseUnmarshaller.unmarshall(this, context);
	}
