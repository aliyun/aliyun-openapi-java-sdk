 ...
 * @version 
 */
public class SetZeroCreditShutdownPolicyRequest extends RpcAcsRequest<SetZeroCreditShutdownPolicyResponse> {
	   

	private Long uid;

	private String shutdownPolicy;
	public SetZeroCreditShutdownPolicyRequest() {
		super("Agency", "2018-07-01", "SetZeroCreditShutdownPolicy", "openApi");
	...
	@Override
	public Class<SetZeroCreditShutdownPolicyResponse> getResponseClass() {
		return SetZeroCreditShutdownPolicyResponse.class;
	}
