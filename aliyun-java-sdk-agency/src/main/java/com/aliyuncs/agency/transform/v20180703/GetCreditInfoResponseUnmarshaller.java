...
import com.aliyuncs.agency.model.v20180703.GetCreditInfoResponse;
import com.aliyuncs.agency.model.v20180703.GetCreditInfoResponse.Data;
...
public class GetCreditInfoResponseUnmarshaller {
	...
	public static GetCreditInfoResponse unmarshall(GetCreditInfoResponse getCreditInfoResponse, UnmarshallerContext _ctx) {
		...
		data.setNewBuyStatus(_ctx.stringValue("GetCreditInfoResponse.Data.newBuyStatus"));
