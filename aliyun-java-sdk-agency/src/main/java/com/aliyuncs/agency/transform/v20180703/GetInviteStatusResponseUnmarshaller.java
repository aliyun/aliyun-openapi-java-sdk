...
import com.aliyuncs.agency.model.v20180703.GetInviteStatusResponse;
import com.aliyuncs.agency.model.v20180703.GetInviteStatusResponse.InviteStatus;
import com.aliyuncs.agency.model.v20180703.GetInviteStatusResponse.InviteStatus.InviteStatusList;
...
public class GetInviteStatusResponseUnmarshaller {
	...
	public static GetInviteStatusResponse unmarshall(GetInviteStatusResponse getInviteStatusResponse, UnmarshallerContext _ctx) {
		...
		for (int i = 0; i < _ctx.lengthValue("GetInviteStatusResponse.Data.Length"); i++) {
			...
			inviteStatusList.setCid(_ctx.longValue("GetInviteStatusResponse.Data["+ i +"].InviteStatusList.Cid"));
			inviteStatusList.setUid(_ctx.longValue("GetInviteStatusResponse.Data["+ i +"].InviteStatusList.Uid"));
