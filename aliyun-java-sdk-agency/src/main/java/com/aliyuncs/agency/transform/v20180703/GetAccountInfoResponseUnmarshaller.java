...
import com.aliyuncs.agency.model.v20180703.GetAccountInfoResponse;
import com.aliyuncs.agency.model.v20180703.GetAccountInfoResponse.AccountInfo;
import com.aliyuncs.agency.model.v20180703.GetAccountInfoResponse.PageInfo;
...
public class GetAccountInfoResponseUnmarshaller {
	...
	public static GetAccountInfoResponse unmarshall(GetAccountInfoResponse getAccountInfoResponse, UnmarshallerContext _ctx) {
		...
		for (int i = 0; i < _ctx.lengthValue("GetAccountInfoResponse.AccountInfoList.Length"); i++) {
			...
			accountInfo.setCid(_ctx.longValue("GetAccountInfoResponse.AccountInfoList["+ i +"].Cid"));
