...
import com.aliyuncs.openitag.model.v20220616.DeleteTaskResponse;
...
public class DeleteTaskResponseUnmarshaller {
	...
	public static DeleteTaskResponse unmarshall(DeleteTaskResponse deleteTaskResponse, UnmarshallerContext _ctx) {
		...
		deleteTaskResponse.setCode(_ctx.integerValue("DeleteTaskResponse.Code"));
		deleteTaskResponse.setMessage(_ctx.stringValue("DeleteTaskResponse.Message"));
		deleteTaskResponse.setDetails(_ctx.stringValue("DeleteTaskResponse.Details"));
