 ...
 * @version 
 */
public class UpdateTaskRequest extends RoaAcsRequest<UpdateTaskResponse> {
	...
	public UpdateTaskRequest() {
		super("OpenITag", "2022-06-16", "UpdateTask");
		setUriPattern("/openapi/api/v1/tenants/[TenantId]/tasks/[TaskId]");
