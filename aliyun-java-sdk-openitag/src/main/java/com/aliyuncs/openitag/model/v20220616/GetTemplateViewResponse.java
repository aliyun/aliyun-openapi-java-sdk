...
import com.aliyuncs.openitag.transform.v20220616.GetTemplateViewResponseUnmarshaller;
 ...
 * @version 
 */
public class GetTemplateViewResponse extends AcsResponse {
	...
	@Override
	public GetTemplateViewResponse getInstance(UnmarshallerContext context) {
		return	GetTemplateViewResponseUnmarshaller.unmarshall(this, context);
	}
