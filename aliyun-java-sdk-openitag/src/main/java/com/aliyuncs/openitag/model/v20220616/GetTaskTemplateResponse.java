...
import com.aliyuncs.openitag.transform.v20220616.GetTaskTemplateResponseUnmarshaller;
 ...
 * @version 
 */
public class GetTaskTemplateResponse extends AcsResponse {
	...
	@Override
	public GetTaskTemplateResponse getInstance(UnmarshallerContext context) {
		return	GetTaskTemplateResponseUnmarshaller.unmarshall(this, context);
	}
