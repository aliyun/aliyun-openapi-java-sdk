...
import com.aliyuncs.openitag.transform.v20220616.GetTaskTemplateQuestionsResponseUnmarshaller;
 ...
 * @version 
 */
public class GetTaskTemplateQuestionsResponse extends AcsResponse {
	...
	@Override
	public GetTaskTemplateQuestionsResponse getInstance(UnmarshallerContext context) {
		return	GetTaskTemplateQuestionsResponseUnmarshaller.unmarshall(this, context);
	}
