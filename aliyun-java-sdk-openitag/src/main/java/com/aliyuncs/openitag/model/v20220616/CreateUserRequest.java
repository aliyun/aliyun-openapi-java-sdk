 ...
 * @version 
 */
public class CreateUserRequest extends RoaAcsRequest<CreateUserResponse> {
	...
	public CreateUserRequest() {
		super("OpenITag", "2022-06-16", "CreateUser");
		setUriPattern("/openapi/api/v1/tenants/[TenantId]/users");
