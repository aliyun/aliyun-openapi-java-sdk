 ...
 * @version 
 */
public class GetTaskStatusRequest extends RoaAcsRequest<GetTaskStatusResponse> {
	...
	public GetTaskStatusRequest() {
		super("OpenITag", "2022-06-16", "GetTaskStatus");
		setUriPattern("/openapi/api/v1/tenants/[TenantId]/tasks/[TaskId]/status");
