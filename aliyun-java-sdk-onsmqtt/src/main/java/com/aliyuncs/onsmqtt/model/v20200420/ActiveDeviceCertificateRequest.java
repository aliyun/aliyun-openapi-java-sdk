 ...
 * @version 
 */
public class ActiveDeviceCertificateRequest extends RpcAcsRequest<ActiveDeviceCertificateResponse> {
	...
	@Override
	public Class<ActiveDeviceCertificateResponse> getResponseClass() {
		return ActiveDeviceCertificateResponse.class;
	}
