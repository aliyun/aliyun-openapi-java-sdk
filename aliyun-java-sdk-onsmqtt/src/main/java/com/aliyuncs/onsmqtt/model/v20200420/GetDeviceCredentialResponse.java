...
import com.aliyuncs.onsmqtt.transform.v20200420.GetDeviceCredentialResponseUnmarshaller;
 ...
 * @version 
 */
public class GetDeviceCredentialResponse extends AcsResponse {
	...
	@Override
	public GetDeviceCredentialResponse getInstance(UnmarshallerContext context) {
		return	GetDeviceCredentialResponseUnmarshaller.unmarshall(this, context);
	}
