 ...
 * @version 
 */
public class AddCustomAuthIdentityRequest extends RpcAcsRequest<AddCustomAuthIdentityResponse> {
	...
	public AddCustomAuthIdentityRequest() {
		super("OnsMqtt", "2020-04-20", "AddCustomAuthIdentity", "onsmqtt");
	...
	@Override
	public Class<AddCustomAuthIdentityResponse> getResponseClass() {
		return AddCustomAuthIdentityResponse.class;
	}
