 ...
 * @version 
 */
public class QueryMqttTraceDeviceRequest extends RpcAcsRequest<QueryMqttTraceDeviceResponse> {
	...
	@Override
	public Class<QueryMqttTraceDeviceResponse> getResponseClass() {
		return QueryMqttTraceDeviceResponse.class;
	}
