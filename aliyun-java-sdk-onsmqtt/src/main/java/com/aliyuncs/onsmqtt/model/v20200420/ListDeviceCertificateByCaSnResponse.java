...
import com.aliyuncs.onsmqtt.transform.v20200420.ListDeviceCertificateByCaSnResponseUnmarshaller;
 ...
 * @version 
 */
public class ListDeviceCertificateByCaSnResponse extends AcsResponse {
	...
	@Override
	public ListDeviceCertificateByCaSnResponse getInstance(UnmarshallerContext context) {
		return	ListDeviceCertificateByCaSnResponseUnmarshaller.unmarshall(this, context);
	}
