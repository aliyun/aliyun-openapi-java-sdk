 ...
 * @version 
 */
public class GetDeviceCertificateRequest extends RpcAcsRequest<GetDeviceCertificateResponse> {
	...
	@Override
	public Class<GetDeviceCertificateResponse> getResponseClass() {
		return GetDeviceCertificateResponse.class;
	}
