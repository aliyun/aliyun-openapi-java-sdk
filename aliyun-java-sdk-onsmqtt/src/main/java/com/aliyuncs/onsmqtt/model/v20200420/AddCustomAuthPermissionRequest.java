 ...
 * @version 
 */
public class AddCustomAuthPermissionRequest extends RpcAcsRequest<AddCustomAuthPermissionResponse> {
	...
	public AddCustomAuthPermissionRequest() {
		super("OnsMqtt", "2020-04-20", "AddCustomAuthPermission", "onsmqtt");
	...
	@Override
	public Class<AddCustomAuthPermissionResponse> getResponseClass() {
		return AddCustomAuthPermissionResponse.class;
	}
