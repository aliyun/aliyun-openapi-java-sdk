 ...
 * @version 
 */
public class DeleteCaCertificateRequest extends RpcAcsRequest<DeleteCaCertificateResponse> {
	...
	public DeleteCaCertificateRequest() {
		super("OnsMqtt", "2020-04-20", "DeleteCaCertificate", "onsmqtt");
	...
	@Override
	public Class<DeleteCaCertificateResponse> getResponseClass() {
		return DeleteCaCertificateResponse.class;
	}
