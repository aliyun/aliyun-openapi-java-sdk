 ...
 * @version 
 */
public class GetRegisterCodeRequest extends RpcAcsRequest<GetRegisterCodeResponse> {
	...
	@Override
	public Class<GetRegisterCodeResponse> getResponseClass() {
		return GetRegisterCodeResponse.class;
	}
