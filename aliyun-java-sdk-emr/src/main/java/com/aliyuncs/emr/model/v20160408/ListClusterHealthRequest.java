 ...
 * @version 
 */
public class ListClusterHealthRequest extends RpcAcsRequest<ListClusterHealthResponse> {
	
	public ListClusterHealthRequest() {
		super("Emr", "2016-04-08", "ListClusterHealth");
	}
	...
	@Override
	public Class<ListClusterHealthResponse> getResponseClass() {
		return ListClusterHealthResponse.class;
	}
