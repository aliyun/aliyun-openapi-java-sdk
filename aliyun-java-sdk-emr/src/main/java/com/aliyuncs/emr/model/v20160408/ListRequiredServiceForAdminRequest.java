 ...
 * @version 
 */
public class ListRequiredServiceForAdminRequest extends RpcAcsRequest<ListRequiredServiceForAdminResponse> {
	
	public ListRequiredServiceForAdminRequest() {
		super("Emr", "2016-04-08", "ListRequiredServiceForAdmin");
	}
	...
	@Override
	public Class<ListRequiredServiceForAdminResponse> getResponseClass() {
		return ListRequiredServiceForAdminResponse.class;
	}
