...
import com.aliyuncs.emr.transform.v20160408.ListClustersForAdminResponseUnmarshaller;
 ...
 * @version 
 */
public class ListClustersForAdminResponse extends AcsResponse {
	...
	@Override
	public ListClustersForAdminResponse getInstance(UnmarshallerContext context) {
		return	ListClustersForAdminResponseUnmarshaller.unmarshall(this, context);
	}
}
