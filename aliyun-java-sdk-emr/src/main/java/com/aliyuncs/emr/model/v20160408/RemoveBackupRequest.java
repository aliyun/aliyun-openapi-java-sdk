 ...
 * @version 
 */
public class RemoveBackupRequest extends RpcAcsRequest<RemoveBackupResponse> {
	
	public RemoveBackupRequest() {
		super("Emr", "2016-04-08", "RemoveBackup", "emr");
		try {
	...
	@Override
	public Class<RemoveBackupResponse> getResponseClass() {
		return RemoveBackupResponse.class;
	}
