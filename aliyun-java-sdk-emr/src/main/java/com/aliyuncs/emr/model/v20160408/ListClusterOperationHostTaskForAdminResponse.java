...
import com.aliyuncs.emr.transform.v20160408.ListClusterOperationHostTaskForAdminResponseUnmarshaller;
 ...
 * @version 
 */
public class ListClusterOperationHostTaskForAdminResponse extends AcsResponse {
	...
	@Override
	public ListClusterOperationHostTaskForAdminResponse getInstance(UnmarshallerContext context) {
		return	ListClusterOperationHostTaskForAdminResponseUnmarshaller.unmarshall(this, context);
	}
}
