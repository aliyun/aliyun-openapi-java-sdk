...
import com.aliyuncs.emr.transform.v20160408.DescribeClusterResourcePoolSchedulerTypeForAdminResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeClusterResourcePoolSchedulerTypeForAdminResponse extends AcsResponse {
	...
	@Override
	public DescribeClusterResourcePoolSchedulerTypeForAdminResponse getInstance(UnmarshallerContext context) {
		return	DescribeClusterResourcePoolSchedulerTypeForAdminResponseUnmarshaller.unmarshall(this, context);
	}
}
