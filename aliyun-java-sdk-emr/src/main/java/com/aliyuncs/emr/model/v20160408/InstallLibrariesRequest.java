 ...
 * @version 
 */
public class InstallLibrariesRequest extends RpcAcsRequest<InstallLibrariesResponse> {
	...
	@Override
	public Class<InstallLibrariesResponse> getResponseClass() {
		return InstallLibrariesResponse.class;
	}
