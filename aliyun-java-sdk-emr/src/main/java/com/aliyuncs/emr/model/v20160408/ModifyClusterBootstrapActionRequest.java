 ...
 * @version 
 */
public class ModifyClusterBootstrapActionRequest extends RpcAcsRequest<ModifyClusterBootstrapActionResponse> {
	...
	public ModifyClusterBootstrapActionRequest() {
		super("Emr", "2016-04-08", "ModifyClusterBootstrapAction", "emr");
	...
	@Override
	public Class<ModifyClusterBootstrapActionResponse> getResponseClass() {
		return ModifyClusterBootstrapActionResponse.class;
	}
