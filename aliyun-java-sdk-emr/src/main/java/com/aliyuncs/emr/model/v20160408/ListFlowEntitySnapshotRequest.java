 ...
 * @version 
 */
public class ListFlowEntitySnapshotRequest extends RpcAcsRequest<ListFlowEntitySnapshotResponse> {
	...
	public ListFlowEntitySnapshotRequest() {
		super("Emr", "2016-04-08", "ListFlowEntitySnapshot");
	...
	@Override
	public Class<ListFlowEntitySnapshotResponse> getResponseClass() {
		return ListFlowEntitySnapshotResponse.class;
	}
