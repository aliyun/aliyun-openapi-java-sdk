...
public class ListJobExecutionPlanHierarchyRequest extends RpcAcsRequest<ListJobExecutionPlanHierarchyResponse> {
	...
	public void setCurrentId(Long currentId) {
		...
		if(currentId != null){
			putQueryParameter("CurrentId", currentId.toString());
		}
	}
	...
	@Override
	public Class<ListJobExecutionPlanHierarchyResponse> getResponseClass() {
		return ListJobExecutionPlanHierarchyResponse.class;
	}
