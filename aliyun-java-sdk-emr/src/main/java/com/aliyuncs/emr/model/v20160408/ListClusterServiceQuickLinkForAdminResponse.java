...
import com.aliyuncs.emr.transform.v20160408.ListClusterServiceQuickLinkForAdminResponseUnmarshaller;
 ...
 * @version 
 */
public class ListClusterServiceQuickLinkForAdminResponse extends AcsResponse {
	...
	@Override
	public ListClusterServiceQuickLinkForAdminResponse getInstance(UnmarshallerContext context) {
		return	ListClusterServiceQuickLinkForAdminResponseUnmarshaller.unmarshall(this, context);
	}
}
