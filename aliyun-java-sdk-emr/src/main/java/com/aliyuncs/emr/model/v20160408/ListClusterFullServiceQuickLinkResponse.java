...
import com.aliyuncs.emr.transform.v20160408.ListClusterFullServiceQuickLinkResponseUnmarshaller;
 ...
 * @version 
 */
public class ListClusterFullServiceQuickLinkResponse extends AcsResponse {
	...
	@Override
	public ListClusterFullServiceQuickLinkResponse getInstance(UnmarshallerContext context) {
		return	ListClusterFullServiceQuickLinkResponseUnmarshaller.unmarshall(this, context);
	}
}
