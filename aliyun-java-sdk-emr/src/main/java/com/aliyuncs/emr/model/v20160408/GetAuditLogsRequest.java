 ...
 * @version 
 */
public class GetAuditLogsRequest extends RpcAcsRequest<GetAuditLogsResponse> {
	
	public GetAuditLogsRequest() {
		super("Emr", "2016-04-08", "GetAuditLogs", "emr");
		try {
	...
	@Override
	public Class<GetAuditLogsResponse> getResponseClass() {
		return GetAuditLogsResponse.class;
	}
