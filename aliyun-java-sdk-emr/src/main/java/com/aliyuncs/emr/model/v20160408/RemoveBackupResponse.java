...
import com.aliyuncs.emr.transform.v20160408.RemoveBackupResponseUnmarshaller;
 ...
 * @version 
 */
public class RemoveBackupResponse extends AcsResponse {
	...
	@Override
	public RemoveBackupResponse getInstance(UnmarshallerContext context) {
		return	RemoveBackupResponseUnmarshaller.unmarshall(this, context);
	}
}
