 ...
 * @version 
 */
public class ModifyScalingConfigItemV2Request extends RpcAcsRequest<ModifyScalingConfigItemV2Response> {
	...
	public ModifyScalingConfigItemV2Request() {
		super("Emr", "2016-04-08", "ModifyScalingConfigItemV2", "emr");
	...
	public void setConfigItemBizId(String configItemBizId) {
		this.configItemBizId = configItemBizId;
		if(configItemBizId != null){
			putQueryParameter("ConfigItemBizId", configItemBizId);
		}
	}
	...
	@Override
	public Class<ModifyScalingConfigItemV2Response> getResponseClass() {
		return ModifyScalingConfigItemV2Response.class;
	}
