...
import com.aliyuncs.emr.transform.v20160408.PlanHostNameResponseUnmarshaller;
 ...
 * @version 
 */
public class PlanHostNameResponse extends AcsResponse {
	...
	@Override
	public PlanHostNameResponse getInstance(UnmarshallerContext context) {
		return	PlanHostNameResponseUnmarshaller.unmarshall(this, context);
	}
}
