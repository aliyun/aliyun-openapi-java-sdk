 ...
 * @version 
 */
public class DescribeScalingGroupInstanceV2Request extends RpcAcsRequest<DescribeScalingGroupInstanceV2Response> {
	...
	public DescribeScalingGroupInstanceV2Request() {
		super("Emr", "2016-04-08", "DescribeScalingGroupInstanceV2", "emr");
	...
	public void setHostGroupBizId(String hostGroupBizId) {
		...
		if(hostGroupBizId != null){
			putQueryParameter("HostGroupBizId", hostGroupBizId);
		}
	}

	@Override
	public Class<DescribeScalingGroupInstanceV2Response> getResponseClass() {
		return DescribeScalingGroupInstanceV2Response.class;
	}
