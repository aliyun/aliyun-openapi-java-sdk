...
import com.aliyuncs.emr.transform.v20160408.ListUserStatisticsResponseUnmarshaller;
 ...
 * @version 
 */
public class ListUserStatisticsResponse extends AcsResponse {
	...
	@Override
	public ListUserStatisticsResponse getInstance(UnmarshallerContext context) {
		return	ListUserStatisticsResponseUnmarshaller.unmarshall(this, context);
	}
