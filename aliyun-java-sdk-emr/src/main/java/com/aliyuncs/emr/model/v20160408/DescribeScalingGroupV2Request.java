 ...
 * @version 
 */
public class DescribeScalingGroupV2Request extends RpcAcsRequest<DescribeScalingGroupV2Response> {
	...
	@Override
	public Class<DescribeScalingGroupV2Response> getResponseClass() {
		return DescribeScalingGroupV2Response.class;
	}
