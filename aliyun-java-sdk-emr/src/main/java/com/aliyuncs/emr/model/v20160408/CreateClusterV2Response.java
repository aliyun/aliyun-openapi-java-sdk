...
import com.aliyuncs.emr.transform.v20160408.CreateClusterV2ResponseUnmarshaller;
 ...
 * @version 
 */
public class CreateClusterV2Response extends AcsResponse {
	...
	@Override
	public CreateClusterV2Response getInstance(UnmarshallerContext context) {
		return	CreateClusterV2ResponseUnmarshaller.unmarshall(this, context);
	}
}
