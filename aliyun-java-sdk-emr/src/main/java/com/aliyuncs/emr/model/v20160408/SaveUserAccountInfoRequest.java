 ...
 * @version 
 */
public class SaveUserAccountInfoRequest extends RpcAcsRequest<SaveUserAccountInfoResponse> {
	
	public SaveUserAccountInfoRequest() {
		super("Emr", "2016-04-08", "SaveUserAccountInfo", "emr");
		try {
	...
	@Override
	public Class<SaveUserAccountInfoResponse> getResponseClass() {
		return SaveUserAccountInfoResponse.class;
	}
