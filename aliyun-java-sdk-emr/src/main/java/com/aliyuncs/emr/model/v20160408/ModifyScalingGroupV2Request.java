 ...
 * @version 
 */
public class ModifyScalingGroupV2Request extends RpcAcsRequest<ModifyScalingGroupV2Response> {
	...
	private String name;
	public ModifyScalingGroupV2Request() {
		super("Emr", "2016-04-08", "ModifyScalingGroupV2", "emr");
	...
	@Override
	public Class<ModifyScalingGroupV2Response> getResponseClass() {
		return ModifyScalingGroupV2Response.class;
	}
