...
import com.aliyuncs.emr.transform.v20160408.ListOpsOperationTask1ResponseUnmarshaller;
 ...
 * @version 
 */
public class ListOpsOperationTask1Response extends AcsResponse {
	...
	@Override
	public ListOpsOperationTask1Response getInstance(UnmarshallerContext context) {
		return	ListOpsOperationTask1ResponseUnmarshaller.unmarshall(this, context);
	}
}
