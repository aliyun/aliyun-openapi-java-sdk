 ...
 * @version 
 */
public class ListLibraryInstallTasksRequest extends RpcAcsRequest<ListLibraryInstallTasksResponse> {
	...
	@Override
	public Class<ListLibraryInstallTasksResponse> getResponseClass() {
		return ListLibraryInstallTasksResponse.class;
	}
