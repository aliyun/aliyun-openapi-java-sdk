 ...
 * @version 
 */
public class DescribeScalingConfigItemV2Request extends RpcAcsRequest<DescribeScalingConfigItemV2Response> {
	...
	public DescribeScalingConfigItemV2Request() {
		super("Emr", "2016-04-08", "DescribeScalingConfigItemV2", "emr");
	...
	public void setScalingConfigItemId(String scalingConfigItemId) {
		this.scalingConfigItemId = scalingConfigItemId;
		if(scalingConfigItemId != null){
			putQueryParameter("ScalingConfigItemId", scalingConfigItemId);
		}
	}

	@Override
	public Class<DescribeScalingConfigItemV2Response> getResponseClass() {
		return DescribeScalingConfigItemV2Response.class;
	}
