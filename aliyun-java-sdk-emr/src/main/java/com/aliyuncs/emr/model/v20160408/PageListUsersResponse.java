...
import com.aliyuncs.emr.transform.v20160408.PageListUsersResponseUnmarshaller;
 ...
 * @version 
 */
public class PageListUsersResponse extends AcsResponse {
	...
	@Override
	public PageListUsersResponse getInstance(UnmarshallerContext context) {
		return	PageListUsersResponseUnmarshaller.unmarshall(this, context);
	}
}
