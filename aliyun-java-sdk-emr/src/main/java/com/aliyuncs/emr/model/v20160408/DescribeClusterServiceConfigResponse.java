...
import com.aliyuncs.emr.transform.v20160408.DescribeClusterServiceConfigResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeClusterServiceConfigResponse extends AcsResponse {
	...
	@Override
	public DescribeClusterServiceConfigResponse getInstance(UnmarshallerContext context) {
		return	DescribeClusterServiceConfigResponseUnmarshaller.unmarshall(this, context);
	}
}
