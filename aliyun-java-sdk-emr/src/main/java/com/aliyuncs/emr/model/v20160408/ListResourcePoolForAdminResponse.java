...
import com.aliyuncs.emr.transform.v20160408.ListResourcePoolForAdminResponseUnmarshaller;
 ...
 * @version 
 */
public class ListResourcePoolForAdminResponse extends AcsResponse {
	...
	@Override
	public ListResourcePoolForAdminResponse getInstance(UnmarshallerContext context) {
		return	ListResourcePoolForAdminResponseUnmarshaller.unmarshall(this, context);
	}
}
