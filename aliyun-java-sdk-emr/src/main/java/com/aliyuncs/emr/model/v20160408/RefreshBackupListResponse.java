...
import com.aliyuncs.emr.transform.v20160408.RefreshBackupListResponseUnmarshaller;
 ...
 * @version 
 */
public class RefreshBackupListResponse extends AcsResponse {
	...
	@Override
	public RefreshBackupListResponse getInstance(UnmarshallerContext context) {
		return	RefreshBackupListResponseUnmarshaller.unmarshall(this, context);
	}
}
