 ...
 * @version 
 */
public class DetachAndReleaseClusterEniRequest extends RpcAcsRequest<DetachAndReleaseClusterEniResponse> {
	...
	@Override
	public Class<DetachAndReleaseClusterEniResponse> getResponseClass() {
		return DetachAndReleaseClusterEniResponse.class;
	}
