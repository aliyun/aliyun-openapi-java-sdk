 ...
 * @version 
 */
public class QuerySlsMetricDataRequest extends RpcAcsRequest<QuerySlsMetricDataResponse> {
	
	public QuerySlsMetricDataRequest() {
		super("Emr", "2016-04-08", "QuerySlsMetricData", "emr");
	}
	...
	@Override
	public Class<QuerySlsMetricDataResponse> getResponseClass() {
		return QuerySlsMetricDataResponse.class;
	}
