...
import com.aliyuncs.emr.transform.v20160408.DescribeHpHostResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeHpHostResponse extends AcsResponse {
	...
	@Override
	public DescribeHpHostResponse getInstance(UnmarshallerContext context) {
		return	DescribeHpHostResponseUnmarshaller.unmarshall(this, context);
	}
}
