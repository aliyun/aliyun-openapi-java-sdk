 ...
 * @version 
 */
public class ListClustersForAdminRequest extends RpcAcsRequest<ListClustersForAdminResponse> {
	
	public ListClustersForAdminRequest() {
		super("Emr", "2016-04-08", "ListClustersForAdmin");
	}
	...
	@Override
	public Class<ListClustersForAdminResponse> getResponseClass() {
		return ListClustersForAdminResponse.class;
	}
