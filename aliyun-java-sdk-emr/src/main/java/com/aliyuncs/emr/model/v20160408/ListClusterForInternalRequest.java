 ...
 * @version 
 */
public class ListClusterForInternalRequest extends RpcAcsRequest<ListClusterForInternalResponse> {
	
	public ListClusterForInternalRequest() {
		super("Emr", "2016-04-08", "ListClusterForInternal");
	}
	...
	@Override
	public Class<ListClusterForInternalResponse> getResponseClass() {
		return ListClusterForInternalResponse.class;
	}
