...
import com.aliyuncs.emr.transform.v20160408.DescribeClusterServiceForAdminResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeClusterServiceForAdminResponse extends AcsResponse {
	...
	@Override
	public DescribeClusterServiceForAdminResponse getInstance(UnmarshallerContext context) {
		return	DescribeClusterServiceForAdminResponseUnmarshaller.unmarshall(this, context);
	}
}
