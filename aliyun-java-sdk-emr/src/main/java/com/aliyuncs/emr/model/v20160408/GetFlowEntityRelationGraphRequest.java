 ...
 * @version 
 */
public class GetFlowEntityRelationGraphRequest extends RpcAcsRequest<GetFlowEntityRelationGraphResponse> {
	...
	public GetFlowEntityRelationGraphRequest() {
		super("Emr", "2016-04-08", "GetFlowEntityRelationGraph");
	...
	public void setRelationship(String relationship) {
		...
		if(relationship != null){
			putQueryParameter("Relationship", relationship);
		}
	}
	...
	@Override
	public Class<GetFlowEntityRelationGraphResponse> getResponseClass() {
		return GetFlowEntityRelationGraphResponse.class;
	}
