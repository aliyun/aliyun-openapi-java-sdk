...
import com.aliyuncs.emr.transform.v20160408.RenewClusterForAdminResponseUnmarshaller;
 ...
 * @version 
 */
public class RenewClusterForAdminResponse extends AcsResponse {
	...
	@Override
	public RenewClusterForAdminResponse getInstance(UnmarshallerContext context) {
		return	RenewClusterForAdminResponseUnmarshaller.unmarshall(this, context);
	}
}
