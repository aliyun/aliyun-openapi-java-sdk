 ...
 * @version 
 */
public class CheckUserRoleRequest extends RpcAcsRequest<CheckUserRoleResponse> {
	
	public CheckUserRoleRequest() {
		super("Emr", "2016-04-08", "CheckUserRole");
	}
	...
	@Override
	public Class<CheckUserRoleResponse> getResponseClass() {
		return CheckUserRoleResponse.class;
	}
