...
import com.aliyuncs.emr.transform.v20160408.DescribeClusterServiceConfigForAdminResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeClusterServiceConfigForAdminResponse extends AcsResponse {
	...
	@Override
	public DescribeClusterServiceConfigForAdminResponse getInstance(UnmarshallerContext context) {
		return	DescribeClusterServiceConfigForAdminResponseUnmarshaller.unmarshall(this, context);
	}
}
