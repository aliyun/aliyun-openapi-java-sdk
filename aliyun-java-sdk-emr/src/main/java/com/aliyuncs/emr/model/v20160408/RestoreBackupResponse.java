...
import com.aliyuncs.emr.transform.v20160408.RestoreBackupResponseUnmarshaller;
 ...
 * @version 
 */
public class RestoreBackupResponse extends AcsResponse {
	...
	@Override
	public RestoreBackupResponse getInstance(UnmarshallerContext context) {
		return	RestoreBackupResponseUnmarshaller.unmarshall(this, context);
	}
}
