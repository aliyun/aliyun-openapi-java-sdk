...
import com.aliyuncs.emr.transform.v20160408.ListClusterServiceResponseUnmarshaller;
 ...
 * @version 
 */
public class ListClusterServiceResponse extends AcsResponse {
	...
	@Override
	public ListClusterServiceResponse getInstance(UnmarshallerContext context) {
		return	ListClusterServiceResponseUnmarshaller.unmarshall(this, context);
	}
}
