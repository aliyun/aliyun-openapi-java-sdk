...
import com.aliyuncs.emr.transform.v20160408.DescribeClusterForAdminResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeClusterForAdminResponse extends AcsResponse {
	...
	public static class ClusterInfo {
		...
		public static class EcsOrderInfo {
			...
			public List<Node2> getNodes1() {
				return this.nodes1;
			}

			public void setNodes1(List<Node2> nodes1) {
				this.nodes1 = nodes1;
			}
			...
			public static class Node2 {
				...
				private List<DaemonInfo5> daemonInfos3;

				private List<DiskInfo6> diskInfos4;
				...
				public List<DaemonInfo5> getDaemonInfos3() {
					return this.daemonInfos3;
				}

				public void setDaemonInfos3(List<DaemonInfo5> daemonInfos3) {
					this.daemonInfos3 = daemonInfos3;
				}

				public List<DiskInfo6> getDiskInfos4() {
					return this.diskInfos4;
				}

				public void setDiskInfos4(List<DiskInfo6> diskInfos4) {
					this.diskInfos4 = diskInfos4;
				}

				public static class DaemonInfo5 {
	...
	@Override
	public DescribeClusterForAdminResponse getInstance(UnmarshallerContext context) {
		return	DescribeClusterForAdminResponseUnmarshaller.unmarshall(this, context);
	}
}
