 ...
 * @version 
 */
public class ListScalingGroupV2Request extends RpcAcsRequest<ListScalingGroupV2Response> {
	...
	@Override
	public Class<ListScalingGroupV2Response> getResponseClass() {
		return ListScalingGroupV2Response.class;
	}
