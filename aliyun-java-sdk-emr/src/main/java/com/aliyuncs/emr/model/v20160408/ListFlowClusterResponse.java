...
import com.aliyuncs.emr.transform.v20160408.ListFlowClusterResponseUnmarshaller;
 ...
 * @version 
 */
public class ListFlowClusterResponse extends AcsResponse {
	...
	@Override
	public ListFlowClusterResponse getInstance(UnmarshallerContext context) {
		return	ListFlowClusterResponseUnmarshaller.unmarshall(this, context);
	}
}
