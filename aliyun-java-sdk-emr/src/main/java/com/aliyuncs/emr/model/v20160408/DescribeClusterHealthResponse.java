...
import com.aliyuncs.emr.transform.v20160408.DescribeClusterHealthResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeClusterHealthResponse extends AcsResponse {
	...
	@Override
	public DescribeClusterHealthResponse getInstance(UnmarshallerContext context) {
		return	DescribeClusterHealthResponseUnmarshaller.unmarshall(this, context);
	}
}
