...
import com.aliyuncs.emr.transform.v20160408.DescribeClusterBasicInfoForAdminResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeClusterBasicInfoForAdminResponse extends AcsResponse {
	...
	@Override
	public DescribeClusterBasicInfoForAdminResponse getInstance(UnmarshallerContext context) {
		return	DescribeClusterBasicInfoForAdminResponseUnmarshaller.unmarshall(this, context);
	}
}
