 ...
 * @version 
 */
public class ListLibraryStatusRequest extends RpcAcsRequest<ListLibraryStatusResponse> {
	...
	@Override
	public Class<ListLibraryStatusResponse> getResponseClass() {
		return ListLibraryStatusResponse.class;
	}
