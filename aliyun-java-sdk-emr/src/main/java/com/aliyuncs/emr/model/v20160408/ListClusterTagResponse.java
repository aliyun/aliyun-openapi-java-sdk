...
import com.aliyuncs.emr.transform.v20160408.ListClusterTagResponseUnmarshaller;
 ...
 * @version 
 */
public class ListClusterTagResponse extends AcsResponse {
	...
	@Override
	public ListClusterTagResponse getInstance(UnmarshallerContext context) {
		return	ListClusterTagResponseUnmarshaller.unmarshall(this, context);
	}
}
