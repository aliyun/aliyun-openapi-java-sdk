...
import com.aliyuncs.emr.model.v20160408.CreateUserGroupResponse;
...
public class CreateUserGroupResponseUnmarshaller {
	...
	public static CreateUserGroupResponse unmarshall(CreateUserGroupResponse createUserGroupResponse, UnmarshallerContext _ctx) {
		...
		createUserGroupResponse.setPaging(_ctx.booleanValue("CreateUserGroupResponse.Paging"));
		createUserGroupResponse.setData(_ctx.booleanValue("CreateUserGroupResponse.Data"));
