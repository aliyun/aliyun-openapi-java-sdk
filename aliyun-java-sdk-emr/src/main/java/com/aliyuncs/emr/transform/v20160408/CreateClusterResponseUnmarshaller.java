...
import com.aliyuncs.emr.model.v20160408.CreateClusterResponse;
...
public class CreateClusterResponseUnmarshaller {
	...
	public static CreateClusterResponse unmarshall(CreateClusterResponse createClusterResponse, UnmarshallerContext context) {
		...
		createClusterResponse.setEmrOrderId(context.stringValue("CreateClusterResponse.EmrOrderId"));
		createClusterResponse.setMasterOrderId(context.stringValue("CreateClusterResponse.MasterOrderId"));
		createClusterResponse.setCoreOrderId(context.stringValue("CreateClusterResponse.CoreOrderId"));
