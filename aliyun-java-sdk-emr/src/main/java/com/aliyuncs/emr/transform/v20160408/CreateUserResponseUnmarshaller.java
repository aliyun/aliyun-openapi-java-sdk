...
import com.aliyuncs.emr.model.v20160408.CreateUserResponse;
...
public class CreateUserResponseUnmarshaller {
	...
	public static CreateUserResponse unmarshall(CreateUserResponse createUserResponse, UnmarshallerContext _ctx) {
		...
		createUserResponse.setPaging(_ctx.booleanValue("CreateUserResponse.Paging"));
		createUserResponse.setData(_ctx.booleanValue("CreateUserResponse.Data"));
