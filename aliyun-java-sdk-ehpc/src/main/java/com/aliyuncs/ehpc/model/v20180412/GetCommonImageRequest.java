 ...
 * @version 
 */
public class GetCommonImageRequest extends RpcAcsRequest<GetCommonImageResponse> {
	...
	public void setContainType(String containType) {
		...
		if(containType != null){
			putQueryParameter("ContainType", containType);
		}
	}
	...
	@Override
	public Class<GetCommonImageResponse> getResponseClass() {
		return GetCommonImageResponse.class;
	}
