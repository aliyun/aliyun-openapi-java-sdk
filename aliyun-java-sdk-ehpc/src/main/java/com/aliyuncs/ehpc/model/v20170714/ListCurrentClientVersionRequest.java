...
public class ListCurrentClientVersionRequest extends RpcAcsRequest<ListCurrentClientVersionResponse> {
	...
	public ListCurrentClientVersionRequest() {
		super("EHPC", "2017-07-14", "ListCurrentClientVersion", "ehs");
	}

	@Override
	public Class<ListCurrentClientVersionResponse> getResponseClass() {
		return ListCurrentClientVersionResponse.class;
	}
