 ...
 * @version 
 */
public class AddContainerAppResponse extends AcsResponse {
	...
	@Override
	public AddContainerAppResponse getInstance(UnmarshallerContext context) {
		return	AddContainerAppResponseUnmarshaller.unmarshall(this, context);
	}
}
