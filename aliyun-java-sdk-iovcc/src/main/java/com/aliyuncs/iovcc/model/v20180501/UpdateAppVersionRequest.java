 ...
 * @version 
 */
public class UpdateAppVersionRequest extends RpcAcsRequest<UpdateAppVersionResponse> {
	...
	public UpdateAppVersionRequest() {
		super("iovcc", "2018-05-01", "UpdateAppVersion", "iovcc");
	...
	@Override
	public Class<UpdateAppVersionResponse> getResponseClass() {
		return UpdateAppVersionResponse.class;
	}
