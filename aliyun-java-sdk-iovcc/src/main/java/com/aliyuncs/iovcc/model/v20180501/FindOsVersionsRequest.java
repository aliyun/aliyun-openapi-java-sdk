 ...
 * @version 
 */
public class FindOsVersionsRequest extends RpcAcsRequest<FindOsVersionsResponse> {
	...
	public FindOsVersionsRequest() {
		super("iovcc", "2018-05-01", "FindOsVersions", "iovcc");
	...
	@Override
	public Class<FindOsVersionsResponse> getResponseClass() {
		return FindOsVersionsResponse.class;
	}
