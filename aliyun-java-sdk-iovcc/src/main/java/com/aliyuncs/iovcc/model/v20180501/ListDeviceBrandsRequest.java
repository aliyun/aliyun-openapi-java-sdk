 ...
 * @version 
 */
public class ListDeviceBrandsRequest extends RpcAcsRequest<ListDeviceBrandsResponse> {
	...
	public ListDeviceBrandsRequest() {
		super("iovcc", "2018-05-01", "ListDeviceBrands", "iovcc");
	...
	@Override
	public Class<ListDeviceBrandsResponse> getResponseClass() {
		return ListDeviceBrandsResponse.class;
	}
