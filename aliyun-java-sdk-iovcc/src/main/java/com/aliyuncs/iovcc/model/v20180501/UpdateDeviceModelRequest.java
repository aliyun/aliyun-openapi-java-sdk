 ...
 * @version 
 */
public class UpdateDeviceModelRequest extends RpcAcsRequest<UpdateDeviceModelResponse> {
	...
	public UpdateDeviceModelRequest() {
		super("iovcc", "2018-05-01", "UpdateDeviceModel", "iovcc");
	...
	@Override
	public Class<UpdateDeviceModelResponse> getResponseClass() {
		return UpdateDeviceModelResponse.class;
	}
