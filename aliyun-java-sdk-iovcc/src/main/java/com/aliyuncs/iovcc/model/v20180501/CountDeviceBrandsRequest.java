 ...
 * @version 
 */
public class CountDeviceBrandsRequest extends RpcAcsRequest<CountDeviceBrandsResponse> {
	...
	public CountDeviceBrandsRequest() {
		super("iovcc", "2018-05-01", "CountDeviceBrands", "iovcc");
	...
	@Override
	public Class<CountDeviceBrandsResponse> getResponseClass() {
		return CountDeviceBrandsResponse.class;
	}
