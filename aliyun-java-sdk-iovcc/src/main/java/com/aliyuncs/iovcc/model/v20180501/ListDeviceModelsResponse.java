...
import com.aliyuncs.iovcc.transform.v20180501.ListDeviceModelsResponseUnmarshaller;
 ...
 * @version 
 */
public class ListDeviceModelsResponse extends AcsResponse {

	private String requestId;

	private List<Result> deviceModels;
	...
	public List<Result> getDeviceModels() {
		return this.deviceModels;
	}

	public void setDeviceModels(List<Result> deviceModels) {
	...
	@Override
	public ListDeviceModelsResponse getInstance(UnmarshallerContext context) {
		return	ListDeviceModelsResponseUnmarshaller.unmarshall(this, context);
	}
