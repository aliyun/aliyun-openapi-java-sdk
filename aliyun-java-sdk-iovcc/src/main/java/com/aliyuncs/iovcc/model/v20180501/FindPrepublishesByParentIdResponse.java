...
import com.aliyuncs.iovcc.transform.v20180501.FindPrepublishesByParentIdResponseUnmarshaller;
 ...
 * @version 
 */
public class FindPrepublishesByParentIdResponse extends AcsResponse {
	...
	public void setPrepublishList(PrepublishList prepublishList) {
		this.prepublishList = prepublishList;
	}

	public static class PrepublishList {
	...
	@Override
	public FindPrepublishesByParentIdResponse getInstance(UnmarshallerContext context) {
		return	FindPrepublishesByParentIdResponseUnmarshaller.unmarshall(this, context);
	}
