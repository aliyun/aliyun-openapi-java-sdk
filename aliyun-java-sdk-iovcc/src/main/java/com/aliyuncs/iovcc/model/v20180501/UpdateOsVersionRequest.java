 ...
 * @version 
 */
public class UpdateOsVersionRequest extends RpcAcsRequest<UpdateOsVersionResponse> {
	...
	public UpdateOsVersionRequest() {
		super("iovcc", "2018-05-01", "UpdateOsVersion", "iovcc");
	...
	@Override
	public Class<UpdateOsVersionResponse> getResponseClass() {
		return UpdateOsVersionResponse.class;
	}
