 ...
 * @version 
 */
public class UpdateOpsItemRequest extends RpcAcsRequest<UpdateOpsItemResponse> {
	...
	public UpdateOpsItemRequest() {
		super("oos", "2019-06-01", "UpdateOpsItem", "oos");
	...
	@Override
	public Class<UpdateOpsItemResponse> getResponseClass() {
		return UpdateOpsItemResponse.class;
	}
