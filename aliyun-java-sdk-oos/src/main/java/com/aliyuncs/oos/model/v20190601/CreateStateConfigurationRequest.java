 ...
 * @version 
 */
public class CreateStateConfigurationRequest extends RpcAcsRequest<CreateStateConfigurationResponse> {
	...
	@Override
	public Class<CreateStateConfigurationResponse> getResponseClass() {
		return CreateStateConfigurationResponse.class;
	}
