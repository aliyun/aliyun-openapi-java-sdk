...
import com.aliyuncs.oos.transform.v20190601.ListParameterVersionsResponseUnmarshaller;
 ...
 * @version 
 */
public class ListParameterVersionsResponse extends AcsResponse {
	...
	@Override
	public ListParameterVersionsResponse getInstance(UnmarshallerContext context) {
		return	ListParameterVersionsResponseUnmarshaller.unmarshall(this, context);
	}
