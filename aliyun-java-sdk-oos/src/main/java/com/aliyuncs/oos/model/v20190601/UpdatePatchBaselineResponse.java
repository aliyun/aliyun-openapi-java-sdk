 ...
 * @version 
 */
public class UpdatePatchBaselineResponse extends AcsResponse {
	...
	@Override
	public UpdatePatchBaselineResponse getInstance(UnmarshallerContext context) {
		return	UpdatePatchBaselineResponseUnmarshaller.unmarshall(this, context);
	}
