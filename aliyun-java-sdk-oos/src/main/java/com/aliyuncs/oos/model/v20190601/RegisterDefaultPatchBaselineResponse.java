...
import com.aliyuncs.oos.transform.v20190601.RegisterDefaultPatchBaselineResponseUnmarshaller;
 ...
 * @version 
 */
public class RegisterDefaultPatchBaselineResponse extends AcsResponse {
	...
	@Override
	public RegisterDefaultPatchBaselineResponse getInstance(UnmarshallerContext context) {
		return	RegisterDefaultPatchBaselineResponseUnmarshaller.unmarshall(this, context);
	}
