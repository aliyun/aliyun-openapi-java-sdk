 ...
 * @version 
 */
public class ListStateConfigurationsRequest extends RpcAcsRequest<ListStateConfigurationsResponse> {
	...
	@Override
	public Class<ListStateConfigurationsResponse> getResponseClass() {
		return ListStateConfigurationsResponse.class;
	}
