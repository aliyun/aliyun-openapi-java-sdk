 ...
 * @version 
 */
public class ListOpsItemsRequest extends RpcAcsRequest<ListOpsItemsResponse> {
	...
	public ListOpsItemsRequest() {
		super("oos", "2019-06-01", "ListOpsItems", "oos");
	...
	public void setResourceTags(String resourceTags) {
		...
		if(resourceTags != null){
			putQueryParameter("ResourceTags", resourceTags);
		}
	}
	...
	@Override
	public Class<ListOpsItemsResponse> getResponseClass() {
		return ListOpsItemsResponse.class;
	}
