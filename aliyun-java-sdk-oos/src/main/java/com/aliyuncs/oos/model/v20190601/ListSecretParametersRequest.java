 ...
 * @version 
 */
public class ListSecretParametersRequest extends RpcAcsRequest<ListSecretParametersResponse> {
	...
	@Override
	public Class<ListSecretParametersResponse> getResponseClass() {
		return ListSecretParametersResponse.class;
	}
