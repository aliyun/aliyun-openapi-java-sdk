 ...
 * @version 
 */
public class UpdateExecutionRequest extends RpcAcsRequest<UpdateExecutionResponse> {
	...
	@Override
	public Class<UpdateExecutionResponse> getResponseClass() {
		return UpdateExecutionResponse.class;
	}
