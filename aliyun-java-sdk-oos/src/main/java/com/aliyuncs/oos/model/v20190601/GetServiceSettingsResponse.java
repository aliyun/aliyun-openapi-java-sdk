...
import com.aliyuncs.oos.transform.v20190601.GetServiceSettingsResponseUnmarshaller;
 ...
 * @version 
 */
public class GetServiceSettingsResponse extends AcsResponse {
	...
	@Override
	public GetServiceSettingsResponse getInstance(UnmarshallerContext context) {
		return	GetServiceSettingsResponseUnmarshaller.unmarshall(this, context);
	}
