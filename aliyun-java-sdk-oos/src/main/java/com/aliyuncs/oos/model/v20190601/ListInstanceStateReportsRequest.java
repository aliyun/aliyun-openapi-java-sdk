 ...
 * @version 
 */
public class ListInstanceStateReportsRequest extends RpcAcsRequest<ListInstanceStateReportsResponse> {
	...
	@Override
	public Class<ListInstanceStateReportsResponse> getResponseClass() {
		return ListInstanceStateReportsResponse.class;
	}
