 ...
 * @version 
 */
public class ListInventoryEntriesRequest extends RpcAcsRequest<ListInventoryEntriesResponse> {
	...
	@Override
	public Class<ListInventoryEntriesResponse> getResponseClass() {
		return ListInventoryEntriesResponse.class;
	}
