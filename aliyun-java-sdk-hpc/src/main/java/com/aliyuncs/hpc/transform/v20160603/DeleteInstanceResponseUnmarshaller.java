...
import com.aliyuncs.hpc.model.v20160603.DeleteInstanceResponse;
...
public class DeleteInstanceResponseUnmarshaller {
	...
	public static DeleteInstanceResponse unmarshall(DeleteInstanceResponse deleteInstanceResponse, UnmarshallerContext context) {
		...
		deleteInstanceResponse.setInstanceId(context.stringValue("DeleteInstanceResponse.InstanceId"));
		deleteInstanceResponse.setRegionId(context.stringValue("DeleteInstanceResponse.RegionId"));
