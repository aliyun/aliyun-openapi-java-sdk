...
public class ModifyJumpserverPasswordRequest extends RpcAcsRequest<ModifyJumpserverPasswordResponse> {
	...
	public ModifyJumpserverPasswordRequest() {
		super("HPC", "2016-12-13", "ModifyJumpserverPassword", "hpc");
	...
	@Override
	public Class<ModifyJumpserverPasswordResponse> getResponseClass() {
		return ModifyJumpserverPasswordResponse.class;
	}
