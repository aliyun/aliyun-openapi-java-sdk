 ...
 * @version 
 */
public class GetGlobalDeploymentDefaultsRequest extends RoaAcsRequest<GetGlobalDeploymentDefaultsResponse> {
	...
	public void setNamespace(String namespace) {
		...
		if(namespace != null){
			putHeaderParameter("namespace", namespace);
		}
	}

	@Override
	public Class<GetGlobalDeploymentDefaultsResponse> getResponseClass() {
		return GetGlobalDeploymentDefaultsResponse.class;
	}
