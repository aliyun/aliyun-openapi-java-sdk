 ...
 * @version 
 */
public class GetDefaultDatabaseRequest extends RoaAcsRequest<GetDefaultDatabaseResponse> {
	...
	@Override
	public Class<GetDefaultDatabaseResponse> getResponseClass() {
		return GetDefaultDatabaseResponse.class;
	}
