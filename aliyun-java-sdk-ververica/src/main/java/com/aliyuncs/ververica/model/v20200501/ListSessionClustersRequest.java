 ...
 * @version 
 */
public class ListSessionClustersRequest extends RoaAcsRequest<ListSessionClustersResponse> {
	...
	@Override
	public Class<ListSessionClustersResponse> getResponseClass() {
		return ListSessionClustersResponse.class;
	}
