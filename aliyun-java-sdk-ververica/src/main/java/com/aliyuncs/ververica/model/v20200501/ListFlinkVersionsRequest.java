 ...
 * @version 
 */
public class ListFlinkVersionsRequest extends RoaAcsRequest<ListFlinkVersionsResponse> {
	...
	@Override
	public Class<ListFlinkVersionsResponse> getResponseClass() {
		return ListFlinkVersionsResponse.class;
	}
