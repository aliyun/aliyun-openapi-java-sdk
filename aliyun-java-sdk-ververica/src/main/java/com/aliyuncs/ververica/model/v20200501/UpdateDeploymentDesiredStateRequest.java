 ...
 * @version 
 */
public class UpdateDeploymentDesiredStateRequest extends RoaAcsRequest<UpdateDeploymentDesiredStateResponse> {
	...
	@Override
	public Class<UpdateDeploymentDesiredStateResponse> getResponseClass() {
		return UpdateDeploymentDesiredStateResponse.class;
	}
