 ...
 * @version 
 */
public class ValidateSqlScriptRequest extends RoaAcsRequest<ValidateSqlScriptResponse> {
	...
	@Override
	public Class<ValidateSqlScriptResponse> getResponseClass() {
		return ValidateSqlScriptResponse.class;
	}
