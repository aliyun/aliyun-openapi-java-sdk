 ...
 * @version 
 */
public class ReplaceDeploymentRequest extends RoaAcsRequest<ReplaceDeploymentResponse> {
	...
	public ReplaceDeploymentRequest() {
		super("ververica", "2020-05-01", "ReplaceDeployment");
	...
	@Override
	public Class<ReplaceDeploymentResponse> getResponseClass() {
		return ReplaceDeploymentResponse.class;
	}
