 ...
 * @version 
 */
public class ExecuteSqlScriptRequest extends RoaAcsRequest<ExecuteSqlScriptResponse> {
	...
	@Override
	public Class<ExecuteSqlScriptResponse> getResponseClass() {
		return ExecuteSqlScriptResponse.class;
	}
