 ...
 * @version 
 */
public class ExecuteSqlscriptsStatementsRequest extends RoaAcsRequest<ExecuteSqlscriptsStatementsResponse> {
	...
	@Override
	public Class<ExecuteSqlscriptsStatementsResponse> getResponseClass() {
		return ExecuteSqlscriptsStatementsResponse.class;
	}
