 ...
 * @version 
 */
public class DeleteUdfArtifactRequest extends RoaAcsRequest<DeleteUdfArtifactResponse> {
	...
	@Override
	public Class<DeleteUdfArtifactResponse> getResponseClass() {
		return DeleteUdfArtifactResponse.class;
	}
