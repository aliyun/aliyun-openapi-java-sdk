 ...
 * @version 
 */
public class UpdateMemberRequest extends RoaAcsRequest<UpdateMemberResponse> {
	...
	public UpdateMemberRequest() {
		super("ververica", "2020-05-01", "UpdateMember");
		setUriPattern("/pop/workspaces/[workspace]/members/v1/namespaces/[namespace]");
