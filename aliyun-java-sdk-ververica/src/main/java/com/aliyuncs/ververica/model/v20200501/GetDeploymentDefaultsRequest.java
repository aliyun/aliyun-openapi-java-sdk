 ...
 * @version 
 */
public class GetDeploymentDefaultsRequest extends RoaAcsRequest<GetDeploymentDefaultsResponse> {
	...
	@Override
	public Class<GetDeploymentDefaultsResponse> getResponseClass() {
		return GetDeploymentDefaultsResponse.class;
	}
