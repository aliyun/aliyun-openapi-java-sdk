...
import com.aliyuncs.ververica.model.v20200501.ListConnectorsResponse;
...
public class ListConnectorsResponseUnmarshaller {
	...
	public static ListConnectorsResponse unmarshall(ListConnectorsResponse listConnectorsResponse, UnmarshallerContext _ctx) {
		...
		listConnectorsResponse.setSuccess(_ctx.booleanValue("ListConnectorsResponse.success"));
		listConnectorsResponse.setData(_ctx.stringValue("ListConnectorsResponse.data"));
