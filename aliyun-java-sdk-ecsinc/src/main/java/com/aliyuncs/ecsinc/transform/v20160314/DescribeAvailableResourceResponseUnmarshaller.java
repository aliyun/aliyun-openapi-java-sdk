...
import com.aliyuncs.ecsinc.model.v20160314.DescribeAvailableResourceResponse;
import com.aliyuncs.ecsinc.model.v20160314.DescribeAvailableResourceResponse.AvailableZone;
import com.aliyuncs.ecsinc.model.v20160314.DescribeAvailableResourceResponse.AvailableZone.AvailableResource;
import com.aliyuncs.ecsinc.model.v20160314.DescribeAvailableResourceResponse.AvailableZone.AvailableResource.SupportedResource;
...
public class DescribeAvailableResourceResponseUnmarshaller {
	...
	public static DescribeAvailableResourceResponse unmarshall(DescribeAvailableResourceResponse describeAvailableResourceResponse, UnmarshallerContext context) {
		...
		for (int i = 0; i < context.lengthValue("DescribeAvailableResourceResponse.AvailableZones.Length"); i++) {
			...
			availableZone.setLocalName(context.stringValue("DescribeAvailableResourceResponse.AvailableZones["+ i +"].LocalName"));
			availableZone.setStatus(context.stringValue("DescribeAvailableResourceResponse.AvailableZones["+ i +"].Status"));
			availableZone.setStatusCategory(context.stringValue("DescribeAvailableResourceResponse.AvailableZones["+ i +"].StatusCategory"));
