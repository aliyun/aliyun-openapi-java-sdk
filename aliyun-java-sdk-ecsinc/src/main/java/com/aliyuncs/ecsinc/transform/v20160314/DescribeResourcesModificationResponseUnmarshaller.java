...
import com.aliyuncs.ecsinc.model.v20160314.DescribeResourcesModificationResponse;
import com.aliyuncs.ecsinc.model.v20160314.DescribeResourcesModificationResponse.AvailableZone;
import com.aliyuncs.ecsinc.model.v20160314.DescribeResourcesModificationResponse.AvailableZone.AvailableResource;
import com.aliyuncs.ecsinc.model.v20160314.DescribeResourcesModificationResponse.AvailableZone.AvailableResource.SupportedResource;
...
public class DescribeResourcesModificationResponseUnmarshaller {
	...
	public static DescribeResourcesModificationResponse unmarshall(DescribeResourcesModificationResponse describeResourcesModificationResponse, UnmarshallerContext context) {
		...
		for (int i = 0; i < context.lengthValue("DescribeResourcesModificationResponse.AvailableZones.Length"); i++) {
			...
			availableZone.setStatusCategory(context.stringValue("DescribeResourcesModificationResponse.AvailableZones["+ i +"].StatusCategory"));
			...
			for (int j = 0; j < context.lengthValue("DescribeResourcesModificationResponse.AvailableZones["+ i +"].AvailableResources.Length"); j++) {
				...
				for (int k = 0; k < context.lengthValue("DescribeResourcesModificationResponse.AvailableZones["+ i +"].AvailableResources["+ j +"].SupportedResources.Length"); k++) {
					...
					supportedResource.setStatusCategory(context.stringValue("DescribeResourcesModificationResponse.AvailableZones["+ i +"].AvailableResources["+ j +"].SupportedResources["+ k +"].StatusCategory"));
