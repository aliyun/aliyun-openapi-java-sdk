 ...
 * @version 
 */
public class InnerEcsQueryByParamRequest extends RpcAcsRequest<InnerEcsQueryByParamResponse> {
	
	public InnerEcsQueryByParamRequest() {
		super("EcsInc", "2016-03-14", "InnerEcsQueryByParam", "ecs", "innerAPI");
	}
	...
	@Override
	public Class<InnerEcsQueryByParamResponse> getResponseClass() {
		return InnerEcsQueryByParamResponse.class;
	}
