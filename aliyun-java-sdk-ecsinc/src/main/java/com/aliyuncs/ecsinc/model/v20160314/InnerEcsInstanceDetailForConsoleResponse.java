...
import com.aliyuncs.ecsinc.transform.v20160314.InnerEcsInstanceDetailForConsoleResponseUnmarshaller;
 ...
 * @version 
 */
public class InnerEcsInstanceDetailForConsoleResponse extends AcsResponse {
	...
	@Override
	public InnerEcsInstanceDetailForConsoleResponse getInstance(UnmarshallerContext context) {
		return	InnerEcsInstanceDetailForConsoleResponseUnmarshaller.unmarshall(this, context);
	}
}
