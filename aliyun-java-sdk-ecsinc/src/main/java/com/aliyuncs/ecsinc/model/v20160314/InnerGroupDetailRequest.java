 ...
 * @version 
 */
public class InnerGroupDetailRequest extends RpcAcsRequest<InnerGroupDetailResponse> {
	
	public InnerGroupDetailRequest() {
		super("EcsInc", "2016-03-14", "InnerGroupDetail", "ecs", "innerAPI");
	}
	...
	@Override
	public Class<InnerGroupDetailResponse> getResponseClass() {
		return InnerGroupDetailResponse.class;
	}
