...
import com.aliyuncs.ecsinc.transform.v20160314.InnerEcsQueryBySerialNumberResponseUnmarshaller;
 ...
 * @version 
 */
public class InnerEcsQueryBySerialNumberResponse extends AcsResponse {
	...
	@Override
	public InnerEcsQueryBySerialNumberResponse getInstance(UnmarshallerContext context) {
		return	InnerEcsQueryBySerialNumberResponseUnmarshaller.unmarshall(this, context);
	}
}
