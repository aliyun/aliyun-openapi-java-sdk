 ...
 * @version 
 */
public class InnerGroupJoinRequest extends RpcAcsRequest<InnerGroupJoinResponse> {
	
	public InnerGroupJoinRequest() {
		super("EcsInc", "2016-03-14", "InnerGroupJoin", "ecs", "innerAPI");
	}
	...
	@Override
	public Class<InnerGroupJoinResponse> getResponseClass() {
		return InnerGroupJoinResponse.class;
	}
