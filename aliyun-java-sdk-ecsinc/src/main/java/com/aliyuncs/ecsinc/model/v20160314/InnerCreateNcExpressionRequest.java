 ...
 * @version 
 */
public class InnerCreateNcExpressionRequest extends RpcAcsRequest<InnerCreateNcExpressionResponse> {
	
	public InnerCreateNcExpressionRequest() {
		super("EcsInc", "2016-03-14", "InnerCreateNcExpression", "ecs", "innerAPI");
	}
	...
	@Override
	public Class<InnerCreateNcExpressionResponse> getResponseClass() {
		return InnerCreateNcExpressionResponse.class;
	}
