 ...
 * @version 
 */
public class InnerDescribeNcExpressionRequest extends RpcAcsRequest<InnerDescribeNcExpressionResponse> {
	
	public InnerDescribeNcExpressionRequest() {
		super("EcsInc", "2016-03-14", "InnerDescribeNcExpression", "ecs", "innerAPI");
	}
	...
	@Override
	public Class<InnerDescribeNcExpressionResponse> getResponseClass() {
		return InnerDescribeNcExpressionResponse.class;
	}
