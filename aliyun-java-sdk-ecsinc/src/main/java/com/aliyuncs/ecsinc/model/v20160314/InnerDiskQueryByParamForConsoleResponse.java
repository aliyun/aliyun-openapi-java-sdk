...
import com.aliyuncs.ecsinc.transform.v20160314.InnerDiskQueryByParamForConsoleResponseUnmarshaller;
 ...
 * @version 
 */
public class InnerDiskQueryByParamForConsoleResponse extends AcsResponse {
	...
	@Override
	public InnerDiskQueryByParamForConsoleResponse getInstance(UnmarshallerContext context) {
		return	InnerDiskQueryByParamForConsoleResponseUnmarshaller.unmarshall(this, context);
	}
}
