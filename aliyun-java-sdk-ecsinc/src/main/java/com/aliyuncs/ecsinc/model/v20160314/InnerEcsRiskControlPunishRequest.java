 ...
 * @version 
 */
public class InnerEcsRiskControlPunishRequest extends RpcAcsRequest<InnerEcsRiskControlPunishResponse> {
	
	public InnerEcsRiskControlPunishRequest() {
		super("EcsInc", "2016-03-14", "InnerEcsRiskControlPunish", "ecs", "innerAPI");
	}
	...
	@Override
	public Class<InnerEcsRiskControlPunishResponse> getResponseClass() {
		return InnerEcsRiskControlPunishResponse.class;
	}
