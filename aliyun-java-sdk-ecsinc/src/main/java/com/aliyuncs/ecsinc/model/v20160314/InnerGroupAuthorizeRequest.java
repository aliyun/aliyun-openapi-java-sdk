 ...
 * @version 
 */
public class InnerGroupAuthorizeRequest extends RpcAcsRequest<InnerGroupAuthorizeResponse> {
	
	public InnerGroupAuthorizeRequest() {
		super("EcsInc", "2016-03-14", "InnerGroupAuthorize", "ecs", "innerAPI");
	}
	...
	public void setSourceGroupId(Long sourceGroupId) {
		...
		if(sourceGroupId != null){
			putQueryParameter("sourceGroupId", sourceGroupId.toString());
		}
	}
	...
	@Override
	public Class<InnerGroupAuthorizeResponse> getResponseClass() {
		return InnerGroupAuthorizeResponse.class;
	}
