...
import com.aliyuncs.ecsinc.transform.v20160314.InnerEcsFindByIdResponseUnmarshaller;
 ...
 * @version 
 */
public class InnerEcsFindByIdResponse extends AcsResponse {
	...
	@Override
	public InnerEcsFindByIdResponse getInstance(UnmarshallerContext context) {
		return	InnerEcsFindByIdResponseUnmarshaller.unmarshall(this, context);
	}
}
