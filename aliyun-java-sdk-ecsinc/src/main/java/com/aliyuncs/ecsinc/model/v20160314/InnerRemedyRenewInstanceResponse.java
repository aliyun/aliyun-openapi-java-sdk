...
import com.aliyuncs.ecsinc.transform.v20160314.InnerRemedyRenewInstanceResponseUnmarshaller;
 ...
 * @version 
 */
public class InnerRemedyRenewInstanceResponse extends AcsResponse {
	...
	@Override
	public InnerRemedyRenewInstanceResponse getInstance(UnmarshallerContext context) {
		return	InnerRemedyRenewInstanceResponseUnmarshaller.unmarshall(this, context);
	}
}
