 ...
 * @version 
 */
public class GdprPhysicalDeleteResourceRequest extends RpcAcsRequest<GdprPhysicalDeleteResourceResponse> {
	
	public GdprPhysicalDeleteResourceRequest() {
		super("EcsInc", "2016-03-14", "GdprPhysicalDeleteResource", "ecs", "innerAPI");
	}
	...
	@Override
	public Class<GdprPhysicalDeleteResourceResponse> getResponseClass() {
		return GdprPhysicalDeleteResourceResponse.class;
	}
