 ...
 * @version 
 */
public class DescribeResourceCreationCapacityRequest extends RpcAcsRequest<DescribeResourceCreationCapacityResponse> {
	
	public DescribeResourceCreationCapacityRequest() {
		super("EcsInc", "2016-03-14", "DescribeResourceCreationCapacity", "ecs", "innerAPI");
	}
	...
	@Override
	public Class<DescribeResourceCreationCapacityResponse> getResponseClass() {
		return DescribeResourceCreationCapacityResponse.class;
	}
