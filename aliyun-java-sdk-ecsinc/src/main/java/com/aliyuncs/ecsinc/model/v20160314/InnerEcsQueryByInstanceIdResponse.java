...
import com.aliyuncs.ecsinc.transform.v20160314.InnerEcsQueryByInstanceIdResponseUnmarshaller;
 ...
 * @version 
 */
public class InnerEcsQueryByInstanceIdResponse extends AcsResponse {
	...
	@Override
	public InnerEcsQueryByInstanceIdResponse getInstance(UnmarshallerContext context) {
		return	InnerEcsQueryByInstanceIdResponseUnmarshaller.unmarshall(this, context);
	}
}
