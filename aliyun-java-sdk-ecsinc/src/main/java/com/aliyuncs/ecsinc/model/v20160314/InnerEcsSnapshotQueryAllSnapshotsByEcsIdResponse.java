...
import com.aliyuncs.ecsinc.transform.v20160314.InnerEcsSnapshotQueryAllSnapshotsByEcsIdResponseUnmarshaller;
 ...
 * @version 
 */
public class InnerEcsSnapshotQueryAllSnapshotsByEcsIdResponse extends AcsResponse {
	...
	@Override
	public InnerEcsSnapshotQueryAllSnapshotsByEcsIdResponse getInstance(UnmarshallerContext context) {
		return	InnerEcsSnapshotQueryAllSnapshotsByEcsIdResponseUnmarshaller.unmarshall(this, context);
	}
}
