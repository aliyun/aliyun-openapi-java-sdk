 ...
 * @version 
 */
public class InnerGroupLeaveRequest extends RpcAcsRequest<InnerGroupLeaveResponse> {
	
	public InnerGroupLeaveRequest() {
		super("EcsInc", "2016-03-14", "InnerGroupLeave", "ecs", "innerAPI");
	}
	...
	@Override
	public Class<InnerGroupLeaveResponse> getResponseClass() {
		return InnerGroupLeaveResponse.class;
	}
