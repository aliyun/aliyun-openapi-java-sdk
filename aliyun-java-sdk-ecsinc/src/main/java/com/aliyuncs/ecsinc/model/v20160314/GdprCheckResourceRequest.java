 ...
 * @version 
 */
public class GdprCheckResourceRequest extends RpcAcsRequest<GdprCheckResourceResponse> {
	
	public GdprCheckResourceRequest() {
		super("EcsInc", "2016-03-14", "GdprCheckResource", "ecs", "innerAPI");
	}
	...
	@Override
	public Class<GdprCheckResourceResponse> getResponseClass() {
		return GdprCheckResourceResponse.class;
	}
