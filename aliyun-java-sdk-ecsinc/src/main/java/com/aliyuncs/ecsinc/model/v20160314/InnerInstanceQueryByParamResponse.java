...
import com.aliyuncs.ecsinc.transform.v20160314.InnerInstanceQueryByParamResponseUnmarshaller;
 ...
 * @version 
 */
public class InnerInstanceQueryByParamResponse extends AcsResponse {
	...
	@Override
	public InnerInstanceQueryByParamResponse getInstance(UnmarshallerContext context) {
		return	InnerInstanceQueryByParamResponseUnmarshaller.unmarshall(this, context);
	}
}
