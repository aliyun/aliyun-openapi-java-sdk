 ...
 * @version 
 */
public class InnerDiskQueryByParamForConsoleRequest extends RpcAcsRequest<InnerDiskQueryByParamForConsoleResponse> {
	
	public InnerDiskQueryByParamForConsoleRequest() {
		super("EcsInc", "2016-03-14", "InnerDiskQueryByParamForConsole", "ecs", "innerAPI");
	}
	...
	@Override
	public Class<InnerDiskQueryByParamForConsoleResponse> getResponseClass() {
		return InnerDiskQueryByParamForConsoleResponse.class;
	}
