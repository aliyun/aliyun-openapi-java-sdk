 ...
 * @version 
 */
public class InnerCheckEniEipOperateRequest extends RpcAcsRequest<InnerCheckEniEipOperateResponse> {
	
	public InnerCheckEniEipOperateRequest() {
		super("EcsInc", "2016-03-14", "InnerCheckEniEipOperate", "ecs", "innerAPI");
	}
	...
	@Override
	public Class<InnerCheckEniEipOperateResponse> getResponseClass() {
		return InnerCheckEniEipOperateResponse.class;
	}
