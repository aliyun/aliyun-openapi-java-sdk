...
import com.aliyuncs.ecsinc.transform.v20160314.InnerImageQueryAvailableImgsResponseUnmarshaller;
 ...
 * @version 
 */
public class InnerImageQueryAvailableImgsResponse extends AcsResponse {
	...
	@Override
	public InnerImageQueryAvailableImgsResponse getInstance(UnmarshallerContext context) {
		return	InnerImageQueryAvailableImgsResponseUnmarshaller.unmarshall(this, context);
	}
}
