 ...
 * @version 
 */
public class InnerSnapshotSecurityMountRequest extends RpcAcsRequest<InnerSnapshotSecurityMountResponse> {
	
	public InnerSnapshotSecurityMountRequest() {
		super("EcsInc", "2016-03-14", "InnerSnapshotSecurityMount", "ecs", "innerAPI");
	}
	...
	public Long getSnapshotIndexId() {
		return this.snapshotIndexId;
	}

	public void setSnapshotIndexId(Long snapshotIndexId) {
		this.snapshotIndexId = snapshotIndexId;
		if(snapshotIndexId != null){
			putQueryParameter("snapshotIndexId", snapshotIndexId.toString());
		}
	}

	@Override
	public Class<InnerSnapshotSecurityMountResponse> getResponseClass() {
		return InnerSnapshotSecurityMountResponse.class;
	}
