...
import com.aliyuncs.ecsinc.transform.v20160314.InnerEcsQueryByHpcClusterIdResponseUnmarshaller;
 ...
 * @version 
 */
public class InnerEcsQueryByHpcClusterIdResponse extends AcsResponse {
	...
	public static class Item {
		...
		public void setRdmaIp(String rdmaIp) {
			this.rdmaIp = rdmaIp;
		}
	...
	@Override
	public InnerEcsQueryByHpcClusterIdResponse getInstance(UnmarshallerContext context) {
		return	InnerEcsQueryByHpcClusterIdResponseUnmarshaller.unmarshall(this, context);
	}
}
