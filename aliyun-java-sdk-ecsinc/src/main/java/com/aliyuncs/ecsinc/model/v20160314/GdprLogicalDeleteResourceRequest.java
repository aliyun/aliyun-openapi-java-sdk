 ...
 * @version 
 */
public class GdprLogicalDeleteResourceRequest extends RpcAcsRequest<GdprLogicalDeleteResourceResponse> {
	
	public GdprLogicalDeleteResourceRequest() {
		super("EcsInc", "2016-03-14", "GdprLogicalDeleteResource", "ecs", "innerAPI");
	}
	...
	@Override
	public Class<GdprLogicalDeleteResourceResponse> getResponseClass() {
		return GdprLogicalDeleteResourceResponse.class;
	}
