...
import com.aliyuncs.ecsinc.transform.v20160314.InnerEcsQueryByIntranetIpResponseUnmarshaller;
 ...
 * @version 
 */
public class InnerEcsQueryByIntranetIpResponse extends AcsResponse {
	...
	@Override
	public InnerEcsQueryByIntranetIpResponse getInstance(UnmarshallerContext context) {
		return	InnerEcsQueryByIntranetIpResponseUnmarshaller.unmarshall(this, context);
	}
}
