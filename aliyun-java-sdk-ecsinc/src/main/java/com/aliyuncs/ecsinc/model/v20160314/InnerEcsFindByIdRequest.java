 ...
 * @version 
 */
public class InnerEcsFindByIdRequest extends RpcAcsRequest<InnerEcsFindByIdResponse> {
	
	public InnerEcsFindByIdRequest() {
		super("EcsInc", "2016-03-14", "InnerEcsFindById", "ecs", "innerAPI");
	}
	...
	@Override
	public Class<InnerEcsFindByIdResponse> getResponseClass() {
		return InnerEcsFindByIdResponse.class;
	}
