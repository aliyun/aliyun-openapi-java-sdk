...
import com.aliyuncs.ecsinc.transform.v20160314.InnerDescribeEniResponseUnmarshaller;
 ...
 * @version 
 */
public class InnerDescribeEniResponse extends AcsResponse {
	...
	@Override
	public InnerDescribeEniResponse getInstance(UnmarshallerContext context) {
		return	InnerDescribeEniResponseUnmarshaller.unmarshall(this, context);
	}
}
