...
import com.aliyuncs.ecsinc.transform.v20160314.InnerEcsRegionQueryActiveResponseUnmarshaller;
 ...
 * @version 
 */
public class InnerEcsRegionQueryActiveResponse extends AcsResponse {
	...
	@Override
	public InnerEcsRegionQueryActiveResponse getInstance(UnmarshallerContext context) {
		return	InnerEcsRegionQueryActiveResponseUnmarshaller.unmarshall(this, context);
	}
}
