 ...
 * @version 
 */
public class InnerSnapshotSecurityUnmountRequest extends RpcAcsRequest<InnerSnapshotSecurityUnmountResponse> {
	
	public InnerSnapshotSecurityUnmountRequest() {
		super("EcsInc", "2016-03-14", "InnerSnapshotSecurityUnmount", "ecs", "innerAPI");
	}
	...
	@Override
	public Class<InnerSnapshotSecurityUnmountResponse> getResponseClass() {
		return InnerSnapshotSecurityUnmountResponse.class;
	}
