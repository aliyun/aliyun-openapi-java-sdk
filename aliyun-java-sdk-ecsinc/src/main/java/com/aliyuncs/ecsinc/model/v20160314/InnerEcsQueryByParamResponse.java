...
import com.aliyuncs.ecsinc.transform.v20160314.InnerEcsQueryByParamResponseUnmarshaller;
 ...
 * @version 
 */
public class InnerEcsQueryByParamResponse extends AcsResponse {
	...
	@Override
	public InnerEcsQueryByParamResponse getInstance(UnmarshallerContext context) {
		return	InnerEcsQueryByParamResponseUnmarshaller.unmarshall(this, context);
	}
}
