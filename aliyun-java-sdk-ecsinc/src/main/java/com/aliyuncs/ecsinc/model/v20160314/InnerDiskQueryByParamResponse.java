...
import com.aliyuncs.ecsinc.transform.v20160314.InnerDiskQueryByParamResponseUnmarshaller;
 ...
 * @version 
 */
public class InnerDiskQueryByParamResponse extends AcsResponse {
	...
	@Override
	public InnerDiskQueryByParamResponse getInstance(UnmarshallerContext context) {
		return	InnerDiskQueryByParamResponseUnmarshaller.unmarshall(this, context);
	}
}
