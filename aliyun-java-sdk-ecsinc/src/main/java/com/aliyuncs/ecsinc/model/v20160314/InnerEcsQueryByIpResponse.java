...
import com.aliyuncs.ecsinc.transform.v20160314.InnerEcsQueryByIpResponseUnmarshaller;
 ...
 * @version 
 */
public class InnerEcsQueryByIpResponse extends AcsResponse {
	...
	@Override
	public InnerEcsQueryByIpResponse getInstance(UnmarshallerContext context) {
		return	InnerEcsQueryByIpResponseUnmarshaller.unmarshall(this, context);
	}
}
