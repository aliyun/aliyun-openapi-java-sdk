 ...
 * @version 
 */
public class DescribeNetworkAnalyticsDataTransferRequest extends RpcAcsRequest<DescribeNetworkAnalyticsDataTransferResponse> {
	
	public DescribeNetworkAnalyticsDataTransferRequest() {
		super("Netana", "2018-10-18", "DescribeNetworkAnalyticsDataTransfer", "Netana");
	}
	...
	@Override
	public Class<DescribeNetworkAnalyticsDataTransferResponse> getResponseClass() {
		return DescribeNetworkAnalyticsDataTransferResponse.class;
	}
