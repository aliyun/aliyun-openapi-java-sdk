...
import com.aliyuncs.netana.transform.v20181018.DescribeNetworkAnalyticsPacketLossResponseUnmarshaller;
...
public class DescribeNetworkAnalyticsPacketLossResponse extends AcsResponse {
	...
	public List<PacketLossInfo> getPacketLossInfos() {
		return this.packetLossInfos;
	}

	public void setPacketLossInfos(List<PacketLossInfo> packetLossInfos) {
		this.packetLossInfos = packetLossInfos;
	}
	...
	public static class PacketLossInfo {
		...
		public String getOutBoundTotalPacket() {
			return this.outBoundTotalPacket;
		}

		public void setOutBoundTotalPacket(String outBoundTotalPacket) {
	...
	@Override
	public DescribeNetworkAnalyticsPacketLossResponse getInstance(UnmarshallerContext context) {
		return	DescribeNetworkAnalyticsPacketLossResponseUnmarshaller.unmarshall(this, context);
	}
}
