...
import com.aliyuncs.paifeaturestore.model.v20230621.GetFeatureEntityResponse;
import com.aliyuncs.transform.UnmarshallerContext;


public class GetFeatureEntityResponseUnmarshaller {

	public static GetFeatureEntityResponse unmarshall(GetFeatureEntityResponse getFeatureEntityResponse, UnmarshallerContext _ctx) {
		
		getFeatureEntityResponse.setRequestId(_ctx.stringValue("GetFeatureEntityResponse.RequestId"));
		getFeatureEntityResponse.setName(_ctx.stringValue("GetFeatureEntityResponse.Name"));
		getFeatureEntityResponse.setProjectId(_ctx.stringValue("GetFeatureEntityResponse.ProjectId"));
