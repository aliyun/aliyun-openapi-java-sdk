 ...
 * @version 
 */
public class GetFeatureViewRequest extends RoaAcsRequest<GetFeatureViewResponse> {
	...
	public GetFeatureViewRequest() {
		super("PaiFeatureStore", "2023-06-21", "GetFeatureView");
	...
	@Override
	public Class<GetFeatureViewResponse> getResponseClass() {
		return GetFeatureViewResponse.class;
	}
