 ...
 * @version 
 */
public class GetModelFeatureFGFeatureRequest extends RoaAcsRequest<GetModelFeatureFGFeatureResponse> {
	   

	private String modelFeatureId;

	private String instanceId;
	public GetModelFeatureFGFeatureRequest() {
		super("PaiFeatureStore", "2023-06-21", "GetModelFeatureFGFeature");
	...
	@Override
	public Class<GetModelFeatureFGFeatureResponse> getResponseClass() {
		return GetModelFeatureFGFeatureResponse.class;
	}
