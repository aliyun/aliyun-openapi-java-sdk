 ...
 * @version 
 */
public class GetFeatureEntityRequest extends RoaAcsRequest<GetFeatureEntityResponse> {
	   

	private String featureEntityId;

	private String instanceId;
	public GetFeatureEntityRequest() {
		super("PaiFeatureStore", "2023-06-21", "GetFeatureEntity");
	...
	@Override
	public Class<GetFeatureEntityResponse> getResponseClass() {
		return GetFeatureEntityResponse.class;
	}
