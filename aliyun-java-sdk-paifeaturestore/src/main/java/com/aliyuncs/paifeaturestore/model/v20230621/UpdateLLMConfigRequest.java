 ...
 * @version 
 */
public class UpdateLLMConfigRequest extends RoaAcsRequest<UpdateLLMConfigResponse> {
	...
	public UpdateLLMConfigRequest() {
		super("PaiFeatureStore", "2023-06-21", "UpdateLLMConfig");
	...
	@Override
	public Class<UpdateLLMConfigResponse> getResponseClass() {
		return UpdateLLMConfigResponse.class;
	}
