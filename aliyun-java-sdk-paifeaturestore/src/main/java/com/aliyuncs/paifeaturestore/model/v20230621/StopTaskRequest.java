 ...
 * @version 
 */
public class StopTaskRequest extends RoaAcsRequest<StopTaskResponse> {
	...
	public StopTaskRequest() {
		super("PaiFeatureStore", "2023-06-21", "StopTask");
		setProtocol(ProtocolType.HTTPS);
		setUriPattern("/api/v1/instances/[InstanceId]/tasks/[TaskId]/action/stop");
