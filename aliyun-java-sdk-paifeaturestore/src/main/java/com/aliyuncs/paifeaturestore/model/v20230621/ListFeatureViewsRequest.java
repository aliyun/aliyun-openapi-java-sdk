 ...
 * @version 
 */
public class ListFeatureViewsRequest extends RoaAcsRequest<ListFeatureViewsResponse> {
	...
	@Override
	public Class<ListFeatureViewsResponse> getResponseClass() {
		return ListFeatureViewsResponse.class;
	}
