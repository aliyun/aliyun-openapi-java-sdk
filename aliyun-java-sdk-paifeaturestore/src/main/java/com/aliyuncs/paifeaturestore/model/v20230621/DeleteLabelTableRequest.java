 ...
 * @version 
 */
public class DeleteLabelTableRequest extends RoaAcsRequest<DeleteLabelTableResponse> {
	   

	private String instanceId;

	private String labelTableId;
	public DeleteLabelTableRequest() {
		super("PaiFeatureStore", "2023-06-21", "DeleteLabelTable");
	...
	@Override
	public Class<DeleteLabelTableResponse> getResponseClass() {
		return DeleteLabelTableResponse.class;
	}
