...
import com.aliyuncs.batchcompute.model.v20150630.ListJobStatusRequest;
 ...
 */
public class ListJobStatusRequestTest extends TestCase {

    @Test
    public void testSetResourceId() {

        ListJobStatusRequest req = new ListJobStatusRequest();
    ...
    public void testGetReponseClass(){
        ListJobStatusRequest req = new ListJobStatusRequest();
        assertEquals(ListJobStatusResponse.class, req.getResponseClass());
    }
}