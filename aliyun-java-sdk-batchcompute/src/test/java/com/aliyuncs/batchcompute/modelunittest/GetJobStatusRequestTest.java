...
import com.aliyuncs.batchcompute.model.v20150630.GetJobStatusRequest;
 ...
 */
public class GetJobStatusRequestTest extends TestCase {

    @Test
    public void testConstructor() {

        String RESOURCE_ID = "abc123";
        GetJobStatusRequest req = new GetJobStatusRequest(RESOURCE_ID);
