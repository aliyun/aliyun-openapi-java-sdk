 ...
 */
public class ListTaskStatusResponseTest extends TestCase {


    @Test
    public void testGetGetInstance() throws ServerException {

        ListTaskStatusResponse res = new ListTaskStatusResponse();
        ...
        assertEquals(res.getTaskStatusList().size(), 2);
    }
