...
import com.aliyuncs.batchcompute.transform.v20150630.ListJobStatusResponseUnmarshaller;
 ...
 */
public class ListJobStatusResponseUnmarshallerTest extends TestCase {

    @Test
    public void testUnmarshall(){

        ListJobStatusResponse response = new ListJobStatusResponse();
        ...
        String body = FileLoader.loadFile("resources/listJobStatus.json");
        ...
        try {
            ListJobStatusResponseUnmarshaller.unmarshall(response, context);
        } catch (ServerException e) {
            e.printStackTrace();
        }

        List<JobStatus> list = response.getJobStatusList();
