 ...
 * @version 
 */
public class ListInstancesRequest extends BatchComputeRequest<ListInstancesResponse> {
	
	public ListInstancesRequest() {
		super("BatchCompute", "2015-11-11", "ListInstances");
		setUriPattern("/jobs/[ResourceName]/tasks/[TaskName]/instances");
