 ...
 * @version 
 */
public class DeleteImageRequest extends BatchComputeRequest<DeleteImageResponse> {

	public DeleteImageRequest() {
		super("BatchCompute", "2015-11-11", "DeleteImage");
		setUriPattern("/images/[ResourceName]");
