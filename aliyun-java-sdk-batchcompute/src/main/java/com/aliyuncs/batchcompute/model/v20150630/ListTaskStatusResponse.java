 ...
 * @author auto create
 */
public class ListTaskStatusResponse extends BatchComputeResponse {
    ...
    @Override
    public ListTaskStatusResponse getInstance(UnmarshallerContext context) throws ServerException {
        return ListTaskStatusResponseUnmarshaller.unmarshall(this, context);
    }
}
