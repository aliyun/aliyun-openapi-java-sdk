 ...
 * @version 
 */
public class GetImageRequest extends BatchComputeRequest<GetImageResponse> {

	public GetImageRequest() {
		super("BatchCompute", "2015-11-11", "GetImage");
		setUriPattern("/images/[imageId]");
	...
	public void setImageId(String imageId) {
		...
		putPathParameter("imageId", imageId);
	}
