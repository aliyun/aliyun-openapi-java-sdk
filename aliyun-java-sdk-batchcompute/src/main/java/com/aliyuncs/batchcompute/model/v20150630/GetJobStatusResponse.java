 ...
 * @author auto create
 */
public class GetJobStatusResponse extends BatchComputeResponse {
    ...
    @Override
    public GetJobStatusResponse getInstance(UnmarshallerContext context) throws ServerException {
