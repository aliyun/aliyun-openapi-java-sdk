 ...
 * @version 
 */
public class GetClusterInstanceRequest extends BatchComputeRequest<GetClusterInstanceResponse> {
	...
	public GetClusterInstanceRequest(String clusterId, String groupName, String instanceId) {
		super("BatchCompute", "2015-11-11", "GetCluster");
		setUriPattern("/clusters/[ClusterId]/groups/[GroupName]/instances/[InstanceId]");
		setMethod(MethodType.GET);
