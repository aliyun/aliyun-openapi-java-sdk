...
public class CreateClusterResponseUnmarshaller {
	...
	public static CreateClusterResponse unmarshall(CreateClusterResponse createClusterResponse, UnmarshallerContext context) throws ServerException {
		...
		try {
			...
			throw new ServerException("API.EncodeError", "encode response body error", createClusterResponse.getRequestId());
		} catch (IOException e) {
			throw new ServerException("API.EncodeError", "encode response body error", createClusterResponse.getRequestId());
		}
