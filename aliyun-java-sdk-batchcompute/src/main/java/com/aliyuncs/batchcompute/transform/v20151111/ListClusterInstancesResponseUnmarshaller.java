...
public class ListClusterInstancesResponseUnmarshaller {

	public static ListClusterInstancesResponse unmarshall(ListClusterInstancesResponse res, UnmarshallerContext context) throws ServerException {
	...
	private static void setContent(String body, ListClusterInstancesResponse res) throws IOException {
		ObjectMapper mapper = new ObjectMapper();

		MarkableResult<ClusterInstance> result = mapper.readValue(body,
				new TypeReference<MarkableResult<ClusterInstance>>() {
				});

		res.setItems(result.getItems());
		res.setNextMarker(result.getNextMarker());
	}
}