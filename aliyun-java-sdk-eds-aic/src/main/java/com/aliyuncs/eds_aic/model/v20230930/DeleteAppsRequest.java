 ...
 * @version 
 */
public class DeleteAppsRequest extends RpcAcsRequest<DeleteAppsResponse> {
	   

	private List<String> appIdLists;
	public DeleteAppsRequest() {
		super("eds-aic", "2023-09-30", "DeleteApps");
	...
	@Override
	public Class<DeleteAppsResponse> getResponseClass() {
		return DeleteAppsResponse.class;
	}
