 ...
 * @version 
 */
public class UninstallMonitorAgentRequest extends RpcAcsRequest<UninstallMonitorAgentResponse> {
	   

	private List<String> androidInstanceIdss;

	private String saleMode;
	public UninstallMonitorAgentRequest() {
		super("eds-aic", "2023-09-30", "UninstallMonitorAgent");
	...
	@Override
	public Class<UninstallMonitorAgentResponse> getResponseClass() {
		return UninstallMonitorAgentResponse.class;
	}
