 ...
 * @version 
 */
public class ModifySystemPropertyTemplateRequest extends RpcAcsRequest<ModifySystemPropertyTemplateResponse> {
	...
	public ModifySystemPropertyTemplateRequest() {
		super("eds-aic", "2023-09-30", "ModifySystemPropertyTemplate");
	...
	@Override
	public Class<ModifySystemPropertyTemplateResponse> getResponseClass() {
		return ModifySystemPropertyTemplateResponse.class;
	}
