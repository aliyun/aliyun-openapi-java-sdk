 ...
 * @version 
 */
public class RebootAndroidInstancesInGroupRequest extends RpcAcsRequest<RebootAndroidInstancesInGroupResponse> {
	...
	public RebootAndroidInstancesInGroupRequest() {
		super("eds-aic", "2023-09-30", "RebootAndroidInstancesInGroup");
	...
	@Override
	public Class<RebootAndroidInstancesInGroupResponse> getResponseClass() {
		return RebootAndroidInstancesInGroupResponse.class;
	}
