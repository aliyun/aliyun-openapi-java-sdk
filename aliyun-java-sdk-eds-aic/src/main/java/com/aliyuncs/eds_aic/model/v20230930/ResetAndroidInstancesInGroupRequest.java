 ...
 * @version 
 */
public class ResetAndroidInstancesInGroupRequest extends RpcAcsRequest<ResetAndroidInstancesInGroupResponse> {
	...
	public ResetAndroidInstancesInGroupRequest() {
		super("eds-aic", "2023-09-30", "ResetAndroidInstancesInGroup");
	...
	public void setSettingResetType(Integer settingResetType) {
		this.settingResetType = settingResetType;
		if(settingResetType != null){
			putQueryParameter("SettingResetType", settingResetType.toString());
		}
	}
	...
	@Override
	public Class<ResetAndroidInstancesInGroupResponse> getResponseClass() {
		return ResetAndroidInstancesInGroupResponse.class;
	}
