 ...
 * @version 
 */
public class DeleteAndroidInstanceGroupRequest extends RpcAcsRequest<DeleteAndroidInstanceGroupResponse> {
	   

	private List<String> instanceGroupIdss;
	public DeleteAndroidInstanceGroupRequest() {
		super("eds-aic", "2023-09-30", "DeleteAndroidInstanceGroup");
	...
	@Override
	public Class<DeleteAndroidInstanceGroupResponse> getResponseClass() {
		return DeleteAndroidInstanceGroupResponse.class;
	}
