 ...
 * @version 
 */
public class StartAndroidInstanceRequest extends RpcAcsRequest<StartAndroidInstanceResponse> {
	   

	private List<String> androidInstanceIdss;

	private String saleMode;
	public StartAndroidInstanceRequest() {
		super("eds-aic", "2023-09-30", "StartAndroidInstance");
	...
	@Override
	public Class<StartAndroidInstanceResponse> getResponseClass() {
		return StartAndroidInstanceResponse.class;
	}
