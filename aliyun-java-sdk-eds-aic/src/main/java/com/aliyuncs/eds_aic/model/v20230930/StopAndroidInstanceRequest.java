 ...
 * @version 
 */
public class StopAndroidInstanceRequest extends RpcAcsRequest<StopAndroidInstanceResponse> {
	...
	public StopAndroidInstanceRequest() {
		super("eds-aic", "2023-09-30", "StopAndroidInstance");
	...
	@Override
	public Class<StopAndroidInstanceResponse> getResponseClass() {
		return StopAndroidInstanceResponse.class;
	}
