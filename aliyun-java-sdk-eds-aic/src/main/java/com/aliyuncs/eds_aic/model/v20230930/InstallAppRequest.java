 ...
 * @version 
 */
public class InstallAppRequest extends RpcAcsRequest<InstallAppResponse> {
	...
	public InstallAppRequest() {
		super("eds-aic", "2023-09-30", "InstallApp");
	...
	@Override
	public Class<InstallAppResponse> getResponseClass() {
		return InstallAppResponse.class;
	}
