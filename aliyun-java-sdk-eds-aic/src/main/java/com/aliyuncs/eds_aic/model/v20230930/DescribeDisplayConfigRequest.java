 ...
 * @version 
 */
public class DescribeDisplayConfigRequest extends RpcAcsRequest<DescribeDisplayConfigResponse> {
	   

	private List<String> androidInstanceIdss;
	public DescribeDisplayConfigRequest() {
		super("eds-aic", "2023-09-30", "DescribeDisplayConfig");
	...
	@Override
	public Class<DescribeDisplayConfigResponse> getResponseClass() {
		return DescribeDisplayConfigResponse.class;
	}
