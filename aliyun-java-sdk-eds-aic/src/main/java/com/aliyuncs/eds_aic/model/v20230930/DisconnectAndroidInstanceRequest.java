 ...
 * @version 
 */
public class DisconnectAndroidInstanceRequest extends RpcAcsRequest<DisconnectAndroidInstanceResponse> {
	   

	private List<String> instanceIdss;

	private String endUserId;
	public DisconnectAndroidInstanceRequest() {
		super("eds-aic", "2023-09-30", "DisconnectAndroidInstance");
	...
	@Override
	public Class<DisconnectAndroidInstanceResponse> getResponseClass() {
		return DisconnectAndroidInstanceResponse.class;
	}
