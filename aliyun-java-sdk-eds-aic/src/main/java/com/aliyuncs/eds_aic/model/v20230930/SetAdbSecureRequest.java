 ...
 * @version 
 */
public class SetAdbSecureRequest extends RpcAcsRequest<SetAdbSecureResponse> {
	   

	private List<String> instanceIdss;

	private Integer status;
	public SetAdbSecureRequest() {
		super("eds-aic", "2023-09-30", "SetAdbSecure");
	...
	@Override
	public Class<SetAdbSecureResponse> getResponseClass() {
		return SetAdbSecureResponse.class;
	}
