...
public class GetCallInVoiceRecordURLResponse extends AcsResponse {
	...
	private String callInVoiceRecordUrl;
	...
	public String getCallInVoiceRecordUrl() {
		return this.callInVoiceRecordUrl;
	}

	public void setCallInVoiceRecordUrl(String callInVoiceRecordUrl) {
		this.callInVoiceRecordUrl = callInVoiceRecordUrl;
	}
