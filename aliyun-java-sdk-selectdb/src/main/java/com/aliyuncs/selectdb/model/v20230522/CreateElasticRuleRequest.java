 ...
 * @version 
 */
public class CreateElasticRuleRequest extends RpcAcsRequest<CreateElasticRuleResponse> {
	...
	public CreateElasticRuleRequest() {
		super("selectdb", "2023-05-22", "CreateElasticRule");
	...
	@Override
	public Class<CreateElasticRuleResponse> getResponseClass() {
		return CreateElasticRuleResponse.class;
	}
