 ...
 * @version 
 */
public class GetModifyBEClusterInquiryRequest extends RpcAcsRequest<GetModifyBEClusterInquiryResponse> {
	...
	public GetModifyBEClusterInquiryRequest() {
		super("selectdb", "2023-05-22", "GetModifyBEClusterInquiry");
	...
	@Override
	public Class<GetModifyBEClusterInquiryResponse> getResponseClass() {
		return GetModifyBEClusterInquiryResponse.class;
	}
