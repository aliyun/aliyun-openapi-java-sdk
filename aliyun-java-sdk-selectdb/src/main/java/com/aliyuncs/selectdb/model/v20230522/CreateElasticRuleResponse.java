...
import com.aliyuncs.selectdb.transform.v20230522.CreateElasticRuleResponseUnmarshaller;
 ...
 * @version 
 */
public class CreateElasticRuleResponse extends AcsResponse {
	...
	@Override
	public CreateElasticRuleResponse getInstance(UnmarshallerContext context) {
		return	CreateElasticRuleResponseUnmarshaller.unmarshall(this, context);
	}
