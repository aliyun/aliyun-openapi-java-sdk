 ...
 * @version 
 */
public class CheckCreateDBInstanceRequest extends RpcAcsRequest<CheckCreateDBInstanceResponse> {
	...
	public CheckCreateDBInstanceRequest() {
		super("selectdb", "2023-05-22", "CheckCreateDBInstance");
	...
	@Override
	public Class<CheckCreateDBInstanceResponse> getResponseClass() {
		return CheckCreateDBInstanceResponse.class;
	}
