...
import com.aliyuncs.selectdb.transform.v20230522.DescribeElasticRulesResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeElasticRulesResponse extends AcsResponse {
	...
	@Override
	public DescribeElasticRulesResponse getInstance(UnmarshallerContext context) {
		return	DescribeElasticRulesResponseUnmarshaller.unmarshall(this, context);
	}
