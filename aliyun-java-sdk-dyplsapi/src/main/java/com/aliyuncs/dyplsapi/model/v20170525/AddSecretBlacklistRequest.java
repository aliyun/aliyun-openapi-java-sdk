 ...
 * @version 
 */
public class AddSecretBlacklistRequest extends RpcAcsRequest<AddSecretBlacklistResponse> {
	...
	@Override
	public Class<AddSecretBlacklistResponse> getResponseClass() {
		return AddSecretBlacklistResponse.class;
	}
