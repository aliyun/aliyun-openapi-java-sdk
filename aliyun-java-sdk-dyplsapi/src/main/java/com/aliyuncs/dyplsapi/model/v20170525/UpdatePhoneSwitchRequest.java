 ...
 * @version 
 */
public class UpdatePhoneSwitchRequest extends RpcAcsRequest<UpdatePhoneSwitchResponse> {
	...
	@Override
	public Class<UpdatePhoneSwitchResponse> getResponseClass() {
		return UpdatePhoneSwitchResponse.class;
	}
