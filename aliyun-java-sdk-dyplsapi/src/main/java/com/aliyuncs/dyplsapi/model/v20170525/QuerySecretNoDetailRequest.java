 ...
 * @version 
 */
public class QuerySecretNoDetailRequest extends RpcAcsRequest<QuerySecretNoDetailResponse> {
	...
	@Override
	public Class<QuerySecretNoDetailResponse> getResponseClass() {
		return QuerySecretNoDetailResponse.class;
	}
