 ...
 * @version 
 */
public class GetXConfigRequest extends RpcAcsRequest<GetXConfigResponse> {
	...
	public GetXConfigRequest() {
		super("Dyplsapi", "2017-05-25", "GetXConfig", "dypls");
	...
	@Override
	public Class<GetXConfigResponse> getResponseClass() {
		return GetXConfigResponse.class;
	}
