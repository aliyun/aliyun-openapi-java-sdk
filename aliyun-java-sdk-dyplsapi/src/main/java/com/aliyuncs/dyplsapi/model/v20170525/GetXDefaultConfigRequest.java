 ...
 * @version 
 */
public class GetXDefaultConfigRequest extends RpcAcsRequest<GetXDefaultConfigResponse> {
	...
	public GetXDefaultConfigRequest() {
		super("Dyplsapi", "2017-05-25", "GetXDefaultConfig", "dypls");
	...
	@Override
	public Class<GetXDefaultConfigResponse> getResponseClass() {
		return GetXDefaultConfigResponse.class;
	}
