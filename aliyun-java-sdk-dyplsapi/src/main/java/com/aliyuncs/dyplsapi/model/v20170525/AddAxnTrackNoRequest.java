 ...
 * @version 
 */
public class AddAxnTrackNoRequest extends RpcAcsRequest<AddAxnTrackNoResponse> {
	...
	@Override
	public Class<AddAxnTrackNoResponse> getResponseClass() {
		return AddAxnTrackNoResponse.class;
	}
