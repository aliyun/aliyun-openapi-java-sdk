...
import com.aliyuncs.dyplsapi.transform.v20170525.GetXDefaultConfigResponseUnmarshaller;
 ...
 * @version 
 */
public class GetXDefaultConfigResponse extends AcsResponse {
	...
	public static class Data {
		...
		private List<ReachJsonItem> reachJson;

		private List<SequenceCallItem> sequenceCall;
		...
		public List<ReachJsonItem> getReachJson() {
			return this.reachJson;
		}

		public void setReachJson(List<ReachJsonItem> reachJson) {
			this.reachJson = reachJson;
		}

		public List<SequenceCallItem> getSequenceCall() {
			return this.sequenceCall;
		}

		public void setSequenceCall(List<SequenceCallItem> sequenceCall) {
			this.sequenceCall = sequenceCall;
		}

		public static class ReachJsonItem {
		...
		public static class SequenceCallItem {
	...
	@Override
	public GetXDefaultConfigResponse getInstance(UnmarshallerContext context) {
		return	GetXDefaultConfigResponseUnmarshaller.unmarshall(this, context);
	}
