 ...
 * @version 
 */
public class GetSubscriptionDetailRequest extends RpcAcsRequest<GetSubscriptionDetailResponse> {
	...
	@Override
	public Class<GetSubscriptionDetailResponse> getResponseClass() {
		return GetSubscriptionDetailResponse.class;
	}
