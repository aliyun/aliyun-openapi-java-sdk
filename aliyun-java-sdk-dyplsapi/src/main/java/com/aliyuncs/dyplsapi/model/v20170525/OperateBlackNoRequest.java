 ...
 * @version 
 */
public class OperateBlackNoRequest extends RpcAcsRequest<OperateBlackNoResponse> {
	...
	public OperateBlackNoRequest() {
		super("Dyplsapi", "2017-05-25", "OperateBlackNo");
	...
	@Override
	public Class<OperateBlackNoResponse> getResponseClass() {
		return OperateBlackNoResponse.class;
	}
