...
import com.aliyuncs.dyplsapi.transform.v20170525.BindAxbResponseUnmarshaller;
 ...
 * @version 
 */
public class BindAxbResponse extends AcsResponse {
	...
	@Override
	public BindAxbResponse getInstance(UnmarshallerContext context) {
		return	BindAxbResponseUnmarshaller.unmarshall(this, context);
	}
}
