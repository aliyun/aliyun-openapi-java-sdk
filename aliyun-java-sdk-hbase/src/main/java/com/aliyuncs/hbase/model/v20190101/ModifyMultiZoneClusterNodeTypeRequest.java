 ...
 * @version 
 */
public class ModifyMultiZoneClusterNodeTypeRequest extends RpcAcsRequest<ModifyMultiZoneClusterNodeTypeResponse> {
	...
	@Override
	public Class<ModifyMultiZoneClusterNodeTypeResponse> getResponseClass() {
		return ModifyMultiZoneClusterNodeTypeResponse.class;
	}
