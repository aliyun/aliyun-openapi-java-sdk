...
import com.aliyuncs.hbase.transform.v20190101.DescribeMultiZoneAvailableResourceResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeMultiZoneAvailableResourceResponse extends AcsResponse {
	...
	@Override
	public DescribeMultiZoneAvailableResourceResponse getInstance(UnmarshallerContext context) {
		return	DescribeMultiZoneAvailableResourceResponseUnmarshaller.unmarshall(this, context);
	}
}
