 ...
 * @version 
 */
public class QueryXpackRelatedDBRequest extends RpcAcsRequest<QueryXpackRelatedDBResponse> {
	
	public QueryXpackRelatedDBRequest() {
		super("HBase", "2017-01-15", "QueryXpackRelatedDB");
	}
	...
	@Override
	public Class<QueryXpackRelatedDBResponse> getResponseClass() {
		return QueryXpackRelatedDBResponse.class;
	}
