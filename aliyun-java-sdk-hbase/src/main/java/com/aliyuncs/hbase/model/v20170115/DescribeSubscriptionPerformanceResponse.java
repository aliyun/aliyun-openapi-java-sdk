...
import com.aliyuncs.hbase.transform.v20170115.DescribeSubscriptionPerformanceResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeSubscriptionPerformanceResponse extends AcsResponse {
	...
	@Override
	public DescribeSubscriptionPerformanceResponse getInstance(UnmarshallerContext context) {
		return	DescribeSubscriptionPerformanceResponseUnmarshaller.unmarshall(this, context);
	}
