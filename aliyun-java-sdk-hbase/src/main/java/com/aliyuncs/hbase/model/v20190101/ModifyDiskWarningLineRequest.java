 ...
 * @version 
 */
public class ModifyDiskWarningLineRequest extends RpcAcsRequest<ModifyDiskWarningLineResponse> {
	...
	public void setWarningLine(Integer warningLine) {
		...
		if(warningLine != null){
			putQueryParameter("WarningLine", warningLine.toString());
		}
	}

	@Override
	public Class<ModifyDiskWarningLineResponse> getResponseClass() {
		return ModifyDiskWarningLineResponse.class;
	}
