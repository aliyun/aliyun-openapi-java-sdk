...
public class CreateServerlessClusterRequest extends RpcAcsRequest<CreateServerlessClusterResponse> {
	...
	public void setServerlessCapability(Integer serverlessCapability) {
		this.serverlessCapability = serverlessCapability;
		if(serverlessCapability != null){
			putQueryParameter("ServerlessCapability", serverlessCapability.toString());
		}
	}
	...
	public void setServerlessStorage(Integer serverlessStorage) {
		this.serverlessStorage = serverlessStorage;
		if(serverlessStorage != null){
			putQueryParameter("ServerlessStorage", serverlessStorage.toString());
		}
	}
	...
	public void setServerlessSpec(String serverlessSpec) {
		this.serverlessSpec = serverlessSpec;
		if(serverlessSpec != null){
			putQueryParameter("ServerlessSpec", serverlessSpec);
		}
	}

	@Override
	public Class<CreateServerlessClusterResponse> getResponseClass() {
