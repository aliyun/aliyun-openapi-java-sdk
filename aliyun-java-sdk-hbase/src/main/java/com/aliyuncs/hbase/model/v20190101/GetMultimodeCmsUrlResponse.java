...
import com.aliyuncs.hbase.transform.v20190101.GetMultimodeCmsUrlResponseUnmarshaller;
...
public class GetMultimodeCmsUrlResponse extends AcsResponse {
	...
	@Override
	public GetMultimodeCmsUrlResponse getInstance(UnmarshallerContext context) {
		return	GetMultimodeCmsUrlResponseUnmarshaller.unmarshall(this, context);
	}
}
