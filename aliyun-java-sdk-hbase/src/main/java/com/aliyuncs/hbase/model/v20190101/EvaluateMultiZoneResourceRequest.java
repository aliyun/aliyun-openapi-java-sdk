 ...
 * @version 
 */
public class EvaluateMultiZoneResourceRequest extends RpcAcsRequest<EvaluateMultiZoneResourceResponse> {
	...
	@Override
	public Class<EvaluateMultiZoneResourceResponse> getResponseClass() {
		return EvaluateMultiZoneResourceResponse.class;
	}
