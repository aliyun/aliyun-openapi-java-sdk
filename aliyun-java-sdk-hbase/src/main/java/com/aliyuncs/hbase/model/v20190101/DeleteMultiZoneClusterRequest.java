 ...
 * @version 
 */
public class DeleteMultiZoneClusterRequest extends RpcAcsRequest<DeleteMultiZoneClusterResponse> {
	...
	@Override
	public Class<DeleteMultiZoneClusterResponse> getResponseClass() {
		return DeleteMultiZoneClusterResponse.class;
	}
