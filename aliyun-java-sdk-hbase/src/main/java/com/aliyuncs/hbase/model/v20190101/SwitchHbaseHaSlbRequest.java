 ...
 * @version 
 */
public class SwitchHbaseHaSlbRequest extends RpcAcsRequest<SwitchHbaseHaSlbResponse> {
	...
	@Override
	public Class<SwitchHbaseHaSlbResponse> getResponseClass() {
		return SwitchHbaseHaSlbResponse.class;
	}
