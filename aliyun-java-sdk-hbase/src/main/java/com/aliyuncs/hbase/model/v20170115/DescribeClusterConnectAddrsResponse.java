...
import com.aliyuncs.hbase.transform.v20170115.DescribeClusterConnectAddrsResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeClusterConnectAddrsResponse extends AcsResponse {
	...
	@Override
	public DescribeClusterConnectAddrsResponse getInstance(UnmarshallerContext context) {
		return	DescribeClusterConnectAddrsResponseUnmarshaller.unmarshall(this, context);
	}
}
