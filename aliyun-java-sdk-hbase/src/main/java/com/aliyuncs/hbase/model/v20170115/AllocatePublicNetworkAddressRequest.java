...
public class AllocatePublicNetworkAddressRequest extends RpcAcsRequest<AllocatePublicNetworkAddressResponse> {
	...
	public AllocatePublicNetworkAddressRequest() {
		super("HBase", "2017-01-15", "AllocatePublicNetworkAddress");
	}
	...
	@Override
	public Class<AllocatePublicNetworkAddressResponse> getResponseClass() {
		return AllocatePublicNetworkAddressResponse.class;
	}
