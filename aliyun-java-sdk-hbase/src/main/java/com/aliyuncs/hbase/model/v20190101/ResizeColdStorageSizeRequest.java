 ...
 * @version 
 */
public class ResizeColdStorageSizeRequest extends RpcAcsRequest<ResizeColdStorageSizeResponse> {
	...
	@Override
	public Class<ResizeColdStorageSizeResponse> getResponseClass() {
		return ResizeColdStorageSizeResponse.class;
	}
