...
public class BruteforceLogResponse extends AcsResponse {
	...
	public void setLogList(List<BruteforceLog> logList) {
	...
	@Override
	public BruteforceLogResponse getInstance(UnmarshallerContext context) {
		return	BruteforceLogResponseUnmarshaller.unmarshall(this, context);
	}
}
