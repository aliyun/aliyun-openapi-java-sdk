 ...
 * @version 
 */
public class WebshellLogRequest extends RpcAcsRequest<WebshellLogResponse> {
	
	public WebshellLogRequest() {
		super("Yundun", "2015-04-16", "WebshellLog");
	}
	...
	@Override
	public Class<WebshellLogResponse> getResponseClass() {
		return WebshellLogResponse.class;
	}
