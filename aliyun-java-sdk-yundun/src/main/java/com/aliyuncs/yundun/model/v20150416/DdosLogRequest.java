 ...
 * @version 
 */
public class DdosLogRequest extends RpcAcsRequest<DdosLogResponse> {
	
	public DdosLogRequest() {
		super("Yundun", "2015-04-16", "DdosLog");
	}
	...
	@Override
	public Class<DdosLogResponse> getResponseClass() {
		return DdosLogResponse.class;
	}
