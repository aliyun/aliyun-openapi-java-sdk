...
import com.aliyuncs.marketplaceintl.transform.v20221230.NoticeInstanceUserResponseUnmarshaller;
 ...
 * @version 
 */
public class NoticeInstanceUserResponse extends AcsResponse {
	...
	@Override
	public NoticeInstanceUserResponse getInstance(UnmarshallerContext context) {
		return	NoticeInstanceUserResponseUnmarshaller.unmarshall(this, context);
	}
