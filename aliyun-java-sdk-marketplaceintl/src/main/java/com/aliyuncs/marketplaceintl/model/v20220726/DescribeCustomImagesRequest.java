 ...
 * @version 
 */
public class DescribeCustomImagesRequest extends RpcAcsRequest<DescribeCustomImagesResponse> {
	...
	public DescribeCustomImagesRequest() {
		super("marketplaceIntl", "2022-07-26", "DescribeCustomImages");
	...
	@Override
	public Class<DescribeCustomImagesResponse> getResponseClass() {
		return DescribeCustomImagesResponse.class;
	}
