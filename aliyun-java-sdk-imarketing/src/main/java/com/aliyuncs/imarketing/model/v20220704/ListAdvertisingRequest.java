 ...
 * @version 
 */
public class ListAdvertisingRequest extends RpcAcsRequest<ListAdvertisingResponse> {
	...
	public ListAdvertisingRequest() {
		super("imarketing", "2022-07-04", "ListAdvertising");
	...
	@Override
	public Class<ListAdvertisingResponse> getResponseClass() {
		return ListAdvertisingResponse.class;
	}
