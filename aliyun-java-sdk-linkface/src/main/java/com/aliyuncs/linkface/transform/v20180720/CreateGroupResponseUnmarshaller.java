...
public class CreateGroupResponseUnmarshaller {
	...
	public static CreateGroupResponse unmarshall(CreateGroupResponse createGroupResponse, UnmarshallerContext context) {
		...
		createGroupResponse.setCode(context.integerValue("CreateGroupResponse.Code"));
		createGroupResponse.setMessage(context.stringValue("CreateGroupResponse.Message"));
		createGroupResponse.setSuccess(context.booleanValue("CreateGroupResponse.Success"));
