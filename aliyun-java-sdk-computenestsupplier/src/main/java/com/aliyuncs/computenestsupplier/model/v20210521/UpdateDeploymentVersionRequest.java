 ...
 * @version 
 */
public class UpdateDeploymentVersionRequest extends RpcAcsRequest<UpdateDeploymentVersionResponse> {
	...
	public UpdateDeploymentVersionRequest() {
		super("ComputeNestSupplier", "2021-05-21", "UpdateDeploymentVersion");
	...
	@Override
	public Class<UpdateDeploymentVersionResponse> getResponseClass() {
		return UpdateDeploymentVersionResponse.class;
	}
