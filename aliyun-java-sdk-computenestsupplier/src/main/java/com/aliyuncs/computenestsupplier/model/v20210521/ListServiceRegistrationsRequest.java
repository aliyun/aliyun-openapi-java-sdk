 ...
 * @version 
 */
public class ListServiceRegistrationsRequest extends RpcAcsRequest<ListServiceRegistrationsResponse> {
	...
	public ListServiceRegistrationsRequest() {
		super("ComputeNestSupplier", "2021-05-21", "ListServiceRegistrations");
	...
	@Override
	public Class<ListServiceRegistrationsResponse> getResponseClass() {
		return ListServiceRegistrationsResponse.class;
	}
