 ...
 * @version 
 */
public class CreateDeploymentVersionRequest extends RpcAcsRequest<CreateDeploymentVersionResponse> {
	...
	public CreateDeploymentVersionRequest() {
		super("ComputeNestSupplier", "2021-05-21", "CreateDeploymentVersion");
	...
	@Override
	public Class<CreateDeploymentVersionResponse> getResponseClass() {
		return CreateDeploymentVersionResponse.class;
	}
