 ...
 * @version 
 */
public class GetDataStreamRequest extends RoaAcsRequest<GetDataStreamResponse> {
	...
	public GetDataStreamRequest() {
		super("es-serverless", "2022-08-22", "GetDataStream", "elkxops");
	...
	@Override
	public Class<GetDataStreamResponse> getResponseClass() {
		return GetDataStreamResponse.class;
	}
