...
import com.aliyuncs.es_serverless.model.v20220822.DeleteAppResponse;
import com.aliyuncs.es_serverless.model.v20220822.DeleteAppResponse.Result;
...
public class DeleteAppResponseUnmarshaller {
	...
	public static DeleteAppResponse unmarshall(DeleteAppResponse deleteAppResponse, UnmarshallerContext _ctx) {
		...
		result.setInstanceId(_ctx.stringValue("DeleteAppResponse.result.instanceId"));
		deleteAppResponse.setResult(result);
