 ...
 * @version 
 */
public class GetVersionIdByBusinessInfoRequest extends RpcAcsRequest<GetVersionIdByBusinessInfoResponse> {
	
	public GetVersionIdByBusinessInfoRequest() {
		super("Zhuque", "2016-07-01", "GetVersionIdByBusinessInfo");
	}
	...
	@Override
	public Class<GetVersionIdByBusinessInfoResponse> getResponseClass() {
		return GetVersionIdByBusinessInfoResponse.class;
	}
