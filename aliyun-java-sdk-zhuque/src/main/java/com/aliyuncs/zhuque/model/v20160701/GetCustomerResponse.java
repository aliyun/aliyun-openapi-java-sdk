...
import com.aliyuncs.zhuque.transform.v20160701.GetCustomerResponseUnmarshaller;
 ...
 * @version 
 */
public class GetCustomerResponse extends AcsResponse {
	...
	@Override
	public GetCustomerResponse getInstance(UnmarshallerContext context) {
		return	GetCustomerResponseUnmarshaller.unmarshall(this, context);
	}
}
