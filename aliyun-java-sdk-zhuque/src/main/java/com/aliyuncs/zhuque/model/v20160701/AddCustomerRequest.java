 ...
 * @version 
 */
public class AddCustomerRequest extends RpcAcsRequest<AddCustomerResponse> {
	
	public AddCustomerRequest() {
		super("Zhuque", "2016-07-01", "AddCustomer");
	}
	...
	public void setCustomerOrigin(String customerOrigin) {
		...
		if(customerOrigin != null){
			putQueryParameter("CustomerOrigin", customerOrigin);
		}
	}
	...
	@Override
	public Class<AddCustomerResponse> getResponseClass() {
		return AddCustomerResponse.class;
	}
