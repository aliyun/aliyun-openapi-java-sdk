 ...
 * @version 
 */
public class ListProjectsByBusinessIdRequest extends RpcAcsRequest<ListProjectsByBusinessIdResponse> {
	
	public ListProjectsByBusinessIdRequest() {
		super("Zhuque", "2016-07-01", "ListProjectsByBusinessId");
	}
	...
	@Override
	public Class<ListProjectsByBusinessIdResponse> getResponseClass() {
		return ListProjectsByBusinessIdResponse.class;
	}
