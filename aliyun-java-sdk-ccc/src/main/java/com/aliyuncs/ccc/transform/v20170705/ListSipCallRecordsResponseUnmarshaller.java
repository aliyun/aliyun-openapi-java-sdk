...
import com.aliyuncs.ccc.model.v20170705.ListSipCallRecordsResponse;
import com.aliyuncs.ccc.model.v20170705.ListSipCallRecordsResponse.SipCallRecords;
...
public class ListSipCallRecordsResponseUnmarshaller {
	...
	public static ListSipCallRecordsResponse unmarshall(ListSipCallRecordsResponse listSipCallRecordsResponse, UnmarshallerContext _ctx) {
		...
		for (int i = 0; i < _ctx.lengthValue("ListSipCallRecordsResponse.Data.Length"); i++) {
			...
			sipCallRecords.setReleaseInitiator(_ctx.stringValue("ListSipCallRecordsResponse.Data["+ i +"].ReleaseInitiator"));
			sipCallRecords.setLastResponseCode(_ctx.stringValue("ListSipCallRecordsResponse.Data["+ i +"].LastResponseCode"));
			sipCallRecords.setLastResponseText(_ctx.stringValue("ListSipCallRecordsResponse.Data["+ i +"].LastResponseText"));
			sipCallRecords.setStartTime(_ctx.longValue("ListSipCallRecordsResponse.Data["+ i +"].StartTime"));
			sipCallRecords.setEndTime(_ctx.longValue("ListSipCallRecordsResponse.Data["+ i +"].EndTime"));
			...
			sipCallRecords.setCarrierResponse(_ctx.stringValue("ListSipCallRecordsResponse.Data["+ i +"].CarrierResponse"));
