 ...
 * @version 
 */
public class AddPhoneNumberToSkillGroupsRequest extends RpcAcsRequest<AddPhoneNumberToSkillGroupsResponse> {
	...
	@Override
	public Class<AddPhoneNumberToSkillGroupsResponse> getResponseClass() {
		return AddPhoneNumberToSkillGroupsResponse.class;
	}
