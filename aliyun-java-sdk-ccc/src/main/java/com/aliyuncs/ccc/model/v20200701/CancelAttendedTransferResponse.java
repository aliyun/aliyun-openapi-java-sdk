...
import com.aliyuncs.ccc.transform.v20200701.CancelAttendedTransferResponseUnmarshaller;
 ...
 * @version 
 */
public class CancelAttendedTransferResponse extends AcsResponse {
	...
	@Override
	public CancelAttendedTransferResponse getInstance(UnmarshallerContext context) {
		return	CancelAttendedTransferResponseUnmarshaller.unmarshall(this, context);
	}
