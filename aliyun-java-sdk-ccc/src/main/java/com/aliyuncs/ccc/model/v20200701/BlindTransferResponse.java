...
import com.aliyuncs.ccc.transform.v20200701.BlindTransferResponseUnmarshaller;
 ...
 * @version 
 */
public class BlindTransferResponse extends AcsResponse {
	...
	@Override
	public BlindTransferResponse getInstance(UnmarshallerContext context) {
		return	BlindTransferResponseUnmarshaller.unmarshall(this, context);
	}
