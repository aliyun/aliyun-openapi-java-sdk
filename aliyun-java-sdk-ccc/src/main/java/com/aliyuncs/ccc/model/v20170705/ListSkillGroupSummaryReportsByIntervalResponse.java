...
import com.aliyuncs.ccc.transform.v20170705.ListSkillGroupSummaryReportsByIntervalResponseUnmarshaller;
...
public class ListSkillGroupSummaryReportsByIntervalResponse extends AcsResponse {
	...
	public static class PagedSkillGroupSummaryReport {
		...
		private List<SkillGroupTimeIntervalReport> list;
		...
		public List<SkillGroupTimeIntervalReport> getList() {
			return this.list;
		}

		public void setList(List<SkillGroupTimeIntervalReport> list) {
			this.list = list;
		}

		public static class SkillGroupTimeIntervalReport {

			private String skillGroupId;

			private List<SkillGroupSummaryReport> intervalList;
			...
			public List<SkillGroupSummaryReport> getIntervalList() {
				return this.intervalList;
			}

			public void setIntervalList(List<SkillGroupSummaryReport> intervalList) {
