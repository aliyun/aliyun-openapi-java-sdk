...
import com.aliyuncs.ccc.transform.v20200701.MonitorCallResponseUnmarshaller;
 ...
 * @version 
 */
public class MonitorCallResponse extends AcsResponse {
	...
	@Override
	public MonitorCallResponse getInstance(UnmarshallerContext context) {
		return	MonitorCallResponseUnmarshaller.unmarshall(this, context);
	}
