 ...
 * @version 
 */
public class PredictiveRecordFailureRequest extends RpcAcsRequest<PredictiveRecordFailureResponse> {
	
	public PredictiveRecordFailureRequest() {
		super("CCC", "2017-07-05", "PredictiveRecordFailure");
	...
	@Override
	public Class<PredictiveRecordFailureResponse> getResponseClass() {
		return PredictiveRecordFailureResponse.class;
	}
