 ...
 * @version 
 */
public class SignInGroupRequest extends RpcAcsRequest<SignInGroupResponse> {
	...
	@Override
	public Class<SignInGroupResponse> getResponseClass() {
		return SignInGroupResponse.class;
	}
