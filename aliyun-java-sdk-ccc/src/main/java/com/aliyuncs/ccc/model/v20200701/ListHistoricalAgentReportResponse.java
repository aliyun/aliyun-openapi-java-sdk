	...
	public static class Data {
		...
		public static class Items {
			...
			public static class Inbound {
				...
				public Long getCallsTransfered() {
					return this.callsTransfered;
				}

				public void setCallsTransfered(Long callsTransfered) {
					this.callsTransfered = callsTransfered;
				}
