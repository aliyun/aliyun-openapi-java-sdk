 ...
 * @version 
 */
public class CreateCallTagsRequest extends RpcAcsRequest<CreateCallTagsResponse> {
	...
	@Override
	public Class<CreateCallTagsResponse> getResponseClass() {
		return CreateCallTagsResponse.class;
	}
