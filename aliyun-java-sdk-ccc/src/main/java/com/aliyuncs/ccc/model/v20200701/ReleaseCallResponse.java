...
import com.aliyuncs.ccc.transform.v20200701.ReleaseCallResponseUnmarshaller;
 ...
 * @version 
 */
public class ReleaseCallResponse extends AcsResponse {
	...
	@Override
	public ReleaseCallResponse getInstance(UnmarshallerContext context) {
		return	ReleaseCallResponseUnmarshaller.unmarshall(this, context);
	}
