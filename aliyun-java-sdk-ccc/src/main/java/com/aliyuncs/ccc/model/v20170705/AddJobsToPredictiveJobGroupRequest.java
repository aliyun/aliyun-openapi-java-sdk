 ...
 * @version 
 */
public class AddJobsToPredictiveJobGroupRequest extends RpcAcsRequest<AddJobsToPredictiveJobGroupResponse> {
	...
	public AddJobsToPredictiveJobGroupRequest() {
		super("CCC", "2017-07-05", "AddJobsToPredictiveJobGroup");
	...
	@Override
	public Class<AddJobsToPredictiveJobGroupResponse> getResponseClass() {
		return AddJobsToPredictiveJobGroupResponse.class;
	}
