 ...
 * @version 
 */
public class ReadyForServiceRequest extends RpcAcsRequest<ReadyForServiceResponse> {
	...
	@Override
	public Class<ReadyForServiceResponse> getResponseClass() {
		return ReadyForServiceResponse.class;
	}
