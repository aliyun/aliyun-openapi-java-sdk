 ...
 * @version 
 */
public class MuteCallResponse extends AcsResponse {
	...
	@Override
	public MuteCallResponse getInstance(UnmarshallerContext context) {
		return	MuteCallResponseUnmarshaller.unmarshall(this, context);
	}
