...
import com.aliyuncs.ccc.transform.v20200701.CompleteAttendedTransferResponseUnmarshaller;
 ...
 * @version 
 */
public class CompleteAttendedTransferResponse extends AcsResponse {
	...
	@Override
	public CompleteAttendedTransferResponse getInstance(UnmarshallerContext context) {
		return	CompleteAttendedTransferResponseUnmarshaller.unmarshall(this, context);
	}
