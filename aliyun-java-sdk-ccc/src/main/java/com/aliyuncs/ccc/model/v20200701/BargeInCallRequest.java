 ...
 * @version 
 */
public class BargeInCallRequest extends RpcAcsRequest<BargeInCallResponse> {
	...
	public void setBargedUserId(String bargedUserId) {
		this.bargedUserId = bargedUserId;
		if(bargedUserId != null){
			putQueryParameter("BargedUserId", bargedUserId);
		}
	}
	...
	@Override
	public Class<BargeInCallResponse> getResponseClass() {
