 ...
 * @version 
 */
public class ListHistoricalAgentSkillGroupReportRequest extends RpcAcsRequest<ListHistoricalAgentSkillGroupReportResponse> {
	...
	@Override
	public Class<ListHistoricalAgentSkillGroupReportResponse> getResponseClass() {
		return ListHistoricalAgentSkillGroupReportResponse.class;
	}
