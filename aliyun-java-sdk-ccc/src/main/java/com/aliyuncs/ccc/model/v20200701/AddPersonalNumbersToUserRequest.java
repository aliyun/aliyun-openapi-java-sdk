 ...
 * @version 
 */
public class AddPersonalNumbersToUserRequest extends RpcAcsRequest<AddPersonalNumbersToUserResponse> {
	...
	@Override
	public Class<AddPersonalNumbersToUserResponse> getResponseClass() {
