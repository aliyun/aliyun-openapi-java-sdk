 ...
 * @version 
 */
public class ListWaitingChatsRequest extends RpcAcsRequest<ListWaitingChatsResponse> {
	...
	public ListWaitingChatsRequest() {
		super("CCC", "2020-07-01", "ListWaitingChats", "CCC");
	...
	@Override
	public Class<ListWaitingChatsResponse> getResponseClass() {
		return ListWaitingChatsResponse.class;
	}
