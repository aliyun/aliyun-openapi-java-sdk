...
import com.aliyuncs.ccc.transform.v20200701.RetrieveCallResponseUnmarshaller;
 ...
 * @version 
 */
public class RetrieveCallResponse extends AcsResponse {
	...
	@Override
	public RetrieveCallResponse getInstance(UnmarshallerContext context) {
		return	RetrieveCallResponseUnmarshaller.unmarshall(this, context);
	}
