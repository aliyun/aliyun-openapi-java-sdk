...
import com.aliyuncs.ccc.transform.v20200701.RedialCallResponseUnmarshaller;
 ...
 * @version 
 */
public class RedialCallResponse extends AcsResponse {
	...
	@Override
	public RedialCallResponse getInstance(UnmarshallerContext context) {
		return	RedialCallResponseUnmarshaller.unmarshall(this, context);
	}
