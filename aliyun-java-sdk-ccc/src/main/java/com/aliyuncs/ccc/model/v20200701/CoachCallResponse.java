...
import com.aliyuncs.ccc.transform.v20200701.CoachCallResponseUnmarshaller;
 ...
 * @version 
 */
public class CoachCallResponse extends AcsResponse {
	...
	@Override
	public CoachCallResponse getInstance(UnmarshallerContext context) {
		return	CoachCallResponseUnmarshaller.unmarshall(this, context);
	}
