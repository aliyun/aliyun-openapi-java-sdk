...
import com.aliyuncs.ccc.transform.v20200701.SwitchToConferenceResponseUnmarshaller;
 ...
 * @version 
 */
public class SwitchToConferenceResponse extends AcsResponse {
	...
	@Override
	public SwitchToConferenceResponse getInstance(UnmarshallerContext context) {
		return	SwitchToConferenceResponseUnmarshaller.unmarshall(this, context);
	}
