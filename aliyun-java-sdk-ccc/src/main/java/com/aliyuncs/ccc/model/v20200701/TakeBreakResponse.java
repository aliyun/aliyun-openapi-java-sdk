...
import com.aliyuncs.ccc.transform.v20200701.TakeBreakResponseUnmarshaller;
 ...
 * @version 
 */
public class TakeBreakResponse extends AcsResponse {
	...
	@Override
	public TakeBreakResponse getInstance(UnmarshallerContext context) {
		return	TakeBreakResponseUnmarshaller.unmarshall(this, context);
	}
