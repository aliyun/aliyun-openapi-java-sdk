 ...
 * @version 
 */
public class UpdateConfigItemsRequest extends RpcAcsRequest<UpdateConfigItemsResponse> {
	...
	public void setConfigItems(String configItems) {
		...
		if(configItems != null){
			putQueryParameter("ConfigItems", configItems);
		}
	}
	...
	@Override
	public Class<UpdateConfigItemsResponse> getResponseClass() {
		return UpdateConfigItemsResponse.class;
	}
