...
import com.aliyuncs.ccc.transform.v20200701.SendDtmfSignalingResponseUnmarshaller;
 ...
 * @version 
 */
public class SendDtmfSignalingResponse extends AcsResponse {
	...
	@Override
	public SendDtmfSignalingResponse getInstance(UnmarshallerContext context) {
		return	SendDtmfSignalingResponseUnmarshaller.unmarshall(this, context);
	}
