 ...
 * @version 
 */
public class DeletePhoneTagsRequest extends RpcAcsRequest<DeletePhoneTagsResponse> {
	...
	@Override
	public Class<DeletePhoneTagsResponse> getResponseClass() {
		return DeletePhoneTagsResponse.class;
	}
