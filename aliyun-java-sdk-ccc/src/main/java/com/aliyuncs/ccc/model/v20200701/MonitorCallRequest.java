 ...
 * @version 
 */
public class MonitorCallRequest extends RpcAcsRequest<MonitorCallResponse> {
	...
	public void setMonitoredUserId(String monitoredUserId) {
		...
		if(monitoredUserId != null){
			putQueryParameter("MonitoredUserId", monitoredUserId);
		}
	}

	@Override
	public Class<MonitorCallResponse> getResponseClass() {
		return MonitorCallResponse.class;
	}
