 ...
 * @version 
 */
public class ListOutboundNumbersOfUserRequest extends RpcAcsRequest<ListOutboundNumbersOfUserResponse> {
	...
	@Override
	public Class<ListOutboundNumbersOfUserResponse> getResponseClass() {
		return ListOutboundNumbersOfUserResponse.class;
	}
