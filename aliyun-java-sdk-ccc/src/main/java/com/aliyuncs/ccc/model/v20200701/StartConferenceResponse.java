 ...
 * @version 
 */
public class StartConferenceResponse extends AcsResponse {
	...
	@Override
	public StartConferenceResponse getInstance(UnmarshallerContext context) {
		return	StartConferenceResponseUnmarshaller.unmarshall(this, context);
	}
