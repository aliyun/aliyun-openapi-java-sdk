...
import com.aliyuncs.ccc.transform.v20170705.GetJobListResponseUnmarshaller;
 ...
 * @version 
 */
public class GetJobListResponse extends AcsResponse {
	...
	@Override
	public GetJobListResponse getInstance(UnmarshallerContext context) {
		return	GetJobListResponseUnmarshaller.unmarshall(this, context);
	}
