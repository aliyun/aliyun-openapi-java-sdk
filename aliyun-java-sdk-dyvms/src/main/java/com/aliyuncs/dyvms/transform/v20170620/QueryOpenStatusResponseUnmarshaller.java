...
import com.aliyuncs.dyvms.model.v20170620.QueryOpenStatusResponse;
...
public class QueryOpenStatusResponseUnmarshaller {
	...
	public static QueryOpenStatusResponse unmarshall(QueryOpenStatusResponse queryOpenStatusResponse, UnmarshallerContext _ctx) {
		...
		queryOpenStatusResponse.setCode(_ctx.stringValue("QueryOpenStatusResponse.code"));
		queryOpenStatusResponse.setData(_ctx.booleanValue("QueryOpenStatusResponse.data"));
