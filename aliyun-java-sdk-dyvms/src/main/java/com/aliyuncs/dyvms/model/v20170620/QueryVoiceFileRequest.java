 ...
 * @version 
 */
public class QueryVoiceFileRequest extends RpcAcsRequest<QueryVoiceFileResponse> {
	...
	public QueryVoiceFileRequest() {
		super("Dyvms", "2017-06-20", "QueryVoiceFile", "dyvms");
	...
	@Override
	public Class<QueryVoiceFileResponse> getResponseClass() {
		return QueryVoiceFileResponse.class;
	}
