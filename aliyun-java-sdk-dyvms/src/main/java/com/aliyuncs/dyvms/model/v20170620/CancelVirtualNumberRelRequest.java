 ...
 * @version 
 */
public class CancelVirtualNumberRelRequest extends RpcAcsRequest<CancelVirtualNumberRelResponse> {
	...
	public CancelVirtualNumberRelRequest() {
		super("Dyvms", "2017-06-20", "CancelVirtualNumberRel", "dyvms");
	...
	@Override
	public Class<CancelVirtualNumberRelResponse> getResponseClass() {
		return CancelVirtualNumberRelResponse.class;
	}
