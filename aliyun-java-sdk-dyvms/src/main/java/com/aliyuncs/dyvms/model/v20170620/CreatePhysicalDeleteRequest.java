 ...
 * @version 
 */
public class CreatePhysicalDeleteRequest extends RpcAcsRequest<CreatePhysicalDeleteResponse> {
	...
	public CreatePhysicalDeleteRequest() {
		super("Dyvms", "2017-06-20", "CreatePhysicalDelete", "dyvms");
	...
	@Override
	public Class<CreatePhysicalDeleteResponse> getResponseClass() {
		return CreatePhysicalDeleteResponse.class;
	}
