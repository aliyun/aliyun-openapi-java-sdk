 ...
 * @version 
 */
public class QueryQualificationAuditInfoRequest extends RpcAcsRequest<QueryQualificationAuditInfoResponse> {
	...
	public QueryQualificationAuditInfoRequest() {
		super("Dyvms", "2017-06-20", "QueryQualificationAuditInfo", "dyvms");
	...
	@Override
	public Class<QueryQualificationAuditInfoResponse> getResponseClass() {
		return QueryQualificationAuditInfoResponse.class;
	}
