 ...
 * @version 
 */
public class ExpandSpecRequest extends RpcAcsRequest<ExpandSpecResponse> {
	...
	public ExpandSpecRequest() {
		super("Dyvms", "2017-06-20", "ExpandSpec", "dyvms");
	...
	@Override
	public Class<ExpandSpecResponse> getResponseClass() {
		return ExpandSpecResponse.class;
	}
