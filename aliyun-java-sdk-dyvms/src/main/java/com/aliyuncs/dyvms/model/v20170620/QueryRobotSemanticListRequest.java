 ...
 * @version 
 */
public class QueryRobotSemanticListRequest extends RpcAcsRequest<QueryRobotSemanticListResponse> {
	...
	public QueryRobotSemanticListRequest() {
		super("Dyvms", "2017-06-20", "QueryRobotSemanticList", "dyvms");
	...
	@Override
	public Class<QueryRobotSemanticListResponse> getResponseClass() {
		return QueryRobotSemanticListResponse.class;
	}
