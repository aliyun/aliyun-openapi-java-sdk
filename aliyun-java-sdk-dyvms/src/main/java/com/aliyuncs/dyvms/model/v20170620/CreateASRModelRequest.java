 ...
 * @version 
 */
public class CreateASRModelRequest extends RpcAcsRequest<CreateASRModelResponse> {
	...
	public CreateASRModelRequest() {
		super("Dyvms", "2017-06-20", "CreateASRModel", "dyvms");
	...
	@Override
	public Class<CreateASRModelResponse> getResponseClass() {
		return CreateASRModelResponse.class;
	}
