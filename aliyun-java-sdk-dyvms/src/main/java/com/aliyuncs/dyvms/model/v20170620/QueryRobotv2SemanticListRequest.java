 ...
 * @version 
 */
public class QueryRobotv2SemanticListRequest extends RpcAcsRequest<QueryRobotv2SemanticListResponse> {
	...
	public QueryRobotv2SemanticListRequest() {
		super("Dyvms", "2017-06-20", "QueryRobotv2SemanticList", "dyvms");
	...
	@Override
	public Class<QueryRobotv2SemanticListResponse> getResponseClass() {
		return QueryRobotv2SemanticListResponse.class;
	}
