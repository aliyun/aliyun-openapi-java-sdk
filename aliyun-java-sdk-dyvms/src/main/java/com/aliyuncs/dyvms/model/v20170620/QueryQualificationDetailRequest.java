 ...
 * @version 
 */
public class QueryQualificationDetailRequest extends RpcAcsRequest<QueryQualificationDetailResponse> {
	...
	public QueryQualificationDetailRequest() {
		super("Dyvms", "2017-06-20", "QueryQualificationDetail", "dyvms");
	...
	@Override
	public Class<QueryQualificationDetailResponse> getResponseClass() {
		return QueryQualificationDetailResponse.class;
	}
