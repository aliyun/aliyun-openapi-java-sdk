 ...
 * @version 
 */
public class UpdateCallInGobalConfigRequest extends RpcAcsRequest<UpdateCallInGobalConfigResponse> {
	...
	public UpdateCallInGobalConfigRequest() {
		super("Dyvms", "2017-06-20", "UpdateCallInGobalConfig", "dyvms");
	...
	@Override
	public Class<UpdateCallInGobalConfigResponse> getResponseClass() {
		return UpdateCallInGobalConfigResponse.class;
	}
