 ...
 * @version 
 */
public class DeleteNumberRequest extends RpcAcsRequest<DeleteNumberResponse> {
	...
	public DeleteNumberRequest() {
		super("Dyvms", "2017-06-20", "DeleteNumber", "dyvms");
	...
	@Override
	public Class<DeleteNumberResponse> getResponseClass() {
		return DeleteNumberResponse.class;
	}
