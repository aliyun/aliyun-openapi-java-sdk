 ...
 * @version 
 */
public class CreateRobotIntentRequest extends RpcAcsRequest<CreateRobotIntentResponse> {
	...
	public CreateRobotIntentRequest() {
		super("Dyvms", "2017-06-20", "CreateRobotIntent", "dyvms");
	...
	@Override
	public Class<CreateRobotIntentResponse> getResponseClass() {
		return CreateRobotIntentResponse.class;
	}
