 ...
 * @version 
 */
public class CreateRobotRequest extends RpcAcsRequest<CreateRobotResponse> {
	...
	public CreateRobotRequest() {
		super("Dyvms", "2017-06-20", "CreateRobot", "dyvms");
	...
	@Override
	public Class<CreateRobotResponse> getResponseClass() {
		return CreateRobotResponse.class;
	}
