 ...
 * @version 
 */
public class CreateCallInGobalConfigRequest extends RpcAcsRequest<CreateCallInGobalConfigResponse> {
	...
	public CreateCallInGobalConfigRequest() {
		super("Dyvms", "2017-06-20", "CreateCallInGobalConfig", "dyvms");
	...
	@Override
	public Class<CreateCallInGobalConfigResponse> getResponseClass() {
		return CreateCallInGobalConfigResponse.class;
	}
