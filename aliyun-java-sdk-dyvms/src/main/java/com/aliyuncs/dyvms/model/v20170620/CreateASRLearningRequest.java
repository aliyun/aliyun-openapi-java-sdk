 ...
 * @version 
 */
public class CreateASRLearningRequest extends RpcAcsRequest<CreateASRLearningResponse> {
	...
	public CreateASRLearningRequest() {
		super("Dyvms", "2017-06-20", "CreateASRLearning", "dyvms");
	...
	@Override
	public Class<CreateASRLearningResponse> getResponseClass() {
		return CreateASRLearningResponse.class;
	}
