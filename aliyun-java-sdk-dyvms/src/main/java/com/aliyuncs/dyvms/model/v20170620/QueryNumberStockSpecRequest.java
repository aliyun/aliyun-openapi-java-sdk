 ...
 * @version 
 */
public class QueryNumberStockSpecRequest extends RpcAcsRequest<QueryNumberStockSpecResponse> {
	...
	public QueryNumberStockSpecRequest() {
		super("Dyvms", "2017-06-20", "QueryNumberStockSpec", "dyvms");
	...
	@Override
	public Class<QueryNumberStockSpecResponse> getResponseClass() {
		return QueryNumberStockSpecResponse.class;
	}
