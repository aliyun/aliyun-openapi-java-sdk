 ...
 * @version 
 */
public class QueryTtsInfoRequest extends RpcAcsRequest<QueryTtsInfoResponse> {
	...
	public QueryTtsInfoRequest() {
		super("Dyvms", "2017-06-20", "QueryTtsInfo", "dyvms");
	...
	public void setPodType(String podType) {
		...
		if(podType != null){
			putQueryParameter("PodType", podType);
		}
	}
	...
	@Override
	public Class<QueryTtsInfoResponse> getResponseClass() {
		return QueryTtsInfoResponse.class;
	}
