 ...
 * @version 
 */
public class QueryAuditNumberStateRequest extends RpcAcsRequest<QueryAuditNumberStateResponse> {
	...
	public QueryAuditNumberStateRequest() {
		super("Dyvms", "2017-06-20", "QueryAuditNumberState", "dyvms");
	...
	@Override
	public Class<QueryAuditNumberStateResponse> getResponseClass() {
		return QueryAuditNumberStateResponse.class;
	}
