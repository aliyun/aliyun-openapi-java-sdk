 ...
 * @version 
 */
public class ApplyAddProcedureSceneRequest extends RpcAcsRequest<ApplyAddProcedureSceneResponse> {
	...
	public ApplyAddProcedureSceneRequest() {
		super("Dyvms", "2017-06-20", "ApplyAddProcedureScene", "dyvms");
	...
	@Override
	public Class<ApplyAddProcedureSceneResponse> getResponseClass() {
		return ApplyAddProcedureSceneResponse.class;
	}
