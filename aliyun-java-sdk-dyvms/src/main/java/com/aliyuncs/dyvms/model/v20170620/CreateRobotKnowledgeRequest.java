 ...
 * @version 
 */
public class CreateRobotKnowledgeRequest extends RpcAcsRequest<CreateRobotKnowledgeResponse> {
	...
	public CreateRobotKnowledgeRequest() {
		super("Dyvms", "2017-06-20", "CreateRobotKnowledge", "dyvms");
	...
	@Override
	public Class<CreateRobotKnowledgeResponse> getResponseClass() {
		return CreateRobotKnowledgeResponse.class;
	}
