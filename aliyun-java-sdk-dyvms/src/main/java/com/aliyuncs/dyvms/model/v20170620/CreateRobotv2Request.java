 ...
 * @version 
 */
public class CreateRobotv2Request extends RpcAcsRequest<CreateRobotv2Response> {
	...
	public CreateRobotv2Request() {
		super("Dyvms", "2017-06-20", "CreateRobotv2", "dyvms");
	...
	@Override
	public Class<CreateRobotv2Response> getResponseClass() {
		return CreateRobotv2Response.class;
	}
