 ...
 * @version 
 */
public class TestRobotv2DialogRequest extends RpcAcsRequest<TestRobotv2DialogResponse> {
	...
	private String tts;
	public TestRobotv2DialogRequest() {
		super("Dyvms", "2017-06-20", "TestRobotv2Dialog", "dyvms");
	...
	@Override
	public Class<TestRobotv2DialogResponse> getResponseClass() {
		return TestRobotv2DialogResponse.class;
	}
