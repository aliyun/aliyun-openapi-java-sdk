 ...
 * @version 
 */
public class QueryQualificationsRequest extends RpcAcsRequest<QueryQualificationsResponse> {
	...
	public QueryQualificationsRequest() {
		super("Dyvms", "2017-06-20", "QueryQualifications", "dyvms");
	...
	@Override
	public Class<QueryQualificationsResponse> getResponseClass() {
		return QueryQualificationsResponse.class;
	}
