 ...
 * @version 
 */
public class QueryUserDeleteStatusRequest extends RpcAcsRequest<QueryUserDeleteStatusResponse> {
	...
	public QueryUserDeleteStatusRequest() {
		super("Dyvms", "2017-06-20", "QueryUserDeleteStatus", "dyvms");
	...
	@Override
	public Class<QueryUserDeleteStatusResponse> getResponseClass() {
		return QueryUserDeleteStatusResponse.class;
	}
