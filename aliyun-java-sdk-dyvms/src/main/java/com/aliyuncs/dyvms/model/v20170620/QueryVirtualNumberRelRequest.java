 ...
 * @version 
 */
public class QueryVirtualNumberRelRequest extends RpcAcsRequest<QueryVirtualNumberRelResponse> {
	...
	public QueryVirtualNumberRelRequest() {
		super("Dyvms", "2017-06-20", "QueryVirtualNumberRel", "dyvms");
	...
	@Override
	public Class<QueryVirtualNumberRelResponse> getResponseClass() {
		return QueryVirtualNumberRelResponse.class;
	}
