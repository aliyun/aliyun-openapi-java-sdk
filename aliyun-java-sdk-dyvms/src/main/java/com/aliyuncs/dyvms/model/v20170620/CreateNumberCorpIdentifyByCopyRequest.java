 ...
 * @version 
 */
public class CreateNumberCorpIdentifyByCopyRequest extends RpcAcsRequest<CreateNumberCorpIdentifyByCopyResponse> {
	...
	public CreateNumberCorpIdentifyByCopyRequest() {
		super("Dyvms", "2017-06-20", "CreateNumberCorpIdentifyByCopy", "dyvms");
	...
	@Override
	public Class<CreateNumberCorpIdentifyByCopyResponse> getResponseClass() {
		return CreateNumberCorpIdentifyByCopyResponse.class;
	}
