 ...
 * @version 
 */
public class CreateRobotv2IntentRequest extends RpcAcsRequest<CreateRobotv2IntentResponse> {
	...
	public CreateRobotv2IntentRequest() {
		super("Dyvms", "2017-06-20", "CreateRobotv2Intent", "dyvms");
	...
	public void setIntentContent(String intentContent) {
		...
		if(intentContent != null){
			putQueryParameter("IntentContent", intentContent);
		}
	}
	...
	@Override
	public Class<CreateRobotv2IntentResponse> getResponseClass() {
		return CreateRobotv2IntentResponse.class;
	}
