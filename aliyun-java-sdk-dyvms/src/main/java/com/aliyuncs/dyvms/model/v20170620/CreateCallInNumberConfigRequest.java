 ...
 * @version 
 */
public class CreateCallInNumberConfigRequest extends RpcAcsRequest<CreateCallInNumberConfigResponse> {
	...
	public CreateCallInNumberConfigRequest() {
		super("Dyvms", "2017-06-20", "CreateCallInNumberConfig", "dyvms");
	...
	@Override
	public Class<CreateCallInNumberConfigResponse> getResponseClass() {
		return CreateCallInNumberConfigResponse.class;
	}
