 ...
 * @version 
 */
public class UpdateRobotProcessRequest extends RpcAcsRequest<UpdateRobotProcessResponse> {
	...
	public UpdateRobotProcessRequest() {
		super("Dyvms", "2017-06-20", "UpdateRobotProcess", "dyvms");
	...
	@Override
	public Class<UpdateRobotProcessResponse> getResponseClass() {
		return UpdateRobotProcessResponse.class;
	}
