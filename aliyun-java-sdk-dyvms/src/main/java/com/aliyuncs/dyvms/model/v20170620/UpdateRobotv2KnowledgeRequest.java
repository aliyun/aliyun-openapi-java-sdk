 ...
 * @version 
 */
public class UpdateRobotv2KnowledgeRequest extends RpcAcsRequest<UpdateRobotv2KnowledgeResponse> {
	...
	public UpdateRobotv2KnowledgeRequest() {
		super("Dyvms", "2017-06-20", "UpdateRobotv2Knowledge", "dyvms");
	...
	@Override
	public Class<UpdateRobotv2KnowledgeResponse> getResponseClass() {
		return UpdateRobotv2KnowledgeResponse.class;
	}
