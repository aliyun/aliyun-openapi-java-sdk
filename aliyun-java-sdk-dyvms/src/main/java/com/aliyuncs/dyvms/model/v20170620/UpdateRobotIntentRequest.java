 ...
 * @version 
 */
public class UpdateRobotIntentRequest extends RpcAcsRequest<UpdateRobotIntentResponse> {
	...
	public UpdateRobotIntentRequest() {
		super("Dyvms", "2017-06-20", "UpdateRobotIntent", "dyvms");
	...
	@Override
	public Class<UpdateRobotIntentResponse> getResponseClass() {
		return UpdateRobotIntentResponse.class;
	}
