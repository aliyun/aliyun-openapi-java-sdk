...
import com.aliyuncs.advisor_share.transform.v20180608.ListWaitingAccountsResponseUnmarshaller;
 ...
 * @version 
 */
public class ListWaitingAccountsResponse extends AcsResponse {
	...
	@Override
	public ListWaitingAccountsResponse getInstance(UnmarshallerContext context) {
		return	ListWaitingAccountsResponseUnmarshaller.unmarshall(this, context);
	}
