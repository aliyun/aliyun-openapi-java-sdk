...
import com.aliyuncs.advisor_share.transform.v20180608.GetUserCheckReportResponseUnmarshaller;
 ...
 * @version 
 */
public class GetUserCheckReportResponse extends AcsResponse {
	...
	public static class Data {
		...
		private String weeklyGenerateTime;
		...
		public void setWeeklyReportUrl(String weeklyReportUrl) {
			this.weeklyReportUrl = weeklyReportUrl;
		}

		public String getWeeklyGenerateTime() {
			return this.weeklyGenerateTime;
		}

		public void setWeeklyGenerateTime(String weeklyGenerateTime) {
			this.weeklyGenerateTime = weeklyGenerateTime;
		}
	}

	@Override
	public GetUserCheckReportResponse getInstance(UnmarshallerContext context) {
		return	GetUserCheckReportResponseUnmarshaller.unmarshall(this, context);
	}
