 ...
 * @version 
 */
public class GetProductRiskTrendRequest extends RpcAcsRequest<GetProductRiskTrendResponse> {
	...
	public GetProductRiskTrendRequest() {
		super("Advisor-Share", "2018-06-08", "GetProductRiskTrend", "advisor");
	...
	@Override
	public Class<GetProductRiskTrendResponse> getResponseClass() {
