...
import com.aliyuncs.advisor_share.transform.v20180608.GetUserEmailReportResponseUnmarshaller;
 ...
 * @version 
 */
public class GetUserEmailReportResponse extends AcsResponse {
	...
	@Override
	public GetUserEmailReportResponse getInstance(UnmarshallerContext context) {
		return	GetUserEmailReportResponseUnmarshaller.unmarshall(this, context);
	}
