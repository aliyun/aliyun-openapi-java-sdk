...
import com.aliyuncs.advisor_share.transform.v20180608.ListPrimaryAccountsResponseUnmarshaller;
 ...
 * @version 
 */
public class ListPrimaryAccountsResponse extends AcsResponse {
	...
	@Override
	public ListPrimaryAccountsResponse getInstance(UnmarshallerContext context) {
		return	ListPrimaryAccountsResponseUnmarshaller.unmarshall(this, context);
	}
