 ...
 * @version 
 */
public class ListAppResourcesInfoRequest extends RpcAcsRequest<ListAppResourcesInfoResponse> {
	...
	public ListAppResourcesInfoRequest() {
		super("Advisor-Share", "2018-06-08", "ListAppResourcesInfo", "advisor");
	...
	@Override
	public Class<ListAppResourcesInfoResponse> getResponseClass() {
		return ListAppResourcesInfoResponse.class;
	}
