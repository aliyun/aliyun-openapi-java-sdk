 ...
 * @version 
 */
public class DeleteUisRequest extends RpcAcsRequest<DeleteUisResponse> {
	...
	public DeleteUisRequest() {
		super("Uisplus", "2020-07-07", "DeleteUis", "uisplus");
	...
	@Override
	public Class<DeleteUisResponse> getResponseClass() {
		return DeleteUisResponse.class;
	}
