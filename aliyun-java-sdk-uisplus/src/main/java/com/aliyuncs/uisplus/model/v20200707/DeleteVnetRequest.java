 ...
 * @version 
 */
public class DeleteVnetRequest extends RpcAcsRequest<DeleteVnetResponse> {
	...
	public DeleteVnetRequest() {
		super("Uisplus", "2020-07-07", "DeleteVnet", "uisplus");
	...
	@Override
	public Class<DeleteVnetResponse> getResponseClass() {
		return DeleteVnetResponse.class;
	}
