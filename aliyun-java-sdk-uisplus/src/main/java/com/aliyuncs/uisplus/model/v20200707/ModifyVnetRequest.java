 ...
 * @version 
 */
public class ModifyVnetRequest extends RpcAcsRequest<ModifyVnetResponse> {
	...
	public ModifyVnetRequest() {
		super("Uisplus", "2020-07-07", "ModifyVnet", "uisplus");
	...
	@Override
	public Class<ModifyVnetResponse> getResponseClass() {
		return ModifyVnetResponse.class;
	}
