 ...
 * @version 
 */
public class UnAssociateEipRequest extends RpcAcsRequest<UnAssociateEipResponse> {
	...
	public UnAssociateEipRequest() {
		super("Uisplus", "2020-07-07", "UnAssociateEip", "uisplus");
	...
	@Override
	public Class<UnAssociateEipResponse> getResponseClass() {
		return UnAssociateEipResponse.class;
	}
