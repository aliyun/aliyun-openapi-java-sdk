 ...
 * @version 
 */
public class ModifyGreConnectionRequest extends RpcAcsRequest<ModifyGreConnectionResponse> {
	...
	public ModifyGreConnectionRequest() {
		super("Uisplus", "2020-07-07", "ModifyGreConnection", "uisplus");
	...
	@Override
	public Class<ModifyGreConnectionResponse> getResponseClass() {
		return ModifyGreConnectionResponse.class;
	}
