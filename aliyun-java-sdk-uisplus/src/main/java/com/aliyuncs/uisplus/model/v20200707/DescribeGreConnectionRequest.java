 ...
 * @version 
 */
public class DescribeGreConnectionRequest extends RpcAcsRequest<DescribeGreConnectionResponse> {
	   

	private String greConnectionId;

	private String uisId;
	public DescribeGreConnectionRequest() {
		super("Uisplus", "2020-07-07", "DescribeGreConnection", "uisplus");
	...
	@Override
	public Class<DescribeGreConnectionResponse> getResponseClass() {
		return DescribeGreConnectionResponse.class;
	}
