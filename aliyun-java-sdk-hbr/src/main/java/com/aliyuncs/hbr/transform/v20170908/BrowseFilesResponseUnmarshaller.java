...
public class BrowseFilesResponseUnmarshaller {
	...
	public static BrowseFilesResponse unmarshall(BrowseFilesResponse browseFilesResponse, UnmarshallerContext _ctx) {
		...
		browseFilesResponse.setNextToken(_ctx.stringValue("BrowseFilesResponse.NextToken"));
		...
		browseFilesResponse.setMaxResults(_ctx.integerValue("BrowseFilesResponse.MaxResults"));
		...
		for (int i = 0; i < _ctx.lengthValue("BrowseFilesResponse.Nodes.Length"); i++) {
			...
			node.setEventName(_ctx.stringValue("BrowseFilesResponse.Nodes["+ i +"].EventName"));
			node.setRiskLevel(_ctx.stringValue("BrowseFilesResponse.Nodes["+ i +"].RiskLevel"));
			node.setMd5(_ctx.stringValue("BrowseFilesResponse.Nodes["+ i +"].Md5"));
