 ...
 * @version 
 */
public class GetVaultListRequest extends RpcAcsRequest<GetVaultListResponse> {
	   

	private String vaultRegionId;
	public GetVaultListRequest() {
		super("hbr", "2017-09-08", "GetVaultList", "hbr");
	...
	@Override
	public Class<GetVaultListResponse> getResponseClass() {
		return GetVaultListResponse.class;
	}
