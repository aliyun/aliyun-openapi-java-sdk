 ...
 * @version 
 */
public class DescribeBackupSourceGroupsRequest extends RpcAcsRequest<DescribeBackupSourceGroupsResponse> {
	...
	public DescribeBackupSourceGroupsRequest() {
		super("hbr", "2017-09-08", "DescribeBackupSourceGroups", "hbr");
	...
	@Override
	public Class<DescribeBackupSourceGroupsResponse> getResponseClass() {
		return DescribeBackupSourceGroupsResponse.class;
	}
