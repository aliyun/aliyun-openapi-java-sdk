...
import com.aliyuncs.hbr.transform.v20170908.DescribeVmMigrationPlanResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeVmMigrationPlanResponse extends AcsResponse {
	...
	@Override
	public DescribeVmMigrationPlanResponse getInstance(UnmarshallerContext context) {
		return	DescribeVmMigrationPlanResponseUnmarshaller.unmarshall(this, context);
	}
}
