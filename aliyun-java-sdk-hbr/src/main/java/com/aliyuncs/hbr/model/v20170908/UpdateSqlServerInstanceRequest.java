 ...
 * @version 
 */
public class UpdateSqlServerInstanceRequest extends RpcAcsRequest<UpdateSqlServerInstanceResponse> {
	...
	public UpdateSqlServerInstanceRequest() {
		super("hbr", "2017-09-08", "UpdateSqlServerInstance", "hbr");
	...
	@Override
	public Class<UpdateSqlServerInstanceResponse> getResponseClass() {
		return UpdateSqlServerInstanceResponse.class;
	}
