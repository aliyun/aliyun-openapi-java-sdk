 ...
 * @version 
 */
public class AddCrossAccountRequest extends RpcAcsRequest<AddCrossAccountResponse> {
	...
	public AddCrossAccountRequest() {
		super("hbr", "2017-09-08", "AddCrossAccount", "hbr");
	...
	@Override
	public Class<AddCrossAccountResponse> getResponseClass() {
		return AddCrossAccountResponse.class;
	}
