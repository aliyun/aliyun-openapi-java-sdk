...
import com.aliyuncs.hbr.transform.v20170908.UninstallBackupClientsResponseUnmarshaller;
 ...
 * @version 
 */
public class UninstallBackupClientsResponse extends AcsResponse {
	...
	@Override
	public UninstallBackupClientsResponse getInstance(UnmarshallerContext context) {
		return	UninstallBackupClientsResponseUnmarshaller.unmarshall(this, context);
	}
