 ...
 * @version 
 */
public class DescribeEcsInstancesRequest extends RpcAcsRequest<DescribeEcsInstancesResponse> {
	...
	public DescribeEcsInstancesRequest() {
		super("hbr", "2017-09-08", "DescribeEcsInstances", "hbr");
	...
	@Override
	public Class<DescribeEcsInstancesResponse> getResponseClass() {
		return DescribeEcsInstancesResponse.class;
	}
