 ...
 * @version 
 */
public class DescribeRestoreJobs2Request extends RpcAcsRequest<DescribeRestoreJobs2Response> {
	...
	public DescribeRestoreJobs2Request() {
		super("hbr", "2017-09-08", "DescribeRestoreJobs2", "hbr");
	...
	@Override
	public Class<DescribeRestoreJobs2Response> getResponseClass() {
		return DescribeRestoreJobs2Response.class;
	}
