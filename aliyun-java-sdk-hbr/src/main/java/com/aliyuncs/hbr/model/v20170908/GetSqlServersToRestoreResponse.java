...
import com.aliyuncs.hbr.transform.v20170908.GetSqlServersToRestoreResponseUnmarshaller;
 ...
 * @version 
 */
public class GetSqlServersToRestoreResponse extends AcsResponse {
	...
	@Override
	public GetSqlServersToRestoreResponse getInstance(UnmarshallerContext context) {
		return	GetSqlServersToRestoreResponseUnmarshaller.unmarshall(this, context);
	}
}
