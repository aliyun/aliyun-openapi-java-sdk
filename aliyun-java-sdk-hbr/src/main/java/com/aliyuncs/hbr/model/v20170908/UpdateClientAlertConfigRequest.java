 ...
 * @version 
 */
public class UpdateClientAlertConfigRequest extends RpcAcsRequest<UpdateClientAlertConfigResponse> {
	...
	public UpdateClientAlertConfigRequest() {
		super("hbr", "2017-09-08", "UpdateClientAlertConfig", "hbr");
	...
	@Override
	public Class<UpdateClientAlertConfigResponse> getResponseClass() {
		return UpdateClientAlertConfigResponse.class;
	}
