...
import com.aliyuncs.hbr.transform.v20170908.DescribeBackupSourcesResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeBackupSourcesResponse extends AcsResponse {
	...
	@Override
	public DescribeBackupSourcesResponse getInstance(UnmarshallerContext context) {
		return	DescribeBackupSourcesResponseUnmarshaller.unmarshall(this, context);
	}
}
