 ...
 * @version 
 */
public class DescribeHanaRestoresRequest extends RpcAcsRequest<DescribeHanaRestoresResponse> {
	...
	@Override
	public Class<DescribeHanaRestoresResponse> getResponseClass() {
		return DescribeHanaRestoresResponse.class;
	}
