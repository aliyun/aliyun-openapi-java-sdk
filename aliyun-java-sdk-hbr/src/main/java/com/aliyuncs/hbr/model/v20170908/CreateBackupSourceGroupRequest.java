 ...
 * @version 
 */
public class CreateBackupSourceGroupRequest extends RpcAcsRequest<CreateBackupSourceGroupResponse> {
	...
	public CreateBackupSourceGroupRequest() {
		super("hbr", "2017-09-08", "CreateBackupSourceGroup", "hbr");
	...
	@Override
	public Class<CreateBackupSourceGroupResponse> getResponseClass() {
		return CreateBackupSourceGroupResponse.class;
	}
