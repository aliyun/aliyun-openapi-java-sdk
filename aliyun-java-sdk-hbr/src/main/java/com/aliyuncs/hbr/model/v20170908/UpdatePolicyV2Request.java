 ...
 * @version 
 */
public class UpdatePolicyV2Request extends RpcAcsRequest<UpdatePolicyV2Response> {
	...
	public UpdatePolicyV2Request() {
		super("hbr", "2017-09-08", "UpdatePolicyV2", "hbr");
	...
	@Override
	public Class<UpdatePolicyV2Response> getResponseClass() {
		return UpdatePolicyV2Response.class;
	}
