 ...
 * @version 
 */
public class DeleteBackupSourceGroupRequest extends RpcAcsRequest<DeleteBackupSourceGroupResponse> {
	   

	private String backupSourceGroupId;
	public DeleteBackupSourceGroupRequest() {
		super("hbr", "2017-09-08", "DeleteBackupSourceGroup", "hbr");
	...
	@Override
	public Class<DeleteBackupSourceGroupResponse> getResponseClass() {
		return DeleteBackupSourceGroupResponse.class;
	}
