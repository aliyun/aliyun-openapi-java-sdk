 ...
 * @version 
 */
public class AddSqlServerLogRequest extends RpcAcsRequest<AddSqlServerLogResponse> {
	...
	public AddSqlServerLogRequest() {
		super("hbr", "2017-09-08", "AddSqlServerLog", "hbr");
	...
	@Override
	public Class<AddSqlServerLogResponse> getResponseClass() {
		return AddSqlServerLogResponse.class;
	}
