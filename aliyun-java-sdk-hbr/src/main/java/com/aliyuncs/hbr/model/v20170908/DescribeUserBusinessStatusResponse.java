...
import com.aliyuncs.hbr.transform.v20170908.DescribeUserBusinessStatusResponseUnmarshaller;
...
public class DescribeUserBusinessStatusResponse extends AcsResponse {
	...
	public String getInDebtStatus() {
		return this.inDebtStatus;
	}

	public void setInDebtStatus(String inDebtStatus) {
		this.inDebtStatus = inDebtStatus;
	}
	...
	public void setRiskControlStatus(String riskControlStatus) {
