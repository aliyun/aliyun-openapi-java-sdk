 ...
 * @version 
 */
public class DescribeRecoverableOtsInstancesRequest extends RpcAcsRequest<DescribeRecoverableOtsInstancesResponse> {
	...
	public DescribeRecoverableOtsInstancesRequest() {
		super("hbr", "2017-09-08", "DescribeRecoverableOtsInstances", "hbr");
	...
	@Override
	public Class<DescribeRecoverableOtsInstancesResponse> getResponseClass() {
		return DescribeRecoverableOtsInstancesResponse.class;
	}
