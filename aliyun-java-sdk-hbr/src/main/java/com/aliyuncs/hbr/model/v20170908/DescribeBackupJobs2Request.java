 ...
 * @version 
 */
public class DescribeBackupJobs2Request extends RpcAcsRequest<DescribeBackupJobs2Response> {
	...
	public DescribeBackupJobs2Request() {
		super("hbr", "2017-09-08", "DescribeBackupJobs2", "hbr");
	...
	@Override
	public Class<DescribeBackupJobs2Response> getResponseClass() {
		return DescribeBackupJobs2Response.class;
	}
