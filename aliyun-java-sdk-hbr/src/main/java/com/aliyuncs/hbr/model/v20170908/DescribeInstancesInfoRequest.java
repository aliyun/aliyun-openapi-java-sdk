 ...
 * @version 
 */
public class DescribeInstancesInfoRequest extends RpcAcsRequest<DescribeInstancesInfoResponse> {
	...
	public DescribeInstancesInfoRequest() {
		super("hbr", "2017-09-08", "DescribeInstancesInfo", "hbr");
	...
	@Override
	public Class<DescribeInstancesInfoResponse> getResponseClass() {
		return DescribeInstancesInfoResponse.class;
	}
