 ...
 * @version 
 */
public class DescribeClientsRequest extends RpcAcsRequest<DescribeClientsResponse> {
	...
	@Override
	public Class<DescribeClientsResponse> getResponseClass() {
		return DescribeClientsResponse.class;
	}
