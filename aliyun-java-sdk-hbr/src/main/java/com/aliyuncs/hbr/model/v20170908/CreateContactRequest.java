 ...
 * @version 
 */
public class CreateContactRequest extends RpcAcsRequest<CreateContactResponse> {
	...
	public CreateContactRequest() {
		super("hbr", "2017-09-08", "CreateContact", "hbr");
	...
	public void setMobileVerifyCode(String mobileVerifyCode) {
		...
		if(mobileVerifyCode != null){
			putQueryParameter("MobileVerifyCode", mobileVerifyCode);
		}
	}
	...
	public void setEmailVerifyCode(String emailVerifyCode) {
		...
		if(emailVerifyCode != null){
			putQueryParameter("EmailVerifyCode", emailVerifyCode);
		}
	}
