 ...
 * @version 
 */
public class DescribeHanaBackupsRequest extends RpcAcsRequest<DescribeHanaBackupsResponse> {
	...
	public DescribeHanaBackupsRequest() {
		super("hbr", "2017-09-08", "DescribeHanaBackups", "hbr");
	...
	@Override
	public Class<DescribeHanaBackupsResponse> getResponseClass() {
		return DescribeHanaBackupsResponse.class;
	}
