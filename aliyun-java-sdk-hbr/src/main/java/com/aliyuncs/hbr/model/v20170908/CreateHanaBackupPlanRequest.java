 ...
 * @version 
 */
public class CreateHanaBackupPlanRequest extends RpcAcsRequest<CreateHanaBackupPlanResponse> {
	...
	@Override
	public Class<CreateHanaBackupPlanResponse> getResponseClass() {
		return CreateHanaBackupPlanResponse.class;
	}
