 ...
 * @version 
 */
public class DescribeRecentSnapshotsRequest extends RpcAcsRequest<DescribeRecentSnapshotsResponse> {
	...
	public DescribeRecentSnapshotsRequest() {
		super("hbr", "2017-09-08", "DescribeRecentSnapshots", "hbr");
	...
	@Override
	public Class<DescribeRecentSnapshotsResponse> getResponseClass() {
		return DescribeRecentSnapshotsResponse.class;
	}
