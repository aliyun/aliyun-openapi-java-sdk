 ...
 * @version 
 */
public class DeleteVaultReplicationRequest extends RpcAcsRequest<DeleteVaultReplicationResponse> {
	...
	public DeleteVaultReplicationRequest() {
		super("hbr", "2017-09-08", "DeleteVaultReplication", "hbr");
	...
	@Override
	public Class<DeleteVaultReplicationResponse> getResponseClass() {
		return DeleteVaultReplicationResponse.class;
	}
