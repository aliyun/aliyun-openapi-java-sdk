...
import com.aliyuncs.hbr.transform.v20170908.DescribeNasInstancesResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeNasInstancesResponse extends AcsResponse {
	...
	@Override
	public DescribeNasInstancesResponse getInstance(UnmarshallerContext context) {
		return	DescribeNasInstancesResponseUnmarshaller.unmarshall(this, context);
	}
}
