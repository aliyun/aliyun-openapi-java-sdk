 ...
 * @version 
 */
public class DeleteProxyBrandUserRequest extends RpcAcsRequest<DeleteProxyBrandUserResponse> {
	...
	public DeleteProxyBrandUserRequest() {
		super("UniMkt", "2018-12-12", "DeleteProxyBrandUser", "uniMkt");
	...
	@Override
	public Class<DeleteProxyBrandUserResponse> getResponseClass() {
		return DeleteProxyBrandUserResponse.class;
	}
