 ...
 * @version 
 */
public class ListUserRequest extends RpcAcsRequest<ListUserResponse> {
	...
	public ListUserRequest() {
		super("UniMkt", "2018-12-12", "ListUser", "1.0.0");
	...
	@Override
	public Class<ListUserResponse> getResponseClass() {
		return ListUserResponse.class;
	}
