...
public class CheckTenantBizResponse extends AcsResponse {
	...
	public static class Model {
		...
		public void setCanAccessMedia(Boolean canAccessMedia) {
		...
		public void setCanAccessAdSlot(Boolean canAccessAdSlot) {
			this.canAccessAdSlot = canAccessAdSlot;
		}
	}

	@Override
	public CheckTenantBizResponse getInstance(UnmarshallerContext context) {
		return	CheckTenantBizResponseUnmarshaller.unmarshall(this, context);
	}
