 ...
 * @version 
 */
public class CreateSlotRequest extends RpcAcsRequest<CreateSlotResponse> {
	...
	public CreateSlotRequest() {
		super("UniMkt", "2018-12-12", "CreateSlot", "uniMkt");
	...
	@Override
	public Class<CreateSlotResponse> getResponseClass() {
		return CreateSlotResponse.class;
	}
