 ...
 * @version 
 */
public class QueryTenantUserByUserIdRequest extends RpcAcsRequest<QueryTenantUserByUserIdResponse> {
	...
	public QueryTenantUserByUserIdRequest() {
		super("UniMkt", "2018-12-12", "QueryTenantUserByUserId", "1.0.0");
	...
	@Override
	public Class<QueryTenantUserByUserIdResponse> getResponseClass() {
		return QueryTenantUserByUserIdResponse.class;
	}
