 ...
 * @version 
 */
public class QueryMediaRequest extends RpcAcsRequest<QueryMediaResponse> {
	...
	public QueryMediaRequest() {
		super("UniMkt", "2018-12-12", "QueryMedia", "uniMkt");
	...
	@Override
	public Class<QueryMediaResponse> getResponseClass() {
		return QueryMediaResponse.class;
	}
