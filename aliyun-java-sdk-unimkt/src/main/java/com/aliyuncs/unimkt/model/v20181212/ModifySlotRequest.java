 ...
 * @version 
 */
public class ModifySlotRequest extends RpcAcsRequest<ModifySlotResponse> {
	...
	public ModifySlotRequest() {
		super("UniMkt", "2018-12-12", "ModifySlot", "uniMkt");
	...
	public void setAdSlot(String adSlot) {
		this.adSlot = adSlot;
		if(adSlot != null){
			putBodyParameter("AdSlot", adSlot);
		}
	}

	@Override
	public Class<ModifySlotResponse> getResponseClass() {
		return ModifySlotResponse.class;
	}
