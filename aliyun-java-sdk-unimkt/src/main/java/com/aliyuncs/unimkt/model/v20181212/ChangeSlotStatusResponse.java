...
import com.aliyuncs.unimkt.transform.v20181212.ChangeSlotStatusResponseUnmarshaller;
 ...
 * @version 
 */
public class ChangeSlotStatusResponse extends AcsResponse {
	...
	@Override
	public ChangeSlotStatusResponse getInstance(UnmarshallerContext context) {
		return	ChangeSlotStatusResponseUnmarshaller.unmarshall(this, context);
	}
