 ...
 * @version 
 */
public class CheckTenantBizRequest extends RpcAcsRequest<CheckTenantBizResponse> {
	...
	public CheckTenantBizRequest() {
		super("UniMkt", "2018-12-12", "CheckTenantBiz", "1.0.0");
	...
	@Override
	public Class<CheckTenantBizResponse> getResponseClass() {
		return CheckTenantBizResponse.class;
	}
