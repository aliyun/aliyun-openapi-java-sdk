...
import com.aliyuncs.unimkt.transform.v20181212.ModifySlotResponseUnmarshaller;
 ...
 * @version 
 */
public class ModifySlotResponse extends AcsResponse {
	...
	@Override
	public ModifySlotResponse getInstance(UnmarshallerContext context) {
		return	ModifySlotResponseUnmarshaller.unmarshall(this, context);
	}
