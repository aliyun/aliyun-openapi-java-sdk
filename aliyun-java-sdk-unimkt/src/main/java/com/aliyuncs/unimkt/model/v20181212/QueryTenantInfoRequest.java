 ...
 * @version 
 */
public class QueryTenantInfoRequest extends RpcAcsRequest<QueryTenantInfoResponse> {
	...
	public QueryTenantInfoRequest() {
		super("UniMkt", "2018-12-12", "QueryTenantInfo", "1.0.0");
	...
	@Override
	public Class<QueryTenantInfoResponse> getResponseClass() {
		return QueryTenantInfoResponse.class;
	}
