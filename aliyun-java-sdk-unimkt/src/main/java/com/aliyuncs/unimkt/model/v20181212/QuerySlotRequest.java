 ...
 * @version 
 */
public class QuerySlotRequest extends RpcAcsRequest<QuerySlotResponse> {
	...
	public QuerySlotRequest() {
		super("UniMkt", "2018-12-12", "QuerySlot", "uniMkt");
	...
	@Override
	public Class<QuerySlotResponse> getResponseClass() {
		return QuerySlotResponse.class;
	}
