 ...
 * @version 
 */
public class QueryTenantBizConfigRequest extends RpcAcsRequest<QueryTenantBizConfigResponse> {
	...
	public QueryTenantBizConfigRequest() {
		super("UniMkt", "2018-12-12", "QueryTenantBizConfig", "uniMkt");
	...
	@Override
	public Class<QueryTenantBizConfigResponse> getResponseClass() {
		return QueryTenantBizConfigResponse.class;
	}
