 ...
 * @version 
 */
public class ChangeTenantUserStatusRequest extends RpcAcsRequest<ChangeTenantUserStatusResponse> {
	...
	@Override
	public Class<ChangeTenantUserStatusResponse> getResponseClass() {
		return ChangeTenantUserStatusResponse.class;
	}
