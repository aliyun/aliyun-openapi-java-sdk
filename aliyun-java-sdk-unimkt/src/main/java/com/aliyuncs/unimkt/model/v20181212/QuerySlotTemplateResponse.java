...
import com.aliyuncs.unimkt.transform.v20181212.QuerySlotTemplateResponseUnmarshaller;
 ...
 * @version 
 */
public class QuerySlotTemplateResponse extends AcsResponse {
	...
	@Override
	public QuerySlotTemplateResponse getInstance(UnmarshallerContext context) {
		return	QuerySlotTemplateResponseUnmarshaller.unmarshall(this, context);
	}
