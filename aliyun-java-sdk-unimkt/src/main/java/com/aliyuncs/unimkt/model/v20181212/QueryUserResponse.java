...
import com.aliyuncs.unimkt.transform.v20181212.QueryUserResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryUserResponse extends AcsResponse {
	...
	@Override
	public QueryUserResponse getInstance(UnmarshallerContext context) {
		return	QueryUserResponseUnmarshaller.unmarshall(this, context);
	}
