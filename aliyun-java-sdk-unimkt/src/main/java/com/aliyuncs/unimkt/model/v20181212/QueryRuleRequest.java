 ...
 * @version 
 */
public class QueryRuleRequest extends RpcAcsRequest<QueryRuleResponse> {
	...
	public QueryRuleRequest() {
		super("UniMkt", "2018-12-12", "QueryRule", "uniMkt");
	...
	@Override
	public Class<QueryRuleResponse> getResponseClass() {
		return QueryRuleResponse.class;
	}
