 ...
 * @version 
 */
public class QueryTenantUserRequest extends RpcAcsRequest<QueryTenantUserResponse> {
	...
	public QueryTenantUserRequest() {
		super("UniMkt", "2018-12-12", "QueryTenantUser", "uniMkt");
	...
	@Override
	public Class<QueryTenantUserResponse> getResponseClass() {
		return QueryTenantUserResponse.class;
	}
