...
import com.aliyuncs.unimkt.transform.v20181212.UpdateFlowResponseUnmarshaller;
...
public class UpdateFlowResponse extends AcsResponse {
	...
	@Override
	public UpdateFlowResponse getInstance(UnmarshallerContext context) {
		return	UpdateFlowResponseUnmarshaller.unmarshall(this, context);
	}
