...
import com.aliyuncs.unimkt.transform.v20181212.QuerySlotResponseUnmarshaller;
 ...
 * @version 
 */
public class QuerySlotResponse extends AcsResponse {
	...
	@Override
	public QuerySlotResponse getInstance(UnmarshallerContext context) {
		return	QuerySlotResponseUnmarshaller.unmarshall(this, context);
	}
