...
import com.aliyuncs.unimkt.transform.v20181212.BidResponseUnmarshaller;
 ...
 * @version 
 */
public class BidResponse extends AcsResponse {
	...
	@Override
	public BidResponse getInstance(UnmarshallerContext context) {
		return	BidResponseUnmarshaller.unmarshall(this, context);
	}
