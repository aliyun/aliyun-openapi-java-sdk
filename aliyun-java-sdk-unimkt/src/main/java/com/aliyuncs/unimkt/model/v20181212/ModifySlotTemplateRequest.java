 ...
 * @version 
 */
public class ModifySlotTemplateRequest extends RpcAcsRequest<ModifySlotTemplateResponse> {
	...
	public ModifySlotTemplateRequest() {
		super("UniMkt", "2018-12-12", "ModifySlotTemplate", "uniMkt");
	...
	@Override
	public Class<ModifySlotTemplateResponse> getResponseClass() {
		return ModifySlotTemplateResponse.class;
	}
