 ...
 * @version 
 */
public class CreatesSlotTemplateRequest extends RpcAcsRequest<CreatesSlotTemplateResponse> {
	...
	public CreatesSlotTemplateRequest() {
		super("UniMkt", "2018-12-12", "CreatesSlotTemplate", "uniMkt");
	...
	public String getAdSlotTemplate() {
		return this.adSlotTemplate;
	}

	public void setAdSlotTemplate(String adSlotTemplate) {
		this.adSlotTemplate = adSlotTemplate;
		if(adSlotTemplate != null){
			putBodyParameter("AdSlotTemplate", adSlotTemplate);
		}
	}
	...
	@Override
	public Class<CreatesSlotTemplateResponse> getResponseClass() {
		return CreatesSlotTemplateResponse.class;
	}
