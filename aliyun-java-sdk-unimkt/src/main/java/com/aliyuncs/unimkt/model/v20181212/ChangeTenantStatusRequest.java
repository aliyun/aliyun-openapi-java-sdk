 ...
 * @version 
 */
public class ChangeTenantStatusRequest extends RpcAcsRequest<ChangeTenantStatusResponse> {
	...
	public ChangeTenantStatusRequest() {
		super("UniMkt", "2018-12-12", "ChangeTenantStatus", "uniMkt");
	...
	@Override
	public Class<ChangeTenantStatusResponse> getResponseClass() {
		return ChangeTenantStatusResponse.class;
	}
