 ...
 * @version 
 */
public class ModifyTenantInfoRequest extends RpcAcsRequest<ModifyTenantInfoResponse> {
	...
	public ModifyTenantInfoRequest() {
		super("UniMkt", "2018-12-12", "ModifyTenantInfo", "uniMkt");
	...
	@Override
	public Class<ModifyTenantInfoResponse> getResponseClass() {
		return ModifyTenantInfoResponse.class;
	}
