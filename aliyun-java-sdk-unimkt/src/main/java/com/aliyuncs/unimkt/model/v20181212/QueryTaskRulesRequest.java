 ...
 * @version 
 */
public class QueryTaskRulesRequest extends RpcAcsRequest<QueryTaskRulesResponse> {
	...
	public QueryTaskRulesRequest() {
		super("UniMkt", "2018-12-12", "QueryTaskRules", "uniMkt");
	...
	@Override
	public Class<QueryTaskRulesResponse> getResponseClass() {
		return QueryTaskRulesResponse.class;
	}
