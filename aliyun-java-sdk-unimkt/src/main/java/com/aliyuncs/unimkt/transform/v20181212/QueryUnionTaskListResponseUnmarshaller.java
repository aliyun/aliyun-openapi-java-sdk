...
public class QueryUnionTaskListResponseUnmarshaller {
	...
	public static QueryUnionTaskListResponse unmarshall(QueryUnionTaskListResponse queryUnionTaskListResponse, UnmarshallerContext _ctx) {
		
		queryUnionTaskListResponse.setRequestId(_ctx.stringValue("QueryUnionTaskListResponse.RequestId"));
