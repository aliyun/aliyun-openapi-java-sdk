...
import com.aliyuncs.videoenhan.model.v20200320.ToneSdrVideoResponse;
import com.aliyuncs.videoenhan.model.v20200320.ToneSdrVideoResponse.Data;
...
public class ToneSdrVideoResponseUnmarshaller {
	...
	public static ToneSdrVideoResponse unmarshall(ToneSdrVideoResponse toneSdrVideoResponse, UnmarshallerContext _ctx) {
		...
		toneSdrVideoResponse.setData(data);
