 ...
 * @version 
 */
public class AbstractFilmVideoRequest extends RpcAcsRequest<AbstractFilmVideoResponse> {
	...
	@Override
	public Class<AbstractFilmVideoResponse> getResponseClass() {
		return AbstractFilmVideoResponse.class;
	}
