 ...
 * @version 
 */
public class SuperResolveVideoRequest extends RpcAcsRequest<SuperResolveVideoResponse> {
	...
	@Override
	public Class<SuperResolveVideoResponse> getResponseClass() {
		return SuperResolveVideoResponse.class;
	}
