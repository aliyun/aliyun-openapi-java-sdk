...
import com.aliyuncs.ons.transform.v20170918.OnsSubscriptionListResponseUnmarshaller;
 ...
 * @version 
 */
public class OnsSubscriptionListResponse extends AcsResponse {
	...
	@Override
	public OnsSubscriptionListResponse getInstance(UnmarshallerContext context) {
		return	OnsSubscriptionListResponseUnmarshaller.unmarshall(this, context);
	}
}
