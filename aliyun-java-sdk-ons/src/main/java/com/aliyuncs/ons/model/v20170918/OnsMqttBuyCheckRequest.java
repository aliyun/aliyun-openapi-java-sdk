 ...
 * @version 
 */
public class OnsMqttBuyCheckRequest extends RpcAcsRequest<OnsMqttBuyCheckResponse> {
	
	public OnsMqttBuyCheckRequest() {
		super("Ons", "2017-09-18", "OnsMqttBuyCheck");
	}
	...
	@Override
	public Class<OnsMqttBuyCheckResponse> getResponseClass() {
		return OnsMqttBuyCheckResponse.class;
	}
