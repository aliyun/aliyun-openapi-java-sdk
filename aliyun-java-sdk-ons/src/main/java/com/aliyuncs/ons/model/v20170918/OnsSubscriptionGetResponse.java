...
import com.aliyuncs.ons.transform.v20170918.OnsSubscriptionGetResponseUnmarshaller;
 ...
 * @version 
 */
public class OnsSubscriptionGetResponse extends AcsResponse {
	...
	@Override
	public OnsSubscriptionGetResponse getInstance(UnmarshallerContext context) {
		return	OnsSubscriptionGetResponseUnmarshaller.unmarshall(this, context);
	}
}
