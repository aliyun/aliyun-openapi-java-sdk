 ...
 * @version 
 */
public class OnsBuyOrdersProduceRequest extends RpcAcsRequest<OnsBuyOrdersProduceResponse> {
	
	public OnsBuyOrdersProduceRequest() {
		super("Ons", "2017-09-18", "OnsBuyOrdersProduce");
	}
	...
	@Override
	public Class<OnsBuyOrdersProduceResponse> getResponseClass() {
		return OnsBuyOrdersProduceResponse.class;
	}
