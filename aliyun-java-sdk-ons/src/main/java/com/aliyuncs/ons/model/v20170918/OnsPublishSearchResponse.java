...
import com.aliyuncs.ons.transform.v20170918.OnsPublishSearchResponseUnmarshaller;
 ...
 * @version 
 */
public class OnsPublishSearchResponse extends AcsResponse {
	...
	@Override
	public OnsPublishSearchResponse getInstance(UnmarshallerContext context) {
		return	OnsPublishSearchResponseUnmarshaller.unmarshall(this, context);
	}
}
