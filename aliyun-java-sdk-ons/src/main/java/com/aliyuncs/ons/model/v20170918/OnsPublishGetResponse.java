...
import com.aliyuncs.ons.transform.v20170918.OnsPublishGetResponseUnmarshaller;
 ...
 * @version 
 */
public class OnsPublishGetResponse extends AcsResponse {
	...
	@Override
	public OnsPublishGetResponse getInstance(UnmarshallerContext context) {
		return	OnsPublishGetResponseUnmarshaller.unmarshall(this, context);
	}
}
