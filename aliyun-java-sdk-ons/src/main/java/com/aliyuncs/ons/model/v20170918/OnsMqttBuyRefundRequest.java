 ...
 * @version 
 */
public class OnsMqttBuyRefundRequest extends RpcAcsRequest<OnsMqttBuyRefundResponse> {
	
	public OnsMqttBuyRefundRequest() {
		super("Ons", "2017-09-18", "OnsMqttBuyRefund");
	}
	...
	@Override
	public Class<OnsMqttBuyRefundResponse> getResponseClass() {
		return OnsMqttBuyRefundResponse.class;
	}
