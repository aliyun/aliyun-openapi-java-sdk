...
import com.aliyuncs.ons.transform.v20180628.OnsMessageGetByKeyResponseUnmarshaller;
...
public class OnsMessageGetByKeyResponse extends AcsResponse {
	...
	public void setData(List<OnsRestMessageDo> data) {
		this.data = data;
	}
	...
	@Override
	public OnsMessageGetByKeyResponse getInstance(UnmarshallerContext context) {
		return	OnsMessageGetByKeyResponseUnmarshaller.unmarshall(this, context);
	}
}
