...
import com.aliyuncs.ons.transform.v20190214.OnsMessageDetailResponseUnmarshaller;
 ...
 * @version 
 */
public class OnsMessageDetailResponse extends AcsResponse {
	...
	@Override
	public OnsMessageDetailResponse getInstance(UnmarshallerContext context) {
		return	OnsMessageDetailResponseUnmarshaller.unmarshall(this, context);
	}
