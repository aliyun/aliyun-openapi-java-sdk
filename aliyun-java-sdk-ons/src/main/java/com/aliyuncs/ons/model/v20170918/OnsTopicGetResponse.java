...
import com.aliyuncs.ons.transform.v20170918.OnsTopicGetResponseUnmarshaller;
 ...
 * @version 
 */
public class OnsTopicGetResponse extends AcsResponse {
	...
	@Override
	public OnsTopicGetResponse getInstance(UnmarshallerContext context) {
		return	OnsTopicGetResponseUnmarshaller.unmarshall(this, context);
	}
}
