...
import com.aliyuncs.ons.transform.v20180516.OnsMqttQueryClientByGroupIdResponseUnmarshaller;
 ...
 * @version 
 */
public class OnsMqttQueryClientByGroupIdResponse extends AcsResponse {
	...
	@Override
	public OnsMqttQueryClientByGroupIdResponse getInstance(UnmarshallerContext context) {
		return	OnsMqttQueryClientByGroupIdResponseUnmarshaller.unmarshall(this, context);
	}
}
