 ...
 * @version 
 */
public class OnsMqttManualUpdateRuleRequest extends RpcAcsRequest<OnsMqttManualUpdateRuleResponse> {
	
	public OnsMqttManualUpdateRuleRequest() {
		super("Ons", "2017-09-18", "OnsMqttManualUpdateRule");
	}
	...
	public void setAdminKey(String adminKey) {
		...
		if(adminKey != null){
			putQueryParameter("AdminKey", adminKey);
		}
	}

	@Override
	public Class<OnsMqttManualUpdateRuleResponse> getResponseClass() {
		return OnsMqttManualUpdateRuleResponse.class;
	}
