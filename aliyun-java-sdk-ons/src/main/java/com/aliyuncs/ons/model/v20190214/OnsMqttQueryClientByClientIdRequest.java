...
public class OnsMqttQueryClientByClientIdRequest extends RpcAcsRequest<OnsMqttQueryClientByClientIdResponse> {
	...
	public OnsMqttQueryClientByClientIdRequest() {
		super("Ons", "2019-02-14", "OnsMqttQueryClientByClientId", "ons");
	...
	@Override
	public Class<OnsMqttQueryClientByClientIdResponse> getResponseClass() {
		return OnsMqttQueryClientByClientIdResponse.class;
	}
