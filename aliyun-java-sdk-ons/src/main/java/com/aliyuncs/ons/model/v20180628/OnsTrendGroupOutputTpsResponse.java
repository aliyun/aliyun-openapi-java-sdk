...
import com.aliyuncs.ons.transform.v20180628.OnsTrendGroupOutputTpsResponseUnmarshaller;
...
public class OnsTrendGroupOutputTpsResponse extends AcsResponse {
	...
	@Override
	public OnsTrendGroupOutputTpsResponse getInstance(UnmarshallerContext context) {
		return	OnsTrendGroupOutputTpsResponseUnmarshaller.unmarshall(this, context);
	}
}
