...
import com.aliyuncs.ons.transform.v20180516.OnsSubscriptionSearchResponseUnmarshaller;
...
public class OnsSubscriptionSearchResponse extends AcsResponse {
	...
	@Override
	public OnsSubscriptionSearchResponse getInstance(UnmarshallerContext context) {
		return	OnsSubscriptionSearchResponseUnmarshaller.unmarshall(this, context);
	}
}
