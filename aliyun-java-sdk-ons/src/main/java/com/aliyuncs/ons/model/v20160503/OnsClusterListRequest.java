 ...
 * @version 
 */
public class OnsClusterListRequest extends RpcAcsRequest<OnsClusterListResponse> {
	
	public OnsClusterListRequest() {
		super("Ons", "2016-05-03", "OnsClusterList");
	}
	...
	@Override
	public Class<OnsClusterListResponse> getResponseClass() {
		return OnsClusterListResponse.class;
	}
