...
import com.aliyuncs.ons.transform.v20190214.OnsDLQMessagePageQueryByGroupIdResponseUnmarshaller;
 ...
 * @version 
 */
public class OnsDLQMessagePageQueryByGroupIdResponse extends AcsResponse {
	...
	@Override
	public OnsDLQMessagePageQueryByGroupIdResponse getInstance(UnmarshallerContext context) {
		return	OnsDLQMessagePageQueryByGroupIdResponseUnmarshaller.unmarshall(this, context);
	}
}
