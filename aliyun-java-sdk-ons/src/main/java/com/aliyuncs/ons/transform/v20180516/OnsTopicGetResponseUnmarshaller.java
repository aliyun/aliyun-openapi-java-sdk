...
import com.aliyuncs.ons.model.v20180516.OnsTopicGetResponse.PublishInfoDo;
...
public class OnsTopicGetResponseUnmarshaller {
	...
	public static OnsTopicGetResponse unmarshall(OnsTopicGetResponse onsTopicGetResponse, UnmarshallerContext context) {
		...
		for (int i = 0; i < context.lengthValue("OnsTopicGetResponse.Data.Length"); i++) {
			...
			publishInfoDo.setInstanceId(context.stringValue("OnsTopicGetResponse.Data["+ i +"].InstanceId"));
			publishInfoDo.setIndependentNaming(context.booleanValue("OnsTopicGetResponse.Data["+ i +"].IndependentNaming"));
