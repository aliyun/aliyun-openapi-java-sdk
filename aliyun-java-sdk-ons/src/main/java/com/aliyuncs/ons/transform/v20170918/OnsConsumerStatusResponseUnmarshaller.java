...
import com.aliyuncs.ons.model.v20170918.OnsConsumerStatusResponse;
import com.aliyuncs.ons.model.v20170918.OnsConsumerStatusResponse.Data;
import com.aliyuncs.ons.model.v20170918.OnsConsumerStatusResponse.Data.ConnectionDo;
import com.aliyuncs.ons.model.v20170918.OnsConsumerStatusResponse.Data.ConsumerConnectionInfoDo;
import com.aliyuncs.ons.model.v20170918.OnsConsumerStatusResponse.Data.ConsumerConnectionInfoDo.ConsumerRunningDataDo;
import com.aliyuncs.ons.model.v20170918.OnsConsumerStatusResponse.Data.ConsumerConnectionInfoDo.SubscriptionData;
import com.aliyuncs.ons.model.v20170918.OnsConsumerStatusResponse.Data.ConsumerConnectionInfoDo.ThreadTrackDo;
import com.aliyuncs.ons.model.v20170918.OnsConsumerStatusResponse.Data.DetailInTopicDo;
	...
	public static OnsConsumerStatusResponse unmarshall(OnsConsumerStatusResponse onsConsumerStatusResponse, UnmarshallerContext context) {
		...
		for (int i = 0; i < context.lengthValue("OnsConsumerStatusResponse.Data.ConsumerConnectionInfoList.Length"); i++) {
			...
			for (int j = 0; j < context.lengthValue("OnsConsumerStatusResponse.Data.ConsumerConnectionInfoList["+ i +"].RunningDataList.Length"); j++) {
				...
				consumerRunningDataDo.setConsumerId(context.stringValue("OnsConsumerStatusResponse.Data.ConsumerConnectionInfoList["+ i +"].RunningDataList["+ j +"].ConsumerId"));
