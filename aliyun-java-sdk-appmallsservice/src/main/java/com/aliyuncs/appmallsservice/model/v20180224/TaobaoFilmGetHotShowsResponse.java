...
import com.aliyuncs.appmallsservice.transform.v20180224.TaobaoFilmGetHotShowsResponseUnmarshaller;
 ...
 * @version 
 */
public class TaobaoFilmGetHotShowsResponse extends AcsResponse {
	...
	@Override
	public TaobaoFilmGetHotShowsResponse getInstance(UnmarshallerContext context) {
		return	TaobaoFilmGetHotShowsResponseUnmarshaller.unmarshall(this, context);
	}
