 ...
 * @version 
 */
public class SaveAuthenticationInfoRequest extends RpcAcsRequest<SaveAuthenticationInfoResponse> {
	...
	@Override
	public Class<SaveAuthenticationInfoResponse> getResponseClass() {
