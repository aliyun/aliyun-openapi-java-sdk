 ...
 * @version 
 */
public class GetRepoWebhookLogListRequest extends RoaAcsRequest<GetRepoWebhookLogListResponse> {
	...
	@Override
	public Class<GetRepoWebhookLogListResponse> getResponseClass() {
		return GetRepoWebhookLogListResponse.class;
	}
