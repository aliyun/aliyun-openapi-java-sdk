...
public class GetNamespaceAuthorizationListResponse extends AcsResponse {
	...
	@Override
	public GetNamespaceAuthorizationListResponse getInstance(UnmarshallerContext context) {
		return	GetNamespaceAuthorizationListResponseUnmarshaller.unmarshall(this, context);
	}
}
