 ...
 * @version 
 */
public class GetRepoAuthorizationListRequest extends RoaAcsRequest<GetRepoAuthorizationListResponse> {
	
	public GetRepoAuthorizationListRequest() {
		super("cr", "2016-06-07", "GetRepoAuthorizationList", "cr");
	...
	@Override
	public Class<GetRepoAuthorizationListResponse> getResponseClass() {
		return GetRepoAuthorizationListResponse.class;
	}
