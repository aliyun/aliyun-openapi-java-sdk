 ...
 * @version 
 */
public class GetImageScanRequest extends RoaAcsRequest<GetImageScanResponse> {
	
	public GetImageScanRequest() {
		super("cr", "2016-06-07", "GetImageScan", "cr");
	...
	@Override
	public Class<GetImageScanResponse> getResponseClass() {
		return GetImageScanResponse.class;
	}
