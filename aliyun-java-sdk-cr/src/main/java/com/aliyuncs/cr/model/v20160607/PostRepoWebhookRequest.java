 ...
 * @version 
 */
public class PostRepoWebhookRequest extends RoaAcsRequest<PostRepoWebhookResponse> {
	
	public PostRepoWebhookRequest() {
		super("cr", "2016-06-07", "PostRepoWebhook");
	...
	@Override
	public Class<PostRepoWebhookResponse> getResponseClass() {
		return PostRepoWebhookResponse.class;
	}
