 ...
 * @version 
 */
public class StartRepoBuildRequest extends RoaAcsRequest<StartRepoBuildResponse> {
	
	public StartRepoBuildRequest() {
		super("cr", "2016-06-07", "StartRepoBuild", "cr");
	...
	@Override
	public Class<StartRepoBuildResponse> getResponseClass() {
		return StartRepoBuildResponse.class;
	}
