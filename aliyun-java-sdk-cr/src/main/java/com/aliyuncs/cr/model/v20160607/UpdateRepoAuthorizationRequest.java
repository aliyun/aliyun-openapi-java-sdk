 ...
 * @version 
 */
public class UpdateRepoAuthorizationRequest extends RoaAcsRequest<UpdateRepoAuthorizationResponse> {
	
	public UpdateRepoAuthorizationRequest() {
		super("cr", "2016-06-07", "UpdateRepoAuthorization", "cr");
	...
	@Override
	public Class<UpdateRepoAuthorizationResponse> getResponseClass() {
		return UpdateRepoAuthorizationResponse.class;
	}
