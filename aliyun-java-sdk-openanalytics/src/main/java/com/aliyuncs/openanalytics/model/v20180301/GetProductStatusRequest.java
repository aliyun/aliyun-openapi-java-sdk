 ...
 * @version 
 */
public class GetProductStatusRequest extends RpcAcsRequest<GetProductStatusResponse> {
	
	public GetProductStatusRequest() {
		super("openanalytics", "2018-03-01", "GetProductStatus", "openanalytics");
	}
	...
	@Override
	public Class<GetProductStatusResponse> getResponseClass() {
		return GetProductStatusResponse.class;
	}
