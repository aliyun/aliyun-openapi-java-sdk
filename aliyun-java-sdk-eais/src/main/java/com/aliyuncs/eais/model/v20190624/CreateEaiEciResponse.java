...
import com.aliyuncs.eais.transform.v20190624.CreateEaiEciResponseUnmarshaller;
 ...
 * @version 
 */
public class CreateEaiEciResponse extends AcsResponse {
	...
	@Override
	public CreateEaiEciResponse getInstance(UnmarshallerContext context) {
		return	CreateEaiEciResponseUnmarshaller.unmarshall(this, context);
	}
