...
import com.aliyuncs.eais.transform.v20190624.AttachEaiResponseUnmarshaller;
 ...
 * @version 
 */
public class AttachEaiResponse extends AcsResponse {
	...
	@Override
	public AttachEaiResponse getInstance(UnmarshallerContext context) {
		return	AttachEaiResponseUnmarshaller.unmarshall(this, context);
	}
