 ...
 * @version 
 */
public class DeleteEaisEiRequest extends RpcAcsRequest<DeleteEaisEiResponse> {
	   

	private String eiInstanceId;

	private Boolean force;
	public DeleteEaisEiRequest() {
		super("eais", "2019-06-24", "DeleteEaisEi", "eais");
	...
	@Override
	public Class<DeleteEaisEiResponse> getResponseClass() {
		return DeleteEaisEiResponse.class;
	}
