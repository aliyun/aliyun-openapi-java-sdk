 ...
 * @version 
 */
public class StartEaisEiRequest extends RpcAcsRequest<StartEaisEiResponse> {
	   

	private String eiInstanceId;
	public StartEaisEiRequest() {
		super("eais", "2019-06-24", "StartEaisEi", "eais");
	...
	@Override
	public Class<StartEaisEiResponse> getResponseClass() {
		return StartEaisEiResponse.class;
	}
