...
import com.aliyuncs.eais.transform.v20190624.CreateEaiEcsResponseUnmarshaller;
 ...
 * @version 
 */
public class CreateEaiEcsResponse extends AcsResponse {
	...
	@Override
	public CreateEaiEcsResponse getInstance(UnmarshallerContext context) {
		return	CreateEaiEcsResponseUnmarshaller.unmarshall(this, context);
	}
