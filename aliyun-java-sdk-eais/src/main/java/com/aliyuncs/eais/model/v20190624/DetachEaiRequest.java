 ...
 * @version 
 */
public class DetachEaiRequest extends RpcAcsRequest<DetachEaiResponse> {
	   

	private String elasticAcceleratedInstanceId;
	public DetachEaiRequest() {
		super("eais", "2019-06-24", "DetachEai", "eais");
	...
	@Override
	public Class<DetachEaiResponse> getResponseClass() {
		return DetachEaiResponse.class;
	}
