 ...
 * @version 
 */
public class StopEaisEiRequest extends RpcAcsRequest<StopEaisEiResponse> {
	   

	private String eiInstanceId;
	public StopEaisEiRequest() {
		super("eais", "2019-06-24", "StopEaisEi", "eais");
	...
	@Override
	public Class<StopEaisEiResponse> getResponseClass() {
		return StopEaisEiResponse.class;
	}
