...
import com.aliyuncs.eais.transform.v20190624.StartEaiJupyterResponseUnmarshaller;
 ...
 * @version 
 */
public class StartEaiJupyterResponse extends AcsResponse {
	...
	@Override
	public StartEaiJupyterResponse getInstance(UnmarshallerContext context) {
		return	StartEaiJupyterResponseUnmarshaller.unmarshall(this, context);
	}
