 ...
 * @version 
 */
public class DetachEaisEiRequest extends RpcAcsRequest<DetachEaisEiResponse> {
	   

	private String eiInstanceId;
	public DetachEaisEiRequest() {
		super("eais", "2019-06-24", "DetachEaisEi", "eais");
	...
	@Override
	public Class<DetachEaisEiResponse> getResponseClass() {
		return DetachEaisEiResponse.class;
	}
