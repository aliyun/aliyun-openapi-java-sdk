...
import com.aliyuncs.lto.transform.v20210707.ListPrivacyRuleSharedMemberResponseUnmarshaller;
 ...
 * @version 
 */
public class ListPrivacyRuleSharedMemberResponse extends AcsResponse {
	...
	@Override
	public ListPrivacyRuleSharedMemberResponse getInstance(UnmarshallerContext context) {
		return	ListPrivacyRuleSharedMemberResponseUnmarshaller.unmarshall(this, context);
	}
