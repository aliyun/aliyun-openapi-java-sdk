 ...
 * @version 
 */
public class DeletePrivacyRuleRequest extends RpcAcsRequest<DeletePrivacyRuleResponse> {
	   

	private String privacyRuleId;
	public DeletePrivacyRuleRequest() {
		super("lto", "2021-07-07", "DeletePrivacyRule");
	...
	@Override
	public Class<DeletePrivacyRuleResponse> getResponseClass() {
		return DeletePrivacyRuleResponse.class;
	}
