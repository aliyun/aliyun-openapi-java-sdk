 ...
 * @version 
 */
public class ListBaaSAntChainPeerRequest extends RpcAcsRequest<ListBaaSAntChainPeerResponse> {
	...
	public ListBaaSAntChainPeerRequest() {
		super("lto", "2021-07-07", "ListBaaSAntChainPeer");
	...
	@Override
	public Class<ListBaaSAntChainPeerResponse> getResponseClass() {
		return ListBaaSAntChainPeerResponse.class;
	}
