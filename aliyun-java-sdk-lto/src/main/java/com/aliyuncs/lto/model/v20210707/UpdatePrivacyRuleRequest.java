 ...
 * @version 
 */
public class UpdatePrivacyRuleRequest extends RpcAcsRequest<UpdatePrivacyRuleResponse> {
	...
	public UpdatePrivacyRuleRequest() {
		super("lto", "2021-07-07", "UpdatePrivacyRule");
	...
	@Override
	public Class<UpdatePrivacyRuleResponse> getResponseClass() {
		return UpdatePrivacyRuleResponse.class;
	}
