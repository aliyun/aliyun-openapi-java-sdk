 ...
 * @version 
 */
public class ListBaaSFabricChannelRequest extends RpcAcsRequest<ListBaaSFabricChannelResponse> {
	   

	private String baaSFabricConsortiumId;
	public ListBaaSFabricChannelRequest() {
		super("lto", "2021-07-07", "ListBaaSFabricChannel");
	...
	@Override
	public Class<ListBaaSFabricChannelResponse> getResponseClass() {
		return ListBaaSFabricChannelResponse.class;
	}
