...
import com.aliyuncs.lto.transform.v20210707.DescribeStatDeviceInfoResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeStatDeviceInfoResponse extends AcsResponse {
	...
	public static class Data {
		...
		private List<BizChainInfo> bizChainList;

		public Integer getTotalAuthorizedCount() {
			return this.totalAuthorizedCount;
		}

		public void setTotalAuthorizedCount(Integer totalAuthorizedCount) {
		...
		public void setDistributableCount(Integer distributableCount) {
			this.distributableCount = distributableCount;
		}

		public List<BizChainInfo> getBizChainList() {
			return this.bizChainList;
		}

		public void setBizChainList(List<BizChainInfo> bizChainList) {
	...
	@Override
	public DescribeStatDeviceInfoResponse getInstance(UnmarshallerContext context) {
		return	DescribeStatDeviceInfoResponseUnmarshaller.unmarshall(this, context);
	}
