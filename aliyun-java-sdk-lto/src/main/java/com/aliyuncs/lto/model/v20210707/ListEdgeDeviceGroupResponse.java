...
import com.aliyuncs.lto.transform.v20210707.ListEdgeDeviceGroupResponseUnmarshaller;
 ...
 * @version 
 */
public class ListEdgeDeviceGroupResponse extends AcsResponse {
	...
	@Override
	public ListEdgeDeviceGroupResponse getInstance(UnmarshallerContext context) {
		return	ListEdgeDeviceGroupResponseUnmarshaller.unmarshall(this, context);
	}
