...
import com.aliyuncs.lto.transform.v20210707.ListMemberAccessRecordResponseUnmarshaller;
 ...
 * @version 
 */
public class ListMemberAccessRecordResponse extends AcsResponse {
	...
	public static class Data {
		...
		public static class MemberInfo {
			...
			public void setMemberResponseDate(Long memberResponseDate) {
	...
	@Override
	public ListMemberAccessRecordResponse getInstance(UnmarshallerContext context) {
		return	ListMemberAccessRecordResponseUnmarshaller.unmarshall(this, context);
	}
