 ...
 * @version 
 */
public class QueryBlockchainMetadataRequest extends RpcAcsRequest<QueryBlockchainMetadataResponse> {
	...
	public QueryBlockchainMetadataRequest() {
		super("lto", "2021-07-07", "QueryBlockchainMetadata");
	...
	@Override
	public Class<QueryBlockchainMetadataResponse> getResponseClass() {
		return QueryBlockchainMetadataResponse.class;
	}
