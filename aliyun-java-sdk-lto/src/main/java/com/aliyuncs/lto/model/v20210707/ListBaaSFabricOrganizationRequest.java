 ...
 * @version 
 */
public class ListBaaSFabricOrganizationRequest extends RpcAcsRequest<ListBaaSFabricOrganizationResponse> {
	   

	private String baaSFabricChannelId;
	public ListBaaSFabricOrganizationRequest() {
		super("lto", "2021-07-07", "ListBaaSFabricOrganization");
	...
	@Override
	public Class<ListBaaSFabricOrganizationResponse> getResponseClass() {
		return ListBaaSFabricOrganizationResponse.class;
	}
