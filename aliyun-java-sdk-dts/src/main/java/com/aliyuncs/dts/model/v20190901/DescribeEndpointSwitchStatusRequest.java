...
public class DescribeEndpointSwitchStatusRequest extends RpcAcsRequest<DescribeEndpointSwitchStatusResponse> {
	...
	public DescribeEndpointSwitchStatusRequest() {
		super("Dts", "2019-09-01", "DescribeEndpointSwitchStatus");
	...
	@Override
	public Class<DescribeEndpointSwitchStatusResponse> getResponseClass() {
		return DescribeEndpointSwitchStatusResponse.class;
	}
