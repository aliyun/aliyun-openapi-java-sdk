 ...
 * @version 
 */
public class StartDtsJobRequest extends RpcAcsRequest<StartDtsJobResponse> {
	...
	public StartDtsJobRequest() {
		super("Dts", "2020-01-01", "StartDtsJob", "dts");
	...
	@Override
	public Class<StartDtsJobResponse> getResponseClass() {
		return StartDtsJobResponse.class;
	}
