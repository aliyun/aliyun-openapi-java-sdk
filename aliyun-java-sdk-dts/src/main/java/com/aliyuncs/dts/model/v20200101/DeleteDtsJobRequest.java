 ...
 * @version 
 */
public class DeleteDtsJobRequest extends RpcAcsRequest<DeleteDtsJobResponse> {
	...
	@Override
	public Class<DeleteDtsJobResponse> getResponseClass() {
		return DeleteDtsJobResponse.class;
	}
