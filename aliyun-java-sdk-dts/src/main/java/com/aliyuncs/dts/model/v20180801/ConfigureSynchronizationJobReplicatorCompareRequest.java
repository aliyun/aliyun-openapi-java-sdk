 ...
 * @version 
 */
public class ConfigureSynchronizationJobReplicatorCompareRequest extends RpcAcsRequest<ConfigureSynchronizationJobReplicatorCompareResponse> {
	...
	public ConfigureSynchronizationJobReplicatorCompareRequest() {
		super("Dts", "2018-08-01", "ConfigureSynchronizationJobReplicatorCompare", "dts");
	...
	public void setSynchronizationReplicatorCompareEnable(Boolean synchronizationReplicatorCompareEnable) {
		...
		if(synchronizationReplicatorCompareEnable != null){
			putQueryParameter("SynchronizationReplicatorCompareEnable", synchronizationReplicatorCompareEnable.toString());
		}
	}
	...
	@Override
	public Class<ConfigureSynchronizationJobReplicatorCompareResponse> getResponseClass() {
		return ConfigureSynchronizationJobReplicatorCompareResponse.class;
	}
