 ...
 * @version 
 */
public class SuspendDtsJobRequest extends RpcAcsRequest<SuspendDtsJobResponse> {
	...
	@Override
	public Class<SuspendDtsJobResponse> getResponseClass() {
		return SuspendDtsJobResponse.class;
	}
