 ...
 * @version 
 */
public class ModifyDtsJobPasswordRequest extends RpcAcsRequest<ModifyDtsJobPasswordResponse> {
	...
	@Override
	public Class<ModifyDtsJobPasswordResponse> getResponseClass() {
		return ModifyDtsJobPasswordResponse.class;
	}
