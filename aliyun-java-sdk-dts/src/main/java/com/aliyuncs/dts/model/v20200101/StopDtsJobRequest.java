 ...
 * @version 
 */
public class StopDtsJobRequest extends RpcAcsRequest<StopDtsJobResponse> {
	...
	public StopDtsJobRequest() {
		super("Dts", "2020-01-01", "StopDtsJob", "dts");
	...
	@Override
	public Class<StopDtsJobResponse> getResponseClass() {
		return StopDtsJobResponse.class;
	}
