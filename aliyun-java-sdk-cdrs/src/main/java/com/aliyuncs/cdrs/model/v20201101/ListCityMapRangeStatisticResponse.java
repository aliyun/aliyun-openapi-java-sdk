...
import com.aliyuncs.cdrs.transform.v20201101.ListCityMapRangeStatisticResponseUnmarshaller;
 ...
 * @version 
 */
public class ListCityMapRangeStatisticResponse extends AcsResponse {
	...
	@Override
	public ListCityMapRangeStatisticResponse getInstance(UnmarshallerContext context) {
		return	ListCityMapRangeStatisticResponseUnmarshaller.unmarshall(this, context);
	}
