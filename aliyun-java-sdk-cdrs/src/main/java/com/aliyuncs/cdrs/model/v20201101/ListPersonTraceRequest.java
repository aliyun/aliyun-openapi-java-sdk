 ...
 * @version 
 */
public class ListPersonTraceRequest extends RpcAcsRequest<ListPersonTraceResponse> {
	...
	public ListPersonTraceRequest() {
		super("CDRS", "2020-11-01", "ListPersonTrace");
	...
	@Override
	public Class<ListPersonTraceResponse> getResponseClass() {
