 ...
 * @version 
 */
public class AddCdrsMonitorRequest extends RpcAcsRequest<AddCdrsMonitorResponse> {
	...
	public AddCdrsMonitorRequest() {
		super("CDRS", "2020-11-01", "AddCdrsMonitor");
	...
	@Override
	public Class<AddCdrsMonitorResponse> getResponseClass() {
		return AddCdrsMonitorResponse.class;
	}
