 ...
 * @version 
 */
public class SearchAggregateObjectRequest extends RpcAcsRequest<SearchAggregateObjectResponse> {
	...
	public SearchAggregateObjectRequest() {
		super("CDRS", "2020-11-01", "SearchAggregateObject");
	...
	@Override
	public Class<SearchAggregateObjectResponse> getResponseClass() {
		return SearchAggregateObjectResponse.class;
	}
