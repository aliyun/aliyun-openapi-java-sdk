 ...
 * @version 
 */
public class GetCdrsMonitorResultRequest extends RpcAcsRequest<GetCdrsMonitorResultResponse> {
	...
	public GetCdrsMonitorResultRequest() {
		super("CDRS", "2020-11-01", "GetCdrsMonitorResult");
	...
	@Override
	public Class<GetCdrsMonitorResultResponse> getResponseClass() {
		return GetCdrsMonitorResultResponse.class;
	}
