...
import com.aliyuncs.cdrs.transform.v20201101.ListDeviceDetailResponseUnmarshaller;
 ...
 * @version 
 */
public class ListDeviceDetailResponse extends AcsResponse {
	...
	@Override
	public ListDeviceDetailResponse getInstance(UnmarshallerContext context) {
		return	ListDeviceDetailResponseUnmarshaller.unmarshall(this, context);
	}
