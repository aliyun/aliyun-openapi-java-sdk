 ...
 * @version 
 */
public class ListPersonTrackRequest extends RpcAcsRequest<ListPersonTrackResponse> {
	...
	public ListPersonTrackRequest() {
		super("CDRS", "2020-11-01", "ListPersonTrack");
	...
	@Override
	public Class<ListPersonTrackResponse> getResponseClass() {
		return ListPersonTrackResponse.class;
	}
