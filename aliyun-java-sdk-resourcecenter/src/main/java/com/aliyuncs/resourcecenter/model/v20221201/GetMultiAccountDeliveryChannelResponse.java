...
import com.aliyuncs.resourcecenter.transform.v20221201.GetMultiAccountDeliveryChannelResponseUnmarshaller;
 ...
 * @version 
 */
public class GetMultiAccountDeliveryChannelResponse extends AcsResponse {
	...
	@Override
	public GetMultiAccountDeliveryChannelResponse getInstance(UnmarshallerContext context) {
		return	GetMultiAccountDeliveryChannelResponseUnmarshaller.unmarshall(this, context);
	}
