 ...
 * @version 
 */
public class UpdateMultiAccountDeliveryChannelRequest extends RpcAcsRequest<UpdateMultiAccountDeliveryChannelResponse> {
	...
	public UpdateMultiAccountDeliveryChannelRequest() {
		super("ResourceCenter", "2022-12-01", "UpdateMultiAccountDeliveryChannel");
	...
	public void setResourceChangeDelivery(ResourceChangeDelivery resourceChangeDelivery) {
		...
		if (resourceChangeDelivery != null) {
				...
				putQueryParameter("ResourceChangeDelivery.Enabled" , resourceChangeDelivery.getEnabled());
	...
	public void setDeliveryChannelFilter(DeliveryChannelFilter deliveryChannelFilter) {
		...
		if (deliveryChannelFilter != null) {
				...
				if (deliveryChannelFilter.getAccountScopes() != null) {
					for (int depth1 = 0; depth1 < deliveryChannelFilter.getAccountScopes().size(); depth1++) {
						putQueryParameter("DeliveryChannelFilter.AccountScopes." + (depth1 + 1) , deliveryChannelFilter.getAccountScopes().get(depth1));
					}
				}
		}	
	}
	...
	public void setResourceSnapshotDelivery(ResourceSnapshotDelivery resourceSnapshotDelivery) {
		...
		if (resourceSnapshotDelivery != null) {
				...
				putQueryParameter("ResourceSnapshotDelivery.Enabled" , resourceSnapshotDelivery.getEnabled());
	...
	public static class DeliveryChannelFilter {
		...
		public List<String> getAccountScopes() {
			return this.accountScopes;
		}

		public void setAccountScopes(List<String> accountScopes) {
	...
	@Override
	public Class<UpdateMultiAccountDeliveryChannelResponse> getResponseClass() {
		return UpdateMultiAccountDeliveryChannelResponse.class;
	}
