...
import com.aliyuncs.resourcecenter.transform.v20221201.ListMultiAccountResourceRelationshipsResponseUnmarshaller;
 ...
 * @version 
 */
public class ListMultiAccountResourceRelationshipsResponse extends AcsResponse {
	...
	@Override
	public ListMultiAccountResourceRelationshipsResponse getInstance(UnmarshallerContext context) {
		return	ListMultiAccountResourceRelationshipsResponseUnmarshaller.unmarshall(this, context);
	}
