...
import com.aliyuncs.resourcecenter.transform.v20221201.ListMultiAccountDeliveryChannelsResponseUnmarshaller;
 ...
 * @version 
 */
public class ListMultiAccountDeliveryChannelsResponse extends AcsResponse {
	...
	@Override
	public ListMultiAccountDeliveryChannelsResponse getInstance(UnmarshallerContext context) {
		return	ListMultiAccountDeliveryChannelsResponseUnmarshaller.unmarshall(this, context);
	}
