...
import com.aliyuncs.resourcecenter.transform.v20221201.GetMultiAccountDeliveryChannelStatisticsResponseUnmarshaller;
 ...
 * @version 
 */
public class GetMultiAccountDeliveryChannelStatisticsResponse extends AcsResponse {
	...
	@Override
	public GetMultiAccountDeliveryChannelStatisticsResponse getInstance(UnmarshallerContext context) {
		return	GetMultiAccountDeliveryChannelStatisticsResponseUnmarshaller.unmarshall(this, context);
	}
