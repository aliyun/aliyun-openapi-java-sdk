 ...
 * @version 
 */
public class ListResourceRelationshipsRequest extends RpcAcsRequest<ListResourceRelationshipsResponse> {
	...
	public ListResourceRelationshipsRequest() {
		super("ResourceCenter", "2022-12-01", "ListResourceRelationships");
	...
	@Override
	public Class<ListResourceRelationshipsResponse> getResponseClass() {
		return ListResourceRelationshipsResponse.class;
	}
