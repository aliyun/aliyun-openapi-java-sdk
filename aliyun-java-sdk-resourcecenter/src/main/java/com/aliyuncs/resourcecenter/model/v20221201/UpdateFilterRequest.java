 ...
 * @version 
 */
public class UpdateFilterRequest extends RpcAcsRequest<UpdateFilterResponse> {
	...
	public UpdateFilterRequest() {
		super("ResourceCenter", "2022-12-01", "UpdateFilter");
	...
	@Override
	public Class<UpdateFilterResponse> getResponseClass() {
		return UpdateFilterResponse.class;
	}
