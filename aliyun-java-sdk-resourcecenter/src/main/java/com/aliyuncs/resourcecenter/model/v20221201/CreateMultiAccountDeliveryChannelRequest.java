 ...
 * @version 
 */
public class CreateMultiAccountDeliveryChannelRequest extends RpcAcsRequest<CreateMultiAccountDeliveryChannelResponse> {
	...
	public CreateMultiAccountDeliveryChannelRequest() {
		super("ResourceCenter", "2022-12-01", "CreateMultiAccountDeliveryChannel");
	...
	@Override
	public Class<CreateMultiAccountDeliveryChannelResponse> getResponseClass() {
		return CreateMultiAccountDeliveryChannelResponse.class;
	}
