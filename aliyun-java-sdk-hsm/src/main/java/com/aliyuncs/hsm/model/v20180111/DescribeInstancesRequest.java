...
public class DescribeInstancesRequest extends RpcAcsRequest<DescribeInstancesResponse> {
	...
	public DescribeInstancesRequest() {
		super("hsm", "2018-01-11", "DescribeInstances", "hsm");
	}
	...
	public Integer getHsmStatus() {
		return this.hsmStatus;
	}

	public void setHsmStatus(Integer hsmStatus) {
		this.hsmStatus = hsmStatus;
		if(hsmStatus != null){
			putQueryParameter("HsmStatus", hsmStatus.toString());
		}
	}
