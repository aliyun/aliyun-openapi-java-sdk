 ...
 * @version 
 */
public class DeleteDirectoriesRequest extends RpcAcsRequest<DeleteDirectoriesResponse> {
	...
	@Override
	public Class<DeleteDirectoriesResponse> getResponseClass() {
		return DeleteDirectoriesResponse.class;
	}
