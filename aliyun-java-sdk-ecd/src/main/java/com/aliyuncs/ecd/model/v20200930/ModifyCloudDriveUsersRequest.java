 ...
 * @version 
 */
public class ModifyCloudDriveUsersRequest extends RpcAcsRequest<ModifyCloudDriveUsersResponse> {
	...
	public ModifyCloudDriveUsersRequest() {
		super("ecd", "2020-09-30", "ModifyCloudDriveUsers", "gwsecd");
	...
	@Override
	public Class<ModifyCloudDriveUsersResponse> getResponseClass() {
		return ModifyCloudDriveUsersResponse.class;
	}
