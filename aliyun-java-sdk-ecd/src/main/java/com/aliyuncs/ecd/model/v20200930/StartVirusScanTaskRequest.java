 ...
 * @version 
 */
public class StartVirusScanTaskRequest extends RpcAcsRequest<StartVirusScanTaskResponse> {
	...
	public StartVirusScanTaskRequest() {
		super("ecd", "2020-09-30", "StartVirusScanTask", "gwsecd");
	...
	@Override
	public Class<StartVirusScanTaskResponse> getResponseClass() {
		return StartVirusScanTaskResponse.class;
	}
