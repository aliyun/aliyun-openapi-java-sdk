 ...
 * @version 
 */
public class GetSpMetadataRequest extends RpcAcsRequest<GetSpMetadataResponse> {
	...
	@Override
	public Class<GetSpMetadataResponse> getResponseClass() {
		return GetSpMetadataResponse.class;
	}
