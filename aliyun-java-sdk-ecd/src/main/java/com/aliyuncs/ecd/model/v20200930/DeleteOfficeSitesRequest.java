 ...
 * @version 
 */
public class DeleteOfficeSitesRequest extends RpcAcsRequest<DeleteOfficeSitesResponse> {
	...
	@Override
	public Class<DeleteOfficeSitesResponse> getResponseClass() {
		return DeleteOfficeSitesResponse.class;
	}
