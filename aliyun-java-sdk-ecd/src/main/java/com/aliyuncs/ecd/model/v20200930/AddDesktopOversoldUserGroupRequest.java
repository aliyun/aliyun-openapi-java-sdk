 ...
 * @version 
 */
public class AddDesktopOversoldUserGroupRequest extends RpcAcsRequest<AddDesktopOversoldUserGroupResponse> {
	...
	public AddDesktopOversoldUserGroupRequest() {
		super("ecd", "2020-09-30", "AddDesktopOversoldUserGroup", "gwsecd");
	...
	@Override
	public Class<AddDesktopOversoldUserGroupResponse> getResponseClass() {
		return AddDesktopOversoldUserGroupResponse.class;
	}
