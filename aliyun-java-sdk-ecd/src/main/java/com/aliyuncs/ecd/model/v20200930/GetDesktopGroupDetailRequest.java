 ...
 * @version 
 */
public class GetDesktopGroupDetailRequest extends RpcAcsRequest<GetDesktopGroupDetailResponse> {
	...
	@Override
	public Class<GetDesktopGroupDetailResponse> getResponseClass() {
		return GetDesktopGroupDetailResponse.class;
	}
