 ...
 * @version 
 */
public class DetachEndUserRequest extends RpcAcsRequest<DetachEndUserResponse> {
	...
	@Override
	public Class<DetachEndUserResponse> getResponseClass() {
		return DetachEndUserResponse.class;
	}
