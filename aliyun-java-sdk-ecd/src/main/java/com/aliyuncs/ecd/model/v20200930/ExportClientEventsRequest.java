 ...
 * @version 
 */
public class ExportClientEventsRequest extends RpcAcsRequest<ExportClientEventsResponse> {
	...
	@Override
	public Class<ExportClientEventsResponse> getResponseClass() {
		return ExportClientEventsResponse.class;
	}
