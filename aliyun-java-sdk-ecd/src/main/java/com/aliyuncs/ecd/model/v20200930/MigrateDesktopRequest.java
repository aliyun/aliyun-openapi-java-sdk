 ...
 * @version 
 */
public class MigrateDesktopRequest extends RpcAcsRequest<MigrateDesktopResponse> {
	   

	private String targetDirectoryId;

	private List<String> desktopIds;
	public MigrateDesktopRequest() {
		super("ecd", "2020-09-30", "MigrateDesktop");
	...
	@Override
	public Class<MigrateDesktopResponse> getResponseClass() {
		return MigrateDesktopResponse.class;
	}
