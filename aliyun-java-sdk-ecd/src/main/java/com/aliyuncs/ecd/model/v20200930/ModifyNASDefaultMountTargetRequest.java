 ...
 * @version 
 */
public class ModifyNASDefaultMountTargetRequest extends RpcAcsRequest<ModifyNASDefaultMountTargetResponse> {
	...
	@Override
	public Class<ModifyNASDefaultMountTargetResponse> getResponseClass() {
		return ModifyNASDefaultMountTargetResponse.class;
	}
