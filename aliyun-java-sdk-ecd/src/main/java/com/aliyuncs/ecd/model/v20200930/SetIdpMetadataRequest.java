 ...
 * @version 
 */
public class SetIdpMetadataRequest extends RpcAcsRequest<SetIdpMetadataResponse> {
	...
	public void setIdpMetadata(String idpMetadata) {
		...
		if(idpMetadata != null){
			putQueryParameter("IdpMetadata", idpMetadata);
		}
	}

	@Override
	public Class<SetIdpMetadataResponse> getResponseClass() {
		return SetIdpMetadataResponse.class;
	}
