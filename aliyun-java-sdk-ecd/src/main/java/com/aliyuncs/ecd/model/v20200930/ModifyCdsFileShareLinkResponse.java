...
import com.aliyuncs.ecd.transform.v20200930.ModifyCdsFileShareLinkResponseUnmarshaller;
 ...
 * @version 
 */
public class ModifyCdsFileShareLinkResponse extends AcsResponse {
	...
	@Override
	public ModifyCdsFileShareLinkResponse getInstance(UnmarshallerContext context) {
		return	ModifyCdsFileShareLinkResponseUnmarshaller.unmarshall(this, context);
	}
