 ...
 * @version 
 */
public class DeleteBundlesRequest extends RpcAcsRequest<DeleteBundlesResponse> {
	...
	@Override
	public Class<DeleteBundlesResponse> getResponseClass() {
		return DeleteBundlesResponse.class;
	}
