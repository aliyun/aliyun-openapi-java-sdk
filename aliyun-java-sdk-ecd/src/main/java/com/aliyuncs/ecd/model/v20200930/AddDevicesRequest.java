 ...
 * @version 
 */
public class AddDevicesRequest extends RpcAcsRequest<AddDevicesResponse> {
	...
	public AddDevicesRequest() {
		super("ecd", "2020-09-30", "AddDevices", "gwsecd");
	...
	@Override
	public Class<AddDevicesResponse> getResponseClass() {
		return AddDevicesResponse.class;
	}
