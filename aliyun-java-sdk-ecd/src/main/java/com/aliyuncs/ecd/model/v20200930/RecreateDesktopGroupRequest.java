 ...
 * @version 
 */
public class RecreateDesktopGroupRequest extends RpcAcsRequest<RecreateDesktopGroupResponse> {
	   

	private String ownBundleId;

	private String desktopGroupId;
	public RecreateDesktopGroupRequest() {
		super("ecd", "2020-09-30", "RecreateDesktopGroup");
	...
	@Override
	public Class<RecreateDesktopGroupResponse> getResponseClass() {
		return RecreateDesktopGroupResponse.class;
	}
