 ...
 * @version 
 */
public class DeleteDesktopGroupRequest extends RpcAcsRequest<DeleteDesktopGroupResponse> {
	...
	@Override
	public Class<DeleteDesktopGroupResponse> getResponseClass() {
		return DeleteDesktopGroupResponse.class;
	}
