 ...
 * @version 
 */
public class ModifyDesktopOversoldGroupSaleRequest extends RpcAcsRequest<ModifyDesktopOversoldGroupSaleResponse> {
	...
	public ModifyDesktopOversoldGroupSaleRequest() {
		super("ecd", "2020-09-30", "ModifyDesktopOversoldGroupSale", "gwsecd");
	...
	@Override
	public Class<ModifyDesktopOversoldGroupSaleResponse> getResponseClass() {
		return ModifyDesktopOversoldGroupSaleResponse.class;
	}
