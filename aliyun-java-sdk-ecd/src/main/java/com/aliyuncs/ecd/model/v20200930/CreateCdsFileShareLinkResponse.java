...
import com.aliyuncs.ecd.transform.v20200930.CreateCdsFileShareLinkResponseUnmarshaller;
 ...
 * @version 
 */
public class CreateCdsFileShareLinkResponse extends AcsResponse {
	...
	@Override
	public CreateCdsFileShareLinkResponse getInstance(UnmarshallerContext context) {
		return	CreateCdsFileShareLinkResponseUnmarshaller.unmarshall(this, context);
	}
