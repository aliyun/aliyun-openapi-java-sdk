 ...
 * @version 
 */
public class WakeupDesktopsRequest extends RpcAcsRequest<WakeupDesktopsResponse> {
	...
	@Override
	public Class<WakeupDesktopsResponse> getResponseClass() {
		return WakeupDesktopsResponse.class;
	}
