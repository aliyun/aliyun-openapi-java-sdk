...
import com.aliyuncs.ecd.transform.v20200930.VerifyCenResponseUnmarshaller;
 ...
 * @version 
 */
public class VerifyCenResponse extends AcsResponse {
	...
	@Override
	public VerifyCenResponse getInstance(UnmarshallerContext context) {
		return	VerifyCenResponseUnmarshaller.unmarshall(this, context);
	}
