 ...
 * @version 
 */
public class DescribeNetworkPackagesRequest extends RpcAcsRequest<DescribeNetworkPackagesResponse> {
	...
	@Override
	public Class<DescribeNetworkPackagesResponse> getResponseClass() {
		return DescribeNetworkPackagesResponse.class;
	}
