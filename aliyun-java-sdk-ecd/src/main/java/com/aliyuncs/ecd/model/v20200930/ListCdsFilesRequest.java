 ...
 * @version 
 */
public class ListCdsFilesRequest extends RpcAcsRequest<ListCdsFilesResponse> {
	...
	@Override
	public Class<ListCdsFilesResponse> getResponseClass() {
		return ListCdsFilesResponse.class;
	}
