 ...
 * @version 
 */
public class DeletePolicyGroupsRequest extends RpcAcsRequest<DeletePolicyGroupsResponse> {
	...
	@Override
	public Class<DeletePolicyGroupsResponse> getResponseClass() {
		return DeletePolicyGroupsResponse.class;
	}
