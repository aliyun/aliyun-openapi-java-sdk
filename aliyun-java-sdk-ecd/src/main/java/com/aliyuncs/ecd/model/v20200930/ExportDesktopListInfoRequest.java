 ...
 * @version 
 */
public class ExportDesktopListInfoRequest extends RpcAcsRequest<ExportDesktopListInfoResponse> {
	...
	@Override
	public Class<ExportDesktopListInfoResponse> getResponseClass() {
		return ExportDesktopListInfoResponse.class;
	}
