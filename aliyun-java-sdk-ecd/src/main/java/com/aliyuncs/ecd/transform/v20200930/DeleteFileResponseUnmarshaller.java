...
import com.aliyuncs.ecd.model.v20200930.DeleteFileResponse;
...
public class DeleteFileResponseUnmarshaller {
	...
	public static DeleteFileResponse unmarshall(DeleteFileResponse deleteFileResponse, UnmarshallerContext _ctx) {
		...
		deleteFileResponse.setSuccess(_ctx.stringValue("DeleteFileResponse.Success"));
		deleteFileResponse.setData(_ctx.booleanValue("DeleteFileResponse.Data"));
