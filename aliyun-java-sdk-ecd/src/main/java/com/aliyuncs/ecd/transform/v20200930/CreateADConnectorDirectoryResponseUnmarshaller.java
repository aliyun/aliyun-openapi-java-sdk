...
import com.aliyuncs.ecd.model.v20200930.CreateADConnectorDirectoryResponse;
import com.aliyuncs.ecd.model.v20200930.CreateADConnectorDirectoryResponse.AdConnector;
import com.aliyuncs.transform.UnmarshallerContext;


public class CreateADConnectorDirectoryResponseUnmarshaller {
	...
	public static CreateADConnectorDirectoryResponse unmarshall(CreateADConnectorDirectoryResponse createADConnectorDirectoryResponse, UnmarshallerContext _ctx) {
		...
		for (int i = 0; i < _ctx.lengthValue("CreateADConnectorDirectoryResponse.AdConnectors.Length"); i++) {
			...
			adConnector.setAddress(_ctx.stringValue("CreateADConnectorDirectoryResponse.AdConnectors["+ i +"].Address"));

			adConnectors.add(adConnector);
		}
		createADConnectorDirectoryResponse.setAdConnectors(adConnectors);
