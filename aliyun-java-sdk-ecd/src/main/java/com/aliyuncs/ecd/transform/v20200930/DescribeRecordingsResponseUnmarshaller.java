...
public class DescribeRecordingsResponseUnmarshaller {
	...
	public static DescribeRecordingsResponse unmarshall(DescribeRecordingsResponse describeRecordingsResponse, UnmarshallerContext _ctx) {
		...
		for (int i = 0; i < _ctx.lengthValue("DescribeRecordingsResponse.Recordings.Length"); i++) {
			...
			recording.setPolicyGroupId(_ctx.stringValue("DescribeRecordingsResponse.Recordings["+ i +"].PolicyGroupId"));
			recording.setDesktopName(_ctx.stringValue("DescribeRecordingsResponse.Recordings["+ i +"].DesktopName"));
			recording.setSignedUrl(_ctx.stringValue("DescribeRecordingsResponse.Recordings["+ i +"].SignedUrl"));
