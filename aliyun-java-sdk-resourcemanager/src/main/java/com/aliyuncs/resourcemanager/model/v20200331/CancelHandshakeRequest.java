 ...
 * @version 
 */
public class CancelHandshakeRequest extends RpcAcsRequest<CancelHandshakeResponse> {
	...
	@Override
	public Class<CancelHandshakeResponse> getResponseClass() {
		return CancelHandshakeResponse.class;
	}
