 ...
 * @version 
 */
public class BindSecureMobilePhoneRequest extends RpcAcsRequest<BindSecureMobilePhoneResponse> {
	...
	@Override
	public Class<BindSecureMobilePhoneResponse> getResponseClass() {
		return BindSecureMobilePhoneResponse.class;
	}
