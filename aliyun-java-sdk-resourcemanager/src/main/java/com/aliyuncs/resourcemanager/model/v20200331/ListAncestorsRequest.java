 ...
 * @version 
 */
public class ListAncestorsRequest extends RpcAcsRequest<ListAncestorsResponse> {
	...
	@Override
	public Class<ListAncestorsResponse> getResponseClass() {
		return ListAncestorsResponse.class;
	}
