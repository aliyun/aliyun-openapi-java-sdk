 ...
 * @version 
 */
public class GetHandshakeRequest extends RpcAcsRequest<GetHandshakeResponse> {
	...
	@Override
	public Class<GetHandshakeResponse> getResponseClass() {
		return GetHandshakeResponse.class;
	}
