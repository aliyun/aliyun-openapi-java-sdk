 ...
 * @version 
 */
public class GetResourceGroupRequest extends RpcAcsRequest<GetResourceGroupResponse> {
	...
	@Override
	public Class<GetResourceGroupResponse> getResponseClass() {
		return GetResourceGroupResponse.class;
	}
