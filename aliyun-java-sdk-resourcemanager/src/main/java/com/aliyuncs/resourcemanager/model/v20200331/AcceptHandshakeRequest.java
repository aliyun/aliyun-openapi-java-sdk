 ...
 * @version 
 */
public class AcceptHandshakeRequest extends RpcAcsRequest<AcceptHandshakeResponse> {
	...
	@Override
	public Class<AcceptHandshakeResponse> getResponseClass() {
		return AcceptHandshakeResponse.class;
	}
