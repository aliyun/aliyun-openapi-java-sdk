...
import com.aliyuncs.resourcemanager.transform.v20200331.EnableResourceDirectoryResponseUnmarshaller;
 ...
 * @version 
 */
public class EnableResourceDirectoryResponse extends AcsResponse {
	...
	@Override
	public EnableResourceDirectoryResponse getInstance(UnmarshallerContext context) {
		return	EnableResourceDirectoryResponseUnmarshaller.unmarshall(this, context);
	}
