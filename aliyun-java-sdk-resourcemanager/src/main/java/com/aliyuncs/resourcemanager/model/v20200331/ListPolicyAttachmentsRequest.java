 ...
 * @version 
 */
public class ListPolicyAttachmentsRequest extends RpcAcsRequest<ListPolicyAttachmentsResponse> {
	...
	@Override
	public Class<ListPolicyAttachmentsResponse> getResponseClass() {
		return ListPolicyAttachmentsResponse.class;
	}
