 ...
 * @version 
 */
public class DetachControlPolicyRequest extends RpcAcsRequest<DetachControlPolicyResponse> {
	...
	@Override
	public Class<DetachControlPolicyResponse> getResponseClass() {
		return DetachControlPolicyResponse.class;
	}
