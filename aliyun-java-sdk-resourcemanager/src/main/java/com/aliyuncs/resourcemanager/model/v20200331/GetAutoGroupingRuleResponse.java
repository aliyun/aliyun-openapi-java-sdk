...
import com.aliyuncs.resourcemanager.transform.v20200331.GetAutoGroupingRuleResponseUnmarshaller;
 ...
 * @version 
 */
public class GetAutoGroupingRuleResponse extends AcsResponse {
	...
	@Override
	public GetAutoGroupingRuleResponse getInstance(UnmarshallerContext context) {
		return	GetAutoGroupingRuleResponseUnmarshaller.unmarshall(this, context);
	}
