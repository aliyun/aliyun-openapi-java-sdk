...
public class DeleteAccountRequest extends RpcAcsRequest<DeleteAccountResponse> {
	...
	@SerializedName("abandonableCheckId")
	private List<String> abandonableCheckId;
	...
	public void setAbandonableCheckId(List<String> abandonableCheckId) {
		this.abandonableCheckId = abandonableCheckId;	
		if (abandonableCheckId != null) {
			putQueryParameter("AbandonableCheckId" , new Gson().toJson(abandonableCheckId));
		}	
	}
