...
import com.aliyuncs.resourcemanager.transform.v20200331.ListHandshakesForResourceDirectoryResponseUnmarshaller;
...
public class ListHandshakesForResourceDirectoryResponse extends AcsResponse {
	...
	@Override
	public ListHandshakesForResourceDirectoryResponse getInstance(UnmarshallerContext context) {
		return	ListHandshakesForResourceDirectoryResponseUnmarshaller.unmarshall(this, context);
	}
}
