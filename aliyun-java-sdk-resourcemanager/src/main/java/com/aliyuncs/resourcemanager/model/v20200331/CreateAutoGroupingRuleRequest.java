 ...
 * @version 
 */
public class CreateAutoGroupingRuleRequest extends RpcAcsRequest<CreateAutoGroupingRuleResponse> {
	...
	public CreateAutoGroupingRuleRequest() {
		super("ResourceManager", "2020-03-31", "CreateAutoGroupingRule", "resourcemanager");
	...
	@Override
	public Class<CreateAutoGroupingRuleResponse> getResponseClass() {
		return CreateAutoGroupingRuleResponse.class;
	}
