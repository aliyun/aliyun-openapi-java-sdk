...
public class DescribeSlowSQLHistoryListRequest extends RpcAcsRequest<DescribeSlowSQLHistoryListResponse> {
	...
	public DescribeSlowSQLHistoryListRequest() {
		super("OceanBasePro", "2019-09-01", "DescribeSlowSQLHistoryList");
	...
	@Override
	public Class<DescribeSlowSQLHistoryListResponse> getResponseClass() {
		return DescribeSlowSQLHistoryListResponse.class;
	}
