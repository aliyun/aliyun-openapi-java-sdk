...
public class CreateTenantReadOnlyConnectionRequest extends RpcAcsRequest<CreateTenantReadOnlyConnectionResponse> {
	...
	public CreateTenantReadOnlyConnectionRequest() {
		super("OceanBasePro", "2019-09-01", "CreateTenantReadOnlyConnection", "oceanbase");
	...
	@Override
	public Class<CreateTenantReadOnlyConnectionResponse> getResponseClass() {
		return CreateTenantReadOnlyConnectionResponse.class;
	}
