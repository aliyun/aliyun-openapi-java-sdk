 ...
 * @version 
 */
public class DescribeOasAnomalySQLListRequest extends RpcAcsRequest<DescribeOasAnomalySQLListResponse> {
	...
	public DescribeOasAnomalySQLListRequest() {
		super("OceanBasePro", "2019-09-01", "DescribeOasAnomalySQLList", "oceanbase");
	...
	@Override
	public Class<DescribeOasAnomalySQLListResponse> getResponseClass() {
		return DescribeOasAnomalySQLListResponse.class;
	}
