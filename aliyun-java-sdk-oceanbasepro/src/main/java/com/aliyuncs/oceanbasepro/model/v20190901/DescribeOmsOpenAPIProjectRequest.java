 ...
 * @version 
 */
public class DescribeOmsOpenAPIProjectRequest extends RpcAcsRequest<DescribeOmsOpenAPIProjectResponse> {
	...
	@Override
	public Class<DescribeOmsOpenAPIProjectResponse> getResponseClass() {
		return DescribeOmsOpenAPIProjectResponse.class;
	}
