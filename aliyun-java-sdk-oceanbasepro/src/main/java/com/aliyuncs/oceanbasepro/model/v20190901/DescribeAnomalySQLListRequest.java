 ...
 * @version 
 */
public class DescribeAnomalySQLListRequest extends RpcAcsRequest<DescribeAnomalySQLListResponse> {
	...
	public DescribeAnomalySQLListRequest() {
		super("OceanBasePro", "2019-09-01", "DescribeAnomalySQLList", "oceanbase");
	...
	@Override
	public Class<DescribeAnomalySQLListResponse> getResponseClass() {
		return DescribeAnomalySQLListResponse.class;
	}
