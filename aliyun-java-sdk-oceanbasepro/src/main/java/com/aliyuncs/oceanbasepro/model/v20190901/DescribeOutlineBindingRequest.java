 ...
 * @version 
 */
public class DescribeOutlineBindingRequest extends RpcAcsRequest<DescribeOutlineBindingResponse> {
	...
	public DescribeOutlineBindingRequest() {
		super("OceanBasePro", "2019-09-01", "DescribeOutlineBinding", "oceanbase");
	...
	@Override
	public Class<DescribeOutlineBindingResponse> getResponseClass() {
		return DescribeOutlineBindingResponse.class;
	}
