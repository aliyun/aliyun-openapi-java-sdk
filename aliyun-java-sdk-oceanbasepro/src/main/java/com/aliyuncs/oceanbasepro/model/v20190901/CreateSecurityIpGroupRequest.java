 ...
 * @version 
 */
public class CreateSecurityIpGroupRequest extends RpcAcsRequest<CreateSecurityIpGroupResponse> {
	...
	public CreateSecurityIpGroupRequest() {
		super("OceanBasePro", "2019-09-01", "CreateSecurityIpGroup", "oceanbase");
	...
	@Override
	public Class<CreateSecurityIpGroupResponse> getResponseClass() {
		return CreateSecurityIpGroupResponse.class;
	}
