 ...
 * @version 
 */
public class DescribeOasSQLDetailsRequest extends RpcAcsRequest<DescribeOasSQLDetailsResponse> {
	...
	public DescribeOasSQLDetailsRequest() {
		super("OceanBasePro", "2019-09-01", "DescribeOasSQLDetails", "oceanbase");
	...
	@Override
	public Class<DescribeOasSQLDetailsResponse> getResponseClass() {
		return DescribeOasSQLDetailsResponse.class;
	}
