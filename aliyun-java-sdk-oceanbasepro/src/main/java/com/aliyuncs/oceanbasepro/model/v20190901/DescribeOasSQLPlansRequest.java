...
public class DescribeOasSQLPlansRequest extends RpcAcsRequest<DescribeOasSQLPlansResponse> {
	...
	public DescribeOasSQLPlansRequest() {
		super("OceanBasePro", "2019-09-01", "DescribeOasSQLPlans", "oceanbase");
	...
	@Override
	public Class<DescribeOasSQLPlansResponse> getResponseClass() {
		return DescribeOasSQLPlansResponse.class;
	}
