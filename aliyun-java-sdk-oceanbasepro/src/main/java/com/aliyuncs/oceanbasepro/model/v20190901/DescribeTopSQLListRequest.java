 ...
 * @version 
 */
public class DescribeTopSQLListRequest extends RpcAcsRequest<DescribeTopSQLListResponse> {
	...
	public DescribeTopSQLListRequest() {
		super("OceanBasePro", "2019-09-01", "DescribeTopSQLList", "oceanbase");
	...
	@Override
	public Class<DescribeTopSQLListResponse> getResponseClass() {
		return DescribeTopSQLListResponse.class;
	}
