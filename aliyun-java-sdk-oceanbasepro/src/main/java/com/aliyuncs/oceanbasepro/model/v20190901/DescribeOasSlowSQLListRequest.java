 ...
 * @version 
 */
public class DescribeOasSlowSQLListRequest extends RpcAcsRequest<DescribeOasSlowSQLListResponse> {
	...
	public DescribeOasSlowSQLListRequest() {
		super("OceanBasePro", "2019-09-01", "DescribeOasSlowSQLList", "oceanbase");
	...
	@Override
	public Class<DescribeOasSlowSQLListResponse> getResponseClass() {
		return DescribeOasSlowSQLListResponse.class;
	}
