...
import com.aliyuncs.oceanbasepro.transform.v20190901.DescribeSlowSQLListResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeSlowSQLListResponse extends AcsResponse {

	private Long totalCount;

	private String requestId;

	private List<Data> slowSQLList;
	...
	public List<Data> getSlowSQLList() {
		return this.slowSQLList;
	}

	public void setSlowSQLList(List<Data> slowSQLList) {
	...
	@Override
	public DescribeSlowSQLListResponse getInstance(UnmarshallerContext context) {
		return	DescribeSlowSQLListResponseUnmarshaller.unmarshall(this, context);
	}
