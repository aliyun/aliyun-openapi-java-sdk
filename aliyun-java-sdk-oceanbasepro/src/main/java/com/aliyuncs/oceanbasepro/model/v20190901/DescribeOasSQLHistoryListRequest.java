 ...
 * @version 
 */
public class DescribeOasSQLHistoryListRequest extends RpcAcsRequest<DescribeOasSQLHistoryListResponse> {
	...
	public DescribeOasSQLHistoryListRequest() {
		super("OceanBasePro", "2019-09-01", "DescribeOasSQLHistoryList", "oceanbase");
	...
	@Override
	public Class<DescribeOasSQLHistoryListResponse> getResponseClass() {
		return DescribeOasSQLHistoryListResponse.class;
	}
