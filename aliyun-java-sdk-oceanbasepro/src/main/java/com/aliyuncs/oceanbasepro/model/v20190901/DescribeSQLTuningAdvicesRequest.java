 ...
 * @version 
 */
public class DescribeSQLTuningAdvicesRequest extends RpcAcsRequest<DescribeSQLTuningAdvicesResponse> {
	...
	@Override
	public Class<DescribeSQLTuningAdvicesResponse> getResponseClass() {
