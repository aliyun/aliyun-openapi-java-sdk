...
public class DescribeOasSQLHistoryListResponseUnmarshaller {
	...
	public static DescribeOasSQLHistoryListResponse unmarshall(DescribeOasSQLHistoryListResponse describeOasSQLHistoryListResponse, UnmarshallerContext _ctx) {
		...
		for (int i = 0; i < _ctx.lengthValue("DescribeOasSQLHistoryListResponse.Data.Length"); i++) {
			...
			dataItem.setAvgAffectedRows(_ctx.doubleValue("DescribeOasSQLHistoryListResponse.Data["+ i +"].AvgAffectedRows"));
			dataItem.setAvgBlockCacheHit(_ctx.doubleValue("DescribeOasSQLHistoryListResponse.Data["+ i +"].AvgBlockCacheHit"));
			dataItem.setAvgBlockIndexCacheHit(_ctx.doubleValue("DescribeOasSQLHistoryListResponse.Data["+ i +"].AvgBlockIndexCacheHit"));
			dataItem.setAvgBloomFilterCacheHit(_ctx.doubleValue("DescribeOasSQLHistoryListResponse.Data["+ i +"].AvgBloomFilterCacheHit"));
			...
			dataItem.setAvgRpcCount(_ctx.doubleValue("DescribeOasSQLHistoryListResponse.Data["+ i +"].AvgRpcCount"));
			...
			dataItem.setAvgReturnRows(_ctx.doubleValue("DescribeOasSQLHistoryListResponse.Data["+ i +"].AvgReturnRows"));
			dataItem.setAvgLogicalReads(_ctx.doubleValue("DescribeOasSQLHistoryListResponse.Data["+ i +"].AvgLogicalReads"));
			dataItem.setRetryCount(_ctx.longValue("DescribeOasSQLHistoryListResponse.Data["+ i +"].RetryCount"));
			dataItem.setAvgRowCacheHit(_ctx.doubleValue("DescribeOasSQLHistoryListResponse.Data["+ i +"].AvgRowCacheHit"));
			dataItem.setAvgDiskReads(_ctx.doubleValue("DescribeOasSQLHistoryListResponse.Data["+ i +"].AvgDiskReads"));
			dataItem.setAvgMemstoreReadRows(_ctx.doubleValue("DescribeOasSQLHistoryListResponse.Data["+ i +"].AvgMemstoreReadRows"));
			dataItem.setAvgSsstoreReadRows(_ctx.doubleValue("DescribeOasSQLHistoryListResponse.Data["+ i +"].AvgSsstoreReadRows"));
			...
			dataItem.setRetCode4012Count(_ctx.longValue("DescribeOasSQLHistoryListResponse.Data["+ i +"].RetCode4012Count"));
			dataItem.setRetCode4013Count(_ctx.longValue("DescribeOasSQLHistoryListResponse.Data["+ i +"].RetCode4013Count"));
			dataItem.setRetCode5001Count(_ctx.longValue("DescribeOasSQLHistoryListResponse.Data["+ i +"].RetCode5001Count"));
			dataItem.setRetCode5024Count(_ctx.longValue("DescribeOasSQLHistoryListResponse.Data["+ i +"].RetCode5024Count"));
			dataItem.setRetCode5167Count(_ctx.longValue("DescribeOasSQLHistoryListResponse.Data["+ i +"].RetCode5167Count"));
			dataItem.setRetCode5217Count(_ctx.longValue("DescribeOasSQLHistoryListResponse.Data["+ i +"].RetCode5217Count"));
			dataItem.setRetCode6002Count(_ctx.longValue("DescribeOasSQLHistoryListResponse.Data["+ i +"].RetCode6002Count"));
