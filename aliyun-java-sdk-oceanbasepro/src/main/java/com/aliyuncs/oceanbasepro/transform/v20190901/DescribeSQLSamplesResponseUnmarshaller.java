...
public class DescribeSQLSamplesResponseUnmarshaller {
	...
	public static DescribeSQLSamplesResponse unmarshall(DescribeSQLSamplesResponse describeSQLSamplesResponse, UnmarshallerContext _ctx) {
		...
		for (int i = 0; i < _ctx.lengthValue("DescribeSQLSamplesResponse.Data.Length"); i++) {
			...
			dataItem.setRequestId(_ctx.longValue("DescribeSQLSamplesResponse.Data["+ i +"].RequestId"));
			...
			dataItem.setClientPort(_ctx.integerValue("DescribeSQLSamplesResponse.Data["+ i +"].ClientPort"));
			...
			dataItem.setPlanId(_ctx.longValue("DescribeSQLSamplesResponse.Data["+ i +"].PlanId"));
			dataItem.setAffectedRows(_ctx.longValue("DescribeSQLSamplesResponse.Data["+ i +"].AffectedRows"));
			dataItem.setReturnRows(_ctx.longValue("DescribeSQLSamplesResponse.Data["+ i +"].ReturnRows"));
			dataItem.setPartitionCount(_ctx.longValue("DescribeSQLSamplesResponse.Data["+ i +"].PartitionCount"));
			dataItem.setRetCode(_ctx.integerValue("DescribeSQLSamplesResponse.Data["+ i +"].RetCode"));
			...
			dataItem.setWaitCount(_ctx.longValue("DescribeSQLSamplesResponse.Data["+ i +"].WaitCount"));
			dataItem.setRpcCount(_ctx.longValue("DescribeSQLSamplesResponse.Data["+ i +"].RpcCount"));
			...
			dataItem.setRetryCount(_ctx.longValue("DescribeSQLSamplesResponse.Data["+ i +"].RetryCount"));
			...
			dataItem.setMemstoreReadRows(_ctx.longValue("DescribeSQLSamplesResponse.Data["+ i +"].MemstoreReadRows"));
			dataItem.setExpectedWorkerCount(_ctx.longValue("DescribeSQLSamplesResponse.Data["+ i +"].ExpectedWorkerCount"));
			dataItem.setUsedWorkerCount(_ctx.longValue("DescribeSQLSamplesResponse.Data["+ i +"].UsedWorkerCount"));
			dataItem.setSsstoreReadRows(_ctx.longValue("DescribeSQLSamplesResponse.Data["+ i +"].SsstoreReadRows"));
			dataItem.setObServerId(_ctx.longValue("DescribeSQLSamplesResponse.Data["+ i +"].ObServerId"));
			dataItem.setObUserId(_ctx.longValue("DescribeSQLSamplesResponse.Data["+ i +"].ObUserId"));
			dataItem.setObDbId(_ctx.longValue("DescribeSQLSamplesResponse.Data["+ i +"].ObDbId"));
