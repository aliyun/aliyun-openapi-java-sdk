 ...
 * @version 
 */
public class GetAsrServerInfoRequest extends RpcAcsRequest<GetAsrServerInfoResponse> {
	...
	@Override
	public Class<GetAsrServerInfoResponse> getResponseClass() {
		return GetAsrServerInfoResponse.class;
	}
