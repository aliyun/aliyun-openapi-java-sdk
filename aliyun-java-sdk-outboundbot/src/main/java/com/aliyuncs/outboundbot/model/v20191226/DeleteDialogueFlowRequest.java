 ...
 * @version 
 */
public class DeleteDialogueFlowRequest extends RpcAcsRequest<DeleteDialogueFlowResponse> {
	...
	@Override
	public Class<DeleteDialogueFlowResponse> getResponseClass() {
		return DeleteDialogueFlowResponse.class;
	}
