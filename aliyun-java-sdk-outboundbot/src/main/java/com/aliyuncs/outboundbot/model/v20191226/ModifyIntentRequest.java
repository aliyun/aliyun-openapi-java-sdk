 ...
 * @version 
 */
public class ModifyIntentRequest extends RpcAcsRequest<ModifyIntentResponse> {
	...
	@Override
	public Class<ModifyIntentResponse> getResponseClass() {
		return ModifyIntentResponse.class;
	}
