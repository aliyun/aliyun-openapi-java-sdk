 ...
 * @version 
 */
public class ModifyBeebotIntentUserSayRequest extends RpcAcsRequest<ModifyBeebotIntentUserSayResponse> {
	...
	public ModifyBeebotIntentUserSayRequest() {
		super("OutboundBot", "2019-12-26", "ModifyBeebotIntentUserSay", "outboundbot");
	...
	@Override
	public Class<ModifyBeebotIntentUserSayResponse> getResponseClass() {
		return ModifyBeebotIntentUserSayResponse.class;
	}
