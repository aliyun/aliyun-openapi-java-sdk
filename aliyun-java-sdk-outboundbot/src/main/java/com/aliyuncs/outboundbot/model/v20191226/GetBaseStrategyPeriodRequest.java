 ...
 * @version 
 */
public class GetBaseStrategyPeriodRequest extends RpcAcsRequest<GetBaseStrategyPeriodResponse> {
	...
	@Override
	public Class<GetBaseStrategyPeriodResponse> getResponseClass() {
		return GetBaseStrategyPeriodResponse.class;
	}
