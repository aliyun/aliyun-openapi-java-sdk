...
import com.aliyuncs.outboundbot.transform.v20191226.CreateGlobalQuestionResponseUnmarshaller;
...
public class CreateGlobalQuestionResponse extends AcsResponse {
	...
	@Override
	public CreateGlobalQuestionResponse getInstance(UnmarshallerContext context) {
		return	CreateGlobalQuestionResponseUnmarshaller.unmarshall(this, context);
	}
