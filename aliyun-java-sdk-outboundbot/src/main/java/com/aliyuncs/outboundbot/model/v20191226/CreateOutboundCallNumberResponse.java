...
import com.aliyuncs.outboundbot.transform.v20191226.CreateOutboundCallNumberResponseUnmarshaller;
...
public class CreateOutboundCallNumberResponse extends AcsResponse {
	...
	@Override
	public CreateOutboundCallNumberResponse getInstance(UnmarshallerContext context) {
		return	CreateOutboundCallNumberResponseUnmarshaller.unmarshall(this, context);
	}
