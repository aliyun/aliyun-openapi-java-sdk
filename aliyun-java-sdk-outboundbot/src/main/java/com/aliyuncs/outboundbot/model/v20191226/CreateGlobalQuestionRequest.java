 ...
 * @version 
 */
public class CreateGlobalQuestionRequest extends RpcAcsRequest<CreateGlobalQuestionResponse> {
	...
	public CreateGlobalQuestionRequest() {
		super("OutboundBot", "2019-12-26", "CreateGlobalQuestion", "outboundbot");
	...
	@Override
	public Class<CreateGlobalQuestionResponse> getResponseClass() {
		return CreateGlobalQuestionResponse.class;
	}
