 ...
 * @version 
 */
public class RollbackScriptRequest extends RpcAcsRequest<RollbackScriptResponse> {
	...
	public void setRollbackVersion(String rollbackVersion) {
		...
		if(rollbackVersion != null){
			putQueryParameter("RollbackVersion", rollbackVersion);
		}
	}

	@Override
	public Class<RollbackScriptResponse> getResponseClass() {
		return RollbackScriptResponse.class;
	}
