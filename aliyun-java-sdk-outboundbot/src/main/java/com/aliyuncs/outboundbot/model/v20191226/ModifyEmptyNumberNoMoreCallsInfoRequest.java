 ...
 * @version 
 */
public class ModifyEmptyNumberNoMoreCallsInfoRequest extends RpcAcsRequest<ModifyEmptyNumberNoMoreCallsInfoResponse> {
	...
	public void setEmptyNumberNoMoreCalls(Boolean emptyNumberNoMoreCalls) {
		...
		if(emptyNumberNoMoreCalls != null){
			putQueryParameter("EmptyNumberNoMoreCalls", emptyNumberNoMoreCalls.toString());
		}
	}
	...
	@Override
	public Class<ModifyEmptyNumberNoMoreCallsInfoResponse> getResponseClass() {
		return ModifyEmptyNumberNoMoreCallsInfoResponse.class;
	}
