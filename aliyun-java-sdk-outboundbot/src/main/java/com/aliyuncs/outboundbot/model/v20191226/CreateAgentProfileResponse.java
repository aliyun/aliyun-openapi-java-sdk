...
import com.aliyuncs.outboundbot.transform.v20191226.CreateAgentProfileResponseUnmarshaller;
 ...
 * @version 
 */
public class CreateAgentProfileResponse extends AcsResponse {
	...
	@Override
	public CreateAgentProfileResponse getInstance(UnmarshallerContext context) {
		return	CreateAgentProfileResponseUnmarshaller.unmarshall(this, context);
	}
