 ...
 * @version 
 */
public class SaveEffectiveDaysRequest extends RpcAcsRequest<SaveEffectiveDaysResponse> {
	...
	public void setEffectiveDays(Integer effectiveDays) {
		...
		if(effectiveDays != null){
			putQueryParameter("EffectiveDays", effectiveDays.toString());
		}
	}
	...
	@Override
	public Class<SaveEffectiveDaysResponse> getResponseClass() {
		return SaveEffectiveDaysResponse.class;
	}
