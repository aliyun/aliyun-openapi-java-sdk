 ...
 * @version 
 */
public class ImportScriptRequest extends RpcAcsRequest<ImportScriptResponse> {
	...
	@Override
	public Class<ImportScriptResponse> getResponseClass() {
		return ImportScriptResponse.class;
	}
