...
import com.aliyuncs.outboundbot.transform.v20191226.GetJobByPhoneNumberResponseUnmarshaller;
 ...
 * @version 
 */
public class GetJobByPhoneNumberResponse extends AcsResponse {
	...
	@Override
	public GetJobByPhoneNumberResponse getInstance(UnmarshallerContext context) {
		return	GetJobByPhoneNumberResponseUnmarshaller.unmarshall(this, context);
	}
