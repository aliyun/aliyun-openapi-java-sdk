...
import com.aliyuncs.outboundbot.transform.v20191226.ListAgentProfilesResponseUnmarshaller;
 ...
 * @version 
 */
public class ListAgentProfilesResponse extends AcsResponse {
	...
	@Override
	public ListAgentProfilesResponse getInstance(UnmarshallerContext context) {
		return	ListAgentProfilesResponseUnmarshaller.unmarshall(this, context);
	}
