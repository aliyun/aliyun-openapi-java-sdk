 ...
 * @version 
 */
public class DescribeScriptVoiceConfigRequest extends RpcAcsRequest<DescribeScriptVoiceConfigResponse> {
	...
	@Override
	public Class<DescribeScriptVoiceConfigResponse> getResponseClass() {
		return DescribeScriptVoiceConfigResponse.class;
	}
