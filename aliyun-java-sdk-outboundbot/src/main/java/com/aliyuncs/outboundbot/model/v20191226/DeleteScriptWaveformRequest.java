 ...
 * @version 
 */
public class DeleteScriptWaveformRequest extends RpcAcsRequest<DeleteScriptWaveformResponse> {
	...
	public void setScriptWaveformId(String scriptWaveformId) {
		...
		if(scriptWaveformId != null){
			putQueryParameter("ScriptWaveformId", scriptWaveformId);
		}
	}
	...
	@Override
	public Class<DeleteScriptWaveformResponse> getResponseClass() {
		return DeleteScriptWaveformResponse.class;
	}
