...
import com.aliyuncs.outboundbot.transform.v20191226.GetAgentProfileResponseUnmarshaller;
 ...
 * @version 
 */
public class GetAgentProfileResponse extends AcsResponse {
	...
	@Override
	public GetAgentProfileResponse getInstance(UnmarshallerContext context) {
		return	GetAgentProfileResponseUnmarshaller.unmarshall(this, context);
	}
