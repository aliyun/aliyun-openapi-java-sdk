 ...
 * @version 
 */
public class DeleteScriptRecordingRequest extends RpcAcsRequest<DeleteScriptRecordingResponse> {
	...
	@Override
	public Class<DeleteScriptRecordingResponse> getResponseClass() {
		return DeleteScriptRecordingResponse.class;
	}
