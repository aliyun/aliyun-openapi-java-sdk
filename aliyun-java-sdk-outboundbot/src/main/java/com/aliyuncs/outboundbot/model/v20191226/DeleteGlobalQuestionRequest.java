 ...
 * @version 
 */
public class DeleteGlobalQuestionRequest extends RpcAcsRequest<DeleteGlobalQuestionResponse> {
	...
	public DeleteGlobalQuestionRequest() {
		super("OutboundBot", "2019-12-26", "DeleteGlobalQuestion", "outboundbot");
	...
	@Override
	public Class<DeleteGlobalQuestionResponse> getResponseClass() {
		return DeleteGlobalQuestionResponse.class;
	}
