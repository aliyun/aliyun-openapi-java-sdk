 ...
 * @version 
 */
public class GetAgentProfileRequest extends RpcAcsRequest<GetAgentProfileResponse> {
	...
	public GetAgentProfileRequest() {
		super("OutboundBot", "2019-12-26", "GetAgentProfile", "outboundbot");
	...
	@Override
	public Class<GetAgentProfileResponse> getResponseClass() {
		return GetAgentProfileResponse.class;
	}
