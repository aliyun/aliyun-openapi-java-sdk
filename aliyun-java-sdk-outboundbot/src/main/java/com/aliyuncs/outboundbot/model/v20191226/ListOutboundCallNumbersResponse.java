...
import com.aliyuncs.outboundbot.transform.v20191226.ListOutboundCallNumbersResponseUnmarshaller;
...
public class ListOutboundCallNumbersResponse extends AcsResponse {
	...
	public void setOutboundCallNumbers(OutboundCallNumbers outboundCallNumbers) {
	...
	public static class OutboundCallNumbers {
		...
		public void setList(List<OutboundCallNumber> list) {
			this.list = list;
		}
	...
	@Override
	public ListOutboundCallNumbersResponse getInstance(UnmarshallerContext context) {
		return	ListOutboundCallNumbersResponseUnmarshaller.unmarshall(this, context);
	}
