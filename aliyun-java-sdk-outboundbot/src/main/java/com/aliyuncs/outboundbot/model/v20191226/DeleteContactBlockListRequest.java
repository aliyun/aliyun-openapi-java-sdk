 ...
 * @version 
 */
public class DeleteContactBlockListRequest extends RpcAcsRequest<DeleteContactBlockListResponse> {
	...
	public void setContactBlockListId(String contactBlockListId) {
		...
		if(contactBlockListId != null){
			putQueryParameter("ContactBlockListId", contactBlockListId);
		}
	}
	...
	@Override
	public Class<DeleteContactBlockListResponse> getResponseClass() {
		return DeleteContactBlockListResponse.class;
	}
