 ...
 * @version 
 */
public class GetAfterAnswerDelayPlaybackRequest extends RpcAcsRequest<GetAfterAnswerDelayPlaybackResponse> {
	...
	@Override
	public Class<GetAfterAnswerDelayPlaybackResponse> getResponseClass() {
		return GetAfterAnswerDelayPlaybackResponse.class;
	}
