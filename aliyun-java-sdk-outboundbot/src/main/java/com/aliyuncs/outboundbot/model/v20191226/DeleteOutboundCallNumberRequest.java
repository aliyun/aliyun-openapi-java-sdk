 ...
 * @version 
 */
public class DeleteOutboundCallNumberRequest extends RpcAcsRequest<DeleteOutboundCallNumberResponse> {
	...
	@Override
	public Class<DeleteOutboundCallNumberResponse> getResponseClass() {
		return DeleteOutboundCallNumberResponse.class;
	}
