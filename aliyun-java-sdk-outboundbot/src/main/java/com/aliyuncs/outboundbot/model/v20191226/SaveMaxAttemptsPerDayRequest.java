 ...
 * @version 
 */
public class SaveMaxAttemptsPerDayRequest extends RpcAcsRequest<SaveMaxAttemptsPerDayResponse> {
	...
	public void setMaxAttemptsPerDay(Integer maxAttemptsPerDay) {
		...
		if(maxAttemptsPerDay != null){
			putQueryParameter("MaxAttemptsPerDay", maxAttemptsPerDay.toString());
		}
	}
	...
	@Override
	public Class<SaveMaxAttemptsPerDayResponse> getResponseClass() {
		return SaveMaxAttemptsPerDayResponse.class;
	}
