...
import com.aliyuncs.outboundbot.transform.v20191226.CreateScriptWaveformResponseUnmarshaller;
...
public class CreateScriptWaveformResponse extends AcsResponse {
	...
	@Override
	public CreateScriptWaveformResponse getInstance(UnmarshallerContext context) {
		return	CreateScriptWaveformResponseUnmarshaller.unmarshall(this, context);
	}
