 ...
 * @version 
 */
public class DescribeGlobalQuestionRequest extends RpcAcsRequest<DescribeGlobalQuestionResponse> {
	...
	@Override
	public Class<DescribeGlobalQuestionResponse> getResponseClass() {
		return DescribeGlobalQuestionResponse.class;
	}
