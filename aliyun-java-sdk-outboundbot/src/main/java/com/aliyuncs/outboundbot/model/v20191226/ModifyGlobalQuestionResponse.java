...
import com.aliyuncs.outboundbot.transform.v20191226.ModifyGlobalQuestionResponseUnmarshaller;
...
public class ModifyGlobalQuestionResponse extends AcsResponse {
	...
	@Override
	public ModifyGlobalQuestionResponse getInstance(UnmarshallerContext context) {
		return	ModifyGlobalQuestionResponseUnmarshaller.unmarshall(this, context);
	}
