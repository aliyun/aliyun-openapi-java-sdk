 ...
 * @version 
 */
public class GetContactBlockListRequest extends RpcAcsRequest<GetContactBlockListResponse> {
	...
	@Override
	public Class<GetContactBlockListResponse> getResponseClass() {
		return GetContactBlockListResponse.class;
	}
