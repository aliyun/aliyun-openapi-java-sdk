...
import com.aliyuncs.outboundbot.model.v20191226.ListChatbotInstancesResponse.Bot;
...
public class ListChatbotInstancesResponseUnmarshaller {
	...
	public static ListChatbotInstancesResponse unmarshall(ListChatbotInstancesResponse listChatbotInstancesResponse, UnmarshallerContext _ctx) {
		...
		listChatbotInstancesResponse.setHttpStatusCode(_ctx.integerValue("ListChatbotInstancesResponse.HttpStatusCode"));
		listChatbotInstancesResponse.setCode(_ctx.stringValue("ListChatbotInstancesResponse.Code"));
		listChatbotInstancesResponse.setMessage(_ctx.stringValue("ListChatbotInstancesResponse.Message"));
		listChatbotInstancesResponse.setSuccess(_ctx.booleanValue("ListChatbotInstancesResponse.Success"));
		listChatbotInstancesResponse.setPageSize(_ctx.longValue("ListChatbotInstancesResponse.PageSize"));
		listChatbotInstancesResponse.setPageNumber(_ctx.longValue("ListChatbotInstancesResponse.PageNumber"));
