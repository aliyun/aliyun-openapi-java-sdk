 ...
 * @version 
 */
public class DisableFirewallRuleRequest extends RpcAcsRequest<DisableFirewallRuleResponse> {
	...
	public DisableFirewallRuleRequest() {
		super("SWAS", "2017-08-10", "DisableFirewallRule", "SWAS");
	...
	@Override
	public Class<DisableFirewallRuleResponse> getResponseClass() {
		return DisableFirewallRuleResponse.class;
	}
