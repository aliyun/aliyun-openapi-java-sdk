...
import com.aliyuncs.swas.transform.v20170810.ListCustomImagesForResetResponseUnmarshaller;
 ...
 * @version 
 */
public class ListCustomImagesForResetResponse extends AcsResponse {
	...
	@Override
	public ListCustomImagesForResetResponse getInstance(UnmarshallerContext context) {
		return	ListCustomImagesForResetResponseUnmarshaller.unmarshall(this, context);
	}
