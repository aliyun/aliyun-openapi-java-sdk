 ...
 * @version 
 */
public class MarkSnapshotUpgradeRequest extends RpcAcsRequest<MarkSnapshotUpgradeResponse> {
	...
	public MarkSnapshotUpgradeRequest() {
		super("SWAS", "2017-08-10", "MarkSnapshotUpgrade", "SWAS");
	...
	@Override
	public Class<MarkSnapshotUpgradeResponse> getResponseClass() {
		return MarkSnapshotUpgradeResponse.class;
	}
