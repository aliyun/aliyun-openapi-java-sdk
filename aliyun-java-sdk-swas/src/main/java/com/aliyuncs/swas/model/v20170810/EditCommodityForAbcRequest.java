 ...
 * @version 
 */
public class EditCommodityForAbcRequest extends RpcAcsRequest<EditCommodityForAbcResponse> {
	...
	public EditCommodityForAbcRequest() {
		super("SWAS", "2017-08-10", "EditCommodityForAbc", "SWAS");
	...
	@Override
	public Class<EditCommodityForAbcResponse> getResponseClass() {
		return EditCommodityForAbcResponse.class;
	}
