 ...
 * @version 
 */
public class ModifyDiskRemarkRequest extends RpcAcsRequest<ModifyDiskRemarkResponse> {
	...
	public ModifyDiskRemarkRequest() {
		super("SWAS", "2017-08-10", "ModifyDiskRemark", "SWAS");
	...
	@Override
	public Class<ModifyDiskRemarkResponse> getResponseClass() {
		return ModifyDiskRemarkResponse.class;
	}
