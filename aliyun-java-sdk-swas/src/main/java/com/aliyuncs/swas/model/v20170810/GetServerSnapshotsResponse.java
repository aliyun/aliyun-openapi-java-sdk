...
import com.aliyuncs.swas.transform.v20170810.GetServerSnapshotsResponseUnmarshaller;
 ...
 * @version 
 */
public class GetServerSnapshotsResponse extends AcsResponse {
	...
	private List<ServerSnapshot> serverSnapshots;
	...
	public List<ServerSnapshot> getServerSnapshots() {
		return this.serverSnapshots;
	}

	public void setServerSnapshots(List<ServerSnapshot> serverSnapshots) {
		this.serverSnapshots = serverSnapshots;
	}
	...
	public static class ServerSnapshot {
		...
		public Long getSupportImage() {
			return this.supportImage;
		}

		public void setSupportImage(Long supportImage) {
			this.supportImage = supportImage;
		}
	}

	@Override
	public GetServerSnapshotsResponse getInstance(UnmarshallerContext context) {
		return	GetServerSnapshotsResponseUnmarshaller.unmarshall(this, context);
	}
