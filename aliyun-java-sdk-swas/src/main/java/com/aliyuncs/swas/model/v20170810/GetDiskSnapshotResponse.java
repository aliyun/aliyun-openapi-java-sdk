...
import com.aliyuncs.swas.transform.v20170810.GetDiskSnapshotResponseUnmarshaller;
 ...
 * @version 
 */
public class GetDiskSnapshotResponse extends AcsResponse {
	...
	@Override
	public GetDiskSnapshotResponse getInstance(UnmarshallerContext context) {
		return	GetDiskSnapshotResponseUnmarshaller.unmarshall(this, context);
	}
