 ...
 * @version 
 */
public class DescribeCommodityInfoForAbcRequest extends RpcAcsRequest<DescribeCommodityInfoForAbcResponse> {
	...
	public DescribeCommodityInfoForAbcRequest() {
		super("SWAS", "2017-08-10", "DescribeCommodityInfoForAbc", "SWAS");
	...
	@Override
	public Class<DescribeCommodityInfoForAbcResponse> getResponseClass() {
		return DescribeCommodityInfoForAbcResponse.class;
	}
