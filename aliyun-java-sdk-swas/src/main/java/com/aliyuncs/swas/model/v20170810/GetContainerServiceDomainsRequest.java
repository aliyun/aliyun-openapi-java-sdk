 ...
 * @version 
 */
public class GetContainerServiceDomainsRequest extends RpcAcsRequest<GetContainerServiceDomainsResponse> {
	   

	private String containerServiceId;

	private String site;
	public GetContainerServiceDomainsRequest() {
		super("SWAS", "2017-08-10", "GetContainerServiceDomains", "SWAS");
	...
	@Override
	public Class<GetContainerServiceDomainsResponse> getResponseClass() {
		return GetContainerServiceDomainsResponse.class;
	}
