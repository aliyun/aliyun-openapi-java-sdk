 ...
 * @version 
 */
public class GetSnapshotRequest extends RpcAcsRequest<GetSnapshotResponse> {
	...
	public GetSnapshotRequest() {
		super("SWAS", "2017-08-10", "GetSnapshot", "SWAS");
	...
	@Override
	public Class<GetSnapshotResponse> getResponseClass() {
		return GetSnapshotResponse.class;
	}
