 ...
 * @version 
 */
public class StartServerRequest extends RpcAcsRequest<StartServerResponse> {
	...
	public StartServerRequest() {
		super("SWAS", "2017-08-10", "StartServer", "SWAS");
	...
	@Override
	public Class<StartServerResponse> getResponseClass() {
