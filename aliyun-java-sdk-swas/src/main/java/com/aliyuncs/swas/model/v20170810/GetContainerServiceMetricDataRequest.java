 ...
 * @version 
 */
public class GetContainerServiceMetricDataRequest extends RpcAcsRequest<GetContainerServiceMetricDataResponse> {
	...
	public GetContainerServiceMetricDataRequest() {
		super("SWAS", "2017-08-10", "GetContainerServiceMetricData", "SWAS");
	...
	@Override
	public Class<GetContainerServiceMetricDataResponse> getResponseClass() {
		return GetContainerServiceMetricDataResponse.class;
	}
