 ...
 * @version 
 */
public class CopyCustomImageRequest extends RpcAcsRequest<CopyCustomImageResponse> {
	...
	public CopyCustomImageRequest() {
		super("SWAS", "2017-08-10", "CopyCustomImage", "SWAS");
	...
	@Override
	public Class<CopyCustomImageResponse> getResponseClass() {
		return CopyCustomImageResponse.class;
	}
