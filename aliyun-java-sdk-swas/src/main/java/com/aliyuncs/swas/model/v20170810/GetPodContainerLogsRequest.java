 ...
 * @version 
 */
public class GetPodContainerLogsRequest extends RpcAcsRequest<GetPodContainerLogsResponse> {
	...
	private String site;
	public GetPodContainerLogsRequest() {
		super("SWAS", "2017-08-10", "GetPodContainerLogs", "SWAS");
	...
	@Override
	public Class<GetPodContainerLogsResponse> getResponseClass() {
		return GetPodContainerLogsResponse.class;
	}
