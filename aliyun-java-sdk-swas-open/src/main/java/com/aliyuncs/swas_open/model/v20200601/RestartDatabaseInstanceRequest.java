 ...
 * @version 
 */
public class RestartDatabaseInstanceRequest extends RpcAcsRequest<RestartDatabaseInstanceResponse> {
	...
	@Override
	public Class<RestartDatabaseInstanceResponse> getResponseClass() {
		return RestartDatabaseInstanceResponse.class;
	}
