 ...
 * @version 
 */
public class DescribeDatabaseInstanceParametersRequest extends RpcAcsRequest<DescribeDatabaseInstanceParametersResponse> {
	...
	@Override
	public Class<DescribeDatabaseInstanceParametersResponse> getResponseClass() {
		return DescribeDatabaseInstanceParametersResponse.class;
	}
