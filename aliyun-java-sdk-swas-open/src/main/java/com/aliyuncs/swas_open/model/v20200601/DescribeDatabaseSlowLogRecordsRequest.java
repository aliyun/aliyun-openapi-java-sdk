 ...
 * @version 
 */
public class DescribeDatabaseSlowLogRecordsRequest extends RpcAcsRequest<DescribeDatabaseSlowLogRecordsResponse> {
	...
	@Override
	public Class<DescribeDatabaseSlowLogRecordsResponse> getResponseClass() {
		return DescribeDatabaseSlowLogRecordsResponse.class;
	}
