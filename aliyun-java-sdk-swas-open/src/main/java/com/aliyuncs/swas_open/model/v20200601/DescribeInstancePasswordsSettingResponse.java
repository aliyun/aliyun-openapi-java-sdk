...
import com.aliyuncs.swas_open.transform.v20200601.DescribeInstancePasswordsSettingResponseUnmarshaller;
...
public class DescribeInstancePasswordsSettingResponse extends AcsResponse {
	...
	@Override
	public DescribeInstancePasswordsSettingResponse getInstance(UnmarshallerContext context) {
		return	DescribeInstancePasswordsSettingResponseUnmarshaller.unmarshall(this, context);
	}
