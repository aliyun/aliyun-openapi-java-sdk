 ...
 * @version 
 */
public class StartDatabaseInstanceRequest extends RpcAcsRequest<StartDatabaseInstanceResponse> {
	...
	@Override
	public Class<StartDatabaseInstanceResponse> getResponseClass() {
		return StartDatabaseInstanceResponse.class;
	}
