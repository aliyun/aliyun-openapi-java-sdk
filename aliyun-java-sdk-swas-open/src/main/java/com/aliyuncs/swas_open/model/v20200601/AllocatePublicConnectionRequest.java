 ...
 * @version 
 */
public class AllocatePublicConnectionRequest extends RpcAcsRequest<AllocatePublicConnectionResponse> {
	...
	@Override
	public Class<AllocatePublicConnectionResponse> getResponseClass() {
		return AllocatePublicConnectionResponse.class;
	}
