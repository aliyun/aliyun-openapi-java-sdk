 ...
 * @version 
 */
public class CreateFirewallTemplateRequest extends RpcAcsRequest<CreateFirewallTemplateResponse> {
	...
	@Override
	public Class<CreateFirewallTemplateResponse> getResponseClass() {
		return CreateFirewallTemplateResponse.class;
	}
