 ...
 * @version 
 */
public class DescribeDatabaseErrorLogsRequest extends RpcAcsRequest<DescribeDatabaseErrorLogsResponse> {
	...
	@Override
	public Class<DescribeDatabaseErrorLogsResponse> getResponseClass() {
		return DescribeDatabaseErrorLogsResponse.class;
	}
