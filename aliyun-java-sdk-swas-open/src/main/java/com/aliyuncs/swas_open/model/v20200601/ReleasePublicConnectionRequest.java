 ...
 * @version 
 */
public class ReleasePublicConnectionRequest extends RpcAcsRequest<ReleasePublicConnectionResponse> {
	...
	@Override
	public Class<ReleasePublicConnectionResponse> getResponseClass() {
		return ReleasePublicConnectionResponse.class;
	}
