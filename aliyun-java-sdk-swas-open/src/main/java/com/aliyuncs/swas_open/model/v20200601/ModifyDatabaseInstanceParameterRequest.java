 ...
 * @version 
 */
public class ModifyDatabaseInstanceParameterRequest extends RpcAcsRequest<ModifyDatabaseInstanceParameterResponse> {
	...
	@Override
	public Class<ModifyDatabaseInstanceParameterResponse> getResponseClass() {
		return ModifyDatabaseInstanceParameterResponse.class;
	}
