...
public class DeleteKeyPairsRequest extends RpcAcsRequest<DeleteKeyPairsResponse> {
	...
	public List<String> getKeyPairNamess() {
		return this.keyPairNamess;
	}

	public void setKeyPairNamess(List<String> keyPairNamess) {
		this.keyPairNamess = keyPairNamess;	
		if (keyPairNamess != null) {
			for (int i = 0; i < keyPairNamess.size(); i++) {
				putQueryParameter("KeyPairNames." + (i + 1) , keyPairNamess.get(i));
			}
		}	
	}
