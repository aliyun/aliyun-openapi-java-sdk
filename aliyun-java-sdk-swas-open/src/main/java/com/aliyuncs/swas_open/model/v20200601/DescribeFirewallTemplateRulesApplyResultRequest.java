 ...
 * @version 
 */
public class DescribeFirewallTemplateRulesApplyResultRequest extends RpcAcsRequest<DescribeFirewallTemplateRulesApplyResultResponse> {
	...
	@Override
	public Class<DescribeFirewallTemplateRulesApplyResultResponse> getResponseClass() {
		return DescribeFirewallTemplateRulesApplyResultResponse.class;
	}
