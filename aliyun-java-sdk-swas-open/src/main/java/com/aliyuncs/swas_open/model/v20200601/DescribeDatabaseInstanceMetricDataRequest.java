 ...
 * @version 
 */
public class DescribeDatabaseInstanceMetricDataRequest extends RpcAcsRequest<DescribeDatabaseInstanceMetricDataResponse> {
	...
	@Override
	public Class<DescribeDatabaseInstanceMetricDataResponse> getResponseClass() {
		return DescribeDatabaseInstanceMetricDataResponse.class;
	}
