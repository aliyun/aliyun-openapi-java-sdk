...
import com.aliyuncs.swas_open.model.v20200601.DetachKeyPairResponse;
import com.aliyuncs.swas_open.model.v20200601.DetachKeyPairResponse.Result;
...
public class DetachKeyPairResponseUnmarshaller {
	...
	public static DetachKeyPairResponse unmarshall(DetachKeyPairResponse detachKeyPairResponse, UnmarshallerContext _ctx) {
		...
		detachKeyPairResponse.setTotalCount(_ctx.integerValue("DetachKeyPairResponse.TotalCount"));
		detachKeyPairResponse.setFailCount(_ctx.integerValue("DetachKeyPairResponse.FailCount"));
