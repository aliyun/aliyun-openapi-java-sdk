...
import com.aliyuncs.dds.model.v20151201.CheckServiceLinkedRoleResponse;
...
public class CheckServiceLinkedRoleResponseUnmarshaller {
	...
	public static CheckServiceLinkedRoleResponse unmarshall(CheckServiceLinkedRoleResponse checkServiceLinkedRoleResponse, UnmarshallerContext _ctx) {
		...
		checkServiceLinkedRoleResponse.setServiceLinkedRoleExists(_ctx.booleanValue("CheckServiceLinkedRoleResponse.ServiceLinkedRoleExists"));
