...
public class DescribeKernelReleaseNotesRequest extends RpcAcsRequest<DescribeKernelReleaseNotesResponse> {
	...
	public DescribeKernelReleaseNotesRequest() {
		super("Dds", "2015-12-01", "DescribeKernelReleaseNotes");
	...
	@Override
	public Class<DescribeKernelReleaseNotesResponse> getResponseClass() {
		return DescribeKernelReleaseNotesResponse.class;
	}
