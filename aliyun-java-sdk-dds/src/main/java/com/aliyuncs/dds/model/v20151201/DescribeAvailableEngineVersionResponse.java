...
public class DescribeAvailableEngineVersionResponse extends AcsResponse {
	...
	@Override
	public DescribeAvailableEngineVersionResponse getInstance(UnmarshallerContext context) {
		return	DescribeAvailableEngineVersionResponseUnmarshaller.unmarshall(this, context);
	}
}
