...
import com.aliyuncs.dds.transform.v20151201.DescribeClusterRecoverTimeResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeClusterRecoverTimeResponse extends AcsResponse {
	...
	@Override
	public DescribeClusterRecoverTimeResponse getInstance(UnmarshallerContext context) {
		return	DescribeClusterRecoverTimeResponseUnmarshaller.unmarshall(this, context);
	}
