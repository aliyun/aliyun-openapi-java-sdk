...
public class DescribeReplicationGroupResponse extends AcsResponse {
	...
	public void setTunnelContext(List<String> tunnelContext) {
		this.tunnelContext = tunnelContext;
	}

	@Override
	public DescribeReplicationGroupResponse getInstance(UnmarshallerContext context) {
		return	DescribeReplicationGroupResponseUnmarshaller.unmarshall(this, context);
	}
