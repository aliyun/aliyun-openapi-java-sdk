 ...
 * @version 
 */
public class EnablePolicyTypeRequest extends RpcAcsRequest<EnablePolicyTypeResponse> {
	...
	@Override
	public Class<EnablePolicyTypeResponse> getResponseClass() {
		return EnablePolicyTypeResponse.class;
	}
