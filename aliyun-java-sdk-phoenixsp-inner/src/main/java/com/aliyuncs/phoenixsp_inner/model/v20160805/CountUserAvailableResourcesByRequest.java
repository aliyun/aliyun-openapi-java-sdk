 ...
 * @version 
 */
public class CountUserAvailableResourcesByRequest extends RpcAcsRequest<CountUserAvailableResourcesByResponse> {
	
	public CountUserAvailableResourcesByRequest() {
		super("Phoenixsp-inner", "2016-08-05", "CountUserAvailableResourcesBy");
	}
	...
	@Override
	public Class<CountUserAvailableResourcesByResponse> getResponseClass() {
		return CountUserAvailableResourcesByResponse.class;
	}
