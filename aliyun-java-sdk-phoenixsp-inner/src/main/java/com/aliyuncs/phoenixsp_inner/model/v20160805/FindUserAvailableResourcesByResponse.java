...
import com.aliyuncs.phoenixsp_inner.transform.v20160805.FindUserAvailableResourcesByResponseUnmarshaller;
 ...
 * @version 
 */
public class FindUserAvailableResourcesByResponse extends AcsResponse {
	...
	@Override
	public FindUserAvailableResourcesByResponse getInstance(UnmarshallerContext context) {
		return	FindUserAvailableResourcesByResponseUnmarshaller.unmarshall(this, context);
	}
}
