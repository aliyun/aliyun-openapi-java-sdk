 ...
 * @version 
 */
public class QueryIotCardOfferDtlRequest extends RpcAcsRequest<QueryIotCardOfferDtlResponse> {
	...
	@Override
	public Class<QueryIotCardOfferDtlResponse> getResponseClass() {
		return QueryIotCardOfferDtlResponse.class;
	}
