 ...
 * @version 
 */
public class DoIotUnbindResumeRequest extends RpcAcsRequest<DoIotUnbindResumeResponse> {
	...
	@Override
	public Class<DoIotUnbindResumeResponse> getResponseClass() {
		return DoIotUnbindResumeResponse.class;
	}
