 ...
 * @version 
 */
public class QueryPersonalInfoRequest extends RpcAcsRequest<QueryPersonalInfoResponse> {
	...
	@Override
	public Class<QueryPersonalInfoResponse> getResponseClass() {
		return QueryPersonalInfoResponse.class;
	}
