 ...
 * @version 
 */
public class DoSendIotSmsRequest extends RpcAcsRequest<DoSendIotSmsResponse> {
	...
	@Override
	public Class<DoSendIotSmsResponse> getResponseClass() {
		return DoSendIotSmsResponse.class;
	}
