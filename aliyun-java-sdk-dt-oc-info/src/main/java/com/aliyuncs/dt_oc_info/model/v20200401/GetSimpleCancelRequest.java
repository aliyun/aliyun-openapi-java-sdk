 ...
 * @version 
 */
public class GetSimpleCancelRequest extends RpcAcsRequest<GetSimpleCancelResponse> {
	...
	public GetSimpleCancelRequest() {
		super("dt-oc-info", "2020-04-01", "GetSimpleCancel");
	...
	@Override
	public Class<GetSimpleCancelResponse> getResponseClass() {
		return GetSimpleCancelResponse.class;
	}
