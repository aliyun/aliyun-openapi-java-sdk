 ...
 * @version 
 */
public class GetCompetitorInfoRequest extends RpcAcsRequest<GetCompetitorInfoResponse> {
	...
	public GetCompetitorInfoRequest() {
		super("dt-oc-info", "2020-04-01", "GetCompetitorInfo");
	...
	@Override
	public Class<GetCompetitorInfoResponse> getResponseClass() {
		return GetCompetitorInfoResponse.class;
	}
