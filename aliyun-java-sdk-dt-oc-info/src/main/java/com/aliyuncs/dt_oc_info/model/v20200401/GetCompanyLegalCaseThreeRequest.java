 ...
 * @version 
 */
public class GetCompanyLegalCaseThreeRequest extends RpcAcsRequest<GetCompanyLegalCaseThreeResponse> {
	...
	public GetCompanyLegalCaseThreeRequest() {
		super("dt-oc-info", "2020-04-01", "GetCompanyLegalCaseThree");
	...
	@Override
	public Class<GetCompanyLegalCaseThreeResponse> getResponseClass() {
		return GetCompanyLegalCaseThreeResponse.class;
	}
