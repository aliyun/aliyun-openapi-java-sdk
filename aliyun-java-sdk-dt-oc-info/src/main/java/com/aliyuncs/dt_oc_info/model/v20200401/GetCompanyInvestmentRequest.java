 ...
 * @version 
 */
public class GetCompanyInvestmentRequest extends RpcAcsRequest<GetCompanyInvestmentResponse> {
	...
	public GetCompanyInvestmentRequest() {
		super("dt-oc-info", "2020-04-01", "GetCompanyInvestment");
	...
	@Override
	public Class<GetCompanyInvestmentResponse> getResponseClass() {
		return GetCompanyInvestmentResponse.class;
	}
