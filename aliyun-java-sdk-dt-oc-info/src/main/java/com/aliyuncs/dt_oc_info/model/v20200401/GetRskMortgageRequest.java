 ...
 * @version 
 */
public class GetRskMortgageRequest extends RpcAcsRequest<GetRskMortgageResponse> {
	...
	public GetRskMortgageRequest() {
		super("dt-oc-info", "2020-04-01", "GetRskMortgage");
	...
	@Override
	public Class<GetRskMortgageResponse> getResponseClass() {
		return GetRskMortgageResponse.class;
	}
