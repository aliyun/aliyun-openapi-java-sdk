 ...
 * @version 
 */
public class GetCopyrightRequest extends RpcAcsRequest<GetCopyrightResponse> {
	...
	public GetCopyrightRequest() {
		super("dt-oc-info", "2020-04-01", "GetCopyright");
	...
	@Override
	public Class<GetCopyrightResponse> getResponseClass() {
		return GetCopyrightResponse.class;
	}
