 ...
 * @version 
 */
public class GetTerminationCaseRequest extends RpcAcsRequest<GetTerminationCaseResponse> {
	...
	public GetTerminationCaseRequest() {
		super("dt-oc-info", "2020-04-01", "GetTerminationCase");
	...
	@Override
	public Class<GetTerminationCaseResponse> getResponseClass() {
		return GetTerminationCaseResponse.class;
	}
