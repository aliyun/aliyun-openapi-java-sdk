 ...
 * @version 
 */
public class GetCheckupRequest extends RpcAcsRequest<GetCheckupResponse> {
	...
	public GetCheckupRequest() {
		super("dt-oc-info", "2020-04-01", "GetCheckup");
	...
	@Override
	public Class<GetCheckupResponse> getResponseClass() {
		return GetCheckupResponse.class;
	}
