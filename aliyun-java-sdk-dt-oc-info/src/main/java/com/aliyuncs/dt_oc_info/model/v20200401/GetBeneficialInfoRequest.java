 ...
 * @version 
 */
public class GetBeneficialInfoRequest extends RpcAcsRequest<GetBeneficialInfoResponse> {
	   

	private String oneCompanyId;
	public GetBeneficialInfoRequest() {
		super("dt-oc-info", "2020-04-01", "GetBeneficialInfo");
	...
	@Override
	public Class<GetBeneficialInfoResponse> getResponseClass() {
		return GetBeneficialInfoResponse.class;
	}
