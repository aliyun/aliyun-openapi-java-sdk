 ...
 * @version 
 */
public class GetSeriousIllegalRequest extends RpcAcsRequest<GetSeriousIllegalResponse> {
	...
	public GetSeriousIllegalRequest() {
		super("dt-oc-info", "2020-04-01", "GetSeriousIllegal");
	...
	@Override
	public Class<GetSeriousIllegalResponse> getResponseClass() {
		return GetSeriousIllegalResponse.class;
	}
