 ...
 * @version 
 */
public class GetClearAccountThreeRequest extends RpcAcsRequest<GetClearAccountThreeResponse> {
	...
	public GetClearAccountThreeRequest() {
		super("dt-oc-info", "2020-04-01", "GetClearAccountThree");
	...
	@Override
	public Class<GetClearAccountThreeResponse> getResponseClass() {
		return GetClearAccountThreeResponse.class;
	}
