...
import com.aliyuncs.dt_oc_info.transform.v20220829.GetOcIcDoubleCheckupResponseUnmarshaller;
 ...
 * @version 
 */
public class GetOcIcDoubleCheckupResponse extends AcsResponse {
	...
	@Override
	public GetOcIcDoubleCheckupResponse getInstance(UnmarshallerContext context) {
		return	GetOcIcDoubleCheckupResponseUnmarshaller.unmarshall(this, context);
	}
