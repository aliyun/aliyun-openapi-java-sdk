 ...
 * @version 
 */
public class GetTaxLevelRequest extends RpcAcsRequest<GetTaxLevelResponse> {
	...
	public GetTaxLevelRequest() {
		super("dt-oc-info", "2020-04-01", "GetTaxLevel");
	...
	@Override
	public Class<GetTaxLevelResponse> getResponseClass() {
		return GetTaxLevelResponse.class;
	}
