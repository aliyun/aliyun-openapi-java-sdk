 ...
 * @version 
 */
public class GetCompanyPartnersListThreeRequest extends RpcAcsRequest<GetCompanyPartnersListThreeResponse> {
	...
	public GetCompanyPartnersListThreeRequest() {
		super("dt-oc-info", "2020-04-01", "GetCompanyPartnersListThree");
	...
	@Override
	public Class<GetCompanyPartnersListThreeResponse> getResponseClass() {
		return GetCompanyPartnersListThreeResponse.class;
	}
