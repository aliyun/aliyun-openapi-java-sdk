 ...
 * @version 
 */
public class GetCompanyEquityPledgeRequest extends RpcAcsRequest<GetCompanyEquityPledgeResponse> {
	...
	public GetCompanyEquityPledgeRequest() {
		super("dt-oc-info", "2020-04-01", "GetCompanyEquityPledge");
	...
	@Override
	public Class<GetCompanyEquityPledgeResponse> getResponseClass() {
		return GetCompanyEquityPledgeResponse.class;
	}
