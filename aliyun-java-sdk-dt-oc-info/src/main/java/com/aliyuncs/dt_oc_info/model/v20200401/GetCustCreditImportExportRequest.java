 ...
 * @version 
 */
public class GetCustCreditImportExportRequest extends RpcAcsRequest<GetCustCreditImportExportResponse> {
	...
	public GetCustCreditImportExportRequest() {
		super("dt-oc-info", "2020-04-01", "GetCustCreditImportExport");
	...
	@Override
	public Class<GetCustCreditImportExportResponse> getResponseClass() {
		return GetCustCreditImportExportResponse.class;
	}
