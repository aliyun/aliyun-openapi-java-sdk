 ...
 * @version 
 */
public class GetCompanyChangeThreeRequest extends RpcAcsRequest<GetCompanyChangeThreeResponse> {
	...
	public GetCompanyChangeThreeRequest() {
		super("dt-oc-info", "2020-04-01", "GetCompanyChangeThree");
	...
	@Override
	public Class<GetCompanyChangeThreeResponse> getResponseClass() {
		return GetCompanyChangeThreeResponse.class;
	}
