 ...
 * @version 
 */
public class GetOperateAbnormalRequest extends RpcAcsRequest<GetOperateAbnormalResponse> {
	...
	public GetOperateAbnormalRequest() {
		super("dt-oc-info", "2020-04-01", "GetOperateAbnormal");
	...
	@Override
	public Class<GetOperateAbnormalResponse> getResponseClass() {
		return GetOperateAbnormalResponse.class;
	}
