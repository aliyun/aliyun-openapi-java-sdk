 ...
 * @version 
 */
public class GetCorpFinanceRequest extends RpcAcsRequest<GetCorpFinanceResponse> {
	...
	public GetCorpFinanceRequest() {
		super("dt-oc-info", "2020-04-01", "GetCorpFinance");
	...
	@Override
	public Class<GetCorpFinanceResponse> getResponseClass() {
		return GetCorpFinanceResponse.class;
	}
