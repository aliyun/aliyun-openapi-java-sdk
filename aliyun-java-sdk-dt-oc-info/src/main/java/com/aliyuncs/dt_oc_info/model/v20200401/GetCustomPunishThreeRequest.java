 ...
 * @version 
 */
public class GetCustomPunishThreeRequest extends RpcAcsRequest<GetCustomPunishThreeResponse> {
	...
	public GetCustomPunishThreeRequest() {
		super("dt-oc-info", "2020-04-01", "GetCustomPunishThree");
	...
	@Override
	public Class<GetCustomPunishThreeResponse> getResponseClass() {
		return GetCustomPunishThreeResponse.class;
	}
