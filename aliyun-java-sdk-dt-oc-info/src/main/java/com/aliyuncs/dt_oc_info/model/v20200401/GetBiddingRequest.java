 ...
 * @version 
 */
public class GetBiddingRequest extends RpcAcsRequest<GetBiddingResponse> {
	...
	public GetBiddingRequest() {
		super("dt-oc-info", "2020-04-01", "GetBidding");
	...
	@Override
	public Class<GetBiddingResponse> getResponseClass() {
		return GetBiddingResponse.class;
	}
