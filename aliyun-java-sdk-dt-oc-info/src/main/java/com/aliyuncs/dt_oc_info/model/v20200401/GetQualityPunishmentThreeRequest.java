 ...
 * @version 
 */
public class GetQualityPunishmentThreeRequest extends RpcAcsRequest<GetQualityPunishmentThreeResponse> {
	...
	public GetQualityPunishmentThreeRequest() {
		super("dt-oc-info", "2020-04-01", "GetQualityPunishmentThree");
	...
	@Override
	public Class<GetQualityPunishmentThreeResponse> getResponseClass() {
		return GetQualityPunishmentThreeResponse.class;
	}
