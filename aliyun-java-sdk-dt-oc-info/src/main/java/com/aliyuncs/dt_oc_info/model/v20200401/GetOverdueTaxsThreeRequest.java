 ...
 * @version 
 */
public class GetOverdueTaxsThreeRequest extends RpcAcsRequest<GetOverdueTaxsThreeResponse> {
	...
	public GetOverdueTaxsThreeRequest() {
		super("dt-oc-info", "2020-04-01", "GetOverdueTaxsThree");
	...
	@Override
	public Class<GetOverdueTaxsThreeResponse> getResponseClass() {
		return GetOverdueTaxsThreeResponse.class;
	}
