 ...
 * @version 
 */
public class GetSatpartyPunishThreeRequest extends RpcAcsRequest<GetSatpartyPunishThreeResponse> {
	...
	public GetSatpartyPunishThreeRequest() {
		super("dt-oc-info", "2020-04-01", "GetSatpartyPunishThree");
	...
	@Override
	public Class<GetSatpartyPunishThreeResponse> getResponseClass() {
		return GetSatpartyPunishThreeResponse.class;
	}
