 ...
 * @version 
 */
public class GetLcenseInfomationRequest extends RpcAcsRequest<GetLcenseInfomationResponse> {
	...
	public GetLcenseInfomationRequest() {
		super("dt-oc-info", "2020-04-01", "GetLcenseInfomation");
	...
	@Override
	public Class<GetLcenseInfomationResponse> getResponseClass() {
		return GetLcenseInfomationResponse.class;
	}
