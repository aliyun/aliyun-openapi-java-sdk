 ...
 * @version 
 */
public class GetRecruitInfoRequest extends RpcAcsRequest<GetRecruitInfoResponse> {
	...
	public GetRecruitInfoRequest() {
		super("dt-oc-info", "2020-04-01", "GetRecruitInfo");
	...
	@Override
	public Class<GetRecruitInfoResponse> getResponseClass() {
		return GetRecruitInfoResponse.class;
	}
