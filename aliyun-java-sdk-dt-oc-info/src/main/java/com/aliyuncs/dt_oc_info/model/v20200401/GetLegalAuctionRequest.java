 ...
 * @version 
 */
public class GetLegalAuctionRequest extends RpcAcsRequest<GetLegalAuctionResponse> {
	...
	public GetLegalAuctionRequest() {
		super("dt-oc-info", "2020-04-01", "GetLegalAuction");
	...
	@Override
	public Class<GetLegalAuctionResponse> getResponseClass() {
		return GetLegalAuctionResponse.class;
	}
