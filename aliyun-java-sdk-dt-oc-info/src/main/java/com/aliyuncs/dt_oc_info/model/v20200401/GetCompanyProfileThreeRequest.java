 ...
 * @version 
 */
public class GetCompanyProfileThreeRequest extends RpcAcsRequest<GetCompanyProfileThreeResponse> {
	...
	public GetCompanyProfileThreeRequest() {
		super("dt-oc-info", "2020-04-01", "GetCompanyProfileThree");
	...
	@Override
	public Class<GetCompanyProfileThreeResponse> getResponseClass() {
		return GetCompanyProfileThreeResponse.class;
	}
