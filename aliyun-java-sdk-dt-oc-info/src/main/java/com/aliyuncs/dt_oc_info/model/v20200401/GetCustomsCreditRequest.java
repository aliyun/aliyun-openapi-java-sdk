 ...
 * @version 
 */
public class GetCustomsCreditRequest extends RpcAcsRequest<GetCustomsCreditResponse> {
	...
	public GetCustomsCreditRequest() {
		super("dt-oc-info", "2020-04-01", "GetCustomsCredit");
	...
	@Override
	public Class<GetCustomsCreditResponse> getResponseClass() {
		return GetCustomsCreditResponse.class;
	}
