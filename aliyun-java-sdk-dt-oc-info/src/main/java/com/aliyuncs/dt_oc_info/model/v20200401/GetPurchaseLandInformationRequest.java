 ...
 * @version 
 */
public class GetPurchaseLandInformationRequest extends RpcAcsRequest<GetPurchaseLandInformationResponse> {
	...
	public GetPurchaseLandInformationRequest() {
		super("dt-oc-info", "2020-04-01", "GetPurchaseLandInformation");
	...
	@Override
	public Class<GetPurchaseLandInformationResponse> getResponseClass() {
		return GetPurchaseLandInformationResponse.class;
	}
