 ...
 * @version 
 */
public class GetSoftCopyrightRequest extends RpcAcsRequest<GetSoftCopyrightResponse> {
	...
	public GetSoftCopyrightRequest() {
		super("dt-oc-info", "2020-04-01", "GetSoftCopyright");
	...
	@Override
	public Class<GetSoftCopyrightResponse> getResponseClass() {
		return GetSoftCopyrightResponse.class;
	}
