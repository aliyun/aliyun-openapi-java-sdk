 ...
 * @version 
 */
public class GetDoubleCheckupRequest extends RpcAcsRequest<GetDoubleCheckupResponse> {
	...
	public GetDoubleCheckupRequest() {
		super("dt-oc-info", "2020-04-01", "GetDoubleCheckup");
	...
	@Override
	public Class<GetDoubleCheckupResponse> getResponseClass() {
		return GetDoubleCheckupResponse.class;
	}
