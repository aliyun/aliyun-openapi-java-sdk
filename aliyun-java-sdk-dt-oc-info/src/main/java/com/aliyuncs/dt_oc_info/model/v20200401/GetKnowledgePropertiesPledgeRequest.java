 ...
 * @version 
 */
public class GetKnowledgePropertiesPledgeRequest extends RpcAcsRequest<GetKnowledgePropertiesPledgeResponse> {
	...
	public GetKnowledgePropertiesPledgeRequest() {
		super("dt-oc-info", "2020-04-01", "GetKnowledgePropertiesPledge");
	...
	@Override
	public Class<GetKnowledgePropertiesPledgeResponse> getResponseClass() {
		return GetKnowledgePropertiesPledgeResponse.class;
	}
