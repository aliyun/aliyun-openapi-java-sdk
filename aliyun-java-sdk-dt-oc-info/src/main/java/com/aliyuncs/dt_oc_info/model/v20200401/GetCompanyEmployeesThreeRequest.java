 ...
 * @version 
 */
public class GetCompanyEmployeesThreeRequest extends RpcAcsRequest<GetCompanyEmployeesThreeResponse> {
	...
	public GetCompanyEmployeesThreeRequest() {
		super("dt-oc-info", "2020-04-01", "GetCompanyEmployeesThree");
	...
	@Override
	public Class<GetCompanyEmployeesThreeResponse> getResponseClass() {
		return GetCompanyEmployeesThreeResponse.class;
	}
