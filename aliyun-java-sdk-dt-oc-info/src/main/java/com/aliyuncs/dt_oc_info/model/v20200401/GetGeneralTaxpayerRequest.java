 ...
 * @version 
 */
public class GetGeneralTaxpayerRequest extends RpcAcsRequest<GetGeneralTaxpayerResponse> {
	...
	public GetGeneralTaxpayerRequest() {
		super("dt-oc-info", "2020-04-01", "GetGeneralTaxpayer");
	...
	@Override
	public Class<GetGeneralTaxpayerResponse> getResponseClass() {
		return GetGeneralTaxpayerResponse.class;
	}
