 ...
 * @version 
 */
public class GetQualificationCertificateRequest extends RpcAcsRequest<GetQualificationCertificateResponse> {
	...
	public GetQualificationCertificateRequest() {
		super("dt-oc-info", "2020-04-01", "GetQualificationCertificate");
	...
	@Override
	public Class<GetQualificationCertificateResponse> getResponseClass() {
		return GetQualificationCertificateResponse.class;
	}
