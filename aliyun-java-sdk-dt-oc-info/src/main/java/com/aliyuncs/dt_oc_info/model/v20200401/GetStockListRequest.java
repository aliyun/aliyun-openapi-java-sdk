 ...
 * @version 
 */
public class GetStockListRequest extends RpcAcsRequest<GetStockListResponse> {
	...
	public GetStockListRequest() {
		super("dt-oc-info", "2020-04-01", "GetStockList");
	...
	@Override
	public Class<GetStockListResponse> getResponseClass() {
		return GetStockListResponse.class;
	}
