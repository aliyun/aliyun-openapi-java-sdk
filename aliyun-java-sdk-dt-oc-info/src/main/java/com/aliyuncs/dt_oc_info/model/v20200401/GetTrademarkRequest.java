 ...
 * @version 
 */
public class GetTrademarkRequest extends RpcAcsRequest<GetTrademarkResponse> {
	...
	public GetTrademarkRequest() {
		super("dt-oc-info", "2020-04-01", "GetTrademark");
	...
	@Override
	public Class<GetTrademarkResponse> getResponseClass() {
		return GetTrademarkResponse.class;
	}
