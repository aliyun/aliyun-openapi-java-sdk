 ...
 * @version 
 */
public class GetJudicialFreezesRequest extends RpcAcsRequest<GetJudicialFreezesResponse> {
	...
	public GetJudicialFreezesRequest() {
		super("dt-oc-info", "2020-04-01", "GetJudicialFreezes");
	...
	@Override
	public Class<GetJudicialFreezesResponse> getResponseClass() {
		return GetJudicialFreezesResponse.class;
	}
