 ...
 * @version 
 */
public class GetCorpProductRequest extends RpcAcsRequest<GetCorpProductResponse> {
	...
	public GetCorpProductRequest() {
		super("dt-oc-info", "2020-04-01", "GetCorpProduct");
	...
	@Override
	public Class<GetCorpProductResponse> getResponseClass() {
		return GetCorpProductResponse.class;
	}
