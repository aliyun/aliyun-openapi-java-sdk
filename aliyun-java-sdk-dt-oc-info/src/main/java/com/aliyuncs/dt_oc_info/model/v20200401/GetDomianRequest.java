 ...
 * @version 
 */
public class GetDomianRequest extends RpcAcsRequest<GetDomianResponse> {
	...
	public GetDomianRequest() {
		super("dt-oc-info", "2020-04-01", "GetDomian");
	...
	@Override
	public Class<GetDomianResponse> getResponseClass() {
		return GetDomianResponse.class;
	}
