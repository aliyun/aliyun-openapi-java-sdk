 ...
 * @version 
 */
public class GetLegalNoticesThreeRequest extends RpcAcsRequest<GetLegalNoticesThreeResponse> {
	...
	public GetLegalNoticesThreeRequest() {
		super("dt-oc-info", "2020-04-01", "GetLegalNoticesThree");
	...
	@Override
	public Class<GetLegalNoticesThreeResponse> getResponseClass() {
		return GetLegalNoticesThreeResponse.class;
	}
