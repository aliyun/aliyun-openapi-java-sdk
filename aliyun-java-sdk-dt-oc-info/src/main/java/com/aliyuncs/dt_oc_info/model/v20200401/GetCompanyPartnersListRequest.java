 ...
 * @version 
 */
public class GetCompanyPartnersListRequest extends RpcAcsRequest<GetCompanyPartnersListResponse> {
	...
	public GetCompanyPartnersListRequest() {
		super("dt-oc-info", "2020-04-01", "GetCompanyPartnersList");
	...
	@Override
	public Class<GetCompanyPartnersListResponse> getResponseClass() {
		return GetCompanyPartnersListResponse.class;
	}
