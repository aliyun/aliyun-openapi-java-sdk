 ...
 * @version 
 */
public class GetCoreTeamRequest extends RpcAcsRequest<GetCoreTeamResponse> {
	...
	public GetCoreTeamRequest() {
		super("dt-oc-info", "2020-04-01", "GetCoreTeam");
	...
	@Override
	public Class<GetCoreTeamResponse> getResponseClass() {
		return GetCoreTeamResponse.class;
	}
