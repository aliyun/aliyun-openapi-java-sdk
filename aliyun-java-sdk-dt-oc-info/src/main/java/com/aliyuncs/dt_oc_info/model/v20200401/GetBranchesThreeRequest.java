 ...
 * @version 
 */
public class GetBranchesThreeRequest extends RpcAcsRequest<GetBranchesThreeResponse> {
	...
	public GetBranchesThreeRequest() {
		super("dt-oc-info", "2020-04-01", "GetBranchesThree");
	...
	@Override
	public Class<GetBranchesThreeResponse> getResponseClass() {
		return GetBranchesThreeResponse.class;
	}
