...
import com.aliyuncs.emas_appmonitor.transform.v20190611.QueryApiStatusCodeGroupTrendResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryApiStatusCodeGroupTrendResponse extends AcsResponse {
	...
	@Override
	public QueryApiStatusCodeGroupTrendResponse getInstance(UnmarshallerContext context) {
		return	QueryApiStatusCodeGroupTrendResponseUnmarshaller.unmarshall(this, context);
	}
