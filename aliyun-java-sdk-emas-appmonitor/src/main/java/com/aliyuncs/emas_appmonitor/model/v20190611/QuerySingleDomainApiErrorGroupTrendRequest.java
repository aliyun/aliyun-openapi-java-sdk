 ...
 * @version 
 */
public class QuerySingleDomainApiErrorGroupTrendRequest extends RpcAcsRequest<QuerySingleDomainApiErrorGroupTrendResponse> {
	...
	public QuerySingleDomainApiErrorGroupTrendRequest() {
		super("emas-appmonitor", "2019-06-11", "QuerySingleDomainApiErrorGroupTrend");
	...
	@Override
	public Class<QuerySingleDomainApiErrorGroupTrendResponse> getResponseClass() {
		return QuerySingleDomainApiErrorGroupTrendResponse.class;
	}
