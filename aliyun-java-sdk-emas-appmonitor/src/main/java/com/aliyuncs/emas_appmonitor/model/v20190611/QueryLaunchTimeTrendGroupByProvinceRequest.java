 ...
 * @version 
 */
public class QueryLaunchTimeTrendGroupByProvinceRequest extends RpcAcsRequest<QueryLaunchTimeTrendGroupByProvinceResponse> {
	...
	public QueryLaunchTimeTrendGroupByProvinceRequest() {
		super("emas-appmonitor", "2019-06-11", "QueryLaunchTimeTrendGroupByProvince");
	...
	@Override
	public Class<QueryLaunchTimeTrendGroupByProvinceResponse> getResponseClass() {
		return QueryLaunchTimeTrendGroupByProvinceResponse.class;
	}
