 ...
 * @version 
 */
public class QueryApiAvgDurationTrendRequest extends RpcAcsRequest<QueryApiAvgDurationTrendResponse> {
	...
	public QueryApiAvgDurationTrendRequest() {
		super("emas-appmonitor", "2019-06-11", "QueryApiAvgDurationTrend");
	...
	@Override
	public Class<QueryApiAvgDurationTrendResponse> getResponseClass() {
		return QueryApiAvgDurationTrendResponse.class;
	}
