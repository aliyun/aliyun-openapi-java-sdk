 ...
 * @version 
 */
public class QueryApiErrorTrendRequest extends RpcAcsRequest<QueryApiErrorTrendResponse> {
	...
	public QueryApiErrorTrendRequest() {
		super("emas-appmonitor", "2019-06-11", "QueryApiErrorTrend");
	...
	@Override
	public Class<QueryApiErrorTrendResponse> getResponseClass() {
		return QueryApiErrorTrendResponse.class;
	}
