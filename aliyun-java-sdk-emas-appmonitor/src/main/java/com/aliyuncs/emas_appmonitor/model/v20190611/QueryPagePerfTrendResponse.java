...
import com.aliyuncs.emas_appmonitor.transform.v20190611.QueryPagePerfTrendResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryPagePerfTrendResponse extends AcsResponse {
	...
	@Override
	public QueryPagePerfTrendResponse getInstance(UnmarshallerContext context) {
		return	QueryPagePerfTrendResponseUnmarshaller.unmarshall(this, context);
	}
