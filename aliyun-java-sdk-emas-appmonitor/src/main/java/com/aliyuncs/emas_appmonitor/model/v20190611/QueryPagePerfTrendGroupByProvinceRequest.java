 ...
 * @version 
 */
public class QueryPagePerfTrendGroupByProvinceRequest extends RpcAcsRequest<QueryPagePerfTrendGroupByProvinceResponse> {
	...
	public QueryPagePerfTrendGroupByProvinceRequest() {
		super("emas-appmonitor", "2019-06-11", "QueryPagePerfTrendGroupByProvince");
	...
	@Override
	public Class<QueryPagePerfTrendGroupByProvinceResponse> getResponseClass() {
		return QueryPagePerfTrendGroupByProvinceResponse.class;
	}
