 ...
 * @version 
 */
public class QueryApiStatusCodeGroupTrendRequest extends RpcAcsRequest<QueryApiStatusCodeGroupTrendResponse> {
	...
	public QueryApiStatusCodeGroupTrendRequest() {
		super("emas-appmonitor", "2019-06-11", "QueryApiStatusCodeGroupTrend");
	...
	@Override
	public Class<QueryApiStatusCodeGroupTrendResponse> getResponseClass() {
		return QueryApiStatusCodeGroupTrendResponse.class;
	}
