...
import com.aliyuncs.emas_appmonitor.transform.v20190611.QuerySingleDomainApiStatusCodeGroupTrendResponseUnmarshaller;
 ...
 * @version 
 */
public class QuerySingleDomainApiStatusCodeGroupTrendResponse extends AcsResponse {
	...
	@Override
	public QuerySingleDomainApiStatusCodeGroupTrendResponse getInstance(UnmarshallerContext context) {
		return	QuerySingleDomainApiStatusCodeGroupTrendResponseUnmarshaller.unmarshall(this, context);
	}
