...
import com.aliyuncs.emas_appmonitor.transform.v20190611.QuerySingleDomainApiErrorGroupTrendResponseUnmarshaller;
 ...
 * @version 
 */
public class QuerySingleDomainApiErrorGroupTrendResponse extends AcsResponse {
	...
	@Override
	public QuerySingleDomainApiErrorGroupTrendResponse getInstance(UnmarshallerContext context) {
		return	QuerySingleDomainApiErrorGroupTrendResponseUnmarshaller.unmarshall(this, context);
	}
