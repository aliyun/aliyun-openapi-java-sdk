 ...
 * @version 
 */
public class QueryApiErrorGroupTrendRequest extends RpcAcsRequest<QueryApiErrorGroupTrendResponse> {
	...
	public QueryApiErrorGroupTrendRequest() {
		super("emas-appmonitor", "2019-06-11", "QueryApiErrorGroupTrend");
	...
	@Override
	public Class<QueryApiErrorGroupTrendResponse> getResponseClass() {
		return QueryApiErrorGroupTrendResponse.class;
	}
