 ...
 * @version 
 */
public class QueryPagePerfTrendRequest extends RpcAcsRequest<QueryPagePerfTrendResponse> {
	...
	public QueryPagePerfTrendRequest() {
		super("emas-appmonitor", "2019-06-11", "QueryPagePerfTrend");
	...
	@Override
	public Class<QueryPagePerfTrendResponse> getResponseClass() {
		return QueryPagePerfTrendResponse.class;
	}
