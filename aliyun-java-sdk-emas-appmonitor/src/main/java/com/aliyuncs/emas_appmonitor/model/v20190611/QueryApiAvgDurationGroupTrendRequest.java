 ...
 * @version 
 */
public class QueryApiAvgDurationGroupTrendRequest extends RpcAcsRequest<QueryApiAvgDurationGroupTrendResponse> {
	...
	public QueryApiAvgDurationGroupTrendRequest() {
		super("emas-appmonitor", "2019-06-11", "QueryApiAvgDurationGroupTrend");
	...
	@Override
	public Class<QueryApiAvgDurationGroupTrendResponse> getResponseClass() {
		return QueryApiAvgDurationGroupTrendResponse.class;
	}
