 ...
 * @version 
 */
public class QueryPagePerfTrendGroupByPageNameRequest extends RpcAcsRequest<QueryPagePerfTrendGroupByPageNameResponse> {
	...
	public QueryPagePerfTrendGroupByPageNameRequest() {
		super("emas-appmonitor", "2019-06-11", "QueryPagePerfTrendGroupByPageName");
	...
	@Override
	public Class<QueryPagePerfTrendGroupByPageNameResponse> getResponseClass() {
		return QueryPagePerfTrendGroupByPageNameResponse.class;
	}
