...
import com.aliyuncs.emas_appmonitor.transform.v20190611.QueryApiErrorGroupTrendResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryApiErrorGroupTrendResponse extends AcsResponse {
	...
	@Override
	public QueryApiErrorGroupTrendResponse getInstance(UnmarshallerContext context) {
		return	QueryApiErrorGroupTrendResponseUnmarshaller.unmarshall(this, context);
	}
