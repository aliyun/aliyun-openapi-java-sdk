...
import com.aliyuncs.emas_appmonitor.transform.v20190611.QueryApiDurationDistributionResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryApiDurationDistributionResponse extends AcsResponse {
	...
	@Override
	public QueryApiDurationDistributionResponse getInstance(UnmarshallerContext context) {
		return	QueryApiDurationDistributionResponseUnmarshaller.unmarshall(this, context);
	}
