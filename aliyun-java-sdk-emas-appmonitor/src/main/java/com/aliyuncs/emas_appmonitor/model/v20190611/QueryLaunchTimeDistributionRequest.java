 ...
 * @version 
 */
public class QueryLaunchTimeDistributionRequest extends RpcAcsRequest<QueryLaunchTimeDistributionResponse> {
	...
	public QueryLaunchTimeDistributionRequest() {
		super("emas-appmonitor", "2019-06-11", "QueryLaunchTimeDistribution");
	...
	@Override
	public Class<QueryLaunchTimeDistributionResponse> getResponseClass() {
		return QueryLaunchTimeDistributionResponse.class;
	}
