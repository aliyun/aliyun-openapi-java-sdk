 ...
 * @version 
 */
public class QueryApiStatusCodeTrendRequest extends RpcAcsRequest<QueryApiStatusCodeTrendResponse> {
	...
	public QueryApiStatusCodeTrendRequest() {
		super("emas-appmonitor", "2019-06-11", "QueryApiStatusCodeTrend");
	...
	@Override
	public Class<QueryApiStatusCodeTrendResponse> getResponseClass() {
		return QueryApiStatusCodeTrendResponse.class;
	}
