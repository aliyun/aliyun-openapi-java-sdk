...
import com.aliyuncs.emas_appmonitor.transform.v20190611.QueryLaunchTimeDistributionResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryLaunchTimeDistributionResponse extends AcsResponse {
	...
	@Override
	public QueryLaunchTimeDistributionResponse getInstance(UnmarshallerContext context) {
		return	QueryLaunchTimeDistributionResponseUnmarshaller.unmarshall(this, context);
	}
