...
import com.aliyuncs.emas_appmonitor.transform.v20190611.QueryCrashTrendResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryCrashTrendResponse extends AcsResponse {
	...
	@Override
	public QueryCrashTrendResponse getInstance(UnmarshallerContext context) {
		return	QueryCrashTrendResponseUnmarshaller.unmarshall(this, context);
	}
