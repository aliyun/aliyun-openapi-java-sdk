 ...
 * @version 
 */
public class QuerySingleDomainApiAvgDurationGroupTrendRequest extends RpcAcsRequest<QuerySingleDomainApiAvgDurationGroupTrendResponse> {
	...
	public QuerySingleDomainApiAvgDurationGroupTrendRequest() {
		super("emas-appmonitor", "2019-06-11", "QuerySingleDomainApiAvgDurationGroupTrend");
	...
	@Override
	public Class<QuerySingleDomainApiAvgDurationGroupTrendResponse> getResponseClass() {
		return QuerySingleDomainApiAvgDurationGroupTrendResponse.class;
	}
