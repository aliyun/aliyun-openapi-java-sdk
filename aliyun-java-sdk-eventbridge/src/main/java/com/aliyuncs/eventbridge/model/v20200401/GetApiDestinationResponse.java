...
import com.aliyuncs.eventbridge.transform.v20200401.GetApiDestinationResponseUnmarshaller;
 ...
 * @version 
 */
public class GetApiDestinationResponse extends AcsResponse {
	...
	@Override
	public GetApiDestinationResponse getInstance(UnmarshallerContext context) {
		return	GetApiDestinationResponseUnmarshaller.unmarshall(this, context);
	}
