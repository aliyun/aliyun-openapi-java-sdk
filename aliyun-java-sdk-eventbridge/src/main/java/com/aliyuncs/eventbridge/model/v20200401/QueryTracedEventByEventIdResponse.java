...
public class QueryTracedEventByEventIdResponse extends AcsResponse {
	...
	@Override
	public QueryTracedEventByEventIdResponse getInstance(UnmarshallerContext context) {
		return	QueryTracedEventByEventIdResponseUnmarshaller.unmarshall(this, context);
	}
