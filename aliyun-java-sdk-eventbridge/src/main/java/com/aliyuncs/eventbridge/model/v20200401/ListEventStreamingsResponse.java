		...
		public static class EventStreamingsItem {
			...
			public static class Sink {
				...
				public static class SinkFcParameters {
					...
					public void setBody1(Body1 body1) {
						this.body1 = body1;
					}
				...
				public static class SinkRabbitMQParameters {
					...
					public QueueName2 getQueueName2() {
						return this.queueName2;
					}

					public void setQueueName2(QueueName2 queueName2) {
					...
					public static class QueueName2 {
