 ...
 * @version 
 */
public class ChangeSkyRequest extends RpcAcsRequest<ChangeSkyResponse> {
	   

	private String replaceImageURL;

	private String imageURL;
	public ChangeSkyRequest() {
		super("imageseg", "2019-12-30", "ChangeSky", "imageseg");
	...
	public void setReplaceImageURL(String replaceImageURL) {
		...
		if(replaceImageURL != null){
			putQueryParameter("ReplaceImageURL", replaceImageURL);
		}
	}
	...
	@Override
	public Class<ChangeSkyResponse> getResponseClass() {
		return ChangeSkyResponse.class;
	}
