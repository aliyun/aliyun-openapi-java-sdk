 ...
 * @version 
 */
public class SegmentHairRequest extends RpcAcsRequest<SegmentHairResponse> {
	...
	@Override
	public Class<SegmentHairResponse> getResponseClass() {
		return SegmentHairResponse.class;
	}
