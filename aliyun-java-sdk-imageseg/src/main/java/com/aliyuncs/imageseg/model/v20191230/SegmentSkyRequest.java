 ...
 * @version 
 */
public class SegmentSkyRequest extends RpcAcsRequest<SegmentSkyResponse> {
	...
	@Override
	public Class<SegmentSkyResponse> getResponseClass() {
		return SegmentSkyResponse.class;
	}
