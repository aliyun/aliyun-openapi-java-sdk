 ...
 * @version 
 */
public class SegmentSkinRequest extends RpcAcsRequest<SegmentSkinResponse> {
	...
	@Override
	public Class<SegmentSkinResponse> getResponseClass() {
		return SegmentSkinResponse.class;
	}
