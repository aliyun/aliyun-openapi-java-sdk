...
import com.aliyuncs.ecsops.model.v20160401.OpsDescribeConstraintInvisibleCauseResponse;
import com.aliyuncs.transform.UnmarshallerContext;


public class OpsDescribeConstraintInvisibleCauseResponseUnmarshaller {

	public static OpsDescribeConstraintInvisibleCauseResponse unmarshall(OpsDescribeConstraintInvisibleCauseResponse opsDescribeConstraintInvisibleCauseResponse, UnmarshallerContext _ctx) {
		...
		for (int i = 0; i < _ctx.lengthValue("OpsDescribeConstraintInvisibleCauseResponse.FailedRuleList.Length"); i++) {
			failedRuleList.add(_ctx.stringValue("OpsDescribeConstraintInvisibleCauseResponse.FailedRuleList["+ i +"]"));
		}
		opsDescribeConstraintInvisibleCauseResponse.setFailedRuleList(failedRuleList);
	 
	 	return opsDescribeConstraintInvisibleCauseResponse;
	}
}