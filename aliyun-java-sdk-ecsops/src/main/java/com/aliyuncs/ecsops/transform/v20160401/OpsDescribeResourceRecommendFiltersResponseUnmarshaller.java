...
import com.aliyuncs.ecsops.model.v20160401.OpsDescribeResourceRecommendFiltersResponse;
import com.aliyuncs.ecsops.model.v20160401.OpsDescribeResourceRecommendFiltersResponse.RecommendFilter;
import com.aliyuncs.transform.UnmarshallerContext;


public class OpsDescribeResourceRecommendFiltersResponseUnmarshaller {

	public static OpsDescribeResourceRecommendFiltersResponse unmarshall(OpsDescribeResourceRecommendFiltersResponse opsDescribeResourceRecommendFiltersResponse, UnmarshallerContext _ctx) {
		
		opsDescribeResourceRecommendFiltersResponse.setRequestId(_ctx.stringValue("OpsDescribeResourceRecommendFiltersResponse.RequestId"));
		...
		opsDescribeResourceRecommendFiltersResponse.setRecommendFilters(recommendFilters);
	 
	 	return opsDescribeResourceRecommendFiltersResponse;
	}
}