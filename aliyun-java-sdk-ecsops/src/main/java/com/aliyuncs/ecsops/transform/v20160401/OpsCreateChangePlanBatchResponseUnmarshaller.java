...
import com.aliyuncs.ecsops.model.v20160401.OpsCreateChangePlanBatchResponse;
import com.aliyuncs.ecsops.model.v20160401.OpsCreateChangePlanBatchResponse.Data;
import com.aliyuncs.transform.UnmarshallerContext;


public class OpsCreateChangePlanBatchResponseUnmarshaller {
	...
	public static OpsCreateChangePlanBatchResponse unmarshall(OpsCreateChangePlanBatchResponse opsCreateChangePlanBatchResponse, UnmarshallerContext _ctx) {
		...
		Data data = new Data();
		data.setStatus(_ctx.stringValue("OpsCreateChangePlanBatchResponse.Data.Status"));
		data.setChangePlanBatchId(_ctx.stringValue("OpsCreateChangePlanBatchResponse.Data.ChangePlanBatchId"));
		opsCreateChangePlanBatchResponse.setData(data);
	 
	 	return opsCreateChangePlanBatchResponse;
	}
}