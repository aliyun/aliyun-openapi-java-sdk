...
import com.aliyuncs.ecsops.model.v20160401.OpsSgSwitchZkModeResponse;
import com.aliyuncs.ecsops.model.v20160401.OpsSgSwitchZkModeResponse.Data;
import com.aliyuncs.transform.UnmarshallerContext;


public class OpsSgSwitchZkModeResponseUnmarshaller {
	...
	public static OpsSgSwitchZkModeResponse unmarshall(OpsSgSwitchZkModeResponse opsSgSwitchZkModeResponse, UnmarshallerContext _ctx) {
		...
		Data data = new Data();
		data.setResultInfoStr(_ctx.stringValue("OpsSgSwitchZkModeResponse.Data.ResultInfoStr"));
		opsSgSwitchZkModeResponse.setData(data);
	 
	 	return opsSgSwitchZkModeResponse;
	}
}