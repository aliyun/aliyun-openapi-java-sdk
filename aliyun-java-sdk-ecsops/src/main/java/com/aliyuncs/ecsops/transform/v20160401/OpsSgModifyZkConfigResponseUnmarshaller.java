...
import com.aliyuncs.ecsops.model.v20160401.OpsSgModifyZkConfigResponse;
import com.aliyuncs.ecsops.model.v20160401.OpsSgModifyZkConfigResponse.Data;
import com.aliyuncs.transform.UnmarshallerContext;


public class OpsSgModifyZkConfigResponseUnmarshaller {
	...
	public static OpsSgModifyZkConfigResponse unmarshall(OpsSgModifyZkConfigResponse opsSgModifyZkConfigResponse, UnmarshallerContext _ctx) {
		...
		Data data = new Data();
		data.setResultInfoStr(_ctx.stringValue("OpsSgModifyZkConfigResponse.Data.ResultInfoStr"));
		opsSgModifyZkConfigResponse.setData(data);
	 
	 	return opsSgModifyZkConfigResponse;
	}
}