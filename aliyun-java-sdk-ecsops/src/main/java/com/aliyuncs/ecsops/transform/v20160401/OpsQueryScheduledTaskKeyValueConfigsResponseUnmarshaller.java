...
import com.aliyuncs.ecsops.model.v20160401.OpsQueryScheduledTaskKeyValueConfigsResponse;
import com.aliyuncs.ecsops.model.v20160401.OpsQueryScheduledTaskKeyValueConfigsResponse.ScheduledTaskKeyValueConfig;
import com.aliyuncs.transform.UnmarshallerContext;


public class OpsQueryScheduledTaskKeyValueConfigsResponseUnmarshaller {

	public static OpsQueryScheduledTaskKeyValueConfigsResponse unmarshall(OpsQueryScheduledTaskKeyValueConfigsResponse opsQueryScheduledTaskKeyValueConfigsResponse, UnmarshallerContext _ctx) {
		
		opsQueryScheduledTaskKeyValueConfigsResponse.setRequestId(_ctx.stringValue("OpsQueryScheduledTaskKeyValueConfigsResponse.RequestId"));
		opsQueryScheduledTaskKeyValueConfigsResponse.setCount(_ctx.integerValue("OpsQueryScheduledTaskKeyValueConfigsResponse.Count"));
		...
		opsQueryScheduledTaskKeyValueConfigsResponse.setScheduledTaskKeyValueConfigs(scheduledTaskKeyValueConfigs);
	 
	 	return opsQueryScheduledTaskKeyValueConfigsResponse;
	}
}