...
import com.aliyuncs.ecsops.model.v20160401.OpsCreateNcTagResponse;
import com.aliyuncs.ecsops.model.v20160401.OpsCreateNcTagResponse.Data;
import com.aliyuncs.transform.UnmarshallerContext;


public class OpsCreateNcTagResponseUnmarshaller {
	...
	public static OpsCreateNcTagResponse unmarshall(OpsCreateNcTagResponse opsCreateNcTagResponse, UnmarshallerContext _ctx) {
		...
		Data data = new Data();
		data.setNcTagId(_ctx.stringValue("OpsCreateNcTagResponse.Data.NcTagId"));
		opsCreateNcTagResponse.setData(data);
	 
	 	return opsCreateNcTagResponse;
	}
}