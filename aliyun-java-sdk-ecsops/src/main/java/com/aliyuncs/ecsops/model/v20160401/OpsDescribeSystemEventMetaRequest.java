 ...
 * @version 
 */
public class OpsDescribeSystemEventMetaRequest extends RpcAcsRequest<OpsDescribeSystemEventMetaResponse> {
	...
	public OpsDescribeSystemEventMetaRequest() {
		super("Ecsops", "2016-04-01", "OpsDescribeSystemEventMeta", "ecsops");
	...
	@Override
	public Class<OpsDescribeSystemEventMetaResponse> getResponseClass() {
		return OpsDescribeSystemEventMetaResponse.class;
	}
