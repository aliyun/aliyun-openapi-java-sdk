...
import com.aliyuncs.ecsops.transform.v20160401.OpsDescribeNetworkInterfacesResponseUnmarshaller;
...
public class OpsDescribeNetworkInterfacesResponse extends AcsResponse {
	...
	@Override
	public OpsDescribeNetworkInterfacesResponse getInstance(UnmarshallerContext context) {
		return	OpsDescribeNetworkInterfacesResponseUnmarshaller.unmarshall(this, context);
	}
}
