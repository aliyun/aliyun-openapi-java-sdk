 ...
 * @version 
 */
public class OpsCloudBoxManagementChannelListRequest extends RpcAcsRequest<OpsCloudBoxManagementChannelListResponse> {
	...
	public OpsCloudBoxManagementChannelListRequest() {
		super("Ecsops", "2016-04-01", "OpsCloudBoxManagementChannelList", "ecsops");
	...
	@Override
	public Class<OpsCloudBoxManagementChannelListResponse> getResponseClass() {
		return OpsCloudBoxManagementChannelListResponse.class;
	}
