 ...
 * @version 
 */
public class OpsCreateDedicatedHostTypeRequest extends RpcAcsRequest<OpsCreateDedicatedHostTypeResponse> {
	...
	public OpsCreateDedicatedHostTypeRequest() {
		super("Ecsops", "2016-04-01", "OpsCreateDedicatedHostType", "ecsops");
	...
	@Override
	public Class<OpsCreateDedicatedHostTypeResponse> getResponseClass() {
		return OpsCreateDedicatedHostTypeResponse.class;
	}
