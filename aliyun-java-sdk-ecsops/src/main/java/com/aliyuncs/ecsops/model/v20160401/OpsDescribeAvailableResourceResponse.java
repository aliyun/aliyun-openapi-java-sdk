...
import com.aliyuncs.ecsops.transform.v20160401.OpsDescribeAvailableResourceResponseUnmarshaller;
 ...
 * @version 
 */
public class OpsDescribeAvailableResourceResponse extends AcsResponse {
	...
	@Override
	public OpsDescribeAvailableResourceResponse getInstance(UnmarshallerContext context) {
		return	OpsDescribeAvailableResourceResponseUnmarshaller.unmarshall(this, context);
	}
}
