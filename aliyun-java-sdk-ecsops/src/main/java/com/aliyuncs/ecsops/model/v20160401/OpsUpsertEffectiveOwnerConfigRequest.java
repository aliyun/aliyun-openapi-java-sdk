 ...
 * @version 
 */
public class OpsUpsertEffectiveOwnerConfigRequest extends RpcAcsRequest<OpsUpsertEffectiveOwnerConfigResponse> {
	...
	public OpsUpsertEffectiveOwnerConfigRequest() {
		super("Ecsops", "2016-04-01", "OpsUpsertEffectiveOwnerConfig", "ecsops");
	...
	@Override
	public Class<OpsUpsertEffectiveOwnerConfigResponse> getResponseClass() {
		return OpsUpsertEffectiveOwnerConfigResponse.class;
	}
