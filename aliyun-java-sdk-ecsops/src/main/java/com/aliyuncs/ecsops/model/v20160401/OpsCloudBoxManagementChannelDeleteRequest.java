 ...
 * @version 
 */
public class OpsCloudBoxManagementChannelDeleteRequest extends RpcAcsRequest<OpsCloudBoxManagementChannelDeleteResponse> {
	...
	public OpsCloudBoxManagementChannelDeleteRequest() {
		super("Ecsops", "2016-04-01", "OpsCloudBoxManagementChannelDelete", "ecsops");
	...
	@Override
	public Class<OpsCloudBoxManagementChannelDeleteResponse> getResponseClass() {
		return OpsCloudBoxManagementChannelDeleteResponse.class;
	}
