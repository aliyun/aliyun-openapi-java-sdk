...
import com.aliyuncs.ecsops.transform.v20160401.OpsChangeGroupTypeResponseUnmarshaller;
 ...
 * @version 
 */
public class OpsChangeGroupTypeResponse extends AcsResponse {
	...
	@Override
	public OpsChangeGroupTypeResponse getInstance(UnmarshallerContext context) {
		return	OpsChangeGroupTypeResponseUnmarshaller.unmarshall(this, context);
	}
}
