 ...
 * @version 
 */
public class OpsModifyInstanceTypeAttributeRequest extends RpcAcsRequest<OpsModifyInstanceTypeAttributeResponse> {
	...
	private List<String> needSetNullFields;
	...
	public List<String> getNeedSetNullFields() {
		return this.needSetNullFields;
	}

	public void setNeedSetNullFields(List<String> needSetNullFields) {
		this.needSetNullFields = needSetNullFields;	
		if (needSetNullFields != null) {
			for (int i = 0; i < needSetNullFields.size(); i++) {
				putQueryParameter("NeedSetNullField." + (i + 1) , needSetNullFields.get(i));
			}
		}	
	}
	...
	@Override
	public Class<OpsModifyInstanceTypeAttributeResponse> getResponseClass() {
		return OpsModifyInstanceTypeAttributeResponse.class;
	}
