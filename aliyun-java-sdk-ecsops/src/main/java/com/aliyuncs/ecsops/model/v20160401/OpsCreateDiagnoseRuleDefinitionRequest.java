 ...
 * @version 
 */
public class OpsCreateDiagnoseRuleDefinitionRequest extends RpcAcsRequest<OpsCreateDiagnoseRuleDefinitionResponse> {
	...
	public OpsCreateDiagnoseRuleDefinitionRequest() {
		super("Ecsops", "2016-04-01", "OpsCreateDiagnoseRuleDefinition", "ecsops");
	...
	@Override
	public Class<OpsCreateDiagnoseRuleDefinitionResponse> getResponseClass() {
		return OpsCreateDiagnoseRuleDefinitionResponse.class;
	}
