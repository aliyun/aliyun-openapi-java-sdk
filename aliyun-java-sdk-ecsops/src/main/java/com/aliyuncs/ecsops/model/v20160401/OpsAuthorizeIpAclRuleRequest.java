 ...
 * @version 
 */
public class OpsAuthorizeIpAclRuleRequest extends RpcAcsRequest<OpsAuthorizeIpAclRuleResponse> {
	...
	public OpsAuthorizeIpAclRuleRequest() {
		super("Ecsops", "2016-04-01", "OpsAuthorizeIpAclRule", "ecsops");
	...
	@Override
	public Class<OpsAuthorizeIpAclRuleResponse> getResponseClass() {
		return OpsAuthorizeIpAclRuleResponse.class;
	}
