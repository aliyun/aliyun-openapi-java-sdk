 ...
 * @version 
 */
public class OpsHouyiTerminateWorkflowRequest extends RpcAcsRequest<OpsHouyiTerminateWorkflowResponse> {
	...
	public OpsHouyiTerminateWorkflowRequest() {
		super("Ecsops", "2016-04-01", "OpsHouyiTerminateWorkflow", "ecsops");
	...
	@Override
	public Class<OpsHouyiTerminateWorkflowResponse> getResponseClass() {
		return OpsHouyiTerminateWorkflowResponse.class;
	}
