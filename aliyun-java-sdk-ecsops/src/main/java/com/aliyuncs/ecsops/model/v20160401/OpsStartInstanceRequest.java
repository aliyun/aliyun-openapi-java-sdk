 ...
 * @version 
 */
public class OpsStartInstanceRequest extends RpcAcsRequest<OpsStartInstanceResponse> {
	...
	public OpsStartInstanceRequest() {
		super("Ecsops", "2016-04-01", "OpsStartInstance", "ecsops");
	...
	@Override
	public Class<OpsStartInstanceResponse> getResponseClass() {
		return OpsStartInstanceResponse.class;
	}
