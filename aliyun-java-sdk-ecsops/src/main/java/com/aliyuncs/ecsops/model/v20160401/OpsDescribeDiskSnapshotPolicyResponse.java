...
import com.aliyuncs.ecsops.transform.v20160401.OpsDescribeDiskSnapshotPolicyResponseUnmarshaller;
...
public class OpsDescribeDiskSnapshotPolicyResponse extends AcsResponse {
	...
	@Override
	public OpsDescribeDiskSnapshotPolicyResponse getInstance(UnmarshallerContext context) {
		return	OpsDescribeDiskSnapshotPolicyResponseUnmarshaller.unmarshall(this, context);
	}
}
