 ...
 * @version 
 */
public class OpsRollbackWorkflowRequest extends RpcAcsRequest<OpsRollbackWorkflowResponse> {
	   

	private List<String> workflowIdLists;

	private String auditParamStr;
	public OpsRollbackWorkflowRequest() {
		super("Ecsops", "2016-04-01", "OpsRollbackWorkflow", "ecsops");
	...
	@Override
	public Class<OpsRollbackWorkflowResponse> getResponseClass() {
		return OpsRollbackWorkflowResponse.class;
	}
