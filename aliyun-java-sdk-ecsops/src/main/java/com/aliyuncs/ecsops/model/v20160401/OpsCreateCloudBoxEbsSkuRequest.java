 ...
 * @version 
 */
public class OpsCreateCloudBoxEbsSkuRequest extends RpcAcsRequest<OpsCreateCloudBoxEbsSkuResponse> {
	...
	private String name;
	public OpsCreateCloudBoxEbsSkuRequest() {
		super("Ecsops", "2016-04-01", "OpsCreateCloudBoxEbsSku", "ecsops");
	...
	@Override
	public Class<OpsCreateCloudBoxEbsSkuResponse> getResponseClass() {
		return OpsCreateCloudBoxEbsSkuResponse.class;
	}
