 ...
 * @version 
 */
public class OpsDetachNetworkInterfaceRequest extends RpcAcsRequest<OpsDetachNetworkInterfaceResponse> {
	...
	public OpsDetachNetworkInterfaceRequest() {
		super("Ecsops", "2016-04-01", "OpsDetachNetworkInterface", "ecsops");
	...
	@Override
	public Class<OpsDetachNetworkInterfaceResponse> getResponseClass() {
		return OpsDetachNetworkInterfaceResponse.class;
	}
