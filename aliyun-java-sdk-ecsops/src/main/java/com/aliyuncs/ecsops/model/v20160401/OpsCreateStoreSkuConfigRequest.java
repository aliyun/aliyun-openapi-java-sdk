 ...
 * @version 
 */
public class OpsCreateStoreSkuConfigRequest extends RpcAcsRequest<OpsCreateStoreSkuConfigResponse> {
	...
	public OpsCreateStoreSkuConfigRequest() {
		super("Ecsops", "2016-04-01", "OpsCreateStoreSkuConfig", "ecsops");
	...
	@Override
	public Class<OpsCreateStoreSkuConfigResponse> getResponseClass() {
		return OpsCreateStoreSkuConfigResponse.class;
	}
