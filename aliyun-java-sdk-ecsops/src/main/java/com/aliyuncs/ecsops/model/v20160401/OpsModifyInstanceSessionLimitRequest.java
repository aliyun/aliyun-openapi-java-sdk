 ...
 * @version 
 */
public class OpsModifyInstanceSessionLimitRequest extends RpcAcsRequest<OpsModifyInstanceSessionLimitResponse> {
	...
	public OpsModifyInstanceSessionLimitRequest() {
		super("Ecsops", "2016-04-01", "OpsModifyInstanceSessionLimit", "ecsops");
	...
	@Override
	public Class<OpsModifyInstanceSessionLimitResponse> getResponseClass() {
		return OpsModifyInstanceSessionLimitResponse.class;
	}
