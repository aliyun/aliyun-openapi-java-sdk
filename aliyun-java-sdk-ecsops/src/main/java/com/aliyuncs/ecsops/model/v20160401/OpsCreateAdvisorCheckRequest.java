 ...
 * @version 
 */
public class OpsCreateAdvisorCheckRequest extends RpcAcsRequest<OpsCreateAdvisorCheckResponse> {
	...
	@Override
	public Class<OpsCreateAdvisorCheckResponse> getResponseClass() {
		return OpsCreateAdvisorCheckResponse.class;
	}
