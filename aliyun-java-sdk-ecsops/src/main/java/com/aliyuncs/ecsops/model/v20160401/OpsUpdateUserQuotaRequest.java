 ...
 * @version 
 */
public class OpsUpdateUserQuotaRequest extends RpcAcsRequest<OpsUpdateUserQuotaResponse> {
	...
	public OpsUpdateUserQuotaRequest() {
		super("Ecsops", "2016-04-01", "OpsUpdateUserQuota", "ecsops");
	...
	@Override
	public Class<OpsUpdateUserQuotaResponse> getResponseClass() {
		return OpsUpdateUserQuotaResponse.class;
	}
