...
import com.aliyuncs.ecsops.transform.v20160401.OpsQueryWorkflowListResponseUnmarshaller;
 ...
 * @version 
 */
public class OpsQueryWorkflowListResponse extends AcsResponse {
	...
	@Override
	public OpsQueryWorkflowListResponse getInstance(UnmarshallerContext context) {
		return	OpsQueryWorkflowListResponseUnmarshaller.unmarshall(this, context);
	}
}
