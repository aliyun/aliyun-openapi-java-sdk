 ...
 * @version 
 */
public class OpsHouyiQueryWorkflowListRequest extends RpcAcsRequest<OpsHouyiQueryWorkflowListResponse> {
	...
	public OpsHouyiQueryWorkflowListRequest() {
		super("Ecsops", "2016-04-01", "OpsHouyiQueryWorkflowList", "ecsops");
	...
	@Override
	public Class<OpsHouyiQueryWorkflowListResponse> getResponseClass() {
		return OpsHouyiQueryWorkflowListResponse.class;
	}
