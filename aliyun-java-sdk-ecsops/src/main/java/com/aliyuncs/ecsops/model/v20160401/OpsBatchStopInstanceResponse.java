...
import com.aliyuncs.ecsops.transform.v20160401.OpsBatchStopInstanceResponseUnmarshaller;
 ...
 * @version 
 */
public class OpsBatchStopInstanceResponse extends AcsResponse {
	...
	@Override
	public OpsBatchStopInstanceResponse getInstance(UnmarshallerContext context) {
		return	OpsBatchStopInstanceResponseUnmarshaller.unmarshall(this, context);
	}
}
