 ...
 * @version 
 */
public class OpsDescribePriceRequest extends RpcAcsRequest<OpsDescribePriceResponse> {
	...
	public OpsDescribePriceRequest() {
		super("Ecsops", "2016-04-01", "OpsDescribePrice", "ecsops");
	...
	public void setNeedSpotPrice(Boolean needSpotPrice) {
		this.needSpotPrice = needSpotPrice;
		if(needSpotPrice != null){
			putQueryParameter("NeedSpotPrice", needSpotPrice.toString());
		}
	}
	...
	@Override
	public Class<OpsDescribePriceResponse> getResponseClass() {
		return OpsDescribePriceResponse.class;
	}
