 ...
 * @version 
 */
public class OpsUpdateScheduledTaskRequest extends RpcAcsRequest<OpsUpdateScheduledTaskResponse> {
	...
	@Override
	public Class<OpsUpdateScheduledTaskResponse> getResponseClass() {
		return OpsUpdateScheduledTaskResponse.class;
	}
