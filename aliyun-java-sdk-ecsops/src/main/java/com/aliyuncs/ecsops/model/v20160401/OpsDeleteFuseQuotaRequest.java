 ...
 * @version 
 */
public class OpsDeleteFuseQuotaRequest extends RpcAcsRequest<OpsDeleteFuseQuotaResponse> {
	...
	public OpsDeleteFuseQuotaRequest() {
		super("Ecsops", "2016-04-01", "OpsDeleteFuseQuota", "ecsops");
	...
	@Override
	public Class<OpsDeleteFuseQuotaResponse> getResponseClass() {
		return OpsDeleteFuseQuotaResponse.class;
	}
