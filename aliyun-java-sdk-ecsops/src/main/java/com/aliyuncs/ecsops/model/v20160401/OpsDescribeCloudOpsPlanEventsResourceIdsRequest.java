 ...
 * @version 
 */
public class OpsDescribeCloudOpsPlanEventsResourceIdsRequest extends RpcAcsRequest<OpsDescribeCloudOpsPlanEventsResourceIdsResponse> {
	...
	public OpsDescribeCloudOpsPlanEventsResourceIdsRequest() {
		super("Ecsops", "2016-04-01", "OpsDescribeCloudOpsPlanEventsResourceIds", "ecsops");
	...
	@Override
	public Class<OpsDescribeCloudOpsPlanEventsResourceIdsResponse> getResponseClass() {
		return OpsDescribeCloudOpsPlanEventsResourceIdsResponse.class;
	}
