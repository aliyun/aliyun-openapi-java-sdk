 ...
 * @version 
 */
public class OpsSreModifyOwnerAppRequest extends RpcAcsRequest<OpsSreModifyOwnerAppResponse> {
	...
	public OpsSreModifyOwnerAppRequest() {
		super("Ecsops", "2016-04-01", "OpsSreModifyOwnerApp", "ecsops");
	...
	public void setOwnerAppId(String ownerAppId) {
		...
		if(ownerAppId != null){
			putQueryParameter("OwnerAppId", ownerAppId);
		}
	}
	...
	@Override
	public Class<OpsSreModifyOwnerAppResponse> getResponseClass() {
		return OpsSreModifyOwnerAppResponse.class;
	}
