 ...
 * @version 
 */
public class OpsRevokeIpAclRuleRequest extends RpcAcsRequest<OpsRevokeIpAclRuleResponse> {
	...
	public OpsRevokeIpAclRuleRequest() {
		super("Ecsops", "2016-04-01", "OpsRevokeIpAclRule", "ecsops");
	...
	@Override
	public Class<OpsRevokeIpAclRuleResponse> getResponseClass() {
		return OpsRevokeIpAclRuleResponse.class;
	}
