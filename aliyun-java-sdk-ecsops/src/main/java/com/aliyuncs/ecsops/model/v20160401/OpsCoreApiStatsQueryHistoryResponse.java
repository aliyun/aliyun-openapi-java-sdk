...
import com.aliyuncs.ecsops.transform.v20160401.OpsCoreApiStatsQueryHistoryResponseUnmarshaller;
...
public class OpsCoreApiStatsQueryHistoryResponse extends AcsResponse {
	...
	@Override
	public OpsCoreApiStatsQueryHistoryResponse getInstance(UnmarshallerContext context) {
		return	OpsCoreApiStatsQueryHistoryResponseUnmarshaller.unmarshall(this, context);
	}
