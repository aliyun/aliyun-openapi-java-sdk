...
import com.aliyuncs.ecsops.transform.v20160401.OpsQueryDiskModelResponseUnmarshaller;
 ...
 * @version 
 */
public class OpsQueryDiskModelResponse extends AcsResponse {
	...
	@Override
	public OpsQueryDiskModelResponse getInstance(UnmarshallerContext context) {
		return	OpsQueryDiskModelResponseUnmarshaller.unmarshall(this, context);
	}
}
