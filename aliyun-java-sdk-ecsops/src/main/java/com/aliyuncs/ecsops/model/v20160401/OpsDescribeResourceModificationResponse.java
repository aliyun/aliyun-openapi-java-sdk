...
import com.aliyuncs.ecsops.transform.v20160401.OpsDescribeResourceModificationResponseUnmarshaller;
 ...
 * @version 
 */
public class OpsDescribeResourceModificationResponse extends AcsResponse {
	...
	@Override
	public OpsDescribeResourceModificationResponse getInstance(UnmarshallerContext context) {
		return	OpsDescribeResourceModificationResponseUnmarshaller.unmarshall(this, context);
	}
}
