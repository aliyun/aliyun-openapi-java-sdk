 ...
 * @version 
 */
public class OpsQueryUserQuotaCategoryRequest extends RpcAcsRequest<OpsQueryUserQuotaCategoryResponse> {
	...
	@Override
	public Class<OpsQueryUserQuotaCategoryResponse> getResponseClass() {
		return OpsQueryUserQuotaCategoryResponse.class;
	}
