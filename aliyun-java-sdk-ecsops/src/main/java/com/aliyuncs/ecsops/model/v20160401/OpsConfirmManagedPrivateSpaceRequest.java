 ...
 * @version 
 */
public class OpsConfirmManagedPrivateSpaceRequest extends RpcAcsRequest<OpsConfirmManagedPrivateSpaceResponse> {
	...
	public OpsConfirmManagedPrivateSpaceRequest() {
		super("Ecsops", "2016-04-01", "OpsConfirmManagedPrivateSpace", "ecsops");
	...
	@Override
	public Class<OpsConfirmManagedPrivateSpaceResponse> getResponseClass() {
		return OpsConfirmManagedPrivateSpaceResponse.class;
	}
