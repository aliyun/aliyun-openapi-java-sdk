 ...
 * @version 
 */
public class OpsHouyiRollbackWorkflowRequest extends RpcAcsRequest<OpsHouyiRollbackWorkflowResponse> {
	...
	public OpsHouyiRollbackWorkflowRequest() {
		super("Ecsops", "2016-04-01", "OpsHouyiRollbackWorkflow", "ecsops");
	...
	@Override
	public Class<OpsHouyiRollbackWorkflowResponse> getResponseClass() {
		return OpsHouyiRollbackWorkflowResponse.class;
	}
