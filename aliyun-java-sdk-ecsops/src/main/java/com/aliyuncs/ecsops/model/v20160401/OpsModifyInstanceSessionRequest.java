 ...
 * @version 
 */
public class OpsModifyInstanceSessionRequest extends RpcAcsRequest<OpsModifyInstanceSessionResponse> {
	...
	public OpsModifyInstanceSessionRequest() {
		super("Ecsops", "2016-04-01", "OpsModifyInstanceSession", "ecsops");
	...
	@Override
	public Class<OpsModifyInstanceSessionResponse> getResponseClass() {
		return OpsModifyInstanceSessionResponse.class;
	}
