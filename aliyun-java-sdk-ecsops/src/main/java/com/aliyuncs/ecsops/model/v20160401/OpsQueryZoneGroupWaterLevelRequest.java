 ...
 * @version 
 */
public class OpsQueryZoneGroupWaterLevelRequest extends RpcAcsRequest<OpsQueryZoneGroupWaterLevelResponse> {
	...
	public OpsQueryZoneGroupWaterLevelRequest() {
		super("Ecsops", "2016-04-01", "OpsQueryZoneGroupWaterLevel", "ecsops");
	...
	@Override
	public Class<OpsQueryZoneGroupWaterLevelResponse> getResponseClass() {
		return OpsQueryZoneGroupWaterLevelResponse.class;
	}
