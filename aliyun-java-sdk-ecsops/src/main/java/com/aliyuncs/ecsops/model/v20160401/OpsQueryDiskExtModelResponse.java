...
import com.aliyuncs.ecsops.transform.v20160401.OpsQueryDiskExtModelResponseUnmarshaller;
...
public class OpsQueryDiskExtModelResponse extends AcsResponse {
	...
	@Override
	public OpsQueryDiskExtModelResponse getInstance(UnmarshallerContext context) {
		return	OpsQueryDiskExtModelResponseUnmarshaller.unmarshall(this, context);
	}
}
