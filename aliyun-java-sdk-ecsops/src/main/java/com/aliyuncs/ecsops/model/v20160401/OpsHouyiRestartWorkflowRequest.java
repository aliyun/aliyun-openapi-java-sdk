 ...
 * @version 
 */
public class OpsHouyiRestartWorkflowRequest extends RpcAcsRequest<OpsHouyiRestartWorkflowResponse> {
	...
	public OpsHouyiRestartWorkflowRequest() {
		super("Ecsops", "2016-04-01", "OpsHouyiRestartWorkflow", "ecsops");
	...
	@Override
	public Class<OpsHouyiRestartWorkflowResponse> getResponseClass() {
		return OpsHouyiRestartWorkflowResponse.class;
	}
