 ...
 * @version 
 */
public class OpsModifyEniStatusRequest extends RpcAcsRequest<OpsModifyEniStatusResponse> {
	...
	public OpsModifyEniStatusRequest() {
		super("Ecsops", "2016-04-01", "OpsModifyEniStatus", "ecsops");
	...
	public void setTargetApp(String targetApp) {
		...
		if(targetApp != null){
			putQueryParameter("TargetApp", targetApp);
		}
	}
	...
	@Override
	public Class<OpsModifyEniStatusResponse> getResponseClass() {
		return OpsModifyEniStatusResponse.class;
	}
