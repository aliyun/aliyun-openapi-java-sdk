...
import com.aliyuncs.ecsops.transform.v20160401.OpsDescribeCloudOpsPlanEventsResourceIdsResponseUnmarshaller;
...
public class OpsDescribeCloudOpsPlanEventsResourceIdsResponse extends AcsResponse {
	...
	public void setData(List<PlanEventAttribute> data) {
		this.data = data;
	}
	...
	@Override
	public OpsDescribeCloudOpsPlanEventsResourceIdsResponse getInstance(UnmarshallerContext context) {
		return	OpsDescribeCloudOpsPlanEventsResourceIdsResponseUnmarshaller.unmarshall(this, context);
	}
}
