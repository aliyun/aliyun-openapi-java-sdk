 ...
 * @version 
 */
public class OpsCreateAlertsRequest extends RpcAcsRequest<OpsCreateAlertsResponse> {
	...
	public OpsCreateAlertsRequest() {
		super("Ecsops", "2016-04-01", "OpsCreateAlerts", "ecsops");
	...
	@Override
	public Class<OpsCreateAlertsResponse> getResponseClass() {
		return OpsCreateAlertsResponse.class;
	}
