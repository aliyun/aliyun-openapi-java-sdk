 ...
 * @version 
 */
public class OpsModifySystemEventMetaRequest extends RpcAcsRequest<OpsModifySystemEventMetaResponse> {
	...
	public OpsModifySystemEventMetaRequest() {
		super("Ecsops", "2016-04-01", "OpsModifySystemEventMeta", "ecsops");
	...
	@Override
	public Class<OpsModifySystemEventMetaResponse> getResponseClass() {
		return OpsModifySystemEventMetaResponse.class;
	}
