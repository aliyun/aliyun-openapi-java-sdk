 ...
 * @version 
 */
public class OpsListZonesRequest extends RpcAcsRequest<OpsListZonesResponse> {
	...
	public OpsListZonesRequest() {
		super("Ecsops", "2016-04-01", "OpsListZones", "ecsops");
	...
	@Override
	public Class<OpsListZonesResponse> getResponseClass() {
		return OpsListZonesResponse.class;
	}
