...
import com.aliyuncs.ecsops.transform.v20160401.OpsDescribeInstancesFullStatusResponseUnmarshaller;
...
public class OpsDescribeInstancesFullStatusResponse extends AcsResponse {
	...
	@Override
	public OpsDescribeInstancesFullStatusResponse getInstance(UnmarshallerContext context) {
		return	OpsDescribeInstancesFullStatusResponseUnmarshaller.unmarshall(this, context);
	}
}
