 ...
 * @version 
 */
public class OpsDeleteUserQuotaResourceRequest extends RpcAcsRequest<OpsDeleteUserQuotaResourceResponse> {
	...
	public OpsDeleteUserQuotaResourceRequest() {
		super("Ecsops", "2016-04-01", "OpsDeleteUserQuotaResource", "ecsops");
	...
	@Override
	public Class<OpsDeleteUserQuotaResourceResponse> getResponseClass() {
		return OpsDeleteUserQuotaResourceResponse.class;
	}
