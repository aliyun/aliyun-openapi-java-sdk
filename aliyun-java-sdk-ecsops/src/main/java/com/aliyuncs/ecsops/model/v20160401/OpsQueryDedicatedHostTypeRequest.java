 ...
 * @version 
 */
public class OpsQueryDedicatedHostTypeRequest extends RpcAcsRequest<OpsQueryDedicatedHostTypeResponse> {
	...
	public OpsQueryDedicatedHostTypeRequest() {
		super("Ecsops", "2016-04-01", "OpsQueryDedicatedHostType", "ecsops");
	...
	@Override
	public Class<OpsQueryDedicatedHostTypeResponse> getResponseClass() {
		return OpsQueryDedicatedHostTypeResponse.class;
	}
