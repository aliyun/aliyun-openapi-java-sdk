 ...
 * @version 
 */
public class OpsUpdateChangePlanCompletionResourceRequest extends RpcAcsRequest<OpsUpdateChangePlanCompletionResourceResponse> {
	...
	public OpsUpdateChangePlanCompletionResourceRequest() {
		super("Ecsops", "2016-04-01", "OpsUpdateChangePlanCompletionResource", "ecsops");
	...
	@Override
	public Class<OpsUpdateChangePlanCompletionResourceResponse> getResponseClass() {
		return OpsUpdateChangePlanCompletionResourceResponse.class;
	}
