 ...
 * @version 
 */
public class OpsAuthorizeInstanceAclRuleRequest extends RpcAcsRequest<OpsAuthorizeInstanceAclRuleResponse> {
	...
	public OpsAuthorizeInstanceAclRuleRequest() {
		super("Ecsops", "2016-04-01", "OpsAuthorizeInstanceAclRule", "ecsops");
	...
	@Override
	public Class<OpsAuthorizeInstanceAclRuleResponse> getResponseClass() {
		return OpsAuthorizeInstanceAclRuleResponse.class;
	}
