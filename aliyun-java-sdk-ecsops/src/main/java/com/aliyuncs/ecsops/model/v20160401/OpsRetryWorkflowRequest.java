 ...
 * @version 
 */
public class OpsRetryWorkflowRequest extends RpcAcsRequest<OpsRetryWorkflowResponse> {
	...
	@Override
	public Class<OpsRetryWorkflowResponse> getResponseClass() {
		return OpsRetryWorkflowResponse.class;
	}
