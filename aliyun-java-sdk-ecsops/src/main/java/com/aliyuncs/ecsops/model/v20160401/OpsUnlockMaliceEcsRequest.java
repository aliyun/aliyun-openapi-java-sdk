 ...
 * @version 
 */
public class OpsUnlockMaliceEcsRequest extends RpcAcsRequest<OpsUnlockMaliceEcsResponse> {
	...
	public OpsUnlockMaliceEcsRequest() {
		super("Ecsops", "2016-04-01", "OpsUnlockMaliceEcs", "ecsops");
	...
	@Override
	public Class<OpsUnlockMaliceEcsResponse> getResponseClass() {
		return OpsUnlockMaliceEcsResponse.class;
	}
