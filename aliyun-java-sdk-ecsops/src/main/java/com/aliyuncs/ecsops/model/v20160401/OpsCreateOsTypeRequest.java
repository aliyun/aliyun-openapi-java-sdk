 ...
 * @version 
 */
public class OpsCreateOsTypeRequest extends RpcAcsRequest<OpsCreateOsTypeResponse> {
	...
	public OpsCreateOsTypeRequest() {
		super("Ecsops", "2016-04-01", "OpsCreateOsType", "ecsops");
	...
	@Override
	public Class<OpsCreateOsTypeResponse> getResponseClass() {
		return OpsCreateOsTypeResponse.class;
	}
