 ...
 * @version 
 */
public class OpsCorrectBusinessInstanceRequest extends RpcAcsRequest<OpsCorrectBusinessInstanceResponse> {
	...
	public OpsCorrectBusinessInstanceRequest() {
		super("Ecsops", "2016-04-01", "OpsCorrectBusinessInstance", "ecsops");
	...
	@Override
	public Class<OpsCorrectBusinessInstanceResponse> getResponseClass() {
		return OpsCorrectBusinessInstanceResponse.class;
	}
