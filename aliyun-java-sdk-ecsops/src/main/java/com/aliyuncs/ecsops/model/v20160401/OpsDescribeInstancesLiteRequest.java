 ...
 * @version 
 */
public class OpsDescribeInstancesLiteRequest extends RpcAcsRequest<OpsDescribeInstancesLiteResponse> {
	...
	public OpsDescribeInstancesLiteRequest() {
		super("Ecsops", "2016-04-01", "OpsDescribeInstancesLite", "ecsops");
	...
	@Override
	public Class<OpsDescribeInstancesLiteResponse> getResponseClass() {
		return OpsDescribeInstancesLiteResponse.class;
	}
