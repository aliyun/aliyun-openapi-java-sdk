 ...
 * @version 
 */
public class OpsRestartWorkflowRequest extends RpcAcsRequest<OpsRestartWorkflowResponse> {
	   

	private List<String> workflowIdLists;

	private String auditParamStr;
	public OpsRestartWorkflowRequest() {
		super("Ecsops", "2016-04-01", "OpsRestartWorkflow", "ecsops");
	...
	@Override
	public Class<OpsRestartWorkflowResponse> getResponseClass() {
		return OpsRestartWorkflowResponse.class;
	}
