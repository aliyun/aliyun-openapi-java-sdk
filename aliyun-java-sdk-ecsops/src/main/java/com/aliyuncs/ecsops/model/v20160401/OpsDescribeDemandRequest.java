 ...
 * @version 
 */
public class OpsDescribeDemandRequest extends RpcAcsRequest<OpsDescribeDemandResponse> {
	...
	public OpsDescribeDemandRequest() {
		super("Ecsops", "2016-04-01", "OpsDescribeDemand", "ecsops");
	...
	@Override
	public Class<OpsDescribeDemandResponse> getResponseClass() {
		return OpsDescribeDemandResponse.class;
	}
