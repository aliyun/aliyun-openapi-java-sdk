 ...
 * @version 
 */
public class OpsSgModifyZkConfigRequest extends RpcAcsRequest<OpsSgModifyZkConfigResponse> {
	   

	private String remoteConfigJsonStr;

	private String auditParamStr;
	public OpsSgModifyZkConfigRequest() {
		super("Ecsops", "2016-04-01", "OpsSgModifyZkConfig", "ecsops");
	...
	@Override
	public Class<OpsSgModifyZkConfigResponse> getResponseClass() {
		return OpsSgModifyZkConfigResponse.class;
	}
