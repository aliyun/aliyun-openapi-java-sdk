 ...
 * @version 
 */
public class OpsUpdateCloudBoxSkuRequest extends RpcAcsRequest<OpsUpdateCloudBoxSkuResponse> {
	...
	public OpsUpdateCloudBoxSkuRequest() {
		super("Ecsops", "2016-04-01", "OpsUpdateCloudBoxSku", "ecsops");
	...
	@Override
	public Class<OpsUpdateCloudBoxSkuResponse> getResponseClass() {
		return OpsUpdateCloudBoxSkuResponse.class;
	}
