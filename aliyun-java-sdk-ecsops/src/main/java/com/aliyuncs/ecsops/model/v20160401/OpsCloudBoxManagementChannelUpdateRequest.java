 ...
 * @version 
 */
public class OpsCloudBoxManagementChannelUpdateRequest extends RpcAcsRequest<OpsCloudBoxManagementChannelUpdateResponse> {
	...
	public OpsCloudBoxManagementChannelUpdateRequest() {
		super("Ecsops", "2016-04-01", "OpsCloudBoxManagementChannelUpdate", "ecsops");
	...
	@Override
	public Class<OpsCloudBoxManagementChannelUpdateResponse> getResponseClass() {
		return OpsCloudBoxManagementChannelUpdateResponse.class;
	}
