 ...
 * @version 
 */
public class OpsBatchRestartInstanceRequest extends RpcAcsRequest<OpsBatchRestartInstanceResponse> {
	...
	@Override
	public Class<OpsBatchRestartInstanceResponse> getResponseClass() {
		return OpsBatchRestartInstanceResponse.class;
	}
