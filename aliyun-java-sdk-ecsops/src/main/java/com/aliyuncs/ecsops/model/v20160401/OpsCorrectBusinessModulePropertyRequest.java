 ...
 * @version 
 */
public class OpsCorrectBusinessModulePropertyRequest extends RpcAcsRequest<OpsCorrectBusinessModulePropertyResponse> {
	...
	public OpsCorrectBusinessModulePropertyRequest() {
		super("Ecsops", "2016-04-01", "OpsCorrectBusinessModuleProperty", "ecsops");
	...
	@Override
	public Class<OpsCorrectBusinessModulePropertyResponse> getResponseClass() {
		return OpsCorrectBusinessModulePropertyResponse.class;
	}
