 ...
 * @version 
 */
public class OpsAddDiagnosticPluginItemRequest extends RpcAcsRequest<OpsAddDiagnosticPluginItemResponse> {
	...
	@Override
	public Class<OpsAddDiagnosticPluginItemResponse> getResponseClass() {
		return OpsAddDiagnosticPluginItemResponse.class;
	}
