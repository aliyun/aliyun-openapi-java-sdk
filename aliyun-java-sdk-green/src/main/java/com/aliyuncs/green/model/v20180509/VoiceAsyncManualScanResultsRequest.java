 ...
 * @version 
 */
public class VoiceAsyncManualScanResultsRequest extends RoaAcsRequest<VoiceAsyncManualScanResultsResponse> {
	...
	@Override
	public Class<VoiceAsyncManualScanResultsResponse> getResponseClass() {
		return VoiceAsyncManualScanResultsResponse.class;
	}
