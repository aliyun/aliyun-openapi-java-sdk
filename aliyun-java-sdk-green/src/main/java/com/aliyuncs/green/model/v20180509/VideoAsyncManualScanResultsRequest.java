 ...
 * @version 
 */
public class VideoAsyncManualScanResultsRequest extends RoaAcsRequest<VideoAsyncManualScanResultsResponse> {
	...
	@Override
	public Class<VideoAsyncManualScanResultsResponse> getResponseClass() {
		return VideoAsyncManualScanResultsResponse.class;
	}
