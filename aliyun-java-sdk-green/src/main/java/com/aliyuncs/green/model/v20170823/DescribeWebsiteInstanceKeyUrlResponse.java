...
public class DescribeWebsiteInstanceKeyUrlResponse extends AcsResponse {
	...
	public void setWebsiteInstanceKeyUrlList(List<String> websiteInstanceKeyUrlList) {
		this.websiteInstanceKeyUrlList = websiteInstanceKeyUrlList;
	}

	@Override
	public DescribeWebsiteInstanceKeyUrlResponse getInstance(UnmarshallerContext context) {
		return	DescribeWebsiteInstanceKeyUrlResponseUnmarshaller.unmarshall(this, context);
	}
