...
public class TextAsyncManualScanResultsResponse extends AcsResponse {
	...
	@Override
	public TextAsyncManualScanResultsResponse getInstance(UnmarshallerContext context) {
		return	TextAsyncManualScanResultsResponseUnmarshaller.unmarshall(this, context);
	}
}
