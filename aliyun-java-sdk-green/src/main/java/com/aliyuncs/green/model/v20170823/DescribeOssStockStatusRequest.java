...
public class DescribeOssStockStatusRequest extends RpcAcsRequest<DescribeOssStockStatusResponse> {
	...
	public DescribeOssStockStatusRequest() {
		super("Green", "2017-08-23", "DescribeOssStockStatus", "green");
	...
	@Override
	public Class<DescribeOssStockStatusResponse> getResponseClass() {
		return DescribeOssStockStatusResponse.class;
	}
