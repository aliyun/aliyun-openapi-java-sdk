 ...
 * @version 
 */
public class VoiceSyncScanRequest extends RoaAcsRequest<VoiceSyncScanResponse> {
	...
	@Override
	public Class<VoiceSyncScanResponse> getResponseClass() {
		return VoiceSyncScanResponse.class;
	}
