 ...
 * @version 
 */
public class WebpageAsyncScanRequest extends RoaAcsRequest<WebpageAsyncScanResponse> {
	...
	@Override
	public Class<WebpageAsyncScanResponse> getResponseClass() {
		return WebpageAsyncScanResponse.class;
	}
