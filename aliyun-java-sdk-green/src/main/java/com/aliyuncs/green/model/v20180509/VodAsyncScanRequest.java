 ...
 * @version 
 */
public class VodAsyncScanRequest extends RoaAcsRequest<VodAsyncScanResponse> {
	...
	@Override
	public Class<VodAsyncScanResponse> getResponseClass() {
		return VodAsyncScanResponse.class;
	}
