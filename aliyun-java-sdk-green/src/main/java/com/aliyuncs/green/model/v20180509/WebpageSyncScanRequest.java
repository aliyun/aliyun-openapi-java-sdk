 ...
 * @version 
 */
public class WebpageSyncScanRequest extends RoaAcsRequest<WebpageSyncScanResponse> {
	...
	@Override
	public Class<WebpageSyncScanResponse> getResponseClass() {
		return WebpageSyncScanResponse.class;
	}
