 ...
 * @version 
 */
public class TextAsyncManualScanRequest extends RoaAcsRequest<TextAsyncManualScanResponse> {
	...
	@Override
	public Class<TextAsyncManualScanResponse> getResponseClass() {
		return TextAsyncManualScanResponse.class;
	}
