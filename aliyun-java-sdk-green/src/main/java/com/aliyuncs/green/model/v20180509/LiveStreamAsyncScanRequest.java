 ...
 * @version 
 */
public class LiveStreamAsyncScanRequest extends RoaAcsRequest<LiveStreamAsyncScanResponse> {
	...
	@Override
	public Class<LiveStreamAsyncScanResponse> getResponseClass() {
		return LiveStreamAsyncScanResponse.class;
	}
