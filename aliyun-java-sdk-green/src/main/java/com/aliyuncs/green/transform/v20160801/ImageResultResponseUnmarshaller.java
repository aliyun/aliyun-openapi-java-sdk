...
import com.aliyuncs.green.model.v20160801.ImageResultResponse;
import com.aliyuncs.green.model.v20160801.ImageResultResponse.ImageResult;
import com.aliyuncs.green.model.v20160801.ImageResultResponse.ImageResult.ErrorResult;
import com.aliyuncs.green.model.v20160801.ImageResultResponse.ImageResult.IllegalResult;
import com.aliyuncs.green.model.v20160801.ImageResultResponse.ImageResult.OcrResult;
import com.aliyuncs.green.model.v20160801.ImageResultResponse.ImageResult.PornResult;
import com.aliyuncs.green.model.v20160801.ImageResultResponse.ImageResult.QrcodeResult;
import com.aliyuncs.green.model.v20160801.ImageResultResponse.ImageResult.SensitiveFaceResult;
import com.aliyuncs.green.model.v20160801.ImageResultResponse.ImageResult.SensitiveFaceResult.ImageSensitiveFaceHitItem;
import com.aliyuncs.green.model.v20160801.ImageResultResponse.ImageResult.SensitiveFaceResult.ImageSensitiveFaceHitItem.ImageSensitiveFaceSimiInfo;
import com.aliyuncs.green.model.v20160801.ImageResultResponse.ImageResult.SpamResult;
import com.aliyuncs.green.model.v20160801.ImageResultResponse.ImageResult.SpamResult.KeywordResult;
...
public class ImageResultResponseUnmarshaller {
	...
	public static ImageResultResponse unmarshall(ImageResultResponse imageResultResponse, UnmarshallerContext context) {
		...
		for (int i = 0; i < context.lengthValue("ImageResultResponse.ImageResult.SensitiveFaceResult.Items.Length"); i++) {
			ImageSensitiveFaceHitItem imageSensitiveFaceHitItem = new ImageSensitiveFaceHitItem();
			imageSensitiveFaceHitItem.setX(context.floatValue("ImageResultResponse.ImageResult.SensitiveFaceResult.Items["+ i +"].X"));
			imageSensitiveFaceHitItem.setY(context.floatValue("ImageResultResponse.ImageResult.SensitiveFaceResult.Items["+ i +"].Y"));
			imageSensitiveFaceHitItem.setw(context.floatValue("ImageResultResponse.ImageResult.SensitiveFaceResult.Items["+ i +"].w"));
			imageSensitiveFaceHitItem.seth(context.floatValue("ImageResultResponse.ImageResult.SensitiveFaceResult.Items["+ i +"].h"));

			List<ImageSensitiveFaceSimiInfo> simiInfoList = new ArrayList<ImageSensitiveFaceSimiInfo>();
			for (int j = 0; j < context.lengthValue("ImageResultResponse.ImageResult.SensitiveFaceResult.Items["+ i +"].SimiInfoList.Length"); j++) {
				ImageSensitiveFaceSimiInfo imageSensitiveFaceSimiInfo = new ImageSensitiveFaceSimiInfo();
				imageSensitiveFaceSimiInfo.setName(context.stringValue("ImageResultResponse.ImageResult.SensitiveFaceResult.Items["+ i +"].SimiInfoList["+ j +"].Name"));
				imageSensitiveFaceSimiInfo.setScore(context.floatValue("ImageResultResponse.ImageResult.SensitiveFaceResult.Items["+ i +"].SimiInfoList["+ j +"].Score"));
