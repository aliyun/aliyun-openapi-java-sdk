...
import com.aliyuncs.green.model.v20161216.TextAntispamDetectionResponse.TextAntispamResult;
...
public class TextAntispamDetectionResponseUnmarshaller {
	...
	public static TextAntispamDetectionResponse unmarshall(TextAntispamDetectionResponse textAntispamDetectionResponse, UnmarshallerContext context) {
		...
		for (int i = 0; i < context.lengthValue("TextAntispamDetectionResponse.TextAntispamResults.Length"); i++) {
			...
			textAntispamResult.setTaskId(context.stringValue("TextAntispamDetectionResponse.TextAntispamResults["+ i +"].TaskId"));
			textAntispamResult.setLabel(context.stringValue("TextAntispamDetectionResponse.TextAntispamResults["+ i +"].Label"));
			textAntispamResult.setSubLabel(context.stringValue("TextAntispamDetectionResponse.TextAntispamResults["+ i +"].SubLabel"));
