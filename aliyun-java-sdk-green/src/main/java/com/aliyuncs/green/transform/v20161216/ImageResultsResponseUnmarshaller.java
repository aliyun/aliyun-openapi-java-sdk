...
import com.aliyuncs.green.model.v20161216.ImageResultsResponse;
import com.aliyuncs.green.model.v20161216.ImageResultsResponse.ImageDetectResult;
import com.aliyuncs.green.model.v20161216.ImageResultsResponse.ImageDetectResult.ImageResult;
import com.aliyuncs.green.model.v20161216.ImageResultsResponse.ImageDetectResult.ImageResult.AdResult;
import com.aliyuncs.green.model.v20161216.ImageResultsResponse.ImageDetectResult.ImageResult.ErrorResult;
import com.aliyuncs.green.model.v20161216.ImageResultsResponse.ImageDetectResult.ImageResult.IllegalResult;
import com.aliyuncs.green.model.v20161216.ImageResultsResponse.ImageDetectResult.ImageResult.OcrResult;
import com.aliyuncs.green.model.v20161216.ImageResultsResponse.ImageDetectResult.ImageResult.PornResult;
import com.aliyuncs.green.model.v20161216.ImageResultsResponse.ImageDetectResult.ImageResult.QrcodeResult;
import com.aliyuncs.green.model.v20161216.ImageResultsResponse.ImageDetectResult.ImageResult.SensitiveFaceResult;
import com.aliyuncs.green.model.v20161216.ImageResultsResponse.ImageDetectResult.ImageResult.SensitiveFaceResult.ImageSensitiveFaceHitItem;
import com.aliyuncs.green.model.v20161216.ImageResultsResponse.ImageDetectResult.ImageResult.SensitiveFaceResult.ImageSensitiveFaceHitItem.ImageSensitiveFaceSimiInfo;
import com.aliyuncs.green.model.v20161216.ImageResultsResponse.ImageDetectResult.ImageResult.SpamResult;
import com.aliyuncs.green.model.v20161216.ImageResultsResponse.ImageDetectResult.ImageResult.SpamResult.KeywordResult;
...
public class ImageResultsResponseUnmarshaller {
	...
	public static ImageResultsResponse unmarshall(ImageResultsResponse imageResultsResponse, UnmarshallerContext context) {
		...
		for (int i = 0; i < context.lengthValue("ImageResultsResponse.ImageDetectResults.Length"); i++) {
			...
			adResult.setRate(context.floatValue("ImageResultsResponse.ImageDetectResults["+ i +"].ImageResult.AdResult.Rate"));
			adResult.setLabel(context.integerValue("ImageResultsResponse.ImageDetectResults["+ i +"].ImageResult.AdResult.Label"));
			adResult.setRiskType(context.integerValue("ImageResultsResponse.ImageDetectResults["+ i +"].ImageResult.AdResult.RiskType"));

			List<String> riskDetails = new ArrayList<String>();
			for (int j = 0; j < context.lengthValue("ImageResultsResponse.ImageDetectResults["+ i +"].ImageResult.AdResult.RiskDetails.Length"); j++) {
				riskDetails.add(context.stringValue("ImageResultsResponse.ImageDetectResults["+ i +"].ImageResult.AdResult.RiskDetails["+ j +"]"));
			}
			...
			for (int j = 0; j < context.lengthValue("ImageResultsResponse.ImageDetectResults["+ i +"].ImageResult.SensitiveFaceResult.Items.Length"); j++) {
				ImageSensitiveFaceHitItem imageSensitiveFaceHitItem = new ImageSensitiveFaceHitItem();
				imageSensitiveFaceHitItem.setX(context.floatValue("ImageResultsResponse.ImageDetectResults["+ i +"].ImageResult.SensitiveFaceResult.Items["+ j +"].X"));
				imageSensitiveFaceHitItem.setY(context.floatValue("ImageResultsResponse.ImageDetectResults["+ i +"].ImageResult.SensitiveFaceResult.Items["+ j +"].Y"));
				imageSensitiveFaceHitItem.setW(context.floatValue("ImageResultsResponse.ImageDetectResults["+ i +"].ImageResult.SensitiveFaceResult.Items["+ j +"].W"));
				imageSensitiveFaceHitItem.setH(context.floatValue("ImageResultsResponse.ImageDetectResults["+ i +"].ImageResult.SensitiveFaceResult.Items["+ j +"].H"));

				List<ImageSensitiveFaceSimiInfo> simiInfoList = new ArrayList<ImageSensitiveFaceSimiInfo>();
				for (int k = 0; k < context.lengthValue("ImageResultsResponse.ImageDetectResults["+ i +"].ImageResult.SensitiveFaceResult.Items["+ j +"].SimiInfoList.Length"); k++) {
					ImageSensitiveFaceSimiInfo imageSensitiveFaceSimiInfo = new ImageSensitiveFaceSimiInfo();
					imageSensitiveFaceSimiInfo.setName(context.stringValue("ImageResultsResponse.ImageDetectResults["+ i +"].ImageResult.SensitiveFaceResult.Items["+ j +"].SimiInfoList["+ k +"].Name"));
					imageSensitiveFaceSimiInfo.setScore(context.floatValue("ImageResultsResponse.ImageDetectResults["+ i +"].ImageResult.SensitiveFaceResult.Items["+ j +"].SimiInfoList["+ k +"].Score"));
