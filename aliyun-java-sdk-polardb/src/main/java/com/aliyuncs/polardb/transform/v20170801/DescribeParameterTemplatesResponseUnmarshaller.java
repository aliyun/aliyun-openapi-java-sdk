...
import com.aliyuncs.polardb.model.v20170801.DescribeParameterTemplatesResponse.TemplateRecord;
...
public class DescribeParameterTemplatesResponseUnmarshaller {
	...
	public static DescribeParameterTemplatesResponse unmarshall(DescribeParameterTemplatesResponse describeParameterTemplatesResponse, UnmarshallerContext context) {
		...
		describeParameterTemplatesResponse.setDBType(context.stringValue("DescribeParameterTemplatesResponse.DBType"));
		describeParameterTemplatesResponse.setDBVersion(context.stringValue("DescribeParameterTemplatesResponse.DBVersion"));
