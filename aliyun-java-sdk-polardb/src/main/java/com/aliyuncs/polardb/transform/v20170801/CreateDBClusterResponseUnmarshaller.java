...
public class CreateDBClusterResponseUnmarshaller {
	...
	public static CreateDBClusterResponse unmarshall(CreateDBClusterResponse createDBClusterResponse, UnmarshallerContext context) {
		...
		createDBClusterResponse.setConnectionString(context.stringValue("CreateDBClusterResponse.ConnectionString"));
		createDBClusterResponse.setPort(context.stringValue("CreateDBClusterResponse.Port"));
