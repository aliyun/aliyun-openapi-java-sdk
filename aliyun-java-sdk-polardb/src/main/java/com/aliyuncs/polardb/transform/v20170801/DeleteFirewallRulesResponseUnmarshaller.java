...
import com.aliyuncs.polardb.model.v20170801.DeleteFirewallRulesResponse;
...
public class DeleteFirewallRulesResponseUnmarshaller {
	...
	public static DeleteFirewallRulesResponse unmarshall(DeleteFirewallRulesResponse deleteFirewallRulesResponse, UnmarshallerContext _ctx) {
		...
		deleteFirewallRulesResponse.setMessage(_ctx.stringValue("DeleteFirewallRulesResponse.Message"));
		deleteFirewallRulesResponse.setSuccess(_ctx.booleanValue("DeleteFirewallRulesResponse.Success"));
