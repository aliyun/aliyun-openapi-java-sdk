...
import com.aliyuncs.polardb.model.v20170801.ModifyFirewallRulesResponse;
...
public class ModifyFirewallRulesResponseUnmarshaller {
	...
	public static ModifyFirewallRulesResponse unmarshall(ModifyFirewallRulesResponse modifyFirewallRulesResponse, UnmarshallerContext _ctx) {
		...
		modifyFirewallRulesResponse.setMessage(_ctx.stringValue("ModifyFirewallRulesResponse.Message"));
		modifyFirewallRulesResponse.setSuccess(_ctx.booleanValue("ModifyFirewallRulesResponse.Success"));
