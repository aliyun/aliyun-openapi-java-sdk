...
public class Endpoint {
    public static HashMap<String, String> endpointMap = new HashMap<String, String>() {
        {
            put("cn-shanghai-internal-test-1", "polardb.aliyuncs.com");
            put("cn-beijing-gov-1", "polardb.aliyuncs.com");
            put("cn-shenzhen-su18-b01", "polardb.aliyuncs.com");
            put("cn-beijing", "polardb.aliyuncs.com");
            put("cn-wulanchabu", "polardb.aliyuncs.com");
            put("cn-shanghai-inner", "polardb.aliyuncs.com");
            ...
            put("cn-hangzhou-bj-b01", "polardb.aliyuncs.com");
            put("cn-hangzhou-internal-test-1", "polardb.aliyuncs.com");
            put("eu-west-1-oxs", "polardb.aliyuncs.com");
            ...
            put("cn-zhangjiakou-na62-a01", "polardb.aliyuncs.com");
