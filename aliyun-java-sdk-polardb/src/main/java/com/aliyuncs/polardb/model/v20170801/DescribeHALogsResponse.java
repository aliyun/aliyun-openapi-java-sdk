...
import com.aliyuncs.polardb.transform.v20170801.DescribeHALogsResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeHALogsResponse extends AcsResponse {
	...
	@Override
	public DescribeHALogsResponse getInstance(UnmarshallerContext context) {
		return	DescribeHALogsResponseUnmarshaller.unmarshall(this, context);
	}
