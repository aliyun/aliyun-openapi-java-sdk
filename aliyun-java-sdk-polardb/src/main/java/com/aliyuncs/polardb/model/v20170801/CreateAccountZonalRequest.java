 ...
 * @version 
 */
public class CreateAccountZonalRequest extends RpcAcsRequest<CreateAccountZonalResponse> {
	...
	public CreateAccountZonalRequest() {
		super("polardb", "2017-08-01", "CreateAccountZonal", "polardb");
	...
	@Override
	public Class<CreateAccountZonalResponse> getResponseClass() {
		return CreateAccountZonalResponse.class;
	}
