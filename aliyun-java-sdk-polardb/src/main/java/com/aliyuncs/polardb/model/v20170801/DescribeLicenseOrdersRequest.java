 ...
 * @version 
 */
public class DescribeLicenseOrdersRequest extends RpcAcsRequest<DescribeLicenseOrdersResponse> {
	...
	public DescribeLicenseOrdersRequest() {
		super("polardb", "2017-08-01", "DescribeLicenseOrders", "polardb");
	...
	public void setVirtualOrder(Boolean virtualOrder) {
		...
		if(virtualOrder != null){
			putQueryParameter("VirtualOrder", virtualOrder.toString());
		}
	}
	...
	public void setPurchaseChannel(String purchaseChannel) {
		...
		if(purchaseChannel != null){
			putQueryParameter("PurchaseChannel", purchaseChannel);
		}
	}
	...
	@Override
	public Class<DescribeLicenseOrdersResponse> getResponseClass() {
		return DescribeLicenseOrdersResponse.class;
	}
