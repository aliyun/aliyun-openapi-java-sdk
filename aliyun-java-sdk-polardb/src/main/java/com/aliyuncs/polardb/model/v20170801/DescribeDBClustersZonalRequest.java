 ...
 * @version 
 */
public class DescribeDBClustersZonalRequest extends RpcAcsRequest<DescribeDBClustersZonalResponse> {
	...
	public DescribeDBClustersZonalRequest() {
		super("polardb", "2017-08-01", "DescribeDBClustersZonal", "polardb");
	...
	@Override
	public Class<DescribeDBClustersZonalResponse> getResponseClass() {
		return DescribeDBClustersZonalResponse.class;
	}
