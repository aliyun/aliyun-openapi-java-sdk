 ...
 * @version 
 */
public class CreateNetworkChannelRequest extends RpcAcsRequest<CreateNetworkChannelResponse> {
	...
	public CreateNetworkChannelRequest() {
		super("polardb", "2017-08-01", "CreateNetworkChannel", "polardb");
	...
	@Override
	public Class<CreateNetworkChannelResponse> getResponseClass() {
		return CreateNetworkChannelResponse.class;
	}
