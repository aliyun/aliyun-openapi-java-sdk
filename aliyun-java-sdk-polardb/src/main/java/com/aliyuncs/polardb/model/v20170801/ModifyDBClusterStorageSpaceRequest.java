 ...
 * @version 
 */
public class ModifyDBClusterStorageSpaceRequest extends RpcAcsRequest<ModifyDBClusterStorageSpaceResponse> {
	...
	public ModifyDBClusterStorageSpaceRequest() {
		super("polardb", "2017-08-01", "ModifyDBClusterStorageSpace", "polardb");
	...
	@Override
	public Class<ModifyDBClusterStorageSpaceResponse> getResponseClass() {
		return ModifyDBClusterStorageSpaceResponse.class;
	}
