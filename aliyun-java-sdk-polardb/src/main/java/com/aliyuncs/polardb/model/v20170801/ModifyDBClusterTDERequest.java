 ...
 * @version 
 */
public class ModifyDBClusterTDERequest extends RpcAcsRequest<ModifyDBClusterTDEResponse> {
	...
	@Override
	public Class<ModifyDBClusterTDEResponse> getResponseClass() {
		return ModifyDBClusterTDEResponse.class;
	}
