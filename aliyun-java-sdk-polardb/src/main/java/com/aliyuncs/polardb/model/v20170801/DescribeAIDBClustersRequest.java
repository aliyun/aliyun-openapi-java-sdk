 ...
 * @version 
 */
public class DescribeAIDBClustersRequest extends RpcAcsRequest<DescribeAIDBClustersResponse> {
	...
	public DescribeAIDBClustersRequest() {
		super("polardb", "2017-08-01", "DescribeAIDBClusters", "polardb");
	...
	public void setAiNodeType(String aiNodeType) {
		...
		if(aiNodeType != null){
			putQueryParameter("AiNodeType", aiNodeType);
		}
	}
	...
	@Override
	public Class<DescribeAIDBClustersResponse> getResponseClass() {
		return DescribeAIDBClustersResponse.class;
	}
