...
import com.aliyuncs.polardb.transform.v20170801.CreateOrGetVirtualLicenseOrderResponseUnmarshaller;
 ...
 * @version 
 */
public class CreateOrGetVirtualLicenseOrderResponse extends AcsResponse {
	...
	@Override
	public CreateOrGetVirtualLicenseOrderResponse getInstance(UnmarshallerContext context) {
		return	CreateOrGetVirtualLicenseOrderResponseUnmarshaller.unmarshall(this, context);
	}
