...
public class DescribeDBClusterAuditLogCollectorResponse extends AcsResponse {
	...
	@Override
	public DescribeDBClusterAuditLogCollectorResponse getInstance(UnmarshallerContext context) {
		return	DescribeDBClusterAuditLogCollectorResponseUnmarshaller.unmarshall(this, context);
	}
}
