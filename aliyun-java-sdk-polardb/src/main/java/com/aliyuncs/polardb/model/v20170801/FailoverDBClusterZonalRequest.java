 ...
 * @version 
 */
public class FailoverDBClusterZonalRequest extends RpcAcsRequest<FailoverDBClusterZonalResponse> {
	...
	public FailoverDBClusterZonalRequest() {
		super("polardb", "2017-08-01", "FailoverDBClusterZonal", "polardb");
	...
	@Override
	public Class<FailoverDBClusterZonalResponse> getResponseClass() {
		return FailoverDBClusterZonalResponse.class;
	}
