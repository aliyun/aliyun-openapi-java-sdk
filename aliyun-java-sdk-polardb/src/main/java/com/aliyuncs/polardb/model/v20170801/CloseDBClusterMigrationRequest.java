 ...
 * @version 
 */
public class CloseDBClusterMigrationRequest extends RpcAcsRequest<CloseDBClusterMigrationResponse> {
	...
	@Override
	public Class<CloseDBClusterMigrationResponse> getResponseClass() {
		return CloseDBClusterMigrationResponse.class;
	}
