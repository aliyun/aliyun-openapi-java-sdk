 ...
 * @version 
 */
public class DescribeCrossCloudRegionRequest extends RpcAcsRequest<DescribeCrossCloudRegionResponse> {
	...
	public DescribeCrossCloudRegionRequest() {
		super("polardb", "2017-08-01", "DescribeCrossCloudRegion", "polardb");
	...
	@Override
	public Class<DescribeCrossCloudRegionResponse> getResponseClass() {
		return DescribeCrossCloudRegionResponse.class;
	}
