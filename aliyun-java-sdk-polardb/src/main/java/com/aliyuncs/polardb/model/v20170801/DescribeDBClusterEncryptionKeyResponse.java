...
import com.aliyuncs.polardb.transform.v20170801.DescribeDBClusterEncryptionKeyResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeDBClusterEncryptionKeyResponse extends AcsResponse {
	...
	@Override
	public DescribeDBClusterEncryptionKeyResponse getInstance(UnmarshallerContext context) {
		return	DescribeDBClusterEncryptionKeyResponseUnmarshaller.unmarshall(this, context);
	}
