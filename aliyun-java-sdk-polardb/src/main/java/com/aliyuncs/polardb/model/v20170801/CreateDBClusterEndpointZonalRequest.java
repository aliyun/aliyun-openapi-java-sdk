 ...
 * @version 
 */
public class CreateDBClusterEndpointZonalRequest extends RpcAcsRequest<CreateDBClusterEndpointZonalResponse> {
	...
	public CreateDBClusterEndpointZonalRequest() {
		super("polardb", "2017-08-01", "CreateDBClusterEndpointZonal", "polardb");
	...
	@Override
	public Class<CreateDBClusterEndpointZonalResponse> getResponseClass() {
		return CreateDBClusterEndpointZonalResponse.class;
	}
