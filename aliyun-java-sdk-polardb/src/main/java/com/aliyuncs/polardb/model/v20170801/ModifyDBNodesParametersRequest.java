 ...
 * @version 
 */
public class ModifyDBNodesParametersRequest extends RpcAcsRequest<ModifyDBNodesParametersResponse> {
	...
	@Override
	public Class<ModifyDBNodesParametersResponse> getResponseClass() {
		return ModifyDBNodesParametersResponse.class;
	}
