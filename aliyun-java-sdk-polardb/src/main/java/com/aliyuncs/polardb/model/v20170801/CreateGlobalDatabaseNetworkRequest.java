 ...
 * @version 
 */
public class CreateGlobalDatabaseNetworkRequest extends RpcAcsRequest<CreateGlobalDatabaseNetworkResponse> {
	...
	@Override
	public Class<CreateGlobalDatabaseNetworkResponse> getResponseClass() {
		return CreateGlobalDatabaseNetworkResponse.class;
	}
