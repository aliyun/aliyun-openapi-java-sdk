 ...
 * @version 
 */
public class ModifyCronJobPolicyServerlessRequest extends RpcAcsRequest<ModifyCronJobPolicyServerlessResponse> {
	...
	public ModifyCronJobPolicyServerlessRequest() {
		super("polardb", "2017-08-01", "ModifyCronJobPolicyServerless", "polardb");
	...
	@Override
	public Class<ModifyCronJobPolicyServerlessResponse> getResponseClass() {
		return ModifyCronJobPolicyServerlessResponse.class;
	}
