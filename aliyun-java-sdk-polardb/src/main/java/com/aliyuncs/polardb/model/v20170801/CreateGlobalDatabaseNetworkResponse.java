...
public class CreateGlobalDatabaseNetworkResponse extends AcsResponse {
	...
	@Override
	public CreateGlobalDatabaseNetworkResponse getInstance(UnmarshallerContext context) {
		return	CreateGlobalDatabaseNetworkResponseUnmarshaller.unmarshall(this, context);
	}
