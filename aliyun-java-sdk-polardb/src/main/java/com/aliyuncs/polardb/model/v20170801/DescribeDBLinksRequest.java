 ...
 * @version 
 */
public class DescribeDBLinksRequest extends RpcAcsRequest<DescribeDBLinksResponse> {
	...
	@Override
	public Class<DescribeDBLinksResponse> getResponseClass() {
		return DescribeDBLinksResponse.class;
	}
