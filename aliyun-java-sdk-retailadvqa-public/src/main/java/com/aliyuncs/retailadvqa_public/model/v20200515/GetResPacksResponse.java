...
import com.aliyuncs.retailadvqa_public.transform.v20200515.GetResPacksResponseUnmarshaller;
 ...
 * @version 
 */
public class GetResPacksResponse extends AcsResponse {
	...
	@Override
	public GetResPacksResponse getInstance(UnmarshallerContext context) {
		return	GetResPacksResponseUnmarshaller.unmarshall(this, context);
	}
