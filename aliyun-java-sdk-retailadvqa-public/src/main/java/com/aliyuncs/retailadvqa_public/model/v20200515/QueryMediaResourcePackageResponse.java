...
import com.aliyuncs.retailadvqa_public.transform.v20200515.QueryMediaResourcePackageResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryMediaResourcePackageResponse extends AcsResponse {
	...
	@Override
	public QueryMediaResourcePackageResponse getInstance(UnmarshallerContext context) {
		return	QueryMediaResourcePackageResponseUnmarshaller.unmarshall(this, context);
	}
}
