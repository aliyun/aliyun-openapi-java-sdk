...
public class DetailDigitalTemplateResponse extends AcsResponse {
	...
	public static class Data {
		...
		public void setDigitalSmsMaterialModels(List<DigitalSmsMaterialModelsItem> digitalSmsMaterialModels) {
	...
	@Override
	public DetailDigitalTemplateResponse getInstance(UnmarshallerContext context) {
		return	DetailDigitalTemplateResponseUnmarshaller.unmarshall(this, context);
	}
