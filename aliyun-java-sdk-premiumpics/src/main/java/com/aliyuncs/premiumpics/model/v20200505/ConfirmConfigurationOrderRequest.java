 ...
 * @version 
 */
public class ConfirmConfigurationOrderRequest extends RpcAcsRequest<ConfirmConfigurationOrderResponse> {
	...
	public ConfirmConfigurationOrderRequest() {
		super("Premiumpics", "2020-05-05", "ConfirmConfigurationOrder");
	...
	public void setConfigurationId(Long configurationId) {
		...
		if(configurationId != null){
			putQueryParameter("ConfigurationId", configurationId.toString());
		}
	}
	...
	@Override
	public Class<ConfirmConfigurationOrderResponse> getResponseClass() {
		return ConfirmConfigurationOrderResponse.class;
	}
