 ...
 * @version 
 */
public class QueryConfigurationOrderRequest extends RpcAcsRequest<QueryConfigurationOrderResponse> {
	...
	public QueryConfigurationOrderRequest() {
		super("Premiumpics", "2020-05-05", "QueryConfigurationOrder");
	...
	@Override
	public Class<QueryConfigurationOrderResponse> getResponseClass() {
		return QueryConfigurationOrderResponse.class;
	}
