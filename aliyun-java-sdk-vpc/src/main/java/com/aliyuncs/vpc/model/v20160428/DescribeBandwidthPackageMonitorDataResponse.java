...
import com.aliyuncs.vpc.transform.v20160428.DescribeBandwidthPackageMonitorDataResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeBandwidthPackageMonitorDataResponse extends AcsResponse {
	...
	@Override
	public DescribeBandwidthPackageMonitorDataResponse getInstance(UnmarshallerContext context) {
		return	DescribeBandwidthPackageMonitorDataResponseUnmarshaller.unmarshall(this, context);
	}
}
