 ...
 * @version 
 */
public class DescribeVpcGrantRulesToEcrRequest extends RpcAcsRequest<DescribeVpcGrantRulesToEcrResponse> {
	...
	public DescribeVpcGrantRulesToEcrRequest() {
		super("Vpc", "2016-04-28", "DescribeVpcGrantRulesToEcr", "vpc");
	...
	public void setEcrInstanceId(String ecrInstanceId) {
		...
		if(ecrInstanceId != null){
			putQueryParameter("EcrInstanceId", ecrInstanceId);
		}
	}
	...
	@Override
	public Class<DescribeVpcGrantRulesToEcrResponse> getResponseClass() {
		return DescribeVpcGrantRulesToEcrResponse.class;
	}
