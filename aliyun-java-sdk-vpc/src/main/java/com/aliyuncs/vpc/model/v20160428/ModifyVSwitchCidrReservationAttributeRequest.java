 ...
 * @version 
 */
public class ModifyVSwitchCidrReservationAttributeRequest extends RpcAcsRequest<ModifyVSwitchCidrReservationAttributeResponse> {
	...
	public ModifyVSwitchCidrReservationAttributeRequest() {
		super("Vpc", "2016-04-28", "ModifyVSwitchCidrReservationAttribute", "vpc");
	...
	public void setVSwitchCidrReservationId(String vSwitchCidrReservationId) {
		...
		if(vSwitchCidrReservationId != null){
			putQueryParameter("VSwitchCidrReservationId", vSwitchCidrReservationId);
		}
	}

	@Override
	public Class<ModifyVSwitchCidrReservationAttributeResponse> getResponseClass() {
		return ModifyVSwitchCidrReservationAttributeResponse.class;
	}
