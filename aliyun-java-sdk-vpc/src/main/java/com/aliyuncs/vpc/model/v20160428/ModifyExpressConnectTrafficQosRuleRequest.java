 ...
 * @version 
 */
public class ModifyExpressConnectTrafficQosRuleRequest extends RpcAcsRequest<ModifyExpressConnectTrafficQosRuleResponse> {
	...
	public ModifyExpressConnectTrafficQosRuleRequest() {
		super("Vpc", "2016-04-28", "ModifyExpressConnectTrafficQosRule", "vpc");
	...
	@Override
	public Class<ModifyExpressConnectTrafficQosRuleResponse> getResponseClass() {
		return ModifyExpressConnectTrafficQosRuleResponse.class;
	}
