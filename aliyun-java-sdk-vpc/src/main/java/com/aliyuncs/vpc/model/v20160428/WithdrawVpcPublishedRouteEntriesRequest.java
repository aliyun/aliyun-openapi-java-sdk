 ...
 * @version 
 */
public class WithdrawVpcPublishedRouteEntriesRequest extends RpcAcsRequest<WithdrawVpcPublishedRouteEntriesResponse> {
	...
	public WithdrawVpcPublishedRouteEntriesRequest() {
		super("Vpc", "2016-04-28", "WithdrawVpcPublishedRouteEntries", "vpc");
	...
	public void setRouteEntriess(List<RouteEntries> routeEntriess) {
		...
		if (routeEntriess != null) {
			for (int depth1 = 0; depth1 < routeEntriess.size(); depth1++) {
				...
				putQueryParameter("RouteEntries." + (depth1 + 1) + ".DestinationCidrBlock" , routeEntriess.get(depth1).getDestinationCidrBlock());
			}
		}	
	}
	...
	@Override
	public Class<WithdrawVpcPublishedRouteEntriesResponse> getResponseClass() {
		return WithdrawVpcPublishedRouteEntriesResponse.class;
	}
