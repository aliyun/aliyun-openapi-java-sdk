 ...
 * @version 
 */
public class ModifyNetworkAclAttributesRequest extends RpcAcsRequest<ModifyNetworkAclAttributesResponse> {
	...
	@Override
	public Class<ModifyNetworkAclAttributesResponse> getResponseClass() {
		return ModifyNetworkAclAttributesResponse.class;
	}
