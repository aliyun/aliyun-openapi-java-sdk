 ...
 * @version 
 */
public class ModifyExpressConnectTrafficQosQueueRequest extends RpcAcsRequest<ModifyExpressConnectTrafficQosQueueResponse> {
	...
	public ModifyExpressConnectTrafficQosQueueRequest() {
		super("Vpc", "2016-04-28", "ModifyExpressConnectTrafficQosQueue", "vpc");
	...
	@Override
	public Class<ModifyExpressConnectTrafficQosQueueResponse> getResponseClass() {
		return ModifyExpressConnectTrafficQosQueueResponse.class;
	}
