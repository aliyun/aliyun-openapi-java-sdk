 ...
 * @version 
 */
public class CreatePhysicalConnectionOccupancyOrderRequest extends RpcAcsRequest<CreatePhysicalConnectionOccupancyOrderResponse> {
	...
	@Override
	public Class<CreatePhysicalConnectionOccupancyOrderResponse> getResponseClass() {
		return CreatePhysicalConnectionOccupancyOrderResponse.class;
	}
