 ...
 * @version 
 */
public class DescribeCommonBandwidthPackagesRequest extends RpcAcsRequest<DescribeCommonBandwidthPackagesResponse> {
	...
	@Override
	public Class<DescribeCommonBandwidthPackagesResponse> getResponseClass() {
		return DescribeCommonBandwidthPackagesResponse.class;
	}
