 ...
 * @version 
 */
public class SecondApplyPhysicalConnectionLOARequest extends RpcAcsRequest<SecondApplyPhysicalConnectionLOAResponse> {
	...
	public SecondApplyPhysicalConnectionLOARequest() {
		super("Vpc", "2016-04-28", "SecondApplyPhysicalConnectionLOA", "vpc");
	...
	@Override
	public Class<SecondApplyPhysicalConnectionLOAResponse> getResponseClass() {
		return SecondApplyPhysicalConnectionLOAResponse.class;
	}
