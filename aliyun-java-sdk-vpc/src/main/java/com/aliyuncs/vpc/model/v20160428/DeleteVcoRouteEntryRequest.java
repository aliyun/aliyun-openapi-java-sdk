 ...
 * @version 
 */
public class DeleteVcoRouteEntryRequest extends RpcAcsRequest<DeleteVcoRouteEntryResponse> {
	...
	public DeleteVcoRouteEntryRequest() {
		super("Vpc", "2016-04-28", "DeleteVcoRouteEntry", "vpc");
	...
	@Override
	public Class<DeleteVcoRouteEntryResponse> getResponseClass() {
		return DeleteVcoRouteEntryResponse.class;
	}
