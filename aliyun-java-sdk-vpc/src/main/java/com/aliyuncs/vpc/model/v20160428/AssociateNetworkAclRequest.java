 ...
 * @version 
 */
public class AssociateNetworkAclRequest extends RpcAcsRequest<AssociateNetworkAclResponse> {
	...
	@Override
	public Class<AssociateNetworkAclResponse> getResponseClass() {
		return AssociateNetworkAclResponse.class;
	}
