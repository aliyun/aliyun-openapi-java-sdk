 ...
 * @version 
 */
public class ModifyNatIpAttributeRequest extends RpcAcsRequest<ModifyNatIpAttributeResponse> {
	...
	public ModifyNatIpAttributeRequest() {
		super("Vpc", "2016-04-28", "ModifyNatIpAttribute", "vpc");
	...
	public void setNatIpDescription(String natIpDescription) {
		...
		if(natIpDescription != null){
			putQueryParameter("NatIpDescription", natIpDescription);
		}
	}
	...
	public void setNatIpId(String natIpId) {
		...
		if(natIpId != null){
			putQueryParameter("NatIpId", natIpId);
		}
	}
	...
	@Override
	public Class<ModifyNatIpAttributeResponse> getResponseClass() {
		return ModifyNatIpAttributeResponse.class;
	}
