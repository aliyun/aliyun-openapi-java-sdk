 ...
 * @version 
 */
public class RemoveGlobalAccelerationInstanceIpRequest extends RpcAcsRequest<RemoveGlobalAccelerationInstanceIpResponse> {
	...
	@Override
	public Class<RemoveGlobalAccelerationInstanceIpResponse> getResponseClass() {
		return RemoveGlobalAccelerationInstanceIpResponse.class;
	}
