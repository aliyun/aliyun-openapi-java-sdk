 ...
 * @version 
 */
public class GetRouteTargetGroupRequest extends RpcAcsRequest<GetRouteTargetGroupResponse> {
	...
	public GetRouteTargetGroupRequest() {
		super("Vpc", "2016-04-28", "GetRouteTargetGroup", "vpc");
	...
	@Override
	public Class<GetRouteTargetGroupResponse> getResponseClass() {
		return GetRouteTargetGroupResponse.class;
	}
