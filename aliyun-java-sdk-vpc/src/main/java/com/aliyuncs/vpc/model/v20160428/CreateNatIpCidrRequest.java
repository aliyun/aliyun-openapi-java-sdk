 ...
 * @version 
 */
public class CreateNatIpCidrRequest extends RpcAcsRequest<CreateNatIpCidrResponse> {
	...
	public CreateNatIpCidrRequest() {
		super("Vpc", "2016-04-28", "CreateNatIpCidr", "vpc");
	...
	@Override
	public Class<CreateNatIpCidrResponse> getResponseClass() {
		return CreateNatIpCidrResponse.class;
	}
