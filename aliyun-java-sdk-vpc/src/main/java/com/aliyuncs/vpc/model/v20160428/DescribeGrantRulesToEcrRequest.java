 ...
 * @version 
 */
public class DescribeGrantRulesToEcrRequest extends RpcAcsRequest<DescribeGrantRulesToEcrResponse> {
	...
	@Override
	public Class<DescribeGrantRulesToEcrResponse> getResponseClass() {
		return DescribeGrantRulesToEcrResponse.class;
	}
