 ...
 * @version 
 */
public class AddBgpNetworkRequest extends RpcAcsRequest<AddBgpNetworkResponse> {
	...
	@Override
	public Class<AddBgpNetworkResponse> getResponseClass() {
		return AddBgpNetworkResponse.class;
	}
