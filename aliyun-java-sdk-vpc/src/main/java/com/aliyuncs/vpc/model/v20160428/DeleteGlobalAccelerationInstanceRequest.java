 ...
 * @version 
 */
public class DeleteGlobalAccelerationInstanceRequest extends RpcAcsRequest<DeleteGlobalAccelerationInstanceResponse> {
	...
	@Override
	public Class<DeleteGlobalAccelerationInstanceResponse> getResponseClass() {
		return DeleteGlobalAccelerationInstanceResponse.class;
	}
