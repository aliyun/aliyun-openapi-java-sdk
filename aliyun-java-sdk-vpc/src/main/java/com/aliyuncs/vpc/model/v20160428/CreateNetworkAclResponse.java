...
import com.aliyuncs.vpc.transform.v20160428.CreateNetworkAclResponseUnmarshaller;
 ...
 * @version 
 */
public class CreateNetworkAclResponse extends AcsResponse {
	...
	@Override
	public CreateNetworkAclResponse getInstance(UnmarshallerContext context) {
		return	CreateNetworkAclResponseUnmarshaller.unmarshall(this, context);
	}
}
