 ...
 * @version 
 */
public class DeleteIpv4GatewayRequest extends RpcAcsRequest<DeleteIpv4GatewayResponse> {
	...
	@Override
	public Class<DeleteIpv4GatewayResponse> getResponseClass() {
		return DeleteIpv4GatewayResponse.class;
	}
