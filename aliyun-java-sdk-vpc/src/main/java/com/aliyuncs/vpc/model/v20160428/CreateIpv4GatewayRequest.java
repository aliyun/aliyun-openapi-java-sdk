 ...
 * @version 
 */
public class CreateIpv4GatewayRequest extends RpcAcsRequest<CreateIpv4GatewayResponse> {
	...
	public CreateIpv4GatewayRequest() {
		super("Vpc", "2016-04-28", "CreateIpv4Gateway", "vpc");
	...
	@Override
	public Class<CreateIpv4GatewayResponse> getResponseClass() {
		return CreateIpv4GatewayResponse.class;
	}
