 ...
 * @version 
 */
public class CreateEnhancedVpnGatewayRequest extends RpcAcsRequest<CreateEnhancedVpnGatewayResponse> {
	...
	private String name;
	public CreateEnhancedVpnGatewayRequest() {
		super("Vpc", "2016-04-28", "CreateEnhancedVpnGateway", "vpc");
	...
	@Override
	public Class<CreateEnhancedVpnGatewayResponse> getResponseClass() {
		return CreateEnhancedVpnGatewayResponse.class;
	}
