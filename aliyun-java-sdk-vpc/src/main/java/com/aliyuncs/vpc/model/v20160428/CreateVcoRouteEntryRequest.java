 ...
 * @version 
 */
public class CreateVcoRouteEntryRequest extends RpcAcsRequest<CreateVcoRouteEntryResponse> {
	...
	public CreateVcoRouteEntryRequest() {
		super("Vpc", "2016-04-28", "CreateVcoRouteEntry", "vpc");
	...
	@Override
	public Class<CreateVcoRouteEntryResponse> getResponseClass() {
		return CreateVcoRouteEntryResponse.class;
	}
