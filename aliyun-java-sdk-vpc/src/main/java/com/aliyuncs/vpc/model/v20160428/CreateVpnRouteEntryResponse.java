...
import com.aliyuncs.vpc.transform.v20160428.CreateVpnRouteEntryResponseUnmarshaller;
...
public class CreateVpnRouteEntryResponse extends AcsResponse {
	...
	@Override
	public CreateVpnRouteEntryResponse getInstance(UnmarshallerContext context) {
		return	CreateVpnRouteEntryResponseUnmarshaller.unmarshall(this, context);
	}
}
