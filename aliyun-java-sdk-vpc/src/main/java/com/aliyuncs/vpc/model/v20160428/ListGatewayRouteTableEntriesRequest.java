 ...
 * @version 
 */
public class ListGatewayRouteTableEntriesRequest extends RpcAcsRequest<ListGatewayRouteTableEntriesResponse> {
	...
	public ListGatewayRouteTableEntriesRequest() {
		super("Vpc", "2016-04-28", "ListGatewayRouteTableEntries", "vpc");
	...
	@Override
	public Class<ListGatewayRouteTableEntriesResponse> getResponseClass() {
		return ListGatewayRouteTableEntriesResponse.class;
	}
