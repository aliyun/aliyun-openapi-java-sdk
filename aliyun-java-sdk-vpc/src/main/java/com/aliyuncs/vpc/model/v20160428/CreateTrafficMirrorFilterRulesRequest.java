 ...
 * @version 
 */
public class CreateTrafficMirrorFilterRulesRequest extends RpcAcsRequest<CreateTrafficMirrorFilterRulesResponse> {
	...
	public CreateTrafficMirrorFilterRulesRequest() {
		super("Vpc", "2016-04-28", "CreateTrafficMirrorFilterRules", "vpc");
	...
	@Override
	public Class<CreateTrafficMirrorFilterRulesResponse> getResponseClass() {
		return CreateTrafficMirrorFilterRulesResponse.class;
	}
