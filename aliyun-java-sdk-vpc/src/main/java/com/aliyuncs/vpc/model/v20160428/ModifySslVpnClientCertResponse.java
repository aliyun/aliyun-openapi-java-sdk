...
public class ModifySslVpnClientCertResponse extends AcsResponse {
	...
	@Override
	public ModifySslVpnClientCertResponse getInstance(UnmarshallerContext context) {
		return	ModifySslVpnClientCertResponseUnmarshaller.unmarshall(this, context);
	}
}
