 ...
 * @version 
 */
public class DeleteIpv6EgressOnlyRuleRequest extends RpcAcsRequest<DeleteIpv6EgressOnlyRuleResponse> {
	...
	@Override
	public Class<DeleteIpv6EgressOnlyRuleResponse> getResponseClass() {
		return DeleteIpv6EgressOnlyRuleResponse.class;
	}
