 ...
 * @version 
 */
public class ModifyGlobalAccelerationInstanceSpecRequest extends RpcAcsRequest<ModifyGlobalAccelerationInstanceSpecResponse> {
	...
	@Override
	public Class<ModifyGlobalAccelerationInstanceSpecResponse> getResponseClass() {
		return ModifyGlobalAccelerationInstanceSpecResponse.class;
	}
