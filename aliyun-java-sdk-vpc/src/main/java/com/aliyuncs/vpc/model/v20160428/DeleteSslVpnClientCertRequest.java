 ...
 * @version 
 */
public class DeleteSslVpnClientCertRequest extends RpcAcsRequest<DeleteSslVpnClientCertResponse> {
	...
	@Override
	public Class<DeleteSslVpnClientCertResponse> getResponseClass() {
		return DeleteSslVpnClientCertResponse.class;
	}
