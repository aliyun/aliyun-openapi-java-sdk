 ...
 * @version 
 */
public class CreateVSwitchCidrReservationRequest extends RpcAcsRequest<CreateVSwitchCidrReservationResponse> {
	...
	public CreateVSwitchCidrReservationRequest() {
		super("Vpc", "2016-04-28", "CreateVSwitchCidrReservation", "vpc");
	...
	public void setVSwitchCidrReservationDescription(String vSwitchCidrReservationDescription) {
		...
		if(vSwitchCidrReservationDescription != null){
			putQueryParameter("VSwitchCidrReservationDescription", vSwitchCidrReservationDescription);
		}
	}
	...
	public void setVSwitchCidrReservationName(String vSwitchCidrReservationName) {
		...
		if(vSwitchCidrReservationName != null){
			putQueryParameter("VSwitchCidrReservationName", vSwitchCidrReservationName);
		}
	}
	...
	public void setVSwitchCidrReservationMask(String vSwitchCidrReservationMask) {
		this.vSwitchCidrReservationMask = vSwitchCidrReservationMask;
		if(vSwitchCidrReservationMask != null){
			putQueryParameter("VSwitchCidrReservationMask", vSwitchCidrReservationMask);
		}
	}
	...
	public void setVSwitchCidrReservationCidr(String vSwitchCidrReservationCidr) {
		...
		if(vSwitchCidrReservationCidr != null){
			putQueryParameter("VSwitchCidrReservationCidr", vSwitchCidrReservationCidr);
		}
	}
	...
	@Override
	public Class<CreateVSwitchCidrReservationResponse> getResponseClass() {
		return CreateVSwitchCidrReservationResponse.class;
	}
