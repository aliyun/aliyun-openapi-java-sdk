 ...
 * @version 
 */
public class AssociateEipAddressBatchRequest extends RpcAcsRequest<AssociateEipAddressBatchResponse> {
	...
	public AssociateEipAddressBatchRequest() {
		super("Vpc", "2016-04-28", "AssociateEipAddressBatch", "vpc");
	...
	public void setBindedInstanceType(String bindedInstanceType) {
		this.bindedInstanceType = bindedInstanceType;
		if(bindedInstanceType != null){
			putQueryParameter("BindedInstanceType", bindedInstanceType);
		}
	}
	...
	public void setBindedInstanceId(String bindedInstanceId) {
		...
		if(bindedInstanceId != null){
			putQueryParameter("BindedInstanceId", bindedInstanceId);
		}
	}
	...
	@Override
	public Class<AssociateEipAddressBatchResponse> getResponseClass() {
		return AssociateEipAddressBatchResponse.class;
	}
