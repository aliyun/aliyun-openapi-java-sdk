 ...
 * @version 
 */
public class DeleteSslVpnServerRequest extends RpcAcsRequest<DeleteSslVpnServerResponse> {
	...
	@Override
	public Class<DeleteSslVpnServerResponse> getResponseClass() {
		return DeleteSslVpnServerResponse.class;
	}
