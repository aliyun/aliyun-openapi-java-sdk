 ...
 * @version 
 */
public class ModifyIPv6TranslatorBandwidthRequest extends RpcAcsRequest<ModifyIPv6TranslatorBandwidthResponse> {
	...
	@Override
	public Class<ModifyIPv6TranslatorBandwidthResponse> getResponseClass() {
		return ModifyIPv6TranslatorBandwidthResponse.class;
	}
