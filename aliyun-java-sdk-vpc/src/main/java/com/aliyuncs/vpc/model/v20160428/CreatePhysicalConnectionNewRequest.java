 ...
 * @version 
 */
public class CreatePhysicalConnectionNewRequest extends RpcAcsRequest<CreatePhysicalConnectionNewResponse> {
	
	public CreatePhysicalConnectionNewRequest() {
		super("Vpc", "2016-04-28", "CreatePhysicalConnectionNew", "vpc");
	}
	...
	@Override
	public Class<CreatePhysicalConnectionNewResponse> getResponseClass() {
		return CreatePhysicalConnectionNewResponse.class;
	}
