 ...
 * @version 
 */
public class DeleteFullNatEntryRequest extends RpcAcsRequest<DeleteFullNatEntryResponse> {
	...
	public DeleteFullNatEntryRequest() {
		super("Vpc", "2016-04-28", "DeleteFullNatEntry", "vpc");
	...
	@Override
	public Class<DeleteFullNatEntryResponse> getResponseClass() {
		return DeleteFullNatEntryResponse.class;
	}
