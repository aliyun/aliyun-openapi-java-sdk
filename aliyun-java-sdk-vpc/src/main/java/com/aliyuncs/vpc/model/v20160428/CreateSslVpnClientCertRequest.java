 ...
 * @version 
 */
public class CreateSslVpnClientCertRequest extends RpcAcsRequest<CreateSslVpnClientCertResponse> {
	...
	@Override
	public Class<CreateSslVpnClientCertResponse> getResponseClass() {
		return CreateSslVpnClientCertResponse.class;
	}
