 ...
 * @version 
 */
public class DescribeBgpGroupsRequest extends RpcAcsRequest<DescribeBgpGroupsResponse> {
	...
	@Override
	public Class<DescribeBgpGroupsResponse> getResponseClass() {
		return DescribeBgpGroupsResponse.class;
	}
