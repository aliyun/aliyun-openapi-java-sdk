 ...
 * @version 
 */
public class CreateFullNatEntryRequest extends RpcAcsRequest<CreateFullNatEntryResponse> {
	...
	public CreateFullNatEntryRequest() {
		super("Vpc", "2016-04-28", "CreateFullNatEntry", "vpc");
	...
	@Override
	public Class<CreateFullNatEntryResponse> getResponseClass() {
		return CreateFullNatEntryResponse.class;
	}
