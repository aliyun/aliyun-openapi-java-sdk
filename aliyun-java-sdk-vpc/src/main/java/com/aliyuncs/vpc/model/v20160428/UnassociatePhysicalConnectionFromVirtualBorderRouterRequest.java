 ...
 * @version 
 */
public class UnassociatePhysicalConnectionFromVirtualBorderRouterRequest extends RpcAcsRequest<UnassociatePhysicalConnectionFromVirtualBorderRouterResponse> {
	...
	@Override
	public Class<UnassociatePhysicalConnectionFromVirtualBorderRouterResponse> getResponseClass() {
		return UnassociatePhysicalConnectionFromVirtualBorderRouterResponse.class;
	}
