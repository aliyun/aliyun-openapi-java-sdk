 ...
 * @version 
 */
public class UnassociateGlobalAccelerationInstanceRequest extends RpcAcsRequest<UnassociateGlobalAccelerationInstanceResponse> {
	...
	@Override
	public Class<UnassociateGlobalAccelerationInstanceResponse> getResponseClass() {
		return UnassociateGlobalAccelerationInstanceResponse.class;
	}
