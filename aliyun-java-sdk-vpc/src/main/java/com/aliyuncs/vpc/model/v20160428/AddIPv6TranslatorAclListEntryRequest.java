 ...
 * @version 
 */
public class AddIPv6TranslatorAclListEntryRequest extends RpcAcsRequest<AddIPv6TranslatorAclListEntryResponse> {
	...
	public void setAclEntryIp(String aclEntryIp) {
		...
		if(aclEntryIp != null){
			putQueryParameter("AclEntryIp", aclEntryIp);
		}
	}
	...
	@Override
	public Class<AddIPv6TranslatorAclListEntryResponse> getResponseClass() {
		return AddIPv6TranslatorAclListEntryResponse.class;
	}
