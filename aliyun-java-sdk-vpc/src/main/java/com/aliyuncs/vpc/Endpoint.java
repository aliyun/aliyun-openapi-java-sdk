...
public class Endpoint {
    public static HashMap<String, String> endpointMap = new HashMap<String, String>() {
        {
            put("cn-shanghai-internal-test-1", "vpc-pre.cn-hangzhou.aliyuncs.com");
            ...
            put("cn-shanghai-et15-b01", "vpc-pre.cn-hangzhou.aliyuncs.com");
            put("cn-hangzhou-bj-b01", "vpc.aliyuncs.com");
            put("cn-hangzhou-internal-test-1", "vpc-pre.cn-hangzhou.aliyuncs.com");
            put("eu-west-1-oxs", "vpc-nebula.cn-shenzhen-cloudstone.aliyuncs.com");
            put("cn-zhangbei-na61-b01", "vpc.aliyuncs.com");
            put("cn-hangzhou-internal-test-3", "vpc-pre.cn-hangzhou.aliyuncs.com");
            put("cn-shenzhen-finance-1", "vpc.aliyuncs.com");
            put("cn-hangzhou-internal-test-2", "vpc-inner-pre.cn-hangzhou.aliyuncs.com");
            put("cn-hangzhou-test-306", "vpc-pre.cn-hangzhou.aliyuncs.com");
