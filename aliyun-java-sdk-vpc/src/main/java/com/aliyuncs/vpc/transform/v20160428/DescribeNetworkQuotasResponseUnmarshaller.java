...
public class DescribeNetworkQuotasResponseUnmarshaller {
	...
	public static DescribeNetworkQuotasResponse unmarshall(DescribeNetworkQuotasResponse describeNetworkQuotasResponse, UnmarshallerContext context) {
		...
		describeNetworkQuotasResponse.setProduct(context.stringValue("DescribeNetworkQuotasResponse.Product"));
		describeNetworkQuotasResponse.setRegionId(context.stringValue("DescribeNetworkQuotasResponse.RegionId"));
		describeNetworkQuotasResponse.setQuota(context.stringValue("DescribeNetworkQuotasResponse.Quota"));
