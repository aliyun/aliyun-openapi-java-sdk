...
import com.aliyuncs.vpc.model.v20160428.DescribeBandwidthPackagesResponse.BandwidthPackage;
import com.aliyuncs.vpc.model.v20160428.DescribeBandwidthPackagesResponse.BandwidthPackage.PublicIpAddresse;
	...
	public static DescribeBandwidthPackagesResponse unmarshall(DescribeBandwidthPackagesResponse describeBandwidthPackagesResponse, UnmarshallerContext context) {
		...
		for (int i = 0; i < context.lengthValue("DescribeBandwidthPackagesResponse.BandwidthPackages.Length"); i++) {
			...
			for (int j = 0; j < context.lengthValue("DescribeBandwidthPackagesResponse.BandwidthPackages["+ i +"].PublicIpAddresses.Length"); j++) {
				...
				publicIpAddresse.setUsingStatus(context.stringValue("DescribeBandwidthPackagesResponse.BandwidthPackages["+ i +"].PublicIpAddresses["+ j +"].UsingStatus"));
				publicIpAddresse.setApAccessEnabled(context.booleanValue("DescribeBandwidthPackagesResponse.BandwidthPackages["+ i +"].PublicIpAddresses["+ j +"].ApAccessEnabled"));
