...
public class ModifyScenarioRequest extends RpcAcsRequest<ModifyScenarioResponse> {
	...
	public ModifyScenarioRequest() {
		super("CloudCallCenter", "2017-07-05", "ModifyScenario", "CloudCallCenter", "innerAPI");
	}
	...
	@Override
	public Class<ModifyScenarioResponse> getResponseClass() {
		return ModifyScenarioResponse.class;
	}
