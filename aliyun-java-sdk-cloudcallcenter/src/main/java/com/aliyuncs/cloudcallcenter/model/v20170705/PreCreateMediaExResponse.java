...
import com.aliyuncs.cloudcallcenter.transform.v20170705.PreCreateMediaExResponseUnmarshaller;
 ...
 * @version 
 */
public class PreCreateMediaExResponse extends AcsResponse {
	...
	@Override
	public PreCreateMediaExResponse getInstance(UnmarshallerContext context) {
		return	PreCreateMediaExResponseUnmarshaller.unmarshall(this, context);
	}
}
