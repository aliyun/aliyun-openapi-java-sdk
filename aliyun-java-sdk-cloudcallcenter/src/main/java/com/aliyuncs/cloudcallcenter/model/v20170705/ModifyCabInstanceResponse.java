...
import com.aliyuncs.cloudcallcenter.transform.v20170705.ModifyCabInstanceResponseUnmarshaller;
 ...
 * @version 
 */
public class ModifyCabInstanceResponse extends AcsResponse {
	...
	@Override
	public ModifyCabInstanceResponse getInstance(UnmarshallerContext context) {
		return	ModifyCabInstanceResponseUnmarshaller.unmarshall(this, context);
	}
