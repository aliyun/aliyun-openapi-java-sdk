...
public class ListAgentSummaryReportsByIntervalRequest extends RpcAcsRequest<ListAgentSummaryReportsByIntervalResponse> {
	...
	public ListAgentSummaryReportsByIntervalRequest() {
		super("CloudCallCenter", "2017-07-05", "ListAgentSummaryReportsByInterval", "CloudCallCenter", "innerAPI");
	}
	...
	@Override
	public Class<ListAgentSummaryReportsByIntervalResponse> getResponseClass() {
		return ListAgentSummaryReportsByIntervalResponse.class;
	}
