...
import com.aliyuncs.cloudcallcenter.transform.v20170705.ListSkillGroupSummaryReportsByIntervalResponseUnmarshaller;
 ...
 * @version 
 */
public class ListSkillGroupSummaryReportsByIntervalResponse extends AcsResponse {
	...
	public static class Data {
		...
		public static class SkillGroupReport {
			...
			private List<SkillGroupReportByInterval> intervalList;
			...
			public List<SkillGroupReportByInterval> getIntervalList() {
				return this.intervalList;
			}

			public void setIntervalList(List<SkillGroupReportByInterval> intervalList) {
				this.intervalList = intervalList;
			}

			public static class SkillGroupReportByInterval {
	...
	@Override
	public ListSkillGroupSummaryReportsByIntervalResponse getInstance(UnmarshallerContext context) {
		return	ListSkillGroupSummaryReportsByIntervalResponseUnmarshaller.unmarshall(this, context);
	}
}
