...
import com.aliyuncs.cloudcallcenter.transform.v20170705.GetInstanceSummaryReportResponseUnmarshaller;
 ...
 * @version 
 */
public class GetInstanceSummaryReportResponse extends AcsResponse {
	...
	@Override
	public GetInstanceSummaryReportResponse getInstance(UnmarshallerContext context) {
		return	GetInstanceSummaryReportResponseUnmarshaller.unmarshall(this, context);
	}
}
