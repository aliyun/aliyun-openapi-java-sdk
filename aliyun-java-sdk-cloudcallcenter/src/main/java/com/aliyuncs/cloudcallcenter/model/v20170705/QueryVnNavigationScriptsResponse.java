...
import com.aliyuncs.cloudcallcenter.transform.v20170705.QueryVnNavigationScriptsResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryVnNavigationScriptsResponse extends AcsResponse {
	...
	@Override
	public QueryVnNavigationScriptsResponse getInstance(UnmarshallerContext context) {
		return	QueryVnNavigationScriptsResponseUnmarshaller.unmarshall(this, context);
	}
