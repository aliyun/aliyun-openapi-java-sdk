...
import com.aliyuncs.cloudcallcenter.transform.v20170705.CreateSurveyResponseUnmarshaller;
 ...
 * @version 
 */
public class CreateSurveyResponse extends AcsResponse {
	...
	@Override
	public CreateSurveyResponse getInstance(UnmarshallerContext context) {
		return	CreateSurveyResponseUnmarshaller.unmarshall(this, context);
	}
