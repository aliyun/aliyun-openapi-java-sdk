...
import com.aliyuncs.cloudcallcenter.transform.v20170705.ListVnPublishHistoriesResponseUnmarshaller;
 ...
 * @version 
 */
public class ListVnPublishHistoriesResponse extends AcsResponse {
	...
	@Override
	public ListVnPublishHistoriesResponse getInstance(UnmarshallerContext context) {
		return	ListVnPublishHistoriesResponseUnmarshaller.unmarshall(this, context);
	}
