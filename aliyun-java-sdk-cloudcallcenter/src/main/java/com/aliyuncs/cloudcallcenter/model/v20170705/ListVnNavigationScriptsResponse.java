...
import com.aliyuncs.cloudcallcenter.transform.v20170705.ListVnNavigationScriptsResponseUnmarshaller;
 ...
 * @version 
 */
public class ListVnNavigationScriptsResponse extends AcsResponse {
	...
	@Override
	public ListVnNavigationScriptsResponse getInstance(UnmarshallerContext context) {
		return	ListVnNavigationScriptsResponseUnmarshaller.unmarshall(this, context);
	}
