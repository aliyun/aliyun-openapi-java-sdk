...
import com.aliyuncs.cloudcallcenter.transform.v20170705.GetLastManagerIdentifyResponseUnmarshaller;
 ...
 * @version 
 */
public class GetLastManagerIdentifyResponse extends AcsResponse {
	...
	@Override
	public GetLastManagerIdentifyResponse getInstance(UnmarshallerContext context) {
		return	GetLastManagerIdentifyResponseUnmarshaller.unmarshall(this, context);
	}
}
