...
import com.aliyuncs.cloudcallcenter.transform.v20170705.ListPhoneNumbersByRamIdResponseUnmarshaller;
 ...
 * @version 
 */
public class ListPhoneNumbersByRamIdResponse extends AcsResponse {
	...
	@Override
	public ListPhoneNumbersByRamIdResponse getInstance(UnmarshallerContext context) {
		return	ListPhoneNumbersByRamIdResponseUnmarshaller.unmarshall(this, context);
	}
}
