 ...
 * @version 
 */
public class EnablePhoneNumberRequest extends RpcAcsRequest<EnablePhoneNumberResponse> {
	
	public EnablePhoneNumberRequest() {
		super("CloudCallCenter", "2017-07-05", "EnablePhoneNumber", "CloudCallCenter", "innerAPI");
	}
	...
	@Override
	public Class<EnablePhoneNumberResponse> getResponseClass() {
		return EnablePhoneNumberResponse.class;
	}
