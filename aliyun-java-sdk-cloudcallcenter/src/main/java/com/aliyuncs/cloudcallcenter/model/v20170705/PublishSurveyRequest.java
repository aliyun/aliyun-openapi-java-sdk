...
public class PublishSurveyRequest extends RpcAcsRequest<PublishSurveyResponse> {
	...
	public PublishSurveyRequest() {
		super("CloudCallCenter", "2017-07-05", "PublishSurvey", "CloudCallCenter", "innerAPI");
	}
	...
	@Override
	public Class<PublishSurveyResponse> getResponseClass() {
		return PublishSurveyResponse.class;
	}
