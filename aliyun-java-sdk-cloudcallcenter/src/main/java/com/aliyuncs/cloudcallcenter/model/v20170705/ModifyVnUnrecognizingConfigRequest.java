 ...
 * @version 
 */
public class ModifyVnUnrecognizingConfigRequest extends RpcAcsRequest<ModifyVnUnrecognizingConfigResponse> {
	
	public ModifyVnUnrecognizingConfigRequest() {
		super("CloudCallCenter", "2017-07-05", "ModifyVnUnrecognizingConfig", "CloudCallCenter", "innerAPI");
	}
	...
	@Override
	public Class<ModifyVnUnrecognizingConfigResponse> getResponseClass() {
		return ModifyVnUnrecognizingConfigResponse.class;
	}
