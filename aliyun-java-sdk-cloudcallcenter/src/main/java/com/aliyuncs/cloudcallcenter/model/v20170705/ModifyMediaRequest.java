 ...
 * @version 
 */
public class ModifyMediaRequest extends RpcAcsRequest<ModifyMediaResponse> {
	
	public ModifyMediaRequest() {
		super("CloudCallCenter", "2017-07-05", "ModifyMedia", "CloudCallCenter", "innerAPI");
	}
	...
	@Override
	public Class<ModifyMediaResponse> getResponseClass() {
		return ModifyMediaResponse.class;
	}
