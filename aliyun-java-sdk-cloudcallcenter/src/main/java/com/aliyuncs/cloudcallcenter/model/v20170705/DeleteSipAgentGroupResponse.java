...
import com.aliyuncs.cloudcallcenter.transform.v20170705.DeleteSipAgentGroupResponseUnmarshaller;
 ...
 * @version 
 */
public class DeleteSipAgentGroupResponse extends AcsResponse {
	...
	@Override
	public DeleteSipAgentGroupResponse getInstance(UnmarshallerContext context) {
		return	DeleteSipAgentGroupResponseUnmarshaller.unmarshall(this, context);
	}
