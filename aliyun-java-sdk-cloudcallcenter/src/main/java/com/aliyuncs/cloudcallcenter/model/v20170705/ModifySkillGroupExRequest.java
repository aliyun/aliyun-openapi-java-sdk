 ...
 * @version 
 */
public class ModifySkillGroupExRequest extends RpcAcsRequest<ModifySkillGroupExResponse> {
	
	public ModifySkillGroupExRequest() {
		super("CloudCallCenter", "2017-07-05", "ModifySkillGroupEx", "CloudCallCenter", "innerAPI");
	}
	...
	@Override
	public Class<ModifySkillGroupExResponse> getResponseClass() {
		return ModifySkillGroupExResponse.class;
	}
