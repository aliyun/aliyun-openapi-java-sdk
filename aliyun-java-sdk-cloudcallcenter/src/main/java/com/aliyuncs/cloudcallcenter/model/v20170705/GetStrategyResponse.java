...
import com.aliyuncs.cloudcallcenter.transform.v20170705.GetStrategyResponseUnmarshaller;
 ...
 * @version 
 */
public class GetStrategyResponse extends AcsResponse {
	...
	@Override
	public GetStrategyResponse getInstance(UnmarshallerContext context) {
		return	GetStrategyResponseUnmarshaller.unmarshall(this, context);
	}
