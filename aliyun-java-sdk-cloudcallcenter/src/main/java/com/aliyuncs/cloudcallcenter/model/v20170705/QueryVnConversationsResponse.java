...
import com.aliyuncs.cloudcallcenter.transform.v20170705.QueryVnConversationsResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryVnConversationsResponse extends AcsResponse {
	...
	@Override
	public QueryVnConversationsResponse getInstance(UnmarshallerContext context) {
		return	QueryVnConversationsResponseUnmarshaller.unmarshall(this, context);
	}
