...
public class DoLogicalDeleteResourceRequest extends RpcAcsRequest<DoLogicalDeleteResourceResponse> {
	...
	public DoLogicalDeleteResourceRequest() {
		super("CloudCallCenter", "2017-07-05", "DoLogicalDeleteResource", "CloudCallCenter", "innerAPI");
	}
	...
	@Override
	public Class<DoLogicalDeleteResourceResponse> getResponseClass() {
		return DoLogicalDeleteResourceResponse.class;
	}
