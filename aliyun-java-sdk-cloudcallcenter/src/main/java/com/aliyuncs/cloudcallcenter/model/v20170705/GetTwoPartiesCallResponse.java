...
import com.aliyuncs.cloudcallcenter.transform.v20170705.GetTwoPartiesCallResponseUnmarshaller;
 ...
 * @version 
 */
public class GetTwoPartiesCallResponse extends AcsResponse {
	...
	@Override
	public GetTwoPartiesCallResponse getInstance(UnmarshallerContext context) {
		return	GetTwoPartiesCallResponseUnmarshaller.unmarshall(this, context);
	}
}
