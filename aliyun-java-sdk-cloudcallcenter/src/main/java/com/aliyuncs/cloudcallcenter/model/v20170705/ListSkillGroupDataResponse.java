...
import com.aliyuncs.cloudcallcenter.transform.v20170705.ListSkillGroupDataResponseUnmarshaller;
 ...
 * @version 
 */
public class ListSkillGroupDataResponse extends AcsResponse {
	...
	@Override
	public ListSkillGroupDataResponse getInstance(UnmarshallerContext context) {
		return	ListSkillGroupDataResponseUnmarshaller.unmarshall(this, context);
	}
}
