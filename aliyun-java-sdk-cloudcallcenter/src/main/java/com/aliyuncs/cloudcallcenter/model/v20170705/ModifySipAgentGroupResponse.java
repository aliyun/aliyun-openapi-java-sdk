...
import com.aliyuncs.cloudcallcenter.transform.v20170705.ModifySipAgentGroupResponseUnmarshaller;
 ...
 * @version 
 */
public class ModifySipAgentGroupResponse extends AcsResponse {
	...
	@Override
	public ModifySipAgentGroupResponse getInstance(UnmarshallerContext context) {
		return	ModifySipAgentGroupResponseUnmarshaller.unmarshall(this, context);
	}
