...
public class SuspendJobsRequest extends RpcAcsRequest<SuspendJobsResponse> {
	...
	public SuspendJobsRequest() {
		super("CloudCallCenter", "2017-07-05", "SuspendJobs", "CloudCallCenter", "innerAPI");
	}
	...
	@Override
	public Class<SuspendJobsResponse> getResponseClass() {
		return SuspendJobsResponse.class;
	}
