 ...
 * @version 
 */
public class BatchDeleteVnNavigationScriptsRequest extends RpcAcsRequest<BatchDeleteVnNavigationScriptsResponse> {
	
	public BatchDeleteVnNavigationScriptsRequest() {
		super("CloudCallCenter", "2017-07-05", "BatchDeleteVnNavigationScripts", "CloudCallCenter", "innerAPI");
	}
	...
	@Override
	public Class<BatchDeleteVnNavigationScriptsResponse> getResponseClass() {
		return BatchDeleteVnNavigationScriptsResponse.class;
	}
