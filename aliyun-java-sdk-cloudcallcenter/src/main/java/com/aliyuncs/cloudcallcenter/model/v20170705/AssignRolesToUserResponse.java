...
import com.aliyuncs.cloudcallcenter.transform.v20170705.AssignRolesToUserResponseUnmarshaller;
 ...
 * @version 
 */
public class AssignRolesToUserResponse extends AcsResponse {
	...
	@Override
	public AssignRolesToUserResponse getInstance(UnmarshallerContext context) {
		return	AssignRolesToUserResponseUnmarshaller.unmarshall(this, context);
	}
}
