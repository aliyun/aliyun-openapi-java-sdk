...
import com.aliyuncs.cloudcallcenter.transform.v20170705.GetJobStatusByCallIdResponseUnmarshaller;
 ...
 * @version 
 */
public class GetJobStatusByCallIdResponse extends AcsResponse {
	...
	@Override
	public GetJobStatusByCallIdResponse getInstance(UnmarshallerContext context) {
		return	GetJobStatusByCallIdResponseUnmarshaller.unmarshall(this, context);
	}
