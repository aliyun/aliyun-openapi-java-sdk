 ...
 * @version 
 */
public class CreateCCCPhoneNumberOrderRequest extends RpcAcsRequest<CreateCCCPhoneNumberOrderResponse> {
	
	public CreateCCCPhoneNumberOrderRequest() {
		super("CloudCallCenter", "2017-07-05", "CreateCCCPhoneNumberOrder", "CloudCallCenter", "innerAPI");
	}
	...
	@Override
	public Class<CreateCCCPhoneNumberOrderResponse> getResponseClass() {
		return CreateCCCPhoneNumberOrderResponse.class;
	}
