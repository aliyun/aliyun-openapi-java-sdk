...
import com.aliyuncs.cloudcallcenter.transform.v20170705.ListStrategyTemplatesResponseUnmarshaller;
 ...
 * @version 
 */
public class ListStrategyTemplatesResponse extends AcsResponse {
	...
	private List<Strategy> strategyTemplates;
	...
	public List<Strategy> getStrategyTemplates() {
		return this.strategyTemplates;
	}

	public void setStrategyTemplates(List<Strategy> strategyTemplates) {
		this.strategyTemplates = strategyTemplates;
	}
	...
	@Override
	public ListStrategyTemplatesResponse getInstance(UnmarshallerContext context) {
		return	ListStrategyTemplatesResponseUnmarshaller.unmarshall(this, context);
	}
