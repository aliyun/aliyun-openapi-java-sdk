...
import com.aliyuncs.cloudcallcenter.transform.v20170705.ListSurveysResponseUnmarshaller;
 ...
 * @version 
 */
public class ListSurveysResponse extends AcsResponse {
	...
	@Override
	public ListSurveysResponse getInstance(UnmarshallerContext context) {
		return	ListSurveysResponseUnmarshaller.unmarshall(this, context);
	}
