 ...
 * @version 
 */
public class MoveVnNavigationScriptRequest extends RpcAcsRequest<MoveVnNavigationScriptResponse> {
	
	public MoveVnNavigationScriptRequest() {
		super("CloudCallCenter", "2017-07-05", "MoveVnNavigationScript", "CloudCallCenter", "innerAPI");
	}
	...
	@Override
	public Class<MoveVnNavigationScriptResponse> getResponseClass() {
		return MoveVnNavigationScriptResponse.class;
	}
