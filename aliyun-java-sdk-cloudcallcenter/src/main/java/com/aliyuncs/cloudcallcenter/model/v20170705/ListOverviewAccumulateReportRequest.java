 ...
 * @version 
 */
public class ListOverviewAccumulateReportRequest extends RpcAcsRequest<ListOverviewAccumulateReportResponse> {
	
	public ListOverviewAccumulateReportRequest() {
		super("CloudCallCenter", "2017-07-05", "ListOverviewAccumulateReport", "CloudCallCenter", "innerAPI");
	}
	...
	@Override
	public Class<ListOverviewAccumulateReportResponse> getResponseClass() {
		return ListOverviewAccumulateReportResponse.class;
	}
