...
import com.aliyuncs.cloudcallcenter.transform.v20170705.RemoveRolesFromUserResponseUnmarshaller;
 ...
 * @version 
 */
public class RemoveRolesFromUserResponse extends AcsResponse {
	...
	@Override
	public RemoveRolesFromUserResponse getInstance(UnmarshallerContext context) {
		return	RemoveRolesFromUserResponseUnmarshaller.unmarshall(this, context);
	}
}
