...
import com.aliyuncs.cloudcallcenter.transform.v20170705.ListAvailableTestPhoneNumbersResponseUnmarshaller;
 ...
 * @version 
 */
public class ListAvailableTestPhoneNumbersResponse extends AcsResponse {
	...
	@Override
	public ListAvailableTestPhoneNumbersResponse getInstance(UnmarshallerContext context) {
		return	ListAvailableTestPhoneNumbersResponseUnmarshaller.unmarshall(this, context);
	}
}
