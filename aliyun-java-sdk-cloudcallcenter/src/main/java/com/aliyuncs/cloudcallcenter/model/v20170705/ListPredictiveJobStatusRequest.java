...
public class ListPredictiveJobStatusRequest extends RpcAcsRequest<ListPredictiveJobStatusResponse> {
	...
	public ListPredictiveJobStatusRequest() {
		super("CloudCallCenter", "2017-07-05", "ListPredictiveJobStatus", "CloudCallCenter", "innerAPI");
	}
	...
	@Override
	public Class<ListPredictiveJobStatusResponse> getResponseClass() {
		return ListPredictiveJobStatusResponse.class;
	}
