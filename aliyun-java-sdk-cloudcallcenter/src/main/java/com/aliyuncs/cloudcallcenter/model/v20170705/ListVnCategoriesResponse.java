...
import com.aliyuncs.cloudcallcenter.transform.v20170705.ListVnCategoriesResponseUnmarshaller;
 ...
 * @version 
 */
public class ListVnCategoriesResponse extends AcsResponse {
	...
	@Override
	public ListVnCategoriesResponse getInstance(UnmarshallerContext context) {
		return	ListVnCategoriesResponseUnmarshaller.unmarshall(this, context);
	}
