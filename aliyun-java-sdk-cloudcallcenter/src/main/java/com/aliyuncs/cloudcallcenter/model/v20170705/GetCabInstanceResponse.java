...
import com.aliyuncs.cloudcallcenter.transform.v20170705.GetCabInstanceResponseUnmarshaller;
 ...
 * @version 
 */
public class GetCabInstanceResponse extends AcsResponse {
	...
	@Override
	public GetCabInstanceResponse getInstance(UnmarshallerContext context) {
		return	GetCabInstanceResponseUnmarshaller.unmarshall(this, context);
	}
