...
import com.aliyuncs.cloudcallcenter.transform.v20170705.DescribeVnRedirectionResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeVnRedirectionResponse extends AcsResponse {
	...
	@Override
	public DescribeVnRedirectionResponse getInstance(UnmarshallerContext context) {
		return	DescribeVnRedirectionResponseUnmarshaller.unmarshall(this, context);
	}
