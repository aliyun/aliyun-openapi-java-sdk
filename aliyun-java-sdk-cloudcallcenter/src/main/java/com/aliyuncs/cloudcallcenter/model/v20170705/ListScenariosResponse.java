...
import com.aliyuncs.cloudcallcenter.transform.v20170705.ListScenariosResponseUnmarshaller;
 ...
 * @version 
 */
public class ListScenariosResponse extends AcsResponse {
	...
	@Override
	public ListScenariosResponse getInstance(UnmarshallerContext context) {
		return	ListScenariosResponseUnmarshaller.unmarshall(this, context);
	}
