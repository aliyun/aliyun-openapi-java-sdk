...
import com.aliyuncs.cloudcallcenter.transform.v20170705.ModifyMediaResponseUnmarshaller;
 ...
 * @version 
 */
public class ModifyMediaResponse extends AcsResponse {
	...
	@Override
	public ModifyMediaResponse getInstance(UnmarshallerContext context) {
		return	ModifyMediaResponseUnmarshaller.unmarshall(this, context);
	}
}
