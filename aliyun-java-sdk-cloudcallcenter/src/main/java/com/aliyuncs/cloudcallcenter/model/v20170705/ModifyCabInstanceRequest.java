 ...
 * @version 
 */
public class ModifyCabInstanceRequest extends RpcAcsRequest<ModifyCabInstanceResponse> {
	
	public ModifyCabInstanceRequest() {
		super("CloudCallCenter", "2017-07-05", "ModifyCabInstance", "CloudCallCenter", "innerAPI");
	}
	...
	@Override
	public Class<ModifyCabInstanceResponse> getResponseClass() {
		return ModifyCabInstanceResponse.class;
	}
