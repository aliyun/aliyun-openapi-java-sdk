...
import com.aliyuncs.cloudcallcenter.transform.v20170705.CommonQueryTaobaoOrderResponseUnmarshaller;
 ...
 * @version 
 */
public class CommonQueryTaobaoOrderResponse extends AcsResponse {
	...
	@Override
	public CommonQueryTaobaoOrderResponse getInstance(UnmarshallerContext context) {
		return	CommonQueryTaobaoOrderResponseUnmarshaller.unmarshall(this, context);
	}
}
