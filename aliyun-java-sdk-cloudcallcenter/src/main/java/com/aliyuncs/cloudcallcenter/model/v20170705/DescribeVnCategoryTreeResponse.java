...
import com.aliyuncs.cloudcallcenter.transform.v20170705.DescribeVnCategoryTreeResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeVnCategoryTreeResponse extends AcsResponse {
	...
	@Override
	public DescribeVnCategoryTreeResponse getInstance(UnmarshallerContext context) {
		return	DescribeVnCategoryTreeResponseUnmarshaller.unmarshall(this, context);
	}
