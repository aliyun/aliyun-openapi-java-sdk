...
import com.aliyuncs.cloudcallcenter.transform.v20170705.DownloadRecordingResponseUnmarshaller;
...
public class DownloadRecordingResponse extends AcsResponse {
	...
	@Override
	public DownloadRecordingResponse getInstance(UnmarshallerContext context) {
		return	DownloadRecordingResponseUnmarshaller.unmarshall(this, context);
	}
}
