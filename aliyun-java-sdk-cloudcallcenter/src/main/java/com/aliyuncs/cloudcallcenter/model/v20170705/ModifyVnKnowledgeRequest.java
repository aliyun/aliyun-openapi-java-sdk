 ...
 * @version 
 */
public class ModifyVnKnowledgeRequest extends RpcAcsRequest<ModifyVnKnowledgeResponse> {
	
	public ModifyVnKnowledgeRequest() {
		super("CloudCallCenter", "2017-07-05", "ModifyVnKnowledge", "CloudCallCenter", "innerAPI");
	}
	...
	@Override
	public Class<ModifyVnKnowledgeResponse> getResponseClass() {
		return ModifyVnKnowledgeResponse.class;
	}
