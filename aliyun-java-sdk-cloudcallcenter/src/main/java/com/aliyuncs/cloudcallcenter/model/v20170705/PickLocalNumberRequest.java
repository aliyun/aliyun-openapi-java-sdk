...
public class PickLocalNumberRequest extends RpcAcsRequest<PickLocalNumberResponse> {
	...
	public PickLocalNumberRequest() {
		super("CloudCallCenter", "2017-07-05", "PickLocalNumber", "CloudCallCenter", "innerAPI");
	}
	...
	@Override
	public Class<PickLocalNumberResponse> getResponseClass() {
		return PickLocalNumberResponse.class;
	}
