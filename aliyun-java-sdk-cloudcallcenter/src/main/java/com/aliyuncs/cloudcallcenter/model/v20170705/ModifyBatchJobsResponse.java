...
import com.aliyuncs.cloudcallcenter.transform.v20170705.ModifyBatchJobsResponseUnmarshaller;
...
public class ModifyBatchJobsResponse extends AcsResponse {
	...
	@Override
	public ModifyBatchJobsResponse getInstance(UnmarshallerContext context) {
		return	ModifyBatchJobsResponseUnmarshaller.unmarshall(this, context);
	}
