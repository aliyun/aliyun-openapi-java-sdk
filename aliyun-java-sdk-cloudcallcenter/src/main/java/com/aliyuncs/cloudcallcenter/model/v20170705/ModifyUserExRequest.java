 ...
 * @version 
 */
public class ModifyUserExRequest extends RpcAcsRequest<ModifyUserExResponse> {
	
	public ModifyUserExRequest() {
		super("CloudCallCenter", "2017-07-05", "ModifyUserEx", "CloudCallCenter", "innerAPI");
	}
	...
	@Override
	public Class<ModifyUserExResponse> getResponseClass() {
		return ModifyUserExResponse.class;
	}
