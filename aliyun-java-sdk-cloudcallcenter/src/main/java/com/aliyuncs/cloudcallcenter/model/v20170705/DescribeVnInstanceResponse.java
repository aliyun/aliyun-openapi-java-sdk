...
import com.aliyuncs.cloudcallcenter.transform.v20170705.DescribeVnInstanceResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeVnInstanceResponse extends AcsResponse {
	...
	@Override
	public DescribeVnInstanceResponse getInstance(UnmarshallerContext context) {
		return	DescribeVnInstanceResponseUnmarshaller.unmarshall(this, context);
	}
