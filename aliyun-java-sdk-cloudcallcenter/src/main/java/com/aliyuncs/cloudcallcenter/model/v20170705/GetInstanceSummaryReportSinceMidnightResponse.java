...
import com.aliyuncs.cloudcallcenter.transform.v20170705.GetInstanceSummaryReportSinceMidnightResponseUnmarshaller;
 ...
 * @version 
 */
public class GetInstanceSummaryReportSinceMidnightResponse extends AcsResponse {
	...
	public void setInstanceSummaryReport(InstanceSummaryReport instanceSummaryReport) {
	...
	@Override
	public GetInstanceSummaryReportSinceMidnightResponse getInstance(UnmarshallerContext context) {
		return	GetInstanceSummaryReportSinceMidnightResponseUnmarshaller.unmarshall(this, context);
	}
}
