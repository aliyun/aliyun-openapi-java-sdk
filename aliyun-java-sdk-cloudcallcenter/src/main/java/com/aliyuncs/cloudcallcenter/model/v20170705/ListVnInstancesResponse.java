...
import com.aliyuncs.cloudcallcenter.transform.v20170705.ListVnInstancesResponseUnmarshaller;
 ...
 * @version 
 */
public class ListVnInstancesResponse extends AcsResponse {
	...
	@Override
	public ListVnInstancesResponse getInstance(UnmarshallerContext context) {
		return	ListVnInstancesResponseUnmarshaller.unmarshall(this, context);
	}
