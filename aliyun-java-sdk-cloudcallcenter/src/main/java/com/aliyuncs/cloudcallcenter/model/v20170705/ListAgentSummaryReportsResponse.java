...
import com.aliyuncs.cloudcallcenter.transform.v20170705.ListAgentSummaryReportsResponseUnmarshaller;
 ...
 * @version 
 */
public class ListAgentSummaryReportsResponse extends AcsResponse {
	...
	public static class Data {
		...
		public static class AgentReport {
			...
			public static class Overall {
				...
				private String firstLoggedInTimestamp;

				private String lastLoggedOutTimestamp;
				...
				public String getFirstLoggedInTimestamp() {
					return this.firstLoggedInTimestamp;
				}

				public void setFirstLoggedInTimestamp(String firstLoggedInTimestamp) {
					this.firstLoggedInTimestamp = firstLoggedInTimestamp;
				}

				public String getLastLoggedOutTimestamp() {
					return this.lastLoggedOutTimestamp;
				}

				public void setLastLoggedOutTimestamp(String lastLoggedOutTimestamp) {
	...
	@Override
	public ListAgentSummaryReportsResponse getInstance(UnmarshallerContext context) {
		return	ListAgentSummaryReportsResponseUnmarshaller.unmarshall(this, context);
	}
}
