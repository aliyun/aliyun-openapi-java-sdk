...
import com.aliyuncs.cloudcallcenter.transform.v20170705.ListCallDetailDatasResponseUnmarshaller;
 ...
 * @version 
 */
public class ListCallDetailDatasResponse extends AcsResponse {
	...
	@Override
	public ListCallDetailDatasResponse getInstance(UnmarshallerContext context) {
		return	ListCallDetailDatasResponseUnmarshaller.unmarshall(this, context);
	}
}
