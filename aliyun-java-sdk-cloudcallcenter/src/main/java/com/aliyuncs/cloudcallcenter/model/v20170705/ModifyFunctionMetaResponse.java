...
import com.aliyuncs.cloudcallcenter.transform.v20170705.ModifyFunctionMetaResponseUnmarshaller;
 ...
 * @version 
 */
public class ModifyFunctionMetaResponse extends AcsResponse {
	...
	@Override
	public ModifyFunctionMetaResponse getInstance(UnmarshallerContext context) {
		return	ModifyFunctionMetaResponseUnmarshaller.unmarshall(this, context);
	}
}
