...
import com.aliyuncs.cloudcallcenter.transform.v20170705.CreateOrModifySystemSpecificationResponseUnmarshaller;
 ...
 * @version 
 */
public class CreateOrModifySystemSpecificationResponse extends AcsResponse {
	...
	@Override
	public CreateOrModifySystemSpecificationResponse getInstance(UnmarshallerContext context) {
		return	CreateOrModifySystemSpecificationResponseUnmarshaller.unmarshall(this, context);
	}
}
