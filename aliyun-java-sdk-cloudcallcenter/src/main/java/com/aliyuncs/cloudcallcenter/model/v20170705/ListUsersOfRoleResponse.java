...
import com.aliyuncs.cloudcallcenter.transform.v20170705.ListUsersOfRoleResponseUnmarshaller;
 ...
 * @version 
 */
public class ListUsersOfRoleResponse extends AcsResponse {
	...
	@Override
	public ListUsersOfRoleResponse getInstance(UnmarshallerContext context) {
		return	ListUsersOfRoleResponseUnmarshaller.unmarshall(this, context);
	}
}
