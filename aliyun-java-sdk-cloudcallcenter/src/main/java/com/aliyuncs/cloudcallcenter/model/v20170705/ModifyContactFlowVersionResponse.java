...
import com.aliyuncs.cloudcallcenter.transform.v20170705.ModifyContactFlowVersionResponseUnmarshaller;
 ...
 * @version 
 */
public class ModifyContactFlowVersionResponse extends AcsResponse {
	...
	@Override
	public ModifyContactFlowVersionResponse getInstance(UnmarshallerContext context) {
		return	ModifyContactFlowVersionResponseUnmarshaller.unmarshall(this, context);
	}
}
