...
import com.aliyuncs.cloudcallcenter.transform.v20170705.ListVnConversationsResponseUnmarshaller;
 ...
 * @version 
 */
public class ListVnConversationsResponse extends AcsResponse {
	...
	@Override
	public ListVnConversationsResponse getInstance(UnmarshallerContext context) {
		return	ListVnConversationsResponseUnmarshaller.unmarshall(this, context);
	}
