...
import com.aliyuncs.cloudcallcenter.transform.v20170705.DescribeVnNavigationConfigResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeVnNavigationConfigResponse extends AcsResponse {
	...
	@Override
	public DescribeVnNavigationConfigResponse getInstance(UnmarshallerContext context) {
		return	DescribeVnNavigationConfigResponseUnmarshaller.unmarshall(this, context);
	}
