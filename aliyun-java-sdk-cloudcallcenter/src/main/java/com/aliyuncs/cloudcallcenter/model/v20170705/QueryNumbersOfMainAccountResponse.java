...
import com.aliyuncs.cloudcallcenter.transform.v20170705.QueryNumbersOfMainAccountResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryNumbersOfMainAccountResponse extends AcsResponse {
	...
	@Override
	public QueryNumbersOfMainAccountResponse getInstance(UnmarshallerContext context) {
		return	QueryNumbersOfMainAccountResponseUnmarshaller.unmarshall(this, context);
	}
}
