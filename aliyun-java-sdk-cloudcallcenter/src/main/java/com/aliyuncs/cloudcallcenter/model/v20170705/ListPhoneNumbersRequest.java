...
public class ListPhoneNumbersRequest extends RpcAcsRequest<ListPhoneNumbersResponse> {
	...
	public ListPhoneNumbersRequest() {
		super("CloudCallCenter", "2017-07-05", "ListPhoneNumbers", "CloudCallCenter", "innerAPI");
	}
	...
	@Override
	public Class<ListPhoneNumbersResponse> getResponseClass() {
		return ListPhoneNumbersResponse.class;
	}
