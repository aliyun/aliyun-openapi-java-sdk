...
import com.aliyuncs.cloudcallcenter.transform.v20170705.ListAgentDataResponseUnmarshaller;
 ...
 * @version 
 */
public class ListAgentDataResponse extends AcsResponse {
	...
	@Override
	public ListAgentDataResponse getInstance(UnmarshallerContext context) {
		return	ListAgentDataResponseUnmarshaller.unmarshall(this, context);
	}
}
