...
import com.aliyuncs.cloudcallcenter.transform.v20170705.FindUsersResponseUnmarshaller;
...
public class FindUsersResponse extends AcsResponse {
	...
	@Override
	public FindUsersResponse getInstance(UnmarshallerContext context) {
		return	FindUsersResponseUnmarshaller.unmarshall(this, context);
	}
}
