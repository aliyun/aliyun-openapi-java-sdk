...
import com.aliyuncs.cloudcallcenter.transform.v20170705.ListSkillGroupSummaryReportsResponseUnmarshaller;
...
public class ListSkillGroupSummaryReportsResponse extends AcsResponse {
	...
	public static class Data {
		...
		private List<SkillGroupReport> list;
		...
		public List<SkillGroupReport> getList() {
			return this.list;
		}

		public void setList(List<SkillGroupReport> list) {
			this.list = list;
		}

		public static class SkillGroupReport {
			...
			private RealTimeQueueIndicators realTimeQueueIndicators;

			private RealTimeSkillGroupIndicators realTimeSkillGroupIndicators;
			...
			public RealTimeQueueIndicators getRealTimeQueueIndicators() {
				return this.realTimeQueueIndicators;
			}

			public void setRealTimeQueueIndicators(RealTimeQueueIndicators realTimeQueueIndicators) {
				this.realTimeQueueIndicators = realTimeQueueIndicators;
			}

			public RealTimeSkillGroupIndicators getRealTimeSkillGroupIndicators() {
				return this.realTimeSkillGroupIndicators;
			}

			public void setRealTimeSkillGroupIndicators(RealTimeSkillGroupIndicators realTimeSkillGroupIndicators) {
				this.realTimeSkillGroupIndicators = realTimeSkillGroupIndicators;
			}
			...
			public static class RealTimeQueueIndicators {
			...
			public static class RealTimeSkillGroupIndicators {
