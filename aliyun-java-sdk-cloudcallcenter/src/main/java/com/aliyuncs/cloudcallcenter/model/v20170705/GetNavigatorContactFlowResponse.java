...
import com.aliyuncs.cloudcallcenter.transform.v20170705.GetNavigatorContactFlowResponseUnmarshaller;
 ...
 * @version 
 */
public class GetNavigatorContactFlowResponse extends AcsResponse {
	...
	@Override
	public GetNavigatorContactFlowResponse getInstance(UnmarshallerContext context) {
		return	GetNavigatorContactFlowResponseUnmarshaller.unmarshall(this, context);
	}
}
