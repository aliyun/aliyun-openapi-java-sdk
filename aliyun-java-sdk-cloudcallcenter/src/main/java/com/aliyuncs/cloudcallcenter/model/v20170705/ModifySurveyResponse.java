...
import com.aliyuncs.cloudcallcenter.transform.v20170705.ModifySurveyResponseUnmarshaller;
 ...
 * @version 
 */
public class ModifySurveyResponse extends AcsResponse {
	...
	@Override
	public ModifySurveyResponse getInstance(UnmarshallerContext context) {
		return	ModifySurveyResponseUnmarshaller.unmarshall(this, context);
	}
