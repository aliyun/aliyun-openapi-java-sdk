...
import com.aliyuncs.cloudcallcenter.transform.v20170705.DescribeVnKnowledgeResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeVnKnowledgeResponse extends AcsResponse {
	...
	@Override
	public DescribeVnKnowledgeResponse getInstance(UnmarshallerContext context) {
		return	DescribeVnKnowledgeResponseUnmarshaller.unmarshall(this, context);
	}
