...
import com.aliyuncs.cloudcallcenter.transform.v20170705.ListInstancesExResponseUnmarshaller;
 ...
 * @version 
 */
public class ListInstancesExResponse extends AcsResponse {
	...
	private List<CallCenterInstance> instances;
	...
	public List<CallCenterInstance> getInstances() {
		return this.instances;
	}

	public void setInstances(List<CallCenterInstance> instances) {
	...
	@Override
	public ListInstancesExResponse getInstance(UnmarshallerContext context) {
		return	ListInstancesExResponseUnmarshaller.unmarshall(this, context);
	}
}
