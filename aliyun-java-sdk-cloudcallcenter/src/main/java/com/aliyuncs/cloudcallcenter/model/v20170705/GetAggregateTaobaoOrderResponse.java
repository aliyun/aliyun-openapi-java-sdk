...
import com.aliyuncs.cloudcallcenter.transform.v20170705.GetAggregateTaobaoOrderResponseUnmarshaller;
 ...
 * @version 
 */
public class GetAggregateTaobaoOrderResponse extends AcsResponse {
	...
	@Override
	public GetAggregateTaobaoOrderResponse getInstance(UnmarshallerContext context) {
		return	GetAggregateTaobaoOrderResponseUnmarshaller.unmarshall(this, context);
	}
}
