...
import com.aliyuncs.cloudcallcenter.transform.v20170705.QueryNumberCorpIdentifyResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryNumberCorpIdentifyResponse extends AcsResponse {
	...
	public static class Data {
		...
		private List<QueryCorpIdentifyDomain> list;
		...
		public List<QueryCorpIdentifyDomain> getList() {
			return this.list;
		}

		public void setList(List<QueryCorpIdentifyDomain> list) {
			this.list = list;
		}
	...
	@Override
	public QueryNumberCorpIdentifyResponse getInstance(UnmarshallerContext context) {
		return	QueryNumberCorpIdentifyResponseUnmarshaller.unmarshall(this, context);
	}
}
