...
import com.aliyuncs.cloudcallcenter.transform.v20170705.CreateTbAliyunUserMappingResponseUnmarshaller;
 ...
 * @version 
 */
public class CreateTbAliyunUserMappingResponse extends AcsResponse {
	...
	@Override
	public CreateTbAliyunUserMappingResponse getInstance(UnmarshallerContext context) {
		return	CreateTbAliyunUserMappingResponseUnmarshaller.unmarshall(this, context);
	}
}
