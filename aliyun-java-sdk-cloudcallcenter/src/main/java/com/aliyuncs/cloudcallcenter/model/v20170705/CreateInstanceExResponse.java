...
import com.aliyuncs.cloudcallcenter.transform.v20170705.CreateInstanceExResponseUnmarshaller;
 ...
 * @version 
 */
public class CreateInstanceExResponse extends AcsResponse {
	...
	@Override
	public CreateInstanceExResponse getInstance(UnmarshallerContext context) {
		return	CreateInstanceExResponseUnmarshaller.unmarshall(this, context);
	}
}
