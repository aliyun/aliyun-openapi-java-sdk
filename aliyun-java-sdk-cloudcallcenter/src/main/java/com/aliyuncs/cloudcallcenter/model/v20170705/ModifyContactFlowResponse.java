...
import com.aliyuncs.cloudcallcenter.transform.v20170705.ModifyContactFlowResponseUnmarshaller;
 ...
 * @version 
 */
public class ModifyContactFlowResponse extends AcsResponse {
	...
	@Override
	public ModifyContactFlowResponse getInstance(UnmarshallerContext context) {
		return	ModifyContactFlowResponseUnmarshaller.unmarshall(this, context);
	}
}
