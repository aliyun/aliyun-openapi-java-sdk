...
import com.aliyuncs.cloudcallcenter.transform.v20170705.GetCabJobByPhoneNumberResponseUnmarshaller;
 ...
 * @version 
 */
public class GetCabJobByPhoneNumberResponse extends AcsResponse {
	...
	@Override
	public GetCabJobByPhoneNumberResponse getInstance(UnmarshallerContext context) {
		return	GetCabJobByPhoneNumberResponseUnmarshaller.unmarshall(this, context);
	}
