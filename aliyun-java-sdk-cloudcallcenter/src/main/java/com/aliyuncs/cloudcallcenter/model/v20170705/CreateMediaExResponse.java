...
import com.aliyuncs.cloudcallcenter.transform.v20170705.CreateMediaExResponseUnmarshaller;
 ...
 * @version 
 */
public class CreateMediaExResponse extends AcsResponse {
	...
	@Override
	public CreateMediaExResponse getInstance(UnmarshallerContext context) {
		return	CreateMediaExResponseUnmarshaller.unmarshall(this, context);
	}
}
