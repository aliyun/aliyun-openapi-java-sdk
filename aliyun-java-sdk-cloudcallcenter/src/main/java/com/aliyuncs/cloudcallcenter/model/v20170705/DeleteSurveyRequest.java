...
public class DeleteSurveyRequest extends RpcAcsRequest<DeleteSurveyResponse> {
	...
	public DeleteSurveyRequest() {
		super("CloudCallCenter", "2017-07-05", "DeleteSurvey", "CloudCallCenter", "innerAPI");
	}
	...
	@Override
	public Class<DeleteSurveyResponse> getResponseClass() {
		return DeleteSurveyResponse.class;
	}
