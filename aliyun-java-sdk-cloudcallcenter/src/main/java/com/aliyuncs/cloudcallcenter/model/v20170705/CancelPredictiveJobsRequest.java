...
public class CancelPredictiveJobsRequest extends RpcAcsRequest<CancelPredictiveJobsResponse> {
	...
	public CancelPredictiveJobsRequest() {
		super("CloudCallCenter", "2017-07-05", "CancelPredictiveJobs", "CloudCallCenter", "innerAPI");
	}
	...
	@Override
	public Class<CancelPredictiveJobsResponse> getResponseClass() {
		return CancelPredictiveJobsResponse.class;
	}
