...
import com.aliyuncs.cloudcallcenter.transform.v20170705.AddPhoneNumberExResponseUnmarshaller;
 ...
 * @version 
 */
public class AddPhoneNumberExResponse extends AcsResponse {
	...
	@Override
	public AddPhoneNumberExResponse getInstance(UnmarshallerContext context) {
		return	AddPhoneNumberExResponseUnmarshaller.unmarshall(this, context);
	}
}
