...
import com.aliyuncs.cloudcallcenter.transform.v20170705.AddSipAgentGroupResponseUnmarshaller;
 ...
 * @version 
 */
public class AddSipAgentGroupResponse extends AcsResponse {
	...
	@Override
	public AddSipAgentGroupResponse getInstance(UnmarshallerContext context) {
		return	AddSipAgentGroupResponseUnmarshaller.unmarshall(this, context);
	}
