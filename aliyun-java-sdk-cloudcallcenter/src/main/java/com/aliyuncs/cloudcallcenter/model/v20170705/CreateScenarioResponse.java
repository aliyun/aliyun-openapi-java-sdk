...
import com.aliyuncs.cloudcallcenter.transform.v20170705.CreateScenarioResponseUnmarshaller;
 ...
 * @version 
 */
public class CreateScenarioResponse extends AcsResponse {
	...
	@Override
	public CreateScenarioResponse getInstance(UnmarshallerContext context) {
		return	CreateScenarioResponseUnmarshaller.unmarshall(this, context);
	}
