...
import com.aliyuncs.cloudcallcenter.model.v20170705.ListJobGroupsResponse;
import com.aliyuncs.cloudcallcenter.model.v20170705.ListJobGroupsResponse.JobGroups;
import com.aliyuncs.cloudcallcenter.model.v20170705.ListJobGroupsResponse.JobGroups.JobGroup;
import com.aliyuncs.cloudcallcenter.model.v20170705.ListJobGroupsResponse.JobGroups.JobGroup.Progress;
import com.aliyuncs.cloudcallcenter.model.v20170705.ListJobGroupsResponse.JobGroups.JobGroup.Progress.KeyValuePair;
import com.aliyuncs.cloudcallcenter.model.v20170705.ListJobGroupsResponse.JobGroups.JobGroup.Strategy;
import com.aliyuncs.cloudcallcenter.model.v20170705.ListJobGroupsResponse.JobGroups.JobGroup.Strategy.TimeFrame;
...
public class ListJobGroupsResponseUnmarshaller {
	...
	public static ListJobGroupsResponse unmarshall(ListJobGroupsResponse listJobGroupsResponse, UnmarshallerContext context) {
		...
		for (int i = 0; i < context.lengthValue("ListJobGroupsResponse.JobGroups.List.Length"); i++) {
			...
			jobGroup.setScenarioName(context.stringValue("ListJobGroupsResponse.JobGroups.List["+ i +"].ScenarioName"));
