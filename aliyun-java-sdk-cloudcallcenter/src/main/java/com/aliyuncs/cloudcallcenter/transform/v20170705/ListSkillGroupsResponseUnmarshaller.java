...
import com.aliyuncs.cloudcallcenter.model.v20170705.ListSkillGroupsResponse;
import com.aliyuncs.cloudcallcenter.model.v20170705.ListSkillGroupsResponse.SkillGroup;
import com.aliyuncs.cloudcallcenter.model.v20170705.ListSkillGroupsResponse.SkillGroup.PhoneNumber;
...
public class ListSkillGroupsResponseUnmarshaller {
	...
	public static ListSkillGroupsResponse unmarshall(ListSkillGroupsResponse listSkillGroupsResponse, UnmarshallerContext context) {
		...
		for (int i = 0; i < context.lengthValue("ListSkillGroupsResponse.SkillGroups.Length"); i++) {
			...
			skillGroup.setAllowPrivateOutboundNumber(context.booleanValue("ListSkillGroupsResponse.SkillGroups["+ i +"].AllowPrivateOutboundNumber"));
