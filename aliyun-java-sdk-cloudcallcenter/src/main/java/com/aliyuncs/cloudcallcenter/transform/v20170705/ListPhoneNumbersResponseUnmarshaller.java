...
import com.aliyuncs.cloudcallcenter.model.v20170705.ListPhoneNumbersResponse;
import com.aliyuncs.cloudcallcenter.model.v20170705.ListPhoneNumbersResponse.PhoneNumber;
import com.aliyuncs.cloudcallcenter.model.v20170705.ListPhoneNumbersResponse.PhoneNumber.ContactFlow;
import com.aliyuncs.cloudcallcenter.model.v20170705.ListPhoneNumbersResponse.PhoneNumber.PrivacyNumber;
import com.aliyuncs.cloudcallcenter.model.v20170705.ListPhoneNumbersResponse.PhoneNumber.SkillGroup;
...
public class ListPhoneNumbersResponseUnmarshaller {
	...
	public static ListPhoneNumbersResponse unmarshall(ListPhoneNumbersResponse listPhoneNumbersResponse, UnmarshallerContext context) {
		...
		for (int i = 0; i < context.lengthValue("ListPhoneNumbersResponse.PhoneNumbers.Length"); i++) {
			...
			phoneNumber.setNumberCommodityStatus(context.integerValue("ListPhoneNumbersResponse.PhoneNumbers["+ i +"].NumberCommodityStatus"));
