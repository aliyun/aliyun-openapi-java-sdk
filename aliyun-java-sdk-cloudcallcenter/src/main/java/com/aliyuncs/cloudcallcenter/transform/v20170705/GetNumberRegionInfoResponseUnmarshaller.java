...
import com.aliyuncs.cloudcallcenter.model.v20170705.GetNumberRegionInfoResponse;
import com.aliyuncs.cloudcallcenter.model.v20170705.GetNumberRegionInfoResponse.PhoneNumber;
...
public class GetNumberRegionInfoResponseUnmarshaller {
	...
	public static GetNumberRegionInfoResponse unmarshall(GetNumberRegionInfoResponse getNumberRegionInfoResponse, UnmarshallerContext context) {
		...
		getNumberRegionInfoResponse.setHttpStatusCode(context.integerValue("GetNumberRegionInfoResponse.HttpStatusCode"));
