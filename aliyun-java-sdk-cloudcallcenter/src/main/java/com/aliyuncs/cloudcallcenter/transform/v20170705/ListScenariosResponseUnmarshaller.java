...
import com.aliyuncs.cloudcallcenter.model.v20170705.ListScenariosResponse;
import com.aliyuncs.cloudcallcenter.model.v20170705.ListScenariosResponse.Scenario;
import com.aliyuncs.cloudcallcenter.model.v20170705.ListScenariosResponse.Scenario.KeyValuePair;
import com.aliyuncs.cloudcallcenter.model.v20170705.ListScenariosResponse.Scenario.Strategy;
import com.aliyuncs.cloudcallcenter.model.v20170705.ListScenariosResponse.Scenario.Strategy.TimeFrame;
import com.aliyuncs.cloudcallcenter.model.v20170705.ListScenariosResponse.Scenario.Survey;
import com.aliyuncs.cloudcallcenter.model.v20170705.ListScenariosResponse.Scenario.Survey.IntentNode;
...
public class ListScenariosResponseUnmarshaller {
	...
	public static ListScenariosResponse unmarshall(ListScenariosResponse listScenariosResponse, UnmarshallerContext context) {
		...
		for (int i = 0; i < context.lengthValue("ListScenariosResponse.Scenarios.Length"); i++) {
			...
			scenario.setBeebotVersion(context.stringValue("ListScenariosResponse.Scenarios["+ i +"].BeebotVersion"));
