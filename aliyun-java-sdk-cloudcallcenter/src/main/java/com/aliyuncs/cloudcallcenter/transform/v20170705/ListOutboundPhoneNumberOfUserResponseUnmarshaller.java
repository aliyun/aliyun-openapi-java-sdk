...
import com.aliyuncs.cloudcallcenter.model.v20170705.ListOutboundPhoneNumberOfUserResponse;
import com.aliyuncs.cloudcallcenter.model.v20170705.ListOutboundPhoneNumberOfUserResponse.PhoneNumber;
import com.aliyuncs.cloudcallcenter.model.v20170705.ListOutboundPhoneNumberOfUserResponse.PhoneNumber.PrivacyNumber;
...
public class ListOutboundPhoneNumberOfUserResponseUnmarshaller {
	...
	public static ListOutboundPhoneNumberOfUserResponse unmarshall(ListOutboundPhoneNumberOfUserResponse listOutboundPhoneNumberOfUserResponse, UnmarshallerContext context) {
		...
		for (int i = 0; i < context.lengthValue("ListOutboundPhoneNumberOfUserResponse.OutboundPhoneNumbers.Length"); i++) {
			...
			privacyNumber.setRegionNameCity(context.stringValue("ListOutboundPhoneNumberOfUserResponse.OutboundPhoneNumbers["+ i +"].PrivacyNumber.RegionNameCity"));
