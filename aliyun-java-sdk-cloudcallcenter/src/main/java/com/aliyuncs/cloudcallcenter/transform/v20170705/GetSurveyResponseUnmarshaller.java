...
import com.aliyuncs.cloudcallcenter.model.v20170705.GetSurveyResponse;
import com.aliyuncs.cloudcallcenter.model.v20170705.GetSurveyResponse.Survey;
import com.aliyuncs.cloudcallcenter.model.v20170705.GetSurveyResponse.Survey.AsrCustomModel;
import com.aliyuncs.cloudcallcenter.model.v20170705.GetSurveyResponse.Survey.Flow;
...
public class GetSurveyResponseUnmarshaller {
	...
	public static GetSurveyResponse unmarshall(GetSurveyResponse getSurveyResponse, UnmarshallerContext context) {
		...
		survey.setBeebotId(context.stringValue("GetSurveyResponse.Survey.BeebotId"));
		survey.setDebugBeebotId(context.stringValue("GetSurveyResponse.Survey.DebugBeebotId"));
