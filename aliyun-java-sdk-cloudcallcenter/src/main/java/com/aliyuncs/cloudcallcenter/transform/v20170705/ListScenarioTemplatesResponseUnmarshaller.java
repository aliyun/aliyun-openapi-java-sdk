...
import com.aliyuncs.cloudcallcenter.model.v20170705.ListScenarioTemplatesResponse;
import com.aliyuncs.cloudcallcenter.model.v20170705.ListScenarioTemplatesResponse.Scenario;
import com.aliyuncs.cloudcallcenter.model.v20170705.ListScenarioTemplatesResponse.Scenario.KeyValuePair;
import com.aliyuncs.cloudcallcenter.model.v20170705.ListScenarioTemplatesResponse.Scenario.Survey;
import com.aliyuncs.cloudcallcenter.model.v20170705.ListScenarioTemplatesResponse.Scenario.Survey.Flow;
import com.aliyuncs.cloudcallcenter.model.v20170705.ListScenarioTemplatesResponse.Scenario.Survey.IntentNode;
...
public class ListScenarioTemplatesResponseUnmarshaller {
	...
	public static ListScenarioTemplatesResponse unmarshall(ListScenarioTemplatesResponse listScenarioTemplatesResponse, UnmarshallerContext context) {
		...
		for (int i = 0; i < context.lengthValue("ListScenarioTemplatesResponse.ScenarioTemplates.Length"); i++) {
			...
			scenario.setBeebotVersion(context.stringValue("ListScenarioTemplatesResponse.ScenarioTemplates["+ i +"].BeebotVersion"));
