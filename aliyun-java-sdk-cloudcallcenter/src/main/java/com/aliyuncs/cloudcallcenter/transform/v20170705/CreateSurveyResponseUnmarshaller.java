...
import com.aliyuncs.cloudcallcenter.model.v20170705.CreateSurveyResponse;
import com.aliyuncs.cloudcallcenter.model.v20170705.CreateSurveyResponse.Survey;
import com.aliyuncs.cloudcallcenter.model.v20170705.CreateSurveyResponse.Survey.AsrCustomModel;
import com.aliyuncs.cloudcallcenter.model.v20170705.CreateSurveyResponse.Survey.Flow;
...
public class CreateSurveyResponseUnmarshaller {
	...
	public static CreateSurveyResponse unmarshall(CreateSurveyResponse createSurveyResponse, UnmarshallerContext context) {
		...
		survey.setBeebotId(context.stringValue("CreateSurveyResponse.Survey.BeebotId"));
