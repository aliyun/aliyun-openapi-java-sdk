...
import com.aliyuncs.cloudcallcenter.model.v20170705.CreateBatchJobsResponse;
import com.aliyuncs.cloudcallcenter.model.v20170705.CreateBatchJobsResponse.JobGroup;
import com.aliyuncs.cloudcallcenter.model.v20170705.CreateBatchJobsResponse.JobGroup.Strategy;
import com.aliyuncs.cloudcallcenter.model.v20170705.CreateBatchJobsResponse.JobGroup.Strategy.TimeFrame;
...
public class CreateBatchJobsResponseUnmarshaller {
	...
	public static CreateBatchJobsResponse unmarshall(CreateBatchJobsResponse createBatchJobsResponse, UnmarshallerContext context) {
		...
		for (int i = 0; i < context.lengthValue("CreateBatchJobsResponse.JobGroup.Strategy.WorkingTime.Length"); i++) {
			...
			timeFrame.setFrom(context.stringValue("CreateBatchJobsResponse.JobGroup.Strategy.WorkingTime["+ i +"].From"));
			timeFrame.setTo(context.stringValue("CreateBatchJobsResponse.JobGroup.Strategy.WorkingTime["+ i +"].To"));
