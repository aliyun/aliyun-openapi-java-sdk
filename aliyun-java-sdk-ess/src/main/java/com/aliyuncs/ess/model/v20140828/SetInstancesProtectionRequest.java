...
public class SetInstancesProtectionRequest extends RpcAcsRequest<SetInstancesProtectionResponse> {
	...
	public void setProtectedFromScaleIn(Boolean protectedFromScaleIn) {
		...
		if(protectedFromScaleIn != null){
			putQueryParameter("ProtectedFromScaleIn", protectedFromScaleIn.toString());
		}
	}

	@Override
	public Class<SetInstancesProtectionResponse> getResponseClass() {
		return SetInstancesProtectionResponse.class;
	}
