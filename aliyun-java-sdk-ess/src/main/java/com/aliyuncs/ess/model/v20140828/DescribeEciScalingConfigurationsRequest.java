 ...
 * @version 
 */
public class DescribeEciScalingConfigurationsRequest extends RpcAcsRequest<DescribeEciScalingConfigurationsResponse> {
	...
	public DescribeEciScalingConfigurationsRequest() {
		super("Ess", "2014-08-28", "DescribeEciScalingConfigurations", "ess");
	...
	@Override
	public Class<DescribeEciScalingConfigurationsResponse> getResponseClass() {
		return DescribeEciScalingConfigurationsResponse.class;
	}
