 ...
 * @version 
 */
public class ModifyEciScalingConfigurationRequest extends RpcAcsRequest<ModifyEciScalingConfigurationResponse> {
	...
	public ModifyEciScalingConfigurationRequest() {
		super("Ess", "2014-08-28", "ModifyEciScalingConfiguration", "ess");
	...
	public void setContainersUpdateType(String containersUpdateType) {
		this.containersUpdateType = containersUpdateType;
		if(containersUpdateType != null){
			putQueryParameter("ContainersUpdateType", containersUpdateType);
		}
	}
	...
	@Override
	public Class<ModifyEciScalingConfigurationResponse> getResponseClass() {
		return ModifyEciScalingConfigurationResponse.class;
	}
