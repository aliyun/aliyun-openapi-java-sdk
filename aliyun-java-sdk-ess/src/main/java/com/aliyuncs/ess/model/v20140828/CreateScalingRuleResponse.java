...
import com.aliyuncs.ess.transform.v20140828.CreateScalingRuleResponseUnmarshaller;
...
public class CreateScalingRuleResponse extends AcsResponse {
	...
	@Override
	public CreateScalingRuleResponse getInstance(UnmarshallerContext context) {
		return	CreateScalingRuleResponseUnmarshaller.unmarshall(this, context);
	}
}
