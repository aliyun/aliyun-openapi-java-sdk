 ...
 * @version 
 */
public class RollbackInstanceRefreshRequest extends RpcAcsRequest<RollbackInstanceRefreshResponse> {
	...
	public RollbackInstanceRefreshRequest() {
		super("Ess", "2014-08-28", "RollbackInstanceRefresh", "ess");
	...
	@Override
	public Class<RollbackInstanceRefreshResponse> getResponseClass() {
		return RollbackInstanceRefreshResponse.class;
	}
