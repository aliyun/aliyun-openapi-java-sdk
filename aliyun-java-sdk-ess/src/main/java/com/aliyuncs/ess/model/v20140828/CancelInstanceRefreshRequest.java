 ...
 * @version 
 */
public class CancelInstanceRefreshRequest extends RpcAcsRequest<CancelInstanceRefreshResponse> {
	...
	public CancelInstanceRefreshRequest() {
		super("Ess", "2014-08-28", "CancelInstanceRefresh", "ess");
	...
	@Override
	public Class<CancelInstanceRefreshResponse> getResponseClass() {
		return CancelInstanceRefreshResponse.class;
	}
