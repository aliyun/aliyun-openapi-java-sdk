...
public class DescribeScalingActivityDetailResponse extends AcsResponse {
	...
	@Override
	public DescribeScalingActivityDetailResponse getInstance(UnmarshallerContext context) {
		return	DescribeScalingActivityDetailResponseUnmarshaller.unmarshall(this, context);
	}
}
