 ...
 * @version 
 */
public class SuspendInstanceRefreshRequest extends RpcAcsRequest<SuspendInstanceRefreshResponse> {
	...
	public SuspendInstanceRefreshRequest() {
		super("Ess", "2014-08-28", "SuspendInstanceRefresh", "ess");
	...
	@Override
	public Class<SuspendInstanceRefreshResponse> getResponseClass() {
		return SuspendInstanceRefreshResponse.class;
	}
