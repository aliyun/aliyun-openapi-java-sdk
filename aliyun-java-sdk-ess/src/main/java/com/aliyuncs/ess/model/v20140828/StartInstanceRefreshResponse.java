...
import com.aliyuncs.ess.transform.v20140828.StartInstanceRefreshResponseUnmarshaller;
...
public class StartInstanceRefreshResponse extends AcsResponse {
	...
	@Override
	public StartInstanceRefreshResponse getInstance(UnmarshallerContext context) {
		return	StartInstanceRefreshResponseUnmarshaller.unmarshall(this, context);
	}
}
