...
public class Endpoint {
    public static HashMap<String, String> endpointMap = new HashMap<String, String>() {
        {
            put("cn-shanghai-internal-test-1", "ess.aliyuncs.com");
            put("cn-beijing-gov-1", "ess.aliyuncs.com");
            put("cn-shenzhen-su18-b01", "ess.aliyuncs.com");
            put("cn-beijing", "ess.aliyuncs.com");
            put("cn-shanghai-inner", "ess.aliyuncs.com");
            put("cn-shenzhen-st4-d01", "ess.aliyuncs.com");
            put("cn-haidian-cm12-c01", "ess.aliyuncs.com");
            put("cn-hangzhou-internal-prod-1", "ess.aliyuncs.com");
            put("cn-north-2-gov-1", "ess.aliyuncs.com");
            put("cn-yushanfang", "ess.aliyuncs.com");
            put("cn-qingdao", "ess.aliyuncs.com");
            put("cn-hongkong-finance-pop", "ess.aliyuncs.com");
            put("cn-qingdao-nebula", "ess.aliyuncs.com");
            put("cn-shanghai", "ess.aliyuncs.com");
            put("cn-shanghai-finance-1", "ess.aliyuncs.com");
            put("cn-hongkong", "ess.aliyuncs.com");
