 ...
 * @version 
 */
public class RunPreTrainServiceNewRequest extends RpcAcsRequest<RunPreTrainServiceNewResponse> {
	...
	public RunPreTrainServiceNewRequest() {
		super("nlp-automl", "2019-11-11", "RunPreTrainServiceNew");
	...
	@Override
	public Class<RunPreTrainServiceNewResponse> getResponseClass() {
		return RunPreTrainServiceNewResponse.class;
	}
