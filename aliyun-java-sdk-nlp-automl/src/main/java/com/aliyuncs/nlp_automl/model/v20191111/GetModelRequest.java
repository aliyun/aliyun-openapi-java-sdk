 ...
 * @version 
 */
public class GetModelRequest extends RpcAcsRequest<GetModelResponse> {
	...
	public GetModelRequest() {
		super("nlp-automl", "2019-11-11", "GetModel", "nlpautoml");
	...
	@Override
	public Class<GetModelResponse> getResponseClass() {
		return GetModelResponse.class;
	}
