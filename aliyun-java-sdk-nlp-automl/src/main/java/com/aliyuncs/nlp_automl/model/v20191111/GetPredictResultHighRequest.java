 ...
 * @version 
 */
public class GetPredictResultHighRequest extends RpcAcsRequest<GetPredictResultHighResponse> {
	...
	public GetPredictResultHighRequest() {
		super("nlp-automl", "2019-11-11", "GetPredictResultHigh");
	...
	@Override
	public Class<GetPredictResultHighResponse> getResponseClass() {
		return GetPredictResultHighResponse.class;
	}
