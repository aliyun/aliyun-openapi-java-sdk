...
import com.aliyuncs.nlp_automl.transform.v20191111.CreateAsyncPredictResponseUnmarshaller;
...
public class CreateAsyncPredictResponse extends AcsResponse {
	...
	@Override
	public CreateAsyncPredictResponse getInstance(UnmarshallerContext context) {
		return	CreateAsyncPredictResponseUnmarshaller.unmarshall(this, context);
	}
