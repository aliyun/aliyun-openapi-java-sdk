 ...
 * @version 
 */
public class DescribeAnycastPopLocationsRequest extends RpcAcsRequest<DescribeAnycastPopLocationsResponse> {
	...
	@Override
	public Class<DescribeAnycastPopLocationsResponse> getResponseClass() {
		return DescribeAnycastPopLocationsResponse.class;
	}
