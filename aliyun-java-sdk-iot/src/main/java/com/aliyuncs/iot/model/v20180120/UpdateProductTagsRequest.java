 ...
 * @version 
 */
public class UpdateProductTagsRequest extends RpcAcsRequest<UpdateProductTagsResponse> {
	...
	@Override
	public Class<UpdateProductTagsResponse> getResponseClass() {
		return UpdateProductTagsResponse.class;
	}
