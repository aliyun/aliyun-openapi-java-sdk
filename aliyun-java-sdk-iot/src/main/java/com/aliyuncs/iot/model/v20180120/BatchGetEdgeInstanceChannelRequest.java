 ...
 * @version 
 */
public class BatchGetEdgeInstanceChannelRequest extends RpcAcsRequest<BatchGetEdgeInstanceChannelResponse> {
	...
	@Override
	public Class<BatchGetEdgeInstanceChannelResponse> getResponseClass() {
		return BatchGetEdgeInstanceChannelResponse.class;
	}
