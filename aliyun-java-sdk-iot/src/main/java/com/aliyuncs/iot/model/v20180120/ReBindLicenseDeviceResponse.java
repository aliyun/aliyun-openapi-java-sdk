...
import com.aliyuncs.iot.transform.v20180120.ReBindLicenseDeviceResponseUnmarshaller;
...
public class ReBindLicenseDeviceResponse extends AcsResponse {
	...
	@Override
	public ReBindLicenseDeviceResponse getInstance(UnmarshallerContext context) {
		return	ReBindLicenseDeviceResponseUnmarshaller.unmarshall(this, context);
	}
}
