...
import com.aliyuncs.iot.transform.v20180120.BatchCheckImportDeviceResponseUnmarshaller;
...
public class BatchCheckImportDeviceResponse extends AcsResponse {
	...
	@Override
	public BatchCheckImportDeviceResponse getInstance(UnmarshallerContext context) {
		return	BatchCheckImportDeviceResponseUnmarshaller.unmarshall(this, context);
	}
