 ...
 * @version 
 */
public class ListParserDestinationRequest extends RpcAcsRequest<ListParserDestinationResponse> {
	...
	@Override
	public Class<ListParserDestinationResponse> getResponseClass() {
		return ListParserDestinationResponse.class;
	}
