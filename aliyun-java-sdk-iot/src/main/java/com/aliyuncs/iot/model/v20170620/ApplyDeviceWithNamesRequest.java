 ...
 * @version 
 */
public class ApplyDeviceWithNamesRequest extends RoaAcsRequest<ApplyDeviceWithNamesResponse> {
	
	public ApplyDeviceWithNamesRequest() {
		super("Iot", "2017-06-20", "ApplyDeviceWithNames", "iot");
		setProtocol(ProtocolType.HTTPS);
		setUriPattern("/applyDeviceWithNames/[ProductKey]");
