...
import com.aliyuncs.iot.transform.v20180120.BatchGetEdgeInstanceDeviceConfigResponseUnmarshaller;
...
public class BatchGetEdgeInstanceDeviceConfigResponse extends AcsResponse {
	...
	@Override
	public BatchGetEdgeInstanceDeviceConfigResponse getInstance(UnmarshallerContext context) {
		return	BatchGetEdgeInstanceDeviceConfigResponseUnmarshaller.unmarshall(this, context);
	}
