...
public class QueryEdgeDriverVersionResponse extends AcsResponse {
	...
	public static class Data {
		...
		public void setDriverVersionList(List<DriverVersion> driverVersionList) {
	...
	@Override
	public QueryEdgeDriverVersionResponse getInstance(UnmarshallerContext context) {
		return	QueryEdgeDriverVersionResponseUnmarshaller.unmarshall(this, context);
	}
