 ...
 * @version 
 */
public class QuerySchedulePeriodListRequest extends RpcAcsRequest<QuerySchedulePeriodListResponse> {
	...
	@Override
	public Class<QuerySchedulePeriodListResponse> getResponseClass() {
		return QuerySchedulePeriodListResponse.class;
	}
