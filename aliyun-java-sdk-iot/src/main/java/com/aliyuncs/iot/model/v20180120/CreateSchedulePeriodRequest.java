 ...
 * @version 
 */
public class CreateSchedulePeriodRequest extends RpcAcsRequest<CreateSchedulePeriodResponse> {
	...
	@Override
	public Class<CreateSchedulePeriodResponse> getResponseClass() {
		return CreateSchedulePeriodResponse.class;
	}
