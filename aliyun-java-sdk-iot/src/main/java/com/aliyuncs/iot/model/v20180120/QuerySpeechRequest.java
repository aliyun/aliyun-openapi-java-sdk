 ...
 * @version 
 */
public class QuerySpeechRequest extends RpcAcsRequest<QuerySpeechResponse> {
	   

	private String iotInstanceId;

	private String speechCode;
	public QuerySpeechRequest() {
		super("Iot", "2018-01-20", "QuerySpeech", "iot");
	...
	@Override
	public Class<QuerySpeechResponse> getResponseClass() {
		return QuerySpeechResponse.class;
	}
