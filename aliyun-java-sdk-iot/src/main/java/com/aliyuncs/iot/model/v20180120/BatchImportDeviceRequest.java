 ...
 * @version 
 */
public class BatchImportDeviceRequest extends RpcAcsRequest<BatchImportDeviceResponse> {
	...
	public BatchImportDeviceRequest() {
		super("Iot", "2018-01-20", "BatchImportDevice", "iot");
	...
	@Override
	public Class<BatchImportDeviceResponse> getResponseClass() {
		return BatchImportDeviceResponse.class;
	}
