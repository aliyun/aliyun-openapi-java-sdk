...
import com.aliyuncs.iot.transform.v20180120.CreateEdgeOssPreSignedAddressResponseUnmarshaller;
...
public class CreateEdgeOssPreSignedAddressResponse extends AcsResponse {
	...
	@Override
	public CreateEdgeOssPreSignedAddressResponse getInstance(UnmarshallerContext context) {
		return	CreateEdgeOssPreSignedAddressResponseUnmarshaller.unmarshall(this, context);
	}
