...
import com.aliyuncs.iot.transform.v20180120.BatchDeleteDeviceGroupRelationsResponseUnmarshaller;
...
public class BatchDeleteDeviceGroupRelationsResponse extends AcsResponse {
	...
	@Override
	public BatchDeleteDeviceGroupRelationsResponse getInstance(UnmarshallerContext context) {
		return	BatchDeleteDeviceGroupRelationsResponseUnmarshaller.unmarshall(this, context);
	}
}
