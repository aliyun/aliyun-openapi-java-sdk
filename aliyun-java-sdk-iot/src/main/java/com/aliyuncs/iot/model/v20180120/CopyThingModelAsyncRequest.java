 ...
 * @version 
 */
public class CopyThingModelAsyncRequest extends RpcAcsRequest<CopyThingModelAsyncResponse> {
	...
	public CopyThingModelAsyncRequest() {
		super("Iot", "2018-01-20", "CopyThingModelAsync", "iot");
	...
	@Override
	public Class<CopyThingModelAsyncResponse> getResponseClass() {
		return CopyThingModelAsyncResponse.class;
	}
