 ...
 * @version 
 */
public class AddPowerStationRequest extends RpcAcsRequest<AddPowerStationResponse> {
	...
	public AddPowerStationRequest() {
		super("Iot", "2018-01-20", "AddPowerStation", "iot");
	...
	@Override
	public Class<AddPowerStationResponse> getResponseClass() {
		return AddPowerStationResponse.class;
	}
