 ...
 * @version 
 */
public class UpdateEdgeInstanceMessageRoutingRequest extends RpcAcsRequest<UpdateEdgeInstanceMessageRoutingResponse> {
	...
	@Override
	public Class<UpdateEdgeInstanceMessageRoutingResponse> getResponseClass() {
		return UpdateEdgeInstanceMessageRoutingResponse.class;
	}
