 ...
 * @version 
 */
public class DeleteTopicConfigRequest extends RpcAcsRequest<DeleteTopicConfigResponse> {
	...
	@Override
	public Class<DeleteTopicConfigResponse> getResponseClass() {
		return DeleteTopicConfigResponse.class;
	}
