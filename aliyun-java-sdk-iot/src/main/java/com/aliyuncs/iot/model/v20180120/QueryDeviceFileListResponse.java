...
import com.aliyuncs.iot.transform.v20180120.QueryDeviceFileListResponseUnmarshaller;
...
public class QueryDeviceFileListResponse extends AcsResponse {
	...
	public void setData(List<FileSummary> data) {
		this.data = data;
	}
	...
	@Override
	public QueryDeviceFileListResponse getInstance(UnmarshallerContext context) {
		return	QueryDeviceFileListResponseUnmarshaller.unmarshall(this, context);
	}
}
