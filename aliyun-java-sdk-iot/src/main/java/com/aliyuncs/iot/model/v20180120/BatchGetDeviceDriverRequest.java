 ...
 * @version 
 */
public class BatchGetDeviceDriverRequest extends RpcAcsRequest<BatchGetDeviceDriverResponse> {
	...
	@Override
	public Class<BatchGetDeviceDriverResponse> getResponseClass() {
		return BatchGetDeviceDriverResponse.class;
	}
