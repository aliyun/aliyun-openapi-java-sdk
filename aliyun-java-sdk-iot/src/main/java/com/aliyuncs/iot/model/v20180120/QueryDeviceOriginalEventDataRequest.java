 ...
 * @version 
 */
public class QueryDeviceOriginalEventDataRequest extends RpcAcsRequest<QueryDeviceOriginalEventDataResponse> {
	...
	@Override
	public Class<QueryDeviceOriginalEventDataResponse> getResponseClass() {
		return QueryDeviceOriginalEventDataResponse.class;
	}
