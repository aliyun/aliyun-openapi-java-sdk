 ...
 * @version 
 */
public class CreateSubscribeRelationRequest extends RpcAcsRequest<CreateSubscribeRelationResponse> {
	...
	@Override
	public Class<CreateSubscribeRelationResponse> getResponseClass() {
		return CreateSubscribeRelationResponse.class;
	}
