 ...
 * @version 
 */
public class CreateTopicConfigRequest extends RpcAcsRequest<CreateTopicConfigResponse> {
	...
	@Override
	public Class<CreateTopicConfigResponse> getResponseClass() {
		return CreateTopicConfigResponse.class;
	}
