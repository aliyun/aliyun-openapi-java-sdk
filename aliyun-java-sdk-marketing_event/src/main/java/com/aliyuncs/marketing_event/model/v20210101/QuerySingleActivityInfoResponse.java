...
import com.aliyuncs.marketing_event.transform.v20210101.QuerySingleActivityInfoResponseUnmarshaller;
 ...
 * @version 
 */
public class QuerySingleActivityInfoResponse extends AcsResponse {
	...
	@Override
	public QuerySingleActivityInfoResponse getInstance(UnmarshallerContext context) {
		return	QuerySingleActivityInfoResponseUnmarshaller.unmarshall(this, context);
	}
