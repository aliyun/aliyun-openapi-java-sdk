 ...
 * @version 
 */
public class ListAuthenticatorOpsLogsRequest extends RpcAcsRequest<ListAuthenticatorOpsLogsResponse> {
	...
	@Override
	public Class<ListAuthenticatorOpsLogsResponse> getResponseClass() {
		return ListAuthenticatorOpsLogsResponse.class;
	}
