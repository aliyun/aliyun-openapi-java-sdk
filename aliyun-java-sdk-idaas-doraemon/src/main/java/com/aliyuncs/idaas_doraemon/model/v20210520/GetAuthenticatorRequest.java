 ...
 * @version 
 */
public class GetAuthenticatorRequest extends RpcAcsRequest<GetAuthenticatorResponse> {
	...
	@Override
	public Class<GetAuthenticatorResponse> getResponseClass() {
		return GetAuthenticatorResponse.class;
	}
