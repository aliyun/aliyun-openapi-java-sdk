 ...
 * @version 
 */
public class DeregisterAuthenticatorRequest extends RpcAcsRequest<DeregisterAuthenticatorResponse> {
	...
	@Override
	public Class<DeregisterAuthenticatorResponse> getResponseClass() {
		return DeregisterAuthenticatorResponse.class;
	}
