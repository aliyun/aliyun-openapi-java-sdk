...
public class ListAuthenticatorOpsLogsResponse extends AcsResponse {
	...
	@Override
	public ListAuthenticatorOpsLogsResponse getInstance(UnmarshallerContext context) {
		return	ListAuthenticatorOpsLogsResponseUnmarshaller.unmarshall(this, context);
	}
