...
import com.aliyuncs.sas.model.v20181203.DescribeUuidsByVulNamesResponse.MachineInfoStatistic;
...
public class DescribeUuidsByVulNamesResponseUnmarshaller {
	...
	public static DescribeUuidsByVulNamesResponse unmarshall(DescribeUuidsByVulNamesResponse describeUuidsByVulNamesResponse, UnmarshallerContext _ctx) {
		...
		describeUuidsByVulNamesResponse.setMachineInfoStatistics(machineInfoStatistics);
