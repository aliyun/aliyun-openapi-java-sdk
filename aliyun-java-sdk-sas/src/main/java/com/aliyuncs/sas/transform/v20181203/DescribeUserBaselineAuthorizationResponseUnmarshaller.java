...
public class DescribeUserBaselineAuthorizationResponseUnmarshaller {
	...
	public static DescribeUserBaselineAuthorizationResponse unmarshall(DescribeUserBaselineAuthorizationResponse describeUserBaselineAuthorizationResponse, UnmarshallerContext context) {
		
		describeUserBaselineAuthorizationResponse.setRequestId(context.stringValue("DescribeUserBaselineAuthorizationResponse.RequestId"));

		UserBaselineAuthorization userBaselineAuthorization = new UserBaselineAuthorization();
		userBaselineAuthorization.setStatus(context.integerValue("DescribeUserBaselineAuthorizationResponse.UserBaselineAuthorization.Status"));
