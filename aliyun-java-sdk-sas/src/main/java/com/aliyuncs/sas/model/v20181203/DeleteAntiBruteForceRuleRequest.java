 ...
 * @version 
 */
public class DeleteAntiBruteForceRuleRequest extends RpcAcsRequest<DeleteAntiBruteForceRuleResponse> {
	...
	@Override
	public Class<DeleteAntiBruteForceRuleResponse> getResponseClass() {
		return DeleteAntiBruteForceRuleResponse.class;
	}
