 ...
 * @version 
 */
public class ModifyWebLockStartRequest extends RpcAcsRequest<ModifyWebLockStartResponse> {
	...
	@Override
	public Class<ModifyWebLockStartResponse> getResponseClass() {
		return ModifyWebLockStartResponse.class;
	}
