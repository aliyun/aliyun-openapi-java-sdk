 ...
 * @version 
 */
public class DescribeRiskListCheckResultRequest extends RpcAcsRequest<DescribeRiskListCheckResultResponse> {
	...
	@Override
	public Class<DescribeRiskListCheckResultResponse> getResponseClass() {
		return DescribeRiskListCheckResultResponse.class;
	}
