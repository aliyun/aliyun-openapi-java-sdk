...
import com.aliyuncs.sas.transform.v20181203.DescribeImageSensitiveFileByKeyResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeImageSensitiveFileByKeyResponse extends AcsResponse {
	...
	@Override
	public DescribeImageSensitiveFileByKeyResponse getInstance(UnmarshallerContext context) {
		return	DescribeImageSensitiveFileByKeyResponseUnmarshaller.unmarshall(this, context);
	}
