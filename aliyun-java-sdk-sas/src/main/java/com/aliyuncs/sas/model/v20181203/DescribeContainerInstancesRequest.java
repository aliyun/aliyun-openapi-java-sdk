 ...
 * @version 
 */
public class DescribeContainerInstancesRequest extends RpcAcsRequest<DescribeContainerInstancesResponse> {
	...
	public DescribeContainerInstancesRequest() {
		super("Sas", "2018-12-03", "DescribeContainerInstances", "sas");
