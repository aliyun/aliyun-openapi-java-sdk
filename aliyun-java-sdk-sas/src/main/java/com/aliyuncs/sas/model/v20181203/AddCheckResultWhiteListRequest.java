 ...
 * @version 
 */
public class AddCheckResultWhiteListRequest extends RpcAcsRequest<AddCheckResultWhiteListResponse> {
	...
	@Override
	public Class<AddCheckResultWhiteListResponse> getResponseClass() {
		return AddCheckResultWhiteListResponse.class;
	}
