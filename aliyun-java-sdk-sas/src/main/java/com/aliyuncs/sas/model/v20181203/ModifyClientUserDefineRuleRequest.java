 ...
 * @version 
 */
public class ModifyClientUserDefineRuleRequest extends RpcAcsRequest<ModifyClientUserDefineRuleResponse> {
	...
	@Override
	public Class<ModifyClientUserDefineRuleResponse> getResponseClass() {
		return ModifyClientUserDefineRuleResponse.class;
	}
