...
public class ModifyRiskSingleResultStatusRequest extends RpcAcsRequest<ModifyRiskSingleResultStatusResponse> {
	...
	public ModifyRiskSingleResultStatusRequest() {
		super("Sas", "2018-12-03", "ModifyRiskSingleResultStatus");
	...
	@Override
	public Class<ModifyRiskSingleResultStatusResponse> getResponseClass() {
		return ModifyRiskSingleResultStatusResponse.class;
	}
