...
import com.aliyuncs.sas.transform.v20181203.GetClusterCheckItemWarningStatisticsResponseUnmarshaller;
 ...
 * @version 
 */
public class GetClusterCheckItemWarningStatisticsResponse extends AcsResponse {
	...
	@Override
	public GetClusterCheckItemWarningStatisticsResponse getInstance(UnmarshallerContext context) {
		return	GetClusterCheckItemWarningStatisticsResponseUnmarshaller.unmarshall(this, context);
	}
