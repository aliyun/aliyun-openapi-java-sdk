 ...
 * @version 
 */
public class ModifyCycleTaskRequest extends RpcAcsRequest<ModifyCycleTaskResponse> {
	...
	@Override
	public Class<ModifyCycleTaskResponse> getResponseClass() {
		return ModifyCycleTaskResponse.class;
	}
