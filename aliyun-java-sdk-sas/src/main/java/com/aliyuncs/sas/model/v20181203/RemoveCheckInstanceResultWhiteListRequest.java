 ...
 * @version 
 */
public class RemoveCheckInstanceResultWhiteListRequest extends RpcAcsRequest<RemoveCheckInstanceResultWhiteListResponse> {
	...
	@Override
	public Class<RemoveCheckInstanceResultWhiteListResponse> getResponseClass() {
		return RemoveCheckInstanceResultWhiteListResponse.class;
	}
