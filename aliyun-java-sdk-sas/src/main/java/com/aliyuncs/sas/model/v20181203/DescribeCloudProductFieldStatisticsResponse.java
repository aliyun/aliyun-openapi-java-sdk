...
public class DescribeCloudProductFieldStatisticsResponse extends AcsResponse {
	...
	@Override
	public DescribeCloudProductFieldStatisticsResponse getInstance(UnmarshallerContext context) {
		return	DescribeCloudProductFieldStatisticsResponseUnmarshaller.unmarshall(this, context);
	}
