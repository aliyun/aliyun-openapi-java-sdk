 ...
 * @version 
 */
public class GetHoneypotPresetRequest extends RpcAcsRequest<GetHoneypotPresetResponse> {
	...
	@Override
	public Class<GetHoneypotPresetResponse> getResponseClass() {
		return GetHoneypotPresetResponse.class;
	}
