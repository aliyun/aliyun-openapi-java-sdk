 ...
 * @version 
 */
public class GetFileDetectResultRequest extends RpcAcsRequest<GetFileDetectResultResponse> {
	...
	@Override
	public Class<GetFileDetectResultResponse> getResponseClass() {
		return GetFileDetectResultResponse.class;
	}
