 ...
 * @version 
 */
public class ListSystemClientRulesRequest extends RpcAcsRequest<ListSystemClientRulesResponse> {
	...
	public void setIsContainer(Integer isContainer) {
		...
		if(isContainer != null){
			putQueryParameter("IsContainer", isContainer.toString());
		}
	}
	...
	@Override
	public Class<ListSystemClientRulesResponse> getResponseClass() {
		return ListSystemClientRulesResponse.class;
	}
