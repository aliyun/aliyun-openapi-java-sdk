 ...
 * @version 
 */
public class DescribeRiskCheckSummaryRequest extends RpcAcsRequest<DescribeRiskCheckSummaryResponse> {
	...
	@Override
	public Class<DescribeRiskCheckSummaryResponse> getResponseClass() {
		return DescribeRiskCheckSummaryResponse.class;
	}
