...
public class DescribePropertyCronItemRequest extends RpcAcsRequest<DescribePropertyCronItemResponse> {
	...
	public DescribePropertyCronItemRequest() {
		super("Sas", "2018-12-03", "DescribePropertyCronItem", "sas");
	...
	@Override
	public Class<DescribePropertyCronItemResponse> getResponseClass() {
		return DescribePropertyCronItemResponse.class;
	}
