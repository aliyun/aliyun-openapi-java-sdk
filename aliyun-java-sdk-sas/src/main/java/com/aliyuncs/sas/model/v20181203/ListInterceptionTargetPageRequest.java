 ...
 * @version 
 */
public class ListInterceptionTargetPageRequest extends RpcAcsRequest<ListInterceptionTargetPageResponse> {
	...
	@Override
	public Class<ListInterceptionTargetPageResponse> getResponseClass() {
		return ListInterceptionTargetPageResponse.class;
	}
