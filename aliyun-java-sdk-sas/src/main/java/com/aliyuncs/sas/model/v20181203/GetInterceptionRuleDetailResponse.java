...
import com.aliyuncs.sas.transform.v20181203.GetInterceptionRuleDetailResponseUnmarshaller;
 ...
 * @version 
 */
public class GetInterceptionRuleDetailResponse extends AcsResponse {
	...
	public void setInterceptionRuleDetail(InterceptionRuleDetail interceptionRuleDetail) {
		this.interceptionRuleDetail = interceptionRuleDetail;
	}

	public static class InterceptionRuleDetail {
	...
	@Override
	public GetInterceptionRuleDetailResponse getInstance(UnmarshallerContext context) {
		return	GetInterceptionRuleDetailResponseUnmarshaller.unmarshall(this, context);
	}
