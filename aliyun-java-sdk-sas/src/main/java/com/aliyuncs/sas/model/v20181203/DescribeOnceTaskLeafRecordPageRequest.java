 ...
 * @version 
 */
public class DescribeOnceTaskLeafRecordPageRequest extends RpcAcsRequest<DescribeOnceTaskLeafRecordPageResponse> {
	...
	public void setRelateInfo(Boolean relateInfo) {
		...
		if(relateInfo != null){
			putQueryParameter("RelateInfo", relateInfo.toString());
		}
	}
	...
	@Override
	public Class<DescribeOnceTaskLeafRecordPageResponse> getResponseClass() {
		return DescribeOnceTaskLeafRecordPageResponse.class;
	}
