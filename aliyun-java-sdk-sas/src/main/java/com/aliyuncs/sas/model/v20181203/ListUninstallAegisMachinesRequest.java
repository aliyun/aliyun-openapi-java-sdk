 ...
 * @version 
 */
public class ListUninstallAegisMachinesRequest extends RpcAcsRequest<ListUninstallAegisMachinesResponse> {
	...
	@Override
	public Class<ListUninstallAegisMachinesResponse> getResponseClass() {
		return ListUninstallAegisMachinesResponse.class;
	}
