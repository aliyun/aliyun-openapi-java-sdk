 ...
 * @version 
 */
public class DescribeCommonOverallConfigListRequest extends RpcAcsRequest<DescribeCommonOverallConfigListResponse> {
	...
	@Override
	public Class<DescribeCommonOverallConfigListResponse> getResponseClass() {
		return DescribeCommonOverallConfigListResponse.class;
	}
