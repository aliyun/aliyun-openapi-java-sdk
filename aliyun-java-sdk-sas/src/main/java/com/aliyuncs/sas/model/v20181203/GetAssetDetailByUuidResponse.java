...
import com.aliyuncs.sas.transform.v20181203.GetAssetDetailByUuidResponseUnmarshaller;
 ...
 * @version 
 */
public class GetAssetDetailByUuidResponse extends AcsResponse {
	...
	public static class AssetDetail {
		...
		public static class DiskInfo {
			...
			public void setUseSizeByte(Long useSizeByte) {
	...
	@Override
	public GetAssetDetailByUuidResponse getInstance(UnmarshallerContext context) {
		return	GetAssetDetailByUuidResponseUnmarshaller.unmarshall(this, context);
	}
