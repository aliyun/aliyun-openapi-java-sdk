...
public class DescribeRiskListCheckResultResponse extends AcsResponse {
	...
	@Override
	public DescribeRiskListCheckResultResponse getInstance(UnmarshallerContext context) {
		return	DescribeRiskListCheckResultResponseUnmarshaller.unmarshall(this, context);
	}
