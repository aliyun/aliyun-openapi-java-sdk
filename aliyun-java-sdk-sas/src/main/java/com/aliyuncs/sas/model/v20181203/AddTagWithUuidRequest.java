 ...
 * @version 
 */
public class AddTagWithUuidRequest extends RpcAcsRequest<AddTagWithUuidResponse> {
	...
	@Override
	public Class<AddTagWithUuidResponse> getResponseClass() {
		return AddTagWithUuidResponse.class;
	}
