...
public class DescribePropertyProcItemResponse extends AcsResponse {
	...
	public void setPropertyItems(List<PropertyProcItem> propertyItems) {
	...
	@Override
	public DescribePropertyProcItemResponse getInstance(UnmarshallerContext context) {
		return	DescribePropertyProcItemResponseUnmarshaller.unmarshall(this, context);
	}
