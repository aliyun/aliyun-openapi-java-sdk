 ...
 * @version 
 */
public class UpdateHoneypotRequest extends RpcAcsRequest<UpdateHoneypotResponse> {
	...
	@Override
	public Class<UpdateHoneypotResponse> getResponseClass() {
		return UpdateHoneypotResponse.class;
	}
