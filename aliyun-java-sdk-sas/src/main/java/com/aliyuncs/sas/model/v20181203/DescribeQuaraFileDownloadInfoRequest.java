 ...
 * @version 
 */
public class DescribeQuaraFileDownloadInfoRequest extends RpcAcsRequest<DescribeQuaraFileDownloadInfoResponse> {
	...
	@Override
	public Class<DescribeQuaraFileDownloadInfoResponse> getResponseClass() {
		return DescribeQuaraFileDownloadInfoResponse.class;
	}
