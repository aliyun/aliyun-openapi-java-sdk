 ...
 * @version 
 */
public class OperateVirusEventsRequest extends RpcAcsRequest<OperateVirusEventsResponse> {
	...
	@Override
	public Class<OperateVirusEventsResponse> getResponseClass() {
		return OperateVirusEventsResponse.class;
	}
