 ...
 * @version 
 */
public class VerifyCheckInstanceResultRequest extends RpcAcsRequest<VerifyCheckInstanceResultResponse> {
	...
	@Override
	public Class<VerifyCheckInstanceResultResponse> getResponseClass() {
		return VerifyCheckInstanceResultResponse.class;
	}
