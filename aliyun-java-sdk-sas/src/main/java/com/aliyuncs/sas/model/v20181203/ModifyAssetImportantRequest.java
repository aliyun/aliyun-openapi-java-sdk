 ...
 * @version 
 */
public class ModifyAssetImportantRequest extends RpcAcsRequest<ModifyAssetImportantResponse> {
	...
	public void setImportantCode(Integer importantCode) {
		...
		if(importantCode != null){
			putQueryParameter("ImportantCode", importantCode.toString());
		}
	}
	...
	@Override
	public Class<ModifyAssetImportantResponse> getResponseClass() {
		return ModifyAssetImportantResponse.class;
	}
