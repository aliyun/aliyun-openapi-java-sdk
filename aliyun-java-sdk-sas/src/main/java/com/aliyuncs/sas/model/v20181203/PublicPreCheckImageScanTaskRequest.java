 ...
 * @version 
 */
public class PublicPreCheckImageScanTaskRequest extends RpcAcsRequest<PublicPreCheckImageScanTaskResponse> {
	...
	@Override
	public Class<PublicPreCheckImageScanTaskResponse> getResponseClass() {
		return PublicPreCheckImageScanTaskResponse.class;
	}
