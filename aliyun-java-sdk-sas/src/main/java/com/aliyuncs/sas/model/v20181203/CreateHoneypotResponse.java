...
import com.aliyuncs.sas.transform.v20181203.CreateHoneypotResponseUnmarshaller;
 ...
 * @version 
 */
public class CreateHoneypotResponse extends AcsResponse {
	...
	@Override
	public CreateHoneypotResponse getInstance(UnmarshallerContext context) {
		return	CreateHoneypotResponseUnmarshaller.unmarshall(this, context);
	}
