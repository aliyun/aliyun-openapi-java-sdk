 ...
 * @version 
 */
public class ListClusterCnnfStatusDetailRequest extends RpcAcsRequest<ListClusterCnnfStatusDetailResponse> {
	...
	@Override
	public Class<ListClusterCnnfStatusDetailResponse> getResponseClass() {
		return ListClusterCnnfStatusDetailResponse.class;
	}
