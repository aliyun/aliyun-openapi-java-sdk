 ...
 * @version 
 */
public class DisableBruteForceRecordRequest extends RpcAcsRequest<DisableBruteForceRecordResponse> {
	...
	@Override
	public Class<DisableBruteForceRecordResponse> getResponseClass() {
		return DisableBruteForceRecordResponse.class;
	}
