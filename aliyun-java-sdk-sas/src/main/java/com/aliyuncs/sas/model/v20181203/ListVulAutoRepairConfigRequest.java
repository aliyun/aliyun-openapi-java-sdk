...
public class ListVulAutoRepairConfigRequest extends RpcAcsRequest<ListVulAutoRepairConfigResponse> {
	...
	public ListVulAutoRepairConfigRequest() {
		super("Sas", "2018-12-03", "ListVulAutoRepairConfig", "sas");
	...
	@Override
	public Class<ListVulAutoRepairConfigResponse> getResponseClass() {
		return ListVulAutoRepairConfigResponse.class;
	}
