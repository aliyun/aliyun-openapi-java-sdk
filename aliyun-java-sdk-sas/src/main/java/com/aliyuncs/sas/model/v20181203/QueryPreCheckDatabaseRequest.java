 ...
 * @version 
 */
public class QueryPreCheckDatabaseRequest extends RpcAcsRequest<QueryPreCheckDatabaseResponse> {
	...
	@Override
	public Class<QueryPreCheckDatabaseResponse> getResponseClass() {
		return QueryPreCheckDatabaseResponse.class;
	}
