...
import com.aliyuncs.sas.transform.v20181203.GetRulesCountResponseUnmarshaller;
 ...
 * @version 
 */
public class GetRulesCountResponse extends AcsResponse {
	...
	@Override
	public GetRulesCountResponse getInstance(UnmarshallerContext context) {
		return	GetRulesCountResponseUnmarshaller.unmarshall(this, context);
	}
