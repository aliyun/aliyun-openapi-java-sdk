 ...
 * @version 
 */
public class CreateCustomBlockRecordRequest extends RpcAcsRequest<CreateCustomBlockRecordResponse> {
	...
	@Override
	public Class<CreateCustomBlockRecordResponse> getResponseClass() {
		return CreateCustomBlockRecordResponse.class;
	}
