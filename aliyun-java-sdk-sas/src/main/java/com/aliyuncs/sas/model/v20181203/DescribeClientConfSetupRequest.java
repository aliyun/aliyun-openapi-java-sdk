...
public class DescribeClientConfSetupRequest extends RpcAcsRequest<DescribeClientConfSetupResponse> {
	...
	public DescribeClientConfSetupRequest() {
		super("Sas", "2018-12-03", "DescribeClientConfSetup", "sas");
	...
	@Override
	public Class<DescribeClientConfSetupResponse> getResponseClass() {
		return DescribeClientConfSetupResponse.class;
	}
