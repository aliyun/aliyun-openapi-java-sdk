 ...
 * @version 
 */
public class DescribePropertyPortItemRequest extends RpcAcsRequest<DescribePropertyPortItemResponse> {
	...
	@Override
	public Class<DescribePropertyPortItemResponse> getResponseClass() {
		return DescribePropertyPortItemResponse.class;
	}
