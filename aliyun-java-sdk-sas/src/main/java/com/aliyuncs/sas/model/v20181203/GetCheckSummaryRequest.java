 ...
 * @version 
 */
public class GetCheckSummaryRequest extends RpcAcsRequest<GetCheckSummaryResponse> {
	...
	@Override
	public Class<GetCheckSummaryResponse> getResponseClass() {
		return GetCheckSummaryResponse.class;
	}
