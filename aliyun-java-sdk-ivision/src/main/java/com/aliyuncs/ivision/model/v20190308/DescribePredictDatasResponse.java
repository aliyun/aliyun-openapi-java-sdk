...
import com.aliyuncs.ivision.transform.v20190308.DescribePredictDatasResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribePredictDatasResponse extends AcsResponse {
	...
	@Override
	public DescribePredictDatasResponse getInstance(UnmarshallerContext context) {
		return	DescribePredictDatasResponseUnmarshaller.unmarshall(this, context);
	}
}
