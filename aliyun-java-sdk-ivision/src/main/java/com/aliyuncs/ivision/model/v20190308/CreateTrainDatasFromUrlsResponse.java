...
import com.aliyuncs.ivision.transform.v20190308.CreateTrainDatasFromUrlsResponseUnmarshaller;
 ...
 * @version 
 */
public class CreateTrainDatasFromUrlsResponse extends AcsResponse {
	...
	@Override
	public CreateTrainDatasFromUrlsResponse getInstance(UnmarshallerContext context) {
		return	CreateTrainDatasFromUrlsResponseUnmarshaller.unmarshall(this, context);
	}
}
