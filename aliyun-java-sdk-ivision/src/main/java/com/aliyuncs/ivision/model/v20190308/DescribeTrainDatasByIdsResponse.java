...
import com.aliyuncs.ivision.transform.v20190308.DescribeTrainDatasByIdsResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeTrainDatasByIdsResponse extends AcsResponse {
	...
	@Override
	public DescribeTrainDatasByIdsResponse getInstance(UnmarshallerContext context) {
		return	DescribeTrainDatasByIdsResponseUnmarshaller.unmarshall(this, context);
	}
}
