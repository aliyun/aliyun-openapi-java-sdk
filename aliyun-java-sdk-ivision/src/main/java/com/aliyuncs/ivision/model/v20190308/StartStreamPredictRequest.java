 ...
 * @version 
 */
public class StartStreamPredictRequest extends RpcAcsRequest<StartStreamPredictResponse> {
	...
	@Override
	public Class<StartStreamPredictResponse> getResponseClass() {
		return StartStreamPredictResponse.class;
	}
