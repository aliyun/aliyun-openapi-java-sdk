...
import com.aliyuncs.ivision.transform.v20190308.DescribeTrainDatasResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeTrainDatasResponse extends AcsResponse {
	...
	@Override
	public DescribeTrainDatasResponse getInstance(UnmarshallerContext context) {
		return	DescribeTrainDatasResponseUnmarshaller.unmarshall(this, context);
	}
}
