 ...
 * @version 
 */
public class GetRedisValueRequest extends RpcAcsRequest<GetRedisValueResponse> {
	...
	private String bid;
	public GetRedisValueRequest() {
		super("mseap", "2021-01-18", "GetRedisValue");
	...
	@Override
	public Class<GetRedisValueResponse> getResponseClass() {
		return GetRedisValueResponse.class;
	}
