 ...
 * @version 
 */
public class CallbackTaskRequest extends RpcAcsRequest<CallbackTaskResponse> {
	...
	public CallbackTaskRequest() {
		super("mseap", "2021-01-18", "CallbackTask");
	...
	public void setOutTaskId(String outTaskId) {
		...
		if(outTaskId != null){
			putQueryParameter("OutTaskId", outTaskId);
		}
	}
	...
	public void setTaskData(String taskData) {
		...
		if(taskData != null){
			putQueryParameter("TaskData", taskData);
		}
	}
	...
	@Override
	public Class<CallbackTaskResponse> getResponseClass() {
		return CallbackTaskResponse.class;
	}
