 ...
 * @version 
 */
public class GetNodeByTemplateIdRequest extends RpcAcsRequest<GetNodeByTemplateIdResponse> {
	...
	private String bid;
	public GetNodeByTemplateIdRequest() {
		super("mseap", "2021-01-18", "GetNodeByTemplateId");
	...
	@Override
	public Class<GetNodeByTemplateIdResponse> getResponseClass() {
		return GetNodeByTemplateIdResponse.class;
	}
