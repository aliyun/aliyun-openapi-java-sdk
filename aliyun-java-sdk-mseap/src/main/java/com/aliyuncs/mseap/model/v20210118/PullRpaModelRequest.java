 ...
 * @version 
 */
public class PullRpaModelRequest extends RpcAcsRequest<PullRpaModelResponse> {
	...
	private String bid;
	public PullRpaModelRequest() {
		super("mseap", "2021-01-18", "PullRpaModel");
	...
	@Override
	public Class<PullRpaModelResponse> getResponseClass() {
		return PullRpaModelResponse.class;
	}
