 ...
 * @version 
 */
public class IdentifyCodeRequest extends RpcAcsRequest<IdentifyCodeResponse> {
	...
	public IdentifyCodeRequest() {
		super("mseap", "2021-01-18", "IdentifyCode");
	...
	@Override
	public Class<IdentifyCodeResponse> getResponseClass() {
