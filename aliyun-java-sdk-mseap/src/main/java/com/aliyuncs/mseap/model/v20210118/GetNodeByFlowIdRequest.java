 ...
 * @version 
 */
public class GetNodeByFlowIdRequest extends RpcAcsRequest<GetNodeByFlowIdResponse> {
	...
	private Long flowId;
	public GetNodeByFlowIdRequest() {
		super("mseap", "2021-01-18", "GetNodeByFlowId");
	...
	public void setFlowId(Long flowId) {
		this.flowId = flowId;
		if(flowId != null){
			putQueryParameter("FlowId", flowId.toString());
		}
	}

	@Override
	public Class<GetNodeByFlowIdResponse> getResponseClass() {
		return GetNodeByFlowIdResponse.class;
	}
