 ...
 * @version 
 */
public class CreateWebCCRuleRequest extends RpcAcsRequest<CreateWebCCRuleResponse> {
	...
	@Override
	public Class<CreateWebCCRuleResponse> getResponseClass() {
		return CreateWebCCRuleResponse.class;
	}
