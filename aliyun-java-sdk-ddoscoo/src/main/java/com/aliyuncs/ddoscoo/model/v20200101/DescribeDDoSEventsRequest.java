 ...
 * @version 
 */
public class DescribeDDoSEventsRequest extends RpcAcsRequest<DescribeDDoSEventsResponse> {
	...
	public DescribeDDoSEventsRequest() {
		super("ddoscoo", "2020-01-01", "DescribeDDoSEvents", "ddoscoo");
	...
	@Override
	public Class<DescribeDDoSEventsResponse> getResponseClass() {
		return DescribeDDoSEventsResponse.class;
	}
