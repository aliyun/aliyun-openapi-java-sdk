 ...
 * @version 
 */
public class CreateNetworkRulesRequest extends RpcAcsRequest<CreateNetworkRulesResponse> {
	...
	@Override
	public Class<CreateNetworkRulesResponse> getResponseClass() {
		return CreateNetworkRulesResponse.class;
	}
