 ...
 * @version 
 */
public class DescribePortConnsCountRequest extends RpcAcsRequest<DescribePortConnsCountResponse> {
	...
	@Override
	public Class<DescribePortConnsCountResponse> getResponseClass() {
		return DescribePortConnsCountResponse.class;
	}
