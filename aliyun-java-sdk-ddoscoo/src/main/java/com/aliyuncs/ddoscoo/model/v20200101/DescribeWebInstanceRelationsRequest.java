 ...
 * @version 
 */
public class DescribeWebInstanceRelationsRequest extends RpcAcsRequest<DescribeWebInstanceRelationsResponse> {
	...
	@Override
	public Class<DescribeWebInstanceRelationsResponse> getResponseClass() {
		return DescribeWebInstanceRelationsResponse.class;
	}
