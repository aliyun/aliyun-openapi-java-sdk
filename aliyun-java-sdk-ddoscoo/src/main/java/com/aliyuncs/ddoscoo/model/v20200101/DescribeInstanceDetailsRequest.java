 ...
 * @version 
 */
public class DescribeInstanceDetailsRequest extends RpcAcsRequest<DescribeInstanceDetailsResponse> {
	   

	private List<String> instanceIdss;
	public DescribeInstanceDetailsRequest() {
		super("ddoscoo", "2020-01-01", "DescribeInstanceDetails", "ddoscoo");
	...
	@Override
	public Class<DescribeInstanceDetailsResponse> getResponseClass() {
		return DescribeInstanceDetailsResponse.class;
	}
