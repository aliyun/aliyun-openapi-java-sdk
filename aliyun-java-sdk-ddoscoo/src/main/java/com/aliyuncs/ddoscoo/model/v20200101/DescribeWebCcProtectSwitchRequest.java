 ...
 * @version 
 */
public class DescribeWebCcProtectSwitchRequest extends RpcAcsRequest<DescribeWebCcProtectSwitchResponse> {
	...
	@Override
	public Class<DescribeWebCcProtectSwitchResponse> getResponseClass() {
		return DescribeWebCcProtectSwitchResponse.class;
	}
