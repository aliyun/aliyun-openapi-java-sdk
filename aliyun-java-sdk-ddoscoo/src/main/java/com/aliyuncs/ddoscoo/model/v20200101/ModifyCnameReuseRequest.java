 ...
 * @version 
 */
public class ModifyCnameReuseRequest extends RpcAcsRequest<ModifyCnameReuseResponse> {
	...
	@Override
	public Class<ModifyCnameReuseResponse> getResponseClass() {
		return ModifyCnameReuseResponse.class;
	}
