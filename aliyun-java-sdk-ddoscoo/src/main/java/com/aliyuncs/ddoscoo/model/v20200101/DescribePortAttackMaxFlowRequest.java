 ...
 * @version 
 */
public class DescribePortAttackMaxFlowRequest extends RpcAcsRequest<DescribePortAttackMaxFlowResponse> {
	...
	@Override
	public Class<DescribePortAttackMaxFlowResponse> getResponseClass() {
		return DescribePortAttackMaxFlowResponse.class;
	}
