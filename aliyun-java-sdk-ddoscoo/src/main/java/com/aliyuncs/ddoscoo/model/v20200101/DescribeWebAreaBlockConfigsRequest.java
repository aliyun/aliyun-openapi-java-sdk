 ...
 * @version 
 */
public class DescribeWebAreaBlockConfigsRequest extends RpcAcsRequest<DescribeWebAreaBlockConfigsResponse> {
	...
	@Override
	public Class<DescribeWebAreaBlockConfigsResponse> getResponseClass() {
		return DescribeWebAreaBlockConfigsResponse.class;
	}
