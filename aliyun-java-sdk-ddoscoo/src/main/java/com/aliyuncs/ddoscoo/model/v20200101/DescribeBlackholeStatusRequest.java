 ...
 * @version 
 */
public class DescribeBlackholeStatusRequest extends RpcAcsRequest<DescribeBlackholeStatusResponse> {
	...
	@Override
	public Class<DescribeBlackholeStatusResponse> getResponseClass() {
		return DescribeBlackholeStatusResponse.class;
	}
