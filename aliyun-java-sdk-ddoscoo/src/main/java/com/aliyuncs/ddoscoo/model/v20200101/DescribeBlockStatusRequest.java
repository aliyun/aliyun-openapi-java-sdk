 ...
 * @version 
 */
public class DescribeBlockStatusRequest extends RpcAcsRequest<DescribeBlockStatusResponse> {
	...
	@Override
	public Class<DescribeBlockStatusResponse> getResponseClass() {
		return DescribeBlockStatusResponse.class;
	}
