 ...
 * @version 
 */
public class DescribePortMaxConnsRequest extends RpcAcsRequest<DescribePortMaxConnsResponse> {
	...
	@Override
	public Class<DescribePortMaxConnsResponse> getResponseClass() {
		return DescribePortMaxConnsResponse.class;
	}
