 ...
 * @version 
 */
public class AssociateWebCertRequest extends RpcAcsRequest<AssociateWebCertResponse> {
	...
	@Override
	public Class<AssociateWebCertResponse> getResponseClass() {
		return AssociateWebCertResponse.class;
	}
