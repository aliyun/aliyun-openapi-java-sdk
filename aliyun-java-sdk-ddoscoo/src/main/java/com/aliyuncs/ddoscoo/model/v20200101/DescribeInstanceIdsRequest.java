 ...
 * @version 
 */
public class DescribeInstanceIdsRequest extends RpcAcsRequest<DescribeInstanceIdsResponse> {
	...
	public DescribeInstanceIdsRequest() {
		super("ddoscoo", "2020-01-01", "DescribeInstanceIds", "ddoscoo");
	...
	@Override
	public Class<DescribeInstanceIdsResponse> getResponseClass() {
		return DescribeInstanceIdsResponse.class;
	}
