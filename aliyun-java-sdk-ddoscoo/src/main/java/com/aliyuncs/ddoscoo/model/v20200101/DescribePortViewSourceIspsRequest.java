 ...
 * @version 
 */
public class DescribePortViewSourceIspsRequest extends RpcAcsRequest<DescribePortViewSourceIspsResponse> {
	...
	@Override
	public Class<DescribePortViewSourceIspsResponse> getResponseClass() {
		return DescribePortViewSourceIspsResponse.class;
	}
