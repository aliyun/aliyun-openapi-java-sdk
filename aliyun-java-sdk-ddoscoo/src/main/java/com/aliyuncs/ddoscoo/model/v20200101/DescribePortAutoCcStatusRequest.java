 ...
 * @version 
 */
public class DescribePortAutoCcStatusRequest extends RpcAcsRequest<DescribePortAutoCcStatusResponse> {
	...
	@Override
	public Class<DescribePortAutoCcStatusResponse> getResponseClass() {
		return DescribePortAutoCcStatusResponse.class;
	}
