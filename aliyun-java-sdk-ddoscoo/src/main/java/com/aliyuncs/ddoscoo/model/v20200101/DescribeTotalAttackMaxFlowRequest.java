 ...
 * @version 
 */
public class DescribeTotalAttackMaxFlowRequest extends RpcAcsRequest<DescribeTotalAttackMaxFlowResponse> {
	...
	public DescribeTotalAttackMaxFlowRequest() {
		super("ddoscoo", "2020-01-01", "DescribeTotalAttackMaxFlow", "ddoscoo");
	...
	@Override
	public Class<DescribeTotalAttackMaxFlowResponse> getResponseClass() {
		return DescribeTotalAttackMaxFlowResponse.class;
	}
