 ...
 * @version 
 */
public class DescribeInstanceSpecsRequest extends RpcAcsRequest<DescribeInstanceSpecsResponse> {
	...
	@Override
	public Class<DescribeInstanceSpecsResponse> getResponseClass() {
		return DescribeInstanceSpecsResponse.class;
	}
