 ...
 * @version 
 */
public class CreateSchedulerRuleRequest extends RpcAcsRequest<CreateSchedulerRuleResponse> {
	...
	@Override
	public Class<CreateSchedulerRuleResponse> getResponseClass() {
		return CreateSchedulerRuleResponse.class;
	}
