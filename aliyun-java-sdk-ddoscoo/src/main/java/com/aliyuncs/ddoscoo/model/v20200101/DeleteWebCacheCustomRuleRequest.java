 ...
 * @version 
 */
public class DeleteWebCacheCustomRuleRequest extends RpcAcsRequest<DeleteWebCacheCustomRuleResponse> {
	...
	@Override
	public Class<DeleteWebCacheCustomRuleResponse> getResponseClass() {
		return DeleteWebCacheCustomRuleResponse.class;
	}
