 ...
 * @version 
 */
public class DescribePortFlowListRequest extends RpcAcsRequest<DescribePortFlowListResponse> {
	...
	@Override
	public Class<DescribePortFlowListResponse> getResponseClass() {
		return DescribePortFlowListResponse.class;
	}
