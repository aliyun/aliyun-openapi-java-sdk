 ...
 * @version 
 */
public class DescribeWebCacheConfigsRequest extends RpcAcsRequest<DescribeWebCacheConfigsResponse> {
	...
	@Override
	public Class<DescribeWebCacheConfigsResponse> getResponseClass() {
		return DescribeWebCacheConfigsResponse.class;
	}
