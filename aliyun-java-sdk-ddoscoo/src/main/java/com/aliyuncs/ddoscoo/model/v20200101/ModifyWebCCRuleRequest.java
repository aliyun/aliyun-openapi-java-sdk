 ...
 * @version 
 */
public class ModifyWebCCRuleRequest extends RpcAcsRequest<ModifyWebCCRuleResponse> {
	...
	public ModifyWebCCRuleRequest() {
		super("ddoscoo", "2020-01-01", "ModifyWebCCRule", "ddoscoo");
	...
	@Override
	public Class<ModifyWebCCRuleResponse> getResponseClass() {
		return ModifyWebCCRuleResponse.class;
	}
