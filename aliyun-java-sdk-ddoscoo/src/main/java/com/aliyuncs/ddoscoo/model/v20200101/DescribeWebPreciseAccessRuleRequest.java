 ...
 * @version 
 */
public class DescribeWebPreciseAccessRuleRequest extends RpcAcsRequest<DescribeWebPreciseAccessRuleResponse> {
	...
	@Override
	public Class<DescribeWebPreciseAccessRuleResponse> getResponseClass() {
		return DescribeWebPreciseAccessRuleResponse.class;
	}
