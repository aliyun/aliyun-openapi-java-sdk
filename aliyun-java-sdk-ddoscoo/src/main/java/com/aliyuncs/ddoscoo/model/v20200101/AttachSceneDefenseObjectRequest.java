 ...
 * @version 
 */
public class AttachSceneDefenseObjectRequest extends RpcAcsRequest<AttachSceneDefenseObjectResponse> {
	...
	@Override
	public Class<AttachSceneDefenseObjectResponse> getResponseClass() {
		return AttachSceneDefenseObjectResponse.class;
	}
