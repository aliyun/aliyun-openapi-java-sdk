 ...
 * @version 
 */
public class CreateTagResourcesRequest extends RpcAcsRequest<CreateTagResourcesResponse> {
	...
	@Override
	public Class<CreateTagResourcesResponse> getResponseClass() {
		return CreateTagResourcesResponse.class;
	}
