...
public class BandOfferOrderRequest extends RpcAcsRequest<BandOfferOrderResponse> {
	...
	public void setBandId(String bandId) {
		this.bandId = bandId;
		if(bandId != null){
			putQueryParameter("BandId", bandId);
		}
	}
	...
	public void setOfferId(String offerId) {
		...
		if(offerId != null){
			putQueryParameter("OfferId", offerId);
		}
	}
	...
	@Override
	public Class<BandOfferOrderResponse> getResponseClass() {
		return BandOfferOrderResponse.class;
	}
