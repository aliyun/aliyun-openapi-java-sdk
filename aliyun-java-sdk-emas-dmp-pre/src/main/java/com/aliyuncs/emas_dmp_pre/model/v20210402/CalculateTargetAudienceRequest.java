 ...
 * @version 
 */
public class CalculateTargetAudienceRequest extends RpcAcsRequest<CalculateTargetAudienceResponse> {
	...
	public CalculateTargetAudienceRequest() {
		super("emas-dmp-pre", "2021-04-02", "CalculateTargetAudience");
	...
	@Override
	public Class<CalculateTargetAudienceResponse> getResponseClass() {
		return CalculateTargetAudienceResponse.class;
	}
