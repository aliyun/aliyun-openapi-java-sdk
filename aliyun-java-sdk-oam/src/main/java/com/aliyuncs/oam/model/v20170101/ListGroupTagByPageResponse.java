...
import com.aliyuncs.oam.transform.v20170101.ListGroupTagByPageResponseUnmarshaller;
 ...
 * @version 
 */
public class ListGroupTagByPageResponse extends AcsResponse {
	...
	@Override
	public ListGroupTagByPageResponse getInstance(UnmarshallerContext context) {
		return	ListGroupTagByPageResponseUnmarshaller.unmarshall(this, context);
	}
}
