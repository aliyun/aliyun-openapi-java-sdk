...
public class VoiceIdentityStartCheckRequest extends RoaAcsRequest<VoiceIdentityStartCheckResponse> {
	...
	public VoiceIdentityStartCheckRequest() {
		super("aligreen", "2019-11-15", "VoiceIdentityStartCheck");
	...
	@Override
	public Class<VoiceIdentityStartCheckResponse> getResponseClass() {
		return VoiceIdentityStartCheckResponse.class;
	}
