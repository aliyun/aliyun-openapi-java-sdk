 ...
 * @version 
 */
public class RemoveDiskReplicaPairRequest extends RpcAcsRequest<RemoveDiskReplicaPairResponse> {
	...
	public RemoveDiskReplicaPairRequest() {
		super("ebs", "2021-07-30", "RemoveDiskReplicaPair", "ebs");
	...
	@Override
	public Class<RemoveDiskReplicaPairResponse> getResponseClass() {
		return RemoveDiskReplicaPairResponse.class;
	}
