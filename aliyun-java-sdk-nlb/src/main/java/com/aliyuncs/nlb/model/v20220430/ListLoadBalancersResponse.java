...
import com.aliyuncs.nlb.transform.v20220430.ListLoadBalancersResponseUnmarshaller;
...
public class ListLoadBalancersResponse extends AcsResponse {
	...
	public void setLoadBalancers(List<LoadbalancerInfo> loadBalancers) {
	...
	public static class LoadbalancerInfo {
		...
		public List<TagModels> getTags() {
			return this.tags;
		}

		public void setTags(List<TagModels> tags) {
			this.tags = tags;
		}
