...
import com.aliyuncs.nlb.model.v20220430.DescribeZonesResponse;
import com.aliyuncs.nlb.model.v20220430.DescribeZonesResponse.Zone;
...
public class DescribeZonesResponseUnmarshaller {
	...
	public static DescribeZonesResponse unmarshall(DescribeZonesResponse describeZonesResponse, UnmarshallerContext _ctx) {
		...
		describeZonesResponse.setHttpStatusCode(_ctx.integerValue("DescribeZonesResponse.HttpStatusCode"));
		describeZonesResponse.setDynamicCode(_ctx.stringValue("DescribeZonesResponse.DynamicCode"));
		describeZonesResponse.setDynamicMessage(_ctx.stringValue("DescribeZonesResponse.DynamicMessage"));
