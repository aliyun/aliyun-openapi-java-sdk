...
import com.aliyuncs.nlb.model.v20220430.TagResourcesResponse;
...
public class TagResourcesResponseUnmarshaller {
	...
	public static TagResourcesResponse unmarshall(TagResourcesResponse tagResourcesResponse, UnmarshallerContext _ctx) {
		...
		tagResourcesResponse.setDynamicCode(_ctx.stringValue("TagResourcesResponse.DynamicCode"));
		tagResourcesResponse.setDynamicMessage(_ctx.stringValue("TagResourcesResponse.DynamicMessage"));
		tagResourcesResponse.setJobId(_ctx.stringValue("TagResourcesResponse.JobId"));
