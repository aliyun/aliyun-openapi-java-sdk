...
import com.aliyuncs.nlb.model.v20220430.UntagResourcesResponse;
...
public class UntagResourcesResponseUnmarshaller {
	...
	public static UntagResourcesResponse unmarshall(UntagResourcesResponse untagResourcesResponse, UnmarshallerContext _ctx) {
		...
		untagResourcesResponse.setDynamicCode(_ctx.stringValue("UntagResourcesResponse.DynamicCode"));
		untagResourcesResponse.setDynamicMessage(_ctx.stringValue("UntagResourcesResponse.DynamicMessage"));
		untagResourcesResponse.setJobId(_ctx.stringValue("UntagResourcesResponse.JobId"));
