...
import com.aliyuncs.apds.model.v20220331.ListRegionsResponse;
...
public class ListRegionsResponseUnmarshaller {
	...
	public static ListRegionsResponse unmarshall(ListRegionsResponse listRegionsResponse, UnmarshallerContext _ctx) {
		...
		listRegionsResponse.setCode(_ctx.stringValue("ListRegionsResponse.Code"));
		listRegionsResponse.setError(_ctx.stringValue("ListRegionsResponse.error"));
