 ...
 * @version 
 */
public class DescribeOssStsRequest extends RoaAcsRequest<DescribeOssStsResponse> {
	...
	public DescribeOssStsRequest() {
		super("apds", "2022-03-31", "DescribeOssSts");
		setUriPattern("/okss-services/file-job/sts");
	...
	@Override
	public Class<DescribeOssStsResponse> getResponseClass() {
