...
import com.aliyuncs.mns_open.transform.v20220119.ListQueueResponseUnmarshaller;
 ...
 * @version 
 */
public class ListQueueResponse extends AcsResponse {
	...
	@Override
	public ListQueueResponse getInstance(UnmarshallerContext context) {
		return	ListQueueResponseUnmarshaller.unmarshall(this, context);
	}
