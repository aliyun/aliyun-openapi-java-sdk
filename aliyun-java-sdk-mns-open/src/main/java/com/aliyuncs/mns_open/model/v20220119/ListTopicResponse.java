...
import com.aliyuncs.mns_open.transform.v20220119.ListTopicResponseUnmarshaller;
 ...
 * @version 
 */
public class ListTopicResponse extends AcsResponse {
	...
	@Override
	public ListTopicResponse getInstance(UnmarshallerContext context) {
		return	ListTopicResponseUnmarshaller.unmarshall(this, context);
	}
