...
import com.aliyuncs.mns_open.transform.v20220119.GetQueueAttributesResponseUnmarshaller;
 ...
 * @version 
 */
public class GetQueueAttributesResponse extends AcsResponse {
	...
	@Override
	public GetQueueAttributesResponse getInstance(UnmarshallerContext context) {
		return	GetQueueAttributesResponseUnmarshaller.unmarshall(this, context);
	}
