 ...
 * @version 
 */
public class SaveFileRequest extends RpcAcsRequest<SaveFileResponse> {
	...
	public SaveFileRequest() {
		super("tdsr", "2020-01-01", "SaveFile");
	...
	public void setParamFile(String paramFile) {
		...
		if(paramFile != null){
			putQueryParameter("ParamFile", paramFile);
		}
	}

	@Override
	public Class<SaveFileResponse> getResponseClass() {
		return SaveFileResponse.class;
	}
