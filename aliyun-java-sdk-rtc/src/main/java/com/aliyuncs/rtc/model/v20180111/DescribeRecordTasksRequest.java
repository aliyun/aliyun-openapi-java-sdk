 ...
 * @version 
 */
public class DescribeRecordTasksRequest extends RpcAcsRequest<DescribeRecordTasksResponse> {
	...
	@Override
	public Class<DescribeRecordTasksResponse> getResponseClass() {
		return DescribeRecordTasksResponse.class;
	}
