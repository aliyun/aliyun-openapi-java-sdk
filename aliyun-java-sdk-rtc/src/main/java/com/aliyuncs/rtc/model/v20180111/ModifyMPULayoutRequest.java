 ...
 * @version 
 */
public class ModifyMPULayoutRequest extends RpcAcsRequest<ModifyMPULayoutResponse> {
	...
	@Override
	public Class<ModifyMPULayoutResponse> getResponseClass() {
		return ModifyMPULayoutResponse.class;
	}
