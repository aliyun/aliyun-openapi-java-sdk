 ...
 * @version 
 */
public class UpdateTaskParamRequest extends RpcAcsRequest<UpdateTaskParamResponse> {
	
	public UpdateTaskParamRequest() {
		super("rtc", "2018-01-11", "UpdateTaskParam", "rtc");
	}
	...
	@Override
	public Class<UpdateTaskParamResponse> getResponseClass() {
		return UpdateTaskParamResponse.class;
	}
