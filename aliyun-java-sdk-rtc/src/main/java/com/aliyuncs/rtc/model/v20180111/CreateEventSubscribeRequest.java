 ...
 * @version 
 */
public class CreateEventSubscribeRequest extends RpcAcsRequest<CreateEventSubscribeResponse> {
	...
	@Override
	public Class<CreateEventSubscribeResponse> getResponseClass() {
		return CreateEventSubscribeResponse.class;
	}
