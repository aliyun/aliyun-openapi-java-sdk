...
public class DescribeRtcUserCntDataResponse extends AcsResponse {
	...
	public void setUserCntDataPerInterval(List<UserCntModule> userCntDataPerInterval) {
	...
	@Override
	public DescribeRtcUserCntDataResponse getInstance(UnmarshallerContext context) {
		return	DescribeRtcUserCntDataResponseUnmarshaller.unmarshall(this, context);
	}
}
