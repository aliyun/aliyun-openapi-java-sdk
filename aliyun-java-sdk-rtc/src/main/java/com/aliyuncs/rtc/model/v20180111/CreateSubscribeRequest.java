 ...
 * @version 
 */
public class CreateSubscribeRequest extends RpcAcsRequest<CreateSubscribeResponse> {
	...
	public CreateSubscribeRequest() {
		super("rtc", "2018-01-11", "CreateSubscribe", "rtc");
	...
	@Override
	public Class<CreateSubscribeResponse> getResponseClass() {
		return CreateSubscribeResponse.class;
	}
