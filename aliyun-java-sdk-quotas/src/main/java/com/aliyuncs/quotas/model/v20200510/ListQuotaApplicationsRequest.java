 ...
 * @version 
 */
public class ListQuotaApplicationsRequest extends RpcAcsRequest<ListQuotaApplicationsResponse> {
	...
	public ListQuotaApplicationsRequest() {
		super("quotas", "2020-05-10", "ListQuotaApplications", "quotas");
	...
	@Override
	public Class<ListQuotaApplicationsResponse> getResponseClass() {
		return ListQuotaApplicationsResponse.class;
	}
