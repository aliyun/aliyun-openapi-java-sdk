...
import com.aliyuncs.quotas.transform.v20200510.GetQuotaTemplateServiceStatusResponseUnmarshaller;
 ...
 * @version 
 */
public class GetQuotaTemplateServiceStatusResponse extends AcsResponse {
	...
	@Override
	public GetQuotaTemplateServiceStatusResponse getInstance(UnmarshallerContext context) {
		return	GetQuotaTemplateServiceStatusResponseUnmarshaller.unmarshall(this, context);
	}
