...
import com.aliyuncs.sae.model.v20190506.CreateJobResponse;
import com.aliyuncs.sae.model.v20190506.CreateJobResponse.Data;
...
public class CreateJobResponseUnmarshaller {
	...
	public static CreateJobResponse unmarshall(CreateJobResponse createJobResponse, UnmarshallerContext _ctx) {
		...
		createJobResponse.setTraceId(_ctx.stringValue("CreateJobResponse.TraceId"));
		createJobResponse.setErrorCode(_ctx.stringValue("CreateJobResponse.ErrorCode"));
		...
		Data data = new Data();
		data.setChangeOrderId(_ctx.stringValue("CreateJobResponse.Data.ChangeOrderId"));
		data.setAppId(_ctx.stringValue("CreateJobResponse.Data.AppId"));
