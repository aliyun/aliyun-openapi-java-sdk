...
import com.aliyuncs.sae.transform.v20190506.UpdateWebCustomDomainResponseUnmarshaller;
 ...
 * @version 
 */
public class UpdateWebCustomDomainResponse extends AcsResponse {
	...
	@Override
	public UpdateWebCustomDomainResponse getInstance(UnmarshallerContext context) {
		return	UpdateWebCustomDomainResponseUnmarshaller.unmarshall(this, context);
	}
