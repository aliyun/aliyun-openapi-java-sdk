...
import com.aliyuncs.sae.transform.v20190506.StartWebApplicationResponseUnmarshaller;
 ...
 * @version 
 */
public class StartWebApplicationResponse extends AcsResponse {
	...
	@Override
	public StartWebApplicationResponse getInstance(UnmarshallerContext context) {
		return	StartWebApplicationResponseUnmarshaller.unmarshall(this, context);
	}
