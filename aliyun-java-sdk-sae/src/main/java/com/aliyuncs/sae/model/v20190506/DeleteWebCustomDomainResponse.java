...
import com.aliyuncs.sae.transform.v20190506.DeleteWebCustomDomainResponseUnmarshaller;
 ...
 * @version 
 */
public class DeleteWebCustomDomainResponse extends AcsResponse {
	...
	@Override
	public DeleteWebCustomDomainResponse getInstance(UnmarshallerContext context) {
		return	DeleteWebCustomDomainResponseUnmarshaller.unmarshall(this, context);
	}
