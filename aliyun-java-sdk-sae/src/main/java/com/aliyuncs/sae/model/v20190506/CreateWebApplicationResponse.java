...
import com.aliyuncs.sae.transform.v20190506.CreateWebApplicationResponseUnmarshaller;
 ...
 * @version 
 */
public class CreateWebApplicationResponse extends AcsResponse {
	...
	@Override
	public CreateWebApplicationResponse getInstance(UnmarshallerContext context) {
		return	CreateWebApplicationResponseUnmarshaller.unmarshall(this, context);
	}
