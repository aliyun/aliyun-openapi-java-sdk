 ...
 * @version 
 */
public class DeleteIngressRequest extends RoaAcsRequest<DeleteIngressResponse> {
	...
	@Override
	public Class<DeleteIngressResponse> getResponseClass() {
		return DeleteIngressResponse.class;
	}
