 ...
 * @version 
 */
public class ListAppEventsRequest extends RoaAcsRequest<ListAppEventsResponse> {
	...
	public void setObjectKind(String objectKind) {
		...
		if(objectKind != null){
			putQueryParameter("ObjectKind", objectKind);
		}
	}
	...
	@Override
	public Class<ListAppEventsResponse> getResponseClass() {
		return ListAppEventsResponse.class;
	}
