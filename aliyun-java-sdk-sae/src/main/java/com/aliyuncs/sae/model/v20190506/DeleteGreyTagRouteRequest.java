 ...
 * @version 
 */
public class DeleteGreyTagRouteRequest extends RoaAcsRequest<DeleteGreyTagRouteResponse> {
	   

	private Long greyTagRouteId;
	public DeleteGreyTagRouteRequest() {
		super("sae", "2019-05-06", "DeleteGreyTagRoute", "serverless");
	...
	@Override
	public Class<DeleteGreyTagRouteResponse> getResponseClass() {
		return DeleteGreyTagRouteResponse.class;
	}
