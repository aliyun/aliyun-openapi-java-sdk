...
import com.aliyuncs.sae.transform.v20190506.DeleteWebApplicationResponseUnmarshaller;
 ...
 * @version 
 */
public class DeleteWebApplicationResponse extends AcsResponse {
	...
	@Override
	public DeleteWebApplicationResponse getInstance(UnmarshallerContext context) {
		return	DeleteWebApplicationResponseUnmarshaller.unmarshall(this, context);
	}
