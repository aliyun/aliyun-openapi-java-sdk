...
import com.aliyuncs.sae.transform.v20190506.ListNamespacedConfigMapsResponseUnmarshaller;
 ...
 * @version 
 */
public class ListNamespacedConfigMapsResponse extends AcsResponse {
	...
	@Override
	public ListNamespacedConfigMapsResponse getInstance(UnmarshallerContext context) {
		return	ListNamespacedConfigMapsResponseUnmarshaller.unmarshall(this, context);
	}
