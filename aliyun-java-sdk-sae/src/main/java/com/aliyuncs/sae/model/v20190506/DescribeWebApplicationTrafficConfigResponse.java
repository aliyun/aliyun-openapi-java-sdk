...
import com.aliyuncs.sae.transform.v20190506.DescribeWebApplicationTrafficConfigResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeWebApplicationTrafficConfigResponse extends AcsResponse {
	...
	@Override
	public DescribeWebApplicationTrafficConfigResponse getInstance(UnmarshallerContext context) {
		return	DescribeWebApplicationTrafficConfigResponseUnmarshaller.unmarshall(this, context);
	}
