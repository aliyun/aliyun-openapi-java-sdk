...
import com.aliyuncs.sae.transform.v20190506.StopWebApplicationResponseUnmarshaller;
 ...
 * @version 
 */
public class StopWebApplicationResponse extends AcsResponse {
	...
	@Override
	public StopWebApplicationResponse getInstance(UnmarshallerContext context) {
		return	StopWebApplicationResponseUnmarshaller.unmarshall(this, context);
	}
