...
import com.aliyuncs.sae.transform.v20190506.PublishWebApplicationRevisionResponseUnmarshaller;
 ...
 * @version 
 */
public class PublishWebApplicationRevisionResponse extends AcsResponse {
	...
	@Override
	public PublishWebApplicationRevisionResponse getInstance(UnmarshallerContext context) {
		return	PublishWebApplicationRevisionResponseUnmarshaller.unmarshall(this, context);
	}
