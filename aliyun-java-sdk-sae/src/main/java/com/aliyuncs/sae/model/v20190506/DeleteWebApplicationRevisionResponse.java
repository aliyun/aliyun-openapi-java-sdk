...
import com.aliyuncs.sae.transform.v20190506.DeleteWebApplicationRevisionResponseUnmarshaller;
 ...
 * @version 
 */
public class DeleteWebApplicationRevisionResponse extends AcsResponse {
	...
	@Override
	public DeleteWebApplicationRevisionResponse getInstance(UnmarshallerContext context) {
		return	DeleteWebApplicationRevisionResponseUnmarshaller.unmarshall(this, context);
	}
