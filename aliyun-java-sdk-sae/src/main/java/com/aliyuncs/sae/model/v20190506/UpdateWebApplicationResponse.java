...
import com.aliyuncs.sae.transform.v20190506.UpdateWebApplicationResponseUnmarshaller;
 ...
 * @version 
 */
public class UpdateWebApplicationResponse extends AcsResponse {
	...
	@Override
	public UpdateWebApplicationResponse getInstance(UnmarshallerContext context) {
		return	UpdateWebApplicationResponseUnmarshaller.unmarshall(this, context);
	}
