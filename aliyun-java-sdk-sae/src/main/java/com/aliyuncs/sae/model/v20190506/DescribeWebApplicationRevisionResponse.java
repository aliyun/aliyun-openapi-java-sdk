...
import com.aliyuncs.sae.transform.v20190506.DescribeWebApplicationRevisionResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeWebApplicationRevisionResponse extends AcsResponse {
	...
	@Override
	public DescribeWebApplicationRevisionResponse getInstance(UnmarshallerContext context) {
		return	DescribeWebApplicationRevisionResponseUnmarshaller.unmarshall(this, context);
	}
