 ...
 * @version 
 */
public class DetectFruitsRequest extends RpcAcsRequest<DetectFruitsResponse> {
	...
	@Override
	public Class<DetectFruitsResponse> getResponseClass() {
		return DetectFruitsResponse.class;
	}
