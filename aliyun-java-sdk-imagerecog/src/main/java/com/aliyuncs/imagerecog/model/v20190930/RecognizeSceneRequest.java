 ...
 * @version 
 */
public class RecognizeSceneRequest extends RpcAcsRequest<RecognizeSceneResponse> {
	...
	@Override
	public Class<RecognizeSceneResponse> getResponseClass() {
		return RecognizeSceneResponse.class;
	}
