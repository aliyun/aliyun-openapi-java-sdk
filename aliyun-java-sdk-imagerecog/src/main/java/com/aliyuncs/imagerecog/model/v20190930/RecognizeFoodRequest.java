 ...
 * @version 
 */
public class RecognizeFoodRequest extends RpcAcsRequest<RecognizeFoodResponse> {
	...
	@Override
	public Class<RecognizeFoodResponse> getResponseClass() {
		return RecognizeFoodResponse.class;
	}
