...
import com.aliyuncs.viapi_regen.transform.v20211119.GetTrainTaskResponseUnmarshaller;
 ...
 * @version 
 */
public class GetTrainTaskResponse extends AcsResponse {
	...
	public static class Data {
		...
		public void setTrainUseTime(Long trainUseTime) {
			this.trainUseTime = trainUseTime;
		}
	}

	@Override
	public GetTrainTaskResponse getInstance(UnmarshallerContext context) {
		return	GetTrainTaskResponseUnmarshaller.unmarshall(this, context);
	}
