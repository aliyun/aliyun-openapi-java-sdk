...
import com.aliyuncs.viapi_regen.transform.v20211119.EnableDataReflowResponseUnmarshaller;
 ...
 * @version 
 */
public class EnableDataReflowResponse extends AcsResponse {
	...
	@Override
	public EnableDataReflowResponse getInstance(UnmarshallerContext context) {
		return	EnableDataReflowResponseUnmarshaller.unmarshall(this, context);
	}
