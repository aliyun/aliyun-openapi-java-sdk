...
import com.aliyuncs.viapi_regen.transform.v20211119.UpdateTrainTaskResponseUnmarshaller;
 ...
 * @version 
 */
public class UpdateTrainTaskResponse extends AcsResponse {
	...
	@Override
	public UpdateTrainTaskResponse getInstance(UnmarshallerContext context) {
		return	UpdateTrainTaskResponseUnmarshaller.unmarshall(this, context);
	}
