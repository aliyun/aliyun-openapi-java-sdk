...
import com.aliyuncs.viapi_regen.transform.v20211119.CreateTrainTaskResponseUnmarshaller;
 ...
 * @version 
 */
public class CreateTrainTaskResponse extends AcsResponse {
	...
	@Override
	public CreateTrainTaskResponse getInstance(UnmarshallerContext context) {
		return	CreateTrainTaskResponseUnmarshaller.unmarshall(this, context);
	}
