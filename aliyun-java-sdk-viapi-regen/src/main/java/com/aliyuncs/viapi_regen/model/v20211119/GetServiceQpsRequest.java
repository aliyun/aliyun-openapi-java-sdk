 ...
 * @version 
 */
public class GetServiceQpsRequest extends RpcAcsRequest<GetServiceQpsResponse> {
	...
	public GetServiceQpsRequest() {
		super("viapi-regen", "2021-11-19", "GetServiceQps", "selflearning");
	...
	@Override
	public Class<GetServiceQpsResponse> getResponseClass() {
		return GetServiceQpsResponse.class;
	}
