 ...
 * @author auto create
 */
public class DescribeDBInstanceIPArrayListRequest
        extends RpcAcsRequest<DescribeDBInstanceIPArrayListResponse> {

    public DescribeDBInstanceIPArrayListRequest() {
        super("Rds", "2014-08-15", "DescribeDBInstanceIPArrayList");
    }
