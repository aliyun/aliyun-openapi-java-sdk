 ...
 * @version 
 */
public class DeleteDedicatedHostGroupRequest extends RpcAcsRequest<DeleteDedicatedHostGroupResponse> {
	...
	@Override
	public Class<DeleteDedicatedHostGroupResponse> getResponseClass() {
		return DeleteDedicatedHostGroupResponse.class;
	}
