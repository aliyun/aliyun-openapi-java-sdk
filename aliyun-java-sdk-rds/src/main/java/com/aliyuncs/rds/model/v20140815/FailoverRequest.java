 ...
 * @version 
 */
public class FailoverRequest extends RpcAcsRequest<FailoverResponse> {
	
	public FailoverRequest() {
		super("Rds", "2014-08-15", "Failover", "rds");
	}
	...
	@Override
	public Class<FailoverResponse> getResponseClass() {
		return FailoverResponse.class;
	}
