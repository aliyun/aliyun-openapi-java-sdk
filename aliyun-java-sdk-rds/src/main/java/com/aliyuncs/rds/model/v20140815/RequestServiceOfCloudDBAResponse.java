...
public class RequestServiceOfCloudDBAResponse extends AcsResponse {
	...
	@Override
	public RequestServiceOfCloudDBAResponse getInstance(UnmarshallerContext context) {
		return	RequestServiceOfCloudDBAResponseUnmarshaller.unmarshall(this, context);
	}
