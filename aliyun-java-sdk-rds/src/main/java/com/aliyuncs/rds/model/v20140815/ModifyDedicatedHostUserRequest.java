 ...
 * @version 
 */
public class ModifyDedicatedHostUserRequest extends RpcAcsRequest<ModifyDedicatedHostUserResponse> {
	...
	public ModifyDedicatedHostUserRequest() {
		super("Rds", "2014-08-15", "ModifyDedicatedHostUser", "rds");
	...
	@Override
	public Class<ModifyDedicatedHostUserResponse> getResponseClass() {
		return ModifyDedicatedHostUserResponse.class;
	}
