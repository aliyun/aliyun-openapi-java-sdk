 ...
 * @version 
 */
public class CreateDedicatedHostRequest extends RpcAcsRequest<CreateDedicatedHostResponse> {
	...
	@Override
	public Class<CreateDedicatedHostResponse> getResponseClass() {
		return CreateDedicatedHostResponse.class;
	}
