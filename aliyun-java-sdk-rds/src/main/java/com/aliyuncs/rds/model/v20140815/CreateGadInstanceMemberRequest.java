...
public class CreateGadInstanceMemberRequest extends RpcAcsRequest<CreateGadInstanceMemberResponse> {
	...
	public void setGadInstanceId(String gadInstanceId) {
		this.gadInstanceId = gadInstanceId;
		if(gadInstanceId != null){
			putQueryParameter("GadInstanceId", gadInstanceId);
		}
	}
	...
	@Override
	public Class<CreateGadInstanceMemberResponse> getResponseClass() {
		return CreateGadInstanceMemberResponse.class;
	}
