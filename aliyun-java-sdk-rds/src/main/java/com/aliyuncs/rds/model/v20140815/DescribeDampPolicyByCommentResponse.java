...
public class DescribeDampPolicyByCommentResponse extends AcsResponse {
	...
	@Override
	public DescribeDampPolicyByCommentResponse getInstance(UnmarshallerContext context) {
		return	DescribeDampPolicyByCommentResponseUnmarshaller.unmarshall(this, context);
	}
}
