 ...
 * @author auto create
 */
public class DescribeImportsForSQLServerRequest
        extends RpcAcsRequest<DescribeImportsForSQLServerResponse> {

    public DescribeImportsForSQLServerRequest() {
        super("Rds", "2014-08-15", "DescribeImportsForSQLServer");
    }
