...
import com.aliyuncs.rds.transform.v20140815.EvaluateFailoverResponseUnmarshaller;
 ...
 * @version 
 */
public class EvaluateFailoverResponse extends AcsResponse {
	...
	@Override
	public EvaluateFailoverResponse getInstance(UnmarshallerContext context) {
		return	EvaluateFailoverResponseUnmarshaller.unmarshall(this, context);
	}
