 ...
 * @version 
 */
public class ModifyDTCSecurityIpHostsForSQLServerRequest extends RpcAcsRequest<ModifyDTCSecurityIpHostsForSQLServerResponse> {
	...
	public void setWhiteListGroupName(String whiteListGroupName) {
		...
		if(whiteListGroupName != null){
			putQueryParameter("WhiteListGroupName", whiteListGroupName);
		}
	}
	...
	public void setSecurityIpHosts(String securityIpHosts) {
		...
		if(securityIpHosts != null){
			putQueryParameter("SecurityIpHosts", securityIpHosts);
		}
	}
	...
	@Override
	public Class<ModifyDTCSecurityIpHostsForSQLServerResponse> getResponseClass() {
		return ModifyDTCSecurityIpHostsForSQLServerResponse.class;
	}
