 ...
 * @version 
 */
public class PreCheckCreateOrderForCloneRequest extends RpcAcsRequest<PreCheckCreateOrderForCloneResponse> {
	...
	private String cloneInstanceDefaultValue;

	private String payType;
	public PreCheckCreateOrderForCloneRequest() {
		super("Rds", "2014-08-15", "PreCheckCreateOrderForClone", "rds");
	...
	public String getCloneInstanceDefaultValue() {
		return this.cloneInstanceDefaultValue;
	}

	public void setCloneInstanceDefaultValue(String cloneInstanceDefaultValue) {
		this.cloneInstanceDefaultValue = cloneInstanceDefaultValue;
		if(cloneInstanceDefaultValue != null){
			putQueryParameter("CloneInstanceDefaultValue", cloneInstanceDefaultValue);
		}
	}
	...
	@Override
	public Class<PreCheckCreateOrderForCloneResponse> getResponseClass() {
		return PreCheckCreateOrderForCloneResponse.class;
	}
