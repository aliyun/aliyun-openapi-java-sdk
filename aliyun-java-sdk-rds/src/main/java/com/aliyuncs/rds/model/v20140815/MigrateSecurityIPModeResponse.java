...
import com.aliyuncs.rds.transform.v20140815.MigrateSecurityIPModeResponseUnmarshaller;
...
public class MigrateSecurityIPModeResponse extends AcsResponse {
	...
	@Override
	public MigrateSecurityIPModeResponse getInstance(UnmarshallerContext context) {
		return	MigrateSecurityIPModeResponseUnmarshaller.unmarshall(this, context);
	}
}
