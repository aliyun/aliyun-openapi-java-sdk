 ...
 * @version 
 */
public class ModifyADInfoRequest extends RpcAcsRequest<ModifyADInfoResponse> {
	...
	public void setADAccountName(String aDAccountName) {
		...
		if(aDAccountName != null){
			putQueryParameter("ADAccountName", aDAccountName);
		}
	}
	...
	public void setADPassword(String aDPassword) {
		...
		if(aDPassword != null){
			putQueryParameter("ADPassword", aDPassword);
		}
	}
	...
	public void setADServerIpAddress(String aDServerIpAddress) {
		...
		if(aDServerIpAddress != null){
			putQueryParameter("ADServerIpAddress", aDServerIpAddress);
		}
	}

	@Override
	public Class<ModifyADInfoResponse> getResponseClass() {
		return ModifyADInfoResponse.class;
	}
