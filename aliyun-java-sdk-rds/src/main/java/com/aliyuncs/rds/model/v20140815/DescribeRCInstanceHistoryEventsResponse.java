...
import com.aliyuncs.rds.transform.v20140815.DescribeRCInstanceHistoryEventsResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeRCInstanceHistoryEventsResponse extends AcsResponse {
	...
	private List<InstanceSystemEventSetItem> instanceSystemEventSet;
	...
	public List<InstanceSystemEventSetItem> getInstanceSystemEventSet() {
		return this.instanceSystemEventSet;
	}

	public void setInstanceSystemEventSet(List<InstanceSystemEventSetItem> instanceSystemEventSet) {
		this.instanceSystemEventSet = instanceSystemEventSet;
	}

	public static class InstanceSystemEventSetItem {
	...
	@Override
	public DescribeRCInstanceHistoryEventsResponse getInstance(UnmarshallerContext context) {
		return	DescribeRCInstanceHistoryEventsResponseUnmarshaller.unmarshall(this, context);
	}
