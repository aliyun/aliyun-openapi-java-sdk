 ...
 * @version 
 */
public class RebootRCInstancesRequest extends RpcAcsRequest<RebootRCInstancesResponse> {
	...
	public RebootRCInstancesRequest() {
		super("Rds", "2014-08-15", "RebootRCInstances", "rds");
	...
	@Override
	public Class<RebootRCInstancesResponse> getResponseClass() {
		return RebootRCInstancesResponse.class;
	}
