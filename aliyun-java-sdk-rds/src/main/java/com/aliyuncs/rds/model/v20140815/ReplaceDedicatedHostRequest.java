 ...
 * @version 
 */
public class ReplaceDedicatedHostRequest extends RpcAcsRequest<ReplaceDedicatedHostResponse> {
	...
	@Override
	public Class<ReplaceDedicatedHostResponse> getResponseClass() {
		return ReplaceDedicatedHostResponse.class;
	}
