 ...
 * @version 
 */
public class ReleaseInstanceConnectionRequest extends RpcAcsRequest<ReleaseInstanceConnectionResponse> {
	...
	@Override
	public Class<ReleaseInstanceConnectionResponse> getResponseClass() {
		return ReleaseInstanceConnectionResponse.class;
	}
