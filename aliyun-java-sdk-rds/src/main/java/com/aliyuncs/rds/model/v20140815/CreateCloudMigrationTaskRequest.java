 ...
 * @version 
 */
public class CreateCloudMigrationTaskRequest extends RpcAcsRequest<CreateCloudMigrationTaskResponse> {
	...
	@Override
	public Class<CreateCloudMigrationTaskResponse> getResponseClass() {
		return CreateCloudMigrationTaskResponse.class;
	}
