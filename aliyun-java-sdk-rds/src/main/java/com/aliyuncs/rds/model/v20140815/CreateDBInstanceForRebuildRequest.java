 ...
 * @version 
 */
public class CreateDBInstanceForRebuildRequest extends RpcAcsRequest<CreateDBInstanceForRebuildResponse> {
	...
	@Override
	public Class<CreateDBInstanceForRebuildResponse> getResponseClass() {
		return CreateDBInstanceForRebuildResponse.class;
	}
