 ...
 * @version 
 */
public class CreateRCNodePoolRequest extends RpcAcsRequest<CreateRCNodePoolResponse> {
	...
	public CreateRCNodePoolRequest() {
		super("Rds", "2014-08-15", "CreateRCNodePool", "rds");
	...
	public void setNodePoolName(String nodePoolName) {
		...
		if(nodePoolName != null){
			putQueryParameter("NodePoolName", nodePoolName);
		}
	}
	...
	@Override
	public Class<CreateRCNodePoolResponse> getResponseClass() {
		return CreateRCNodePoolResponse.class;
	}
