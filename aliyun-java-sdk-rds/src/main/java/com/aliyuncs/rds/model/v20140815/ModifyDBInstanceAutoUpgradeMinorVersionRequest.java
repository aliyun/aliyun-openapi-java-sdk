...
public class ModifyDBInstanceAutoUpgradeMinorVersionRequest extends RpcAcsRequest<ModifyDBInstanceAutoUpgradeMinorVersionResponse> {
	...
	public ModifyDBInstanceAutoUpgradeMinorVersionRequest() {
		super("Rds", "2014-08-15", "ModifyDBInstanceAutoUpgradeMinorVersion");
	...
	public void setAutoUpgradeMinorVersion(String autoUpgradeMinorVersion) {
		...
		if(autoUpgradeMinorVersion != null){
			putQueryParameter("AutoUpgradeMinorVersion", autoUpgradeMinorVersion);
		}
	}
	...
	@Override
	public Class<ModifyDBInstanceAutoUpgradeMinorVersionResponse> getResponseClass() {
		return ModifyDBInstanceAutoUpgradeMinorVersionResponse.class;
	}
