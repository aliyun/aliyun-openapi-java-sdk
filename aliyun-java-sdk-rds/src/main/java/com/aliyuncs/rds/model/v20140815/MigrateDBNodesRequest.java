 ...
 * @version 
 */
public class MigrateDBNodesRequest extends RpcAcsRequest<MigrateDBNodesResponse> {
	...
	@Override
	public Class<MigrateDBNodesResponse> getResponseClass() {
		return MigrateDBNodesResponse.class;
	}
