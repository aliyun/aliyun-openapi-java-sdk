...
public class DescribeAvailableRecoveryTimeRequest extends RpcAcsRequest<DescribeAvailableRecoveryTimeResponse> {
	...
	public DescribeAvailableRecoveryTimeRequest() {
		super("Rds", "2014-08-15", "DescribeAvailableRecoveryTime");
	...
	@Override
	public Class<DescribeAvailableRecoveryTimeResponse> getResponseClass() {
		return DescribeAvailableRecoveryTimeResponse.class;
	}
