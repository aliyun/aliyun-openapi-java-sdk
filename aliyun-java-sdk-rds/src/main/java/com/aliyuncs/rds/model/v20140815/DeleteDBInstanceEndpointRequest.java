 ...
 * @version 
 */
public class DeleteDBInstanceEndpointRequest extends RpcAcsRequest<DeleteDBInstanceEndpointResponse> {
	...
	@Override
	public Class<DeleteDBInstanceEndpointResponse> getResponseClass() {
		return DeleteDBInstanceEndpointResponse.class;
	}
