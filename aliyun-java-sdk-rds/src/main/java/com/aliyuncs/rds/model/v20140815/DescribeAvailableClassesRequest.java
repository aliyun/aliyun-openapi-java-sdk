...
public class DescribeAvailableClassesRequest extends RpcAcsRequest<DescribeAvailableClassesResponse> {
	...
	public DescribeAvailableClassesRequest() {
		super("Rds", "2014-08-15", "DescribeAvailableClasses", "rds");
	...
	@Override
	public Class<DescribeAvailableClassesResponse> getResponseClass() {
		return DescribeAvailableClassesResponse.class;
	}
