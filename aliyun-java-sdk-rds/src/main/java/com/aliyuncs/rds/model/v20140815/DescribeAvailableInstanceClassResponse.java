...
public class DescribeAvailableInstanceClassResponse extends AcsResponse {
	...
	@Override
	public DescribeAvailableInstanceClassResponse getInstance(UnmarshallerContext context) {
		return	DescribeAvailableInstanceClassResponseUnmarshaller.unmarshall(this, context);
	}
