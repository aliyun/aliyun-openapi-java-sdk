...
import com.aliyuncs.rds.transform.v20140815.CheckInstanceExistResponseUnmarshaller;
...
public class CheckInstanceExistResponse extends AcsResponse {
	...
	@Override
	public CheckInstanceExistResponse getInstance(UnmarshallerContext context) {
		return	CheckInstanceExistResponseUnmarshaller.unmarshall(this, context);
	}
}
