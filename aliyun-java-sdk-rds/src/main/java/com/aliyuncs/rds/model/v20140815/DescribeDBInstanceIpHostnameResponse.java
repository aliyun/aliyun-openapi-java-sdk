...
public class DescribeDBInstanceIpHostnameResponse extends AcsResponse {
	...
	@Override
	public DescribeDBInstanceIpHostnameResponse getInstance(UnmarshallerContext context) {
		return	DescribeDBInstanceIpHostnameResponseUnmarshaller.unmarshall(this, context);
	}
}
