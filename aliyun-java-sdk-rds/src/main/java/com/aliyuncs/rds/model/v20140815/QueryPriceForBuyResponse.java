 ...
 * @version 
 */
public class QueryPriceForBuyResponse extends AcsResponse {
	...
	@Override
	public QueryPriceForBuyResponse getInstance(UnmarshallerContext context) {
		return	QueryPriceForBuyResponseUnmarshaller.unmarshall(this, context);
	}
}
