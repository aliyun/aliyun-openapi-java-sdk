...
public class DescribeReadDBInstanceDelayRequest extends RpcAcsRequest<DescribeReadDBInstanceDelayResponse> {
	...
	public void setReadInstanceId(String readInstanceId) {
		this.readInstanceId = readInstanceId;
		if(readInstanceId != null){
			putQueryParameter("ReadInstanceId", readInstanceId);
		}
	}
	...
	@Override
	public Class<DescribeReadDBInstanceDelayResponse> getResponseClass() {
		return DescribeReadDBInstanceDelayResponse.class;
	}
