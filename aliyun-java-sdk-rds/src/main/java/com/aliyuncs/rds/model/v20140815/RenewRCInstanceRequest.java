 ...
 * @version 
 */
public class RenewRCInstanceRequest extends RpcAcsRequest<RenewRCInstanceResponse> {
	...
	public RenewRCInstanceRequest() {
		super("Rds", "2014-08-15", "RenewRCInstance", "rds");
	...
	public void setPeriodAlign(Boolean periodAlign) {
		this.periodAlign = periodAlign;
		if(periodAlign != null){
			putQueryParameter("PeriodAlign", periodAlign.toString());
		}
	}
	...
	@Override
	public Class<RenewRCInstanceResponse> getResponseClass() {
		return RenewRCInstanceResponse.class;
	}
