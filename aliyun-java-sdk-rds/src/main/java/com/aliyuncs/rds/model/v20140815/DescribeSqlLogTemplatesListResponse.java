...
import com.aliyuncs.rds.transform.v20140815.DescribeSqlLogTemplatesListResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeSqlLogTemplatesListResponse extends AcsResponse {
	...
	@Override
	public DescribeSqlLogTemplatesListResponse getInstance(UnmarshallerContext context) {
		return	DescribeSqlLogTemplatesListResponseUnmarshaller.unmarshall(this, context);
	}
}
