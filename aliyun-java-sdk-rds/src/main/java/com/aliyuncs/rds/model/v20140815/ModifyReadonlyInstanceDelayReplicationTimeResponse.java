...
import com.aliyuncs.rds.transform.v20140815.ModifyReadonlyInstanceDelayReplicationTimeResponseUnmarshaller;
...
public class ModifyReadonlyInstanceDelayReplicationTimeResponse extends AcsResponse {
	...
	@Override
	public ModifyReadonlyInstanceDelayReplicationTimeResponse getInstance(UnmarshallerContext context) {
		return	ModifyReadonlyInstanceDelayReplicationTimeResponseUnmarshaller.unmarshall(this, context);
	}
}
