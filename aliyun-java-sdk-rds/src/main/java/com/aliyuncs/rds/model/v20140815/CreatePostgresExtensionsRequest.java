 ...
 * @version 
 */
public class CreatePostgresExtensionsRequest extends RpcAcsRequest<CreatePostgresExtensionsResponse> {
	...
	public void setSourceDatabase(String sourceDatabase) {
		...
		if(sourceDatabase != null){
			putQueryParameter("SourceDatabase", sourceDatabase);
		}
	}
	...
	@Override
	public Class<CreatePostgresExtensionsResponse> getResponseClass() {
		return CreatePostgresExtensionsResponse.class;
	}
