 ...
 * @version 
 */
public class ModifyDBInstanceEndpointAddressRequest extends RpcAcsRequest<ModifyDBInstanceEndpointAddressResponse> {
	...
	@Override
	public Class<ModifyDBInstanceEndpointAddressResponse> getResponseClass() {
		return ModifyDBInstanceEndpointAddressResponse.class;
	}
