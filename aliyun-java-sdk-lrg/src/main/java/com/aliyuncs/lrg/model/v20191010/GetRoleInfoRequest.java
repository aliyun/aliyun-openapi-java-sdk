 ...
 * @version 
 */
public class GetRoleInfoRequest extends RoaAcsRequest<GetRoleInfoResponse> {
	...
	public GetRoleInfoRequest() {
		super("LRG", "2019-10-10", "GetRoleInfo");
		setUriPattern("/api/v2/[productName]/deploy-unit/[deployUnitName]/role");
	...
	@Override
	public Class<GetRoleInfoResponse> getResponseClass() {
		return GetRoleInfoResponse.class;
	}
