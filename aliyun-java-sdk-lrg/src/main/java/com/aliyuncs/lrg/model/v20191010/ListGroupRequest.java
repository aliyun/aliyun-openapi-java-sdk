 ...
 * @version 
 */
public class ListGroupRequest extends RoaAcsRequest<ListGroupResponse> {
	...
	public ListGroupRequest() {
		super("LRG", "2019-10-10", "ListGroup");
		setUriPattern("/api/v2/gw/xgw/gw-group?action=list");
	...
	@Override
	public Class<ListGroupResponse> getResponseClass() {
		return ListGroupResponse.class;
	}
