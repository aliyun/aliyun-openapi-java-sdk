 ...
 * @version 
 */
public class UpdateTunnelIdRequest extends RoaAcsRequest<UpdateTunnelIdResponse> {
	   

	private String big_region_name;

	private String status;
	public UpdateTunnelIdRequest() {
		super("LRG", "2019-10-10", "UpdateTunnelId");
		setUriPattern("/api/v2/gw/tunnel-id?action=update");
	...
	@Override
	public Class<UpdateTunnelIdResponse> getResponseClass() {
		return UpdateTunnelIdResponse.class;
	}
