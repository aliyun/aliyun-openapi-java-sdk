 ...
 * @version 
 */
public class GwListGatewayRequest extends RoaAcsRequest<GwListGatewayResponse> {
	   

	private String big_region_name;

	private String status;
	public GwListGatewayRequest() {
		super("LRG", "2019-10-10", "GwListGateway");
		setUriPattern("/api/v2/gw/xgw/gw-server?action=list");
	...
	@Override
	public Class<GwListGatewayResponse> getResponseClass() {
		return GwListGatewayResponse.class;
	}
