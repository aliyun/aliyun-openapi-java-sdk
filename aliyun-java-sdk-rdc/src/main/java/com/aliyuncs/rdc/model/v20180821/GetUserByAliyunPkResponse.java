...
import com.aliyuncs.rdc.transform.v20180821.GetUserByAliyunPkResponseUnmarshaller;
 ...
 * @version 
 */
public class GetUserByAliyunPkResponse extends AcsResponse {
	...
	@Override
	public GetUserByAliyunPkResponse getInstance(UnmarshallerContext context) {
		return	GetUserByAliyunPkResponseUnmarshaller.unmarshall(this, context);
	}
