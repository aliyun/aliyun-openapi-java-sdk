...
import com.aliyuncs.rdc.transform.v20180821.GetIssueByIdResponseUnmarshaller;
 ...
 * @version 
 */
public class GetIssueByIdResponse extends AcsResponse {
	...
	@Override
	public GetIssueByIdResponse getInstance(UnmarshallerContext context) {
		return	GetIssueByIdResponseUnmarshaller.unmarshall(this, context);
	}
