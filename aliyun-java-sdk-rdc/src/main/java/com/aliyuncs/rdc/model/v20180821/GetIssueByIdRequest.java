 ...
 * @version 
 */
public class GetIssueByIdRequest extends RpcAcsRequest<GetIssueByIdResponse> {
	...
	@Override
	public Class<GetIssueByIdResponse> getResponseClass() {
		return GetIssueByIdResponse.class;
	}
