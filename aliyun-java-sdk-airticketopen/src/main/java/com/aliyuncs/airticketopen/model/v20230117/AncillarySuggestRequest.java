 ...
 * @version 
 */
public class AncillarySuggestRequest extends RoaAcsRequest<AncillarySuggestResponse> {
	...
	public AncillarySuggestRequest() {
		super("airticketOpen", "2023-01-17", "AncillarySuggest");
		setUriPattern("/airticket/v1/ancillary/action-suggest");
	...
	@Override
	public Class<AncillarySuggestResponse> getResponseClass() {
		return AncillarySuggestResponse.class;
	}
