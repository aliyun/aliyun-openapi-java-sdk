 ...
 * @version 
 */
public class ChangeDetailRequest extends RoaAcsRequest<ChangeDetailResponse> {
	...
	public ChangeDetailRequest() {
		super("airticketOpen", "2023-01-17", "ChangeDetail");
		setUriPattern("/airticket/v1/change/detail");
	...
	public void setChange_order_num(Long change_order_num) {
		...
		if(change_order_num != null){
			putQueryParameter("change_order_num", change_order_num.toString());
		}
	}
	...
	@Override
	public Class<ChangeDetailResponse> getResponseClass() {
		return ChangeDetailResponse.class;
	}
