 ...
 * @version 
 */
public class TicketingCheckRequest extends RoaAcsRequest<TicketingCheckResponse> {
	...
	public TicketingCheckRequest() {
		super("airticketOpen", "2023-01-17", "TicketingCheck");
		setUriPattern("/airticket/v1/trade/action-ticketing-check");
	...
	@Override
	public Class<TicketingCheckResponse> getResponseClass() {
		return TicketingCheckResponse.class;
	}
