 ...
 * @version 
 */
public class ChangeCancelRequest extends RoaAcsRequest<ChangeCancelResponse> {
	...
	public ChangeCancelRequest() {
		super("airticketOpen", "2023-01-17", "ChangeCancel");
		setUriPattern("/airticket/v1/change/action-cancel");
	...
	@Override
	public Class<ChangeCancelResponse> getResponseClass() {
