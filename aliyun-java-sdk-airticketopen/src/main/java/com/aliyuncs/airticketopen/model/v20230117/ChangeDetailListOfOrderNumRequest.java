 ...
 * @version 
 */
public class ChangeDetailListOfOrderNumRequest extends RoaAcsRequest<ChangeDetailListOfOrderNumResponse> {
	...
	public ChangeDetailListOfOrderNumRequest() {
		super("airticketOpen", "2023-01-17", "ChangeDetailListOfOrderNum");
		setUriPattern("/airticket/v1/change/order-num/detail-list");
	...
	@Override
	public Class<ChangeDetailListOfOrderNumResponse> getResponseClass() {
		return ChangeDetailListOfOrderNumResponse.class;
	}
