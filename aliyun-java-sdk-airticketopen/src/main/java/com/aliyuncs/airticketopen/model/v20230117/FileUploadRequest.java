 ...
 * @version 
 */
public class FileUploadRequest extends RoaAcsRequest<FileUploadResponse> {
	...
	public FileUploadRequest() {
		super("airticketOpen", "2023-01-17", "FileUpload");
		setUriPattern("/airticket/v1/attachment/action-upload");
	...
	public void setFile_content(String file_content) {
		...
		if(file_content != null){
			putBodyParameter("file_content", file_content);
		}
	}
