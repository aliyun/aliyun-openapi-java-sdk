 ...
 * @version 
 */
public class OrderListRequest extends RoaAcsRequest<OrderListResponse> {
	...
	public OrderListRequest() {
		super("airticketOpen", "2023-01-17", "OrderList");
		setUriPattern("/airticket/v1/trade/order-list");
	...
	public Long getBook_time_start() {
		return this.book_time_start;
	}

	public void setBook_time_start(Long book_time_start) {
		this.book_time_start = book_time_start;
		if(book_time_start != null){
			putQueryParameter("book_time_start", book_time_start.toString());
		}
	}
	...
	public Long getBook_time_end() {
		return this.book_time_end;
	}

	public void setBook_time_end(Long book_time_end) {
		this.book_time_end = book_time_end;
		if(book_time_end != null){
			putQueryParameter("book_time_end", book_time_end.toString());
		}
	}
