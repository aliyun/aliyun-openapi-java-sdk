 ...
 * @version 
 */
public class RefundDetailRequest extends RoaAcsRequest<RefundDetailResponse> {
	   

	private Long refund_order_num;
	...
	public RefundDetailRequest() {
		super("airticketOpen", "2023-01-17", "RefundDetail");
		setUriPattern("/airticket/v1/refund/detail");
		setMethod(MethodType.GET);
	}

	public Long getRefund_order_num() {
		return this.refund_order_num;
	}

	public void setRefund_order_num(Long refund_order_num) {
		this.refund_order_num = refund_order_num;
		if(refund_order_num != null){
			putQueryParameter("refund_order_num", refund_order_num.toString());
		}
	}
