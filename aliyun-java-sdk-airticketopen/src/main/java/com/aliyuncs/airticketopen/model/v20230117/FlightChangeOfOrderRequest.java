 ...
 * @version 
 */
public class FlightChangeOfOrderRequest extends RoaAcsRequest<FlightChangeOfOrderResponse> {
	...
	public FlightChangeOfOrderRequest() {
		super("airticketOpen", "2023-01-17", "FlightChangeOfOrder");
		setUriPattern("/airticket/v1/flightchange/of-order");
	...
	@Override
	public Class<FlightChangeOfOrderResponse> getResponseClass() {
		return FlightChangeOfOrderResponse.class;
	}
