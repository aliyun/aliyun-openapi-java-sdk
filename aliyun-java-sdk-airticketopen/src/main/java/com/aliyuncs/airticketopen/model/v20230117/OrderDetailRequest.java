 ...
 * @version 
 */
public class OrderDetailRequest extends RoaAcsRequest<OrderDetailResponse> {
	...
	public OrderDetailRequest() {
		super("airticketOpen", "2023-01-17", "OrderDetail");
		setUriPattern("/airticket/v1/trade/order-detail");
	...
	public void setOut_order_num(String out_order_num) {
		...
		if(out_order_num != null){
			putQueryParameter("out_order_num", out_order_num);
		}
	}
