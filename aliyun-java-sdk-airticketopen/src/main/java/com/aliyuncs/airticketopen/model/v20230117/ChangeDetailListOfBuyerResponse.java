...
public class ChangeDetailListOfBuyerResponse extends AcsResponse {
	...
	@Override
	public ChangeDetailListOfBuyerResponse getInstance(UnmarshallerContext context) {
		return	ChangeDetailListOfBuyerResponseUnmarshaller.unmarshall(this, context);
	}
