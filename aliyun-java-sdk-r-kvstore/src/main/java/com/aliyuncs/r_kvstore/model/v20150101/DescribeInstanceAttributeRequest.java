...
public class DescribeInstanceAttributeRequest extends RpcAcsRequest<DescribeInstanceAttributeResponse> {
	...
	public DescribeInstanceAttributeRequest() {
		super("R-kvstore", "2015-01-01", "DescribeInstanceAttribute");
	...
	@Override
	public Class<DescribeInstanceAttributeResponse> getResponseClass() {
		return DescribeInstanceAttributeResponse.class;
	}
