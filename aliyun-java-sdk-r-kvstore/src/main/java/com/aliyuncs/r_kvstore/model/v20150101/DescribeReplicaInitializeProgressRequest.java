...
public class DescribeReplicaInitializeProgressRequest extends RpcAcsRequest<DescribeReplicaInitializeProgressResponse> {
	...
	public DescribeReplicaInitializeProgressRequest() {
		super("R-kvstore", "2015-01-01", "DescribeReplicaInitializeProgress");
	...
	@Override
	public Class<DescribeReplicaInitializeProgressResponse> getResponseClass() {
		return DescribeReplicaInitializeProgressResponse.class;
	}
