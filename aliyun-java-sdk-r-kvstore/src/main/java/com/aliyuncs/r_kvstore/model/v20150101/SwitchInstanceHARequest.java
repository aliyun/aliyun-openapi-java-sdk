 ...
 * @version 
 */
public class SwitchInstanceHARequest extends RpcAcsRequest<SwitchInstanceHAResponse> {
	...
	public SwitchInstanceHARequest() {
		super("R-kvstore", "2015-01-01", "SwitchInstanceHA", "redisa");
	...
	@Override
	public Class<SwitchInstanceHAResponse> getResponseClass() {
		return SwitchInstanceHAResponse.class;
	}
