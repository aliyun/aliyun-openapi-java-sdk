 ...
 * @version 
 */
public class CreateDedicatedInstanceRequest extends RpcAcsRequest<CreateDedicatedInstanceResponse> {
	...
	@Override
	public Class<CreateDedicatedInstanceResponse> getResponseClass() {
