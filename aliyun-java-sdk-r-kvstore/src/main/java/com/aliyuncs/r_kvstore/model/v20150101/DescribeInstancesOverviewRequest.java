 ...
 * @version 
 */
public class DescribeInstancesOverviewRequest extends RpcAcsRequest<DescribeInstancesOverviewResponse> {
	...
	public DescribeInstancesOverviewRequest() {
		super("R-kvstore", "2015-01-01", "DescribeInstancesOverview", "redisa");
	...
	@Override
	public Class<DescribeInstancesOverviewResponse> getResponseClass() {
		return DescribeInstancesOverviewResponse.class;
	}
