...
import com.aliyuncs.r_kvstore.transform.v20150101.DescribeReplicaUsageResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeReplicaUsageResponse extends AcsResponse {
	...
	@Override
	public DescribeReplicaUsageResponse getInstance(UnmarshallerContext context) {
		return	DescribeReplicaUsageResponseUnmarshaller.unmarshall(this, context);
	}
