...
public class DescribeMonthlyServiceStatusDetailResponse extends AcsResponse {
	...
	public void setAffectedInfos(List<AffectedInfo> affectedInfos) {
		this.affectedInfos = affectedInfos;
	}
	...
	@Override
	public DescribeMonthlyServiceStatusDetailResponse getInstance(UnmarshallerContext context) {
		return	DescribeMonthlyServiceStatusDetailResponseUnmarshaller.unmarshall(this, context);
	}
}
