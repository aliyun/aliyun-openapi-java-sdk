...
import com.aliyuncs.r_kvstore.transform.v20150101.DescribeInstancesByExpireTimeResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeInstancesByExpireTimeResponse extends AcsResponse {
	...
	@Override
	public DescribeInstancesByExpireTimeResponse getInstance(UnmarshallerContext context) {
		return	DescribeInstancesByExpireTimeResponseUnmarshaller.unmarshall(this, context);
	}
}
