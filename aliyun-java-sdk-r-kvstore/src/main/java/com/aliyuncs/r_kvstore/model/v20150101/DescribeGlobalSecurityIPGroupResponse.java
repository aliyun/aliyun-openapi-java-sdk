...
import com.aliyuncs.r_kvstore.transform.v20150101.DescribeGlobalSecurityIPGroupResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeGlobalSecurityIPGroupResponse extends AcsResponse {
	...
	@Override
	public DescribeGlobalSecurityIPGroupResponse getInstance(UnmarshallerContext context) {
		return	DescribeGlobalSecurityIPGroupResponseUnmarshaller.unmarshall(this, context);
	}
