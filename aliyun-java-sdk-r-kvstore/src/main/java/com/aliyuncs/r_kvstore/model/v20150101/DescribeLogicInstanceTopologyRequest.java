...
public class DescribeLogicInstanceTopologyRequest extends RpcAcsRequest<DescribeLogicInstanceTopologyResponse> {
	...
	public DescribeLogicInstanceTopologyRequest() {
		super("R-kvstore", "2015-01-01", "DescribeLogicInstanceTopology");
	...
	@Override
	public Class<DescribeLogicInstanceTopologyResponse> getResponseClass() {
		return DescribeLogicInstanceTopologyResponse.class;
	}
