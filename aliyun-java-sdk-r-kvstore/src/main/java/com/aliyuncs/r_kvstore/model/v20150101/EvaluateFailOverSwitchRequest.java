...
public class EvaluateFailOverSwitchRequest extends RpcAcsRequest<EvaluateFailOverSwitchResponse> {
	...
	public EvaluateFailOverSwitchRequest() {
		super("R-kvstore", "2015-01-01", "EvaluateFailOverSwitch");
	...
	@Override
	public Class<EvaluateFailOverSwitchResponse> getResponseClass() {
		return EvaluateFailOverSwitchResponse.class;
	}
