...
public class ModifyInstanceSpecPreCheckRequest extends RpcAcsRequest<ModifyInstanceSpecPreCheckResponse> {
	...
	public ModifyInstanceSpecPreCheckRequest() {
		super("R-kvstore", "2015-01-01", "ModifyInstanceSpecPreCheck");
	...
	public void setTargetInstanceClass(String targetInstanceClass) {
		this.targetInstanceClass = targetInstanceClass;
		if(targetInstanceClass != null){
			putQueryParameter("TargetInstanceClass", targetInstanceClass);
		}
	}

	@Override
	public Class<ModifyInstanceSpecPreCheckResponse> getResponseClass() {
		return ModifyInstanceSpecPreCheckResponse.class;
	}
