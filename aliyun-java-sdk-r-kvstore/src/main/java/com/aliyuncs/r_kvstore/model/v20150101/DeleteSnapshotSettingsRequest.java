...
public class DeleteSnapshotSettingsRequest extends RpcAcsRequest<DeleteSnapshotSettingsResponse> {
	...
	public DeleteSnapshotSettingsRequest() {
		super("R-kvstore", "2015-01-01", "DeleteSnapshotSettings");
	...
	@Override
	public Class<DeleteSnapshotSettingsResponse> getResponseClass() {
		return DeleteSnapshotSettingsResponse.class;
	}
