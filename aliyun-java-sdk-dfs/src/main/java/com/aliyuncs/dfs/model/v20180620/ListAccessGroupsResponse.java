...
import com.aliyuncs.dfs.transform.v20180620.ListAccessGroupsResponseUnmarshaller;
 ...
 * @version 
 */
public class ListAccessGroupsResponse extends AcsResponse {
	...
	@Override
	public ListAccessGroupsResponse getInstance(UnmarshallerContext context) {
		return	ListAccessGroupsResponseUnmarshaller.unmarshall(this, context);
	}
