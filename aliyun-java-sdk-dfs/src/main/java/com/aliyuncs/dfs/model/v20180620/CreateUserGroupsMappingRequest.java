 ...
 * @version 
 */
public class CreateUserGroupsMappingRequest extends RpcAcsRequest<CreateUserGroupsMappingResponse> {
	...
	@Override
	public Class<CreateUserGroupsMappingResponse> getResponseClass() {
