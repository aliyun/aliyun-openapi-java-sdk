 ...
 * @version 
 */
public class BindVscMountPointAliasRequest extends RpcAcsRequest<BindVscMountPointAliasResponse> {
	...
	@Override
	public Class<BindVscMountPointAliasResponse> getResponseClass() {
