...
import com.aliyuncs.dfs.model.v20180620.DescribeRegionsResponse;
import com.aliyuncs.dfs.model.v20180620.DescribeRegionsResponse.Regions;
import com.aliyuncs.dfs.model.v20180620.DescribeRegionsResponse.Regions.RegionItem;
...
public class DescribeRegionsResponseUnmarshaller {
	...
	public static DescribeRegionsResponse unmarshall(DescribeRegionsResponse describeRegionsResponse, UnmarshallerContext _ctx) {
		...
		for (int i = 0; i < _ctx.lengthValue("DescribeRegionsResponse.Regions.Region.Length"); i++) {
			...
			regionItem.setRegionEndpoint(_ctx.stringValue("DescribeRegionsResponse.Regions.Region["+ i +"].RegionEndpoint"));
			regionItem.setLocalName(_ctx.stringValue("DescribeRegionsResponse.Regions.Region["+ i +"].LocalName"));
