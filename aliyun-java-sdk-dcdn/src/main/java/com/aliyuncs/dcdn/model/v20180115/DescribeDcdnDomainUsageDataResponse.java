...
import com.aliyuncs.dcdn.transform.v20180115.DescribeDcdnDomainUsageDataResponseUnmarshaller;
...
public class DescribeDcdnDomainUsageDataResponse extends AcsResponse {
	...
	@Override
	public DescribeDcdnDomainUsageDataResponse getInstance(UnmarshallerContext context) {
		return	DescribeDcdnDomainUsageDataResponseUnmarshaller.unmarshall(this, context);
	}
}
