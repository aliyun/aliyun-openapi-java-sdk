 ...
 * @version 
 */
public class DescribeDcdnDomainIpaBpsDataRequest extends RpcAcsRequest<DescribeDcdnDomainIpaBpsDataResponse> {
	...
	public DescribeDcdnDomainIpaBpsDataRequest() {
		super("dcdn", "2018-01-15", "DescribeDcdnDomainIpaBpsData");
	...
	@Override
	public Class<DescribeDcdnDomainIpaBpsDataResponse> getResponseClass() {
		return DescribeDcdnDomainIpaBpsDataResponse.class;
	}
