...
import com.aliyuncs.dcdn.transform.v20180115.DescribeDcdnDomainHitRateDataResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeDcdnDomainHitRateDataResponse extends AcsResponse {
	...
	@Override
	public DescribeDcdnDomainHitRateDataResponse getInstance(UnmarshallerContext context) {
		return	DescribeDcdnDomainHitRateDataResponseUnmarshaller.unmarshall(this, context);
	}
}
