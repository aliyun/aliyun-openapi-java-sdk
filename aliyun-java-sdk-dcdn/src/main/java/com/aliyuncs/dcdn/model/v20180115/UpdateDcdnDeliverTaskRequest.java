 ...
 * @version 
 */
public class UpdateDcdnDeliverTaskRequest extends RpcAcsRequest<UpdateDcdnDeliverTaskResponse> {
	...
	@Override
	public Class<UpdateDcdnDeliverTaskResponse> getResponseClass() {
		return UpdateDcdnDeliverTaskResponse.class;
	}
