...
import com.aliyuncs.dcdn.transform.v20180115.DescribeDcdnDomainRealTimeHttpCodeDataResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeDcdnDomainRealTimeHttpCodeDataResponse extends AcsResponse {
	...
	@Override
	public DescribeDcdnDomainRealTimeHttpCodeDataResponse getInstance(UnmarshallerContext context) {
		return	DescribeDcdnDomainRealTimeHttpCodeDataResponseUnmarshaller.unmarshall(this, context);
	}
}
