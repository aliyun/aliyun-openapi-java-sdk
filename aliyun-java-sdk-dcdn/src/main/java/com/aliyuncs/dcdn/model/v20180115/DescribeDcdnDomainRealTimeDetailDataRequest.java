 ...
 * @version 
 */
public class DescribeDcdnDomainRealTimeDetailDataRequest extends RpcAcsRequest<DescribeDcdnDomainRealTimeDetailDataResponse> {
	...
	public DescribeDcdnDomainRealTimeDetailDataRequest() {
		super("dcdn", "2018-01-15", "DescribeDcdnDomainRealTimeDetailData");
	...
	@Override
	public Class<DescribeDcdnDomainRealTimeDetailDataResponse> getResponseClass() {
		return DescribeDcdnDomainRealTimeDetailDataResponse.class;
	}
