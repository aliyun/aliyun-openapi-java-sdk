 ...
 * @version 
 */
public class DescribeDcdnDomainCnameResponse extends AcsResponse {
	...
	@Override
	public DescribeDcdnDomainCnameResponse getInstance(UnmarshallerContext context) {
		return	DescribeDcdnDomainCnameResponseUnmarshaller.unmarshall(this, context);
	}
}
