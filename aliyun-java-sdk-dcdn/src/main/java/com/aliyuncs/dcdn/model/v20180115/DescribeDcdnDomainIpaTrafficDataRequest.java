 ...
 * @version 
 */
public class DescribeDcdnDomainIpaTrafficDataRequest extends RpcAcsRequest<DescribeDcdnDomainIpaTrafficDataResponse> {
	...
	public DescribeDcdnDomainIpaTrafficDataRequest() {
		super("dcdn", "2018-01-15", "DescribeDcdnDomainIpaTrafficData");
	...
	@Override
	public Class<DescribeDcdnDomainIpaTrafficDataResponse> getResponseClass() {
		return DescribeDcdnDomainIpaTrafficDataResponse.class;
	}
