 ...
 * @version 
 */
public class OpenDcdnServiceRequest extends RpcAcsRequest<OpenDcdnServiceResponse> {
	...
	public OpenDcdnServiceRequest() {
		super("dcdn", "2018-01-15", "OpenDcdnService");
	...
	@Override
	public Class<OpenDcdnServiceResponse> getResponseClass() {
		return OpenDcdnServiceResponse.class;
	}
