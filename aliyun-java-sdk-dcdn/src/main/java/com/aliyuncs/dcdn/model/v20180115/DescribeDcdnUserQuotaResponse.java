...
import com.aliyuncs.dcdn.transform.v20180115.DescribeDcdnUserQuotaResponseUnmarshaller;
...
public class DescribeDcdnUserQuotaResponse extends AcsResponse {
	...
	@Override
	public DescribeDcdnUserQuotaResponse getInstance(UnmarshallerContext context) {
		return	DescribeDcdnUserQuotaResponseUnmarshaller.unmarshall(this, context);
	}
}
