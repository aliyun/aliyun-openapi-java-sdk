...
import com.aliyuncs.dcdn.transform.v20180115.DescribeDcdnRefreshQuotaResponseUnmarshaller;
...
public class DescribeDcdnRefreshQuotaResponse extends AcsResponse {
	...
	@Override
	public DescribeDcdnRefreshQuotaResponse getInstance(UnmarshallerContext context) {
		return	DescribeDcdnRefreshQuotaResponseUnmarshaller.unmarshall(this, context);
	}
}
