 ...
 * @version 
 */
public class DescribeDcdnUserResourcePackageResponse extends AcsResponse {
	...
	@Override
	public DescribeDcdnUserResourcePackageResponse getInstance(UnmarshallerContext context) {
		return	DescribeDcdnUserResourcePackageResponseUnmarshaller.unmarshall(this, context);
	}
}
