...
import com.aliyuncs.dcdn.transform.v20180115.DescribeDcdnDomainLogResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeDcdnDomainLogResponse extends AcsResponse {
	...
	@Override
	public DescribeDcdnDomainLogResponse getInstance(UnmarshallerContext context) {
		return	DescribeDcdnDomainLogResponseUnmarshaller.unmarshall(this, context);
	}
}
