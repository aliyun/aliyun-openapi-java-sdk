 ...
 * @version 
 */
public class CreateDcdnSLSRealTimeLogDeliveryRequest extends RpcAcsRequest<CreateDcdnSLSRealTimeLogDeliveryResponse> {
	...
	public CreateDcdnSLSRealTimeLogDeliveryRequest() {
		super("dcdn", "2018-01-15", "CreateDcdnSLSRealTimeLogDelivery");
	...
	@Override
	public Class<CreateDcdnSLSRealTimeLogDeliveryResponse> getResponseClass() {
		return CreateDcdnSLSRealTimeLogDeliveryResponse.class;
	}
