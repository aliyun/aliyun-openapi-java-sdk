...
import com.aliyuncs.dcdn.transform.v20180115.DescribeDcdnSMCertificateListResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeDcdnSMCertificateListResponse extends AcsResponse {
	...
	@Override
	public DescribeDcdnSMCertificateListResponse getInstance(UnmarshallerContext context) {
		return	DescribeDcdnSMCertificateListResponseUnmarshaller.unmarshall(this, context);
	}
