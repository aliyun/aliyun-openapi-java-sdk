 ...
 * @version 
 */
public class SetDcdnConfigOfVersionRequest extends RpcAcsRequest<SetDcdnConfigOfVersionResponse> {
	...
	public SetDcdnConfigOfVersionRequest() {
		super("dcdn", "2018-01-15", "SetDcdnConfigOfVersion");
	...
	public void setFunctionArgs(String functionArgs) {
		...
		if(functionArgs != null){
			putQueryParameter("FunctionArgs", functionArgs);
		}
	}
	...
	@Override
	public Class<SetDcdnConfigOfVersionResponse> getResponseClass() {
		return SetDcdnConfigOfVersionResponse.class;
	}
