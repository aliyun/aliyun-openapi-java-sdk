...
import com.aliyuncs.dcdn.transform.v20180115.DescribeUserErStatusResponseUnmarshaller;
...
public class DescribeUserErStatusResponse extends AcsResponse {
	...
	@Override
	public DescribeUserErStatusResponse getInstance(UnmarshallerContext context) {
		return	DescribeUserErStatusResponseUnmarshaller.unmarshall(this, context);
	}
}
