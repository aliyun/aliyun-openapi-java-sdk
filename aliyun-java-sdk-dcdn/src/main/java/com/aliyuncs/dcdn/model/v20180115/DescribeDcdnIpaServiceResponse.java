...
import com.aliyuncs.dcdn.transform.v20180115.DescribeDcdnIpaServiceResponseUnmarshaller;
...
public class DescribeDcdnIpaServiceResponse extends AcsResponse {
	...
	@Override
	public DescribeDcdnIpaServiceResponse getInstance(UnmarshallerContext context) {
		return	DescribeDcdnIpaServiceResponseUnmarshaller.unmarshall(this, context);
	}
}
