...
import com.aliyuncs.dcdn.transform.v20180115.DescribeDcdnHttpsDomainListResponseUnmarshaller;
...
public class DescribeDcdnHttpsDomainListResponse extends AcsResponse {
	...
	@Override
	public DescribeDcdnHttpsDomainListResponse getInstance(UnmarshallerContext context) {
		return	DescribeDcdnHttpsDomainListResponseUnmarshaller.unmarshall(this, context);
	}
}
