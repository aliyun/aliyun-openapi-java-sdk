...
import com.aliyuncs.dcdn.transform.v20180115.DescribeDcdnSMCertificateDetailResponseUnmarshaller;
...
public class DescribeDcdnSMCertificateDetailResponse extends AcsResponse {
	...
	@Override
	public DescribeDcdnSMCertificateDetailResponse getInstance(UnmarshallerContext context) {
		return	DescribeDcdnSMCertificateDetailResponseUnmarshaller.unmarshall(this, context);
	}
}
