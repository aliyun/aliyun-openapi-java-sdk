...
import com.aliyuncs.dcdn.transform.v20180115.DescribeDcdnConfigOfVersionResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeDcdnConfigOfVersionResponse extends AcsResponse {
	...
	@Override
	public DescribeDcdnConfigOfVersionResponse getInstance(UnmarshallerContext context) {
		return	DescribeDcdnConfigOfVersionResponseUnmarshaller.unmarshall(this, context);
	}
}
