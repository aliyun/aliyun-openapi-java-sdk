 ...
 * @version 
 */
public class BatchSetDcdnDomainCertificateRequest extends RpcAcsRequest<BatchSetDcdnDomainCertificateResponse> {
	...
	public BatchSetDcdnDomainCertificateRequest() {
		super("dcdn", "2018-01-15", "BatchSetDcdnDomainCertificate");
	...
	@Override
	public Class<BatchSetDcdnDomainCertificateResponse> getResponseClass() {
		return BatchSetDcdnDomainCertificateResponse.class;
	}
