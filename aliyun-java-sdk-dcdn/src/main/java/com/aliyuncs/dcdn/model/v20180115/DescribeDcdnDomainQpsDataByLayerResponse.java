...
import com.aliyuncs.dcdn.transform.v20180115.DescribeDcdnDomainQpsDataByLayerResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeDcdnDomainQpsDataByLayerResponse extends AcsResponse {
	...
	@Override
	public DescribeDcdnDomainQpsDataByLayerResponse getInstance(UnmarshallerContext context) {
		return	DescribeDcdnDomainQpsDataByLayerResponseUnmarshaller.unmarshall(this, context);
	}
}
