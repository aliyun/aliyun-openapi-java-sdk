...
import com.aliyuncs.schedulerx2.model.v20190430.CreateNamespaceResponse.Data;
...
public class CreateNamespaceResponseUnmarshaller {
	...
	public static CreateNamespaceResponse unmarshall(CreateNamespaceResponse createNamespaceResponse, UnmarshallerContext _ctx) {
		...
		Data data = new Data();
		data.setNamespaceUid(_ctx.stringValue("CreateNamespaceResponse.Data.NamespaceUid"));
