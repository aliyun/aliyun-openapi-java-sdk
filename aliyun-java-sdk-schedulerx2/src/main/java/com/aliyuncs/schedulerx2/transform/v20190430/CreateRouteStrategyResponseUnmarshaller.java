...
import com.aliyuncs.schedulerx2.model.v20190430.CreateRouteStrategyResponse;
import com.aliyuncs.schedulerx2.model.v20190430.CreateRouteStrategyResponse.Data;
...
public class CreateRouteStrategyResponseUnmarshaller {
	...
	public static CreateRouteStrategyResponse unmarshall(CreateRouteStrategyResponse createRouteStrategyResponse, UnmarshallerContext _ctx) {
		...
		Data data = new Data();
		data.setAppGroupId(_ctx.longValue("CreateRouteStrategyResponse.Data.AppGroupId"));
		createRouteStrategyResponse.setData(data);
