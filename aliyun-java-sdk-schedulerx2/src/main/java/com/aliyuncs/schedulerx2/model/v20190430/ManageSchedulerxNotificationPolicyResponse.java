...
import com.aliyuncs.schedulerx2.transform.v20190430.ManageSchedulerxNotificationPolicyResponseUnmarshaller;
 ...
 * @version 
 */
public class ManageSchedulerxNotificationPolicyResponse extends AcsResponse {
	...
	@Override
	public ManageSchedulerxNotificationPolicyResponse getInstance(UnmarshallerContext context) {
		return	ManageSchedulerxNotificationPolicyResponseUnmarshaller.unmarshall(this, context);
	}
