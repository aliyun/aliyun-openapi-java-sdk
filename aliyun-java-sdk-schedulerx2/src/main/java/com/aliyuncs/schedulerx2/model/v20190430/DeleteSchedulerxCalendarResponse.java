...
import com.aliyuncs.schedulerx2.transform.v20190430.DeleteSchedulerxCalendarResponseUnmarshaller;
 ...
 * @version 
 */
public class DeleteSchedulerxCalendarResponse extends AcsResponse {
	...
	@Override
	public DeleteSchedulerxCalendarResponse getInstance(UnmarshallerContext context) {
		return	DeleteSchedulerxCalendarResponseUnmarshaller.unmarshall(this, context);
	}
