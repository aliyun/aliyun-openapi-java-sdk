...
public class GetJobInstanceListResponse extends AcsResponse {
	...
	public static class Data {
		...
		public void setJobInstanceDetails(List<JobInstanceDetailsItem> jobInstanceDetails) {
	...
	@Override
	public GetJobInstanceListResponse getInstance(UnmarshallerContext context) {
		return	GetJobInstanceListResponseUnmarshaller.unmarshall(this, context);
	}
