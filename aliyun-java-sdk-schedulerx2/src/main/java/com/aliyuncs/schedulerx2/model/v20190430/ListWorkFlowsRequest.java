 ...
 * @version 
 */
public class ListWorkFlowsRequest extends RpcAcsRequest<ListWorkFlowsResponse> {
	...
	public ListWorkFlowsRequest() {
		super("schedulerx2", "2019-04-30", "ListWorkFlows", "schedulerx2");
	...
	@Override
	public Class<ListWorkFlowsResponse> getResponseClass() {
		return ListWorkFlowsResponse.class;
	}
