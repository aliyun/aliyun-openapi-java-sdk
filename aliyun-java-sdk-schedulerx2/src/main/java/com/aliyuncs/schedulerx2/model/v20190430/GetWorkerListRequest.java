 ...
 * @version 
 */
public class GetWorkerListRequest extends RpcAcsRequest<GetWorkerListResponse> {
	...
	@Override
	public Class<GetWorkerListResponse> getResponseClass() {
		return GetWorkerListResponse.class;
	}
