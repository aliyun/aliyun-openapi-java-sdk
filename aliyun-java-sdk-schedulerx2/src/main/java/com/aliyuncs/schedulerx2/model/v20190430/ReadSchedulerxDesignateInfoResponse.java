...
import com.aliyuncs.schedulerx2.transform.v20190430.ReadSchedulerxDesignateInfoResponseUnmarshaller;
...
public class ReadSchedulerxDesignateInfoResponse extends AcsResponse {
	...
	@Override
	public ReadSchedulerxDesignateInfoResponse getInstance(UnmarshallerContext context) {
		return	ReadSchedulerxDesignateInfoResponseUnmarshaller.unmarshall(this, context);
	}
