...
import com.aliyuncs.schedulerx2.transform.v20190430.ReadSchedulerxCalendarResponseUnmarshaller;
 ...
 * @version 
 */
public class ReadSchedulerxCalendarResponse extends AcsResponse {
	...
	public static class Data {
		...
		public static class Record {
			...
			public void setSystemCalendar(Boolean systemCalendar) {
	...
	@Override
	public ReadSchedulerxCalendarResponse getInstance(UnmarshallerContext context) {
		return	ReadSchedulerxCalendarResponseUnmarshaller.unmarshall(this, context);
	}
