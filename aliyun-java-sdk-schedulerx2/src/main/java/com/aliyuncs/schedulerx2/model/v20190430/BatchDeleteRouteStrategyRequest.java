 ...
 * @version 
 */
public class BatchDeleteRouteStrategyRequest extends RpcAcsRequest<BatchDeleteRouteStrategyResponse> {
	...
	@Override
	public Class<BatchDeleteRouteStrategyResponse> getResponseClass() {
		return BatchDeleteRouteStrategyResponse.class;
	}
