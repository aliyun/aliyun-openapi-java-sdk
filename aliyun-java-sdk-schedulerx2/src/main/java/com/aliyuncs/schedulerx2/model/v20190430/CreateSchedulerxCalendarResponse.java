...
import com.aliyuncs.schedulerx2.transform.v20190430.CreateSchedulerxCalendarResponseUnmarshaller;
 ...
 * @version 
 */
public class CreateSchedulerxCalendarResponse extends AcsResponse {
	...
	@Override
	public CreateSchedulerxCalendarResponse getInstance(UnmarshallerContext context) {
		return	CreateSchedulerxCalendarResponseUnmarshaller.unmarshall(this, context);
	}
