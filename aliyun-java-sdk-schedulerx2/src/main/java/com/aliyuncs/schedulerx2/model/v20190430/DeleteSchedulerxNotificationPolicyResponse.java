...
import com.aliyuncs.schedulerx2.transform.v20190430.DeleteSchedulerxNotificationPolicyResponseUnmarshaller;
 ...
 * @version 
 */
public class DeleteSchedulerxNotificationPolicyResponse extends AcsResponse {
	...
	@Override
	public DeleteSchedulerxNotificationPolicyResponse getInstance(UnmarshallerContext context) {
		return	DeleteSchedulerxNotificationPolicyResponseUnmarshaller.unmarshall(this, context);
	}
