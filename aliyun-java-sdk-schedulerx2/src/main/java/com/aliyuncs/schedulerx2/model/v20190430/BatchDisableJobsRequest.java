 ...
 * @version 
 */
public class BatchDisableJobsRequest extends RpcAcsRequest<BatchDisableJobsResponse> {
	...
	@Override
	public Class<BatchDisableJobsResponse> getResponseClass() {
		return BatchDisableJobsResponse.class;
	}
