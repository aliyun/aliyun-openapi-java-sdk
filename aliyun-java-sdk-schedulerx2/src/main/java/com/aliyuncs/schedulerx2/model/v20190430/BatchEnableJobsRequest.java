 ...
 * @version 
 */
public class BatchEnableJobsRequest extends RpcAcsRequest<BatchEnableJobsResponse> {
	...
	public BatchEnableJobsRequest() {
		super("schedulerx2", "2019-04-30", "BatchEnableJobs", "schedulerx2");
	...
	@Override
	public Class<BatchEnableJobsResponse> getResponseClass() {
		return BatchEnableJobsResponse.class;
	}
