 ...
 * @version 
 */
public class SetJobInstanceSuccessRequest extends RpcAcsRequest<SetJobInstanceSuccessResponse> {
	...
	@Override
	public Class<SetJobInstanceSuccessResponse> getResponseClass() {
		return SetJobInstanceSuccessResponse.class;
	}
