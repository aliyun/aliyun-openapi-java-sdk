...
import com.aliyuncs.schedulerx2.transform.v20190430.CreateSchedulerxNotificationPolicyResponseUnmarshaller;
 ...
 * @version 
 */
public class CreateSchedulerxNotificationPolicyResponse extends AcsResponse {
	...
	@Override
	public CreateSchedulerxNotificationPolicyResponse getInstance(UnmarshallerContext context) {
		return	CreateSchedulerxNotificationPolicyResponseUnmarshaller.unmarshall(this, context);
	}
