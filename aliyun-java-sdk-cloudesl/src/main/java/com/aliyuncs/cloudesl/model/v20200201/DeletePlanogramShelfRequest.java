 ...
 * @version 
 */
public class DeletePlanogramShelfRequest extends RpcAcsRequest<DeletePlanogramShelfResponse> {
	...
	public DeletePlanogramShelfRequest() {
		super("cloudesl", "2020-02-01", "DeletePlanogramShelf", "cloudesl");
	...
	@Override
	public Class<DeletePlanogramShelfResponse> getResponseClass() {
		return DeletePlanogramShelfResponse.class;
	}
