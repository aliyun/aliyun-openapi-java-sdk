 ...
 * @version 
 */
public class DescribeLogisticsRequest extends RpcAcsRequest<DescribeLogisticsResponse> {
	...
	@Override
	public Class<DescribeLogisticsResponse> getResponseClass() {
		return DescribeLogisticsResponse.class;
	}
