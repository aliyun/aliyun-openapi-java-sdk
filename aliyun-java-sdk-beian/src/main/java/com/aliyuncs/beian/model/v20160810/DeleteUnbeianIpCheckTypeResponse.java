...
import com.aliyuncs.beian.transform.v20160810.DeleteUnbeianIpCheckTypeResponseUnmarshaller;
 ...
 * @version 
 */
public class DeleteUnbeianIpCheckTypeResponse extends AcsResponse {
	...
	@Override
	public DeleteUnbeianIpCheckTypeResponse getInstance(UnmarshallerContext context) {
		return	DeleteUnbeianIpCheckTypeResponseUnmarshaller.unmarshall(this, context);
	}
}
