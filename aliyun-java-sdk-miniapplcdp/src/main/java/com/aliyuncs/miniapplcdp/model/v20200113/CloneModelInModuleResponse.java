...
import com.aliyuncs.miniapplcdp.transform.v20200113.CloneModelInModuleResponseUnmarshaller;
 ...
 * @version 
 */
public class CloneModelInModuleResponse extends AcsResponse {
	...
	@Override
	public CloneModelInModuleResponse getInstance(UnmarshallerContext context) {
		return	CloneModelInModuleResponseUnmarshaller.unmarshall(this, context);
	}
