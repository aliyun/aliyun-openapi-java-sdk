...
import com.aliyuncs.miniapplcdp.transform.v20200113.CloneModelFromCommitResponseUnmarshaller;
 ...
 * @version 
 */
public class CloneModelFromCommitResponse extends AcsResponse {
	...
	@Override
	public CloneModelFromCommitResponse getInstance(UnmarshallerContext context) {
		return	CloneModelFromCommitResponseUnmarshaller.unmarshall(this, context);
	}
