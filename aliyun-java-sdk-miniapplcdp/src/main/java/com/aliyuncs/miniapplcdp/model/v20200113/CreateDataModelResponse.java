...
import com.aliyuncs.miniapplcdp.transform.v20200113.CreateDataModelResponseUnmarshaller;
 ...
 * @version 
 */
public class CreateDataModelResponse extends AcsResponse {
	...
	@Override
	public CreateDataModelResponse getInstance(UnmarshallerContext context) {
		return	CreateDataModelResponseUnmarshaller.unmarshall(this, context);
	}
