...
import com.aliyuncs.miniapplcdp.transform.v20200113.ListModuleDependenciesResponseUnmarshaller;
 ...
 * @version 
 */
public class ListModuleDependenciesResponse extends AcsResponse {
	...
	@Override
	public ListModuleDependenciesResponse getInstance(UnmarshallerContext context) {
		return	ListModuleDependenciesResponseUnmarshaller.unmarshall(this, context);
	}
