 ...
 * @version 
 */
public class BatchRestoreModelRequest extends RpcAcsRequest<BatchRestoreModelResponse> {
	...
	@Override
	public Class<BatchRestoreModelResponse> getResponseClass() {
		return BatchRestoreModelResponse.class;
	}
