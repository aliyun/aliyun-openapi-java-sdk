...
import com.aliyuncs.miniapplcdp.transform.v20200113.ListModulesByPageResponseUnmarshaller;
 ...
 * @version 
 */
public class ListModulesByPageResponse extends AcsResponse {
	...
	@Override
	public ListModulesByPageResponse getInstance(UnmarshallerContext context) {
		return	ListModulesByPageResponseUnmarshaller.unmarshall(this, context);
	}
