...
import com.aliyuncs.miniapplcdp.transform.v20200113.GetDataModelResponseUnmarshaller;
 ...
 * @version 
 */
public class GetDataModelResponse extends AcsResponse {
	...
	@Override
	public GetDataModelResponse getInstance(UnmarshallerContext context) {
		return	GetDataModelResponseUnmarshaller.unmarshall(this, context);
	}
