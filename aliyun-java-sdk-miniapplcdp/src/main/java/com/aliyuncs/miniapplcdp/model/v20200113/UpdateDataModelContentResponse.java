...
import com.aliyuncs.miniapplcdp.transform.v20200113.UpdateDataModelContentResponseUnmarshaller;
 ...
 * @version 
 */
public class UpdateDataModelContentResponse extends AcsResponse {
	...
	@Override
	public UpdateDataModelContentResponse getInstance(UnmarshallerContext context) {
		return	UpdateDataModelContentResponseUnmarshaller.unmarshall(this, context);
	}
