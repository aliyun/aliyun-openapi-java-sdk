 ...
 * @version 
 */
public class ListDataModelsRequest extends RpcAcsRequest<ListDataModelsResponse> {
	...
	public ListDataModelsRequest() {
		super("miniapplcdp", "2020-01-13", "ListDataModels");
	...
	@Override
	public Class<ListDataModelsResponse> getResponseClass() {
		return ListDataModelsResponse.class;
	}
