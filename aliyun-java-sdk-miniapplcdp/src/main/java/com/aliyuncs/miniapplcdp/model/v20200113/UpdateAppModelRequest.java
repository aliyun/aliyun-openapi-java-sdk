 ...
 * @version 
 */
public class UpdateAppModelRequest extends RpcAcsRequest<UpdateAppModelResponse> {
	...
	@Override
	public Class<UpdateAppModelResponse> getResponseClass() {
		return UpdateAppModelResponse.class;
	}
