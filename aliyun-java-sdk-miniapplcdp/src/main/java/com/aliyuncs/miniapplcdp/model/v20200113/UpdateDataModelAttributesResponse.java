...
import com.aliyuncs.miniapplcdp.transform.v20200113.UpdateDataModelAttributesResponseUnmarshaller;
 ...
 * @version 
 */
public class UpdateDataModelAttributesResponse extends AcsResponse {
	...
	@Override
	public UpdateDataModelAttributesResponse getInstance(UnmarshallerContext context) {
		return	UpdateDataModelAttributesResponseUnmarshaller.unmarshall(this, context);
	}
