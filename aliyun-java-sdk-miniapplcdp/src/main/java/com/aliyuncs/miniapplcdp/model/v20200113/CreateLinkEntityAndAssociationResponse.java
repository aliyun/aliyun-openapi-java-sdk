...
import com.aliyuncs.miniapplcdp.transform.v20200113.CreateLinkEntityAndAssociationResponseUnmarshaller;
 ...
 * @version 
 */
public class CreateLinkEntityAndAssociationResponse extends AcsResponse {
	...
	@Override
	public CreateLinkEntityAndAssociationResponse getInstance(UnmarshallerContext context) {
		return	CreateLinkEntityAndAssociationResponseUnmarshaller.unmarshall(this, context);
	}
