...
import com.aliyuncs.miniapplcdp.transform.v20200113.ListDataModelsResponseUnmarshaller;
 ...
 * @version 
 */
public class ListDataModelsResponse extends AcsResponse {
	...
	@Override
	public ListDataModelsResponse getInstance(UnmarshallerContext context) {
		return	ListDataModelsResponseUnmarshaller.unmarshall(this, context);
	}
