...
import com.aliyuncs.miniapplcdp.transform.v20200113.ListModelsResponseUnmarshaller;
 ...
 * @version 
 */
public class ListModelsResponse extends AcsResponse {
	...
	@Override
	public ListModelsResponse getInstance(UnmarshallerContext context) {
		return	ListModelsResponseUnmarshaller.unmarshall(this, context);
	}
