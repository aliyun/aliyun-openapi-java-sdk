 ...
 * @version 
 */
public class RepairApRadioRequest extends RpcAcsRequest<RepairApRadioResponse> {
	...
	public RepairApRadioRequest() {
		super("cloudwifi-pop", "2019-11-18", "RepairApRadio", "cloudap");
	...
	@Override
	public Class<RepairApRadioResponse> getResponseClass() {
		return RepairApRadioResponse.class;
	}
