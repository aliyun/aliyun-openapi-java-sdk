 ...
 * @version 
 */
public class GetApAssetRequest extends RpcAcsRequest<GetApAssetResponse> {
	...
	@Override
	public Class<GetApAssetResponse> getResponseClass() {
		return GetApAssetResponse.class;
	}
