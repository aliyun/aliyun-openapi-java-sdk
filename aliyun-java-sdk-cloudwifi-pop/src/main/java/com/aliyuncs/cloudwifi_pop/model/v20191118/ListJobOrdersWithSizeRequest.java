 ...
 * @version 
 */
public class ListJobOrdersWithSizeRequest extends RpcAcsRequest<ListJobOrdersWithSizeResponse> {
	...
	public ListJobOrdersWithSizeRequest() {
		super("cloudwifi-pop", "2019-11-18", "ListJobOrdersWithSize", "cloudap");
	...
	@Override
	public Class<ListJobOrdersWithSizeResponse> getResponseClass() {
		return ListJobOrdersWithSizeResponse.class;
	}
