 ...
 * @version 
 */
public class NewNetDeviceInfoRequest extends RpcAcsRequest<NewNetDeviceInfoResponse> {
	...
	public NewNetDeviceInfoRequest() {
		super("cloudwifi-pop", "2019-11-18", "NewNetDeviceInfo", "cloudap");
	...
	@Override
	public Class<NewNetDeviceInfoResponse> getResponseClass() {
		return NewNetDeviceInfoResponse.class;
	}
