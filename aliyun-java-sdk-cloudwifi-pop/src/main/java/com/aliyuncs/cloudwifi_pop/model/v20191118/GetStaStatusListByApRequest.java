 ...
 * @version 
 */
public class GetStaStatusListByApRequest extends RpcAcsRequest<GetStaStatusListByApResponse> {
	...
	@Override
	public Class<GetStaStatusListByApResponse> getResponseClass() {
		return GetStaStatusListByApResponse.class;
	}
