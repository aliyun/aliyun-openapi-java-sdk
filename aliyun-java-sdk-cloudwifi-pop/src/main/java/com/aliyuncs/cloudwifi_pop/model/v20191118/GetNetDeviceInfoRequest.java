 ...
 * @version 
 */
public class GetNetDeviceInfoRequest extends RpcAcsRequest<GetNetDeviceInfoResponse> {
	...
	public GetNetDeviceInfoRequest() {
		super("cloudwifi-pop", "2019-11-18", "GetNetDeviceInfo", "cloudap");
	...
	@Override
	public Class<GetNetDeviceInfoResponse> getResponseClass() {
		return GetNetDeviceInfoResponse.class;
	}
