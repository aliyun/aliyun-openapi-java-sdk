 ...
 * @version 
 */
public class GetApAddressByMacRequest extends RpcAcsRequest<GetApAddressByMacResponse> {
	...
	@Override
	public Class<GetApAddressByMacResponse> getResponseClass() {
		return GetApAddressByMacResponse.class;
	}
