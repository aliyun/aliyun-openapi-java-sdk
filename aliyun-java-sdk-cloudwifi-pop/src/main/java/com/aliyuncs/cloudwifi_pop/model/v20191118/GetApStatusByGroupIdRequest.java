 ...
 * @version 
 */
public class GetApStatusByGroupIdRequest extends RpcAcsRequest<GetApStatusByGroupIdResponse> {
	...
	@Override
	public Class<GetApStatusByGroupIdResponse> getResponseClass() {
		return GetApStatusByGroupIdResponse.class;
	}
