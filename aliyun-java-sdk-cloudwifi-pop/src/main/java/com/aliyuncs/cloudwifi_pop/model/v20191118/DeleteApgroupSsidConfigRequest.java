 ...
 * @version 
 */
public class DeleteApgroupSsidConfigRequest extends RpcAcsRequest<DeleteApgroupSsidConfigResponse> {
	...
	public DeleteApgroupSsidConfigRequest() {
		super("cloudwifi-pop", "2019-11-18", "DeleteApgroupSsidConfig", "cloudap");
	...
	@Override
	public Class<DeleteApgroupSsidConfigResponse> getResponseClass() {
		return DeleteApgroupSsidConfigResponse.class;
	}
