 ...
 * @version 
 */
public class GetRadioRunHistoryTimeSerRequest extends RpcAcsRequest<GetRadioRunHistoryTimeSerResponse> {
	...
	public GetRadioRunHistoryTimeSerRequest() {
		super("cloudwifi-pop", "2019-11-18", "GetRadioRunHistoryTimeSer", "cloudap");
	...
	@Override
	public Class<GetRadioRunHistoryTimeSerResponse> getResponseClass() {
