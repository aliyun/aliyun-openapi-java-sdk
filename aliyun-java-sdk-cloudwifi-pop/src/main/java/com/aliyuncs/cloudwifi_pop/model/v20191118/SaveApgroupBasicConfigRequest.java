 ...
 * @version 
 */
public class SaveApgroupBasicConfigRequest extends RpcAcsRequest<SaveApgroupBasicConfigResponse> {
	...
	public SaveApgroupBasicConfigRequest() {
		super("cloudwifi-pop", "2019-11-18", "SaveApgroupBasicConfig", "cloudap");
	...
	public void setIsConfigStrongConsistency(Boolean isConfigStrongConsistency) {
		this.isConfigStrongConsistency = isConfigStrongConsistency;
		if(isConfigStrongConsistency != null){
			putQueryParameter("IsConfigStrongConsistency", isConfigStrongConsistency.toString());
		}
	}
	...
	@Override
	public Class<SaveApgroupBasicConfigResponse> getResponseClass() {
		return SaveApgroupBasicConfigResponse.class;
	}
