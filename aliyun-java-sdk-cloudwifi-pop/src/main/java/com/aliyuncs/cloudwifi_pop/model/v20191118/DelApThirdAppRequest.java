 ...
 * @version 
 */
public class DelApThirdAppRequest extends RpcAcsRequest<DelApThirdAppResponse> {
	...
	private String mac;
	public DelApThirdAppRequest() {
		super("cloudwifi-pop", "2019-11-18", "DelApThirdApp", "cloudap");
	...
	@Override
	public Class<DelApThirdAppResponse> getResponseClass() {
		return DelApThirdAppResponse.class;
	}
