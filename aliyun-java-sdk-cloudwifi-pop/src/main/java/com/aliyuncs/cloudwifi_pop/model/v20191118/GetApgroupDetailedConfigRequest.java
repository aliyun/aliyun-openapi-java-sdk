 ...
 * @version 
 */
public class GetApgroupDetailedConfigRequest extends RpcAcsRequest<GetApgroupDetailedConfigResponse> {
	...
	public GetApgroupDetailedConfigRequest() {
		super("cloudwifi-pop", "2019-11-18", "GetApgroupDetailedConfig", "cloudap");
	...
	@Override
	public Class<GetApgroupDetailedConfigResponse> getResponseClass() {
		return GetApgroupDetailedConfigResponse.class;
	}
