 ...
 * @version 
 */
public class NewApgroupConfigRequest extends RpcAcsRequest<NewApgroupConfigResponse> {
	...
	public void setParentApgroupId(String parentApgroupId) {
		this.parentApgroupId = parentApgroupId;
		if(parentApgroupId != null){
			putQueryParameter("ParentApgroupId", parentApgroupId);
		}
	}
	...
	@Override
	public Class<NewApgroupConfigResponse> getResponseClass() {
		return NewApgroupConfigResponse.class;
	}
