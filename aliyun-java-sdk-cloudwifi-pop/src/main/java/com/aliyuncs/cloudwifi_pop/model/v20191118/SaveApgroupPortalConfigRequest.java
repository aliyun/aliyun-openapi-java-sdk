 ...
 * @version 
 */
public class SaveApgroupPortalConfigRequest extends RpcAcsRequest<SaveApgroupPortalConfigResponse> {
	...
	public SaveApgroupPortalConfigRequest() {
		super("cloudwifi-pop", "2019-11-18", "SaveApgroupPortalConfig", "cloudap");
	...
	@Override
	public Class<SaveApgroupPortalConfigResponse> getResponseClass() {
		return SaveApgroupPortalConfigResponse.class;
	}
