 ...
 * @version 
 */
public class EffectApConfigRequest extends RpcAcsRequest<EffectApConfigResponse> {
	...
	@Override
	public Class<EffectApConfigResponse> getResponseClass() {
		return EffectApConfigResponse.class;
	}
