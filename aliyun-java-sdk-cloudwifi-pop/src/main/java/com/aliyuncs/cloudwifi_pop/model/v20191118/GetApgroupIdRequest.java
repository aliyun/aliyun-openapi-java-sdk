 ...
 * @version 
 */
public class GetApgroupIdRequest extends RpcAcsRequest<GetApgroupIdResponse> {
	...
	@Override
	public Class<GetApgroupIdResponse> getResponseClass() {
		return GetApgroupIdResponse.class;
	}
