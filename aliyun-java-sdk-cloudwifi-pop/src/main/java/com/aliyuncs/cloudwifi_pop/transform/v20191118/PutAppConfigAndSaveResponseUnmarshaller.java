...
import com.aliyuncs.cloudwifi_pop.model.v20191118.PutAppConfigAndSaveResponse;
import java.util.Map;
import com.aliyuncs.transform.UnmarshallerContext;


public class PutAppConfigAndSaveResponseUnmarshaller {

	public static PutAppConfigAndSaveResponse unmarshall(PutAppConfigAndSaveResponse putAppConfigAndSaveResponse, UnmarshallerContext _ctx) {
