 ...
 * @version 
 */
public class ListAppTypeRequest extends RpcAcsRequest<ListAppTypeResponse> {
	   

	private String businessScenario;
	public ListAppTypeRequest() {
		super("emas-dmp", "2021-04-02", "ListAppType");
	...
	@Override
	public Class<ListAppTypeResponse> getResponseClass() {
		return ListAppTypeResponse.class;
	}
