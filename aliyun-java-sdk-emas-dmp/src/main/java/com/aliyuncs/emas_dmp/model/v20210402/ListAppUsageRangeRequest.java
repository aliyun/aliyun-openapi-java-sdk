 ...
 * @version 
 */
public class ListAppUsageRangeRequest extends RpcAcsRequest<ListAppUsageRangeResponse> {
	   

	private String businessScenario;
	public ListAppUsageRangeRequest() {
		super("emas-dmp", "2021-04-02", "ListAppUsageRange");
	...
	@Override
	public Class<ListAppUsageRangeResponse> getResponseClass() {
		return ListAppUsageRangeResponse.class;
	}
