 ...
 * @version 
 */
public class CreateTargetAudienceByAppRequest extends RpcAcsRequest<CreateTargetAudienceByAppResponse> {
	...
	public CreateTargetAudienceByAppRequest() {
		super("emas-dmp", "2021-04-02", "CreateTargetAudienceByApp");
	...
	public void setPkgList(String pkgList) {
		...
		if(pkgList != null){
			putBodyParameter("PkgList", pkgList);
		}
	}
	...
	@Override
	public Class<CreateTargetAudienceByAppResponse> getResponseClass() {
		return CreateTargetAudienceByAppResponse.class;
	}
